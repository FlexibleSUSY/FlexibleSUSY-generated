 ...
 */
template<>
class NMSSMEFTHiggs<Two_scale> : public Model, public NMSSMEFTHiggs_slha {
public:
   explicit NMSSMEFTHiggs(const NMSSMEFTHiggs_input_parameters& input_ = NMSSMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NMSSMEFTHiggs(const NMSSMEFTHiggs_slha&, bool do_convert_masses_to_slha = true);
