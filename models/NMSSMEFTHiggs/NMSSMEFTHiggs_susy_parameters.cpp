...
// File generated at Tue 10 Oct 2017 20:24:34
...
#define CLASSNAME NMSSMEFTHiggs_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int NMSSMEFTHiggs_susy_parameters::numberOfParameters;

NMSSMEFTHiggs_susy_parameters::NMSSMEFTHiggs_susy_parameters(const NMSSMEFTHiggs_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

NMSSMEFTHiggs_susy_parameters::NMSSMEFTHiggs_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const NMSSMEFTHiggs_input_parameters& input_
...
Eigen::ArrayXd NMSSMEFTHiggs_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

NMSSMEFTHiggs_susy_parameters NMSSMEFTHiggs_susy_parameters::calc_beta(int loops) const
{
   ...
   return NMSSMEFTHiggs_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Lambdax, beta_Kappa, beta_Yu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu, beta_vS);
}

NMSSMEFTHiggs_susy_parameters NMSSMEFTHiggs_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void NMSSMEFTHiggs_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd NMSSMEFTHiggs_susy_parameters::get() const
{
...
void NMSSMEFTHiggs_susy_parameters::print(std::ostream& ostr) const
{
...
void NMSSMEFTHiggs_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const NMSSMEFTHiggs_input_parameters& NMSSMEFTHiggs_susy_parameters::get_input() const
{
   return input;
}

NMSSMEFTHiggs_input_parameters& NMSSMEFTHiggs_susy_parameters::get_input()
{
   return input;
}

void NMSSMEFTHiggs_susy_parameters::set_input_parameters(const NMSSMEFTHiggs_input_parameters& input_)
{
   input = input_;
}

NMSSMEFTHiggs_susy_parameters::Susy_traces NMSSMEFTHiggs_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const NMSSMEFTHiggs_susy_parameters& susy_pars)
{
