...
NMSSMEFTHiggs_slha_io::NMSSMEFTHiggs_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void NMSSMEFTHiggs_slha_io::clear()
{
   slha_io.clear();
}

void NMSSMEFTHiggs_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void NMSSMEFTHiggs_slha_io::fill(NMSSMEFTHiggs_slha& model) const
{
   fill(static_cast<NMSSMEFTHiggs_mass_eigenstates&>(model));
 ...
 */
void NMSSMEFTHiggs_slha_io::set_extpar(const NMSSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NMSSMEFTHiggs_slha_io::set_imminpar(const NMSSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NMSSMEFTHiggs_slha_io::set_imextpar(const NMSSMEFTHiggs_input_parameters& input)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void NMSSMEFTHiggs_slha_io::set_minpar(const NMSSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NMSSMEFTHiggs_slha_io::set_input(const NMSSMEFTHiggs_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void NMSSMEFTHiggs_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void NMSSMEFTHiggs_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void NMSSMEFTHiggs_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::set_unitarity_infinite_s(
 ...
 */
void NMSSMEFTHiggs_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void NMSSMEFTHiggs_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void NMSSMEFTHiggs_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, NMSSMEFTHiggs_info::model_name)
 ...
 */
void NMSSMEFTHiggs_slha_io::set_mass(const NMSSMEFTHiggs_physical& physical,
 ...
 */
void NMSSMEFTHiggs_slha_io::set_mixing_matrices(const NMSSMEFTHiggs_physical& physical,
...
void NMSSMEFTHiggs_slha_io::set_ckm(
...
void NMSSMEFTHiggs_slha_io::set_pmns(
 ...
 */
void NMSSMEFTHiggs_slha_io::set_model_parameters(const NMSSMEFTHiggs_slha& model)
{
   {
...
void NMSSMEFTHiggs_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void NMSSMEFTHiggs_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void NMSSMEFTHiggs_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void NMSSMEFTHiggs_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void NMSSMEFTHiggs_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, NMSSMEFTHiggs_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void NMSSMEFTHiggs_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = NMSSMEFTHiggs_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + NMSSMEFTHiggs_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void NMSSMEFTHiggs_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::set_spectrum(const NMSSMEFTHiggs_slha& model)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void NMSSMEFTHiggs_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void NMSSMEFTHiggs_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void NMSSMEFTHiggs_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double NMSSMEFTHiggs_slha_io::get_parameter_output_scale() const
{
 ...
 */
void NMSSMEFTHiggs_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void NMSSMEFTHiggs_slha_io::fill(NMSSMEFTHiggs_input_parameters& input) const
{
 ...
 */
void NMSSMEFTHiggs_slha_io::fill_drbar_parameters(NMSSMEFTHiggs_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void NMSSMEFTHiggs_slha_io::fill(NMSSMEFTHiggs_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   NMSSMEFTHiggs_physical physical_hk;
 ...
 */
void NMSSMEFTHiggs_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void NMSSMEFTHiggs_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NMSSMEFTHiggs_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NMSSMEFTHiggs_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void NMSSMEFTHiggs_slha_io::fill_minpar_tuple(NMSSMEFTHiggs_input_parameters& input,
...
void NMSSMEFTHiggs_slha_io::fill_extpar_tuple(NMSSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NMSSMEFTHiggs_slha_io::fill_imminpar_tuple(NMSSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NMSSMEFTHiggs_slha_io::fill_imextpar_tuple(NMSSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void NMSSMEFTHiggs_slha_io::fill_physical(NMSSMEFTHiggs_physical& physical) const
{
   {
