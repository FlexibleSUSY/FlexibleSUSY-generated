...
#ifndef NMSSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define NMSSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "NMSSMEFTHiggs_low_scale_constraint.hpp"
...
template<>
class NMSSMEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   NMSSMEFTHiggs_low_scale_constraint() = default;
   NMSSMEFTHiggs_low_scale_constraint(NMSSMEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NMSSMEFTHiggs_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "NMSSMEFTHiggs low-scale constraint"; }
