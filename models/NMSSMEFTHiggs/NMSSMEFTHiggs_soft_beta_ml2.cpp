...
// File generated at Fri 20 Oct 2017 08:32:52
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_ml2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_ml2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_ml2_3_loop(const Soft_traces& soft_traces) const
{
