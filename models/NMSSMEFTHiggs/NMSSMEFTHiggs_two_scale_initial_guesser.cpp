...
NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::NMSSMEFTHiggs_standard_model_initial_guesser(
   ...
   const NMSSMEFTHiggs_susy_scale_constraint<Two_scale>& susy_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("NMSSMEFTHiggs_initial_guesser: Error: pointer to model"
                       " NMSSMEFTHiggs<Two_scale> must not be zero");
}
 ...
 */
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 */
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
...
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
 ...
 * corrections).
 */
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void NMSSMEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
