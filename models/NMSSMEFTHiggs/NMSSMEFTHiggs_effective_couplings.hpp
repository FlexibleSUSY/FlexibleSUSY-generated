...
class NMSSMEFTHiggs_effective_couplings {
public:
   NMSSMEFTHiggs_effective_couplings(const NMSSMEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const NMSSMEFTHiggs_mass_eigenstates& model_);
