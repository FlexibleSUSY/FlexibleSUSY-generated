...
public:
   ...
   NMSSMEFTHiggs_soft_parameters& operator=(const NMSSMEFTHiggs_soft_parameters&) = default;
   NMSSMEFTHiggs_soft_parameters& operator=(NMSSMEFTHiggs_soft_parameters&&) = default;
   ...
   NMSSMEFTHiggs_soft_parameters calc_beta() const;
   NMSSMEFTHiggs_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const NMSSMEFTHiggs_soft_parameters&);
