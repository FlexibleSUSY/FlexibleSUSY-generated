...
struct NMSSMEFTHiggs_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class NMSSMEFTHiggs_slha_io {
public:
   NMSSMEFTHiggs_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(NMSSMEFTHiggs_input_parameters&) const;
   void fill(NMSSMEFTHiggs_mass_eigenstates&) const;
   template <class Model> void fill(NMSSMEFTHiggs_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const NMSSMEFTHiggs_slha<Model>&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&);
   void set_input(const NMSSMEFTHiggs_input_parameters&);
   ...
   template <class Model> void set_spectrum(const NMSSMEFTHiggs_slha<Model>&);
   template <class T> void set_spectrum(const NMSSMEFTHiggs<T>&);
   ...
   static void fill_minpar_tuple(NMSSMEFTHiggs_input_parameters&, int, double);
   static void fill_extpar_tuple(NMSSMEFTHiggs_input_parameters&, int, double);
   static void fill_imminpar_tuple(NMSSMEFTHiggs_input_parameters&, int, double);
   static void fill_imextpar_tuple(NMSSMEFTHiggs_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const NMSSMEFTHiggs_slha<Model>&, const softsusy::QedQcd&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const NMSSMEFTHiggs_slha<Model>&, const softsusy::QedQcd&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const NMSSMEFTHiggs_input_parameters&);
   void set_imminpar(const NMSSMEFTHiggs_input_parameters&);
   void set_imextpar(const NMSSMEFTHiggs_input_parameters&);
   void set_minpar(const NMSSMEFTHiggs_input_parameters&);
   void set_mass(const NMSSMEFTHiggs_physical&, bool);
   void set_mixing_matrices(const NMSSMEFTHiggs_physical&, bool);
   template <class Model> void set_model_parameters(const NMSSMEFTHiggs_slha<Model>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(NMSSMEFTHiggs_mass_eigenstates&) const;
   void fill_physical(NMSSMEFTHiggs_physical&) const;
};
 ...
 */
template <class Model>
void NMSSMEFTHiggs_slha_io::fill(NMSSMEFTHiggs_slha<Model>& model) const
{
...
template <class Model>
void NMSSMEFTHiggs_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const NMSSMEFTHiggs_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const NMSSMEFTHiggs_scales& scales,
   const NMSSMEFTHiggs_observables& observables)
{
   NMSSMEFTHiggs_slha_io slha_io;
   const NMSSMEFTHiggs_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll NMSSMEFTHiggs_slha_io::fill_slhaea(
   const NMSSMEFTHiggs_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const NMSSMEFTHiggs_scales& scales, const NMSSMEFTHiggs_observables& observables)
{
   SLHAea::Coll slhaea;
   NMSSMEFTHiggs_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void NMSSMEFTHiggs_slha_io::set_model_parameters(const NMSSMEFTHiggs_slha<Model>& model)
{
   {
...
void NMSSMEFTHiggs_slha_io::set_extra(
   const NMSSMEFTHiggs_slha<Model>& model, const NMSSMEFTHiggs_scales& scales,
   const NMSSMEFTHiggs_observables& observables)
{
 ...
 */
template <class... Ts>
void NMSSMEFTHiggs_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<NMSSMEFTHiggs_slha_io> ss(this);
 ...
 */
template <class T>
void NMSSMEFTHiggs_slha_io::set_spectrum(const NMSSMEFTHiggs<T>& model)
{
   set_spectrum(NMSSMEFTHiggs_slha<NMSSMEFTHiggs<T> >(model));
}
 ...
 */
template <class Model>
void NMSSMEFTHiggs_slha_io::set_spectrum(const NMSSMEFTHiggs_slha<Model>& model)
{
   const NMSSMEFTHiggs_physical physical(model.get_physical_slha());
