...
#include "decays/NMSSMEFTHiggs_decays.hpp"
...
struct NMSSMEFTHiggs_physical;
class NMSSMEFTHiggs_slha;
...
public:
   ...
   void fill(NMSSMEFTHiggs_slha&) const;
   ...
   void set_decays(const NMSSMEFTHiggs_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const NMSSMEFTHiggs_slha&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const NMSSMEFTHiggs_slha&);
   ...
   void fill_decays_data(const NMSSMEFTHiggs_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, NMSSMEFTHiggs_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const NMSSMEFTHiggs_slha&);
 ...
 */
template <class... Ts>
void NMSSMEFTHiggs_slha_io::fill(
   ...
   NMSSMEFTHiggs_decays const * const decays)
{
