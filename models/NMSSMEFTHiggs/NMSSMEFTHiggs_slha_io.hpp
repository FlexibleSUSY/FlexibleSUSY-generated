...
public:
   ...
   void set_extra(const NMSSMEFTHiggs_slha&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NMSSMEFTHiggs_scales&, const NMSSMEFTHiggs_observables&);
