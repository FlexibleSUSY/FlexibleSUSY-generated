 ...
 */
double NMSSMEFTHiggs_susy_parameters::calc_beta_Kappa_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NMSSMEFTHiggs_susy_parameters::calc_beta_Kappa_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NMSSMEFTHiggs_susy_parameters::calc_beta_Kappa_3_loop(const Susy_traces& susy_traces) const
{
