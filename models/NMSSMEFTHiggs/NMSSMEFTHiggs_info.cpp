...
namespace NMSSMEFTHiggs_info {
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {
      ...
      "TYu(2,0)", "TYu(2,1)", "TYu(2,2)", "mq2(0,0)", "mq2(0,1)", "mq2(0,2)",
   ...
   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      ...
      "Re(ZN(2,0))", "Im(ZN(2,0))", "Re(ZN(2,1))", "Im(ZN(2,1))", "Re(ZN(2,2))",
      "Im(ZN(2,2))", "Re(ZN(2,3))", "Im(ZN(2,3))", "Re(ZN(2,4))", "Im(ZN(2,4))",
      "Re(ZN(3,0))", "Im(ZN(3,0))", "Re(ZN(3,1))", "Im(ZN(3,1))", "Re(ZN(3,2))",
      "Im(ZN(3,2))", "Re(ZN(3,3))", "Im(ZN(3,3))", "Re(ZN(3,4))", "Im(ZN(3,4))",
      "Re(ZN(4,0))", "Im(ZN(4,0))", "Re(ZN(4,1))", "Im(ZN(4,1))", "Re(ZN(4,2))",
      "Im(ZN(4,2))", "Re(ZN(4,3))", "Im(ZN(4,3))", "Re(ZN(4,4))", "Im(ZN(4,4))",
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS> input_parameter_names
       = {"MSUSY", "M1Input", "M2Input", "M3Input", "MuInput", "TanBeta",
      "LambdaInput", "KappaInput", "ALambdaInput", "AKappaInput", "mq2Input(0,0)",
   ...
   const std::string model_name = "NMSSMEFTHiggs";
