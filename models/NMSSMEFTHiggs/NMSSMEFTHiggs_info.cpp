...
namespace NMSSMEFTHiggs_info {
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS>
      ...
      , "TanBeta", "LambdaInput", "KappaInput", "ALambdaInput", "AKappaInput",
      ...
      "mu2Input(2,1)", "mu2Input(2,2)", "md2Input(0,0)", "md2Input(0,1)",
      "md2Input(0,2)", "md2Input(1,0)", "md2Input(1,1)", "md2Input(1,2)",
      "md2Input(2,0)", "md2Input(2,1)", "md2Input(2,2)", "ml2Input(0,0)",
      ...
      "me2Input(2,2)", "AuInput(0,0)", "AuInput(0,1)", "AuInput(0,2)",
      "AuInput(1,0)", "AuInput(1,1)", "AuInput(1,2)", "AuInput(2,0)",
      "AuInput(2,1)", "AuInput(2,2)", "AdInput(0,0)", "AdInput(0,1)",
      "AdInput(0,2)", "AdInput(1,0)", "AdInput(1,1)", "AdInput(1,2)",
      "AdInput(2,0)", "AdInput(2,1)", "AdInput(2,2)", "AeInput(0,0)",
      "AeInput(0,1)", "AeInput(0,2)", "AeInput(1,0)", "AeInput(1,1)",
