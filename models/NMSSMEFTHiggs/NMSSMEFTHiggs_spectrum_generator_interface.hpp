...
template <class T>
class NMSSMEFTHiggs_spectrum_generator_interface {
public:
   virtual ~NMSSMEFTHiggs_spectrum_generator_interface() = default;
   ...
   void run(const softsusy::QedQcd&, const NMSSMEFTHiggs_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "NMSSMEFTHiggs_spectrum.dat") const;

protected:
   NMSSMEFTHiggs<T> model;
   ...
   void translate_exception_to_problem(NMSSMEFTHiggs<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const NMSSMEFTHiggs_input_parameters&) = 0;
};
 ...
 */
template <class T>
void NMSSMEFTHiggs_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void NMSSMEFTHiggs_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const NMSSMEFTHiggs_input_parameters& input)
{
 ...
 */
template <class T>
void NMSSMEFTHiggs_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   NMSSMEFTHiggs_mass_eigenstates tmp_model(model);
   try {
 ...
 */
template <class T>
void NMSSMEFTHiggs_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   NMSSMEFTHiggs_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void NMSSMEFTHiggs_spectrum_generator_interface<T>::translate_exception_to_problem(NMSSMEFTHiggs<T>& model)
{
   try {
      throw;
