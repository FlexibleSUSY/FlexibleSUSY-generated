...
install-src::
		...
		install -d $(NMSSMEFTHiggs_INSTALL_CXXQFT_DIR)
		...
		install -m u=rw,g=r,o=r $(LIBNMSSMEFTHiggs_CXXQFT_HDR) $(NMSSMEFTHiggs_INSTALL_CXXQFT_DIR)
...
clean-$(MODNAME)-src:
		...
		-rm -f $(LIBNMSSMEFTHiggs_CXXQFT_HDR)
