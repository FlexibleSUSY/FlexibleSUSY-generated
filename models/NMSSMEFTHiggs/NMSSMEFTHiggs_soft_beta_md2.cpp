...
// File generated at Mon 5 Mar 2018 16:25:58
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_md2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_md2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_md2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSMEFTHiggs_soft_parameters::calc_beta_md2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
