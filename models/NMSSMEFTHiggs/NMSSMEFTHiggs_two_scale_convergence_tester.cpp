...
NMSSMEFTHiggs_convergence_tester<Two_scale>::NMSSMEFTHiggs_convergence_tester(
   NMSSMEFTHiggs<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<NMSSMEFTHiggs<Two_scale> >(model, accuracy_goal, sg)
{
}

double NMSSMEFTHiggs_convergence_tester<Two_scale>::max_rel_diff() const
{
   const NMSSMEFTHiggs<Two_scale>& ol = get_last_iteration_model();
   const NMSSMEFTHiggs<Two_scale>& ne = get_current_iteration_model();
