...
/**
 * @file NMSSMEFTHiggs_f_to_f_conversion.cpp
 *
...
namespace NMSSMEFTHiggs_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const NMSSMEFTHiggs_mass_eigenstates& model) {
