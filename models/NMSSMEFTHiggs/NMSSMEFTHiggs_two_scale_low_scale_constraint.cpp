...
// File generated at Wed 16 Oct 2019 19:38:27

#include "NMSSMEFTHiggs_two_scale_low_scale_constraint.hpp"
...
NMSSMEFTHiggs_low_scale_constraint<Two_scale>::NMSSMEFTHiggs_low_scale_constraint(
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
const Eigen::Matrix<std::complex<double>,3,3>& NMSSMEFTHiggs_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& NMSSMEFTHiggs_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double NMSSMEFTHiggs_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double NMSSMEFTHiggs_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<NMSSMEFTHiggs<Two_scale>*>(model_);
}

void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& NMSSMEFTHiggs_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
   check_model_ptr();
...
double NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();

   double theta_w = std::asin(Electroweak_constants::sinThetaW);

   NMSSMEFTHiggs_weinberg_angle::Sm_parameters sm_pars;
   ...
   NMSSMEFTHiggs_weinberg_angle weinberg(MODEL, sm_pars);
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   check_model_ptr();
   ...
   if (IsFinite(new_g1)) {
      model->get_problems().unflag_non_perturbative_parameter(NMSSMEFTHiggs_info::
         g1);
   } else {
...
double NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   check_model_ptr();
...
double NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   check_model_ptr();
...
double NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_running_SM_masses()
{
   check_model_ptr();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_Yu_DRbar()
{
   check_model_ptr();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   check_model_ptr();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::calculate_Ye_DRbar()
{
   check_model_ptr();
...
void NMSSMEFTHiggs_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("NMSSMEFTHiggs_low_scale_constraint<Two_scale>: "
