...
// File generated at Tue 22 Jan 2019 14:38:19

/**
 * @file NMSSMEFTHiggs_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 14:38:19 with FlexibleSUSY
...
double calculate_a_muon_impl(NMSSMEFTHiggs_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const NMSSMEFTHiggs_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("NMSSMEFTHiggs_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double NMSSMEFTHiggs_a_muon::calculate_a_muon(const NMSSMEFTHiggs_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("NMSSMEFTHiggs_a_muon:" << e.what());
...
double NMSSMEFTHiggs_a_muon::calculate_a_muon_uncertainty(const NMSSMEFTHiggs_mass_eigenstates& model_)
{
   NMSSMEFTHiggs_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("NMSSMEFTHiggs_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
