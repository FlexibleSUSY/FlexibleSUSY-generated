...
{
   std::cout <<
      "Usage: run_cmd_line_NMSSMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
int run_solver(const NMSSMEFTHiggs_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(NMSSMEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const NMSSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
