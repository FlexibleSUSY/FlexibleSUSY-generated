...
int run_solver(int loop_library, const NMSSMEFTHiggs_input_parameters& input)
{
...
int run(int solver_type, int loop_library, const NMSSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
