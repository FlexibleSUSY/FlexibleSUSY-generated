...
#ifndef NMSSMEFTHiggs_DECAY_TABLE_H
#define NMSSMEFTHiggs_DECAY_TABLE_H
...
class NMSSMEFTHiggs_decay_table {
private:
...
public:
   ...
   NMSSMEFTHiggs_decay_table();
   ~NMSSMEFTHiggs_decay_table() = default;
   NMSSMEFTHiggs_decay_table(const NMSSMEFTHiggs_decay_table&) = default;
   NMSSMEFTHiggs_decay_table(NMSSMEFTHiggs_decay_table&&) = default;
   NMSSMEFTHiggs_decay_table& operator=(const NMSSMEFTHiggs_decay_table&) = default;
   NMSSMEFTHiggs_decay_table& operator=(NMSSMEFTHiggs_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const NMSSMEFTHiggs_decay_table&);
