...
// File generated at Fri 10 Apr 2020 18:44:25
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassWB_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassWB_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassWB_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassWB_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassWB_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
