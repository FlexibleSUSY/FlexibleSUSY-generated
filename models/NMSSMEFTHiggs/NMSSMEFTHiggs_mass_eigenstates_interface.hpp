...
/**
 * @file NMSSMEFTHiggs_mass_eigenstates_interface.hpp
 *
...
#ifndef NMSSMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
#define NMSSMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class NMSSMEFTHiggs_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class NMSSMEFTHiggs_mass_eigenstates_interface {
public:
   virtual ~NMSSMEFTHiggs_mass_eigenstates_interface() {}

   virtual std::unique_ptr<NMSSMEFTHiggs_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const NMSSMEFTHiggs_input_parameters& get_input_parameters() const = 0;
   virtual NMSSMEFTHiggs_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const NMSSMEFTHiggs_physical& get_physical() const = 0;
   virtual NMSSMEFTHiggs_physical& get_physical() = 0;
   ...
   virtual void set_physical(const NMSSMEFTHiggs_physical&) = 0;
