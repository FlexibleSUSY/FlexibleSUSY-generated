...
NMSSMEFTHiggs_slha::NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_input_parameters& input_,
 ...
 */
NMSSMEFTHiggs_slha::NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : NMSSMEFTHiggs_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void NMSSMEFTHiggs_slha::clear()
{
   NMSSMEFTHiggs_mass_eigenstates::clear();
   physical_slha.clear();
}

void NMSSMEFTHiggs_slha::calculate_spectrum()
{
   NMSSMEFTHiggs_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void NMSSMEFTHiggs_slha::convert_to_slha()
{
...
void NMSSMEFTHiggs_slha::calculate_ckm_matrix()
{
...
void NMSSMEFTHiggs_slha::calculate_pmns_matrix()
{
 ...
 */
void NMSSMEFTHiggs_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void NMSSMEFTHiggs_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void NMSSMEFTHiggs_slha::convert_soft_squared_masses_to_slha()
{
...
const NMSSMEFTHiggs_physical& NMSSMEFTHiggs_slha::get_physical_slha() const
{
   return physical_slha;
}

NMSSMEFTHiggs_physical& NMSSMEFTHiggs_slha::get_physical_slha()
{
   return physical_slha;
}

void NMSSMEFTHiggs_slha::print(std::ostream& ostr) const
{
   NMSSMEFTHiggs_mass_eigenstates::print(ostr);
...
void NMSSMEFTHiggs_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const NMSSMEFTHiggs_slha& model)
{
   model.print(ostr);
   return ostr;
}
