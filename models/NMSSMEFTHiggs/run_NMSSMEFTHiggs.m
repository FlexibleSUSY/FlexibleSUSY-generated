...
handle = FSNMSSMEFTHiggsOpenHandle[
    fsSettings -> {
...
spectrum    = FSNMSSMEFTHiggsCalculateSpectrum[handle];
observables = FSNMSSMEFTHiggsCalculateObservables[handle];
decays      = FSNMSSMEFTHiggsCalculateDecays[handle];
