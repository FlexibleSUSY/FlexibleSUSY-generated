...
#include "NMSSMEFTHiggs_utilities.hpp"
...
// NMSSMEFTHiggs_parameter_getter ////////////////////////////////////////

std::vector<std::string> NMSSMEFTHiggs_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace NMSSMEFTHiggs_info;
...
std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_MIXINGS> NMSSMEFTHiggs_parameter_getter::get_mixing_names()
{
   return NMSSMEFTHiggs_info::particle_mixing_names;
}

Eigen::ArrayXd NMSSMEFTHiggs_parameter_getter::get_parameters(const NMSSMEFTHiggs_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_PARAMETERS> NMSSMEFTHiggs_parameter_getter::get_parameter_names()
{
   return NMSSMEFTHiggs_info::parameter_names;
}

std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_PARTICLES> NMSSMEFTHiggs_parameter_getter::get_particle_names()
{
   return NMSSMEFTHiggs_info::particle_names;
}

std::vector<std::string> NMSSMEFTHiggs_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> NMSSMEFTHiggs_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_MIXINGS> NMSSMEFTHiggs_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_MIXINGS> NMSSMEFTHiggs_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_INPUT_PARAMETERS> NMSSMEFTHiggs_parameter_getter::get_input_parameter_names()
{
   return NMSSMEFTHiggs_info::input_parameter_names;
}

std::array<std::string, NMSSMEFTHiggs_info::NUMBER_OF_EXTRA_PARAMETERS> NMSSMEFTHiggs_parameter_getter::get_extra_parameter_names()
{
   return NMSSMEFTHiggs_info::extra_parameter_names;
}

decltype(NMSSMEFTHiggs_info::NUMBER_OF_MASSES) NMSSMEFTHiggs_parameter_getter::get_number_of_masses()
{
   return NMSSMEFTHiggs_info::NUMBER_OF_MASSES;
}

// NMSSMEFTHiggs_spectrum_plotter ////////////////////////////////////////

NMSSMEFTHiggs_spectrum_plotter::NMSSMEFTHiggs_spectrum_plotter(const NMSSMEFTHiggs_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void NMSSMEFTHiggs_spectrum_plotter::extract_spectrum(const NMSSMEFTHiggs_mass_eigenstates& model)
{
   spectrum.clear();
...
void NMSSMEFTHiggs_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("NMSSMEFTHiggs_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("NMSSMEFTHiggs_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("NMSSMEFTHiggs_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void NMSSMEFTHiggs_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("NMSSMEFTHiggs_spectrum_plotter::write_spectrum: "
...
namespace NMSSMEFTHiggs_database {
 ...
 */
void to_database(
   const std::string& file_name, const NMSSMEFTHiggs_mass_eigenstates& model,
   ...
   const NMSSMEFTHiggs_observables* observables)
{
   ...
   append(names, NMSSMEFTHiggs_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, NMSSMEFTHiggs_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, NMSSMEFTHiggs_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, NMSSMEFTHiggs_parameter_getter::get_DRbar_mass_names());
   append(names, NMSSMEFTHiggs_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, NMSSMEFTHiggs_parameter_getter::get_pole_mass_names());
   append(names, NMSSMEFTHiggs_parameter_getter::get_pole_mixing_names());
   ...
   if (NMSSMEFTHiggs_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, NMSSMEFTHiggs_observables::get_names());
 ...
 */
NMSSMEFTHiggs_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, NMSSMEFTHiggs_observables* observables)
{
   NMSSMEFTHiggs_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = NMSSMEFTHiggs_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = NMSSMEFTHiggs_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = NMSSMEFTHiggs_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = NMSSMEFTHiggs_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? NMSSMEFTHiggs_observables::NUMBER_OF_OBSERVABLES : 0);
