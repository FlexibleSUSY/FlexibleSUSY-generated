...
/**
 * @file NMSSMEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef NMSSMEFTHiggs_MASS_EIGENSTATES_H
#define NMSSMEFTHiggs_MASS_EIGENSTATES_H
 ...
 */
class NMSSMEFTHiggs_mass_eigenstates
   : public NMSSMEFTHiggs_soft_parameters
   , public NMSSMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit NMSSMEFTHiggs_mass_eigenstates(const NMSSMEFTHiggs_input_parameters& input_ = NMSSMEFTHiggs_input_parameters());
   NMSSMEFTHiggs_mass_eigenstates(const NMSSMEFTHiggs_mass_eigenstates&) = default;
   NMSSMEFTHiggs_mass_eigenstates(NMSSMEFTHiggs_mass_eigenstates&&) = default;
   virtual ~NMSSMEFTHiggs_mass_eigenstates() = default;
   NMSSMEFTHiggs_mass_eigenstates& operator=(const NMSSMEFTHiggs_mass_eigenstates&) = default;
   NMSSMEFTHiggs_mass_eigenstates& operator=(NMSSMEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<NMSSMEFTHiggs_ewsb_solver_interface>&);
   ...
   double get_lsp(NMSSMEFTHiggs_info::Particles&) const;
...
private:
   ...
   mutable Problems problems{NMSSMEFTHiggs_info::model_name,
   ...
   std::shared_ptr<NMSSMEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const NMSSMEFTHiggs_mass_eigenstates&);
