 ...
 */
class NMSSMEFTHiggs_mass_eigenstates : public NMSSMEFTHiggs_soft_parameters {
public:
   ...
   void set_physical(const NMSSMEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const NMSSMEFTHiggs_physical& get_physical() const;
   NMSSMEFTHiggs_physical& get_physical();
