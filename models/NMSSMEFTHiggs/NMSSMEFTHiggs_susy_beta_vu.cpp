...
double NMSSMEFTHiggs_susy_parameters::calc_beta_vu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vu = Re(-0.005*vu*(-600*traceYdAdjYuYuAdjYd - 1800*traceYuAdjYuYuAdjYu
      - 600*traceYdAdjYd*AbsSqr(Lambdax) - 200*traceYeAdjYe*AbsSqr(Lambdax) -
      400*AbsSqr(Kappa)*AbsSqr(Lambdax) + 207*Quad(g1) + 275*Quad(g2) + 340*
 ...
 */
double NMSSMEFTHiggs_susy_parameters::calc_beta_vu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
