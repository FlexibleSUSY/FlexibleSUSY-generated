...
// File generated at Tue 10 Oct 2017 20:39:46

/**
 * @file NMSSMEFTHiggs_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Tue 10 Oct 2017 20:39:46 with FlexibleSUSY
...
#define CLASSNAME NMSSMEFTHiggs_mass_eigenstates
...
CLASSNAME::NMSSMEFTHiggs_mass_eigenstates(const NMSSMEFTHiggs_input_parameters& input_)
   : NMSSMEFTHiggs_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new NMSSMEFTHiggs_ewsb_solver<Two_scale>())
#endif
{
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<NMSSMEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("NMSSMEFTHiggs_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("NMSSMEFTHiggs_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("NMSSMEFTHiggs_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving NMSSMEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   NMSSMEFTHiggs_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(NMSSMEFTHiggs_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = NMSSMEFTHiggs_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NMSSMEFTHiggs_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Sd, eigenvalue_error >
      precision * Abs(MSd(0)));
#else
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Sv, eigenvalue_error >
      precision * Abs(MSv(0)));
#else
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Su, eigenvalue_error >
      precision * Abs(MSu(0)));
#else
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Se, eigenvalue_error >
      precision * Abs(MSe(0)));
#else
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Hpm, eigenvalue_error >
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(NMSSMEFTHiggs_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
double CLASSNAME::get_ewsb_eq_hh_1() const
{
   double result = Re(mHd2*vd - 0.35355339059327373*vS*vu*Conj(TLambdax) +
      0.075*Cube(vd)*Sqr(g1) + 0.125*Cube(vd)*Sqr(g2) + 0.5*vd*AbsSqr(Lambdax)*Sqr
...
double CLASSNAME::get_ewsb_eq_hh_2() const
{
   double result = Re(mHu2*vu - 0.35355339059327373*vd*vS*Conj(TLambdax) +
      0.075*Cube(vu)*Sqr(g1) + 0.125*Cube(vu)*Sqr(g2) + 0.5*vu*AbsSqr(Lambdax)*Sqr
...
double CLASSNAME::get_ewsb_eq_hh_3() const
{
   double result = Re(ms2*vS - 0.35355339059327373*vd*vu*Conj(TLambdax) +
      AbsSqr(Kappa)*Cube(vS) - 0.5*vd*vS*vu*Conj(Lambdax)*Kappa - 0.5*vd*vS*vu*
      Conj(Kappa)*Lambdax + 0.5*vS*AbsSqr(Lambdax)*Sqr(vd) + 0.35355339059327373*
      Conj(TKappa)*Sqr(vS) + 0.5*vS*AbsSqr(Lambdax)*Sqr(vu) + 0.35355339059327373*
      Sqr(vS)*TKappa - 0.35355339059327373*vd*vu*TLambdax);
...
std::complex<double> CLASSNAME::CpAhAhUSdconjUSd(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(
      ...
      ,Conj(Yd(j1,gO2))*KroneckerDelta(gO1,3 + j1))*ZA(gI1,2)*ZA(gI2,1),0) + IF(
      gO2 < 3,-0.5*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*KroneckerDelta(gO1,3 + j1))
      *ZA(gI1,1)*ZA(gI2,2),0) + 0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
...
std::complex<double> CLASSNAME::CpAhSdconjUSd(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0.,
      ...
      Conj(Yd(j1,gO2))*Conj(ZD(gI1,3 + j1)))*ZA(gI2,1),0) + IF(gO2 < 3,
      std::complex<double>(0,0.5)*vu*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(
      gI1,3 + j1)))*ZA(gI2,2),0) - std::complex<double>(0.,0.7071067811865475)*SUM
      (j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYd(j1,j2)))*
      ZA(gI2,0) - std::complex<double>(0,0.5)*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)))*ZA(gI2,1) -
      std::complex<double>(0,0.5)*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM
      (j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)))*ZA(gI2,2);
...
std::complex<double> CLASSNAME::CpAhSuconjUSu(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vS*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZA(gI2,0),0) +
      IF(gO2 < 3,std::complex<double>(0.,0.7071067811865475)*SUM(j1,0,2,Conj(ZU(
      gI1,3 + j1))*Conj(TYu(j1,gO2)))*ZA(gI2,1),0) + IF(gO2 < 3,std::complex<
      double>(0,0.5)*vd*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*
      ZA(gI2,2),0) - std::complex<double>(0,0.5)*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(
      ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)))*ZA(gI2,0) -
      std::complex<double>(0.,0.7071067811865475)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(
      j1,0,2,KroneckerDelta(gO2,3 + j1)*TYu(j1,j2)))*ZA(gI2,1) - std::complex<
      double>(0,0.5)*vd*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)))*ZA(gI2,2);
...
std::complex<double> CLASSNAME::CphhSuconjUSu(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZU(gI1,gO2))*Sqr
      ...
      0) + IF(gO2 < 3,0.5*vS*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 +
      j1)))*ZH(gI2,0),0) + IF(gO2 < 3,-0.05*vu*Conj(ZU(gI1,gO2))*Sqr(g1)*ZH(gI2,1)
      ,0) + IF(gO2 < 3,0.25*vu*Conj(ZU(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3
      ,-0.7071067811865475*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(TYu(j1,gO2)))*ZH(
      gI2,1),0) + IF(gO2 < 3,-(vu*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,Conj(Yu(
      j1,gO2))*Yu(j1,j2)))*ZH(gI2,1)),0) + IF(gO2 < 3,0.5*vd*Lambdax*SUM(j1,0,2,
      Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZH(gI2,2),0) - 0.2*vd*Sqr(g1)*SUM(j1,
      0,2,Conj(ZU(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZH(gI2,0) + 0.5*vS*Conj
...
std::complex<double> CLASSNAME::CpAhAhUSeconjUSe(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(
      ...
      ,Conj(Ye(j1,gO2))*KroneckerDelta(gO1,3 + j1))*ZA(gI1,2)*ZA(gI2,1),0) + IF(
      gO2 < 3,-0.5*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*KroneckerDelta(gO1,3 + j1))
      *ZA(gI1,1)*ZA(gI2,2),0) + 0.3*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      KroneckerDelta(gO2,3 + j1))*ZA(gI1,0)*ZA(gI2,0) - SUM(j3,0,2,KroneckerDelta(
      gO1,3 + j3)*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Ye(j3,j1))
...
std::complex<double> CLASSNAME::CpAhSeconjUSe(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0.,
      ...
      gI2,0),0) + IF(gO2 < 3,std::complex<double>(0,0.5)*vS*Lambdax*SUM(j1,0,2,
      Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 + j1)))*ZA(gI2,1),0) + IF(gO2 < 3,
      std::complex<double>(0,0.5)*vu*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(
      gI1,3 + j1)))*ZA(gI2,2),0) - std::complex<double>(0.,0.7071067811865475)*SUM
      (j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYe(j1,j2)))*
      ZA(gI2,0) - std::complex<double>(0,0.5)*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZA(gI2,1) -
      std::complex<double>(0,0.5)*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM
      (j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZA(gI2,2);
...
std::complex<double> CLASSNAME::CphhSeconjUSe(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2))*
      ...
      Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3,0.5*vS*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))
...
std::complex<double> CLASSNAME::CpAhAhUhhUhh(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      ...
      Lambdax)*(-(KroneckerDelta(0,gO2)*ZA(gI1,2)*ZA(gI2,2)) + KroneckerDelta(2,
      gO2)*(ZA(gI1,2)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,2)))) + KroneckerDelta(0,gO1)*(
...
std::complex<double> CLASSNAME::CphhhhUhhUhh(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*(-(
      ...
      *AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(gI1,0)*ZH(gI2,0) - 3*(3*Sqr(g1)
      ...
      + KroneckerDelta(0,gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(
      gI1,1)*ZH(gI2,0) + (-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(gI1,0)*
      ZH(gI2,1) + 10*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*ZH(gI1,2)*ZH(gI2,
      2)) + 10*KroneckerDelta(2,gO2)*(Conj(Kappa)*Lambdax*(ZH(gI1,2)*ZH(gI2,0) +
      ZH(gI1,0)*ZH(gI2,2)) + Conj(Lambdax)*(ZH(gI1,2)*(Kappa*ZH(gI2,0) - 2*Lambdax
      *ZH(gI2,1)) + (Kappa*ZH(gI1,0) - 2*Lambdax*ZH(gI1,1))*ZH(gI2,2)))) - 10*
      ...
      gI2,1) - 12*Kappa*ZH(gI1,2)*ZH(gI2,2)) + Lambdax*(KroneckerDelta(1,gO2)*(ZH(
      gI1,2)*ZH(gI2,0) + ZH(gI1,0)*ZH(gI2,2)) + KroneckerDelta(0,gO2)*(ZH(gI1,2)*
      ZH(gI2,1) + ZH(gI1,1)*ZH(gI2,2))))));
...
std::complex<double> CLASSNAME::CpAhAhUhh(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO2)*(
      ...
      *ZA(gI2,2) - 10*vd*Conj(Lambdax)*Kappa*ZA(gI1,2)*ZA(gI2,2) - 10*vd*Conj(
      Kappa)*Lambdax*ZA(gI1,2)*ZA(gI2,2) + ZA(gI1,0)*(vu*(-20*AbsSqr(Lambdax) + 3*
      Sqr(g1) + 5*Sqr(g2))*ZA(gI2,0) + 5*(2*vS*Conj(Lambdax)*Kappa + 2*vS*Conj(
      Kappa)*Lambdax - 1.4142135623730951*(Conj(TLambdax) + TLambdax))*ZA(gI2,2)))
      - 5*KroneckerDelta(2,gO2)*(1.4142135623730951*(Conj(TLambdax)*(ZA(gI1,1)*ZA
      (gI2,0) + ZA(gI1,0)*ZA(gI2,1)) + TLambdax*(ZA(gI1,1)*ZA(gI2,0) + ZA(gI1,0)*
      ZA(gI2,1)) - 2*(Conj(TKappa) + TKappa)*ZA(gI1,2)*ZA(gI2,2)) + 2*Conj(Lambdax
      )*(-(Kappa*ZA(gI1,2)*(vu*ZA(gI2,0) + vd*ZA(gI2,1))) + ZA(gI1,1)*(vS*Kappa*ZA
      (gI2,0) + 2*vS*Lambdax*ZA(gI2,1) - vd*Kappa*ZA(gI2,2)) + ZA(gI1,0)*(2*vS*
      Lambdax*ZA(gI2,0) + vS*Kappa*ZA(gI2,1) - vu*Kappa*ZA(gI2,2))) - 2*Conj(Kappa
      )*(Lambdax*ZA(gI1,0)*(-(vS*ZA(gI2,1)) + vu*ZA(gI2,2)) + ZA(gI1,2)*(vu*
      Lambdax*ZA(gI2,0) + vd*Lambdax*ZA(gI2,1) - 4*vS*Kappa*ZA(gI2,2)) + ZA(gI1,1)
      *(-(vS*Lambdax*ZA(gI2,0)) + vd*Lambdax*ZA(gI2,2)))) - KroneckerDelta(0,gO2)*
      (vd*(3*Sqr(g1) + 5*Sqr(g2))*ZA(gI1,0)*ZA(gI2,0) + ZA(gI1,1)*(vd*(20*AbsSqr(
      Lambdax) - 3*Sqr(g1) - 5*Sqr(g2))*ZA(gI2,1) + 5*(-2*vS*Conj(Lambdax)*Kappa -
      2*vS*Conj(Kappa)*Lambdax + 1.4142135623730951*(Conj(TLambdax) + TLambdax))*
      ZA(gI2,2)) + 5*ZA(gI1,2)*(1.4142135623730951*(Conj(TLambdax) + TLambdax)*ZA(
      gI2,1) + Conj(Kappa)*(-2*vS*Lambdax*ZA(gI2,1) + 2*vu*Lambdax*ZA(gI2,2)) +
      Conj(Lambdax)*(-2*vS*Kappa*ZA(gI2,1) + 2*(vu*Kappa + 2*vd*Lambdax)*ZA(gI2,2)
      ))));
...
std::complex<double> CLASSNAME::CpAhhhUhh(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(-2*Conj(
      Lambdax)*Kappa*(-(KroneckerDelta(1,gO2)*(-(vS*ZA(gI2,0)*ZH(gI1,2)) + ZA(gI2,
      2)*(vS*ZH(gI1,0) + vd*ZH(gI1,2)))) + KroneckerDelta(2,gO2)*(-(ZA(gI2,2)*(vu*
      ZH(gI1,0) + vd*ZH(gI1,1))) + ZA(gI2,1)*(vS*ZH(gI1,0) + vd*ZH(gI1,2)) + ZA(
      gI2,0)*(vS*ZH(gI1,1) + vu*ZH(gI1,2))) - KroneckerDelta(0,gO2)*(-(vS*ZA(gI2,1
      )*ZH(gI1,2)) + ZA(gI2,2)*(vS*ZH(gI1,1) + vu*ZH(gI1,2)))) + 2*Conj(Kappa)*
      Lambdax*(-(KroneckerDelta(1,gO2)*(-(vS*ZA(gI2,0)*ZH(gI1,2)) + ZA(gI2,2)*(vS*
      ZH(gI1,0) + vd*ZH(gI1,2)))) + KroneckerDelta(2,gO2)*(-(ZA(gI2,2)*(vu*ZH(gI1,
      0) + vd*ZH(gI1,1))) + ZA(gI2,1)*(vS*ZH(gI1,0) + vd*ZH(gI1,2)) + ZA(gI2,0)*(
      vS*ZH(gI1,1) + vu*ZH(gI1,2))) - KroneckerDelta(0,gO2)*(-(vS*ZA(gI2,1)*ZH(gI1
      ,2)) + ZA(gI2,2)*(vS*ZH(gI1,1) + vu*ZH(gI1,2)))) + 1.4142135623730951*(
      KroneckerDelta(2,gO2)*(TLambdax*(ZA(gI2,1)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,1))
      + 2*(Conj(TKappa) - TKappa)*ZA(gI2,2)*ZH(gI1,2)) + TLambdax*(KroneckerDelta(
      1,gO2)*(ZA(gI2,2)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,2)) + KroneckerDelta(0,gO2)*(
      ZA(gI2,2)*ZH(gI1,1) + ZA(gI2,1)*ZH(gI1,2))) - Conj(TLambdax)*(KroneckerDelta
      (2,gO2)*(ZA(gI2,1)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,1)) + KroneckerDelta(1,gO2)*
      (ZA(gI2,2)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,2)) + KroneckerDelta(0,gO2)*(ZA(gI2,
      2)*ZH(gI1,1) + ZA(gI2,1)*ZH(gI1,2)))));
...
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO2)*(-(ZH(gI1,0)
      *(3*vd*(3*Sqr(g1) + 5*Sqr(g2))*ZH(gI2,0) + vu*(20*AbsSqr(Lambdax) - 3*Sqr(g1
...
std::complex<double> CLASSNAME::CpUhhSdconjSd(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*(10*vu*KroneckerDelta(2,gO2)*(Conj(
      ...
      3 + j1)) - 5*vS*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,
      j2)*ZD(gI1,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD
      (gI2,3 + j1)))*ZD(gI1,j2))))) + KroneckerDelta(0,gO2)*(vd*(Sqr(g1) + 5*Sqr(
      g2))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) + 2*(vd*Sqr(g1)*SUM(j1,0,2,Conj
      (ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) - 5*(1.4142135623730951*SUM(j2,0,2,Conj(ZD(
...
std::complex<double> CLASSNAME::CpAhAhUAhUAh(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*(-(
      ...
      *AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZA(gI1,0)*ZA(gI2,0) - 3*(3*Sqr(g1)
      ...
      + KroneckerDelta(0,gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZA(
      gI1,1)*ZA(gI2,0) + (-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZA(gI1,0)*
      ZA(gI2,1) + 10*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*ZA(gI1,2)*ZA(gI2,
      2)) + 10*KroneckerDelta(2,gO2)*(Conj(Kappa)*Lambdax*(ZA(gI1,2)*ZA(gI2,0) +
      ZA(gI1,0)*ZA(gI2,2)) + Conj(Lambdax)*(ZA(gI1,2)*(Kappa*ZA(gI2,0) - 2*Lambdax
      *ZA(gI2,1)) + (Kappa*ZA(gI1,0) - 2*Lambdax*ZA(gI1,1))*ZA(gI2,2)))) - 10*
      ...
      gI2,1) - 12*Kappa*ZA(gI1,2)*ZA(gI2,2)) + Lambdax*(KroneckerDelta(1,gO2)*(ZA(
      gI1,2)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,2)) + KroneckerDelta(0,gO2)*(ZA(gI1,2)*
      ZA(gI2,1) + ZA(gI1,1)*ZA(gI2,2))))));
...
std::complex<double> CLASSNAME::CpUAhUAhhhhh(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      ...
      Lambdax)*(-(KroneckerDelta(0,gO2)*ZH(gI1,2)*ZH(gI2,2)) + KroneckerDelta(2,
      gO2)*(ZH(gI1,2)*ZH(gI2,0) + ZH(gI1,0)*ZH(gI2,2)))) + KroneckerDelta(0,gO1)*(
...
std::complex<double> CLASSNAME::CpAhAhUAh(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(-2*Conj(
      ...
      *ZA(gI2,1) - vu*ZA(gI2,2))) - KroneckerDelta(2,gO2)*(ZA(gI1,2)*(vu*ZA(gI2,0)
      ...
      (vS*ZA(gI2,1)) + vu*ZA(gI2,2)))) + 1.4142135623730951*(-(KroneckerDelta(2,
      gO2)*(TLambdax*(ZA(gI1,1)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,1)) + 2*(Conj(TKappa)
      - TKappa)*ZA(gI1,2)*ZA(gI2,2))) - TLambdax*(KroneckerDelta(1,gO2)*(ZA(gI1,2
      )*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,2)) + KroneckerDelta(0,gO2)*(ZA(gI1,2)*ZA(gI2
      ,1) + ZA(gI1,1)*ZA(gI2,2))) + Conj(TLambdax)*(KroneckerDelta(2,gO2)*(ZA(gI1,
      1)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,1)) + KroneckerDelta(1,gO2)*(ZA(gI1,2)*ZA(
      gI2,0) + ZA(gI1,0)*ZA(gI2,2)) + KroneckerDelta(0,gO2)*(ZA(gI1,2)*ZA(gI2,1) +
      ZA(gI1,1)*ZA(gI2,2)))));
...
std::complex<double> CLASSNAME::CpAhUAhhh(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.05*(5*KroneckerDelta(2,gO2)*(
      -1.4142135623730951*(Conj(TLambdax)*(ZA(gI2,1)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,
      1)) + TLambdax*(ZA(gI2,1)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,1)) - 2*(Conj(TKappa)
      + TKappa)*ZA(gI2,2)*ZH(gI1,2)) + 2*Conj(Lambdax)*(-(ZA(gI2,2)*((vu*Kappa +
      2*vd*Lambdax)*ZH(gI1,0) + (vd*Kappa + 2*vu*Lambdax)*ZH(gI1,1))) + Kappa*ZA(
...
{
   const std::complex<double> result = 0.05*(-(KroneckerDelta(1,gO2)*(10*ZH(gI2
      ,2)*(2*vS*Conj(Kappa)*Lambdax*ZP(gI1,0) + 1.4142135623730951*TLambdax*ZP(gI1
      ,0) + 2*vS*AbsSqr(Lambdax)*ZP(gI1,1)) + ZH(gI2,0)*(5*vu*(-2*AbsSqr(Lambdax)
...
std::complex<double> CLASSNAME::CpAhAhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      ...
      g1) + 5*Sqr(g2))*ZA(gI1,1)*ZA(gI2,1) - 20*AbsSqr(Lambdax)*ZA(gI1,2)*ZA(gI2,2
      )) + 5*KroneckerDelta(0,gO2)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gI1,1)*ZA(
      gI2,0) + (-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gI1,0)*ZA(gI2,1) + 4*Conj(Lambdax
      )*Kappa*ZA(gI1,2)*ZA(gI2,2))) - KroneckerDelta(0,gO1)*(KroneckerDelta(0,gO2)
      *((3*Sqr(g1) + 5*Sqr(g2))*ZA(gI1,0)*ZA(gI2,0) + (-3*Sqr(g1) + 5*Sqr(g2))*ZA(
      gI1,1)*ZA(gI2,1) + 20*AbsSqr(Lambdax)*ZA(gI1,2)*ZA(gI2,2)) - 5*
      KroneckerDelta(1,gO2)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gI1,1)*ZA(gI2,0) +
      (-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gI1,0)*ZA(gI2,1) + 4*Conj(Kappa)*Lambdax*
      ZA(gI1,2)*ZA(gI2,2))));
...
std::complex<double> CLASSNAME::CphhhhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      ...
      g1) + 5*Sqr(g2))*ZH(gI1,1)*ZH(gI2,1) - 20*AbsSqr(Lambdax)*ZH(gI1,2)*ZH(gI2,2
      )) - 5*KroneckerDelta(0,gO2)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZH(gI1,1)*ZH(
      gI2,0) + (-2*AbsSqr(Lambdax) + Sqr(g2))*ZH(gI1,0)*ZH(gI2,1) + 4*Conj(Lambdax
      )*Kappa*ZH(gI1,2)*ZH(gI2,2))) - KroneckerDelta(0,gO1)*(KroneckerDelta(0,gO2)
      *((3*Sqr(g1) + 5*Sqr(g2))*ZH(gI1,0)*ZH(gI2,0) + (-3*Sqr(g1) + 5*Sqr(g2))*ZH(
      gI1,1)*ZH(gI2,1) + 20*AbsSqr(Lambdax)*ZH(gI1,2)*ZH(gI2,2)) + 5*
      KroneckerDelta(1,gO2)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZH(gI1,1)*ZH(gI2,0) +
      (-2*AbsSqr(Lambdax) + Sqr(g2))*ZH(gI1,0)*ZH(gI2,1) + 4*Conj(Kappa)*Lambdax*
      ZH(gI1,2)*ZH(gI2,2))));
...
{
   const std::complex<double> result = 0.1*(-5*g2*Conj(ZN(gI2,1))*
      KroneckerDelta(2,gO2)*ZH(gI1,0) + 7.0710678118654755*Conj(ZN(gI2,4))*
      KroneckerDelta(3,gO2)*Lambdax*ZH(gI1,0) + 7.0710678118654755*Conj(ZN(gI2,3))
      *KroneckerDelta(4,gO2)*Lambdax*ZH(gI1,0) - 3.872983346207417*g1*Conj(ZN(gI2,
      ...
      7.0710678118654755*Conj(ZN(gI2,4))*KroneckerDelta(2,gO2)*Lambdax*ZH(gI1,1) +
      3.872983346207417*g1*Conj(ZN(gI2,0))*(KroneckerDelta(2,gO2)*ZH(gI1,0) -
      KroneckerDelta(3,gO2)*ZH(gI1,1)) - 14.142135623730951*Conj(ZN(gI2,4))*
      KroneckerDelta(4,gO2)*Kappa*ZH(gI1,2) + 7.0710678118654755*Conj(ZN(gI2,3))*
      ...
      *g1*KroneckerDelta(0,gO2)*ZH(gI1,0) - 5*g2*KroneckerDelta(1,gO2)*ZH(gI1,0) +
      7.0710678118654755*Lambdax*(KroneckerDelta(4,gO2)*ZH(gI1,1) +
...
{
   const std::complex<double> result = 0.1*(3.872983346207417*g1*KroneckerDelta
      (0,gO1)*ZH(gI1,0)*ZN(gI2,2) - 5*g2*KroneckerDelta(1,gO1)*ZH(gI1,0)*ZN(gI2,2)
      + 7.0710678118654755*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZH(gI1,1)*ZN(gI2,2
      ) + 7.0710678118654755*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZH(gI1,0)*ZN(gI2,
      3) - 3.872983346207417*g1*KroneckerDelta(0,gO1)*ZH(gI1,1)*ZN(gI2,3) + 5*g2*
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(5*g2*Conj(
      ZN(gI1,1))*KroneckerDelta(2,gO2)*ZA(gI2,0) + 7.0710678118654755*Conj(ZN(gI1,
      4))*KroneckerDelta(3,gO2)*Lambdax*ZA(gI2,0) + 7.0710678118654755*Conj(ZN(gI1
      ,3))*KroneckerDelta(4,gO2)*Lambdax*ZA(gI2,0) + 3.872983346207417*g1*Conj(ZN(
      ...
      *ZA(gI2,1) + 7.0710678118654755*Conj(ZN(gI1,4))*KroneckerDelta(2,gO2)*
      Lambdax*ZA(gI2,1) + 3.872983346207417*g1*Conj(ZN(gI1,0))*(-(KroneckerDelta(2
      ,gO2)*ZA(gI2,0)) + KroneckerDelta(3,gO2)*ZA(gI2,1)) - 14.142135623730951*
      Conj(ZN(gI1,4))*KroneckerDelta(4,gO2)*Kappa*ZA(gI2,2) + 7.0710678118654755*
      Conj(ZN(gI1,3))*KroneckerDelta(2,gO2)*Lambdax*ZA(gI2,2) + Conj(ZN(gI1,2))*(
      -3.872983346207417*g1*KroneckerDelta(0,gO2)*ZA(gI2,0) + 5*(g2*KroneckerDelta
      (1,gO2)*ZA(gI2,0) + 1.4142135623730951*Lambdax*(KroneckerDelta(4,gO2)*ZA(gI2
      ,1) + KroneckerDelta(3,gO2)*ZA(gI2,2)))));
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VG)
         ;
}
...
void CLASSNAME::calculate_MGlu_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Glu);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Glu
         );
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fv)
         ;
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VP)
         ;
}
...
void CLASSNAME::calculate_MVZ_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VZ)
         ;
}
...
void CLASSNAME::calculate_MSd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZD;
            ...
            problems.flag_bad_mass(NMSSMEFTHiggs_info::Sd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Sd);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Sd)
         ;
}
...
void CLASSNAME::calculate_MSv_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZV;
            ...
            problems.flag_bad_mass(NMSSMEFTHiggs_info::Sv,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZV);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Sv);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Sv)
         ;
}
...
void CLASSNAME::calculate_MSu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZU;
            ...
            problems.flag_bad_mass(NMSSMEFTHiggs_info::Su,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZU);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Su);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Su)
         ;
}
...
void CLASSNAME::calculate_MSe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZE;
            ...
            problems.flag_bad_mass(NMSSMEFTHiggs_info::Se,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZE);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Se);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Se)
         ;
}
...
void CLASSNAME::calculate_Mhh_pole()
{
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(NMSSMEFTHiggs_info::hh)
                  ;
            }
         }
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::hh)
         ;
}
...
void CLASSNAME::calculate_MAh_pole()
{
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(NMSSMEFTHiggs_info::Ah)
                  ;
            }
         }
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Ah)
         ;
}
...
void CLASSNAME::calculate_MHpm_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(NMSSMEFTHiggs_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Hpm
         );
}
...
void CLASSNAME::calculate_MChi_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 5; ++es) {
         ...
         decltype(ZN) mix_ZN;
            ...
            problems.flag_bad_mass(NMSSMEFTHiggs_info::Chi,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZN);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Chi);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Chi
         );
}
...
void CLASSNAME::calculate_MCha_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP,
            eigenvalue_error);
         problems.flag_bad_mass(NMSSMEFTHiggs_info::Cha,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Cha);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Cha
         );
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER,
            eigenvalue_error);
         problems.flag_bad_mass(NMSSMEFTHiggs_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fe)
         ;
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR,
            eigenvalue_error);
         problems.flag_bad_mass(NMSSMEFTHiggs_info::Fd,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fd)
         ;
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR,
            eigenvalue_error);
         problems.flag_bad_mass(NMSSMEFTHiggs_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::Fu)
         ;
}
...
void CLASSNAME::calculate_MVWm_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VWm);
   else
      problems.unflag_no_pole_mass_convergence(NMSSMEFTHiggs_info::VWm
         );
}
...
std::ostream& operator<<(std::ostream& ostr, const NMSSMEFTHiggs_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
