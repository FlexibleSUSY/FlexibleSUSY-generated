...
/**
 * @file NMSSMEFTHiggs_FFV_form_factors.cpp
 *
...
std::valarray<std::complex<double>> calculate_Fe_Fe_VP_form_factors (
   ...
   val += std::complex<double> {1., 0.} * FFV_FFS<Fe,Fe,VP,Cha,Cha,Sv>::value(indices1, indices2, context, discard_SM_contributions);
