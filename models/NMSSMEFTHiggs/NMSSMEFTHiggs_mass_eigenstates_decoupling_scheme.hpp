...
/**
 * @file NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef NMSSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define NMSSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "NMSSMEFTHiggs_info.hpp"
#include "NMSSMEFTHiggs_physical.hpp"
#include "NMSSMEFTHiggs_soft_parameters.hpp"
#include "NMSSMEFTHiggs_mass_eigenstates_interface.hpp"
...
#define SUPER(p) NMSSMEFTHiggs_soft_parameters::p
...
/**
 * @class NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme
   : private NMSSMEFTHiggs_soft_parameters
   , public NMSSMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const NMSSMEFTHiggs_input_parameters& input_ = NMSSMEFTHiggs_input_parameters());
   explicit NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const NMSSMEFTHiggs_mass_eigenstates&);
   NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme(NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme() = default;
   NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(const NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<NMSSMEFTHiggs_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const NMSSMEFTHiggs_mass_eigenstates&);
   ...
   const NMSSMEFTHiggs_input_parameters& get_input_parameters() const override;
   NMSSMEFTHiggs_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const NMSSMEFTHiggs_physical& get_physical() const override;
   NMSSMEFTHiggs_physical& get_physical() override;
   ...
   void set_physical(const NMSSMEFTHiggs_physical&) override;
...
private:
   ...
   NMSSMEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{NMSSMEFTHiggs_info::model_name,
                     &NMSSMEFTHiggs_info::particle_names_getter,
                     &NMSSMEFTHiggs_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const NMSSMEFTHiggs_mass_eigenstates_decoupling_scheme&);
