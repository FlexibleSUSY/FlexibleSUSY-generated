...
class NMSSMEFTHiggs_slha : public NMSSMEFTHiggs_mass_eigenstates {
public:
   explicit NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_input_parameters& input_ = NMSSMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_mass_eigenstates&, bool do_convert_masses_to_slha = true);
