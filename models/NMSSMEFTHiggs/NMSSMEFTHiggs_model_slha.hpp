...
class NMSSMEFTHiggs_slha : public Model {
public:
   explicit NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_input_parameters& input_ = NMSSMEFTHiggs_input_parameters());
   explicit NMSSMEFTHiggs_slha(const Model&, bool do_convert_masses_to_slha = true);
   NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_slha&) = default;
   NMSSMEFTHiggs_slha(NMSSMEFTHiggs_slha&&) = default;
   virtual ~NMSSMEFTHiggs_slha() = default;
   NMSSMEFTHiggs_slha& operator=(const NMSSMEFTHiggs_slha&) = default;
   NMSSMEFTHiggs_slha& operator=(NMSSMEFTHiggs_slha&&) = default;
   ...
   const NMSSMEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   NMSSMEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   NMSSMEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
NMSSMEFTHiggs_slha<Model>::NMSSMEFTHiggs_slha(const NMSSMEFTHiggs_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
NMSSMEFTHiggs_slha<Model>::NMSSMEFTHiggs_slha(const Model& model_,
...
template <class Model>
void NMSSMEFTHiggs_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void NMSSMEFTHiggs_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void NMSSMEFTHiggs_slha<Model>::convert_to_slha()
{
...
template <class Model>
void NMSSMEFTHiggs_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void NMSSMEFTHiggs_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void NMSSMEFTHiggs_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void NMSSMEFTHiggs_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void NMSSMEFTHiggs_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const NMSSMEFTHiggs_physical& NMSSMEFTHiggs_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
NMSSMEFTHiggs_physical& NMSSMEFTHiggs_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void NMSSMEFTHiggs_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void NMSSMEFTHiggs_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const NMSSMEFTHiggs_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
