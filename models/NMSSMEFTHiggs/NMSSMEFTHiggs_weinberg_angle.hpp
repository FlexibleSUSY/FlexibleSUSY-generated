...
#ifndef NMSSMEFTHiggs_WEINBERG_ANGLE_H
#define NMSSMEFTHiggs_WEINBERG_ANGLE_H
...
/**
 * @class NMSSMEFTHiggs_weinberg_angle
...
public:
   ...
   NMSSMEFTHiggs_weinberg_angle(const NMSSMEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NMSSMEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NMSSMEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
