...
// File generated at Tue 10 Oct 2017 20:24:47
...
const int NMSSMEFTHiggs_soft_parameters::numberOfParameters;

NMSSMEFTHiggs_soft_parameters::NMSSMEFTHiggs_soft_parameters(const NMSSMEFTHiggs_input_parameters& input_)
   : NMSSMEFTHiggs_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

NMSSMEFTHiggs_soft_parameters::NMSSMEFTHiggs_soft_parameters(
   const NMSSMEFTHiggs_susy_parameters& susy_model
   ...
   : NMSSMEFTHiggs_susy_parameters(susy_model)
...
Eigen::ArrayXd NMSSMEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

NMSSMEFTHiggs_soft_parameters NMSSMEFTHiggs_soft_parameters::calc_beta(int loops) const
{
   ...
   const NMSSMEFTHiggs_susy_parameters susy_betas(NMSSMEFTHiggs_susy_parameters::calc_beta(loops));

   return NMSSMEFTHiggs_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TLambdax, beta_TKappa, beta_TYu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_MassB, beta_MassWB, beta_MassG);
}

NMSSMEFTHiggs_soft_parameters NMSSMEFTHiggs_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void NMSSMEFTHiggs_soft_parameters::clear()
{
   NMSSMEFTHiggs_susy_parameters::clear();
...
Eigen::ArrayXd NMSSMEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(NMSSMEFTHiggs_susy_parameters::get());
...
void NMSSMEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   NMSSMEFTHiggs_susy_parameters::print(ostr);
...
void NMSSMEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   NMSSMEFTHiggs_susy_parameters::set(pars);
...
NMSSMEFTHiggs_soft_parameters::Soft_traces NMSSMEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const NMSSMEFTHiggs_soft_parameters& soft_pars)
{
