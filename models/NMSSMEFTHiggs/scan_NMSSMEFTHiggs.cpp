...
{
   std::cout <<
      "Usage: scan_NMSSMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
struct NMSSMEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
NMSSMEFTHiggs_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   NMSSMEFTHiggs_input_parameters& input)
{
   ...
   NMSSMEFTHiggs_scan_result result;
...
void scan(int solver_type, NMSSMEFTHiggs_input_parameters& input,
