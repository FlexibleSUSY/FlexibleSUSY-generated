...
Eigen::ArrayXd NMSSMEFTHiggs_input_parameters::get() const
{
...
void NMSSMEFTHiggs_input_parameters::set(const Eigen::ArrayXd& pars)
{
   MSUSY = pars(0);
   M1Input = pars(1);
   M2Input = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const NMSSMEFTHiggs_input_parameters& input)
{
