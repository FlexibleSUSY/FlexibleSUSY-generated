...
/**
 * @file cxx_qft/NMSSMEFTHiggs_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.0 and SARAH 4.14.5 .
 */

#ifndef NMSSMEFTHiggs_CXXQFT_CONTEXT_BASE_H
#define NMSSMEFTHiggs_CXXQFT_CONTEXT_BASE_H
...
namespace NMSSMEFTHiggs_cxx_diagrams {
   ...
   struct context_base {
      NMSSMEFTHiggs_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(NMSSMEFTHiggs_mass_eigenstates_interface const& m) : model(m) {}
      context_base(NMSSMEFTHiggs_mass_eigenstates_interface const* const m) : model(*m) {}
