...
// File generated at Wed 16 Oct 2019 19:36:32
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassG_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassG_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSMEFTHiggs_soft_parameters::calc_beta_MassG_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
