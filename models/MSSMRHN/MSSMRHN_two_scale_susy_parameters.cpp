...
// File generated at Mon 23 Feb 2015 13:39:22
...
MSSMRHN_susy_parameters::MSSMRHN_susy_parameters(const MSSMRHN_input_parameters& input_)
   ...
   )), Yu(Eigen::Matrix<double,3,3>::Zero()), Yv(Eigen::Matrix<double,3,3>
   ::Zero()), Mu(0), Mv(Eigen::Matrix<double,3,3>::Zero()), g1(0), g2(0), g3(0)
   , vd(0), vu(0)
...
MSSMRHN_susy_parameters MSSMRHN_susy_parameters::calc_beta() const
{
   ...
   Eigen::Matrix<double,3,3> beta_Mv(calc_beta_Mv_one_loop(TRACE_STRUCT));
   ...
   if (get_loops() > 1) {
      ...
      beta_Mv += calc_beta_Mv_two_loop(TRACE_STRUCT);
...
Eigen::Matrix<double,3,3> CLASSNAME::get_SqSq() const
{
   ...
   if (get_loops() > 1) {
      anomDim += twoLoop*(0.8*Sqr(g1)*(Yu.adjoint()*Yu) - 2*(
         ...
         Power(g1,4) + 3.75*Power(g2,4) - 0.8888888888888888*Power(g3,4) + 8*
         Sqr(g2)*Sqr(g3) + 0.011111111111111112*Sqr(g1)*(9*Sqr(g2) + 16*Sqr(g3)
         ))*UNITMATRIX(3));
   }
...
Eigen::Matrix<double,3,3> CLASSNAME::get_SlSl() const
{
   ...
   anomDim = oneOver16PiSqr*(Ye.adjoint()*Ye + Yv.adjoint()*Yv - 0.3*(Sqr
      (g1) + 5*Sqr(g2))*UNITMATRIX(3));
   ...
   if (get_loops() > 1) {
      anomDim += twoLoop*(-2*(Ye.adjoint()*Ye*Ye.adjoint()*Ye) - 2*(
         ...
         .trace() + 0.03*(69*Power(g1,4) + 125*Power(g2,4) + 30*Sqr(g1)*Sqr(g2)
         )*UNITMATRIX(3));
   }
...
double CLASSNAME::get_SHuSHu() const
{
   ...
   anomDim = oneOver16PiSqr*(-0.3*(Sqr(g1) + 5*Sqr(g2)) + 3*(Yu*
      Yu.adjoint()).trace() + (Yv*Yv.adjoint()).trace());

   if (get_loops() > 1) {
      anomDim += twoLoop*(2.07*Power(g1,4) + 3.75*Power(g2,4) + 0.9*
         Sqr(g1)*Sqr(g2) + 0.8*(Sqr(g1) + 20*Sqr(g3))*(Yu*Yu.adjoint()).trace()
         - 3*(Yd*Yu.adjoint()*Yu*Yd.adjoint()).trace() - (Ye*Yv.adjoint()*Yv*
...
Eigen::Matrix<double,3,3> CLASSNAME::get_SuRSuR() const
{
   ...
   if (get_loops() > 1) {
      anomDim += twoLoop*(-0.4*(5*(Yu.conjugate()*Yd.transpose()*
         ...
         .trace())) + 0.035555555555555556*(107*Power(g1,4) - 25*Power(g3,4) +
         80*Sqr(g1)*Sqr(g3))*UNITMATRIX(3));
   }
...
Eigen::Matrix<double,3,3> CLASSNAME::get_SvRSvR() const
{
   ...
   anomDim = 2*oneOver16PiSqr*(Yv.conjugate()*Yv.transpose());
...
const Eigen::ArrayXd MSSMRHN_susy_parameters::get() const
{
...
void MSSMRHN_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   ...
   TRACE_STRUCT.traceYeAdjYeYeAdjYe = (Ye*Ye.adjoint()*Ye*Ye.adjoint()).trace()
      ;
   TRACE_STRUCT.traceYeAdjYvYvAdjYe = (Ye*Yv.adjoint()*Yv*Ye.adjoint()).trace()
      ;
   TRACE_STRUCT.traceYuAdjYu = (Yu*Yu.adjoint()).trace();
   TRACE_STRUCT.traceYvAdjYv = (Yv*Yv.adjoint()).trace();
   TRACE_STRUCT.traceYuAdjYuYuAdjYu = (Yu*Yu.adjoint()*Yu*Yu.adjoint()).trace()
      ;
   TRACE_STRUCT.traceYvAdjYvYvAdjYv = (Yv*Yv.adjoint()*Yv*Yv.adjoint()).trace()
      ;
