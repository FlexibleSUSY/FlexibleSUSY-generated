...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMRHN.x [options]\n"
      "Options:\n"
      "  --m0=<value>\n"
      "  --m12=<value>\n"
      "  --TanBeta=<value>\n"
...
int run_solver(int loop_library, const MSSMRHN_input_parameters& input)
{
   ...
   MSSMRHN_decays decays;if (settings.get(Spectrum_generator_settings::calculate_sm_masses)) {
...
int run(int solver_type, int loop_library, const MSSMRHN_input_parameters& input)
{
   int exit_code = 0;
