...
int run_solver(const MSSMRHN_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMRHN_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMRHN_input_parameters& input)
{
   int exit_code = 0;
