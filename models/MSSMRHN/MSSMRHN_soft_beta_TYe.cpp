...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_TYe_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYe = (0.2*(30*traceAdjYdTYd*Ye + 10*traceAdjYeTYe*Ye + 18*MassB*Ye*Sqr
      ...
      9*Sqr(g1)*TYe - 15*Sqr(g2)*TYe) + 4*(Ye*Ye.adjoint()*TYe) + 2*(Ye*Yv.
      adjoint()*TYv) + 5*(TYe*Ye.adjoint()*Ye) + TYe*Yv.adjoint()*Yv).real();
...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_TYe_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYe = (0.1*(-360*traceYdAdjYdTYdAdjYd*Ye - 60*traceYdAdjYuTYuAdjYd*Ye -
      120*traceYeAdjYeTYeAdjYe*Ye - 20*traceYeAdjYvTYvAdjYe*Ye - 60*
      traceYuAdjYdTYdAdjYu*Ye - 20*traceYvAdjYeTYeAdjYv*Ye - 540*MassB*Ye*Quad(
      g1) - 300*MassWB*Ye*Quad(g2) - 8*traceAdjYdTYd*Ye*Sqr(g1) + 24*
      ...
      traceYeAdjYeYeAdjYe*TYe - 10*traceYeAdjYvYvAdjYe*TYe + 135*Quad(g1)*TYe +
      75*Quad(g2)*TYe - 4*traceYdAdjYd*Sqr(g1)*TYe + 12*traceYeAdjYe*Sqr(g1)*
      TYe + 18*Sqr(g1)*Sqr(g2)*TYe + 160*traceYdAdjYd*Sqr(g3)*TYe) - 6*(3*
      ...
      - 2*(3*traceYuAdjYu + traceYvAdjYv)*(Ye*Yv.adjoint()*TYv) + 0.2*(-75*
      traceYdAdjYd - 25*traceYeAdjYe - 6*Sqr(g1) + 60*Sqr(g2))*(TYe*Ye.adjoint(
 ...
 */
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_TYe_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
