...
#ifndef MSSMRHN_WEINBERG_ANGLE_H
#define MSSMRHN_WEINBERG_ANGLE_H
...
public:
   ...
   MSSMRHN_weinberg_angle(const MSSMRHN_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMRHN_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMRHN_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
