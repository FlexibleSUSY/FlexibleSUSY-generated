...
#ifndef MSSMRHN_TWO_SCALE_susy_parameters_H
#define MSSMRHN_TWO_SCALE_susy_parameters_H
...
public:
   ...
   MSSMRHN_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const MSSMRHN_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   virtual ~MSSMRHN_susy_parameters() {}
   ...
   MSSMRHN_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
   ...
   void set_Mv(int i, int k, double value) { Mv(i,k) = value; }
...
private:
   ...
   Eigen::Matrix<double,3,3> calc_beta_Mv_one_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Mv_two_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Mv_three_loop(const TRACE_STRUCT_TYPE&) const;
