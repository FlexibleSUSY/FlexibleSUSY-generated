...
MSSMRHN_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   MSSMRHN_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, MSSMRHN_input_parameters& input,
