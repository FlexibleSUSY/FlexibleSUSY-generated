...
double MSSMRHN_susy_parameters::calc_beta_vu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vu = Re(0.1*oneOver16PiSqr*vu*(-30*traceYuAdjYu - 10*traceYvAdjYv + 3*
      Sqr(g1) + 15*Sqr(g2)));
...
double MSSMRHN_susy_parameters::calc_beta_vu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vu = Re(-0.005*twoLoop*vu*(-600*traceYdAdjYuYuAdjYd - 200*
      traceYeAdjYvYvAdjYe - 1800*traceYuAdjYuYuAdjYu - 600*traceYvAdjYvYvAdjYv
      + 207*Quad(g1) + 275*Quad(g2) + 340*traceYuAdjYu*Sqr(g1) + 60*
      traceYvAdjYv*Sqr(g1) + 900*traceYuAdjYu*Sqr(g2) + 300*traceYvAdjYv*Sqr(g2
      ) + 90*Sqr(g1)*Sqr(g2) + 3200*traceYuAdjYu*Sqr(g3)));
 ...
 */
double MSSMRHN_susy_parameters::calc_beta_vu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
