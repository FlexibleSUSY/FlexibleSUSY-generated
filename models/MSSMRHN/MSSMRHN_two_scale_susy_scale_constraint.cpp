...
void MSSMRHN_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<MSSMRHN<Two_scale>*>(model_);
}

void MSSMRHN_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MSSMRHN_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
...
void MSSMRHN_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MSSMRHN_susy_scale_constraint<Two_scale>: "
