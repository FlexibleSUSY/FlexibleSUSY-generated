...
// File generated at Mon 5 Mar 2018 18:46:23
...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_mu2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mu2 = (twoLoop*(-0.8*(15*traceconjTYuTpTYu + 5*traceconjTYvTpTYv
      ...
      *(Yu*Yd.adjoint()*TYd*(TYu).adjoint()) - 8*mHu2*(Yu*Yu.adjoint()*Yu*
      ...
      *(mu2*Yu*Yu.adjoint()*Yu*Yu.adjoint()) - 4*(Yu*mq2*Yd.adjoint()*Yd*
      ...
      Yu.adjoint()*Yu*Yu.adjoint()*mu2) + 0.07111111111111111*(2*Conj(MassB)*
      Sqr(g1)*(321*MassB*Sqr(g1) + 40*(2*MassB + MassG)*Sqr(g3)) + 5*(
      -11.618950038622252*g1*Tr31 + 30*Tr23*Quad(g3) + 6*Tr2U111*Sqr(g1) + 8*
