...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_mu2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mu2 = (twoLoop*(-12*traceconjTYuTpTYu*(Yu*Yu.adjoint()) - 4*
      traceconjTYvTpTYv*(Yu*Yu.adjoint()) - 4*traceml2AdjYvYv*(Yu*Yu.adjoint())
      - 12*tracemq2AdjYuYu*(Yu*Yu.adjoint()) - 12*tracemu2YuAdjYu*(Yu*
      Yu.adjoint()) - 4*tracemv2YvAdjYv*(Yu*Yu.adjoint()) - 24*mHu2*
      traceYuAdjYu*(Yu*Yu.adjoint()) - 8*mHu2*traceYvAdjYv*(Yu*Yu.adjoint()) -
      0.8*mHu2*Sqr(g1)*(Yu*Yu.adjoint()) + 12*mHu2*Sqr(g2)*(Yu*Yu.adjoint()) +
      24*AbsSqr(MassWB)*Sqr(g2)*(Yu*Yu.adjoint()) - 12*traceAdjYuTYu*(Yu*(TYu)
      .adjoint()) - 4*traceAdjYvTYv*(Yu*(TYu).adjoint()) + 0.8*MassB*Sqr(g1)*(
      Yu*(TYu).adjoint()) - 12*MassWB*Sqr(g2)*(Yu*(TYu).adjoint()) - 12*
      traceconjTYuTpYu*(TYu*Yu.adjoint()) - 4*traceconjTYvTpYv*(TYu*Yu.adjoint(
      )) - 12*Conj(MassWB)*Sqr(g2)*(TYu*Yu.adjoint()) - 12*traceYuAdjYu*(TYu*(
      TYu).adjoint()) - 4*traceYvAdjYv*(TYu*(TYu).adjoint()) - 0.8*Sqr(g1)*(TYu
      *(TYu).adjoint()) + 12*Sqr(g2)*(TYu*(TYu).adjoint()) - 6*traceYuAdjYu*(
      mu2*Yu*Yu.adjoint()) - 2*traceYvAdjYv*(mu2*Yu*Yu.adjoint()) - 0.4*Sqr(g1)
      *(mu2*Yu*Yu.adjoint()) + 6*Sqr(g2)*(mu2*Yu*Yu.adjoint()) - 12*
      traceYuAdjYu*(Yu*mq2*Yu.adjoint()) - 4*traceYvAdjYv*(Yu*mq2*Yu.adjoint())
      - 0.8*Sqr(g1)*(Yu*mq2*Yu.adjoint()) + 12*Sqr(g2)*(Yu*mq2*Yu.adjoint()) -
      6*traceYuAdjYu*(Yu*Yu.adjoint()*mu2) - 2*traceYvAdjYv*(Yu*Yu.adjoint()*
      mu2) - 0.4*Sqr(g1)*(Yu*Yu.adjoint()*mu2) + 6*Sqr(g2)*(Yu*Yu.adjoint()*mu2
      ) - 4*mHd2*(Yu*Yd.adjoint()*Yd*Yu.adjoint()) - 4*mHu2*(Yu*Yd.adjoint()*Yd
      *Yu.adjoint()) - 4*(Yu*Yd.adjoint()*TYd*(TYu).adjoint()) - 8*mHu2*(Yu*
      ...
      Yu*Yu.adjoint()) + TYu*Yu.adjoint()) + 8*(321*MassB*Sqr(g1) + 40*(2*MassB
