...
#define MSSMRHN_MASS_EIGENSTATES_H
 ...
 */
class MSSMRHN_mass_eigenstates : public MSSMRHN_soft_parameters {
public:
   explicit MSSMRHN_mass_eigenstates(const MSSMRHN_input_parameters& input_ = MSSMRHN_input_parameters());
   virtual ~MSSMRHN_mass_eigenstates();
   ...
   const MSSMRHN_physical& get_physical() const;
   MSSMRHN_physical& get_physical();
   const Problems<MSSMRHN_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<MSSMRHN_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   const std::complex<double>& get_UV(int i, int k) const { return UV(i,k); }
   ...
   void calculate_MChi();
   Eigen::Matrix<double,6,6> get_mass_matrix_Fv() const;
   void calculate_MFv();
   ...
   std::complex<double> CpconjUSeconjSvHpm(unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpconjUSeFvChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpconjUSvconjSeHpm(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjUSvconjSvAh(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjUSvconjSvhh(unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpconjUSvFvChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUhhSvSv(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUhhFvFvPR(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUhhFvFvPL(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUAhSvSv(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUAhFvFvPR(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUAhFvFvPL(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpconjUHpmFvFePR(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjUHpmFvFePL(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpconjUHpmSvSe(unsigned gO2, unsigned gI1, unsigned gI2) const;
   ...
   double CpVGVGconjSdSd(unsigned gI1, unsigned gI2) const;
   double CpVGVGconjSuSu(unsigned gI1, unsigned gI2) const;
   double CpVGconjSdSd(unsigned gI1, unsigned gI2) const;
   double CpVGconjSuSu(unsigned gI1, unsigned gI2) const;
   double CpVGGluGluPL(unsigned , unsigned ) const;
   double CpVGGluGluPR(unsigned , unsigned ) const;
   ...
   std::complex<double> CpVPVPconjHpmHpm(unsigned gI1, unsigned gI2) const;
   double CpVPconjHpmHpm(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPbarChaChaPL(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPbarChaChaPR(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpVPVPconjSdSd(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPVPconjSeSe(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPVPconjSuSu(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPconjSdSd(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPconjSeSe(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPconjSuSu(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVPconjVWmHpm(unsigned gI2) const;
   ...
   std::complex<double> CpVZconjSvSv(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVZFvFvPL(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpVZFvFvPR(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpVWmconjVWmconjSvSv(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjVWmFvFePL(unsigned gI1, unsigned gI2) const;
   double CpconjVWmFvFePR(unsigned , unsigned ) const;
   ...
   std::complex<double> CpUChibarChaHpmPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarChaHpmPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUChibarChaVWmPR(unsigned gO2, unsigned gI1) const;
   std::complex<double> CpUChibarChaVWmPL(unsigned gO1, unsigned gI1) const;
   std::complex<double> CpUChibarFdSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarFdSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarFeSePL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarFeSePR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarFuSuPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarFuSuPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUChiconjSvFvPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChiSvFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChiSvFvPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUFvconjHpmFePL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvconjHpmFePR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvbarChaSePL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvbarChaSePR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvhhFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvhhFvPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvbarFeHpmPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvbarFeHpmPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvbarFeVWmPR(unsigned gO2, unsigned gI1) const;
   double CpUFvbarFeVWmPL(unsigned , unsigned ) const;
   std::complex<double> CpUFvconjSeChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvconjSeChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvFvAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvFvAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvconjSvChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvconjSvChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvSvChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUFvSvChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   double CpUFvconjVWmFePR(unsigned , unsigned ) const;
   std::complex<double> CpUFvconjVWmFePL(unsigned gO1, unsigned gI2) const;
   std::complex<double> CpUFvVZFvPR(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpUFvVZFvPL(unsigned gO1, unsigned gI2) const;
   ...
   std::complex<double> CpbarUChaSeFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpbarUChaSeFvPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpbarUFeHpmFvPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpbarUFeVWmFvPL(unsigned gO1, unsigned gI2) const;
   ...
   std::complex<double> CpGlubarFdSdPL(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpGlubarFdSdPR(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpGlubarFuSuPL(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpGlubarFuSuPR(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpbarFeHpmFvPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
...
private:
   ...
   MSSMRHN_physical physical; ///< contains the pole masses and mixings
   Problems<MSSMRHN_info::NUMBER_OF_PARTICLES> problems;
   ...
   Eigen::Matrix<std::complex<double>,6,6> UV;
...
std::ostream& operator<<(std::ostream&, const MSSMRHN_mass_eigenstates&);
