...
#include "MSSMRHN_mass_eigenstates_interface.hpp"
...
#define SUPER(p) MSSMRHN_soft_parameters::p
 ...
 */
class MSSMRHN_mass_eigenstates
   : public MSSMRHN_soft_parameters
   , public MSSMRHN_mass_eigenstates_interface
{
public:
   explicit MSSMRHN_mass_eigenstates(const MSSMRHN_input_parameters& input_ = MSSMRHN_input_parameters());
   MSSMRHN_mass_eigenstates(const MSSMRHN_mass_eigenstates&) = default;
   MSSMRHN_mass_eigenstates(MSSMRHN_mass_eigenstates&&) = default;
   virtual ~MSSMRHN_mass_eigenstates() = default;
   MSSMRHN_mass_eigenstates& operator=(const MSSMRHN_mass_eigenstates&) = default;
   MSSMRHN_mass_eigenstates& operator=(MSSMRHN_mass_eigenstates&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSMRHN_mass_eigenstates_interface> clone() const override;
   ...
   void set_ewsb_solver(const std::shared_ptr<MSSMRHN_ewsb_solver_interface>&);
   ...
   const MSSMRHN_input_parameters& get_input_parameters() const override;
   MSSMRHN_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSMRHN_physical& get_physical() const override;
   MSSMRHN_physical& get_physical() override;
   ...
   void set_physical(const MSSMRHN_physical&) override;
   ...
   const Eigen::Matrix<double,3,3>& get_Mv() const override { return SUPER(Mv); }
   double get_Mv(int i, int k) const override { return SUPER(Mv(i,k)); }
   ...
   const Eigen::Matrix<double,3,3>& get_BMv() const override { return SUPER(BMv); }
   double get_BMv(int i, int k) const override { return SUPER(BMv(i,k)); }
   ...
   const Eigen::Matrix<double,3,3>& get_mv2() const override { return SUPER(mv2); }
   double get_mv2(int i, int k) const override { return SUPER(mv2(i,k)); }
   ...
   void set_Mv(const Eigen::Matrix<double,3,3>& Mv_) override { Mv = Mv_; }
   void set_Mv(int i, int k, const double& value) override { Mv(i,k) = value; }
   ...
   void set_BMv(const Eigen::Matrix<double,3,3>& BMv_) override { BMv = BMv_; }
   void set_BMv(int i, int k, const double& value) override { BMv(i,k) = value; }
   ...
   void set_mv2(const Eigen::Matrix<double,3,3>& mv2_) override { mv2 = mv2_; }
   void set_mv2(int i, int k, const double& value) override { mv2(i,k) = value; }
   ...
   const Eigen::Array<double,6,1>& get_MFv() const override { return MFv; }
   ...
   const Eigen::Matrix<std::complex<double>,6,6>& get_UV() const override { return UV; }
   std::complex<double> get_UV(int i, int k) const override { return UV(i,k); }
   ...
   Eigen::Matrix<double,6,6> get_mass_matrix_Fv() const override;
   ...
   std::complex<double> CpHpmconjUSeconjSv(int gI2, int gO2, int gI1) const;
   std::complex<double> CpHpmSvconjUSe(int gI2, int gI1, int gO2) const;
   std::complex<double> CpFvChaconjUSePR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpFvChaconjUSePL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpAhconjSvconjUSv(int gI2, int gI1, int gO2) const;
   std::complex<double> CpAhSvconjUSv(int gI2, int gI1, int gO2) const;
   std::complex<double> CphhconjSvconjUSv(int gI2, int gI1, int gO2) const;
   std::complex<double> CphhSvconjUSv(int gI2, int gI1, int gO2) const;
   std::complex<double> CpHpmconjSeconjUSv(int gI2, int gI1, int gO2) const;
   std::complex<double> CpChiFvconjUSvPR(int gI2, int gI1, int gO2) const;
   ...
   std::complex<double> CpUhhSvSv(int gO2, int gI1, int gI2) const;
   std::complex<double> CpUhhSvconjSv(int gO2, int gI2, int gI1) const;
   std::complex<double> CpFvFvUhhPR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpFvFvUhhPL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpUAhSvSv(int gO2, int gI1, int gI2) const;
   std::complex<double> CpUAhSvconjSv(int gO2, int gI2, int gI1) const;
   std::complex<double> CpFvFvUAhPR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpFvFvUAhPL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpFvFeconjUHpmPR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpFvFeconjUHpmPL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpSeSvconjUHpm(int gI2, int gI1, int gO2) const;
   ...
   std::complex<double> CpSvconjSvVZ(int gI2, int gI1) const;
   std::complex<double> CpFvFvVZPL(int gI1, int gI2) const;
   std::complex<double> CpFvFvVZPR(int gI1, int gI2) const;
   ...
   std::complex<double> CpSvconjSvconjVWmVWm(int gI1, int gI2) const;
   std::complex<double> CpFvFeconjVWmPL(int gI1, int gI2) const;
   double CpFvFeconjVWmPR(int , int ) const;
   ...
   std::complex<double> CpUChiFvconjSvPR(int gO1, int gI2, int gI1) const;
   std::complex<double> CpUChiFvSvPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpUChiFvSvPR(int gO1, int gI2, int gI1) const;
   ...
   std::complex<double> CpUFvFeconjHpmPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpUFvFeconjHpmPR(int gO1, int gI2, int gI1) const;
   std::complex<double> CpbarChaUFvSePL(int gI1, int gO2, int gI2) const;
   std::complex<double> CpbarChaUFvSePR(int gI1, int gO1, int gI2) const;
   std::complex<double> CpFvUFvhhPL(int gI2, int gO2, int gI1) const;
   std::complex<double> CpFvUFvhhPR(int gI2, int gO1, int gI1) const;
   std::complex<double> CpbarFeUFvHpmPL(int gI1, int gO2, int gI2) const;
   std::complex<double> CpbarFeUFvHpmPR(int gI1, int gO1, int gI2) const;
   std::complex<double> CpbarFeUFvVWmPL(int gI1, int gO2) const;
   double CpbarFeUFvVWmPR(int , int ) const;
   std::complex<double> CpFvUFvAhPL(int gI1, int gO2, int gI2) const;
   std::complex<double> CpFvUFvAhPR(int gI1, int gO1, int gI2) const;
   std::complex<double> CpUFvChaconjSePL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpUFvChaconjSePR(int gO1, int gI2, int gI1) const;
   std::complex<double> CpChiUFvconjSvPL(int gI2, int gO2, int gI1) const;
   std::complex<double> CpChiUFvconjSvPR(int gI2, int gO1, int gI1) const;
   std::complex<double> CpChiUFvSvPL(int gI2, int gO2, int gI1) const;
   std::complex<double> CpChiUFvSvPR(int gI2, int gO1, int gI1) const;
   double CpUFvFeconjVWmPR(int , int ) const;
   std::complex<double> CpUFvFeconjVWmPL(int gO1, int gI2) const;
   std::complex<double> CpFvUFvVZPL(int gI2, int gO2) const;
   std::complex<double> CpFvUFvVZPR(int gI2, int gO1) const;
   ...
   std::complex<double> CpbarUChaFvSePL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpbarUChaFvSePR(int gO1, int gI2, int gI1) const;
   ...
   std::complex<double> CpbarUFeFvHpmPR(int gO1, int gI2, int gI1) const;
   ...
   std::complex<double> CpbarUFeFvVWmPL(int gO1, int gI2) const;
   ...
   std::complex<double> CpbarFeFvHpmPR(int gO1, int gI2, int gI1) const;
   ...
   Eigen::Matrix<std::complex<double>,6,6> self_energy_Sv_1loop(double p) const;
...
private:
   ...
   mutable Problems problems{MSSMRHN_info::model_name,
                             &MSSMRHN_info::particle_names_getter,
                             &MSSMRHN_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSMRHN_ewsb_solver_interface> ewsb_solver{};
