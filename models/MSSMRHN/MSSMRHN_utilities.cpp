...
MSSMRHN_spectrum_plotter::MSSMRHN_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> MSSMRHN_spectrum_plotter::to_valarray(double v)
{
   ...
   const MSSMRHN_observables* observables)
{
   ...
   append(names, MSSMRHN_parameter_getter().get_mass_names());
   append(names, MSSMRHN_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, MSSMRHN_observables* observables)
{
   ...
   const std::size_t number_of_masses = MSSMRHN_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = MSSMRHN_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = MSSMRHN_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? MSSMRHN_observables::NUMBER_OF_OBSERVABLES : 0u);
