...
#define CLASSNAME MSSMRHN_weinberg_angle
 ...
 */
CLASSNAME::MSSMRHN_weinberg_angle(
...
void CLASSNAME::set_model(const MSSMRHN_mass_eigenstates* model_)
{
   model = model_;
}
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * MSSMRHN_info::normalization_g3 /
