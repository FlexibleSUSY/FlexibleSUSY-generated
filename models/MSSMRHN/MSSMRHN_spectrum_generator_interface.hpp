...
public:
   MSSMRHN_spectrum_generator_interface()
      : model()
      , settings()
   ...
   virtual void run(const softsusy::QedQcd&, const MSSMRHN_input_parameters&) = 0;
 ...
 */
template <class T>
void MSSMRHN_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
