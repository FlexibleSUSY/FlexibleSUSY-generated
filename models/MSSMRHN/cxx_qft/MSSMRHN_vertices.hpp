...
template<> struct VertexData<fields::Fe, fields::Fv, typename conj<fields::Hpm>::type>
{
   using vertex_type = ChiralVertex;
};
...
template<> inline
Vertex<fields::Fe, fields::Fv, typename conj<fields::Hpm>::type>::vertex_type
Vertex<fields::Fe, fields::Fv, typename conj<fields::Hpm>::type>::evaluate(const indices_type& indices, const context_base& context)
{
   const int gt2 = indices[0];
   const int gt1 = indices[1];
   const int gt3 = indices[2];
