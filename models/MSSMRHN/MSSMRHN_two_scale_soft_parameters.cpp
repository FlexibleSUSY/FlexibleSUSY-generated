...
// File generated at Mon 23 Feb 2015 13:39:35
...
void MSSMRHN_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   ...
   TRACE_STRUCT.traceYeAdjYeTYeAdjYe = (Ye*Ye.adjoint()*TYe*Ye.adjoint()).trace
      ();
   TRACE_STRUCT.traceYeAdjYvTYvAdjYe = (Ye*Yv.adjoint()*TYv*Ye.adjoint()).trace
      ();
   TRACE_STRUCT.traceYuAdjYdTYdAdjYu = (Yu*Yd.adjoint()*TYd*Yu.adjoint()).trace
      ();
   TRACE_STRUCT.traceYvAdjYeTYeAdjYv = (Yv*Ye.adjoint()*TYe*Yv.adjoint()).trace
      ();
   TRACE_STRUCT.traceAdjYuTYu = (Yu.adjoint()*TYu).trace();
   TRACE_STRUCT.traceAdjYvTYv = (Yv.adjoint()*TYv).trace();
   ...
   TRACE_STRUCT.traceYuAdjYuTYuAdjYu = (Yu*Yu.adjoint()*TYu*Yu.adjoint()).trace
      ();
   TRACE_STRUCT.traceYvAdjYvTYvAdjYv = (Yv*Yv.adjoint()*TYv*Yv.adjoint()).trace
      ();
   ...
   TRACE_STRUCT.traceconjTYuTpTYu = (TYu.conjugate()*(TYu).transpose()).trace()
      ;
   TRACE_STRUCT.traceconjTYvTpTYv = (TYv.conjugate()*(TYv).transpose()).trace()
      ;
   TRACE_STRUCT.traceml2AdjYvYv = (ml2*Yv.adjoint()*Yv).trace();
   TRACE_STRUCT.tracemq2AdjYuYu = (mq2*Yu.adjoint()*Yu).trace();
   TRACE_STRUCT.tracemu2YuAdjYu = (mu2*Yu*Yu.adjoint()).trace();
   TRACE_STRUCT.tracemv2YvAdjYv = (mv2*Yv*Yv.adjoint()).trace();
   TRACE_STRUCT.traceconjTYuTpYu = (TYu.conjugate()*Yu.transpose()).trace();
   TRACE_STRUCT.traceconjTYvTpYv = (TYv.conjugate()*Yv.transpose()).trace();
   ...
   TRACE_STRUCT.traceYeAdjYeTYeAdjTYe = (Ye*Ye.adjoint()*TYe*(TYe).adjoint())
      .trace();
   TRACE_STRUCT.traceYeAdjYvTYvAdjTYe = (Ye*Yv.adjoint()*TYv*(TYe).adjoint())
      .trace();
   TRACE_STRUCT.traceYeAdjTYeTYeAdjYe = (Ye*(TYe).adjoint()*TYe*Ye.adjoint())
      .trace();
   TRACE_STRUCT.traceYeAdjTYvTYvAdjYe = (Ye*(TYv).adjoint()*TYv*Ye.adjoint())
      .trace();
   ...
   TRACE_STRUCT.traceYuAdjTYdTYdAdjYu = (Yu*(TYd).adjoint()*TYd*Yu.adjoint())
      .trace();
   TRACE_STRUCT.traceYvAdjYeTYeAdjTYv = (Yv*Ye.adjoint()*TYe*(TYv).adjoint())
      .trace();
   TRACE_STRUCT.traceYvAdjTYeTYeAdjYv = (Yv*(TYe).adjoint()*TYe*Yv.adjoint())
      .trace();
   ...
   TRACE_STRUCT.traceme2YeAdjYeYeAdjYe = (me2*Ye*Ye.adjoint()*Ye*Ye.adjoint())
      .trace();
   TRACE_STRUCT.traceme2YeAdjYvYvAdjYe = (me2*Ye*Yv.adjoint()*Yv*Ye.adjoint())
      .trace();
   TRACE_STRUCT.traceml2AdjYeYeAdjYeYe = (ml2*Ye.adjoint()*Ye*Ye.adjoint()*Ye)
      .trace();
   TRACE_STRUCT.traceml2AdjYeYeAdjYvYv = (ml2*Ye.adjoint()*Ye*Yv.adjoint()*Yv)
      .trace();
   TRACE_STRUCT.traceml2AdjYvYvAdjYeYe = (ml2*Yv.adjoint()*Yv*Ye.adjoint()*Ye)
      .trace();
   ...
   TRACE_STRUCT.tracemu2YuAdjYdYdAdjYu = (mu2*Yu*Yd.adjoint()*Yd*Yu.adjoint())
      .trace();
   TRACE_STRUCT.tracemv2YvAdjYeYeAdjYv = (mv2*Yv*Ye.adjoint()*Ye*Yv.adjoint())
      .trace();
   ...
   TRACE_STRUCT.traceYuAdjTYuTYuAdjYu = (Yu*(TYu).adjoint()*TYu*Yu.adjoint())
      .trace();
   TRACE_STRUCT.traceYvAdjYvTYvAdjTYv = (Yv*Yv.adjoint()*TYv*(TYv).adjoint())
      .trace();
   TRACE_STRUCT.traceYvAdjTYvTYvAdjYv = (Yv*(TYv).adjoint()*TYv*Yv.adjoint())
      .trace();
   TRACE_STRUCT.traceml2AdjYvYvAdjYvYv = (ml2*Yv.adjoint()*Yv*Yv.adjoint()*Yv)
      .trace();
   ...
   TRACE_STRUCT.tracemu2YuAdjYuYuAdjYu = (mu2*Yu*Yu.adjoint()*Yu*Yu.adjoint())
      .trace();
   TRACE_STRUCT.tracemv2YvAdjYvYvAdjYv = (mv2*Yv*Yv.adjoint()*Yv*Yv.adjoint())
      .trace();
