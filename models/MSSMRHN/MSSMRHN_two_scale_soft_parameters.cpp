...
// File generated at Sat 27 Aug 2016 12:55:20
...
MSSMRHN_soft_parameters MSSMRHN_soft_parameters::calc_beta() const
{
   ...
   if (get_loops() > 0) {
      ...
      beta_BMv += calc_beta_BMv_one_loop(TRACE_STRUCT);
      ...
      beta_mv2 += calc_beta_mv2_one_loop(TRACE_STRUCT);
...
MSSMRHN_soft_parameters MSSMRHN_soft_parameters::calc_beta(unsigned loops) const
{
   MSSMRHN_soft_parameters p(*this);
   p.set_loops(loops);
