...
#ifndef MSSMRHN_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMRHN_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMRHN_low_scale_constraint.hpp"
...
template<>
class MSSMRHN_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMRHN_low_scale_constraint() = default;
   MSSMRHN_low_scale_constraint(MSSMRHN<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMRHN_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMRHN low-scale constraint"; }
