...
template<>
class MSSMRHN_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   MSSMRHN_low_scale_constraint();
   MSSMRHN_low_scale_constraint(MSSMRHN<Two_scale>*, const MSSMRHN_input_parameters&, const QedQcd&);
   virtual ~MSSMRHN_low_scale_constraint();
   virtual void apply();
