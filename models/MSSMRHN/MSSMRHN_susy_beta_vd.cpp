...
// File generated at Sun 26 Aug 2018 14:55:38
...
double MSSMRHN_susy_parameters::calc_beta_vd_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vd = Re(-0.005*twoLoop*vd*(207*Quad(g1) + 10*Sqr(g1)*(10*(traceYdAdjYd
      ...
      traceYeAdjYe)*Sqr(g2) + 8*(-9*traceYdAdjYdYdAdjYd - 3*traceYdAdjYuYuAdjYd
       - 3*traceYeAdjYeYeAdjYe - traceYeAdjYvYvAdjYe + 16*traceYdAdjYd*Sqr(g3))
      )));
