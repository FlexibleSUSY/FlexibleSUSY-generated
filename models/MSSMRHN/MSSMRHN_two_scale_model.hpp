...
/**
 * @file MSSMRHN_two_scale_model.hpp
 * @brief contains class for model with routines needed to solve boundary
 *        value problem using the two_scale solver by solvingt EWSB
 *        and determine the pole masses and mixings
 *
 * This file was generated at Tue 24 Feb 2015 17:45:22 with FlexibleSUSY
 * 1.0.4 (git commit: v1.0.4-355-g539c238) and SARAH 4.4.6 .
 */

#ifndef MSSMRHN_TWO_SCALE_H
#define MSSMRHN_TWO_SCALE_H

#include "MSSMRHN_model.hpp"
...
class Two_scale;
/**
 * @class MSSMRHN<Two_scale>
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
template<>
class MSSMRHN<Two_scale> : public Two_scale_model, public MSSMRHN_soft_parameters {
public:
   explicit MSSMRHN(const MSSMRHN_input_parameters& input_ = MSSMRHN_input_parameters());
   virtual ~MSSMRHN();
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(MSSMRHN<Two_scale>::*Memfun_t)();
      MSSMRHN<Two_scale>* model;
      Memfun_t fun;

      Thread(MSSMRHN<Two_scale>* model_, Memfun_t fun_)
...
std::ostream& operator<<(std::ostream&, const MSSMRHN<Two_scale>&);
