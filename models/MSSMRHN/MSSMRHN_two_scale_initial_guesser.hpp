...
template<>
class MSSMRHN_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ...
   virtual ~MSSMRHN_initial_guesser() = default;
...
private:
   MSSMRHN<Two_scale>* model{nullptr}; ///< pointer to model class
