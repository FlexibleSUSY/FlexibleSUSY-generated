...
double MSSMRHN_susy_parameters::calc_beta_Mu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Mu = Re(-0.2*Mu*(-15*traceYdAdjYd - 5*traceYeAdjYe - 15*traceYuAdjYu -
      5*traceYvAdjYv + 3*Sqr(g1) + 15*Sqr(g2)));
...
double MSSMRHN_susy_parameters::calc_beta_Mu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Mu = Re(0.02*Mu*(-450*traceYdAdjYdYdAdjYd - 300*traceYdAdjYuYuAdjYd -
      150*traceYeAdjYeYeAdjYe - 100*traceYeAdjYvYvAdjYe - 450*
      traceYuAdjYuYuAdjYu - 150*traceYvAdjYvYvAdjYv + 207*Quad(g1) + 375*Quad(
      g2) - 20*traceYdAdjYd*Sqr(g1) + 60*traceYeAdjYe*Sqr(g1) + 40*traceYuAdjYu
      *Sqr(g1) + 90*Sqr(g1)*Sqr(g2) + 800*traceYdAdjYd*Sqr(g3) + 800*
      traceYuAdjYu*Sqr(g3)));
