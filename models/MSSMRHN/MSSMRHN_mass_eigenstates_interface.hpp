...
/**
 * @file MSSMRHN_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSMRHN_MASS_EIGENSTATES_INTERFACE_H
#define MSSMRHN_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMRHN_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMRHN_mass_eigenstates_interface {
public:
   virtual ~MSSMRHN_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMRHN_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMRHN_input_parameters& get_input_parameters() const = 0;
   virtual MSSMRHN_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMRHN_physical& get_physical() const = 0;
   virtual MSSMRHN_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMRHN_physical&) = 0;
   ...
   virtual const Eigen::Matrix<double,3,3>& get_Yv() const = 0;
   virtual double get_Yv(int i, int k) const = 0;
   virtual double get_Mu() const = 0;
   virtual const Eigen::Matrix<double,3,3>& get_Mv() const = 0;
   virtual double get_Mv(int i, int k) const = 0;
   ...
   virtual const Eigen::Matrix<double,3,3>& get_TYv() const = 0;
   virtual double get_TYv(int i, int k) const = 0;
   virtual double get_BMu() const = 0;
   virtual const Eigen::Matrix<double,3,3>& get_BMv() const = 0;
   virtual double get_BMv(int i, int k) const = 0;
   ...
   virtual const Eigen::Matrix<double,3,3>& get_mv2() const = 0;
   virtual double get_mv2(int i, int k) const = 0;
   ...
   virtual void set_Yv(const Eigen::Matrix<double,3,3>& Yv_) = 0;
   virtual void set_Yv(int i, int k, const double& value) = 0;
   virtual void set_Mu(double Mu_) = 0;
   virtual void set_Mv(const Eigen::Matrix<double,3,3>& Mv_) = 0;
   virtual void set_Mv(int i, int k, const double& value) = 0;
   ...
   virtual void set_TYv(const Eigen::Matrix<double,3,3>& TYv_) = 0;
   virtual void set_TYv(int i, int k, const double& value) = 0;
   virtual void set_BMu(double BMu_) = 0;
   virtual void set_BMv(const Eigen::Matrix<double,3,3>& BMv_) = 0;
   virtual void set_BMv(int i, int k, const double& value) = 0;
   ...
   virtual void set_mv2(const Eigen::Matrix<double,3,3>& mv2_) = 0;
   virtual void set_mv2(int i, int k, const double& value) = 0;
   ...
   virtual const Eigen::Array<double,6,1>& get_MSv() const = 0;
   ...
   virtual const Eigen::Array<double,6,1>& get_MFv() const = 0;
   ...
   virtual const Eigen::Matrix<double,6,6>& get_ZV() const = 0;
   ...
   virtual const Eigen::Matrix<std::complex<double>,6,6>& get_UV() const = 0;
   virtual std::complex<double> get_UV(int i, int k) const = 0;
   ...
   virtual Eigen::Matrix<double,6,6> get_mass_matrix_Sv() const = 0;
   ...
   virtual Eigen::Matrix<double,6,6> get_mass_matrix_Fv() const = 0;
