...
// File generated at Thu 15 Dec 2016 13:00:03
...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_mq2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mq2 = (twoLoop*((-2*(3*traceconjTYdTpTYd + traceconjTYeTpTYe + 3*
      ...
      *Sqr(g2) - 8*MassG*Sqr(g3))) + 3*(2*(45*Power(g2,4)*Tr22 + 80*Power(g3,4)
      *Tr23 + 7.745966692414834*g1*Tr31 + Tr2U111*Sqr(g1)) + 3*Conj(MassWB)*Sqr
