...
// File generated at Wed 16 Oct 2019 22:35:07
...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_me2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_me2 = (twoLoop*(-0.8*(15*traceconjTYdTpTYd + 5*traceconjTYeTpTYe + 15*
      ...
      *MassB*Sqr(g1) - 15*MassWB*Sqr(g2))*(Ye*(TYe).adjoint()) - 0.8*(15*
      ...
      Ye.adjoint()) - 4*(Ye*Ye.adjoint()*TYe*(TYe).adjoint()) - 4*(mHd2 + mHu2)
      *(Ye*Yv.adjoint()*Yv*Ye.adjoint()) - 4*(Ye*Yv.adjoint()*TYv*(TYe).adjoint
      ()) - 4*(Ye*(TYe).adjoint()*TYe*Ye.adjoint()) - 4*(Ye*(TYv).adjoint()*TYv
      *Ye.adjoint()) - 4*(TYe*Ye.adjoint()*Ye*(TYe).adjoint()) - 4*(TYe*Yv.
      adjoint()*Yv*(TYe).adjoint()) - 4*(TYe*(TYe).adjoint()*Ye*Ye.adjoint()) -
      4*(TYe*(TYv).adjoint()*Yv*Ye.adjoint()) - 2*(me2*Ye*Ye.adjoint()*Ye*Ye.
      adjoint()) - 2*(me2*Ye*Yv.adjoint()*Yv*Ye.adjoint()) - 4*(Ye*ml2*Ye.
      adjoint()*Ye*Ye.adjoint()) - 4*(Ye*ml2*Yv.adjoint()*Yv*Ye.adjoint()) - 4*
 ...
 */
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_me2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
