...
// File generated at Mon 5 Mar 2018 18:46:24
...
Eigen::Matrix<double,3,3> MSSMRHN_soft_parameters::calc_beta_me2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_me2 = (twoLoop*(-0.8*(15*traceconjTYdTpTYd + 5*traceconjTYeTpTYe
      ...
      4*(Ye*Ye.adjoint()*TYe*(TYe).adjoint()) - 4*(mHd2 + mHu2)*(Ye*Yv.adjoint(
      )*Yv*Ye.adjoint()) - 4*(Ye*Yv.adjoint()*TYv*(TYe).adjoint()) - 4*(Ye*(TYe
      ).adjoint()*TYe*Ye.adjoint()) - 4*(Ye*(TYv).adjoint()*TYv*Ye.adjoint()) -
      4*(TYe*Ye.adjoint()*Ye*(TYe).adjoint()) - 4*(TYe*Yv.adjoint()*Yv*(TYe)
      .adjoint()) - 4*(TYe*(TYe).adjoint()*Ye*Ye.adjoint()) - 4*(TYe*(TYv)
      .adjoint()*Yv*Ye.adjoint()) - 2*(me2*Ye*Ye.adjoint()*Ye*Ye.adjoint()) - 2
      *(me2*Ye*Yv.adjoint()*Yv*Ye.adjoint()) - 4*(Ye*ml2*Ye.adjoint()*Ye*
      Ye.adjoint()) - 4*(Ye*ml2*Yv.adjoint()*Yv*Ye.adjoint()) - 4*(Ye*
      Ye.adjoint()*me2*Ye*Ye.adjoint()) - 4*(Ye*Ye.adjoint()*Ye*ml2*Ye.adjoint(
      )) - 2*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*me2) - 4*(Ye*Yv.adjoint()*mv2*Yv*
      Ye.adjoint()) - 4*(Ye*Yv.adjoint()*Yv*ml2*Ye.adjoint()) - 2*(Ye*
