 ...
 */
double MSSMRHN_soft_parameters::calc_beta_MassB_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMRHN_soft_parameters::calc_beta_MassB_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_MassB = Re(0.08*Sqr(g1)*(70*traceAdjYdTYd + 90*traceAdjYeTYe + 130*
      traceAdjYuTYu + 30*traceAdjYvTYv - 70*MassB*traceYdAdjYd - 90*MassB*
      traceYeAdjYe - 130*MassB*traceYuAdjYu - 30*MassB*traceYvAdjYv + 398*MassB
      *Sqr(g1) + 135*MassB*Sqr(g2) + 135*MassWB*Sqr(g2) + 440*MassB*Sqr(g3) +
      440*MassG*Sqr(g3)));
 ...
 */
double MSSMRHN_soft_parameters::calc_beta_MassB_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
