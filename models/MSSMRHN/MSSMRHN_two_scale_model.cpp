...
Eigen::Matrix<double,6,6> CLASSNAME::get_mass_matrix_Sv() const
{
   ...
   mass_matrix_Sv(3,0) = Conj(mass_matrix_Sv(0,3));
   mass_matrix_Sv(3,1) = Conj(mass_matrix_Sv(1,3));
   mass_matrix_Sv(3,2) = Conj(mass_matrix_Sv(2,3));
   ...
   mass_matrix_Sv(4,0) = Conj(mass_matrix_Sv(0,4));
   mass_matrix_Sv(4,1) = Conj(mass_matrix_Sv(1,4));
   mass_matrix_Sv(4,2) = Conj(mass_matrix_Sv(2,4));
   mass_matrix_Sv(4,3) = Conj(mass_matrix_Sv(3,4));
   ...
   mass_matrix_Sv(5,0) = Conj(mass_matrix_Sv(0,5));
   mass_matrix_Sv(5,1) = Conj(mass_matrix_Sv(1,5));
   mass_matrix_Sv(5,2) = Conj(mass_matrix_Sv(2,5));
   mass_matrix_Sv(5,3) = Conj(mass_matrix_Sv(3,5));
   mass_matrix_Sv(5,4) = Conj(mass_matrix_Sv(4,5));
...
Eigen::Matrix<double,6,6> CLASSNAME::get_mass_matrix_Fv() const
{
   ...
   mass_matrix_Fv(3,0) = mass_matrix_Fv(0,3);
   mass_matrix_Fv(3,1) = mass_matrix_Fv(1,3);
   mass_matrix_Fv(3,2) = mass_matrix_Fv(2,3);
   mass_matrix_Fv(3,3) = Mv(0,0);
   mass_matrix_Fv(3,4) = 0.5*Mv(0,1) + 0.5*Mv(1,0);
   mass_matrix_Fv(3,5) = 0.5*Mv(0,2) + 0.5*Mv(2,0);
   mass_matrix_Fv(4,0) = mass_matrix_Fv(0,4);
   mass_matrix_Fv(4,1) = mass_matrix_Fv(1,4);
   mass_matrix_Fv(4,2) = mass_matrix_Fv(2,4);
   mass_matrix_Fv(4,3) = mass_matrix_Fv(3,4);
   mass_matrix_Fv(4,4) = Mv(1,1);
   mass_matrix_Fv(4,5) = 0.5*Mv(1,2) + 0.5*Mv(2,1);
   mass_matrix_Fv(5,0) = mass_matrix_Fv(0,5);
   mass_matrix_Fv(5,1) = mass_matrix_Fv(1,5);
   mass_matrix_Fv(5,2) = mass_matrix_Fv(2,5);
   mass_matrix_Fv(5,3) = mass_matrix_Fv(3,5);
   mass_matrix_Fv(5,4) = mass_matrix_Fv(4,5);
...
std::complex<double> CLASSNAME::tadpole_hh(unsigned gO1) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3443 += A0(MAh(gI1))*CpUhhAhAh(gO1,gI1,gI1);
   }
   tmp_3442 += tmp_3443;
   result += (-0.5) * tmp_3442;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3445 += A0(MHpm(gI1))*CpUhhconjHpmHpm(gO1,gI1,gI1);
   }
   tmp_3444 += tmp_3445;
   result += (-1) * tmp_3444;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3447 += A0(Mhh(gI1))*CpUhhhhhh(gO1,gI1,gI1);
   }
   tmp_3446 += tmp_3447;
   result += (-0.5) * tmp_3446;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3449 += A0(MCha(gI1))*(CpUhhbarChaChaPL(gO1,gI1,gI1) +
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3451 += A0(MFd(gI1))*(CpUhhbarFdFdPL(gO1,gI1,gI1) + CpUhhbarFdFdPR
         (gO1,gI1,gI1))*MFd(gI1);
   }
   tmp_3450 += tmp_3451;
   result += (6) * tmp_3450;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3453 += A0(MFe(gI1))*(CpUhhbarFeFePL(gO1,gI1,gI1) + CpUhhbarFeFePR
         (gO1,gI1,gI1))*MFe(gI1);
   }
   tmp_3452 += tmp_3453;
   result += (2) * tmp_3452;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3455 += A0(MFu(gI1))*(CpUhhbarFuFuPL(gO1,gI1,gI1) + CpUhhbarFuFuPR
         (gO1,gI1,gI1))*MFu(gI1);
   }
   tmp_3454 += tmp_3455;
   result += (6) * tmp_3454;
   ...
   for (unsigned gI1 = 0; gI1 < 4; ++gI1) {
      tmp_3456 += A0(MChi(gI1))*(CpUhhChiChiPL(gO1,gI1,gI1) + CpUhhChiChiPR(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3458 += A0(MSd(gI1))*CpUhhconjSdSd(gO1,gI1,gI1);
   }
   tmp_3457 += tmp_3458;
   result += (-3) * tmp_3457;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3460 += A0(MSe(gI1))*CpUhhconjSeSe(gO1,gI1,gI1);
   }
   tmp_3459 += tmp_3460;
   result += (-1) * tmp_3459;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3462 += A0(MSu(gI1))*CpUhhconjSuSu(gO1,gI1,gI1);
   }
   tmp_3461 += tmp_3462;
   result += (-3) * tmp_3461;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3464 += A0(MSv(gI1))*CpUhhconjSvSv(gO1,gI1,gI1);
   }
   tmp_3463 += tmp_3464;
   result += (-1) * tmp_3463;
   std::complex<double> tmp_3465;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3465 += A0(MFv(gI1))*(CpUhhFvFvPL(gO1,gI1,gI1) + CpUhhFvFvPR(gO1,
         gI1,gI1))*MFv(gI1);
   }
   result += tmp_3465;
