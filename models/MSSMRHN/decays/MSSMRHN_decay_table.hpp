...
#ifndef MSSMRHN_DECAY_TABLE_H
#define MSSMRHN_DECAY_TABLE_H
...
public:
   ...
   MSSMRHN_decay_table();
   ~MSSMRHN_decay_table() = default;
   MSSMRHN_decay_table(const MSSMRHN_decay_table&) = default;
   MSSMRHN_decay_table(MSSMRHN_decay_table&&) = default;
   MSSMRHN_decay_table& operator=(const MSSMRHN_decay_table&) = default;
   MSSMRHN_decay_table& operator=(MSSMRHN_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const MSSMRHN_decay_table&);
