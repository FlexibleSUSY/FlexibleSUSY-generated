...
// File generated at Wed 16 Oct 2019 22:46:47
...
MSSMRHN_initial_guesser<Two_scale>::MSSMRHN_initial_guesser(
   MSSMRHN<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MSSMRHN_low_scale_constraint<Two_scale>& low_constraint_,
   const MSSMRHN_susy_scale_constraint<Two_scale>& susy_constraint_,
...
{
   if (!model)
      throw SetupError("MSSMRHN_initial_guesser: Error: pointer to model"
                       " MSSMRHN<Two_scale> must not be zero");
}
 ...
 */
void MSSMRHN_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMRHN_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSMRHN_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void MSSMRHN_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void MSSMRHN_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMRHN_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMRHN_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void MSSMRHN_initial_guesser<Two_scale>::guess_soft_parameters()
{
