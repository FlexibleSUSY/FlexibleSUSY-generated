...
const int MSSMRHN_observables::NUMBER_OF_OBSERVABLES;
...
MSSMRHN_observables calculate_observables(MSSMRHN_mass_eigenstates& model,
                                              ...
                                              const Physical_input& physical_input)
{
   ...
   try {
      ...
      observables.AMU = MSSMRHN_a_muon::calculate_a_muon(MODEL);
