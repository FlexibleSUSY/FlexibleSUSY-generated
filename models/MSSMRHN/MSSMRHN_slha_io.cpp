 ...
 */
void MSSMRHN_slha_io::set_extpar(const MSSMRHN_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMRHN_slha_io::set_imminpar(const MSSMRHN_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMRHN_slha_io::set_imextpar(const MSSMRHN_input_parameters& input)
{
 ...
 */
void MSSMRHN_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMRHN_slha_io::set_minpar(const MSSMRHN_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMRHN_slha_io::set_input(const MSSMRHN_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
   ...
   slha_io.set_block("BMvIN", INPUTPARAMETER(BMvInput), "BMvInput");
 ...
 */
void MSSMRHN_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MSSMRHN_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMRHN_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMRHN_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void MSSMRHN_slha_io::set_unitarity_infinite_s(
 ...
 */
void MSSMRHN_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMRHN_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMRHN_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMRHN_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMRHN_info::model_name)
 ...
 */
void MSSMRHN_slha_io::set_mass(const MSSMRHN_physical& physical,
                                   bool write_sm_masses)
{
   ...
   if (write_sm_masses) {
      mass
         ...
         << FORMAT_MASS(9900012, LOCALPHYSICAL(MFv(3)), "Fv(4)")
         << FORMAT_MASS(9900014, LOCALPHYSICAL(MFv(4)), "Fv(5)")
         << FORMAT_MASS(9900016, LOCALPHYSICAL(MFv(5)), "Fv(6)")
 ...
 */
void MSSMRHN_slha_io::set_mixing_matrices(const MSSMRHN_physical& physical,
...
void MSSMRHN_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void MSSMRHN_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void MSSMRHN_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void MSSMRHN_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void MSSMRHN_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, MSSMRHN_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void MSSMRHN_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = MSSMRHN_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + MSSMRHN_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void MSSMRHN_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void MSSMRHN_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double MSSMRHN_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMRHN_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMRHN_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMRHN_slha_io::read_from_stream(std::istream& istr)
{
...
void MSSMRHN_slha_io::fill(MSSMRHN_input_parameters& input) const
{
   ...
   slha_io.read_block("BMvIN", input.BMvInput);
 ...
 */
void MSSMRHN_slha_io::fill_drbar_parameters(MSSMRHN_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMRHN_slha_io::fill(MSSMRHN_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMRHN_physical physical_hk;
 ...
 */
void MSSMRHN_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMRHN_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMRHN_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void MSSMRHN_slha_io::fill_minpar_tuple(MSSMRHN_input_parameters& input,
...
void MSSMRHN_slha_io::fill_extpar_tuple(MSSMRHN_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMRHN_slha_io::fill_imminpar_tuple(MSSMRHN_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMRHN_slha_io::fill_imextpar_tuple(MSSMRHN_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMRHN_slha_io::fill_physical(MSSMRHN_physical& physical) const
{
   {
   ...
   LOCALPHYSICAL(MFv)(3) = slha_io.read_entry("MASS", 9900012);
   LOCALPHYSICAL(MFv)(4) = slha_io.read_entry("MASS", 9900014);
   LOCALPHYSICAL(MFv)(5) = slha_io.read_entry("MASS", 9900016);
