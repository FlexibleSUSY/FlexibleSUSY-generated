...
#ifndef MSSMRHN_TWO_SCALE_MATCHING_H
#define MSSMRHN_TWO_SCALE_MATCHING_H
...
template <class T> class MSSMRHN;
template <class T> class MSSMRHN_standard_model_Matching;
...
template<>
class MSSMRHN_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MSSMRHN_standard_model_Matching();

   MSSMRHN_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MSSMRHN<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MSSMRHN_standard_model_Matching();
