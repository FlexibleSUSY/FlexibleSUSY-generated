...
// File generated at Tue 22 Jan 2019 17:52:21
...
MSSMRHN_convergence_tester<Two_scale>::MSSMRHN_convergence_tester(
   MSSMRHN<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMRHN<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double MSSMRHN_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const MSSMRHN<Two_scale>& ne = get_current_iteration_model();
