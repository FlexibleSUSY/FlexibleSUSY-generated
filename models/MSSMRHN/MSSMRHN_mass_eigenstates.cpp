...
// File generated at Tue 22 Jan 2019 17:52:12
 ...
 * parameters.
 *
 * This file was generated at Tue 22 Jan 2019 17:52:12 with FlexibleSUSY
...
std::complex<double> CLASSNAME::CpUSdSvconjUSdconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)*
      ...
      *ZV(gI2,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2
      )) + 0.05*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3
       + j1))*SUM(j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2));
...
std::complex<double> CLASSNAME::CpHpmSuconjUSd(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZU(
      ...
      (Yu(j1,gO2))*Yu(j1,j2)))*ZP(gI2,1),0) + SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0
      ,2,KroneckerDelta(gO2,3 + j1)*TYd(j1,j2)))*ZP(gI2,0) + 0.7071067811865475*vu
      *SUM(j3,0,2,Conj(ZU(gI1,3 + j3))*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(
...
std::complex<double> CLASSNAME::CpSdconjHpmconjUSu(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZD(
      ...
      (Yu(j1,gO2))*Yu(j1,j2)))*ZP(gI1,1),0) + Conj(Mu)*SUM(j2,0,2,Conj(ZD(gI2,j2))
      *SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)))*ZP(gI1,0) +
...
std::complex<double> CLASSNAME::CpUSuSvconjUSuconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)*
      ...
      IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZV(gI1,j2))
      *ZV(gI2,j2)),0) + IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j2,0
      ,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)),0) + IF(gO1 < 3,-(SUM(j1,0,2,KroneckerDelta(
...
std::complex<double> CLASSNAME::CphhSuconjUSu(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZU(gI1,gO2))*Sqr(g1
      ...
      < 3,-0.7071067811865475*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(TYu(j1,gO2)))*
      ZH(gI2,1),0) + IF(gO2 < 3,-(vu*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,Conj(
      Yu(j1,gO2))*Yu(j1,j2)))*ZH(gI2,1)),0) - 0.2*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZU(
      gI1,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZH(gI2,0) + 0.7071067811865475*Conj
      (Mu)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1
      ,j2)))*ZH(gI2,0) + 0.2*vu*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*
...
std::complex<double> CLASSNAME::CpHpmUSeconjHpmconjUSe(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(Yv(
      j1,gO2))*Yv(j1,gO1))*ZP(gI1,1)*ZP(gI2,1)),0),0) + IF(gO1 < 3,-0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,-0.25*
      ...
      0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1,0)*ZP(gI2,
      0) - SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,KroneckerDelta(gO2,3 +
      j2)*SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))))*ZP(gI1,0)*ZP(gI2,0) - 0.3*Sqr(g1
      )*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1,1
      )*ZP(gI2,1);
...
std::complex<double> CLASSNAME::CpUSeSvconjUSeconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Yv(j1,
      gO1)*ZV(gI2,3 + j1))*SUM(j3,0,2,Conj(Yv(j3,gO2))*Conj(ZV(gI1,3 + j3)))),0),0
      ...
      ,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,-0.075*KroneckerDelta(gO1,
      ...
      0.15*Sqr(g1)*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1))*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CphhSeconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2))*Sqr(
      ...
      g2)*ZH(gI2,1),0) + IF(gO2 < 3,0.7071067811865475*Mu*SUM(j1,0,2,Conj(Ye(j1,
      gO2))*Conj(ZE(gI1,3 + j1)))*ZH(gI2,1),0) + 0.3*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZE
      (gI1,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZH(gI2,0) - 0.7071067811865475*SUM
...
std::complex<double> CLASSNAME::CpHpmconjUSeconjSv(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,0.5*SUM(j2,0,2,SUM(j1,0,2,Conj(
      Yv(j1,gO2))*Mv(j1,j2))*ZV(gI1,3 + j2))*ZP(gI2,1),0) + IF(gO2 < 3,0.5*SUM(j2,
      0,2,SUM(j1,0,2,Conj(Yv(j1,gO2))*Mv(j2,j1))*ZV(gI1,3 + j2))*ZP(gI2,1),0);
...
std::complex<double> CLASSNAME::CpHpmSvconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZV(
      gI1,gO2))*Sqr(g2)*ZP(gI2,0),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Yv(j1,gO2))*
      Conj(ZV(gI1,3 + j1)))*ZP(gI2,0),0) + IF(gO2 < 3,0.7071067811865475*vd*SUM(j2
      ...
      IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj
      (Yv(j1,gO2))*Yv(j1,j2)))*ZP(gI2,1),0) + SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0
      ,2,KroneckerDelta(gO2,3 + j1)*TYe(j1,j2)))*ZP(gI2,0) + 0.7071067811865475*vu
      *SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(
      j1,0,2,Conj(Yv(j3,j1))*Ye(j2,j1))))*ZP(gI2,0) + Conj(Mu)*SUM(j2,0,2,Conj(ZV(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZP(gI2,1) +
      0.7071067811865475*vd*SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,
      KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j3,j1))*Ye(j2,j1))))*ZP(gI2,1)
      ;
...
std::complex<double> CLASSNAME::CpFvChaconjUSePR(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,SUM(j1,0,2,Conj(Yv(j1,gO2))*UV(
      gI1,3 + j1))*UP(gI2,1),0);
...
std::complex<double> CLASSNAME::CpFvChaconjUSePL(int gI1, int gI2, int gO1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(UM(gI2,0))*Conj(UV(gI1
      ,gO1))),0) + Conj(UM(gI2,1))*SUM(j2,0,2,Conj(UV(gI1,j2))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpAhAhUSvconjUSv(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(Yv(
      j1,gO2))*Yv(j1,gO1))*ZA(gI1,1)*ZA(gI2,1)),0),0) + IF(gO1 < 3,-0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,-0.25*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 < 3,0.25*
...
std::complex<double> CLASSNAME::CphhhhUSvconjUSv(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(Yv(
      j1,gO2))*Yv(j1,gO1))*ZH(gI1,1)*ZH(gI2,1)),0),0) + IF(gO1 < 3,-0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,-0.25*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 3,0.25*
...
std::complex<double> CLASSNAME::CpSeconjHpmconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZE(
      ...
      IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj
      (Yv(j1,gO2))*Yv(j1,j2)))*ZP(gI1,1),0) + Conj(Mu)*SUM(j2,0,2,Conj(ZE(gI2,j2))
      *SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yv(j1,j2)))*ZP(gI1,0) +
...
std::complex<double> CLASSNAME::CpSeUSvconjSeconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Ye(j1,
      ...
      *Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1)),0) + IF(gO1 < 3,-
      ...
      j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yv(j1,j2)))*SUM(j4,0,2,SUM(j3,0,2
      ,Conj(Yv(j3,j4))*KroneckerDelta(gO1,3 + j3))*ZE(gI2,j4));
...
std::complex<double> CLASSNAME::CphhconjSvconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*SUM(j2,0,2,
      SUM(j1,0,2,Conj(Yv(j1,gO2))*Mv(j1,j2))*ZV(gI1,3 + j2))*ZH(gI2,1),0) + 0.25*(
      4*IF(gO2 < 3,-0.35355339059327373*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,gO2))*Mv(
      j2,j1))*ZV(gI1,3 + j2))*ZH(gI2,1),0) - 1.4142135623730951*(SUM(j3,0,2,SUM(j2
      ,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Mv(j1,j2)))*ZV(
      gI1,j3)) + SUM(j3,0,2,SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(
      Yv(j1,j3))*Mv(j2,j1)))*ZV(gI1,j3)))*ZH(gI2,1));
...
std::complex<double> CLASSNAME::CphhSvconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZV(gI1,gO2))*Sqr(
      g1)*ZH(gI2,0),0) + IF(gO2 < 3,-0.25*vd*Conj(ZV(gI1,gO2))*Sqr(g2)*ZH(gI2,0),0
      ) + IF(gO2 < 3,0.7071067811865475*Mu*SUM(j1,0,2,Conj(Yv(j1,gO2))*Conj(ZV(gI1
      ,3 + j1)))*ZH(gI2,0),0) + IF(gO2 < 3,0.15*vu*Conj(ZV(gI1,gO2))*Sqr(g1)*ZH(
      gI2,1),0) + IF(gO2 < 3,0.25*vu*Conj(ZV(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(
      gO2 < 3,-0.7071067811865475*SUM(j1,0,2,Conj(ZV(gI1,3 + j1))*Conj(TYv(j1,gO2)
      ))*ZH(gI2,1),0) + IF(gO2 < 3,-(vu*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,
      Conj(Yv(j1,gO2))*Yv(j1,j2)))*ZH(gI2,1)),0) + 0.7071067811865475*Conj(Mu)*SUM
      (j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yv(j1,j2)))*
...
std::complex<double> CLASSNAME::CpHpmconjSeconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = 0.5*(SUM(j3,0,2,SUM(j2,0,2,KroneckerDelta(
      gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Mv(j1,j2)))*ZE(gI1,j3)) + SUM(j3,0,2,
      SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Mv(j2,j1)))
      *ZE(gI1,j3)))*ZP(gI2,1);
...
std::complex<double> CLASSNAME::CpChiFvconjUSvPL(int gI2, int gI1, int gO1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.5477225575051661*g1*Conj(UV(
      gI1,gO1))*Conj(ZN(gI2,0)),0) + IF(gO1 < 3,-0.7071067811865475*g2*Conj(UV(gI1
      ,gO1))*Conj(ZN(gI2,1)),0) - Conj(ZN(gI2,3))*SUM(j2,0,2,Conj(UV(gI1,j2))*SUM(
      j1,0,2,KroneckerDelta(gO1,3 + j1)*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpUhhSdconjSd(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(-(KroneckerDelta(1,gO2)*(vu*(Sqr(g1)
      + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) + 2*(vu*Sqr(g1)*SUM(j1,
      0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) - 7.0710678118654755*(Conj(Mu)*SUM(
      j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) + Mu*SUM(j2,0,
...
std::complex<double> CLASSNAME::CpUhhSeconjSe(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO2)*(vu*(3*Sqr(g1)
      - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 6*vu*Sqr(g1)*SUM(j1,0
      ,2,Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1)) + 14.142135623730951*(Conj(Mu)*SUM(
      j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) + Mu*SUM(j2,0,
...
std::complex<double> CLASSNAME::CpUhhSuconjSu(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO2)*(vd*(Sqr(g1) -
      5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) - 4*vd*Sqr(g1)*SUM(j1,0,2
      ,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)) + 14.142135623730951*(Conj(Mu)*SUM(j2,
      0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + Mu*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CpUhhSvSv(int gO2, int gI1, int gI2) const
{
   ...
   const std::complex<double> result = -0.35355339059327373*KroneckerDelta(1,gO2)*
      (SUM(j3,0,2,Conj(ZV(gI2,3 + j3))*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj
      (Mv(j1,j3))*Yv(j1,j2)))) + SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,Conj(
      ZV(gI2,j2))*SUM(j1,0,2,Conj(Mv(j1,j3))*Yv(j1,j2)))) + SUM(j3,0,2,Conj(ZV(gI2
      ,3 + j3))*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj(Mv(j3,j1))*Yv(j1,j2)))
      ) + SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,
      Conj(Mv(j3,j1))*Yv(j1,j2)))));
...
std::complex<double> CLASSNAME::CpUhhSvconjSv(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO2)*(-(vd*(3*Sqr(g1
      ) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZV(gI2,j1))*ZV(gI1,j1))) + 14.142135623730951
      *(Conj(Mu)*SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,Yv(j1,j2)*ZV(gI1,3 + j1)))
      + Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*Conj(ZV(gI2,3 + j1)))*ZV(gI1,j2))
      )) + KroneckerDelta(1,gO2)*(vu*(3*Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZV(
      gI2,j1))*ZV(gI1,j1)) - 10*(1.4142135623730951*SUM(j2,0,2,Conj(ZV(gI2,j2))*
      SUM(j1,0,2,ZV(gI1,3 + j1)*TYv(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(
      j1,0,2,Conj(ZV(gI2,3 + j1))*Conj(TYv(j1,j2)))*ZV(gI1,j2)) + 2*vu*(SUM(j3,0,2
      ,Conj(ZV(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j3,j1))*Yv(j2,j1))*ZV(
      gI1,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,Conj(Yv(j1
      ,j3))*Yv(j1,j2)))*ZV(gI1,j3))))));
...
std::complex<double> CLASSNAME::CpFvFvUhhPR(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = -0.7071067811865475*KroneckerDelta(1,gO2)*(
      SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*UV(gI2,3 + j1))*UV(gI1,j2)) + SUM(j2,0
      ,2,SUM(j1,0,2,Conj(Yv(j1,j2))*UV(gI1,3 + j1))*UV(gI2,j2)));
...
std::complex<double> CLASSNAME::CpUAhSdconjSd(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.7071067811865475
      )*(Conj(Mu)*KroneckerDelta(1,gO2)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(
      j1,j2)*ZD(gI1,3 + j1))) - KroneckerDelta(1,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1)))*ZD(gI1,j2)) + KroneckerDelta(0,gO2)*(
...
std::complex<double> CLASSNAME::CpUAhSeconjSe(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.7071067811865475
      )*(Conj(Mu)*KroneckerDelta(1,gO2)*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(
      j1,j2)*ZE(gI1,3 + j1))) - KroneckerDelta(1,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1)))*ZE(gI1,j2)) + KroneckerDelta(0,gO2)*(
...
std::complex<double> CLASSNAME::CpUAhSuconjSu(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.7071067811865475
      )*(Conj(Mu)*KroneckerDelta(0,gO2)*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(
      j1,j2)*ZU(gI1,3 + j1))) - KroneckerDelta(0,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1)))*ZU(gI1,j2)) + KroneckerDelta(1,gO2)*(
...
std::complex<double> CLASSNAME::CpUAhSvSv(int gO2, int gI1, int gI2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-
      ...
      SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj(Mv(j1,j3))*Yv(j1,j2)))) + SUM(j3
      ,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,Conj(Mv(j1,
      j3))*Yv(j1,j2)))) + SUM(j3,0,2,Conj(ZV(gI2,3 + j3))*SUM(j2,0,2,Conj(ZV(gI1,
      j2))*SUM(j1,0,2,Conj(Mv(j3,j1))*Yv(j1,j2)))) + SUM(j3,0,2,Conj(ZV(gI1,3 + j3
      ))*SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,Conj(Mv(j3,j1))*Yv(j1,j2)))));
...
std::complex<double> CLASSNAME::CpUAhSvconjSv(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.7071067811865475
      )*(Conj(Mu)*KroneckerDelta(0,gO2)*SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,Yv(
      j1,j2)*ZV(gI1,3 + j1))) - KroneckerDelta(0,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Yv(j1,j2))*Conj(ZV(gI2,3 + j1)))*ZV(gI1,j2)) + KroneckerDelta(1,gO2)*(
      SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,ZV(gI1,3 + j1)*TYv(j1,j2))) - SUM(j2,
      0,2,SUM(j1,0,2,Conj(ZV(gI2,3 + j1))*Conj(TYv(j1,j2)))*ZV(gI1,j2))));
...
std::complex<double> CLASSNAME::CpFvFvUAhPR(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *KroneckerDelta(1,gO2)*(SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*UV(gI2,3 + j1)
      )*UV(gI1,j2)) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*UV(gI1,3 + j1))*UV(gI2
      ,j2)));
...
std::complex<double> CLASSNAME::CpFvFvUAhPL(int gI1, int gI2, int gO1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.7071067811865475
      )*KroneckerDelta(1,gO1)*(SUM(j2,0,2,Conj(UV(gI2,j2))*SUM(j1,0,2,Conj(UV(gI1,
      3 + j1))*Yv(j1,j2))) + SUM(j2,0,2,Conj(UV(gI1,j2))*SUM(j1,0,2,Conj(UV(gI2,3
      + j1))*Yv(j1,j2))));
...
std::complex<double> CLASSNAME::CpUHpmSvconjUHpmconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*KroneckerDelta(
      1,gO2)*((3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)) - 20
      *SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j3,j1))*Yv(j2
      ,j1))*ZV(gI2,3 + j2)))) + KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*((-3*
      Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)) - 20*SUM(j3,0,2
      ,SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gI2,
      j3))));
...
std::complex<double> CLASSNAME::CpFvFeconjUHpmPR(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = KroneckerDelta(0,gO2)*SUM(j2,0,2,SUM(j1,0,2
      ,Conj(Ye(j1,j2))*ZER(gI2,j1))*UV(gI1,j2));
...
std::complex<double> CLASSNAME::CpFvFeconjUHpmPL(int gI1, int gI2, int gO1) const
{
   ...
   const std::complex<double> result = KroneckerDelta(1,gO1)*SUM(j2,0,2,Conj(ZEL(
      gI2,j2))*SUM(j1,0,2,Conj(UV(gI1,3 + j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpSdconjUHpmconjSu(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = KroneckerDelta(0,gO2)*(-0.35355339059327373
      *vd*Sqr(g2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZU(gI1,j1)) + Conj(Mu)*SUM(j2,0,2,
      Conj(ZD(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + SUM(j2,0,2,SUM(j1,0
      ,2,Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2)))*ZU(gI1,j2)) + 0.7071067811865475*
      vu*SUM(j3,0,2,Conj(ZD(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(
      j2,j1))*ZU(gI1,3 + j2))) + 0.7071067811865475*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(
      ZD(gI2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gI1,j3))) - 0.25*
      KroneckerDelta(1,gO2)*(1.4142135623730951*vu*Sqr(g2)*SUM(j1,0,2,Conj(ZD(gI2,
      j1))*ZU(gI1,j1)) - 2*(2*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,ZU(gI1,3 + j1
      )*TYu(j1,j2))) + 2*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gI2,3 +
      j1)))*ZU(gI1,j2)) + 1.4142135623730951*(vd*SUM(j3,0,2,Conj(ZD(gI2,3 + j3))*
      SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gI1,3 + j2))) + vu*SUM(
      j3,0,2,SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU
      (gI1,j3)))));
...
std::complex<double> CLASSNAME::CpSeconjUHpmconjSv(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = KroneckerDelta(0,gO2)*(-0.35355339059327373
      *vd*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZV(gI1,j1)) + Conj(Mu)*SUM(j2,0,2,
      Conj(ZE(gI2,j2))*SUM(j1,0,2,Yv(j1,j2)*ZV(gI1,3 + j1))) + SUM(j2,0,2,SUM(j1,0
      ,2,Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2)))*ZV(gI1,j2)) + 0.7071067811865475*
      vu*SUM(j3,0,2,Conj(ZE(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Yv(
      j2,j1))*ZV(gI1,3 + j2))) + 0.7071067811865475*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(
      ZE(gI2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gI1,j3))) - 0.25*
      KroneckerDelta(1,gO2)*(1.4142135623730951*vu*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI2,
      j1))*ZV(gI1,j1)) - 2*(2*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,ZV(gI1,3 + j1
      )*TYv(j1,j2))) + 2*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI2,3 +
      j1)))*ZV(gI1,j2)) + 1.4142135623730951*(vd*SUM(j3,0,2,Conj(ZE(gI2,3 + j3))*
      SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Yv(j2,j1))*ZV(gI1,3 + j2))) + vu*SUM(
      j3,0,2,SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj(Yv(j1,j3))*Yv(j1,j2)))*ZV
      (gI1,j3)))));
...
std::complex<double> CLASSNAME::CpSeSvconjUHpm(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = 0.5*KroneckerDelta(1,gO2)*(SUM(j3,0,2,Conj(
      ZV(gI1,3 + j3))*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj(Mv(j1,j3))*Yv(j1
      ,j2)))) + SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1
...
std::complex<double> CLASSNAME::CpSvconjSvVZVZ(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(7.745966692414834*g1*g2*Sin(2*ThetaW(
      )) + 3*Sqr(g1) + 5*Sqr(g2) + Cos(2*ThetaW())*(-3*Sqr(g1) + 5*Sqr(g2)))*SUM(
      j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1));
...
std::complex<double> CLASSNAME::CpSvconjSvVZ(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.5*(g2*Cos(ThetaW()) + 0.7745966692414834*
      g1*Sin(ThetaW()))*SUM(j1,0,2,Conj(ZV(gI2,j1))*ZV(gI1,j1));
...
std::complex<double> CLASSNAME::CpUChiFvconjSvPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,gO2)
      *SUM(j1,0,2,Conj(UV(gI2,j1))*ZV(gI1,j1)) - 0.7071067811865475*g2*
...
std::complex<double> CLASSNAME::CpUChiFvconjSvPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(KroneckerDelta(3,gO1)*SUM(j2,0,2,SUM(j1,0
      ,2,Conj(Yv(j1,j2))*UV(gI2,3 + j1))*ZV(gI1,j2)));
...
std::complex<double> CLASSNAME::CpUChiFvSvPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(KroneckerDelta(3,gO2)*SUM(j2,0,2,Conj(ZV(
...
std::complex<double> CLASSNAME::CpUChiFvSvPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,gO1)
      *SUM(j1,0,2,Conj(ZV(gI1,j1))*UV(gI2,j1)) - 0.7071067811865475*g2*
...
std::complex<double> CLASSNAME::CpbarChaUFvSePL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = Conj(UP(gI1,1))*SUM(j2,0,2,Conj(ZE(gI2,j2))
      *SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpFvUFvhhPL(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*SUM(j1,0,2,
      Conj(UV(gI2,3 + j1))*Yv(j1,gO2))*ZH(gI1,1),0) - 0.7071067811865475*SUM(j2,0,
      2,Conj(UV(gI2,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yv(j1,j2)))*ZH(gI1,
      1);
...
std::complex<double> CLASSNAME::CpFvUFvhhPR(int gI2, int gO1, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*SUM(j1,0,2,
      Conj(Yv(j1,gO1))*UV(gI2,3 + j1))*ZH(gI1,1),0) - 0.7071067811865475*SUM(j2,0,
      2,SUM(j1,0,2,Conj(Yv(j1,j2))*KroneckerDelta(gO1,3 + j1))*UV(gI2,j2))*ZH(gI1,
      1);
...
std::complex<double> CLASSNAME::CpbarFeUFvHpmPL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,SUM(j1,0,2,Conj(ZER(gI1,j1))*Ye(
      j1,gO2))*ZP(gI2,0),0);
...
std::complex<double> CLASSNAME::CpbarFeUFvVWmPL(int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*g2*ZEL(gI1,
      gO2),0);
...
std::complex<double> CLASSNAME::CpUFvChaconjSePL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,Conj(UM(gI2,1))*SUM(j1,0,2,Ye(j1
      ,gO2)*ZE(gI1,3 + j1)),0) + IF(gO2 < 3,-(g2*Conj(UM(gI2,0))*ZE(gI1,gO2)),0);
...
std::complex<double> CLASSNAME::CpChiUFvconjSvPL(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-(Conj(ZN(gI2,3))*SUM(j1,0,2,Yv(
      j1,gO2)*ZV(gI1,3 + j1))),0) + IF(gO2 < 3,0.5477225575051661*g1*Conj(ZN(gI2,0
      ))*ZV(gI1,gO2),0) + IF(gO2 < 3,-0.7071067811865475*g2*Conj(ZN(gI2,1))*ZV(gI1
      ,gO2),0);
...
std::complex<double> CLASSNAME::CpChiUFvSvPL(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = -(Conj(ZN(gI2,3))*SUM(j2,0,2,Conj(ZV(gI1,j2
      ))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yv(j1,j2))));
...
std::complex<double> CLASSNAME::CpbarUChaFeconjSvPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO2)*SUM(j1,0,2,Conj(
      ZEL(gI2,j1))*ZV(gI1,j1))) + KroneckerDelta(1,gO2)*SUM(j2,0,2,Conj(ZEL(gI2,j2
      ))*SUM(j1,0,2,Yv(j1,j2)*ZV(gI1,3 + j1)));
...
std::complex<double> CLASSNAME::CpbarUChaFvSePR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*SUM(j1,0,2,Conj(
      ZE(gI1,j1))*UV(gI2,j1))) + KroneckerDelta(1,gO1)*SUM(j2,0,2,SUM(j1,0,2,Conj(
      Ye(j1,j2))*Conj(ZE(gI1,3 + j1)))*UV(gI2,j2));
...
std::complex<double> CLASSNAME::CpbarUFeChaSvPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(ZV(gI1,gO1))*UP(gI2,0)
      ),0) + IF(gO1 < 3,SUM(j1,0,2,Conj(Yv(j1,gO1))*Conj(ZV(gI1,3 + j1)))*UP(gI2,1
      ),0);
...
std::complex<double> CLASSNAME::CpbarFeChaSvPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(g2*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZEL(gO1,j1
      ))*UP(gI2,0)) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*Conj(ZV(gI1,3 + j1)))*
      ZEL(gO1,j2))*UP(gI2,1);
...
std::complex<double> CLASSNAME::self_energy_Sd_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,5,A0(Sqr(MSv(gI1)))*CpUSdSvconjUSdconjSv(gO1,gI1,gO2,gI1))
      ;
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSd(gI1)),Sqr(MAh(gI2)))*Conj(
      CpAhSdconjUSd(gI2,gI1,gO2))*CpAhSdconjUSd(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSd(gI1)),Sqr(Mhh(gI2)))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Su_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,5,A0(Sqr(MSv(gI1)))*CpUSuSvconjUSuconjSv(gO1,gI1,gO2,gI1))
      ;
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSu(gI1)),Sqr(MAh(gI2)))*Conj(
      CpAhSuconjUSu(gI2,gI1,gO2))*CpAhSuconjUSu(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSu(gI1)),Sqr(Mhh(gI2)))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Se_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,5,A0(Sqr(MSv(gI1)))*CpUSeSvconjUSeconjSv(gO1,gI1,gO2,gI1))
      ;
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSe(gI1)),Sqr(MAh(gI2)))*Conj(
      CpAhSeconjUSe(gI2,gI1,gO2))*CpAhSeconjUSe(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSe(gI1)),Sqr(Mhh(gI2)))*Conj(
      CphhSeconjUSe(gI2,gI1,gO2))*CphhSeconjUSe(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MHpm(gI2)))*Conj(
      CpHpmconjUSeconjSv(gI2,gO2,gI1))*CpHpmconjUSeconjSv(gI2,gO1,gI1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MHpm(gI2)))*Conj(
   ...
   result += -2*SUM(gI1,0,5,MFv(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MCha(
      gI2)))*(Conj(CpFvChaconjUSePR(gI1,gI2,gO2))*CpFvChaconjUSePL(gI1,gI2,gO1) +
      Conj(CpFvChaconjUSePL(gI1,gI2,gO2))*CpFvChaconjUSePR(gI1,gI2,gO1))*MCha(gI2)
      ));
...
std::complex<double> CLASSNAME::self_energy_Sv_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,A0(Sqr(MAh(gI1)))*CpAhAhUSvconjUSv(gI1,gI1,gO1,gO2))
      ;
   result += -0.5*SUM(gI1,0,1,A0(Sqr(Mhh(gI1)))*CphhhhUSvconjUSv(gI1,gI1,gO1,gO2))
      ;
   ...
   result += -SUM(gI1,0,5,A0(Sqr(MSv(gI1)))*CpSvUSvconjSvconjUSv(gI1,gO1,gI1,gO2))
      ;
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MAh(gI2)))*Conj(
      CpAhconjSvconjUSv(gI2,gI1,gO2))*CpAhconjSvconjUSv(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MAh(gI2)))*Conj(
      CpAhSvconjUSv(gI2,gI1,gO2))*CpAhSvconjUSv(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(Mhh(gI2)))*Conj(
      CphhconjSvconjUSv(gI2,gI1,gO2))*CphhconjSvconjUSv(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(Mhh(gI2)))*Conj(
      CphhSvconjUSv(gI2,gI1,gO2))*CphhSvconjUSv(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSe(gI1)),Sqr(MHpm(gI2)))*Conj(
      CpHpmconjSeconjUSv(gI2,gI1,gO2))*CpHpmconjSeconjUSv(gI2,gI1,gO1)));
...
std::complex<double> CLASSNAME::self_energy_hh_1loop(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MSv(gI2)))*Conj(
      CpUhhSvSv(gO2,gI1,gI2))*CpUhhSvSv(gO1,gI1,gI2)));
   ...
   result += -SUM(gI1,0,5,MFv(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MFv(gI2
      )))*(Conj(CpFvFvUhhPR(gI1,gI2,gO2))*CpFvFvUhhPL(gI1,gI2,gO1) + Conj(
...
std::complex<double> CLASSNAME::self_energy_Ah_1loop(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MSv(gI2)))*Conj(
      CpUAhSvSv(gO2,gI1,gI2))*CpUAhSvSv(gO1,gI1,gI2)));
   result += 0.5*SUM(gI1,0,5,SUM(gI2,0,5,(Conj(CpFvFvUAhPL(gI1,gI2,gO2))*
      ...
      gI2,gO1))*G0(Sqr(p),Sqr(MFv(gI1)),Sqr(MFv(gI2)))));
   result += -SUM(gI1,0,5,MFv(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MFv(gI2
      )))*(Conj(CpFvFvUAhPR(gI1,gI2,gO2))*CpFvFvUAhPL(gI1,gI2,gO1) + Conj(
...
std::complex<double> CLASSNAME::self_energy_Hpm_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,5,MFv(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MFe(
      gI2)))*(Conj(CpFvFeconjUHpmPR(gI1,gI2,gO2))*CpFvFeconjUHpmPL(gI1,gI2,gO1) +
      Conj(CpFvFeconjUHpmPL(gI1,gI2,gO2))*CpFvFeconjUHpmPR(gI1,gI2,gO1))*MFe(gI2))
      );
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MSe(gI2)))*Conj(
      CpSeSvconjUHpm(gI2,gI1,gO2))*CpSeSvconjUHpm(gI2,gI1,gO1)));
...
std::complex<double> CLASSNAME::self_energy_VWm_1loop(double p ) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,2,(AbsSqr(CpFvFeconjVWmPL(gI1,gI2)) + AbsSqr(
      CpFvFeconjVWmPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFv(gI1)),Sqr(MFe(gI2))) + 4*B0(Sqr
      (p),Sqr(MFv(gI1)),Sqr(MFe(gI2)))*MFe(gI2)*MFv(gI1)*Re(Conj(CpFvFeconjVWmPL(
      gI1,gI2))*CpFvFeconjVWmPR(gI1,gI2))));
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MSv(gI1)))*Conj(
      CpUChiFvconjSvPL(gO2,gI2,gI1))*CpUChiFvconjSvPR(gO1,gI2,gI1)*MFv(gI2)));
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MSv(gI1)))*Conj(
      CpUChiFvSvPL(gO2,gI2,gI1))*CpUChiFvSvPR(gO1,gI2,gI1)*MFv(gI2)));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(MHpm(gI1)))*Conj(
      CpUFvFeconjHpmPL(gO2,gI2,gI1))*CpUFvFeconjHpmPR(gO1,gI2,gI1)*MFe(gI2)));
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(Mhh(gI1)))*Conj(
      CpFvUFvhhPL(gI2,gO2,gI1))*CpFvUFvhhPR(gI2,gO1,gI1)*MFv(gI2)));
   result += -4*SUM(gI1,0,2,B0(Sqr(p),Sqr(MFe(gI1)),Sqr(MVWm))*Conj(
      CpbarFeUFvVWmPL(gI1,gO2))*CpbarFeUFvVWmPR(gI1,gO1)*MFe(gI1));
   result += SUM(gI1,0,2,MFe(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFe(gI1)),Sqr(MHpm(gI2
      )))*Conj(CpbarFeUFvHpmPL(gI1,gO2,gI2))*CpbarFeUFvHpmPR(gI1,gO1,gI2)));
   result += SUM(gI1,0,5,MFv(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MAh(gI2)
      ))*Conj(CpFvUFvAhPL(gI1,gO2,gI2))*CpFvUFvAhPR(gI1,gO1,gI2)));
   result += SUM(gI1,0,5,SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MSe(gI1)))*Conj(
      CpUFvChaconjSePL(gO2,gI2,gI1))*CpUFvChaconjSePR(gO1,gI2,gI1)*MCha(gI2)));
   result += SUM(gI1,0,5,SUM(gI2,0,3,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSv(gI1)))*Conj(
      CpChiUFvconjSvPL(gI2,gO2,gI1))*CpChiUFvconjSvPR(gI2,gO1,gI1)*MChi(gI2)));
   result += SUM(gI1,0,5,SUM(gI2,0,3,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSv(gI1)))*Conj(
      CpChiUFvSvPL(gI2,gO2,gI1))*CpChiUFvSvPR(gI2,gO1,gI1)*MChi(gI2)));
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(MVWm))*Conj(
      CpUFvFeconjVWmPR(gO2,gI2))*CpUFvFeconjVWmPL(gO1,gI2)*MFe(gI2));
   result += -4*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ))*Conj(CpFvUFvVZPL(gI2
      ,gO2))*CpFvUFvVZPR(gI2,gO1)*MFv(gI2));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,2,B1(Sqr(p),Sqr(MFe(gI1)),Sqr(MVWm))*Conj(CpbarFeUFvVWmPR(
      gI1,gO2))*CpbarFeUFvVWmPR(gI1,gO1));
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVWm))*Conj(CpUFvFeconjVWmPL
      (gO2,gI2))*CpUFvFeconjVWmPL(gO1,gI2));
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ))*Conj(CpFvUFvVZPR(gI2,
      gO2))*CpFvUFvVZPR(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,2,B1(Sqr(p),Sqr(MFe(gI1)),Sqr(MVWm))*Conj(CpbarFeUFvVWmPL(
      gI1,gO2))*CpbarFeUFvVWmPL(gI1,gO1));
   result += -0.5*SUM(gI1,0,2,SUM(gI2,0,1,B1(Sqr(p),Sqr(MFe(gI1)),Sqr(MHpm(gI2)))*
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVWm))*Conj(CpUFvFeconjVWmPR
      (gO2,gI2))*CpUFvFeconjVWmPR(gO1,gI2));
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ))*Conj(CpFvUFvVZPL(gI2,
      gO2))*CpFvUFvVZPL(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MSe(gI1)))*Conj(
      CpbarUChaFvSePL(gO2,gI2,gI1))*CpbarUChaFvSePR(gO1,gI2,gI1)*MFv(gI2)));
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(Mhh(gI1)))*Conj(
      CpbarUFeFehhPL(gO2,gI2,gI1))*CpbarUFeFehhPR(gO1,gI2,gI1)*MFe(gI2)));
   result += SUM(gI1,0,1,SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MHpm(gI1)))*Conj(
      CpbarUFeFvHpmPL(gO2,gI2,gI1))*CpbarUFeFvHpmPR(gO1,gI2,gI1)*MFv(gI2)));
   result += SUM(gI1,0,2,MFe(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFe(gI1)),Sqr(MAh(gI2)
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(CpbarUFeFvVWmPL(
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(CpbarUFeFvVWmPR(
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFd(gI2)),Sqr(Mhh(gI1)))*Conj(
   ...
   result += SUM(gI1,0,2,MFd(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFd(gI1)),Sqr(MAh(gI2)
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI2)),Sqr(Mhh(gI1)))*Conj(
   ...
   result += SUM(gI1,0,2,MFu(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFu(gI1)),Sqr(MAh(gI2)
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_1_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -4*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(CpbarFeFvVWmPR
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PR_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(CpbarFeFvVWmPL(
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PL_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(CpbarFeFvVWmPR(
...
std::complex<double> CLASSNAME::tadpole_hh_1loop(int gO1) const
{
   ...
   result += SUM(gI1,0,5,A0(Sqr(MFv(gI1)))*(CpFvFvUhhPL(gI1,gI1,gO1) + CpFvFvUhhPR
      (gI1,gI1,gO1))*MFv(gI1));
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMRHN_info::hh, eigenvalue_error >
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMRHN_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMRHN_info::Hpm, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
