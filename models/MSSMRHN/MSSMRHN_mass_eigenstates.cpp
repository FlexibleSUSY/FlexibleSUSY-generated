...
CLASSNAME::MSSMRHN_mass_eigenstates(const MSSMRHN_input_parameters& input_)
   ...
   , MVG(0), MGlu(0), MVP(0), MVZ(0), MSd(Eigen::Array<double,6,1>::Zero()),
      ...
      , MSv(Eigen::Array<double,6,1>::Zero()), Mhh(Eigen::Array<double,2,1>::Zero(
      )), MAh(Eigen::Array<double,2,1>::Zero()), MHpm(Eigen::Array<double,2,1>
      ::Zero()), MChi(Eigen::Array<double,4,1>::Zero()), MFv(Eigen::Array<double,6
      ,1>::Zero()), MCha(Eigen::Array<double,2,1>::Zero()), MFe(Eigen::Array<
...
std::complex<double> CLASSNAME::CpconjUSdSuHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_273 += KroneckerDelta(gO2,3 + j1)*Yd(j1,j2);
      }
      tmp_272 += tmp_273;
      tmp_271 += (Conj(ZU(gI1,j2))) * tmp_272;
   }
   tmp_270 += tmp_271;
   result += (Conj(Mu)*Conj(ZP(gI2,1))) * tmp_270;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_277 += KroneckerDelta(gO2,3 + j1)*TYd(j1,j2);
      }
      tmp_276 += tmp_277;
      tmp_275 += (Conj(ZU(gI1,j2))) * tmp_276;
   }
   tmp_274 += tmp_275;
   result += (Conj(ZP(gI2,0))) * tmp_274;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_283 += Conj(Yu(j3,j1))*Yd(j2,j1);
         }
         tmp_282 += tmp_283;
         tmp_281 += (KroneckerDelta(gO2,3 + j2)) * tmp_282;
      }
      tmp_280 += tmp_281;
      tmp_279 += (Conj(ZU(gI1,3 + j3))) * tmp_280;
   }
   tmp_278 += tmp_279;
   result += (0.7071067811865475*vu*Conj(ZP(gI2,0))) * tmp_278;
   ...
   tmp_284 += tmp_285;
   result += (0.7071067811865475*vd*Conj(ZP(gI2,1))) * tmp_284;
   if (gO2 < 3) {
   ...
   if (gO2 < 3) {
      ...
      tmp_290 += tmp_291;
      result += (Conj(ZP(gI2,0))*Mu) * tmp_290;
   }
   if (gO2 < 3) {
      std::complex<double> tmp_292;
      std::complex<double> tmp_293;
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_293 += Conj(ZU(gI1,3 + j1))*Conj(TYu(j1,gO2));
      }
      tmp_292 += tmp_293;
      result += (Conj(ZP(gI2,1))) * tmp_292;
   }
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_297 += Conj(Yd(j1,gO2))*Yd(j1,j2);
         }
         tmp_296 += tmp_297;
         tmp_295 += (Conj(ZU(gI1,j2))) * tmp_296;
      }
      tmp_294 += tmp_295;
      result += (0.7071067811865475*vd*Conj(ZP(gI2,0))) * tmp_294;
   }
   if (gO2 < 3) {
      ...
      tmp_298 += tmp_299;
      result += (0.7071067811865475*vu*Conj(ZP(gI2,1))) * tmp_298;
   }
...
std::complex<double> CLASSNAME::CpUSuconjUSuconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_322 += tmp_323;
   result += (-0.2*Conj(ZP(gI2,0))*Sqr(g1)*ZP(gI1,0)) * tmp_322;
   if (gO1 < 3) {
      result += 0.05*Conj(ZP(gI2,0))*KroneckerDelta(gO1,gO2)*Sqr(g1)*ZP(gI1,
         0);
   }
   ...
   if (gO1 < 3 && gO2 < 3) {
      ...
      tmp_324 += tmp_325;
      result += (-(Conj(ZP(gI2,0))*ZP(gI1,0))) * tmp_324;
   }
   ...
   tmp_326 += tmp_327;
   result += (0.2*Conj(ZP(gI2,1))*Sqr(g1)*ZP(gI1,1)) * tmp_326;
   ...
   tmp_328 += tmp_329;
   result += (-(Conj(ZP(gI2,1))*ZP(gI1,1))) * tmp_328;
   if (gO1 < 3) {
      result += -0.05*Conj(ZP(gI2,1))*KroneckerDelta(gO1,gO2)*Sqr(g1)*ZP(gI1
         ,1);
   }
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_630 += tmp_631;
   result += (0.3*Conj(ZP(gI2,0))*Sqr(g1)*ZP(gI1,0)) * tmp_630;
   ...
   tmp_632 += tmp_633;
   result += (-(Conj(ZP(gI2,0))*ZP(gI1,0))) * tmp_632;
   if (gO1 < 3) {
   ...
   tmp_638 += tmp_639;
   result += (-0.3*Conj(ZP(gI2,1))*Sqr(g1)*ZP(gI1,1)) * tmp_638;
   if (gO1 < 3) {
   ...
   if (gO1 < 3 && gO2 < 3) {
      ...
      tmp_640 += tmp_641;
      result += (-(Conj(ZP(gI2,1))*ZP(gI1,1))) * tmp_640;
   }
...
std::complex<double> CLASSNAME::CpconjUSeconjSvHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      tmp_826 += tmp_827;
      result += (0.5*Conj(ZP(gI2,1))) * tmp_826;
   }
   if (gO2 < 3) {
      ...
      tmp_830 += tmp_831;
      result += (0.5*Conj(ZP(gI2,1))) * tmp_830;
   }
...
std::complex<double> CLASSNAME::CpconjUSeSvHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_875 += KroneckerDelta(gO2,3 + j1)*Ye(j1,j2);
      }
      tmp_874 += tmp_875;
      tmp_873 += (Conj(ZV(gI1,j2))) * tmp_874;
   }
   tmp_872 += tmp_873;
   result += (Conj(Mu)*Conj(ZP(gI2,1))) * tmp_872;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_879 += KroneckerDelta(gO2,3 + j1)*TYe(j1,j2);
      }
      tmp_878 += tmp_879;
      tmp_877 += (Conj(ZV(gI1,j2))) * tmp_878;
   }
   tmp_876 += tmp_877;
   result += (Conj(ZP(gI2,0))) * tmp_876;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_885 += Conj(Yv(j3,j1))*Ye(j2,j1);
         }
         tmp_884 += tmp_885;
         tmp_883 += (KroneckerDelta(gO2,3 + j2)) * tmp_884;
      }
      tmp_882 += tmp_883;
      tmp_881 += (Conj(ZV(gI1,3 + j3))) * tmp_882;
   }
   tmp_880 += tmp_881;
   result += (0.7071067811865475*vu*Conj(ZP(gI2,0))) * tmp_880;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_891 += Conj(Yv(j3,j1))*Ye(j2,j1);
         }
         tmp_890 += tmp_891;
         tmp_889 += (KroneckerDelta(gO2,3 + j2)) * tmp_890;
      }
      tmp_888 += tmp_889;
      tmp_887 += (Conj(ZV(gI1,3 + j3))) * tmp_888;
   }
   tmp_886 += tmp_887;
   result += (0.7071067811865475*vd*Conj(ZP(gI2,1))) * tmp_886;
   if (gO2 < 3) {
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_893 += Conj(Yv(j1,gO2))*Conj(ZV(gI1,3 + j1));
      }
      tmp_892 += tmp_893;
      result += (Conj(ZP(gI2,0))*Mu) * tmp_892;
   }
   if (gO2 < 3) {
      std::complex<double> tmp_894;
      std::complex<double> tmp_895;
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_895 += Conj(ZV(gI1,3 + j1))*Conj(TYv(j1,gO2));
      }
      tmp_894 += tmp_895;
      result += (Conj(ZP(gI2,1))) * tmp_894;
   }
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_899 += Conj(Ye(j1,gO2))*Ye(j1,j2);
         }
         tmp_898 += tmp_899;
         tmp_897 += (Conj(ZV(gI1,j2))) * tmp_898;
      }
      tmp_896 += tmp_897;
      result += (0.7071067811865475*vd*Conj(ZP(gI2,0))) * tmp_896;
   }
   if (gO2 < 3) {
      ...
      tmp_900 += tmp_901;
      result += (0.7071067811865475*vu*Conj(ZP(gI2,1))) * tmp_900;
   }
...
std::complex<double> CLASSNAME::CpUSvconjUSvconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3 && gO2 < 3) {
      ...
      tmp_922 += tmp_923;
      result += (-(Conj(ZP(gI2,0))*ZP(gI1,0))) * tmp_922;
   }
   ...
   tmp_924 += tmp_925;
   result += (-(Conj(ZP(gI2,1))*ZP(gI1,1))) * tmp_924;
   if (gO1 < 3) {
      result += 0.15*Conj(ZP(gI2,1))*KroneckerDelta(gO1,gO2)*Sqr(g1)*ZP(gI1,
         1);
   }
...
std::complex<double> CLASSNAME::CpconjUSvconjSeHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1068 += tmp_1074;
   result += (0.5*Conj(ZP(gI2,1))) * tmp_1068;
...
std::complex<double> CLASSNAME::CpconjUSvconjSvAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1079 += tmp_1080;
   result += (std::complex<double>(0,0.35355339059327373)*ZA(gI2,1)) * tmp_1079
      ;
   ...
   tmp_1085 += tmp_1086;
   result += (std::complex<double>(0,0.35355339059327373)*ZA(gI2,1)) * tmp_1085
      ;
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpconjUSvSvAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1125 += tmp_1126;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,1)) * tmp_1125
      ;
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUhhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1300 += tmp_1301;
   tmp_1279 += (std::complex<double>(0,0.7071067811865475)*KroneckerDelta(1,gO2
      )*Mu) * tmp_1300;
...
std::complex<double> CLASSNAME::CpUhhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1341 += tmp_1342;
   tmp_1320 += (std::complex<double>(0,0.7071067811865475)*KroneckerDelta(1,gO2
      )*Mu) * tmp_1341;
...
std::complex<double> CLASSNAME::CpUhhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1382 += tmp_1383;
   tmp_1361 += (std::complex<double>(0,0.7071067811865475)*KroneckerDelta(0,gO2
      )*Mu) * tmp_1382;
...
std::complex<double> CLASSNAME::CpUhhconjSvSv(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1419 += tmp_1420;
   tmp_1402 += (std::complex<double>(0,0.7071067811865475)*KroneckerDelta(0,gO2
      )*Mu) * tmp_1419;
...
std::complex<double> CLASSNAME::CpUAhSvSv(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1662 += tmp_1678;
   result += (std::complex<double>(0,-0.35355339059327373)*KroneckerDelta(1,gO2
      )) * tmp_1662;
...
std::complex<double> CLASSNAME::CpUChiconjSdFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1991 += tmp_1992;
   tmp_1990 += (std::complex<double>(0,-0.3651483716701107)*g1*KroneckerDelta(0
      ,gO1)) * tmp_1991;
...
std::complex<double> CLASSNAME::CpUChiconjSeFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2007 += tmp_2008;
   tmp_2006 += (std::complex<double>(0,-1.0954451150103321)*g1*KroneckerDelta(0
      ,gO1)) * tmp_2007;
...
std::complex<double> CLASSNAME::CpUChiconjSuFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2016 += tmp_2017;
   tmp_2013 += (std::complex<double>(0,-0.7071067811865475)*g2*KroneckerDelta(1
      ,gO2)) * tmp_2016;
...
std::complex<double> CLASSNAME::CpUChiconjSvFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2032 += tmp_2033;
   tmp_2029 += (std::complex<double>(0,-0.7071067811865475)*g2*KroneckerDelta(1
      ,gO2)) * tmp_2032;
...
std::complex<double> CLASSNAME::CpUFvFvAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2066 += tmp_2067;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,1)) * tmp_2066
      ;
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpbarFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2212 += tmp_2213;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,0)) * tmp_2212
      ;
...
std::complex<double> CLASSNAME::CpbarFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2260 += tmp_2261;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,0)) * tmp_2260
      ;
...
std::complex<double> CLASSNAME::CpbarFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_2324 += tmp_2325;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,1)) * tmp_2324
      ;
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   for (unsigned es = 0; es < 6; ++es) {
      ...
      #ifdef CHECK_EIGENVALUE_ERROR
         double eigenvalue_error;
         fs_diagonalize_symmetric(M_1loop, eigen_values, mix_UV,
            eigenvalue_error);
