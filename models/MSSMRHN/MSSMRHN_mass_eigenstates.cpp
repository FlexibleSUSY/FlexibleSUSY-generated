...
{
   return std::make_unique<MSSMRHN_mass_eigenstates>(*this);
}
...
std::complex<double> CLASSNAME::CpAhconjSvconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0.,
      ...
      gI1,3 + j2))*ZA(gI2,1),0) + IF(gO2 < 3,std::complex<double>(0.,
      0.35355339059327373)*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,gO2))*Mv(j2,j1))*ZV(
      gI1,3 + j2))*ZA(gI2,1),0) + std::complex<double>(0.,0.35355339059327373)*(
      SUM(j3,0,2,SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*
      Mv(j1,j2)))*ZV(gI1,j3)) + SUM(j3,0,2,SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*
      SUM(j1,0,2,Conj(Yv(j1,j3))*Mv(j2,j1)))*ZV(gI1,j3)))*ZA(gI2,1);
...
std::complex<double> CLASSNAME::CphhconjSvconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*SUM(j2,0,2,
      SUM(j1,0,2,Conj(Yv(j1,gO2))*Mv(j1,j2))*ZV(gI1,3 + j2))*ZH(gI2,1),0) + IF(gO2
       < 3,-0.35355339059327373*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,gO2))*Mv(j2,j1))*
      ZV(gI1,3 + j2))*ZH(gI2,1),0) - 0.35355339059327373*(SUM(j3,0,2,SUM(j2,0,2,
      KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Mv(j1,j2)))*ZV(gI1,j3)
      ) + SUM(j3,0,2,SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,
      j3))*Mv(j2,j1)))*ZV(gI1,j3)))*ZH(gI2,1);
...
std::complex<double> CLASSNAME::CpUhhSdconjSd(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(-(KroneckerDelta(1,gO2)*(vu*(Sqr(g1)
      + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) + 2*vu*Sqr(g1)*SUM(j1,0
      ,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) - 14.142135623730951*(Conj(Mu)*SUM(
...
double CLASSNAME::calculate_MVZ_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMRHN_info::VZ);return m_pole;
   }
...
double CLASSNAME::calculate_MVWm_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMRHN_info::VWm);return m_pole;
   }
