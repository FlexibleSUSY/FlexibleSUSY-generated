...
/**
 * @file MSSMRHN_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSMRHN_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSMRHN_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class MSSMRHN_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMRHN_mass_eigenstates_decoupling_scheme
   : private MSSMRHN_soft_parameters
   , public MSSMRHN_mass_eigenstates_interface
{
public:
   explicit MSSMRHN_mass_eigenstates_decoupling_scheme(const MSSMRHN_input_parameters& input_ = MSSMRHN_input_parameters());
   explicit MSSMRHN_mass_eigenstates_decoupling_scheme(const MSSMRHN_mass_eigenstates&);
   MSSMRHN_mass_eigenstates_decoupling_scheme(const MSSMRHN_mass_eigenstates_decoupling_scheme&) = default;
   MSSMRHN_mass_eigenstates_decoupling_scheme(MSSMRHN_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSMRHN_mass_eigenstates_decoupling_scheme() = default;
   MSSMRHN_mass_eigenstates_decoupling_scheme& operator=(const MSSMRHN_mass_eigenstates_decoupling_scheme&) = default;
   MSSMRHN_mass_eigenstates_decoupling_scheme& operator=(MSSMRHN_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const MSSMRHN_mass_eigenstates&);
...
std::ostream& operator<<(std::ostream&, const MSSMRHN_mass_eigenstates_decoupling_scheme&);
