 ...
 *
 * This file was generated at Tue 22 Jan 2019 17:52:29 with FlexibleSUSY
...
double calculate_a_muon_impl(MSSMRHN_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MSSMRHN_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMRHN_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MSSMRHN_a_muon::calculate_a_muon(const MSSMRHN_mass_eigenstates& model_)
{
...
double MSSMRHN_a_muon::calculate_a_muon_uncertainty(const MSSMRHN_mass_eigenstates& model_)
{
   MSSMRHN_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMRHN_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
