...
public:
   ...
   MSSMRHN_susy_parameters& operator=(const MSSMRHN_susy_parameters&) = default;
   MSSMRHN_susy_parameters& operator=(MSSMRHN_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSMRHN_input_parameters& get_input() const;
   MSSMRHN_input_parameters& get_input();
   void set_input_parameters(const MSSMRHN_input_parameters&);

   MSSMRHN_susy_parameters calc_beta() const;
   MSSMRHN_susy_parameters calc_beta(int) const;
   virtual void clear();
   ...
   void set_Yv(int i, int k, const double& value) { Yv(i,k) = value; }
   void set_Mu(double Mu_) { Mu = Mu_; }
   void set_Mv(const Eigen::Matrix<double,3,3>& Mv_) { Mv = Mv_; }
   void set_Mv(int i, int k, const double& value) { Mv(i,k) = value; }
   ...
   const Eigen::Matrix<double,3,3>& get_Mv() const { return Mv; }
   double get_Mv(int i, int k) const { return Mv(i,k); }
...
protected:
   ...
   Eigen::Matrix<double,3,3> Yv{Eigen::Matrix<double,3,3>::Zero()};
   double Mu{};
   Eigen::Matrix<double,3,3> Mv{Eigen::Matrix<double,3,3>::Zero()};
   double g1{};
   double g2{};
   double g3{};
   double vd{};
...
private:
   ...
   Eigen::Matrix<double,3,3> calc_beta_Yv_1_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Yv_2_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Yv_3_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Yv_4_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Yv_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   Eigen::Matrix<double,3,3> calc_beta_Mv_1_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Mv_2_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Mv_3_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Mv_4_loop(const TRACE_STRUCT_TYPE&) const;
   Eigen::Matrix<double,3,3> calc_beta_Mv_5_loop(const TRACE_STRUCT_TYPE&) const;
...
std::ostream& operator<<(std::ostream&, const MSSMRHN_susy_parameters&);
