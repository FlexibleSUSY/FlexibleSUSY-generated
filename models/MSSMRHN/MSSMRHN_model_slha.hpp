...
class MSSMRHN_slha : public MSSMRHN_mass_eigenstates {
public:
   explicit MSSMRHN_slha(const MSSMRHN_input_parameters& input_ = MSSMRHN_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MSSMRHN_slha(const MSSMRHN_mass_eigenstates&, bool do_convert_masses_to_slha = true);
