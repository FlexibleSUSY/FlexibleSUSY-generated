...
#include "decays/MSSMRHN_decays.hpp"
...
public:
   ...
   void set_decays(const MSSMRHN_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const MSSMRHN_slha&, const MSSMRHN_scales&, const MSSMRHN_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const MSSMRHN_slha&);
   ...
   void fill_decays_data(const MSSMRHN_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMRHN_scales&, const MSSMRHN_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MSSMRHN_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const MSSMRHN_slha&);
...
void MSSMRHN_slha_io::fill(
   ...
   MSSMRHN_decays const * const decays)
{
