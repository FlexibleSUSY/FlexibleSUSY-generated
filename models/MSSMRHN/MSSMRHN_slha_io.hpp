...
public:
   ...
   template <class T> void set_extra(const MSSMRHN_slha<T>&, const MSSMRHN_scales&);
   ...
   static void convert_to_slha_convention(MSSMRHN_physical&);
...
private:
   ...
   template <class T> void set_model_parameters(const MSSMRHN_slha<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(MSSMRHN_slha<T>&) const;
   template <class T> void fill_physical(MSSMRHN_slha<T>&) const;
};
 ...
 */
template <class T>
void MSSMRHN_slha_io::fill(MSSMRHN_slha<T>& model) const
{
 ...
 */
template <class T>
void MSSMRHN_slha_io::fill_drbar_parameters(MSSMRHN_slha<T>& model) const
{
 ...
 */
template <class T>
void MSSMRHN_slha_io::fill_physical(MSSMRHN_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
   ...
   PHYSICAL(MSv)(3) = slha_io.read_entry("MASS", 2000012);
   PHYSICAL(MSv)(4) = slha_io.read_entry("MASS", 2000014);
   PHYSICAL(MSv)(5) = slha_io.read_entry("MASS", 2000016);
   ...
   PHYSICAL(MFv)(3) = slha_io.read_entry("MASS", 9900012);
   PHYSICAL(MFv)(4) = slha_io.read_entry("MASS", 9900014);
   PHYSICAL(MFv)(5) = slha_io.read_entry("MASS", 9900016);
...
{
   SLHAea::Coll slhaea;
   MSSMRHN_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
 ...
 */
template <class T>
void MSSMRHN_slha_io::set_model_parameters(const MSSMRHN_slha<T>& model)
{
   {
...
{
   const MSSMRHN_slha<T> model_slha(model);
 ...
 */
template <class T>
void MSSMRHN_slha_io::set_spectrum(const MSSMRHN_slha<T>& model)
{
   const MSSMRHN_physical physical(model.get_physical_slha());
