...
public:
   ...
   void set_extra(const MSSMRHN_slha&, const MSSMRHN_scales&, const MSSMRHN_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMRHN_scales&, const MSSMRHN_observables&);
