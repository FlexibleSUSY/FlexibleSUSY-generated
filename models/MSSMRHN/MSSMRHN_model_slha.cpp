...
MSSMRHN_slha::MSSMRHN_slha(const MSSMRHN_input_parameters& input_,
 ...
 */
MSSMRHN_slha::MSSMRHN_slha(const MSSMRHN_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MSSMRHN_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MSSMRHN_slha::clear()
{
   MSSMRHN_mass_eigenstates::clear();
   physical_slha.clear();
}

void MSSMRHN_slha::calculate_spectrum()
{
   MSSMRHN_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MSSMRHN_slha::convert_to_slha()
{
...
void MSSMRHN_slha::calculate_ckm_matrix()
{
...
void MSSMRHN_slha::calculate_pmns_matrix()
{
 ...
 */
void MSSMRHN_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MSSMRHN_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MSSMRHN_slha::convert_soft_squared_masses_to_slha()
{
...
const MSSMRHN_physical& MSSMRHN_slha::get_physical_slha() const
{
   return physical_slha;
}

MSSMRHN_physical& MSSMRHN_slha::get_physical_slha()
{
   return physical_slha;
}

void MSSMRHN_slha::print(std::ostream& ostr) const
{
   MSSMRHN_mass_eigenstates::print(ostr);
...
void MSSMRHN_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MSSMRHN_slha& model)
{
   model.print(ostr);
   return ostr;
}
