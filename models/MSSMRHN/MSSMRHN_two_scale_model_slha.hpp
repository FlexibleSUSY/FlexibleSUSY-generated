...
// File generated at Sun 31 May 2015 12:46:22
...
public:
   ...
   explicit MSSMRHN_slha(const MSSMRHN<Two_scale>&);
   ...
   const std::complex<double>& get_UV_pole_slha(int i, int k) const { return physical_slha.UV(i,k); }
