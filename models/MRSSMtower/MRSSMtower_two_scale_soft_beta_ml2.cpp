...
// File generated at Sat 15 Oct 2016 15:08:53
 ...
 */
Eigen::Matrix<double,3,3> MRSSMtower_soft_parameters::calc_beta_ml2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSMtower_soft_parameters::calc_beta_ml2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_ml2 = (twoLoop*(0.2*(-10*(2*mHd2 + mRd2 + mS2)*AbsSqr(LamSD) - 15
      ...
      *ml2) + (6*Power(g2,4)*Tr22 + 0.4*g1*(3*g1*Tr2U111 - 7.745966692414834*
      Tr31))*UNITMATRIX(3))).real();
 ...
 */
Eigen::Matrix<double,3,3> MRSSMtower_soft_parameters::calc_beta_ml2_three_loop(const Soft_traces& soft_traces) const
{
