...
// File generated at Mon 27 Feb 2017 13:21:59
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_MuD_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_MuD_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_MuD_three_loop(const Susy_traces& susy_traces) const
{
