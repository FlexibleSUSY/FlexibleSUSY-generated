...
// File generated at Thu 15 Dec 2016 12:39:18
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamSU_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamSU_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamSU_three_loop(const Susy_traces& susy_traces) const
{
