...
// File generated at Mon 27 Feb 2017 13:22:18
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mRd2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mRd2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mRd2 = Re(twoLoop*(6*Power(g2,4)*Tr22 + 3.0983866769659336*g1*
      ...
      traceml2AdjYeYe - 3*tracemq2AdjYdYd - 6*mHd2*traceYdAdjYd - 3*mRd2*
      traceYdAdjYd - 3*mT2*traceYdAdjYd - 2*mHd2*traceYeAdjYe - mRd2*
      traceYeAdjYe - mT2*traceYeAdjYe - (mHd2 + mHu2 + mRd2 + mRu2 + 2*mT2)*
      AbsSqr(LamTU) + 4*(mHd2 + mRd2 + mT2)*Sqr(g2)) - 12*(mHd2 + mRd2 + mS2)*
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mRd2_three_loop(const Soft_traces& soft_traces) const
{
