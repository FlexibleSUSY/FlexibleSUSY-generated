 ...
 */
double MRSSMtower_soft_parameters::calc_beta_MDGoc_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_MDGoc_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_MDGoc_three_loop(const Soft_traces& soft_traces) const
{
