...
// File generated at Wed 12 Apr 2017 10:52:20
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamTD_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamTD_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamTD_three_loop(const Susy_traces& susy_traces) const
{
