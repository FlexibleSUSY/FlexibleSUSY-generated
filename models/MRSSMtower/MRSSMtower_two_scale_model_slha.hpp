...
/**
 * @file MRSSMtower_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Wed 12 Apr 2017 11:40:21

#ifndef MRSSMtower_TWO_SCALE_SLHA_H
#define MRSSMtower_TWO_SCALE_SLHA_H

#include "MRSSMtower_two_scale_model.hpp"
#include "MRSSMtower_physical.hpp"
#include "MRSSMtower_model_slha.hpp"
...
/**
 * @class MRSSMtower_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class MRSSMtower_slha<Two_scale> : public MRSSMtower<Two_scale> {
public:
   explicit MRSSMtower_slha(const MRSSMtower_input_parameters& input_ = MRSSMtower_input_parameters());
   explicit MRSSMtower_slha(const MRSSMtower<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~MRSSMtower_slha();
   ...
   const MRSSMtower_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MRSSMtower_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MRSSMtower_physical physical_slha; ///< contains the pole masses and mixings in slha convention
