...
// File generated at Sat 15 Oct 2016 15:08:41
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamSD_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamSD_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_LamSD_three_loop(const Susy_traces& susy_traces) const
{
