...
class MRSSMtower_soft_parameters : public MRSSMtower_susy_parameters {
public:
   explicit MRSSMtower_soft_parameters(const MRSSMtower_input_parameters& input_ = MRSSMtower_input_parameters());
   MRSSMtower_soft_parameters(const MRSSMtower_susy_parameters& , double BMu_, double BMuD_, double BMuU_, const Eigen::Matrix<double,3,3>&
   ...
   virtual ~MRSSMtower_soft_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   MRSSMtower_soft_parameters calc_beta() const;
   MRSSMtower_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MRSSMtower_soft_parameters&);
