 ...
 */
double MRSSMtower_susy_parameters::calc_beta_vd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_vd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_vd = Re(-0.025*twoLoop*vd*(45*Power(g1,4) + 145*Power(g2,4) - 360
 ...
 */
double MRSSMtower_susy_parameters::calc_beta_vd_three_loop(const Susy_traces& susy_traces) const
{
