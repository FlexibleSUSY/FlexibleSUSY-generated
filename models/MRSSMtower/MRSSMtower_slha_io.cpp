...
char const * const MRSSMtower_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "HMIX", "MSQ2", "MSE2", "MSL2", "MSU2", "MSD2",
   "MSOFT", "NMSSMRUN" }
;

MRSSMtower_slha_io::MRSSMtower_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MRSSMtower_slha_io::clear()
{
   slha_io.clear();
}

void MRSSMtower_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void MRSSMtower_slha_io::set_extpar(const MRSSMtower_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MRSSMtower_slha_io::set_minpar(const MRSSMtower_input_parameters& input)
{
 ...
 */
void MRSSMtower_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MRSSMtower_slha_io::set_spinfo(const Problems<MRSSMtower_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void MRSSMtower_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MRSSMtower_info::model_name)
 ...
 */
void MRSSMtower_slha_io::set_mass(const MRSSMtower_physical& physical,
 ...
 */
void MRSSMtower_slha_io::set_mixing_matrices(const MRSSMtower_physical& physical,
...
void MRSSMtower_slha_io::set_ckm(
...
void MRSSMtower_slha_io::set_pmns(
 ...
 */
void MRSSMtower_slha_io::write_to(const std::string& output)
{
   if (output == "-")
 ...
 */
double MRSSMtower_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MRSSMtower_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MRSSMtower_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MRSSMtower_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MRSSMtower_slha_io::fill(MRSSMtower_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&MRSSMtower_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&MRSSMtower_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void MRSSMtower_slha_io::fill_drbar_parameters(MRSSMtower_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MRSSMtower_slha_io::fill(MRSSMtower_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MRSSMtower_physical physical_hk;
 ...
 */
void MRSSMtower_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MRSSMtower_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void MRSSMtower_slha_io::fill_minpar_tuple(MRSSMtower_input_parameters& input,
...
void MRSSMtower_slha_io::fill_extpar_tuple(MRSSMtower_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MRSSMtower_slha_io::fill_physical(MRSSMtower_physical& physical) const
{
   {
 ...
 */
double MRSSMtower_slha_io::read_scale() const
{
   double scale = 0.;
