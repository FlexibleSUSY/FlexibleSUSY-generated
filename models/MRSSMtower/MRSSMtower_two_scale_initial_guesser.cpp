...
{
   assert(model && "MRSSMtower_initial_guesser: Error: pointer to model"
          " MRSSMtower<Two_scale> must not be zero");
}
 ...
 */
void MRSSMtower_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 */
void MRSSMtower_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void MRSSMtower_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MRSSMtower_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MRSSMtower_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MRSSMtower_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MRSSMtower_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
