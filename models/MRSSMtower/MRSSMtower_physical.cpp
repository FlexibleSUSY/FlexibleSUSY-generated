...
MRSSMtower_physical::MRSSMtower_physical()
   :
...
void MRSSMtower_physical::clear()
{
   MVG = 0.;
   MGlu = 0.;
 ...
 * to be complex.
 */
void MRSSMtower_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void MRSSMtower_physical::convert_to_slha()
{

}

Eigen::ArrayXd MRSSMtower_physical::get() const
{
...
void MRSSMtower_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MRSSMtower_physical::get_masses() const
{
...
void MRSSMtower_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void MRSSMtower_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MRSSMtower_physical& phys_pars)
{
