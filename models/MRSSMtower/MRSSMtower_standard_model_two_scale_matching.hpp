...
#ifndef MRSSMtower_TWO_SCALE_MATCHING_H
#define MRSSMtower_TWO_SCALE_MATCHING_H
...
template <class T> class MRSSMtower;
template <class T> class MRSSMtower_standard_model_Matching;
...
template<>
class MRSSMtower_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MRSSMtower_standard_model_Matching();

   MRSSMtower_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MRSSMtower<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MRSSMtower_standard_model_Matching();
