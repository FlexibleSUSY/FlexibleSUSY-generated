 ...
 */
double MRSSMtower_soft_parameters::calc_beta_MDBS_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_MDBS_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_MDBS_three_loop(const Soft_traces& soft_traces) const
{
