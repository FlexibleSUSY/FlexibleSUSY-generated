...
// File generated at Wed 12 Apr 2017 10:52:31
...
const int MRSSMtower_soft_parameters::numberOfParameters;

MRSSMtower_soft_parameters::MRSSMtower_soft_parameters(const MRSSMtower_input_parameters& input_)
   : MRSSMtower_susy_parameters(input_)
   , BMu(0), BMuD(0), BMuU(0), mq2(Eigen::Matrix<double,3,3>::Zero()), ml2(
   Eigen::Matrix<double,3,3>::Zero()), mHd2(0), mHu2(0), md2(Eigen::Matrix<
   double,3,3>::Zero()), mu2(Eigen::Matrix<double,3,3>::Zero()), me2(
   Eigen::Matrix<double,3,3>::Zero()), mS2(0), mT2(0), moc2(0), mRd2(0), mRu2(0
   ), MDBS(0), MDWBT(0), MDGoc(0)

{
   set_number_of_parameters(numberOfParameters);
}

MRSSMtower_soft_parameters::MRSSMtower_soft_parameters(
   const MRSSMtower_susy_parameters& susy_model
   ...
   : MRSSMtower_susy_parameters(susy_model)
   , BMu(BMu_), BMuD(BMuD_), BMuU(BMuU_), mq2(mq2_), ml2(ml2_), mHd2(mHd2_),
   mHu2(mHu2_), md2(md2_), mu2(mu2_), me2(me2_), mS2(mS2_), mT2(mT2_), moc2(
   moc2_), mRd2(mRd2_), mRu2(mRu2_), MDBS(MDBS_), MDWBT(MDWBT_), MDGoc(MDGoc_)

{
   set_number_of_parameters(numberOfParameters);
}

Eigen::ArrayXd MRSSMtower_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MRSSMtower_soft_parameters MRSSMtower_soft_parameters::calc_beta() const
{
   double beta_BMu = 0.;
   double beta_BMuD = 0.;
   double beta_BMuU = 0.;
   ...
   const MRSSMtower_susy_parameters susy_betas(MRSSMtower_susy_parameters::calc_beta());

   return MRSSMtower_soft_parameters(susy_betas, beta_BMu, beta_BMuD, beta_BMuU, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_mS2, beta_mT2, beta_moc2, beta_mRd2, beta_mRu2, beta_MDBS, beta_MDWBT, beta_MDGoc);
}

MRSSMtower_soft_parameters MRSSMtower_soft_parameters::calc_beta(unsigned loops) const
{
   MRSSMtower_soft_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void MRSSMtower_soft_parameters::clear()
{
   MRSSMtower_susy_parameters::clear();
...
Eigen::ArrayXd MRSSMtower_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MRSSMtower_susy_parameters::get());
...
void MRSSMtower_soft_parameters::print(std::ostream& ostr) const
{
   MRSSMtower_susy_parameters::print(ostr);
...
void MRSSMtower_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MRSSMtower_susy_parameters::set(pars);
...
void MRSSMtower_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const MRSSMtower_soft_parameters& soft_pars)
{
