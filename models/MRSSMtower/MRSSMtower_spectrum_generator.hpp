 ...
 */
template <class T>
void MRSSMtower_spectrum_generator<T>::run(const softsusy::QedQcd& oneset,
                                const MRSSMtower_input_parameters& input)
{
   ...
   MRSSMtower_convergence_tester<T> convergence_tester(
   ...
   MRSSMtower_standard_model_initial_guesser<T> initial_guesser(&model, &eft, oneset,
                                                  low_scale_constraint,
                                                  susy_scale_constraint);
