...
// File generated at Mon 19 Sep 2016 09:37:18
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mHu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mHu2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   const double tracemq2AdjYuYu = TRACE_STRUCT.tracemq2AdjYuYu;
   const double tracemu2YuAdjYu = TRACE_STRUCT.tracemu2YuAdjYu;
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mHu2_three_loop(const Soft_traces& soft_traces) const
{
