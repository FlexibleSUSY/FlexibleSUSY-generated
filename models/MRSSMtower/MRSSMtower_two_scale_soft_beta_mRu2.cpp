 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mRu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mRu2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMtower_soft_parameters::calc_beta_mRu2_three_loop(const Soft_traces& soft_traces) const
{
