...
#ifndef MRSSMtower_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MRSSMtower_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MRSSMtower_low_scale_constraint.hpp"
...
template<>
class MRSSMtower_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   MRSSMtower_low_scale_constraint();
   MRSSMtower_low_scale_constraint(MRSSMtower<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MRSSMtower_low_scale_constraint();
   virtual void apply();
