...
// File generated at Mon 19 Sep 2016 09:37:19
 ...
 */
Eigen::Matrix<double,3,3> MRSSMtower_soft_parameters::calc_beta_mu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSMtower_soft_parameters::calc_beta_mu2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mu2 = (twoLoop*(-0.4*(30*tracemq2AdjYuYu + 30*tracemu2YuAdjYu +
      ...
      mu2) + 1.0666666666666667*(10*Power(g3,4)*Tr23 + g1*(2*g1*Tr2U111 -
 ...
 */
Eigen::Matrix<double,3,3> MRSSMtower_soft_parameters::calc_beta_mu2_three_loop(const Soft_traces& soft_traces) const
{
