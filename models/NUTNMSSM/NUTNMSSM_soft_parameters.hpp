...
public:
   ...
   NUTNMSSM_soft_parameters& operator=(const NUTNMSSM_soft_parameters&) = default;
   NUTNMSSM_soft_parameters& operator=(NUTNMSSM_soft_parameters&&) = default;
   ...
   NUTNMSSM_soft_parameters calc_beta(int) const;
