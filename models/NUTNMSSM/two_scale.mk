...
NUTNMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBNUTNMSSM_SRC += \
		$(DIR)/NUTNMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/NUTNMSSM_two_scale_ewsb_solver.cpp \
...
LIBNUTNMSSM_HDR += \
		...
		$(DIR)/NUTNMSSM_two_scale_spectrum_generator.hpp \
