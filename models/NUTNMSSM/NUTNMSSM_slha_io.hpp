...
public:
   ...
   static void convert_to_slha_convention(NUTNMSSM_physical&);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const NUTNMSSM_slha<T>&, const QedQcd&, const NUTNMSSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const NUTNMSSM_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const NUTNMSSM_slha<T>&, const QedQcd&, const NUTNMSSM_scales&);
...
private:
   ...
   template <class T> void fill_drbar_parameters(NUTNMSSM_slha<T>&) const;
   template <class T> void fill_physical(NUTNMSSM_slha<T>&) const;
};
 ...
 */
template <class T>
void NUTNMSSM_slha_io::fill_drbar_parameters(NUTNMSSM_slha<T>& model) const
{
 ...
 */
template <class T>
void NUTNMSSM_slha_io::fill_physical(NUTNMSSM_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
...
void NUTNMSSM_slha_io::fill_slhaea(
   ...
   const QedQcd& qedqcd, const NUTNMSSM_scales& scales)
{
...
SLHAea::Coll NUTNMSSM_slha_io::fill_slhaea(
   const NUTNMSSM_slha<T>& model, const QedQcd& qedqcd)
{
