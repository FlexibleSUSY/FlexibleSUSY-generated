...
public:
   ...
   void set_extra(const NUTNMSSM_slha&, const NUTNMSSM_scales&, const NUTNMSSM_observables&);
   ...
   void set_spectrum(const NUTNMSSM_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NUTNMSSM_scales&, const NUTNMSSM_observables&);
...
private:
   ...
   void set_model_parameters(const NUTNMSSM_slha&);
