...
public:
   ...
   template <class Model> void fill(NUTNMSSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const NUTNMSSM_slha<Model>&, const NUTNMSSM_scales&, const NUTNMSSM_observables&);
   ...
   template <class Model> void set_spectrum(const NUTNMSSM_slha<Model>&);
   ...
   static void fill_slhaea(SLHAea::Coll&, const NUTNMSSM_slha<Model>&, const softsusy::QedQcd&, const NUTNMSSM_scales&, const NUTNMSSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const NUTNMSSM_slha<Model>&, const softsusy::QedQcd&, const NUTNMSSM_scales&, const NUTNMSSM_observables&);
...
private:
   ...
   void set_imminpar(const NUTNMSSM_input_parameters&);
   void set_imextpar(const NUTNMSSM_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const NUTNMSSM_slha<Model>&);
 ...
 */
template <class Model>
void NUTNMSSM_slha_io::fill(NUTNMSSM_slha<Model>& model) const
{
...
void NUTNMSSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const NUTNMSSM_slha<Model>& model,
...
SLHAea::Coll NUTNMSSM_slha_io::fill_slhaea(
   const NUTNMSSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const NUTNMSSM_scales& scales, const NUTNMSSM_observables& observables)
{
   SLHAea::Coll slhaea;
   NUTNMSSM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void NUTNMSSM_slha_io::set_model_parameters(const NUTNMSSM_slha<Model>& model)
{
   {
...
void NUTNMSSM_slha_io::set_extra(
   const NUTNMSSM_slha<Model>& model, const NUTNMSSM_scales& scales,
   const NUTNMSSM_observables& observables)
{
 ...
 */
template <class... Ts>
void NUTNMSSM_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<NUTNMSSM_slha_io> ss(this);
...
{
   set_spectrum(NUTNMSSM_slha<NUTNMSSM<T> >(model));
}
 ...
 */
template <class Model>
void NUTNMSSM_slha_io::set_spectrum(const NUTNMSSM_slha<Model>& model)
{
   const NUTNMSSM_physical physical(model.get_physical_slha());
