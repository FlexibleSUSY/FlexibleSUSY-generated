 ...
 * to be complex.
 */
void NUTNMSSM_physical::convert_to_hk()
{
...
void NUTNMSSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd NUTNMSSM_physical::get_masses() const
{
...
void NUTNMSSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void NUTNMSSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const NUTNMSSM_physical& phys_pars)
{
