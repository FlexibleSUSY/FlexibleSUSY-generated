 ...
 */
double NUTNMSSM_susy_parameters::calc_beta_Kappa_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTNMSSM_susy_parameters::calc_beta_Kappa_two_loop(const Susy_traces& susy_traces) const
{
