...
// File generated at Wed 12 Apr 2017 12:54:18
 ...
 * parameters.
 *
 * This file was generated at Wed 12 Apr 2017 12:54:18 with FlexibleSUSY
...
CLASSNAME::NUTNMSSM_mass_eigenstates(const NUTNMSSM_input_parameters& input_)
   ...
   , physical()
   , problems(NUTNMSSM_info::particle_names)
...
CLASSNAME::~NUTNMSSM_mass_eigenstates()
{
}
...
const Problems<NUTNMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<NUTNMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   NUTNMSSM_mass_eigenstates* model = ewsb_args->model;
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_tachyon(NUTNMSSM_info::Hpm);
...
void CLASSNAME::calculate_MSd()
{
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_tachyon(NUTNMSSM_info::VWm);
   }
...
std::complex<double> CLASSNAME::CpUSuconjUSuconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_570 += KroneckerDelta(gO2,3 + j1)*Yu(j1,gO1);
      }
      tmp_568 += tmp_570;
      ...
      for (unsigned j4 = 0; j4 < 3; ++j4) {
         ...
         for (unsigned j3 = 0; j3 < 3; ++j3) {
            tmp_573 += Conj(Yu(j3,j4))*Conj(ZU(gI2,3 + j3));
         }
         tmp_572 += tmp_573;
         tmp_571 += (ZU(gI1,j4)) * tmp_572;
      }
      tmp_569 += tmp_571;
      result += (-3) * tmp_568 * tmp_569;
   }
   if (gO1 < 3) {
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_704 += KroneckerDelta(gO2,3 + j1)*Ye(j1,j2);
      }
      tmp_703 += tmp_704;
      tmp_702 += (Conj(ZV(gI2,j2))) * tmp_703;
   }
   tmp_700 += tmp_702;
   ...
   for (unsigned j4 = 0; j4 < 3; ++j4) {
      ...
      for (unsigned j3 = 0; j3 < 3; ++j3) {
         tmp_707 += Conj(Ye(j3,j4))*KroneckerDelta(gO1,3 + j3);
      }
      tmp_706 += tmp_707;
      tmp_705 += (ZV(gI1,j4)) * tmp_706;
   }
   tmp_701 += tmp_705;
   result += (-1) * tmp_700 * tmp_701;
   ...
   tmp_708 += tmp_709;
   result += (0.3*KroneckerDelta(gI1,gI2)*Sqr(g1)) * tmp_708;
   if (gO1 < 3) {
      result += -0.15*KroneckerDelta(gI1,gI2)*KroneckerDelta(gO1,gO2)*Sqr(g1
         );
   }
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_775 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
      }
      tmp_774 += tmp_775;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_777 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
      }
      tmp_776 += tmp_777;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_781 += Conj(ZD(gI2,j2))*ZD(gI1,j2);
      }
      tmp_780 += tmp_781;
      result += (0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_780;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_782;
      std::complex<double> tmp_783;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_783 += Conj(ZD(gI2,j2))*ZD(gI1,j2);
      }
      tmp_782 += tmp_783;
      result += (-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_782;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_784;
      std::complex<double> tmp_785;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_785 += Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2);
      }
      tmp_784 += tmp_785;
      result += (0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_784;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_831 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
      }
      tmp_830 += tmp_831;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_833 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
      }
      tmp_832 += tmp_833;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_835 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
      }
      tmp_834 += tmp_835;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_837 += Conj(ZE(gI2,j2))*ZE(gI1,j2);
      }
      tmp_836 += tmp_837;
      result += (-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_836;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_838;
      std::complex<double> tmp_839;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_839 += Conj(ZE(gI2,j2))*ZE(gI1,j2);
      }
      tmp_838 += tmp_839;
      result += (-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_838;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_840;
      std::complex<double> tmp_841;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_841 += Conj(ZE(gI2,3 + j2))*ZE(gI1,3 + j2);
      }
      tmp_840 += tmp_841;
      result += (0.15*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_840;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUhhUhhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_978 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_977 += tmp_978;
         tmp_976 += (ZD(gI1,3 + j2)) * tmp_977;
      }
      tmp_975 += tmp_976;
      tmp_974 += (Conj(ZD(gI2,3 + j3))) * tmp_975;
   }
   tmp_973 += tmp_974;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_984 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_983 += tmp_984;
         tmp_982 += (Conj(ZD(gI2,j2))) * tmp_983;
      }
      tmp_981 += tmp_982;
      tmp_980 += (ZD(gI1,j3)) * tmp_981;
   }
   tmp_979 += tmp_980;
   tmp_966 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta(
      0,gO2)) * tmp_979;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_986 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_985 += tmp_986;
   tmp_966 += (std::complex<double>(0,-0.05)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_985;
   ...
   tmp_966 += (std::complex<double>(0,-0.25)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_987;
   std::complex<double> tmp_989;
   std::complex<double> tmp_990;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_990 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_989 += tmp_990;
   tmp_966 += (std::complex<double>(0,-0.1)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_989;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_994 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_993 += tmp_994;
      tmp_992 += (Conj(ZD(gI2,j2))) * tmp_993;
   }
   tmp_991 += tmp_992;
   tmp_966 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)) * tmp_991;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_998 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_997 += tmp_998;
      tmp_996 += (ZD(gI1,j2)) * tmp_997;
   }
   tmp_995 += tmp_996;
   tmp_966 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO2)*KroneckerDelta
      (2,gO1)*Lambdax) * tmp_995;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1002 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1001 += tmp_1002;
      tmp_1000 += (Conj(ZD(gI2,j2))) * tmp_1001;
   }
   tmp_999 += tmp_1000;
   tmp_966 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)) * tmp_999;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1006 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1005 += tmp_1006;
      tmp_1004 += (ZD(gI1,j2)) * tmp_1005;
   }
   tmp_1003 += tmp_1004;
   tmp_966 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO1)*KroneckerDelta
      (2,gO2)*Lambdax) * tmp_1003;
...
std::complex<double> CLASSNAME::CpUhhUhhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1013 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1012 += tmp_1013;
   tmp_1007 += (std::complex<double>(0,0.3)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1012;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1019 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1018 += tmp_1019;
         tmp_1017 += (ZE(gI1,3 + j2)) * tmp_1018;
      }
      tmp_1016 += tmp_1017;
      tmp_1015 += (Conj(ZE(gI2,3 + j3))) * tmp_1016;
   }
   tmp_1014 += tmp_1015;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1025 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1024 += tmp_1025;
         tmp_1023 += (Conj(ZE(gI2,j2))) * tmp_1024;
      }
      tmp_1022 += tmp_1023;
      tmp_1021 += (ZE(gI1,j3)) * tmp_1022;
   }
   tmp_1020 += tmp_1021;
   tmp_1007 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1020;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1035 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1034 += tmp_1035;
      tmp_1033 += (Conj(ZE(gI2,j2))) * tmp_1034;
   }
   tmp_1032 += tmp_1033;
   tmp_1007 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2)
      *KroneckerDelta(2,gO1)) * tmp_1032;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1039 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1038 += tmp_1039;
      tmp_1037 += (ZE(gI1,j2)) * tmp_1038;
   }
   tmp_1036 += tmp_1037;
   tmp_1007 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1036;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1043 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1042 += tmp_1043;
      tmp_1041 += (Conj(ZE(gI2,j2))) * tmp_1042;
   }
   tmp_1040 += tmp_1041;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1047 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1046 += tmp_1047;
      tmp_1045 += (ZE(gI1,j2)) * tmp_1046;
   }
   tmp_1044 += tmp_1045;
   tmp_1007 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1044;
...
std::complex<double> CLASSNAME::CpUhhUhhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1054 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1053 += tmp_1054;
   tmp_1048 += (std::complex<double>(0,-0.2)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1053;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1058 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1057 += tmp_1058;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1066 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1065 += tmp_1066;
         tmp_1064 += (ZU(gI1,3 + j2)) * tmp_1065;
      }
      tmp_1063 += tmp_1064;
      tmp_1062 += (Conj(ZU(gI2,3 + j3))) * tmp_1063;
   }
   tmp_1061 += tmp_1062;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1072 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_1071 += tmp_1072;
         tmp_1070 += (Conj(ZU(gI2,j2))) * tmp_1071;
      }
      tmp_1069 += tmp_1070;
      tmp_1068 += (ZU(gI1,j3)) * tmp_1069;
   }
   tmp_1067 += tmp_1068;
   tmp_1048 += (std::complex<double>(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta
      (1,gO2)) * tmp_1067;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1076 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1075 += tmp_1076;
      tmp_1074 += (Conj(ZU(gI2,j2))) * tmp_1075;
   }
   tmp_1073 += tmp_1074;
   tmp_1048 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(0,gO2)
      *KroneckerDelta(2,gO1)) * tmp_1073;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1080 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1079 += tmp_1080;
      tmp_1078 += (ZU(gI1,j2)) * tmp_1079;
   }
   tmp_1077 += tmp_1078;
   tmp_1048 += (std::complex<double>(0,0.5)*KroneckerDelta(0,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1077;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1084 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1083 += tmp_1084;
      tmp_1082 += (Conj(ZU(gI2,j2))) * tmp_1083;
   }
   tmp_1081 += tmp_1082;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1088 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1087 += tmp_1088;
      tmp_1086 += (ZU(gI1,j2)) * tmp_1087;
   }
   tmp_1085 += tmp_1086;
   tmp_1048 += (std::complex<double>(0,0.5)*KroneckerDelta(0,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1085;
...
std::complex<double> CLASSNAME::CpUhhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1099 += ZD(gI1,3 + j1)*TYd(j1,j2);
      }
      tmp_1098 += tmp_1099;
      tmp_1097 += (Conj(ZD(gI2,j2))) * tmp_1098;
   }
   tmp_1096 += tmp_1097;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1103 += Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_1102 += tmp_1103;
      tmp_1101 += (ZD(gI1,j2)) * tmp_1102;
   }
   tmp_1100 += tmp_1101;
   tmp_1089 += (std::complex<double>(0.,-0.7071067811865475)*KroneckerDelta(0,
      gO2)) * tmp_1100;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1109 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1108 += tmp_1109;
         tmp_1107 += (ZD(gI1,3 + j2)) * tmp_1108;
      }
      tmp_1106 += tmp_1107;
      tmp_1105 += (Conj(ZD(gI2,3 + j3))) * tmp_1106;
   }
   tmp_1104 += tmp_1105;
   tmp_1089 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1104
      ;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1115 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1114 += tmp_1115;
         tmp_1113 += (Conj(ZD(gI2,j2))) * tmp_1114;
      }
      tmp_1112 += tmp_1113;
      tmp_1111 += (ZD(gI1,j3)) * tmp_1112;
   }
   tmp_1110 += tmp_1111;
   tmp_1089 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1110
      ;
   std::complex<double> tmp_1116;
   std::complex<double> tmp_1117;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1117 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1116 += tmp_1117;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1119 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1118 += tmp_1119;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1121 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1120 += tmp_1121;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1125 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1124 += tmp_1125;
      tmp_1123 += (Conj(ZD(gI2,j2))) * tmp_1124;
   }
   tmp_1122 += tmp_1123;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1129 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1128 += tmp_1129;
      tmp_1127 += (ZD(gI1,j2)) * tmp_1128;
   }
   tmp_1126 += tmp_1127;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1133 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1132 += tmp_1133;
      tmp_1131 += (Conj(ZD(gI2,j2))) * tmp_1132;
   }
   tmp_1130 += tmp_1131;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1137 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1136 += tmp_1137;
      tmp_1135 += (ZD(gI1,j2)) * tmp_1136;
   }
   tmp_1134 += tmp_1135;
...
std::complex<double> CLASSNAME::CpUhhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1144 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1143 += tmp_1144;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1148 += ZE(gI1,3 + j1)*TYe(j1,j2);
      }
      tmp_1147 += tmp_1148;
      tmp_1146 += (Conj(ZE(gI2,j2))) * tmp_1147;
   }
   tmp_1145 += tmp_1146;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1152 += Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_1151 += tmp_1152;
      tmp_1150 += (ZE(gI1,j2)) * tmp_1151;
   }
   tmp_1149 += tmp_1150;
   tmp_1138 += (std::complex<double>(0.,-0.7071067811865475)*KroneckerDelta(0,
      gO2)) * tmp_1149;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1158 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1157 += tmp_1158;
         tmp_1156 += (ZE(gI1,3 + j2)) * tmp_1157;
      }
      tmp_1155 += tmp_1156;
      tmp_1154 += (Conj(ZE(gI2,3 + j3))) * tmp_1155;
   }
   tmp_1153 += tmp_1154;
   tmp_1138 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1153
      ;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1164 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1163 += tmp_1164;
         tmp_1162 += (Conj(ZE(gI2,j2))) * tmp_1163;
      }
      tmp_1161 += tmp_1162;
      tmp_1160 += (ZE(gI1,j3)) * tmp_1161;
   }
   tmp_1159 += tmp_1160;
   tmp_1138 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1159
      ;
   std::complex<double> tmp_1165;
   std::complex<double> tmp_1166;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1166 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1165 += tmp_1166;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1168 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1167 += tmp_1168;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1170 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1169 += tmp_1170;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1174 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1173 += tmp_1174;
      tmp_1172 += (Conj(ZE(gI2,j2))) * tmp_1173;
   }
   tmp_1171 += tmp_1172;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1178 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1177 += tmp_1178;
      tmp_1176 += (ZE(gI1,j2)) * tmp_1177;
   }
   tmp_1175 += tmp_1176;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1182 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1181 += tmp_1182;
      tmp_1180 += (Conj(ZE(gI2,j2))) * tmp_1181;
   }
   tmp_1179 += tmp_1180;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1186 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1185 += tmp_1186;
      tmp_1184 += (ZE(gI1,j2)) * tmp_1185;
   }
   tmp_1183 += tmp_1184;
...
std::complex<double> CLASSNAME::CpUhhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1193 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1192 += tmp_1193;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1197 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1196 += tmp_1197;
      tmp_1195 += (Conj(ZU(gI2,j2))) * tmp_1196;
   }
   tmp_1194 += tmp_1195;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1201 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1200 += tmp_1201;
      tmp_1199 += (ZU(gI1,j2)) * tmp_1200;
   }
   tmp_1198 += tmp_1199;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1203 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1202 += tmp_1203;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1205 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1204 += tmp_1205;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1207 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1206 += tmp_1207;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1215 += Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2));
      }
      tmp_1214 += tmp_1215;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1221 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1220 += tmp_1221;
         tmp_1219 += (ZU(gI1,3 + j2)) * tmp_1220;
      }
      tmp_1218 += tmp_1219;
      tmp_1217 += (Conj(ZU(gI2,3 + j3))) * tmp_1218;
   }
   tmp_1216 += tmp_1217;
   tmp_1187 += (std::complex<double>(0,-1)*vu*KroneckerDelta(1,gO2)) * tmp_1216
      ;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1227 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_1226 += tmp_1227;
         tmp_1225 += (Conj(ZU(gI2,j2))) * tmp_1226;
      }
      tmp_1224 += tmp_1225;
      tmp_1223 += (ZU(gI1,j3)) * tmp_1224;
   }
   tmp_1222 += tmp_1223;
   tmp_1187 += (std::complex<double>(0,-1)*vu*KroneckerDelta(1,gO2)) * tmp_1222
      ;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1231 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1230 += tmp_1231;
      tmp_1229 += (Conj(ZU(gI2,j2))) * tmp_1230;
   }
   tmp_1228 += tmp_1229;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1235 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1234 += tmp_1235;
      tmp_1233 += (ZU(gI1,j2)) * tmp_1234;
   }
   tmp_1232 += tmp_1233;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1266 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1265 += tmp_1266;
   tmp_1260 += (std::complex<double>(0,0.1)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1265;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1272 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1271 += tmp_1272;
         tmp_1270 += (ZD(gI1,3 + j2)) * tmp_1271;
      }
      tmp_1269 += tmp_1270;
      tmp_1268 += (Conj(ZD(gI2,3 + j3))) * tmp_1269;
   }
   tmp_1267 += tmp_1268;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1278 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1277 += tmp_1278;
         tmp_1276 += (Conj(ZD(gI2,j2))) * tmp_1277;
      }
      tmp_1275 += tmp_1276;
      tmp_1274 += (ZD(gI1,j3)) * tmp_1275;
   }
   tmp_1273 += tmp_1274;
   tmp_1260 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1273;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1288 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1287 += tmp_1288;
      tmp_1286 += (Conj(ZD(gI2,j2))) * tmp_1287;
   }
   tmp_1285 += tmp_1286;
   tmp_1260 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2
      )*KroneckerDelta(2,gO1)) * tmp_1285;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1292 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1291 += tmp_1292;
      tmp_1290 += (ZD(gI1,j2)) * tmp_1291;
   }
   tmp_1289 += tmp_1290;
   tmp_1260 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1289;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1296 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1295 += tmp_1296;
      tmp_1294 += (Conj(ZD(gI2,j2))) * tmp_1295;
   }
   tmp_1293 += tmp_1294;
   tmp_1260 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1
      )*KroneckerDelta(2,gO2)) * tmp_1293;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1300 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1299 += tmp_1300;
      tmp_1298 += (ZD(gI1,j2)) * tmp_1299;
   }
   tmp_1297 += tmp_1298;
   tmp_1260 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1297;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1307 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1306 += tmp_1307;
   tmp_1301 += (std::complex<double>(0,0.3)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1306;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1313 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1312 += tmp_1313;
         tmp_1311 += (ZE(gI1,3 + j2)) * tmp_1312;
      }
      tmp_1310 += tmp_1311;
      tmp_1309 += (Conj(ZE(gI2,3 + j3))) * tmp_1310;
   }
   tmp_1308 += tmp_1309;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1319 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1318 += tmp_1319;
         tmp_1317 += (Conj(ZE(gI2,j2))) * tmp_1318;
      }
      tmp_1316 += tmp_1317;
      tmp_1315 += (ZE(gI1,j3)) * tmp_1316;
   }
   tmp_1314 += tmp_1315;
   tmp_1301 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1314;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1329 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1328 += tmp_1329;
      tmp_1327 += (Conj(ZE(gI2,j2))) * tmp_1328;
   }
   tmp_1326 += tmp_1327;
   tmp_1301 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2
      )*KroneckerDelta(2,gO1)) * tmp_1326;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1333 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1332 += tmp_1333;
      tmp_1331 += (ZE(gI1,j2)) * tmp_1332;
   }
   tmp_1330 += tmp_1331;
   tmp_1301 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1330;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1337 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1336 += tmp_1337;
      tmp_1335 += (Conj(ZE(gI2,j2))) * tmp_1336;
   }
   tmp_1334 += tmp_1335;
   tmp_1301 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1
      )*KroneckerDelta(2,gO2)) * tmp_1334;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1341 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1340 += tmp_1341;
      tmp_1339 += (ZE(gI1,j2)) * tmp_1340;
   }
   tmp_1338 += tmp_1339;
   tmp_1301 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1338;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1352 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1351 += tmp_1352;
   tmp_1342 += (std::complex<double>(0,0.25)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1351;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1360 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1359 += tmp_1360;
         tmp_1358 += (ZU(gI1,3 + j2)) * tmp_1359;
      }
      tmp_1357 += tmp_1358;
      tmp_1356 += (Conj(ZU(gI2,3 + j3))) * tmp_1357;
   }
   tmp_1355 += tmp_1356;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1366 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_1365 += tmp_1366;
         tmp_1364 += (Conj(ZU(gI2,j2))) * tmp_1365;
      }
      tmp_1363 += tmp_1364;
      tmp_1362 += (ZU(gI1,j3)) * tmp_1363;
   }
   tmp_1361 += tmp_1362;
   tmp_1342 += (std::complex<double>(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta
      (1,gO2)) * tmp_1361;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1370 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1369 += tmp_1370;
      tmp_1368 += (Conj(ZU(gI2,j2))) * tmp_1369;
   }
   tmp_1367 += tmp_1368;
   tmp_1342 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(0,gO2
      )*KroneckerDelta(2,gO1)) * tmp_1367;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1374 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1373 += tmp_1374;
      tmp_1372 += (ZU(gI1,j2)) * tmp_1373;
   }
   tmp_1371 += tmp_1372;
   tmp_1342 += (std::complex<double>(0,-0.5)*KroneckerDelta(0,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1371;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1382 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1381 += tmp_1382;
      tmp_1380 += (ZU(gI1,j2)) * tmp_1381;
   }
   tmp_1379 += tmp_1380;
   tmp_1342 += (std::complex<double>(0,-0.5)*KroneckerDelta(0,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1379;
...
std::complex<double> CLASSNAME::CpUAhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1387 += ZD(gI1,3 + j1)*TYd(j1,j2);
      }
      tmp_1386 += tmp_1387;
      tmp_1385 += (Conj(ZD(gI2,j2))) * tmp_1386;
   }
   tmp_1384 += tmp_1385;
   tmp_1383 += (0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1384;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1391 += Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_1390 += tmp_1391;
      tmp_1389 += (ZD(gI1,j2)) * tmp_1390;
   }
   tmp_1388 += tmp_1389;
   tmp_1383 += (-0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1388;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1395 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1394 += tmp_1395;
      tmp_1393 += (Conj(ZD(gI2,j2))) * tmp_1394;
   }
   tmp_1392 += tmp_1393;
   tmp_1383 += (0.5*vS*Conj(Lambdax)*KroneckerDelta(1,gO2)) * tmp_1392;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1403 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1402 += tmp_1403;
      tmp_1401 += (Conj(ZD(gI2,j2))) * tmp_1402;
   }
   tmp_1400 += tmp_1401;
   tmp_1383 += (0.5*vu*Conj(Lambdax)*KroneckerDelta(2,gO2)) * tmp_1400;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1407 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1406 += tmp_1407;
      tmp_1405 += (ZD(gI1,j2)) * tmp_1406;
   }
   tmp_1404 += tmp_1405;
   tmp_1383 += (-0.5*vu*KroneckerDelta(2,gO2)*Lambdax) * tmp_1404;
...
std::complex<double> CLASSNAME::CpUAhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1412 += ZE(gI1,3 + j1)*TYe(j1,j2);
      }
      tmp_1411 += tmp_1412;
      tmp_1410 += (Conj(ZE(gI2,j2))) * tmp_1411;
   }
   tmp_1409 += tmp_1410;
   tmp_1408 += (0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1409;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1416 += Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_1415 += tmp_1416;
      tmp_1414 += (ZE(gI1,j2)) * tmp_1415;
   }
   tmp_1413 += tmp_1414;
   tmp_1408 += (-0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1413;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1420 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1419 += tmp_1420;
      tmp_1418 += (Conj(ZE(gI2,j2))) * tmp_1419;
   }
   tmp_1417 += tmp_1418;
   tmp_1408 += (0.5*vS*Conj(Lambdax)*KroneckerDelta(1,gO2)) * tmp_1417;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1428 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1427 += tmp_1428;
      tmp_1426 += (Conj(ZE(gI2,j2))) * tmp_1427;
   }
   tmp_1425 += tmp_1426;
   tmp_1408 += (0.5*vu*Conj(Lambdax)*KroneckerDelta(2,gO2)) * tmp_1425;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1432 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1431 += tmp_1432;
      tmp_1430 += (ZE(gI1,j2)) * tmp_1431;
   }
   tmp_1429 += tmp_1430;
   tmp_1408 += (-0.5*vu*KroneckerDelta(2,gO2)*Lambdax) * tmp_1429;
...
std::complex<double> CLASSNAME::CpUAhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1441 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1440 += tmp_1441;
      tmp_1439 += (ZU(gI1,j2)) * tmp_1440;
   }
   tmp_1438 += tmp_1439;
   tmp_1433 += (-0.5*vS*KroneckerDelta(0,gO2)*Lambdax) * tmp_1438;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1449 += Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2));
      }
      tmp_1448 += tmp_1449;
      tmp_1447 += (ZU(gI1,j2)) * tmp_1448;
   }
   tmp_1446 += tmp_1447;
   tmp_1433 += (-0.7071067811865475*KroneckerDelta(1,gO2)) * tmp_1446;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1453 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1452 += tmp_1453;
      tmp_1451 += (Conj(ZU(gI2,j2))) * tmp_1452;
   }
   tmp_1450 += tmp_1451;
   tmp_1433 += (0.5*vd*Conj(Lambdax)*KroneckerDelta(2,gO2)) * tmp_1450;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1457 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1456 += tmp_1457;
      tmp_1455 += (ZU(gI1,j2)) * tmp_1456;
   }
   tmp_1454 += tmp_1455;
   tmp_1433 += (-0.5*vd*KroneckerDelta(2,gO2)*Lambdax) * tmp_1454;
...
std::complex<double> CLASSNAME::CpconjUHpmconjSvSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1481 += Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_1480 += tmp_1481;
      tmp_1479 += (ZV(gI1,j2)) * tmp_1480;
   }
   tmp_1478 += tmp_1479;
   tmp_1475 += (std::complex<double>(0,1)*KroneckerDelta(0,gO2)) * tmp_1478;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1487 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1486 += tmp_1487;
         tmp_1485 += (Conj(ZE(gI2,j2))) * tmp_1486;
      }
      tmp_1484 += tmp_1485;
      tmp_1483 += (ZV(gI1,j3)) * tmp_1484;
   }
   tmp_1482 += tmp_1483;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1493 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1492 += tmp_1493;
      tmp_1491 += (ZV(gI1,j2)) * tmp_1492;
   }
   tmp_1490 += tmp_1491;
   tmp_1475 += (std::complex<double>(0.,0.7071067811865475)*vS*KroneckerDelta(1
      ,gO2)*Lambdax) * tmp_1490;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1500 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1499 += tmp_1500;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1506 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1505 += tmp_1506;
         tmp_1504 += (ZD(gI1,3 + j2)) * tmp_1505;
      }
      tmp_1503 += tmp_1504;
      tmp_1502 += (Conj(ZD(gI2,3 + j3))) * tmp_1503;
   }
   tmp_1501 += tmp_1502;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1525 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1524 += tmp_1525;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1531 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1530 += tmp_1531;
         tmp_1529 += (ZE(gI1,3 + j2)) * tmp_1530;
      }
      tmp_1528 += tmp_1529;
      tmp_1527 += (Conj(ZE(gI2,3 + j3))) * tmp_1528;
   }
   tmp_1526 += tmp_1527;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1544 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1543 += tmp_1544;
   tmp_1538 += (std::complex<double>(0,-0.2)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1543;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1550 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1549 += tmp_1550;
         tmp_1548 += (Conj(ZU(gI2,j2))) * tmp_1549;
      }
      tmp_1547 += tmp_1548;
      tmp_1546 += (ZU(gI1,j3)) * tmp_1547;
   }
   tmp_1545 += tmp_1546;
   ...
   tmp_1538 += (std::complex<double>(0,-0.05)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1551;
   ...
   tmp_1538 += (std::complex<double>(0,-0.25)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1553;
   std::complex<double> tmp_1555;
   std::complex<double> tmp_1556;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1556 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1555 += tmp_1556;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1562 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1561 += tmp_1562;
         tmp_1560 += (ZU(gI1,3 + j2)) * tmp_1561;
      }
      tmp_1559 += tmp_1560;
      tmp_1558 += (Conj(ZU(gI2,3 + j3))) * tmp_1559;
   }
   tmp_1557 += tmp_1558;
...
std::complex<double> CLASSNAME::CpconjUHpmconjSuSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1573 += Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_1572 += tmp_1573;
      tmp_1571 += (ZU(gI1,j2)) * tmp_1572;
   }
   tmp_1570 += tmp_1571;
   tmp_1563 += (std::complex<double>(0,1)*KroneckerDelta(0,gO2)) * tmp_1570;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1579 += Conj(Yd(j3,j1))*Yu(j2,j1);
         }
         tmp_1578 += tmp_1579;
         tmp_1577 += (ZU(gI1,3 + j2)) * tmp_1578;
      }
      tmp_1576 += tmp_1577;
      tmp_1575 += (Conj(ZD(gI2,3 + j3))) * tmp_1576;
   }
   tmp_1574 += tmp_1575;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1585 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1584 += tmp_1585;
         tmp_1583 += (Conj(ZD(gI2,j2))) * tmp_1584;
      }
      tmp_1582 += tmp_1583;
      tmp_1581 += (ZU(gI1,j3)) * tmp_1582;
   }
   tmp_1580 += tmp_1581;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1591 += ZU(gI1,3 + j1)*TYu(j1,j2);
      }
      tmp_1590 += tmp_1591;
      tmp_1589 += (Conj(ZD(gI2,j2))) * tmp_1590;
   }
   tmp_1588 += tmp_1589;
   tmp_1563 += (std::complex<double>(0,1)*KroneckerDelta(1,gO2)) * tmp_1588;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1595 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1594 += tmp_1595;
      tmp_1593 += (ZU(gI1,j2)) * tmp_1594;
   }
   tmp_1592 += tmp_1593;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1601 += Conj(Yd(j3,j1))*Yu(j2,j1);
         }
         tmp_1600 += tmp_1601;
         tmp_1599 += (ZU(gI1,3 + j2)) * tmp_1600;
      }
      tmp_1598 += tmp_1599;
      tmp_1597 += (Conj(ZD(gI2,3 + j3))) * tmp_1598;
   }
   tmp_1596 += tmp_1597;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_tachyon(NUTNMSSM_info::VZ);
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::hh))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::Ah))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUTNMSSM_info::VWm))
      return;
