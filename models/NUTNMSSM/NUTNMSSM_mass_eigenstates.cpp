...
// File generated at Fri 26 Jun 2015 19:13:26
 ...
 * parameters.
 *
 * This file was generated at Fri 26 Jun 2015 19:13:26 with FlexibleSUSY
...
int CLASSNAME::solve_ewsb_tree_level_via_soft_higgs_masses()
{
   ...
   const double new_mHd2 = Re((0.025*(14.142135623730951*vS*vu*Conj(TLambdax) -
      3*Power(vd,3)*Sqr(g1) - 5*Power(vd,3)*Sqr(g2) - 20*vd*AbsSqr(Lambdax)*Sqr(
      vS) + 10*vu*Conj(Lambdax)*Kappa*Sqr(vS) + 10*vu*Conj(Kappa)*Lambdax*Sqr(vS)
   ...
   const double new_mHu2 = Re((0.025*(14.142135623730951*vd*vS*Conj(TLambdax) -
      3*Power(vu,3)*Sqr(g1) - 5*Power(vu,3)*Sqr(g2) - 20*vu*AbsSqr(Lambdax)*Sqr(
      vd) + 3*vu*Sqr(g1)*Sqr(vd) + 5*vu*Sqr(g2)*Sqr(vd) - 20*vu*AbsSqr(Lambdax)*
      Sqr(vS) + 10*vd*Conj(Lambdax)*Kappa*Sqr(vS) + 10*vd*Conj(Kappa)*Lambdax*Sqr(
      vS) + 14.142135623730951*vd*vS*TLambdax))/vu);
   const double new_ms2 = Re((0.25*(-4*Power(vS,3)*AbsSqr(Kappa) +
...
std::complex<double> CLASSNAME::CpUAhAhAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   result = std::complex<double>(0,0.25)*(-2*Conj(Lambdax)*Kappa*(
      ...
      *ZA(gI2,2))) + KroneckerDelta(2,gO2)*(-(ZA(gI1,2)*(vu*ZA(gI2,0) + vd*ZA(gI2,
      1))) + ZA(gI1,1)*(vS*ZA(gI2,0) - vd*ZA(gI2,2)) + ZA(gI1,0)*(vS*ZA(gI2,1) -
      vu*ZA(gI2,2))) + KroneckerDelta(0,gO2)*(vS*ZA(gI1,1)*ZA(gI2,2) + ZA(gI1,2)*(
      vS*ZA(gI2,1) - vu*ZA(gI2,2)))) + 2*Conj(Kappa)*Lambdax*(KroneckerDelta(1,gO2
      )*(vS*ZA(gI1,0)*ZA(gI2,2) + ZA(gI1,2)*(vS*ZA(gI2,0) - vd*ZA(gI2,2))) +
      KroneckerDelta(2,gO2)*(-(ZA(gI1,2)*(vu*ZA(gI2,0) + vd*ZA(gI2,1))) + ZA(gI1,1
      )*(vS*ZA(gI2,0) - vd*ZA(gI2,2)) + ZA(gI1,0)*(vS*ZA(gI2,1) - vu*ZA(gI2,2))) +
      KroneckerDelta(0,gO2)*(vS*ZA(gI1,1)*ZA(gI2,2) + ZA(gI1,2)*(vS*ZA(gI2,1) -
      vu*ZA(gI2,2)))) + 1.4142135623730951*(-(KroneckerDelta(2,gO2)*(TLambdax*(ZA(
      gI1,1)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,1)) + 2*(Conj(TKappa) - TKappa)*ZA(gI1,2
      )*ZA(gI2,2))) - TLambdax*(KroneckerDelta(1,gO2)*(ZA(gI1,2)*ZA(gI2,0) + ZA(
      gI1,0)*ZA(gI2,2)) + KroneckerDelta(0,gO2)*(ZA(gI1,2)*ZA(gI2,1) + ZA(gI1,1)*
...
std::complex<double> CLASSNAME::CpUChiconjSdFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1672 += tmp_1673;
   tmp_1671 += (std::complex<double>(0,-0.3651483716701107)*g1*KroneckerDelta(0
      ,gO1)) * tmp_1672;
...
std::complex<double> CLASSNAME::CpUChiconjSeFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1688 += tmp_1689;
   tmp_1687 += (std::complex<double>(0,-1.0954451150103321)*g1*KroneckerDelta(0
      ,gO1)) * tmp_1688;
...
std::complex<double> CLASSNAME::CpUChiconjSuFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1697 += tmp_1698;
   tmp_1694 += (std::complex<double>(0,-0.7071067811865475)*g2*KroneckerDelta(1
      ,gO2)) * tmp_1697;
...
std::complex<double> CLASSNAME::CpbarFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1810 += tmp_1811;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,0)) * tmp_1810
      ;
...
std::complex<double> CLASSNAME::CpbarFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1846 += tmp_1847;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,0)) * tmp_1846
      ;
...
std::complex<double> CLASSNAME::CpbarFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1910 += tmp_1911;
   result += (std::complex<double>(0,-0.7071067811865475)*ZA(gI2,1)) * tmp_1910
      ;
...
std::complex<double> CLASSNAME::self_energy_Fd_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2847 += B0(p,MGlu,MSd(gI1))*Conj(CpbarFdSdGluPL(gO2,gI1,1))*
...
std::complex<double> CLASSNAME::self_energy_Fd_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2858 += B1(p,MGlu,MSd(gI1))*Conj(CpbarFdSdGluPR(gO2,gI1,1))*
         CpbarFdSdGluPR(gO1,gI1,1);
   }
   tmp_2857 += tmp_2858;
...
std::complex<double> CLASSNAME::self_energy_Fd_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2879 += B1(p,MGlu,MSd(gI1))*Conj(CpbarFdSdGluPL(gO2,gI1,1))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2909 += B0(p,MGlu,MSu(gI1))*Conj(CpbarFuSuGluPL(gO2,gI1,1))*
...
std::complex<double> CLASSNAME::self_energy_Fu_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2923 += B1(p,MGlu,MSu(gI1))*Conj(CpbarFuSuGluPR(gO2,gI1,1))*
         CpbarFuSuGluPR(gO1,gI1,1);
   }
   tmp_2922 += tmp_2923;
...
std::complex<double> CLASSNAME::self_energy_Fu_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2946 += B1(p,MGlu,MSu(gI1))*Conj(CpbarFuSuGluPL(gO2,gI1,1))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1_heavy(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2975 += B0(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPL(gO2,gI1,1))*
         CpbarUFuSuGluPR(gO1,gI1,1);
   }
   tmp_2974 += tmp_2975;
...
std::complex<double> CLASSNAME::self_energy_Fu_PR_heavy(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2989 += B1(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPR(gO2,gI1,1))*
         CpbarUFuSuGluPR(gO1,gI1,1);
   }
   tmp_2988 += tmp_2989;
...
std::complex<double> CLASSNAME::self_energy_Fu_PL_heavy(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3012 += B1(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPL(gO2,gI1,1))*
         CpbarUFuSuGluPL(gO1,gI1,1);
   }
   tmp_3011 += tmp_3012;
...
void CLASSNAME::self_energy_hh_2loop(double result[6]) const
{
   ...
   double mg = MGlu;
   double mAsq = ((Sqr(vd) + Sqr(vu))*(0.5*Kappa*Lambdax*Sqr(vS) + 0.7071067811865475*vS*TLambdax))/(vd*vu);
