...
// File generated at Wed 12 Apr 2017 12:52:16
...
const int NUTNMSSM_soft_parameters::numberOfParameters;

NUTNMSSM_soft_parameters::NUTNMSSM_soft_parameters(const NUTNMSSM_input_parameters& input_)
   : NUTNMSSM_susy_parameters(input_)
...
NUTNMSSM_soft_parameters::NUTNMSSM_soft_parameters(
   const NUTNMSSM_susy_parameters& susy_model
   ...
   : NUTNMSSM_susy_parameters(susy_model)
...
Eigen::ArrayXd NUTNMSSM_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

NUTNMSSM_soft_parameters NUTNMSSM_soft_parameters::calc_beta() const
{
   ...
   const NUTNMSSM_susy_parameters susy_betas(NUTNMSSM_susy_parameters::calc_beta());

   return NUTNMSSM_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TLambdax, beta_TKappa, beta_TYu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_MassB, beta_MassWB, beta_MassG);
}

NUTNMSSM_soft_parameters NUTNMSSM_soft_parameters::calc_beta(unsigned loops) const
{
   NUTNMSSM_soft_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void NUTNMSSM_soft_parameters::clear()
{
   NUTNMSSM_susy_parameters::clear();
...
void NUTNMSSM_soft_parameters::print(std::ostream& ostr) const
{
   NUTNMSSM_susy_parameters::print(ostr);
...
void NUTNMSSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   NUTNMSSM_susy_parameters::set(pars);
...
void NUTNMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const NUTNMSSM_soft_parameters& soft_pars)
{
