...
// File generated at Mon 23 Feb 2015 13:31:17
...
NUTNMSSM_low_scale_constraint<Two_scale>::NUTNMSSM_low_scale_constraint(
   ...
   const NUTNMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void NUTNMSSM_low_scale_constraint<Two_scale>::set_input_parameters(const NUTNMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
