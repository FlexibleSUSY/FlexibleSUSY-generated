...
// File generated at Fri 26 Jun 2015 19:12:39
...
NUTNMSSM_low_scale_constraint<Two_scale>::NUTNMSSM_low_scale_constraint(
   NUTNMSSM<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void NUTNMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& NUTNMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
