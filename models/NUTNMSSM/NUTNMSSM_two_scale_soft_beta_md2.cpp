...
// File generated at Tue 12 Jul 2016 11:47:45
 ...
 */
Eigen::Matrix<double,3,3> NUTNMSSM_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NUTNMSSM_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = (twoLoop*(-12*traceconjTYdTpTYd*(Yd*Yd.adjoint()) - 4*
      ...
      (Yd*(TYd).adjoint()) - 4*Conj(Lambdax)*TLambdax*(Yd*(TYd).adjoint()) - 12
      *traceconjTYdTpYd*(TYd*Yd.adjoint()) - 4*traceconjTYeTpYe*(TYd*Yd.adjoint
      ()) - 4*Conj(TLambdax)*Lambdax*(TYd*Yd.adjoint()) - 12*Conj(MassWB)*Sqr(
      ...
      Yd.adjoint()) - 2*AbsSqr(Lambdax)*(md2*Yd*Yd.adjoint()) + 0.4*Sqr(g1)*(
      md2*Yd*Yd.adjoint()) + 6*Sqr(g2)*(md2*Yd*Yd.adjoint()) - 12*traceYdAdjYd*
      (Yd*mq2*Yd.adjoint()) - 4*traceYeAdjYe*(Yd*mq2*Yd.adjoint()) - 4*AbsSqr(
      Lambdax)*(Yd*mq2*Yd.adjoint()) + 0.8*Sqr(g1)*(Yd*mq2*Yd.adjoint()) + 12*
      Sqr(g2)*(Yd*mq2*Yd.adjoint()) - 6*traceYdAdjYd*(Yd*Yd.adjoint()*md2) - 2*
      traceYeAdjYe*(Yd*Yd.adjoint()*md2) - 2*AbsSqr(Lambdax)*(Yd*Yd.adjoint()*
 ...
 */
Eigen::Matrix<double,3,3> NUTNMSSM_soft_parameters::calc_beta_md2_three_loop(const Soft_traces& soft_traces) const
{
