 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_ms2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_ms2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_ms2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_ms2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_ms2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
