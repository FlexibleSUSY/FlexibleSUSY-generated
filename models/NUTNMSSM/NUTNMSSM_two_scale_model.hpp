 ...
 */
template<>
class NUTNMSSM<Two_scale> : public Two_scale_model, public NUTNMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(NUTNMSSM<Two_scale>::*Memfun_t)();
      NUTNMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(NUTNMSSM<Two_scale>* model_, Memfun_t fun_)
