...
// File generated at Sun 31 May 2015 12:43:03
...
NUTNMSSM_convergence_tester<Two_scale>::NUTNMSSM_convergence_tester(NUTNMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<NUTNMSSM<Two_scale> >(model, accuracy_goal)
{
}

NUTNMSSM_convergence_tester<Two_scale>::~NUTNMSSM_convergence_tester()
{
}

double NUTNMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const NUTNMSSM<Two_scale>& ol = get_last_iteration_model();
   const NUTNMSSM<Two_scale>& ne = get_model();
