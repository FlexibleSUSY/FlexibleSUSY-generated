...
NUTNMSSM_convergence_tester<Two_scale>::NUTNMSSM_convergence_tester(
   NUTNMSSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<NUTNMSSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double NUTNMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const NUTNMSSM<Two_scale>& ne = get_current_iteration_model();
