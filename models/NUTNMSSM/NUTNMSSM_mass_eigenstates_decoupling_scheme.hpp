...
/**
 * @file NUTNMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef NUTNMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define NUTNMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "NUTNMSSM_info.hpp"
#include "NUTNMSSM_physical.hpp"
#include "NUTNMSSM_soft_parameters.hpp"
#include "NUTNMSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) NUTNMSSM_soft_parameters::p
...
/**
 * @class NUTNMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class NUTNMSSM_mass_eigenstates_decoupling_scheme
   : private NUTNMSSM_soft_parameters
   , public NUTNMSSM_mass_eigenstates_interface
{
public:
   explicit NUTNMSSM_mass_eigenstates_decoupling_scheme(const NUTNMSSM_input_parameters& input_ = NUTNMSSM_input_parameters());
   explicit NUTNMSSM_mass_eigenstates_decoupling_scheme(const NUTNMSSM_mass_eigenstates&);
   NUTNMSSM_mass_eigenstates_decoupling_scheme(const NUTNMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NUTNMSSM_mass_eigenstates_decoupling_scheme(NUTNMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~NUTNMSSM_mass_eigenstates_decoupling_scheme() = default;
   NUTNMSSM_mass_eigenstates_decoupling_scheme& operator=(const NUTNMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NUTNMSSM_mass_eigenstates_decoupling_scheme& operator=(NUTNMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<NUTNMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const NUTNMSSM_mass_eigenstates&);
   ...
   const NUTNMSSM_input_parameters& get_input_parameters() const override;
   NUTNMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const NUTNMSSM_physical& get_physical() const override;
   NUTNMSSM_physical& get_physical() override;
   ...
   void set_physical(const NUTNMSSM_physical&) override;
...
private:
   ...
   Problems problems{NUTNMSSM_info::model_name,
                     &NUTNMSSM_info::particle_names_getter,
                     &NUTNMSSM_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const NUTNMSSM_mass_eigenstates_decoupling_scheme&);
