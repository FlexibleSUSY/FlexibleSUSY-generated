 ...
 * SLHA output file.
 */
void NUTNMSSM_slha_io::fill(NUTNMSSM_slha& model) const
{
 ...
 */
void NUTNMSSM_slha_io::set_extpar(const NUTNMSSM_input_parameters& input)
{
   ...
   extpar << FORMAT_ELEMENT(65, input.MuEff, "MuEff");
 ...
 * @param input struct of input parameters
 */
void NUTNMSSM_slha_io::set_imminpar(const NUTNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUTNMSSM_slha_io::set_imextpar(const NUTNMSSM_input_parameters& input)
{
 ...
 */
void NUTNMSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void NUTNMSSM_slha_io::set_minpar(const NUTNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUTNMSSM_slha_io::set_input(const NUTNMSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void NUTNMSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void NUTNMSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void NUTNMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void NUTNMSSM_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void NUTNMSSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void NUTNMSSM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void NUTNMSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void NUTNMSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void NUTNMSSM_slha_io::set_spinfo(
 ...
 */
void NUTNMSSM_slha_io::set_mass(const NUTNMSSM_physical& physical,
 ...
 */
void NUTNMSSM_slha_io::set_mixing_matrices(const NUTNMSSM_physical& physical,
...
void NUTNMSSM_slha_io::set_pmns(
 ...
 */
void NUTNMSSM_slha_io::set_model_parameters(const NUTNMSSM_slha& model)
{
   {
...
void NUTNMSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void NUTNMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void NUTNMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void NUTNMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void NUTNMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void NUTNMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, NUTNMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void NUTNMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = NUTNMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + NUTNMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void NUTNMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void NUTNMSSM_slha_io::set_spectrum(const NUTNMSSM_slha& model)
{
...
void NUTNMSSM_slha_io::set_extra(
   const NUTNMSSM_slha& model,
   const NUTNMSSM_scales& scales,
   const NUTNMSSM_observables& observables,
 ...
 */
void NUTNMSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void NUTNMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void NUTNMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void NUTNMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double NUTNMSSM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void NUTNMSSM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void NUTNMSSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void NUTNMSSM_slha_io::fill(NUTNMSSM_input_parameters& input) const
{
 ...
 */
void NUTNMSSM_slha_io::fill_drbar_parameters(NUTNMSSM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void NUTNMSSM_slha_io::fill(NUTNMSSM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   NUTNMSSM_physical physical_hk;
 ...
 */
void NUTNMSSM_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NUTNMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NUTNMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void NUTNMSSM_slha_io::fill_minpar_tuple(NUTNMSSM_input_parameters& input,
...
void NUTNMSSM_slha_io::fill_extpar_tuple(NUTNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NUTNMSSM_slha_io::fill_imminpar_tuple(NUTNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NUTNMSSM_slha_io::fill_imextpar_tuple(NUTNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void NUTNMSSM_slha_io::fill_physical(NUTNMSSM_physical& physical) const
{
   {
 ...
 */
double NUTNMSSM_slha_io::read_scale() const
{
