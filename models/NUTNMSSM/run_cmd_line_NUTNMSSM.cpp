...
int run_solver(int loop_library, const NUTNMSSM_input_parameters& input)
{
   ...
   NUTNMSSM_decays decays;decays = NUTNMSSM_decays(std::get<0>(models), qedqcd, physical_input, flexibledecay_settings);
...
int run(int solver_type, int loop_library, const NUTNMSSM_input_parameters& input)
{
   int exit_code = 0;
