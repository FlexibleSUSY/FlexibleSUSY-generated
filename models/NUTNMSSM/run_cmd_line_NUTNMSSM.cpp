...
int run_solver(const NUTNMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(NUTNMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const NUTNMSSM_input_parameters& input)
{
   int exit_code = 0;
