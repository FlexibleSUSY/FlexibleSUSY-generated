...
#include "NUTNMSSM_low_scale_constraint.hpp"
...
template<>
class NUTNMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   NUTNMSSM_low_scale_constraint() = default;
   NUTNMSSM_low_scale_constraint(NUTNMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NUTNMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "NUTNMSSM low-scale constraint"; }
