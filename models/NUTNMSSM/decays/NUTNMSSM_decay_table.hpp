...
#ifndef NUTNMSSM_DECAY_TABLE_H
#define NUTNMSSM_DECAY_TABLE_H
...
public:
   ...
   NUTNMSSM_decay_table();
   ~NUTNMSSM_decay_table() = default;
   NUTNMSSM_decay_table(const NUTNMSSM_decay_table&) = default;
   NUTNMSSM_decay_table(NUTNMSSM_decay_table&&) = default;
   NUTNMSSM_decay_table& operator=(const NUTNMSSM_decay_table&) = default;
   NUTNMSSM_decay_table& operator=(NUTNMSSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const NUTNMSSM_decay_table&);
