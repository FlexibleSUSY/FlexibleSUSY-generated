...
// File generated at Fri 20 Oct 2017 08:58:43
...
NUTNMSSM_soft_parameters NUTNMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const NUTNMSSM_susy_parameters susy_betas(NUTNMSSM_susy_parameters::calc_beta(loops));
...
NUTNMSSM_soft_parameters::Soft_traces NUTNMSSM_soft_parameters::calc_soft_traces(int loops) const
{
