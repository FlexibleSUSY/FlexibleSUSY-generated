...
/**
 * @class NUTNMSSM_initial_guesser<Two_scale>
 * @brief initial guesser for the NUTNMSSM
 */

template<>
class NUTNMSSM_initial_guesser<Two_scale> : public Initial_guesser {
public:
   NUTNMSSM_initial_guesser(NUTNMSSM<Two_scale>*,
                               ...
                               const NUTNMSSM_high_scale_constraint<Two_scale>&);
   virtual ~NUTNMSSM_initial_guesser() = default;
...
private:
   NUTNMSSM<Two_scale>* model{nullptr}; ///< pointer to model class
