...
/**
 * @file NUTNMSSM_f_to_f_conversion.cpp
 *
...
#include "NUTNMSSM_f_to_f_conversion.hpp"
...
namespace NUTNMSSM_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const NUTNMSSM_mass_eigenstates& model) {
