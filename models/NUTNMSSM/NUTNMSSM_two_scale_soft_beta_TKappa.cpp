...
// File generated at Sun 18 Oct 2015 12:49:08
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_TKappa_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_TKappa_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTNMSSM_soft_parameters::calc_beta_TKappa_three_loop(const Soft_traces& soft_traces) const
{
