...
template<>
class NUTNMSSM_high_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "NUTNMSSM high-scale constraint"; }
