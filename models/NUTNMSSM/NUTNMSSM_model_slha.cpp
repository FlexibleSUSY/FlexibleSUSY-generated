...
NUTNMSSM_slha::NUTNMSSM_slha(const NUTNMSSM_input_parameters& input_,
 ...
 */
NUTNMSSM_slha::NUTNMSSM_slha(const NUTNMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : NUTNMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void NUTNMSSM_slha::clear()
{
   NUTNMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void NUTNMSSM_slha::calculate_spectrum()
{
   NUTNMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void NUTNMSSM_slha::convert_to_slha()
{
...
void NUTNMSSM_slha::calculate_ckm_matrix()
{
...
void NUTNMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void NUTNMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void NUTNMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void NUTNMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const NUTNMSSM_physical& NUTNMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

NUTNMSSM_physical& NUTNMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void NUTNMSSM_slha::print(std::ostream& ostr) const
{
   NUTNMSSM_mass_eigenstates::print(ostr);
...
void NUTNMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const NUTNMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
