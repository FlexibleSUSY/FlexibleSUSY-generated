...
template <>
class NUTNMSSM_spectrum_generator<Two_scale>
   : public NUTNMSSM_spectrum_generator_interface<Two_scale> {
public:
   NUTNMSSM_spectrum_generator() = default;
   virtual ~NUTNMSSM_spectrum_generator() = default;
...
protected:
   virtual void run_except(const softsusy::QedQcd&, const NUTNMSSM_input_parameters&) override;
