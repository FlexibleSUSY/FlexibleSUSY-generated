...
// File generated at Tue 12 Jul 2016 11:47:24
...
double NUTNMSSM_susy_parameters::calc_beta_vu_one_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vu = Re(0.1*oneOver16PiSqr*vu*(-10*AbsSqr(Lambdax) + 3*(-10*
 ...
 */
double NUTNMSSM_susy_parameters::calc_beta_vu_three_loop(const Susy_traces& susy_traces) const
{
