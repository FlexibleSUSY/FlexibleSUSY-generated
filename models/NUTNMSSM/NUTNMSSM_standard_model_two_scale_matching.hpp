...
#ifndef NUTNMSSM_TWO_SCALE_MATCHING_H
#define NUTNMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class NUTNMSSM;
template <class T> class NUTNMSSM_standard_model_Matching;
...
template<>
class NUTNMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   NUTNMSSM_standard_model_Matching();

   NUTNMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       NUTNMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~NUTNMSSM_standard_model_Matching();
