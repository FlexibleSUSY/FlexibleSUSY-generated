...
/**
 * @file NUTNMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef NUTNMSSM_MASS_EIGENSTATES_INTERFACE_H
#define NUTNMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class NUTNMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class NUTNMSSM_mass_eigenstates_interface {
public:
   virtual ~NUTNMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<NUTNMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const NUTNMSSM_input_parameters& get_input_parameters() const = 0;
   virtual NUTNMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const NUTNMSSM_physical& get_physical() const = 0;
   virtual NUTNMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const NUTNMSSM_physical&) = 0;
