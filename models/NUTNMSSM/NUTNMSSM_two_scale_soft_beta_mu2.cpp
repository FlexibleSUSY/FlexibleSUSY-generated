...
// File generated at Sun 18 Oct 2015 12:49:19
 ...
 */
Eigen::Matrix<double,3,3> NUTNMSSM_soft_parameters::calc_beta_mu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NUTNMSSM_soft_parameters::calc_beta_mu2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mu2 = (twoLoop*(-12*traceconjTYuTpTYu*(Yu*Yu.adjoint()) - 12*
      ...
      (Yu*(TYu).adjoint()) - 4*Conj(Lambdax)*TLambdax*(Yu*(TYu).adjoint()) - 12
      *traceconjTYuTpYu*(TYu*Yu.adjoint()) - 4*Conj(TLambdax)*Lambdax*(TYu*
      ...
      ) - 6*traceYuAdjYu*(mu2*Yu*Yu.adjoint()) - 2*AbsSqr(Lambdax)*(mu2*Yu*
      Yu.adjoint()) - 0.4*Sqr(g1)*(mu2*Yu*Yu.adjoint()) + 6*Sqr(g2)*(mu2*Yu*
      Yu.adjoint()) - 12*traceYuAdjYu*(Yu*mq2*Yu.adjoint()) - 4*AbsSqr(Lambdax)
      *(Yu*mq2*Yu.adjoint()) - 0.8*Sqr(g1)*(Yu*mq2*Yu.adjoint()) + 12*Sqr(g2)*(
      Yu*mq2*Yu.adjoint()) - 6*traceYuAdjYu*(Yu*Yu.adjoint()*mu2) - 2*AbsSqr(
 ...
 */
Eigen::Matrix<double,3,3> NUTNMSSM_soft_parameters::calc_beta_mu2_three_loop(const Soft_traces& soft_traces) const
{
