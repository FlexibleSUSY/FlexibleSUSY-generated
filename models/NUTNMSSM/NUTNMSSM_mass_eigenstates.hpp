 ...
 */
class NUTNMSSM_mass_eigenstates
   : public NUTNMSSM_soft_parameters
...
public:
   ...
   NUTNMSSM_mass_eigenstates(const NUTNMSSM_mass_eigenstates&) = default;
   NUTNMSSM_mass_eigenstates(NUTNMSSM_mass_eigenstates&&) = default;
   virtual ~NUTNMSSM_mass_eigenstates() = default;
   NUTNMSSM_mass_eigenstates& operator=(const NUTNMSSM_mass_eigenstates&) = default;
   NUTNMSSM_mass_eigenstates& operator=(NUTNMSSM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<NUTNMSSM_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{NUTNMSSM_info::model_name,
   ...
   std::shared_ptr<NUTNMSSM_ewsb_solver_interface> ewsb_solver{};
