...
/**
 * @file NUTNMSSM_mass_eigenstates.hpp
 *
...
#ifndef NUTNMSSM_MASS_EIGENSTATES_H
#define NUTNMSSM_MASS_EIGENSTATES_H
 ...
 */
class NUTNMSSM_mass_eigenstates : public NUTNMSSM_soft_parameters {
public:
   explicit NUTNMSSM_mass_eigenstates(const NUTNMSSM_input_parameters& input_ = NUTNMSSM_input_parameters());
   virtual ~NUTNMSSM_mass_eigenstates();
   ...
   void set_physical(const NUTNMSSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const NUTNMSSM_physical& get_physical() const;
   NUTNMSSM_physical& get_physical();
   const Problems<NUTNMSSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<NUTNMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(NUTNMSSM_info::Particles&) const;
...
private:
   ...
   NUTNMSSM_physical physical; ///< contains the pole masses and mixings
   Problems<NUTNMSSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const NUTNMSSM_mass_eigenstates&);
