...
#include "NUTNMSSM_b_to_s_gamma.hpp"
#include "observables/l_to_l_conversion/settings.hpp"
#include "observables/NUTNMSSM_br_l_to_3l.hpp"
#include "observables/NUTNMSSM_br_l_to_l_gamma.hpp"
#include "observables/NUTNMSSM_l_to_l_conversion.hpp"
                                              ...
                                              const Spectrum_generator_settings& settings)
{
   ...
   try {
      ...
      observables.AMM1(Fe, 1) = NUTNMSSM_amm::calculate_amm<NUTNMSSM_cxx_diagrams::fields::Fe>(MODEL, qedqcd, settings,1);
   } catch (const NonPerturbativeRunningError& e) {
