...
#ifndef NUTNMSSM_WEINBERG_ANGLE_H
#define NUTNMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   NUTNMSSM_weinberg_angle(const NUTNMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NUTNMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NUTNMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
