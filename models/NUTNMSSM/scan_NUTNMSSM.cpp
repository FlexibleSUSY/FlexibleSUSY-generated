...
struct NUTNMSSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
NUTNMSSM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   NUTNMSSM_input_parameters& input)
{
...
void scan(int solver_type, NUTNMSSM_input_parameters& input,
