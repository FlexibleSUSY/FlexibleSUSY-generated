...
class NUTNMSSM_slha : public NUTNMSSM_mass_eigenstates {
public:
   explicit NUTNMSSM_slha(const NUTNMSSM_input_parameters& input_ = NUTNMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NUTNMSSM_slha(const NUTNMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
