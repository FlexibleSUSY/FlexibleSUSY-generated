...
// File generated at Tue 22 Jan 2019 17:34:34

/**
 * @file NUTNMSSM_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 17:34:34 with FlexibleSUSY
...
double calculate_a_muon_impl(NUTNMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const NUTNMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("NUTNMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double NUTNMSSM_a_muon::calculate_a_muon(const NUTNMSSM_mass_eigenstates& model_)
{
...
double NUTNMSSM_a_muon::calculate_a_muon_uncertainty(const NUTNMSSM_mass_eigenstates& model_)
{
   NUTNMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("NUTNMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
