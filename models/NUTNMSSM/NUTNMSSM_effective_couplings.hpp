...
class NUTNMSSM_effective_couplings {
public:
   NUTNMSSM_effective_couplings(const NUTNMSSM_mass_eigenstates&,
                                   const softsusy::QedQcd&,
                                   const Physical_input&);
   ~NUTNMSSM_effective_couplings();
   ...
   void set_model(const NUTNMSSM_mass_eigenstates& model_);
