...
#include "SplitMSSM_low_scale_constraint.hpp"
...
template<>
class SplitMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   SplitMSSM_low_scale_constraint() = default;
   SplitMSSM_low_scale_constraint(SplitMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~SplitMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "SplitMSSM low-scale constraint"; }
