...
/**
 * @file SplitMSSM_two_scale_model_slha.cpp
 * @brief SplitMSSM model class wrapper for SLHA conversion
 */
...
#define CLASSNAME SplitMSSM_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::SplitMSSM_slha(const SplitMSSM_input_parameters& input_)
   : SplitMSSM<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::SplitMSSM_slha(const SplitMSSM<Two_scale>& model_,
...
CLASSNAME::~SplitMSSM_slha()
{
}

void CLASSNAME::clear()
{
   SplitMSSM<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   SplitMSSM<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const SplitMSSM_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

SplitMSSM_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   SplitMSSM<Two_scale>::print(ostr);
