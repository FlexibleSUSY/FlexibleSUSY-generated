...
SplitMSSM_susy_parameters SplitMSSM_susy_parameters::calc_beta() const
{
   ...
   double beta_gYd(calc_beta_gYd_one_loop(TRACE_STRUCT));
   double beta_g2d(calc_beta_g2d_one_loop(TRACE_STRUCT));
   double beta_gYu(calc_beta_gYu_one_loop(TRACE_STRUCT));
   double beta_g2u(calc_beta_g2u_one_loop(TRACE_STRUCT));
