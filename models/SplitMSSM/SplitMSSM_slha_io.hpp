...
public:
   ...
   void set_extra(const SplitMSSM_slha&, const SplitMSSM_scales&, const SplitMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const SplitMSSM_scales&, const SplitMSSM_observables&);
