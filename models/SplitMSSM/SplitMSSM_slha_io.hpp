...
#include "decays/SplitMSSM_decays.hpp"
...
public:
   ...
   void fill(SplitMSSM_slha&) const;
   ...
   void set_decays(const SplitMSSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const SplitMSSM_slha&, const SplitMSSM_scales&, const SplitMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const SplitMSSM_slha&);
   ...
   void fill_decays_data(const SplitMSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const SplitMSSM_scales&, const SplitMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, SplitMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const SplitMSSM_slha&);
...
void SplitMSSM_slha_io::fill(
   ...
   SplitMSSM_decays const * const decays)
{
