...
// File generated at Tue 22 Jan 2019 16:49:08
...
public:
   ...
   template <class Model> void fill(SplitMSSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const SplitMSSM_slha<Model>&, const SplitMSSM_scales&, const SplitMSSM_observables&);
   void set_input(const SplitMSSM_input_parameters&);
   ...
   template <class Model> void set_spectrum(const SplitMSSM_slha<Model>&);
   ...
   static void fill_imminpar_tuple(SplitMSSM_input_parameters&, int, double);
   static void fill_imextpar_tuple(SplitMSSM_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const SplitMSSM_slha<Model>&, const softsusy::QedQcd&, const SplitMSSM_scales&, const SplitMSSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const SplitMSSM_slha<Model>&, const softsusy::QedQcd&, const SplitMSSM_scales&, const SplitMSSM_observables&);
...
private:
   ...
   void set_imminpar(const SplitMSSM_input_parameters&);
   void set_imextpar(const SplitMSSM_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const SplitMSSM_slha<Model>&);
 ...
 */
template <class Model>
void SplitMSSM_slha_io::fill(SplitMSSM_slha<Model>& model) const
{
...
void SplitMSSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const SplitMSSM_slha<Model>& model,
...
SLHAea::Coll SplitMSSM_slha_io::fill_slhaea(
   const SplitMSSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const SplitMSSM_scales& scales, const SplitMSSM_observables& observables)
{
   SLHAea::Coll slhaea;
 ...
 */
template <class Model>
void SplitMSSM_slha_io::set_model_parameters(const SplitMSSM_slha<Model>& model)
{
   {
...
void SplitMSSM_slha_io::set_extra(
   const SplitMSSM_slha<Model>& model, const SplitMSSM_scales& scales,
   const SplitMSSM_observables& observables)
{
 ...
 */
template <class... Ts>
void SplitMSSM_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<SplitMSSM_slha_io> ss(this);
...
{
   set_spectrum(SplitMSSM_slha<SplitMSSM<T> >(model));
}
 ...
 */
template <class Model>
void SplitMSSM_slha_io::set_spectrum(const SplitMSSM_slha<Model>& model)
{
   const SplitMSSM_physical physical(model.get_physical_slha());
