...
int main(int argc, char* argv[])
{
   ...
   SplitMSSM_spectrum_generator<Two_scale> spectrum_generator;
   ...
   SplitMSSM_slha m = std::get<0>(spectrum_generator.get_models_slha());

   Loop_library::set(1);
   Physical_input physical_input;
   SplitMSSM_decays decays(m, qedqcd, physical_input, flexibledecay_settings);
