...
// File generated at Wed 16 Oct 2019 21:52:27
...
double SplitMSSM_soft_parameters::calc_beta_v_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_v = Re(-0.00125*twoLoop*v*(-2400*g2d*g2u*gYd*gYu - 5400*
      ...
      *Sqr(g1) + 1740*traceYeAdjYe*Sqr(g1) + 2420*traceYuAdjYu*Sqr(g1) + 8100*
      ...
      16000*traceYdAdjYd*Sqr(g3) + 16000*traceYuAdjYu*Sqr(g3) + 270*Sqr(g1)*Sqr
      (gYd) + 1350*Sqr(g2)*Sqr(gYd) - 900*Sqr(g2d)*Sqr(gYd) + 270*Sqr(g1)*Sqr(
      gYu) + 1350*Sqr(g2)*Sqr(gYu) - 900*Sqr(g2u)*Sqr(gYu) - 1000*Sqr(gYd)*Sqr(
 ...
 */
double SplitMSSM_soft_parameters::calc_beta_v_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double SplitMSSM_soft_parameters::calc_beta_v_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
