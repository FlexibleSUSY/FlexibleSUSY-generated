...
/**
 * @file SplitMSSM_decays.cpp
 * @brief implementation of particle decays in the SplitMSSM
 *
...
#define CLASSNAME SplitMSSM_decays
#define PHYSICAL(parameter) model.get_physical().parameter

using namespace SplitMSSM_cxx_diagrams;
using namespace SplitMSSM_cxx_diagrams::fields;
namespace info = SplitMSSM_info;
using namespace std::complex_literals;

const SplitMSSM_decay_table& CLASSNAME::get_decay_table() const
{
   return decay_table;
}
...
Decay_amplitude_SVV CLASSNAME::calculate_amplitude<hh, VG, VG>(
   ...
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VG >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VG >::type const& idx_3) const{
...
Decay_amplitude_SVV CLASSNAME::calculate_amplitude<hh, VP, VP>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VP >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VP >::type const& idx_3) const{
...
Decay_amplitude_SVV CLASSNAME::calculate_amplitude<hh, VP, VZ>(
   ...
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VP >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VZ >::type const& idx_3) const{
...
Decay_amplitude_SVV CLASSNAME::calculate_amplitude<hh, VZ, VZ>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VZ >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VZ >::type const& idx_3) const{
...
Decay_amplitude_SVV CLASSNAME::calculate_amplitude<hh, typename conj<VWp>::type, VWp>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<typename fields::conj<fields::VWp>::type >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::VWp >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, typename bar<Fv>::type, Fv>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<typename fields::bar<fields::Fv>::type >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Fv >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, Glu, Glu>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Glu >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Glu >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, typename bar<Fd>::type, Fd>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<typename fields::bar<fields::Fd>::type >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Fd >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, typename bar<Fu>::type, Fu>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<typename fields::bar<fields::Fu>::type >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Fu >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, typename bar<Fe>::type, Fe>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<typename fields::bar<fields::Fe>::type >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Fe >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, Chi, Chi>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Chi >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Chi >::type const& idx_3) const{
...
Decay_amplitude_SFF CLASSNAME::calculate_amplitude<hh, typename bar<Cha>::type, Cha>(
   const context_base& context,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::hh >::type const& idx_1,
   typename SplitMSSM_cxx_diagrams::field_indices<typename fields::bar<fields::Cha>::type >::type const& idx_2,
   typename SplitMSSM_cxx_diagrams::field_indices<fields::Cha >::type const& idx_3) const{
...
typedef boost::mpl::list<
   boost::mpl::list<fields::Cha, fields::Chi>,
   boost::mpl::list<fields::Chi, fields::Cha>
> BSMForWdecay;
...
void CLASSNAME::calculate_hh_decays()
{
   ...
   auto dec_model = [&] () -> std::unique_ptr<
      SplitMSSM_mass_eigenstates_interface> {
      switch (flag) {
         case 1: {
            auto dm = std::make_unique<
               SplitMSSM_mass_eigenstates_decoupling_scheme>(model.get_input())
               ;
         ...
         case 2:
            return std::make_unique<SplitMSSM_mass_eigenstates>(model);
            break;
         default:
   ...
   if (context.physical_mass<hh>(std::array<int, 0>{}) > context.physical_mass<
      ...
      {})) {
      decays.set_decay(partial_width_hh_to_VGVG(dec_model.get()), {
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VG),
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VG)},
         create_process_string<hh, VG, VG>({},{},{}));
   }

   if (context.physical_mass<hh>(std::array<int, 0>{}) > context.physical_mass<
      VP>(std::array<int, 0> {}) + context.physical_mass<VP>(std::array<int, 0>
      {})) {
      decays.set_decay(partial_width_hh_to_VPVP(dec_model.get()), {
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VP),
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VP)},
         create_process_string<hh, VP, VP>({},{},{}));
   }

   if (context.physical_mass<hh>(std::array<int, 0>{}) > context.physical_mass<
      VP>(std::array<int, 0> {}) + context.physical_mass<VZ>(std::array<int, 0>
      {})) {
      decays.set_decay(partial_width_hh_to_VPVZ(dec_model.get()), {
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VP),
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VZ)},
         create_process_string<hh, VP, VZ>({},{},{}));
   }
      decays.set_decay(partial_width_hh_to_VZVZ(dec_model.get()), {
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VZ),
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VZ)},
         create_process_string<hh, VZ, VZ>({},{},{}));
      decays.set_decay(partial_width_hh_to_conjVWpVWp(dec_model.get()), {-
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VWp),
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::VWp)},
         create_process_string<hh, typename conj<VWp>::type, VWp>({},{},{}));
   ...
   for (int gO1 = 0; gO1 < 3; ++gO1) {
      for (int gO2 = 0; gO2 < 3; ++gO2) {
         ...
         decays.set_decay(partial_width_hh_to_barFvFv(dec_model.get(), gO1, gO2
            ), {-SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fv,
            gO1), SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fv,
   ...
   if (context.physical_mass<hh>(std::array<int, 0>{}) > context.physical_mass<
      Glu>(std::array<int, 0> {}) + context.physical_mass<Glu>(std::array<int,
      0> {})) {
      decays.set_decay(partial_width_hh_to_GluGlu(dec_model.get()), {
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Glu),
         SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Glu)},
         create_process_string<hh, Glu, Glu>({},{},{}));
   }
   ...
   for (int gO1 = 0; gO1 < 3; ++gO1) {
      for (int gO2 = 0; gO2 < 3; ++gO2) {
         ...
         decays.set_decay(partial_width_hh_to_barFdFd(dec_model.get(), gO1, gO2
            ), {-SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fd,
            gO1), SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fd,
   ...
   for (int gO1 = 0; gO1 < 3; ++gO1) {
      for (int gO2 = 0; gO2 < 3; ++gO2) {
         ...
         decays.set_decay(partial_width_hh_to_barFuFu(dec_model.get(), gO1, gO2
            ), {-SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fu,
            gO1), SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fu,
   ...
   for (int gO1 = 0; gO1 < 3; ++gO1) {
      for (int gO2 = 0; gO2 < 3; ++gO2) {
         ...
         decays.set_decay(partial_width_hh_to_barFeFe(dec_model.get(), gO1, gO2
            ), {-SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fe,
            gO1), SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Fe,
   ...
   for (int gO1 = 0; gO1 < 4; ++gO1) {
      for (int gO2 = 0; gO2 < 4; ++gO2) {
         ...
         decays.set_decay(partial_width_hh_to_ChiChi(dec_model.get(), gO1, gO2)
            , {SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Chi,
            gO1), SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::Chi
            , gO2)}, create_process_string<hh, Chi, Chi>({},{gO1},{gO2}));
   ...
   for (int gO1 = 0; gO1 < 2; ++gO1) {
      for (int gO2 = 0; gO2 < 2; ++gO2) {
         ...
         decays.set_decay(partial_width_hh_to_barChaCha(dec_model.get(), gO1,
            gO2), {-SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info::
            Cha, gO1), SplitMSSM_info::get_pdg_code_for_particle(SplitMSSM_info
...
double CLASSNAME::partial_width_hh_to_VGVG(SplitMSSM_mass_eigenstates_interface* model) const
{
...
double CLASSNAME::partial_width_hh_to_VPVP(SplitMSSM_mass_eigenstates_interface* model) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_VPVZ(SplitMSSM_mass_eigenstates_interface* model) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
   const typename field_indices<VP>::type out_1_indices {};
...
double CLASSNAME::partial_width_hh_to_VZVZ(SplitMSSM_mass_eigenstates_interface* model) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_conjVWpVWp(SplitMSSM_mass_eigenstates_interface* model) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_barFvFv(SplitMSSM_mass_eigenstates_interface* model, int gO1, int gO2) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_GluGlu(SplitMSSM_mass_eigenstates_interface* model) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_barFdFd(SplitMSSM_mass_eigenstates_interface* model, int gO1, int gO2) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_barFuFu(SplitMSSM_mass_eigenstates_interface* model, int gO1, int gO2) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_barFeFe(SplitMSSM_mass_eigenstates_interface* model, int gO1, int gO2) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_ChiChi(SplitMSSM_mass_eigenstates_interface* model, int gO1, int gO2) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
...
double CLASSNAME::partial_width_hh_to_barChaCha(SplitMSSM_mass_eigenstates_interface* model, int gO1, int gO2) const
{
   context_base context {model};
   const typename field_indices<hh>::type in_indices {};
