...
/**
 * @file cxx_qft/SplitMSSM_npointfunctions_wilsoncoeffs.hpp
 *
...
struct context_with_vertices : context_base {
   ...
   double scale( void ) const {
      return dynamic_cast<SplitMSSM_mass_eigenstates const&>(model).get_scale();
   }
...
public:
   correlation_function_context(
      const SplitMSSM_mass_eigenstates &m,
