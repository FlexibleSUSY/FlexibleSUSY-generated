...
SplitMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBSplitMSSM_SRC += \
		$(DIR)/SplitMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/SplitMSSM_two_scale_ewsb_solver.cpp \
...
LIBSplitMSSM_HDR += \
		...
		$(DIR)/SplitMSSM_two_scale_spectrum_generator.hpp \
