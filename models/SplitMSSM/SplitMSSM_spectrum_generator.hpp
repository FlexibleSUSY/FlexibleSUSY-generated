                                ...
                                const SplitMSSM_input_parameters& input)
{
   ...
   SplitMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   SplitMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   SplitMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
