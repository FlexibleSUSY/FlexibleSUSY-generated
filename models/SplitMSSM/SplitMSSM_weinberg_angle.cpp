...
#define CLASSNAME SplitMSSM_weinberg_angle
 ...
 */
CLASSNAME::SplitMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const SplitMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * SplitMSSM_info::normalization_g3 /
   ...
   sm.set_Yu(Re(model->get_Yu()*(1.4142135623730951*v)/SMvev));
   sm.set_Yd(Re(model->get_Yd()*(1.4142135623730951*v)/SMvev));
   sm.set_Ye(Re(model->get_Ye()*(1.4142135623730951*v)/SMvev));
