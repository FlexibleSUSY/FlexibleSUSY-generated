...
void SplitMSSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void SplitMSSM_slha_io::fill(SplitMSSM_slha& model) const
{
 ...
 * @param settings class of settings
 */
void SplitMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void SplitMSSM_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void SplitMSSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void SplitMSSM_slha_io::set_spinfo(
 ...
 */
void SplitMSSM_slha_io::set_model_parameters(const SplitMSSM_slha& model)
{
   {
...
void SplitMSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void SplitMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void SplitMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void SplitMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void SplitMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void SplitMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, SplitMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void SplitMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = SplitMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + SplitMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void SplitMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void SplitMSSM_slha_io::set_spectrum(const SplitMSSM_slha& model)
{
...
void SplitMSSM_slha_io::set_extra(
   const SplitMSSM_slha& model,
   const SplitMSSM_scales& scales,
...
void SplitMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void SplitMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void SplitMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void SplitMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void SplitMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}
