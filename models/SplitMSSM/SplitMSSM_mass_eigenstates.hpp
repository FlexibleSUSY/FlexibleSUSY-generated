...
public:
   ...
   void set_physical(const SplitMSSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const SplitMSSM_physical& get_physical() const;
   SplitMSSM_physical& get_physical();
   const Problems<SplitMSSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<SplitMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   std::complex<double> CpconjHpbarChaChiPR(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjHpbarChaChiPL(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpAhbarChaChaPR(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpAhbarChaChaPL(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpAhChiChiPR(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpAhChiChiPL(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CphhbarChaChaPR(unsigned gI1, unsigned gI2) const;
   std::complex<double> CphhbarChaChaPL(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CphhChiChiPR(unsigned gI1, unsigned gI2) const;
   std::complex<double> CphhChiChiPL(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpconjVWpbarChaChiPL(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjVWpbarChaChiPR(unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUChiChiAhPL(unsigned gO2, unsigned gI1) const;
   std::complex<double> CpUChiChiAhPR(unsigned gO1, unsigned gI1) const;
   std::complex<double> CpUChiHpChaPL(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpUChiHpChaPR(unsigned gO1, unsigned gI2) const;
   std::complex<double> CpUChiVWpChaPR(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpUChiVWpChaPL(unsigned gO1, unsigned gI2) const;
   std::complex<double> CpUChiconjHpbarChaPL(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpUChiconjHpbarChaPR(unsigned gO1, unsigned gI2) const;
   std::complex<double> CpUChiconjVWpbarChaPR(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpUChiconjVWpbarChaPL(unsigned gO1, unsigned gI2) const;
   std::complex<double> CpUChihhChiPL(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpUChihhChiPR(unsigned gO1, unsigned gI2) const;
   ...
   std::complex<double> CpbarUChaChaAhPL(unsigned gO2, unsigned gI1) const;
   std::complex<double> CpbarUChaChaAhPR(unsigned gO1, unsigned gI1) const;
   std::complex<double> CpbarUChahhChaPL(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpbarUChahhChaPR(unsigned gO1, unsigned gI2) const;
   ...
   std::complex<double> CpbarUChaconjHpChiPL(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpbarUChaconjHpChiPR(unsigned gO1, unsigned gI2) const;
   std::complex<double> CpbarUChaconjVWpChiPR(unsigned gO2, unsigned gI2) const;
   std::complex<double> CpbarUChaconjVWpChiPL(unsigned gO1, unsigned gI2) const;
...
private:
   ...
   Problems<SplitMSSM_info::NUMBER_OF_PARTICLES> problems;
