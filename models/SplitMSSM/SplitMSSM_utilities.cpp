...
// File generated at Mon 19 Sep 2016 09:48:30
...
std::valarray<double> SplitMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const SplitMSSM_observables* observables)
{
   ...
   append(names, SplitMSSM_parameter_getter().get_mass_names());
   append(names, SplitMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, SplitMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = SplitMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = SplitMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = SplitMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? SplitMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
