...
SplitMSSM_low_scale_constraint<Two_scale>::SplitMSSM_low_scale_constraint(
...
void SplitMSSM_low_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
const Eigen::Matrix<std::complex<double>,3,3>& SplitMSSM_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& SplitMSSM_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double SplitMSSM_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double SplitMSSM_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void SplitMSSM_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<SplitMSSM<Two_scale>*>(model_);
}

void SplitMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& SplitMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void SplitMSSM_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void SplitMSSM_low_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void SplitMSSM_low_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
   check_model_ptr();
...
double SplitMSSM_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();
   ...
   const auto get_mh_pole = [&] () {
      double mh_pole = MODEL->get_physical().Mhh;
      if (mh_pole == 0) {
   ...
   SplitMSSM_weinberg_angle::Sm_parameters sm_pars;
   ...
   SplitMSSM_weinberg_angle weinberg(MODEL, sm_pars);
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   check_model_ptr();
...
double SplitMSSM_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   check_model_ptr();
...
double SplitMSSM_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   check_model_ptr();
...
double SplitMSSM_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_running_SM_masses()
{
   check_model_ptr();
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_Yu_DRbar()
{
   check_model_ptr();
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   check_model_ptr();
...
void SplitMSSM_low_scale_constraint<Two_scale>::calculate_Ye_DRbar()
{
   check_model_ptr();
...
void SplitMSSM_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("SplitMSSM_low_scale_constraint<Two_scale>: "
