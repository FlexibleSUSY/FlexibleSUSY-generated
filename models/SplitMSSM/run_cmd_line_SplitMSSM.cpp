...
// File generated at Tue 10 Oct 2017 21:13:41
...
int run_solver(const SplitMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(SplitMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const SplitMSSM_input_parameters& input)
{
   int exit_code = 0;
