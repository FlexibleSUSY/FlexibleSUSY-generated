...
{
   std::cout <<
      "Usage: run_cmd_line_SplitMSSM.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
int run_solver(int loop_library, const SplitMSSM_input_parameters& input)
{
   ...
   SplitMSSM_decays decays;if (settings.get(Spectrum_generator_settings::calculate_sm_masses)) {
...
int run(int solver_type, int loop_library, const SplitMSSM_input_parameters& input)
{
   int exit_code = 0;
