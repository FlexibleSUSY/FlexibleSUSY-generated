...
// File generated at Fri 20 Oct 2017 08:38:40
...
/**
 * @class SplitMSSM_weinberg_angle
...
public:
   ...
   SplitMSSM_weinberg_angle(const SplitMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const SplitMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const SplitMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
