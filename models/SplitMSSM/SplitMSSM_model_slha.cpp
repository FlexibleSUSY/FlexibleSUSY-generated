...
SplitMSSM_slha::SplitMSSM_slha(const SplitMSSM_input_parameters& input_,
 ...
 */
SplitMSSM_slha::SplitMSSM_slha(const SplitMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : SplitMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void SplitMSSM_slha::clear()
{
   SplitMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void SplitMSSM_slha::calculate_spectrum()
{
   SplitMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void SplitMSSM_slha::convert_to_slha()
{
...
void SplitMSSM_slha::calculate_ckm_matrix()
{
...
void SplitMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void SplitMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void SplitMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void SplitMSSM_slha::convert_soft_squared_masses_to_slha()
{

}

const SplitMSSM_physical& SplitMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

SplitMSSM_physical& SplitMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void SplitMSSM_slha::print(std::ostream& ostr) const
{
   SplitMSSM_mass_eigenstates::print(ostr);
...
void SplitMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const SplitMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
