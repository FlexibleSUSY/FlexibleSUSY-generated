...
// File generated at Mon 5 Mar 2018 17:44:21
 ...
 * parameters.
 *
 * This file was generated at Mon 5 Mar 2018 17:44:21 with FlexibleSUSY
...
{
   if (!ewsb_solver) {
      throw SetupError("SplitMSSM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SplitMSSM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SplitMSSM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }
...
{
   const std::complex<double> result = -0.7071067811865475*UM(gI1,1)*(gYd*ZN(
      gI2,0) + g2d*ZN(gI2,1)) + g2d*UM(gI1,0)*ZN(gI2,2);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*(g2d*UM(gI1,1)*UP(gI2,0) - g2u*UM(gI1,0)*UP(gI2,1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*(g2d*Conj(UM(gI2,1))*Conj(UP(gI1,0)) - g2u*Conj(UM(gI2,
      0))*Conj(UP(gI1,1)));
...
std::complex<double> CLASSNAME::CpChiChiAhPR(int gI1, int gI2) const
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(ZN(gI1,2)*(
      -(gYd*ZN(gI2,0)) + g2d*ZN(gI2,1)) + ZN(gI1,3)*(-(gYu*ZN(gI2,0)) + g2u*ZN(gI2
      ,1)) - gYd*ZN(gI1,0)*ZN(gI2,2) + g2d*ZN(gI1,1)*ZN(gI2,2) - gYu*ZN(gI1,0)*ZN(
...
std::complex<double> CLASSNAME::CpChiChiAhPL(int gI1, int gI2) const
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(Conj(ZN(gI1
      ,2))*(gYd*Conj(ZN(gI2,0)) - g2d*Conj(ZN(gI2,1))) + Conj(ZN(gI1,3))*(gYu*Conj
      (ZN(gI2,0)) - g2u*Conj(ZN(gI2,1))) + gYd*Conj(ZN(gI1,0))*Conj(ZN(gI2,2)) -
      g2d*Conj(ZN(gI1,1))*Conj(ZN(gI2,2)) + gYu*Conj(ZN(gI1,0))*Conj(ZN(gI2,3)) -
      g2u*Conj(ZN(gI1,1))*Conj(ZN(gI2,3)));
...
{
   const std::complex<double> result = -0.7071067811865475*(g2d*UM(gI1,1)*UP(
      gI2,0) + g2u*UM(gI1,0)*UP(gI2,1));
...
{
   const std::complex<double> result = 0.5*(ZN(gI1,2)*(gYd*ZN(gI2,0) - g2d*ZN(
...
std::complex<double> CLASSNAME::CpChiChihhPL(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*(Conj(ZN(gI1,2))*(gYd*Conj(ZN(gI2,0)
      ) - g2d*Conj(ZN(gI2,1))) + Conj(ZN(gI1,3))*(-(gYu*Conj(ZN(gI2,0))) + g2u*
      Conj(ZN(gI2,1))) + gYd*Conj(ZN(gI1,0))*Conj(ZN(gI2,2)) - g2d*Conj(ZN(gI1,1))
      *Conj(ZN(gI2,2)) - gYu*Conj(ZN(gI1,0))*Conj(ZN(gI2,3)) + g2u*Conj(ZN(gI1,1))
      *Conj(ZN(gI2,3)));
...
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(Conj(ZN(gI1
      ,2))*(gYd*KroneckerDelta(0,gO2) - g2d*KroneckerDelta(1,gO2)) + Conj(ZN(gI1,3
      ))*(gYu*KroneckerDelta(0,gO2) - g2u*KroneckerDelta(1,gO2)) + gYd*Conj(ZN(gI1
      ,0))*KroneckerDelta(2,gO2) - g2d*Conj(ZN(gI1,1))*KroneckerDelta(2,gO2) + gYu
      *Conj(ZN(gI1,0))*KroneckerDelta(3,gO2) - g2u*Conj(ZN(gI1,1))*KroneckerDelta(
      3,gO2));
...
std::complex<double> CLASSNAME::CpChiUChiAhPR(int gI1, int gO1) const
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(
      KroneckerDelta(2,gO1)*(-(gYd*ZN(gI1,0)) + g2d*ZN(gI1,1)) + KroneckerDelta(3,
      gO1)*(-(gYu*ZN(gI1,0)) + g2u*ZN(gI1,1)) - gYd*KroneckerDelta(0,gO1)*ZN(gI1,2
      ) + g2d*KroneckerDelta(1,gO1)*ZN(gI1,2) - gYu*KroneckerDelta(0,gO1)*ZN(gI1,3
      ) + g2u*KroneckerDelta(1,gO1)*ZN(gI1,3));
...
{
   const std::complex<double> result = -0.5*g2*(2*KroneckerDelta(1,gO2)*UM(gI2,
      0) + 1.4142135623730951*KroneckerDelta(2,gO2)*UM(gI2,1));
...
{
   const std::complex<double> result = -(g2*Conj(UP(gI2,0))*KroneckerDelta(1,
      gO1)) + 0.7071067811865475*g2*Conj(UP(gI2,1))*KroneckerDelta(3,gO1);
...
{
   const std::complex<double> result = 0.5*(Conj(ZN(gI2,2))*(gYd*KroneckerDelta
      (0,gO2) - g2d*KroneckerDelta(1,gO2)) + Conj(ZN(gI2,3))*(-(gYu*KroneckerDelta
      (0,gO2)) + g2u*KroneckerDelta(1,gO2)) + gYd*Conj(ZN(gI2,0))*KroneckerDelta(2
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*(g2d*Conj(UM(gI1,1))*KroneckerDelta(0,gO2) - g2u*Conj(
      UM(gI1,0))*KroneckerDelta(1,gO2));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*(g2d*KroneckerDelta(1,gO1)*UP(gI1,0) - g2u*
      KroneckerDelta(0,gO1)*UP(gI1,1));
...
{
   const std::complex<double> result = -0.7071067811865475*(g2d*KroneckerDelta(
      1,gO1)*UP(gI2,0) + g2u*KroneckerDelta(0,gO1)*UP(gI2,1));
...
{
   const std::complex<double> result = -(g2u*Conj(ZN(gI2,3))*KroneckerDelta(0,
      gO2)) - 0.7071067811865475*(gYu*Conj(ZN(gI2,0)) + g2u*Conj(ZN(gI2,1)))*
...
std::complex<double> CLASSNAME::self_energy_Ah_1loop(double p ) const
{
   ...
   result += 0.5*SUM(gI1,0,3,SUM(gI2,0,3,(AbsSqr(CpChiChiAhPL(gI1,gI2)) +
      AbsSqr(CpChiChiAhPR(gI1,gI2)))*G0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChi(gI2)))));
   result += -SUM(gI1,0,3,MChi(gI1)*SUM(gI2,0,3,B0(Sqr(p),Sqr(MChi(gI1)),Sqr(
      MChi(gI2)))*(Conj(CpChiChiAhPR(gI1,gI2))*CpChiChiAhPL(gI1,gI2) + Conj(
...
std::complex<double> CLASSNAME::self_energy_hh_1loop(double p ) const
{
   ...
   result += 0.5*SUM(gI1,0,3,SUM(gI2,0,3,(AbsSqr(CpChiChihhPL(gI1,gI2)) +
      AbsSqr(CpChiChihhPR(gI1,gI2)))*G0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChi(gI2)))));
   result += -SUM(gI1,0,3,MChi(gI1)*SUM(gI2,0,3,B0(Sqr(p),Sqr(MChi(gI1)),Sqr(
      MChi(gI2)))*(Conj(CpChiChihhPR(gI1,gI2))*CpChiChihhPL(gI1,gI2) + Conj(
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,3,B0(Sqr(p),Sqr(MChi(gI1)),Sqr(MAh))*Conj(CpChiUChiAhPL(
      gI1,gO2))*CpChiUChiAhPR(gI1,gO1)*MChi(gI1));
   ...
   result += SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MHp))*Conj(CpUChiChaHpPL(
      gO2,gI2))*CpUChiChaHpPR(gO1,gI2)*MCha(gI2));
   result += -4*SUM(gI2,0,1,(-0.5 + B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MVWp)))*Conj(
      CpUChiChaVWpPR(gO2,gI2))*CpUChiChaVWpPL(gO1,gI2)*MCha(gI2));
   result += SUM(gI2,0,3,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(Mhh))*Conj(CpChiUChihhPL(
      gI2,gO2))*CpChiUChihhPR(gI2,gO1)*MChi(gI2));
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(MAh))*Conj(
      CpbarUChaChaAhPL(gO2,gI1))*CpbarUChaChaAhPR(gO1,gI1)*MCha(gI1));
   result += SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(Mhh))*Conj(
      CpbarUChaChahhPL(gO2,gI2))*CpbarUChaChahhPR(gO1,gI2)*MCha(gI2));
...
std::complex<double> CLASSNAME::tadpole_hh_1loop() const
{
   ...
   result += SUM(gI1,0,3,A0(Sqr(MChi(gI1)))*(CpChiChihhPL(gI1,gI1) +
      CpChiChihhPR(gI1,gI1))*MChi(gI1));
