...
// File generated at Sun 26 Aug 2018 14:10:16
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:10:16 with FlexibleSUSY
...
double CLASSNAME::get_mass_matrix_Hp() const
{
   ...
   const double mass_matrix_Hp = Re(-mu2 + Lambdax*Sqr(v) + 0.5*Sqr(g2)*Sqr(v))
      ;
...
double CLASSNAME::get_mass_matrix_Ah() const
{
   ...
   const double mass_matrix_Ah = Re(-mu2 + Lambdax*Sqr(v) + 0.5*Sqr(v)*Sqr(g2*
      Cos(ThetaW()) + 0.7745966692414834*g1*Sin(ThetaW())));
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   if (pole_mass_loop_order > 1 && TOP_POLE_QCD_CORRECTION > 0) {
      const double currentScale = get_scale();
      qcd_2l = -0.005681333976786038*Quad(g3) + 0.0006950925484942519*Log(Sqr(
         currentScale)/Sqr(MGlu))*Quad(g3) - 0.0032348537833770956*Log(Sqr(
         currentScale)/Sqr(MFu(2)))*Quad(g3) + 0.0003208119454588855*Log(Sqr(
         currentScale)/Sqr(MGlu))*Log(Sqr(currentScale)/Sqr(MFu(2)))*Quad(g3) -
         0.00016040597272944275*Quad(g3)*Sqr(Log(Sqr(currentScale)/Sqr(MGlu)))
...
double CLASSNAME::calculate_MFu_DRbar(double m_pole, int idx) const
{
   ...
   if (get_thresholds() > 1 && threshold_corrections.mt > 1) {
      const double q_2l = 0.004888215556068238*Quad(g3) + 0.0006950925484942519
         *Log(Sqr(currentScale)/Sqr(MGlu))*Quad(g3) + 0.0032348537833770956*Log
         (Sqr(currentScale)/Sqr(MFu(idx)))*Quad(g3) + 0.0003208119454588855*Log
         (Sqr(currentScale)/Sqr(MGlu))*Log(Sqr(currentScale)/Sqr(MFu(idx)))*
         Quad(g3) - 0.00016040597272944275*Quad(g3)*Sqr(Log(Sqr(currentScale)/
         Sqr(MGlu))) + 0.0008822328500119351*Quad(g3)*Sqr(Log(Sqr(currentScale)
         /Sqr(MFu(idx))));
