...
public:
   ...
   virtual ~SplitMSSM_susy_parameters() {}
...
private:
   ...
   double calc_beta_gYd_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gYd_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gYd_three_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2d_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2d_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2d_three_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gYu_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gYu_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gYu_three_loop(const TRACE_STRUCT_TYPE&) const;
