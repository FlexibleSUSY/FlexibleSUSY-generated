...
SplitMSSM_susy_parameters SplitMSSM_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   if (loops > 0) {
      ...
      beta_gYd += calc_beta_gYd_1_loop(TRACE_STRUCT);
      beta_g2d += calc_beta_g2d_1_loop(TRACE_STRUCT);
      beta_gYu += calc_beta_gYu_1_loop(TRACE_STRUCT);
      ...
      if (loops > 1) {
         ...
         beta_gYd += calc_beta_gYd_2_loop(TRACE_STRUCT);
         beta_g2d += calc_beta_g2d_2_loop(TRACE_STRUCT);
         beta_gYu += calc_beta_gYu_2_loop(TRACE_STRUCT);
   ...
   return SplitMSSM_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
void SplitMSSM_susy_parameters::print() const
{
   this->print(std::cerr);
}
...
SplitMSSM_susy_parameters::Susy_traces SplitMSSM_susy_parameters::calc_susy_traces(int loops) const
{
