...
// File generated at Tue 10 Oct 2017 21:17:41
...
SM_soft_parameters SM_soft_parameters::calc_beta(int loops) const
{
   double beta_mu2 = 0.;
   double beta_v = 0.;
   ...
   const SM_susy_parameters susy_betas(SM_susy_parameters::calc_beta(loops));
...
SM_soft_parameters::Soft_traces SM_soft_parameters::calc_soft_traces(int loops) const
{
