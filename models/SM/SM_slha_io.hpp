...
public:
   ...
   void set_decays(const SM_decay_table&, FlexibleDecay_settings const&);
   ...
   void fill_decays_data(const SM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const SM_scales&, const SM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, SM_decays const * const = nullptr);
