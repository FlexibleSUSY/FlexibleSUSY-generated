...
public:
   ...
   void set_extra(const SM_slha&, const SM_scales&, const SM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const SM_scales&, const SM_observables&);
