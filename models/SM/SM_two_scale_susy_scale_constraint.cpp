...
SM<Two_scale>* SM_susy_scale_constraint<Two_scale>::get_model() const
{
   return model;
}
...
void SM_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& SM_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
