...
namespace SM_info {
   ...
   class SM_particle_names : public Names {
   public:
      virtual ~SM_particle_names() = default;
   ...
   class SM_parameter_names : public Names {
   public:
      virtual ~SM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const SM_particle_names  particle_names_getter{};
   const SM_parameter_names parameter_names_getter{};
