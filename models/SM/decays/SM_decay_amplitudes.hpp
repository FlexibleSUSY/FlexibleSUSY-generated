...
struct Two_body_decay_amplitude_type<
   ...
   std::enable_if_t<SM_cxx_diagrams::fields::is_scalar<Field_in>::value &&
                           SM_cxx_diagrams::fields::is_scalar<Field_out_1>::value &&
                           SM_cxx_diagrams::fields::is_scalar<Field_out_2>::value>> {
...
struct Two_body_decay_amplitude_type<
   ...
   std::enable_if_t<SM_cxx_diagrams::fields::is_scalar<Field_in>::value &&
                           SM_cxx_diagrams::fields::is_scalar<Field_out_1>::value &&
                           SM_cxx_diagrams::fields::is_vector<Field_out_2>::value>> {
...
struct Two_body_decay_amplitude_type<
   Field_in, Field_out_1, Field_out_2,
   std::enable_if_t<SM_cxx_diagrams::fields::is_scalar<Field_in>::value &&
                           SM_cxx_diagrams::fields::is_vector<Field_out_1>::value &&
                           SM_cxx_diagrams::fields::is_scalar<Field_out_2>::value>> {
   using type = Decay_amplitude_SSV;
};
...
struct Two_body_decay_amplitude_type<
   Field_in, Field_out_1, Field_out_2,
   std::enable_if_t<SM_cxx_diagrams::fields::is_scalar<Field_in>::value &&
                           SM_cxx_diagrams::fields::is_fermion<Field_out_1>::value &&
                           SM_cxx_diagrams::fields::is_fermion<Field_out_2>::value>> {
...
struct Two_body_decay_amplitude_type<
   Field_in, Field_out_1, Field_out_2,
   std::enable_if_t<SM_cxx_diagrams::fields::is_fermion<Field_in>::value &&
                           SM_cxx_diagrams::fields::is_fermion<Field_out_1>::value &&
                           SM_cxx_diagrams::fields::is_scalar<Field_out_2>::value>> {
