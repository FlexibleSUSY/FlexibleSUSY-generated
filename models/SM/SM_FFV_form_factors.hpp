...
std::enable_if_t<
   std::is_same_v<Fj, SM_cxx_diagrams::fields::Fe> && std::is_same_v<Fi, SM_cxx_diagrams::fields::Fe> && std::is_same_v<V, SM_cxx_diagrams::fields::VP>,
