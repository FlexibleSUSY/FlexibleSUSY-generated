...
/**
 * @file SM_mass_eigenstates_interface.hpp
 *
...
#ifndef SM_MASS_EIGENSTATES_INTERFACE_H
#define SM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class SM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class SM_mass_eigenstates_interface {
public:
   virtual ~SM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<SM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const SM_input_parameters& get_input_parameters() const = 0;
   virtual SM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const SM_physical& get_physical() const = 0;
   virtual SM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const SM_physical&) = 0;
