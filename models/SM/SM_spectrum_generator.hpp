...
// File generated at Wed 29 Jun 2016 11:27:26
...
private:
   SM_high_scale_constraint<T> high_scale_constraint;
   SM_susy_scale_constraint<T> susy_scale_constraint;
                                ...
                                const SM_input_parameters& input)
{
   ...
   try {
      ...
      const std::string parameter_name =
         parameter_index < 0 ? "Q" : SM_info::parameter_names[parameter_index];
