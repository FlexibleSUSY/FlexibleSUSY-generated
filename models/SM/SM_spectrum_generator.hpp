...
// File generated at Tue 8 Sep 2015 12:00:07
 ...
 */
template <class T>
void SM_spectrum_generator<T>::run(const softsusy::QedQcd& oneset,
...
{
   SM_spectrum_generator_interface<T>::write_running_couplings(filename, low_scale, susy_scale);
}
