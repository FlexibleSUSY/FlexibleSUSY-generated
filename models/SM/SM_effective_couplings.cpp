...
SM_effective_couplings::SM_effective_couplings(
...
void SM_effective_couplings::calculate_effective_couplings()
{
...
void SM_effective_couplings::set_model(const SM_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void SM_effective_couplings::copy_mixing_matrices_from_model()
{
   Vd = PHYSICAL(Vd);
   Ud = PHYSICAL(Ud);
   Vu = PHYSICAL(Vu);
...
standard_model::Standard_model SM_effective_couplings::initialise_SM() const
{
...
void SM_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> SM_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> SM_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> SM_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double SM_effective_couplings::number_of_active_flavours(double m) const
{
...
double SM_effective_couplings::scalar_scaling_factor(double m) const
{
...
double SM_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double SM_effective_couplings::get_hhVPVP_partial_width() const
{
   const double mass = PHYSICAL(Mhh);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP);
}

double SM_effective_couplings::get_hhVGVG_partial_width() const
{
   const double mass = PHYSICAL(Mhh);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG);
}

double SM_effective_couplings::get_AhVPVP_partial_width() const
{
   const double mass = PHYSICAL(MAh);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP);
}

double SM_effective_couplings::get_AhVGVG_partial_width() const
{
   const double mass = PHYSICAL(MAh);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG);
}

std::complex<double> SM_effective_couplings::CpFdhhbarFdPL(unsigned gt1, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_503 += Conj(Ud(gt3,j1))*Yd(j1,j2);
      }
      tmp_502 += tmp_503;
      tmp_501 += (Conj(Vd(gt1,j2))) * tmp_502;
   }
   tmp_500 += tmp_501;
   result += (-0.7071067811865475) * tmp_500;

   return result;
}

std::complex<double> SM_effective_couplings::CpFuhhbarFuPL(unsigned gt1, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_507 += Conj(Uu(gt3,j1))*Yu(j1,j2);
      }
      tmp_506 += tmp_507;
      tmp_505 += (Conj(Vu(gt1,j2))) * tmp_506;
   }
   tmp_504 += tmp_505;
   result += (0.7071067811865475) * tmp_504;

   return result;
}

std::complex<double> SM_effective_couplings::CpFehhbarFePL(unsigned gt1, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_511 += Conj(Ue(gt3,j1))*Ye(j1,j2);
      }
      tmp_510 += tmp_511;
      tmp_509 += (Conj(Ve(gt1,j2))) * tmp_510;
   }
   tmp_508 += tmp_509;
   result += (-0.7071067811865475) * tmp_508;

   return result;
}

double SM_effective_couplings::CphhVWpconjVWp() const
{
...
std::complex<double> SM_effective_couplings::CpAhFdbarFdPL(unsigned gt2, unsigned gt3) const
{
   const auto Yd = MODELPARAMETER(Yd);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_515 += Conj(Ud(gt3,j1))*Yd(j1,j2);
      }
      tmp_514 += tmp_515;
      tmp_513 += (Conj(Vd(gt2,j2))) * tmp_514;
   }
   tmp_512 += tmp_513;
   result += (std::complex<double>(0.,0.7071067811865475)) * tmp_512;

   return result;
}

std::complex<double> SM_effective_couplings::CpAhFubarFuPL(unsigned gt2, unsigned gt3) const
{
   const auto Yu = MODELPARAMETER(Yu);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_519 += Conj(Uu(gt3,j1))*Yu(j1,j2);
      }
      tmp_518 += tmp_519;
      tmp_517 += (Conj(Vu(gt2,j2))) * tmp_518;
   }
   tmp_516 += tmp_517;
   result += (std::complex<double>(0.,0.7071067811865475)) * tmp_516;

   return result;
}

std::complex<double> SM_effective_couplings::CpAhFebarFePL(unsigned gt2, unsigned gt3) const
{
   const auto Ye = MODELPARAMETER(Ye);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_523 += Conj(Ue(gt3,j1))*Ye(j1,j2);
      }
      tmp_522 += tmp_523;
      tmp_521 += (Conj(Ve(gt2,j2))) * tmp_522;
   }
   tmp_520 += tmp_521;
   result += (std::complex<double>(0.,0.7071067811865475)) * tmp_520;

   return result;
}

void SM_effective_couplings::calculate_eff_CphhVPVP()
{
...
void SM_effective_couplings::calculate_eff_CphhVGVG()
{
   const auto g3 = MODELPARAMETER(g3);
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
...
void SM_effective_couplings::calculate_eff_CpAhVPVP()
{
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
   const auto MFe = PHYSICAL(MFe);
...
void SM_effective_couplings::calculate_eff_CpAhVGVG()
{
   const auto g3 = MODELPARAMETER(g3);
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
