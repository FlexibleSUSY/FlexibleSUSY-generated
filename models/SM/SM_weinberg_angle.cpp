...
#define CLASSNAME SM_weinberg_angle
...
void CLASSNAME::set_model(const SM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * SM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * SM_info::normalization_g2;
