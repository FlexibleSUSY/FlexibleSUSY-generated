...
// File generated at Fri 20 Oct 2017 08:39:41

/**
 * @file SM_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 08:39:41 with FlexibleSUSY
...
double calculate_a_muon_impl(SM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const SM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("SM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double SM_a_muon::calculate_a_muon(const SM_mass_eigenstates& model_)
{
...
double SM_a_muon::calculate_a_muon_uncertainty(const SM_mass_eigenstates& model_)
{
   SM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("SM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
