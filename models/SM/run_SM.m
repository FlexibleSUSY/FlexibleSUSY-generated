...
spectrum    = FSSMCalculateSpectrum[handle];
observables = FSSMCalculateObservables[handle];
decays      = FSSMCalculateDecays[handle];

FSSMCloseHandle[handle];
