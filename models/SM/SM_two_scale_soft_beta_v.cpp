...
// File generated at Sun 10 Jan 2016 15:29:36
 ...
 */
double SM_soft_parameters::calc_beta_v_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SM_soft_parameters::calc_beta_v_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
