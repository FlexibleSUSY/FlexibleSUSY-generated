...
class SM_slha : public SM_mass_eigenstates {
public:
   explicit SM_slha(const SM_input_parameters& input_ = SM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit SM_slha(const SM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
