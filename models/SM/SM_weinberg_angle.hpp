...
public:
   ...
   SM_weinberg_angle(const SM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const SM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const SM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
