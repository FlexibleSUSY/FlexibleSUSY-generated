...
#ifndef SM_TWO_SCALE_MATCHING_H
#define SM_TWO_SCALE_MATCHING_H
...
template <class T> class SM_standard_model_Matching;
...
template<>
class SM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   SM_standard_model_Matching();

   SM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       SM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~SM_standard_model_Matching();
