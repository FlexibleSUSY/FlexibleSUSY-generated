...
// File generated at Mon 27 Feb 2017 13:25:36
...
std::valarray<double> SM_spectrum_plotter::to_valarray(double v)
{
   ...
   const SM_observables* observables)
{
   ...
   append(names, SM_parameter_getter().get_mass_names());
   append(names, SM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, SM_observables* observables)
{
   ...
   const std::size_t number_of_masses = SM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = SM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = SM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? SM_observables::NUMBER_OF_OBSERVABLES : 0u);
