...
// File generated at Tue 10 Oct 2017 21:17:35
...
const int SM_susy_parameters::numberOfParameters;
...
SM_susy_parameters SM_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
         ...
         if (loops > 2) {
         #ifdef ENABLE_THREADS
            {
               ...
               auto fut_g3 = global_thread_pool().run_packaged_task
                  ...
                  TRACE_STRUCT); });
               auto fut_Lambdax = global_thread_pool()
                  .run_packaged_task([this, &TRACE_STRUCT](){ return
                  calc_beta_Lambdax_3_loop(TRACE_STRUCT); });
   ...
   return SM_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
SM_input_parameters& SM_susy_parameters::get_input()
{
   return input;
}
...
SM_susy_parameters::Susy_traces SM_susy_parameters::calc_susy_traces(int loops) const
{
