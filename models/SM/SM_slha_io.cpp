 ...
 */
void SM_slha_io::set_decays(const SM_decay_table& decay_table, FlexibleDecay_settings const& flexibledecay_settings)
{
   for (const auto& particle : decay_table) {
      set_decay_block(particle, flexibledecay_settings);
   }
}
void SM_slha_io::fill_decays_data(const SM_decays& decays, FlexibleDecay_settings const& flexibledecay_settings)
{
