...
Eigen::ArrayXd SM_physical::get() const
{
...
void SM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd SM_physical::get_masses() const
{
...
void SM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHp = pars(1);
   MFv(0) = pars(2);
