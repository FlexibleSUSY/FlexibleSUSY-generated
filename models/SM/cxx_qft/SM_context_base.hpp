...
namespace SM_cxx_diagrams {
   ...
   struct context_base {
      SM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(SM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(SM_mass_eigenstates_interface const* const m) : model(*m) {}
