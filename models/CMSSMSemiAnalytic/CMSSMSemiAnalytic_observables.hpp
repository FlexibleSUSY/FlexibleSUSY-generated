...
#ifndef CMSSMSemiAnalytic_OBSERVABLES_H
#define CMSSMSemiAnalytic_OBSERVABLES_H
...
CMSSMSemiAnalytic_observables calculate_observables(
   CMSSMSemiAnalytic_mass_eigenstates&, const softsusy::QedQcd&,
