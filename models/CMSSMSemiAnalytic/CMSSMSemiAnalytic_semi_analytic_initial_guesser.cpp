...
CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::CMSSMSemiAnalytic_initial_guesser(
   CMSSMSemiAnalytic<Semi_analytic>* model_,
   const softsusy::QedQcd& qedqcd_,
   CMSSMSemiAnalytic_low_scale_constraint<Semi_analytic>& low_constraint_,
   CMSSMSemiAnalytic_susy_scale_constraint<Semi_analytic>& susy_constraint_,
   CMSSMSemiAnalytic_high_scale_constraint<Semi_analytic>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("CMSSMSemiAnalytic_initial_guesser: Error: pointer to model"
                       " CMSSMSemiAnalytic<Semi_analytic> must not be zero");
}
 ...
 */
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::guess()
{
 ...
 */
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::guess_susy_parameters()
{
...
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::initial_guess_low_scale_parameters()
{
   ...
   MODEL->set_m0Sq(Re(Sqr(m12)));
   MODEL->set_BMu0(Re(Sqr(m12)));

}

void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::calculate_Yu_DRbar()
{
 ...
 */
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
...
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::initial_guess_high_scale_parameters()
{
 ...
 * threshold corrections.
 */
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::solve_susy_parameters()
{
...
void CMSSMSemiAnalytic_initial_guesser<Semi_analytic>::guess_soft_parameters()
{
