...
int run_solver(const CMSSMSemiAnalytic_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(CMSSMSemiAnalytic_slha_io::fill_slhaea(
...
int run(int solver_type, const CMSSMSemiAnalytic_input_parameters& input)
{
   int exit_code = 0;
