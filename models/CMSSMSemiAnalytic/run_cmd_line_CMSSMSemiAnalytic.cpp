...
{
   std::cout <<
      "Usage: run_cmd_line_CMSSMSemiAnalytic.x [options]\n"
      "Options:\n"
      "  --m12=<value>\n"
      "  --TanBeta=<value>\n"
      "  --Azero=<value>\n"
...
int run_solver(int loop_library, const CMSSMSemiAnalytic_input_parameters& input)
{
   ...
   CMSSMSemiAnalytic_decays decays;decays = CMSSMSemiAnalytic_decays(std::get<0>(models), qedqcd, physical_input, flexibledecay_settings);
...
int run(int solver_type, int loop_library, const CMSSMSemiAnalytic_input_parameters& input)
{
   int exit_code = 0;
