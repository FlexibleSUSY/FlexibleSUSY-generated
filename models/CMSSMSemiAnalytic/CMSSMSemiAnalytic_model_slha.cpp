...
CMSSMSemiAnalytic_slha::CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_input_parameters& input_,
                                   bool do_convert_masses_to_slha)
   : CMSSMSemiAnalytic_mass_eigenstates(input_)
 ...
 */
CMSSMSemiAnalytic_slha::CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : CMSSMSemiAnalytic_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void CMSSMSemiAnalytic_slha::clear()
{
   CMSSMSemiAnalytic_mass_eigenstates::clear();
   physical_slha.clear();
}

void CMSSMSemiAnalytic_slha::calculate_spectrum()
{
   CMSSMSemiAnalytic_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void CMSSMSemiAnalytic_slha::convert_to_slha()
{
...
void CMSSMSemiAnalytic_slha::calculate_ckm_matrix()
{
...
void CMSSMSemiAnalytic_slha::calculate_pmns_matrix()
{
 ...
 */
void CMSSMSemiAnalytic_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void CMSSMSemiAnalytic_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void CMSSMSemiAnalytic_slha::convert_soft_squared_masses_to_slha()
{
...
const CMSSMSemiAnalytic_physical& CMSSMSemiAnalytic_slha::get_physical_slha() const
{
   return physical_slha;
}

CMSSMSemiAnalytic_physical& CMSSMSemiAnalytic_slha::get_physical_slha()
{
   return physical_slha;
}

void CMSSMSemiAnalytic_slha::print(std::ostream& ostr) const
{
   CMSSMSemiAnalytic_mass_eigenstates::print(ostr);
...
void CMSSMSemiAnalytic_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const CMSSMSemiAnalytic_slha& model)
{
   model.print(ostr);
   return ostr;
}
