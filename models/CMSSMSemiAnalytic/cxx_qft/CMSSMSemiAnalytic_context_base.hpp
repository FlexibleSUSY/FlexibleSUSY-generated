...
/**
 * @file cxx_qft/CMSSMSemiAnalytic_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.0 and SARAH 4.14.5 .
 */

#ifndef CMSSMSemiAnalytic_CXXQFT_CONTEXT_BASE_H
#define CMSSMSemiAnalytic_CXXQFT_CONTEXT_BASE_H
...
namespace CMSSMSemiAnalytic_cxx_diagrams {
   ...
   struct context_base {
      CMSSMSemiAnalytic_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(CMSSMSemiAnalytic_mass_eigenstates_interface const& m) : model(m) {}
      context_base(CMSSMSemiAnalytic_mass_eigenstates_interface const* const m) : model(*m) {}
