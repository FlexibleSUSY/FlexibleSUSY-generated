...
#ifndef CMSSMSemiAnalytic_DECAY_TABLE_H
#define CMSSMSemiAnalytic_DECAY_TABLE_H
...
class CMSSMSemiAnalytic_decay_table {
private:
...
public:
   ...
   CMSSMSemiAnalytic_decay_table();
   ~CMSSMSemiAnalytic_decay_table() = default;
   CMSSMSemiAnalytic_decay_table(const CMSSMSemiAnalytic_decay_table&) = default;
   CMSSMSemiAnalytic_decay_table(CMSSMSemiAnalytic_decay_table&&) = default;
   CMSSMSemiAnalytic_decay_table& operator=(const CMSSMSemiAnalytic_decay_table&) = default;
   CMSSMSemiAnalytic_decay_table& operator=(CMSSMSemiAnalytic_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const CMSSMSemiAnalytic_decay_table&);
