...
#include "CMSSMSemiAnalytic_low_scale_constraint.hpp"
...
template<>
class CMSSMSemiAnalytic_low_scale_constraint<Semi_analytic> : public Single_scale_constraint {
public:

   CMSSMSemiAnalytic_low_scale_constraint() = default;
   CMSSMSemiAnalytic_low_scale_constraint(CMSSMSemiAnalytic<Semi_analytic>*, const softsusy::QedQcd&);
   virtual ~CMSSMSemiAnalytic_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "CMSSMSemiAnalytic low-scale constraint"; }
