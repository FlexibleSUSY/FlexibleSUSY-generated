...
// File generated at Fri 10 Apr 2020 20:48:04
 ...
 *
 * This file was generated at Fri 10 Apr 2020 20:48:04 with FlexibleSUSY
...
CMSSMSemiAnalytic_semi_analytic_solutions::CMSSMSemiAnalytic_semi_analytic_solutions()
{
   initialize_trial_values();
}

void CMSSMSemiAnalytic_semi_analytic_solutions::initialize_trial_values()
{
   trial_data[0].boundary_values.m12 = 1;
   trial_data[0].boundary_values.Azero = 0;
   trial_data[0].boundary_values.m0Sq = 0;
   trial_data[0].boundary_values.BMu0 = 0;
   trial_data[0].boundary_values.Mu = 0;
   trial_data[0].basis_sets.push_back(1);
   trial_data[0].basis_sets.push_back(2);

   trial_data[1].boundary_values.m12 = 0;
   trial_data[1].boundary_values.Azero = 1;
   trial_data[1].boundary_values.m0Sq = 0;
   trial_data[1].boundary_values.BMu0 = 0;
   trial_data[1].boundary_values.Mu = 0;
   ...
   trial_data[2].boundary_values.BMu0 = 0;
   trial_data[2].boundary_values.Mu = 0;
   ...
   trial_data[3].boundary_values.BMu0 = 0;
   trial_data[3].boundary_values.Mu = 0;
   ...
   trial_data[4].boundary_values.BMu0 = 1;
   trial_data[4].boundary_values.Mu = 0;
   trial_data[4].basis_sets.push_back(3);

   trial_data[5].boundary_values.m12 = 1;
   trial_data[5].boundary_values.Azero = 0;
   trial_data[5].boundary_values.m0Sq = 0;
   trial_data[5].boundary_values.BMu0 = 0;
   trial_data[5].boundary_values.Mu = 1.5;
   trial_data[5].basis_sets.push_back(3);

   trial_data[6].boundary_values.m12 = 0;
   trial_data[6].boundary_values.Azero = 1;
   trial_data[6].boundary_values.m0Sq = 0;
   trial_data[6].boundary_values.BMu0 = 0;
   trial_data[6].boundary_values.Mu = 1.5;
   trial_data[6].basis_sets.push_back(3);

}

void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_trial_data(const CMSSMSemiAnalytic_mass_eigenstates& model)
{
...
CMSSMSemiAnalytic_mass_eigenstates CMSSMSemiAnalytic_semi_analytic_solutions::run_to_output_scale(
   const CMSSMSemiAnalytic_mass_eigenstates& model, const Boundary_values& values) const
{
   CMSSMSemiAnalytic_mass_eigenstates result(model);
...
std::map<int,CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t> CMSSMSemiAnalytic_semi_analytic_solutions::create_datasets() const
{
 ...
 * coefficients.
 */
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_coefficients(const CMSSMSemiAnalytic_mass_eigenstates& model_)
{
   ...
   auto basis_3 = [] (const Boundary_values& boundary_values) {
      ...
      const auto BMu0 = BOUNDARYVALUE(BMu0);
      const auto m12 = BOUNDARYVALUE(m12);
      const auto Mu = BOUNDARYVALUE(Mu);
      const auto Azero = BOUNDARYVALUE(Azero);
   ...
   calculate_BMu_coefficients(solver_3, datasets[3]);

}

void CMSSMSemiAnalytic_semi_analytic_solutions::set_to_boundary_values(
   CMSSMSemiAnalytic_mass_eigenstates& model, const Boundary_values& boundary_values) const
{
 ...
 */
void CMSSMSemiAnalytic_semi_analytic_solutions::evaluate_solutions(
   CMSSMSemiAnalytic_mass_eigenstates& model) const
{
   ...
   model.set_MassB(Re(m12*MassBCoeff1 + Azero*MassBCoeff2));
   model.set_MassG(Re(m12*MassGCoeff1 + Azero*MassGCoeff2));
   model.set_MassWB(Re(m12*MassWBCoeff1 + Azero*MassWBCoeff2));
   model.set_TYd((m12*TYdCoeff1 + Azero*TYdCoeff2).real());
   model.set_TYe((m12*TYeCoeff1 + Azero*TYeCoeff2).real());
   model.set_TYu((m12*TYuCoeff1 + Azero*TYuCoeff2).real());
   model.set_md2((m0Sq*md2Coeff1 + Azero*m12*md2Coeff3 + md2Coeff4*Sqr(Azero) +
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_MassB_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_MassG_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_MassWB_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_TYd_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_TYe_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_TYu_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_md2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_me2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_mHd2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_mHu2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_ml2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_mq2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_mu2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CMSSMSemiAnalytic_semi_analytic_solutions::calculate_BMu_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
   for (std::size_t j = 0; j < n; ++j) {
      rhs(j) = data[j]->model.get_BMu();
   }
   Eigen::VectorXd solution = solver.solve(rhs);
   BMuCoeff1 = solution(0);
   BMuCoeff2 = solution(1);
   BMuCoeff3 = solution(2);
}
