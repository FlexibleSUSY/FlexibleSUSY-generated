...
// CMSSMSemiAnalytic_parameter_getter ////////////////////////////////////////

std::vector<std::string> CMSSMSemiAnalytic_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_MIXINGS> CMSSMSemiAnalytic_parameter_getter::get_mixing_names()
{
   return CMSSMSemiAnalytic_info::particle_mixing_names;
}

Eigen::ArrayXd CMSSMSemiAnalytic_parameter_getter::get_parameters(const CMSSMSemiAnalytic_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_PARAMETERS> CMSSMSemiAnalytic_parameter_getter::get_parameter_names()
{
   return CMSSMSemiAnalytic_info::parameter_names;
}

std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_PARTICLES> CMSSMSemiAnalytic_parameter_getter::get_particle_names()
{
   return CMSSMSemiAnalytic_info::particle_names;
}

std::vector<std::string> CMSSMSemiAnalytic_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> CMSSMSemiAnalytic_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_MIXINGS> CMSSMSemiAnalytic_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_MIXINGS> CMSSMSemiAnalytic_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_INPUT_PARAMETERS> CMSSMSemiAnalytic_parameter_getter::get_input_parameter_names()
{
   return CMSSMSemiAnalytic_info::input_parameter_names;
}

std::array<std::string, CMSSMSemiAnalytic_info::NUMBER_OF_EXTRA_PARAMETERS> CMSSMSemiAnalytic_parameter_getter::get_extra_parameter_names()
{
   return CMSSMSemiAnalytic_info::extra_parameter_names;
}

decltype(CMSSMSemiAnalytic_info::NUMBER_OF_MASSES) CMSSMSemiAnalytic_parameter_getter::get_number_of_masses()
{
   return CMSSMSemiAnalytic_info::NUMBER_OF_MASSES;
}

// CMSSMSemiAnalytic_spectrum_plotter ////////////////////////////////////////

CMSSMSemiAnalytic_spectrum_plotter::CMSSMSemiAnalytic_spectrum_plotter(const CMSSMSemiAnalytic_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void CMSSMSemiAnalytic_spectrum_plotter::extract_spectrum(const CMSSMSemiAnalytic_mass_eigenstates& model)
{
   spectrum.clear();
...
void CMSSMSemiAnalytic_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("CMSSMSemiAnalytic_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("CMSSMSemiAnalytic_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("CMSSMSemiAnalytic_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void CMSSMSemiAnalytic_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("CMSSMSemiAnalytic_spectrum_plotter::write_spectrum: "
...
namespace CMSSMSemiAnalytic_database {
 ...
 */
void to_database(
   const std::string& file_name, const CMSSMSemiAnalytic_mass_eigenstates& model,
   ...
   const CMSSMSemiAnalytic_observables* observables)
{
   ...
   append(names, CMSSMSemiAnalytic_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, CMSSMSemiAnalytic_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, CMSSMSemiAnalytic_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, CMSSMSemiAnalytic_parameter_getter::get_DRbar_mass_names());
   append(names, CMSSMSemiAnalytic_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, CMSSMSemiAnalytic_parameter_getter::get_pole_mass_names());
   append(names, CMSSMSemiAnalytic_parameter_getter::get_pole_mixing_names());
   ...
   if (CMSSMSemiAnalytic_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, CMSSMSemiAnalytic_observables::get_names());
 ...
 */
CMSSMSemiAnalytic_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, CMSSMSemiAnalytic_observables* observables)
{
   CMSSMSemiAnalytic_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = CMSSMSemiAnalytic_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = CMSSMSemiAnalytic_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = CMSSMSemiAnalytic_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = CMSSMSemiAnalytic_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? CMSSMSemiAnalytic_observables::NUMBER_OF_OBSERVABLES : 0);
