 ...
 */
class CMSSMSemiAnalytic_mass_eigenstates : public CMSSMSemiAnalytic_soft_parameters {
public:
   ...
   void set_physical(const CMSSMSemiAnalytic_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const CMSSMSemiAnalytic_physical& get_physical() const;
   CMSSMSemiAnalytic_physical& get_physical();
   ...
   void set_BMu0(double BMu0_) { BMu0 = BMu0_; }
   void set_MuBV(double MuBV_) { MuBV = MuBV_; }

   double get_m0Sq() const { return m0Sq; }
   double get_BMu0() const { return BMu0; }
   double get_MuBV() const { return MuBV; }
