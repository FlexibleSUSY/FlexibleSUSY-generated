...
/**
 * @file CMSSMSemiAnalytic_mass_eigenstates.hpp
 *
...
#ifndef CMSSMSemiAnalytic_MASS_EIGENSTATES_H
#define CMSSMSemiAnalytic_MASS_EIGENSTATES_H
...
class CMSSMSemiAnalytic_ewsb_solver_interface;
/**
 * @class CMSSMSemiAnalytic_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class CMSSMSemiAnalytic_mass_eigenstates
   : public CMSSMSemiAnalytic_soft_parameters
   , public CMSSMSemiAnalytic_mass_eigenstates_interface
{
public:
   explicit CMSSMSemiAnalytic_mass_eigenstates(const CMSSMSemiAnalytic_input_parameters& input_ = CMSSMSemiAnalytic_input_parameters());
   CMSSMSemiAnalytic_mass_eigenstates(const CMSSMSemiAnalytic_mass_eigenstates&) = default;
   CMSSMSemiAnalytic_mass_eigenstates(CMSSMSemiAnalytic_mass_eigenstates&&) = default;
   virtual ~CMSSMSemiAnalytic_mass_eigenstates() = default;
   CMSSMSemiAnalytic_mass_eigenstates& operator=(const CMSSMSemiAnalytic_mass_eigenstates&) = default;
   CMSSMSemiAnalytic_mass_eigenstates& operator=(CMSSMSemiAnalytic_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<CMSSMSemiAnalytic_ewsb_solver_interface>&);
   ...
   double get_lsp(CMSSMSemiAnalytic_info::Particles&) const;
...
private:
   ...
   mutable Problems problems{CMSSMSemiAnalytic_info::model_name,
   ...
   std::shared_ptr<CMSSMSemiAnalytic_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const CMSSMSemiAnalytic_mass_eigenstates&);
