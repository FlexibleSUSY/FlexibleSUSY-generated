...
/**
 * @file CMSSMSemiAnalytic_semi_analytic_solutions.hpp
...
#ifndef CMSSMSemiAnalytic_SEMI_ANALYTIC_SOLUTIONS_H
#define CMSSMSemiAnalytic_SEMI_ANALYTIC_SOLUTIONS_H
...
class CMSSMSemiAnalytic_semi_analytic_solutions {
public:
   CMSSMSemiAnalytic_semi_analytic_solutions();
   CMSSMSemiAnalytic_semi_analytic_solutions(
      const CMSSMSemiAnalytic_semi_analytic_solutions&) = default;
   CMSSMSemiAnalytic_semi_analytic_solutions(
      CMSSMSemiAnalytic_semi_analytic_solutions&&) = default;
   ~CMSSMSemiAnalytic_semi_analytic_solutions() = default;
   CMSSMSemiAnalytic_semi_analytic_solutions& operator=(
      const CMSSMSemiAnalytic_semi_analytic_solutions&) = default;
   CMSSMSemiAnalytic_semi_analytic_solutions& operator=(
      CMSSMSemiAnalytic_semi_analytic_solutions&&) = default;
   ...
   double get_BMuCoeff1() const { return BMuCoeff1; }
   double get_BMuCoeff2() const { return BMuCoeff2; }
   double get_BMuCoeff3() const { return BMuCoeff3; }
    ...
    */
   void calculate_coefficients(const CMSSMSemiAnalytic_mass_eigenstates&);
    ...
    */
   void evaluate_solutions(CMSSMSemiAnalytic_mass_eigenstates&) const;
...
private:
   ...
   void calculate_trial_data(const CMSSMSemiAnalytic_mass_eigenstates&);
   void set_to_boundary_values(CMSSMSemiAnalytic_mass_eigenstates&,
                               const Boundary_values&) const;
   CMSSMSemiAnalytic_mass_eigenstates run_to_output_scale(
      const CMSSMSemiAnalytic_mass_eigenstates&, const Boundary_values&) const;
   ...
   void calculate_BMu_coefficients(const Eigen::JacobiSVD<Eigen::MatrixXd>&, const Data_vector_t&);

};

template <class MatrixType, int BasisSize, class BasisEvaluator>
Eigen::JacobiSVD<MatrixType> CMSSMSemiAnalytic_semi_analytic_solutions::create_solver(
   const CMSSMSemiAnalytic_semi_analytic_solutions::Data_vector_t& data,
