...
{
   std::cout <<
      "Usage: scan_CMSSMSemiAnalytic.x [options]\n"
      "Options:\n"
      "  --m12=<value>\n"
      "  --TanBeta=<value>\n"
      "  --Azero=<value>\n"
...
struct CMSSMSemiAnalytic_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
CMSSMSemiAnalytic_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   CMSSMSemiAnalytic_input_parameters& input)
{
   ...
   CMSSMSemiAnalytic_scan_result result;
...
void scan(int solver_type, int loop_library, CMSSMSemiAnalytic_input_parameters& input,
