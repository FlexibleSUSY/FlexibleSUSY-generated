...
public:
   ...
   CMSSMSemiAnalytic_susy_parameters& operator=(const CMSSMSemiAnalytic_susy_parameters&) = default;
   CMSSMSemiAnalytic_susy_parameters& operator=(CMSSMSemiAnalytic_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const CMSSMSemiAnalytic_input_parameters& get_input() const;
   CMSSMSemiAnalytic_input_parameters& get_input();
   void set_input_parameters(const CMSSMSemiAnalytic_input_parameters&);

   CMSSMSemiAnalytic_susy_parameters calc_beta() const;
   CMSSMSemiAnalytic_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const CMSSMSemiAnalytic_susy_parameters&);
