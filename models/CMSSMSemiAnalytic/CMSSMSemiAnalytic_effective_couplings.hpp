...
#ifndef CMSSMSemiAnalytic_EFFECTIVE_COUPLINGS_H
#define CMSSMSemiAnalytic_EFFECTIVE_COUPLINGS_H
...
class CMSSMSemiAnalytic_effective_couplings {
public:
   CMSSMSemiAnalytic_effective_couplings(const CMSSMSemiAnalytic_mass_eigenstates&,
   ...
   void set_model(const CMSSMSemiAnalytic_mass_eigenstates& model_);
