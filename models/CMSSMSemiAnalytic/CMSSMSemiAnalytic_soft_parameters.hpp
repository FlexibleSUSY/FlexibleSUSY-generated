...
public:
   ...
   CMSSMSemiAnalytic_soft_parameters& operator=(const CMSSMSemiAnalytic_soft_parameters&) = default;
   CMSSMSemiAnalytic_soft_parameters& operator=(CMSSMSemiAnalytic_soft_parameters&&) = default;
   ...
   CMSSMSemiAnalytic_soft_parameters calc_beta() const;
   CMSSMSemiAnalytic_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const CMSSMSemiAnalytic_soft_parameters&);
