...
// File generated at Fri 10 Apr 2020 20:47:57
...
struct CMSSMSemiAnalytic_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class CMSSMSemiAnalytic_slha_io {
public:
   CMSSMSemiAnalytic_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(CMSSMSemiAnalytic_input_parameters&) const;
   void fill(CMSSMSemiAnalytic_mass_eigenstates&) const;
   template <class Model> void fill(CMSSMSemiAnalytic_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const CMSSMSemiAnalytic_slha<Model>&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&);
   void set_input(const CMSSMSemiAnalytic_input_parameters&);
   ...
   template <class Model> void set_spectrum(const CMSSMSemiAnalytic_slha<Model>&);
   template <class T> void set_spectrum(const CMSSMSemiAnalytic<T>&);
   ...
   static void fill_minpar_tuple(CMSSMSemiAnalytic_input_parameters&, int, double);
   static void fill_extpar_tuple(CMSSMSemiAnalytic_input_parameters&, int, double);
   static void fill_imminpar_tuple(CMSSMSemiAnalytic_input_parameters&, int, double);
   static void fill_imextpar_tuple(CMSSMSemiAnalytic_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const CMSSMSemiAnalytic_slha<Model>&, const softsusy::QedQcd&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const CMSSMSemiAnalytic_slha<Model>&, const softsusy::QedQcd&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const CMSSMSemiAnalytic_input_parameters&);
   void set_imminpar(const CMSSMSemiAnalytic_input_parameters&);
   void set_imextpar(const CMSSMSemiAnalytic_input_parameters&);
   void set_minpar(const CMSSMSemiAnalytic_input_parameters&);
   void set_mass(const CMSSMSemiAnalytic_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const CMSSMSemiAnalytic_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const CMSSMSemiAnalytic_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(CMSSMSemiAnalytic_mass_eigenstates&) const;
   void fill_physical(CMSSMSemiAnalytic_physical&) const;
};
 ...
 */
template <class Model>
void CMSSMSemiAnalytic_slha_io::fill(CMSSMSemiAnalytic_slha<Model>& model) const
{
...
template <class Model>
void CMSSMSemiAnalytic_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const CMSSMSemiAnalytic_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const CMSSMSemiAnalytic_scales& scales,
   const CMSSMSemiAnalytic_observables& observables)
{
   CMSSMSemiAnalytic_slha_io slha_io;
   const CMSSMSemiAnalytic_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll CMSSMSemiAnalytic_slha_io::fill_slhaea(
   const CMSSMSemiAnalytic_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const CMSSMSemiAnalytic_scales& scales, const CMSSMSemiAnalytic_observables& observables)
{
   SLHAea::Coll slhaea;
   CMSSMSemiAnalytic_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void CMSSMSemiAnalytic_slha_io::set_model_parameters(const CMSSMSemiAnalytic_slha<Model>& model)
{
   {
...
void CMSSMSemiAnalytic_slha_io::set_extra(
   const CMSSMSemiAnalytic_slha<Model>& model, const CMSSMSemiAnalytic_scales& scales,
   const CMSSMSemiAnalytic_observables& observables)
{
 ...
 */
template <class T>
void CMSSMSemiAnalytic_slha_io::set_spectrum(const CMSSMSemiAnalytic<T>& model)
{
   set_spectrum(CMSSMSemiAnalytic_slha<CMSSMSemiAnalytic<T> >(model));
}
 ...
 */
template <class Model>
void CMSSMSemiAnalytic_slha_io::set_spectrum(const CMSSMSemiAnalytic_slha<Model>& model)
{
   const CMSSMSemiAnalytic_physical physical(model.get_physical_slha());
