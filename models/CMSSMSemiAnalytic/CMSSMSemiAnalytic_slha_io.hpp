...
public:
   ...
   void set_extra(const CMSSMSemiAnalytic_slha&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&);
