...
public:
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&, const Spectrum_generator_settings&);
