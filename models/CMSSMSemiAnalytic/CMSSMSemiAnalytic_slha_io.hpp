...
struct CMSSMSemiAnalytic_observables;
struct CMSSMSemiAnalytic_physical;
class CMSSMSemiAnalytic_slha;
...
public:
   ...
   void fill(CMSSMSemiAnalytic_slha&) const;
   ...
   void set_decays(const CMSSMSemiAnalytic_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const CMSSMSemiAnalytic_slha&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const CMSSMSemiAnalytic_slha&);
   ...
   void fill_decays_data(const CMSSMSemiAnalytic_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSMSemiAnalytic_scales&, const CMSSMSemiAnalytic_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, CMSSMSemiAnalytic_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const CMSSMSemiAnalytic_slha&);
 ...
 */
template <class... Ts>
void CMSSMSemiAnalytic_slha_io::fill(
   ...
   CMSSMSemiAnalytic_decays const * const decays)
{
