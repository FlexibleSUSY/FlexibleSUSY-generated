...
/**
 * @file CMSSMSemiAnalytic_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 15:27:42 with FlexibleSUSY
...
#define CLASSNAME CMSSMSemiAnalytic_mass_eigenstates
...
CLASSNAME::CMSSMSemiAnalytic_mass_eigenstates(const CMSSMSemiAnalytic_input_parameters& input_)
   : CMSSMSemiAnalytic_soft_parameters(input_)
#if defined(ENABLE_SEMI_ANALYTIC_SOLVER)
   , ewsb_solver(new CMSSMSemiAnalytic_ewsb_solver<Semi_analytic>())
#endif
{
}
...
const CMSSMSemiAnalytic_physical& CLASSNAME::get_physical() const
{
   return physical;
}

CMSSMSemiAnalytic_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const CMSSMSemiAnalytic_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<CMSSMSemiAnalytic_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("CMSSMSemiAnalytic_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("CMSSMSemiAnalytic_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("CMSSMSemiAnalytic_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving CMSSMSemiAnalytic EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "CMSSMSemiAnalytic\n"
           "========================================\n";
   CMSSMSemiAnalytic_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::Se);
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::Hpm);
...
{
   CMSSMSemiAnalytic_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   CMSSMSemiAnalytic_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(CMSSMSemiAnalytic_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = CMSSMSemiAnalytic_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CMSSMSemiAnalytic_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Sd, eigenvalue_error >
      precision * Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Sv, eigenvalue_error >
      precision * Abs(MSv(0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Su, eigenvalue_error >
      precision * Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Se, eigenvalue_error >
      precision * Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Hpm, eigenvalue_error >
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(CMSSMSemiAnalytic_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(CMSSMSemiAnalytic_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::VZ)
      )
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::Sd)
      )
      return;
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::Sv)
      )
      return;
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::Su)
      )
      return;
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::Se)
      )
      return;
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::hh)
      )
      return;
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(CMSSMSemiAnalytic_info::hh);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CMSSMSemiAnalytic_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(CMSSMSemiAnalytic_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::Ah)
      )
      return;
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(CMSSMSemiAnalytic_info::Ah);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CMSSMSemiAnalytic_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(CMSSMSemiAnalytic_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::Hpm
      ))
      return;
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(CMSSMSemiAnalytic_info::Hpm,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CMSSMSemiAnalytic_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(CMSSMSemiAnalytic_info::Hpm);
}
...
{
   if (!force_output && problems.is_running_tachyon(CMSSMSemiAnalytic_info::VWm
      ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CMSSMSemiAnalytic_info::VWm);
...
std::ostream& operator<<(std::ostream& ostr, const CMSSMSemiAnalytic_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
