...
std::enable_if_t<
   std::is_same_v<Fj, CMSSMSemiAnalytic_cxx_diagrams::fields::Fe> && std::is_same_v<Fi, CMSSMSemiAnalytic_cxx_diagrams::fields::Fe> && std::is_same_v<V, CMSSMSemiAnalytic_cxx_diagrams::fields::VP>,
   std::valarray<std::complex<double>>
>
calculate_form_factors(   int, int,
const CMSSMSemiAnalytic_mass_eigenstates&, bool);
