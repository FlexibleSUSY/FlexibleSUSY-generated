...
/**
 * @file CMSSMSemiAnalytic_unitarity.cpp
 *
...
namespace CMSSMSemiAnalytic_unitarity {
...
// s -> infinity limit
UnitarityInfiniteS
max_scattering_eigenvalue_infinite_s(CMSSMSemiAnalytic_mass_eigenstates const& model) {
