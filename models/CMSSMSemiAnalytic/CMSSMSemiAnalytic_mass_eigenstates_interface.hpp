...
/**
 * @file CMSSMSemiAnalytic_mass_eigenstates_interface.hpp
 *
...
#ifndef CMSSMSemiAnalytic_MASS_EIGENSTATES_INTERFACE_H
#define CMSSMSemiAnalytic_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class CMSSMSemiAnalytic_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class CMSSMSemiAnalytic_mass_eigenstates_interface {
public:
   virtual ~CMSSMSemiAnalytic_mass_eigenstates_interface() {}

   virtual std::unique_ptr<CMSSMSemiAnalytic_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const CMSSMSemiAnalytic_input_parameters& get_input_parameters() const = 0;
   virtual CMSSMSemiAnalytic_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const CMSSMSemiAnalytic_physical& get_physical() const = 0;
   virtual CMSSMSemiAnalytic_physical& get_physical() = 0;
   ...
   virtual void set_physical(const CMSSMSemiAnalytic_physical&) = 0;
   ...
   virtual void set_BMu0(double BMu0_) = 0;
   virtual void set_MuBV(double MuBV_) = 0;
   virtual double get_m0Sq() const = 0;
   virtual double get_BMu0() const = 0;
   virtual double get_MuBV() const = 0;
