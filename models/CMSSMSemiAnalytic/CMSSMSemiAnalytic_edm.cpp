...
/**
 * @file CMSSMSemiAnalytic_edm.cpp
 *
...
double calculate_edm(const CMSSMSemiAnalytic_mass_eigenstates& model, const softsusy::QedQcd& qedqcd, int idx)
{
