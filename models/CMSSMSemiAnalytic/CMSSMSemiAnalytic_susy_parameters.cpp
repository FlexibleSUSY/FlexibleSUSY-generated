...
#define CLASSNAME CMSSMSemiAnalytic_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int CMSSMSemiAnalytic_susy_parameters::numberOfParameters;

CMSSMSemiAnalytic_susy_parameters::CMSSMSemiAnalytic_susy_parameters(const CMSSMSemiAnalytic_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

CMSSMSemiAnalytic_susy_parameters::CMSSMSemiAnalytic_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const CMSSMSemiAnalytic_input_parameters& input_
...
Eigen::ArrayXd CMSSMSemiAnalytic_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

CMSSMSemiAnalytic_susy_parameters CMSSMSemiAnalytic_susy_parameters::calc_beta(int loops) const
{
   ...
   return CMSSMSemiAnalytic_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Yu, beta_Mu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu);
}

CMSSMSemiAnalytic_susy_parameters CMSSMSemiAnalytic_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void CMSSMSemiAnalytic_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd CMSSMSemiAnalytic_susy_parameters::get() const
{
...
void CMSSMSemiAnalytic_susy_parameters::print(std::ostream& ostr) const
{
...
void CMSSMSemiAnalytic_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const CMSSMSemiAnalytic_input_parameters& CMSSMSemiAnalytic_susy_parameters::get_input() const
{
   return input;
}

CMSSMSemiAnalytic_input_parameters& CMSSMSemiAnalytic_susy_parameters::get_input()
{
   return input;
}

void CMSSMSemiAnalytic_susy_parameters::set_input_parameters(const CMSSMSemiAnalytic_input_parameters& input_)
{
   input = input_;
}

CMSSMSemiAnalytic_susy_parameters::Susy_traces CMSSMSemiAnalytic_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const CMSSMSemiAnalytic_susy_parameters& susy_pars)
{
