...
/**
 * @file CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef CMSSMSemiAnalytic_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define CMSSMSemiAnalytic_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "CMSSMSemiAnalytic_info.hpp"
#include "CMSSMSemiAnalytic_physical.hpp"
#include "CMSSMSemiAnalytic_soft_parameters.hpp"
#include "CMSSMSemiAnalytic_mass_eigenstates_interface.hpp"
...
#define SUPER(p) CMSSMSemiAnalytic_soft_parameters::p
...
/**
 * @class CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme
   : private CMSSMSemiAnalytic_soft_parameters
   , public CMSSMSemiAnalytic_mass_eigenstates_interface
{
public:
   explicit CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme(const CMSSMSemiAnalytic_input_parameters& input_ = CMSSMSemiAnalytic_input_parameters());
   explicit CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme(const CMSSMSemiAnalytic_mass_eigenstates&);
   CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme(const CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme&) = default;
   CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme(CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme() = default;
   CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme& operator=(const CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme&) = default;
   CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme& operator=(CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<CMSSMSemiAnalytic_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const CMSSMSemiAnalytic_mass_eigenstates&);
   ...
   const CMSSMSemiAnalytic_input_parameters& get_input_parameters() const override;
   CMSSMSemiAnalytic_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const CMSSMSemiAnalytic_physical& get_physical() const override;
   CMSSMSemiAnalytic_physical& get_physical() override;
   ...
   void set_physical(const CMSSMSemiAnalytic_physical&) override;
   ...
   void set_BMu0(double BMu0_) override { BMu0 = BMu0_; }
   void set_MuBV(double MuBV_) override { MuBV = MuBV_; }

   double get_m0Sq() const override { return m0Sq; }
   double get_BMu0() const override { return BMu0; }
   double get_MuBV() const override { return MuBV; }
...
private:
   ...
   CMSSMSemiAnalytic_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{CMSSMSemiAnalytic_info::model_name,
                     &CMSSMSemiAnalytic_info::particle_names_getter,
                     &CMSSMSemiAnalytic_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const CMSSMSemiAnalytic_mass_eigenstates_decoupling_scheme&);
