...
// File generated at Tue 22 Jan 2019 17:58:49
...
const int CMSSMSemiAnalytic_soft_parameters::numberOfParameters;

CMSSMSemiAnalytic_soft_parameters::CMSSMSemiAnalytic_soft_parameters(const CMSSMSemiAnalytic_input_parameters& input_)
   : CMSSMSemiAnalytic_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

CMSSMSemiAnalytic_soft_parameters::CMSSMSemiAnalytic_soft_parameters(
   const CMSSMSemiAnalytic_susy_parameters& susy_model
   ...
   : CMSSMSemiAnalytic_susy_parameters(susy_model)
...
Eigen::ArrayXd CMSSMSemiAnalytic_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

CMSSMSemiAnalytic_soft_parameters CMSSMSemiAnalytic_soft_parameters::calc_beta(int loops) const
{
   ...
   const CMSSMSemiAnalytic_susy_parameters susy_betas(CMSSMSemiAnalytic_susy_parameters::calc_beta(loops));

   return CMSSMSemiAnalytic_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

CMSSMSemiAnalytic_soft_parameters CMSSMSemiAnalytic_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void CMSSMSemiAnalytic_soft_parameters::clear()
{
   CMSSMSemiAnalytic_susy_parameters::clear();
...
Eigen::ArrayXd CMSSMSemiAnalytic_soft_parameters::get() const
{
   Eigen::ArrayXd pars(CMSSMSemiAnalytic_susy_parameters::get());
...
void CMSSMSemiAnalytic_soft_parameters::print(std::ostream& ostr) const
{
   CMSSMSemiAnalytic_susy_parameters::print(ostr);
...
void CMSSMSemiAnalytic_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   CMSSMSemiAnalytic_susy_parameters::set(pars);
...
CMSSMSemiAnalytic_soft_parameters::Soft_traces CMSSMSemiAnalytic_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const CMSSMSemiAnalytic_soft_parameters& soft_pars)
{
