...
namespace CMSSMSemiAnalytic_librarylink {
...
private:
   ...
   void flush() {
      ...
      while (std::getline(buffer, line)) {
         ...
         MLPutFunction(link, "FSCMSSMSemiAnalyticMessage", 1);
...
class CMSSMSemiAnalytic_spectrum {
public:
   virtual ~CMSSMSemiAnalytic_spectrum() = default;

   virtual void put_model_spectra(MLINK link) const = 0;

   virtual const Spectrum_generator_problems& get_problems() const = 0;
   virtual void fill_slha_io(CMSSMSemiAnalytic_slha_io&, const Spectrum_generator_settings&, const FlexibleDecay_settings&) const = 0;
   virtual double get_model_scale() const = 0;
   virtual const CMSSMSemiAnalytic_observables& get_observables() const = 0;
   virtual const CMSSMSemiAnalytic_decays& get_decays() const = 0;

   virtual void calculate_spectrum(
      const Spectrum_generator_settings&, const SLHA_io::Modsel&,
      const softsusy::QedQcd&, const CMSSMSemiAnalytic_input_parameters&) = 0;
...
class CMSSMSemiAnalytic_spectrum_impl : public CMSSMSemiAnalytic_spectrum
{
public:
   virtual ~CMSSMSemiAnalytic_spectrum_impl() = default;
   ...
   virtual void fill_slha_io(CMSSMSemiAnalytic_slha_io&, const Spectrum_generator_settings&, const FlexibleDecay_settings&) const override;
   virtual double get_model_scale() const override { return std::get<0>(models).get_scale(); }
   virtual const CMSSMSemiAnalytic_observables& get_observables() const override { return observables; }
   virtual const CMSSMSemiAnalytic_decays& get_decays() const override { return decays; }

   virtual void calculate_spectrum(
      const Spectrum_generator_settings&, const SLHA_io::Modsel&,
      const softsusy::QedQcd&, const CMSSMSemiAnalytic_input_parameters&) override;
...
private:
   std::tuple<CMSSMSemiAnalytic<Solver_type>> models{};        ///< running parameters and pole masses
   Spectrum_generator_problems problems{};   ///< spectrum generator problems
   CMSSMSemiAnalytic_scales scales{};              ///< scale information
   CMSSMSemiAnalytic_observables observables{};    ///< observables
   CMSSMSemiAnalytic_decays decays{};              ///< decays
};
...
public:
   ...
   void set_input_parameters(const CMSSMSemiAnalytic_input_parameters& input_) { input = input_; }
...
private:
   CMSSMSemiAnalytic_input_parameters input{};     ///< model input parameters
   ...
   std::unique_ptr<CMSSMSemiAnalytic_spectrum> spectrum{nullptr};  ///< spectrum information

   CMSSMSemiAnalytic_slha_io get_slha_io() const;
...
void Model_data::check_spectrum_pointer() const
{
   if (!spectrum) {
      throw SetupError("No spectrum generator set! "
                       "Did you run FSCMSSMSemiAnalyticCalculateSpectrum[]?");
   }
}
...
CMSSMSemiAnalytic_slha_io Model_data::get_slha_io() const
{
   check_spectrum_pointer();
...
void put_spectrum(const CMSSMSemiAnalytic_slha& model, MLINK link)
{
   MLPutRule(link, CMSSMSemiAnalytic_info::model_name);
   MLPutFunction(link, "List", 97);
   ...
   MLPutRuleTo(link, MODELPARAMETER(BMu0), "BMu0");
   MLPutRuleTo(link, MODELPARAMETER(MuBV), "MuBV");
   MLPutRuleTo(link, MODELPARAMETER(scale), "SCALE");
...
template <typename Solver_type>
void CMSSMSemiAnalytic_spectrum_impl<Solver_type>::put_model_spectra(MLINK link) const
{
...
template <typename Solver_type>
void CMSSMSemiAnalytic_spectrum_impl<Solver_type>::calculate_spectrum(
...
template <typename Solver_type>
void CMSSMSemiAnalytic_spectrum_impl<Solver_type>::calculate_model_observables(
...
template <typename Solver_type>
void CMSSMSemiAnalytic_spectrum_impl<Solver_type>::calculate_model_decays(
...
template <typename Solver_type>
void CMSSMSemiAnalytic_spectrum_impl<Solver_type>::fill_slha_io(CMSSMSemiAnalytic_slha_io& slha_io,
...
{
   check_spectrum_pointer();
   CMSSMSemiAnalytic_observables observables = spectrum->get_observables();
...
{
   check_spectrum_pointer();
   CMSSMSemiAnalytic_decays decays = spectrum->get_decays();
   ...
   for (const auto& decays_list : decay_table) {
      ...
      const auto multiplet_and_index_pair = CMSSMSemiAnalytic_info::get_multiplet_and_index_from_pdg(pid);
...
void Model_data::check_spectrum(MLINK link) const
{
   ...
   for (const auto& s: problems.get_problem_strings())
      put_message(link, "FSCMSSMSemiAnalyticCalculateSpectrum", "error", s);

   for (const auto& s: problems.get_warning_strings())
      put_message(link, "FSCMSSMSemiAnalyticCalculateSpectrum", "warning", s);
...
#ifdef ENABLE_SEMI_ANALYTIC_SOLVER
   case 2:
      spectrum.reset(new CMSSMSemiAnalytic_spectrum_impl<Semi_analytic>());
...
DLLEXPORT int FSCMSSMSemiAnalyticGetSettings(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticGetSettings"))
...
DLLEXPORT int FSCMSSMSemiAnalyticGetSMInputParameters(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticGetSMInputParameters"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSCMSSMSemiAnalyticGetInputParameters(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticGetInputParameters"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSCMSSMSemiAnalyticOpenHandle(
...
DLLEXPORT int FSCMSSMSemiAnalyticCloseHandle(
   WolframLibraryData /* libData */, mint Argc, MArgument* Args, MArgument /* Res */)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;
...
DLLEXPORT int FSCMSSMSemiAnalyticSet(
   WolframLibraryData libData, mint Argc, MArgument* Args, MArgument /* Res */)
{
   using namespace flexiblesusy;
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;
...
DLLEXPORT int FSCMSSMSemiAnalyticGetProblems(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticGetProblems"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSCMSSMSemiAnalyticToSLHA(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticToSLHA"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSCMSSMSemiAnalyticGetWarnings(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticGetWarnings"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSCMSSMSemiAnalyticCalculateSpectrum(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticCalculateSpectrum"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSCMSSMSemiAnalyticCalculateObservables(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticCalculateObservables"))
      return LIBRARY_TYPE_ERROR;
   ...
   try {
      ...
      if (data.get_model_scale() == 0.) {
         put_message(link,
            "FSCMSSMSemiAnalyticCalculateObservables", "warning",
            "Renormalization scale is 0.  Did you run "
            "FSCMSSMSemiAnalyticCalculateSpectrum[]?");
      }
      ...
      put_message(link, "FSCMSSMSemiAnalyticCalculateObservables", "error", e.what_detailed());
      put_error_output(link);
   }
...
DLLEXPORT int FSCMSSMSemiAnalyticCalculateDecays(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::CMSSMSemiAnalytic_librarylink;

   if (!check_number_of_args(link, 1, "FSCMSSMSemiAnalyticCalculateDecays"))
      return LIBRARY_TYPE_ERROR;
   ...
   try {
      ...
      if (data.get_model_scale() == 0.) {
         put_message(link,
            "FSCMSSMSemiAnalyticCalculateDecays", "warning",
            "Renormalization scale is 0.  Did you run "
            "FSCMSSMSemiAnalyticCalculateSpectrum[]?");
      }
      ...
      put_message(link, "FSCMSSMSemiAnalyticCalculateDecays", "error", e.what());
      put_error_output(link);
   }
