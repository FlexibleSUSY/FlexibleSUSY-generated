 ...
 *
 * This file was generated at Tue 22 Jan 2019 18:00:12 with FlexibleSUSY
...
double calculate_a_muon_impl(CMSSMSemiAnalytic_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const CMSSMSemiAnalytic_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("CMSSMSemiAnalytic_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double CMSSMSemiAnalytic_a_muon::calculate_a_muon(const CMSSMSemiAnalytic_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("CMSSMSemiAnalytic_a_muon:" << e.what());
...
double CMSSMSemiAnalytic_a_muon::calculate_a_muon_uncertainty(const CMSSMSemiAnalytic_mass_eigenstates& model_)
{
   CMSSMSemiAnalytic_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("CMSSMSemiAnalytic_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
