...
/**
 * @file CMSSMSemiAnalytic_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Fri 10 Apr 2020 20:47:54
...
/**
 * @class CMSSMSemiAnalytic_slha<T>
...
class CMSSMSemiAnalytic_slha : public Model {
public:
   explicit CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_input_parameters& input_ = CMSSMSemiAnalytic_input_parameters());
   explicit CMSSMSemiAnalytic_slha(const Model&, bool do_convert_masses_to_slha = true);
   CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_slha&) = default;
   CMSSMSemiAnalytic_slha(CMSSMSemiAnalytic_slha&&) = default;
   virtual ~CMSSMSemiAnalytic_slha() = default;
   CMSSMSemiAnalytic_slha& operator=(const CMSSMSemiAnalytic_slha&) = default;
   CMSSMSemiAnalytic_slha& operator=(CMSSMSemiAnalytic_slha&&) = default;
   ...
   const CMSSMSemiAnalytic_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   CMSSMSemiAnalytic_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   CMSSMSemiAnalytic_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
CMSSMSemiAnalytic_slha<Model>::CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
CMSSMSemiAnalytic_slha<Model>::CMSSMSemiAnalytic_slha(const Model& model_,
...
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::convert_to_slha()
{
...
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const CMSSMSemiAnalytic_physical& CMSSMSemiAnalytic_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
CMSSMSemiAnalytic_physical& CMSSMSemiAnalytic_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void CMSSMSemiAnalytic_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void CMSSMSemiAnalytic_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const CMSSMSemiAnalytic_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
