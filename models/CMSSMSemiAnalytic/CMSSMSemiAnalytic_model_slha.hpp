...
class CMSSMSemiAnalytic_slha : public CMSSMSemiAnalytic_mass_eigenstates {
public:
   explicit CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_input_parameters& input_ = CMSSMSemiAnalytic_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit CMSSMSemiAnalytic_slha(const CMSSMSemiAnalytic_mass_eigenstates&, bool do_convert_masses_to_slha = true);
