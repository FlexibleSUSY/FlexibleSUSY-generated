...
/**
 * @class CMSSMSemiAnalytic_weinberg_angle
...
public:
   ...
   CMSSMSemiAnalytic_weinberg_angle(const CMSSMSemiAnalytic_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const CMSSMSemiAnalytic_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const CMSSMSemiAnalytic_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
