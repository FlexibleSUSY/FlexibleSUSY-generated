...
#ifndef CMSSMSemiAnalytic_INFO_H
#define CMSSMSemiAnalytic_INFO_H
...
namespace CMSSMSemiAnalytic_info {
   ...
   enum Input_parameters : int { m12, TanBeta, Azero, MuInput,
      NUMBER_OF_INPUT_PARAMETERS };

   enum Extra_parameters : int { m0Sq, BMu0, MuBV, NUMBER_OF_EXTRA_PARAMETERS };
   ...
   class CMSSMSemiAnalytic_particle_names : public Names {
   public:
      virtual ~CMSSMSemiAnalytic_particle_names() = default;
   ...
   class CMSSMSemiAnalytic_parameter_names : public Names {
   public:
      virtual ~CMSSMSemiAnalytic_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const CMSSMSemiAnalytic_particle_names  particle_names_getter{};
   const CMSSMSemiAnalytic_parameter_names parameter_names_getter{};
