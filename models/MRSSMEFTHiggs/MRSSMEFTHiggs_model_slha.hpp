...
class MRSSMEFTHiggs_slha : public MRSSMEFTHiggs_mass_eigenstates {
public:
   explicit MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_input_parameters& input_ = MRSSMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_mass_eigenstates&, bool do_convert_masses_to_slha = true);
