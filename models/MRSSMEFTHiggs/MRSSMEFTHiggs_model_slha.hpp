...
/**
 * @file MRSSMEFTHiggs_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 22 Jan 2019 14:33:34

#ifndef MRSSMEFTHiggs_SLHA_H
#define MRSSMEFTHiggs_SLHA_H
...
class MRSSMEFTHiggs_slha : public Model {
public:
   explicit MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_input_parameters& input_ = MRSSMEFTHiggs_input_parameters());
   explicit MRSSMEFTHiggs_slha(const Model&, bool do_convert_masses_to_slha = true);
   MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_slha&) = default;
   MRSSMEFTHiggs_slha(MRSSMEFTHiggs_slha&&) = default;
   virtual ~MRSSMEFTHiggs_slha() = default;
   MRSSMEFTHiggs_slha& operator=(const MRSSMEFTHiggs_slha&) = default;
   MRSSMEFTHiggs_slha& operator=(MRSSMEFTHiggs_slha&&) = default;
   ...
   const MRSSMEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MRSSMEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MRSSMEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
MRSSMEFTHiggs_slha<Model>::MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MRSSMEFTHiggs_slha<Model>::MRSSMEFTHiggs_slha(const Model& model_,
...
template <class Model>
void MRSSMEFTHiggs_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void MRSSMEFTHiggs_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MRSSMEFTHiggs_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MRSSMEFTHiggs_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MRSSMEFTHiggs_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MRSSMEFTHiggs_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MRSSMEFTHiggs_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MRSSMEFTHiggs_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MRSSMEFTHiggs_physical& MRSSMEFTHiggs_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MRSSMEFTHiggs_physical& MRSSMEFTHiggs_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MRSSMEFTHiggs_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MRSSMEFTHiggs_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MRSSMEFTHiggs_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
