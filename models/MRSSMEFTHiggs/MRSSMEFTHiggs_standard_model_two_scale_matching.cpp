...
#define CLASSNAME MRSSMEFTHiggs_standard_model_matching_up<Two_scale>

CLASSNAME::MRSSMEFTHiggs_standard_model_matching_up(
   standard_model::StandardModel<Two_scale>* low_,
   MRSSMEFTHiggs<Two_scale>* high_,
...
void CLASSNAME::set_models(Model* low, Model* high)
{
   ...
   model = cast_model<MRSSMEFTHiggs<Two_scale>*>(high);
}
...
void CLASSNAME::match()
{
   ...
   if (model->get_thresholds() && loop_order)
      MRSSMEFTHiggs_standard_model_matching::match_low_to_high_scale_model(*model, *eft, loop_order, higgs_idx);
   else
      MRSSMEFTHiggs_standard_model_matching::match_low_to_high_scale_model_tree_level(*model, *eft);
}
...
#define CLASSNAME MRSSMEFTHiggs_standard_model_matching_down<Two_scale>

CLASSNAME::MRSSMEFTHiggs_standard_model_matching_down(
   standard_model::StandardModel<Two_scale>* low_,
   MRSSMEFTHiggs<Two_scale>* high_,
   const Scale_getter& scale_getter_,
   int loop_order_,
...
void CLASSNAME::match()
{
   ...
   if (model->get_thresholds() && loop_order)
      MRSSMEFTHiggs_standard_model_matching::match_high_to_low_scale_model(*eft, *model, loop_order, higgs_idx);
   else
      MRSSMEFTHiggs_standard_model_matching::match_high_to_low_scale_model_tree_level(*eft, *model, higgs_idx);
}
