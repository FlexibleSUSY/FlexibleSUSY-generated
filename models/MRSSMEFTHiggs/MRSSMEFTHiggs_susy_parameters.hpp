...
// File generated at Wed 16 Oct 2019 19:26:25
...
public:
   ...
   MRSSMEFTHiggs_susy_parameters& operator=(const MRSSMEFTHiggs_susy_parameters&) = default;
   MRSSMEFTHiggs_susy_parameters& operator=(MRSSMEFTHiggs_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MRSSMEFTHiggs_input_parameters& get_input() const;
   MRSSMEFTHiggs_input_parameters& get_input();
   void set_input_parameters(const MRSSMEFTHiggs_input_parameters&);

   MRSSMEFTHiggs_susy_parameters calc_beta() const;
   MRSSMEFTHiggs_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MRSSMEFTHiggs_susy_parameters&);
