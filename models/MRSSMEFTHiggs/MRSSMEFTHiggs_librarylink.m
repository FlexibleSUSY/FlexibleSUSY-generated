...
libMRSSMEFTHiggs = FileNameJoin[{Directory[], "models", "MRSSMEFTHiggs", "MRSSMEFTHiggs_librarylink.so"}];

FSMRSSMEFTHiggsGetSettings = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsGetSettings", LinkObject, LinkObject];
FSMRSSMEFTHiggsGetSMInputParameters = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsGetSMInputParameters", LinkObject, LinkObject];
FSMRSSMEFTHiggsGetInputParameters = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsGetInputParameters", LinkObject, LinkObject];
FSMRSSMEFTHiggsGetProblems = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsGetProblems", LinkObject, LinkObject];
FSMRSSMEFTHiggsGetWarnings = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsGetWarnings", LinkObject, LinkObject];
FSMRSSMEFTHiggsToSLHA = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsToSLHA", LinkObject, LinkObject];

FSMRSSMEFTHiggsOpenHandleLib = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsOpenHandle", {{Real,1}}, Integer];
FSMRSSMEFTHiggsCloseHandle = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsCloseHandle", {Integer}, Void];

FSMRSSMEFTHiggsSetLib = LibraryFunctionLoad[libMRSSMEFTHiggs, "FSMRSSMEFTHiggsSet", {Integer, {Real,1}}, Void];
...
FSMRSSMEFTHiggsMessage[s_] := Message[FSMRSSMEFTHiggs::info, s];

FSMRSSMEFTHiggsCheckIsNumeric[a_?NumericQ] := a;
FSMRSSMEFTHiggsCheckIsNumeric[a_] := (Message[FSMRSSMEFTHiggs::nonum, a]; Abort[]);
...
Options[FSMRSSMEFTHiggsOpenHandle] = {
...
FSMRSSMEFTHiggsOpenHandle[OptionsPattern[]] :=
    FSMRSSMEFTHiggsOpenHandleLib[
        FSMRSSMEFTHiggsCheckIsNumeric /@ {
            ...
            (* MRSSMEFTHiggs input parameters *)
            ,
            OptionValue[TanBeta],
            OptionValue[MS],
...
Options[FSMRSSMEFTHiggsSet] = Options[FSMRSSMEFTHiggsOpenHandle];

FSMRSSMEFTHiggsSet[handle_Integer, a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSMRSSMEFTHiggsSet[handle, a, Sequence @@ s, r];

FSMRSSMEFTHiggsSet[handle_Integer, p:OptionsPattern[]] :=
    FSMRSSMEFTHiggsSetLib[
        handle,
        ReleaseHold[Hold[FSMRSSMEFTHiggsCheckIsNumeric /@ {
            (* spectrum generator settings *)
            OptionValue[precisionGoal],
            OptionValue[maxIterations],
            OptionValue[solver],
        ...
        FSMRSSMEFTHiggsGetSMInputParameters[handle] /.
        FSMRSSMEFTHiggsGetInputParameters[handle]]];
