...
// File generated at Tue 10 Oct 2017 21:42:29

/**
 * @file MRSSMEFTHiggs_cxx_diagrams.hpp
 *
 * This file was generated at Tue 10 Oct 2017 21:42:29 with FlexibleSUSY
 * 2.0.0 and SARAH 4.12.0 .
 */

#ifndef MRSSMEFTHiggs_CXXDIAGRAMS_H
#define MRSSMEFTHiggs_CXXDIAGRAMS_H
...
struct Glu {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = bar<Glu>::type;
};
...
struct SRdp {
   ...
   using lorentz_conjugate = conj<SRdp>::type;
};
...
struct SRum {
   ...
   static constexpr int numberOfFieldIndices = 0;
   static constexpr double electric_charge = -1;
   using lorentz_conjugate = conj<SRum>::type;
};
...
struct Rh {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = conj<Rh>::type;
};
...
struct Chi {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = bar<Chi>::type;
};
...
struct Cha1 {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 1;
   using lorentz_conjugate = bar<Cha1>::type;
};
...
struct Cha2 {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = -1;
   using lorentz_conjugate = bar<Cha2>::type;
};
...
template<> struct conj<sigmaO> { using type = sigmaO; };
template<> struct conj<phiO> { using type = phiO; };
...
*/
struct EvaluationContext {
   MRSSMEFTHiggs_mass_eigenstates& model; ///< The model object.
...
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 4, 3 } };
...
template<> struct VertexData<Fe, bar<Chi>::type, conj<Se>::type>
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 4, 6 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
...
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 3, 4 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
};
...
{
   static constexpr impl::IndexBounds<2> index_bounds = { { 0, 0 }, { 4, 4 } };
   static constexpr int fieldIndexStart[4] = { 0, 0, 1, 2 };
   using vertex_type = SingleComponentedVertex;
};
...
template<> struct VertexData<bar<Fe>::type, Sv, bar<Cha1>::type>
{
...
template<> struct VertexData<Fe, conj<Sv>::type, Cha1>
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 3, 2 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
...
template<> struct VertexData<VP, Cha1, bar<Cha1>::type>
{
...
template<> struct VertexData<bar<Fe>::type, bar<Chi>::type, Se>
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 4, 6 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
...
template<> inline
Vertex<Fe, bar<Chi>::type, conj<Se>::type>::vertex_type
Vertex<Fe, bar<Chi>::type, conj<Se>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   const int gt1 = indices[0];
   const int gt2 = indices[1];
   const int gt3 = indices[2];
   ...
   const std::complex<double> left = -(Conj(ZN2(gt2,2))*SUM(j2,0,2,Conj(ZEL(gt1,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1))));

   const std::complex<double> right = -1.0954451150103321*g1*SUM(j1,0,2,ZE(gt3,3 + j1)*ZER(gt1,j1))*ZN1(gt2,0);
...
Vertex<VP, conj<Hpm>::type, Hpm>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> result = 0.5*(-((0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*ZP(gt2,0)*ZP(gt3,0)) - (0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*ZP(gt2,1)*ZP(gt3,1) - 2*g2*Sin(ThetaW)*(ZP(gt2,2)*ZP(gt3,2) + ZP(gt2,3)*ZP(gt3,3)));
...
template<> inline
Vertex<bar<Fe>::type, Sv, bar<Cha1>::type>::vertex_type
Vertex<bar<Fe>::type, Sv, bar<Cha1>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   const int gt1 = indices[0];
   const int gt2 = indices[1];
   const int gt3 = indices[2];
   ...
   const std::complex<double> left = Conj(UM1(gt3,1))*SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Conj(ZER(gt1,j1))*Ye(j1,j2)));

   const std::complex<double> right = -(g2*SUM(j1,0,2,Conj(ZV(gt2,j1))*ZEL(gt1,j1))*UP1(gt3,0));

   return vertex_type(left, right);
}

template<> inline
Vertex<Fe, conj<Sv>::type, Cha1>::vertex_type
Vertex<Fe, conj<Sv>::type, Cha1>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   const int gt1 = indices[0];
   const int gt2 = indices[1];
   const int gt3 = indices[2];
   ...
   const std::complex<double> left = -(g2*Conj(UP1(gt3,0))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZV(gt2,j1)));

   const std::complex<double> right = SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt1,j1))*ZV(gt2,j2))*UM1(gt3,1);

   return vertex_type(left, right);
}

template<> inline
Vertex<VP, Cha1, bar<Cha1>::type>::vertex_type
Vertex<VP, Cha1, bar<Cha1>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   const int gt2 = indices[0];
   const int gt3 = indices[1];
   const auto g2 = MODELPARAMETER(g2);
   ...
   const std::complex<double> left = 0.5*(2*g2*Conj(UM1(gt3,0))*Sin(ThetaW)*UM1(gt2,0) + Conj(UM1(gt3,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UM1(gt2,1));

   const std::complex<double> right = 0.5*(2*g2*Conj(UP1(gt2,0))*Sin(ThetaW)*UP1(gt3,0) + Conj(UP1(gt2,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UP1(gt3,1));

   return vertex_type(left, right);
}

template<> inline
Vertex<bar<Fe>::type, bar<Chi>::type, Se>::vertex_type
Vertex<bar<Fe>::type, bar<Chi>::type, Se>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   const int gt1 = indices[0];
   const int gt2 = indices[1];
   const int gt3 = indices[2];
   ...
   const std::complex<double> left = -(Conj(ZN2(gt2,2))*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Conj(ZER(gt1,j1))*Ye(j1,j2))));

   const std::complex<double> right = 0.7071067811865475*SUM(j1,0,2,Conj(ZE(gt3,j1))*ZEL(gt1,j1))*(0.7745966692414834*g1*ZN1(gt2,0) + g2*ZN1(gt2,1));
...
Vertex<Fe, Chi, conj<Se>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = 0.7071067811865475*(0.7745966692414834*g1*Conj(ZN1(gt2,0)) + g2*Conj(ZN1(gt2,1)))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1));

   const std::complex<double> right = -(SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt1,j1))*ZE(gt3,j2))*ZN2(gt2,2));
...
template<> inline
double EvaluationContext::mass_impl<SRdp>(const std::array<int, 0>& indices) const
{ return model.get_MSRdp(); }

template<> inline
double EvaluationContext::mass_impl<SRum>(const std::array<int, 0>& indices) const
{ return model.get_MSRum(); }

template<> inline
double EvaluationContext::mass_impl<sigmaO>(const std::array<int, 1>& indices) const
{ return model.get_MsigmaO(); }

template<> inline
double EvaluationContext::mass_impl<phiO>(const std::array<int, 1>& indices) const
{ return model.get_MphiO(); }
...
template<> inline
double EvaluationContext::mass_impl<Rh>(const std::array<int, 1>& indices) const
{ return model.get_MRh(indices[0]); }
...
template<> inline
double EvaluationContext::mass_impl<Cha1>(const std::array<int, 1>& indices) const
{ return model.get_MCha1(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<Cha2>(const std::array<int, 1>& indices) const
{ return model.get_MCha2(indices[0]); }
