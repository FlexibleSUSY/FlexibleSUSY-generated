...
int run_solver(int loop_library, const MRSSMEFTHiggs_input_parameters& input)
{
   ...
   MRSSMEFTHiggs_decays decays;if (settings.get(Spectrum_generator_settings::calculate_sm_masses)) {
...
int run(int solver_type, int loop_library, const MRSSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
