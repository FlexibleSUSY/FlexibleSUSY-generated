...
// File generated at Fri 10 Apr 2020 18:07:12
 ...
 */
double MRSSMEFTHiggs_susy_parameters::calc_beta_LamTD_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSMEFTHiggs_susy_parameters::calc_beta_LamTD_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MRSSMEFTHiggs_susy_parameters::calc_beta_LamTD_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
