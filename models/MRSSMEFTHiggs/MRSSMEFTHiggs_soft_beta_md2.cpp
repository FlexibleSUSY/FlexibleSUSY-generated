...
// File generated at Tue 22 Jan 2019 13:53:35
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_md2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = (oneOver16PiSqr*(4*mHd2*(Yd*Yd.adjoint()) + 2*(md2*Yd*Yd.adjoint(
      )) + 4*(Yd*mq2*Yd.adjoint()) + 2*(Yd*Yd.adjoint()*md2) +
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_md2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_md2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_md2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_md2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
