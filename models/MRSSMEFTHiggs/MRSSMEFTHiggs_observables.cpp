...
#include "observables/MRSSMEFTHiggs_br_l_to_3l.hpp"
#include "observables/MRSSMEFTHiggs_br_l_to_l_gamma.hpp"
#include "observables/MRSSMEFTHiggs_l_to_l_conversion.hpp"
                                              ...
                                              const Spectrum_generator_settings& settings)
{
   ...
   try {
      ...
      observables.AMM1(Fe, 1) = MRSSMEFTHiggs_amm::calculate_amm<MRSSMEFTHiggs_cxx_diagrams::fields::Fe>(MODEL, qedqcd, settings,1);
   } catch (const NonPerturbativeRunningError& e) {
