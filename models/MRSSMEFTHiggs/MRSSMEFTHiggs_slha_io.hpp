...
struct MRSSMEFTHiggs_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MRSSMEFTHiggs_slha_io {
public:
   MRSSMEFTHiggs_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MRSSMEFTHiggs_input_parameters&) const;
   void fill(MRSSMEFTHiggs_mass_eigenstates&) const;
   template <class Model> void fill(MRSSMEFTHiggs_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MRSSMEFTHiggs_slha<Model>&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&);
   void set_input(const MRSSMEFTHiggs_input_parameters&);
   ...
   static void fill_minpar_tuple(MRSSMEFTHiggs_input_parameters&, int, double);
   static void fill_extpar_tuple(MRSSMEFTHiggs_input_parameters&, int, double);
   static void fill_imminpar_tuple(MRSSMEFTHiggs_input_parameters&, int, double);
   static void fill_imextpar_tuple(MRSSMEFTHiggs_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MRSSMEFTHiggs_slha<Model>&, const softsusy::QedQcd&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MRSSMEFTHiggs_slha<Model>&, const softsusy::QedQcd&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MRSSMEFTHiggs_input_parameters&);
   void set_imminpar(const MRSSMEFTHiggs_input_parameters&);
   ...
   void fill_drbar_parameters(MRSSMEFTHiggs_mass_eigenstates&) const;
   void fill_physical(MRSSMEFTHiggs_physical&) const;
};
 ...
 */
template <class Model>
void MRSSMEFTHiggs_slha_io::fill(MRSSMEFTHiggs_slha<Model>& model) const
{
...
template <class Model>
void MRSSMEFTHiggs_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MRSSMEFTHiggs_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MRSSMEFTHiggs_scales& scales,
   const MRSSMEFTHiggs_observables& observables)
{
   MRSSMEFTHiggs_slha_io slha_io;
   const MRSSMEFTHiggs_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MRSSMEFTHiggs_slha_io::fill_slhaea(
   const MRSSMEFTHiggs_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MRSSMEFTHiggs_scales& scales, const MRSSMEFTHiggs_observables& observables)
{
   SLHAea::Coll slhaea;
   MRSSMEFTHiggs_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MRSSMEFTHiggs_slha_io::set_model_parameters(const MRSSMEFTHiggs_slha<Model>& model)
{
   {
...
void MRSSMEFTHiggs_slha_io::set_extra(
   const MRSSMEFTHiggs_slha<Model>& model, const MRSSMEFTHiggs_scales& scales,
   const MRSSMEFTHiggs_observables& observables)
{
 ...
 */
template <class... Ts>
void MRSSMEFTHiggs_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MRSSMEFTHiggs_slha_io> ss(this);
 ...
 */
template <class T>
void MRSSMEFTHiggs_slha_io::set_spectrum(const MRSSMEFTHiggs<T>& model)
{
   set_spectrum(MRSSMEFTHiggs_slha<MRSSMEFTHiggs<T> >(model));
}
 ...
 */
template <class Model>
void MRSSMEFTHiggs_slha_io::set_spectrum(const MRSSMEFTHiggs_slha<Model>& model)
{
   const MRSSMEFTHiggs_physical physical(model.get_physical_slha());
