...
public:
   ...
   void set_extra(const MRSSMEFTHiggs_slha&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&);
