...
#include "decays/MRSSMEFTHiggs_decays.hpp"
...
struct MRSSMEFTHiggs_physical;
class MRSSMEFTHiggs_slha;
...
public:
   ...
   void fill(MRSSMEFTHiggs_slha&) const;
   ...
   void set_decays(const MRSSMEFTHiggs_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const MRSSMEFTHiggs_slha&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const MRSSMEFTHiggs_slha&);
   ...
   void fill_decays_data(const MRSSMEFTHiggs_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MRSSMEFTHiggs_scales&, const MRSSMEFTHiggs_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MRSSMEFTHiggs_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const MRSSMEFTHiggs_slha&);
 ...
 */
template <class... Ts>
void MRSSMEFTHiggs_slha_io::fill(
   ...
   MRSSMEFTHiggs_decays const * const decays)
{
