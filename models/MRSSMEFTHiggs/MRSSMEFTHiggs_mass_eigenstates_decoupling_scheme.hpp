...
/**
 * @file MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MRSSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MRSSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
#define SUPER(p) MRSSMEFTHiggs_soft_parameters::p
...
/**
 * @class MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme
   : private MRSSMEFTHiggs_soft_parameters
   , public MRSSMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const MRSSMEFTHiggs_input_parameters& input_ = MRSSMEFTHiggs_input_parameters());
   explicit MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const MRSSMEFTHiggs_mass_eigenstates&);
   MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme(MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme() = default;
   MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(const MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MRSSMEFTHiggs_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MRSSMEFTHiggs_mass_eigenstates&);
   ...
   const MRSSMEFTHiggs_input_parameters& get_input_parameters() const override;
   MRSSMEFTHiggs_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MRSSMEFTHiggs_physical& get_physical() const override;
   MRSSMEFTHiggs_physical& get_physical() override;
   ...
   void set_physical(const MRSSMEFTHiggs_physical&) override;
...
private:
   ...
   Problems problems{MRSSMEFTHiggs_info::model_name,
                     &MRSSMEFTHiggs_info::particle_names_getter,
                     &MRSSMEFTHiggs_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const MRSSMEFTHiggs_mass_eigenstates_decoupling_scheme&);
