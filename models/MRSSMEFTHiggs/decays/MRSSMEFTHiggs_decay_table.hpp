...
#ifndef MRSSMEFTHiggs_DECAY_TABLE_H
#define MRSSMEFTHiggs_DECAY_TABLE_H
...
class MRSSMEFTHiggs_decay_table {
private:
...
public:
   ...
   MRSSMEFTHiggs_decay_table();
   ~MRSSMEFTHiggs_decay_table() = default;
   MRSSMEFTHiggs_decay_table(const MRSSMEFTHiggs_decay_table&) = default;
   MRSSMEFTHiggs_decay_table(MRSSMEFTHiggs_decay_table&&) = default;
   MRSSMEFTHiggs_decay_table& operator=(const MRSSMEFTHiggs_decay_table&) = default;
   MRSSMEFTHiggs_decay_table& operator=(MRSSMEFTHiggs_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const MRSSMEFTHiggs_decay_table&);
