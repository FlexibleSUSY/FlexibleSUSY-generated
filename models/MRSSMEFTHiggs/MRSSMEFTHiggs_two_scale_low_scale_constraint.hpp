...
#ifndef MRSSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MRSSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MRSSMEFTHiggs_low_scale_constraint.hpp"
...
template<>
class MRSSMEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MRSSMEFTHiggs_low_scale_constraint() = default;
   MRSSMEFTHiggs_low_scale_constraint(MRSSMEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MRSSMEFTHiggs_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MRSSMEFTHiggs low-scale constraint"; }
