...
MRSSMEFTHiggs_slha::MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_input_parameters& input_,
 ...
 */
MRSSMEFTHiggs_slha::MRSSMEFTHiggs_slha(const MRSSMEFTHiggs_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MRSSMEFTHiggs_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MRSSMEFTHiggs_slha::clear()
{
   MRSSMEFTHiggs_mass_eigenstates::clear();
   physical_slha.clear();
}

void MRSSMEFTHiggs_slha::calculate_spectrum()
{
   MRSSMEFTHiggs_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MRSSMEFTHiggs_slha::convert_to_slha()
{
...
void MRSSMEFTHiggs_slha::calculate_ckm_matrix()
{
...
void MRSSMEFTHiggs_slha::calculate_pmns_matrix()
{
 ...
 */
void MRSSMEFTHiggs_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MRSSMEFTHiggs_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MRSSMEFTHiggs_slha::convert_soft_squared_masses_to_slha()
{
...
const MRSSMEFTHiggs_physical& MRSSMEFTHiggs_slha::get_physical_slha() const
{
   return physical_slha;
}

MRSSMEFTHiggs_physical& MRSSMEFTHiggs_slha::get_physical_slha()
{
   return physical_slha;
}

void MRSSMEFTHiggs_slha::print(std::ostream& ostr) const
{
   MRSSMEFTHiggs_mass_eigenstates::print(ostr);
...
void MRSSMEFTHiggs_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MRSSMEFTHiggs_slha& model)
{
   model.print(ostr);
   return ostr;
}
