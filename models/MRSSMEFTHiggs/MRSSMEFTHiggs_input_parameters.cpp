...
// File generated at Sun 26 Aug 2018 14:25:33
...
Eigen::ArrayXd MRSSMEFTHiggs_input_parameters::get() const
{
...
void MRSSMEFTHiggs_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   MS = pars(1);
   LamTDInput = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MRSSMEFTHiggs_input_parameters& input)
{
