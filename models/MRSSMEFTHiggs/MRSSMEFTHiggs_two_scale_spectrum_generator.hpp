...
#include "MRSSMEFTHiggs_spectrum_generator_interface.hpp"
...
template <>
class MRSSMEFTHiggs_spectrum_generator<Two_scale>
   : public MRSSMEFTHiggs_spectrum_generator_interface<Two_scale> {
public:
   MRSSMEFTHiggs_spectrum_generator() = default;
   virtual ~MRSSMEFTHiggs_spectrum_generator() = default;
   ...
   void write_running_couplings(const std::string& filename = "MRSSMEFTHiggs_rgflow.dat") const;

protected:
   virtual void run_except(const softsusy::QedQcd&, const MRSSMEFTHiggs_input_parameters&) override;
