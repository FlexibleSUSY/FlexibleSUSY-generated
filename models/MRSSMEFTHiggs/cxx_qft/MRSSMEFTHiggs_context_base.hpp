...
/**
 * @file cxx_qft/MRSSMEFTHiggs_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.4 .
 */

#ifndef MRSSMEFTHiggs_CXXQFT_CONTEXT_BASE_H
#define MRSSMEFTHiggs_CXXQFT_CONTEXT_BASE_H

#include "MRSSMEFTHiggs_fields.hpp"
#include "MRSSMEFTHiggs_mass_eigenstates_interface.hpp"

namespace flexiblesusy {
namespace MRSSMEFTHiggs_cxx_diagrams {

   struct context_base {
      MRSSMEFTHiggs_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MRSSMEFTHiggs_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MRSSMEFTHiggs_mass_eigenstates_interface const* const m) : model(*m) {}
...
template<> inline
double context_base::mass_impl<fields::SRdp>(const std::array<int, 0>& indices) const
{ return model.get_MSRdp(); }

template<> inline
double context_base::mass_impl<fields::SRum>(const std::array<int, 0>& indices) const
{ return model.get_MSRum(); }

template<> inline
double context_base::mass_impl<fields::sigmaO>(const std::array<int, 0>& indices) const
{ return model.get_MsigmaO(); }

template<> inline
double context_base::mass_impl<fields::phiO>(const std::array<int, 0>& indices) const
...
template<> inline
double context_base::mass_impl<fields::Rh>(const std::array<int, 1>& indices) const
...
template<> inline
double context_base::mass_impl<fields::Cha1>(const std::array<int, 1>& indices) const
{ return model.get_MCha1(indices[0]); }

template<> inline
double context_base::mass_impl<fields::Cha2>(const std::array<int, 1>& indices) const
...
template<> inline
double context_base::physical_mass_impl<fields::SRdp>(const std::array<int, 0>& indices) const
{ return model.get_physical().MSRdp; }

template<> inline
double context_base::physical_mass_impl<fields::SRum>(const std::array<int, 0>& indices) const
{ return model.get_physical().MSRum; }

template<> inline
double context_base::physical_mass_impl<fields::sigmaO>(const std::array<int, 0>& indices) const
{ return model.get_physical().MsigmaO; }

template<> inline
double context_base::physical_mass_impl<fields::phiO>(const std::array<int, 0>& indices) const
{ return model.get_physical().MphiO; }
...
template<> inline
double context_base::physical_mass_impl<fields::Rh>(const std::array<int, 1>& indices) const
{ return model.get_physical().MRh[indices[0]]; }
...
template<> inline
double context_base::physical_mass_impl<fields::Cha1>(const std::array<int, 1>& indices) const
{ return model.get_physical().MCha1[indices[0]]; }

template<> inline
double context_base::physical_mass_impl<fields::Cha2>(const std::array<int, 1>& indices) const
{ return model.get_physical().MCha2[indices[0]]; }
