...
// MRSSMEFTHiggs_parameter_getter ////////////////////////////////////////

std::vector<std::string> MRSSMEFTHiggs_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace MRSSMEFTHiggs_info;
...
std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_MIXINGS> MRSSMEFTHiggs_parameter_getter::get_mixing_names()
{
   return MRSSMEFTHiggs_info::particle_mixing_names;
}

Eigen::ArrayXd MRSSMEFTHiggs_parameter_getter::get_parameters(const MRSSMEFTHiggs_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_PARAMETERS> MRSSMEFTHiggs_parameter_getter::get_parameter_names()
{
   return MRSSMEFTHiggs_info::parameter_names;
}

std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_PARTICLES> MRSSMEFTHiggs_parameter_getter::get_particle_names()
{
   return MRSSMEFTHiggs_info::particle_names;
}

std::vector<std::string> MRSSMEFTHiggs_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> MRSSMEFTHiggs_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_MIXINGS> MRSSMEFTHiggs_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_MIXINGS> MRSSMEFTHiggs_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_INPUT_PARAMETERS> MRSSMEFTHiggs_parameter_getter::get_input_parameter_names()
{
   return MRSSMEFTHiggs_info::input_parameter_names;
}

std::array<std::string, MRSSMEFTHiggs_info::NUMBER_OF_EXTRA_PARAMETERS> MRSSMEFTHiggs_parameter_getter::get_extra_parameter_names()
{
   return MRSSMEFTHiggs_info::extra_parameter_names;
}

decltype(MRSSMEFTHiggs_info::NUMBER_OF_MASSES) MRSSMEFTHiggs_parameter_getter::get_number_of_masses()
{
   return MRSSMEFTHiggs_info::NUMBER_OF_MASSES;
}

// MRSSMEFTHiggs_spectrum_plotter ////////////////////////////////////////

MRSSMEFTHiggs_spectrum_plotter::MRSSMEFTHiggs_spectrum_plotter(const MRSSMEFTHiggs_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void MRSSMEFTHiggs_spectrum_plotter::extract_spectrum(const MRSSMEFTHiggs_mass_eigenstates& model)
{
   spectrum.clear();
...
void MRSSMEFTHiggs_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("MRSSMEFTHiggs_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("MRSSMEFTHiggs_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("MRSSMEFTHiggs_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void MRSSMEFTHiggs_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("MRSSMEFTHiggs_spectrum_plotter::write_spectrum: "
...
namespace MRSSMEFTHiggs_database {
 ...
 */
void to_database(
   const std::string& file_name, const MRSSMEFTHiggs_mass_eigenstates& model,
   ...
   const MRSSMEFTHiggs_observables* observables)
{
   ...
   append(names, MRSSMEFTHiggs_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, MRSSMEFTHiggs_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, MRSSMEFTHiggs_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, MRSSMEFTHiggs_parameter_getter::get_DRbar_mass_names());
   append(names, MRSSMEFTHiggs_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, MRSSMEFTHiggs_parameter_getter::get_pole_mass_names());
   append(names, MRSSMEFTHiggs_parameter_getter::get_pole_mixing_names());
   ...
   if (MRSSMEFTHiggs_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, MRSSMEFTHiggs_observables::get_names());
 ...
 */
MRSSMEFTHiggs_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, MRSSMEFTHiggs_observables* observables)
{
   MRSSMEFTHiggs_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = MRSSMEFTHiggs_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = MRSSMEFTHiggs_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = MRSSMEFTHiggs_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = MRSSMEFTHiggs_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? MRSSMEFTHiggs_observables::NUMBER_OF_OBSERVABLES : 0);
