...
// File generated at Wed 16 Oct 2019 19:27:19
 ...
 */
double MRSSMEFTHiggs_soft_parameters::calc_beta_MDGoc_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMEFTHiggs_soft_parameters::calc_beta_MDGoc_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSMEFTHiggs_soft_parameters::calc_beta_MDGoc_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
