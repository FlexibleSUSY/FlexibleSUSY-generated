...
// File generated at Tue 10 Oct 2017 20:45:55
...
const int MRSSMEFTHiggs_soft_parameters::numberOfParameters;

MRSSMEFTHiggs_soft_parameters::MRSSMEFTHiggs_soft_parameters(const MRSSMEFTHiggs_input_parameters& input_)
   : MRSSMEFTHiggs_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MRSSMEFTHiggs_soft_parameters::MRSSMEFTHiggs_soft_parameters(
   const MRSSMEFTHiggs_susy_parameters& susy_model
   ...
   : MRSSMEFTHiggs_susy_parameters(susy_model)
...
Eigen::ArrayXd MRSSMEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MRSSMEFTHiggs_soft_parameters MRSSMEFTHiggs_soft_parameters::calc_beta(int loops) const
{
   double beta_BMu = 0.;
   double beta_BMuD = 0.;
   double beta_BMuU = 0.;
   ...
   const MRSSMEFTHiggs_susy_parameters susy_betas(MRSSMEFTHiggs_susy_parameters::calc_beta(loops));

   return MRSSMEFTHiggs_soft_parameters(susy_betas, beta_BMu, beta_BMuD, beta_BMuU, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_mS2, beta_mT2, beta_moc2, beta_mRd2, beta_mRu2, beta_MDBS, beta_MDWBT, beta_MDGoc);
}

MRSSMEFTHiggs_soft_parameters MRSSMEFTHiggs_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MRSSMEFTHiggs_soft_parameters::clear()
{
   MRSSMEFTHiggs_susy_parameters::clear();
...
Eigen::ArrayXd MRSSMEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MRSSMEFTHiggs_susy_parameters::get());
...
void MRSSMEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   MRSSMEFTHiggs_susy_parameters::print(ostr);
...
void MRSSMEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MRSSMEFTHiggs_susy_parameters::set(pars);
...
MRSSMEFTHiggs_soft_parameters::Soft_traces MRSSMEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MRSSMEFTHiggs_soft_parameters& soft_pars)
{
