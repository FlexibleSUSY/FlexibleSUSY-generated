...
class MRSSMEFTHiggs_effective_couplings {
public:
   MRSSMEFTHiggs_effective_couplings(const MRSSMEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const MRSSMEFTHiggs_mass_eigenstates& model_);
