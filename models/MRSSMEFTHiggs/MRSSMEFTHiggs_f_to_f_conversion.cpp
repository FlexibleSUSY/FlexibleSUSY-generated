...
/**
 * @file MRSSMEFTHiggs_f_to_f_conversion.cpp
 *
...
namespace MRSSMEFTHiggs_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const MRSSMEFTHiggs_mass_eigenstates& model) {
