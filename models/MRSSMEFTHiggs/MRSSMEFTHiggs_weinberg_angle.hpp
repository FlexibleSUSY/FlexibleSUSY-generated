...
#ifndef MRSSMEFTHiggs_WEINBERG_ANGLE_H
#define MRSSMEFTHiggs_WEINBERG_ANGLE_H
...
/**
 * @class MRSSMEFTHiggs_weinberg_angle
...
public:
   ...
   MRSSMEFTHiggs_weinberg_angle(const MRSSMEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MRSSMEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MRSSMEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
   ...
   std::complex<double> CpbarCha1FvconjSePL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpCha2FvconjSePL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpChiFvconjSvPL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpCha1FeconjSvPL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpbarChiFeconjSePL(int gI1, int gO1, int gI2) const;
