 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_ml2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_ml2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_ml2 = (twoLoop*(0.2*(-10*(2*mHd2 + mRd2 + mS2)*AbsSqr(LamSD) - 15*(2*
      mHd2 + mRd2 + mT2)*AbsSqr(LamTD) + 2*(-5*(3*tracemd2YdAdjYd +
      ...
      *Ye*Ye.adjoint()*me2*Ye) - 2*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*ml2) + (0.4
      *g1*(3*g1*Tr2U111 - 7.745966692414834*Tr31) + 6*Tr22*Quad(g2))*UNITMATRIX
      (3))).real();
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_ml2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSMEFTHiggs_soft_parameters::calc_beta_ml2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
