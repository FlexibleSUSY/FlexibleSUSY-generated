...
// File generated at Tue 22 Jan 2019 14:34:52
...
{
   std::cout <<
      "Usage: scan_MRSSMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MS=<value>\n"
      "  --LamTDInput=<value>\n"
...
struct MRSSMEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MRSSMEFTHiggs_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MRSSMEFTHiggs_input_parameters& input)
{
   ...
   MRSSMEFTHiggs_scan_result result;
...
void scan(int solver_type, MRSSMEFTHiggs_input_parameters& input,
