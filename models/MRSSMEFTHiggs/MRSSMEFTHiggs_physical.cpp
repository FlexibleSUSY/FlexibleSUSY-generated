...
void MRSSMEFTHiggs_physical::clear()
{
   MVG = 0.;
   MGlu = 0.;
 ...
 * to be complex.
 */
void MRSSMEFTHiggs_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void MRSSMEFTHiggs_physical::convert_to_slha()
{

}

Eigen::ArrayXd MRSSMEFTHiggs_physical::get() const
{
...
void MRSSMEFTHiggs_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MRSSMEFTHiggs_physical::get_masses() const
{
...
void MRSSMEFTHiggs_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void MRSSMEFTHiggs_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MRSSMEFTHiggs_physical& phys_pars)
{
