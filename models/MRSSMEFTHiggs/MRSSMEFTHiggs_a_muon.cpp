...
// File generated at Fri 20 Oct 2017 08:40:46

/**
 * @file MRSSMEFTHiggs_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 08:40:46 with FlexibleSUSY
...
#include "MRSSMEFTHiggs_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(MRSSMEFTHiggs_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MRSSMEFTHiggs_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MRSSMEFTHiggs_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MRSSMEFTHiggs_a_muon::calculate_a_muon(const MRSSMEFTHiggs_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("MRSSMEFTHiggs_a_muon:" << e.what());
...
double MRSSMEFTHiggs_a_muon::calculate_a_muon_uncertainty(const MRSSMEFTHiggs_mass_eigenstates& model_)
{
   MRSSMEFTHiggs_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MRSSMEFTHiggs_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
