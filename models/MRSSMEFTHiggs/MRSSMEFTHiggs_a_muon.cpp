...
#include "MRSSMEFTHiggs_FFV_form_factors.hpp"
...
using namespace MRSSMEFTHiggs_cxx_diagrams;
...
double get_MSUSY(const MRSSMEFTHiggs_mass_eigenstates_interface& model)
{
...
void run_to_MSUSY(MRSSMEFTHiggs_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("MRSSMEFTHiggs_a_muon: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("MRSSMEFTHiggs_a_muon:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("MRSSMEFTHiggs_a_muon: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("MRSSMEFTHiggs_a_muon: run_to_MSUSY(): "
...
double calculate_a_muon_impl(const MRSSMEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   VERBOSE_MSG("MRSSMEFTHiggs_a_muon: calculating a_mu at Q = " << model.get_scale());

   context_base context{ model };

   using namespace MRSSMEFTHiggs_cxx_diagrams::fields;

   const auto form_factors = MRSSMEFTHiggs_FFV_form_factors::calculate_Fe_Fe_VP_form_factors(1, 1, model, true);
   ...
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Cha1>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Cha2>::type, Ah>::value({1}, context, qedqcd);
   ...
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SRdp>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SRum>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Su>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Cha1>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Cha2>::type, hh>::value({1}, context, qedqcd);
   ...
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SRdp>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SRum>::type, hh>::value({1}, context, qedqcd);
   ...
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Cha1>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Cha2>::type, Ah>::value({1}, context, qedqcd);
   ...
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Cha1>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Cha2>::type, hh>::value({1}, context, qedqcd);
...
std::pair<double,double> vary_scale(const MRSSMEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model,&qedqcd] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MRSSMEFTHiggs_a_muon: scale variation: " << e.what_detailed());
                     }
                     return amu;
                  });
...
double MRSSMEFTHiggs_a_muon::calculate_a_muon(const MRSSMEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   MRSSMEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("MRSSMEFTHiggs_a_muon: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MRSSMEFTHiggs_a_muon:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
double MRSSMEFTHiggs_a_muon::calculate_a_muon_uncertainty(const MRSSMEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   MRSSMEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("MRSSMEFTHiggs_a_muon: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MRSSMEFTHiggs_a_muon uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
