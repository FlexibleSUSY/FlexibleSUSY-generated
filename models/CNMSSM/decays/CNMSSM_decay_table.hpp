...
#ifndef CNMSSM_DECAY_TABLE_H
#define CNMSSM_DECAY_TABLE_H
...
public:
   ...
   CNMSSM_decay_table();
   ~CNMSSM_decay_table() = default;
   CNMSSM_decay_table(const CNMSSM_decay_table&) = default;
   CNMSSM_decay_table(CNMSSM_decay_table&&) = default;
   CNMSSM_decay_table& operator=(const CNMSSM_decay_table&) = default;
   CNMSSM_decay_table& operator=(CNMSSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const CNMSSM_decay_table&);
