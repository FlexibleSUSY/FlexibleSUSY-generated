...
const int CNMSSM_soft_parameters::numberOfParameters;
...
CNMSSM_soft_parameters CNMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const CNMSSM_susy_parameters susy_betas(CNMSSM_susy_parameters::calc_beta(loops));
...
Eigen::ArrayXd CNMSSM_soft_parameters::get() const
{
...
CNMSSM_soft_parameters::Soft_traces CNMSSM_soft_parameters::calc_soft_traces(int loops) const
{
