...
// File generated at Wed 16 Oct 2019 19:33:42
...
CNMSSM_susy_convergence_tester<Semi_analytic>::CNMSSM_susy_convergence_tester(
...
double CNMSSM_susy_convergence_tester<Semi_analytic>::max_rel_diff() const
{
   const CNMSSM<Semi_analytic>& ol = get_last_iteration_model();
   const CNMSSM<Semi_analytic>& ne = get_current_iteration_model();
