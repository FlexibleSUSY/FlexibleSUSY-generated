...
template<>
class CNMSSM_low_scale_constraint<Semi_analytic> : public Single_scale_constraint {
public:

   CNMSSM_low_scale_constraint() = default;
   CNMSSM_low_scale_constraint(CNMSSM<Semi_analytic>*, const softsusy::QedQcd&);
   virtual ~CNMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "CNMSSM low-scale constraint"; }
