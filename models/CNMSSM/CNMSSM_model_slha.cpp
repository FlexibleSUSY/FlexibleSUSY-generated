...
CNMSSM_slha::CNMSSM_slha(const CNMSSM_input_parameters& input_,
 ...
 */
CNMSSM_slha::CNMSSM_slha(const CNMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : CNMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void CNMSSM_slha::clear()
{
   CNMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void CNMSSM_slha::calculate_spectrum()
{
   CNMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void CNMSSM_slha::convert_to_slha()
{
...
void CNMSSM_slha::calculate_ckm_matrix()
{
...
void CNMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void CNMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void CNMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void CNMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const CNMSSM_physical& CNMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

CNMSSM_physical& CNMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void CNMSSM_slha::print(std::ostream& ostr) const
{
   CNMSSM_mass_eigenstates::print(ostr);
...
void CNMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const CNMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
