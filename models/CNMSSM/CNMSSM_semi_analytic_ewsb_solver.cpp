...
// File generated at Tue 22 Jan 2019 13:51:53
 ...
 *
 * This file was generated at Tue 22 Jan 2019 13:51:53 with FlexibleSUSY
...
#define CLASSNAME CNMSSM_ewsb_solver<Semi_analytic>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(CNMSSM_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   CNMSSM_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(CNMSSM_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(CNMSSM_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(CNMSSM_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(CNMSSM_mass_eigenstates& model_to_solve)
{
   if (!solutions) {
      throw SetupError("CNMSSM_ewsb_solver<Semi_analytic>:solve: "
...
int CLASSNAME::solve_tree_level(CNMSSM_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(
   const CNMSSM_mass_eigenstates& model) const
{
...
void CLASSNAME::set_semi_analytic_solutions(
   CNMSSM_semi_analytic_solutions* s)
{
   solutions = s;
}
