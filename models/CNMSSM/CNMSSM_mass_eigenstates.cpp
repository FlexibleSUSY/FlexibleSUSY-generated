...
// File generated at Sun 26 Aug 2018 13:59:20
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 13:59:20 with FlexibleSUSY
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Sd, eigenvalue_error > precision * Abs(
      MSd(0)));
#else
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Sv, eigenvalue_error > precision * Abs(
      MSv(0)));
#else
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Su, eigenvalue_error > precision * Abs(
      MSu(0)));
#else
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Se, eigenvalue_error > precision * Abs(
      MSe(0)));
#else
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::hh, eigenvalue_error > precision * Abs(
      Mhh(0)));
#else
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Ah, eigenvalue_error > precision * Abs(
      MAh(0)));
#else
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Hpm, eigenvalue_error > precision * Abs(
      MHpm(0)));
#else
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Chi, eigenvalue_error > precision * Abs(
      MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Cha, eigenvalue_error > precision * Abs(
      MCha(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Fe, eigenvalue_error > precision * Abs(
      MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Fd, eigenvalue_error > precision * Abs(
      MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(CNMSSM_info::Fu, eigenvalue_error > precision * Abs(
      MFu(0)));
#else
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(CNMSSM_info::hh, eigenvalue_error >
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(CNMSSM_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(CNMSSM_info::Hpm, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
