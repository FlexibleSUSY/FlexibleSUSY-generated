...
struct CNMSSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
CNMSSM_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   CNMSSM_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, CNMSSM_input_parameters& input,
