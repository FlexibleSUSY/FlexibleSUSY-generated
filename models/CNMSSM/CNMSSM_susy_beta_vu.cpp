 ...
 */
double CNMSSM_susy_parameters::calc_beta_vu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNMSSM_susy_parameters::calc_beta_vu_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNMSSM_susy_parameters::calc_beta_vu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNMSSM_susy_parameters::calc_beta_vu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double CNMSSM_susy_parameters::calc_beta_vu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
