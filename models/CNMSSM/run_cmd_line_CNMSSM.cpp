...
int run_solver(const CNMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(CNMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const CNMSSM_input_parameters& input)
{
   int exit_code = 0;
