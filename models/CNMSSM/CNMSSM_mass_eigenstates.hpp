...
/**
 * @file CNMSSM_mass_eigenstates.hpp
 *
...
#ifndef CNMSSM_MASS_EIGENSTATES_H
#define CNMSSM_MASS_EIGENSTATES_H
...
class CNMSSM_ewsb_solver_interface;
/**
 * @class CNMSSM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class CNMSSM_mass_eigenstates : public CNMSSM_soft_parameters {
public:
   explicit CNMSSM_mass_eigenstates(const CNMSSM_input_parameters& input_ = CNMSSM_input_parameters());
   CNMSSM_mass_eigenstates(const CNMSSM_mass_eigenstates&) = default;
   CNMSSM_mass_eigenstates(CNMSSM_mass_eigenstates&&) = default;
   virtual ~CNMSSM_mass_eigenstates() = default;
   CNMSSM_mass_eigenstates& operator=(const CNMSSM_mass_eigenstates&) = default;
   CNMSSM_mass_eigenstates& operator=(CNMSSM_mass_eigenstates&&) = default;
   ...
   void set_physical(const CNMSSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const CNMSSM_physical& get_physical() const;
   CNMSSM_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<CNMSSM_ewsb_solver_interface>&);
   ...
   double get_lsp(CNMSSM_info::Particles&) const;
...
private:
   ...
   std::shared_ptr<CNMSSM_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const CNMSSM_mass_eigenstates&);
