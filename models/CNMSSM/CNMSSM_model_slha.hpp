...
class CNMSSM_slha : public CNMSSM_mass_eigenstates {
public:
   explicit CNMSSM_slha(const CNMSSM_input_parameters& input_ = CNMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit CNMSSM_slha(const CNMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
