...
/**
 * @file CNMSSM_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the CNMSSM model class in the decoupling scheme
 *
...
#define CLASSNAME CNMSSM_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const CNMSSM_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<CNMSSM_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const CNMSSM_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const CNMSSM_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
