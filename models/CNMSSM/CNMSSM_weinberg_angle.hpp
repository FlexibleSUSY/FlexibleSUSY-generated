...
#ifndef CNMSSM_WEINBERG_ANGLE_H
#define CNMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   CNMSSM_weinberg_angle(const CNMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const CNMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const CNMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
