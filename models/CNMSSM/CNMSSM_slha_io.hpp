...
public:
   ...
   void set_extra(const CNMSSM_slha&, const CNMSSM_scales&, const CNMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CNMSSM_scales&, const CNMSSM_observables&);
