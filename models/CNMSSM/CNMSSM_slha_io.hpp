...
#include "decays/CNMSSM_decays.hpp"
...
public:
   ...
   void set_decays(const CNMSSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const CNMSSM_slha&, const CNMSSM_scales&, const CNMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const CNMSSM_slha&);
   ...
   void fill_decays_data(const CNMSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CNMSSM_scales&, const CNMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, CNMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const CNMSSM_slha&);
...
void CNMSSM_slha_io::fill(
   ...
   CNMSSM_decays const * const decays)
{
