...
#include "CNMSSM_weinberg_angle.hpp"
...
#define CLASSNAME CNMSSM_weinberg_angle
 ...
 */
CLASSNAME::CNMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const CNMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * CNMSSM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * CNMSSM_info::normalization_g2;
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * CNMSSM_info::normalization_g3 /
