...
#ifndef CNMSSM_EFFECTIVE_COUPLINGS_H
#define CNMSSM_EFFECTIVE_COUPLINGS_H
...
class CNMSSM_effective_couplings {
public:
   CNMSSM_effective_couplings(const CNMSSM_mass_eigenstates&,
   ...
   void set_model(const CNMSSM_mass_eigenstates& model_);
