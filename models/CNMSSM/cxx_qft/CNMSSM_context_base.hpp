...
/**
 * @file cxx_qft/CNMSSM_context_base.hpp
 *
 * This file was generated at Fri 10 Apr 2020 17:56:05 with FlexibleSUSY
 * 2.4.2 and SARAH 4.14.3 .
 */

#ifndef CNMSSM_CXXQFT_CONTEXT_BASE_H
#define CNMSSM_CXXQFT_CONTEXT_BASE_H
...
namespace CNMSSM_cxx_diagrams {
   ...
   struct context_base {
      ...
      context_base(const CNMSSM_mass_eigenstates& m) : model(m) {}
