...
*/
double calculate_a_muon(const CNMSSM_mass_eigenstates& model, const softsusy::QedQcd& qedqcd);

/**
* @fn calculate_a_muon_uncertainty
* @brief Calculates \f$\Delta a_\mu\f$ of the muon.
*/
double calculate_a_muon_uncertainty(const CNMSSM_mass_eigenstates& model, const softsusy::QedQcd& qedqcd);
} // namespace CNMSSM_a_muon
} // namespace flexiblesusy
