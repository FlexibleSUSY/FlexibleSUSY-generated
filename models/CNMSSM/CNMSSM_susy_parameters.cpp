...
// File generated at Mon 5 Mar 2018 15:11:21
...
const int CNMSSM_susy_parameters::numberOfParameters;
...
CNMSSM_susy_parameters CNMSSM_susy_parameters::calc_beta(int loops) const
{
   ...
   return CNMSSM_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
Eigen::ArrayXd CNMSSM_susy_parameters::get() const
{
...
CNMSSM_input_parameters& CNMSSM_susy_parameters::get_input()
{
   return input;
}
...
CNMSSM_susy_parameters::Susy_traces CNMSSM_susy_parameters::calc_susy_traces(int loops) const
{
