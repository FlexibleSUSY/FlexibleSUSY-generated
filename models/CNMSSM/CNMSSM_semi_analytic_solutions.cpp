...
CNMSSM_semi_analytic_solutions::CNMSSM_semi_analytic_solutions()
{
   initialize_trial_values();
}

void CNMSSM_semi_analytic_solutions::initialize_trial_values()
{
...
void CNMSSM_semi_analytic_solutions::calculate_trial_data(const CNMSSM_mass_eigenstates& model)
{
...
CNMSSM_mass_eigenstates CNMSSM_semi_analytic_solutions::run_to_output_scale(
   const CNMSSM_mass_eigenstates& model, const Boundary_values& values) const
{
   CNMSSM_mass_eigenstates result(model);
...
std::map<int,CNMSSM_semi_analytic_solutions::Data_vector_t> CNMSSM_semi_analytic_solutions::create_datasets() const
{
 ...
 * coefficients.
 */
void CNMSSM_semi_analytic_solutions::calculate_coefficients(const CNMSSM_mass_eigenstates& model_)
{
...
void CNMSSM_semi_analytic_solutions::set_to_boundary_values(
   CNMSSM_mass_eigenstates& model, const Boundary_values& boundary_values) const
{
 ...
 */
void CNMSSM_semi_analytic_solutions::evaluate_solutions(
   CNMSSM_mass_eigenstates& model) const
{
...
void CNMSSM_semi_analytic_solutions::calculate_MassB_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
...
void CNMSSM_semi_analytic_solutions::calculate_MassG_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_MassWB_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_TYd_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
...
void CNMSSM_semi_analytic_solutions::calculate_TYe_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CNMSSM_semi_analytic_solutions::calculate_TYu_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CNMSSM_semi_analytic_solutions::calculate_TKappa_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_TLambdax_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_md2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CNMSSM_semi_analytic_solutions::calculate_me2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CNMSSM_semi_analytic_solutions::calculate_mHd2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_mHu2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_ml2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CNMSSM_semi_analytic_solutions::calculate_mq2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
...
void CNMSSM_semi_analytic_solutions::calculate_ms2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::VectorXd rhs(n);
...
void CNMSSM_semi_analytic_solutions::calculate_mu2_coefficients(
   const Eigen::JacobiSVD<Eigen::MatrixXd>& solver, const CNMSSM_semi_analytic_solutions::Data_vector_t& data)
{
   const std::size_t n = data.size();
   Eigen::MatrixXd rhs(n, 9);
