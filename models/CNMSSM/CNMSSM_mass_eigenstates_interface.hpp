...
/**
 * @file CNMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef CNMSSM_MASS_EIGENSTATES_INTERFACE_H
#define CNMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class CNMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class CNMSSM_mass_eigenstates_interface {
public:
   virtual ~CNMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<CNMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const CNMSSM_input_parameters& get_input_parameters() const = 0;
   virtual CNMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const CNMSSM_physical& get_physical() const = 0;
   virtual CNMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const CNMSSM_physical&) = 0;
