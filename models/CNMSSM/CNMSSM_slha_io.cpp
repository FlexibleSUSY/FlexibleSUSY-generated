...
CNMSSM_slha_io::CNMSSM_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void CNMSSM_slha_io::clear()
{
   slha_io.clear();
}

void CNMSSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void CNMSSM_slha_io::fill(CNMSSM_slha& model) const
{
   fill(static_cast<CNMSSM_mass_eigenstates&>(model));
 ...
 */
void CNMSSM_slha_io::set_extpar(const CNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSM_slha_io::set_imminpar(const CNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSM_slha_io::set_imextpar(const CNMSSM_input_parameters& input)
{
 ...
 */
void CNMSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSM_slha_io::set_minpar(const CNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSM_slha_io::set_input(const CNMSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void CNMSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void CNMSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void CNMSSM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void CNMSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void CNMSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void CNMSSM_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, CNMSSM_info::model_name)
 ...
 */
void CNMSSM_slha_io::set_mass(const CNMSSM_physical& physical,
 ...
 */
void CNMSSM_slha_io::set_mixing_matrices(const CNMSSM_physical& physical,
 ...
 */
void CNMSSM_slha_io::set_model_parameters(const CNMSSM_slha& model)
{
   {
...
void CNMSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void CNMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void CNMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void CNMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void CNMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void CNMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, CNMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void CNMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = CNMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + CNMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
 ...
 */
void CNMSSM_slha_io::set_spectrum(const CNMSSM_slha& model)
{
   const CNMSSM_physical physical(model.get_physical_slha());
 ...
 */
void CNMSSM_slha_io::set_extra(
   const CNMSSM_slha& model,
   const CNMSSM_scales& scales,
   const CNMSSM_observables& observables,
   const flexiblesusy::Spectrum_generator_settings& spectrum_generator_settings)
{
   ...
   }
   {
      ...
      block << "Block EWSBOutputs" << '\n'
            << FORMAT_ELEMENT(1, (MODELPARAMETER(Kappa)), "Kappa")
            << FORMAT_ELEMENT(2, (MODELPARAMETER(vS)), "vS")
            << FORMAT_ELEMENT(3, (EXTRAPARAMETER(m0Sq)), "m0Sq")
      ;
      slha_io.set_block(block);
   }
 ...
 */
void CNMSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void CNMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void CNMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void CNMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double CNMSSM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void CNMSSM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void CNMSSM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void CNMSSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void CNMSSM_slha_io::fill(CNMSSM_input_parameters& input) const
{
 ...
 */
void CNMSSM_slha_io::fill_drbar_parameters(CNMSSM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void CNMSSM_slha_io::fill(CNMSSM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   CNMSSM_physical physical_hk;
 ...
 */
void CNMSSM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void CNMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void CNMSSM_slha_io::fill_minpar_tuple(CNMSSM_input_parameters& input,
...
void CNMSSM_slha_io::fill_extpar_tuple(CNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void CNMSSM_slha_io::fill_imminpar_tuple(CNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void CNMSSM_slha_io::fill_imextpar_tuple(CNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void CNMSSM_slha_io::fill_physical(CNMSSM_physical& physical) const
{
   {
 ...
 */
double CNMSSM_slha_io::read_scale() const
{
