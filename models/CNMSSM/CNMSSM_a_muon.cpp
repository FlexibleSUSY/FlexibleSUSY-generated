...
// File generated at Sun 26 Aug 2018 14:00:01

/**
 * @file CNMSSM_a_muon.cpp
 *
 * This file was generated at Sun 26 Aug 2018 14:00:01 with FlexibleSUSY
...
#include "CNMSSM_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(CNMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const CNMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("CNMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double CNMSSM_a_muon::calculate_a_muon(const CNMSSM_mass_eigenstates& model_)
{
...
double CNMSSM_a_muon::calculate_a_muon_uncertainty(const CNMSSM_mass_eigenstates& model_)
{
   CNMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("CNMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
