...
public:
   ...
   TMSSM_weinberg_angle(const TMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const TMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const TMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
