 ...
 * @param settings class of settings
 */
void TMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 */
void TMSSM_slha_io::set_unitarity_infinite_s(
...
void TMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void TMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
