...
public:
   ...
   void set_extra(const TMSSM_slha&, const TMSSM_scales&, const TMSSM_observables&);
   ...
   void set_spectrum(const TMSSM_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const TMSSM_scales&, const TMSSM_observables&);
...
private:
   ...
   void set_model_parameters(const TMSSM_slha&);
