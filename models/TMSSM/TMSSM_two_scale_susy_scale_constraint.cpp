...
// File generated at Sun 28 Aug 2016 15:05:32
...
{
   assert(model && "Error: TMSSM_susy_scale_constraint::apply():"
...
{
   assert(model && "Error: TMSSM_susy_scale_constraint::"
...
{
   assert(model && "TMSSM_susy_scale_constraint<Two_scale>::"
