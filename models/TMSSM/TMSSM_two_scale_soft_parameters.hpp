...
public:
   ...
   TMSSM_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
...
private:
   ...
   double calc_beta_BMT_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMT_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMT_three_loop(const TRACE_STRUCT_TYPE&) const;
