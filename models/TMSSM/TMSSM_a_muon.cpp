...
// File generated at Tue 22 Jan 2019 17:05:00

/**
 * @file TMSSM_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 17:05:00 with FlexibleSUSY
...
double calculate_a_muon_impl(TMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const TMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("TMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double TMSSM_a_muon::calculate_a_muon(const TMSSM_mass_eigenstates& model_)
{
...
double TMSSM_a_muon::calculate_a_muon_uncertainty(const TMSSM_mass_eigenstates& model_)
{
   TMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("TMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
