...
/**
 * @file TMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef TMSSM_MASS_EIGENSTATES_INTERFACE_H
#define TMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class TMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class TMSSM_mass_eigenstates_interface {
public:
   virtual ~TMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<TMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const TMSSM_input_parameters& get_input_parameters() const = 0;
   virtual TMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const TMSSM_physical& get_physical() const = 0;
   virtual TMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const TMSSM_physical&) = 0;
   ...
   virtual double get_BMT() const = 0;
   ...
   virtual void set_MT(double MT_) = 0;
   ...
   virtual void set_BMT(double BMT_) = 0;
   ...
   virtual const Eigen::Array<double,3,1>& get_MCha() const = 0;
   ...
   virtual const Eigen::Matrix<std::complex<double>,3,3>& get_UM() const = 0;
   virtual std::complex<double> get_UM(int i, int k) const = 0;
   virtual const Eigen::Matrix<std::complex<double>,3,3>& get_UP() const = 0;
   ...
   virtual Eigen::Matrix<double,3,3> get_mass_matrix_Cha() const = 0;
