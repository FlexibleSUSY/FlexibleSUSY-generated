...
#ifndef TMSSM_DECAY_TABLE_H
#define TMSSM_DECAY_TABLE_H
...
class TMSSM_decay_table {
private:
   static const int number_of_decay_particles = 8;
...
public:
   ...
   TMSSM_decay_table();
   ~TMSSM_decay_table() = default;
   TMSSM_decay_table(const TMSSM_decay_table&) = default;
   TMSSM_decay_table(TMSSM_decay_table&&) = default;
   TMSSM_decay_table& operator=(const TMSSM_decay_table&) = default;
   TMSSM_decay_table& operator=(TMSSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const TMSSM_decay_table&);
