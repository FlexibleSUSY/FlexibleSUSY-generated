 ...
 */
template<>
class TMSSM<Two_scale> : public Two_scale_model, public TMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(TMSSM<Two_scale>::*Memfun_t)();
      TMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(TMSSM<Two_scale>* model_, Memfun_t fun_)
