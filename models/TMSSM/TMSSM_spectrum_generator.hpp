...
// File generated at Tue 5 Sep 2017 11:13:17
                                ...
                                const TMSSM_input_parameters& input)
{
   ...
   TMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   TMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   TMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
   ...
   TMSSM_convergence_tester<T> convergence_tester(
