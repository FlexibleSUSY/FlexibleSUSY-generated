...
#include "TMSSM_edm.hpp"
#include "TMSSM_b_to_s_gamma.hpp"
#include "observables/l_to_l_conversion/settings.hpp"
#include "observables/TMSSM_br_l_to_3l.hpp"
#include "observables/TMSSM_br_l_to_l_gamma.hpp"
#include "observables/TMSSM_l_to_l_conversion.hpp"
...
const int TMSSM_observables::NUMBER_OF_OBSERVABLES;
...
Eigen::ArrayXd TMSSM_observables::get() const
{
   Eigen::ArrayXd vec(1);
...
std::vector<std::string> TMSSM_observables::get_names()
{
...
void TMSSM_observables::set(const Eigen::ArrayXd& vec)
{
