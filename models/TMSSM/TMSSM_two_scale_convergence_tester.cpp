...
TMSSM_convergence_tester<Two_scale>::TMSSM_convergence_tester(
   TMSSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<TMSSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double TMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const TMSSM<Two_scale>& ne = get_current_iteration_model();

   std::array<double, 40> diff{};
