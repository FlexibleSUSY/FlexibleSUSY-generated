...
#define SUPER(p) TMSSM_soft_parameters::p

namespace flexiblesusy {

class TMSSM_ewsb_solver_interface;
/**
 * @class TMSSM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class TMSSM_mass_eigenstates
   : public TMSSM_soft_parameters
   , public TMSSM_mass_eigenstates_interface
{
public:
   explicit TMSSM_mass_eigenstates(const TMSSM_input_parameters& input_ = TMSSM_input_parameters());
   TMSSM_mass_eigenstates(const TMSSM_mass_eigenstates&) = default;
   TMSSM_mass_eigenstates(TMSSM_mass_eigenstates&&) = default;
   virtual ~TMSSM_mass_eigenstates() = default;
   TMSSM_mass_eigenstates& operator=(const TMSSM_mass_eigenstates&) = default;
   TMSSM_mass_eigenstates& operator=(TMSSM_mass_eigenstates&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<TMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void set_ewsb_solver(const std::shared_ptr<TMSSM_ewsb_solver_interface>&);
   ...
   const TMSSM_input_parameters& get_input_parameters() const override;
   TMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const TMSSM_physical& get_physical() const override;
   TMSSM_physical& get_physical() override;
   ...
   void set_physical(const TMSSM_physical&) override;
   ...
   double get_MT() const override { return SUPER(MT); }
   ...
   double get_BMT() const override { return SUPER(BMT); }
   ...
   void set_MT(double MT_) override { MT = MT_; }
   ...
   void set_BMT(double BMT_) override { BMT = BMT_; }
   ...
   const Eigen::Array<double,3,1>& get_MCha() const override { return MCha; }
   ...
   const Eigen::Matrix<std::complex<double>,3,3>& get_UM() const override { return UM; }
   std::complex<double> get_UM(int i, int k) const override { return UM(i,k); }
   const Eigen::Matrix<std::complex<double>,3,3>& get_UP() const override { return UP; }
   ...
   Eigen::Matrix<double,3,3> get_mass_matrix_Cha() const override;
   ...
   Eigen::Matrix<std::complex<double>,5,5> self_energy_Chi_1loop_1(double p) const;
   std::complex<double> self_energy_Chi_1loop_PR(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,5,5> self_energy_Chi_1loop_PR(double p) const;
   std::complex<double> self_energy_Chi_1loop_PL(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,5,5> self_energy_Chi_1loop_PL(double p) const;
   std::complex<double> self_energy_Cha_1loop_1(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Cha_1loop_1(double p) const;
   std::complex<double> self_energy_Cha_1loop_PR(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Cha_1loop_PR(double p) const;
   std::complex<double> self_energy_Cha_1loop_PL(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Cha_1loop_PL(double p) const;
...
private:
   ...
   mutable Problems problems{TMSSM_info::model_name,
                             &TMSSM_info::particle_names_getter,
                             &TMSSM_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<TMSSM_ewsb_solver_interface> ewsb_solver{};
   ...
   Eigen::Array<double,3,1> MCha{Eigen::Array<double,3,1>::Zero()};
   ...
   Eigen::Matrix<std::complex<double>,3,3> UM{Eigen::Matrix<std::complex<double>,3,3>::Zero()};
   Eigen::Matrix<std::complex<double>,3,3> UP{Eigen::Matrix<std::complex<double>,3,3>::Zero()};
