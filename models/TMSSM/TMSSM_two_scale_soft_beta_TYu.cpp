...
// File generated at Fri 26 Jun 2015 18:57:58
 ...
 */
Eigen::Matrix<double,3,3> TMSSM_soft_parameters::calc_beta_TYu_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> TMSSM_soft_parameters::calc_beta_TYu_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYu = (twoLoop*(6.095555555555555*Power(g1,4)*TYu + 13.5*Power(g2
      ...
      *Sqr(g2)*Sqr(g3) + 1800*MassWB*Sqr(g2)*Sqr(g3) - 180*traceAdjYuTYu*(Sqr(
      ...
      (Yu*Yd.adjoint()*TYd) - 3*AbsSqr(Lambdax)*(Yu*Yd.adjoint()*TYd) + 0.8*Sqr
      (g1)*(Yu*Yd.adjoint()*TYd) - 18*traceAdjYuTYu*(Yu*Yu.adjoint()*Yu) - 0.8*
      MassB*Sqr(g1)*(Yu*Yu.adjoint()*Yu) - 12*MassWB*Sqr(g2)*(Yu*Yu.adjoint()*
      Yu) - 9*Conj(Lambdax)*TLambdax*(Yu*Yu.adjoint()*Yu) - 12*traceYuAdjYu*(Yu
      *Yu.adjoint()*TYu) - 6*AbsSqr(Lambdax)*(Yu*Yu.adjoint()*TYu) + 1.2*Sqr(g1
      )*(Yu*Yu.adjoint()*TYu) + 6*Sqr(g2)*(Yu*Yu.adjoint()*TYu) - 3*
      traceYdAdjYd*(TYu*Yd.adjoint()*Yd) - traceYeAdjYe*(TYu*Yd.adjoint()*Yd) -
      1.5*AbsSqr(Lambdax)*(TYu*Yd.adjoint()*Yd) + 0.4*Sqr(g1)*(TYu*Yd.adjoint(
      )*Yd) - 15*traceYuAdjYu*(TYu*Yu.adjoint()*Yu) - 7.5*AbsSqr(Lambdax)*(TYu*
 ...
 */
Eigen::Matrix<double,3,3> TMSSM_soft_parameters::calc_beta_TYu_three_loop(const Soft_traces& soft_traces) const
{
