...
// File generated at Tue 22 Jan 2019 16:50:10
...
TMSSM_soft_parameters::TMSSM_soft_parameters(
   ...
   double TLambdax_, const Eigen::Matrix<double,3,3>& TYu_, double BMu_, double
    BMT_, const Eigen::Matrix<double,3,3>& mq2_, const Eigen::Matrix<double,3,3
   ...
   , double mT2_, double MassB_, double MassWB_, double MassG_
)
...
TMSSM_soft_parameters::Soft_traces TMSSM_soft_parameters::calc_soft_traces(int loops) const
{
   ...
   if (loops > 0) {
      ...
      TRACE_STRUCT.Tr31 = Re(0.012909944487358056*g1*(45*(mHd2 - mHu2)*AbsSqr(Lambdax
      ...
      TRACE_STRUCT.Tr22 = Re(0.5*(mHd2 + mHu2 + 4*mT2 + (ml2).trace() + 3*(mq2).trace
         ()));
