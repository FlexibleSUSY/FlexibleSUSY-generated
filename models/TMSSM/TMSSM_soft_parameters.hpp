...
#ifndef TMSSM_soft_parameters_H
#define TMSSM_soft_parameters_H
...
class TMSSM_soft_parameters : public TMSSM_susy_parameters {
public:
   explicit TMSSM_soft_parameters(const TMSSM_input_parameters& input_ = TMSSM_input_parameters());
   TMSSM_soft_parameters(const TMSSM_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>& TYe_,
   ...
   TMSSM_soft_parameters(const TMSSM_soft_parameters&) = default;
   TMSSM_soft_parameters(TMSSM_soft_parameters&&) = default;
   virtual ~TMSSM_soft_parameters() = default;
   TMSSM_soft_parameters& operator=(const TMSSM_soft_parameters&) = default;
   TMSSM_soft_parameters& operator=(TMSSM_soft_parameters&&) = default;
   ...
   TMSSM_soft_parameters calc_beta() const;
   TMSSM_soft_parameters calc_beta(int) const;
   ...
   void set_BMT(double BMT_) { BMT = BMT_; }
   ...
   double get_BMT() const { return BMT; }
...
private:
   static const int numberOfParameters = 117;
   ...
   double calc_beta_BMT_1_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMT_2_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMT_3_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMT_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMT_5_loop(const TRACE_STRUCT_TYPE&) const;
...
std::ostream& operator<<(std::ostream&, const TMSSM_soft_parameters&);
