...
class TMSSM_slha : public TMSSM_mass_eigenstates {
public:
   explicit TMSSM_slha(const TMSSM_input_parameters& input_ = TMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit TMSSM_slha(const TMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
