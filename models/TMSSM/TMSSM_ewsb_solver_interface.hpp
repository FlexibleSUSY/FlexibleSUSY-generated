...
/**
 * @file TMSSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Sun 26 Aug 2018 14:15:34 with FlexibleSUSY
 * 2.2.0 (git commit: 8489097de2d6938a6da0149378457b5ad13d9425) and SARAH 4.13.0 .
 */

#ifndef TMSSM_EWSB_SOLVER_INTERFACE_H
#define TMSSM_EWSB_SOLVER_INTERFACE_H
...
class TMSSM_ewsb_solver_interface {
public:
   virtual ~TMSSM_ewsb_solver_interface() {}
   ...
   virtual int solve(TMSSM_mass_eigenstates&) = 0;
};
