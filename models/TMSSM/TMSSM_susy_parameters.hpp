...
#ifndef TMSSM_susy_parameters_H
#define TMSSM_susy_parameters_H
...
public:
   ...
   TMSSM_susy_parameters(double scale_, int loops_, int thresholds_, const TMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_,
   ...
   TMSSM_susy_parameters(const TMSSM_susy_parameters&) = default;
   TMSSM_susy_parameters(TMSSM_susy_parameters&&) = default;
   virtual ~TMSSM_susy_parameters() = default;
   TMSSM_susy_parameters& operator=(const TMSSM_susy_parameters&) = default;
   TMSSM_susy_parameters& operator=(TMSSM_susy_parameters&&) = default;
...
private:
   ...
   double calc_beta_MT_1_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MT_2_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MT_3_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MT_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MT_5_loop(const TRACE_STRUCT_TYPE&) const;
