...
#ifndef TMSSM_TWO_SCALE_MATCHING_H
#define TMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class TMSSM;
template <class T> class TMSSM_standard_model_Matching;
...
template<>
class TMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   TMSSM_standard_model_Matching();

   TMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       TMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~TMSSM_standard_model_Matching();
