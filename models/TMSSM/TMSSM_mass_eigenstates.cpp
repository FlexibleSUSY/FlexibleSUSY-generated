...
// File generated at Fri 20 Oct 2017 08:44:24
 ...
 * parameters.
 *
 * This file was generated at Fri 20 Oct 2017 08:44:24 with FlexibleSUSY
...
int CLASSNAME::solve_ewsb_tree_level_custom()
{
   ...
   mHd2 = Re((0.025*(-40*vd*AbsSqr(Mu) + 20*vu*BMu + 20*vu*Conj(BMu) + 20*MT*vT
      ...
      *vd*vT*Conj(Mu)*Lambdax - 20*vd*vT*Conj(Lambdax)*Mu - 3*Cube(vd)*Sqr(g1) - 5
      *Cube(vd)*Sqr(g2) - 10*vd*AbsSqr(Lambdax)*Sqr(vT) - 10*vd*AbsSqr(Lambdax)*
      Sqr(vu) + 3*vd*Sqr(g1)*Sqr(vu) + 5*vd*Sqr(g2)*Sqr(vu) + 10*vT*vu*TLambdax))
      /vd);
   mHu2 = Re((0.025*(-40*vu*AbsSqr(Mu) + 20*vd*BMu + 20*vd*Conj(BMu) + 20*MT*vd
      ...
      *vT*vu*Conj(Mu)*Lambdax - 20*vT*vu*Conj(Lambdax)*Mu - 3*Cube(vu)*Sqr(g1) - 5
...
{
   if (!ewsb_solver) {
      throw SetupError("TMSSM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("TMSSM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("TMSSM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }
...
std::complex<double> CLASSNAME::CpAhAhUSdconjUSd(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(
      ...
      -0.35355339059327373*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*KroneckerDelta(gO1,
      3 + j1))*ZA(gI1,1)*ZA(gI2,2),0) + 0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,
      3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,0)*ZA(gI2,0) - SUM(j3,0,2,
...
std::complex<double> CLASSNAME::CpHpmSuconjUSd(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ZU(gI1,gO2))*Sqr(g2)*ZP(gI2,0),0) + IF(gO2 < 3,-0.5*vT*Lambdax*SUM(j1,0,2,
      Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZP(gI2,0),0) + IF(gO2 < 3,Mu*SUM(j1,0
      ,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZP(gI2,0),0) + IF(gO2 < 3,
      ...
      - 0.7071067811865475*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,
      2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)))*ZP(gI2,3);
...
std::complex<double> CLASSNAME::CpSeconjHpmconjUSv(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      IF(gO2 < 3,-0.5*vT*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI2,3 + j1))
      )*ZP(gI1,1),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI2,3 +
      j1)))*ZP(gI1,1),0) + IF(gO2 < 3,-0.5*vT*Conj(ZE(gI2,gO2))*Sqr(g2)*ZP(gI1,2),
      0) + IF(gO2 < 3,0.5*vT*Conj(ZE(gI2,gO2))*Sqr(g2)*ZP(gI1,3),0) + IF(gO2 < 3,
      -0.7071067811865475*vu*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI2,3 +
      j1)))*ZP(gI1,3),0);
...
std::complex<double> CLASSNAME::CpAhAhUSuconjUSu(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(
      ...
      -0.35355339059327373*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*KroneckerDelta(gO1,
      3 + j1))*ZA(gI1,0)*ZA(gI2,2),0) - 0.2*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,
      3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,0)*ZA(gI2,0) + 0.2*Sqr(g1)*SUM(j1
...
std::complex<double> CLASSNAME::CpSdconjHpmconjUSu(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      IF(gO2 < 3,-0.5*vT*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI2,3 + j1))
      )*ZP(gI1,1),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI2,3 +
      j1)))*ZP(gI1,1),0) + IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,2,Conj(ZD(gI2
      ,j2))*SUM(j1,0,2,Conj(Yu(j1,gO2))*Yu(j1,j2)))*ZP(gI1,1),0) + IF(gO2 < 3,-0.5
      *vT*Conj(ZD(gI2,gO2))*Sqr(g2)*ZP(gI1,2),0) + IF(gO2 < 3,0.5*vT*Conj(ZD(gI2,
      gO2))*Sqr(g2)*ZP(gI1,3),0) + IF(gO2 < 3,-0.7071067811865475*vu*Lambdax*SUM(
      j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI2,3 + j1)))*ZP(gI1,3),0) - 0.5*vT*Conj(
      Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*
      Yu(j1,j2)))*ZP(gI1,0) + Conj(Mu)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,
      ...
      + 0.7071067811865475*vd*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,
      2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)))*ZP(gI1,2);
...
std::complex<double> CLASSNAME::CphhSuconjUSu(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZU(gI1,gO2))*Sqr
      ...
      0) + IF(gO2 < 3,0.35355339059327373*vT*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*
      Conj(ZU(gI1,3 + j1)))*ZH(gI2,0),0) + IF(gO2 < 3,0.7071067811865475*Mu*SUM(j1
      ,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZH(gI2,0),0) + IF(gO2 < 3,-0.05*
      vu*Conj(ZU(gI1,gO2))*Sqr(g1)*ZH(gI2,1),0) + IF(gO2 < 3,0.25*vu*Conj(ZU(gI1,
      gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3,-0.7071067811865475*SUM(j1,0,2,Conj(
      ZU(gI1,3 + j1))*Conj(TYu(j1,gO2)))*ZH(gI2,1),0) + IF(gO2 < 3,-(vu*SUM(j2,0,2
...
std::complex<double> CLASSNAME::CpAhAhUSeconjUSe(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(
      ...
      KroneckerDelta(gO1,3 + j1))*ZA(gI1,2)*ZA(gI2,1),0) + IF(gO2 < 3,
      -0.35355339059327373*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*KroneckerDelta(gO1,
      3 + j1))*ZA(gI1,1)*ZA(gI2,2),0) + 0.3*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,
      3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,0)*ZA(gI2,0) - SUM(j3,0,2,
      KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpHpmSvconjUSe(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      IF(gO2 < 3,-0.5*vT*Conj(ZV(gI1,gO2))*Sqr(g2)*ZP(gI2,2),0) + IF(gO2 < 3,0.5*
      vT*Conj(ZV(gI1,gO2))*Sqr(g2)*ZP(gI2,3),0) + SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(
      j1,0,2,KroneckerDelta(gO2,3 + j1)*TYe(j1,j2)))*ZP(gI2,0) - 0.5*vT*Conj(
      Lambdax)*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*
      Ye(j1,j2)))*ZP(gI2,1) + Conj(Mu)*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CphhSeconjUSe(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2))*
      ...
      Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3,0.35355339059327373*vT*Lambdax*SUM(j1,0,2,
      Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 + j1)))*ZH(gI2,1),0) + IF(gO2 < 3,
...
std::complex<double> CLASSNAME::CpUhhUhhconjVWmVWm(int gO1, int gO2) const
{
   const std::complex<double> result = 0.5*(KroneckerDelta(0,gO1)*
      ...
      KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2))*Sqr(g2);
...
{
   const std::complex<double> result = 0.05*(-10*AbsSqr(Lambdax)*KroneckerDelta
      (2,gO1)*KroneckerDelta(2,gO2)*(ZA(gI1,0)*ZA(gI2,0) + ZA(gI1,1)*ZA(gI2,1)) +
...
{
   const std::complex<double> result = 0.05*(-10*AbsSqr(Lambdax)*KroneckerDelta
      (2,gO1)*(KroneckerDelta(2,gO2)*(ZH(gI1,0)*ZH(gI2,0) + ZH(gI1,1)*ZH(gI2,1)) +
...
std::complex<double> CLASSNAME::CpAhhhUhh(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(-(Conj(
      ...
      *TLambdax*ZA(gI2,1)*ZH(gI1,0) - Conj(TLambdax)*KroneckerDelta(1,gO2)*ZA(gI2,
      ...
      2) + KroneckerDelta(0,gO2)*TLambdax*ZA(gI2,1)*ZH(gI1,2) + 2*Conj(MT)*Lambdax
      *(KroneckerDelta(2,gO2)*(ZA(gI2,1)*ZH(gI1,0) + ZA(gI2,0)*ZH(gI1,1)) +
      KroneckerDelta(1,gO2)*(-(ZA(gI2,2)*ZH(gI1,0)) + ZA(gI2,0)*ZH(gI1,2)) +
      KroneckerDelta(0,gO2)*(-(ZA(gI2,2)*ZH(gI1,1)) + ZA(gI2,1)*ZH(gI1,2))) - 2*
      Conj(Lambdax)*(MT*KroneckerDelta(2,gO2)*(ZA(gI2,1)*ZH(gI1,0) + ZA(gI2,0)*ZH(
      gI1,1)) - KroneckerDelta(1,gO2)*(ZA(gI2,2)*(MT*ZH(gI1,0) + Mu*ZH(gI1,1)) -
      MT*ZA(gI2,0)*ZH(gI1,2)) - KroneckerDelta(0,gO2)*(ZA(gI2,2)*(Mu*ZH(gI1,0) +
      MT*ZH(gI1,1)) - MT*ZA(gI2,1)*ZH(gI1,2))));
...
std::complex<double> CLASSNAME::CphhhhUhh(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO2)*(-(ZH(gI1,0)
      *(3*vd*(3*Sqr(g1) + 5*Sqr(g2))*ZH(gI2,0) + vu*(10*AbsSqr(Lambdax) - 3*Sqr(g1
      ) - 5*Sqr(g2))*ZH(gI2,1) + 10*(Conj(Mu)*Lambdax + Conj(Lambdax)*(vT*Lambdax
      + Mu))*ZH(gI2,2))) + ZH(gI1,1)*(vu*(-10*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(
      g2))*ZH(gI2,0) + vd*(-10*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(gI2,1)
      + 5*(2*MT*Conj(Lambdax) + Conj(TLambdax) + 2*Conj(MT)*Lambdax + TLambdax)*ZH
      (gI2,2)) - 5*ZH(gI1,2)*(2*Conj(Mu)*Lambdax*ZH(gI2,0) - (Conj(TLambdax) + 2*
      Conj(MT)*Lambdax + TLambdax)*ZH(gI2,1) + 2*Conj(Lambdax)*((vT*Lambdax + Mu)*
      ZH(gI2,0) - MT*ZH(gI2,1) + vd*Lambdax*ZH(gI2,2)))) + KroneckerDelta(1,gO2)*(
      ZH(gI1,1)*(vd*(-10*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(gI2,0) - 3*vu
      *(3*Sqr(g1) + 5*Sqr(g2))*ZH(gI2,1) - 10*(Conj(Mu)*Lambdax + Conj(Lambdax)*(
      vT*Lambdax + Mu))*ZH(gI2,2)) + ZH(gI1,0)*(vu*(-10*AbsSqr(Lambdax) + 3*Sqr(g1
      ) + 5*Sqr(g2))*ZH(gI2,0) + vd*(-10*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*
      ZH(gI2,1) + 5*(2*MT*Conj(Lambdax) + Conj(TLambdax) + 2*Conj(MT)*Lambdax +
...
{
   const std::complex<double> result = 0.5*(-1.4142135623730951*KroneckerDelta(
      0,gO2)*(g2*UM(gI1,1)*UP(gI2,0) + Conj(Lambdax)*UM(gI1,2)*UP(gI2,1)) +
...
std::complex<double> CLASSNAME::CpUhhUhhHpmconjHpm(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(-(KroneckerDelta(0,gO1)*(5*(
      ...
      ZP(gI2,1) + 10*(-((-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,2)*ZP(gI2,2)) + Sqr(
      g2)*ZP(gI1,3)*ZP(gI2,3))))) + KroneckerDelta(1,gO1)*(-5*(KroneckerDelta(0,
      gO2)*(AbsSqr(Lambdax) + Sqr(g2))*(ZP(gI1,1)*ZP(gI2,0) + ZP(gI1,0)*ZP(gI2,1))
      ...
      *ZP(gI1,2)*ZP(gI2,2) - (-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,3)*ZP(gI2,3))))
      - 5*KroneckerDelta(2,gO1)*(Sqr(g2)*(1.4142135623730951*KroneckerDelta(0,gO2
      ...
      gI1,3)*ZP(gI2,1) + ZP(gI1,1)*(ZP(gI2,2) - ZP(gI2,3))) + 4*KroneckerDelta(2,
      gO2)*(ZP(gI1,2) - ZP(gI1,3))*(ZP(gI2,2) - ZP(gI2,3))) + AbsSqr(Lambdax)*(2*
...
{
   const std::complex<double> result = 0.05*(-5*KroneckerDelta(2,gO2)*(-2*Conj(
      Mu)*Lambdax*ZP(gI1,0)*ZP(gI2,0) - 4*Conj(MT)*Lambdax*ZP(gI1,1)*ZP(gI2,0) - 2
...
{
   const std::complex<double> result = 0.1*(5*Conj(Lambdax)*KroneckerDelta(2,
      gO2)*(ZN(gI1,3)*ZN(gI2,2) + ZN(gI1,2)*ZN(gI2,3)) + KroneckerDelta(0,gO2)*(ZN
      (gI1,2)*(3.872983346207417*g1*ZN(gI2,0) - 5*g2*ZN(gI2,1)) +
      3.872983346207417*g1*ZN(gI1,0)*ZN(gI2,2) - 5*g2*ZN(gI1,1)*ZN(gI2,2) + 5*Conj
      (Lambdax)*ZN(gI1,4)*ZN(gI2,3) + 5*Conj(Lambdax)*ZN(gI1,3)*ZN(gI2,4)) +
      ...
      Conj(Lambdax)*(ZN(gI1,4)*ZN(gI2,2) + ZN(gI1,2)*ZN(gI2,4))));
...
std::complex<double> CLASSNAME::CpChiChiUhhPL(int gI1, int gI2, int gO1) const
{
   const std::complex<double> result = 0.1*(-5*g2*Conj(ZN(gI1,1))*Conj(ZN(gI2,2
      ...
      KroneckerDelta(0,gO1) - Conj(ZN(gI2,3))*KroneckerDelta(1,gO1)) + 5*Conj(ZN(
      gI1,4))*Conj(ZN(gI2,3))*KroneckerDelta(0,gO1)*Lambdax + 5*Conj(ZN(gI1,3))*
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*KroneckerDelta(
      1,gO2)*KroneckerDelta(2,gO1)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*KroneckerDelta(
      1,gO2)*KroneckerDelta(2,gO1)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(
      j1,0,2,Ye(j1,j2)*ZE(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*KroneckerDelta(
      0,gO2)*KroneckerDelta(2,gO1)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*vu*
      KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,
      Yd(j1,j2)*ZD(gI1,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*
      Conj(ZD(gI2,3 + j1)))*ZD(gI1,j2))) + KroneckerDelta(1,gO2)*(-(vu*(Sqr(g1) +
      5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1))) - 2*vu*Sqr(g1)*SUM(j1,0,
      2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) + 7.0710678118654755*(vT*Conj(Lambdax
      )*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) + 2*Conj
      (Mu)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) + (vT
      *Lambdax + 2*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1)))
      *ZD(gI1,j2)))) + KroneckerDelta(0,gO2)*(vd*(Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,
      Conj(ZD(gI2,j1))*ZD(gI1,j1)) + 2*(vd*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))
      *ZD(gI1,3 + j1)) - 5*(1.4142135623730951*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,
      0,2,ZD(gI1,3 + j1)*TYd(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,
      Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gI1,j2)) + 2*vd*(SUM(j3,0,2,Conj(
      ZD(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gI1,3 +
      j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd
      (j1,j2)))*ZD(gI1,j3)))))));
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*vu*
      KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,
      Ye(j1,j2)*ZE(gI1,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*
      Conj(ZE(gI2,3 + j1)))*ZE(gI1,j2))) + KroneckerDelta(1,gO2)*(vu*(3*Sqr(g1) -
      5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 6*vu*Sqr(g1)*SUM(j1,0,2
      ,Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1)) + 7.0710678118654755*(vT*Conj(Lambdax)
      *SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) + 2*Conj(
      Mu)*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) + (vT*
      Lambdax + 2*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1)))*
      ZE(gI1,j2)))) - KroneckerDelta(0,gO2)*(vd*(3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2
      ,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 6*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))
      *ZE(gI1,3 + j1)) + 10*(1.4142135623730951*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1
      ,0,2,ZE(gI1,3 + j1)*TYe(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,
      Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gI1,j2)) + 2*vd*(SUM(j3,0,2,Conj(
      ZE(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gI1,3 +
      j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye
      (j1,j2)))*ZE(gI1,j3))))));
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*vd*
      KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,
      Yu(j1,j2)*ZU(gI1,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*
      Conj(ZU(gI2,3 + j1)))*ZU(gI1,j2))) + KroneckerDelta(0,gO2)*(vd*(Sqr(g1) - 5*
      Sqr(g2))*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) - 4*vd*Sqr(g1)*SUM(j1,0,2,
      Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)) + 7.0710678118654755*(vT*Conj(Lambdax)*
      SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + 2*Conj(
      Mu)*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + (vT*
      Lambdax + 2*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1)))*
      ZU(gI1,j2)))) - KroneckerDelta(1,gO2)*(vu*(Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,
      Conj(ZU(gI2,j1))*ZU(gI1,j1)) - 4*vu*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*
      ZU(gI1,3 + j1)) + 10*(1.4142135623730951*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,
      0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,
      Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gI1,j2)) + 2*vu*(SUM(j3,0,2,Conj(
      ZU(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gI1,3 +
      j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu
      (j1,j2)))*ZU(gI1,j3))))));
...
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(g2*Conj(UM(
      gI2,0))*(1.4142135623730951*Conj(UP(gI1,1))*KroneckerDelta(1,gO1) - 2*Conj(
      UP(gI1,2))*KroneckerDelta(2,gO1)) + Conj(UM(gI2,2))*(2*g2*Conj(UP(gI1,0))*
      KroneckerDelta(2,gO1) - 1.4142135623730951*Conj(UP(gI1,1))*KroneckerDelta(0,
      gO1)*Lambdax) + Conj(UM(gI2,1))*(1.4142135623730951*g2*Conj(UP(gI1,0))*
      KroneckerDelta(0,gO1) + 1.4142135623730951*Conj(UP(gI1,2))*KroneckerDelta(1,
      gO1)*Lambdax + Conj(UP(gI1,1))*KroneckerDelta(2,gO1)*Lambdax));
...
std::complex<double> CLASSNAME::CpUAhUAhHpmconjHpm(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*(-(
      ...
      )))) + 5*(KroneckerDelta(1,gO2)*(AbsSqr(Lambdax) + Sqr(g2))*(ZP(gI1,1)*ZP(
      gI2,0) + ZP(gI1,0)*ZP(gI2,1)) - 1.4142135623730951*KroneckerDelta(2,gO2)*(
      -AbsSqr(Lambdax) + Sqr(g2))*(ZP(gI1,2)*ZP(gI2,0) + ZP(gI1,3)*ZP(gI2,0) + ZP(
      gI1,0)*(ZP(gI2,2) + ZP(gI2,3))))) + KroneckerDelta(1,gO1)*(KroneckerDelta(1,
      gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) - 5*Sqr(g2))*ZP(gI1,0)*ZP(gI2,0) - (3
      *Sqr(g1) + 5*Sqr(g2))*ZP(gI1,1)*ZP(gI2,1) - 10*(Sqr(g2)*ZP(gI1,2)*ZP(gI2,2)
      - (-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,3)*ZP(gI2,3))) + 5*(KroneckerDelta(0
      ,gO2)*(AbsSqr(Lambdax) + Sqr(g2))*(ZP(gI1,1)*ZP(gI2,0) + ZP(gI1,0)*ZP(gI2,1)
      ) + 1.4142135623730951*KroneckerDelta(2,gO2)*(-AbsSqr(Lambdax) + Sqr(g2))*(
      ZP(gI1,2)*ZP(gI2,1) + ZP(gI1,3)*ZP(gI2,1) + ZP(gI1,1)*(ZP(gI2,2) + ZP(gI2,3)
      )))) - 5*KroneckerDelta(2,gO1)*(Sqr(g2)*(4*KroneckerDelta(2,gO2)*(ZP(gI1,2)
      + ZP(gI1,3))*(ZP(gI2,2) + ZP(gI2,3)) + 1.4142135623730951*KroneckerDelta(0,
      ...
      ZP(gI1,3)*ZP(gI2,1) + ZP(gI1,1)*(ZP(gI2,2) + ZP(gI2,3)))) + AbsSqr(Lambdax)*
      (2*KroneckerDelta(2,gO2)*(ZP(gI1,0)*ZP(gI2,0) + ZP(gI1,1)*ZP(gI2,1)) +
      1.4142135623730951*(-(KroneckerDelta(0,gO2)*(ZP(gI1,2)*ZP(gI2,0) + ZP(gI1,3)
...
std::complex<double> CLASSNAME::CpUAhHpmconjHpm(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = std::complex<double>(0,-0.25)*(4*Conj(MT
      )*KroneckerDelta(2,gO2)*Lambdax*ZP(gI1,1)*ZP(gI2,0) - vu*KroneckerDelta(0,
      gO2)*Sqr(g2)*ZP(gI1,1)*ZP(gI2,0) - vd*KroneckerDelta(1,gO2)*Sqr(g2)*ZP(gI1,1
      )*ZP(gI2,0) - 2*KroneckerDelta(2,gO2)*TLambdax*ZP(gI1,1)*ZP(gI2,0) -
...
std::complex<double> CLASSNAME::CpChiChiUAhPL(int gI1, int gI2, int gO1) const
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(5*g2*Conj(
      ...
      *KroneckerDelta(1,gO1) + 3.872983346207417*g1*Conj(ZN(gI1,0))*(-(Conj(ZN(gI2
      ,2))*KroneckerDelta(0,gO1)) + Conj(ZN(gI2,3))*KroneckerDelta(1,gO1)) + 5*
      Conj(ZN(gI1,4))*Conj(ZN(gI2,3))*KroneckerDelta(0,gO1)*Lambdax + 5*Conj(ZN(
      gI1,3))*Conj(ZN(gI2,4))*KroneckerDelta(0,gO1)*Lambdax + 5*Conj(ZN(gI1,4))*
      Conj(ZN(gI2,2))*KroneckerDelta(1,gO1)*Lambdax + 5*Conj(ZN(gI1,3))*Conj(ZN(
      gI2,2))*KroneckerDelta(2,gO1)*Lambdax + Conj(ZN(gI1,2))*(-3.872983346207417*
      g1*Conj(ZN(gI2,0))*KroneckerDelta(0,gO1) + 5*(g2*Conj(ZN(gI2,1))*
      KroneckerDelta(0,gO1) + Conj(ZN(gI2,4))*KroneckerDelta(1,gO1)*Lambdax + Conj
      (ZN(gI2,3))*KroneckerDelta(2,gO1)*Lambdax)));
...
std::complex<double> CLASSNAME::CpUAhUAhSdconjSd(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(-7.0710678118654755*KroneckerDelta
      (1,gO2)*KroneckerDelta(2,gO1)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM
      (j1,0,2,Yd(j1,j2)*ZD(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(
      j1,j2))*Conj(ZD(gI1,3 + j1)))*ZD(gI2,j2))) - KroneckerDelta(1,gO1)*(
      KroneckerDelta(1,gO2)*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(
      gI2,j1)) + 2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1))) +
      7.0710678118654755*KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(
      gI1,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0
...
std::complex<double> CLASSNAME::CpUAhUAhSeconjSe(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(-7.0710678118654755*KroneckerDelta
      (1,gO2)*KroneckerDelta(2,gO1)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM
      (j1,0,2,Ye(j1,j2)*ZE(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(
      j1,j2))*Conj(ZE(gI1,3 + j1)))*ZE(gI2,j2))) + KroneckerDelta(1,gO1)*(
      KroneckerDelta(1,gO2)*((3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gI1,j1))*
      ZE(gI2,j1)) - 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1))) -
      7.0710678118654755*KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(
      gI1,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0
...
std::complex<double> CLASSNAME::CpUAhUAhSuconjSu(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(-7.0710678118654755*KroneckerDelta
      (0,gO2)*KroneckerDelta(2,gO1)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM
      (j1,0,2,Yu(j1,j2)*ZU(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
      j1,j2))*Conj(ZU(gI1,3 + j1)))*ZU(gI2,j2))) + KroneckerDelta(0,gO1)*(
      KroneckerDelta(0,gO2)*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(
      gI2,j1)) - 4*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1))) -
      7.0710678118654755*KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(
      gI1,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0
...
std::complex<double> CLASSNAME::CpAhAhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*(-(
      ...
      AbsSqr(Lambdax) - 3*Sqr(g1) + 5*Sqr(g2))*ZA(gI1,1)*ZA(gI2,1) + 10*AbsSqr(
      Lambdax)*ZA(gI1,2)*ZA(gI2,2))) + 5*(KroneckerDelta(1,gO2)*(AbsSqr(Lambdax) +
      Sqr(g2))*(ZA(gI1,1)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,1)) - 1.4142135623730951*(
      KroneckerDelta(2,gO2) + KroneckerDelta(3,gO2))*(-AbsSqr(Lambdax) + Sqr(g2))*
      (ZA(gI1,2)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,2)))) + KroneckerDelta(1,gO1)*(
      KroneckerDelta(1,gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) - 5*Sqr(g2))*ZA(gI1,
      0)*ZA(gI2,0) - (3*Sqr(g1) + 5*Sqr(g2))*ZA(gI1,1)*ZA(gI2,1) - 10*AbsSqr(
      Lambdax)*ZA(gI1,2)*ZA(gI2,2)) + 5*(KroneckerDelta(0,gO2)*(AbsSqr(Lambdax) +
      Sqr(g2))*(ZA(gI1,1)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,1)) + 1.4142135623730951*(
      KroneckerDelta(2,gO2) + KroneckerDelta(3,gO2))*(-AbsSqr(Lambdax) + Sqr(g2))*
      (ZA(gI1,2)*ZA(gI2,1) + ZA(gI1,1)*ZA(gI2,2)))) + 5*(-(KroneckerDelta(3,gO1)*(
...
std::complex<double> CLASSNAME::CpHpmUHpmconjHpmconjUHpm(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*((
      ...
      ) + 10*(KroneckerDelta(2,gO2)*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,2) -
      ...
      ZP(gI1,2)*ZP(gI2,2) + 5*Sqr(g2)*ZP(gI1,3)*ZP(gI2,3)))) - KroneckerDelta(0,
      gO1)*((KroneckerDelta(1,gO2)*(10*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2))*ZP
      (gI1,1) + 10*(KroneckerDelta(2,gO2)*Sqr(g2)*ZP(gI1,2) - KroneckerDelta(3,gO2
      )*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,3)))*ZP(gI2,0) + KroneckerDelta(0,
      gO2)*(2*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,0)*ZP(gI2,0) + (10*AbsSqr(Lambdax) -
      3*Sqr(g1) - 5*Sqr(g2))*ZP(gI1,1)*ZP(gI2,1) + 10*(Sqr(g2)*ZP(gI1,2)*ZP(gI2,2)
      - (-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,3)*ZP(gI2,3)))) - 10*(
      KroneckerDelta(2,gO1)*((KroneckerDelta(0,gO2)*Sqr(g2)*ZP(gI1,0) -
      KroneckerDelta(1,gO2)*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,1) - 2*
      KroneckerDelta(3,gO2)*Sqr(g2)*ZP(gI1,3))*ZP(gI2,2) + KroneckerDelta(2,gO2)*(
      Sqr(g2)*ZP(gI1,0)*ZP(gI2,0) - (-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,1)*ZP(
      gI2,1) + 2*Sqr(g2)*(2*ZP(gI1,2)*ZP(gI2,2) - ZP(gI1,3)*ZP(gI2,3)))) +
      KroneckerDelta(3,gO1)*((-(KroneckerDelta(0,gO2)*(-2*AbsSqr(Lambdax) + Sqr(g2
      ))*ZP(gI1,0)) + Sqr(g2)*(KroneckerDelta(1,gO2)*ZP(gI1,1) - 2*KroneckerDelta(
      2,gO2)*ZP(gI1,2)))*ZP(gI2,3) + KroneckerDelta(3,gO2)*(-((-2*AbsSqr(Lambdax)
      + Sqr(g2))*ZP(gI1,0)*ZP(gI2,0)) + Sqr(g2)*(ZP(gI1,1)*ZP(gI2,1) - 2*ZP(gI1,2)
      *ZP(gI2,2) + 4*ZP(gI1,3)*ZP(gI2,3))))));
...
std::complex<double> CLASSNAME::CphhHpmconjUHpm(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = 0.05*(-5*(KroneckerDelta(2,gO2)*(
      ...
      *vd*AbsSqr(Lambdax)*ZH(gI2,2)*ZP(gI1,0) + 1.4142135623730951*vd*Sqr(g2)*ZH(
      ...
      + vT*Sqr(g2))*ZP(gI1,0) + 2.8284271247461903*Conj(TLambdax)*ZP(gI1,1) - 2*
      vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,2)) - 4*vT*Sqr(g2)*ZH(gI2,2)*ZP(gI1
      ,3)) + KroneckerDelta(3,gO2)*(-2.8284271247461903*TLambdax*ZH(gI2,1)*ZP(gI1,
      0) + 1.4142135623730951*vd*AbsSqr(Lambdax)*ZH(gI2,2)*ZP(gI1,0) -
...
std::complex<double> CLASSNAME::CpChiChaconjUHpmPR(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = -(Conj(Lambdax)*KroneckerDelta(2,gO2)*UP
      ...
      1.4142135623730951*g2*KroneckerDelta(3,gO2)*(-(UP(gI2,2)*ZN(gI1,1)) + UP(
      gI2,0)*ZN(gI1,4));
...
std::complex<double> CLASSNAME::CpUHpmSdconjUHpmconjSd(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = 0.05*(-10*(-(KroneckerDelta(3,gO1)*
      KroneckerDelta(3,gO2)*Sqr(g2)*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1))) +
...
std::complex<double> CLASSNAME::CpUHpmSeconjUHpmconjSe(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      KroneckerDelta(1,gO2)*((3*Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gI1,j1))*
      ZE(gI2,j1)) - 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1))) -
      20*Conj(Lambdax)*KroneckerDelta(2,gO2)*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,
      2,Ye(j1,j2)*ZE(gI2,3 + j1)))) - 10*(-(KroneckerDelta(3,gO1)*KroneckerDelta(3
      ,gO2)*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1))) + KroneckerDelta(2,
      gO1)*(KroneckerDelta(2,gO2)*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1))
      + 2*KroneckerDelta(1,gO2)*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj
      (ZE(gI1,3 + j1)))*ZE(gI2,j2)))) - KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2
      )*((3*Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)) - 6*Sqr(
      g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1)) + 20*SUM(j3,0,2,Conj(ZE(
      gI1,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gI2,3 + j2)
      ))));
...
std::complex<double> CLASSNAME::CpSdconjUHpmconjSu(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.25*(-2*vT*KroneckerDelta(2,gO2)*Sqr(g2
      )*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZU(gI1,j1)) + 2*vT*KroneckerDelta(3,gO2)*Sqr(
      g2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZU(gI1,j1)) + 2.8284271247461903*vd*Conj(
...
std::complex<double> CLASSNAME::CpbarChaChaVPPL(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*(2*g2*Conj(UM(gI2,0))*Sin(ThetaW())*
      ...
      ThetaW()))*UM(gI1,1) + 2*g2*Conj(UM(gI2,2))*Sin(ThetaW())*UM(gI1,2));
...
std::complex<double> CLASSNAME::CpbarChaChaVPPR(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*(2*g2*Conj(UP(gI1,0))*Sin(ThetaW())*
      ...
      ThetaW()))*UP(gI2,1) + 2*g2*Conj(UP(gI1,2))*Sin(ThetaW())*UP(gI2,2));
...
std::complex<double> CLASSNAME::CpbarChaChaVZPL(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*(2*g2*Conj(UM(gI2,0))*Cos(ThetaW())*
      ...
      ThetaW()))*UM(gI1,1) + 2*g2*Conj(UM(gI2,2))*Cos(ThetaW())*UM(gI1,2));
...
std::complex<double> CLASSNAME::CpbarChaChaVZPR(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*(2*g2*Conj(UP(gI1,0))*Cos(ThetaW())*
      ...
      ThetaW()))*UP(gI2,1) + 2*g2*Conj(UP(gI1,2))*Cos(ThetaW())*UP(gI2,2));
...
std::complex<double> CLASSNAME::CpAhAhconjVWmVWm(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*Sqr(g2)*(ZA(gI1,0)*ZA(gI2,0) + ZA(
      gI1,1)*ZA(gI2,1) + 4*ZA(gI1,2)*ZA(gI2,2));
...
std::complex<double> CLASSNAME::CphhhhconjVWmVWm(int gI1, int gI2) const
{
   const std::complex<double> result = 0.5*Sqr(g2)*(ZH(gI1,0)*ZH(gI2,0) + ZH(
      gI1,1)*ZH(gI2,1) + 4*ZH(gI1,2)*ZH(gI2,2));
...
std::complex<double> CLASSNAME::CphhHpmconjVWm(int gI2, int gI1) const
{
   const std::complex<double> result = -0.5*g2*(ZH(gI2,0)*ZP(gI1,0) - ZH(gI2,1)
      *ZP(gI1,1) + 1.4142135623730951*ZH(gI2,2)*(ZP(gI1,2) + ZP(gI1,3)));
...
std::complex<double> CLASSNAME::CpbarChaUChiHpmPR(int gI1, int gO1, int gI2) const
{
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,
      gO1)*UM(gI1,1)*ZP(gI2,0) + 0.7071067811865475*g2*KroneckerDelta(1,gO1)*UM(
      gI1,1)*ZP(gI2,0) + 0.7071067811865475*Conj(Lambdax)*KroneckerDelta(4,gO1)*UM
      (gI1,1)*ZP(gI2,1) - KroneckerDelta(2,gO1)*(g2*UM(gI1,0)*ZP(gI2,0) + Conj(
      Lambdax)*UM(gI1,2)*ZP(gI2,1)) - 1.4142135623730951*g2*KroneckerDelta(4,gO1)*
      UM(gI1,0)*ZP(gI2,2) + 1.4142135623730951*g2*KroneckerDelta(1,gO1)*UM(gI1,2)*
      ZP(gI2,2) + Conj(Lambdax)*KroneckerDelta(3,gO1)*UM(gI1,1)*ZP(gI2,3);
...
std::complex<double> CLASSNAME::CpChiUChihhPL(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.1*(-5*g2*Conj(ZN(gI2,1))*
      KroneckerDelta(2,gO2)*ZH(gI1,0) + 5*Conj(ZN(gI2,4))*KroneckerDelta(3,gO2)*
      Lambdax*ZH(gI1,0) + 5*Conj(ZN(gI2,3))*KroneckerDelta(4,gO2)*Lambdax*ZH(gI1,0
...
std::complex<double> CLASSNAME::CpChiUChihhPR(int gI2, int gO1, int gI1) const
{
   const std::complex<double> result = 0.1*(3.872983346207417*g1*KroneckerDelta
      ...
      + 5*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZH(gI1,1)*ZN(gI2,2) + 5*Conj(
...
std::complex<double> CLASSNAME::CpbarChaUChiVWmPL(int gI1, int gO2) const
{
   const std::complex<double> result = -0.5*g2*(2*KroneckerDelta(1,gO2)*UM(gI1,
      0) + 1.4142135623730951*KroneckerDelta(2,gO2)*UM(gI1,1) + 2*KroneckerDelta(4
      ,gO2)*UM(gI1,2));
...
std::complex<double> CLASSNAME::CpbarChaUChiVWmPR(int gI1, int gO1) const
{
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*KroneckerDelta(1,
      gO1)) + 0.7071067811865475*g2*Conj(UP(gI1,1))*KroneckerDelta(3,gO1) - g2*
      Conj(UP(gI1,2))*KroneckerDelta(4,gO1);
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(3,gO1)*UP(gI2,0)*ZP(
      gI1,1)) + Conj(Lambdax)*(0.7071067811865475*KroneckerDelta(4,gO1)*UP(gI2,1)*
      ZP(gI1,0) + KroneckerDelta(3,gO1)*UP(gI2,2)*ZP(gI1,0) - KroneckerDelta(2,gO1
      )*UP(gI2,1)*ZP(gI1,2)) + 0.1414213562373095*(-3.872983346207417*g1*
      KroneckerDelta(0,gO1)*UP(gI2,1)*ZP(gI1,1) - 5*g2*(-2*KroneckerDelta(4,gO1)*
      UP(gI2,0)*ZP(gI1,3) + KroneckerDelta(1,gO1)*(UP(gI2,1)*ZP(gI1,1) + 2*UP(gI2,
      2)*ZP(gI1,3))));
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(5*g2*Conj(
      ZN(gI1,1))*KroneckerDelta(2,gO2)*ZA(gI2,0) + 5*Conj(ZN(gI1,4))*
      KroneckerDelta(3,gO2)*Lambdax*ZA(gI2,0) + 5*Conj(ZN(gI1,3))*KroneckerDelta(4
      ,gO2)*Lambdax*ZA(gI2,0) + 3.872983346207417*g1*Conj(ZN(gI1,3))*
      KroneckerDelta(0,gO2)*ZA(gI2,1) - 5*g2*Conj(ZN(gI1,3))*KroneckerDelta(1,gO2)
      *ZA(gI2,1) - 5*g2*Conj(ZN(gI1,1))*KroneckerDelta(3,gO2)*ZA(gI2,1) + 5*Conj(
      ...
      ZA(gI2,1)) + 5*Conj(ZN(gI1,3))*KroneckerDelta(2,gO2)*Lambdax*ZA(gI2,2) +
      Conj(ZN(gI1,2))*(-3.872983346207417*g1*KroneckerDelta(0,gO2)*ZA(gI2,0) + 5*(
      g2*KroneckerDelta(1,gO2)*ZA(gI2,0) + KroneckerDelta(4,gO2)*Lambdax*ZA(gI2,1)
      + KroneckerDelta(3,gO2)*Lambdax*ZA(gI2,2))));
...
std::complex<double> CLASSNAME::CpUChiChaconjVWmPL(int gO1, int gI2) const
{
   const std::complex<double> result = -0.5*g2*(2*Conj(UM(gI2,0))*
      ...
      gO1) + 2*Conj(UM(gI2,2))*KroneckerDelta(4,gO1));
...
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(Conj(UM(gI1
      ,2))*(-1.4142135623730951*KroneckerDelta(1,gO2)*Lambdax*ZA(gI2,0) + 2*g2*
...
{
   const std::complex<double> result = 0.5*(-(Conj(UM(gI2,2))*(
      1.4142135623730951*KroneckerDelta(1,gO2)*Lambdax*ZH(gI1,0) + 2*g2*
      KroneckerDelta(0,gO2)*ZH(gI1,2))) + g2*Conj(UM(gI2,0))*(-1.4142135623730951*
      KroneckerDelta(1,gO2)*ZH(gI1,1) + 2*KroneckerDelta(2,gO2)*ZH(gI1,2)) + Conj(
      UM(gI2,1))*(-1.4142135623730951*g2*KroneckerDelta(0,gO2)*ZH(gI1,0) +
      1.4142135623730951*KroneckerDelta(2,gO2)*Lambdax*ZH(gI1,1) + KroneckerDelta(
      1,gO2)*Lambdax*ZH(gI1,2)));
...
{
   const std::complex<double> result = KroneckerDelta(2,gO1)*(-(Conj(Lambdax)*
      ZN(gI2,2)*ZP(gI1,1)) + 1.4142135623730951*g2*ZN(gI2,1)*ZP(gI1,2)) - g2*
...
std::complex<double> CLASSNAME::CpbarUChaChaVPPR(int gO2, int gI2) const
{
   const std::complex<double> result = g2*KroneckerDelta(0,gO2)*Sin(ThetaW())*
      ...
      5*g2*Sin(ThetaW()))*UP(gI2,1) + g2*KroneckerDelta(2,gO2)*Sin(ThetaW())*UP(
      gI2,2);
...
std::complex<double> CLASSNAME::CpbarUChaChaVPPL(int gO1, int gI2) const
{
   const std::complex<double> result = g2*(Conj(UM(gI2,0))*KroneckerDelta(0,gO1
      ...
      ))*KroneckerDelta(1,gO1)*(3.872983346207417*g1*Cos(ThetaW()) + 5*g2*Sin(
      ThetaW()));
...
std::complex<double> CLASSNAME::CpbarUChaChaVZPR(int gO2, int gI2) const
{
   const std::complex<double> result = g2*Cos(ThetaW())*KroneckerDelta(0,gO2)*
      ...
      3.872983346207417*g1*Sin(ThetaW()))*UP(gI2,1) + g2*Cos(ThetaW())*
      KroneckerDelta(2,gO2)*UP(gI2,2);
...
std::complex<double> CLASSNAME::CpbarUChaChiVWmPL(int gO1, int gI2) const
{
   const std::complex<double> result = -0.5*g2*(2*Conj(ZN(gI2,1))*
      ...
      gO1) + 2*Conj(ZN(gI2,4))*KroneckerDelta(2,gO1));
...
std::complex<double> CLASSNAME::self_energy_Sd_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFu(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI1)),Sqr(
...
std::complex<double> CLASSNAME::self_energy_Hpm_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,3,A0(Sqr(MHpm(gI1)))*CpHpmUHpmconjHpmconjUHpm(gI1,gO1,
      gI1,gO2));
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MHpm(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhHpmconjUHpm(gI2,gI1,gO2))*CpAhHpmconjUHpm(gI2,gI1,gO1)));
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MHpm(gI1)),Sqr(Mhh(gI2)))*
...
std::complex<double> CLASSNAME::self_energy_VWm_1loop(double p ) const
{
   ...
   result += -4*SUM(gI1,0,3,SUM(gI2,0,2,AbsSqr(CpAhHpmconjVWm(gI2,gI1))*B00(Sqr
      (p),Sqr(MAh(gI2)),Sqr(MHpm(gI1)))));
   result += -4*SUM(gI1,0,3,SUM(gI2,0,2,AbsSqr(CphhHpmconjVWm(gI2,gI1))*B00(Sqr
      (p),Sqr(Mhh(gI2)),Sqr(MHpm(gI1)))));
   result += SUM(gI1,0,4,SUM(gI2,0,2,(AbsSqr(CpChiChaconjVWmPL(gI1,gI2)) +
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MSv(gI1)))*
      ...
      ;
   result += SUM(gI1,0,2,MCha(gI1)*SUM(gI2,0,3,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(
   ...
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MHpm(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(Mhh(gI1)))*
   ...
   result += SUM(gI1,0,3,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MHpm(gI1)))*
   ...
   result += 3*SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFd(gI2)),Sqr(MSu(gI1)))*
      ...
      gI2)));
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MCha(gI2)),0)*Conj(CpbarUChaChaVPPR(
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MVZ))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MSv(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MSu(gI1)))*
