...
namespace TMSSM_info {
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {
      ...
      "me2(2,2)", "mT2", "MassB", "MassWB", "MassG"};
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS> input_parameter_names
       = {"m0", "m12", "TanBeta", "Sign(Mu)", "Azero", "MTinput", "Qin",
      "LambdaInput", "vTInput"};
...
int get_pdg_code_for_particle(Particles p, int index)
{
   ...
   case Cha: pdg_codes = {-1000024, -1000037, -1000047}; break;
...
std::pair<std::string, boost::optional<unsigned int>> get_multiplet_and_index_from_pdg(int pdg)
{
   ...
   case 1000047: name = {"barCha", 3}; break;
