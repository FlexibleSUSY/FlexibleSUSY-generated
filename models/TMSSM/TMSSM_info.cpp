...
namespace TMSSM_info {
   ...
   const std::array<int, NUMBER_OF_PARTICLES> particle_multiplicities = {1, 1,
      3, 6, 3, 6, 6, 3, 3, 4, 5, 3, 3, 3, 3, 1, 1, 1};
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {
      ...
      , "Ye(1,2)", "Ye(2,0)", "Ye(2,1)", "Ye(2,2)", "Lambdax", "Yu(0,0)",
      "Yu(0,1)", "Yu(0,2)", "Yu(1,0)", "Yu(1,1)", "Yu(1,2)", "Yu(2,0)", "Yu(2,1)",
      "Yu(2,2)", "Mu", "MT", "g1", "g2", "g3", "vd", "vu", "vT", "TYd(0,0)",
      ...
      "TYu(2,0)", "TYu(2,1)", "TYu(2,2)", "BMu", "BMT", "mq2(0,0)", "mq2(0,1)",
      ...
      "me2(2,1)", "me2(2,2)", "mT2", "MassB", "MassWB", "MassG"};
   ...
   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      ...
      "ZA(2,1)", "ZA(2,2)", "ZP(0,0)", "ZP(0,1)", "ZP(0,2)", "ZP(0,3)", "ZP(1,0)",
      "ZP(1,1)", "ZP(1,2)", "ZP(1,3)", "ZP(2,0)", "ZP(2,1)", "ZP(2,2)", "ZP(2,3)"
      , "ZP(3,0)", "ZP(3,1)", "ZP(3,2)", "ZP(3,3)", "Re(ZN(0,0))", "Im(ZN(0,0))",
      "Re(ZN(0,1))", "Im(ZN(0,1))", "Re(ZN(0,2))", "Im(ZN(0,2))", "Re(ZN(0,3))",
      "Im(ZN(0,3))", "Re(ZN(0,4))", "Im(ZN(0,4))", "Re(ZN(1,0))", "Im(ZN(1,0))",
      "Re(ZN(1,1))", "Im(ZN(1,1))", "Re(ZN(1,2))", "Im(ZN(1,2))", "Re(ZN(1,3))",
      "Im(ZN(1,3))", "Re(ZN(1,4))", "Im(ZN(1,4))", "Re(ZN(2,0))", "Im(ZN(2,0))",
      "Re(ZN(2,1))", "Im(ZN(2,1))", "Re(ZN(2,2))", "Im(ZN(2,2))", "Re(ZN(2,3))",
      "Im(ZN(2,3))", "Re(ZN(2,4))", "Im(ZN(2,4))", "Re(ZN(3,0))", "Im(ZN(3,0))",
      "Re(ZN(3,1))", "Im(ZN(3,1))", "Re(ZN(3,2))", "Im(ZN(3,2))", "Re(ZN(3,3))",
      "Im(ZN(3,3))", "Re(ZN(3,4))", "Im(ZN(3,4))", "Re(ZN(4,0))", "Im(ZN(4,0))",
      "Re(ZN(4,1))", "Im(ZN(4,1))", "Re(ZN(4,2))", "Im(ZN(4,2))", "Re(ZN(4,3))",
      "Im(ZN(4,3))", "Re(ZN(4,4))", "Im(ZN(4,4))", "Re(UM(0,0))", "Im(UM(0,0))",
      "Re(UM(0,1))", "Im(UM(0,1))", "Re(UM(0,2))", "Im(UM(0,2))", "Re(UM(1,0))",
      "Im(UM(1,0))", "Re(UM(1,1))", "Im(UM(1,1))", "Re(UM(1,2))", "Im(UM(1,2))",
      "Re(UM(2,0))", "Im(UM(2,0))", "Re(UM(2,1))", "Im(UM(2,1))", "Re(UM(2,2))",
      "Im(UM(2,2))", "Re(UP(0,0))", "Im(UP(0,0))", "Re(UP(0,1))", "Im(UP(0,1))",
      "Re(UP(0,2))", "Im(UP(0,2))", "Re(UP(1,0))", "Im(UP(1,0))", "Re(UP(1,1))",
      "Im(UP(1,1))", "Re(UP(1,2))", "Im(UP(1,2))", "Re(UP(2,0))", "Im(UP(2,0))",
      "Re(UP(2,1))", "Im(UP(2,1))", "Re(UP(2,2))", "Im(UP(2,2))", "Re(ZEL(0,0))",
