...
namespace TMSSM_info {
   ...
   const char* parameter_names[NUMBER_OF_PARAMETERS] = {"Yd(0,0)", "Yd(0,1)",
      ...
      , "Ye(2,1)", "Ye(2,2)", "Lambdax", "Yu(0,0)", "Yu(0,1)", "Yu(0,2)",
      "Yu(1,0)", "Yu(1,1)", "Yu(1,2)", "Yu(2,0)", "Yu(2,1)", "Yu(2,2)", "Mu", "MT"
      , "g1", "g2", "g3", "vd", "vu", "vT", "TYd(0,0)", "TYd(0,1)", "TYd(0,2)",
      "TYd(1,0)", "TYd(1,1)", "TYd(1,2)", "TYd(2,0)", "TYd(2,1)", "TYd(2,2)",
      "TYe(0,0)", "TYe(0,1)", "TYe(0,2)", "TYe(1,0)", "TYe(1,1)", "TYe(1,2)",
      "TYe(2,0)", "TYe(2,1)", "TYe(2,2)", "TLambdax", "TYu(0,0)", "TYu(0,1)",
      "TYu(0,2)", "TYu(1,0)", "TYu(1,1)", "TYu(1,2)", "TYu(2,0)", "TYu(2,1)",
      "TYu(2,2)", "BMu", "BMT", "mq2(0,0)", "mq2(0,1)", "mq2(0,2)", "mq2(1,0)",
   ...
   const char* particle_mixing_names[NUMBER_OF_MIXINGS] = {   "ZD(0,0)",
      ...
      , "ZP(0,0)", "ZP(0,1)", "ZP(0,2)", "ZP(0,3)", "ZP(1,0)", "ZP(1,1)",
      "ZP(1,2)", "ZP(1,3)", "ZP(2,0)", "ZP(2,1)", "ZP(2,2)", "ZP(2,3)", "ZP(3,0)",
      "ZP(3,1)", "ZP(3,2)", "ZP(3,3)", "Re(ZN(0,0))", "Im(ZN(0,0))",
      ...
      "Im(ZUR(2,1))", "Re(ZUR(2,2))", "Im(ZUR(2,2))"};
