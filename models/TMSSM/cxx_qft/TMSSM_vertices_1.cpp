...
/**
 * @file cxx_qft/TMSSM_vertices.cpp
 *
 * This file was generated with FlexibleSUSY 2.7.1 and SARAH 4.14.5 .
 */

#include "TMSSM_context_base.hpp"
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-2*AbsSqr(Lambdax)*ZA(gt1,2)*(ZA(gt2,2)*(ZA(gt3,0)*ZA(gt4,0) + ZA(gt3,1)*ZA(gt4,1)) + ZA(gt2,0)*(ZA(gt3,2)*ZA(gt4,0) + ZA(gt3,0)*ZA(gt4,2)) + ZA(gt2,1)*(ZA(gt3,2)*ZA(gt4,1) + ZA(gt3,1)*ZA(gt4,2))) + ZA(gt1,1)*((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt2,0)*(ZA(gt3,1)*ZA(gt4,0) + ZA(gt3,0)*ZA(gt4,1)) - 2*AbsSqr(Lambdax)*ZA(gt2,2)*(ZA(gt3,2)*ZA(gt4,1) + ZA(gt3,1)*ZA(gt4,2)) + ZA(gt2,1)*((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,0)*ZA(gt4,0) - 3*(0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,1)*ZA(gt4,1) - 2*AbsSqr(Lambdax)*ZA(gt3,2)*ZA(gt4,2))) - ZA(gt1,0)*(-((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt2,1)*(ZA(gt3,1)*ZA(gt4,0) + ZA(gt3,0)*ZA(gt4,1))) + 2*AbsSqr(Lambdax)*ZA(gt2,2)*(ZA(gt3,2)*ZA(gt4,0) + ZA(gt3,0)*ZA(gt4,2)) + ZA(gt2,0)*(3*(0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,0)*ZA(gt4,0) - (-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,1)*ZA(gt4,1) + 2*AbsSqr(Lambdax)*ZA(gt3,2)*ZA(gt4,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*((Conj(TLambdax) + 2*Conj(MT)*Lambdax - TLambdax)*(ZA(gt1,2)*(ZA(gt2,1)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,1)) + ZA(gt1,1)*(ZA(gt2,2)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,2)) + ZA(gt1,0)*(ZA(gt2,2)*ZA(gt3,1) + ZA(gt2,1)*ZA(gt3,2))) - 2*Conj(Mu)*Lambdax*(ZA(gt1,2)*(ZA(gt2,0)*ZA(gt3,0) + ZA(gt2,1)*ZA(gt3,1)) + ZA(gt1,0)*(ZA(gt2,2)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,2)) + ZA(gt1,1)*(ZA(gt2,2)*ZA(gt3,1) + ZA(gt2,1)*ZA(gt3,2))) + 2*Conj(Lambdax)*(ZA(gt1,2)*(ZA(gt2,0)*(Mu*ZA(gt3,0) - MT*ZA(gt3,1)) + ZA(gt2,1)*(-(MT*ZA(gt3,0)) + Mu*ZA(gt3,1))) + ZA(gt1,0)*(ZA(gt2,2)*(Mu*ZA(gt3,0) - MT*ZA(gt3,1)) + (Mu*ZA(gt2,0) - MT*ZA(gt2,1))*ZA(gt3,2)) + ZA(gt1,1)*(ZA(gt2,2)*(-(MT*ZA(gt3,0)) + Mu*ZA(gt3,1)) + (-(MT*ZA(gt2,0)) + Mu*ZA(gt2,1))*ZA(gt3,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-2*AbsSqr(Lambdax)*ZA(gt1,2)*ZA(gt2,2)*(ZH(gt3,0)*ZH(gt4,0) + ZH(gt3,1)*ZH(gt4,1)) - ZA(gt1,1)*ZA(gt2,1)*(-((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0)) + (0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) + 2*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2)) - ZA(gt1,0)*ZA(gt2,0)*((0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - (-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) + 2*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(5*ZA(gt1,2)*(2*Conj(MT)*Lambdax*(ZA(gt2,1)*ZH(gt3,0) + ZA(gt2,0)*ZH(gt3,1)) - (Conj(TLambdax) + TLambdax)*(ZA(gt2,1)*ZH(gt3,0) + ZA(gt2,0)*ZH(gt3,1)) + 2*Conj(Lambdax)*(MT*ZA(gt2,1)*ZH(gt3,0) + MT*ZA(gt2,0)*ZH(gt3,1) - Lambdax*ZA(gt2,2)*(vd*ZH(gt3,0) + vu*ZH(gt3,1)))) + ZA(gt1,1)*(ZA(gt2,1)*(vd*(-10*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(gt3,0) - vu*(3*Sqr(g1) + 5*Sqr(g2))*ZH(gt3,1) - 10*(Conj(Mu)*Lambdax + Conj(Lambdax)*(vT*Lambdax + Mu))*ZH(gt3,2)) + 5*(2*MT*Conj(Lambdax)*(ZA(gt2,2)*ZH(gt3,0) - ZA(gt2,0)*ZH(gt3,2)) + 2*Conj(MT)*Lambdax*(ZA(gt2,2)*ZH(gt3,0) - ZA(gt2,0)*ZH(gt3,2)) - (Conj(TLambdax) + TLambdax)*(ZA(gt2,2)*ZH(gt3,0) + ZA(gt2,0)*ZH(gt3,2)))) - ZA(gt1,0)*(ZA(gt2,0)*(vd*(3*Sqr(g1) + 5*Sqr(g2))*ZH(gt3,0) + vu*(10*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2))*ZH(gt3,1) + 10*(Conj(Mu)*Lambdax + Conj(Lambdax)*(vT*Lambdax + Mu))*ZH(gt3,2)) + 5*((Conj(TLambdax) + TLambdax)*(ZA(gt2,2)*ZH(gt3,1) + ZA(gt2,1)*ZH(gt3,2)) + Conj(Lambdax)*(-2*MT*ZA(gt2,2)*ZH(gt3,1) + 2*MT*ZA(gt2,1)*ZH(gt3,2)) + Conj(MT)*(-2*Lambdax*ZA(gt2,2)*ZH(gt3,1) + 2*Lambdax*ZA(gt2,1)*ZH(gt3,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZA(gt1,0)*(-((AbsSqr(Lambdax) + Sqr(g2))*ZA(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1))) + ZA(gt2,0)*((0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (4*AbsSqr(Lambdax) - 0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1) + 4*AbsSqr(Lambdax)*ZP(gt3,2)*ZP(gt4,2) - 2*Sqr(g2)*ZP(gt3,2)*ZP(gt4,2) + 2*Sqr(g2)*ZP(gt3,3)*ZP(gt4,3)) + 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZA(gt2,2)*(ZP(gt3,2)*ZP(gt4,0) + ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(ZP(gt4,2) + ZP(gt4,3))))) + ZA(gt1,1)*((AbsSqr(Lambdax) + Sqr(g2))*ZA(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) + 0.2*ZA(gt2,1)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) - 5*Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) - (3*Sqr(g1) + 5*Sqr(g2))*ZP(gt3,1)*ZP(gt4,1) - 10*Sqr(g2)*ZP(gt3,2)*ZP(gt4,2) + 10*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,3)*ZP(gt4,3)) + 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZA(gt2,2)*(ZP(gt3,2)*ZP(gt4,1) + ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(ZP(gt4,2) + ZP(gt4,3)))) - ZA(gt1,2)*(Sqr(g2)*(4*ZA(gt2,2)*(ZP(gt3,2) + ZP(gt3,3))*(ZP(gt4,2) + ZP(gt4,3)) + 1.4142135623730951*ZA(gt2,0)*(ZP(gt3,2)*ZP(gt4,0) + ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(ZP(gt4,2) + ZP(gt4,3))) - 1.4142135623730951*ZA(gt2,1)*(ZP(gt3,2)*ZP(gt4,1) + ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(ZP(gt4,2) + ZP(gt4,3)))) + AbsSqr(Lambdax)*(2*ZA(gt2,2)*(ZP(gt3,0)*ZP(gt4,0) + ZP(gt3,1)*ZP(gt4,1)) + 1.4142135623730951*(-(ZA(gt2,0)*(ZP(gt3,2)*ZP(gt4,0) + ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(ZP(gt4,2) + ZP(gt4,3)))) + ZA(gt2,1)*(ZP(gt3,2)*ZP(gt4,1) + ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(ZP(gt4,2) + ZP(gt4,3)))))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gt3,j1))*ZD(gt4,j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) + 2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gt3,3 + j1))*ZD(gt4,3 + j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) - 5*(4*SUM(j3,0,2,Conj(ZD(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*ZA(gt1,0)*ZA(gt2,0) + 4*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZA(gt1,0)*ZA(gt2,0) + 1.4142135623730951*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt3,3 + j1)))*ZD(gt4,j2)))*(ZA(gt1,2)*ZA(gt2,1) + ZA(gt1,1)*ZA(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(-((3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gt3,j1))*ZE(gt4,j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1))) + 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt3,3 + j1))*ZE(gt4,3 + j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) - 5*(4*SUM(j3,0,2,Conj(ZE(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt4,3 + j2)))*ZA(gt1,0)*ZA(gt2,0) + 4*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZA(gt1,0)*ZA(gt2,0) + 1.4142135623730951*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt3,3 + j1)))*ZE(gt4,j2)))*(ZA(gt1,2)*ZA(gt2,1) + ZA(gt1,1)*ZA(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZU(gt4,j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) + 4*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gt3,3 + j1))*ZU(gt4,3 + j1))*(-(ZA(gt1,0)*ZA(gt2,0)) + ZA(gt1,1)*ZA(gt2,1)) - 5*(4*(SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3)))*ZA(gt1,1)*ZA(gt2,1) + 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*(ZA(gt1,2)*ZA(gt2,0) + ZA(gt1,0)*ZA(gt2,2)) + 1.4142135623730951*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZU(gt4,j2))*(ZA(gt1,2)*ZA(gt2,0) + ZA(gt1,0)*ZA(gt2,2))));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.5*Sqr(g2)*(ZA(gt1,0)*ZA(gt2,0) + ZA(gt1,1)*ZA(gt2,1) + 4*ZA(gt1,2)*ZA(gt2,2));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*(-(Conj(TLambdax)*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,0)) - 2*Conj(MT)*Lambdax*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,0) + TLambdax*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,0) - Conj(TLambdax)*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,0) + 2*Conj(MT)*Lambdax*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,0) + TLambdax*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,0) - Conj(TLambdax)*ZA(gt1,2)*ZH(gt2,0)*ZH(gt3,1) - 2*Conj(MT)*Lambdax*ZA(gt1,2)*ZH(gt2,0)*ZH(gt3,1) + TLambdax*ZA(gt1,2)*ZH(gt2,0)*ZH(gt3,1) - Conj(TLambdax)*ZA(gt1,0)*ZH(gt2,2)*ZH(gt3,1) + 2*Conj(MT)*Lambdax*ZA(gt1,0)*ZH(gt2,2)*ZH(gt3,1) + TLambdax*ZA(gt1,0)*ZH(gt2,2)*ZH(gt3,1) - 2*Conj(Mu)*Lambdax*ZA(gt1,2)*(ZH(gt2,0)*ZH(gt3,0) + ZH(gt2,1)*ZH(gt3,1)) - Conj(TLambdax)*ZA(gt1,1)*ZH(gt2,0)*ZH(gt3,2) + 2*Conj(MT)*Lambdax*ZA(gt1,1)*ZH(gt2,0)*ZH(gt3,2) + TLambdax*ZA(gt1,1)*ZH(gt2,0)*ZH(gt3,2) - Conj(TLambdax)*ZA(gt1,0)*ZH(gt2,1)*ZH(gt3,2) + 2*Conj(MT)*Lambdax*ZA(gt1,0)*ZH(gt2,1)*ZH(gt3,2) + TLambdax*ZA(gt1,0)*ZH(gt2,1)*ZH(gt3,2) + 2*Conj(Lambdax)*(ZA(gt1,2)*(ZH(gt2,0)*(Mu*ZH(gt3,0) + MT*ZH(gt3,1)) + ZH(gt2,1)*(MT*ZH(gt3,0) + Mu*ZH(gt3,1))) - MT*(ZA(gt1,1)*(ZH(gt2,2)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,2)) + ZA(gt1,0)*(ZH(gt2,2)*ZH(gt3,1) + ZH(gt2,1)*ZH(gt3,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*(ZA(gt1,0)*((AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) - ZP(gt3,0)*ZP(gt4,1)) + 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,2)*(ZP(gt3,2)*ZP(gt4,0) - ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(-ZP(gt4,2) + ZP(gt4,3)))) + ZA(gt1,1)*((AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) - ZP(gt3,0)*ZP(gt4,1)) - 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,2)*(ZP(gt3,2)*ZP(gt4,1) - ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(-ZP(gt4,2) + ZP(gt4,3)))) + ZA(gt1,2)*(4*Sqr(g2)*ZH(gt2,2)*(-(ZP(gt3,3)*ZP(gt4,2)) + ZP(gt3,2)*ZP(gt4,3)) - 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,0)*(ZP(gt3,2)*ZP(gt4,0) + ZP(gt3,3)*ZP(gt4,0) - ZP(gt3,0)*(ZP(gt4,2) + ZP(gt4,3))) - 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,1)*(ZP(gt3,2)*ZP(gt4,1) + ZP(gt3,3)*ZP(gt4,1) - ZP(gt3,1)*(ZP(gt4,2) + ZP(gt4,3)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt3,3 + j1)))*ZD(gt4,j2)))*(ZA(gt1,2)*ZH(gt2,1) + ZA(gt1,1)*ZH(gt2,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt3,3 + j1)))*ZE(gt4,j2)))*(ZA(gt1,2)*ZH(gt2,1) + ZA(gt1,1)*ZH(gt2,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZU(gt4,j2)))*(ZA(gt1,2)*ZH(gt2,0) + ZA(gt1,0)*ZH(gt2,2));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const int gt2261 = indices[0];
   const int gt2262 = indices[1];
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*(2*(-1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZA(gt1,0)*ZP(gt2,0) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZD(gt4,j2))*ZA(gt1,2)*ZP(gt2,0) + 1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gt4,j3))*ZA(gt1,1)*ZP(gt2,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZA(gt1,2)*ZP(gt2,1) + 1.4142135623730951*SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*(-(ZA(gt1,1)*ZP(gt2,0)) + ZA(gt1,0)*ZP(gt2,1)) + 1.4142135623730951*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZD(gt4,j2))*ZA(gt1,0)*ZP(gt2,2) + 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZA(gt1,1)*ZP(gt2,3)) + Sqr(g2)*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZD(gt4,j1))*(1.4142135623730951*ZA(gt1,0)*ZP(gt2,0) - 1.4142135623730951*ZA(gt1,1)*ZP(gt2,1) + 2*ZA(gt1,2)*(ZP(gt2,2) + ZP(gt2,3))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*(-2.8284271247461903*SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZA(gt1,0)*ZP(gt2,0) + 2*Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1)))*(ZA(gt1,2)*ZP(gt2,1) + 1.4142135623730951*ZA(gt1,1)*ZP(gt2,3)) + Sqr(g2)*SUM(j1,0,2,Conj(ZV(gt3,j1))*ZE(gt4,j1))*(1.4142135623730951*ZA(gt1,0)*ZP(gt2,0) - 1.4142135623730951*ZA(gt1,1)*ZP(gt2,1) + 2*ZA(gt1,2)*(ZP(gt2,2) + ZP(gt2,3))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*(vu*Sqr(g2)*ZA(gt1,0)*ZP(gt2,1)*ZP(gt3,0) + vd*Sqr(g2)*ZA(gt1,1)*ZP(gt2,1)*ZP(gt3,0) + 2*Conj(TLambdax)*ZA(gt1,2)*ZP(gt2,1)*ZP(gt3,0) + 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,0)*ZP(gt2,2)*ZP(gt3,0) - 1.4142135623730951*vd*Sqr(g2)*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,0) - 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,0)*ZP(gt2,3)*ZP(gt3,0) + 2.8284271247461903*Conj(TLambdax)*ZA(gt1,1)*ZP(gt2,3)*ZP(gt3,0) - 1.4142135623730951*vd*Sqr(g2)*ZA(gt1,2)*ZP(gt2,3)*ZP(gt3,0) - vu*Sqr(g2)*ZA(gt1,0)*ZP(gt2,0)*ZP(gt3,1) - vd*Sqr(g2)*ZA(gt1,1)*ZP(gt2,0)*ZP(gt3,1) + 4*Conj(MT)*Lambdax*ZA(gt1,2)*ZP(gt2,0)*ZP(gt3,1) - 2*TLambdax*ZA(gt1,2)*ZP(gt2,0)*ZP(gt3,1) + 2.8284271247461903*TLambdax*ZA(gt1,0)*ZP(gt2,2)*ZP(gt3,1) - 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1) - 1.4142135623730951*vu*Sqr(g2)*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1) + 5.656854249492381*Conj(MT)*Lambdax*ZA(gt1,0)*ZP(gt2,3)*ZP(gt3,1) + 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,1)*ZP(gt2,3)*ZP(gt3,1) - 1.4142135623730951*vu*Sqr(g2)*ZA(gt1,2)*ZP(gt2,3)*ZP(gt3,1) - 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,0)*ZP(gt2,0)*ZP(gt3,2) - 5.656854249492381*Conj(MT)*Lambdax*ZA(gt1,1)*ZP(gt2,0)*ZP(gt3,2) + 1.4142135623730951*vd*Sqr(g2)*ZA(gt1,2)*ZP(gt2,0)*ZP(gt3,2) - 2.8284271247461903*Conj(TLambdax)*ZA(gt1,0)*ZP(gt2,1)*ZP(gt3,2) + 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,1)*ZP(gt2,1)*ZP(gt3,2) + 1.4142135623730951*vu*Sqr(g2)*ZA(gt1,2)*ZP(gt2,1)*ZP(gt3,2) - 4*vT*Sqr(g2)*ZA(gt1,2)*ZP(gt2,3)*ZP(gt3,2) + 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,0)*ZP(gt2,0)*ZP(gt3,3) - 2.8284271247461903*TLambdax*ZA(gt1,1)*ZP(gt2,0)*ZP(gt3,3) + 1.4142135623730951*vd*Sqr(g2)*ZA(gt1,2)*ZP(gt2,0)*ZP(gt3,3) - 1.4142135623730951*vT*Sqr(g2)*ZA(gt1,1)*ZP(gt2,1)*ZP(gt3,3) + 1.4142135623730951*vu*Sqr(g2)*ZA(gt1,2)*ZP(gt2,1)*ZP(gt3,3) + 4*vT*Sqr(g2)*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,3) - 2*Conj(Mu)*Lambdax*(ZA(gt1,2)*(ZP(gt2,0)*ZP(gt3,0) + ZP(gt2,1)*ZP(gt3,1)) + 1.4142135623730951*(ZA(gt1,0)*(-(ZP(gt2,2)*ZP(gt3,0)) + ZP(gt2,0)*ZP(gt3,3)) + ZA(gt1,1)*(-(ZP(gt2,2)*ZP(gt3,1)) + ZP(gt2,1)*ZP(gt3,3)))) + Conj(Lambdax)*(ZA(gt1,0)*(-1.4142135623730951*vT*Lambdax*ZP(gt2,2)*ZP(gt3,0) + 1.4142135623730951*vT*Lambdax*ZP(gt2,3)*ZP(gt3,0) + 2.8284271247461903*Mu*ZP(gt2,3)*ZP(gt3,0) - vu*Lambdax*ZP(gt2,0)*ZP(gt3,1) + 1.4142135623730951*vT*Lambdax*ZP(gt2,0)*ZP(gt3,2) - 2.8284271247461903*Mu*ZP(gt2,0)*ZP(gt3,2) - 1.4142135623730951*vT*Lambdax*ZP(gt2,0)*ZP(gt3,3) + ZP(gt2,1)*(vu*Lambdax*ZP(gt3,0) - 5.656854249492381*MT*ZP(gt3,3))) + ZA(gt1,2)*(1.4142135623730951*Lambdax*(ZP(gt2,2) + ZP(gt2,3))*(vd*ZP(gt3,0) + vu*ZP(gt3,1)) + ZP(gt2,0)*(2*Mu*ZP(gt3,0) - 1.4142135623730951*vd*Lambdax*(ZP(gt3,2) + ZP(gt3,3))) - ZP(gt2,1)*(4*MT*ZP(gt3,0) - 2*Mu*ZP(gt3,1) + 1.4142135623730951*vu*Lambdax*(ZP(gt3,2) + ZP(gt3,3)))) + ZA(gt1,1)*(-((vd*Lambdax*ZP(gt2,0) + 1.4142135623730951*(vT*Lambdax - 2*Mu)*ZP(gt2,3))*ZP(gt3,1)) + 1.4142135623730951*ZP(gt2,2)*(4*MT*ZP(gt3,0) + vT*Lambdax*ZP(gt3,1)) + ZP(gt2,1)*(vd*Lambdax*ZP(gt3,0) + 1.4142135623730951*(-((vT*Lambdax + 2*Mu)*ZP(gt3,2)) + vT*Lambdax*ZP(gt3,3))))));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*g2*(0.7745966692414834*g1*Cos(ThetaW)*ZA(gt1,0)*ZP(gt2,0) + 0.7745966692414834*g1*Cos(ThetaW)*ZA(gt1,1)*ZP(gt2,1) + 1.4142135623730951*g2*Sin(ThetaW)*ZA(gt1,2)*(ZP(gt2,2) - ZP(gt2,3)));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*g2*(0.7745966692414834*g1*Sin(ThetaW)*ZA(gt1,0)*ZP(gt2,0) + 0.7745966692414834*g1*Sin(ThetaW)*ZA(gt1,1)*ZP(gt2,1) + 1.4142135623730951*g2*Cos(ThetaW)*ZA(gt1,2)*(-ZP(gt2,2) + ZP(gt2,3)));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*g2*(ZA(gt1,0)*ZP(gt2,0) + ZA(gt1,1)*ZP(gt2,1) + 1.4142135623730951*ZA(gt1,2)*(ZP(gt2,2) - ZP(gt2,3)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*(2*(-1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gt4,j3))*ZA(gt1,0)*ZP(gt3,0) - Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZA(gt1,2)*ZP(gt3,0) + 1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3))*ZA(gt1,1)*ZP(gt3,1) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZU(gt4,j2))*ZA(gt1,2)*ZP(gt3,1) + 1.4142135623730951*SUM(j3,0,2,Conj(ZD(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2)))*(-(ZA(gt1,1)*ZP(gt3,0)) + ZA(gt1,0)*ZP(gt3,1)) + 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZA(gt1,0)*ZP(gt3,2) + 1.4142135623730951*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZU(gt4,j2))*ZA(gt1,1)*ZP(gt3,3)) + Sqr(g2)*SUM(j1,0,2,Conj(ZD(gt2,j1))*ZU(gt4,j1))*(1.4142135623730951*ZA(gt1,0)*ZP(gt3,0) - 1.4142135623730951*ZA(gt1,1)*ZP(gt3,1) + 2*ZA(gt1,2)*(ZP(gt3,2) + ZP(gt3,3))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(2*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,ZD(gt3,3 + j1)*TYd(j1,j2)))*ZA(gt1,0) - 2*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gt2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gt3,j2))*ZA(gt1,0) + vT*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZA(gt1,1) + 2*Conj(Mu)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZA(gt1,1) - vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZA(gt1,1) - 2*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZA(gt1,1) + vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZA(gt1,2) - vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZA(gt1,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*(-2.8284271247461903*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gt4,j3))*ZA(gt1,0)*ZP(gt3,0) + 2*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZV(gt4,j2))*(ZA(gt1,2)*ZP(gt3,1) + 1.4142135623730951*ZA(gt1,1)*ZP(gt3,3)) + Sqr(g2)*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZV(gt4,j1))*(1.4142135623730951*ZA(gt1,0)*ZP(gt3,0) - 1.4142135623730951*ZA(gt1,1)*ZP(gt3,1) + 2*ZA(gt1,2)*(ZP(gt3,2) + ZP(gt3,3))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(2*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 + j1)*TYe(j1,j2)))*ZA(gt1,0) - 2*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gt3,j2))*ZA(gt1,0) + vT*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZA(gt1,1) + 2*Conj(Mu)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZA(gt1,1) - vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZA(gt1,1) - 2*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZA(gt1,1) + vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZA(gt1,2) - vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZA(gt1,2));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(2*Conj(Mu)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*ZA(gt1,0) - vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*ZA(gt1,0) - 2*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*ZA(gt1,0) + 2*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZU(gt3,3 + j1)*TYu(j1,j2)))*ZA(gt1,1) - 2*SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gt3,j2))*ZA(gt1,1) - vd*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*ZA(gt1,2) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*(vT*ZA(gt1,0) + vd*ZA(gt1,2)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0,0.5)*(Conj(UM(gt2,2))*(-1.4142135623730951*Conj(UP(gt1,1))*Lambdax*ZA(gt3,0) + 2*g2*Conj(UP(gt1,0))*ZA(gt3,2)) + g2*Conj(UM(gt2,0))*(1.4142135623730951*Conj(UP(gt1,1))*ZA(gt3,1) - 2*Conj(UP(gt1,2))*ZA(gt3,2)) + Conj(UM(gt2,1))*(1.4142135623730951*g2*Conj(UP(gt1,0))*ZA(gt3,0) + 1.4142135623730951*Conj(UP(gt1,2))*Lambdax*ZA(gt3,1) + Conj(UP(gt1,1))*Lambdax*ZA(gt3,2)));

   const std::complex<double> right = std::complex<double>(0,-0.5)*(-1.4142135623730951*Conj(Lambdax)*UM(gt1,2)*UP(gt2,1)*ZA(gt3,0) + UM(gt1,1)*(1.4142135623730951*g2*UP(gt2,0)*ZA(gt3,0) + Conj(Lambdax)*(1.4142135623730951*UP(gt2,2)*ZA(gt3,1) + UP(gt2,1)*ZA(gt3,2))) + g2*(2*UM(gt1,2)*UP(gt2,0)*ZA(gt3,2) + UM(gt1,0)*(1.4142135623730951*UP(gt2,1)*ZA(gt3,1) - 2*UP(gt2,2)*ZA(gt3,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = Conj(UM(gt2,2))*(-(Conj(ZN(gt1,2))*Lambdax*ZP(gt3,1)) + 1.4142135623730951*g2*Conj(ZN(gt1,1))*ZP(gt3,2)) - g2*Conj(UM(gt2,0))*(Conj(ZN(gt1,2))*ZP(gt3,0) + 1.4142135623730951*Conj(ZN(gt1,4))*ZP(gt3,2)) + Conj(UM(gt2,1))*(0.5477225575051661*g1*Conj(ZN(gt1,0))*ZP(gt3,0) + 0.7071067811865475*g2*Conj(ZN(gt1,1))*ZP(gt3,0) + 0.7071067811865475*Conj(ZN(gt1,4))*Lambdax*ZP(gt3,1) + Conj(ZN(gt1,3))*Lambdax*ZP(gt3,3));

   const std::complex<double> right = 0.5*(-1.4142135623730951*UP(gt2,1)*(0.7745966692414834*g1*ZN(gt1,0) + g2*ZN(gt1,1))*ZP(gt3,1) + Conj(Lambdax)*(2*UP(gt2,2)*ZN(gt1,3)*ZP(gt3,0) + UP(gt2,1)*(1.4142135623730951*ZN(gt1,4)*ZP(gt3,0) - 2*ZN(gt1,2)*ZP(gt3,2))) - 2*g2*(1.4142135623730951*UP(gt2,2)*ZN(gt1,1)*ZP(gt3,3) + UP(gt2,0)*(ZN(gt1,3)*ZP(gt3,1) - 1.4142135623730951*ZN(gt1,4)*ZP(gt3,3))));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = -0.5*g2*(2*Conj(UM(gt2,0))*ZN(gt1,1) + 1.4142135623730951*Conj(UM(gt2,1))*ZN(gt1,2) + 2*Conj(UM(gt2,2))*ZN(gt1,4));

   const std::complex<double> right = -(g2*Conj(ZN(gt1,1))*UP(gt2,0)) + 0.7071067811865475*g2*Conj(ZN(gt1,3))*UP(gt2,1) - g2*Conj(ZN(gt1,4))*UP(gt2,2);
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0,0.1)*(5*g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,2))*ZA(gt3,0) + 5*Conj(ZN(gt1,4))*Conj(ZN(gt2,3))*Lambdax*ZA(gt3,0) + 5*Conj(ZN(gt1,3))*Conj(ZN(gt2,4))*Lambdax*ZA(gt3,0) + 3.872983346207417*g1*Conj(ZN(gt1,3))*Conj(ZN(gt2,0))*ZA(gt3,1) - 5*g2*Conj(ZN(gt1,3))*Conj(ZN(gt2,1))*ZA(gt3,1) - 5*g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,3))*ZA(gt3,1) + 5*Conj(ZN(gt1,4))*Conj(ZN(gt2,2))*Lambdax*ZA(gt3,1) + 3.872983346207417*g1*Conj(ZN(gt1,0))*(-(Conj(ZN(gt2,2))*ZA(gt3,0)) + Conj(ZN(gt2,3))*ZA(gt3,1)) + 5*Conj(ZN(gt1,3))*Conj(ZN(gt2,2))*Lambdax*ZA(gt3,2) + Conj(ZN(gt1,2))*(-3.872983346207417*g1*Conj(ZN(gt2,0))*ZA(gt3,0) + 5*(g2*Conj(ZN(gt2,1))*ZA(gt3,0) + Conj(ZN(gt2,4))*Lambdax*ZA(gt3,1) + Conj(ZN(gt2,3))*Lambdax*ZA(gt3,2))));

   const std::complex<double> right = std::complex<double>(0,-0.5)*(Conj(Lambdax)*ZA(gt3,2)*(ZN(gt1,3)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,3)) + ZA(gt3,0)*(ZN(gt1,2)*(-0.7745966692414834*g1*ZN(gt2,0) + g2*ZN(gt2,1)) - 0.7745966692414834*g1*ZN(gt1,0)*ZN(gt2,2) + g2*ZN(gt1,1)*ZN(gt2,2) + Conj(Lambdax)*ZN(gt1,4)*ZN(gt2,3) + Conj(Lambdax)*ZN(gt1,3)*ZN(gt2,4)) + ZA(gt3,1)*(ZN(gt1,3)*(0.7745966692414834*g1*ZN(gt2,0) - g2*ZN(gt2,1)) + (0.7745966692414834*g1*ZN(gt1,0) - g2*ZN(gt1,1))*ZN(gt2,3) + Conj(Lambdax)*(ZN(gt1,4)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,4))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = 0.5*(-(g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,2))*ZH(gt3,0)) + Conj(ZN(gt1,4))*Conj(ZN(gt2,3))*Lambdax*ZH(gt3,0) + Conj(ZN(gt1,3))*Conj(ZN(gt2,4))*Lambdax*ZH(gt3,0) - 0.7745966692414834*g1*Conj(ZN(gt1,3))*Conj(ZN(gt2,0))*ZH(gt3,1) + g2*Conj(ZN(gt1,3))*Conj(ZN(gt2,1))*ZH(gt3,1) + g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,3))*ZH(gt3,1) + Conj(ZN(gt1,4))*Conj(ZN(gt2,2))*Lambdax*ZH(gt3,1) + 0.7745966692414834*g1*Conj(ZN(gt1,0))*(Conj(ZN(gt2,2))*ZH(gt3,0) - Conj(ZN(gt2,3))*ZH(gt3,1)) + Conj(ZN(gt1,3))*Conj(ZN(gt2,2))*Lambdax*ZH(gt3,2) + Conj(ZN(gt1,2))*(0.7745966692414834*g1*Conj(ZN(gt2,0))*ZH(gt3,0) - g2*Conj(ZN(gt2,1))*ZH(gt3,0) + Conj(ZN(gt2,4))*Lambdax*ZH(gt3,1) + Conj(ZN(gt2,3))*Lambdax*ZH(gt3,2)));

   const std::complex<double> right = 0.5*(Conj(Lambdax)*ZH(gt3,2)*(ZN(gt1,3)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,3)) + ZH(gt3,0)*(ZN(gt1,2)*(0.7745966692414834*g1*ZN(gt2,0) - g2*ZN(gt2,1)) + 0.7745966692414834*g1*ZN(gt1,0)*ZN(gt2,2) - g2*ZN(gt1,1)*ZN(gt2,2) + Conj(Lambdax)*ZN(gt1,4)*ZN(gt2,3) + Conj(Lambdax)*ZN(gt1,3)*ZN(gt2,4)) + ZH(gt3,1)*(ZN(gt1,3)*(-0.7745966692414834*g1*ZN(gt2,0) + g2*ZN(gt2,1)) + (-0.7745966692414834*g1*ZN(gt1,0) + g2*ZN(gt1,1))*ZN(gt2,3) + Conj(Lambdax)*(ZN(gt1,4)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,4))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-2*AbsSqr(Lambdax)*ZH(gt1,2)*(ZH(gt2,2)*(ZH(gt3,0)*ZH(gt4,0) + ZH(gt3,1)*ZH(gt4,1)) + ZH(gt2,0)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + ZH(gt2,1)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2))) + ZH(gt1,1)*((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt2,0)*(ZH(gt3,1)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,1)) - 2*AbsSqr(Lambdax)*ZH(gt2,2)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2)) + ZH(gt2,1)*((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - 3*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) - 2*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2))) - ZH(gt1,0)*(-((-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt2,1)*(ZH(gt3,1)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,1))) + 2*AbsSqr(Lambdax)*ZH(gt2,2)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + ZH(gt2,0)*(3*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - (-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) + 2*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZH(gt2,0)*(3*vd*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) - vu*(-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) + 2*(Conj(Mu)*Lambdax + Conj(Lambdax)*(vT*Lambdax + Mu))*ZH(gt3,2)) - ZH(gt2,1)*(vu*(-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) + vd*(-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) + (2*MT*Conj(Lambdax) + Conj(TLambdax) + 2*Conj(MT)*Lambdax + TLambdax)*ZH(gt3,2)) + ZH(gt2,2)*(2*Conj(Mu)*Lambdax*ZH(gt3,0) - (Conj(TLambdax) + 2*Conj(MT)*Lambdax + TLambdax)*ZH(gt3,1) + 2*Conj(Lambdax)*((vT*Lambdax + Mu)*ZH(gt3,0) - MT*ZH(gt3,1) + vd*Lambdax*ZH(gt3,2))))) + ZH(gt1,1)*(ZH(gt2,1)*(vd*(-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) - 3*vu*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) - 2*(Conj(Mu)*Lambdax + Conj(Lambdax)*(vT*Lambdax + Mu))*ZH(gt3,2)) + ZH(gt2,0)*(vu*(-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) + vd*(-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) + (2*MT*Conj(Lambdax) + Conj(TLambdax) + 2*Conj(MT)*Lambdax + TLambdax)*ZH(gt3,2)) + ZH(gt2,2)*(Conj(TLambdax)*ZH(gt3,0) + 2*Conj(MT)*Lambdax*ZH(gt3,0) + TLambdax*ZH(gt3,0) - 2*Conj(Mu)*Lambdax*ZH(gt3,1) + 2*Conj(Lambdax)*(MT*ZH(gt3,0) - (vT*Lambdax + Mu)*ZH(gt3,1) - vu*Lambdax*ZH(gt3,2)))) - ZH(gt1,2)*(-((Conj(TLambdax) + 2*Conj(MT)*Lambdax + TLambdax)*(ZH(gt2,1)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,1))) + 2*Conj(Mu)*Lambdax*(ZH(gt2,0)*ZH(gt3,0) + ZH(gt2,1)*ZH(gt3,1)) + 2*Conj(Lambdax)*(Lambdax*ZH(gt2,2)*(vd*ZH(gt3,0) + vu*ZH(gt3,1)) + ZH(gt2,0)*((vT*Lambdax + Mu)*ZH(gt3,0) - MT*ZH(gt3,1) + vd*Lambdax*ZH(gt3,2)) + ZH(gt2,1)*(-(MT*ZH(gt3,0)) + (vT*Lambdax + Mu)*ZH(gt3,1) + vu*Lambdax*ZH(gt3,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,1)*((AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) + 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,2)*(ZP(gt3,2)*ZP(gt4,1) - ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(ZP(gt4,2) - ZP(gt4,3))) + ZH(gt2,1)*((4*AbsSqr(Lambdax) - 0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1) + 2*Sqr(g2)*ZP(gt3,2)*ZP(gt4,2) + 4*AbsSqr(Lambdax)*ZP(gt3,3)*ZP(gt4,3) - 2*Sqr(g2)*ZP(gt3,3)*ZP(gt4,3)))) - ZH(gt1,0)*((AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) + 1.4142135623730951*(-AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,2)*(ZP(gt3,2)*ZP(gt4,0) - ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(ZP(gt4,2) - ZP(gt4,3))) + ZH(gt2,0)*((0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (4*AbsSqr(Lambdax) - 0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1) + 4*AbsSqr(Lambdax)*ZP(gt3,2)*ZP(gt4,2) - 2*Sqr(g2)*ZP(gt3,2)*ZP(gt4,2) + 2*Sqr(g2)*ZP(gt3,3)*ZP(gt4,3))) - ZH(gt1,2)*(Sqr(g2)*(1.4142135623730951*ZH(gt2,0)*(ZP(gt3,2)*ZP(gt4,0) - ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(ZP(gt4,2) - ZP(gt4,3))) + 1.4142135623730951*ZH(gt2,1)*(ZP(gt3,2)*ZP(gt4,1) - ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(ZP(gt4,2) - ZP(gt4,3))) + 4*ZH(gt2,2)*(ZP(gt3,2) - ZP(gt3,3))*(ZP(gt4,2) - ZP(gt4,3))) + AbsSqr(Lambdax)*(2*ZH(gt2,2)*(ZP(gt3,0)*ZP(gt4,0) + ZP(gt3,1)*ZP(gt4,1)) + 1.4142135623730951*(ZH(gt2,0)*(-(ZP(gt3,2)*ZP(gt4,0)) + ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*(-ZP(gt4,2) + ZP(gt4,3))) + ZH(gt2,1)*(-(ZP(gt3,2)*ZP(gt4,1)) + ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*(-ZP(gt4,2) + ZP(gt4,3)))))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gt3,j1))*ZD(gt4,j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gt3,3 + j1))*ZD(gt4,3 + j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 5*(-4*SUM(j3,0,2,Conj(ZD(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*ZH(gt1,0)*ZH(gt2,0) - 4*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZH(gt1,0)*ZH(gt2,0) + 1.4142135623730951*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt3,3 + j1)))*ZD(gt4,j2)))*(ZH(gt1,2)*ZH(gt2,1) + ZH(gt1,1)*ZH(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(-((3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gt3,j1))*ZE(gt4,j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1))) + 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt3,3 + j1))*ZE(gt4,3 + j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 5*(-4*SUM(j3,0,2,Conj(ZE(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt4,3 + j2)))*ZH(gt1,0)*ZH(gt2,0) - 4*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZH(gt1,0)*ZH(gt2,0) + 1.4142135623730951*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt3,3 + j1)))*ZE(gt4,j2)))*(ZH(gt1,2)*ZH(gt2,1) + ZH(gt1,1)*ZH(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZU(gt4,j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 4*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gt3,3 + j1))*ZU(gt4,3 + j1))*(-(ZH(gt1,0)*ZH(gt2,0)) + ZH(gt1,1)*ZH(gt2,1)) + 5*(-4*(SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3)))*ZH(gt1,1)*ZH(gt2,1) + 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*(ZH(gt1,2)*ZH(gt2,0) + ZH(gt1,0)*ZH(gt2,2)) + 1.4142135623730951*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZU(gt4,j2))*(ZH(gt1,2)*ZH(gt2,0) + ZH(gt1,0)*ZH(gt2,2))));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.5*Sqr(g2)*(ZH(gt1,0)*ZH(gt2,0) + ZH(gt1,1)*ZH(gt2,1) + 4*ZH(gt1,2)*ZH(gt2,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(Sqr(g2)*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZD(gt4,j1))*(1.4142135623730951*ZH(gt1,0)*ZP(gt2,0) + 1.4142135623730951*ZH(gt1,1)*ZP(gt2,1) + 2*ZH(gt1,2)*(ZP(gt2,2) - ZP(gt2,3)))) + 2*(1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZH(gt1,0)*ZP(gt2,0) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZD(gt4,j2))*ZH(gt1,2)*ZP(gt2,0) + 1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gt4,j3))*ZH(gt1,1)*ZP(gt2,1) - Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZH(gt1,2)*ZP(gt2,1) + 1.4142135623730951*SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*(ZH(gt1,1)*ZP(gt2,0) + ZH(gt1,0)*ZP(gt2,1)) + 1.4142135623730951*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZD(gt4,j2))*ZH(gt1,0)*ZP(gt2,2) - 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZH(gt1,1)*ZP(gt2,3)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(2.8284271247461903*SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZH(gt1,0)*ZP(gt2,0) - Sqr(g2)*SUM(j1,0,2,Conj(ZV(gt3,j1))*ZE(gt4,j1))*(1.4142135623730951*ZH(gt1,0)*ZP(gt2,0) + 1.4142135623730951*ZH(gt1,1)*ZP(gt2,1) + 2*ZH(gt1,2)*(ZP(gt2,2) - ZP(gt2,3))) - 2*Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1)))*(ZH(gt1,2)*ZP(gt2,1) + 1.4142135623730951*ZH(gt1,1)*ZP(gt2,3)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(-(ZH(gt1,0)*(ZP(gt2,1)*(5*vu*(AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vd*(20*AbsSqr(Lambdax) - 3*Sqr(g1) + 5*Sqr(g2))*ZP(gt3,1) + 14.142135623730951*(Conj(TLambdax)*ZP(gt3,2) + 2*MT*Conj(Lambdax)*ZP(gt3,3))) + 5*(ZP(gt2,2)*(1.4142135623730951*(-(vT*AbsSqr(Lambdax)) + 2*Conj(Mu)*Lambdax + vT*Sqr(g2))*ZP(gt3,0) + 2.8284271247461903*TLambdax*ZP(gt3,1) - 2*vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,2)) + ZP(gt2,3)*(1.4142135623730951*(Conj(Lambdax)*(vT*Lambdax + 2*Mu) - vT*Sqr(g2))*ZP(gt3,0) + 5.656854249492381*Conj(MT)*Lambdax*ZP(gt3,1) + 2*vd*Sqr(g2)*ZP(gt3,3))) + ZP(gt2,0)*(vd*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gt3,0) + 5*vu*(AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1) + 7.0710678118654755*((Conj(Lambdax)*(-(vT*Lambdax) + 2*Mu) + vT*Sqr(g2))*ZP(gt3,2) + (vT*AbsSqr(Lambdax) + 2*Conj(Mu)*Lambdax - vT*Sqr(g2))*ZP(gt3,3))))) - 5*ZH(gt1,2)*(-2*Conj(Mu)*Lambdax*ZP(gt2,0)*ZP(gt3,0) - 2*Conj(TLambdax)*ZP(gt2,1)*ZP(gt3,0) + 1.4142135623730951*vd*Sqr(g2)*ZP(gt2,2)*ZP(gt3,0) - 1.4142135623730951*vd*Sqr(g2)*ZP(gt2,3)*ZP(gt3,0) - 4*Conj(MT)*Lambdax*ZP(gt2,0)*ZP(gt3,1) - 2*TLambdax*ZP(gt2,0)*ZP(gt3,1) - 2*Conj(Mu)*Lambdax*ZP(gt2,1)*ZP(gt3,1) + 1.4142135623730951*vu*Sqr(g2)*ZP(gt2,2)*ZP(gt3,1) - 1.4142135623730951*vu*Sqr(g2)*ZP(gt2,3)*ZP(gt3,1) + 1.4142135623730951*vd*Sqr(g2)*ZP(gt2,0)*ZP(gt3,2) + 1.4142135623730951*vu*Sqr(g2)*ZP(gt2,1)*ZP(gt3,2) + 4*vT*Sqr(g2)*ZP(gt2,2)*ZP(gt3,2) - 4*vT*Sqr(g2)*ZP(gt2,3)*ZP(gt3,2) - 1.4142135623730951*vd*Sqr(g2)*ZP(gt2,0)*ZP(gt3,3) - 1.4142135623730951*vu*Sqr(g2)*ZP(gt2,1)*ZP(gt3,3) - 4*vT*Sqr(g2)*ZP(gt2,2)*ZP(gt3,3) + 4*vT*Sqr(g2)*ZP(gt2,3)*ZP(gt3,3) + Conj(Lambdax)*(-1.4142135623730951*Lambdax*(ZP(gt2,2) - ZP(gt2,3))*(vd*ZP(gt3,0) + vu*ZP(gt3,1)) + ZP(gt2,0)*(2*(vT*Lambdax - Mu)*ZP(gt3,0) + 1.4142135623730951*vd*Lambdax*(-ZP(gt3,2) + ZP(gt3,3))) + ZP(gt2,1)*(-4*MT*ZP(gt3,0) + 2*(vT*Lambdax - Mu)*ZP(gt3,1) + 1.4142135623730951*vu*Lambdax*(-ZP(gt3,2) + ZP(gt3,3))))) + ZH(gt1,1)*(-(ZP(gt2,1)*(5*vd*(AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vu*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gt3,1) + 7.0710678118654755*((-(Conj(Lambdax)*(vT*Lambdax + 2*Mu)) + vT*Sqr(g2))*ZP(gt3,2) + (vT*AbsSqr(Lambdax) - 2*Conj(Mu)*Lambdax - vT*Sqr(g2))*ZP(gt3,3)))) + ZP(gt2,0)*(vu*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) - 5*Sqr(g2))*ZP(gt3,0) - 5*vd*(AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1) + 14.142135623730951*(2*Conj(MT)*Lambdax*ZP(gt3,2) + TLambdax*ZP(gt3,3))) + 5*(2.8284271247461903*Conj(TLambdax)*ZP(gt2,3)*ZP(gt3,0) + 2.8284271247461903*Conj(Mu)*Lambdax*ZP(gt2,2)*ZP(gt3,1) - 1.4142135623730951*vT*Sqr(g2)*ZP(gt2,2)*ZP(gt3,1) + 1.4142135623730951*vT*Sqr(g2)*ZP(gt2,3)*ZP(gt3,1) - 2*vu*Sqr(g2)*ZP(gt2,2)*ZP(gt3,2) + 2*vu*Sqr(g2)*ZP(gt2,3)*ZP(gt3,3) + Conj(Lambdax)*(1.4142135623730951*ZP(gt2,2)*(4*MT*ZP(gt3,0) + vT*Lambdax*ZP(gt3,1)) - ZP(gt2,3)*(1.4142135623730951*(vT*Lambdax - 2*Mu)*ZP(gt3,1) + 4*vu*Lambdax*ZP(gt3,3))))));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.5*g2*(0.7745966692414834*g1*Cos(ThetaW)*ZH(gt1,0)*ZP(gt2,0) - 0.7745966692414834*g1*Cos(ThetaW)*ZH(gt1,1)*ZP(gt2,1) + 1.4142135623730951*g2*Sin(ThetaW)*ZH(gt1,2)*(ZP(gt2,2) + ZP(gt2,3)));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.5*g2*(-0.7745966692414834*g1*Sin(ThetaW)*ZH(gt1,0)*ZP(gt2,0) + 0.7745966692414834*g1*Sin(ThetaW)*ZH(gt1,1)*ZP(gt2,1) + 1.4142135623730951*g2*Cos(ThetaW)*ZH(gt1,2)*(ZP(gt2,2) + ZP(gt2,3)));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.5*g2*(ZH(gt1,0)*ZP(gt2,0) - ZH(gt1,1)*ZP(gt2,1) + 1.4142135623730951*ZH(gt1,2)*(ZP(gt2,2) + ZP(gt2,3)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(Sqr(g2)*SUM(j1,0,2,Conj(ZD(gt2,j1))*ZU(gt4,j1))*(1.4142135623730951*ZH(gt1,0)*ZP(gt3,0) + 1.4142135623730951*ZH(gt1,1)*ZP(gt3,1) + 2*ZH(gt1,2)*(ZP(gt3,2) - ZP(gt3,3)))) + 2*(1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gt4,j3))*ZH(gt1,0)*ZP(gt3,0) - Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZH(gt1,2)*ZP(gt3,0) + 1.4142135623730951*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3))*ZH(gt1,1)*ZP(gt3,1) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZU(gt4,j2))*ZH(gt1,2)*ZP(gt3,1) + 1.4142135623730951*SUM(j3,0,2,Conj(ZD(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2)))*(ZH(gt1,1)*ZP(gt3,0) + ZH(gt1,0)*ZP(gt3,1)) + 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZH(gt1,0)*ZP(gt3,2) - 1.4142135623730951*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZU(gt4,j2))*ZH(gt1,1)*ZP(gt3,3)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gt2,j1))*ZD(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gt2,3 + j1))*ZD(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 5*(-2.8284271247461903*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,ZD(gt3,3 + j1)*TYd(j1,j2)))*ZH(gt1,0) - 2.8284271247461903*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gt2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gt3,j2))*ZH(gt1,0) - 4*vd*SUM(j3,0,2,Conj(ZD(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt3,3 + j2)))*ZH(gt1,0) - 4*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt3,j3))*ZH(gt1,0) + 1.4142135623730951*vT*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZH(gt1,1) + 2.8284271247461903*Conj(Mu)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZH(gt1,1) + 1.4142135623730951*vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZH(gt1,1) + 2.8284271247461903*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZH(gt1,1) + 1.4142135623730951*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZH(gt1,2) + 1.4142135623730951*vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZH(gt1,2)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(2.8284271247461903*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gt4,j3))*ZH(gt1,0)*ZP(gt3,0) - Sqr(g2)*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZV(gt4,j1))*(1.4142135623730951*ZH(gt1,0)*ZP(gt3,0) + 1.4142135623730951*ZH(gt1,1)*ZP(gt3,1) + 2*ZH(gt1,2)*(ZP(gt3,2) - ZP(gt3,3))) - 2*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZV(gt4,j2))*(ZH(gt1,2)*ZP(gt3,1) + 1.4142135623730951*ZH(gt1,1)*ZP(gt3,3)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-2.8284271247461903*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 + j1)*TYe(j1,j2)))*ZH(gt1,0) - 2.8284271247461903*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gt3,j2))*ZH(gt1,0) - 4*vd*SUM(j3,0,2,Conj(ZE(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt3,3 + j2)))*ZH(gt1,0) - 4*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt3,j3))*ZH(gt1,0) + 1.4142135623730951*vT*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,1) + 2.8284271247461903*Conj(Mu)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,1) + 1.4142135623730951*vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,1) + 2.8284271247461903*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,1) - 0.2*(3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZE(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 1.2*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 1.4142135623730951*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,2) + 1.4142135623730951*vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,2));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gt2,j1))*ZU(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 4*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1))*(-(vd*ZH(gt1,0)) + vu*ZH(gt1,1)) + 5*(2.8284271247461903*Conj(Mu)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*ZH(gt1,0) + 1.4142135623730951*vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*ZH(gt1,0) + 2.8284271247461903*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*ZH(gt1,0) - 2.8284271247461903*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZU(gt3,3 + j1)*TYu(j1,j2)))*ZH(gt1,1) - 2.8284271247461903*SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gt3,j2))*ZH(gt1,1) - 4*vu*SUM(j3,0,2,Conj(ZU(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt3,3 + j2)))*ZH(gt1,1) - 4*vu*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt3,j3))*ZH(gt1,1) + 1.4142135623730951*vd*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*ZH(gt1,2) + 1.4142135623730951*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*(vT*ZH(gt1,0) + vd*ZH(gt1,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = 0.5*(-(Conj(UM(gt2,2))*(1.4142135623730951*Conj(UP(gt1,1))*Lambdax*ZH(gt3,0) + 2*g2*Conj(UP(gt1,0))*ZH(gt3,2))) + g2*Conj(UM(gt2,0))*(-1.4142135623730951*Conj(UP(gt1,1))*ZH(gt3,1) + 2*Conj(UP(gt1,2))*ZH(gt3,2)) + Conj(UM(gt2,1))*(-1.4142135623730951*g2*Conj(UP(gt1,0))*ZH(gt3,0) + 1.4142135623730951*Conj(UP(gt1,2))*Lambdax*ZH(gt3,1) + Conj(UP(gt1,1))*Lambdax*ZH(gt3,2)));

   const std::complex<double> right = 0.5*(-1.4142135623730951*Conj(Lambdax)*UM(gt1,2)*UP(gt2,1)*ZH(gt3,0) + UM(gt1,1)*(-1.4142135623730951*g2*UP(gt2,0)*ZH(gt3,0) + Conj(Lambdax)*(1.4142135623730951*UP(gt2,2)*ZH(gt3,1) + UP(gt2,1)*ZH(gt3,2))) - g2*(2*UM(gt1,2)*UP(gt2,0)*ZH(gt3,2) + UM(gt1,0)*(1.4142135623730951*UP(gt2,1)*ZH(gt3,1) - 2*UP(gt2,2)*ZH(gt3,2))));
   ...
   const std::array<int, 1>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.5*Sqr(g2)*(vd*ZH(gt1,0) + vu*ZH(gt1,1) + 4*vT*ZH(gt1,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(ZP(gt1,0)*(-2*(0.6*Sqr(g1) + Sqr(g2))*ZP(gt2,0)*ZP(gt3,0)*ZP(gt4,0) + (-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZP(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) - 2*Sqr(g2)*ZP(gt2,2)*(ZP(gt3,2)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,2)) + 2*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt2,3)*(ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,3))) + ZP(gt1,1)*(-2*(0.6*Sqr(g1) + Sqr(g2))*ZP(gt2,1)*ZP(gt3,1)*ZP(gt4,1) + (-2*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZP(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) + 2*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt2,2)*(ZP(gt3,2)*ZP(gt4,1) + ZP(gt3,1)*ZP(gt4,2)) - 2*Sqr(g2)*ZP(gt2,3)*(ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*ZP(gt4,3))) - 2*(ZP(gt1,3)*(-((-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt2,0)*(ZP(gt3,3)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,3))) + Sqr(g2)*(4*ZP(gt2,3)*ZP(gt3,3)*ZP(gt4,3) + ZP(gt2,1)*(ZP(gt3,3)*ZP(gt4,1) + ZP(gt3,1)*ZP(gt4,3)) - 2*ZP(gt2,2)*(ZP(gt3,3)*ZP(gt4,2) + ZP(gt3,2)*ZP(gt4,3)))) + ZP(gt1,2)*(Sqr(g2)*ZP(gt2,0)*(ZP(gt3,2)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,2)) - (-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt2,1)*(ZP(gt3,2)*ZP(gt4,1) + ZP(gt3,1)*ZP(gt4,2)) + 2*Sqr(g2)*(2*ZP(gt2,2)*ZP(gt3,2)*ZP(gt4,2) - ZP(gt2,3)*(ZP(gt3,3)*ZP(gt4,2) + ZP(gt3,2)*ZP(gt4,3))))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gt2,3 + j1))*ZD(gt4,3 + j1))*(ZP(gt1,0)*ZP(gt3,0) - ZP(gt1,1)*ZP(gt3,1)) - 20*(SUM(j3,0,2,Conj(ZD(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*ZP(gt1,0)*ZP(gt3,0) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gt4,j3))*ZP(gt1,1)*ZP(gt3,1) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt4,j2))*ZP(gt1,2)*ZP(gt3,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZP(gt1,1)*ZP(gt3,2)) + SUM(j1,0,2,Conj(ZD(gt2,j1))*ZD(gt4,j1))*((Sqr(g1) - 5*Sqr(g2))*ZP(gt1,0)*ZP(gt3,0) - (Sqr(g1) - 5*Sqr(g2))*ZP(gt1,1)*ZP(gt3,1) + 10*Sqr(g2)*(-(ZP(gt1,2)*ZP(gt3,2)) + ZP(gt1,3)*ZP(gt3,3))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt4,3 + j1))*(ZP(gt1,0)*ZP(gt3,0) - ZP(gt1,1)*ZP(gt3,1)) - 20*(SUM(j3,0,2,Conj(ZE(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt4,3 + j2)))*ZP(gt1,0)*ZP(gt3,0) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt4,j2))*ZP(gt1,2)*ZP(gt3,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1)))*ZP(gt1,1)*ZP(gt3,2)) + SUM(j1,0,2,Conj(ZE(gt2,j1))*ZE(gt4,j1))*(-((3*Sqr(g1) + 5*Sqr(g2))*ZP(gt1,0)*ZP(gt3,0)) + (3*Sqr(g1) + 5*Sqr(g2))*ZP(gt1,1)*ZP(gt3,1) + 10*Sqr(g2)*(-(ZP(gt1,2)*ZP(gt3,2)) + ZP(gt1,3)*ZP(gt3,3))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(-4*(Sqr(g1)*SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt4,3 + j1))*(ZP(gt1,0)*ZP(gt3,0) - ZP(gt1,1)*ZP(gt3,1)) + 5*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gt4,j3))*ZP(gt1,0)*ZP(gt3,0) - Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZP(gt1,3)*ZP(gt3,0) + SUM(j3,0,2,Conj(ZU(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2)))*ZP(gt1,1)*ZP(gt3,1) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt4,j2))*ZP(gt1,0)*ZP(gt3,3))) + SUM(j1,0,2,Conj(ZU(gt2,j1))*ZU(gt4,j1))*((Sqr(g1) + 5*Sqr(g2))*ZP(gt1,0)*ZP(gt3,0) - (Sqr(g1) + 5*Sqr(g2))*ZP(gt1,1)*ZP(gt3,1) + 10*Sqr(g2)*(ZP(gt1,2)*ZP(gt3,2) - ZP(gt1,3)*ZP(gt3,3))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(Sqr(g2)*SUM(j1,0,2,Conj(ZU(gt2,j1))*ZD(gt3,j1))*(1.4142135623730951*vd*ZP(gt1,0) + 1.4142135623730951*vu*ZP(gt1,1) + 2*vT*(ZP(gt1,2) - ZP(gt1,3)))) + 2*(2*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZD(gt3,3 + j1)*TYd(j1,j2)))*ZP(gt1,0) + 1.4142135623730951*vu*SUM(j3,0,2,Conj(ZU(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))*ZD(gt3,3 + j2)))*ZP(gt1,0) + 1.4142135623730951*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt3,j3))*ZP(gt1,0) - vT*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZP(gt1,1) + 2*Conj(Mu)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZP(gt1,1) + 2*SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2)))*ZD(gt3,j2))*ZP(gt1,1) + 1.4142135623730951*vd*SUM(j3,0,2,Conj(ZU(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))*ZD(gt3,3 + j2)))*ZP(gt1,1) + 1.4142135623730951*vu*SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gt3,j3))*ZP(gt1,1) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZD(gt3,j2))*((-(vT*Lambdax) + 2*Mu)*ZP(gt1,0) + 1.4142135623730951*vd*Lambdax*ZP(gt1,2)) - 1.4142135623730951*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZP(gt1,3)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 + j1)*TYe(j1,j2)))*ZP(gt1,0) + 0.7071067811865475*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt3,j3))*ZP(gt1,0) - 0.5*vT*Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZP(gt1,1) + Conj(Mu)*SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZP(gt1,1) - 0.7071067811865475*vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZP(gt1,3) - 0.25*Sqr(g2)*SUM(j1,0,2,Conj(ZV(gt2,j1))*ZE(gt3,j1))*(1.4142135623730951*vd*ZP(gt1,0) + 1.4142135623730951*vu*ZP(gt1,1) + 2*vT*ZP(gt1,2) - 2*vT*ZP(gt1,3));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(Sqr(g2)*SUM(j1,0,2,Conj(ZD(gt1,j1))*ZU(gt3,j1))*(1.4142135623730951*vd*ZP(gt2,0) + 1.4142135623730951*vu*ZP(gt2,1) + 2*vT*ZP(gt2,2) - 2*vT*ZP(gt2,3))) + 2*(2*Conj(Mu)*SUM(j2,0,2,Conj(ZD(gt1,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*ZP(gt2,0) + 2*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gt1,3 + j1))*Conj(TYd(j1,j2)))*ZU(gt3,j2))*ZP(gt2,0) + 1.4142135623730951*vu*SUM(j3,0,2,Conj(ZD(gt1,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gt3,3 + j2)))*ZP(gt2,0) + 1.4142135623730951*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt1,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gt3,j3))*ZP(gt2,0) + 2*SUM(j2,0,2,Conj(ZD(gt1,j2))*SUM(j1,0,2,ZU(gt3,3 + j1)*TYu(j1,j2)))*ZP(gt2,1) - vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt1,3 + j1)))*ZU(gt3,j2))*ZP(gt2,1) + 2*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt1,3 + j1)))*ZU(gt3,j2))*ZP(gt2,1) + 1.4142135623730951*vd*SUM(j3,0,2,Conj(ZD(gt1,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gt3,3 + j2)))*ZP(gt2,1) + 1.4142135623730951*vu*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt1,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt3,j3))*ZP(gt2,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt1,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*(-(vT*ZP(gt2,0)) + 1.4142135623730951*vd*ZP(gt2,2)) - 1.4142135623730951*vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt1,3 + j1)))*ZU(gt3,j2))*ZP(gt2,3)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt1,3 + j1))*Conj(TYe(j1,j2)))*ZV(gt3,j2))*ZP(gt2,0) + 0.7071067811865475*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt1,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gt3,j3))*ZP(gt2,0) - 0.5*vT*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt1,3 + j1)))*ZV(gt3,j2))*ZP(gt2,1) + Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt1,3 + j1)))*ZV(gt3,j2))*ZP(gt2,1) - 0.7071067811865475*vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt1,3 + j1)))*ZV(gt3,j2))*ZP(gt2,3) - 0.25*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gt1,j1))*ZV(gt3,j1))*(1.4142135623730951*vd*ZP(gt2,0) + 1.4142135623730951*vu*ZP(gt2,1) + 2*vT*ZP(gt2,2) - 2*vT*ZP(gt2,3));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = -(g2*Conj(UP(gt1,0))*Sin(ThetaW)*UP(gt2,0)) - 0.5*Conj(UP(gt1,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UP(gt2,1) - g2*Conj(UP(gt1,2))*Sin(ThetaW)*UP(gt2,2);

   const std::complex<double> right = -(g2*Conj(UM(gt2,0))*Sin(ThetaW)*UM(gt1,0)) - 0.5*Conj(UM(gt2,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UM(gt1,1) - g2*Conj(UM(gt2,2))*Sin(ThetaW)*UM(gt1,2);
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = g2*Conj(UP(gt1,0))*ZN(gt2,1) - 0.7071067811865475*g2*Conj(UP(gt1,1))*ZN(gt2,3) + g2*Conj(UP(gt1,2))*ZN(gt2,4);

   const std::complex<double> right = g2*Conj(ZN(gt2,1))*UM(gt1,0) + 0.7071067811865475*g2*Conj(ZN(gt2,2))*UM(gt1,1) + g2*Conj(ZN(gt2,4))*UM(gt1,2);
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = -0.5*g2*(2*Conj(ZN(gt2,1))*UM(gt1,0) + 1.4142135623730951*Conj(ZN(gt2,2))*UM(gt1,1) + 2*Conj(ZN(gt2,4))*UM(gt1,2));

   const std::complex<double> right = -(g2*Conj(UP(gt1,0))*ZN(gt2,1)) + 0.7071067811865475*g2*Conj(UP(gt1,1))*ZN(gt2,3) - g2*Conj(UP(gt1,2))*ZN(gt2,4);
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = -(g2*Conj(UP(gt1,0))*Cos(ThetaW)*UP(gt2,0)) - 0.5*Conj(UP(gt1,1))*(g2*Cos(ThetaW) - 0.7745966692414834*g1*Sin(ThetaW))*UP(gt2,1) - g2*Conj(UP(gt1,2))*Cos(ThetaW)*UP(gt2,2);

   const std::complex<double> right = -(g2*Conj(UM(gt2,0))*Cos(ThetaW)*UM(gt1,0)) - 0.5*Conj(UM(gt2,1))*(g2*Cos(ThetaW) - 0.7745966692414834*g1*Sin(ThetaW))*UM(gt1,1) - g2*Conj(UM(gt2,2))*Cos(ThetaW)*UM(gt1,2);
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = g2*Conj(UM(gt2,0))*Cos(ThetaW)*UM(gt1,0) + 0.5*Conj(UM(gt2,1))*(g2*Cos(ThetaW) - 0.7745966692414834*g1*Sin(ThetaW))*UM(gt1,1) + g2*Conj(UM(gt2,2))*Cos(ThetaW)*UM(gt1,2);

   const std::complex<double> right = g2*Conj(UP(gt1,0))*Cos(ThetaW)*UP(gt2,0) + 0.5*Conj(UP(gt1,1))*(g2*Cos(ThetaW) - 0.7745966692414834*g1*Sin(ThetaW))*UP(gt2,1) + g2*Conj(UP(gt1,2))*Cos(ThetaW)*UP(gt2,2);
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = g2*Conj(UM(gt2,0))*Sin(ThetaW)*UM(gt1,0) + 0.5*Conj(UM(gt2,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UM(gt1,1) + g2*Conj(UM(gt2,2))*Sin(ThetaW)*UM(gt1,2);

   const std::complex<double> right = g2*Conj(UP(gt1,0))*Sin(ThetaW)*UP(gt2,0) + 0.5*Conj(UP(gt1,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UP(gt2,1) + g2*Conj(UP(gt1,2))*Sin(ThetaW)*UP(gt2,2);
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = Conj(UP(gt1,1))*(0.7071067811865475*Conj(ZN(gt2,4))*Lambdax*ZP(gt3,0) - 0.5477225575051661*g1*Conj(ZN(gt2,0))*ZP(gt3,1) - 0.7071067811865475*g2*Conj(ZN(gt2,1))*ZP(gt3,1) - Conj(ZN(gt2,2))*Lambdax*ZP(gt3,2)) + Conj(UP(gt1,2))*(Conj(ZN(gt2,3))*Lambdax*ZP(gt3,0) - 1.4142135623730951*g2*Conj(ZN(gt2,1))*ZP(gt3,3)) + g2*Conj(UP(gt1,0))*(-(Conj(ZN(gt2,3))*ZP(gt3,1)) + 1.4142135623730951*Conj(ZN(gt2,4))*ZP(gt3,3));

   const std::complex<double> right = UM(gt1,2)*(-(Conj(Lambdax)*ZN(gt2,2)*ZP(gt3,1)) + 1.4142135623730951*g2*ZN(gt2,1)*ZP(gt3,2)) - g2*UM(gt1,0)*(ZN(gt2,2)*ZP(gt3,0) + 1.4142135623730951*ZN(gt2,4)*ZP(gt3,2)) + UM(gt1,1)*(0.5477225575051661*g1*ZN(gt2,0)*ZP(gt3,0) + 0.7071067811865475*g2*ZN(gt2,1)*ZP(gt3,0) + 0.7071067811865475*Conj(Lambdax)*ZN(gt2,4)*ZP(gt3,1) + Conj(Lambdax)*ZN(gt2,3)*ZP(gt3,3));
   ...
   const std::array<int, 1>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.25*Sqr(g2)*(vd*ZH(gt3,0) + vu*ZH(gt3,1) + 4*vT*ZH(gt3,2));
