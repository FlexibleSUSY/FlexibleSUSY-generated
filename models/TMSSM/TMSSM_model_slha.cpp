...
TMSSM_slha::TMSSM_slha(const TMSSM_input_parameters& input_,
 ...
 */
TMSSM_slha::TMSSM_slha(const TMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : TMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void TMSSM_slha::clear()
{
   TMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void TMSSM_slha::calculate_spectrum()
{
   TMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void TMSSM_slha::convert_to_slha()
{
...
void TMSSM_slha::calculate_ckm_matrix()
{
...
void TMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void TMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void TMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void TMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const TMSSM_physical& TMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

TMSSM_physical& TMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void TMSSM_slha::print(std::ostream& ostr) const
{
   TMSSM_mass_eigenstates::print(ostr);
...
void TMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const TMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
