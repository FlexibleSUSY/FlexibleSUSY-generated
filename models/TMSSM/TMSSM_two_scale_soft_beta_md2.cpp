 ...
 */
Eigen::Matrix<double,3,3> TMSSM_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> TMSSM_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = (twoLoop*(-12*traceconjTYdTpTYd*(Yd*Yd.adjoint()) - 4*
      ...
      12*mHd2*AbsSqr(Lambdax)*(Yd*Yd.adjoint()) - 6*mHu2*AbsSqr(Lambdax)*(Yd*
      Yd.adjoint()) - 6*mT2*AbsSqr(Lambdax)*(Yd*Yd.adjoint()) - 6*AbsSqr(
      ...
      (Yd*(TYd).adjoint()) - 6*Conj(Lambdax)*TLambdax*(Yd*(TYd).adjoint()) - 12
      *traceconjTYdTpYd*(TYd*Yd.adjoint()) - 4*traceconjTYeTpYe*(TYd*Yd.adjoint
      ()) - 6*Conj(TLambdax)*Lambdax*(TYd*Yd.adjoint()) - 12*Conj(MassWB)*Sqr(
      g2)*(TYd*Yd.adjoint()) - 12*traceYdAdjYd*(TYd*(TYd).adjoint()) - 4*
      traceYeAdjYe*(TYd*(TYd).adjoint()) - 6*AbsSqr(Lambdax)*(TYd*(TYd).adjoint
      ()) + 0.8*Sqr(g1)*(TYd*(TYd).adjoint()) + 12*Sqr(g2)*(TYd*(TYd).adjoint()
      ) - 6*traceYdAdjYd*(md2*Yd*Yd.adjoint()) - 2*traceYeAdjYe*(md2*Yd*
      Yd.adjoint()) - 3*AbsSqr(Lambdax)*(md2*Yd*Yd.adjoint()) + 0.4*Sqr(g1)*(
      md2*Yd*Yd.adjoint()) + 6*Sqr(g2)*(md2*Yd*Yd.adjoint()) - 12*traceYdAdjYd*
      (Yd*mq2*Yd.adjoint()) - 4*traceYeAdjYe*(Yd*mq2*Yd.adjoint()) - 6*AbsSqr(
      Lambdax)*(Yd*mq2*Yd.adjoint()) + 0.8*Sqr(g1)*(Yd*mq2*Yd.adjoint()) + 12*
      Sqr(g2)*(Yd*mq2*Yd.adjoint()) - 6*traceYdAdjYd*(Yd*Yd.adjoint()*md2) - 2*
      traceYeAdjYe*(Yd*Yd.adjoint()*md2) - 3*AbsSqr(Lambdax)*(Yd*Yd.adjoint()*
 ...
 */
Eigen::Matrix<double,3,3> TMSSM_soft_parameters::calc_beta_md2_three_loop(const Soft_traces& soft_traces) const
{
