...
// File generated at Mon 23 Feb 2015 12:27:26
...
TMSSM_low_scale_constraint<Two_scale>::TMSSM_low_scale_constraint(
   ...
   const TMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void TMSSM_low_scale_constraint<Two_scale>::set_input_parameters(const TMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
