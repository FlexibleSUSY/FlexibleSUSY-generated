...
// File generated at Fri 26 Jun 2015 18:58:11
...
double TMSSM_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   ...
   const double delta_alpha_em = 0.15915494309189535*alphaEm*(
      ...
      *FiniteLog(Abs(MCha(2)/currentScale)) - 0.3333333333333333*FiniteLog(Abs(
      MHpm(1)/currentScale)) - 0.3333333333333333*FiniteLog(Abs(MHpm(2)
      /currentScale)) - 0.3333333333333333*FiniteLog(Abs(MHpm(3)/currentScale)) -
