...
// File generated at Mon 27 Feb 2017 13:28:14
...
{
   assert(model && "Error: TMSSM_low_scale_constraint::apply():"
...
void TMSSM_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
...
{
   assert(model && "TMSSM_low_scale_constraint<Two_scale>::"
...
double TMSSM_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "TMSSM_low_scale_constraint<Two_scale>::"
 ...
 */
double TMSSM_low_scale_constraint<Two_scale>::recalculate_mw_pole(double mw_pole)
{
   assert(model && "TMSSM_low_scale_constraint<Two_scale>::"
   ...
   if (mw_pole_sqr < 0.)
      MODEL->get_problems().flag_tachyon(TMSSM_info::VWm);
