...
// File generated at Tue 10 Oct 2017 21:53:16
...
double TMSSM_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   ...
   const double delta_alpha_em = 0.15915494309189535*alphaEm*(
      ...
      1.3333333333333333*FiniteLog(Abs(MCha(2)/currentScale)) - 0.3333333333333333
      *FiniteLog(Abs(MHpm(1)/currentScale)) - 0.3333333333333333*FiniteLog(Abs(
      MHpm(2)/currentScale)) - 0.3333333333333333*FiniteLog(Abs(MHpm(3)
...
void TMSSM_low_scale_constraint<Two_scale>::calculate_MNeutrino_DRbar()
{
   neutrinoDRbar.setZero();
