...
// File generated at Tue 7 Jul 2015 12:08:55
...
TMSSM_low_scale_constraint<Two_scale>::TMSSM_low_scale_constraint(
   TMSSM<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void TMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& TMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
 ...
 */
void TMSSM_low_scale_constraint<Two_scale>::recalculate_mw_pole()
{
   assert(model && "TMSSM_low_scale_constraint<Two_scale>::"
