...
TMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBTMSSM_SRC += \
		$(DIR)/TMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/TMSSM_two_scale_ewsb_solver.cpp \
...
LIBTMSSM_HDR += \
		...
		$(DIR)/TMSSM_two_scale_spectrum_generator.hpp \
