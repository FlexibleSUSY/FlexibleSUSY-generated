...
int run_solver(const TMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(TMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const TMSSM_input_parameters& input)
{
   int exit_code = 0;
