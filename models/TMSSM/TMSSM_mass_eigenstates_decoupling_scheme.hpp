...
/**
 * @file TMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef TMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define TMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class TMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class TMSSM_mass_eigenstates_decoupling_scheme
   : private TMSSM_soft_parameters
   , public TMSSM_mass_eigenstates_interface
{
public:
   explicit TMSSM_mass_eigenstates_decoupling_scheme(const TMSSM_input_parameters& input_ = TMSSM_input_parameters());
   explicit TMSSM_mass_eigenstates_decoupling_scheme(const TMSSM_mass_eigenstates&);
   TMSSM_mass_eigenstates_decoupling_scheme(const TMSSM_mass_eigenstates_decoupling_scheme&) = default;
   TMSSM_mass_eigenstates_decoupling_scheme(TMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~TMSSM_mass_eigenstates_decoupling_scheme() = default;
   TMSSM_mass_eigenstates_decoupling_scheme& operator=(const TMSSM_mass_eigenstates_decoupling_scheme&) = default;
   TMSSM_mass_eigenstates_decoupling_scheme& operator=(TMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const TMSSM_mass_eigenstates&);
...
private:
   ...
   Problems problems{TMSSM_info::model_name,
...
std::ostream& operator<<(std::ostream&, const TMSSM_mass_eigenstates_decoupling_scheme&);
