...
public:
   ...
   TMSSM_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const TMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   TMSSM_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
private:
   ...
   double calc_beta_MT_three_loop(const TRACE_STRUCT_TYPE&) const;
