...
#define CLASSNAME TMSSM_weinberg_angle
 ...
 */
CLASSNAME::TMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const TMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * TMSSM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * TMSSM_info::normalization_g2;
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-
         ...
         ,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZA(2,1)))) - RHO2(Mhh(0)/MT)*(Sqr(Abs((SUM(j2,0
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-0.224
         ...
         Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1
         ))*ZUL(2,j2)))*ZA(2,1)))) - RHO2(Mhh(0)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,
         j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
         ...
         2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1
         ,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZH(1,1)))) - RHO2(Mhh(2)/MT)*(
         Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) -
         SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZH(2,1))) - Sqr
         (Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) +
         SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZH(2,1))))));   }
...
std::complex<double> CLASSNAME::delta_vb_wave_Fv(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,2,SUM(gI2,0,5,-(AbsSqr(
      ...
      )),Sqr(MSv(gI2)))))) + SUM(gI1,1,3,SUM(gI2,0,2,-(AbsSqr(CpbarFeFvHpmPL(gI2,
...
std::complex<double> CLASSNAME::delta_vb_wave_Fe(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,2,SUM(gI2,0,2,-(AbsSqr(
      ...
      ,Sqr(Mhh(gI1)))))) + SUM(gI1,0,2,SUM(gI2,1,3,-(AbsSqr(CpbarFvFeconjHpmPL(gI1
...
std::complex<double> CLASSNAME::delta_vb_vertex(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = (SUM(gI1,0,2,SUM(gI2,0,4,SUM(gI3,0,5,
      ...
      MChi(gI3)))))) + SUM(gI1,0,4,SUM(gI2,0,2,SUM(gI3,0,2,CpbarChaFeconjSvPL(gI2,
      ...
      3,SUM(gI2,0,2,SUM(gI3,0,2,-0.5*CpbarFeFehhPL(gI3,gO1,gI2)*CpbarFvFeconjHpmPR
      ...
      (gI1,1,3,SUM(gI2,1,2,SUM(gI3,0,2,-0.5*CpAhHpmconjVWm(gI2,gI1)*CpbarFeFeAhPL(
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,2,SUM(gI2,0,4,SUM(gI3,0,2,SUM(gI4
      ,0,2,CpbarChaFeconjSvPL(gI4,gO1,gI1)*CpbarFeChaSvPR(gO4,gI4,gI3)*
      CpbarFvChiSvPR(gO2,gI2,gI1)*CpChiFvconjSvPL(gI2,gO3,gI3)*D27(Sqr(MSv(gI1)),
      Sqr(MChi(gI2)),Sqr(MSv(gI3)),Sqr(MCha(gI4))))))) + SUM(gI1,0,2,SUM(gI2,0,4,
      SUM(gI3,0,5,SUM(gI4,0,2,0.5*CpbarChaFeconjSvPL(gI4,gO1,gI1)*CpbarFeChiSePR(
      gO4,gI2,gI3)*CpbarFvChiSvPR(gO2,gI2,gI1)*CpChaFvconjSePL(gI4,gO3,gI3)*D0(Sqr
      (MSv(gI1)),Sqr(MChi(gI2)),Sqr(MSe(gI3)),Sqr(MCha(gI4)))*MCha(gI4)*MChi(gI2))
      ))) + SUM(gI1,0,2,SUM(gI2,0,5,SUM(gI3,0,2,SUM(gI4,0,2,0.5*CpbarChabarFvSePR(
      gI3,gO2,gI2)*CpbarChaFeconjSvPL(gI1,gO1,gI4)*CpbarFeChaSvPR(gO4,gI3,gI4)*
      CpChaFvconjSePL(gI1,gO3,gI2)*D0(Sqr(MCha(gI1)),Sqr(MSe(gI2)),Sqr(MCha(gI3)),
      Sqr(MSv(gI4)))*MCha(gI1)*MCha(gI3))))) + SUM(gI1,0,2,SUM(gI2,1,3,SUM(gI3,0,2
      ,SUM(gI4,0,2,CpbarFeFehhPL(gI1,gO1,gI4)*CpbarFeFehhPR(gO4,gI3,gI4)*
      CpbarFeFvHpmPL(gI3,gO3,gI2)*CpbarFvFeconjHpmPR(gO2,gI1,gI2)*D27(Sqr(MFe(gI1)
      ),Sqr(MHpm(gI2)),Sqr(MFe(gI3)),Sqr(Mhh(gI4))))))) + SUM(gI1,0,2,SUM(gI2,1,3,
      ...
      (gI1)*MChi(gI3))))) + SUM(gI1,0,5,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,0,4,0.5*
      ...
      0,2,SUM(gI3,0,5,SUM(gI4,0,4,CpbarChabarFvSePR(gI2,gO2,gI1)*CpbarFeChiSePR(
      gO4,gI4,gI3)*CpChaFvconjSePL(gI2,gO3,gI3)*CpChiFeconjSePL(gI4,gO1,gI1)*D27(
      Sqr(MSe(gI1)),Sqr(MCha(gI2)),Sqr(MSe(gI3)),Sqr(MChi(gI4))))))) + SUM(gI1,1,3
      ,SUM(gI2,0,2,SUM(gI3,1,3,SUM(gI4,0,2,-(CpbarFeFvHpmPL(gI2,gO3,gI1)*
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * TMSSM_info::normalization_g3 /
...
double CLASSNAME::calculate_delta_alpha_hat_bsm(double alpha_em) const
{
   ...
   delta_alpha_hat_bsm += alpha_em/(2.*Pi)*(0.3333333333333333 -
      ...
      *FiniteLog(Abs(MCha(1)/currentScale)) - 1.3333333333333333*FiniteLog(Abs(
      MCha(2)/currentScale)) - 0.3333333333333333*FiniteLog(Abs(MHpm(1)/
      currentScale)) - 0.3333333333333333*FiniteLog(Abs(MHpm(2)/currentScale)) -
      0.3333333333333333*FiniteLog(Abs(MHpm(3)/currentScale)) - 0.1111111111111111
