...
{
   const double gY = MODEL->get_g1() * TMSSM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * TMSSM_info::normalization_g2;
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,2,SUM(gI2,0,4,SUM(gI3,0,2,SUM(
      gI4,0,2,CpbarChaFeconjSvPL(gI4,gO1,gI1)*CpbarFeChaSvPR(gO4,gI4,gI3)*
