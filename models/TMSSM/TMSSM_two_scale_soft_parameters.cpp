...
// File generated at Mon 23 Feb 2015 12:27:07
...
void TMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   ...
   TRACE_STRUCT.Tr31 = 0.012909944487358056*g1*(45*(mHd2 - mHu2)*AbsSqr(Lambdax
   ...
   TRACE_STRUCT.Tr22 = 0.5*(mHd2 + mHu2 + 4*mT2 + (ml2).trace() + 3*(mq2).trace
      ());
