...
// File generated at Mon 19 Sep 2016 09:52:19
 ...
 */
double TMSSM_soft_parameters::calc_beta_mHd2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double TMSSM_soft_parameters::calc_beta_mHd2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_mHd2 = Re(twoLoop*(6*Power(g2,4)*Tr22 - 3.0983866769659336*g1*
      ...
      *traceconjTYdTpYd*Sqr(g1) + 2.4*traceconjTYeTpTYe*Sqr(g1) - 2.4*MassB*
      ...
      (g1)*(20*traceAdjYdTYd - 60*traceAdjYeTYe - 40*MassB*traceYdAdjYd + 120*
      MassB*traceYeAdjYe + 621*MassB*Sqr(g1) + 90*MassB*Sqr(g2) + 45*MassWB*Sqr
 ...
 */
double TMSSM_soft_parameters::calc_beta_mHd2_three_loop(const Soft_traces& soft_traces) const
{
