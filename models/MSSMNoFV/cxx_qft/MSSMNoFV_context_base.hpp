...
using cxx_diagrams::field_indices;
   ...
   struct context_base {
      MSSMNoFV_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MSSMNoFV_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MSSMNoFV_mass_eigenstates_interface const* const m) : model(*m) {}
