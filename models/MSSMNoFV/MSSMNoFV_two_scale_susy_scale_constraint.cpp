...
void MSSMNoFV_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
void MSSMNoFV_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MSSMNoFV_susy_scale_constraint<Two_scale>: "
