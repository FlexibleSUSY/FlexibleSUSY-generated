...
{
   const auto gY = MODEL->get_g1() * MSSMNoFV_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * MSSMNoFV_info::normalization_g2;
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * MSSMNoFV_info::normalization_g3 /
