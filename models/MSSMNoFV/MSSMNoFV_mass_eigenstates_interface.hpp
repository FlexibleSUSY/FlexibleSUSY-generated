...
/**
 * @file MSSMNoFV_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSMNoFV_MASS_EIGENSTATES_INTERFACE_H
#define MSSMNoFV_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMNoFV_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMNoFV_mass_eigenstates_interface {
public:
   virtual ~MSSMNoFV_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMNoFV_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMNoFV_input_parameters& get_input_parameters() const = 0;
   virtual MSSMNoFV_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMNoFV_physical& get_physical() const = 0;
   virtual MSSMNoFV_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMNoFV_physical&) = 0;
