...
MSSMNoFV_convergence_tester<Two_scale>::MSSMNoFV_convergence_tester(
   MSSMNoFV<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMNoFV<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double MSSMNoFV_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const MSSMNoFV<Two_scale>& ne = get_current_iteration_model();
