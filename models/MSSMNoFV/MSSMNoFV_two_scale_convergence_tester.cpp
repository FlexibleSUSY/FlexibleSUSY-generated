...
// File generated at Tue 12 Jul 2016 12:31:14
...
MSSMNoFV_convergence_tester<Two_scale>::MSSMNoFV_convergence_tester(MSSMNoFV<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<MSSMNoFV<Two_scale> >(model, accuracy_goal)
{
}

MSSMNoFV_convergence_tester<Two_scale>::~MSSMNoFV_convergence_tester()
{
}

double MSSMNoFV_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMNoFV<Two_scale>& ol = get_last_iteration_model();
   const MSSMNoFV<Two_scale>& ne = get_model();
