...
// File generated at Wed 12 Apr 2017 13:47:07
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_mHu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_mHu2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_mHu2_three_loop(const Soft_traces& soft_traces) const
{
