...
/**
 * @file MSSMNoFV_amm.cpp
 *
 * This file was generated with FlexibleSUSY 2.8.0 and SARAH 4.15.1 .
 */

#include "MSSMNoFV_amm.hpp"
#include "MSSMNoFV_mass_eigenstates.hpp"

#include "cxx_qft/MSSMNoFV_qft.hpp"
#include "cxx_qft/MSSMNoFV_particle_aliases.hpp"
...
double get_MLCP(const MSSMNoFV_mass_eigenstates_interface& model)
{
...
void run_to_MSUSY(MSSMNoFV_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("MSSMNoFV_amm: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("MSSMNoFV_amm:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("MSSMNoFV_amm: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("MSSMNoFV_amm: run_to_MSUSY(): "
...
template <typename Lepton>
std::enable_if_t<std::is_same_v<Lepton, MSSMNoFV_cxx_diagrams::fields::Fe>, double>
lepton_pole_mass(const softsusy::QedQcd& qedqcd)
{
   return qedqcd.displayPoleMel();
}

template <typename Lepton>
std::enable_if_t<std::is_same_v<Lepton, MSSMNoFV_cxx_diagrams::fields::Fm>, double>
lepton_pole_mass(const softsusy::QedQcd& qedqcd)
{
...
template <typename Lepton>
double calculate_amm_impl_1l(const context_base& context, const MSSMNoFV_mass_eigenstates& model, double ml_pole)
{
   using namespace MSSMNoFV_cxx_diagrams::fields;

   const auto form_factors = MSSMNoFV_FFV_form_factors::calculate_form_factors<Lepton,Lepton,VP>(model, true);
...
template <typename Lepton>
double calculate_amm_impl(const MSSMNoFV_mass_eigenstates& model, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings)
{
   VERBOSE_MSG("MSSMNoFV_amm: calculating a_mu at Q = " << model.get_scale());
...
template <typename Lepton>
double MSSMNoFV_amm::calculate_amm(const MSSMNoFV_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings)
{
   MSSMNoFV_mass_eigenstates model(model_);

   VERBOSE_MSG("MSSMNoFV_amm: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MSSMNoFV_amm:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
template double MSSMNoFV_amm::calculate_amm<MSSMNoFV_cxx_diagrams::fields::Fe>(const MSSMNoFV_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&);
template double MSSMNoFV_amm::calculate_amm<MSSMNoFV_cxx_diagrams::fields::Fm>(const MSSMNoFV_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&);

template <typename Lepton>
double MSSMNoFV_amm::calculate_amm_uncertainty(const MSSMNoFV_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings)
{
   MSSMNoFV_mass_eigenstates model(model_);

   VERBOSE_MSG("MSSMNoFV_amm: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MSSMNoFV_amm uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
// spliting templated function into header and cpp
// https://isocpp.org/wiki/faq/templates#separate-template-fn-defn-from-decl
template double MSSMNoFV_amm::calculate_amm_uncertainty<MSSMNoFV_cxx_diagrams::fields::Fe>(const MSSMNoFV_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&);
template double MSSMNoFV_amm::calculate_amm_uncertainty<MSSMNoFV_cxx_diagrams::fields::Fm>(const MSSMNoFV_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&);
