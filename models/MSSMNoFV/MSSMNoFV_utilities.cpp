...
// MSSMNoFV_parameter_getter ////////////////////////////////////////

std::vector<std::string> MSSMNoFV_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, MSSMNoFV_info::NUMBER_OF_MIXINGS> MSSMNoFV_parameter_getter::get_mixing_names()
{
   return MSSMNoFV_info::particle_mixing_names;
}

Eigen::ArrayXd MSSMNoFV_parameter_getter::get_parameters(const MSSMNoFV_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, MSSMNoFV_info::NUMBER_OF_PARAMETERS> MSSMNoFV_parameter_getter::get_parameter_names()
{
   return MSSMNoFV_info::parameter_names;
}

std::array<std::string, MSSMNoFV_info::NUMBER_OF_PARTICLES> MSSMNoFV_parameter_getter::get_particle_names()
{
   return MSSMNoFV_info::particle_names;
}

std::vector<std::string> MSSMNoFV_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> MSSMNoFV_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, MSSMNoFV_info::NUMBER_OF_MIXINGS> MSSMNoFV_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, MSSMNoFV_info::NUMBER_OF_MIXINGS> MSSMNoFV_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, MSSMNoFV_info::NUMBER_OF_INPUT_PARAMETERS> MSSMNoFV_parameter_getter::get_input_parameter_names()
{
   return MSSMNoFV_info::input_parameter_names;
}

std::array<std::string, MSSMNoFV_info::NUMBER_OF_EXTRA_PARAMETERS> MSSMNoFV_parameter_getter::get_extra_parameter_names()
{
   return MSSMNoFV_info::extra_parameter_names;
}

decltype(MSSMNoFV_info::NUMBER_OF_MASSES) MSSMNoFV_parameter_getter::get_number_of_masses()
{
 ...
 */
void to_database(
   const std::string& file_name, const MSSMNoFV_mass_eigenstates& model,
   ...
   const MSSMNoFV_observables* observables)
{
   ...
   append(names, MSSMNoFV_parameter_getter::get_input_parameter_names());
   ...
   if (MSSMNoFV_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, MSSMNoFV_observables::get_names());
