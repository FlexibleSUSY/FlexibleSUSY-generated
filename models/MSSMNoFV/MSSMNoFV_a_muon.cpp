 ...
 *
 * This file was generated at Fri 20 Oct 2017 09:18:10 with FlexibleSUSY
...
#include "MSSMNoFV_cxx_diagrams.hpp"
...
double get_MSUSY(const MSSMNoFV_mass_eigenstates& model)
{
...
double calculate_a_muon_impl(MSSMNoFV_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MSSMNoFV_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMNoFV_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MSSMNoFV_a_muon::calculate_a_muon(const MSSMNoFV_mass_eigenstates& model_)
{
...
double MSSMNoFV_a_muon::calculate_a_muon_uncertainty(const MSSMNoFV_mass_eigenstates& model_)
{
   MSSMNoFV_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMNoFV_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
