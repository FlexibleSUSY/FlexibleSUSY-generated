...
// File generated at Sun 28 Aug 2016 15:25:32
...
MSSMNoFV_susy_parameters MSSMNoFV_susy_parameters::calc_beta() const
{
   ...
   return MSSMNoFV_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Yu, beta_Mu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu);
}

MSSMNoFV_susy_parameters MSSMNoFV_susy_parameters::calc_beta(unsigned loops) const
{
   MSSMNoFV_susy_parameters p(*this);
   p.set_loops(loops);
...
void MSSMNoFV_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
