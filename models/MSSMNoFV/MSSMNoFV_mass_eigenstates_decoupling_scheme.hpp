...
/**
 * @file MSSMNoFV_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSMNoFV_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSMNoFV_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "MSSMNoFV_info.hpp"
#include "MSSMNoFV_physical.hpp"
#include "MSSMNoFV_soft_parameters.hpp"
#include "MSSMNoFV_mass_eigenstates_interface.hpp"
...
#define SUPER(p) MSSMNoFV_soft_parameters::p
...
/**
 * @class MSSMNoFV_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMNoFV_mass_eigenstates_decoupling_scheme
   : private MSSMNoFV_soft_parameters
   , public MSSMNoFV_mass_eigenstates_interface
{
public:
   explicit MSSMNoFV_mass_eigenstates_decoupling_scheme(const MSSMNoFV_input_parameters& input_ = MSSMNoFV_input_parameters());
   explicit MSSMNoFV_mass_eigenstates_decoupling_scheme(const MSSMNoFV_mass_eigenstates&);
   MSSMNoFV_mass_eigenstates_decoupling_scheme(const MSSMNoFV_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFV_mass_eigenstates_decoupling_scheme(MSSMNoFV_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSMNoFV_mass_eigenstates_decoupling_scheme() = default;
   MSSMNoFV_mass_eigenstates_decoupling_scheme& operator=(const MSSMNoFV_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFV_mass_eigenstates_decoupling_scheme& operator=(MSSMNoFV_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSMNoFV_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MSSMNoFV_mass_eigenstates&);
   ...
   const MSSMNoFV_input_parameters& get_input_parameters() const override;
   MSSMNoFV_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSMNoFV_physical& get_physical() const override;
   MSSMNoFV_physical& get_physical() override;
   ...
   void set_physical(const MSSMNoFV_physical&) override;
...
std::ostream& operator<<(std::ostream&, const MSSMNoFV_mass_eigenstates_decoupling_scheme&);
