...
#ifndef MSSMNoFV_WEINBERG_ANGLE_H
#define MSSMNoFV_WEINBERG_ANGLE_H
...
public:
   ...
   MSSMNoFV_weinberg_angle(const MSSMNoFV_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMNoFV_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMNoFV_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
