...
public:
   ...
   void set_extra(const MSSMNoFV_slha&, const MSSMNoFV_scales&, const MSSMNoFV_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const MSSMNoFV_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMNoFV_scales&, const MSSMNoFV_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MSSMNoFV_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const MSSMNoFV_slha&);
...
void MSSMNoFV_slha_io::fill(
   ...
   MSSMNoFV_decays const * const decays)
{
