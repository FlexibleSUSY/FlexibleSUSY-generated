...
public:
   ...
   void set_extra(const MSSMNoFV_slha&, const MSSMNoFV_scales&, const MSSMNoFV_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMNoFV_scales&, const MSSMNoFV_observables&);
