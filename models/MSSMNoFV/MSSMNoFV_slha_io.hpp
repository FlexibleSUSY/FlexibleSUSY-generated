...
// File generated at Tue 24 Feb 2015 17:51:03
...
struct MSSMNoFV_scales {
   MSSMNoFV_scales() : HighScale(0.), SUSYScale(0.), LowScale(0.) {}
...
public:
   ...
   template <class T> void fill(MSSMNoFV_slha<T>&) const;
   void fill(Spectrum_generator_settings&) const;
   double get_parameter_output_scale() const;
   const SLHA_io& get_slha_io() const { return slha_io; }
   void read_from_file(const std::string&);
   void set_extpar(const MSSMNoFV_input_parameters&);
   template <class T> void set_extra(const MSSMNoFV_slha<T>&, const MSSMNoFV_scales&);
   void set_minpar(const MSSMNoFV_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const MSSMNoFV_slha<T>&);
   template <class T> void set_spectrum(const MSSMNoFV<T>&);
   void set_spinfo(const Problems<MSSMNoFV_info::NUMBER_OF_PARTICLES>&);
   ...
   static void convert_to_slha_convention(MSSMNoFV_physical&);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MSSMNoFV_slha<T>&, const QedQcd&, const MSSMNoFV_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMNoFV_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMNoFV_slha<T>&, const QedQcd&, const MSSMNoFV_scales&);
...
private:
   ...
   template <class T> void set_model_parameters(const MSSMNoFV_slha<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(MSSMNoFV_slha<T>&) const;
   template <class T> void fill_physical(MSSMNoFV_slha<T>&) const;
};
 ...
 */
template <class T>
void MSSMNoFV_slha_io::fill(MSSMNoFV_slha<T>& model) const
{
 ...
 */
template <class T>
void MSSMNoFV_slha_io::fill_drbar_parameters(MSSMNoFV_slha<T>& model) const
{
 ...
 */
template <class T>
void MSSMNoFV_slha_io::fill_physical(MSSMNoFV_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZH);
...
void MSSMNoFV_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMNoFV_slha<T>& model,
   const QedQcd& qedqcd, const MSSMNoFV_scales& scales)
{
...
SLHAea::Coll MSSMNoFV_slha_io::fill_slhaea(
   const MSSMNoFV_slha<T>& model, const QedQcd& qedqcd)
{
...
{
   SLHAea::Coll slhaea;
   MSSMNoFV_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
 ...
 */
template <class T>
void MSSMNoFV_slha_io::set_model_parameters(const MSSMNoFV_slha<T>& model)
{
   {
...
void MSSMNoFV_slha_io::set_extra(
   const MSSMNoFV_slha<T>& model, const MSSMNoFV_scales& scales)
{
...
{
   const MSSMNoFV_slha<T> model_slha(model);
 ...
 */
template <class T>
void MSSMNoFV_slha_io::set_spectrum(const MSSMNoFV_slha<T>& model)
{
   const MSSMNoFV_physical physical(model.get_physical_slha());
