...
// File generated at Mon 19 Sep 2016 10:15:23
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFV_soft_parameters::calc_beta_mq2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFV_soft_parameters::calc_beta_mq2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFV_soft_parameters::calc_beta_mq2_three_loop(const Soft_traces& soft_traces) const
{
