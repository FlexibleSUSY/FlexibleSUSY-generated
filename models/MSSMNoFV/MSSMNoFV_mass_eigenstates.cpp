...
#include "MSSMNoFV_ewsb_solver_interface.hpp"
#include "config.h"
...
CLASSNAME::CLASSNAME(const MSSMNoFV_input_parameters& input_)
   : MSSMNoFV_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new MSSMNoFV_ewsb_solver<Two_scale>())
#endif
{
}

std::unique_ptr<MSSMNoFV_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<MSSMNoFV_mass_eigenstates>(*this);
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MSSMNoFV_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving MSSMNoFV EWSB at " << ewsb_loop_order << "-loop order");
...
{
   if (PHYSICAL(MSveL) < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::SveL); }
   if (PHYSICAL(MSvmL) < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::SvmL); }
   if (PHYSICAL(MSvtL) < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::SvtL); }
   if (PHYSICAL(MSd).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Sd); }
   if (PHYSICAL(MSu).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Su); }
   if (PHYSICAL(MSe).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Se); }
   if (PHYSICAL(MSm).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Sm); }
   if (PHYSICAL(MStau).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Stau); }
   if (PHYSICAL(MSs).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Ss); }
   if (PHYSICAL(MSc).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Sc); }
   if (PHYSICAL(MSb).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Sb); }
   if (PHYSICAL(MSt).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::St); }
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::hh); }
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Ah); }
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFV_info::Hpm); }
}
...
const MSSMNoFV_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

MSSMNoFV_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
...
void CLASSNAME::calculate_MSveL()
{
   ...
   if (MSveL < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::SveL);
   }
...
void CLASSNAME::calculate_MSvmL()
{
   ...
   if (MSvmL < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::SvmL);
   }
...
void CLASSNAME::calculate_MSvtL()
{
   ...
   if (MSvtL < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::SvtL);
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Sd, eigenvalue_error > precision * Abs
      (MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Sd);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Su, eigenvalue_error > precision * Abs
      (MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Se, eigenvalue_error > precision * Abs
      (MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Se);
   }
...
void CLASSNAME::calculate_MSm()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Sm, eigenvalue_error > precision * Abs
      (MSm(0)));
#else
   ...
   if (MSm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Sm);
   }
...
void CLASSNAME::calculate_MStau()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Stau, eigenvalue_error > precision *
      Abs(MStau(0)));
#else
   ...
   if (MStau.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Stau);
   }
...
void CLASSNAME::calculate_MSs()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Ss, eigenvalue_error > precision * Abs
      (MSs(0)));
#else
   ...
   if (MSs.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Ss);
   }
...
void CLASSNAME::calculate_MSc()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Sc, eigenvalue_error > precision * Abs
      (MSc(0)));
#else
   ...
   if (MSc.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Sc);
   }
...
void CLASSNAME::calculate_MSb()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Sb, eigenvalue_error > precision * Abs
      (MSb(0)));
#else
   ...
   if (MSb.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Sb);
   }
...
void CLASSNAME::calculate_MSt()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::St, eigenvalue_error > precision * Abs
      (MSt(0)));
#else
   ...
   if (MSt.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::St);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::hh, eigenvalue_error > precision * Abs
      (Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Ah, eigenvalue_error > precision * Abs
      (MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Hpm, eigenvalue_error > precision *
      Abs(MHpm(0)));
#else
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Chi, eigenvalue_error > precision *
      Abs(MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSMNoFV_info::Cha, eigenvalue_error > precision *
      Abs(MCha(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(MSSMNoFV_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::VZ))
      return;
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFV_info::VZ);
   }
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::SveL))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::SvmL))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::SvtL))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Sm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Stau))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Ss))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Sc))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Sb))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::St))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::hh))
      return;
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMNoFV_info::hh, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Ah))
      return;
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMNoFV_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFV_info::VWm))
      return;
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFV_info::VWm);
   }
...
double CLASSNAME::calculate_MVZ_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFV_info::VZ);return m_pole;
   }
...
double CLASSNAME::calculate_MVWm_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFV_info::VWm);return m_pole;
   }
