...
// File generated at Sun 26 Aug 2018 15:20:37
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 15:20:37 with FlexibleSUSY
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMNoFV_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMNoFV_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMNoFV_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }
