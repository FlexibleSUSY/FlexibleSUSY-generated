...
// File generated at Tue 12 Jul 2016 12:29:41
 ...
 */
double MSSMNoFV_susy_parameters::calc_beta_Mu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMNoFV_susy_parameters::calc_beta_Mu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMNoFV_susy_parameters::calc_beta_Mu_three_loop(const Susy_traces& susy_traces) const
{
