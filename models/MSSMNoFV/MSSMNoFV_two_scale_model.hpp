 ...
 */
template<>
class MSSMNoFV<Two_scale> : public Two_scale_model, public MSSMNoFV_soft_parameters {
public:
...
Eigen::Array<double,1,1> get_MPseudoscalarHiggs() const;
   ...
   std::complex<double> CpUhhbarFeFePR(unsigned gO2) const;
   std::complex<double> CpUhhbarFeFePL(unsigned gO1) const;
   std::complex<double> CpUhhbarFmFmPR(unsigned gO2) const;
   std::complex<double> CpUhhbarFmFmPL(unsigned gO1) const;
   std::complex<double> CpUhhbarFtauFtauPR(unsigned gO2) const;
   std::complex<double> CpUhhbarFtauFtauPL(unsigned gO1) const;
   std::complex<double> CpUhhbarFbFbPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFbFbPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFcFcPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFcFcPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFdFdPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFdFdPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFsFsPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFsFsPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFtFtPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFtFtPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFuFuPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpUhhbarFuFuPL(unsigned gO1, unsigned , unsigned ) const;
   ...
   std::complex<double> CpconjUHpmbarFveFePR(unsigned gO2) const;
   double CpconjUHpmbarFveFePL(unsigned ) const;
   std::complex<double> CpconjUHpmbarFvmFmPR(unsigned gO2) const;
   double CpconjUHpmbarFvmFmPL(unsigned ) const;
   std::complex<double> CpconjUHpmbarFvtFtauPR(unsigned gO2) const;
   double CpconjUHpmbarFvtFtauPL(unsigned ) const;
   std::complex<double> CpconjUHpmbarFcFsPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpconjUHpmbarFcFsPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpconjUHpmbarFtFbPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpconjUHpmbarFtFbPL(unsigned gO1, unsigned , unsigned ) const;
   std::complex<double> CpconjUHpmbarFuFdPR(unsigned gO2, unsigned , unsigned ) const;
   std::complex<double> CpconjUHpmbarFuFdPL(unsigned gO1, unsigned , unsigned ) const;
   ...
   std::complex<double> CpbarUChaconjSveLFePR(unsigned gO1) const;
   double CpbarUChaconjSvmLFmPL(unsigned gO2) const;
   std::complex<double> CpbarUChaconjSvmLFmPR(unsigned gO1) const;
   double CpbarUChaconjSvtLFtauPL(unsigned gO2) const;
   std::complex<double> CpbarUChaconjSvtLFtauPR(unsigned gO1) const;
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(MSSMNoFV<Two_scale>::*Memfun_t)();
      MSSMNoFV<Two_scale>* model;
      Memfun_t fun;

      Thread(MSSMNoFV<Two_scale>* model_, Memfun_t fun_)
