...
// File generated at Sun 26 Aug 2018 15:16:24
...
const int MSSMNoFV_soft_parameters::numberOfParameters;

MSSMNoFV_soft_parameters::MSSMNoFV_soft_parameters(const MSSMNoFV_input_parameters& input_)
   : MSSMNoFV_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMNoFV_soft_parameters::MSSMNoFV_soft_parameters(
   const MSSMNoFV_susy_parameters& susy_model
   ...
   : MSSMNoFV_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMNoFV_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMNoFV_soft_parameters MSSMNoFV_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMNoFV_susy_parameters susy_betas(MSSMNoFV_susy_parameters::calc_beta(loops));

   return MSSMNoFV_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMNoFV_soft_parameters MSSMNoFV_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMNoFV_soft_parameters::clear()
{
   MSSMNoFV_susy_parameters::clear();
...
Eigen::ArrayXd MSSMNoFV_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMNoFV_susy_parameters::get());
...
void MSSMNoFV_soft_parameters::print(std::ostream& ostr) const
{
   MSSMNoFV_susy_parameters::print(ostr);
...
void MSSMNoFV_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMNoFV_susy_parameters::set(pars);
...
MSSMNoFV_soft_parameters::Soft_traces MSSMNoFV_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFV_soft_parameters& soft_pars)
{
