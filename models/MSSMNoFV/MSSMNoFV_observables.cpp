...
#include "observables/MSSMNoFV_br_l_to_3l.hpp"
#include "observables/MSSMNoFV_br_l_to_l_gamma.hpp"
#include "observables/MSSMNoFV_l_to_l_conversion.hpp"
                                              ...
                                              const Spectrum_generator_settings& settings)
{
   ...
   try {
      ...
      observables.AMM0(Fe) = MSSMNoFV_amm::calculate_amm<MSSMNoFV_cxx_diagrams::fields::Fe>(MODEL, qedqcd, settings);
      observables.AMM0(Fm) = MSSMNoFV_amm::calculate_amm<MSSMNoFV_cxx_diagrams::fields::Fm>(MODEL, qedqcd, settings);
      #ifdef ENABLE_GM2CALC
