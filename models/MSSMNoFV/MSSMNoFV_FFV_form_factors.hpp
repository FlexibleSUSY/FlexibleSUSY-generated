...
std::enable_if_t<
   std::is_same_v<Fj, MSSMNoFV_cxx_diagrams::fields::Fe> && std::is_same_v<Fi, MSSMNoFV_cxx_diagrams::fields::Fe> && std::is_same_v<V, MSSMNoFV_cxx_diagrams::fields::VP>,
   std::valarray<std::complex<double>>
>
calculate_form_factors(     const MSSMNoFV_mass_eigenstates&, bool);

template <typename Fj, typename Fi, typename V>
std::enable_if_t<
   std::is_same_v<Fj, MSSMNoFV_cxx_diagrams::fields::Fm> && std::is_same_v<Fi, MSSMNoFV_cxx_diagrams::fields::Fm> && std::is_same_v<V, MSSMNoFV_cxx_diagrams::fields::VP>,
   std::valarray<std::complex<double>>
>
calculate_form_factors(     const MSSMNoFV_mass_eigenstates&, bool);
