...
#ifndef MSSMNoFV_TWO_SCALE_soft_parameters_H
#define MSSMNoFV_TWO_SCALE_soft_parameters_H
...
public:
   ...
   virtual ~MSSMNoFV_soft_parameters() {}
   ...
   MSSMNoFV_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
