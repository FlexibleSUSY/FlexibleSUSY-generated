...
void MSSMNoFV_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
double MSSMNoFV_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();

   double theta_w = std::asin(Electroweak_constants::sinThetaW);

   MSSMNoFV_weinberg_angle::Sm_parameters sm_pars;
   ...
   MSSMNoFV_weinberg_angle weinberg(MODEL, sm_pars);
...
double MSSMNoFV_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void MSSMNoFV_low_scale_constraint<Two_scale>::calculate_running_SM_masses()
{
   check_model_ptr();
...
void MSSMNoFV_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MSSMNoFV_low_scale_constraint<Two_scale>: "
