...
template<>
class MSSMNoFV_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ...
   virtual ~MSSMNoFV_initial_guesser() = default;
...
private:
   MSSMNoFV<Two_scale>* model{nullptr}; ///< pointer to model class
