...
template<>
class MSSMNoFV_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   MSSMNoFV_low_scale_constraint();
   MSSMNoFV_low_scale_constraint(MSSMNoFV<Two_scale>*, const MSSMNoFV_input_parameters&, const QedQcd&);
   virtual ~MSSMNoFV_low_scale_constraint();
   virtual void apply();
