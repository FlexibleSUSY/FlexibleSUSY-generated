...
#ifndef MSSMNoFV_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMNoFV_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMNoFV_low_scale_constraint.hpp"
...
template<>
class MSSMNoFV_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMNoFV_low_scale_constraint() = default;
   MSSMNoFV_low_scale_constraint(MSSMNoFV<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMNoFV_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMNoFV low-scale constraint"; }
