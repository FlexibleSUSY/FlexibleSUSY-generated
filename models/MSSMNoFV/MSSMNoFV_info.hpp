...
namespace MSSMNoFV_info {
   ...
   class MSSMNoFV_particle_names : public Names {
   public:
      virtual ~MSSMNoFV_particle_names() = default;
   ...
   class MSSMNoFV_parameter_names : public Names {
   public:
      virtual ~MSSMNoFV_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMNoFV_particle_names  particle_names_getter{};
   const MSSMNoFV_parameter_names parameter_names_getter{};
