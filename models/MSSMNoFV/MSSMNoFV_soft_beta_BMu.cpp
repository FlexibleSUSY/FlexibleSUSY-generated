...
// File generated at Sun 26 Aug 2018 15:17:17
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_BMu_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_BMu_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_BMu_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMNoFV_soft_parameters::calc_beta_BMu_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
