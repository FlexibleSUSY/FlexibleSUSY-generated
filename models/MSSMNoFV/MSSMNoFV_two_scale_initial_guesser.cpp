...
// File generated at Tue 22 Jan 2019 17:57:56
...
MSSMNoFV_initial_guesser<Two_scale>::MSSMNoFV_initial_guesser(
   MSSMNoFV<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MSSMNoFV_low_scale_constraint<Two_scale>& low_constraint_,
   const MSSMNoFV_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSMNoFV_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("MSSMNoFV_initial_guesser: Error: pointer to model"
                       " MSSMNoFV<Two_scale> must not be zero");
}
 ...
 */
void MSSMNoFV_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMNoFV_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSMNoFV_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void MSSMNoFV_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void MSSMNoFV_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMNoFV_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMNoFV_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void MSSMNoFV_initial_guesser<Two_scale>::guess_soft_parameters()
{
