...
#ifndef MSSMNoFV_TWO_SCALE_MATCHING_H
#define MSSMNoFV_TWO_SCALE_MATCHING_H
...
template <class T> class MSSMNoFV;
template <class T> class MSSMNoFV_standard_model_Matching;
...
template<>
class MSSMNoFV_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MSSMNoFV_standard_model_Matching();

   MSSMNoFV_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MSSMNoFV<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MSSMNoFV_standard_model_Matching();
