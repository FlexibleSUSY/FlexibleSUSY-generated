Get["models/MSSMNoFV/MSSMNoFV_librarylink.m"];

handle = FSMSSMNoFVOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMNoFVCalculateSpectrum[handle];
observables = FSMSSMNoFVCalculateObservables[handle];

FSMSSMNoFVCloseHandle[handle];
