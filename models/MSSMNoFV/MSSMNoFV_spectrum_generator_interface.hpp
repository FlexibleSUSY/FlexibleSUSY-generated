...
public:
   MSSMNoFV_spectrum_generator_interface()
      : model()
      , settings()
   ...
   virtual void run(const softsusy::QedQcd&, const MSSMNoFV_input_parameters&) = 0;
 ...
 */
template <class T>
void MSSMNoFV_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
