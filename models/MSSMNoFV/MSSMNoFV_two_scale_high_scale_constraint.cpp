...
// File generated at Tue 22 Jan 2019 17:57:55
...
#define FSHimalayaMh23L [&] () {                                        \
      ...
      try {                                                             \
         ...
         model->get_problems().flag_bad_mass(MSSMNoFV_info::hh); \
         WARNING(e.what());                                             \
         VERBOSE_MSG(pars);                                             \
      }                                                                 \
                                                                        \
...
const MSSMNoFV_input_parameters& MSSMNoFV_high_scale_constraint<Two_scale>::get_input_parameters() const
{
   return model->get_input();
}

MSSMNoFV<Two_scale>* MSSMNoFV_high_scale_constraint<Two_scale>::get_model() const
{
   return model;
}
