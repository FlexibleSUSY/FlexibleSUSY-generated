...
MSSMNoFV_physical::MSSMNoFV_physical()
   :
 ...
 * to be complex.
 */
void MSSMNoFV_physical::convert_to_hk()
{
...
void MSSMNoFV_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSMNoFV_physical::get_masses() const
{
...
void MSSMNoFV_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFd = pars(2);
...
void MSSMNoFV_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFV_physical& phys_pars)
{
