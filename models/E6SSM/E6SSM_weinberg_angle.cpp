...
#define CLASSNAME E6SSM_weinberg_angle
 ...
 */
CLASSNAME::E6SSM_weinberg_angle(
...
void CLASSNAME::set_model(const E6SSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * E6SSM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * E6SSM_info::normalization_g2;
