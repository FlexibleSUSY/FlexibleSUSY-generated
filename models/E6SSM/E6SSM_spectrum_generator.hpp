...
// File generated at Fri 26 Jun 2015 19:08:56
 ...
 */
template <class T>
void E6SSM_spectrum_generator<T>::run(const softsusy::QedQcd& oneset,
                                const E6SSM_input_parameters& input)
{
   ...
   E6SSM_convergence_tester<T> convergence_tester(&model, this->precision_goal);
