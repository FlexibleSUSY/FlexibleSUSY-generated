 ...
 * to be complex.
 */
void E6SSM_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void E6SSM_physical::convert_to_slha()
{
...
Eigen::ArrayXd E6SSM_physical::get() const
{
...
void E6SSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd E6SSM_physical::get_masses() const
{
...
void E6SSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
