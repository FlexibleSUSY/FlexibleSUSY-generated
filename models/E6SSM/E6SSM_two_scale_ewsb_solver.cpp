...
// File generated at Tue 10 Oct 2017 22:59:31

/**
 * @file E6SSM_two_scale_ewsb_solver.cpp
 *
 * @brief implementation of EWSB solver for two-scale iteration
 *
 * This file was generated at Tue 10 Oct 2017 22:59:31 with FlexibleSUSY
...
#define CLASSNAME E6SSM_ewsb_solver<Two_scale>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(E6SSM_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   E6SSM_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(E6SSM_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(E6SSM_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(E6SSM_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(E6SSM_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(E6SSM_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const E6SSM_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const E6SSM_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const E6SSM_mass_eigenstates& model) const
{
   ...
   mHd2 = Re((0.0125*(28.284271247461902*vs*vu*Conj(TLambdax) + 80*tadpole[0] -
      6*Cube(vd)*Sqr(g1) - 10*Cube(vd)*Sqr(g2) - 9*Cube(vd)*Sqr(gN) - 40*vd*
      AbsSqr(Lambdax)*Sqr(vs) + 15*vd*Sqr(gN)*Sqr(vs) - 40*vd*AbsSqr(Lambdax)*Sqr(
      vu) + 6*vd*Sqr(g1)*Sqr(vu) + 10*vd*Sqr(g2)*Sqr(vu) - 6*vd*Sqr(gN)*Sqr(vu) +
      28.284271247461902*vs*vu*TLambdax))/vd);
   mHu2 = Re((0.025*(14.142135623730951*vd*vs*Conj(TLambdax) + 40*tadpole[1] -
      3*Cube(vu)*Sqr(g1) - 5*Cube(vu)*Sqr(g2) - 2*Cube(vu)*Sqr(gN) - 20*vu*AbsSqr(
