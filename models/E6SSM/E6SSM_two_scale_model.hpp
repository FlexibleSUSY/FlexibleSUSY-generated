 ...
 *
 * This file was generated at Tue 24 Feb 2015 17:41:30 with FlexibleSUSY
 ...
 */
template<>
class E6SSM<Two_scale> : public Two_scale_model, public E6SSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(E6SSM<Two_scale>::*Memfun_t)();
      E6SSM<Two_scale>* model;
      Memfun_t fun;

      Thread(E6SSM<Two_scale>* model_, Memfun_t fun_)
