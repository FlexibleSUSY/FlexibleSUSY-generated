...
// File generated at Tue 22 Jan 2019 17:09:23

/**
 * @file E6SSM_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 17:09:23 with FlexibleSUSY
...
double calculate_a_muon_impl(E6SSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const E6SSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("E6SSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double E6SSM_a_muon::calculate_a_muon(const E6SSM_mass_eigenstates& model_)
{
...
double E6SSM_a_muon::calculate_a_muon_uncertainty(const E6SSM_mass_eigenstates& model_)
{
   E6SSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("E6SSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
