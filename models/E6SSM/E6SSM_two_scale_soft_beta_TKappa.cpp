...
// File generated at Thu 15 Dec 2016 12:50:55
 ...
 */
Eigen::Matrix<double,3,3> E6SSM_soft_parameters::calc_beta_TKappa_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSM_soft_parameters::calc_beta_TKappa_two_loop(const Soft_traces& soft_traces) const
{
   const double traceKappaAdjKappa = TRACE_STRUCT.traceKappaAdjKappa;
   const double traceLambda12AdjLambda12 =
      TRACE_STRUCT.traceLambda12AdjLambda12;
 ...
 */
Eigen::Matrix<double,3,3> E6SSM_soft_parameters::calc_beta_TKappa_three_loop(const Soft_traces& soft_traces) const
{
