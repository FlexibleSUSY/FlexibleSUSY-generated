...
public:
   ...
   void set_extra(const E6SSM_slha&, const E6SSM_scales&, const E6SSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const E6SSM_scales&, const E6SSM_observables&);
