...
public:
   ...
   static void convert_to_slha_convention(E6SSM_physical&);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const E6SSM_slha<T>&, const QedQcd&, const E6SSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const E6SSM_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const E6SSM_slha<T>&, const QedQcd&, const E6SSM_scales&);
...
private:
   ...
   template <class T> void fill_drbar_parameters(E6SSM_slha<T>&) const;
   template <class T> void fill_physical(E6SSM_slha<T>&) const;
};
 ...
 */
template <class T>
void E6SSM_slha_io::fill_drbar_parameters(E6SSM_slha<T>& model) const
{
 ...
 */
template <class T>
void E6SSM_slha_io::fill_physical(E6SSM_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
...
void E6SSM_slha_io::fill_slhaea(
   ...
   const QedQcd& qedqcd, const E6SSM_scales& scales)
{
...
SLHAea::Coll E6SSM_slha_io::fill_slhaea(
   const E6SSM_slha<T>& model, const QedQcd& qedqcd)
{
   E6SSM_scales scales;
...
{
   SLHAea::Coll slhaea;
   E6SSM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
