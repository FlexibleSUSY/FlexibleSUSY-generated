...
/**
 * @file E6SSM_mass_eigenstates_interface.hpp
 *
...
#ifndef E6SSM_MASS_EIGENSTATES_INTERFACE_H
#define E6SSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class E6SSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class E6SSM_mass_eigenstates_interface {
public:
   virtual ~E6SSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<E6SSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const E6SSM_input_parameters& get_input_parameters() const = 0;
   virtual E6SSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const E6SSM_physical& get_physical() const = 0;
   virtual E6SSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const E6SSM_physical&) = 0;
