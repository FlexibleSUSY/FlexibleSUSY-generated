...
// File generated at Fri 10 Apr 2020 20:05:54
...
public:
   ...
   virtual void fill_slha_io(E6SSM_slha_io&) const = 0;
...
public:
   ...
   virtual void fill_slha_io(E6SSM_slha_io&) const override;
...
private:
   std::tuple<E6SSM_slha<E6SSM<Solver_type>>> models{};        ///< running parameters and pole masses
                ...
                const std::vector<std::string>& heads = {})
{
   for (std::size_t i = 0; i < flags.size(); i++) {
      if (flags[i]) {
         ...
         MLPutSymbol(link, E6SSM_info::particle_names[i].c_str());
      }
   }
}
...
void put_spectrum(const E6SSM_slha<Model>& model, MLINK link)
{
...
template <typename Solver_type>
void E6SSM_spectrum_impl<Solver_type>::fill_slha_io(E6SSM_slha_io& slha_io) const
{
