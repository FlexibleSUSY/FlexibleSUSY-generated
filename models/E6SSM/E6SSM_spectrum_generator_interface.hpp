...
public:
   E6SSM_spectrum_generator_interface()
      : model()
      , settings()
   ...
   virtual void run(const softsusy::QedQcd&, const E6SSM_input_parameters&) = 0;
 ...
 */
template <class T>
void E6SSM_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
