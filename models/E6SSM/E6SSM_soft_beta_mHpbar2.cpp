 ...
 */
double E6SSM_soft_parameters::calc_beta_mHpbar2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double E6SSM_soft_parameters::calc_beta_mHpbar2_2_loop(const Soft_traces& soft_traces) const
{
