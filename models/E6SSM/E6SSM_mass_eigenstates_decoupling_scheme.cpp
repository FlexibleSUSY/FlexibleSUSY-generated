...
/**
 * @file E6SSM_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the E6SSM model class in the decoupling scheme
 *
...
#define CLASSNAME E6SSM_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const E6SSM_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<E6SSM_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const E6SSM_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const E6SSM_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
