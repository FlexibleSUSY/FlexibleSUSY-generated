...
class E6SSM_ewsb_solver_interface;
/**
...
public:
   ...
   E6SSM_mass_eigenstates(const E6SSM_mass_eigenstates&) = default;
   E6SSM_mass_eigenstates(E6SSM_mass_eigenstates&&) = default;
   virtual ~E6SSM_mass_eigenstates() = default;
   E6SSM_mass_eigenstates& operator=(const E6SSM_mass_eigenstates&) = default;
   E6SSM_mass_eigenstates& operator=(E6SSM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<E6SSM_ewsb_solver_interface>&);
...
private:
   ...
   std::shared_ptr<E6SSM_ewsb_solver_interface> ewsb_solver{};
