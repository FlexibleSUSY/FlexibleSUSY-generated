...
/**
 * @file E6SSM_br_l_to_l_gamma.cpp
 *
...
#include "E6SSM_br_l_to_l_gamma.hpp"
...
void run_to_MSUSY(E6SSM_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("E6SSM_l_to_lgamma: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("E6SSM_l_to_lgamma:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("E6SSM_l_to_lgamma: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("E6SSM_l_to_lgamma: run_to_MSUSY(): "
...
namespace E6SSM_br_l_to_l_gamma {
