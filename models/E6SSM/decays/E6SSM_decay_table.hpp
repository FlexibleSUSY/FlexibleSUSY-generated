...
#ifndef E6SSM_DECAY_TABLE_H
#define E6SSM_DECAY_TABLE_H
...
public:
   ...
   E6SSM_decay_table();
   ~E6SSM_decay_table() = default;
   E6SSM_decay_table(const E6SSM_decay_table&) = default;
   E6SSM_decay_table(E6SSM_decay_table&&) = default;
   E6SSM_decay_table& operator=(const E6SSM_decay_table&) = default;
   E6SSM_decay_table& operator=(E6SSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const E6SSM_decay_table&);
