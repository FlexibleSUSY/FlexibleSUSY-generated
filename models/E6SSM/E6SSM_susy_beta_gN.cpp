 ...
 */
double E6SSM_susy_parameters::calc_beta_gN_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double E6SSM_susy_parameters::calc_beta_gN_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double E6SSM_susy_parameters::calc_beta_gN_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double E6SSM_susy_parameters::calc_beta_gN_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double E6SSM_susy_parameters::calc_beta_gN_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
