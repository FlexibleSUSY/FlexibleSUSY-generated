...
// E6SSM_parameter_getter ////////////////////////////////////////

std::vector<std::string> E6SSM_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, E6SSM_info::NUMBER_OF_MIXINGS> E6SSM_parameter_getter::get_mixing_names()
{
   return E6SSM_info::particle_mixing_names;
}

Eigen::ArrayXd E6SSM_parameter_getter::get_parameters(const E6SSM_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, E6SSM_info::NUMBER_OF_PARAMETERS> E6SSM_parameter_getter::get_parameter_names()
{
   return E6SSM_info::parameter_names;
}

std::array<std::string, E6SSM_info::NUMBER_OF_PARTICLES> E6SSM_parameter_getter::get_particle_names()
{
   return E6SSM_info::particle_names;
}

std::vector<std::string> E6SSM_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> E6SSM_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, E6SSM_info::NUMBER_OF_MIXINGS> E6SSM_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, E6SSM_info::NUMBER_OF_MIXINGS> E6SSM_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, E6SSM_info::NUMBER_OF_INPUT_PARAMETERS> E6SSM_parameter_getter::get_input_parameter_names()
{
   return E6SSM_info::input_parameter_names;
}

std::array<std::string, E6SSM_info::NUMBER_OF_EXTRA_PARAMETERS> E6SSM_parameter_getter::get_extra_parameter_names()
{
   return E6SSM_info::extra_parameter_names;
}

decltype(E6SSM_info::NUMBER_OF_MASSES) E6SSM_parameter_getter::get_number_of_masses()
{
   return E6SSM_info::NUMBER_OF_MASSES;
}

// E6SSM_spectrum_plotter ////////////////////////////////////////

E6SSM_spectrum_plotter::E6SSM_spectrum_plotter(const E6SSM_mass_eigenstates& model)
{
   ...
   const E6SSM_observables* observables)
{
   ...
   append(names, E6SSM_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, E6SSM_parameter_getter::get_DRbar_mass_names());
   append(names, E6SSM_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, E6SSM_parameter_getter::get_pole_mass_names());
   append(names, E6SSM_parameter_getter::get_pole_mixing_names());
   ...
   Physical_input* physical_input, E6SSM_observables* observables)
{
   ...
   const auto number_of_masses = E6SSM_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = E6SSM_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = E6SSM_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = E6SSM_info::NUMBER_OF_EXTRA_PARAMETERS;
