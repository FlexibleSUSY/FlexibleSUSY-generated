...
public:
   ...
   void set_model(const E6SSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const E6SSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
