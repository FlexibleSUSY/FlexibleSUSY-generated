...
E6SSM_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   E6SSM_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, E6SSM_input_parameters& input,
