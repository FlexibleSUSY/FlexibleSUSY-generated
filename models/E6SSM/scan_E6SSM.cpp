...
// File generated at Wed 16 Oct 2019 22:02:31
...
struct E6SSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
E6SSM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   E6SSM_input_parameters& input)
{
...
void scan(int solver_type, E6SSM_input_parameters& input,
