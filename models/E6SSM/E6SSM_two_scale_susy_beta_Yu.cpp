...
// File generated at Mon 27 Feb 2017 13:33:04
 ...
 */
Eigen::Matrix<double,3,3> E6SSM_susy_parameters::calc_beta_Yu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSM_susy_parameters::calc_beta_Yu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
Eigen::Matrix<double,3,3> E6SSM_susy_parameters::calc_beta_Yu_three_loop(const Susy_traces& susy_traces) const
{
