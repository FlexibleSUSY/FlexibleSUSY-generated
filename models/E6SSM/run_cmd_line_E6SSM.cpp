...
int run_solver(int loop_library, const E6SSM_input_parameters& input)
{
   ...
   E6SSM_decays decays;if (settings.get(Spectrum_generator_settings::calculate_sm_masses)) {
...
int run(int solver_type, int loop_library, const E6SSM_input_parameters& input)
{
   int exit_code = 0;
