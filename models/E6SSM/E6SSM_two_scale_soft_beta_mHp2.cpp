...
// File generated at Mon 23 Feb 2015 13:02:35
...
double E6SSM_soft_parameters::calc_beta_mHp2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHp2 = 0.04*twoLoop*(6*Conj(MassBp)*Sqr(gN)*(3*(MassB + 2*MassBp)
      *Sqr(g1) + 5*(2*MassBp + MassWB)*Sqr(g2) + 96*MassBp*Sqr(gN)) + 9*Conj(
      MassB)*Sqr(g1)*(99*MassB*Sqr(g1) + 5*(2*MassB + MassWB)*Sqr(g2) + 2*(2*
      MassB + MassBp)*Sqr(gN)) + 5*(30*Power(g2,4)*Tr22 - 4.898979485566356*g1*
