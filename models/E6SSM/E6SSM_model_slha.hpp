...
class E6SSM_slha : public E6SSM_mass_eigenstates {
public:
   explicit E6SSM_slha(const E6SSM_input_parameters& input_ = E6SSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit E6SSM_slha(const E6SSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
