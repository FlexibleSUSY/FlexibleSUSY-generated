...
/**
 * @file E6SSM_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Fri 20 Oct 2017 09:00:37
...
class E6SSM_slha : public Model {
public:
   explicit E6SSM_slha(const E6SSM_input_parameters& input_ = E6SSM_input_parameters());
   explicit E6SSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   E6SSM_slha(const E6SSM_slha&) = default;
   E6SSM_slha(E6SSM_slha&&) = default;
   virtual ~E6SSM_slha() = default;
   E6SSM_slha& operator=(const E6SSM_slha&) = default;
   E6SSM_slha& operator=(E6SSM_slha&&) = default;
...
template <class Model>
E6SSM_slha<Model>::E6SSM_slha(const E6SSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
E6SSM_slha<Model>::E6SSM_slha(const Model& model_,
...
template <class Model>
void E6SSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void E6SSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void E6SSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void E6SSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void E6SSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void E6SSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void E6SSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const E6SSM_physical& E6SSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
E6SSM_physical& E6SSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void E6SSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void E6SSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const E6SSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
