...
#ifndef E6SSM_TWO_SCALE_MATCHING_H
#define E6SSM_TWO_SCALE_MATCHING_H
...
template <class T> class E6SSM;
template <class T> class E6SSM_standard_model_Matching;
...
template<>
class E6SSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   E6SSM_standard_model_Matching();

   E6SSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       E6SSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~E6SSM_standard_model_Matching();
