...
/**
 * @class E6SSM_initial_guesser<Two_scale>
 * @brief initial guesser for the E6SSM
 */

template<>
class E6SSM_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ...
   virtual ~E6SSM_initial_guesser() = default;
...
private:
   E6SSM<Two_scale>* model{nullptr}; ///< pointer to model class
