...
CE6SSM_slha::CE6SSM_slha(const CE6SSM_input_parameters& input_,
                                   bool do_convert_masses_to_slha)
   : CE6SSM_mass_eigenstates(input_)
 ...
 */
CE6SSM_slha::CE6SSM_slha(const CE6SSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : CE6SSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void CE6SSM_slha::clear()
{
   CE6SSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void CE6SSM_slha::calculate_spectrum()
{
   CE6SSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void CE6SSM_slha::convert_to_slha()
{
...
void CE6SSM_slha::calculate_ckm_matrix()
{
...
void CE6SSM_slha::calculate_pmns_matrix()
{
 ...
 */
void CE6SSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void CE6SSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void CE6SSM_slha::convert_soft_squared_masses_to_slha()
{
...
const CE6SSM_physical& CE6SSM_slha::get_physical_slha() const
{
   return physical_slha;
}

CE6SSM_physical& CE6SSM_slha::get_physical_slha()
{
   return physical_slha;
}

void CE6SSM_slha::print(std::ostream& ostr) const
{
   CE6SSM_mass_eigenstates::print(ostr);
...
void CE6SSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const CE6SSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
