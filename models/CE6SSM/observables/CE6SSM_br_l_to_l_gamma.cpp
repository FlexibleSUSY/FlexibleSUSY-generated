...
/**
 * @file CE6SSM_br_l_to_l_gamma.cpp
 *
...
#include "CE6SSM_br_l_to_l_gamma.hpp"
...
void run_to_MSUSY(CE6SSM_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("CE6SSM_l_to_lgamma: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("CE6SSM_l_to_lgamma:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("CE6SSM_l_to_lgamma: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("CE6SSM_l_to_lgamma: run_to_MSUSY(): "
...
namespace CE6SSM_br_l_to_l_gamma {
