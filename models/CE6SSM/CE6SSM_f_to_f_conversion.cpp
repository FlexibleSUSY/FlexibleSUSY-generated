...
/**
 * @file CE6SSM_f_to_f_conversion.cpp
 *
...
#include "CE6SSM_f_to_f_conversion.hpp"
...
namespace CE6SSM_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const CE6SSM_mass_eigenstates& model) {
