...
// File generated at Mon 5 Mar 2018 17:18:48
...
CE6SSM_effective_couplings::CE6SSM_effective_couplings(
   const CE6SSM_mass_eigenstates& model_,
...
void CE6SSM_effective_couplings::calculate_effective_couplings()
{
...
void CE6SSM_effective_couplings::set_model(const CE6SSM_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void CE6SSM_effective_couplings::copy_mixing_matrices_from_model()
{
...
standard_model::Standard_model CE6SSM_effective_couplings::initialise_SM() const
{
...
void CE6SSM_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> CE6SSM_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> CE6SSM_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> CE6SSM_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double CE6SSM_effective_couplings::number_of_active_flavours(double m) const
{
...
double CE6SSM_effective_couplings::scalar_scaling_factor(double m) const
{
...
double CE6SSM_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double CE6SSM_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double CE6SSM_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double CE6SSM_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double CE6SSM_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> CE6SSM_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> CE6SSM_effective_couplings::CpbarFeFeAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> CE6SSM_effective_couplings::CpbarFeFehhPL(int gO2, int gI2, int gI1) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> CE6SSM_effective_couplings::CpbarFdFdAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> CE6SSM_effective_couplings::CpbarFdFdhhPL(int gO2, int gI2, int gI1) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> CE6SSM_effective_couplings::CpbarFuFuAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> CE6SSM_effective_couplings::CpbarFuFuhhPL(int gO2, int gI2, int gI1) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> CE6SSM_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
...
std::complex<double> CE6SSM_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
...
std::complex<double> CE6SSM_effective_couplings::CphhSeconjSe(int gt1, int gt2, int gt3) const
{
...
std::complex<double> CE6SSM_effective_couplings::CphhSDXconjSDX(int gt1, int gt2, int gt3) const
{
...
std::complex<double> CE6SSM_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
...
std::complex<double> CE6SSM_effective_couplings::CpbarChaChahhPL(int gt3, int gt1, int gt2) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Lambdax = MODELPARAMETER(Lambdax);
...
std::complex<double> CE6SSM_effective_couplings::CpbarFDXFDXhhPL(int gt3, int gt1, int gt2) const
{
   const auto Kappa = MODELPARAMETER(Kappa);
...
std::complex<double> CE6SSM_effective_couplings::CphhSHIpconjSHIp(int gt1, int gt2, int gt3) const
{
...
std::complex<double> CE6SSM_effective_couplings::CpbarChaIChaIhhPL(int gt3, int gt1, int gt2) const
{
   const auto Lambda12 = MODELPARAMETER(Lambda12);
...
std::complex<double> CE6SSM_effective_couplings::CphhSHppconjSHpp(int gt1, int gt2, int gt3) const
{
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
   const auto gN = MODELPARAMETER(gN);
...
std::complex<double> CE6SSM_effective_couplings::CpAhSdconjSd(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto vs = MODELPARAMETER(vs);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> CE6SSM_effective_couplings::CpAhSuconjSu(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto vd = MODELPARAMETER(vd);
   const auto vs = MODELPARAMETER(vs);
...
std::complex<double> CE6SSM_effective_couplings::CpAhSeconjSe(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto vs = MODELPARAMETER(vs);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> CE6SSM_effective_couplings::CpAhSDXconjSDX(int gt1, int gt2, int gt3) const
{
   const auto TKappa = MODELPARAMETER(TKappa);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> CE6SSM_effective_couplings::CpAhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto TLambdax = MODELPARAMETER(TLambdax);
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
...
std::complex<double> CE6SSM_effective_couplings::CpbarChaChaAhPL(int gt3, int gt2, int gt1) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Lambdax = MODELPARAMETER(Lambdax);
...
std::complex<double> CE6SSM_effective_couplings::CpbarFDXFDXAhPL(int gt3, int gt2, int gt1) const
{
   const auto Kappa = MODELPARAMETER(Kappa);
...
std::complex<double> CE6SSM_effective_couplings::CpAhSHIpconjSHIp(int gt1, int gt2, int gt3) const
{
   const auto TLambda12 = MODELPARAMETER(TLambda12);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> CE6SSM_effective_couplings::CpbarChaIChaIAhPL(int gt3, int gt2, int gt1) const
{
   const auto Lambda12 = MODELPARAMETER(Lambda12);
...
void CE6SSM_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
void CE6SSM_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
...
void CE6SSM_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto MCha = MODELPARAMETER(MCha);
...
void CE6SSM_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
