...
#include "CE6SSM_b_to_s_gamma.hpp"
#include "observables/l_to_l_conversion/settings.hpp"
#include "observables/CE6SSM_br_l_to_3l.hpp"
#include "observables/CE6SSM_br_l_to_l_gamma.hpp"
#include "observables/CE6SSM_l_to_l_conversion.hpp"
...
CE6SSM_observables calculate_observables(const CE6SSM_mass_eigenstates& model,
                                              ...
                                              const Spectrum_generator_settings& settings)
{
   ...
   try {
      ...
      observables.AMM1(Fe, 1) = CE6SSM_amm::calculate_amm<CE6SSM_cxx_diagrams::fields::Fe>(MODEL, qedqcd, settings,1);
   } catch (const NonPerturbativeRunningError& e) {
