...
public:
   ...
   void set_decays(const CE6SSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const CE6SSM_slha&, const CE6SSM_scales&, const CE6SSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const CE6SSM_slha&);
   ...
   void fill_decays_data(const CE6SSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CE6SSM_scales&, const CE6SSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, CE6SSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const CE6SSM_slha&);
...
void CE6SSM_slha_io::fill(
   ...
   CE6SSM_decays const * const decays)
{
