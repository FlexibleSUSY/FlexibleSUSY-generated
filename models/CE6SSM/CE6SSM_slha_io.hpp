...
public:
   ...
   void set_extra(const CE6SSM_slha&, const CE6SSM_scales&, const CE6SSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CE6SSM_scales&, const CE6SSM_observables&);
