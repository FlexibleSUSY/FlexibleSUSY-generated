...
public:
   ...
   void fill(CE6SSM_mass_eigenstates&) const;
   template <class Model> void fill(CE6SSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const CE6SSM_slha<Model>&, const CE6SSM_scales&, const CE6SSM_observables&);
   void set_input(const CE6SSM_input_parameters&);
   ...
   template <class Model> void set_spectrum(const CE6SSM_slha<Model>&);
   ...
   static void fill_imminpar_tuple(CE6SSM_input_parameters&, int, double);
   static void fill_imextpar_tuple(CE6SSM_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const CE6SSM_slha<Model>&, const softsusy::QedQcd&, const CE6SSM_scales&, const CE6SSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const CE6SSM_slha<Model>&, const softsusy::QedQcd&, const CE6SSM_scales&, const CE6SSM_observables&);
...
private:
   ...
   void set_imminpar(const CE6SSM_input_parameters&);
   void set_imextpar(const CE6SSM_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const CE6SSM_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(CE6SSM_mass_eigenstates&) const;
   void fill_physical(CE6SSM_physical&) const;
};
 ...
 */
template <class Model>
void CE6SSM_slha_io::fill(CE6SSM_slha<Model>& model) const
{
...
template <class Model>
void CE6SSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const CE6SSM_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const CE6SSM_scales& scales,
   const CE6SSM_observables& observables)
{
   CE6SSM_slha_io slha_io;
   const CE6SSM_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll CE6SSM_slha_io::fill_slhaea(
   const CE6SSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const CE6SSM_scales& scales, const CE6SSM_observables& observables)
{
   SLHAea::Coll slhaea;
   CE6SSM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void CE6SSM_slha_io::set_model_parameters(const CE6SSM_slha<Model>& model)
{
   {
...
void CE6SSM_slha_io::set_extra(
   const CE6SSM_slha<Model>& model, const CE6SSM_scales& scales,
   const CE6SSM_observables& observables)
{
...
{
   set_spectrum(CE6SSM_slha<CE6SSM<T> >(model));
}
 ...
 */
template <class Model>
void CE6SSM_slha_io::set_spectrum(const CE6SSM_slha<Model>& model)
{
   const CE6SSM_physical physical(model.get_physical_slha());
