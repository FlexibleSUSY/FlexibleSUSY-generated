...
const int CE6SSM_soft_parameters::numberOfParameters;
...
CE6SSM_soft_parameters CE6SSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const CE6SSM_susy_parameters susy_betas(CE6SSM_susy_parameters::calc_beta(loops));
...
Eigen::ArrayXd CE6SSM_soft_parameters::get() const
{
...
CE6SSM_soft_parameters::Soft_traces CE6SSM_soft_parameters::calc_soft_traces(int loops) const
{
