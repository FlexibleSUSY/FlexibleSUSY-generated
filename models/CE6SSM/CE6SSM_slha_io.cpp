...
void CE6SSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void CE6SSM_slha_io::fill(CE6SSM_slha& model) const
{
   fill(static_cast<CE6SSM_mass_eigenstates&>(model));
...
void CE6SSM_slha_io::set_extpar(const CE6SSM_input_parameters& input)
{
   ...
   extpar << "Block EXTPAR\n";
   extpar << FORMAT_ELEMENT(67, input.m0SqGuess, "m0SqGuess");
   extpar << FORMAT_ELEMENT(68, input.m12Guess, "m12Guess");
   extpar << FORMAT_ELEMENT(69, input.AzeroGuess, "AzeroGuess");
 ...
 * @param input struct of input parameters
 */
void CE6SSM_slha_io::set_imminpar(const CE6SSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CE6SSM_slha_io::set_imextpar(const CE6SSM_input_parameters& input)
{
 ...
 */
void CE6SSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void CE6SSM_slha_io::set_input(const CE6SSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void CE6SSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void CE6SSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void CE6SSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void CE6SSM_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void CE6SSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void CE6SSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void CE6SSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void CE6SSM_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, CE6SSM_info::model_name)
 ...
 */
void CE6SSM_slha_io::set_model_parameters(const CE6SSM_slha& model)
{
   {
...
void CE6SSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void CE6SSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void CE6SSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void CE6SSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void CE6SSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void CE6SSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, CE6SSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void CE6SSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = CE6SSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + CE6SSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void CE6SSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void CE6SSM_slha_io::set_spectrum(const CE6SSM_slha& model)
{
   const CE6SSM_physical physical(model.get_physical_slha());
 ...
 */
void CE6SSM_slha_io::set_extra(
   const CE6SSM_slha& model,
   ...
   const flexiblesusy::Spectrum_generator_settings& spectrum_generator_settings)
{
   ...
   }
   {
      ...
      block << "Block EWSBOutputs" << '\n'
            << FORMAT_ELEMENT(1, (EXTRAPARAMETER(m0Sq)), "m0Sq")
            << FORMAT_ELEMENT(2, (EXTRAPARAMETER(m12)), "m12")
            << FORMAT_ELEMENT(3, (EXTRAPARAMETER(Azero)), "Azero")
      ;
      slha_io.set_block(block);
   }
   {
 ...
 */
void CE6SSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void CE6SSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void CE6SSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void CE6SSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
void CE6SSM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void CE6SSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void CE6SSM_slha_io::fill_drbar_parameters(CE6SSM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void CE6SSM_slha_io::fill(CE6SSM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   CE6SSM_physical physical_hk;
 ...
 */
void CE6SSM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void CE6SSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void CE6SSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}
...
{
   switch (key) {
   case 67: input.m0SqGuess = value; break;
   case 68: input.m12Guess = value; break;
   case 69: input.AzeroGuess = value; break;
...
void CE6SSM_slha_io::fill_imminpar_tuple(CE6SSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void CE6SSM_slha_io::fill_imextpar_tuple(CE6SSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void CE6SSM_slha_io::fill_physical(CE6SSM_physical& physical) const
{
   {
