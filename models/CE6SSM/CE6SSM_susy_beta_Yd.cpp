...
// File generated at Sun 26 Aug 2018 13:46:20
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_Yd = (twoLoop*(Yd*(-9*traceYdAdjYdYdAdjYd - 3*traceYdAdjYuYuAdjYd - 3*
      traceYeAdjYeYeAdjYe + 4.588888888888889*Quad(g1) + 16.5*Quad(g2) +
      ...
      *Yd) - 2*(Yd*Yu.adjoint()*Yu*Yd.adjoint()*Yd) - 2*(Yd*Yu.adjoint()*Yu*Yu.
      adjoint()*Yu))).real();
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yd_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yd_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
