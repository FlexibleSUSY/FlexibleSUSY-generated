...
// File generated at Mon 5 Mar 2018 17:18:37
 ...
 *
 * This file was generated at Mon 5 Mar 2018 17:18:37 with FlexibleSUSY
...
public:
   ...
   const Eigen::Matrix<double,3,3>& get_mDx2Coeff1() const { return
      solutions.get_mDx2Coeff1(); }
   const Eigen::Matrix<double,3,3>& get_mDx2Coeff2() const { return
      solutions.get_mDx2Coeff2(); }
   const Eigen::Matrix<double,3,3>& get_mDx2Coeff3() const { return
      solutions.get_mDx2Coeff3(); }
   const Eigen::Matrix<double,3,3>& get_mDx2Coeff4() const { return
      solutions.get_mDx2Coeff4(); }

   const Eigen::Matrix<double,3,3>& get_mDxbar2Coeff1() const { return
      solutions.get_mDxbar2Coeff1(); }
   const Eigen::Matrix<double,3,3>& get_mDxbar2Coeff2() const { return
      solutions.get_mDxbar2Coeff2(); }
   const Eigen::Matrix<double,3,3>& get_mDxbar2Coeff3() const { return
      solutions.get_mDxbar2Coeff3(); }
   const Eigen::Matrix<double,3,3>& get_mDxbar2Coeff4() const { return
      solutions.get_mDxbar2Coeff4(); }
   ...
   const Eigen::Matrix<double,2,2>& get_msI2Coeff1() const { return
      solutions.get_msI2Coeff1(); }
   const Eigen::Matrix<double,2,2>& get_msI2Coeff2() const { return
      solutions.get_msI2Coeff2(); }
   const Eigen::Matrix<double,2,2>& get_msI2Coeff3() const { return
      solutions.get_msI2Coeff3(); }
   const Eigen::Matrix<double,2,2>& get_msI2Coeff4() const { return
      solutions.get_msI2Coeff4(); }
