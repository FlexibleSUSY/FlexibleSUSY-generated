...
// CE6SSM_parameter_getter ////////////////////////////////////////

std::vector<std::string> CE6SSM_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, CE6SSM_info::NUMBER_OF_MIXINGS> CE6SSM_parameter_getter::get_mixing_names()
{
   return CE6SSM_info::particle_mixing_names;
}

Eigen::ArrayXd CE6SSM_parameter_getter::get_parameters(const CE6SSM_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, CE6SSM_info::NUMBER_OF_PARAMETERS> CE6SSM_parameter_getter::get_parameter_names()
{
   return CE6SSM_info::parameter_names;
}

std::array<std::string, CE6SSM_info::NUMBER_OF_PARTICLES> CE6SSM_parameter_getter::get_particle_names()
{
   return CE6SSM_info::particle_names;
}

std::vector<std::string> CE6SSM_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> CE6SSM_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, CE6SSM_info::NUMBER_OF_MIXINGS> CE6SSM_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, CE6SSM_info::NUMBER_OF_MIXINGS> CE6SSM_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, CE6SSM_info::NUMBER_OF_INPUT_PARAMETERS> CE6SSM_parameter_getter::get_input_parameter_names()
{
   return CE6SSM_info::input_parameter_names;
}

std::array<std::string, CE6SSM_info::NUMBER_OF_EXTRA_PARAMETERS> CE6SSM_parameter_getter::get_extra_parameter_names()
{
   return CE6SSM_info::extra_parameter_names;
}

decltype(CE6SSM_info::NUMBER_OF_MASSES) CE6SSM_parameter_getter::get_number_of_masses()
{
   return CE6SSM_info::NUMBER_OF_MASSES;
}

// CE6SSM_spectrum_plotter ////////////////////////////////////////

CE6SSM_spectrum_plotter::CE6SSM_spectrum_plotter(const CE6SSM_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void CE6SSM_spectrum_plotter::extract_spectrum(const CE6SSM_mass_eigenstates& model)
{
   spectrum.clear();
...
void CE6SSM_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("CE6SSM_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("CE6SSM_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("CE6SSM_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void CE6SSM_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("CE6SSM_spectrum_plotter::write_spectrum: "
 ...
 */
void to_database(
   const std::string& file_name, const CE6SSM_mass_eigenstates& model,
   const softsusy::QedQcd* qedqcd, const Physical_input* physical_input,
   const CE6SSM_observables* observables)
{
   ...
   append(names, CE6SSM_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, CE6SSM_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, CE6SSM_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, CE6SSM_parameter_getter::get_DRbar_mass_names());
   append(names, CE6SSM_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, CE6SSM_parameter_getter::get_pole_mass_names());
   append(names, CE6SSM_parameter_getter::get_pole_mixing_names());
   ...
   if (CE6SSM_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, CE6SSM_observables::get_names());
 ...
 */
CE6SSM_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, CE6SSM_observables* observables)
{
   CE6SSM_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = CE6SSM_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = CE6SSM_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = CE6SSM_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = CE6SSM_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? CE6SSM_observables::NUMBER_OF_OBSERVABLES : 0);
