...
/**
 * @file CE6SSM_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Mon 5 Mar 2018 17:17:48 with FlexibleSUSY
...
#define CLASSNAME CE6SSM_mass_eigenstates
...
CLASSNAME::CE6SSM_mass_eigenstates(const CE6SSM_input_parameters& input_)
   : CE6SSM_soft_parameters(input_)
#if defined(ENABLE_SEMI_ANALYTIC_SOLVER)
   , ewsb_solver(new CE6SSM_ewsb_solver<Semi_analytic>())
#endif
{
}
...
const CE6SSM_physical& CLASSNAME::get_physical() const
{
   return physical;
}

CE6SSM_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const CE6SSM_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<CE6SSM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("CE6SSM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("CE6SSM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("CE6SSM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving CE6SSM EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "CE6SSM\n"
           "========================================\n";
   CE6SSM_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::Se);
   if (PHYSICAL(MSDX).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::SDX);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::Hpm);
   if (PHYSICAL(MSHI0).tail<4>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::SHI0);
   if (PHYSICAL(MSHIp).tail<4>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::SHIp);
   if (PHYSICAL(MSSI0).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::SSI0);
   if (PHYSICAL(MSHp0).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::SHp0);
   if (PHYSICAL(MSHpp).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(CE6SSM_info::SHpp);
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(CE6SSM_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = CE6SSM_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CE6SSM_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Sd, eigenvalue_error > precision *
      Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Sv, eigenvalue_error > precision *
      Abs(MSv(0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Su, eigenvalue_error > precision *
      Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Se, eigenvalue_error > precision *
      Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::Se);
   }
...
void CLASSNAME::calculate_MSDX()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SDX, MSDX, ZDX, eigenvalue_error)
      ;
   problems.flag_bad_mass(CE6SSM_info::SDX, eigenvalue_error > precision
      * Abs(MSDX(0)));
#else
   ...
   if (MSDX.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::SDX);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::hh, eigenvalue_error > precision *
      Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Ah, eigenvalue_error > precision *
      Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Hpm, eigenvalue_error > precision
      * Abs(MHpm(0)));
#else
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Chi, eigenvalue_error > precision
      * Abs(MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Cha, eigenvalue_error > precision
      * Abs(MCha(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Fe, eigenvalue_error > precision *
      Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Fd, eigenvalue_error > precision *
      Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Fu, eigenvalue_error > precision *
      Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFDX()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::FDX, eigenvalue_error > precision
      * Abs(MFDX(0)));
#else
...
void CLASSNAME::calculate_MSHI0()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SHI0, MSHI0, UHI0,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::SHI0, eigenvalue_error > precision
      * Abs(MSHI0(0)));
#else
   fs_diagonalize_hermitian(mass_matrix_SHI0, MSHI0, UHI0);
#endif
   ...
   if (MSHI0.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::SHI0);
   }
...
void CLASSNAME::calculate_MSHIp()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SHIp, MSHIp, UHIp,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::SHIp, eigenvalue_error > precision
      * Abs(MSHIp(0)));
#else
   fs_diagonalize_hermitian(mass_matrix_SHIp, MSHIp, UHIp);
#endif
   ...
   if (MSHIp.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::SHIp);
   }
...
void CLASSNAME::calculate_MChaI()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::ChaI, eigenvalue_error > precision
      * Abs(MChaI(0)));
#else
...
void CLASSNAME::calculate_MChiI()
{
   ...
   fs_diagonalize_symmetric(mass_matrix_ChiI, MChiI, ZNI,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::ChiI, eigenvalue_error > precision
      * Abs(MChiI(0)));
#else
   fs_diagonalize_symmetric(mass_matrix_ChiI, MChiI, ZNI);
#endif
...
void CLASSNAME::calculate_MSSI0()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SSI0, MSSI0, ZSSI,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::SSI0, eigenvalue_error > precision
      * Abs(MSSI0(0)));
#else
   fs_diagonalize_hermitian(mass_matrix_SSI0, MSSI0, ZSSI);
#endif
   ...
   if (MSSI0.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::SSI0);
   }
...
void CLASSNAME::calculate_MFSI()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::FSI, eigenvalue_error > precision
      * Abs(MFSI(0)));
#else
...
void CLASSNAME::calculate_MSHp0()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SHp0, MSHp0, UHp0,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::SHp0, eigenvalue_error > precision
      * Abs(MSHp0(0)));
#else
   fs_diagonalize_hermitian(mass_matrix_SHp0, MSHp0, UHp0);
#endif
   ...
   if (MSHp0.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::SHp0);
   }
...
void CLASSNAME::calculate_MSHpp()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SHpp, MSHpp, UHpp,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::SHpp, eigenvalue_error > precision
      * Abs(MSHpp(0)));
#else
   fs_diagonalize_hermitian(mass_matrix_SHpp, MSHpp, UHpp);
#endif
   ...
   if (MSHpp.minCoeff() < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::SHpp);
   }
...
void CLASSNAME::calculate_MChiP()
{
   ...
   fs_diagonalize_symmetric(mass_matrix_ChiP, MChiP, ZNp,
      eigenvalue_error);
   problems.flag_bad_mass(CE6SSM_info::ChiP, eigenvalue_error > precision
      * Abs(MChiP(0)));
#else
   fs_diagonalize_symmetric(mass_matrix_ChiP, MChiP, ZNp);
#endif
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(CE6SSM_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CE6SSM_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::VZp))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CE6SSM_info::VZp);
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::Sd))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZD;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZD,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::Sd, eigenvalue_error >
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::Sv))
      return;
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      Eigen::Matrix<double,3,3> mix_ZV;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::Sv, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::Su))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZU;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::Su, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::Se))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZE;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::Se, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::SDX))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> self_energy = Re(self_energy_SDX_1loop
         (p));
      const Eigen::Matrix<double,6,6> M_loop(M_tree - self_energy);
      Eigen::Array<double,6,1> eigen_values;
      Eigen::Matrix<double,6,6> mix_ZDX;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZDX,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::SDX, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZDX);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::hh))
      return;
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(CE6SSM_info::hh);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CE6SSM_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(CE6SSM_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::Ah))
      return;
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(CE6SSM_info::Ah);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CE6SSM_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(CE6SSM_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::Hpm))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(CE6SSM_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CE6SSM_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(CE6SSM_info::Hpm);
}
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      decltype(ZN) mix_ZN;
         ...
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZN,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::Chi, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZN);
      #endif
...
void CLASSNAME::calculate_MCha_pole()
{
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      problems.flag_bad_mass(CE6SSM_info::Cha, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER, eigenvalue_error)
         ;
      problems.flag_bad_mass(CE6SSM_info::Fe, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR, eigenvalue_error)
         ;
      problems.flag_bad_mass(CE6SSM_info::Fd, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR, eigenvalue_error)
         ;
      problems.flag_bad_mass(CE6SSM_info::Fu, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFDX_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZDXL, mix_ZDXR,
         eigenvalue_error);
      problems.flag_bad_mass(CE6SSM_info::FDX, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
      fs_svd(M_loop, eigen_values, mix_ZDXL, mix_ZDXR);
   #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::SHI0))
      return;
   ...
   for (int es = 0; es < 4; ++es) {
      ...
      Eigen::Matrix<double,4,4> mix_UHI0;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHI0,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::SHI0, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHI0);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::SHIp))
      return;
   ...
   for (int es = 0; es < 4; ++es) {
      ...
      Eigen::Matrix<double,4,4> mix_UHIp;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHIp,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::SHIp, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHIp);
      #endif
...
void CLASSNAME::calculate_MChaI_pole()
{
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZMI, mix_ZPI, eigenvalue_error)
         ;
      problems.flag_bad_mass(CE6SSM_info::ChaI, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
   ...
   for (int es = 0; es < 4; ++es) {
      ...
      decltype(ZNI) mix_ZNI;
         ...
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZNI,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::ChiI, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZNI);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::SSI0))
      return;
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZSSI;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZSSI,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::SSI0, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZSSI);
      #endif
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      decltype(ZFSI) mix_ZFSI;
         ...
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZFSI,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::FSI, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZFSI);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::SHp0))
      return;
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_UHp0;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHp0,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::SHp0, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHp0);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::SHpp))
      return;
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_UHpp;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHpp,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::SHpp, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_UHpp);
      #endif
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      decltype(ZNp) mix_ZNp;
         ...
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZNp,
            eigenvalue_error);
         problems.flag_bad_mass(CE6SSM_info::ChiP, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZNp);
      #endif
...
{
   if (!force_output && problems.is_running_tachyon(CE6SSM_info::VWm))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CE6SSM_info::VWm);
...
std::ostream& operator<<(std::ostream& ostr, const CE6SSM_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
