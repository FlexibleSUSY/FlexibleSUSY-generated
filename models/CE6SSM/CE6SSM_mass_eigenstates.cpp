...
// File generated at Sun 26 Aug 2018 14:01:07
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:01:07 with FlexibleSUSY
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Sd, eigenvalue_error > precision * Abs(
      MSd(0)));
#else
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Sv, eigenvalue_error > precision * Abs(
      MSv(0)));
#else
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Su, eigenvalue_error > precision * Abs(
      MSu(0)));
#else
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Se, eigenvalue_error > precision * Abs(
      MSe(0)));
#else
...
void CLASSNAME::calculate_MSDX()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::SDX, eigenvalue_error > precision * Abs(
      MSDX(0)));
#else
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::hh, eigenvalue_error > precision * Abs(
      Mhh(0)));
#else
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Ah, eigenvalue_error > precision * Abs(
      MAh(0)));
#else
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Hpm, eigenvalue_error > precision * Abs(
      MHpm(0)));
#else
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Chi, eigenvalue_error > precision * Abs(
      MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Cha, eigenvalue_error > precision * Abs(
      MCha(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Fe, eigenvalue_error > precision * Abs(
      MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Fd, eigenvalue_error > precision * Abs(
      MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::Fu, eigenvalue_error > precision * Abs(
      MFu(0)));
#else
...
void CLASSNAME::calculate_MFDX()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::FDX, eigenvalue_error > precision * Abs(
      MFDX(0)));
#else
...
void CLASSNAME::calculate_MSHI0()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::SHI0, eigenvalue_error > precision * Abs
      (MSHI0(0)));
#else
...
void CLASSNAME::calculate_MSHIp()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::SHIp, eigenvalue_error > precision * Abs
      (MSHIp(0)));
#else
...
void CLASSNAME::calculate_MChaI()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::ChaI, eigenvalue_error > precision * Abs
      (MChaI(0)));
#else
...
void CLASSNAME::calculate_MChiI()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::ChiI, eigenvalue_error > precision * Abs
      (MChiI(0)));
#else
...
void CLASSNAME::calculate_MSSI0()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::SSI0, eigenvalue_error > precision * Abs
      (MSSI0(0)));
#else
...
void CLASSNAME::calculate_MFSI()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::FSI, eigenvalue_error > precision * Abs(
      MFSI(0)));
#else
...
void CLASSNAME::calculate_MSHp0()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::SHp0, eigenvalue_error > precision * Abs
      (MSHp0(0)));
#else
...
void CLASSNAME::calculate_MSHpp()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::SHpp, eigenvalue_error > precision * Abs
      (MSHpp(0)));
#else
...
void CLASSNAME::calculate_MChiP()
{
   ...
   problems.flag_bad_mass(CE6SSM_info::ChiP, eigenvalue_error > precision * Abs
      (MChiP(0)));
#else
...
std::complex<double> CLASSNAME::CpHpmUSvconjHpmconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(20*IF(gO1 < 3,-(AbsSqr(Ye(gO1,gO1))*
      ...
      -3*Sqr(g1) + 5*Sqr(g2) + 3*Sqr(gN))*ZP(gI1,0)*ZP(gI2,0) + (3*Sqr(g1) - 5*Sqr
      (g2) + 2*Sqr(gN))*ZP(gI1,1)*ZP(gI2,1)));
...
std::complex<double> CLASSNAME::CpSeUSvconjSeconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(20*IF(gO1 < 3,IF(gO2 < 3,-0.5*Conj(ZE
      (gI1,gO2))*Sqr(g2)*ZE(gI2,gO1),0),0) + 20*IF(gO1 < 3,IF(gO2 < 3,-(Conj(Ye(
...
std::complex<double> CLASSNAME::CpbarChaChaVZPL(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(20*g2*Conj(UM(gI2,0))*Cos(ThetaW())*
      Cos(ThetaWp())*UM(gI1,0) + Conj(UM(gI2,1))*(10*g2*Cos(ThetaW())*Cos(ThetaWp(
...
std::complex<double> CLASSNAME::CpSuconjSuVZVZ(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.016666666666666666*((-4.898979485566356*
      g1*gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + 30*Sqr(g2)*Sqr(Cos(
      ThetaW()))*Sqr(Cos(ThetaWp())) + Cos(ThetaW())*(9.486832980505138*g2*gN*Sin(
      2*ThetaWp()) - 15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Cos(ThetaWp()))) +
      2*Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 3*Sqr(gN)*Sqr(Sin(ThetaWp
      ())))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)) + (19.595917942265423*g1*gN*
      Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + 32*Sqr(g1)*Sqr(Cos(ThetaWp()))
      *Sqr(Sin(ThetaW())) + 3*Sqr(gN)*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZU(gI1,
      3 + j1))*ZU(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::CpbarChaChaVZpPL(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(-20*g2*Conj(UM(gI2,0))*Cos(ThetaW())*
      Sin(ThetaWp())*UM(gI1,0) + Conj(UM(gI2,1))*(9.486832980505138*gN*Cos(ThetaWp
...
std::complex<double> CLASSNAME::CpSdconjSdVZpVZp(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.016666666666666666*((3*Sqr(gN)*Sqr(Cos(
      ...
      15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,Conj
      (ZD(gI1,j1))*ZD(gI2,j1)) + 4*(3*Sqr(gN)*Sqr(Cos(ThetaWp())) + g1*Sin(ThetaW(
      ))*(2.449489742783178*gN*Sin(2*ThetaWp()) + 2*g1*Sin(ThetaW())*Sqr(Sin(
...
std::complex<double> CLASSNAME::CpSuconjSuVZpVZp(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.016666666666666666*((3*Sqr(gN)*Sqr(Cos(
      ...
      Sin(ThetaWp()))) - Cos(ThetaW())*(9.486832980505138*g2*gN*Sin(2*ThetaWp()) +
      15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,Conj
      (ZU(gI1,j1))*ZU(gI2,j1)) + (-19.595917942265423*g1*gN*Cos(ThetaWp())*Sin(
...
std::complex<double> CLASSNAME::CpbarUChaChaVZPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(20*g2*Conj(UM(gI2,0))*Cos(ThetaW())*
      Cos(ThetaWp())*KroneckerDelta(0,gO1) + Conj(UM(gI2,1))*KroneckerDelta(1,gO1)
      *(10*g2*Cos(ThetaW())*Cos(ThetaWp()) - 7.745966692414834*g1*Cos(ThetaWp())*
      Sin(ThetaW()) + 9.486832980505138*gN*Sin(ThetaWp())));
...
std::complex<double> CLASSNAME::CpbarUChaChaVZpPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = 0.1*(-10*g2*Cos(ThetaW())*KroneckerDelta(0,
      gO2)*Sin(ThetaWp())*UP(gI2,0) + KroneckerDelta(1,gO2)*(-3.1622776601683795*
      gN*Cos(ThetaWp()) + (-5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()
...
std::complex<double> CLASSNAME::CpbarUChaChaVZpPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(-20*g2*Conj(UM(gI2,0))*Cos(ThetaW())*
      KroneckerDelta(0,gO1)*Sin(ThetaWp()) + Conj(UM(gI2,1))*KroneckerDelta(1,gO1)
      *(9.486832980505138*gN*Cos(ThetaWp()) + 2*(-5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp())));
...
std::complex<double> CLASSNAME::CpbarFdChiSdPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.03333333333333333*(-30*SUM(j1,0,2,Conj(Yd
      (j1,j1))*Conj(ZD(gI1,3 + j1))*ZDL(gO1,j1))*ZN(gI2,2) - SUM(j1,0,2,Conj(ZD(
...
std::complex<double> CLASSNAME::CpbarFuChiSuPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.03333333333333333*(-30*SUM(j1,0,2,Conj(Yu
      (j1,j1))*Conj(ZU(gI1,3 + j1))*ZUL(gO1,j1))*ZN(gI2,3) - SUM(j1,0,2,Conj(ZU(
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(CE6SSM_info::hh, eigenvalue_error >
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(CE6SSM_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(CE6SSM_info::Hpm, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
