...
// File generated at Mon 5 Mar 2018 17:18:57

/**
 * @file CE6SSM_a_muon.cpp
 *
 * This file was generated at Mon 5 Mar 2018 17:18:57 with FlexibleSUSY
...
#include "CE6SSM_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(CE6SSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const CE6SSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("CE6SSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double CE6SSM_a_muon::calculate_a_muon(const CE6SSM_mass_eigenstates& model_)
{
...
double CE6SSM_a_muon::calculate_a_muon_uncertainty(const CE6SSM_mass_eigenstates& model_)
{
   CE6SSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("CE6SSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
