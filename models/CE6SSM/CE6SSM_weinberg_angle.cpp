...
// File generated at Mon 5 Mar 2018 17:18:22

#include "CE6SSM_mass_eigenstates.hpp"
#include "CE6SSM_weinberg_angle.hpp"
...
#define CLASSNAME CE6SSM_weinberg_angle
 ...
 */
CLASSNAME::CE6SSM_weinberg_angle(
...
void CLASSNAME::set_model(const CE6SSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * CE6SSM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * CE6SSM_info::normalization_g2;
