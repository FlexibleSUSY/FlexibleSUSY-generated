 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (-0.03333333333333333*Yu*(-90*traceYuAdjYu - 30*AbsSqr(Lambdax) +
      26*Sqr(g1) + 90*Sqr(g2) + 160*Sqr(g3) + 9*Sqr(gN)) + Yu*Yd.adjoint()*Yd +
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (0.0005555555555555556*Yu*(-5400*traceYdAdjYuYuAdjYd - 16200*
      traceYuAdjYuYuAdjYu - 5400*traceKappaAdjKappa*AbsSqr(Lambdax) - 3600*
      traceLambda12AdjLambda12*AbsSqr(Lambdax) - 5400*traceYdAdjYd*AbsSqr(
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
