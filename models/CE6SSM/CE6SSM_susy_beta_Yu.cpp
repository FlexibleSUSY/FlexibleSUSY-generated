...
// File generated at Mon 5 Mar 2018 16:03:21
...
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (twoLoop*(Yu*(-3*traceYdAdjYuYuAdjYd - 9*traceYuAdjYuYuAdjYu
      + 8.695555555555556*Quad(g1) + 16.5*Quad(g2) + 14.222222222222221*Quad(
      g3) + 2.865*Quad(gN) + 16*traceYuAdjYu*Sqr(g3) + 8*Sqr(g2)*Sqr(g3) + Sqr(
      g1)*(0.8*traceYuAdjYu + Sqr(g2) + 3.022222222222222*Sqr(g3) +
