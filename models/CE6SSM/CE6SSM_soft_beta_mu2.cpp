...
Eigen::Matrix<double,3,3> CE6SSM_soft_parameters::calc_beta_mu2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mu2 = (4*mHu2*(Yu*Yu.adjoint()) + 4*(TYu*(TYu).adjoint()) + 2*(mu2*Yu*
      ...
      0.03333333333333333*(30.983866769659336*g1*Tr11 - 9.486832980505138*gN*
      Tr14 + 64*AbsSqr(MassB)*Sqr(g1) + 320*AbsSqr(MassG)*Sqr(g3) + 6*AbsSqr(
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_soft_parameters::calc_beta_mu2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
