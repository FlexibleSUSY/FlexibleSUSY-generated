...
// File generated at Mon 5 Mar 2018 16:04:31
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_soft_parameters::calc_beta_mu2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_soft_parameters::calc_beta_mu2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mu2 = (twoLoop*(-0.8*(15*traceconjTYuTpTYu + 15*tracemq2AdjYuYu +
      ...
      *(2*MassB + MassG)*Sqr(g3) + 3*(2*MassB + MassBp)*Sqr(gN)) + 20*(3*(-4*g1
      *(2.449489742783178*gN*(Tr2U114 + Tr2U141) + 15.491933384829668*Tr31) + 3
      *gN*(gN*Tr2U144 + 6.324555320336759*Tr34) + 160*Tr23*Quad(g3) + 32*
      Tr2U111*Sqr(g1)) + 8*Conj(MassG)*Sqr(g3)*(32*(MassB + 2*MassG)*Sqr(g1) +
      300*MassG*Sqr(g3) + 3*(MassBp + 2*MassG)*Sqr(gN))))*UNITMATRIX(3))).real(
      );
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_soft_parameters::calc_beta_mu2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_soft_parameters::calc_beta_mu2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
