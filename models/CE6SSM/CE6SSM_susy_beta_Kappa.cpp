...
// File generated at Wed 16 Oct 2019 18:57:48
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Kappa_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Kappa_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CE6SSM_susy_parameters::calc_beta_Kappa_3_loop(const Susy_traces& susy_traces) const
{
