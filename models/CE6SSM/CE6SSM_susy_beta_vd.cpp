...
// File generated at Wed 16 Oct 2019 18:57:55
 ...
 */
double CE6SSM_susy_parameters::calc_beta_vd_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vd = Re(0.05*oneOver16PiSqr*vd*(-60*traceYdAdjYd - 20*traceYeAdjYe - 20
      *AbsSqr(Lambdax) + 6*Sqr(g1) + 30*Sqr(g2) + 9*Sqr(gN)));
 ...
 */
double CE6SSM_susy_parameters::calc_beta_vd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double CE6SSM_susy_parameters::calc_beta_vd_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CE6SSM_susy_parameters::calc_beta_vd_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double CE6SSM_susy_parameters::calc_beta_vd_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
