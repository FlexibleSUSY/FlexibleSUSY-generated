...
/**
 * @file CE6SSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Fri 10 Apr 2020 18:42:50 with FlexibleSUSY
 * 2.4.2 (git commit: a94199e5620b8684f5d30d0eece5757a5a72c4a4) and SARAH 4.14.3 .
 */

#ifndef CE6SSM_EWSB_SOLVER_INTERFACE_H
#define CE6SSM_EWSB_SOLVER_INTERFACE_H
...
class CE6SSM_ewsb_solver_interface {
public:
   virtual ~CE6SSM_ewsb_solver_interface() {}
   ...
   virtual int solve(CE6SSM_mass_eigenstates&) = 0;
};
