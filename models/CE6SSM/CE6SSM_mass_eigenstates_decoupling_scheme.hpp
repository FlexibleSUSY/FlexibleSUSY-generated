...
/**
 * @file CE6SSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef CE6SSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define CE6SSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
#define SUPER(p) CE6SSM_soft_parameters::p
...
/**
 * @class CE6SSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class CE6SSM_mass_eigenstates_decoupling_scheme
   : private CE6SSM_soft_parameters
   , public CE6SSM_mass_eigenstates_interface
{
public:
   explicit CE6SSM_mass_eigenstates_decoupling_scheme(const CE6SSM_input_parameters& input_ = CE6SSM_input_parameters());
   explicit CE6SSM_mass_eigenstates_decoupling_scheme(const CE6SSM_mass_eigenstates&);
   CE6SSM_mass_eigenstates_decoupling_scheme(const CE6SSM_mass_eigenstates_decoupling_scheme&) = default;
   CE6SSM_mass_eigenstates_decoupling_scheme(CE6SSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~CE6SSM_mass_eigenstates_decoupling_scheme() = default;
   CE6SSM_mass_eigenstates_decoupling_scheme& operator=(const CE6SSM_mass_eigenstates_decoupling_scheme&) = default;
   CE6SSM_mass_eigenstates_decoupling_scheme& operator=(CE6SSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<CE6SSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const CE6SSM_mass_eigenstates&);
   ...
   const CE6SSM_input_parameters& get_input_parameters() const override;
   CE6SSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const CE6SSM_physical& get_physical() const override;
   CE6SSM_physical& get_physical() override;
   ...
   void set_physical(const CE6SSM_physical&) override;
   ...
   void set_m12(double m12_) override { m12 = m12_; }
   void set_Azero(double Azero_) override { Azero = Azero_; }
   void set_MuPrBV(double MuPrBV_) override { MuPrBV = MuPrBV_; }

   double get_m0Sq() const override { return m0Sq; }
   double get_m12() const override { return m12; }
   double get_Azero() const override { return Azero; }
   double get_MuPrBV() const override { return MuPrBV; }
...
std::ostream& operator<<(std::ostream&, const CE6SSM_mass_eigenstates_decoupling_scheme&);
