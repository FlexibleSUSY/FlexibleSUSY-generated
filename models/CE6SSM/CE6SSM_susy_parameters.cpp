...
// File generated at Mon 5 Mar 2018 16:03:17
...
const int CE6SSM_susy_parameters::numberOfParameters;
...
CE6SSM_susy_parameters CE6SSM_susy_parameters::calc_beta(int loops) const
{
   ...
   return CE6SSM_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
Eigen::ArrayXd CE6SSM_susy_parameters::get() const
{
...
CE6SSM_input_parameters& CE6SSM_susy_parameters::get_input()
{
   return input;
}
...
CE6SSM_susy_parameters::Susy_traces CE6SSM_susy_parameters::calc_susy_traces(int loops) const
{
