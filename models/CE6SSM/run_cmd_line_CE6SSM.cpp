...
// File generated at Fri 10 Apr 2020 18:43:17
...
int run_solver(const CE6SSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(CE6SSM_slha_io::fill_slhaea(
...
int run(int solver_type, const CE6SSM_input_parameters& input)
{
   int exit_code = 0;
...
#ifdef ENABLE_SEMI_ANALYTIC_SOLVER
   case 2:
      exit_code = run_solver<Semi_analytic>(input);
