...
#ifndef CE6SSM_SEMI_ANALYTIC_LOW_SCALE_CONSTRAINT_H
#define CE6SSM_SEMI_ANALYTIC_LOW_SCALE_CONSTRAINT_H

#include "CE6SSM_low_scale_constraint.hpp"
...
template<>
class CE6SSM_low_scale_constraint<Semi_analytic> : public Single_scale_constraint {
public:

   CE6SSM_low_scale_constraint() = default;
   CE6SSM_low_scale_constraint(CE6SSM<Semi_analytic>*, const softsusy::QedQcd&);
   virtual ~CE6SSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "CE6SSM low-scale constraint"; }
