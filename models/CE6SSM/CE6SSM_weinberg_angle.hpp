...
#ifndef CE6SSM_WEINBERG_ANGLE_H
#define CE6SSM_WEINBERG_ANGLE_H
...
public:
   ...
   CE6SSM_weinberg_angle(const CE6SSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const CE6SSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const CE6SSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
