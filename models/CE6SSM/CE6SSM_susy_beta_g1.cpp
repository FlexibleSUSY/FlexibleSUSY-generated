 ...
 */
double CE6SSM_susy_parameters::calc_beta_g1_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CE6SSM_susy_parameters::calc_beta_g1_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CE6SSM_susy_parameters::calc_beta_g1_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CE6SSM_susy_parameters::calc_beta_g1_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double CE6SSM_susy_parameters::calc_beta_g1_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
