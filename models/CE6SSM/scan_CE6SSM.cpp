...
struct CE6SSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
CE6SSM_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   CE6SSM_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, CE6SSM_input_parameters& input,
...
#ifdef ENABLE_SEMI_ANALYTIC_SOLVER
      case 2:
         result = run_parameter_point<Semi_analytic>(loop_library, qedqcd, input);
