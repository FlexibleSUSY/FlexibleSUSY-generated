...
// File generated at Tue 22 Jan 2019 15:18:08

/**
 * @file CE6SSM_semi_analytic_ewsb_solver.cpp
 *
 * @brief implementation of EWSB solver for semi-analytic iteration
 *
 * This file was generated at Tue 22 Jan 2019 15:18:08 with FlexibleSUSY
...
#define CLASSNAME CE6SSM_ewsb_solver<Semi_analytic>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(CE6SSM_mass_eigenstates& model_to_solve)
{
   ...
   auto ewsb_stepper = [this, model](const EWSB_vector_t& ewsb_pars) mutable -> EWSB_vector_t {
      const double m0Sq = ewsb_pars(0);
      const double m12 = ewsb_pars(1);
      const double Azero = ewsb_pars(2);

      model.set_m0Sq(m0Sq);
      model.set_m12(m12);
      model.set_Azero(Azero);
...
int CLASSNAME::solve_iteratively_with(
   CE6SSM_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(CE6SSM_mass_eigenstates& model, const EWSB_solver* solver)
{
   const auto solution = solver->get_solution();

   const double m0Sq = solution(0);
   const double m12 = solution(1);
   const double Azero = solution(2);
   model.set_m0Sq(m0Sq);
   model.set_m12(m12);
   model.set_Azero(Azero);
...
void CLASSNAME::set_best_ewsb_solution(CE6SSM_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(CE6SSM_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(CE6SSM_mass_eigenstates& model_to_solve)
{
   if (!solutions) {
      throw SetupError("CE6SSM_ewsb_solver<Semi_analytic>:solve: "
...
int CLASSNAME::solve_tree_level(CE6SSM_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(
   const CE6SSM_mass_eigenstates& model) const
{
...
void CLASSNAME::set_semi_analytic_solutions(
   CE6SSM_semi_analytic_solutions* s)
{
   solutions = s;
}
