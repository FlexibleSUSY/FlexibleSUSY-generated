...
class CE6SSM_slha : public CE6SSM_mass_eigenstates {
public:
   explicit CE6SSM_slha(const CE6SSM_input_parameters& input_ = CE6SSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit CE6SSM_slha(const CE6SSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
