...
/**
 * @file CE6SSM_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 22 Jan 2019 15:17:29

#ifndef CE6SSM_SLHA_H
#define CE6SSM_SLHA_H
...
class CE6SSM_slha : public Model {
public:
   explicit CE6SSM_slha(const CE6SSM_input_parameters& input_ = CE6SSM_input_parameters());
   explicit CE6SSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   CE6SSM_slha(const CE6SSM_slha&) = default;
   CE6SSM_slha(CE6SSM_slha&&) = default;
   virtual ~CE6SSM_slha() = default;
   CE6SSM_slha& operator=(const CE6SSM_slha&) = default;
   CE6SSM_slha& operator=(CE6SSM_slha&&) = default;
   ...
   const CE6SSM_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   CE6SSM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   CE6SSM_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
CE6SSM_slha<Model>::CE6SSM_slha(const CE6SSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
CE6SSM_slha<Model>::CE6SSM_slha(const Model& model_,
...
template <class Model>
void CE6SSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void CE6SSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void CE6SSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void CE6SSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void CE6SSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void CE6SSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void CE6SSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const CE6SSM_physical& CE6SSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
CE6SSM_physical& CE6SSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void CE6SSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void CE6SSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const CE6SSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
