...
// File generated at Fri 10 Apr 2020 18:06:46
 ...
 */
Eigen::Matrix<double,2,2> CE6SSM_soft_parameters::calc_beta_mH1I2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mH1I2 = (oneOver16PiSqr*(2*ms2*((Lambda12).adjoint()*Lambda12) + 2*((
      TLambda12).adjoint()*TLambda12) + mH1I2*(Lambda12).adjoint()*Lambda12 + 2
      *((Lambda12).adjoint()*mH2I2.conjugate()*Lambda12) + (Lambda12).adjoint()
      *Lambda12*mH1I2 - 0.1*(7.745966692414834*g1*Tr11 + 9.486832980505138*gN*
      Tr14 + 12*AbsSqr(MassB)*Sqr(g1) + 60*AbsSqr(MassWB)*Sqr(g2) + 18*AbsSqr(
 ...
 */
Eigen::Matrix<double,2,2> CE6SSM_soft_parameters::calc_beta_mH1I2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> CE6SSM_soft_parameters::calc_beta_mH1I2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> CE6SSM_soft_parameters::calc_beta_mH1I2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,2,2> CE6SSM_soft_parameters::calc_beta_mH1I2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
