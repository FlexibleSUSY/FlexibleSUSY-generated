 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 15:26:46 with FlexibleSUSY
...
CLASSNAME::MSSM_mass_eigenstates(const MSSM_input_parameters& input_)
   ...
   , ewsb_solver(new MSSM_ewsb_solver<Two_scale>())
#endif
{
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MSSM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving MSSM EWSB at " << ewsb_loop_order << "-loop order");
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::Se);
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSM_info::Hpm);
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSM_info::Sd, eigenvalue_error > precision * Abs(MSd
      (0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(MSSM_info::Sv, eigenvalue_error > precision * Abs(MSv
      (0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSM_info::Su, eigenvalue_error > precision * Abs(MSu
      (0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSM_info::Se, eigenvalue_error > precision * Abs(MSe
      (0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSM_info::hh, eigenvalue_error > precision * Abs(Mhh
      (0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSM_info::Ah, eigenvalue_error > precision * Abs(MAh
      (0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSM_info::Hpm, eigenvalue_error > precision * Abs(
      MHpm(0)));
#else
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSM_info::Chi, eigenvalue_error > precision * Abs(
      MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSM_info::Cha, eigenvalue_error > precision * Abs(
      MCha(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(MSSM_info::Fe, eigenvalue_error > precision * Abs(MFe
      (0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(MSSM_info::Fd, eigenvalue_error > precision * Abs(MFd
      (0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(MSSM_info::Fu, eigenvalue_error > precision * Abs(MFu
      (0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(MSSM_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(MSSM_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::hh))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::Ah))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::Hpm))
      return;
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(MSSM_info::Fe, eigenvalue_error > precision * Abs(
         eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(MSSM_info::Fd, eigenvalue_error > precision * Abs(
         eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(MSSM_info::Fu, eigenvalue_error > precision * Abs(
         eigen_values(0)));
   #else
...
{
   if (!force_output && problems.is_running_tachyon(MSSM_info::VWm))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(MSSM_info::VWm);
