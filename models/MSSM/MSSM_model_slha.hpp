...
class MSSM_slha : public MSSM_mass_eigenstates {
public:
   explicit MSSM_slha(const MSSM_input_parameters& input_ = MSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MSSM_slha(const MSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
