...
class MSSM_slha : public Model {
public:
   explicit MSSM_slha(const MSSM_input_parameters& input_ = MSSM_input_parameters());
   explicit MSSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   MSSM_slha(const MSSM_slha&) = default;
   MSSM_slha(MSSM_slha&&) = default;
   virtual ~MSSM_slha() = default;
   MSSM_slha& operator=(const MSSM_slha&) = default;
   MSSM_slha& operator=(MSSM_slha&&) = default;
...
template <class Model>
MSSM_slha<Model>::MSSM_slha(const MSSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MSSM_slha<Model>::MSSM_slha(const Model& model_,
...
template <class Model>
void MSSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MSSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MSSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MSSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MSSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MSSM_physical& MSSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MSSM_physical& MSSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MSSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MSSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MSSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
