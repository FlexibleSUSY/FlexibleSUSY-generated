...
public:
   ...
   void set_decays(const MSSM_decay_table&, FlexibleDecay_settings const&);
   ...
   void fill_decays_data(const MSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSM_scales&, const MSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MSSM_decays const * const = nullptr);
...
void MSSM_slha_io::fill(
   ...
   MSSM_decays const * const decays)
{
