...
public:
   ...
   template <class Model> void fill(MSSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSM_slha<Model>&, const MSSM_scales&, const MSSM_observables&);
   ...
   template <class Model> void set_spectrum(const MSSM_slha<Model>&);
   ...
   static void fill_slhaea(SLHAea::Coll&, const MSSM_slha<Model>&, const softsusy::QedQcd&, const MSSM_scales&, const MSSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSM_slha<Model>&, const softsusy::QedQcd&, const MSSM_scales&, const MSSM_observables&);
...
private:
   ...
   template <class Model> void set_model_parameters(const MSSM_slha<Model>&);
 ...
 */
template <class Model>
void MSSM_slha_io::fill(MSSM_slha<Model>& model) const
{
...
void MSSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSM_slha<Model>& model,
...
SLHAea::Coll MSSM_slha_io::fill_slhaea(
   const MSSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
 ...
 */
template <class Model>
void MSSM_slha_io::set_model_parameters(const MSSM_slha<Model>& model)
{
   {
...
void MSSM_slha_io::set_extra(
   const MSSM_slha<Model>& model, const MSSM_scales& scales,
   const MSSM_observables& observables)
{
...
{
   set_spectrum(MSSM_slha<MSSM<T> >(model));
}
 ...
 */
template <class Model>
void MSSM_slha_io::set_spectrum(const MSSM_slha<Model>& model)
{
   const MSSM_physical physical(model.get_physical_slha());
