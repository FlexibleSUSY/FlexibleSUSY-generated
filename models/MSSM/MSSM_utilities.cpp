...
// File generated at Mon 27 Feb 2017 13:56:51
   ...
   const MSSM_observables* observables)
{
   ...
   append(names, MSSM_parameter_getter().get_mass_names());
   append(names, MSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, MSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = MSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = MSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = MSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? MSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
