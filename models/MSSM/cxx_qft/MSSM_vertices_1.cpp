...
// File generated at Wed 16 Oct 2019 22:54:40

/**
 * @file cxx_qft/MSSM_vertices.cpp
 *
 * This file was generated at Wed 16 Oct 2019 22:54:40 with FlexibleSUSY
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = 0.5*(-2*g2*Conj(UP(gt1,0))*Sin(ThetaW)*UP(gt2,0) - Conj(UP(gt1,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UP(gt2,1));

   const std::complex<double> right = 0.5*(-2*g2*Conj(UM(gt2,0))*Sin(ThetaW)*UM(gt1,0) - Conj(UM(gt2,1))*(0.7745966692414834*g1*Cos(ThetaW) + g2*Sin(ThetaW))*UM(gt1,1));
