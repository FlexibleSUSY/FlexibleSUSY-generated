...
// File generated at Wed 16 Oct 2019 22:54:39

/**
 * @file cxx_qft/MSSM_vertices.hpp
 *
 * This file was generated at Wed 16 Oct 2019 22:54:39 with FlexibleSUSY
...
namespace detail {
template<> struct VertexImpl<fields::Ah, typename bar<fields::Fe>::type, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::Chi, typename conj<fields::Se>::type, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::Fe, fields::Ah, typename bar<fields::Fe>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::Fe, fields::Chi, typename conj<fields::Se>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::Fe, fields::hh, typename bar<fields::Fe>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::Fe, typename bar<fields::Fv>::type, typename conj<fields::Hpm>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::Fe, typename conj<fields::Sv>::type, typename bar<fields::Cha>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::hh, typename bar<fields::Fe>::type, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::VP, fields::Cha, typename bar<fields::Cha>::type>
{
   static ChiralVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::VP, fields::Fe, typename bar<fields::Fe>::type>
{
   static ChiralVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::VP, fields::Hpm, typename conj<fields::Hpm>::type>
{
   static MomentumDifferenceVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::VP, fields::Se, typename conj<fields::Se>::type>
{
   static MomentumDifferenceVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Ah, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Cha, fields::Sv>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Chi, fields::Se>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Fe, fields::Ah>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Fe, fields::hh>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Fe, fields::VP>
{
   static ChiralVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Fv, fields::Hpm>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::hh, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Hpm, fields::Fv>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Se, fields::Chi>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Sv, fields::Cha>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fv>::type, typename conj<fields::Hpm>::type, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename conj<fields::Se>::type, fields::Se, fields::VP>
{
   static MomentumDifferenceVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<typename conj<fields::Sv>::type, typename bar<fields::Cha>::type, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
