...
template<> struct VertexImpl<fields::Fe, typename fields::conj<fields::Sv>::type, typename fields::bar<fields::Cha>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<fields::Sv, typename fields::conj<fields::Sv>::type, fields::VP>
{
   static MomentumDifferenceVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename fields::bar<fields::Fe>::type, fields::Sv, fields::Cha>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
