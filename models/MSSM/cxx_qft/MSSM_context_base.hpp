...
/**
 * @file cxx_qft/MSSM_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.3 .
 */

#ifndef MSSM_CXXQFT_CONTEXT_BASE_H
#define MSSM_CXXQFT_CONTEXT_BASE_H
...
namespace MSSM_cxx_diagrams {
   ...
   struct context_base {
      MSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MSSM_mass_eigenstates_interface const* const m) : model(*m) {}
