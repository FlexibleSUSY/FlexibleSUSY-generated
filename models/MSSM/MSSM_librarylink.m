...
FSMSSMGetProblems = LibraryFunctionLoad[libMSSM, "FSMSSMGetProblems", LinkObject, LinkObject];
FSMSSMGetWarnings = LibraryFunctionLoad[libMSSM, "FSMSSMGetWarnings", LinkObject, LinkObject];
FSMSSMToSLHA = LibraryFunctionLoad[libMSSM, "FSMSSMToSLHA", LinkObject, LinkObject];
...
FSMSSMCalculateDecays = LibraryFunctionLoad[libMSSM, "FSMSSMCalculateDecays", LinkObject, LinkObject];
...
FSMSSMCalculateDecays::error = "`1`";
FSMSSMCalculateDecays::warning = "`1`";
...
FSMSSMOpenHandle[a___, (fsSettings | fsSMParameters | fsModelParameters | fdSettings) -> s_List, r___] :=
...
FSMSSMSet[handle_Integer, p:OptionsPattern[]] :=
    FSMSSMSetLib[
        handle,
        ReleaseHold[Hold[FSMSSMCheckIsNumeric /@ {
            (* spectrum generator settings *)
            OptionValue[precisionGoal],
            OptionValue[maxIterations],
            OptionValue[solver],
