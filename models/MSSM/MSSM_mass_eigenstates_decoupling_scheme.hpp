...
/**
 * @file MSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "MSSM_info.hpp"
#include "MSSM_physical.hpp"
#include "MSSM_soft_parameters.hpp"
#include "MSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) MSSM_soft_parameters::p
...
/**
 * @class MSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSM_mass_eigenstates_decoupling_scheme
   : private MSSM_soft_parameters
   , public MSSM_mass_eigenstates_interface
{
public:
   explicit MSSM_mass_eigenstates_decoupling_scheme(const MSSM_input_parameters& input_ = MSSM_input_parameters());
   explicit MSSM_mass_eigenstates_decoupling_scheme(const MSSM_mass_eigenstates&);
   MSSM_mass_eigenstates_decoupling_scheme(const MSSM_mass_eigenstates_decoupling_scheme&) = default;
   MSSM_mass_eigenstates_decoupling_scheme(MSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSM_mass_eigenstates_decoupling_scheme() = default;
   MSSM_mass_eigenstates_decoupling_scheme& operator=(const MSSM_mass_eigenstates_decoupling_scheme&) = default;
   MSSM_mass_eigenstates_decoupling_scheme& operator=(MSSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MSSM_mass_eigenstates&);
   ...
   const MSSM_input_parameters& get_input_parameters() const override;
   MSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSM_physical& get_physical() const override;
   MSSM_physical& get_physical() override;
   ...
   void set_physical(const MSSM_physical&) override;
...
std::ostream& operator<<(std::ostream&, const MSSM_mass_eigenstates_decoupling_scheme&);
