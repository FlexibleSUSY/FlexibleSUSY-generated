...
// File generated at Fri 8 Jan 2016 13:31:10
                                ...
                                const MSSM_input_parameters& input)
{
   ...
   MSSM_convergence_tester<T> convergence_tester(&model, this->precision_goal);
   ...
   try {
      ...
      const std::string parameter_name =
         parameter_index < 0 ? "Q" : MSSM_info::parameter_names[parameter_index];
