...
// File generated at Sun 31 May 2015 12:57:11
 ...
 */
template <class T>
void MSSM_spectrum_generator<T>::write_running_couplings(const std::string& filename) const
{
 ...
 */
template <class T>
void MSSM_spectrum_generator<T>::write_spectrum(const std::string& filename) const
{
