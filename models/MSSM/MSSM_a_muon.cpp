...
// File generated at Fri 20 Oct 2017 09:20:06

/**
 * @file MSSM_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 09:20:06 with FlexibleSUSY
...
double calculate_a_muon_impl(MSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MSSM_a_muon::calculate_a_muon(const MSSM_mass_eigenstates& model_)
{
...
double MSSM_a_muon::calculate_a_muon_uncertainty(const MSSM_mass_eigenstates& model_)
{
   MSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
