...
// File generated at Tue 12 Jul 2016 12:45:21
...
public:
   ...
   MSSM_susy_parameters(double scale_, double loops_, double thresholds_, const MSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
