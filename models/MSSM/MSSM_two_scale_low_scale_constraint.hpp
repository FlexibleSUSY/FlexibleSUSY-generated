...
template<>
class MSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSM_low_scale_constraint() = default;
   MSSM_low_scale_constraint(MSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSM low-scale constraint"; }
