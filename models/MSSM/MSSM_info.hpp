...
// File generated at Sun 26 Aug 2018 15:26:51
...
namespace MSSM_info {
   ...
   enum Masses : int { MVG, MGlu, MFv_1, MFv_2, MFv_3, MSd_1, MSd_2, MSd_3, MSd_4,
      ...
      MSe_1, MSe_2, MSe_3, MSe_4, MSe_5, MSe_6, Mhh_1, Mhh_2, MAh_1, MAh_2, MHpm_1
      , MHpm_2, MChi_1, MChi_2, MChi_3, MChi_4, MCha_1, MCha_2, MFe_1, MFe_2,
      MFe_3, MFd_1, MFd_2, MFd_3, MFu_1, MFu_2, MFu_3, MVWm, MVP, MVZ,
      NUMBER_OF_MASSES };
   ...
   enum Mixings : int { ZD0_0, ZD0_1, ZD0_2, ZD0_3, ZD0_4, ZD0_5, ZD1_0, ZD1_1,
      ...
      ZH0_1, ZH1_0, ZH1_1, ZA0_0, ZA0_1, ZA1_0, ZA1_1, ZP0_0, ZP0_1, ZP1_0, ZP1_1,
   ...
   enum Input_parameters : int { TanBeta, SignMu, Qin, mHd2IN, mHu2IN, Aeij0_0,
      Aeij0_1, Aeij0_2, Aeij1_0, Aeij1_1, Aeij1_2, Aeij2_0, Aeij2_1, Aeij2_2,
      Adij0_0, Adij0_1, Adij0_2, Adij1_0, Adij1_1, Adij1_2, Adij2_0, Adij2_1,
      Adij2_2, Auij0_0, Auij0_1, Auij0_2, Auij1_0, Auij1_1, Auij1_2, Auij2_0,
      Auij2_1, Auij2_2, mq2Input0_0, mq2Input0_1, mq2Input0_2, mq2Input1_0,
      ...
      , me2Input2_1, me2Input2_2, MassBInput, MassWBInput, MassGInput,
   ...
   class MSSM_particle_names : public Names {
   public:
      virtual ~MSSM_particle_names() = default;
   ...
   class MSSM_parameter_names : public Names {
   public:
      virtual ~MSSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSM_particle_names  particle_names_getter{};
   const MSSM_parameter_names parameter_names_getter{};
