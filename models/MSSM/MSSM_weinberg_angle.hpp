...
#ifndef MSSM_WEINBERG_ANGLE_H
#define MSSM_WEINBERG_ANGLE_H
...
public:
   ...
   MSSM_weinberg_angle(const MSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
