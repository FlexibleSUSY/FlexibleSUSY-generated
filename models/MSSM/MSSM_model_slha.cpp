...
MSSM_slha::MSSM_slha(const MSSM_input_parameters& input_,
 ...
 */
MSSM_slha::MSSM_slha(const MSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MSSM_slha::clear()
{
   MSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void MSSM_slha::calculate_spectrum()
{
   MSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MSSM_slha::convert_to_slha()
{
...
void MSSM_slha::calculate_ckm_matrix()
{
...
void MSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void MSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const MSSM_physical& MSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

MSSM_physical& MSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void MSSM_slha::print(std::ostream& ostr) const
{
...
void MSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
