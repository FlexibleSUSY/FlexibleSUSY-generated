...
// File generated at Fri 10 Apr 2020 20:45:18
...
MSSM_soft_parameters MSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSM_susy_parameters susy_betas(MSSM_susy_parameters::calc_beta(loops));
...
MSSM_soft_parameters::Soft_traces MSSM_soft_parameters::calc_soft_traces(int loops) const
{
