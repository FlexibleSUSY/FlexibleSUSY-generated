...
/**
 * @file MSSM_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the MSSM model class in the decoupling scheme
 *
...
#define CLASSNAME MSSM_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const MSSM_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<MSSM_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const MSSM_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const MSSM_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
