...
/**
 * @file MSSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Fri 20 Oct 2017 09:19:53 with FlexibleSUSY
 * 2.0.1 (git commit: 5296739235bd0ef7020eda218da9c069270c3f45) and SARAH 4.12.0 .
 */

#ifndef MSSM_EWSB_SOLVER_INTERFACE_H
#define MSSM_EWSB_SOLVER_INTERFACE_H
...
class MSSM_ewsb_solver_interface {
public:
   virtual ~MSSM_ewsb_solver_interface() {}
   ...
   virtual int solve(MSSM_mass_eigenstates&) = 0;
};
