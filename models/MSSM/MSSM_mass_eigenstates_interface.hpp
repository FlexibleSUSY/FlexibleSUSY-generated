...
/**
 * @file MSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSM_MASS_EIGENSTATES_INTERFACE_H
#define MSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSM_mass_eigenstates_interface {
public:
   virtual ~MSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSM_input_parameters& get_input_parameters() const = 0;
   virtual MSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSM_physical& get_physical() const = 0;
   virtual MSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSM_physical&) = 0;
