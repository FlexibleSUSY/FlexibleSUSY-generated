...
Eigen::ArrayXd MSSM_physical::get() const
{
...
void MSSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSM_physical::get_masses() const
{
...
void MSSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
