...
template<>
class CMSSMNoFV_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "CMSSMNoFV low-scale constraint"; }
