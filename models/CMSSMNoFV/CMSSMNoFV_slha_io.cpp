 ...
 * SLHA output file.
 */
void CMSSMNoFV_slha_io::fill(CMSSMNoFV_slha& model) const
{
 ...
 * @param input struct of input parameters
 */
void CMSSMNoFV_slha_io::set_imminpar(const CMSSMNoFV_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CMSSMNoFV_slha_io::set_imextpar(const CMSSMNoFV_input_parameters& input)
{
 ...
 */
void CMSSMNoFV_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void CMSSMNoFV_slha_io::set_input(const CMSSMNoFV_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void CMSSMNoFV_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void CMSSMNoFV_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void CMSSMNoFV_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void CMSSMNoFV_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void CMSSMNoFV_slha_io::set_unitarity_infinite_s(
 ...
 */
void CMSSMNoFV_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void CMSSMNoFV_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void CMSSMNoFV_slha_io::set_spinfo(
 ...
 */
void CMSSMNoFV_slha_io::set_model_parameters(const CMSSMNoFV_slha& model)
{
   {
...
void CMSSMNoFV_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void CMSSMNoFV_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void CMSSMNoFV_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void CMSSMNoFV_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void CMSSMNoFV_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void CMSSMNoFV_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, CMSSMNoFV_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void CMSSMNoFV_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = CMSSMNoFV_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + CMSSMNoFV_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void CMSSMNoFV_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void CMSSMNoFV_slha_io::set_spectrum(const CMSSMNoFV_slha& model)
{
...
void CMSSMNoFV_slha_io::set_extra(
   const CMSSMNoFV_slha& model,
   const CMSSMNoFV_scales& scales,
 ...
 */
void CMSSMNoFV_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void CMSSMNoFV_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void CMSSMNoFV_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void CMSSMNoFV_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void CMSSMNoFV_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void CMSSMNoFV_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}
...
void CMSSMNoFV_slha_io::fill_imminpar_tuple(CMSSMNoFV_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void CMSSMNoFV_slha_io::fill_imextpar_tuple(CMSSMNoFV_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
