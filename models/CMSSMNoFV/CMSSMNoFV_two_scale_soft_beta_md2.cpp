...
// File generated at Mon 19 Sep 2016 10:13:02
 ...
 */
Eigen::Matrix<double,3,3> CMSSMNoFV_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CMSSMNoFV_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CMSSMNoFV_soft_parameters::calc_beta_md2_three_loop(const Soft_traces& soft_traces) const
{
