...
// File generated at Mon 23 Feb 2015 14:10:59
...
CMSSMNoFV_low_scale_constraint<Two_scale>::CMSSMNoFV_low_scale_constraint(
   ...
   const CMSSMNoFV_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void CMSSMNoFV_low_scale_constraint<Two_scale>::set_input_parameters(const CMSSMNoFV_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
