...
// File generated at Wed 16 Oct 2019 22:47:19
...
void CMSSMNoFV_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
double CMSSMNoFV_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();

   double theta_w = std::asin(Electroweak_constants::sinThetaW);

   CMSSMNoFV_weinberg_angle::Sm_parameters sm_pars;
   ...
   CMSSMNoFV_weinberg_angle weinberg(MODEL, sm_pars);
...
double CMSSMNoFV_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void CMSSMNoFV_low_scale_constraint<Two_scale>::calculate_running_SM_masses()
{
   check_model_ptr();
...
void CMSSMNoFV_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("CMSSMNoFV_low_scale_constraint<Two_scale>: "
