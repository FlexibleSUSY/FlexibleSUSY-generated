...
struct CMSSMNoFV_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
CMSSMNoFV_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   CMSSMNoFV_input_parameters& input)
{
...
void scan(int solver_type, CMSSMNoFV_input_parameters& input,
