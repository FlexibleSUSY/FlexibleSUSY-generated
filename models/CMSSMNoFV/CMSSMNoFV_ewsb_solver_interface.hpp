...
class CMSSMNoFV_ewsb_solver_interface {
public:
   virtual ~CMSSMNoFV_ewsb_solver_interface() {}
   ...
   virtual int solve(CMSSMNoFV_mass_eigenstates&) = 0;
};
