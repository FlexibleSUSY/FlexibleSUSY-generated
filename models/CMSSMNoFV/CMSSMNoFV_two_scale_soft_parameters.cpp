...
// File generated at Wed 12 Apr 2017 13:42:40
...
CMSSMNoFV_soft_parameters CMSSMNoFV_soft_parameters::calc_beta() const
{
   ...
   const CMSSMNoFV_susy_parameters susy_betas(CMSSMNoFV_susy_parameters::calc_beta());
...
CMSSMNoFV_soft_parameters CMSSMNoFV_soft_parameters::calc_beta(unsigned loops) const
{
   CMSSMNoFV_soft_parameters p(*this);
   p.set_loops(loops);
...
void CMSSMNoFV_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
