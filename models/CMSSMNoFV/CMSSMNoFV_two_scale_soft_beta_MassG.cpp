...
// File generated at Sun 28 Aug 2016 15:23:35
 ...
 */
double CMSSMNoFV_soft_parameters::calc_beta_MassG_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CMSSMNoFV_soft_parameters::calc_beta_MassG_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CMSSMNoFV_soft_parameters::calc_beta_MassG_three_loop(const Soft_traces& soft_traces) const
{
