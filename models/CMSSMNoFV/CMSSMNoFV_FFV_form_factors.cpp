...
/**
 * @file CMSSMNoFV_FFV_form_factors.cpp
 *
...
namespace CMSSMNoFV_FFV_form_factors {

std::valarray<std::complex<double>> calculate_Fm_Fm_VP_form_factors (
     const CMSSMNoFV_mass_eigenstates& model, bool discard_SM_contributions) {
...
>
calculate_form_factors(     const CMSSMNoFV_mass_eigenstates& model, bool discard_SM_contributions) {
return calculate_Fm_Fm_VP_form_factors(     model, discard_SM_contributions);
}
template std::valarray<std::complex<double>> calculate_form_factors<Fm,Fm,VP>(     const CMSSMNoFV_mass_eigenstates&, bool);
