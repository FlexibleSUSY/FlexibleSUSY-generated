...
// CMSSMNoFV_parameter_getter ////////////////////////////////////////

std::vector<std::string> CMSSMNoFV_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, CMSSMNoFV_info::NUMBER_OF_MIXINGS> CMSSMNoFV_parameter_getter::get_mixing_names()
{
   return CMSSMNoFV_info::particle_mixing_names;
}

Eigen::ArrayXd CMSSMNoFV_parameter_getter::get_parameters(const CMSSMNoFV_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, CMSSMNoFV_info::NUMBER_OF_PARAMETERS> CMSSMNoFV_parameter_getter::get_parameter_names()
{
   return CMSSMNoFV_info::parameter_names;
}

std::array<std::string, CMSSMNoFV_info::NUMBER_OF_PARTICLES> CMSSMNoFV_parameter_getter::get_particle_names()
{
   return CMSSMNoFV_info::particle_names;
}

std::vector<std::string> CMSSMNoFV_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> CMSSMNoFV_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, CMSSMNoFV_info::NUMBER_OF_MIXINGS> CMSSMNoFV_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, CMSSMNoFV_info::NUMBER_OF_MIXINGS> CMSSMNoFV_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, CMSSMNoFV_info::NUMBER_OF_INPUT_PARAMETERS> CMSSMNoFV_parameter_getter::get_input_parameter_names()
{
   return CMSSMNoFV_info::input_parameter_names;
}

std::array<std::string, CMSSMNoFV_info::NUMBER_OF_EXTRA_PARAMETERS> CMSSMNoFV_parameter_getter::get_extra_parameter_names()
{
   return CMSSMNoFV_info::extra_parameter_names;
}

decltype(CMSSMNoFV_info::NUMBER_OF_MASSES) CMSSMNoFV_parameter_getter::get_number_of_masses()
{
