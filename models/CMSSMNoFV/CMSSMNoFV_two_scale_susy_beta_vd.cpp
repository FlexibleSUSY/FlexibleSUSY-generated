...
// File generated at Mon 27 Feb 2017 13:47:49
 ...
 */
double CMSSMNoFV_susy_parameters::calc_beta_vd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CMSSMNoFV_susy_parameters::calc_beta_vd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double CMSSMNoFV_susy_parameters::calc_beta_vd_three_loop(const Susy_traces& susy_traces) const
{
