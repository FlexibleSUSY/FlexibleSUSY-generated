 ...
 */
template<>
class CMSSMNoFV<Two_scale> : public Two_scale_model, public CMSSMNoFV_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(CMSSMNoFV<Two_scale>::*Memfun_t)();
      CMSSMNoFV<Two_scale>* model;
      Memfun_t fun;

      Thread(CMSSMNoFV<Two_scale>* model_, Memfun_t fun_)
