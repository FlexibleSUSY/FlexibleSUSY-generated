...
CMSSMNoFV_convergence_tester<Two_scale>::CMSSMNoFV_convergence_tester(
   CMSSMNoFV<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<CMSSMNoFV<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double CMSSMNoFV_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const CMSSMNoFV<Two_scale>& ne = get_current_iteration_model();
