...
// File generated at Sun 26 Aug 2018 15:10:59
...
public:
   ...
   template <class Model> void fill(CMSSMNoFV_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const CMSSMNoFV_slha<Model>&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&);
   void set_input(const CMSSMNoFV_input_parameters&);
   ...
   template <class Model> void set_spectrum(const CMSSMNoFV_slha<Model>&);
   ...
   static void fill_imminpar_tuple(CMSSMNoFV_input_parameters&, int, double);
   static void fill_imextpar_tuple(CMSSMNoFV_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const CMSSMNoFV_slha<Model>&, const softsusy::QedQcd&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const CMSSMNoFV_slha<Model>&, const softsusy::QedQcd&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&);
...
private:
   ...
   void set_imminpar(const CMSSMNoFV_input_parameters&);
   void set_imextpar(const CMSSMNoFV_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const CMSSMNoFV_slha<Model>&);
 ...
 */
template <class Model>
void CMSSMNoFV_slha_io::fill(CMSSMNoFV_slha<Model>& model) const
{
...
void CMSSMNoFV_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const CMSSMNoFV_slha<Model>& model,
...
SLHAea::Coll CMSSMNoFV_slha_io::fill_slhaea(
   const CMSSMNoFV_slha<Model>& model, const softsusy::QedQcd& qedqcd,
 ...
 */
template <class Model>
void CMSSMNoFV_slha_io::set_model_parameters(const CMSSMNoFV_slha<Model>& model)
{
   {
...
void CMSSMNoFV_slha_io::set_extra(
   const CMSSMNoFV_slha<Model>& model, const CMSSMNoFV_scales& scales,
   const CMSSMNoFV_observables& observables)
{
 ...
 */
template <class... Ts>
void CMSSMNoFV_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<CMSSMNoFV_slha_io> ss(this);
...
{
   set_spectrum(CMSSMNoFV_slha<CMSSMNoFV<T> >(model));
}
 ...
 */
template <class Model>
void CMSSMNoFV_slha_io::set_spectrum(const CMSSMNoFV_slha<Model>& model)
{
   const CMSSMNoFV_physical physical(model.get_physical_slha());
