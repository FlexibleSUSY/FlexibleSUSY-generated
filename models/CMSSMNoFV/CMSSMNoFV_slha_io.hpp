...
public:
   ...
   void fill(CMSSMNoFV_slha&) const;
   ...
   void set_extra(const CMSSMNoFV_slha&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const CMSSMNoFV_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, CMSSMNoFV_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const CMSSMNoFV_slha&);
...
void CMSSMNoFV_slha_io::fill(
   ...
   CMSSMNoFV_decays const * const decays)
{
