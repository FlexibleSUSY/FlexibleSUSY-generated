...
public:
   ...
   template <class T> void set_extra(const CMSSMNoFV_slha<T>&, const CMSSMNoFV_scales&);
   ...
   static void convert_to_slha_convention(CMSSMNoFV_physical&);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const CMSSMNoFV_slha<T>&, const QedQcd&, const CMSSMNoFV_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CMSSMNoFV_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CMSSMNoFV_slha<T>&, const QedQcd&, const CMSSMNoFV_scales&);
...
private:
   ...
   template <class T> void fill_drbar_parameters(CMSSMNoFV_slha<T>&) const;
   template <class T> void fill_physical(CMSSMNoFV_slha<T>&) const;
};
 ...
 */
template <class T>
void CMSSMNoFV_slha_io::fill_drbar_parameters(CMSSMNoFV_slha<T>& model) const
{
 ...
 */
template <class T>
void CMSSMNoFV_slha_io::fill_physical(CMSSMNoFV_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZH);
...
void CMSSMNoFV_slha_io::fill_slhaea(
   ...
   const QedQcd& qedqcd, const CMSSMNoFV_scales& scales)
{
...
SLHAea::Coll CMSSMNoFV_slha_io::fill_slhaea(
   const CMSSMNoFV_slha<T>& model, const QedQcd& qedqcd)
{
...
{
   SLHAea::Coll slhaea;
   CMSSMNoFV_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
