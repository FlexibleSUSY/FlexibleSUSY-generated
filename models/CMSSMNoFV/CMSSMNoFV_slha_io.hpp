...
public:
   ...
   void set_extra(const CMSSMNoFV_slha&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSMNoFV_scales&, const CMSSMNoFV_observables&);
