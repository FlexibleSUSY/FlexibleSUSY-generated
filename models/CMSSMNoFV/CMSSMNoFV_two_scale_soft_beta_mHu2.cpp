...
// File generated at Thu 15 Dec 2016 13:06:17
 ...
 */
double CMSSMNoFV_soft_parameters::calc_beta_mHu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CMSSMNoFV_soft_parameters::calc_beta_mHu2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double CMSSMNoFV_soft_parameters::calc_beta_mHu2_three_loop(const Soft_traces& soft_traces) const
{
