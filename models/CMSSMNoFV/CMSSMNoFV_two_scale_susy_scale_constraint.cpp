...
// File generated at Sun 26 Aug 2018 15:11:15
...
void CMSSMNoFV_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<CMSSMNoFV<Two_scale>*>(model_);
}

void CMSSMNoFV_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& CMSSMNoFV_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
...
void CMSSMNoFV_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("CMSSMNoFV_susy_scale_constraint<Two_scale>: "
