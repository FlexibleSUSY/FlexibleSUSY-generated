...
// File generated at Wed 16 Oct 2019 22:43:47
...
const int CMSSMNoFV_soft_parameters::numberOfParameters;

CMSSMNoFV_soft_parameters::CMSSMNoFV_soft_parameters(const CMSSMNoFV_input_parameters& input_)
   : CMSSMNoFV_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

CMSSMNoFV_soft_parameters::CMSSMNoFV_soft_parameters(
   const CMSSMNoFV_susy_parameters& susy_model
   ...
   : CMSSMNoFV_susy_parameters(susy_model)
...
Eigen::ArrayXd CMSSMNoFV_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

CMSSMNoFV_soft_parameters CMSSMNoFV_soft_parameters::calc_beta(int loops) const
{
   ...
   const CMSSMNoFV_susy_parameters susy_betas(CMSSMNoFV_susy_parameters::calc_beta(loops));

   return CMSSMNoFV_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

CMSSMNoFV_soft_parameters CMSSMNoFV_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void CMSSMNoFV_soft_parameters::clear()
{
   CMSSMNoFV_susy_parameters::clear();
...
Eigen::ArrayXd CMSSMNoFV_soft_parameters::get() const
{
   Eigen::ArrayXd pars(CMSSMNoFV_susy_parameters::get());
...
void CMSSMNoFV_soft_parameters::print(std::ostream& ostr) const
{
   CMSSMNoFV_susy_parameters::print(ostr);
...
void CMSSMNoFV_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   CMSSMNoFV_susy_parameters::set(pars);
...
CMSSMNoFV_soft_parameters::Soft_traces CMSSMNoFV_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const CMSSMNoFV_soft_parameters& soft_pars)
{
