...
#ifndef CMSSMNoFV_TWO_SCALE_MATCHING_H
#define CMSSMNoFV_TWO_SCALE_MATCHING_H
...
template <class T> class CMSSMNoFV;
template <class T> class CMSSMNoFV_standard_model_Matching;
...
template<>
class CMSSMNoFV_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   CMSSMNoFV_standard_model_Matching();

   CMSSMNoFV_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       CMSSMNoFV<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~CMSSMNoFV_standard_model_Matching();
