...
/**
 * @file cxx_qft/CMSSMNoFV_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.8.0 and SARAH 4.15.1 .
 */

#ifndef CMSSMNoFV_CXXQFT_CONTEXT_BASE_H
#define CMSSMNoFV_CXXQFT_CONTEXT_BASE_H
...
using cxx_diagrams::field_indices;
   ...
   struct context_base {
      CMSSMNoFV_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(CMSSMNoFV_mass_eigenstates_interface const& m) : model(m) {}
      context_base(CMSSMNoFV_mass_eigenstates_interface const* const m) : model(*m) {}
