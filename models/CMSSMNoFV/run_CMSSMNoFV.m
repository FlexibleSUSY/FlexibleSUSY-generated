Get["models/CMSSMNoFV/CMSSMNoFV_librarylink.m"];

handle = FSCMSSMNoFVOpenHandle[
    fsSettings -> {
...
spectrum    = FSCMSSMNoFVCalculateSpectrum[handle];
observables = FSCMSSMNoFVCalculateObservables[handle];
FSCMSSMNoFVCloseHandle[handle];
