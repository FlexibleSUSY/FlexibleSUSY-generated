...
CMSSMNoFV_initial_guesser<Two_scale>::CMSSMNoFV_initial_guesser(
   CMSSMNoFV<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const CMSSMNoFV_low_scale_constraint<Two_scale>& low_constraint_,
   const CMSSMNoFV_susy_scale_constraint<Two_scale>& susy_constraint_,
   const CMSSMNoFV_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("CMSSMNoFV_initial_guesser: Error: pointer to model"
                       " CMSSMNoFV<Two_scale> must not be zero");
}
 ...
 */
void CMSSMNoFV_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void CMSSMNoFV_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void CMSSMNoFV_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void CMSSMNoFV_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void CMSSMNoFV_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void CMSSMNoFV_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void CMSSMNoFV_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void CMSSMNoFV_initial_guesser<Two_scale>::guess_soft_parameters()
{
