...
// File generated at Sun 10 Jan 2016 15:50:07
...
private:
   RGFlow<T> solver;
   CMSSMNoFV_high_scale_constraint<T> high_scale_constraint;
                                ...
                                const CMSSMNoFV_input_parameters& input)
{
   ...
   CMSSMNoFV_convergence_tester<T> convergence_tester(&model, this->precision_goal);
   ...
   try {
      ...
      const std::string parameter_name =
         parameter_index < 0 ? "Q" : CMSSMNoFV_info::parameter_names[parameter_index];
