...
// File generated at Mon 23 Feb 2015 14:20:22
 ...
 */
template <class T>
void CMSSMNoFV_spectrum_generator<T>::write_running_couplings(const std::string& filename) const
{
   CMSSMNoFV<T> tmp_model(model);
   tmp_model.run_to(low_scale);

   CMSSMNoFV_parameter_getter parameter_getter;
   Coupling_monitor<CMSSMNoFV<T>, CMSSMNoFV_parameter_getter>
 ...
 */
template <class T>
void CMSSMNoFV_spectrum_generator<T>::write_spectrum(const std::string& filename) const
{
