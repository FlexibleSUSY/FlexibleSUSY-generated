...
#include "CMSSMNoFV_initial_guesser.hpp"
...
/**
 * @class CMSSMNoFV_initial_guesser<Two_scale>
 * @brief initial guesser for the CMSSMNoFV
 */

template<>
class CMSSMNoFV_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ...
   virtual ~CMSSMNoFV_initial_guesser() = default;
...
private:
   CMSSMNoFV<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   CMSSMNoFV_low_scale_constraint<Two_scale> low_constraint{};
   CMSSMNoFV_susy_scale_constraint<Two_scale> susy_constraint{};
   CMSSMNoFV_high_scale_constraint<Two_scale> high_constraint{};
