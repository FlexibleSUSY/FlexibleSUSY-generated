...
// File generated at Sun 26 Aug 2018 15:11:52
...
{
   std::cout <<
      "Usage: run_cmd_line_CMSSMNoFV.x [options]\n"
      "Options:\n"
      "  --m0=<value>\n"
      "  --m12=<value>\n"
      "  --TanBeta=<value>\n"
...
int run_solver(const CMSSMNoFV_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(CMSSMNoFV_slha_io::fill_slhaea(
...
int run(int solver_type, const CMSSMNoFV_input_parameters& input)
{
   int exit_code = 0;
