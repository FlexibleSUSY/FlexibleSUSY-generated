...
CMSSMNoFV_slha::CMSSMNoFV_slha(const CMSSMNoFV_input_parameters& input_,
 ...
 */
CMSSMNoFV_slha::CMSSMNoFV_slha(const CMSSMNoFV_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : CMSSMNoFV_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void CMSSMNoFV_slha::clear()
{
   CMSSMNoFV_mass_eigenstates::clear();
   physical_slha.clear();
}

void CMSSMNoFV_slha::calculate_spectrum()
{
   CMSSMNoFV_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void CMSSMNoFV_slha::convert_to_slha()
{
...
void CMSSMNoFV_slha::calculate_ckm_matrix()
{

}

void CMSSMNoFV_slha::calculate_pmns_matrix()
{
 ...
 */
void CMSSMNoFV_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void CMSSMNoFV_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void CMSSMNoFV_slha::convert_soft_squared_masses_to_slha()
{
...
const CMSSMNoFV_physical& CMSSMNoFV_slha::get_physical_slha() const
{
   return physical_slha;
}

CMSSMNoFV_physical& CMSSMNoFV_slha::get_physical_slha()
{
   return physical_slha;
}

void CMSSMNoFV_slha::print(std::ostream& ostr) const
{
   CMSSMNoFV_mass_eigenstates::print(ostr);
...
void CMSSMNoFV_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const CMSSMNoFV_slha& model)
{
   model.print(ostr);
   return ostr;
}
