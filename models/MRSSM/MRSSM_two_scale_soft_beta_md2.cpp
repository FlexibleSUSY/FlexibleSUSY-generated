...
// File generated at Tue 27 Oct 2015 15:10:07
...
Eigen::Matrix<double,3,3> MRSSM_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = (oneOver16PiSqr*(2*(2*mHd2*(Yd*Yd.adjoint()) + md2*Yd*
      Yd.adjoint() + 2*(Yd*mq2*Yd.adjoint()) + Yd*Yd.adjoint()*md2) +
...
Eigen::Matrix<double,3,3> MRSSM_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = (twoLoop*(-0.4*(30*tracemd2YdAdjYd + 10*traceme2YeAdjYe +
      ...
      Yd.adjoint()) - 2*AbsSqr(LamSD)*(md2*Yd*Yd.adjoint()) - 3*AbsSqr(LamTD)*(
      md2*Yd*Yd.adjoint()) + 0.4*Sqr(g1)*(md2*Yd*Yd.adjoint()) + 6*Sqr(g2)*(md2
      *Yd*Yd.adjoint()) - 12*traceYdAdjYd*(Yd*mq2*Yd.adjoint()) - 4*
      traceYeAdjYe*(Yd*mq2*Yd.adjoint()) - 4*AbsSqr(LamSD)*(Yd*mq2*Yd.adjoint()
      ) - 6*AbsSqr(LamTD)*(Yd*mq2*Yd.adjoint()) + 0.8*Sqr(g1)*(Yd*mq2*
      Yd.adjoint()) + 12*Sqr(g2)*(Yd*mq2*Yd.adjoint()) - 6*traceYdAdjYd*(Yd*
      Yd.adjoint()*md2) - 2*traceYeAdjYe*(Yd*Yd.adjoint()*md2) - 2*AbsSqr(LamSD
      )*(Yd*Yd.adjoint()*md2) - 3*AbsSqr(LamTD)*(Yd*Yd.adjoint()*md2) + 0.4*Sqr
      (g1)*(Yd*Yd.adjoint()*md2) + 6*Sqr(g2)*(Yd*Yd.adjoint()*md2) - 8*mHd2*(Yd
      *Yd.adjoint()*Yd*Yd.adjoint()) - 4*mHd2*(Yd*Yu.adjoint()*Yu*Yd.adjoint())
      - 4*mHu2*(Yd*Yu.adjoint()*Yu*Yd.adjoint()) - 2*(md2*Yd*Yd.adjoint()*Yd*
      ...
      )) - 2*(Yd*Yu.adjoint()*Yu*Yd.adjoint()*md2) + 0.5333333333333333*(20*
      Power(g3,4)*Tr23 + g1*(g1*Tr2U111 + 3.872983346207417*Tr31))*UNITMATRIX(3
      ))).real();
