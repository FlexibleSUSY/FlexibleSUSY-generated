 ...
 */
double MRSSM_soft_parameters::calc_beta_MDBS_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDBS_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDBS_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDBS_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDBS_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
