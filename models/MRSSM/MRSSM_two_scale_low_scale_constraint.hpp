...
#ifndef MRSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MRSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MRSSM_low_scale_constraint.hpp"
...
template<>
class MRSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MRSSM_low_scale_constraint() = default;
   MRSSM_low_scale_constraint(MRSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MRSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MRSSM low-scale constraint"; }
