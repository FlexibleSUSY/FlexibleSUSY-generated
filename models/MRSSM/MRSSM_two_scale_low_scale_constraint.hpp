...
// File generated at Tue 24 Feb 2015 17:31:36
...
template<>
class MRSSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   MRSSM_low_scale_constraint();
   MRSSM_low_scale_constraint(MRSSM<Two_scale>*, const MRSSM_input_parameters&, const QedQcd&);
   virtual ~MRSSM_low_scale_constraint();
   virtual void apply();
