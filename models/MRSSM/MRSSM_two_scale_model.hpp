...
// File generated at Mon 23 Feb 2015 12:52:17
 ...
 *
 * This file was generated at Mon 23 Feb 2015 12:52:17 with FlexibleSUSY
 ...
 */
template<>
class MRSSM<Two_scale> : public Two_scale_model, public MRSSM_soft_parameters {
public:
   ...
   double get_MSOc() const { return MSOc; }
...
Eigen::Array<double,3,1> get_MPseudoscalarHiggs() const;
   ...
   void calculate_MFv();
   double get_mass_matrix_SOc() const;
   void calculate_MSOc();
   ...
   double CpUSdconjUSdconjSOcSOc(unsigned , unsigned ) const;
   ...
   std::complex<double> CpconjUSdconjSOcSd(unsigned gO2, unsigned gI2) const;
   ...
   double CpUSuconjUSuconjSOcSOc(unsigned , unsigned ) const;
   ...
   std::complex<double> CpconjUSuSuSOc(unsigned gO2, unsigned gI1) const;
   ...
   double CpSOcconjSOcconjSOcSOc() const;
   std::complex<double> CpconjSOcVGSOc() const;
   double CpSOcconjSOcconjSdSd(unsigned , unsigned ) const;
   double CpSOcconjSOcconjSuSu(unsigned , unsigned ) const;
   std::complex<double> CpconjSOcconjSdSd(unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjSOcconjSuSu(unsigned gI1, unsigned gI2) const;
   double CpconjSOcbarGluGluPR(unsigned , unsigned ) const;
   std::complex<double> CpconjSOcbarGluGluPL(unsigned , unsigned ) const;
   ...
   std::complex<double> CpbarGluconjSOcGluPL() const;
   double CpbarGluconjSOcGluPR() const;
   ...
   std::complex<double> self_energy_SOc(double p ) const;
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(MRSSM<Two_scale>::*Memfun_t)();
      MRSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(MRSSM<Two_scale>* model_, Memfun_t fun_)
