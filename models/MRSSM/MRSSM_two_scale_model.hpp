 ...
 */
template<>
class MRSSM<Two_scale> : public Model, public MRSSM_slha {
public:
   explicit MRSSM(const MRSSM_input_parameters& input_ = MRSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MRSSM(const MRSSM_slha&, bool do_convert_masses_to_slha = true);
