 ...
 */
Eigen::Matrix<double,3,3> MRSSM_soft_parameters::calc_beta_md2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSM_soft_parameters::calc_beta_md2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSM_soft_parameters::calc_beta_md2_3_loop(const Soft_traces& soft_traces) const
{
