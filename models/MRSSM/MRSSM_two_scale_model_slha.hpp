...
// File generated at Tue 12 Jul 2016 11:20:54
...
public:
   ...
   explicit MRSSM_slha(const MRSSM<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~MRSSM_slha();
...
std::ostream& operator<<(std::ostream& ostr, const MRSSM_slha<Two_scale>& model);
