...
/**
 * @file MRSSM_f_to_f_conversion.cpp
 *
...
#include "MRSSM_f_to_f_conversion.hpp"
...
namespace MRSSM_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const MRSSM_mass_eigenstates& model) {
