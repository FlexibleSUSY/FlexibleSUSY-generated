 ...
 * SLHA output file.
 */
void MRSSM_slha_io::fill(MRSSM_slha& model) const
{
 ...
 * @param input struct of input parameters
 */
void MRSSM_slha_io::set_imminpar(const MRSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MRSSM_slha_io::set_imextpar(const MRSSM_input_parameters& input)
{
 ...
 */
void MRSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MRSSM_slha_io::set_input(const MRSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
...

   {
      ...
      block << "Block HMIXIN" << '\n'
            << FORMAT_ELEMENT(203, (INPUTPARAMETER(BMuDInput)), "BMuDInput")
            << FORMAT_ELEMENT(101, (INPUTPARAMETER(BMuInput)), "BMuInput")
            << FORMAT_ELEMENT(204, (INPUTPARAMETER(BMuUInput)), "BMuUInput")
            ...
            << FORMAT_ELEMENT(310, (INPUTPARAMETER(vTInput)), "vTInput")
      ;
   ...
   slha_io.set_block("MSU2IN", INPUTPARAMETER(mu2Input), "mu2Input");
   {
      ...
      block << "Block NMSSMRUNIN" << '\n'
            << FORMAT_ELEMENT(5, (INPUTPARAMETER(vSInput)), "vSInput")
      ;
      slha_io.set_block(block);
   }
 ...
 */
void MRSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MRSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void MRSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MRSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MRSSM_slha_io::set_model_parameters(const MRSSM_slha& model)
{
   {
      std::ostringstream block;
...
void MRSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void MRSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void MRSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void MRSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void MRSSM_slha_io::set_spectrum(const MRSSM_slha& model)
{
 ...
 */
void MRSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void MRSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void MRSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void MRSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
...
void MRSSM_slha_io::fill_imminpar_tuple(MRSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MRSSM_slha_io::fill_imextpar_tuple(MRSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
