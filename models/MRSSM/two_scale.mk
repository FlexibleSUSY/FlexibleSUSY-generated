...
MRSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBMRSSM_SRC += \
		$(DIR)/MRSSM_two_scale_convergence_tester.cpp \
		$(DIR)/MRSSM_two_scale_ewsb_solver.cpp \
...
LIBMRSSM_HDR += \
		...
		$(DIR)/MRSSM_two_scale_spectrum_generator.hpp \
