...
#ifndef MRSSM_TWO_SCALE_MATCHING_H
#define MRSSM_TWO_SCALE_MATCHING_H
...
template <class T> class MRSSM;
template <class T> class MRSSM_standard_model_Matching;
...
template<>
class MRSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MRSSM_standard_model_Matching();

   MRSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MRSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MRSSM_standard_model_Matching();
