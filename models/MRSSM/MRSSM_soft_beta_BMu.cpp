...
// File generated at Fri 10 Apr 2020 19:56:30
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMu_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_BMu = Re(-0.1*oneOver16PiSqr*BMu*(-30*traceYdAdjYd - 10*traceYeAdjYe -
      30*traceYuAdjYu - 10*AbsSqr(LamSD) - 10*AbsSqr(LamSU) - 15*AbsSqr(LamTD)
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMu_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_BMu = Re(0.05*twoLoop*BMu*(-180*traceYdAdjYdYdAdjYd - 120*
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMu_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
