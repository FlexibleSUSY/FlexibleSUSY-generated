...
/**
 * @file MRSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MRSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MRSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
#define SUPER(p) MRSSM_soft_parameters::p
...
/**
 * @class MRSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MRSSM_mass_eigenstates_decoupling_scheme
   : private MRSSM_soft_parameters
   , public MRSSM_mass_eigenstates_interface
{
public:
   explicit MRSSM_mass_eigenstates_decoupling_scheme(const MRSSM_input_parameters& input_ = MRSSM_input_parameters());
   explicit MRSSM_mass_eigenstates_decoupling_scheme(const MRSSM_mass_eigenstates&);
   MRSSM_mass_eigenstates_decoupling_scheme(const MRSSM_mass_eigenstates_decoupling_scheme&) = default;
   MRSSM_mass_eigenstates_decoupling_scheme(MRSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MRSSM_mass_eigenstates_decoupling_scheme() = default;
   MRSSM_mass_eigenstates_decoupling_scheme& operator=(const MRSSM_mass_eigenstates_decoupling_scheme&) = default;
   MRSSM_mass_eigenstates_decoupling_scheme& operator=(MRSSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MRSSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MRSSM_mass_eigenstates&);
   ...
   const MRSSM_input_parameters& get_input_parameters() const override;
   MRSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MRSSM_physical& get_physical() const override;
   MRSSM_physical& get_physical() override;
   ...
   void set_physical(const MRSSM_physical&) override;
...
std::ostream& operator<<(std::ostream&, const MRSSM_mass_eigenstates_decoupling_scheme&);
