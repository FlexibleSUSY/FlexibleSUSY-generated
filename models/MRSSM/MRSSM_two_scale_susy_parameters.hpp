...
#ifndef MRSSM_TWO_SCALE_susy_parameters_H
#define MRSSM_TWO_SCALE_susy_parameters_H
...
public:
   ...
   MRSSM_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const MRSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   MRSSM_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
