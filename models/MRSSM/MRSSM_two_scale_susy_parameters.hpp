...
public:
   ...
   MRSSM_susy_parameters(double scale_, double loops_, double thresholds_, const MRSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
