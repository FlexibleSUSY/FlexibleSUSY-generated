 ...
 */
double MRSSM_soft_parameters::calc_beta_mS2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_mS2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_mS2_three_loop(const Soft_traces& soft_traces) const
{
