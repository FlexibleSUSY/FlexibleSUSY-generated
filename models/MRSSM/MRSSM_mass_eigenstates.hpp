 ...
 *
 * This file was generated at Sun 31 May 2015 12:28:19 with FlexibleSUSY
 * 1.1.0 (git commit: v1.1.0) and SARAH 4.5.6 .
 */

#ifndef MRSSM_IMODEL_H
#define MRSSM_IMODEL_H
...
public:
   ...
   std::complex<double> CpphiObarGluGluPR(unsigned , unsigned ) const;
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(MRSSM_mass_eigenstates::*Memfun_t)();
      MRSSM_mass_eigenstates* model;
      Memfun_t fun;

      Thread(MRSSM_mass_eigenstates* model_, Memfun_t fun_)
