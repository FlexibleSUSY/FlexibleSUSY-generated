...
public:
   ...
   void set_extra(const MRSSM_slha&, const MRSSM_scales&, const MRSSM_observables&);
   ...
   void set_spectrum(const MRSSM_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MRSSM_scales&, const MRSSM_observables&);
...
private:
   ...
   void set_model_parameters(const MRSSM_slha&);
