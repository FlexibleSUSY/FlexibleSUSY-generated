...
public:
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MRSSM_slha<T>&, const softsusy::QedQcd&, const MRSSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MRSSM_slha<T>&, const softsusy::QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MRSSM_slha<T>&, const softsusy::QedQcd&, const MRSSM_scales&);
