...
/**
 * @file MRSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef MRSSM_MASS_EIGENSTATES_INTERFACE_H
#define MRSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MRSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MRSSM_mass_eigenstates_interface {
public:
   virtual ~MRSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MRSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MRSSM_input_parameters& get_input_parameters() const = 0;
   virtual MRSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MRSSM_physical& get_physical() const = 0;
   virtual MRSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MRSSM_physical&) = 0;
