...
MRSSM_soft_parameters MRSSM_soft_parameters::calc_beta(int loops) const
{
   double beta_BMu = 0.;
   double beta_BMuD = 0.;
   double beta_BMuU = 0.;
   ...
   const MRSSM_susy_parameters susy_betas(MRSSM_susy_parameters::calc_beta(loops));
...
Eigen::ArrayXd MRSSM_soft_parameters::get() const
{
...
MRSSM_soft_parameters::Soft_traces MRSSM_soft_parameters::calc_soft_traces(int loops) const
{
