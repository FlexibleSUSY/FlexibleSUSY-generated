 ...
 */
double MRSSM_susy_parameters::calc_beta_vu_one_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_vu = 0.1*oneOver16PiSqr*vu*(-10*AbsSqr(LamSU) + 3*(-10*
 ...
 */
double MRSSM_susy_parameters::calc_beta_vu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_vu = -0.025*twoLoop*vu*(45*Power(g1,4) + 145*Power(g2,4) - 120*
