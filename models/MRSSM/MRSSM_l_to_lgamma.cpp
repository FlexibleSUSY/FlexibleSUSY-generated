...
using namespace MRSSM_FFV_form_factors;
...
double lepton_total_decay_width(
      ...
      const MRSSM_mass_eigenstates& model, const softsusy::QedQcd& qedqcd) {
