...
// File generated at Fri 20 Oct 2017 08:51:17

/**
 * @file MRSSM_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 08:51:17 with FlexibleSUSY
...
double calculate_a_muon_impl(MRSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MRSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MRSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MRSSM_a_muon::calculate_a_muon(const MRSSM_mass_eigenstates& model_)
{
...
double MRSSM_a_muon::calculate_a_muon_uncertainty(const MRSSM_mass_eigenstates& model_)
{
   MRSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MRSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
