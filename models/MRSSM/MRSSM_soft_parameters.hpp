...
public:
   ...
   MRSSM_soft_parameters& operator=(const MRSSM_soft_parameters&) = default;
   MRSSM_soft_parameters& operator=(MRSSM_soft_parameters&&) = default;
   ...
   MRSSM_soft_parameters calc_beta(int) const;
