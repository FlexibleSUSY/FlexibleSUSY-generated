...
// File generated at Fri 10 Apr 2020 19:58:27
 ...
 * parameters.
 *
 * This file was generated at Fri 10 Apr 2020 19:58:27 with FlexibleSUSY
...
CLASSNAME::CLASSNAME(const MRSSM_input_parameters& input_)
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Sd, eigenvalue_error > precision * Abs(
      MSd(0)));
#else
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Sv, eigenvalue_error > precision * Abs(
      MSv(0)));
#else
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Su, eigenvalue_error > precision * Abs(
      MSu(0)));
#else
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Se, eigenvalue_error > precision * Abs(
      MSe(0)));
#else
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MRSSM_info::hh, eigenvalue_error > precision * Abs(
      Mhh(0)));
#else
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Ah, eigenvalue_error > precision * Abs(
      MAh(0)));
#else
...
void CLASSNAME::calculate_MRh()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Rh, eigenvalue_error > precision * Abs(
      MRh(0)));
#else
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Hpm, eigenvalue_error > precision * Abs(
      MHpm(0)));
#else
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Chi, eigenvalue_error > precision * Abs(
      MChi(0)));
#else
...
void CLASSNAME::calculate_MCha1()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Cha1, eigenvalue_error > precision * Abs(
      MCha1(0)));
#else
...
void CLASSNAME::calculate_MCha2()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Cha2, eigenvalue_error > precision * Abs(
      MCha2(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Fe, eigenvalue_error > precision * Abs(
      MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Fd, eigenvalue_error > precision * Abs(
      MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(MRSSM_info::Fu, eigenvalue_error > precision * Abs(
      MFu(0)));
#else
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         Eigen::Matrix<double,4,4> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM_info::Hpm, eigenvalue_error >
