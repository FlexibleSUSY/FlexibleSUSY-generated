...
// File generated at Tue 10 Oct 2017 21:40:21
...
void MRSSM_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<MRSSM<Two_scale>*>(model_);
}

void MRSSM_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MRSSM_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
...
void MRSSM_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MRSSM_susy_scale_constraint<Two_scale>: "
