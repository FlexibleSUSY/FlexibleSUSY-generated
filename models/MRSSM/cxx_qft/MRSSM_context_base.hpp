...
#define MRSSM_CXXQFT_CONTEXT_BASE_H

#include "MRSSM_fields.hpp"
#include "MRSSM_mass_eigenstates_interface.hpp"

namespace flexiblesusy {
namespace MRSSM_cxx_diagrams {

   struct context_base {
      MRSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MRSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MRSSM_mass_eigenstates_interface const* const m) : model(*m) {}
