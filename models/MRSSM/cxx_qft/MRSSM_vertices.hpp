 ...
 *
 * This file was generated at Fri 10 Apr 2020 19:59:03 with FlexibleSUSY
...
template<> struct VertexImpl<fields::Cha1, typename bar<fields::Cha1>::type, fields::VP>
{
...
template<> struct VertexImpl<typename bar<fields::Chi>::type, typename conj<fields::Se>::type, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename bar<fields::Fe>::type, fields::Se, typename bar<fields::Chi>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename bar<fields::Fe>::type, typename bar<fields::Cha1>::type, fields::Sv>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename conj<fields::Sv>::type, fields::Cha1, fields::Fe>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
