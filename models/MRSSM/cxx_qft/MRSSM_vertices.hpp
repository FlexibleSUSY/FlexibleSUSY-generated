...
// File generated at Tue 22 Jan 2019 16:57:08

/**
 * @file cxx_qft/MRSSM_vertices.hpp
 *
 * This file was generated at Tue 22 Jan 2019 16:57:08 with FlexibleSUSY
 * 2.3.0 and SARAH 4.14.1 .
 */

#ifndef MRSSM_CXXQFT_VERTICES_H
#define MRSSM_CXXQFT_VERTICES_H
...
template<> struct VertexData<fields::Fe, typename bar<fields::Chi>::type, typename conj<fields::Se>::type>
{
   using vertex_type = ChiralVertex;
};
...
template<> struct VertexData<typename bar<fields::Fe>::type, fields::Sv, typename bar<fields::Cha1>::type>
{
   using vertex_type = ChiralVertex;
};

template<> struct VertexData<fields::Fe, typename conj<fields::Sv>::type, fields::Cha1>
{
   using vertex_type = ChiralVertex;
};

template<> struct VertexData<fields::VP, fields::Cha1, typename bar<fields::Cha1>::type>
{
   using vertex_type = ChiralVertex;
};

template<> struct VertexData<typename bar<fields::Fe>::type, typename bar<fields::Chi>::type, fields::Se>
{
   using vertex_type = ChiralVertex;
};
...
template<> inline
Vertex<fields::Fe, typename bar<fields::Chi>::type, typename conj<fields::Se>::type>::vertex_type
Vertex<fields::Fe, typename bar<fields::Chi>::type, typename conj<fields::Se>::type>::evaluate(const indices_type& indices, const context_base& context)
{
   const int gt2 = indices[0];
...
template<> inline
Vertex<typename bar<fields::Fe>::type, fields::Sv, typename bar<fields::Cha1>::type>::vertex_type
Vertex<typename bar<fields::Fe>::type, fields::Sv, typename bar<fields::Cha1>::type>::evaluate(const indices_type& indices, const context_base& context)
{
   const int gt2 = indices[0];
   const int gt3 = indices[1];
   const int gt1 = indices[2];
...
template<> inline
Vertex<fields::Fe, typename conj<fields::Sv>::type, fields::Cha1>::vertex_type
Vertex<fields::Fe, typename conj<fields::Sv>::type, fields::Cha1>::evaluate(const indices_type& indices, const context_base& context)
{
   const int gt2 = indices[0];
   const int gt3 = indices[1];
   const int gt1 = indices[2];
...
template<> inline
Vertex<fields::VP, fields::Cha1, typename bar<fields::Cha1>::type>::vertex_type
Vertex<fields::VP, fields::Cha1, typename bar<fields::Cha1>::type>::evaluate(const indices_type& indices, const context_base& context)
{
   const int gt2 = indices[0];
   const int gt1 = indices[1];
   const auto g2 = MODELPARAMETER(g2);
...
template<> inline
Vertex<typename bar<fields::Fe>::type, typename bar<fields::Chi>::type, fields::Se>::vertex_type
Vertex<typename bar<fields::Fe>::type, typename bar<fields::Chi>::type, fields::Se>::evaluate(const indices_type& indices, const context_base& context)
{
   const int gt2 = indices[0];
   const int gt1 = indices[1];
   const int gt3 = indices[2];
