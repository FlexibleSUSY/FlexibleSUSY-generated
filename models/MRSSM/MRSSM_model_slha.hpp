...
class MRSSM_slha : public MRSSM_mass_eigenstates {
public:
   explicit MRSSM_slha(const MRSSM_input_parameters& input_ = MRSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MRSSM_slha(const MRSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
