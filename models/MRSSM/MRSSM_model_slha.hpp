...
class MRSSM_slha : public Model {
public:
   explicit MRSSM_slha(const MRSSM_input_parameters& input_ = MRSSM_input_parameters());
   explicit MRSSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   MRSSM_slha(const MRSSM_slha&) = default;
   MRSSM_slha(MRSSM_slha&&) = default;
   virtual ~MRSSM_slha() = default;
   MRSSM_slha& operator=(const MRSSM_slha&) = default;
   MRSSM_slha& operator=(MRSSM_slha&&) = default;
...
template <class Model>
MRSSM_slha<Model>::MRSSM_slha(const MRSSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MRSSM_slha<Model>::MRSSM_slha(const Model& model_,
...
template <class Model>
void MRSSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MRSSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MRSSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MRSSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MRSSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MRSSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MRSSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MRSSM_physical& MRSSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MRSSM_physical& MRSSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MRSSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MRSSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MRSSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
