...
MRSSM_slha::MRSSM_slha(const MRSSM_input_parameters& input_,
 ...
 */
MRSSM_slha::MRSSM_slha(const MRSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MRSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MRSSM_slha::clear()
{
   MRSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void MRSSM_slha::calculate_spectrum()
{
   MRSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MRSSM_slha::convert_to_slha()
{
...
void MRSSM_slha::calculate_ckm_matrix()
{
...
void MRSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void MRSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MRSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MRSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const MRSSM_physical& MRSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

MRSSM_physical& MRSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void MRSSM_slha::print(std::ostream& ostr) const
{
   MRSSM_mass_eigenstates::print(ostr);
...
void MRSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MRSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
