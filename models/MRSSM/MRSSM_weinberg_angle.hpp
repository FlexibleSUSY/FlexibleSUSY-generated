...
#ifndef MRSSM_WEINBERG_ANGLE_H
#define MRSSM_WEINBERG_ANGLE_H
...
public:
   ...
   MRSSM_weinberg_angle(const MRSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MRSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MRSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
