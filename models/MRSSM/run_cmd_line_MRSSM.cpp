...
{
   std::cout <<
      "Usage: run_cmd_line_MRSSM.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --LamTDInput=<value>\n"
      "  --LamTUInput=<value>\n"
...
int main(int argc, char* argv[])
{
   ...
   const MRSSM_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(MRSSM_slha_io::fill_slhaea(model, qedqcd, scales, observables));
