...
// File generated at Wed 16 Oct 2019 21:41:08
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDWBT_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDWBT_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_MDWBT_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
