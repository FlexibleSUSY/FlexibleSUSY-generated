...
/**
 * @file MRSSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Tue 22 Jan 2019 16:56:05 with FlexibleSUSY
 * 2.3.0 (git commit: b5dda61ad35a8ffff74bde70f63e1c2b815e751a) and SARAH 4.14.1 .
 */

#ifndef MRSSM_EWSB_SOLVER_INTERFACE_H
#define MRSSM_EWSB_SOLVER_INTERFACE_H
...
class MRSSM_ewsb_solver_interface {
public:
   virtual ~MRSSM_ewsb_solver_interface() {}
   ...
   virtual int solve(MRSSM_mass_eigenstates&) = 0;
};
