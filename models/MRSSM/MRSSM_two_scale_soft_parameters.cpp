...
// File generated at Tue 24 Feb 2015 17:31:26
...
MRSSM_soft_parameters::MRSSM_soft_parameters(
   const MRSSM_susy_parameters& susy_model
   ...
   : MRSSM_susy_parameters(susy_model)
...
Eigen::ArrayXd MRSSM_soft_parameters::beta() const
{
...
const Eigen::ArrayXd MRSSM_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MRSSM_susy_parameters::get());
...
void MRSSM_soft_parameters::print(std::ostream& ostr) const
{
   MRSSM_susy_parameters::print(ostr);
...
void MRSSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MRSSM_susy_parameters::set(pars);
...
void MRSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   ...
   TRACE_STRUCT.Tr11 = 0.7745966692414834*g1*(-mHd2 + mHu2 + mRd2 - mRu2 + (md2
      ).trace() + (me2).trace() - (ml2).trace() + (mq2).trace() - 2*(mu2).trace())
      ;
   TRACE_STRUCT.Tr2U111 = 0.1*Sqr(g1)*(3*mHd2 + 3*mHu2 + 3*mRd2 + 3*mRu2 + 2*(
      md2).trace() + 6*(me2).trace() + 3*(ml2).trace() + (mq2).trace() + 8*(mu2)
      .trace());
   TRACE_STRUCT.Tr31 = 0.012909944487358056*g1*(30*(mHd2 - mRd2)*AbsSqr(LamSD)
      ...
      .trace() - 90*mHu2*(Yu*Yu.adjoint()).trace() - 60*(Yd*Yd.adjoint()*
   ...
   TRACE_STRUCT.Tr22 = 0.5*(mHd2 + mHu2 + mRd2 + mRu2 + 4*mT2 + (ml2).trace() +
      3*(mq2).trace());
   TRACE_STRUCT.Tr23 = 0.5*(6*moc2 + (md2).trace() + 2*(mq2).trace() + (mu2)
      .trace());
