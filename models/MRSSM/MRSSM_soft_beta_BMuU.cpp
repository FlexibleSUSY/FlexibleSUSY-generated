...
// File generated at Mon 5 Mar 2018 17:48:01
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMuU_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMuU_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_BMuU = Re(0.1*twoLoop*(-8*LamSU*BMuD*Conj(LamSD)*(15*traceYdAdjYd
      ...
      Sqr(g2)) + BMuU*(-30*traceYdAdjYuYuAdjYd - 90*traceYuAdjYuYuAdjYu + 45*
      Quad(g1) + 165*Quad(g2) + 8*traceYuAdjYu*Sqr(g1) + 18*Sqr(g1)*Sqr(g2) +
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMuU_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM_soft_parameters::calc_beta_BMuU_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
