...
// File generated at Sun 28 Aug 2016 15:22:15
 ...
 */
Eigen::Matrix<double,3,3> NUHMSSM_soft_parameters::calc_beta_me2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NUHMSSM_soft_parameters::calc_beta_me2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NUHMSSM_soft_parameters::calc_beta_me2_three_loop(const Soft_traces& soft_traces) const
{
