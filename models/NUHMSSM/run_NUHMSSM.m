Get["models/NUHMSSM/NUHMSSM_librarylink.m"];

handle = FSNUHMSSMOpenHandle[
    fsSettings -> {
...
spectrum    = FSNUHMSSMCalculateSpectrum[handle];
observables = FSNUHMSSMCalculateObservables[handle];
FSNUHMSSMCloseHandle[handle];
