...
#include "NUHMSSM_low_scale_constraint.hpp"
...
template<>
class NUHMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   NUHMSSM_low_scale_constraint() = default;
   NUHMSSM_low_scale_constraint(NUHMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NUHMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "NUHMSSM low-scale constraint"; }
