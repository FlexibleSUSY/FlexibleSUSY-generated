                                ...
                                const NUHMSSM_input_parameters& input)
{
   ...
   NUHMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   NUHMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   NUHMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
