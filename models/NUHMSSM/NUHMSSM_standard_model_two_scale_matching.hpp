...
#ifndef NUHMSSM_TWO_SCALE_MATCHING_H
#define NUHMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class NUHMSSM;
template <class T> class NUHMSSM_standard_model_Matching;
...
template<>
class NUHMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   NUHMSSM_standard_model_Matching();

   NUHMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       NUHMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~NUHMSSM_standard_model_Matching();
