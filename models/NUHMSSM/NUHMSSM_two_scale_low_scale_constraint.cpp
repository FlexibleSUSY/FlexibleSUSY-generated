...
// File generated at Sun 31 May 2015 12:48:53
...
NUHMSSM_low_scale_constraint<Two_scale>::NUHMSSM_low_scale_constraint(
   NUHMSSM<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void NUHMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& NUHMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
