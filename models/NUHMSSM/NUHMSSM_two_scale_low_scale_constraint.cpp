...
// File generated at Tue 8 Sep 2015 13:21:21
...
NUHMSSM_low_scale_constraint<Two_scale>::NUHMSSM_low_scale_constraint(
   NUHMSSM<Two_scale>* model_, const softsusy::QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
double NUHMSSM_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "NUHMSSM_low_scale_constraint<Two_scale>::"
 ...
 */
void NUHMSSM_low_scale_constraint<Two_scale>::recalculate_mw_pole()
{
   assert(model && "NUHMSSM_low_scale_constraint<Two_scale>::"
