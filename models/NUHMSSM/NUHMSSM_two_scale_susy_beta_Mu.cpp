...
// File generated at Fri 26 Jun 2015 19:16:35
 ...
 */
double NUHMSSM_susy_parameters::calc_beta_Mu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUHMSSM_susy_parameters::calc_beta_Mu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double NUHMSSM_susy_parameters::calc_beta_Mu_three_loop(const Susy_traces& susy_traces) const
{
