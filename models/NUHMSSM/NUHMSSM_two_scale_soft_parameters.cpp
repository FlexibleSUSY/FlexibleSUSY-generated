...
// File generated at Sat 15 Oct 2016 15:49:24
...
NUHMSSM_soft_parameters NUHMSSM_soft_parameters::calc_beta() const
{
   ...
   const NUHMSSM_susy_parameters susy_betas(NUHMSSM_susy_parameters::calc_beta());
...
NUHMSSM_soft_parameters NUHMSSM_soft_parameters::calc_beta(unsigned loops) const
{
   NUHMSSM_soft_parameters p(*this);
   p.set_loops(loops);
...
void NUHMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
