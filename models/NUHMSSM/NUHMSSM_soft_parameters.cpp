...
// File generated at Sun 26 Aug 2018 14:58:45
...
const int NUHMSSM_soft_parameters::numberOfParameters;

NUHMSSM_soft_parameters::NUHMSSM_soft_parameters(const NUHMSSM_input_parameters& input_)
   : NUHMSSM_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

NUHMSSM_soft_parameters::NUHMSSM_soft_parameters(
   const NUHMSSM_susy_parameters& susy_model
   ...
   : NUHMSSM_susy_parameters(susy_model)
...
Eigen::ArrayXd NUHMSSM_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

NUHMSSM_soft_parameters NUHMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const NUHMSSM_susy_parameters susy_betas(NUHMSSM_susy_parameters::calc_beta(loops));

   return NUHMSSM_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

NUHMSSM_soft_parameters NUHMSSM_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void NUHMSSM_soft_parameters::clear()
{
   NUHMSSM_susy_parameters::clear();
...
Eigen::ArrayXd NUHMSSM_soft_parameters::get() const
{
   Eigen::ArrayXd pars(NUHMSSM_susy_parameters::get());
...
void NUHMSSM_soft_parameters::print(std::ostream& ostr) const
{
   NUHMSSM_susy_parameters::print(ostr);
...
void NUHMSSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   NUHMSSM_susy_parameters::set(pars);
...
NUHMSSM_soft_parameters::Soft_traces NUHMSSM_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSM_soft_parameters& soft_pars)
{
