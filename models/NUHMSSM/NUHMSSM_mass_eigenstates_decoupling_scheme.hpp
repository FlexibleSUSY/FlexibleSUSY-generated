...
/**
 * @file NUHMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef NUHMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define NUHMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "NUHMSSM_info.hpp"
#include "NUHMSSM_physical.hpp"
#include "NUHMSSM_soft_parameters.hpp"
#include "NUHMSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) NUHMSSM_soft_parameters::p
...
/**
 * @class NUHMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class NUHMSSM_mass_eigenstates_decoupling_scheme
   : private NUHMSSM_soft_parameters
   , public NUHMSSM_mass_eigenstates_interface
{
public:
   explicit NUHMSSM_mass_eigenstates_decoupling_scheme(const NUHMSSM_input_parameters& input_ = NUHMSSM_input_parameters());
   explicit NUHMSSM_mass_eigenstates_decoupling_scheme(const NUHMSSM_mass_eigenstates&);
   NUHMSSM_mass_eigenstates_decoupling_scheme(const NUHMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NUHMSSM_mass_eigenstates_decoupling_scheme(NUHMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~NUHMSSM_mass_eigenstates_decoupling_scheme() = default;
   NUHMSSM_mass_eigenstates_decoupling_scheme& operator=(const NUHMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NUHMSSM_mass_eigenstates_decoupling_scheme& operator=(NUHMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<NUHMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const NUHMSSM_mass_eigenstates&);
   ...
   const NUHMSSM_input_parameters& get_input_parameters() const override;
   NUHMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const NUHMSSM_physical& get_physical() const override;
   NUHMSSM_physical& get_physical() override;
   ...
   void set_physical(const NUHMSSM_physical&) override;
...
private:
   ...
   Problems problems{NUHMSSM_info::model_name,
                     &NUHMSSM_info::particle_names_getter,
                     &NUHMSSM_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const NUHMSSM_mass_eigenstates_decoupling_scheme&);
