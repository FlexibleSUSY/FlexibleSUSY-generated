...
NUHMSSM_spectrum_plotter::NUHMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> NUHMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const NUHMSSM_observables* observables)
{
   ...
   append(names, NUHMSSM_parameter_getter().get_mass_names());
   append(names, NUHMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, NUHMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = NUHMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = NUHMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = NUHMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? NUHMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
