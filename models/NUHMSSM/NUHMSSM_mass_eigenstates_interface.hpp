...
/**
 * @file NUHMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef NUHMSSM_MASS_EIGENSTATES_INTERFACE_H
#define NUHMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class NUHMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class NUHMSSM_mass_eigenstates_interface {
public:
   virtual ~NUHMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<NUHMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const NUHMSSM_input_parameters& get_input_parameters() const = 0;
   virtual NUHMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const NUHMSSM_physical& get_physical() const = 0;
   virtual NUHMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const NUHMSSM_physical&) = 0;
