...
public:
   ...
   NUHMSSM_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const NUHMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   NUHMSSM_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
