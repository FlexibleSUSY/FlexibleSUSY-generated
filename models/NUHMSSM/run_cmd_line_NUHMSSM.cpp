...
int run_solver(const NUHMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(NUHMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const NUHMSSM_input_parameters& input)
{
   int exit_code = 0;
