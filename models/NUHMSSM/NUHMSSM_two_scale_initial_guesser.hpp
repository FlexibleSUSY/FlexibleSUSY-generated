...
template<>
class NUHMSSM_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ...
   virtual ~NUHMSSM_initial_guesser() = default;
...
private:
   NUHMSSM<Two_scale>* model{nullptr}; ///< pointer to model class
