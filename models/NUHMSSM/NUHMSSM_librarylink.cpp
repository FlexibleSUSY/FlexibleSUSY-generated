...
public:
   ...
   virtual void fill_slha_io(NUHMSSM_slha_io&, const Spectrum_generator_settings&) const = 0;
...
public:
   ...
   virtual void fill_slha_io(NUHMSSM_slha_io&, const Spectrum_generator_settings&) const override;
