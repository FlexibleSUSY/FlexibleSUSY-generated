 ...
 */
class NUHMSSM_mass_eigenstates : public NUHMSSM_soft_parameters {
public:
   explicit NUHMSSM_mass_eigenstates(const NUHMSSM_input_parameters& input_ = NUHMSSM_input_parameters());
   virtual ~NUHMSSM_mass_eigenstates();
   ...
   const NUHMSSM_physical& get_physical() const;
   NUHMSSM_physical& get_physical();
   const Problems<NUHMSSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<NUHMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
...
private:
   struct EWSB_args {
      NUHMSSM_mass_eigenstates* model;
   ...
   NUHMSSM_physical physical; ///< contains the pole masses and mixings
   Problems<NUHMSSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const NUHMSSM_mass_eigenstates&);
