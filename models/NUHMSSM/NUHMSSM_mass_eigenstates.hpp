...
class NUHMSSM_ewsb_solver_interface;
/**
 * @class NUHMSSM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class NUHMSSM_mass_eigenstates
   : public NUHMSSM_soft_parameters
...
public:
   ...
   NUHMSSM_mass_eigenstates(const NUHMSSM_mass_eigenstates&) = default;
   NUHMSSM_mass_eigenstates(NUHMSSM_mass_eigenstates&&) = default;
   virtual ~NUHMSSM_mass_eigenstates() = default;
   NUHMSSM_mass_eigenstates& operator=(const NUHMSSM_mass_eigenstates&) = default;
   NUHMSSM_mass_eigenstates& operator=(NUHMSSM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<NUHMSSM_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{NUHMSSM_info::model_name,
   ...
   std::shared_ptr<NUHMSSM_ewsb_solver_interface> ewsb_solver{};
