...
public:
   ...
   NUHMSSM_weinberg_angle(const NUHMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NUHMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NUHMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
