...
#ifndef NUHMSSM_TWO_SCALE_soft_parameters_H
#define NUHMSSM_TWO_SCALE_soft_parameters_H
...
public:
   ...
   virtual ~NUHMSSM_soft_parameters() {}
   ...
   NUHMSSM_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
