...
// File generated at Wed 12 Apr 2017 13:07:34

/**
 * @file NUHMSSM_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Wed 12 Apr 2017 13:07:34 with FlexibleSUSY
...
#define CLASSNAME NUHMSSM_mass_eigenstates
...
CLASSNAME::NUHMSSM_mass_eigenstates(const NUHMSSM_input_parameters& input_)
   : NUHMSSM_soft_parameters(input_)
   ...
   , physical()
   , problems(NUHMSSM_info::particle_names)
...
CLASSNAME::~NUHMSSM_mass_eigenstates()
{
}
...
const NUHMSSM_physical& CLASSNAME::get_physical() const
{
   return physical;
}

NUHMSSM_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const NUHMSSM_physical& physical_)
{
   physical = physical_;
}

const Problems<NUHMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<NUHMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   NUHMSSM_mass_eigenstates* model = ewsb_args->model;
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "NUHMSSM\n"
           "========================================\n";
   NUHMSSM_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_tachyon(NUHMSSM_info::Hpm);
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   NUHMSSM_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(NUHMSSM_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = NUHMSSM_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUHMSSM_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(NUHMSSM_info::hh, eigenvalue_error > precision
      * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(NUHMSSM_info::Ah, eigenvalue_error > precision
      * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(NUHMSSM_info::Hpm, eigenvalue_error > precision
      * Abs(MHpm(0)));
#else
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_tachyon(NUHMSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_tachyon(NUHMSSM_info::VWm);
   }
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_tachyon(NUHMSSM_info::VZ);
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::hh))
      return;
         ...
         for (unsigned i = 0; i < 2; i++) {
            for (unsigned k = 0; k < 2; k++) {
               if (!std::isfinite(self_energy_2l(i,k))) {
                  ...
                  problems.flag_bad_mass(NUHMSSM_info::hh)
                     ;
               }
            }
         }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NUHMSSM_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(NUHMSSM_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::Ah))
      return;
      ...
      if (pole_mass_loop_order > 1) {
         ...
         for (unsigned i = 0; i < 2; i++) {
            for (unsigned k = 0; k < 2; k++) {
               if (!std::isfinite(self_energy_2l(i,k))) {
                  self_energy_2l(i,k) = 0.;
                  problems.flag_bad_mass(NUHMSSM_info::Ah)
                     ;
               }
            }
         }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NUHMSSM_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(NUHMSSM_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::Hpm))
      return;
   ...
   do {
      ...
      for (unsigned es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(NUHMSSM_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NUHMSSM_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(NUHMSSM_info::Hpm);
}
...
void CLASSNAME::calculate_MCha_pole()
{
   ...
   for (unsigned es = 0; es < 2; ++es) {
      ...
      problems.flag_bad_mass(NUHMSSM_info::Cha, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER, eigenvalue_error)
         ;
      problems.flag_bad_mass(NUHMSSM_info::Fe, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR, eigenvalue_error)
         ;
      problems.flag_bad_mass(NUHMSSM_info::Fd, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR, eigenvalue_error)
         ;
      problems.flag_bad_mass(NUHMSSM_info::Fu, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
{
   if (!force_output && problems.is_tachyon(NUHMSSM_info::VWm))
      return;
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSM_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
