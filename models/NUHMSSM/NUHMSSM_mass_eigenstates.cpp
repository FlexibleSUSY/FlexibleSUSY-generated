...
std::unique_ptr<NUHMSSM_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<NUHMSSM_mass_eigenstates>(*this);
}
...
const NUHMSSM_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

NUHMSSM_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
