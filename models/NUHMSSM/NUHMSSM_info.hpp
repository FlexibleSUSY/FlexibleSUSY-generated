...
namespace NUHMSSM_info {
   ...
   public:
      virtual ~NUHMSSM_particle_names() = default;
   ...
   class NUHMSSM_parameter_names : public Names {
   public:
      virtual ~NUHMSSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const NUHMSSM_particle_names  particle_names_getter{};
   const NUHMSSM_parameter_names parameter_names_getter{};
