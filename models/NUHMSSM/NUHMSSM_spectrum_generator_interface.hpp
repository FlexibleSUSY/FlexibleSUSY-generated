...
public:
   ...
   virtual void run(const softsusy::QedQcd&, const NUHMSSM_input_parameters&) = 0;
   ...
   double start, double stop) const
{
   ...
   Coupling_monitor<NUHMSSM_mass_eigenstates, NUHMSSM_parameter_getter>
 ...
 */
template <class T>
void NUHMSSM_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
