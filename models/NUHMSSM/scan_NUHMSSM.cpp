...
NUHMSSM_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   NUHMSSM_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, NUHMSSM_input_parameters& input,
