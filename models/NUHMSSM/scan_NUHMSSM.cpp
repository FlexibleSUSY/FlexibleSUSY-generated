...
struct NUHMSSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
NUHMSSM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   NUHMSSM_input_parameters& input)
{
...
void scan(int solver_type, NUHMSSM_input_parameters& input,
