...
// File generated at Tue 27 Oct 2015 15:27:53
 ...
 */
double NUHMSSM_susy_parameters::calc_beta_vd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUHMSSM_susy_parameters::calc_beta_vd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double NUHMSSM_susy_parameters::calc_beta_vd_three_loop(const Susy_traces& susy_traces) const
{
