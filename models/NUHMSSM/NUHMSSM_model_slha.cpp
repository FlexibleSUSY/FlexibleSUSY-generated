...
NUHMSSM_slha::NUHMSSM_slha(const NUHMSSM_input_parameters& input_,
 ...
 */
NUHMSSM_slha::NUHMSSM_slha(const NUHMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : NUHMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void NUHMSSM_slha::clear()
{
   NUHMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void NUHMSSM_slha::calculate_spectrum()
{
   NUHMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void NUHMSSM_slha::convert_to_slha()
{
...
void NUHMSSM_slha::calculate_ckm_matrix()
{
...
void NUHMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void NUHMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void NUHMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void NUHMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const NUHMSSM_physical& NUHMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

NUHMSSM_physical& NUHMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void NUHMSSM_slha::print(std::ostream& ostr) const
{
   NUHMSSM_mass_eigenstates::print(ostr);
...
void NUHMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const NUHMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
