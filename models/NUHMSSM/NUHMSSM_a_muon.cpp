...
// File generated at Tue 22 Jan 2019 17:42:31

/**
 * @file NUHMSSM_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 17:42:31 with FlexibleSUSY
...
double calculate_a_muon_impl(NUHMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const NUHMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("NUHMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double NUHMSSM_a_muon::calculate_a_muon(const NUHMSSM_mass_eigenstates& model_)
{
...
double NUHMSSM_a_muon::calculate_a_muon_uncertainty(const NUHMSSM_mass_eigenstates& model_)
{
   NUHMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("NUHMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
