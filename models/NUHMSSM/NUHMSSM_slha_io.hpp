...
public:
   ...
   void set_extra(const NUHMSSM_slha&, const NUHMSSM_scales&, const NUHMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NUHMSSM_scales&, const NUHMSSM_observables&);
