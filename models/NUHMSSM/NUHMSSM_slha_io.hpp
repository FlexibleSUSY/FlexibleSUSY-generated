...
public:
   ...
   void set_extra(const NUHMSSM_slha&, const NUHMSSM_scales&, const NUHMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const NUHMSSM_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NUHMSSM_scales&, const NUHMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, NUHMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const NUHMSSM_slha&);
...
void NUHMSSM_slha_io::fill(
   ...
   NUHMSSM_decays const * const decays)
{
