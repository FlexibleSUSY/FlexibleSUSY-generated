...
/**
 * @file NUHMSSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Tue 10 Oct 2017 22:54:03 with FlexibleSUSY
 * 2.0.0 (git commit: e7cd01524dc37f9ba34ce6090bb584b8c724259f) and SARAH 4.12.0 .
 */

#ifndef NUHMSSM_EWSB_SOLVER_INTERFACE_H
#define NUHMSSM_EWSB_SOLVER_INTERFACE_H
...
class NUHMSSM_ewsb_solver_interface {
public:
   virtual ~NUHMSSM_ewsb_solver_interface() {}
   ...
   virtual int solve(NUHMSSM_mass_eigenstates&) = 0;
};
