...
NUHMSSM_slha_io::NUHMSSM_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void NUHMSSM_slha_io::clear()
{
   slha_io.clear();
}

void NUHMSSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void NUHMSSM_slha_io::fill(NUHMSSM_slha& model) const
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSM_slha_io::set_imminpar(const NUHMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSM_slha_io::set_imextpar(const NUHMSSM_input_parameters& input)
{
 ...
 */
void NUHMSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSM_slha_io::set_minpar(const NUHMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSM_slha_io::set_input(const NUHMSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void NUHMSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void NUHMSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void NUHMSSM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void NUHMSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void NUHMSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void NUHMSSM_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, NUHMSSM_info::model_name)
 ...
 */
void NUHMSSM_slha_io::set_mass(const NUHMSSM_physical& physical,
 ...
 */
void NUHMSSM_slha_io::set_mixing_matrices(const NUHMSSM_physical& physical,
 ...
 */
void NUHMSSM_slha_io::set_model_parameters(const NUHMSSM_slha& model)
{
   {
...
void NUHMSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void NUHMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void NUHMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void NUHMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void NUHMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void NUHMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, NUHMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void NUHMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = NUHMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + NUHMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
 ...
 */
void NUHMSSM_slha_io::set_spectrum(const NUHMSSM_slha& model)
{
 ...
 */
void NUHMSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void NUHMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void NUHMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void NUHMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
void NUHMSSM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void NUHMSSM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void NUHMSSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void NUHMSSM_slha_io::fill(NUHMSSM_input_parameters& input) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NUHMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void NUHMSSM_slha_io::fill_minpar_tuple(NUHMSSM_input_parameters& input,
...
void NUHMSSM_slha_io::fill_imminpar_tuple(NUHMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NUHMSSM_slha_io::fill_imextpar_tuple(NUHMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
double NUHMSSM_slha_io::read_scale() const
{
