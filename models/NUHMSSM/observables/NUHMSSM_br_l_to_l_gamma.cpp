...
/**
 * @file NUHMSSM_br_l_to_l_gamma.cpp
 *
...
#include "NUHMSSM_br_l_to_l_gamma.hpp"
...
void run_to_MSUSY(NUHMSSM_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("NUHMSSM_l_to_lgamma: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("NUHMSSM_l_to_lgamma:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("NUHMSSM_l_to_lgamma: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("NUHMSSM_l_to_lgamma: run_to_MSUSY(): "
...
namespace NUHMSSM_br_l_to_l_gamma {
