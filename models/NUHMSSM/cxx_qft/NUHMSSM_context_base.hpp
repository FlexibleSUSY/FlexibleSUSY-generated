...
/**
 * @file cxx_qft/NUHMSSM_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.4 .
 */

#ifndef NUHMSSM_CXXQFT_CONTEXT_BASE_H
#define NUHMSSM_CXXQFT_CONTEXT_BASE_H
...
namespace NUHMSSM_cxx_diagrams {
   ...
   struct context_base {
      NUHMSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(NUHMSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(NUHMSSM_mass_eigenstates_interface const* const m) : model(*m) {}
