...
// File generated at Sat 27 Aug 2016 13:05:56
 ...
 */
double NUHMSSM_soft_parameters::calc_beta_MassG_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUHMSSM_soft_parameters::calc_beta_MassG_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUHMSSM_soft_parameters::calc_beta_MassG_three_loop(const Soft_traces& soft_traces) const
{
