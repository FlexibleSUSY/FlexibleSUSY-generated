 ...
 */
template<>
class NUHMSSM<Two_scale> : public Two_scale_model, public NUHMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(NUHMSSM<Two_scale>::*Memfun_t)();
      NUHMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(NUHMSSM<Two_scale>* model_, Memfun_t fun_)
