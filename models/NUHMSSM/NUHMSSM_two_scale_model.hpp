 ...
 */
template<>
class NUHMSSM<Two_scale> : public Model, public NUHMSSM_slha {
public:
   explicit NUHMSSM(const NUHMSSM_input_parameters& input_ = NUHMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NUHMSSM(const NUHMSSM_slha&, bool do_convert_masses_to_slha = true);
