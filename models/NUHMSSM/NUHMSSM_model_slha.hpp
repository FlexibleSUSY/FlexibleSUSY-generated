...
class NUHMSSM_slha : public NUHMSSM_mass_eigenstates {
public:
   explicit NUHMSSM_slha(const NUHMSSM_input_parameters& input_ = NUHMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NUHMSSM_slha(const NUHMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
