...
class NUHMSSM_slha : public Model {
public:
   explicit NUHMSSM_slha(const NUHMSSM_input_parameters& input_ = NUHMSSM_input_parameters());
   explicit NUHMSSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   NUHMSSM_slha(const NUHMSSM_slha&) = default;
   NUHMSSM_slha(NUHMSSM_slha&&) = default;
   virtual ~NUHMSSM_slha() = default;
   NUHMSSM_slha& operator=(const NUHMSSM_slha&) = default;
   NUHMSSM_slha& operator=(NUHMSSM_slha&&) = default;
   ...
   const NUHMSSM_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   NUHMSSM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   NUHMSSM_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
NUHMSSM_slha<Model>::NUHMSSM_slha(const NUHMSSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
NUHMSSM_slha<Model>::NUHMSSM_slha(const Model& model_,
...
template <class Model>
void NUHMSSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void NUHMSSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void NUHMSSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void NUHMSSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void NUHMSSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void NUHMSSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void NUHMSSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const NUHMSSM_physical& NUHMSSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
NUHMSSM_physical& NUHMSSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void NUHMSSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void NUHMSSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const NUHMSSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
