...
NUHMSSM_physical::NUHMSSM_physical()
   :
 ...
 * to be complex.
 */
void NUHMSSM_physical::convert_to_hk()
{
...
void NUHMSSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd NUHMSSM_physical::get_masses() const
{
...
void NUHMSSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void NUHMSSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSM_physical& phys_pars)
{
