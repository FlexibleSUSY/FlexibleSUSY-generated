...
int main(int argc, char* argv[])
{
   ...
   const MSSMtower_slha<algorithm_type> model(spectrum_generator.get_model());
   ...
   const MSSMtower_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(MSSMtower_slha_io::fill_slhaea(model, qedqcd, scales, observables));
