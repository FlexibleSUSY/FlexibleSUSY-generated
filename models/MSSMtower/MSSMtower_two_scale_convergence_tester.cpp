...
// File generated at Mon 19 Sep 2016 09:35:47
...
MSSMtower_convergence_tester<Two_scale>::MSSMtower_convergence_tester(MSSMtower<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<MSSMtower<Two_scale> >(model, accuracy_goal)
{
}

MSSMtower_convergence_tester<Two_scale>::~MSSMtower_convergence_tester()
{
}

double MSSMtower_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMtower<Two_scale>& ol = get_last_iteration_model();
   const MSSMtower<Two_scale>& ne = get_model();
