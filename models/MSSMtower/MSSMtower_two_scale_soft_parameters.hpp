...
#ifndef MSSMtower_TWO_SCALE_soft_parameters_H
#define MSSMtower_TWO_SCALE_soft_parameters_H
...
class MSSMtower_soft_parameters : public MSSMtower_susy_parameters {
public:
   explicit MSSMtower_soft_parameters(const MSSMtower_input_parameters& input_ = MSSMtower_input_parameters());
   MSSMtower_soft_parameters(const MSSMtower_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   virtual ~MSSMtower_soft_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   MSSMtower_soft_parameters calc_beta() const;
   MSSMtower_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMtower_soft_parameters&);
