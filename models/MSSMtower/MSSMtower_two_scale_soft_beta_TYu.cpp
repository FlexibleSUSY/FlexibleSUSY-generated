...
// File generated at Mon 19 Sep 2016 09:35:37
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_soft_parameters::calc_beta_TYu_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_soft_parameters::calc_beta_TYu_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   const double traceAdjYuTYu = TRACE_STRUCT.traceAdjYuTYu;
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_soft_parameters::calc_beta_TYu_three_loop(const Soft_traces& soft_traces) const
{
