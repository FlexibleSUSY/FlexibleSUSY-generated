...
// File generated at Sat 15 Oct 2016 15:07:09
...
const int MSSMtower_soft_parameters::numberOfParameters;

MSSMtower_soft_parameters::MSSMtower_soft_parameters(const MSSMtower_input_parameters& input_)
   : MSSMtower_susy_parameters(input_)
...
MSSMtower_soft_parameters::MSSMtower_soft_parameters(
   const MSSMtower_susy_parameters& susy_model
   ...
   : MSSMtower_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMtower_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMtower_soft_parameters MSSMtower_soft_parameters::calc_beta() const
{
   ...
   const MSSMtower_susy_parameters susy_betas(MSSMtower_susy_parameters::calc_beta());

   return MSSMtower_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMtower_soft_parameters MSSMtower_soft_parameters::calc_beta(unsigned loops) const
{
   MSSMtower_soft_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void MSSMtower_soft_parameters::clear()
{
   MSSMtower_susy_parameters::clear();
...
Eigen::ArrayXd MSSMtower_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMtower_susy_parameters::get());
...
void MSSMtower_soft_parameters::print(std::ostream& ostr) const
{
   MSSMtower_susy_parameters::print(ostr);
...
void MSSMtower_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMtower_susy_parameters::set(pars);
...
void MSSMtower_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const MSSMtower_soft_parameters& soft_pars)
{
