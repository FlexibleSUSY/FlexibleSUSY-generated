...
// File generated at Mon 19 Sep 2016 09:35:26
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_susy_parameters::calc_beta_Ye_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_susy_parameters::calc_beta_Ye_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_susy_parameters::calc_beta_Ye_three_loop(const Susy_traces& susy_traces) const
{
