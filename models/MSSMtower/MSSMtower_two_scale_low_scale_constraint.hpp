...
#ifndef MSSMtower_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMtower_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMtower_low_scale_constraint.hpp"
...
template<>
class MSSMtower_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   MSSMtower_low_scale_constraint();
   MSSMtower_low_scale_constraint(MSSMtower<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMtower_low_scale_constraint();
   virtual void apply();
