...
// File generated at Mon 27 Feb 2017 13:20:47

#include "MSSMtower_two_scale_high_scale_constraint.hpp"
...
MSSMtower_high_scale_constraint<Two_scale>::MSSMtower_high_scale_constraint()
...
void MSSMtower_high_scale_constraint<Two_scale>::apply()
{
   assert(model && "Error: MSSMtower_high_scale_constraint::apply():"
...
bool MSSMtower_high_scale_constraint<Two_scale>::check_non_perturbative()
{
   bool problem = false;
...
double MSSMtower_high_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double MSSMtower_high_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const MSSMtower_input_parameters& MSSMtower_high_scale_constraint<Two_scale>::get_input_parameters() const
{
   return model->get_input();
}

MSSMtower<Two_scale>* MSSMtower_high_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void MSSMtower_high_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
   model = cast_model<MSSMtower<Two_scale>*>(model_);
}

void MSSMtower_high_scale_constraint<Two_scale>::set_scale(double s)
{
   scale = s;
}

void MSSMtower_high_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
...
void MSSMtower_high_scale_constraint<Two_scale>::initialize()
{
   assert(model && "MSSMtower_high_scale_constraint<Two_scale>::"
...
void MSSMtower_high_scale_constraint<Two_scale>::update_scale()
{
   assert(model && "MSSMtower_high_scale_constraint<Two_scale>::"
          "update_scale(): model pointer is zero.");

   const double currentScale = model->get_scale();
   const MSSMtower_soft_parameters beta_functions(model->calc_beta());
   ...
   if (errno == ERANGE) {
      ...
      ERROR("MSSMtower_high_scale_constraint<Two_scale>: Overflow error"
