...
/**
 * @file MSSMtower_mass_eigenstates.hpp
 *
...
#ifndef MSSMtower_MASS_EIGENSTATES_H
#define MSSMtower_MASS_EIGENSTATES_H

#include "MSSMtower_two_scale_soft_parameters.hpp"
#include "MSSMtower_physical.hpp"
...
class EWSB_solver;
/**
 * @class MSSMtower_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMtower_mass_eigenstates : public MSSMtower_soft_parameters {
public:
   explicit MSSMtower_mass_eigenstates(const MSSMtower_input_parameters& input_ = MSSMtower_input_parameters());
   virtual ~MSSMtower_mass_eigenstates();
   ...
   void set_physical(const MSSMtower_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMtower_physical& get_physical() const;
   MSSMtower_physical& get_physical();
   const Problems<MSSMtower_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<MSSMtower_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(MSSMtower_info::Particles&) const;
...
private:
   struct EWSB_args {
      MSSMtower_mass_eigenstates* model;
   ...
   MSSMtower_physical physical; ///< contains the pole masses and mixings
   Problems<MSSMtower_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const MSSMtower_mass_eigenstates&);
