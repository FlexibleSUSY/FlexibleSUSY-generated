...
// File generated at Mon 27 Feb 2017 13:21:40
...
MSSMtower_effective_couplings::MSSMtower_effective_couplings(
   const MSSMtower_mass_eigenstates& model_,
...
void MSSMtower_effective_couplings::calculate_effective_couplings()
{
...
void MSSMtower_effective_couplings::set_model(const MSSMtower_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void MSSMtower_effective_couplings::copy_mixing_matrices_from_model()
{
...
standard_model::Standard_model MSSMtower_effective_couplings::initialise_SM() const
{
...
void MSSMtower_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> MSSMtower_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> MSSMtower_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> MSSMtower_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double MSSMtower_effective_couplings::number_of_active_flavours(double m) const
{
...
double MSSMtower_effective_couplings::scalar_scaling_factor(double m) const
{
...
double MSSMtower_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double MSSMtower_effective_couplings::get_hhVPVP_partial_width(unsigned gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double MSSMtower_effective_couplings::get_hhVGVG_partial_width(unsigned gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double MSSMtower_effective_couplings::get_AhVPVP_partial_width(unsigned gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double MSSMtower_effective_couplings::get_AhVGVG_partial_width(unsigned gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> MSSMtower_effective_couplings::CpAhFebarFePL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2811 += Conj(ZER(gt3,j1))*Ye(j1,j2);
      }
      tmp_2810 += tmp_2811;
      tmp_2809 += (Conj(ZEL(gt2,j2))) * tmp_2810;
   }
   tmp_2808 += tmp_2809;
...
std::complex<double> MSSMtower_effective_couplings::CpFehhbarFePL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto Ye = MODELPARAMETER(Ye);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2815 += Conj(ZER(gt3,j1))*Ye(j1,j2);
      }
      tmp_2814 += tmp_2815;
      tmp_2813 += (Conj(ZEL(gt1,j2))) * tmp_2814;
   }
   tmp_2812 += tmp_2813;
   result += (-0.7071067811865475*ZH(gt2,0)) * tmp_2812;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CphhSdconjSd(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2818 += Conj(ZD(gt2,j1))*ZD(gt3,j1);
   }
   tmp_2817 += tmp_2818;
   tmp_2816 += ((0.6*Sqr(g1) + 3*Sqr(g2))*(vd*ZH(gt1,0) - vu*ZH(gt1,1))) *
      tmp_2817;
   std::complex<double> tmp_2819;
   std::complex<double> tmp_2820;
   std::complex<double> tmp_2821;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2821 += Conj(ZD(gt2,3 + j1))*ZD(gt3,3 + j1);
   }
   tmp_2820 += tmp_2821;
   tmp_2819 += (0.6*Sqr(g1)*(vd*ZH(gt1,0) - vu*ZH(gt1,1))) * tmp_2820;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2826 += ZD(gt3,3 + j1)*TYd(j1,j2);
      }
      tmp_2825 += tmp_2826;
      tmp_2824 += (Conj(ZD(gt2,j2))) * tmp_2825;
   }
   tmp_2823 += tmp_2824;
   tmp_2822 += (1.4142135623730951*ZH(gt1,0)) * tmp_2823;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2830 += Conj(ZD(gt2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_2829 += tmp_2830;
      tmp_2828 += (ZD(gt3,j2)) * tmp_2829;
   }
   tmp_2827 += tmp_2828;
   tmp_2822 += (1.4142135623730951*ZH(gt1,0)) * tmp_2827;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_2836 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_2835 += tmp_2836;
         tmp_2834 += (ZD(gt3,3 + j2)) * tmp_2835;
      }
      tmp_2833 += tmp_2834;
      tmp_2832 += (Conj(ZD(gt2,3 + j3))) * tmp_2833;
   }
   tmp_2831 += tmp_2832;
   tmp_2822 += (2*vd*ZH(gt1,0)) * tmp_2831;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_2842 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_2841 += tmp_2842;
         tmp_2840 += (Conj(ZD(gt2,j2))) * tmp_2841;
      }
      tmp_2839 += tmp_2840;
      tmp_2838 += (ZD(gt3,j3)) * tmp_2839;
   }
   tmp_2837 += tmp_2838;
   tmp_2822 += (2*vd*ZH(gt1,0)) * tmp_2837;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2846 += Yd(j1,j2)*ZD(gt3,3 + j1);
      }
      tmp_2845 += tmp_2846;
      tmp_2844 += (Conj(ZD(gt2,j2))) * tmp_2845;
   }
   tmp_2843 += tmp_2844;
   tmp_2822 += (-1.4142135623730951*Conj(Mu)*ZH(gt1,1)) * tmp_2843;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2850 += Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1));
      }
      tmp_2849 += tmp_2850;
      tmp_2848 += (ZD(gt3,j2)) * tmp_2849;
   }
   tmp_2847 += tmp_2848;
   tmp_2822 += (-1.4142135623730951*Mu*ZH(gt1,1)) * tmp_2847;
   tmp_2819 += (-3) * tmp_2822;
   tmp_2816 += (2) * tmp_2819;
   result += (0.08333333333333333) * tmp_2816;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CphhSuconjSu(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2853 += Conj(ZU(gt2,j1))*ZU(gt3,j1);
   }
   tmp_2852 += tmp_2853;
   tmp_2851 += ((0.6*Sqr(g1) - 3*Sqr(g2))*(vd*ZH(gt1,0) - vu*ZH(gt1,1))) *
      tmp_2852;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2858 += Yu(j1,j2)*ZU(gt3,3 + j1);
      }
      tmp_2857 += tmp_2858;
      tmp_2856 += (Conj(ZU(gt2,j2))) * tmp_2857;
   }
   tmp_2855 += tmp_2856;
   tmp_2854 += (-4.242640687119286*Conj(Mu)*ZH(gt1,0)) * tmp_2855;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2862 += Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1));
      }
      tmp_2861 += tmp_2862;
      tmp_2860 += (ZU(gt3,j2)) * tmp_2861;
   }
   tmp_2859 += tmp_2860;
   tmp_2854 += (-4.242640687119286*Mu*ZH(gt1,0)) * tmp_2859;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2866 += ZU(gt3,3 + j1)*TYu(j1,j2);
      }
      tmp_2865 += tmp_2866;
      tmp_2864 += (Conj(ZU(gt2,j2))) * tmp_2865;
   }
   tmp_2863 += tmp_2864;
   tmp_2854 += (4.242640687119286*ZH(gt1,1)) * tmp_2863;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2870 += Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2));
      }
      tmp_2869 += tmp_2870;
      tmp_2868 += (ZU(gt3,j2)) * tmp_2869;
   }
   tmp_2867 += tmp_2868;
   tmp_2854 += (4.242640687119286*ZH(gt1,1)) * tmp_2867;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_2876 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_2875 += tmp_2876;
         tmp_2874 += (ZU(gt3,3 + j2)) * tmp_2875;
      }
      tmp_2873 += tmp_2874;
      tmp_2872 += (Conj(ZU(gt2,3 + j3))) * tmp_2873;
   }
   tmp_2871 += tmp_2872;
   tmp_2854 += (6*vu*ZH(gt1,1)) * tmp_2871;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_2882 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_2881 += tmp_2882;
         tmp_2880 += (Conj(ZU(gt2,j2))) * tmp_2881;
      }
      tmp_2879 += tmp_2880;
      tmp_2878 += (ZU(gt3,j3)) * tmp_2879;
   }
   tmp_2877 += tmp_2878;
   tmp_2854 += (6*vu*ZH(gt1,1)) * tmp_2877;
   std::complex<double> tmp_2883;
   std::complex<double> tmp_2884;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2884 += Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1);
   }
   tmp_2883 += tmp_2884;
   tmp_2854 += (1.2*Sqr(g1)*(vd*ZH(gt1,0) - vu*ZH(gt1,1))) * tmp_2883;
   tmp_2851 += (-2) * tmp_2854;
   result += (0.08333333333333333) * tmp_2851;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CphhSeconjSe(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2887 += Conj(ZE(gt2,j1))*ZE(gt3,j1);
   }
   tmp_2886 += tmp_2887;
   tmp_2885 += (-((0.6*Sqr(g1) - Sqr(g2))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)))) *
      tmp_2886;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2892 += ZE(gt3,3 + j1)*TYe(j1,j2);
      }
      tmp_2891 += tmp_2892;
      tmp_2890 += (Conj(ZE(gt2,j2))) * tmp_2891;
   }
   tmp_2889 += tmp_2890;
   tmp_2888 += (-1.4142135623730951*ZH(gt1,0)) * tmp_2889;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2896 += Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_2895 += tmp_2896;
      tmp_2894 += (ZE(gt3,j2)) * tmp_2895;
   }
   tmp_2893 += tmp_2894;
   tmp_2888 += (-1.4142135623730951*ZH(gt1,0)) * tmp_2893;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_2902 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_2901 += tmp_2902;
         tmp_2900 += (ZE(gt3,3 + j2)) * tmp_2901;
      }
      tmp_2899 += tmp_2900;
      tmp_2898 += (Conj(ZE(gt2,3 + j3))) * tmp_2899;
   }
   tmp_2897 += tmp_2898;
   tmp_2888 += (-2*vd*ZH(gt1,0)) * tmp_2897;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_2908 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_2907 += tmp_2908;
         tmp_2906 += (Conj(ZE(gt2,j2))) * tmp_2907;
      }
      tmp_2905 += tmp_2906;
      tmp_2904 += (ZE(gt3,j3)) * tmp_2905;
   }
   tmp_2903 += tmp_2904;
   tmp_2888 += (-2*vd*ZH(gt1,0)) * tmp_2903;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2912 += Ye(j1,j2)*ZE(gt3,3 + j1);
      }
      tmp_2911 += tmp_2912;
      tmp_2910 += (Conj(ZE(gt2,j2))) * tmp_2911;
   }
   tmp_2909 += tmp_2910;
   tmp_2888 += (1.4142135623730951*Conj(Mu)*ZH(gt1,1)) * tmp_2909;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2916 += Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1));
      }
      tmp_2915 += tmp_2916;
      tmp_2914 += (ZE(gt3,j2)) * tmp_2915;
   }
   tmp_2913 += tmp_2914;
   tmp_2888 += (1.4142135623730951*Mu*ZH(gt1,1)) * tmp_2913;
   std::complex<double> tmp_2917;
   std::complex<double> tmp_2918;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2918 += Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1);
   }
   tmp_2917 += tmp_2918;
   tmp_2888 += (0.6*Sqr(g1)*(vd*ZH(gt1,0) - vu*ZH(gt1,1))) * tmp_2917;
   tmp_2885 += (2) * tmp_2888;
   result += (0.25) * tmp_2885;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CphhHpmconjHpm(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
...
std::complex<double> MSSMtower_effective_couplings::CpChahhbarChaPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMtower_effective_couplings::CpFdhhbarFdPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto Yd = MODELPARAMETER(Yd);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2922 += Conj(ZDR(gt3,j1))*Yd(j1,j2);
      }
      tmp_2921 += tmp_2922;
      tmp_2920 += (Conj(ZDL(gt1,j2))) * tmp_2921;
   }
   tmp_2919 += tmp_2920;
   result += (-0.7071067811865475*ZH(gt2,0)) * tmp_2919;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CpFuhhbarFuPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto Yu = MODELPARAMETER(Yu);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2926 += Conj(ZUR(gt3,j1))*Yu(j1,j2);
      }
      tmp_2925 += tmp_2926;
      tmp_2924 += (Conj(ZUL(gt1,j2))) * tmp_2925;
   }
   tmp_2923 += tmp_2924;
   result += (-0.7071067811865475*ZH(gt2,1)) * tmp_2923;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CphhVWmconjVWm(unsigned gt1) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> MSSMtower_effective_couplings::CpAhSdconjSd(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto Yd = MODELPARAMETER(Yd);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2931 += ZD(gt3,3 + j1)*TYd(j1,j2);
      }
      tmp_2930 += tmp_2931;
      tmp_2929 += (Conj(ZD(gt2,j2))) * tmp_2930;
   }
   tmp_2928 += tmp_2929;
   tmp_2927 += (ZA(gt1,0)) * tmp_2928;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2935 += Conj(ZD(gt2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_2934 += tmp_2935;
      tmp_2933 += (ZD(gt3,j2)) * tmp_2934;
   }
   tmp_2932 += tmp_2933;
   tmp_2927 += (-ZA(gt1,0)) * tmp_2932;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2940 += Yd(j1,j2)*ZD(gt3,3 + j1);
      }
      tmp_2939 += tmp_2940;
      tmp_2938 += (Conj(ZD(gt2,j2))) * tmp_2939;
   }
   tmp_2937 += tmp_2938;
   tmp_2936 += (Conj(Mu)) * tmp_2937;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2944 += Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1));
      }
      tmp_2943 += tmp_2944;
      tmp_2942 += (ZD(gt3,j2)) * tmp_2943;
   }
   tmp_2941 += tmp_2942;
   tmp_2936 += (-Mu) * tmp_2941;
   tmp_2927 += (ZA(gt1,1)) * tmp_2936;
   result += (std::complex<double>(0.,-0.7071067811865475)) * tmp_2927;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CpAhSuconjSu(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto Yu = MODELPARAMETER(Yu);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2949 += Yu(j1,j2)*ZU(gt3,3 + j1);
      }
      tmp_2948 += tmp_2949;
      tmp_2947 += (Conj(ZU(gt2,j2))) * tmp_2948;
   }
   tmp_2946 += tmp_2947;
   tmp_2945 += (Conj(Mu)*ZA(gt1,0)) * tmp_2946;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2953 += Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1));
      }
      tmp_2952 += tmp_2953;
      tmp_2951 += (ZU(gt3,j2)) * tmp_2952;
   }
   tmp_2950 += tmp_2951;
   tmp_2945 += (-(Mu*ZA(gt1,0))) * tmp_2950;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2957 += ZU(gt3,3 + j1)*TYu(j1,j2);
      }
      tmp_2956 += tmp_2957;
      tmp_2955 += (Conj(ZU(gt2,j2))) * tmp_2956;
   }
   tmp_2954 += tmp_2955;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2961 += Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2));
      }
      tmp_2960 += tmp_2961;
      tmp_2959 += (ZU(gt3,j2)) * tmp_2960;
   }
   tmp_2958 += tmp_2959;
   tmp_2954 += (-1) * tmp_2958;
   tmp_2945 += (ZA(gt1,1)) * tmp_2954;
   result += (std::complex<double>(0.,-0.7071067811865475)) * tmp_2945;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CpAhSeconjSe(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto Ye = MODELPARAMETER(Ye);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2966 += ZE(gt3,3 + j1)*TYe(j1,j2);
      }
      tmp_2965 += tmp_2966;
      tmp_2964 += (Conj(ZE(gt2,j2))) * tmp_2965;
   }
   tmp_2963 += tmp_2964;
   tmp_2962 += (ZA(gt1,0)) * tmp_2963;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2970 += Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_2969 += tmp_2970;
      tmp_2968 += (ZE(gt3,j2)) * tmp_2969;
   }
   tmp_2967 += tmp_2968;
   tmp_2962 += (-ZA(gt1,0)) * tmp_2967;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2975 += Ye(j1,j2)*ZE(gt3,3 + j1);
      }
      tmp_2974 += tmp_2975;
      tmp_2973 += (Conj(ZE(gt2,j2))) * tmp_2974;
   }
   tmp_2972 += tmp_2973;
   tmp_2971 += (Conj(Mu)) * tmp_2972;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2979 += Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1));
      }
      tmp_2978 += tmp_2979;
      tmp_2977 += (ZE(gt3,j2)) * tmp_2978;
   }
   tmp_2976 += tmp_2977;
   tmp_2971 += (-Mu) * tmp_2976;
   tmp_2962 += (ZA(gt1,1)) * tmp_2971;
   result += (std::complex<double>(0.,-0.7071067811865475)) * tmp_2962;

   return result;
}

std::complex<double> MSSMtower_effective_couplings::CpAhHpmconjHpm(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> MSSMtower_effective_couplings::CpAhChabarChaPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMtower_effective_couplings::CpAhFdbarFdPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMtower_effective_couplings::CpAhFubarFuPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
void MSSMtower_effective_couplings::calculate_eff_CphhVPVP(unsigned gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
void MSSMtower_effective_couplings::calculate_eff_CphhVGVG(unsigned gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
...
void MSSMtower_effective_couplings::calculate_eff_CpAhVPVP(unsigned gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto MCha = MODELPARAMETER(MCha);
...
void MSSMtower_effective_couplings::calculate_eff_CpAhVGVG(unsigned gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
