...
// File generated at Wed 12 Apr 2017 10:30:11
...
struct MSSMtower_scales {
   MSSMtower_scales() : HighScale(0.), SUSYScale(0.), LowScale(0.) {}
...
public:
   ...
   void fill(MSSMtower_input_parameters&) const;
   void fill(MSSMtower_mass_eigenstates&) const;
   template <class T> void fill(MSSMtower_slha<T>&) const;
   ...
   void set_extpar(const MSSMtower_input_parameters&);
   template <class T> void set_extra(const MSSMtower_slha<T>&, const MSSMtower_scales&, const MSSMtower_observables&);
   void set_minpar(const MSSMtower_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const MSSMtower_slha<T>&);
   template <class T> void set_spectrum(const MSSMtower<T>&);
   void set_spinfo(const Problems<MSSMtower_info::NUMBER_OF_PARTICLES>&);
   ...
   static void fill_minpar_tuple(MSSMtower_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMtower_input_parameters&, int, double);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MSSMtower_slha<T>&, const softsusy::QedQcd&, const MSSMtower_scales&, const MSSMtower_observables&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMtower_slha<T>&, const softsusy::QedQcd&, const MSSMtower_scales&, const MSSMtower_observables&);
...
private:
   ...
   void set_mass(const MSSMtower_physical&, bool);
   void set_mixing_matrices(const MSSMtower_physical&, bool);
   template <class T> void set_model_parameters(const MSSMtower_slha<T>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMtower_mass_eigenstates&) const;
   void fill_physical(MSSMtower_physical&) const;
};
 ...
 */
template <class T>
void MSSMtower_slha_io::fill(MSSMtower_slha<T>& model) const
{
   fill(static_cast<MSSMtower_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class T>
void MSSMtower_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMtower_slha<T>& model,
   const softsusy::QedQcd& qedqcd, const MSSMtower_scales& scales,
   const MSSMtower_observables& observables)
{
   MSSMtower_slha_io slha_io;
   const MSSMtower_input_parameters& input = model.get_input();
...
template <class T>
SLHAea::Coll MSSMtower_slha_io::fill_slhaea(
   const MSSMtower_slha<T>& model, const softsusy::QedQcd& qedqcd,
   const MSSMtower_scales& scales, const MSSMtower_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMtower_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class T>
void MSSMtower_slha_io::set_model_parameters(const MSSMtower_slha<T>& model)
{
   {
 ...
 */
template <class T>
void MSSMtower_slha_io::set_extra(
   const MSSMtower_slha<T>& model, const MSSMtower_scales& scales,
   const MSSMtower_observables& observables)
{
   const MSSMtower_physical physical(model.get_physical_slha());
 ...
 */
template <class T>
void MSSMtower_slha_io::set_spectrum(const MSSMtower<T>& model)
{
   const MSSMtower_slha<T> model_slha(model);
 ...
 */
template <class T>
void MSSMtower_slha_io::set_spectrum(const MSSMtower_slha<T>& model)
{
   const MSSMtower_physical physical(model.get_physical_slha());
