...
// File generated at Mon 19 Sep 2016 09:35:27
 ...
 */
double MSSMtower_susy_parameters::calc_beta_vd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMtower_susy_parameters::calc_beta_vd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSMtower_susy_parameters::calc_beta_vd_three_loop(const Susy_traces& susy_traces) const
{
