...
class MSSMtower_effective_couplings {
public:
   MSSMtower_effective_couplings(const MSSMtower_mass_eigenstates&,
   ...
   void set_model(const MSSMtower_mass_eigenstates& model_);
