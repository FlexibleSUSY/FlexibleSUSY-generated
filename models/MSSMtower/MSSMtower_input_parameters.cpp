...
Eigen::ArrayXd MSSMtower_input_parameters::get() const
{
...
void MSSMtower_input_parameters::set(const Eigen::ArrayXd& pars)
{
   SignMu = pars(0);
   MSUSY = pars(1);
   M1Input = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMtower_input_parameters& input)
{
