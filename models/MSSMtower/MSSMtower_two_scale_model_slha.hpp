...
/**
 * @file MSSMtower_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Mon 19 Sep 2016 09:35:56

#ifndef MSSMtower_TWO_SCALE_SLHA_H
#define MSSMtower_TWO_SCALE_SLHA_H

#include "MSSMtower_two_scale_model.hpp"
#include "MSSMtower_physical.hpp"
#include "MSSMtower_model_slha.hpp"
...
/**
 * @class MSSMtower_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class MSSMtower_slha<Two_scale> : public MSSMtower<Two_scale> {
public:
   explicit MSSMtower_slha(const MSSMtower_input_parameters& input_ = MSSMtower_input_parameters());
   explicit MSSMtower_slha(const MSSMtower<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~MSSMtower_slha();
   ...
   const MSSMtower_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MSSMtower_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MSSMtower_physical physical_slha; ///< contains the pole masses and mixings in slha convention
...
std::ostream& operator<<(std::ostream& ostr, const MSSMtower_slha<Two_scale>& model);
