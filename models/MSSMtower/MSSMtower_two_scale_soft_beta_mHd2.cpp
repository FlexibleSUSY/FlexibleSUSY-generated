...
// File generated at Wed 12 Apr 2017 10:30:00
 ...
 */
double MSSMtower_soft_parameters::calc_beta_mHd2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMtower_soft_parameters::calc_beta_mHd2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSMtower_soft_parameters::calc_beta_mHd2_three_loop(const Soft_traces& soft_traces) const
{
