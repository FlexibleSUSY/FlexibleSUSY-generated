...
char const * const MSSMtower_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "Te", "Td", "Tu", "HMIX", "MSQ2", "MSE2",
   "MSL2", "MSU2", "MSD2", "MSOFT" }
;

MSSMtower_slha_io::MSSMtower_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MSSMtower_slha_io::clear()
{
   slha_io.clear();
}

void MSSMtower_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void MSSMtower_slha_io::set_extpar(const MSSMtower_input_parameters& input)
{
 ...
 */
void MSSMtower_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMtower_slha_io::set_spinfo(const Problems<MSSMtower_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void MSSMtower_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMtower_info::model_name)
 ...
 */
void MSSMtower_slha_io::set_mass(const MSSMtower_physical& physical,
 ...
 */
void MSSMtower_slha_io::set_mixing_matrices(const MSSMtower_physical& physical,
...
void MSSMtower_slha_io::set_ckm(
...
void MSSMtower_slha_io::set_pmns(
 ...
 */
void MSSMtower_slha_io::write_to(const std::string& output)
{
   if (output == "-")
 ...
 */
double MSSMtower_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMtower_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMtower_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMtower_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMtower_slha_io::fill(MSSMtower_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&MSSMtower_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&MSSMtower_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void MSSMtower_slha_io::fill_drbar_parameters(MSSMtower_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMtower_slha_io::fill(MSSMtower_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMtower_physical physical_hk;
 ...
 */
void MSSMtower_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MSSMtower_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void MSSMtower_slha_io::fill_minpar_tuple(MSSMtower_input_parameters& input,
...
void MSSMtower_slha_io::fill_extpar_tuple(MSSMtower_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMtower_slha_io::fill_physical(MSSMtower_physical& physical) const
{
   {
 ...
 */
double MSSMtower_slha_io::read_scale() const
{
   double scale = 0.;
