 ...
 */
double MSSMtower_susy_parameters::calc_beta_vu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMtower_susy_parameters::calc_beta_vu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMtower_susy_parameters::calc_beta_vu_three_loop(const Susy_traces& susy_traces) const
{
