libMSSMtower = FileNameJoin[{Directory[], "models", "MSSMtower", "MSSMtower_librarylink.so"}];

FSMSSMtowerGetSettings = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerGetSettings", LinkObject, LinkObject];
FSMSSMtowerGetSMInputParameters = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerGetSMInputParameters", LinkObject, LinkObject];
FSMSSMtowerGetInputParameters = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerGetInputParameters", LinkObject, LinkObject];

FSMSSMtowerOpenHandleLib = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerOpenHandle", {{Real,1}}, Integer];
FSMSSMtowerCloseHandle = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerCloseHandle", {Integer}, Void];

FSMSSMtowerSetLib = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerSet", {Integer, {Real,1}}, Void];

FSMSSMtowerCalculateSpectrum = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerCalculateSpectrum", LinkObject, LinkObject];
FSMSSMtowerCalculateObservables = LibraryFunctionLoad[libMSSMtower, "FSMSSMtowerCalculateObservables", LinkObject, LinkObject];

FSMSSMtowerCalculateSpectrum::error = "`1`";
FSMSSMtowerCalculateSpectrum::warning = "`1`";

FSMSSMtowerCalculateObservables::error = "`1`";
...
Options[FSMSSMtowerOpenHandle] = {
    Sequence @@ fsDefaultSettings,
    Sequence @@ fsDefaultSMParameters,
    Sequence @@ fsMSSMtowerDefaultInputParameters
};

FSMSSMtowerOpenHandle[a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSMSSMtowerOpenHandle[a, Sequence @@ s, r];
...
Options[FSMSSMtowerSet] = Options[FSMSSMtowerOpenHandle];

FSMSSMtowerSet[handle_Integer, a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSMSSMtowerSet[handle, a, Sequence @@ s, r];
...
FSMSSMtowerSet[handle_Integer, p:OptionsPattern[]] :=
    FSMSSMtowerSetLib[
        ...
        FSMSSMtowerGetInputParameters[handle]]];
