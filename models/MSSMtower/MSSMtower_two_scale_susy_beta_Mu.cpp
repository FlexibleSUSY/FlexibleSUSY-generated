 ...
 */
double MSSMtower_susy_parameters::calc_beta_Mu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMtower_susy_parameters::calc_beta_Mu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMtower_susy_parameters::calc_beta_Mu_three_loop(const Susy_traces& susy_traces) const
{
