...
#include "MSSMtower_spectrum_generator_interface.hpp"
#include "MSSMtower_two_scale_susy_scale_constraint.hpp"
#include "MSSMtower_two_scale_convergence_tester.hpp"
...
template <class T>
class MSSMtower_spectrum_generator
   : public MSSMtower_spectrum_generator_interface<T> {
public:
   MSSMtower_spectrum_generator()
      : MSSMtower_spectrum_generator_interface<T>()
      , eft()
      , susy_scale(0.)
      , low_scale(0.)
   {}
   virtual ~MSSMtower_spectrum_generator() {}
   ...
   virtual void run(const softsusy::QedQcd&, const MSSMtower_input_parameters&);
   void write_running_couplings(const std::string& filename = "MSSMtower_rgflow.dat") const;
                                ...
                                const MSSMtower_input_parameters& input)
{
   ...
   MSSMtower_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   ...
   MSSMtower_standard_model_Matching<T> matching;
 ...
 */
template <class T>
void MSSMtower_spectrum_generator<T>::write_running_couplings(
   const std::string& filename) const
{
   MSSMtower_spectrum_generator_interface<T>::write_running_couplings(filename, low_scale, susy_scale);
}
