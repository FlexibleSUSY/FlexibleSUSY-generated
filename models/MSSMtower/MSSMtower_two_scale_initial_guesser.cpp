...
#include "MSSMtower_two_scale_initial_guesser.hpp"
...
MSSMtower_standard_model_initial_guesser<Two_scale>::MSSMtower_standard_model_initial_guesser(
   ...
   const MSSMtower_susy_scale_constraint<Two_scale>& susy_constraint_
)
...
{
   assert(model && "MSSMtower_initial_guesser: Error: pointer to model"
          " MSSMtower<Two_scale> must not be zero");
}
 ...
 */
void MSSMtower_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 */
void MSSMtower_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void MSSMtower_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MSSMtower_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMtower_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMtower_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MSSMtower_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
   ...
   MSSMtower_standard_model_Matching<Two_scale> matching;
