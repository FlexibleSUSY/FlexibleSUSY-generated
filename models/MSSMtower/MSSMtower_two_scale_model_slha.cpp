...
/**
 * @file MSSMtower_two_scale_model_slha.cpp
 * @brief MSSMtower model class wrapper for SLHA conversion
 */
...
#define CLASSNAME MSSMtower_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::MSSMtower_slha(const MSSMtower_input_parameters& input_)
   : MSSMtower<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::MSSMtower_slha(const MSSMtower<Two_scale>& model_,
...
CLASSNAME::~MSSMtower_slha()
{
}

void CLASSNAME::clear()
{
   MSSMtower<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   MSSMtower<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const MSSMtower_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

MSSMtower_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   MSSMtower<Two_scale>::print(ostr);
