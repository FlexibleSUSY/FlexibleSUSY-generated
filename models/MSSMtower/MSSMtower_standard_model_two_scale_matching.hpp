...
#ifndef MSSMtower_TWO_SCALE_MATCHING_H
#define MSSMtower_TWO_SCALE_MATCHING_H
...
template <class T> class MSSMtower;
template <class T> class MSSMtower_standard_model_Matching;
...
template<>
class MSSMtower_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MSSMtower_standard_model_Matching();

   MSSMtower_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MSSMtower<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MSSMtower_standard_model_Matching();
