...
// File generated at Wed 12 Apr 2017 10:29:41
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_susy_parameters::calc_beta_Yu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_susy_parameters::calc_beta_Yu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
Eigen::Matrix<double,3,3> MSSMtower_susy_parameters::calc_beta_Yu_three_loop(const Susy_traces& susy_traces) const
{
