...
#ifndef MSSMtower_TWO_SCALE_susy_parameters_H
#define MSSMtower_TWO_SCALE_susy_parameters_H
...
class MSSMtower_susy_parameters : public Beta_function {
public:
   explicit MSSMtower_susy_parameters(const MSSMtower_input_parameters& input_ = MSSMtower_input_parameters());
   MSSMtower_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const MSSMtower_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   virtual ~MSSMtower_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const MSSMtower_input_parameters& get_input() const;
   MSSMtower_input_parameters& get_input();
   void set_input_parameters(const MSSMtower_input_parameters&);

   MSSMtower_susy_parameters calc_beta() const;
   MSSMtower_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
protected:
   ...
   MSSMtower_input_parameters input;
...
std::ostream& operator<<(std::ostream&, const MSSMtower_susy_parameters&);
