...
MSSMtower_physical::MSSMtower_physical()
   :
 ...
 * to be complex.
 */
void MSSMtower_physical::convert_to_hk()
{
...
void MSSMtower_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSMtower_physical::get_masses() const
{
...
void MSSMtower_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void MSSMtower_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MSSMtower_physical& phys_pars)
{
