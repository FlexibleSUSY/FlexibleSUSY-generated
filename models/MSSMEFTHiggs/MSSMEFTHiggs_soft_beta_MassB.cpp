 ...
 */
double MSSMEFTHiggs_soft_parameters::calc_beta_MassB_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMEFTHiggs_soft_parameters::calc_beta_MassB_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMEFTHiggs_soft_parameters::calc_beta_MassB_3_loop(const Soft_traces& soft_traces) const
{
