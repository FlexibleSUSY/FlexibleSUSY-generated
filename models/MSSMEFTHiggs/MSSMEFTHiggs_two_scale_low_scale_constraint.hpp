...
#ifndef MSSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMEFTHiggs_low_scale_constraint.hpp"
...
template<>
class MSSMEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "MSSMEFTHiggs low-scale constraint"; }
