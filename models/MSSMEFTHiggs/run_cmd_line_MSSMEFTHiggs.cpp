...
int run_solver(const MSSMEFTHiggs_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
