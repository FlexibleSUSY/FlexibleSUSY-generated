...
public:
   ...
   void set_extra(const MSSMEFTHiggs_slha&, const MSSMEFTHiggs_scales&, const MSSMEFTHiggs_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMEFTHiggs_scales&, const MSSMEFTHiggs_observables&);
