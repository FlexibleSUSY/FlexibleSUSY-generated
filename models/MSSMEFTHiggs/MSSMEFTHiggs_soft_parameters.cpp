...
// File generated at Tue 22 Jan 2019 14:45:43
...
const int MSSMEFTHiggs_soft_parameters::numberOfParameters;

MSSMEFTHiggs_soft_parameters::MSSMEFTHiggs_soft_parameters(const MSSMEFTHiggs_input_parameters& input_)
   : MSSMEFTHiggs_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMEFTHiggs_soft_parameters::MSSMEFTHiggs_soft_parameters(
   const MSSMEFTHiggs_susy_parameters& susy_model
   ...
   : MSSMEFTHiggs_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMEFTHiggs_soft_parameters MSSMEFTHiggs_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMEFTHiggs_susy_parameters susy_betas(MSSMEFTHiggs_susy_parameters::calc_beta(loops));

   return MSSMEFTHiggs_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMEFTHiggs_soft_parameters MSSMEFTHiggs_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMEFTHiggs_soft_parameters::clear()
{
   MSSMEFTHiggs_susy_parameters::clear();
...
Eigen::ArrayXd MSSMEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMEFTHiggs_susy_parameters::get());
...
void MSSMEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   MSSMEFTHiggs_susy_parameters::print(ostr);
...
void MSSMEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMEFTHiggs_susy_parameters::set(pars);
...
MSSMEFTHiggs_soft_parameters::Soft_traces MSSMEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_soft_parameters& soft_pars)
{
