...
/**
 * @file MSSMEFTHiggs_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
#define MSSMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMEFTHiggs_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMEFTHiggs_mass_eigenstates_interface {
public:
   virtual ~MSSMEFTHiggs_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMEFTHiggs_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMEFTHiggs_input_parameters& get_input_parameters() const = 0;
   virtual MSSMEFTHiggs_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMEFTHiggs_physical& get_physical() const = 0;
   virtual MSSMEFTHiggs_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMEFTHiggs_physical&) = 0;
