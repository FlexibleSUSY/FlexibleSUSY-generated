...
namespace MSSMEFTHiggs_info {
   ...
   class MSSMEFTHiggs_particle_names : public Names {
   public:
      virtual ~MSSMEFTHiggs_particle_names() = default;
   ...
   class MSSMEFTHiggs_parameter_names : public Names {
   public:
      virtual ~MSSMEFTHiggs_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMEFTHiggs_particle_names  particle_names_getter{};
   const MSSMEFTHiggs_parameter_names parameter_names_getter{};
