...
/**
 * @file cxx_qft/MSSMEFTHiggs_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.4 .
 */

#ifndef MSSMEFTHiggs_CXXQFT_CONTEXT_BASE_H
#define MSSMEFTHiggs_CXXQFT_CONTEXT_BASE_H
...
namespace MSSMEFTHiggs_cxx_diagrams {
   ...
   struct context_base {
      MSSMEFTHiggs_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MSSMEFTHiggs_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MSSMEFTHiggs_mass_eigenstates_interface const* const m) : model(*m) {}
