   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const int gt1057 = indices[0];
   const int gt1058 = indices[1];
...
ChiralVertex VertexImpl<fields::Glu, fields::Glu, fields::VG>::evaluate(
...
InverseMetricVertex VertexImpl<fields::Sd, typename fields::conj<fields::Su>::type, typename fields::conj<fields::VWm>::type, fields::VG>::evaluate(
   const std::array<int, 2>& indices, const context_base& context)
{
   const int gt1 = indices[0];
   const int gt2 = indices[1];
...
InverseMetricVertex VertexImpl<fields::Su, typename fields::conj<fields::Sd>::type, fields::VG, fields::VWm>::evaluate(
   const std::array<int, 2>& indices, const context_base& context)
{
   const int gt1 = indices[0];
   const int gt2 = indices[1];
...
MomentumDifferenceVertex VertexImpl<fields::Sv, typename fields::conj<fields::Sv>::type, fields::VP>::evaluate(
   const std::array<int, 2>& indices, const context_base& context)
{
   int minuend_index = 0;
   int subtrahend_index = 1;

   const int gt1066 = indices[0];
   const int gt1067 = indices[1];
...
TripleVectorVertex VertexImpl<fields::VG, fields::VG, fields::VG>::evaluate(
   const std::array<int, 0>& indices, const context_base& context)
{
   const auto g3 = MODELPARAMETER(g3);
...
MomentumVertex VertexImpl<typename fields::bar<fields::gG>::type, fields::gG, fields::VG>::evaluate(
   const std::array<int, 0>& indices, const context_base& context)
{
   const auto g3 = MODELPARAMETER(g3);
