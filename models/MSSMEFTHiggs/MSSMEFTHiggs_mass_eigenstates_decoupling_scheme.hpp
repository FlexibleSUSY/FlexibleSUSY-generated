...
/**
 * @file MSSMEFTHiggs_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "MSSMEFTHiggs_info.hpp"
#include "MSSMEFTHiggs_physical.hpp"
#include "MSSMEFTHiggs_soft_parameters.hpp"
#include "MSSMEFTHiggs_mass_eigenstates_interface.hpp"
...
#define SUPER(p) MSSMEFTHiggs_soft_parameters::p
...
/**
 * @class MSSMEFTHiggs_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMEFTHiggs_mass_eigenstates_decoupling_scheme
   : private MSSMEFTHiggs_soft_parameters
   , public MSSMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit MSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const MSSMEFTHiggs_input_parameters& input_ = MSSMEFTHiggs_input_parameters());
   explicit MSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const MSSMEFTHiggs_mass_eigenstates&);
   MSSMEFTHiggs_mass_eigenstates_decoupling_scheme(const MSSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   MSSMEFTHiggs_mass_eigenstates_decoupling_scheme(MSSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSMEFTHiggs_mass_eigenstates_decoupling_scheme() = default;
   MSSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(const MSSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   MSSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(MSSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSMEFTHiggs_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MSSMEFTHiggs_mass_eigenstates&);
   ...
   const MSSMEFTHiggs_input_parameters& get_input_parameters() const override;
   MSSMEFTHiggs_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSMEFTHiggs_physical& get_physical() const override;
   MSSMEFTHiggs_physical& get_physical() override;
   ...
   void set_physical(const MSSMEFTHiggs_physical&) override;
...
private:
   ...
   MSSMEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMEFTHiggs_info::model_name,
                     &MSSMEFTHiggs_info::particle_names_getter,
                     &MSSMEFTHiggs_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const MSSMEFTHiggs_mass_eigenstates_decoupling_scheme&);
