 ...
 */
template<>
class MSSMEFTHiggs<Two_scale> : public Model, public MSSMEFTHiggs_slha {
public:
   explicit MSSMEFTHiggs(const MSSMEFTHiggs_input_parameters& input_ = MSSMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MSSMEFTHiggs(const MSSMEFTHiggs_slha&, bool do_convert_masses_to_slha = true);
