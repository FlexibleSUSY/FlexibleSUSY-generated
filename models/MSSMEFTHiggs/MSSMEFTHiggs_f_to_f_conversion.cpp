...
/**
 * @file MSSMEFTHiggs_f_to_f_conversion.cpp
 *
...
#include "MSSMEFTHiggs_f_to_f_conversion.hpp"
...
namespace MSSMEFTHiggs_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const MSSMEFTHiggs_mass_eigenstates& model) {
