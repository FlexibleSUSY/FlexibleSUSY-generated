...
// File generated at Tue 10 Oct 2017 20:22:40
...
#define CLASSNAME MSSMEFTHiggs_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int MSSMEFTHiggs_susy_parameters::numberOfParameters;

MSSMEFTHiggs_susy_parameters::MSSMEFTHiggs_susy_parameters(const MSSMEFTHiggs_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMEFTHiggs_susy_parameters::MSSMEFTHiggs_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const MSSMEFTHiggs_input_parameters& input_
...
Eigen::ArrayXd MSSMEFTHiggs_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMEFTHiggs_susy_parameters MSSMEFTHiggs_susy_parameters::calc_beta(int loops) const
{
   ...
   return MSSMEFTHiggs_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Yu, beta_Mu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu);
}

MSSMEFTHiggs_susy_parameters MSSMEFTHiggs_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMEFTHiggs_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd MSSMEFTHiggs_susy_parameters::get() const
{
...
void MSSMEFTHiggs_susy_parameters::print(std::ostream& ostr) const
{
...
void MSSMEFTHiggs_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const MSSMEFTHiggs_input_parameters& MSSMEFTHiggs_susy_parameters::get_input() const
{
   return input;
}

MSSMEFTHiggs_input_parameters& MSSMEFTHiggs_susy_parameters::get_input()
{
   return input;
}

void MSSMEFTHiggs_susy_parameters::set_input_parameters(const MSSMEFTHiggs_input_parameters& input_)
{
   input = input_;
}

MSSMEFTHiggs_susy_parameters::Susy_traces MSSMEFTHiggs_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_susy_parameters& susy_pars)
{
