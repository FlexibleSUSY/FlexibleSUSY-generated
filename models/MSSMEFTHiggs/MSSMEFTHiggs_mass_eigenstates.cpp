...
// File generated at Sun 26 Aug 2018 14:05:44
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:05:44 with FlexibleSUSY
...
#define CLASSNAME MSSMEFTHiggs_mass_eigenstates
...
CLASSNAME::MSSMEFTHiggs_mass_eigenstates(const MSSMEFTHiggs_input_parameters& input_)
   : MSSMEFTHiggs_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new MSSMEFTHiggs_ewsb_solver<Two_scale>())
#endif
{
}
...
const MSSMEFTHiggs_physical& CLASSNAME::get_physical() const
{
   return physical;
}

MSSMEFTHiggs_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const MSSMEFTHiggs_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MSSMEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMEFTHiggs_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMEFTHiggs_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMEFTHiggs_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving MSSMEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "MSSMEFTHiggs\n"
           "========================================\n";
   MSSMEFTHiggs_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::Se);
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMEFTHiggs_info::Hpm);
...
{
   MSSMEFTHiggs_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   MSSMEFTHiggs_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(MSSMEFTHiggs_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = MSSMEFTHiggs_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMEFTHiggs_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Sd, eigenvalue_error > precision *
      Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Sv, eigenvalue_error > precision *
      Abs(MSv(0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Su, eigenvalue_error > precision *
      Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Se, eigenvalue_error > precision *
      Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::hh, eigenvalue_error > precision *
      Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Ah, eigenvalue_error > precision *
      Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Hpm, eigenvalue_error > precision
      * Abs(MHpm(0)));
#else
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Chi, eigenvalue_error > precision
      * Abs(MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Cha, eigenvalue_error > precision
      * Abs(MCha(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Fe, eigenvalue_error > precision *
      Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Fd, eigenvalue_error > precision *
      Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(MSSMEFTHiggs_info::Fu, eigenvalue_error > precision *
      Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(MSSMEFTHiggs_info::VWm);
   }
...
std::complex<double> CLASSNAME::CpHpmSvconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZV(
      ...
      ZP(gI2,0) + Conj(Mu)*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,KroneckerDelta(
...
std::complex<double> CLASSNAME::CpSeconjUHpmconjSv(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = 0.25*(KroneckerDelta(1,gO2)*(-
      1.4142135623730951*vu*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZV(gI1,j1)) + 4*Mu
...
std::complex<double> CLASSNAME::self_energy_Sv_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpSvUSvconjSvconjUSv(gI1,gO1,gI1,gO2))
      ;
   result += SUM(gI1,0,2,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(Mhh(gI2)))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(MSe(
      ...
      ;
   result += SUM(gI1,0,2,SUM(gI2,0,3,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSv(gI1)))*Conj(
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::VG);
}
...
void CLASSNAME::calculate_MGlu_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Glu);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Glu);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fv);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::VP);
}

void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::VZ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(MSSMEFTHiggs_info::VZ);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::VZ);
}

void CLASSNAME::calculate_MSd_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::Sd))
      return;
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZD;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZD,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Sd, eigenvalue_error >
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Sd);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Sd);
}

void CLASSNAME::calculate_MSv_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::Sv))
      return;
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZV;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Sv, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Sv);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Sv);
}

void CLASSNAME::calculate_MSu_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::Su))
      return;
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZU;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Su, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Su);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Su);
}

void CLASSNAME::calculate_MSe_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::Se))
      return;
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZE;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Se, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Se);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Se);
}

void CLASSNAME::calculate_Mhh_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::hh))
      return;
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(MSSMEFTHiggs_info::hh);
            }
         }
      }
   }
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::hh, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::Ah))
      return;
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(MSSMEFTHiggs_info::Ah);
            }
         }
      }
   }
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::Hpm))
      return;
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Hpm, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Hpm);
}
...
void CLASSNAME::calculate_MChi_pole()
{
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         decltype(ZN) mix_ZN;
            ...
            fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZN,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMEFTHiggs_info::Chi, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Chi);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Chi);
}
...
void CLASSNAME::calculate_MCha_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         problems.flag_bad_mass(MSSMEFTHiggs_info::Cha, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Cha);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Cha);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(MSSMEFTHiggs_info::Fe, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fe);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(MSSMEFTHiggs_info::Fd, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(MSSMEFTHiggs_info::Fu, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::Fu);
}

void CLASSNAME::calculate_MVWm_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMEFTHiggs_info::VWm))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(MSSMEFTHiggs_info::VWm);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMEFTHiggs_info::VWm);
   else
      problems.unflag_no_pole_mass_convergence(MSSMEFTHiggs_info::VWm);
}
...
std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
