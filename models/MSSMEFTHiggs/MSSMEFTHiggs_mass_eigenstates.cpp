...
// File generated at Tue 10 Oct 2017 20:33:12
 ...
 * parameters.
 *
 * This file was generated at Tue 10 Oct 2017 20:33:12 with FlexibleSUSY
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZD;
            ...
            problems.flag_bad_mass(MSSMEFTHiggs_info::Sd,
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZV;
            ...
            problems.flag_bad_mass(MSSMEFTHiggs_info::Sv,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZV);
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZU;
            ...
            problems.flag_bad_mass(MSSMEFTHiggs_info::Su,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZU);
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZE;
            ...
            problems.flag_bad_mass(MSSMEFTHiggs_info::Se,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZE);
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(MSSMEFTHiggs_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   do {
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         decltype(ZN) mix_ZN;
            ...
            problems.flag_bad_mass(MSSMEFTHiggs_info::Chi,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZN);
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMEFTHiggs_info::Cha,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP);
      #endif
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMEFTHiggs_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER);
      #endif
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMEFTHiggs_info::Fd,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR);
      #endif
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMEFTHiggs_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR);
      #endif
