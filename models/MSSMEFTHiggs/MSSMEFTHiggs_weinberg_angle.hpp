...
/**
 * @class MSSMEFTHiggs_weinberg_angle
...
public:
   ...
   MSSMEFTHiggs_weinberg_angle(const MSSMEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
