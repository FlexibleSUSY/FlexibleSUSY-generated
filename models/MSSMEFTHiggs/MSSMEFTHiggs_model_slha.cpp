...
MSSMEFTHiggs_slha::MSSMEFTHiggs_slha(const MSSMEFTHiggs_input_parameters& input_,
 ...
 */
MSSMEFTHiggs_slha::MSSMEFTHiggs_slha(const MSSMEFTHiggs_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MSSMEFTHiggs_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MSSMEFTHiggs_slha::clear()
{
   MSSMEFTHiggs_mass_eigenstates::clear();
   physical_slha.clear();
}

void MSSMEFTHiggs_slha::calculate_spectrum()
{
   MSSMEFTHiggs_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MSSMEFTHiggs_slha::convert_to_slha()
{
...
void MSSMEFTHiggs_slha::calculate_ckm_matrix()
{
...
void MSSMEFTHiggs_slha::calculate_pmns_matrix()
{
 ...
 */
void MSSMEFTHiggs_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MSSMEFTHiggs_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MSSMEFTHiggs_slha::convert_soft_squared_masses_to_slha()
{
...
const MSSMEFTHiggs_physical& MSSMEFTHiggs_slha::get_physical_slha() const
{
   return physical_slha;
}

MSSMEFTHiggs_physical& MSSMEFTHiggs_slha::get_physical_slha()
{
   return physical_slha;
}

void MSSMEFTHiggs_slha::print(std::ostream& ostr) const
{
   MSSMEFTHiggs_mass_eigenstates::print(ostr);
...
void MSSMEFTHiggs_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_slha& model)
{
   model.print(ostr);
   return ostr;
}
