...
// File generated at Tue 22 Jan 2019 14:54:29

/**
 * @file MSSMEFTHiggs_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 14:54:29 with FlexibleSUSY
...
double calculate_a_muon_impl(MSSMEFTHiggs_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MSSMEFTHiggs_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMEFTHiggs_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MSSMEFTHiggs_a_muon::calculate_a_muon(const MSSMEFTHiggs_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("MSSMEFTHiggs_a_muon:" << e.what());
...
double MSSMEFTHiggs_a_muon::calculate_a_muon_uncertainty(const MSSMEFTHiggs_mass_eigenstates& model_)
{
   MSSMEFTHiggs_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMEFTHiggs_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
