 ...
 */
class MSSMEFTHiggs_mass_eigenstates : public MSSMEFTHiggs_soft_parameters {
public:
   ...
   void set_physical(const MSSMEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMEFTHiggs_physical& get_physical() const;
   MSSMEFTHiggs_physical& get_physical();
