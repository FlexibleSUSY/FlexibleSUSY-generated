...
/**
 * @file MSSMEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef MSSMEFTHiggs_MASS_EIGENSTATES_H
#define MSSMEFTHiggs_MASS_EIGENSTATES_H
...
class MSSMEFTHiggs_ewsb_solver_interface;
/**
 * @class MSSMEFTHiggs_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMEFTHiggs_mass_eigenstates
   : public MSSMEFTHiggs_soft_parameters
   , public MSSMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit MSSMEFTHiggs_mass_eigenstates(const MSSMEFTHiggs_input_parameters& input_ = MSSMEFTHiggs_input_parameters());
   MSSMEFTHiggs_mass_eigenstates(const MSSMEFTHiggs_mass_eigenstates&) = default;
   MSSMEFTHiggs_mass_eigenstates(MSSMEFTHiggs_mass_eigenstates&&) = default;
   virtual ~MSSMEFTHiggs_mass_eigenstates() = default;
   MSSMEFTHiggs_mass_eigenstates& operator=(const MSSMEFTHiggs_mass_eigenstates&) = default;
   MSSMEFTHiggs_mass_eigenstates& operator=(MSSMEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<MSSMEFTHiggs_ewsb_solver_interface>&);
   ...
   double get_lsp(MSSMEFTHiggs_info::Particles&) const;
...
private:
   ...
   mutable Problems problems{MSSMEFTHiggs_info::model_name,
   ...
   std::shared_ptr<MSSMEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMEFTHiggs_mass_eigenstates&);
