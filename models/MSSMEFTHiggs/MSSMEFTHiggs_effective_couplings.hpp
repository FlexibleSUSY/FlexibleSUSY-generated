...
#ifndef MSSMEFTHiggs_EFFECTIVE_COUPLINGS_H
#define MSSMEFTHiggs_EFFECTIVE_COUPLINGS_H
...
class MSSMEFTHiggs_effective_couplings {
public:
   MSSMEFTHiggs_effective_couplings(const MSSMEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const MSSMEFTHiggs_mass_eigenstates& model_);
