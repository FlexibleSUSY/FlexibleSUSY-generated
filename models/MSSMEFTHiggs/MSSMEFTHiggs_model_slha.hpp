...
class MSSMEFTHiggs_slha : public MSSMEFTHiggs_mass_eigenstates {
public:
   explicit MSSMEFTHiggs_slha(const MSSMEFTHiggs_input_parameters& input_ = MSSMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MSSMEFTHiggs_slha(const MSSMEFTHiggs_mass_eigenstates&, bool do_convert_masses_to_slha = true);
