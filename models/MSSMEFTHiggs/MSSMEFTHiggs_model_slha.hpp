...
/**
 * @file MSSMEFTHiggs_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Wed 16 Oct 2019 19:58:56

#ifndef MSSMEFTHiggs_SLHA_H
#define MSSMEFTHiggs_SLHA_H
...
class MSSMEFTHiggs_slha : public Model {
public:
   explicit MSSMEFTHiggs_slha(const MSSMEFTHiggs_input_parameters& input_ = MSSMEFTHiggs_input_parameters());
   explicit MSSMEFTHiggs_slha(const Model&, bool do_convert_masses_to_slha = true);
   MSSMEFTHiggs_slha(const MSSMEFTHiggs_slha&) = default;
   MSSMEFTHiggs_slha(MSSMEFTHiggs_slha&&) = default;
   virtual ~MSSMEFTHiggs_slha() = default;
   MSSMEFTHiggs_slha& operator=(const MSSMEFTHiggs_slha&) = default;
   MSSMEFTHiggs_slha& operator=(MSSMEFTHiggs_slha&&) = default;
   ...
   const MSSMEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MSSMEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MSSMEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
MSSMEFTHiggs_slha<Model>::MSSMEFTHiggs_slha(const MSSMEFTHiggs_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MSSMEFTHiggs_slha<Model>::MSSMEFTHiggs_slha(const Model& model_,
...
template <class Model>
void MSSMEFTHiggs_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void MSSMEFTHiggs_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MSSMEFTHiggs_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MSSMEFTHiggs_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MSSMEFTHiggs_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MSSMEFTHiggs_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMEFTHiggs_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMEFTHiggs_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MSSMEFTHiggs_physical& MSSMEFTHiggs_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MSSMEFTHiggs_physical& MSSMEFTHiggs_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MSSMEFTHiggs_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MSSMEFTHiggs_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
