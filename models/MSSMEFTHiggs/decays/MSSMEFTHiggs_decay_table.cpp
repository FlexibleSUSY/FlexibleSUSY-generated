...
MSSMEFTHiggs_decay_table::MSSMEFTHiggs_decay_table()
...
void MSSMEFTHiggs_decay_table::clear()
{
...
void MSSMEFTHiggs_decay_table::print(std::ostream& ostr) const
{
   for (const auto& particle: decay_table) {
      ...
      for (const auto& decay: particle) {
         ...
         ostr << "Partial width["
              << MSSMEFTHiggs_info::get_particle_name_from_pdg(pdg)
              << " -> ";
         for (std::size_t i = 0; i < final_state_size; ++i) {
            ostr << MSSMEFTHiggs_info::get_particle_name_from_pdg(final_state[i]);
...
std::ostream& operator<<(std::ostream& ostr,
                         const MSSMEFTHiggs_decay_table& table)
{
   table.print(ostr);
   return ostr;
}

Decays_list& MSSMEFTHiggs_decay_table::get_hh_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_hh_decays(int gI1) const
{
   switch (gI1) {
   case 0: return decay_table[0]; break;
   case 1: return decay_table[1]; break;
...
Decays_list& MSSMEFTHiggs_decay_table::get_Ah_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_Ah_decays(int gI1) const
{
   switch (gI1) {
   case 1: return decay_table[2]; break;
   }
...
Decays_list& MSSMEFTHiggs_decay_table::get_Hpm_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_Hpm_decays(int gI1) const
{
   switch (gI1) {
   case 1: return decay_table[3]; break;
   }
...
Decays_list& MSSMEFTHiggs_decay_table::get_Su_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_Su_decays(int gI1) const
{
   switch (gI1) {
   case 0: return decay_table[4]; break;
   case 1: return decay_table[5]; break;
...
Decays_list& MSSMEFTHiggs_decay_table::get_Sd_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_Sd_decays(int gI1) const
{
   switch (gI1) {
   case 0: return decay_table[10]; break;
   case 1: return decay_table[11]; break;
...
Decays_list& MSSMEFTHiggs_decay_table::get_Se_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_Se_decays(int gI1) const
{
   switch (gI1) {
   case 0: return decay_table[16]; break;
   case 1: return decay_table[17]; break;
...
Decays_list& MSSMEFTHiggs_decay_table::get_Sv_decays(int gI1)
{
   switch (gI1) {
...
const Decays_list& MSSMEFTHiggs_decay_table::get_Sv_decays(int gI1) const
{
   switch (gI1) {
   case 0: return decay_table[22]; break;
   case 1: return decay_table[23]; break;
