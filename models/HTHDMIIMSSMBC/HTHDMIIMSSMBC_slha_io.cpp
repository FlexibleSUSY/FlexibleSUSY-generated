...
char const * const HTHDMIIMSSMBC_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "HMIX" }
;
 ...
 */
void HTHDMIIMSSMBC_slha_io::set_spinfo(const Problems<HTHDMIIMSSMBC_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void HTHDMIIMSSMBC_slha_io::write_to_file(const std::string& file_name)
{
...
void HTHDMIIMSSMBC_slha_io::fill(HTHDMIIMSSMBC_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&HTHDMIIMSSMBC_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&HTHDMIIMSSMBC_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
