...
// File generated at Mon 27 Feb 2017 13:23:21
...
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda4_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(twoLoop*(-23.875*Power(g2,4)*Lambda4 - 80*Lambda1*
      ...
      traceYuAdjYuYuAdjYu - 0.015*Power(g1,4)*(-511*Lambda4 + 940*Sqr(g2)) + 40
      ...
      *Sqr(Lambda4) - 28*Lambda3*Sqr(Lambda4) - 12*traceYdAdjYd*Sqr(Lambda4) -
      ...
      traceYeAdjYe*Sqr(Lambda6) - 0.05*Sqr(g1)*(200*Power(g2,4) - 96*Lambda1*
