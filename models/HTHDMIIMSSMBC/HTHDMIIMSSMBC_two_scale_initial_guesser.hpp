...
#ifndef HTHDMIIMSSMBC_TWO_SCALE_INITIAL_GUESSER_H
#define HTHDMIIMSSMBC_TWO_SCALE_INITIAL_GUESSER_H

#include "HTHDMIIMSSMBC_initial_guesser.hpp"
...
/**
 * @class HTHDMIIMSSMBC_initial_guesser<Two_scale>
 * @brief initial guesser for the HTHDMIIMSSMBC
 */

template<>
class HTHDMIIMSSMBC_initial_guesser<Two_scale> : public Initial_guesser {
public:
   HTHDMIIMSSMBC_initial_guesser(HTHDMIIMSSMBC<Two_scale>*,
                               const softsusy::QedQcd&,
                               const HTHDMIIMSSMBC_low_scale_constraint<Two_scale>&,
                               const HTHDMIIMSSMBC_susy_scale_constraint<Two_scale>&,
                               const HTHDMIIMSSMBC_high_scale_constraint<Two_scale>&);
   virtual ~HTHDMIIMSSMBC_initial_guesser() = default;
...
private:
   HTHDMIIMSSMBC<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   HTHDMIIMSSMBC_low_scale_constraint<Two_scale> low_constraint{};
   HTHDMIIMSSMBC_susy_scale_constraint<Two_scale> susy_constraint{};
   HTHDMIIMSSMBC_high_scale_constraint<Two_scale> high_constraint{};
