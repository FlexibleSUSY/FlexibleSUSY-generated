...
Eigen::ArrayXd HTHDMIIMSSMBC_input_parameters::get() const
{
...
void HTHDMIIMSSMBC_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   MSUSY = pars(1);
   MEWSB = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const HTHDMIIMSSMBC_input_parameters& input)
{
