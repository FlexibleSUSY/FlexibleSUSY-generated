...
class HTHDMIIMSSMBC_slha : public HTHDMIIMSSMBC_mass_eigenstates {
public:
   explicit HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_input_parameters& input_ = HTHDMIIMSSMBC_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_mass_eigenstates&, bool do_convert_masses_to_slha = true);
