...
class HTHDMIIMSSMBC_slha : public Model {
public:
   explicit HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_input_parameters& input_ = HTHDMIIMSSMBC_input_parameters());
   explicit HTHDMIIMSSMBC_slha(const Model&, bool do_convert_masses_to_slha = true);
   HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_slha&) = default;
   HTHDMIIMSSMBC_slha(HTHDMIIMSSMBC_slha&&) = default;
   virtual ~HTHDMIIMSSMBC_slha() = default;
   HTHDMIIMSSMBC_slha& operator=(const HTHDMIIMSSMBC_slha&) = default;
   HTHDMIIMSSMBC_slha& operator=(HTHDMIIMSSMBC_slha&&) = default;
...
template <class Model>
HTHDMIIMSSMBC_slha<Model>::HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
HTHDMIIMSSMBC_slha<Model>::HTHDMIIMSSMBC_slha(const Model& model_,
...
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::convert_to_slha()
{
...
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const HTHDMIIMSSMBC_physical& HTHDMIIMSSMBC_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
HTHDMIIMSSMBC_physical& HTHDMIIMSSMBC_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void HTHDMIIMSSMBC_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void HTHDMIIMSSMBC_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const HTHDMIIMSSMBC_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
