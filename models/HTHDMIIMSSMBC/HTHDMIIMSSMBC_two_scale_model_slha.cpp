...
// File generated at Wed 29 Jun 2016 11:24:25

/**
 * @file HTHDMIIMSSMBC_two_scale_model_slha.cpp
 * @brief HTHDMIIMSSMBC model class wrapper for SLHA conversion
 */
...
#define CLASSNAME HTHDMIIMSSMBC_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_input_parameters& input_)
   : HTHDMIIMSSMBC<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC<Two_scale>& model_,
...
CLASSNAME::~HTHDMIIMSSMBC_slha()
{
}

void CLASSNAME::clear()
{
   HTHDMIIMSSMBC<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   HTHDMIIMSSMBC<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const HTHDMIIMSSMBC_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

HTHDMIIMSSMBC_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   HTHDMIIMSSMBC<Two_scale>::print(ostr);
