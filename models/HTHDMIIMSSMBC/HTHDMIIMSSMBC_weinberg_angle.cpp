...
// File generated at Tue 10 Oct 2017 20:59:28
...
#define CLASSNAME HTHDMIIMSSMBC_weinberg_angle
 ...
 */
CLASSNAME::HTHDMIIMSSMBC_weinberg_angle(
...
void CLASSNAME::set_model(const HTHDMIIMSSMBC_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * HTHDMIIMSSMBC_info::normalization_g1;
   const double g2 = MODEL->get_g2() * HTHDMIIMSSMBC_info::normalization_g2;
