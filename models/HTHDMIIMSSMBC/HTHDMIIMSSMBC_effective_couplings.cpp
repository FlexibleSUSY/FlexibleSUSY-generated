...
std::complex<double> HTHDMIIMSSMBC_effective_couplings::CpFdhhbarFdPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_698 += Conj(Ud(gt3,j1))*Yd(j1,j2);
      }
      tmp_697 += tmp_698;
      tmp_696 += (Conj(Vd(gt1,j2))) * tmp_697;
   }
   tmp_695 += tmp_696;
   result += (-0.7071067811865475*ZH(gt2,0)) * tmp_695;
...
std::complex<double> HTHDMIIMSSMBC_effective_couplings::CpFuhhbarFuPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_702 += Conj(Uu(gt3,j1))*Yu(j1,j2);
      }
      tmp_701 += tmp_702;
      tmp_700 += (Conj(Vu(gt1,j2))) * tmp_701;
   }
   tmp_699 += tmp_700;
   result += (0.7071067811865475*ZH(gt2,1)) * tmp_699;
...
std::complex<double> HTHDMIIMSSMBC_effective_couplings::CpFehhbarFePL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_706 += Conj(Ue(gt3,j1))*Ye(j1,j2);
      }
      tmp_705 += tmp_706;
      tmp_704 += (Conj(Ve(gt1,j2))) * tmp_705;
   }
   tmp_703 += tmp_704;
   result += (-0.7071067811865475*ZH(gt2,0)) * tmp_703;
...
std::complex<double> HTHDMIIMSSMBC_effective_couplings::CpAhFdbarFdPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_710 += Conj(Ud(gt3,j1))*Yd(j1,j2);
      }
      tmp_709 += tmp_710;
      tmp_708 += (Conj(Vd(gt2,j2))) * tmp_709;
   }
   tmp_707 += tmp_708;
   result += (std::complex<double>(0.,0.7071067811865475)*ZA(gt1,0)) * tmp_707;
...
std::complex<double> HTHDMIIMSSMBC_effective_couplings::CpAhFubarFuPL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_714 += Conj(Uu(gt3,j1))*Yu(j1,j2);
      }
      tmp_713 += tmp_714;
      tmp_712 += (Conj(Vu(gt2,j2))) * tmp_713;
   }
   tmp_711 += tmp_712;
   result += (std::complex<double>(0.,0.7071067811865475)*ZA(gt1,1)) * tmp_711;
...
std::complex<double> HTHDMIIMSSMBC_effective_couplings::CpAhFebarFePL(unsigned gt1, unsigned gt2, unsigned gt3) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_718 += Conj(Ue(gt3,j1))*Ye(j1,j2);
      }
      tmp_717 += tmp_718;
      tmp_716 += (Conj(Ve(gt2,j2))) * tmp_717;
   }
   tmp_715 += tmp_716;
   result += (std::complex<double>(0.,0.7071067811865475)*ZA(gt1,0)) * tmp_715;
