...
template <class Scalar, int M, int N>
std::valarray<double> HTHDMIIMSSMBC_spectrum_plotter::to_valarray(const Eigen::Array<Scalar, M, N>& v)
{
...
void to_database(
   ...
   const HTHDMIIMSSMBC_observables* observables = 0);
...
HTHDMIIMSSMBC_mass_eigenstates from_database(
   ...
   HTHDMIIMSSMBC_observables* observables = 0);
