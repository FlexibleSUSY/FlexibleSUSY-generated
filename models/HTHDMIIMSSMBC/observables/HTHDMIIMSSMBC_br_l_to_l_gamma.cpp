...
/**
 * @file HTHDMIIMSSMBC_br_l_to_l_gamma.cpp
 *
...
#include "HTHDMIIMSSMBC_br_l_to_l_gamma.hpp"
...
void run_to_MSUSY(HTHDMIIMSSMBC_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("HTHDMIIMSSMBC_l_to_lgamma: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("HTHDMIIMSSMBC_l_to_lgamma:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("HTHDMIIMSSMBC_l_to_lgamma: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("HTHDMIIMSSMBC_l_to_lgamma: run_to_MSUSY(): "
...
namespace HTHDMIIMSSMBC_br_l_to_l_gamma {
