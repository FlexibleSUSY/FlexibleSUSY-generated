...
libHTHDMIIMSSMBC = FileNameJoin[{Directory[], "models", "HTHDMIIMSSMBC", "HTHDMIIMSSMBC_librarylink.so"}];

FSHTHDMIIMSSMBCGetSettings = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCGetSettings", LinkObject, LinkObject];
FSHTHDMIIMSSMBCGetSMInputParameters = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCGetSMInputParameters", LinkObject, LinkObject];
FSHTHDMIIMSSMBCGetInputParameters = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCGetInputParameters", LinkObject, LinkObject];
FSHTHDMIIMSSMBCGetProblems = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCGetProblems", LinkObject, LinkObject];
FSHTHDMIIMSSMBCGetWarnings = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCGetWarnings", LinkObject, LinkObject];
FSHTHDMIIMSSMBCToSLHA = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCToSLHA", LinkObject, LinkObject];

FSHTHDMIIMSSMBCOpenHandleLib = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCOpenHandle", {{Real,1}}, Integer];
FSHTHDMIIMSSMBCCloseHandle = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCCloseHandle", {Integer}, Void];

FSHTHDMIIMSSMBCSetLib = LibraryFunctionLoad[libHTHDMIIMSSMBC, "FSHTHDMIIMSSMBCSet", {Integer, {Real,1}}, Void];
...
FSHTHDMIIMSSMBCMessage[s_] := Message[FSHTHDMIIMSSMBC::info, s];

FSHTHDMIIMSSMBCCheckIsNumeric[a_?NumericQ] := a;
FSHTHDMIIMSSMBCCheckIsNumeric[a_] := (Message[FSHTHDMIIMSSMBC::nonum, a]; Abort[]);
...
fsHTHDMIIMSSMBCDefaultInputParameters = {
   TanBeta -> 0,
   MSUSY -> 0,
   MEWSB -> 0,
   MuInput -> 0,
...
Options[FSHTHDMIIMSSMBCOpenHandle] = {
    Sequence @@ fsDefaultSettings,
    Sequence @@ fsDefaultSMParameters,
    Sequence @@ fsHTHDMIIMSSMBCDefaultInputParameters
};

FSHTHDMIIMSSMBCOpenHandle[a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSHTHDMIIMSSMBCOpenHandle[a, Sequence @@ s, r];

FSHTHDMIIMSSMBCOpenHandle[OptionsPattern[]] :=
    FSHTHDMIIMSSMBCOpenHandleLib[
        FSHTHDMIIMSSMBCCheckIsNumeric /@ {
            ...
            (* HTHDMIIMSSMBC input parameters *)
            ,
            OptionValue[TanBeta],
            OptionValue[MSUSY],
            OptionValue[MEWSB],
...
Options[FSHTHDMIIMSSMBCSet] = Options[FSHTHDMIIMSSMBCOpenHandle];

FSHTHDMIIMSSMBCSet[handle_Integer, a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSHTHDMIIMSSMBCSet[handle, a, Sequence @@ s, r];
...
FSHTHDMIIMSSMBCSet[handle_Integer, p:OptionsPattern[]] :=
    FSHTHDMIIMSSMBCSetLib[
        ...
        FSHTHDMIIMSSMBCGetInputParameters[handle]]];
