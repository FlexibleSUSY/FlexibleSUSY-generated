...
// File generated at Mon 27 Feb 2017 13:23:26
...
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda2_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda2 = Re(twoLoop*(-1.9125*Power(g1,6) + 16.1875*Power(g2,6) -
      ...
      Lambda4*traceYeAdjYe - 0.125*Power(g2,4)*(11*Lambda2 - 60*Lambda3 - 30*
      Lambda4 + 18*traceYuAdjYu) - 3*Lambda2*traceYuAdjYuYuAdjYu + 30*
      traceYuAdjYuYuAdjYuYuAdjYu - 0.0075*Power(g1,4)*(-2*(691*Lambda2 + 60*
      Lambda3 + 30*Lambda4 - 114*traceYuAdjYu) + 605*Sqr(g2)) + 80*Lambda2*
      ...
      *Lambda3*Lambda4 + 15*Lambda2*traceYuAdjYu + 72*Sqr(Lambda2) + 8*Sqr(
      Lambda3) + 2*Sqr(Lambda4) + 36*Sqr(Lambda7)) - 0.0125*Sqr(g1)*(335*Power(
