 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_v2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_v2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v2 = Re(twoLoop*(-3*Lambda1*Lambda6*v1 - 1.5*Lambda4*Lambda6*v1 -
      ...
      1.5*Lambda5*Lambda7*v1 - 1.75875*Power(g1,4)*v2 + 9.90625*Power(g2,4)*v2
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_v2_three_loop(const Soft_traces& soft_traces) const
{
