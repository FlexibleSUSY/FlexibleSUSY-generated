...
// File generated at Wed 12 Apr 2017 11:00:09
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_v1_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_v1_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_v1 = Re(0.00125*twoLoop*(-1407*Power(g1,4)*v1 + 10*v1*Sqr(g1)*(-2
      *(61*traceYdAdjYd + 87*traceYeAdjYe) + 45*Sqr(g2)) + 25*(317*Power(g2,4)*
      v1 - 108*(3*traceYdAdjYd + traceYeAdjYe)*v1*Sqr(g2) - 8*(4*Lambda3*
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_v1_three_loop(const Soft_traces& soft_traces) const
{
