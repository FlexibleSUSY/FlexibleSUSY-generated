...
public:
   ...
   void set_extra(const HTHDMIIMSSMBC_slha&, const HTHDMIIMSSMBC_scales&, const HTHDMIIMSSMBC_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const HTHDMIIMSSMBC_scales&, const HTHDMIIMSSMBC_observables&);
