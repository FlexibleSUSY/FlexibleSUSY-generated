...
struct HTHDMIIMSSMBC_physical;
class HTHDMIIMSSMBC_slha;
...
public:
   ...
   void fill(HTHDMIIMSSMBC_slha&) const;
   ...
   void set_extra(const HTHDMIIMSSMBC_slha&, const HTHDMIIMSSMBC_scales&, const HTHDMIIMSSMBC_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const HTHDMIIMSSMBC_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const HTHDMIIMSSMBC_scales&, const HTHDMIIMSSMBC_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, HTHDMIIMSSMBC_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const HTHDMIIMSSMBC_slha&);
 ...
 */
template <class... Ts>
void HTHDMIIMSSMBC_slha_io::fill(
   ...
   HTHDMIIMSSMBC_decays const * const decays)
{
