...
HTHDMIIMSSMBC_slha::HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_input_parameters& input_,
 ...
 */
HTHDMIIMSSMBC_slha::HTHDMIIMSSMBC_slha(const HTHDMIIMSSMBC_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : HTHDMIIMSSMBC_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void HTHDMIIMSSMBC_slha::clear()
{
   HTHDMIIMSSMBC_mass_eigenstates::clear();
   physical_slha.clear();
}

void HTHDMIIMSSMBC_slha::calculate_spectrum()
{
   HTHDMIIMSSMBC_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void HTHDMIIMSSMBC_slha::convert_to_slha()
{
...
void HTHDMIIMSSMBC_slha::calculate_ckm_matrix()
{
...
void HTHDMIIMSSMBC_slha::calculate_pmns_matrix()
{
 ...
 */
void HTHDMIIMSSMBC_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void HTHDMIIMSSMBC_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void HTHDMIIMSSMBC_slha::convert_soft_squared_masses_to_slha()
{

}

const HTHDMIIMSSMBC_physical& HTHDMIIMSSMBC_slha::get_physical_slha() const
{
   return physical_slha;
}

HTHDMIIMSSMBC_physical& HTHDMIIMSSMBC_slha::get_physical_slha()
{
   return physical_slha;
}

void HTHDMIIMSSMBC_slha::print(std::ostream& ostr) const
{
   HTHDMIIMSSMBC_mass_eigenstates::print(ostr);
...
void HTHDMIIMSSMBC_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const HTHDMIIMSSMBC_slha& model)
{
   model.print(ostr);
   return ostr;
}
