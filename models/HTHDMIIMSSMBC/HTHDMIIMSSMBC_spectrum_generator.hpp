...
// File generated at Wed 12 Apr 2017 11:05:03
                                ...
                                const HTHDMIIMSSMBC_input_parameters& input)
{
   ...
   HTHDMIIMSSMBC_high_scale_constraint<T> high_scale_constraint(&model);
   HTHDMIIMSSMBC_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   HTHDMIIMSSMBC_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
