...
// File generated at Thu 15 Dec 2016 12:40:42
 ...
 */
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda3_one_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda3 = Re(oneOver16PiSqr*(0.27*Power(g1,4) + 2.25*Power(g2,4)
      - 9*Lambda3*Sqr(g2) - 0.9*Sqr(g1)*(2*Lambda3 + Sqr(g2)) + 2*(6*Lambda1*
 ...
 */
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda3_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   const double beta_Lambda3_1 = Re(-0.005*twoLoop*(765*Power(g1,6) - 3*
      Power(g1,4)*(180*Lambda1 + 180*Lambda2 + 631*Lambda3 + 60*Lambda4 + 30*
      traceYdAdjYd - 150*traceYeAdjYe + 335*Sqr(g2)) - 5*Sqr(g1)*(65*Power(g2,4
      ...
      24*Sqr(Lambda7))) - 25*(259*Power(g2,6) + Power(g2,4)*(180*Lambda1 + 180*
      Lambda2 - 71*Lambda3 + 60*Lambda4 - 18*traceYdAdjYd - 6*traceYeAdjYe) + 6
 ...
 */
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda3_three_loop(const Susy_traces& susy_traces) const
{
