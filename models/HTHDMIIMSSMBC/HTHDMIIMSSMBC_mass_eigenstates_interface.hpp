...
/**
 * @file HTHDMIIMSSMBC_mass_eigenstates_interface.hpp
 *
...
#ifndef HTHDMIIMSSMBC_MASS_EIGENSTATES_INTERFACE_H
#define HTHDMIIMSSMBC_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class HTHDMIIMSSMBC_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class HTHDMIIMSSMBC_mass_eigenstates_interface {
public:
   virtual ~HTHDMIIMSSMBC_mass_eigenstates_interface() {}

   virtual std::unique_ptr<HTHDMIIMSSMBC_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const HTHDMIIMSSMBC_input_parameters& get_input_parameters() const = 0;
   virtual HTHDMIIMSSMBC_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const HTHDMIIMSSMBC_physical& get_physical() const = 0;
   virtual HTHDMIIMSSMBC_physical& get_physical() = 0;
   ...
   virtual void set_physical(const HTHDMIIMSSMBC_physical&) = 0;
   ...
   virtual double get_MCha() const = 0;
   ...
   virtual const Eigen::Array<double,2,1>& get_MChi() const = 0;
   ...
   virtual const Eigen::Matrix<std::complex<double>,2,2>& get_ZN() const = 0;
   ...
   virtual double get_mass_matrix_Cha() const = 0;
   ...
   virtual Eigen::Matrix<double,2,2> get_mass_matrix_Chi() const = 0;
