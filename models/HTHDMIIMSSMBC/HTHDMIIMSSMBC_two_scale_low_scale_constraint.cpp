...
// File generated at Tue 10 Oct 2017 20:59:31
...
void HTHDMIIMSSMBC_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
double HTHDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();

   double theta_w = std::asin(Electroweak_constants::sinThetaW);

   HTHDMIIMSSMBC_weinberg_angle::Sm_parameters sm_pars;
   ...
   HTHDMIIMSSMBC_weinberg_angle weinberg(MODEL, sm_pars);
...
double HTHDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void HTHDMIIMSSMBC_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("HTHDMIIMSSMBC_low_scale_constraint<Two_scale>: "
