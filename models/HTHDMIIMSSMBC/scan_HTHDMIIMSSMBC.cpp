...
{
   std::cout <<
      "Usage: scan_HTHDMIIMSSMBC.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MSUSY=<value>\n"
      "  --MEWSB=<value>\n"
...
struct HTHDMIIMSSMBC_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
HTHDMIIMSSMBC_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   HTHDMIIMSSMBC_input_parameters& input)
{
   ...
   HTHDMIIMSSMBC_scan_result result;
...
void scan(int solver_type, HTHDMIIMSSMBC_input_parameters& input,
