...
// File generated at Sun 26 Aug 2018 14:08:01
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:08:01 with FlexibleSUSY
...
std::complex<double> CLASSNAME::CpChiChiVZPL(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = -0.5*(g2*Cos(ThetaW()) + 0.7745966692414834
      *g1*Sin(ThetaW()))*(Conj(ZN(gI2,0))*ZN(gI1,0) - Conj(ZN(gI2,1))*ZN(gI1,1));
...
std::complex<double> CLASSNAME::CpChiChiVZPR(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(g2*Cos(ThetaW()) + 0.7745966692414834*
      g1*Sin(ThetaW()))*(Conj(ZN(gI1,0))*ZN(gI2,0) - Conj(ZN(gI1,1))*ZN(gI2,1));
...
std::complex<double> CLASSNAME::CpChiUChiVZPR(int gI2, int gO1) const
{
   ...
   const std::complex<double> result = 0.1*(Conj(ZN(gI2,0))*KroneckerDelta(0,gO1)
      - Conj(ZN(gI2,1))*KroneckerDelta(1,gO1))*(5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()));
...
std::complex<double> CLASSNAME::self_energy_VP_1loop(double p ) const
{
   ...
   result += -(A0(Sqr(MVWm))*(CpconjVWmVPVPVWm1() + CpconjVWmVPVPVWm2() + 4*
      CpconjVWmVPVPVWm3()));
   result += (AbsSqr(CpbarChaChaVPPL()) + AbsSqr(CpbarChaChaVPPR()))*H0(Sqr(p),Sqr
      (MCha),Sqr(MCha));
...
std::complex<double> CLASSNAME::self_energy_VZ_1loop(double p ) const
{
   ...
   result += -(A0(Sqr(MVWm))*(4*CpconjVWmVWmVZVZ1() + CpconjVWmVWmVZVZ2() +
      CpconjVWmVWmVZVZ3()));
   result += (AbsSqr(CpbarChaChaVZPL()) + AbsSqr(CpbarChaChaVZPR()))*H0(Sqr(p),Sqr
      (MCha),Sqr(MCha));
   ...
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpHmconjHmVZ(gI2,gI1))*B00(Sqr(p),
      Sqr(MHm(gI1)),Sqr(MHm(gI2)))));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpChiChiVZPL(gI1,gI2)) + AbsSqr(
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -((0.5 + B1(Sqr(p),Sqr(MCha),Sqr(MVWm)))*Conj(CpbarChaUChiVWmPR(gO2))
      *CpbarChaUChiVWmPR(gO1));
   result += -((0.5 + B1(Sqr(p),Sqr(MCha),Sqr(MVWm)))*Conj(CpUChiChaconjVWmPL(gO2)
      )*CpUChiChaconjVWmPL(gO1));
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -((0.5 + B1(Sqr(p),Sqr(MCha),Sqr(MVWm)))*Conj(CpbarChaUChiVWmPL(gO2))
      *CpbarChaUChiVWmPL(gO1));
   result += -((0.5 + B1(Sqr(p),Sqr(MCha),Sqr(MVWm)))*Conj(CpUChiChaconjVWmPR(gO2)
      )*CpUChiChaconjVWmPR(gO1));
   result += -SUM(gI2,0,1,(0.5 + B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MVZ)))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_1(double p ) const
{
   ...
   result += -2*MCha*(-1 + 2*B0(Sqr(p),Sqr(MCha),0))*Conj(CpbarChaChaVPPR())*
      CpbarChaChaVPPL();
   result += -2*MCha*(-1 + 2*B0(Sqr(p),Sqr(MCha),Sqr(MVZ)))*Conj(CpbarChaChaVZPR()
      )*CpbarChaChaVZPL();
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_PR(double p ) const
{
   ...
   result += -SUM(gI2,0,1,AbsSqr(CpbarChaChiVWmPL(gI2))*(0.5 + B1(Sqr(p),Sqr(MChi(
      gI2)),Sqr(MVWm))));
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_PL(double p ) const
{
   ...
   result += -SUM(gI2,0,1,AbsSqr(CpbarChaChiVWmPR(gI2))*(0.5 + B1(Sqr(p),Sqr(MChi(
      gI2)),Sqr(MVWm))));
...
{
   if (!force_output && problems.is_running_tachyon(HTHDMIIMSSMBC_info::VZ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(HTHDMIIMSSMBC_info::hh))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(HTHDMIIMSSMBC_info::Ah))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(HTHDMIIMSSMBC_info::Hm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(HTHDMIIMSSMBC_info::VWm))
      return;
