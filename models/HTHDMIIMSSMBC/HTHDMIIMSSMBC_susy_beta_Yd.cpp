...
Eigen::Matrix<double,3,3> HTHDMIIMSSMBC_susy_parameters::calc_beta_Yd_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yd = (twoLoop*(-0.0016666666666666668*Yd*(-600*Lambda3*Lambda4 + 4050*
      traceYdAdjYdYdAdjYd + 1350*traceYdAdjYuYuAdjYd + 1350*traceYeAdjYeYeAdjYe
       - 900*AbsSqr(Lambda5) - 2700*AbsSqr(Lambda6) - 900*AbsSqr(Lambda7) + 117
      *Quad(g1) + 2850*Quad(g2) + 64800*Quad(g3) - 375*traceYdAdjYd*Sqr(g1) -
 ...
 */
Eigen::Matrix<double,3,3> HTHDMIIMSSMBC_susy_parameters::calc_beta_Yd_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
