...
template<>
class HTHDMIIMSSMBC_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   HTHDMIIMSSMBC_low_scale_constraint();
   HTHDMIIMSSMBC_low_scale_constraint(HTHDMIIMSSMBC<Two_scale>*, const softsusy::QedQcd&);
   virtual ~HTHDMIIMSSMBC_low_scale_constraint();
   virtual void apply();
