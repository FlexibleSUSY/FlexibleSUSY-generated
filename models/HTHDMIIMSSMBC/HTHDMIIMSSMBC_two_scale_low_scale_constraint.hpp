...
#ifndef HTHDMIIMSSMBC_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define HTHDMIIMSSMBC_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "HTHDMIIMSSMBC_low_scale_constraint.hpp"
...
template<>
class HTHDMIIMSSMBC_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   HTHDMIIMSSMBC_low_scale_constraint() = default;
   HTHDMIIMSSMBC_low_scale_constraint(HTHDMIIMSSMBC<Two_scale>*, const softsusy::QedQcd&);
   virtual ~HTHDMIIMSSMBC_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "HTHDMIIMSSMBC low-scale constraint"; }
