...
// File generated at Thu 15 Dec 2016 12:40:37
...
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda7_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda7 = Re(twoLoop*(-36*Lambda1*Lambda3*Lambda6 - 36*Lambda2*
      ...
      - 42*Power(Lambda6,3) + 0.125*Power(g2,4)*(90*Lambda6 - 101*Lambda7) -
      ...
      3) + 0.015*Power(g1,4)*(90*Lambda6 + 601*Lambda7) - 36*Lambda3*Lambda6*
