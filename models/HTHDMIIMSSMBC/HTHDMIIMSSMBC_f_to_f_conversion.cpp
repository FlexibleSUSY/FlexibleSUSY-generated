...
/**
 * @file HTHDMIIMSSMBC_f_to_f_conversion.cpp
 *
...
namespace HTHDMIIMSSMBC_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const HTHDMIIMSSMBC_mass_eigenstates& model) {
