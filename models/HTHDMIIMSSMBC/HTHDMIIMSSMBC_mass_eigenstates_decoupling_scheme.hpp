...
/**
 * @file HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef HTHDMIIMSSMBC_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define HTHDMIIMSSMBC_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme
   : private HTHDMIIMSSMBC_soft_parameters
   , public HTHDMIIMSSMBC_mass_eigenstates_interface
{
public:
   explicit HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme(const HTHDMIIMSSMBC_input_parameters& input_ = HTHDMIIMSSMBC_input_parameters());
   explicit HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme(const HTHDMIIMSSMBC_mass_eigenstates&);
   HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme(const HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme&) = default;
   HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme(HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme() = default;
   HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme& operator=(const HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme&) = default;
   HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme& operator=(HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const HTHDMIIMSSMBC_mass_eigenstates&);
...
private:
   ...
   Problems problems{HTHDMIIMSSMBC_info::model_name,
...
std::ostream& operator<<(std::ostream&, const HTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme&);
