...
// File generated at Wed 16 Oct 2019 21:21:40
...
#define CLASSNAME HTHDMIIMSSMBC_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int HTHDMIIMSSMBC_susy_parameters::numberOfParameters;

HTHDMIIMSSMBC_susy_parameters::HTHDMIIMSSMBC_susy_parameters(const HTHDMIIMSSMBC_input_parameters& input_)
   : input(input_)
{
...
Eigen::ArrayXd HTHDMIIMSSMBC_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

HTHDMIIMSSMBC_susy_parameters HTHDMIIMSSMBC_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return HTHDMIIMSSMBC_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
HTHDMIIMSSMBC_susy_parameters HTHDMIIMSSMBC_susy_parameters::calc_beta() const
{
...
Eigen::ArrayXd HTHDMIIMSSMBC_susy_parameters::get() const
{
...
void HTHDMIIMSSMBC_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const HTHDMIIMSSMBC_input_parameters& HTHDMIIMSSMBC_susy_parameters::get_input() const
{
   return input;
}

HTHDMIIMSSMBC_input_parameters& HTHDMIIMSSMBC_susy_parameters::get_input()
{
   return input;
}

void HTHDMIIMSSMBC_susy_parameters::set_input_parameters(const HTHDMIIMSSMBC_input_parameters& input_)
{
   input = input_;
}

HTHDMIIMSSMBC_susy_parameters::Susy_traces HTHDMIIMSSMBC_susy_parameters::calc_susy_traces(int loops) const
{
