...
#define SUPER(p) HTHDMIIMSSMBC_soft_parameters::p
 ...
 */
class HTHDMIIMSSMBC_mass_eigenstates
   : public HTHDMIIMSSMBC_soft_parameters
   , public HTHDMIIMSSMBC_mass_eigenstates_interface
{
public:
   explicit HTHDMIIMSSMBC_mass_eigenstates(const HTHDMIIMSSMBC_input_parameters& input_ = HTHDMIIMSSMBC_input_parameters());
   HTHDMIIMSSMBC_mass_eigenstates(const HTHDMIIMSSMBC_mass_eigenstates&) = default;
   HTHDMIIMSSMBC_mass_eigenstates(HTHDMIIMSSMBC_mass_eigenstates&&) = default;
   virtual ~HTHDMIIMSSMBC_mass_eigenstates() = default;
   HTHDMIIMSSMBC_mass_eigenstates& operator=(const HTHDMIIMSSMBC_mass_eigenstates&) = default;
   HTHDMIIMSSMBC_mass_eigenstates& operator=(HTHDMIIMSSMBC_mass_eigenstates&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<HTHDMIIMSSMBC_mass_eigenstates_interface> clone() const override;
   ...
   void set_ewsb_solver(const std::shared_ptr<HTHDMIIMSSMBC_ewsb_solver_interface>&);
   ...
   const HTHDMIIMSSMBC_input_parameters& get_input_parameters() const override;
   HTHDMIIMSSMBC_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const HTHDMIIMSSMBC_physical& get_physical() const override;
   HTHDMIIMSSMBC_physical& get_physical() override;
   ...
   void set_physical(const HTHDMIIMSSMBC_physical&) override;
   ...
   double get_MCha() const override { return MCha; }
   ...
   const Eigen::Array<double,2,1>& get_MChi() const override { return MChi; }
   ...
   const Eigen::Matrix<std::complex<double>,2,2>& get_ZN() const override { return ZN; }
   ...
   double get_mass_matrix_Cha() const override;
   ...
   Eigen::Matrix<double,2,2> get_mass_matrix_Chi() const override;
   ...
   double CpbarChaChaVPPL() const;
   double CpbarChaChaVPPR() const;
   ...
   double CpbarChaChaVZPL() const;
   double CpbarChaChaVZPR() const;
   ...
   std::complex<double> CpChiChaconjVWmPL(int gI1) const;
   std::complex<double> CpChiChaconjVWmPR(int gI1) const;
   ...
   double CpbarChaUChiVWmPL(int gO2) const;
   double CpbarChaUChiVWmPR(int gO1) const;
   double CpUChiChaconjVWmPR(int gO2) const;
   double CpUChiChaconjVWmPL(int gO1) const;
   double CpbarFvFeconjHmPL(int , int , int ) const;
   std::complex<double> CpbarFvFeconjHmPR(int gO1, int gI2, int gI1) const;
   std::complex<double> CpbarChaChiVWmPR(int gI2) const;
   std::complex<double> CpbarChaChiVWmPL(int gI2) const;
   ...
   Eigen::Matrix<std::complex<double>,2,2> self_energy_Chi_1loop_1(double p) const;
   std::complex<double> self_energy_Chi_1loop_PR(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,2,2> self_energy_Chi_1loop_PR(double p) const;
   std::complex<double> self_energy_Chi_1loop_PL(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,2,2> self_energy_Chi_1loop_PL(double p) const;
   ...
   std::complex<double> self_energy_Cha_1loop_1(double p ) const;
   std::complex<double> self_energy_Cha_1loop_PR(double p ) const;
   std::complex<double> self_energy_Cha_1loop_PL(double p ) const;
...
private:
   ...
   mutable Problems problems{HTHDMIIMSSMBC_info::model_name,
                             &HTHDMIIMSSMBC_info::particle_names_getter,
                             &HTHDMIIMSSMBC_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<HTHDMIIMSSMBC_ewsb_solver_interface> ewsb_solver{};
   ...
   Eigen::Array<double,2,1> MChi{Eigen::Array<double,2,1>::Zero()};
   double MVWm{};
   double MVP{};
   double MVZ{};
   ...
   Eigen::Matrix<std::complex<double>,2,2> ZN{Eigen::Matrix<std::complex<double>,2,2>::Zero()};
