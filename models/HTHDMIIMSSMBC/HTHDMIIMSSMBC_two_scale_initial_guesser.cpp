...
HTHDMIIMSSMBC_initial_guesser<Two_scale>::HTHDMIIMSSMBC_initial_guesser(
   HTHDMIIMSSMBC<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const HTHDMIIMSSMBC_low_scale_constraint<Two_scale>& low_constraint_,
   const HTHDMIIMSSMBC_susy_scale_constraint<Two_scale>& susy_constraint_,
   const HTHDMIIMSSMBC_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "HTHDMIIMSSMBC_initial_guesser: Error: pointer to model"
          " HTHDMIIMSSMBC<Two_scale> must not be zero");
}
 ...
 */
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::guess()
{
 ...
 * \code{.cpp}
   ...
   MODEL->set_M122(Re((TanBeta*Sqr(MAInput))/(1 + Sqr(TanBeta))));

 * \endcode
 */
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void HTHDMIIMSSMBC_initial_guesser<Two_scale>::guess_soft_parameters()
{
