...
// File generated at Sun 26 Aug 2018 14:08:30

/**
 * @file HTHDMIIMSSMBC_cxx_diagrams.hpp
 *
 * This file was generated at Sun 26 Aug 2018 14:08:30 with FlexibleSUSY
 * 2.2.0 and SARAH 4.13.0 .
 */

#ifndef HTHDMIIMSSMBC_CXXDIAGRAMS_H
#define HTHDMIIMSSMBC_CXXDIAGRAMS_H
...
struct Hm {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = -1;
   using lorentz_conjugate = conj<Hm>::type;
};
...
*/
struct EvaluationContext {
   HTHDMIIMSSMBC_mass_eigenstates& model; ///< The model object.
...
Vertex<bar<Fe>::type, Ah, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,0.7071067811865475)*SUM(j2,0,2,Conj(Ve(gt3,j2))*SUM(j1,0,2,Conj(Ue(gt1,j1))*Ye(j1,j2)))*ZA(gt2,0);

   const std::complex<double> right = std::complex<double>(0.,-0.7071067811865475)*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Ue(gt3,j1))*Ve(gt1,j2))*ZA(gt2,0);
...
Vertex<Fe, Ah, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,0.7071067811865475)*SUM(j2,0,2,Conj(Ve(gt1,j2))*SUM(j1,0,2,Conj(Ue(gt3,j1))*Ye(j1,j2)))*ZA(gt2,0);

   const std::complex<double> right = std::complex<double>(0.,-0.7071067811865475)*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Ue(gt1,j1))*Ve(gt3,j2))*ZA(gt2,0);
...
Vertex<Fe, bar<Fv>::type, conj<Hm>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> right = -(SUM(j1,0,2,Conj(Ye(j1,gt2))*Ue(gt1,j1))*ZP(gt3,0));
...
Vertex<bar<Fe>::type, hh, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*SUM(j2,0,2,Conj(Ve(gt3,j2))*SUM(j1,0,2,Conj(Ue(gt1,j1))*Ye(j1,j2)))*ZH(gt2,0);

   const std::complex<double> right = -0.7071067811865475*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Ue(gt3,j1))*Ve(gt1,j2))*ZH(gt2,0);
...
Vertex<Fe, hh, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*SUM(j2,0,2,Conj(Ve(gt1,j2))*SUM(j1,0,2,Conj(Ue(gt3,j1))*Ye(j1,j2)))*ZH(gt2,0);

   const std::complex<double> right = -0.7071067811865475*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Ue(gt1,j1))*Ve(gt3,j2))*ZH(gt2,0);
...
template<> inline
double EvaluationContext::mass_impl<Cha>(const std::array<int, 0>& indices) const
...
template<> inline
double EvaluationContext::mass_impl<Hm>(const std::array<int, 1>& indices) const
