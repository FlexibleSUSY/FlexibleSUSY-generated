...
// File generated at Wed 12 Apr 2017 10:59:55
 ...
 */
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda5_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda5_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda5 = Re(twoLoop*(7.665*Power(g1,4)*Lambda5 - 23.875*Power(g2
      ...
      *Lambda7 - 168*Lambda5*Lambda6*Lambda7 - 24*Lambda1*Lambda5*traceYdAdjYd
      - 24*Lambda3*Lambda5*traceYdAdjYd - 36*Lambda4*Lambda5*traceYdAdjYd - 12*
      ...
      traceYuAdjYuYuAdjYu + 40*Lambda5*traceYdAdjYd*Sqr(g3) + 40*Lambda5*
 ...
 */
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda5_three_loop(const Susy_traces& susy_traces) const
{
