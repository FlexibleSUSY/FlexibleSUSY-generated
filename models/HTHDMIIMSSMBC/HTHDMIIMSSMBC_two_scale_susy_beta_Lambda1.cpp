...
// File generated at Wed 12 Apr 2017 10:59:57
...
double HTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda1_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda1 = Re(twoLoop*(-1.9125*Power(g1,6) + 16.1875*Power(g2,6) -
      ...
      *traceYdAdjYdYdAdjYdYdAdjYd - 9*Lambda1*traceYdAdjYuYuAdjYd + 6*
      traceYdAdjYuYuAdjYdYdAdjYd - 0.125*Power(g2,4)*(11*Lambda1 + 6*(-10*
      ...
      traceYuAdjYu - 0.0075*Power(g1,4)*(-2*(691*Lambda1 + 30*(2*Lambda3 +
      Lambda4 + traceYdAdjYd - 5*traceYeAdjYe)) + 605*Sqr(g2)) + 80*Lambda1*
      ...
      Sqr(Lambda4) + 18*Sqr(Lambda6))) - 0.0125*Sqr(g1)*(335*Power(g2,4) - 12*
      (39*Lambda1 + 10*Lambda4 + 18*traceYdAdjYd + 22*traceYeAdjYe)*Sqr(g2) - 8
      *(24*Lambda3*Lambda4 + 25*Lambda1*traceYdAdjYd + 8*traceYdAdjYdYdAdjYd +
      75*Lambda1*traceYeAdjYe - 24*traceYeAdjYeYeAdjYe + 216*Sqr(Lambda1) + 24*
