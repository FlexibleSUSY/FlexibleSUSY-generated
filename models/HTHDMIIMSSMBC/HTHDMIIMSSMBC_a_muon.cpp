...
// File generated at Tue 22 Jan 2019 16:16:09

/**
 * @file HTHDMIIMSSMBC_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 16:16:09 with FlexibleSUSY
...
double calculate_a_muon_impl(HTHDMIIMSSMBC_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const HTHDMIIMSSMBC_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("HTHDMIIMSSMBC_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double HTHDMIIMSSMBC_a_muon::calculate_a_muon(const HTHDMIIMSSMBC_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("HTHDMIIMSSMBC_a_muon:" << e.what());
...
double HTHDMIIMSSMBC_a_muon::calculate_a_muon_uncertainty(const HTHDMIIMSSMBC_mass_eigenstates& model_)
{
   HTHDMIIMSSMBC_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("HTHDMIIMSSMBC_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
