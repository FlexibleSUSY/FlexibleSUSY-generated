...
// File generated at Tue 8 Mar 2016 18:05:22
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_M222_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_M222_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(twoLoop*(0.9*Power(g1,4)*M112 + 7.5*Power(g2,4)*M112 -
      ...
      g1,4)*M222 - 5.1875*Power(g2,4)*M222 - 2*Lambda3*Lambda4*M222 - 6*(4*
      Lambda3*M112 + 2*Lambda4*M112 - 3*Lambda7*M122)*traceYdAdjYd - 4.5*M222*
      traceYdAdjYuYuAdjYd + (-8*Lambda3*M112 - 4*Lambda4*M112 + 6*Lambda7*M122)
      *traceYeAdjYe + 18*Lambda7*M122*traceYuAdjYu - 72*Lambda2*M222*
      traceYuAdjYu - 13.5*M222*traceYuAdjYuYuAdjYu + 4.8*Lambda3*M112*Sqr(g1) +
      2.4*Lambda4*M112*Sqr(g1) - 7.2*Lambda7*M122*Sqr(g1) + 14.4*Lambda2*M222*
      Sqr(g1) + 4.25*M222*traceYuAdjYu*Sqr(g1) + 24*Lambda3*M112*Sqr(g2) + 12*
      Lambda4*M112*Sqr(g2) - 36*Lambda7*M122*Sqr(g2) + 72*Lambda2*M222*Sqr(g2)
      ...
      Lambda6) - 18*M112*Sqr(Lambda7) - 27*M222*Sqr(Lambda7) - 2.16*Power(g1,4)
      *Sqr(Mu) - 18*Power(g2,4)*Sqr(Mu)));
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_M222_three_loop(const Soft_traces& soft_traces) const
{
