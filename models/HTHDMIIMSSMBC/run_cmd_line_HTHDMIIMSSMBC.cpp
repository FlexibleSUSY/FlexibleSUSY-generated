...
int run_solver(const HTHDMIIMSSMBC_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(HTHDMIIMSSMBC_slha_io::fill_slhaea(
...
int run(int solver_type, const HTHDMIIMSSMBC_input_parameters& input)
{
   int exit_code = 0;
