...
{
   std::cout <<
      "Usage: run_cmd_line_HTHDMIIMSSMBC.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MSUSY=<value>\n"
      "  --MEWSB=<value>\n"
...
int main(int argc, char* argv[])
{
   ...
   const HTHDMIIMSSMBC_slha<algorithm_type> model(spectrum_generator.get_model());
   ...
   const HTHDMIIMSSMBC_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(HTHDMIIMSSMBC_slha_io::fill_slhaea(model, qedqcd, scales, observables));
