...
std::valarray<double> HTHDMIIMSSMBC_spectrum_plotter::to_valarray(double v)
{
   ...
   const HTHDMIIMSSMBC_observables* observables)
{
   ...
   append(names, HTHDMIIMSSMBC_parameter_getter().get_mass_names());
   append(names, HTHDMIIMSSMBC_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, HTHDMIIMSSMBC_observables* observables)
{
   ...
   const std::size_t number_of_masses = HTHDMIIMSSMBC_parameter_getter().get_number_of_masses();
