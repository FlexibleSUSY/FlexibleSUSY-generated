...
// HTHDMIIMSSMBC_parameter_getter ////////////////////////////////////////

std::vector<std::string> HTHDMIIMSSMBC_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS> HTHDMIIMSSMBC_parameter_getter::get_mixing_names()
{
   return HTHDMIIMSSMBC_info::particle_mixing_names;
}

Eigen::ArrayXd HTHDMIIMSSMBC_parameter_getter::get_parameters(const HTHDMIIMSSMBC_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_PARAMETERS> HTHDMIIMSSMBC_parameter_getter::get_parameter_names()
{
   return HTHDMIIMSSMBC_info::parameter_names;
}

std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_PARTICLES> HTHDMIIMSSMBC_parameter_getter::get_particle_names()
{
   return HTHDMIIMSSMBC_info::particle_names;
}

std::vector<std::string> HTHDMIIMSSMBC_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> HTHDMIIMSSMBC_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS> HTHDMIIMSSMBC_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS> HTHDMIIMSSMBC_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS> HTHDMIIMSSMBC_parameter_getter::get_input_parameter_names()
{
   return HTHDMIIMSSMBC_info::input_parameter_names;
}

std::array<std::string, HTHDMIIMSSMBC_info::NUMBER_OF_EXTRA_PARAMETERS> HTHDMIIMSSMBC_parameter_getter::get_extra_parameter_names()
{
   return HTHDMIIMSSMBC_info::extra_parameter_names;
}

decltype(HTHDMIIMSSMBC_info::NUMBER_OF_MASSES) HTHDMIIMSSMBC_parameter_getter::get_number_of_masses()
{
   return HTHDMIIMSSMBC_info::NUMBER_OF_MASSES;
}

// HTHDMIIMSSMBC_spectrum_plotter ////////////////////////////////////////

HTHDMIIMSSMBC_spectrum_plotter::HTHDMIIMSSMBC_spectrum_plotter(const HTHDMIIMSSMBC_mass_eigenstates& model)
{
...
void HTHDMIIMSSMBC_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("HTHDMIIMSSMBC_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("HTHDMIIMSSMBC_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("HTHDMIIMSSMBC_spectrum_plotter::write_to_file: file written: "
               << file_name);
}
...
namespace HTHDMIIMSSMBC_database {
 ...
 */
void to_database(
   const std::string& file_name, const HTHDMIIMSSMBC_mass_eigenstates& model,
   ...
   const HTHDMIIMSSMBC_observables* observables)
{
   ...
   append(names, HTHDMIIMSSMBC_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, HTHDMIIMSSMBC_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, HTHDMIIMSSMBC_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, HTHDMIIMSSMBC_parameter_getter::get_DRbar_mass_names());
   append(names, HTHDMIIMSSMBC_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, HTHDMIIMSSMBC_parameter_getter::get_pole_mass_names());
   append(names, HTHDMIIMSSMBC_parameter_getter::get_pole_mixing_names());
   ...
   if (HTHDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, HTHDMIIMSSMBC_observables::get_names());
 ...
 */
HTHDMIIMSSMBC_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, HTHDMIIMSSMBC_observables* observables)
{
   HTHDMIIMSSMBC_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = HTHDMIIMSSMBC_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = HTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = HTHDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = HTHDMIIMSSMBC_info::NUMBER_OF_EXTRA_PARAMETERS;
