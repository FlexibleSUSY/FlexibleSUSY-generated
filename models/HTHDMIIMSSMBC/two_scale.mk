...
HTHDMIIMSSMBC_INCLUDE_MK += $(DIR)/two_scale.mk

LIBHTHDMIIMSSMBC_SRC += \
		$(DIR)/HTHDMIIMSSMBC_two_scale_convergence_tester.cpp \
		$(DIR)/HTHDMIIMSSMBC_two_scale_ewsb_solver.cpp \
		...
		$(DIR)/HTHDMIIMSSMBC_two_scale_spectrum_generator.cpp \
...
LIBHTHDMIIMSSMBC_HDR += \
		...
		$(DIR)/HTHDMIIMSSMBC_two_scale_ewsb_solver.hpp \
		...
		$(DIR)/HTHDMIIMSSMBC_two_scale_spectrum_generator.hpp \
