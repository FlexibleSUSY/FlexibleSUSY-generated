...
LIBHTHDMIIMSSMBC_CXXQFT_HDR := \
		...
		$(DIR)/cxx_qft/HTHDMIIMSSMBC_npointfunctions.hpp
...
install-src::
		...
		install -d $(HTHDMIIMSSMBC_INSTALL_CXXQFT_DIR)
		...
		install -m u=rw,g=r,o=r $(LIBHTHDMIIMSSMBC_CXXQFT_HDR) $(HTHDMIIMSSMBC_INSTALL_CXXQFT_DIR)
...
clean-$(MODNAME)-src:
		...
		-rm -f $(LIBHTHDMIIMSSMBC_CXXQFT_HDR)
...
$(LIBHTHDMIIMSSMBC_DEP) $(EXEHTHDMIIMSSMBC_DEP) $(LLHTHDMIIMSSMBC_DEP) $(LIBHTHDMIIMSSMBC_OBJ) $(EXEHTHDMIIMSSMBC_OBJ) $(LLHTHDMIIMSSMBC_OBJ) $(LLHTHDMIIMSSMBC_LIB): \
	CPPFLAGS += $(MODHTHDMIIMSSMBC_SUBMOD_INC) $(MODHTHDMIIMSSMBC_INC) $(GSLFLAGS) $(EIGENFLAGS) $(BOOSTFLAGS) $(TSILFLAGS) $(HIMALAYAFLAGS)
