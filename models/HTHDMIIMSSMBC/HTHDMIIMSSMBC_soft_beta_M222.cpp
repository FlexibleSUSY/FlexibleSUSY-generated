...
double HTHDMIIMSSMBC_soft_parameters::calc_beta_M222_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(0.0025*(-3200*Lambda3*Lambda4*M112 + 1800*Lambda5*Lambda6*
      ...
      M112*Quad(g1) + 1857*M222*Quad(g1) + 3000*M112*Quad(g2) - 2075*M222*Quad(
      ...
      *M222*Sqr(g1) + 1700*M222*traceYuAdjYu*Sqr(g1) - 2880*M122*Conj(Lambda7)*
      ...
      (Lambda3) - 3200*M112*Sqr(Lambda4) - 800*M222*Sqr(Lambda4) - 864*Quad(g1)
 ...
 */
double HTHDMIIMSSMBC_soft_parameters::calc_beta_M222_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
