...
#ifndef HTHDMIIMSSMBC_WEINBERG_ANGLE_H
#define HTHDMIIMSSMBC_WEINBERG_ANGLE_H
...
/**
 * @class HTHDMIIMSSMBC_weinberg_angle
...
public:
   ...
   HTHDMIIMSSMBC_weinberg_angle(const HTHDMIIMSSMBC_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const HTHDMIIMSSMBC_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const HTHDMIIMSSMBC_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
