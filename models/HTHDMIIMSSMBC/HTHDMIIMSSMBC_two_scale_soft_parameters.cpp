...
// File generated at Sat 15 Oct 2016 15:19:39
...
HTHDMIIMSSMBC_soft_parameters::HTHDMIIMSSMBC_soft_parameters(const HTHDMIIMSSMBC_input_parameters& input_)
   ...
   , Mu(0), M122(0), M112(0), M222(0), v1(0), v2(0)
...
HTHDMIIMSSMBC_soft_parameters HTHDMIIMSSMBC_soft_parameters::calc_beta() const
{
   ...
   const HTHDMIIMSSMBC_susy_parameters susy_betas(HTHDMIIMSSMBC_susy_parameters::calc_beta());

   return HTHDMIIMSSMBC_soft_parameters(susy_betas, beta_Mu, beta_M122, beta_M112, beta_M222, beta_v1, beta_v2);
}

HTHDMIIMSSMBC_soft_parameters HTHDMIIMSSMBC_soft_parameters::calc_beta(unsigned loops) const
{
   HTHDMIIMSSMBC_soft_parameters p(*this);
   p.set_loops(loops);
...
void HTHDMIIMSSMBC_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
