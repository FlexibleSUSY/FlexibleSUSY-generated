...
#ifndef HTHDMIIMSSMBC_TWO_SCALE_MATCHING_H
#define HTHDMIIMSSMBC_TWO_SCALE_MATCHING_H
...
template <class T> class HTHDMIIMSSMBC;
template <class T> class HTHDMIIMSSMBC_standard_model_Matching;
...
template<>
class HTHDMIIMSSMBC_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   HTHDMIIMSSMBC_standard_model_Matching();

   HTHDMIIMSSMBC_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       HTHDMIIMSSMBC<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~HTHDMIIMSSMBC_standard_model_Matching();
