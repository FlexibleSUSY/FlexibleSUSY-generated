...
namespace HTHDMIIMSSMBC_info {
   ...
   const char* particle_names[NUMBER_OF_PARTICLES] = {"VG", "Fv", "Cha", "hh",
      "Ah", "Hm", "Fd", "Fu", "Fe", "Chi", "VWm", "VP", "VZ"};

   const char* particle_latex_names[NUMBER_OF_PARTICLES] = {   "g", "\\nu",
      "\\tilde{\\chi}^-", "h", "A^0", "H^-", "d", "u", "e", "\\tilde{\\chi}^0",
      "W^-", "\\gamma", "Z"};
   ...
   const char* particle_mixing_names[NUMBER_OF_MIXINGS] = {   "ZH(0,0)",
      ...
      "Re(ZN(1,0))", "Im(ZN(1,0))", "Re(ZN(1,1))", "Im(ZN(1,1))", "ZZ(0,0)",
