...
class NMSSM_slha : public NMSSM_mass_eigenstates {
public:
   explicit NMSSM_slha(const NMSSM_input_parameters& input_ = NMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NMSSM_slha(const NMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
