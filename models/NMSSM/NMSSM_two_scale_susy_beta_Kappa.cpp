 ...
 */
double NMSSM_susy_parameters::calc_beta_Kappa_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NMSSM_susy_parameters::calc_beta_Kappa_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NMSSM_susy_parameters::calc_beta_Kappa_three_loop(const Susy_traces& susy_traces) const
{
