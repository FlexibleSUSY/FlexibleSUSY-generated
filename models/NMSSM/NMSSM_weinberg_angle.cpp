...
#include "NMSSM_weinberg_angle.hpp"
...
#define CLASSNAME NMSSM_weinberg_angle
 ...
 */
CLASSNAME::NMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const NMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * NMSSM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * NMSSM_info::normalization_g2;
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * NMSSM_info::normalization_g3 /
