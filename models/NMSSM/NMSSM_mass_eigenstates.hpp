...
public:
   ...
   NMSSM_mass_eigenstates(const NMSSM_mass_eigenstates&) = default;
   NMSSM_mass_eigenstates(NMSSM_mass_eigenstates&&) = default;
   virtual ~NMSSM_mass_eigenstates() = default;
   NMSSM_mass_eigenstates& operator=(const NMSSM_mass_eigenstates&) = default;
   NMSSM_mass_eigenstates& operator=(NMSSM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<NMSSM_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{NMSSM_info::model_name,
   ...
   std::shared_ptr<NMSSM_ewsb_solver_interface> ewsb_solver{};
