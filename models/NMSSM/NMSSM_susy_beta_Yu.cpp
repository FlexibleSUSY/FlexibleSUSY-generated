...
// File generated at Sun 26 Aug 2018 14:45:02
 ...
 */
Eigen::Matrix<double,3,3> NMSSM_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSM_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSM_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSM_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
