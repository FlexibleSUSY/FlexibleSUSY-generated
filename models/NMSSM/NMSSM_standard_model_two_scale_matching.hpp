...
#ifndef NMSSM_TWO_SCALE_MATCHING_H
#define NMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class NMSSM;
template <class T> class NMSSM_standard_model_Matching;
...
template<>
class NMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   NMSSM_standard_model_Matching();

   NMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       NMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~NMSSM_standard_model_Matching();
