...
// File generated at Tue 12 Jul 2016 11:53:50
...
NMSSM_spectrum_plotter::NMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> NMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const NMSSM_observables* observables)
{
   ...
   append(names, NMSSM_parameter_getter().get_mass_names());
   append(names, NMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, NMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = NMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = NMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = NMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? NMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
