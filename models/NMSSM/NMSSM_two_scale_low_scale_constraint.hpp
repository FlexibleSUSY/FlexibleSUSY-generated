...
template<>
class NMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   NMSSM_low_scale_constraint() = default;
   NMSSM_low_scale_constraint(NMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "NMSSM low-scale constraint"; }
