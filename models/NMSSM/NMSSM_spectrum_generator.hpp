                                ...
                                const NMSSM_input_parameters& input)
{
   ...
   NMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   NMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   NMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
