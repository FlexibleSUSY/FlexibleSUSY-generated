...
// File generated at Tue 24 Feb 2015 17:45:19
...
NMSSM_high_scale_constraint<Two_scale>::NMSSM_high_scale_constraint(
   ...
   const NMSSM_input_parameters& inputPars_)
   : Constraint<Two_scale>()
   , model(model_)
...
void NMSSM_high_scale_constraint<Two_scale>::set_input_parameters(const NMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
