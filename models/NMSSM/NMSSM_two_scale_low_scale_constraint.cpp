...
// File generated at Mon 23 Feb 2015 13:32:15
...
NMSSM_low_scale_constraint<Two_scale>::NMSSM_low_scale_constraint(
   ...
   const NMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void NMSSM_low_scale_constraint<Two_scale>::set_input_parameters(const NMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
