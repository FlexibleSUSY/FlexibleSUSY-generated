...
// File generated at Thu 15 Dec 2016 12:59:48
...
NMSSM_soft_parameters NMSSM_soft_parameters::calc_beta() const
{
   ...
   const NMSSM_susy_parameters susy_betas(NMSSM_susy_parameters::calc_beta());
...
NMSSM_soft_parameters NMSSM_soft_parameters::calc_beta(unsigned loops) const
{
   NMSSM_soft_parameters p(*this);
   p.set_loops(loops);
...
void NMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
