 ...
 */
template<>
class NMSSM<Two_scale> : public Two_scale_model, public NMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(NMSSM<Two_scale>::*Memfun_t)();
      NMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(NMSSM<Two_scale>* model_, Memfun_t fun_)
