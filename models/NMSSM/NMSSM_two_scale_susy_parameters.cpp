...
// File generated at Wed 12 Apr 2017 12:55:45
...
NMSSM_susy_parameters NMSSM_susy_parameters::calc_beta() const
{
   ...
   return NMSSM_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Lambdax, beta_Kappa, beta_Yu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu, beta_vS);
}

NMSSM_susy_parameters NMSSM_susy_parameters::calc_beta(unsigned loops) const
{
   NMSSM_susy_parameters p(*this);
   p.set_loops(loops);
...
void NMSSM_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
