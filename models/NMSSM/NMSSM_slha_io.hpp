...
#include "decays/NMSSM_decays.hpp"
...
public:
   ...
   void set_decays(const NMSSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const NMSSM_slha&, const NMSSM_scales&, const NMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const NMSSM_slha&);
   ...
   void fill_decays_data(const NMSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NMSSM_scales&, const NMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, NMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const NMSSM_slha&);
...
void NMSSM_slha_io::fill(
   ...
   NMSSM_decays const * const decays)
{
