...
public:
   ...
   void set_extra(const NMSSM_slha&, const NMSSM_scales&, const NMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NMSSM_scales&, const NMSSM_observables&);
