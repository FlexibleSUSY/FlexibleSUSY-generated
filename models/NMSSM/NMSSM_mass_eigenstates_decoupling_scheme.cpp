...
/**
 * @file NMSSM_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the NMSSM model class in the decoupling scheme
 *
...
#define CLASSNAME NMSSM_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const NMSSM_mass_eigenstates& model)
{
   fill_from(model);
}

std::unique_ptr<NMSSM_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<NMSSM_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const NMSSM_mass_eigenstates& model)
{
   set(model.get());
...
const NMSSM_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

NMSSM_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
...
std::ostream& operator<<(std::ostream& ostr, const NMSSM_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
