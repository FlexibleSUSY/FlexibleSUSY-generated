...
#ifndef NMSSM_TWO_SCALE_soft_parameters_H
#define NMSSM_TWO_SCALE_soft_parameters_H
...
public:
   ...
   NMSSM_soft_parameters(const NMSSM_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   NMSSM_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
