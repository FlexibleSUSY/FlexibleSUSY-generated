...
// File generated at Mon 27 Feb 2017 13:42:34
 ...
 */
double NMSSM_susy_parameters::calc_beta_vS_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NMSSM_susy_parameters::calc_beta_vS_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NMSSM_susy_parameters::calc_beta_vS_three_loop(const Susy_traces& susy_traces) const
{
