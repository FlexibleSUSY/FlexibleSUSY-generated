 ...
 * SLHA output file.
 */
void NMSSM_slha_io::fill(NMSSM_slha& model) const
{
 ...
 * @param settings class of settings
 */
void NMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 */
void NMSSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void NMSSM_slha_io::set_model_parameters(const NMSSM_slha& model)
{
   {
...
void NMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void NMSSM_slha_io::set_spectrum(const NMSSM_slha& model)
{
...
void NMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void NMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void NMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
