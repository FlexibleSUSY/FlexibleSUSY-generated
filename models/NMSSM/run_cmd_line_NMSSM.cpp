...
int run_solver(int loop_library, const NMSSM_input_parameters& input)
{
   ...
   NMSSM_decays decays;if (settings.get(Spectrum_generator_settings::calculate_sm_masses)) {
...
int run(int solver_type, int loop_library, const NMSSM_input_parameters& input)
{
   int exit_code = 0;
