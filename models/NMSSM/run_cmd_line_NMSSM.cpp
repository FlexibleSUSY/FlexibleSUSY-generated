...
int run_solver(const NMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(NMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const NMSSM_input_parameters& input)
{
   int exit_code = 0;
