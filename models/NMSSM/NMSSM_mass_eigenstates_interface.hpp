...
/**
 * @file NMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef NMSSM_MASS_EIGENSTATES_INTERFACE_H
#define NMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class NMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class NMSSM_mass_eigenstates_interface {
public:
   virtual ~NMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<NMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const NMSSM_input_parameters& get_input_parameters() const = 0;
   virtual NMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const NMSSM_physical& get_physical() const = 0;
   virtual NMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const NMSSM_physical&) = 0;
