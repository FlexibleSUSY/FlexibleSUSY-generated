...
/**
 * @file cxx_qft/NMSSM_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.1 and SARAH 4.14.5 .
 */

#ifndef NMSSM_CXXQFT_CONTEXT_BASE_H
#define NMSSM_CXXQFT_CONTEXT_BASE_H
...
namespace NMSSM_cxx_diagrams {
   ...
   struct context_base {
      NMSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(NMSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(NMSSM_mass_eigenstates_interface const* const m) : model(*m) {}
