...
struct NMSSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
NMSSM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   NMSSM_input_parameters& input)
{
...
void scan(int solver_type, NMSSM_input_parameters& input,
