...
template double NMSSM_edm::calculate_edm<NMSSM_cxx_diagrams::fields::Fe>(const NMSSM_mass_eigenstates&, const softsusy::QedQcd&, int);

template <typename Lepton>
double calculate_edm(const NMSSM_mass_eigenstates& model, const softsusy::QedQcd& qedqcd, int idx)
{
   context_base context{ model };

   using namespace NMSSM_cxx_diagrams::fields;

   const auto form_factors = NMSSM_FFV_form_factors::calculate_form_factors<Lepton,Lepton,VP>(idx, idx, model, false);
