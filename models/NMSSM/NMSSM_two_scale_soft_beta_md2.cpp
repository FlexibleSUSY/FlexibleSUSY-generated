 ...
 */
Eigen::Matrix<double,3,3> NMSSM_soft_parameters::calc_beta_md2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSM_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> NMSSM_soft_parameters::calc_beta_md2_three_loop(const Soft_traces& soft_traces) const
{
