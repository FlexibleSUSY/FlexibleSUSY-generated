...
/**
 * @file NMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef NMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define NMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "NMSSM_info.hpp"
#include "NMSSM_physical.hpp"
#include "NMSSM_soft_parameters.hpp"
#include "NMSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) NMSSM_soft_parameters::p
...
/**
 * @class NMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class NMSSM_mass_eigenstates_decoupling_scheme
   : private NMSSM_soft_parameters
   , public NMSSM_mass_eigenstates_interface
{
public:
   explicit NMSSM_mass_eigenstates_decoupling_scheme(const NMSSM_input_parameters& input_ = NMSSM_input_parameters());
   explicit NMSSM_mass_eigenstates_decoupling_scheme(const NMSSM_mass_eigenstates&);
   NMSSM_mass_eigenstates_decoupling_scheme(const NMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NMSSM_mass_eigenstates_decoupling_scheme(NMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~NMSSM_mass_eigenstates_decoupling_scheme() = default;
   NMSSM_mass_eigenstates_decoupling_scheme& operator=(const NMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NMSSM_mass_eigenstates_decoupling_scheme& operator=(NMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<NMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const NMSSM_mass_eigenstates&);
   ...
   const NMSSM_input_parameters& get_input_parameters() const override;
   NMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const NMSSM_physical& get_physical() const override;
   NMSSM_physical& get_physical() override;
   ...
   void set_physical(const NMSSM_physical&) override;
...
private:
   ...
   Problems problems{NMSSM_info::model_name,
                     &NMSSM_info::particle_names_getter,
                     &NMSSM_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const NMSSM_mass_eigenstates_decoupling_scheme&);
