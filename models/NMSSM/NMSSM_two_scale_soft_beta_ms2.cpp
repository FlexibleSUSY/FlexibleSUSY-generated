 ...
 */
double NMSSM_soft_parameters::calc_beta_ms2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSM_soft_parameters::calc_beta_ms2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NMSSM_soft_parameters::calc_beta_ms2_three_loop(const Soft_traces& soft_traces) const
{
