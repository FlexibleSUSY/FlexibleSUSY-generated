...
// File generated at Sun 26 Aug 2018 14:48:08

/**
 * @file NMSSM_a_muon.cpp
 *
 * This file was generated at Sun 26 Aug 2018 14:48:08 with FlexibleSUSY
...
#include "NMSSM_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(NMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const NMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("NMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double NMSSM_a_muon::calculate_a_muon(const NMSSM_mass_eigenstates& model_)
{
...
double NMSSM_a_muon::calculate_a_muon_uncertainty(const NMSSM_mass_eigenstates& model_)
{
   NMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("NMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
