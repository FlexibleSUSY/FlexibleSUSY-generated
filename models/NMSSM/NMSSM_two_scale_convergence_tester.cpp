...
// File generated at Fri 26 Jun 2015 19:15:08
...
NMSSM_convergence_tester<Two_scale>::NMSSM_convergence_tester(NMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<NMSSM<Two_scale> >(model, accuracy_goal)
{
}
...
double NMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const NMSSM<Two_scale>& ne = get_model();
