...
public:
   ...
   NMSSM_weinberg_angle(const NMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
