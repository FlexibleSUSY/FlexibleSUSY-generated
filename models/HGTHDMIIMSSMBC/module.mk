...
HGTHDMIIMSSMBC_CXX_QFT_VERTICES_MK := \
...
LIBHGTHDMIIMSSMBC_CXXQFT_HDR := \
		...
		$(DIR)/cxx_qft/HGTHDMIIMSSMBC_npointfunctions.hpp
...
-include $(HGTHDMIIMSSMBC_CXX_QFT_VERTICES_MK)
...
$(HGTHDMIIMSSMBC_SOFT_BETAS_MK): run-metacode-$(MODNAME)
		@$(CONVERT_DOS_PATHS) $@
$(HGTHDMIIMSSMBC_CXX_QFT_VERTICES_MK): run-metacode-$(MODNAME)
		@$(CONVERT_DOS_PATHS) $@
...
$(LIBHGTHDMIIMSSMBC_DEP) $(EXEHGTHDMIIMSSMBC_DEP) $(LLHGTHDMIIMSSMBC_DEP) $(LIBHGTHDMIIMSSMBC_OBJ) $(EXEHGTHDMIIMSSMBC_OBJ) $(LLHGTHDMIIMSSMBC_OBJ) $(LLHGTHDMIIMSSMBC_LIB): \
	CPPFLAGS += $(MODHGTHDMIIMSSMBC_SUBMOD_INC) $(MODHGTHDMIIMSSMBC_INC) $(GSLFLAGS) $(EIGENFLAGS) $(BOOSTFLAGS) $(TSILFLAGS) $(HIMALAYAFLAGS)
