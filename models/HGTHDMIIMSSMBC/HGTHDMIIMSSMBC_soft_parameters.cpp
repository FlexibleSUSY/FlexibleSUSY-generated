...
// File generated at Tue 10 Oct 2017 20:53:58
...
HGTHDMIIMSSMBC_soft_parameters HGTHDMIIMSSMBC_soft_parameters::calc_beta(int loops) const
{
   double beta_MassB = 0.;
   double beta_MassG = 0.;
   ...
   const HGTHDMIIMSSMBC_susy_parameters susy_betas(HGTHDMIIMSSMBC_susy_parameters::calc_beta(loops));
...
HGTHDMIIMSSMBC_soft_parameters::Soft_traces HGTHDMIIMSSMBC_soft_parameters::calc_soft_traces(int loops) const
{
