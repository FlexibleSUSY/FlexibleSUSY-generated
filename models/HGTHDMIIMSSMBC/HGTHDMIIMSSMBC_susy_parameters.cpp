...
HGTHDMIIMSSMBC_susy_parameters HGTHDMIIMSSMBC_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   if (loops > 0) {
      ...
      beta_g1dp += calc_beta_g1dp_1_loop(TRACE_STRUCT);
      beta_g1d += calc_beta_g1d_1_loop(TRACE_STRUCT);
      beta_g2up += calc_beta_g2up_1_loop(TRACE_STRUCT);
      beta_g2u += calc_beta_g2u_1_loop(TRACE_STRUCT);
      ...
      if (loops > 1) {
         ...
         beta_g1dp += calc_beta_g1dp_2_loop(TRACE_STRUCT);
         beta_g1d += calc_beta_g1d_2_loop(TRACE_STRUCT);
         beta_g2up += calc_beta_g2up_2_loop(TRACE_STRUCT);
         beta_g2u += calc_beta_g2u_2_loop(TRACE_STRUCT);
   ...
   return HGTHDMIIMSSMBC_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
void HGTHDMIIMSSMBC_susy_parameters::print() const
{
   this->print(std::cerr);
}
...
HGTHDMIIMSSMBC_susy_parameters::Susy_traces HGTHDMIIMSSMBC_susy_parameters::calc_susy_traces(int loops) const
{
