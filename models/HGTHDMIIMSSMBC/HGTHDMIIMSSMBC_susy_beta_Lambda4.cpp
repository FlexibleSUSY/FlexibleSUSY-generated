...
double HGTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda4_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(0.2*(-20*g1d*g1dp*g2u*g2up + 20*Lambda1*Lambda4 + 20*
      Lambda2*Lambda4 + 40*Lambda3*Lambda4 + 30*Lambda4*traceYdAdjYd + 60*
      ...
      *Conj(Lambda6) + 10*Lambda6*Conj(Lambda7) - 9*Lambda4*Sqr(g1) + 15*
      Lambda4*Sqr(g1d) + 5*Lambda4*Sqr(g1dp) - 45*Lambda4*Sqr(g2) + 9*Sqr(g1)*
      Sqr(g2) + 15*Lambda4*Sqr(g2u) + 20*Sqr(g1d)*Sqr(g2u) + 5*Lambda4*Sqr(g2up
      ) + 20*Sqr(Lambda4)));
...
double HGTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   ...
   const double beta_Lambda4_1 = Re(0.005*(1600*g1d*g1dp*g2u*g2up*Lambda3 +
      2400*g1d*g1dp*g2u*g2up*Lambda4 - 16000*Lambda1*Lambda3*Lambda4 - 16000*
   ...
   const double beta_Lambda4_2 = Re(0.1*(-480*Lambda1*AbsSqr(Lambda5) - 480*
      Lambda2*AbsSqr(Lambda5) - 480*Lambda3*AbsSqr(Lambda5) - 260*Lambda4*
