...
public:
   ...
   void set_extra(const HGTHDMIIMSSMBC_slha&, const HGTHDMIIMSSMBC_scales&, const HGTHDMIIMSSMBC_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const HGTHDMIIMSSMBC_scales&, const HGTHDMIIMSSMBC_observables&);
