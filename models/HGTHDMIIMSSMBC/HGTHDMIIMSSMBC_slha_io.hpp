...
struct HGTHDMIIMSSMBC_physical;
class HGTHDMIIMSSMBC_slha;
...
public:
   ...
   void fill(HGTHDMIIMSSMBC_slha&) const;
   ...
   void set_extra(const HGTHDMIIMSSMBC_slha&, const HGTHDMIIMSSMBC_scales&, const HGTHDMIIMSSMBC_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const HGTHDMIIMSSMBC_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const HGTHDMIIMSSMBC_scales&, const HGTHDMIIMSSMBC_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, HGTHDMIIMSSMBC_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const HGTHDMIIMSSMBC_slha&);
 ...
 */
template <class... Ts>
void HGTHDMIIMSSMBC_slha_io::fill(
   ...
   HGTHDMIIMSSMBC_decays const * const decays)
{
