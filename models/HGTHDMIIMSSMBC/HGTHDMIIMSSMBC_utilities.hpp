...
template <class Scalar, int M, int N>
std::valarray<double> HGTHDMIIMSSMBC_spectrum_plotter::to_valarray(const Eigen::Array<Scalar, M, N>& v)
{
...
void to_database(
   ...
   const HGTHDMIIMSSMBC_observables* observables = 0);
...
HGTHDMIIMSSMBC_mass_eigenstates from_database(
   ...
   HGTHDMIIMSSMBC_observables* observables = 0);
