...
// File generated at Sat 27 Aug 2016 11:51:37
...
double HGTHDMIIMSSMBC_soft_parameters::calc_beta_M222_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(twoLoop*(0.9*Power(g1,4)*M112 + 7.5*Power(g2,4)*M112 -
      ...
      Lambda7*M122 + 24*Lambda4*Lambda7*M122 + 24*Lambda5*Lambda7*M122 + 4.6425
      *Power(g1,4)*M222 - 0.1875*Power(g2,4)*M222 - 5.625*Power(g2u,4)*M222 -
      1.125*Power(g2up,4)*M222 - 2*Lambda3*Lambda4*M222 - 24*Lambda3*M112*
      ...
      MassWB*Mu + 4.8*Lambda3*M112*Sqr(g1) + 2.4*Lambda4*M112*Sqr(g1) - 14.4*
      Lambda7*M122*Sqr(g1) + 14.4*Lambda2*M222*Sqr(g1) + 4.25*M222*traceYuAdjYu
      *Sqr(g1) - 12*Lambda3*M112*Sqr(g1d) - 6*Lambda4*M112*Sqr(g1d) + 18*
      Lambda7*M122*Sqr(g1d) - 4*Lambda3*M112*Sqr(g1dp) - 2*Lambda4*M112*Sqr(
      g1dp) + 6*Lambda7*M122*Sqr(g1dp) + 24*Lambda3*M112*Sqr(g2) + 12*Lambda4*
      M112*Sqr(g2) - 72*Lambda7*M122*Sqr(g2) + 72*Lambda2*M222*Sqr(g2) + 11.25*
      M222*traceYuAdjYu*Sqr(g2) + 1.125*M222*Sqr(g1)*Sqr(g2) + 18*Lambda7*M122*
      Sqr(g2u) - 36*Lambda2*M222*Sqr(g2u) + 1.125*M222*Sqr(g1)*Sqr(g2u) - 2.25*
      M222*Sqr(g1d)*Sqr(g2u) + 20.625*M222*Sqr(g2)*Sqr(g2u) + 0.5*g2up*Conj(
      MassB)*(11*Power(g2up,3)*MassB + 12*g1dp*Lambda7*Mu + 6*g2up*MassB*Sqr(
      g1dp) + 9*g2up*MassB*Sqr(g2u) + 6*g2up*MassWB*Sqr(g2u)) + 6*Lambda7*M122*
      Sqr(g2up) - 12*Lambda2*M222*Sqr(g2up) + 0.375*M222*Sqr(g1)*Sqr(g2up) -
      0.75*M222*Sqr(g1dp)*Sqr(g2up) + 1.875*M222*Sqr(g2)*Sqr(g2up) - 2.25*M222*
      Sqr(g2u)*Sqr(g2up) + 1.5*Conj(MassWB)*(-24*Power(g2,4)*MassWB + 13*Power(
      g2u,4)*MassWB + 12*g1d*g2u*Lambda7*Mu + Sqr(g2u)*(6*MassWB*(Sqr(g1d) - 4*
      Sqr(g2)) + (2*MassB + 3*MassWB)*Sqr(g2up))) + 40*M222*traceYuAdjYu*Sqr(g3
      ) - 60*M222*Sqr(Lambda2) - 8*M112*Sqr(Lambda3) - 2*M222*Sqr(Lambda3) - 8*
      M112*Sqr(Lambda4) - 2*M222*Sqr(Lambda4) - 12*M112*Sqr(Lambda5) - 3*M222*
      Sqr(Lambda5) - 18*M112*Sqr(Lambda6) + 3*M222*Sqr(Lambda6) - 18*M112*Sqr(
