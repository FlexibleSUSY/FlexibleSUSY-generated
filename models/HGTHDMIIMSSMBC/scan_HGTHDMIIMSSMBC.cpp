...
struct HGTHDMIIMSSMBC_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
HGTHDMIIMSSMBC_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   HGTHDMIIMSSMBC_input_parameters& input)
{
   ...
   HGTHDMIIMSSMBC_scan_result result;
...
void scan(int solver_type, HGTHDMIIMSSMBC_input_parameters& input,
