   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,-0.7071067811865475)*(g1d*Conj(UM(gt2,1))*Conj(UP(gt1,0))*ZA(gt3,0) - g2u*Conj(UM(gt2,0))*Conj(UP(gt1,1))*ZA(gt3,1));

   const std::complex<double> right = std::complex<double>(0.,0.7071067811865475)*(g1d*UM(gt1,1)*UP(gt2,0)*ZA(gt3,0) - g2u*UM(gt1,0)*UP(gt2,1)*ZA(gt3,1));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*(g1d*Conj(UM(gt2,1))*Conj(UP(gt1,0))*ZH(gt3,0) + g2u*Conj(UM(gt2,0))*Conj(UP(gt1,1))*ZH(gt3,1));

   const std::complex<double> right = -0.7071067811865475*(g1d*UM(gt1,1)*UP(gt2,0)*ZH(gt3,0) + g2u*UM(gt1,0)*UP(gt2,1)*ZH(gt3,1));
