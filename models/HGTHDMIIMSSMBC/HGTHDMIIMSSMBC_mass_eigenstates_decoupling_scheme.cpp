...
/**
 * @file HGTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the HGTHDMIIMSSMBC model class in the decoupling scheme
 *
...
#include "HGTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme.hpp"
...
#define CLASSNAME HGTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const HGTHDMIIMSSMBC_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<HGTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const HGTHDMIIMSSMBC_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const HGTHDMIIMSSMBC_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
