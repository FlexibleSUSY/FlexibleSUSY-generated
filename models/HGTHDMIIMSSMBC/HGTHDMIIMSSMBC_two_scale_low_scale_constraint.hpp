...
template<>
class HGTHDMIIMSSMBC_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   HGTHDMIIMSSMBC_low_scale_constraint();
   HGTHDMIIMSSMBC_low_scale_constraint(HGTHDMIIMSSMBC<Two_scale>*, const softsusy::QedQcd&);
   virtual ~HGTHDMIIMSSMBC_low_scale_constraint();
   virtual void apply();
