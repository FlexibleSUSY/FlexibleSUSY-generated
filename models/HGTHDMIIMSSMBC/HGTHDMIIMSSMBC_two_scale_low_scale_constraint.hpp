...
#ifndef HGTHDMIIMSSMBC_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define HGTHDMIIMSSMBC_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "HGTHDMIIMSSMBC_low_scale_constraint.hpp"
...
template<>
class HGTHDMIIMSSMBC_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   HGTHDMIIMSSMBC_low_scale_constraint() = default;
   HGTHDMIIMSSMBC_low_scale_constraint(HGTHDMIIMSSMBC<Two_scale>*, const softsusy::QedQcd&);
   virtual ~HGTHDMIIMSSMBC_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "HGTHDMIIMSSMBC low-scale constraint"; }
