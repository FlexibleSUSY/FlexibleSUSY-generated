...
Eigen::Matrix<double,3,3> HGTHDMIIMSSMBC_susy_parameters::calc_beta_Ye_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Ye = (-0.25*Ye*(-12*traceYdAdjYd - 4*traceYeAdjYe + 9*Sqr(g1) - 6*Sqr(
      g1d) - 2*Sqr(g1dp) + 9*Sqr(g2)) + 1.5*(Ye*Ye.adjoint()*Ye)).real();
...
Eigen::Matrix<double,3,3> HGTHDMIIMSSMBC_susy_parameters::calc_beta_Ye_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Ye = (0.0025*Ye*(400*Lambda3*Lambda4 - 2700*traceYdAdjYdYdAdjYd - 900*
      traceYdAdjYuYuAdjYd - 900*traceYeAdjYeYeAdjYe + 600*AbsSqr(Lambda5) +
      1800*AbsSqr(Lambda6) + 600*AbsSqr(Lambda7) + 3162*Quad(g1) - 1125*Quad(
      g1d) - 225*Quad(g1dp) - 1500*Quad(g2) + 250*traceYdAdjYd*Sqr(g1) + 750*
      traceYeAdjYe*Sqr(g1) + 225*Sqr(g1)*Sqr(g1d) + 75*Sqr(g1)*Sqr(g1dp) - 450*
      Sqr(g1d)*Sqr(g1dp) + 2250*traceYdAdjYd*Sqr(g2) + 750*traceYeAdjYe*Sqr(g2)
      + 540*Sqr(g1)*Sqr(g2) + 4125*Sqr(g1d)*Sqr(g2) + 375*Sqr(g1dp)*Sqr(g2) -
      450*Sqr(g1d)*Sqr(g2u) - 150*Sqr(g1dp)*Sqr(g2up) + 8000*traceYdAdjYd*Sqr(
      g3) + 2400*Sqr(Lambda1) + 400*Sqr(Lambda3) + 400*Sqr(Lambda4)) + 0.0375*(
      -320*Lambda1 - 180*traceYdAdjYd - 60*traceYeAdjYe + 129*Sqr(g1) - 90*Sqr(
      g1d) - 30*Sqr(g1dp) + 225*Sqr(g2))*(Ye*Ye.adjoint()*Ye) + 1.5*(Ye*Ye.
