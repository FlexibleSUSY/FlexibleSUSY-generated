...
/**
 * @file HGTHDMIIMSSMBC_mass_eigenstates.hpp
 *
...
#ifndef HGTHDMIIMSSMBC_MASS_EIGENSTATES_H
#define HGTHDMIIMSSMBC_MASS_EIGENSTATES_H
 ...
 */
class HGTHDMIIMSSMBC_mass_eigenstates : public HGTHDMIIMSSMBC_soft_parameters {
public:
   explicit HGTHDMIIMSSMBC_mass_eigenstates(const HGTHDMIIMSSMBC_input_parameters& input_ = HGTHDMIIMSSMBC_input_parameters());
   virtual ~HGTHDMIIMSSMBC_mass_eigenstates();
   ...
   void set_physical(const HGTHDMIIMSSMBC_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const HGTHDMIIMSSMBC_physical& get_physical() const;
   HGTHDMIIMSSMBC_physical& get_physical();
   const Problems<HGTHDMIIMSSMBC_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<HGTHDMIIMSSMBC_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   std::complex<double> CpconjUHmChiChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpconjUHmChiChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpUChibarChaHmPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChibarChaHmPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChiconjHmChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpUChiconjHmChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
   ...
   std::complex<double> CpbarUChaHmChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const;
   std::complex<double> CpbarUChaHmChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const;
...
private:
   ...
   Problems<HGTHDMIIMSSMBC_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const HGTHDMIIMSSMBC_mass_eigenstates&);
