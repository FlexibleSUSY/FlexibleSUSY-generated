...
class HGTHDMIIMSSMBC_ewsb_solver_interface;
/**
...
public:
   ...
   HGTHDMIIMSSMBC_mass_eigenstates(const HGTHDMIIMSSMBC_mass_eigenstates&) = default;
   HGTHDMIIMSSMBC_mass_eigenstates(HGTHDMIIMSSMBC_mass_eigenstates&&) = default;
   virtual ~HGTHDMIIMSSMBC_mass_eigenstates() = default;
   HGTHDMIIMSSMBC_mass_eigenstates& operator=(const HGTHDMIIMSSMBC_mass_eigenstates&) = default;
   HGTHDMIIMSSMBC_mass_eigenstates& operator=(HGTHDMIIMSSMBC_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<HGTHDMIIMSSMBC_ewsb_solver_interface>&);
   ...
   std::complex<double> CpChiChaconjUHmPR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpChiChaconjUHmPL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpbarChaUChiHmPL(int gI1, int gO2, int gI2) const;
   std::complex<double> CpbarChaUChiHmPR(int gI1, int gO1, int gI2) const;
   std::complex<double> CpUChiChaconjHmPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpUChiChaconjHmPR(int gO1, int gI2, int gI1) const;
   ...
   std::complex<double> CpbarUChaChiHmPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpbarUChaChiHmPR(int gO1, int gI2, int gI1) const;
...
private:
   ...
   std::shared_ptr<HGTHDMIIMSSMBC_ewsb_solver_interface> ewsb_solver{};
