...
// File generated at Tue 10 Oct 2017 21:00:28
...
double HGTHDMIIMSSMBC_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double HGTHDMIIMSSMBC_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double HGTHDMIIMSSMBC_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double HGTHDMIIMSSMBC_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarFdFdhhPL(int gO2, int gI2, int gI1) const
{
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarFdFdAhPL(int gO2, int gI1, int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarFeFehhPL(int gO2, int gI2, int gI1) const
{
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarFeFeAhPL(int gO2, int gI1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarFuFuhhPL(int gO2, int gI2, int gI1) const
{
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarFuFuAhPL(int gO2, int gI1, int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CphhHmconjHm(int gt1, int gt2, int gt3) const
{
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarChaChahhPL(int gt3, int gt1, int gt2) const
{
   const auto g1d = MODELPARAMETER(g1d);
   const auto g2u = MODELPARAMETER(g2u);

   const std::complex<double> result = -0.7071067811865475*(g1d*Conj(UM(gt1,1))
      *Conj(UP(gt3,0))*ZH(gt2,0) + g2u*Conj(UM(gt1,0))*Conj(UP(gt3,1))*ZH(gt2,1));

   return result;
}

std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpAhHmconjHm(int gt1, int gt2, int gt3) const
{
   const auto Lambda4 = MODELPARAMETER(Lambda4);
   const auto Lambda5 = MODELPARAMETER(Lambda5);
   const auto Lambda6 = MODELPARAMETER(Lambda6);
...
std::complex<double> HGTHDMIIMSSMBC_effective_couplings::CpbarChaChaAhPL(int gt3, int gt2, int gt1) const
{
   const auto g1d = MODELPARAMETER(g1d);
   const auto g2u = MODELPARAMETER(g2u);

   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*(g1d*Conj(UM(gt2,1))*Conj(UP(gt3,0))*ZA(gt1,0) - g2u*
      Conj(UM(gt2,0))*Conj(UP(gt3,1))*ZA(gt1,1));

   return result;
}

void HGTHDMIIMSSMBC_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
...
void HGTHDMIIMSSMBC_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto g3 = MODELPARAMETER(g3);
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
...
void HGTHDMIIMSSMBC_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
   const auto MFe = PHYSICAL(MFe);
...
void HGTHDMIIMSSMBC_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto g3 = MODELPARAMETER(g3);
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
