Get["models/HGTHDMIIMSSMBC/HGTHDMIIMSSMBC_librarylink.m"];

handle = FSHGTHDMIIMSSMBCOpenHandle[
    fsSettings -> {
...
spectrum    = FSHGTHDMIIMSSMBCCalculateSpectrum[handle];
observables = FSHGTHDMIIMSSMBCCalculateObservables[handle];
FSHGTHDMIIMSSMBCCloseHandle[handle];
