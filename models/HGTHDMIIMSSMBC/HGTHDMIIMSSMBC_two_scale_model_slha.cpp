...
/**
 * @file HGTHDMIIMSSMBC_two_scale_model_slha.cpp
 * @brief HGTHDMIIMSSMBC model class wrapper for SLHA conversion
 */
...
#define CLASSNAME HGTHDMIIMSSMBC_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::HGTHDMIIMSSMBC_slha(const HGTHDMIIMSSMBC_input_parameters& input_)
   : HGTHDMIIMSSMBC<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::HGTHDMIIMSSMBC_slha(const HGTHDMIIMSSMBC<Two_scale>& model_,
...
CLASSNAME::~HGTHDMIIMSSMBC_slha()
{
}

void CLASSNAME::clear()
{
   HGTHDMIIMSSMBC<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   HGTHDMIIMSSMBC<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const HGTHDMIIMSSMBC_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

HGTHDMIIMSSMBC_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   HGTHDMIIMSSMBC<Two_scale>::print(ostr);
