...
{
   std::cout <<
      "Usage: run_cmd_line_HGTHDMIIMSSMBC.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MSUSY=<value>\n"
      "  --MEWSB=<value>\n"
...
int run_solver(const HGTHDMIIMSSMBC_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(HGTHDMIIMSSMBC_slha_io::fill_slhaea(
...
int run(int solver_type, const HGTHDMIIMSSMBC_input_parameters& input)
{
   int exit_code = 0;
