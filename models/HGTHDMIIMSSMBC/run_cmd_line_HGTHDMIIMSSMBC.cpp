...
int main(int argc, char* argv[])
{
   ...
   const HGTHDMIIMSSMBC_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(HGTHDMIIMSSMBC_slha_io::fill_slhaea(model, qedqcd, scales, observables));
