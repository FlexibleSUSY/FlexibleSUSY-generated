...
HGTHDMIIMSSMBC_slha::HGTHDMIIMSSMBC_slha(const HGTHDMIIMSSMBC_input_parameters& input_,
 ...
 */
HGTHDMIIMSSMBC_slha::HGTHDMIIMSSMBC_slha(const HGTHDMIIMSSMBC_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : HGTHDMIIMSSMBC_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void HGTHDMIIMSSMBC_slha::clear()
{
   HGTHDMIIMSSMBC_mass_eigenstates::clear();
   physical_slha.clear();
}

void HGTHDMIIMSSMBC_slha::calculate_spectrum()
{
   HGTHDMIIMSSMBC_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void HGTHDMIIMSSMBC_slha::convert_to_slha()
{
...
void HGTHDMIIMSSMBC_slha::calculate_ckm_matrix()
{
...
void HGTHDMIIMSSMBC_slha::calculate_pmns_matrix()
{
 ...
 */
void HGTHDMIIMSSMBC_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void HGTHDMIIMSSMBC_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void HGTHDMIIMSSMBC_slha::convert_soft_squared_masses_to_slha()
{

}

const HGTHDMIIMSSMBC_physical& HGTHDMIIMSSMBC_slha::get_physical_slha() const
{
   return physical_slha;
}

HGTHDMIIMSSMBC_physical& HGTHDMIIMSSMBC_slha::get_physical_slha()
{
   return physical_slha;
}

void HGTHDMIIMSSMBC_slha::print(std::ostream& ostr) const
{
   HGTHDMIIMSSMBC_mass_eigenstates::print(ostr);
...
void HGTHDMIIMSSMBC_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const HGTHDMIIMSSMBC_slha& model)
{
   model.print(ostr);
   return ostr;
}
