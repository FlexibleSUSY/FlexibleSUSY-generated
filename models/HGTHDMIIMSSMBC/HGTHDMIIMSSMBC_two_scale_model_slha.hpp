...
/**
 * @file HGTHDMIIMSSMBC_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Sat 27 Aug 2016 11:54:33

#ifndef HGTHDMIIMSSMBC_TWO_SCALE_SLHA_H
#define HGTHDMIIMSSMBC_TWO_SCALE_SLHA_H
...
/**
 * @class HGTHDMIIMSSMBC_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class HGTHDMIIMSSMBC_slha<Two_scale> : public HGTHDMIIMSSMBC<Two_scale> {
public:
   explicit HGTHDMIIMSSMBC_slha(const HGTHDMIIMSSMBC_input_parameters& input_ = HGTHDMIIMSSMBC_input_parameters());
   explicit HGTHDMIIMSSMBC_slha(const HGTHDMIIMSSMBC<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~HGTHDMIIMSSMBC_slha();
   ...
   const HGTHDMIIMSSMBC_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   HGTHDMIIMSSMBC_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   HGTHDMIIMSSMBC_physical physical_slha; ///< contains the pole masses and mixings in slha convention
...
std::ostream& operator<<(std::ostream& ostr, const HGTHDMIIMSSMBC_slha<Two_scale>& model);
