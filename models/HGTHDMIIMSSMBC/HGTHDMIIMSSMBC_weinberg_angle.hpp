...
/**
 * @class HGTHDMIIMSSMBC_weinberg_angle
...
public:
   ...
   HGTHDMIIMSSMBC_weinberg_angle(const HGTHDMIIMSSMBC_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const HGTHDMIIMSSMBC_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const HGTHDMIIMSSMBC_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
