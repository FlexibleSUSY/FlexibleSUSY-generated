...
/**
 * @file HGTHDMIIMSSMBC_mass_eigenstates_interface.hpp
 *
...
#ifndef HGTHDMIIMSSMBC_MASS_EIGENSTATES_INTERFACE_H
#define HGTHDMIIMSSMBC_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class HGTHDMIIMSSMBC_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class HGTHDMIIMSSMBC_mass_eigenstates_interface {
public:
   virtual ~HGTHDMIIMSSMBC_mass_eigenstates_interface() {}

   virtual std::unique_ptr<HGTHDMIIMSSMBC_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const HGTHDMIIMSSMBC_input_parameters& get_input_parameters() const = 0;
   virtual HGTHDMIIMSSMBC_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const HGTHDMIIMSSMBC_physical& get_physical() const = 0;
   virtual HGTHDMIIMSSMBC_physical& get_physical() = 0;
   ...
   virtual void set_physical(const HGTHDMIIMSSMBC_physical&) = 0;
   ...
   virtual double get_g1dp() const = 0;
   virtual double get_g1d() const = 0;
   virtual double get_g2up() const = 0;
   ...
   virtual void set_g1dp(double g1dp_) = 0;
   virtual void set_g1d(double g1d_) = 0;
   virtual void set_g2up(double g2up_) = 0;
