...
HGTHDMIIMSSMBC_initial_guesser<Two_scale>::HGTHDMIIMSSMBC_initial_guesser(
   HGTHDMIIMSSMBC<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>& low_constraint_,
   const HGTHDMIIMSSMBC_susy_scale_constraint<Two_scale>& susy_constraint_,
   const HGTHDMIIMSSMBC_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "HGTHDMIIMSSMBC_initial_guesser: Error: pointer to model"
          " HGTHDMIIMSSMBC<Two_scale> must not be zero");
}
 ...
 */
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void HGTHDMIIMSSMBC_initial_guesser<Two_scale>::guess_soft_parameters()
{
