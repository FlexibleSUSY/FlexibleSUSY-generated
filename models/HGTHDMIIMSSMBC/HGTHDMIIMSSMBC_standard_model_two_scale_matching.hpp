...
#ifndef HGTHDMIIMSSMBC_TWO_SCALE_MATCHING_H
#define HGTHDMIIMSSMBC_TWO_SCALE_MATCHING_H
...
template <class T> class HGTHDMIIMSSMBC;
template <class T> class HGTHDMIIMSSMBC_standard_model_Matching;
...
template<>
class HGTHDMIIMSSMBC_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   HGTHDMIIMSSMBC_standard_model_Matching();

   HGTHDMIIMSSMBC_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       HGTHDMIIMSSMBC<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~HGTHDMIIMSSMBC_standard_model_Matching();
