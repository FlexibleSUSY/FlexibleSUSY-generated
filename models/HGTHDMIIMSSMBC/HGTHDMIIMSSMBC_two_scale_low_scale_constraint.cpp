...
// File generated at Wed 29 Jun 2016 11:28:13
...
{
   assert(model && "Error: HGTHDMIIMSSMBC_low_scale_constraint::apply():"
...
void HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
...
{
   assert(model && "HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
double HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
double HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   ...
   const double delta_alpha_s = -0.3183098861837907*alphaS*FiniteLog(Abs(
      MGlu/currentScale));
...
void HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_MNeutrino_DRbar()
{
   assert(model && "HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::"
 ...
 */
void HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::recalculate_mw_pole()
{
   assert(model && "HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::"
   ...
   if (mw_pole_sqr < 0.)
      MODEL->get_problems().flag_tachyon(HGTHDMIIMSSMBC_info::VWm);
