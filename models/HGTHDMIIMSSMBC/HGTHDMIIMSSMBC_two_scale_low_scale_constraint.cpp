...
// File generated at Fri 20 Oct 2017 08:36:35
...
void HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>::apply()
{
   ...
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
   MODEL->set_v1(Re((2*MZMSbar)/(Sqrt(0.6*Sqr(g1) + Sqr(g2))*Sqrt(1 + Sqr(
      TanBeta)))));
   MODEL->set_v2(Re((2*MZMSbar*TanBeta)/(Sqrt(0.6*Sqr(g1) + Sqr(g2))*Sqrt(1 +
      Sqr(TanBeta)))));
   MODEL->set_g1(new_g1);
   MODEL->set_g2(new_g2);
   MODEL->set_g3(new_g3);
