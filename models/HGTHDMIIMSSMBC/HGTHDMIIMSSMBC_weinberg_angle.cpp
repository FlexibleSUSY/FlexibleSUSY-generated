...
// File generated at Fri 20 Oct 2017 08:36:32
...
#define CLASSNAME HGTHDMIIMSSMBC_weinberg_angle
 ...
 */
CLASSNAME::HGTHDMIIMSSMBC_weinberg_angle(
...
void CLASSNAME::set_model(const HGTHDMIIMSSMBC_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * HGTHDMIIMSSMBC_info::normalization_g1;
   const double g2 = MODEL->get_g2() * HGTHDMIIMSSMBC_info::normalization_g2;
