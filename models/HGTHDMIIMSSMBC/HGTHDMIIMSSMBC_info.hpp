...
namespace HGTHDMIIMSSMBC_info {
   enum Particles : unsigned {VG, Fv, Glu, hh, Ah, Hm, Fd, Fu, Fe, Chi, Cha,
      VWm, VP, VZ, NUMBER_OF_PARTICLES};

   enum Masses : unsigned {MVG, MFv_1, MFv_2, MFv_3, MGlu, Mhh_1, Mhh_2, MAh_1,
   ...
   enum Input_parameters : unsigned {TanBeta, MSUSY, MEWSB, MuInput, M1Input,
