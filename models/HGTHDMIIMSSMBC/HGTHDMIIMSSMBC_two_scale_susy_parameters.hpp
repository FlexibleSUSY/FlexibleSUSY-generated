...
// File generated at Mon 19 Sep 2016 09:53:14
...
public:
   ...
   HGTHDMIIMSSMBC_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const HGTHDMIIMSSMBC_input_parameters& input_, double g1_, double g2_, double g3_, double Lambda6_, double Lambda5_,
   ...
   virtual ~HGTHDMIIMSSMBC_susy_parameters() {}
   ...
   HGTHDMIIMSSMBC_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
private:
   ...
   double calc_beta_g1dp_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g1dp_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g1dp_three_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g1d_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g1d_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g1d_three_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2up_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2up_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2up_three_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2u_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2u_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_g2u_three_loop(const TRACE_STRUCT_TYPE&) const;
