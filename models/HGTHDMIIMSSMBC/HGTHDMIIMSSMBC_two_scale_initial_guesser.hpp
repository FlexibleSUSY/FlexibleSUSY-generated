...
#include "HGTHDMIIMSSMBC_initial_guesser.hpp"
...
/**
 * @class HGTHDMIIMSSMBC_initial_guesser<Two_scale>
 * @brief initial guesser for the HGTHDMIIMSSMBC
 */

template<>
class HGTHDMIIMSSMBC_initial_guesser<Two_scale> : public Initial_guesser {
public:
   HGTHDMIIMSSMBC_initial_guesser(HGTHDMIIMSSMBC<Two_scale>*,
                               const softsusy::QedQcd&,
                               const HGTHDMIIMSSMBC_low_scale_constraint<Two_scale>&,
                               const HGTHDMIIMSSMBC_susy_scale_constraint<Two_scale>&,
                               const HGTHDMIIMSSMBC_high_scale_constraint<Two_scale>&);
   virtual ~HGTHDMIIMSSMBC_initial_guesser() = default;
...
private:
   HGTHDMIIMSSMBC<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   HGTHDMIIMSSMBC_low_scale_constraint<Two_scale> low_constraint{};
   HGTHDMIIMSSMBC_susy_scale_constraint<Two_scale> susy_constraint{};
   HGTHDMIIMSSMBC_high_scale_constraint<Two_scale> high_constraint{};
