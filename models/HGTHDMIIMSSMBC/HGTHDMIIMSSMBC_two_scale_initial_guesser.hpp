...
template<>
class HGTHDMIIMSSMBC_initial_guesser<Two_scale> : public Initial_guesser<Two_scale> {
public:
   ...
   virtual ~HGTHDMIIMSSMBC_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   HGTHDMIIMSSMBC<Two_scale>* model; ///< pointer to model class
