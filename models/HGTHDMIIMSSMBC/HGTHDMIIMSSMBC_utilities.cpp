...
// HGTHDMIIMSSMBC_parameter_getter ////////////////////////////////////////

std::vector<std::string> HGTHDMIIMSSMBC_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS> HGTHDMIIMSSMBC_parameter_getter::get_mixing_names()
{
   return HGTHDMIIMSSMBC_info::particle_mixing_names;
}

Eigen::ArrayXd HGTHDMIIMSSMBC_parameter_getter::get_parameters(const HGTHDMIIMSSMBC_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_PARAMETERS> HGTHDMIIMSSMBC_parameter_getter::get_parameter_names()
{
   return HGTHDMIIMSSMBC_info::parameter_names;
}

std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_PARTICLES> HGTHDMIIMSSMBC_parameter_getter::get_particle_names()
{
   return HGTHDMIIMSSMBC_info::particle_names;
}

std::vector<std::string> HGTHDMIIMSSMBC_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> HGTHDMIIMSSMBC_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS> HGTHDMIIMSSMBC_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS> HGTHDMIIMSSMBC_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS> HGTHDMIIMSSMBC_parameter_getter::get_input_parameter_names()
{
   return HGTHDMIIMSSMBC_info::input_parameter_names;
}

std::array<std::string, HGTHDMIIMSSMBC_info::NUMBER_OF_EXTRA_PARAMETERS> HGTHDMIIMSSMBC_parameter_getter::get_extra_parameter_names()
{
   return HGTHDMIIMSSMBC_info::extra_parameter_names;
}

decltype(HGTHDMIIMSSMBC_info::NUMBER_OF_MASSES) HGTHDMIIMSSMBC_parameter_getter::get_number_of_masses()
{
   return HGTHDMIIMSSMBC_info::NUMBER_OF_MASSES;
}

// HGTHDMIIMSSMBC_spectrum_plotter ////////////////////////////////////////

HGTHDMIIMSSMBC_spectrum_plotter::HGTHDMIIMSSMBC_spectrum_plotter(const HGTHDMIIMSSMBC_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void HGTHDMIIMSSMBC_spectrum_plotter::extract_spectrum(const HGTHDMIIMSSMBC_mass_eigenstates& model)
{
   spectrum.clear();
...
void HGTHDMIIMSSMBC_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;
...
{
   if (!filestr.good()) {
      ERROR("HGTHDMIIMSSMBC_spectrum_plotter::write_spectrum: "
...
namespace HGTHDMIIMSSMBC_database {
 ...
 */
void to_database(
   const std::string& file_name, const HGTHDMIIMSSMBC_mass_eigenstates& model,
   ...
   const HGTHDMIIMSSMBC_observables* observables)
{
   ...
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_DRbar_mass_names());
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_pole_mass_names());
   append(names, HGTHDMIIMSSMBC_parameter_getter::get_pole_mixing_names());
   ...
   if (HGTHDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, HGTHDMIIMSSMBC_observables::get_names());
 ...
 */
HGTHDMIIMSSMBC_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, HGTHDMIIMSSMBC_observables* observables)
{
   HGTHDMIIMSSMBC_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = HGTHDMIIMSSMBC_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = HGTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = HGTHDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = HGTHDMIIMSSMBC_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? HGTHDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES : 0);
