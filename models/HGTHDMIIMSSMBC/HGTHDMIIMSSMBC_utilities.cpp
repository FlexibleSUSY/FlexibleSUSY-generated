...
// File generated at Sun 28 Aug 2016 15:02:51
...
HGTHDMIIMSSMBC_spectrum_plotter::HGTHDMIIMSSMBC_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> HGTHDMIIMSSMBC_spectrum_plotter::to_valarray(double v)
{
   ...
   const HGTHDMIIMSSMBC_observables* observables)
{
   ...
   append(names, HGTHDMIIMSSMBC_parameter_getter().get_mass_names());
   append(names, HGTHDMIIMSSMBC_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, HGTHDMIIMSSMBC_observables* observables)
{
   ...
   const std::size_t number_of_masses = HGTHDMIIMSSMBC_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = HGTHDMIIMSSMBC_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = HGTHDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? HGTHDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES : 0u);
