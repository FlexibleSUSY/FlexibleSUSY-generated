...
double HGTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda3_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda3 = Re(0.01*(200*g1d*g1dp*g2u*g2up + 1200*Lambda1*Lambda3 + 1200*
      Lambda2*Lambda3 + 400*Lambda1*Lambda4 + 400*Lambda2*Lambda4 + 600*Lambda3
      ...
      *Lambda3*traceYuAdjYu + 200*AbsSqr(Lambda5) + 400*AbsSqr(Lambda6) + 400*
      ...
      27*Quad(g1) + 225*Quad(g2) - 180*Lambda3*Sqr(g1) + 300*Lambda3*Sqr(g1d) +
      100*Lambda3*Sqr(g1dp) - 900*Lambda3*Sqr(g2) - 90*Sqr(g1)*Sqr(g2) + 300*
      Lambda3*Sqr(g2u) - 500*Sqr(g1d)*Sqr(g2u) + 100*Lambda3*Sqr(g2up) - 100*
      Sqr(g1dp)*Sqr(g2up) + 400*Sqr(Lambda3) + 200*Sqr(Lambda4)));
...
double HGTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda3_2_loop(const Susy_traces& susy_traces) const
{
   ...
   const double beta_Lambda3_1 = Re(0.005*(-800*g1d*g1dp*g2u*g2up*Lambda3 -
      6400*Lambda1*Lambda3*Lambda4 - 6400*Lambda2*Lambda3*Lambda4 - 300*g1dp*
      g2u*g2up*Cube(g1d) - 500*g1d*g2u*g2up*Cube(g1dp) - 300*g1d*g1dp*g2up*Cube
      (g2u) - 500*g1d*g1dp*g2u*Cube(g2up) - 2400*Cube(Lambda3) - 765*Power6(g1)
      + 4875*Power6(g2) + 540*Lambda1*Quad(g1) + 540*Lambda2*Quad(g1) + 1893*
      Lambda3*Quad(g1) + 180*Lambda4*Quad(g1) - 1125*Lambda3*Quad(g1d) - 225*
      Lambda3*Quad(g1dp) + 4500*Lambda1*Quad(g2) + 4500*Lambda2*Quad(g2) + 225*
      Lambda3*Quad(g2) + 1500*Lambda4*Quad(g2) - 1125*Lambda3*Quad(g2u) - 225*
      Lambda3*Quad(g2up) + 2880*Lambda1*Lambda3*Sqr(g1) + 2880*Lambda2*Lambda3*
      Sqr(g1) + 960*Lambda1*Lambda4*Sqr(g1) + 960*Lambda2*Lambda4*Sqr(g1) + 645
      *Quad(g2)*Sqr(g1) - 7200*Lambda1*Lambda3*Sqr(g1d) - 2400*Lambda1*Lambda4*
      Sqr(g1d) - 27*Quad(g1)*Sqr(g1d) - 3825*Quad(g2)*Sqr(g1d) + 2850*Quad(g2u)
      *Sqr(g1d) + 225*Lambda3*Sqr(g1)*Sqr(g1d) - 2400*Lambda1*Lambda3*Sqr(g1dp)
      - 800*Lambda1*Lambda4*Sqr(g1dp) - 9*Quad(g1)*Sqr(g1dp) - 75*Quad(g2)*Sqr(
      g1dp) + 350*Quad(g2up)*Sqr(g1dp) + 75*Lambda3*Sqr(g1)*Sqr(g1dp) - 450*
      Lambda3*Sqr(g1d)*Sqr(g1dp) + 800*g1d*g1dp*g2u*g2up*Sqr(g2) + 14400*
      Lambda1*Lambda3*Sqr(g2) + 14400*Lambda2*Lambda3*Sqr(g2) + 7200*Lambda1*
      Lambda4*Sqr(g2) + 7200*Lambda2*Lambda4*Sqr(g2) - 2400*Lambda3*Lambda4*Sqr
      (g2) + 1005*Quad(g1)*Sqr(g2) - 600*Lambda1*Sqr(g1)*Sqr(g2) - 600*Lambda2*
      Sqr(g1)*Sqr(g2) + 330*Lambda3*Sqr(g1)*Sqr(g2) - 360*Lambda4*Sqr(g1)*Sqr(
      g2) + 4125*Lambda3*Sqr(g1d)*Sqr(g2) - 630*Sqr(g1)*Sqr(g1d)*Sqr(g2) + 375*
      Lambda3*Sqr(g1dp)*Sqr(g2) + 30*Sqr(g1)*Sqr(g1dp)*Sqr(g2) - 7200*Lambda2*
      Lambda3*Sqr(g2u) - 2400*Lambda2*Lambda4*Sqr(g2u) - 27*Quad(g1)*Sqr(g2u) +
      2850*Quad(g1d)*Sqr(g2u) - 3825*Quad(g2)*Sqr(g2u) + 225*Lambda3*Sqr(g1)*
      Sqr(g2u) + 1100*Lambda3*Sqr(g1d)*Sqr(g2u) + 350*Sqr(g1d)*Sqr(g1dp)*Sqr(
      g2u) + 4125*Lambda3*Sqr(g2)*Sqr(g2u) - 630*Sqr(g1)*Sqr(g2)*Sqr(g2u) -
      4000*Sqr(g1d)*Sqr(g2)*Sqr(g2u) - 2400*Lambda2*Lambda3*Sqr(g2up) - 800*
      Lambda2*Lambda4*Sqr(g2up) - 9*Quad(g1)*Sqr(g2up) + 350*Quad(g1dp)*Sqr(
      g2up) - 75*Quad(g2)*Sqr(g2up) + 75*Lambda3*Sqr(g1)*Sqr(g2up) + 100*
   ...
   const double beta_Lambda3_2 = Re(0.01*(-3300*Lambda5*Lambda6*Lambda7 - 7200*
      Lambda1*Lambda3*traceYdAdjYd - 2400*Lambda1*Lambda4*traceYdAdjYd - 1350*
      Lambda3*traceYdAdjYdYdAdjYd + 1200*traceYdAdjYdYdAdjYuYuAdjYd + 1500*
      Lambda3*traceYdAdjYuYuAdjYd + 2400*traceYdAdjYuYuAdjYdYdAdjYd + 3600*
   ...
   const double beta_Lambda3_3 = Re(-32.5*Conj(Lambda5)*Sqr(Conj(Lambda7)));
