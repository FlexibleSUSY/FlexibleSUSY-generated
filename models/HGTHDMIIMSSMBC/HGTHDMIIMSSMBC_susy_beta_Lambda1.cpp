...
double HGTHDMIIMSSMBC_susy_parameters::calc_beta_Lambda1_2_loop(const Susy_traces& susy_traces) const
{
   ...
   const double beta_Lambda1_1 = Re(0.0025*(-8000*Lambda1*Lambda3*Lambda4 -
      3400*Lambda5*Lambda6*Lambda7 - 1200*Lambda1*traceYdAdjYdYdAdjYd + 12000*
   ...
   const double beta_Lambda1_2 = Re(0.5*(-624*Lambda1*AbsSqr(Lambda6) - 126*
      Lambda3*AbsSqr(Lambda6) - 134*Lambda4*AbsSqr(Lambda6) - 72*traceYdAdjYd*
      AbsSqr(Lambda6) - 24*traceYeAdjYe*AbsSqr(Lambda6) - 72*traceYuAdjYu*
      AbsSqr(Lambda6) + 12*Lambda1*AbsSqr(Lambda7) - 36*Lambda3*AbsSqr(Lambda7)
      - 28*Lambda4*AbsSqr(Lambda7) + 6*Lambda2*Lambda7*Conj(Lambda6) - 33*
      Lambda3*Lambda7*Conj(Lambda6) - 25*Lambda4*Lambda7*Conj(Lambda6) + 6*
      Lambda2*Lambda6*Conj(Lambda7) - 33*Lambda3*Lambda6*Conj(Lambda7) - 25*
      Lambda4*Lambda6*Conj(Lambda7) - 17*Conj(Lambda5)*Conj(Lambda6)*Conj(
      Lambda7) - 36*AbsSqr(Lambda6)*Sqr(g2u) - 12*AbsSqr(Lambda6)*Sqr(g2up) -
      71*Conj(Lambda5)*Sqr(Conj(Lambda6)) - 10*Conj(Lambda5)*Sqr(Conj(Lambda7))
      ));
