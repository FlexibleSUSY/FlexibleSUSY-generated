...
/**
 * @file HGTHDMIIMSSMBC_f_to_f_conversion.cpp
 *
...
namespace HGTHDMIIMSSMBC_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const HGTHDMIIMSSMBC_mass_eigenstates& model) {
