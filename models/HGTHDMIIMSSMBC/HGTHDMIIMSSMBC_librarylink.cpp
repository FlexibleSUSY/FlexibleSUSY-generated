...
public:
   ...
   virtual void fill_slha_io(HGTHDMIIMSSMBC_slha_io&, const Spectrum_generator_settings&, const FlexibleDecay_settings&) const = 0;
...
public:
   ...
   virtual void fill_slha_io(HGTHDMIIMSSMBC_slha_io&, const Spectrum_generator_settings&, const FlexibleDecay_settings&) const override;
...
void put_spectrum(const HGTHDMIIMSSMBC_slha& model, MLINK link)
{
...
template <typename Solver_type>
void HGTHDMIIMSSMBC_spectrum_impl<Solver_type>::fill_slha_io(HGTHDMIIMSSMBC_slha_io& slha_io,
