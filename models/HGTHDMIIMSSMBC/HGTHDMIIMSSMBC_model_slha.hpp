...
/**
 * @file HGTHDMIIMSSMBC_model_slha.hpp
...
public:
   ...
   HGTHDMIIMSSMBC_slha& operator=(const HGTHDMIIMSSMBC_slha&) = default;
   HGTHDMIIMSSMBC_slha& operator=(HGTHDMIIMSSMBC_slha&&) = default;
