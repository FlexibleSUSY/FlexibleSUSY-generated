...
// File generated at Tue 10 Oct 2017 22:35:36
...
{
   std::cout <<
      "Usage: scan_E6SSMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
struct E6SSMEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
E6SSMEFTHiggs_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   E6SSMEFTHiggs_input_parameters& input)
{
   ...
   E6SSMEFTHiggs_scan_result result;
...
void scan(int solver_type, E6SSMEFTHiggs_input_parameters& input,
