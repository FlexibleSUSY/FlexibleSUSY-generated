...
E6SSMEFTHiggs_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   E6SSMEFTHiggs_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, E6SSMEFTHiggs_input_parameters& input,
