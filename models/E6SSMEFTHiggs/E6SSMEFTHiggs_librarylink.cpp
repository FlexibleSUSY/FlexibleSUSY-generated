...
// File generated at Fri 10 Apr 2020 19:02:00
...
public:
   ...
   virtual void fill_slha_io(E6SSMEFTHiggs_slha_io&) const = 0;
...
public:
   ...
   virtual void fill_slha_io(E6SSMEFTHiggs_slha_io&) const override;
...
private:
   std::tuple<E6SSMEFTHiggs_slha<E6SSMEFTHiggs<Solver_type>>, standard_model::StandardModel<Two_scale>> models{};        ///< running parameters and pole masses
                ...
                const std::vector<std::string>& heads = {})
{
   for (std::size_t i = 0; i < flags.size(); i++) {
      if (flags[i]) {
         ...
         MLPutSymbol(link, E6SSMEFTHiggs_info::particle_names[i].c_str());
      }
   }
}
...
void put_spectrum(const E6SSMEFTHiggs_slha<Model>& model, MLINK link)
{
...
template <typename Solver_type>
void E6SSMEFTHiggs_spectrum_impl<Solver_type>::fill_slha_io(E6SSMEFTHiggs_slha_io& slha_io) const
{
