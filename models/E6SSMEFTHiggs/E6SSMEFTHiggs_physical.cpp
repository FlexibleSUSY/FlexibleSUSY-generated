...
void E6SSMEFTHiggs_physical::clear()
{
   MVG = 0.;
   MGlu = 0.;
...
Eigen::ArrayXd E6SSMEFTHiggs_physical::get() const
{
...
void E6SSMEFTHiggs_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd E6SSMEFTHiggs_physical::get_masses() const
{
...
void E6SSMEFTHiggs_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void E6SSMEFTHiggs_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const E6SSMEFTHiggs_physical& phys_pars)
{
