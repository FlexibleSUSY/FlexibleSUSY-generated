...
#include "E6SSMEFTHiggs_f_to_f_conversion.hpp"
...
namespace E6SSMEFTHiggs_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const E6SSMEFTHiggs_mass_eigenstates& model) {
