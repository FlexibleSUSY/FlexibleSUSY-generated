...
CLASSNAME::E6SSMEFTHiggs(const E6SSMEFTHiggs_input_parameters& input_)
...
{
   E6SSMEFTHiggs_mass_eigenstates::clear_problems();
}

std::string CLASSNAME::name() const
{
   return E6SSMEFTHiggs_mass_eigenstates::name();
}

void CLASSNAME::run_to(double scale, double eps)
{
   E6SSMEFTHiggs_mass_eigenstates::run_to(scale, eps);
}

void CLASSNAME::print(std::ostream& out) const
{
   E6SSMEFTHiggs_mass_eigenstates::print(out);
}

void CLASSNAME::set_precision(double p)
{
   E6SSMEFTHiggs_mass_eigenstates::set_precision(p);
}
