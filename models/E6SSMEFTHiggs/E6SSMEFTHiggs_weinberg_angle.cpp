...
{
   const auto gY = MODEL->get_g1() * E6SSMEFTHiggs_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * E6SSMEFTHiggs_info::normalization_g2;
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-
         ...
         Sqr(vu))*(RHO2(MAh(2)/MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1
         ))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1))) -
         Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,
         Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1)))) - RHO2(Mhh(0)/MT)*(Sqr(Abs(
         (SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(
         j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(0,1))) - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1)
         )*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1
         )))*ZH(0,1)))) - RHO2(Mhh(1)/MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(
         ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(
         1,1))) - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) +
         SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(1,1)))) - RHO2(Mhh(2)/MT
         )*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0
         ,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(2,1))) - Sqr(Abs((SUM(j1,0,2,
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-0.224
         ...
         SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1))) - Sqr(Abs((SUM(j1
         ,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1))
...
std::complex<double> CLASSNAME::CpChaFvconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(UM(gI1,0))*ZE(gI2,gO1)
      ),0) + IF(gO1 < 3,Conj(UM(gI1,1))*Ye(gO1,gO1)*ZE(gI2,3 + gO1),0);
...
std::complex<double> CLASSNAME::CpChiFeconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5477225575051661*g1*Conj(ZN(gI1,0))*SUM(
      j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) + 0.7071067811865475*g2*Conj(ZN(gI1,1))
      *SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - 0.4472135954999579*gN*Conj(ZN(
      gI1,5))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - Conj(ZN(gI1,2))*SUM(j1,0,
      2,Conj(ZEL(gO1,j1))*Ye(j1,j1)*ZE(gI2,3 + j1));
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,1,SUM(gI4
      ,0,2,0.5*CpbarChabarFvSePR(gI3,gO2,gI2)*CpbarChaFeconjSvPL(gI1,gO1,gI4)*
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * E6SSMEFTHiggs_info::normalization_g3 /
