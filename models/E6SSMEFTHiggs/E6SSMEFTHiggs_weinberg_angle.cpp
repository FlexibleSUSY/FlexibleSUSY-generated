...
// File generated at Tue 10 Oct 2017 22:34:30

#include "E6SSMEFTHiggs_mass_eigenstates.hpp"
#include "E6SSMEFTHiggs_weinberg_angle.hpp"
...
#define CLASSNAME E6SSMEFTHiggs_weinberg_angle
 ...
 */
CLASSNAME::E6SSMEFTHiggs_weinberg_angle(
...
void CLASSNAME::set_model(const E6SSMEFTHiggs_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * E6SSMEFTHiggs_info::normalization_g1;
   const double g2 = MODEL->get_g2() * E6SSMEFTHiggs_info::normalization_g2;
...
double CLASSNAME::calculate_rho_hat_tree() const
{
   ...
   rhohat_tree = (2*Power3(Sqrt(3*Sqr(g1) + 5*Sqr(g2)))*(Sqr(vd) + Sqr(vu)))/(
      -7.0710678118654755*gN*Sin(2*ThetaWp)*Sqr(g2)*(3*Sqr(vd) - 2*Sqr(vu)) + gN*
      Sin(ThetaWp)*(-8.485281374238571*Cos(ThetaWp)*Sqr(g1)*(3*Sqr(vd) - 2*Sqr(vu)
      ) + gN*Sin(ThetaWp)*Sqrt(3*Sqr(g1) + 5*Sqr(g2))*(9*Sqr(vd) + 25*Sqr(vs) + 4*
      Sqr(vu))) + 2*Power3(Sqrt(3*Sqr(g1) + 5*Sqr(g2)))*(Sqr(vd) + Sqr(vu))*Sqr(
      Cos(ThetaWp)));
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         + Sqr(vu))*(RHO2(MAh(2)/MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,
         j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1)))
         - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0
         ,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1)))) - RHO2(Mhh(0)/MT)*(Sqr(
         Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj
         (Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(0,1))) - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2
         ,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(
         2,j1)))*ZH(0,1)))) - RHO2(Mhh(1)/MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*
         Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1))
         )*ZH(1,1))) - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1))
         + SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(1,1)))) - RHO2(Mhh(2)
         /MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(
         j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(2,1))) - Sqr(Abs((SUM(j1,0,2
         ,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL
         (2,j1)*ZUR(2,j1)))*ZH(2,1)))))))/(1 + PIZZTMZ/Sqr(MZ));
   }
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         MAh(2)/MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) -
         SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1))) - Sqr(Abs((SUM(
         j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1
         ))*ZUL(2,j1)*ZUR(2,j1)))*ZA(2,1)))) - RHO2(Mhh(0)/MT)*(Sqr(Abs((SUM(j1,0,2,
         Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(
         2,j1)*ZUR(2,j1)))*ZH(0,1))) - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2
         ,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(0,1))
         )) - RHO2(Mhh(1)/MT)*(Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu
         (j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(1,1))) - Sqr(
         Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj
         (Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(1,1)))) - RHO2(Mhh(2)/MT)*(Sqr(Abs((SUM
         (j1,0,2,Conj(ZUL(2,j1))*Conj(ZUR(2,j1))*Yu(j1,j1)) - SUM(j1,0,2,Conj(Yu(j1,
         j1))*ZUL(2,j1)*ZUR(2,j1)))*ZH(2,1))) - Sqr(Abs((SUM(j1,0,2,Conj(ZUL(2,j1))*
         Conj(ZUR(2,j1))*Yu(j1,j1)) + SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(2,j1)*ZUR(2,j1))
         )*ZH(2,1))))));
   }
...
std::complex<double> CLASSNAME::CpChaFvconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(UM(gI1,0))*ZE(gI2,
      gO1)),0) + IF(gO1 < 3,Conj(UM(gI1,1))*Ye(gO1,gO1)*ZE(gI2,3 + gO1),0);
...
std::complex<double> CLASSNAME::CpChiFvconjSvPL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.5477225575051661*g1*Conj(ZN
      ...
      ZV(gI2,gO1),0) + IF(gO1 < 3,-0.4472135954999579*gN*Conj(ZN(gI1,5))*ZV(gI2,
      gO1),0);
...
std::complex<double> CLASSNAME::CpChiFeconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5477225575051661*g1*Conj(ZN(gI1,0))*
      ...
      ,1))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - 0.4472135954999579*gN*Conj(
      ZN(gI1,5))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - Conj(ZN(gI1,2))*SUM(j1
      ,0,2,Conj(ZEL(gO1,j1))*Ye(j1,j1)*ZE(gI2,3 + j1));
...
std::complex<double> CLASSNAME::delta_vb_wave_Fv(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,-(AbsSqr(
      ...
      gI1,0,5,SUM(gI2,0,2,-(AbsSqr(CpChiFvconjSvPL(gI1,gO1,gI2))*B1(0,Sqr(MChi(gI1
...
std::complex<double> CLASSNAME::delta_vb_vertex(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = (SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,5,
      ...
      + SUM(gI1,0,2,SUM(gI2,0,5,SUM(gI3,0,5,-0.5*CpbarFvChiSvPR(gO2,gI3,gI1)*
      ...
      MChi(gI3)))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,2,CpbarChaFeconjSvPL(gI2,
      ...
      1,SUM(gI2,0,2,SUM(gI3,0,2,-0.5*CpbarFeFehhPL(gI3,gO1,gI2)*CpbarFvFeconjHpmPR
      ...
      (gI1,1,1,SUM(gI2,2,2,SUM(gI3,0,2,-0.5*CpAhHpmconjVWm(gI2,gI1)*CpbarFeFeAhPL(
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,1,SUM(
      ...
      gI1,0,2,SUM(gI2,0,5,SUM(gI3,0,2,SUM(gI4,0,1,CpbarChaFeconjSvPL(gI4,gO1,gI1)*
      ...
      + SUM(gI1,0,2,SUM(gI2,0,5,SUM(gI3,0,5,SUM(gI4,0,1,0.5*CpbarChaFeconjSvPL(gI4
      ...
      2,SUM(gI4,0,2,CpbarFeFehhPL(gI1,gO1,gI4)*CpbarFeFehhPR(gO4,gI3,gI4)*
      ...
      gI1)),Sqr(MHpm(gI2)),Sqr(MFe(gI3)),Sqr(MAh(gI4))))))) + SUM(gI1,0,5,SUM(gI2,
      0,1,SUM(gI3,0,2,SUM(gI4,0,5,0.5*CpbarChabarFvSePR(gI2,gO2,gI1)*
      CpbarFeChaSvPR(gO4,gI2,gI3)*CpChiFeconjSePL(gI4,gO1,gI1)*CpChiFvconjSvPL(gI4
      ,gO3,gI3)*D0(Sqr(MSe(gI1)),Sqr(MCha(gI2)),Sqr(MSv(gI3)),Sqr(MChi(gI4)))*MCha
      (gI2)*MChi(gI4))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,5,SUM(gI4,0,5,
      CpbarChabarFvSePR(gI2,gO2,gI1)*CpbarFeChiSePR(gO4,gI4,gI3)*CpChaFvconjSePL(
      gI2,gO3,gI3)*CpChiFeconjSePL(gI4,gO1,gI1)*D27(Sqr(MSe(gI1)),Sqr(MCha(gI2)),
      Sqr(MSe(gI3)),Sqr(MChi(gI4))))))) + SUM(gI1,0,5,SUM(gI2,0,2,SUM(gI3,0,5,SUM(
      gI4,0,5,CpbarFeChiSePR(gO4,gI3,gI4)*CpbarFvChiSvPR(gO2,gI1,gI2)*
      CpChiFeconjSePL(gI1,gO1,gI4)*CpChiFvconjSvPL(gI3,gO3,gI2)*D27(Sqr(MChi(gI1))
      ,Sqr(MSv(gI2)),Sqr(MChi(gI3)),Sqr(MSe(gI4))))))) + SUM(gI1,0,5,SUM(gI2,0,2,
      SUM(gI3,0,5,SUM(gI4,0,5,0.5*CpbarFeChiSePR(gO4,gI3,gI4)*CpbarFvChiSvPR(gO2,
      gI3,gI2)*CpChiFeconjSePL(gI1,gO1,gI4)*CpChiFvconjSvPL(gI1,gO3,gI2)*D0(Sqr(
      MChi(gI1)),Sqr(MSv(gI2)),Sqr(MChi(gI3)),Sqr(MSe(gI4)))*MChi(gI1)*MChi(gI3)))
      )) + SUM(gI1,1,1,SUM(gI2,0,2,SUM(gI3,1,1,SUM(gI4,0,2,-(CpbarFeFvHpmPL(gI2,
