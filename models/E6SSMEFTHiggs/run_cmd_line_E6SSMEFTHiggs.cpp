...
{
   std::cout <<
      "Usage: run_cmd_line_E6SSMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
int run_solver(int loop_library, const E6SSMEFTHiggs_input_parameters& input)
{
   ...
   E6SSMEFTHiggs_decays decays;decays = E6SSMEFTHiggs_decays(std::get<0>(models), qedqcd, physical_input, flexibledecay_settings);
...
int run(int solver_type, int loop_library, const E6SSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
