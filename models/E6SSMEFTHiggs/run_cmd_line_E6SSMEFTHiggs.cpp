...
int run_solver(const E6SSMEFTHiggs_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(E6SSMEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const E6SSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
