...
struct E6SSMEFTHiggs_physical;
class E6SSMEFTHiggs_slha;
...
public:
   ...
   void fill(E6SSMEFTHiggs_slha&) const;
   ...
   void set_decays(const E6SSMEFTHiggs_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const E6SSMEFTHiggs_slha&, const E6SSMEFTHiggs_scales&, const E6SSMEFTHiggs_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const E6SSMEFTHiggs_slha&);
   ...
   void fill_decays_data(const E6SSMEFTHiggs_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const E6SSMEFTHiggs_scales&, const E6SSMEFTHiggs_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, E6SSMEFTHiggs_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const E6SSMEFTHiggs_slha&);
 ...
 */
template <class... Ts>
void E6SSMEFTHiggs_slha_io::fill(
   ...
   E6SSMEFTHiggs_decays const * const decays)
{
