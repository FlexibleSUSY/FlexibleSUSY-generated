...
public:
   ...
   void set_extra(const E6SSMEFTHiggs_slha&, const E6SSMEFTHiggs_scales&, const E6SSMEFTHiggs_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const E6SSMEFTHiggs_scales&, const E6SSMEFTHiggs_observables&);
