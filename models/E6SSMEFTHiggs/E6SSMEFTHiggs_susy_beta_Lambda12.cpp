 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_susy_parameters::calc_beta_Lambda12_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_susy_parameters::calc_beta_Lambda12_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda12 = (0.005*Lambda12*(-1200*traceKappaAdjKappaKappaAdjKappa - 800
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_susy_parameters::calc_beta_Lambda12_3_loop(const Susy_traces& susy_traces) const
{
   ...
   return threeLoop * beta_Lambda12;
}
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_susy_parameters::calc_beta_Lambda12_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_susy_parameters::calc_beta_Lambda12_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
