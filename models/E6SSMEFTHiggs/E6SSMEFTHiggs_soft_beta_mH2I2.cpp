...
// File generated at Fri 10 Apr 2020 18:30:57
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_soft_parameters::calc_beta_mH2I2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_soft_parameters::calc_beta_mH2I2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_soft_parameters::calc_beta_mH2I2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,2,2> E6SSMEFTHiggs_soft_parameters::calc_beta_mH2I2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
