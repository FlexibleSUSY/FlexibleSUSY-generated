...
/**
 * @file E6SSMEFTHiggs_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 22 Jan 2019 15:35:49
...
class E6SSMEFTHiggs_slha : public Model {
public:
   explicit E6SSMEFTHiggs_slha(const E6SSMEFTHiggs_input_parameters& input_ = E6SSMEFTHiggs_input_parameters());
   explicit E6SSMEFTHiggs_slha(const Model&, bool do_convert_masses_to_slha = true);
   E6SSMEFTHiggs_slha(const E6SSMEFTHiggs_slha&) = default;
   E6SSMEFTHiggs_slha(E6SSMEFTHiggs_slha&&) = default;
   virtual ~E6SSMEFTHiggs_slha() = default;
   E6SSMEFTHiggs_slha& operator=(const E6SSMEFTHiggs_slha&) = default;
   E6SSMEFTHiggs_slha& operator=(E6SSMEFTHiggs_slha&&) = default;
   ...
   const E6SSMEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   E6SSMEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
   ...
   std::complex<double> get_ZDXL_pole_slha(int i, int k) const { return PHYSICAL_SLHA(ZDXL(i,k)); }
   const Eigen::Matrix<std::complex<double>,3,3>& get_ZDXR_pole_slha() const { return PHYSICAL_SLHA(ZDXR); }
   std::complex<double> get_ZDXR_pole_slha(int i, int k) const { return PHYSICAL_SLHA(ZDXR(i,k)); }
   ...
   std::complex<double> get_ZMI_pole_slha(int i, int k) const { return PHYSICAL_SLHA(ZMI(i,k)); }
   const Eigen::Matrix<std::complex<double>,2,2>& get_ZPI_pole_slha() const { return PHYSICAL_SLHA(ZPI); }
   std::complex<double> get_ZPI_pole_slha(int i, int k) const { return PHYSICAL_SLHA(ZPI(i,k)); }
...
private:
   E6SSMEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
E6SSMEFTHiggs_slha<Model>::E6SSMEFTHiggs_slha(const E6SSMEFTHiggs_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
E6SSMEFTHiggs_slha<Model>::E6SSMEFTHiggs_slha(const Model& model_,
...
template <class Model>
void E6SSMEFTHiggs_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void E6SSMEFTHiggs_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void E6SSMEFTHiggs_slha<Model>::convert_to_slha()
{
...
template <class Model>
void E6SSMEFTHiggs_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void E6SSMEFTHiggs_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void E6SSMEFTHiggs_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void E6SSMEFTHiggs_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void E6SSMEFTHiggs_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const E6SSMEFTHiggs_physical& E6SSMEFTHiggs_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
E6SSMEFTHiggs_physical& E6SSMEFTHiggs_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void E6SSMEFTHiggs_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void E6SSMEFTHiggs_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const E6SSMEFTHiggs_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
