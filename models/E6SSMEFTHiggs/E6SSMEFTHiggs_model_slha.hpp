...
class E6SSMEFTHiggs_slha : public E6SSMEFTHiggs_mass_eigenstates {
public:
   explicit E6SSMEFTHiggs_slha(const E6SSMEFTHiggs_input_parameters& input_ = E6SSMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit E6SSMEFTHiggs_slha(const E6SSMEFTHiggs_mass_eigenstates&, bool do_convert_masses_to_slha = true);
