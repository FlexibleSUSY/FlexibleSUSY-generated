...
#include "cxx_qft/E6SSMEFTHiggs_particle_aliases.hpp"
...
double get_MLCP(const E6SSMEFTHiggs_mass_eigenstates_interface& model)
{
...
void run_to_MSUSY(E6SSMEFTHiggs_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("E6SSMEFTHiggs_amm: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("E6SSMEFTHiggs_amm:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("E6SSMEFTHiggs_amm: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("E6SSMEFTHiggs_amm: run_to_MSUSY(): "
...
template <typename Lepton>
double calculate_amm_impl_1l(const context_base& context, const E6SSMEFTHiggs_mass_eigenstates& model, double ml_pole, int idx)
{
   using namespace E6SSMEFTHiggs_cxx_diagrams::fields;

   const auto form_factors = E6SSMEFTHiggs_FFV_form_factors::calculate_form_factors<Lepton,Lepton,VP>(idx, idx, model, true);
...
double calculate_amm_impl_2l_barrzee(const context_base& context, double ml_pole, int idx)
{
   ...
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<ChaI>::type, Ah>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fd>::type, Ah>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<FDX>::type, Ah>::value({idx}, context, ml_pole);
   ...
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<SDX>::type, Ah>::value({idx}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Se>::type, Ah>::value({idx}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<SHIp>::type, Ah>::value({idx}, context, ml_pole);
   ...
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<ChaI>::type, hh>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fd>::type, hh>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<FDX>::type, hh>::value({idx}, context, ml_pole);
   ...
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<SDX>::type, hh>::value({idx}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Se>::type, hh>::value({idx}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<SHIp>::type, hh>::value({idx}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<SHpp>::type, hh>::value({idx}, context, ml_pole);
   ...
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<ChaI>::type, Ah>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fd>::type, Ah>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<FDX>::type, Ah>::value({idx}, context, ml_pole);
   ...
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<ChaI>::type, hh>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fd>::type, hh>::value({idx}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<FDX>::type, hh>::value({idx}, context, ml_pole);
...
template <typename Lepton>
double calculate_amm_impl(const E6SSMEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings, int idx)
{
   VERBOSE_MSG("E6SSMEFTHiggs_amm: calculating a_mu at Q = " << model.get_scale());
...
template <typename Lepton>
double E6SSMEFTHiggs_amm::calculate_amm(const E6SSMEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings, int idx)
{
   E6SSMEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("E6SSMEFTHiggs_amm: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("E6SSMEFTHiggs_amm:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
template double E6SSMEFTHiggs_amm::calculate_amm<E6SSMEFTHiggs_cxx_diagrams::fields::Fe>(const E6SSMEFTHiggs_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&, int);

template <typename Lepton>
double E6SSMEFTHiggs_amm::calculate_amm_uncertainty(const E6SSMEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings, int idx)
{
   E6SSMEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("E6SSMEFTHiggs_amm: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("E6SSMEFTHiggs_amm uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
// spliting templated function into header and cpp
// https://isocpp.org/wiki/faq/templates#separate-template-fn-defn-from-decl
template double E6SSMEFTHiggs_amm::calculate_amm_uncertainty<E6SSMEFTHiggs_cxx_diagrams::fields::Fe>(const E6SSMEFTHiggs_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&, int);
