...
/**
 * @file E6SSMEFTHiggs_b_to_s_gamma.cpp
 *
...
#include "E6SSMEFTHiggs_b_to_s_gamma.hpp"
...
namespace E6SSMEFTHiggs_b_to_s_gamma {
   ...
   const double& matching_scale)
{
   ...
   std::ofstream wc_json("WC_E6SSMEFTHiggs.json");
