...
/**
 * @file E6SSMEFTHiggs_mass_eigenstates_interface.hpp
 *
...
#ifndef E6SSMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
#define E6SSMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class E6SSMEFTHiggs_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class E6SSMEFTHiggs_mass_eigenstates_interface {
public:
   virtual ~E6SSMEFTHiggs_mass_eigenstates_interface() {}

   virtual std::unique_ptr<E6SSMEFTHiggs_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const E6SSMEFTHiggs_input_parameters& get_input_parameters() const = 0;
   virtual E6SSMEFTHiggs_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const E6SSMEFTHiggs_physical& get_physical() const = 0;
   virtual E6SSMEFTHiggs_physical& get_physical() = 0;
   ...
   virtual void set_physical(const E6SSMEFTHiggs_physical&) = 0;
