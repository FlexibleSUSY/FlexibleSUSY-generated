...
// File generated at Sun 26 Aug 2018 14:07:34
...
template <class T>
class E6SSMEFTHiggs_spectrum_generator_interface {
public:
   virtual ~E6SSMEFTHiggs_spectrum_generator_interface() = default;

   std::tuple<E6SSMEFTHiggs<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<E6SSMEFTHiggs_slha<E6SSMEFTHiggs<T>>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(E6SSMEFTHiggs_slha<E6SSMEFTHiggs<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   const E6SSMEFTHiggs<T>& get_model() const
   { return model; }
   E6SSMEFTHiggs<T>& get_model()
   { return model; }
   E6SSMEFTHiggs_slha<E6SSMEFTHiggs<T>> get_model_slha() const
   { return E6SSMEFTHiggs_slha<E6SSMEFTHiggs<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const E6SSMEFTHiggs_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "E6SSMEFTHiggs_spectrum.dat") const;

protected:
   E6SSMEFTHiggs<T> model;
   ...
   void translate_exception_to_problem(E6SSMEFTHiggs<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const E6SSMEFTHiggs_input_parameters&) = 0;
};
 ...
 */
template <class T>
void E6SSMEFTHiggs_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void E6SSMEFTHiggs_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const E6SSMEFTHiggs_input_parameters& input)
{
 ...
 */
template <class T>
void E6SSMEFTHiggs_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   E6SSMEFTHiggs_mass_eigenstates tmp_model(model);
   try {
   ...
   E6SSMEFTHiggs_parameter_getter parameter_getter;
   Coupling_monitor<E6SSMEFTHiggs_mass_eigenstates, E6SSMEFTHiggs_parameter_getter>
 ...
 */
template <class T>
void E6SSMEFTHiggs_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   E6SSMEFTHiggs_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void E6SSMEFTHiggs_spectrum_generator_interface<T>::translate_exception_to_problem(E6SSMEFTHiggs<T>& model)
{
   try {
      throw;
