 ...
 */
Eigen::Matrix<double,3,3> E6SSMEFTHiggs_soft_parameters::calc_beta_TYd_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYd = (0.03333333333333333*(180*traceAdjYdTYd*Yd + 60*traceAdjYeTYe*Yd
      + 28*MassB*Yd*Sqr(g1) + 180*MassWB*Yd*Sqr(g2) + 320*MassG*Yd*Sqr(g3) + 42
      *MassBp*Yd*Sqr(gN) + 90*traceYdAdjYd*TYd + 30*traceYeAdjYe*TYd + 30*
      AbsSqr(Lambdax)*TYd - 14*Sqr(g1)*TYd - 90*Sqr(g2)*TYd - 160*Sqr(g3)*TYd -
      21*Sqr(gN)*TYd + 60*Yd*Conj(Lambdax)*TLambdax) + 4*(Yd*Yd.adjoint()*TYd)
      + 2*(Yd*Yu.adjoint()*TYu) + 5*(TYd*Yd.adjoint()*Yd) + TYd*Yu.adjoint()*Yu
      ).real();
 ...
 */
Eigen::Matrix<double,3,3> E6SSMEFTHiggs_soft_parameters::calc_beta_TYd_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   const Eigen::Matrix<double,3,3> beta_TYd_1 = ((0.002777777777777778*(-12960*
      ...
      *Lambdax*Sqr(Conj(Lambdax))*TLambdax) - 0.4*(45*traceAdjYdTYd + 15*
      traceAdjYeTYe + 4*MassB*Sqr(g1) + 30*MassWB*Sqr(g2) + 6*MassBp*Sqr(gN) +
      15*Conj(Lambdax)*TLambdax)*(Yd*Yd.adjoint()*Yd) + 0.2*(-60*traceYdAdjYd -
      20*traceYeAdjYe - 20*AbsSqr(Lambdax) + 6*Sqr(g1) + 30*Sqr(g2) + 9*Sqr(gN)
      )*(Yd*Yd.adjoint()*TYd) - 0.4*(15*traceAdjYuTYu + 4*MassB*Sqr(g1) +
      MassBp*Sqr(gN))*(Yd*Yu.adjoint()*Yu) + 0.4*(-15*traceYuAdjYu - 5*AbsSqr(
      Lambdax) + 4*Sqr(g1) + Sqr(gN))*(Yd*Yu.adjoint()*TYu) + 0.2*(-75*
      traceYdAdjYd - 25*traceYeAdjYe - 25*AbsSqr(Lambdax) + 6*Sqr(g1) + 60*Sqr(
      g2) + 9*Sqr(gN))*(TYd*Yd.adjoint()*Yd) + 0.2*(-15*traceYuAdjYu - 5*AbsSqr
      (Lambdax) + 4*Sqr(g1) + Sqr(gN))*(TYd*Yu.adjoint()*Yu) - 6*(Yd*Yd.adjoint
      ...
      *Yu.adjoint()*Yu*Yd.adjoint()*TYd) - 4*(Yd*Yu.adjoint()*Yu*Yu.adjoint()*
      ...
      UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_TYd_2 = (-2*Conj(Lambdax)*TLambdax*(Yd*
 ...
 */
Eigen::Matrix<double,3,3> E6SSMEFTHiggs_soft_parameters::calc_beta_TYd_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSMEFTHiggs_soft_parameters::calc_beta_TYd_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> E6SSMEFTHiggs_soft_parameters::calc_beta_TYd_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
