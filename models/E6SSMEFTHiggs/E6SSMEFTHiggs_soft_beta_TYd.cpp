...
// File generated at Sun 26 Aug 2018 13:58:14
...
Eigen::Matrix<double,3,3> E6SSMEFTHiggs_soft_parameters::calc_beta_TYd_2_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_TYd_1 = ((-0.002777777777777778*twoLoop
      *(4*Yd*(3240*traceYdAdjYdTYdAdjYd + 540*traceYdAdjYuTYuAdjYd + 1080*
      ...
      Sqr(g3) + 3*(MassBp + MassWB)*Sqr(gN)) + 2*Sqr(g1)*(90*(MassB + MassWB)*
      Sqr(g2) + 80*(MassB + MassG)*Sqr(g3) - 3*(12*(-traceAdjYdTYd + 3*
      traceAdjYeTYe + MassB*traceYdAdjYd - 3*MassB*traceYeAdjYe) + 7*(MassB +
      MassBp)*Sqr(gN)))) - (-3240*traceYdAdjYdYdAdjYd - 1080*
      traceYdAdjYuYuAdjYd - 1080*traceYeAdjYeYeAdjYe + 1652*Quad(g1) + 5940*
      Quad(g2) + 5120*Quad(g3) + 2457*Quad(gN) + 5760*traceYdAdjYd*Sqr(g3) + 4*
      Sqr(g1)*(-36*traceYdAdjYd + 108*traceYeAdjYe + 90*Sqr(g2) + 80*Sqr(g3) -
      21*Sqr(gN)) - 216*traceYdAdjYd*Sqr(gN) - 72*traceYeAdjYe*Sqr(gN) + 480*
      Sqr(g3)*Sqr(gN) + 180*Sqr(g2)*(16*Sqr(g3) + 3*Sqr(gN)))*TYd + 1080*
      Lambdax*Sqr(Conj(Lambdax))*(Lambdax*TYd + 4*Yd*TLambdax) + 360*Conj(
      Lambdax)*(Lambdax*(3*traceKappaAdjKappa + 2*traceLambda12AdjLambda12 + 3*
      traceYuAdjYu - Sqr(gN))*TYd + 2*Yd*(Lambdax*(3*traceAdjKappaTKappa + 2*
      ...
      ))*TLambdax))) - 0.4*twoLoop*(45*traceAdjYdTYd + 15*traceAdjYeTYe + 4*
      MassB*Sqr(g1) + 30*MassWB*Sqr(g2) + 6*MassBp*Sqr(gN) + 15*Conj(Lambdax)*
      TLambdax)*(Yd*Yd.adjoint()*Yd) + 0.2*twoLoop*(-60*traceYdAdjYd - 20*
      traceYeAdjYe - 20*AbsSqr(Lambdax) + 6*Sqr(g1) + 30*Sqr(g2) + 9*Sqr(gN))*(
      Yd*Yd.adjoint()*TYd) - 0.4*twoLoop*(15*traceAdjYuTYu + 4*MassB*Sqr(g1) +
      MassBp*Sqr(gN))*(Yd*Yu.adjoint()*Yu) + 0.4*twoLoop*(-15*traceYuAdjYu - 5*
      AbsSqr(Lambdax) + 4*Sqr(g1) + Sqr(gN))*(Yd*Yu.adjoint()*TYu) + 0.2*
