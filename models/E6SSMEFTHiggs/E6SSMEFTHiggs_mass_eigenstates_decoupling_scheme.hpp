...
/**
 * @file E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef E6SSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define E6SSMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme
   : private E6SSMEFTHiggs_soft_parameters
   , public E6SSMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme(const E6SSMEFTHiggs_input_parameters& input_ = E6SSMEFTHiggs_input_parameters());
   explicit E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme(const E6SSMEFTHiggs_mass_eigenstates&);
   E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme(const E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme(E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme() = default;
   E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(const E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const E6SSMEFTHiggs_mass_eigenstates&);
...
private:
   ...
   Problems problems{E6SSMEFTHiggs_info::model_name,
...
std::ostream& operator<<(std::ostream&, const E6SSMEFTHiggs_mass_eigenstates_decoupling_scheme&);
