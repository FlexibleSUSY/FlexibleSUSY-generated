 ...
 */
class E6SSMEFTHiggs_mass_eigenstates : public E6SSMEFTHiggs_soft_parameters {
public:
   ...
   void set_physical(const E6SSMEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const E6SSMEFTHiggs_physical& get_physical() const;
   E6SSMEFTHiggs_physical& get_physical();
