...
// File generated at Fri 20 Oct 2017 08:46:13

/**
 * @file E6SSMEFTHiggs_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Fri 20 Oct 2017 08:46:13 with FlexibleSUSY
 * 2.0.1 (git commit: 5296739235bd0ef7020eda218da9c069270c3f45) and SARAH 4.12.0 .
 */

#include "E6SSMEFTHiggs_mass_eigenstates.hpp"
#include "E6SSMEFTHiggs_ewsb_solver_interface.hpp"
...
#define CLASSNAME E6SSMEFTHiggs_mass_eigenstates
...
CLASSNAME::E6SSMEFTHiggs_mass_eigenstates(const E6SSMEFTHiggs_input_parameters& input_)
   : E6SSMEFTHiggs_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new E6SSMEFTHiggs_ewsb_solver<Two_scale>())
#endif
{
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<E6SSMEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb_tree_level_custom()
{
   ...
   mHd2 = Re((0.0125*(28.284271247461902*vs*vu*Conj(TLambdax) - 6*Cube(vd)*Sqr(
      g1) - 10*Cube(vd)*Sqr(g2) - 9*Cube(vd)*Sqr(gN) - 40*vd*AbsSqr(Lambdax)*Sqr(
      vs) + 15*vd*Sqr(gN)*Sqr(vs) - 40*vd*AbsSqr(Lambdax)*Sqr(vu) + 6*vd*Sqr(g1)*
      Sqr(vu) + 10*vd*Sqr(g2)*Sqr(vu) - 6*vd*Sqr(gN)*Sqr(vu) + 28.284271247461902*
      vs*vu*TLambdax))/vd);
   mHu2 = Re((0.025*(14.142135623730951*vd*vs*Conj(TLambdax) - 3*Cube(vu)*Sqr(
      g1) - 5*Cube(vu)*Sqr(g2) - 2*Cube(vu)*Sqr(gN) - 20*vu*AbsSqr(Lambdax)*Sqr(vd
      ) + 3*vu*Sqr(g1)*Sqr(vd) + 5*vu*Sqr(g2)*Sqr(vd) - 3*vu*Sqr(gN)*Sqr(vd) - 20*
      vu*AbsSqr(Lambdax)*Sqr(vs) + 5*vu*Sqr(gN)*Sqr(vs) + 14.142135623730951*vd*vs
      *TLambdax))/vu);
   ms2 = Re((0.0625*(5.656854249492381*vd*vu*Conj(TLambdax) - 5*Cube(vs)*Sqr(gN
      ) - 8*vs*AbsSqr(Lambdax)*Sqr(vd) + 3*vs*Sqr(gN)*Sqr(vd) - 8*vs*AbsSqr(
...
{
   if (!ewsb_solver) {
      throw SetupError("E6SSMEFTHiggs_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("E6SSMEFTHiggs_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("E6SSMEFTHiggs_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving E6SSMEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   E6SSMEFTHiggs_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(E6SSMEFTHiggs_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = E6SSMEFTHiggs_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = E6SSMEFTHiggs_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Sd, eigenvalue_error >
      precision * Abs(MSd(0)));
#else
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Sv, eigenvalue_error >
      precision * Abs(MSv(0)));
#else
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Su, eigenvalue_error >
      precision * Abs(MSu(0)));
#else
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Se, eigenvalue_error >
      precision * Abs(MSe(0)));
#else
...
void CLASSNAME::calculate_MSDX()
{
   ...
   fs_diagonalize_hermitian(mass_matrix_SDX, MSDX, ZDX, eigenvalue_error)
      ;
   problems.flag_bad_mass(E6SSMEFTHiggs_info::SDX, eigenvalue_error >
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Hpm, eigenvalue_error >
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFDX()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::FDX, eigenvalue_error >
...
void CLASSNAME::calculate_MFSI()
{
   ...
   problems.flag_bad_mass(E6SSMEFTHiggs_info::FSI, eigenvalue_error >
...
double CLASSNAME::get_ewsb_eq_hh_1() const
{
   double result = Re(mHd2*vd - 0.35355339059327373*vs*vu*Conj(TLambdax) +
      0.075*Cube(vd)*Sqr(g1) + 0.125*Cube(vd)*Sqr(g2) + 0.1125*Cube(vd)*Sqr(gN) +
      0.5*vd*AbsSqr(Lambdax)*Sqr(vs) - 0.1875*vd*Sqr(gN)*Sqr(vs) + 0.5*vd*AbsSqr(
      Lambdax)*Sqr(vu) - 0.075*vd*Sqr(g1)*Sqr(vu) - 0.125*vd*Sqr(g2)*Sqr(vu) +
      0.075*vd*Sqr(gN)*Sqr(vu) - 0.35355339059327373*vs*vu*TLambdax);
...
double CLASSNAME::get_ewsb_eq_hh_2() const
{
   double result = Re(mHu2*vu - 0.35355339059327373*vd*vs*Conj(TLambdax) +
      0.075*Cube(vu)*Sqr(g1) + 0.125*Cube(vu)*Sqr(g2) + 0.05*Cube(vu)*Sqr(gN) +
      0.5*vu*AbsSqr(Lambdax)*Sqr(vd) - 0.075*vu*Sqr(g1)*Sqr(vd) - 0.125*vu*Sqr(g2)
      *Sqr(vd) + 0.075*vu*Sqr(gN)*Sqr(vd) + 0.5*vu*AbsSqr(Lambdax)*Sqr(vs) - 0.125
      *vu*Sqr(gN)*Sqr(vs) - 0.35355339059327373*vd*vs*TLambdax);
...
double CLASSNAME::get_ewsb_eq_hh_3() const
{
   double result = Re(ms2*vs - 0.35355339059327373*vd*vu*Conj(TLambdax) +
      0.3125*Cube(vs)*Sqr(gN) + 0.5*vs*AbsSqr(Lambdax)*Sqr(vd) - 0.1875*vs*Sqr(gN)
      *Sqr(vd) + 0.5*vs*AbsSqr(Lambdax)*Sqr(vu) - 0.125*vs*Sqr(gN)*Sqr(vu) -
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.31622776601683794*g2*gN*
      Cos(ThetaW())*Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*Sin(ThetaWp()),0) + IF(
      gO1 < 3,-0.08164965809277262*g1*gN*Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*
      Sin(ThetaW())*Sin(ThetaWp()),0) + IF(gO1 < 3,0.2581988897471611*g1*g2*Cos(
      ...
      *g1*gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp())*SUM(j1,0,2,KroneckerDelta
      (gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) + 0.13333333333333333*Sqr(g1)*Sqr(
      Cos(ThetaWp()))*Sqr(Sin(ThetaW()))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      KroneckerDelta(gO2,3 + j1)) + 0.2*Sqr(gN)*Sqr(Sin(ThetaWp()))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpHpmUSdconjHpmconjUSd(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      ...
      Sqr(g2)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,0.075*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,-(AbsSqr(Yu(gO1,gO1))*
      KroneckerDelta(gO1,gO2)*ZP(gI1,1)*ZP(gI2,1)),0) + IF(gO1 < 3,-0.05*
      ...
      KroneckerDelta(gO1,gO2)*Sqr(gN)*ZP(gI1,1)*ZP(gI2,1),0) + 0.1*Sqr(g1)*SUM(j1,
      0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1,0)*ZP(gI2,
      0) + 0.15*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3
      + j1))*ZP(gI1,0)*ZP(gI2,0) - SUM(j2,0,2,AbsSqr(Yd(j2,j2))*KroneckerDelta(
      gO1,3 + j2)*KroneckerDelta(gO2,3 + j2))*ZP(gI1,0)*ZP(gI2,0) - 0.1*Sqr(g1)*
      SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1,1)*
      ZP(gI2,1) + 0.1*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta
      (gO2,3 + j1))*ZP(gI1,1)*ZP(gI2,1);
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(Yu(gO2,gO2))*UP(gI2,1)*
      ZUR(gI1,gO2),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-(Conj(Yd(gO2,gO2))*ZDR(gI1,
      gO2)*ZN(gI2,2)),0) - 0.14907119849998596*SUM(j1,0,2,KroneckerDelta(gO2,3 +
      j1)*ZDR(gI1,j1))*(2.449489742783178*g1*ZN(gI2,0) + 3*gN*ZN(gI2,5));
...
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,
      -0.016666666666666666*Conj(ZD(gI2,gO2))*Sqr(g1)*ZD(gI1,gO1),0),0) + IF(gO1 <
      3,IF(gO2 < 3,-0.25*Conj(ZD(gI2,gO2))*Sqr(g2)*ZD(gI1,gO1),0),0) + IF(gO1 < 3
      ,IF(gO2 < 3,-1.3333333333333333*Conj(ZD(gI2,gO2))*Sqr(g3)*ZD(gI1,gO1),0),0)
      + IF(gO1 < 3,IF(gO2 < 3,-0.025*Conj(ZD(gI2,gO2))*Sqr(gN)*ZD(gI1,gO1),0),0) +
      IF(gO1 < 3,IF(gO2 < 3,-(Conj(Yd(gO2,gO2))*Conj(ZD(gI2,3 + gO2))*Yd(gO1,gO1)
      *ZD(gI1,3 + gO1)),0),0) + IF(gO1 < 3,-0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0) + IF(gO1 < 3,-0.375*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0) +
      IF(gO1 < 3,-0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,
      j1))*ZD(gI1,j1)),0) + IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(
      j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)),0) + IF(gO1 < 3,-0.075*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 +
      ...
      g2)*SUM(j2,0,2,Conj(ZD(gI2,j2))*ZD(gI1,j2)),0) + IF(gO1 < 3,-0.0375*
      ...
      *SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2)),0) + IF(gO1 < 3,-3*
      KroneckerDelta(3 + gO1,gO2)*SUM(j2,0,2,Conj(Yd(j2,j2))*Conj(ZD(gI2,3 + j2))*
      ZD(gI1,j2))*Yd(gO1,gO1),0) + IF(gO1 < 3,-0.016666666666666666*Sqr(g1)*SUM(j1
      ,0,2,Conj(ZD(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZD(gI1,gO1),0) + IF(
      gO1 < 3,0.6666666666666666*Sqr(g3)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*
      KroneckerDelta(gO2,3 + j1))*ZD(gI1,gO1),0) + IF(gO1 < 3,-0.025*Sqr(gN)*SUM(
      j1,0,2,Conj(ZD(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZD(gI1,gO1),0) + IF(
      gO1 < 3,-0.016666666666666666*Sqr(g1)*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*
      KroneckerDelta(gO2,3 + j2))*ZD(gI1,gO1),0) + IF(gO1 < 3,0.6666666666666666*
      Sqr(g3)*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2))*ZD(gI1,
      gO1),0) + IF(gO1 < 3,-0.025*Sqr(gN)*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*
      ...
      gO2 < 3,-0.025*Conj(ZD(gI2,gO2))*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 +
      j1)*ZD(gI1,3 + j1)),0) + IF(gO2 < 3,-3*Conj(Yd(gO2,gO2))*KroneckerDelta(gO1,
      3 + gO2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*Yd(j1,j1)*ZD(gI1,3 + j1)),0) + IF(gO2 <
      3,-0.016666666666666666*Conj(ZD(gI2,gO2))*Sqr(g1)*SUM(j2,0,2,KroneckerDelta
      (gO1,3 + j2)*ZD(gI1,3 + j2)),0) + IF(gO2 < 3,0.6666666666666666*Conj(ZD(gI2,
      gO2))*Sqr(g3)*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZD(gI1,3 + j2)),0) + IF(
      gO2 < 3,-0.025*Conj(ZD(gI2,gO2))*Sqr(gN)*SUM(j2,0,2,KroneckerDelta(gO1,3 +
      j2)*ZD(gI1,3 + j2)),0) - 0.03333333333333333*Sqr(g1)*SUM(j1,0,2,
      ...
      KroneckerDelta(gO1,3 + j1)*ZD(gI1,3 + j1))*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*
      KroneckerDelta(gO2,3 + j2)) - 0.05*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 +
      j1)*ZD(gI1,3 + j1))*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*KroneckerDelta(gO2,3 +
      j2)) - 0.05*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1))*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 0.075*Sqr(gN)*SUM(
      j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*
      KroneckerDelta(gO2,3 + j2)) - 0.1*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD
      (gI1,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 +
      j2)) - 0.15*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1))*SUM(j2,0
      ,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 0.05*Sqr(g1)*SUM
      (j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,
      Conj(ZD(gI2,j2))*ZD(gI1,j2)) - 0.075*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3
      + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZD(gI2,j2))*ZD(gI1,j2)) -
      SUM(j1,0,2,Conj(ZD(gI2,j1))*KroneckerDelta(gO2,3 + j1)*Yd(j1,j1))*SUM(j2,0,
      2,Conj(Yd(j2,j2))*KroneckerDelta(gO1,3 + j2)*ZD(gI1,j2)) - 0.1*Sqr(g1)*SUM(
      j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,
      Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2)) - 0.15*Sqr(gN)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZD(
      gI2,3 + j2))*ZD(gI1,3 + j2)) - 0.03333333333333333*Sqr(g1)*SUM(j1,0,2,Conj(
      ZD(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3
      + j2)*ZD(gI1,3 + j2)) - 0.6666666666666666*Sqr(g3)*SUM(j1,0,2,Conj(ZD(gI2,3
      + j1))*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZD(
      gI1,3 + j2)) - 0.05*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*KroneckerDelta(
      gO2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZD(gI1,3 + j2));
...
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)),0) + IF(gO1 < 3,0.075*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)),0)
      + 0.025*(40*IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,
      Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)),0) + 40*IF(gO1 < 3,0.1125*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 +
      j1)),0) + 40*IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,
      Conj(ZDX(gI2,j2))*ZDX(gI1,j2)),0) + 40*IF(gO1 < 3,0.075*KroneckerDelta(gO1,
      gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(gI2,j2))*ZDX(gI1,j2)),0) + 40*IF(gO1 < 3,
      -0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*ZDX(
      gI1,3 + j2)),0) + 40*IF(gO1 < 3,0.1125*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(
      j2,0,2,Conj(ZDX(gI2,3 + j2))*ZDX(gI1,3 + j2)),0) + 4*Sqr(g1)*SUM(j1,0,2,Conj
      (ZDX(gI2,j1))*ZDX(gI1,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*
      KroneckerDelta(gO2,3 + j2)) + 6*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1
      ,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 4*
      Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1))*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) + 9*Sqr(gN)*SUM(j1,0,
      2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 +
      j2)*KroneckerDelta(gO2,3 + j2)) + 4*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3
      + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI2,j2))*ZDX(gI1,j2))
      + 6*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)
      )*SUM(j2,0,2,Conj(ZDX(gI2,j2))*ZDX(gI1,j2)) - 4*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(
      gI2,3 + j2))*ZDX(gI1,3 + j2)) + 9*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 +
      j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*ZDX(gI1,3 +
      j2)));
...
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-0.5*Conj(ZU(gI2,
      gO2))*Sqr(g2)*ZU(gI1,gO1),0),0) + IF(gO1 < 3,IF(gO2 < 3,-(Conj(Yu(gO2,gO2))*
      Conj(ZU(gI2,3 + gO2))*Yu(gO1,gO1)*ZU(gI1,3 + gO1)),0),0) + IF(gO1 < 3,-0.025
      *KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)),0)
      ...
      ))*ZU(gI1,j1)),0) + IF(gO1 < 3,-0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(
      ...
      j2))*ZU(gI1,3 + j2)),0) + IF(gO1 < 3,-0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)
      *SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*ZU(gI1,3 + j2)),0) - 0.05*Sqr(g1)*SUM(j1,0,
      2,Conj(ZU(gI2,j1))*ZU(gI1,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*
...
std::complex<double> CLASSNAME::CpUSdSeconjUSdconjSe(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.125*
      ...
      ))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,
      0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1)),0) + IF(gO1 < 3,-0.0125*
      ...
      0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1
      ))*SUM(j2,0,2,Conj(ZE(gI1,3 + j2))*ZE(gI2,3 + j2)) - 0.025*Sqr(gN)*SUM(j1,0,
...
{
   const std::complex<double> result = IF(gO2 < 3,0.7071067811865475*vd*AbsSqr(
      Yd(gO2,gO2))*Conj(ZU(gI1,gO2))*ZP(gI2,0),0) + IF(gO2 < 3,0.7071067811865475*
      vs*Conj(Yu(gO2,gO2))*Conj(ZU(gI1,3 + gO2))*Lambdax*ZP(gI2,0),0) + IF(gO2 < 3
...
{
   const std::complex<double> result = IF(gO2 < 3,-(vd*AbsSqr(Yd(gO2,gO2))*Conj
      (ZD(gI1,gO2))*ZH(gI2,0)),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZD(gI1,3 +
      ...
      < 3,0.5*vs*Conj(Yd(gO2,gO2))*Conj(ZD(gI1,3 + gO2))*Lambdax*ZH(gI2,1),0) +
      IF(gO2 < 3,-0.05*vu*Conj(ZD(gI1,gO2))*Sqr(g1)*ZH(gI2,1),0) + IF(gO2 < 3,
      -0.25*vu*Conj(ZD(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3,0.05*vu*Conj(ZD
      (gI1,gO2))*Sqr(gN)*ZH(gI2,1),0) + IF(gO2 < 3,0.5*vu*Conj(Yd(gO2,gO2))*Conj(
      ZD(gI1,3 + gO2))*Lambdax*ZH(gI2,2),0) + IF(gO2 < 3,-0.125*vs*Conj(ZD(gI1,gO2
      ))*Sqr(gN)*ZH(gI2,2),0) + 0.1*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*
...
std::complex<double> CLASSNAME::CpSdconjUSdVZ(int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.5*g2*Conj(ZD(gI2,gO2))*Cos
      (ThetaW())*Cos(ThetaWp()),0) + IF(gO2 < 3,-0.12909944487358055*g1*Conj(ZD(
      gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gO2 < 3,0.15811388300841897*
      gN*Conj(ZD(gI2,gO2))*Sin(ThetaWp()),0) + 0.2581988897471611*g1*Cos(ThetaWp()
...
{
   const std::complex<double> result = IF(gO2 < 3,0.15811388300841897*gN*Conj(
      ZD(gI2,gO2))*Cos(ThetaWp()),0) + IF(gO2 < 3,0.5*g2*Conj(ZD(gI2,gO2))*Cos(
      ThetaW())*Sin(ThetaWp()),0) + IF(gO2 < 3,0.12909944487358055*g1*Conj(ZD(gI2,
      gO2))*Sin(ThetaW())*Sin(ThetaWp()),0) - 0.31622776601683794*gN*Cos(ThetaWp()
      )*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1)) -
      0.2581988897471611*g1*Sin(ThetaW())*Sin(ThetaWp())*SUM(j1,0,2,Conj(ZD(gI2,3
      + j1))*KroneckerDelta(gO2,3 + j1));
...
{
   const std::complex<double> result = 0.05*(20*IF(gO1 < 3,-(AbsSqr(Ye(gO1,gO1)
      )*KroneckerDelta(gO1,gO2)*ZP(gI1,0)*ZP(gI2,0)),0) + KroneckerDelta(gO1,gO2)*
      ((-3*Sqr(g1) + 5*Sqr(g2) + 3*Sqr(gN))*ZP(gI1,0)*ZP(gI2,0) + (3*Sqr(g1) - 5*
      Sqr(g2) + 2*Sqr(gN))*ZP(gI1,1)*ZP(gI2,1)));
...
{
   const double result = -0.25*KroneckerDelta(gI1,gI2)*KroneckerDelta(gO1,gO2)*
      Sqr(gN);
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(Ye(gO2,gO2))*UM(gI1,1)*
      ZER(gI2,gO2),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,0.7071067811865475*vd*AbsSqr(
      Ye(gO2,gO2))*Conj(ZE(gI2,gO2))*ZP(gI1,0),0) + IF(gO2 < 3,Conj(ZE(gI2,3 + gO2
      ))*Conj(TYe(gO2,gO2))*ZP(gI1,0),0) + IF(gO2 < 3,-0.35355339059327373*vd*Conj
      (ZE(gI2,gO2))*Sqr(g2)*ZP(gI1,0),0) + IF(gO2 < 3,0.7071067811865475*vs*Conj(
      Ye(gO2,gO2))*Conj(ZE(gI2,3 + gO2))*Lambdax*ZP(gI1,1),0) + IF(gO2 < 3,
...
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*((-3*Sqr(g1
      ) - 5*Sqr(g2) + 3*Sqr(gN))*ZA(gI1,0)*ZA(gI2,0) + (3*Sqr(g1) + 5*Sqr(g2) + 2*
      Sqr(gN))*ZA(gI1,1)*ZA(gI2,1) - 5*Sqr(gN)*ZA(gI1,2)*ZA(gI2,2));
...
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*((-3*Sqr(g1
      ) - 5*Sqr(g2) + 3*Sqr(gN))*ZH(gI1,0)*ZH(gI2,0) + (3*Sqr(g1) + 5*Sqr(g2) + 2*
      Sqr(gN))*ZH(gI1,1)*ZH(gI2,1) - 5*Sqr(gN)*ZH(gI1,2)*ZH(gI2,2));
...
std::complex<double> CLASSNAME::CpSvUSvconjSvconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gI1 < 3,IF(gI2 < 3,-0.15*Conj(ZV(gI1,
      ...
      gO2))*Sqr(g2)*ZV(gI2,gO1),0),0) + IF(gI1 < 3,IF(gI2 < 3,-0.1*Conj(ZV(gI1,gO2
      ))*Sqr(gN)*ZV(gI2,gO1),0),0) - 0.05*KroneckerDelta(gI1,gI2)*KroneckerDelta(
      gO1,gO2)*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN));
...
std::complex<double> CLASSNAME::CphhSvconjUSv(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gI1 < 3,-0.15*vd*Conj(ZV(gI1,gO2))*
      ...
      0),0) + IF(gI1 < 3,0.15*vd*Conj(ZV(gI1,gO2))*Sqr(gN)*ZH(gI2,0),0) + IF(gI1 <
      3,0.15*vu*Conj(ZV(gI1,gO2))*Sqr(g1)*ZH(gI2,1),0) + IF(gI1 < 3,0.25*vu*Conj(
      ZV(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(gI1 < 3,0.1*vu*Conj(ZV(gI1,gO2))*Sqr(
      gN)*ZH(gI2,1),0) + IF(gI1 < 3,-0.25*vs*Conj(ZV(gI1,gO2))*Sqr(gN)*ZH(gI2,2),0
      );
...
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*((-3*Sqr(g1
      ) - 5*Sqr(g2) + 3*Sqr(gN))*SUM(j1,0,1,Conj(UHI0(gI1,j1))*UHI0(gI2,j1)) + (3*
      Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*SUM(j1,0,1,Conj(UHI0(gI1,2 + j1))*UHI0(gI2,
      2 + j1)));
...
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*((-3*Sqr(g1
      ) + 5*Sqr(g2) + 3*Sqr(gN))*SUM(j1,0,1,Conj(UHIp(gI1,j1))*UHIp(gI2,j1)) + (3*
      Sqr(g1) - 5*Sqr(g2) + 2*Sqr(gN))*SUM(j1,0,1,Conj(UHIp(gI1,2 + j1))*UHIp(gI2,
      2 + j1)));
...
std::complex<double> CLASSNAME::CpSdUSvconjSdconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*((Sqr(g1) +
      5*Sqr(g2) - Sqr(gN))*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)) + 2*(Sqr(g1) -
...
std::complex<double> CLASSNAME::CpSDXUSvconjSDXconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*(-2*(Sqr(g1
      ) - Sqr(gN))*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2,j1)) + (2*Sqr(g1) + 3*Sqr(
      gN))*SUM(j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1)));
...
{
   const std::complex<double> result = 0.05*(20*IF(gO1 < 3,IF(gO2 < 3,-0.5*Conj
      (ZE(gI1,gO2))*Sqr(g2)*ZE(gI2,gO1),0),0) + 20*IF(gO1 < 3,IF(gO2 < 3,-(Conj(Ye
      (gO2,gO2))*Conj(ZE(gI1,3 + gO2))*Ye(gO1,gO1)*ZE(gI2,3 + gO1)),0),0) -
      KroneckerDelta(gO1,gO2)*((3*Sqr(g1) - 5*Sqr(g2) + 2*Sqr(gN))*SUM(j1,0,2,Conj
...
{
   const std::complex<double> result = 0.05*KroneckerDelta(gO1,gO2)*((Sqr(g1) -
      5*Sqr(g2) - Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)) - (4*Sqr(g1) +
...
{
   const std::complex<double> result = IF(gI2 < 3,0.31622776601683794*gN*Conj(
      ZV(gI2,gO2))*Cos(ThetaWp()),0) + IF(gI2 < 3,-0.5*g2*Conj(ZV(gI2,gO2))*Cos(
...
std::complex<double> CLASSNAME::CpUSuconjUSuVZpVZp(int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.31622776601683794*g2*gN*
      Cos(ThetaW())*Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*Sin(ThetaWp()),0) + IF(
      gO1 < 3,0.08164965809277262*g1*gN*Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*Sin
      (ThetaW())*Sin(ThetaWp()),0) + IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*Sqr(
      gN)*Sqr(Cos(ThetaWp())),0) + IF(gO1 < 3,-0.2581988897471611*g1*g2*Cos(ThetaW
      ())*KroneckerDelta(gO1,gO2)*Sin(ThetaW())*Sqr(Sin(ThetaWp())),0) + IF(gO1 <
      3,0.5*KroneckerDelta(gO1,gO2)*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp()))
      ,0) + IF(gO1 < 3,0.03333333333333333*KroneckerDelta(gO1,gO2)*Sqr(g1)*Sqr(Sin
      (ThetaW()))*Sqr(Sin(ThetaWp())),0) - 0.32659863237109044*g1*gN*Cos(ThetaWp()
      )*Sin(ThetaW())*Sin(ThetaWp())*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
...
std::complex<double> CLASSNAME::CpHpmUSuconjHpmconjUSu(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,-(AbsSqr(Yd(gO1,gO1))*
      ...
      ) - SUM(j2,0,2,AbsSqr(Yu(j2,j2))*KroneckerDelta(gO1,3 + j2)*KroneckerDelta(
      gO2,3 + j2))*ZP(gI1,1)*ZP(gI2,1);
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(Yd(gO2,gO2))*UM(gI1,1)*
      ZDR(gI2,gO2),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,0.7071067811865475*vd*AbsSqr(
      Yd(gO2,gO2))*Conj(ZD(gI2,gO2))*ZP(gI1,0),0) + IF(gO2 < 3,Conj(ZD(gI2,3 + gO2
      ))*Conj(TYd(gO2,gO2))*ZP(gI1,0),0) + IF(gO2 < 3,-0.35355339059327373*vd*Conj
      (ZD(gI2,gO2))*Sqr(g2)*ZP(gI1,0),0) + IF(gO2 < 3,0.7071067811865475*vu*AbsSqr
      (Yu(gO2,gO2))*Conj(ZD(gI2,gO2))*ZP(gI1,1),0) + IF(gO2 < 3,0.7071067811865475
      *vs*Conj(Yd(gO2,gO2))*Conj(ZD(gI2,3 + gO2))*Lambdax*ZP(gI1,1),0) + IF(gO2 <
      3,-0.35355339059327373*vu*Conj(ZD(gI2,gO2))*Sqr(g2)*ZP(gI1,1),0) +
...
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,-0.25*KroneckerDelta(gO1,gO2)*
      Sqr(g2)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,0.075*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,-0.5*Conj(Lambdax)*
      KroneckerDelta(3 + gO1,gO2)*Yu(gO1,gO1)*ZA(gI1,2)*ZA(gI2,0),0) + IF(gO1 < 3,
      -(AbsSqr(Yu(gO1,gO1))*KroneckerDelta(gO1,gO2)*ZA(gI1,1)*ZA(gI2,1)),0) + IF(
      gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*ZA(gI1,1)*ZA(gI2,1),0) + IF(
      gO1 < 3,0.25*KroneckerDelta(gO1,gO2)*Sqr(g2)*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1
      < 3,0.05*KroneckerDelta(gO1,gO2)*Sqr(gN)*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 <
      3,-0.5*Conj(Lambdax)*KroneckerDelta(3 + gO1,gO2)*Yu(gO1,gO1)*ZA(gI1,0)*ZA(
      gI2,2),0) + IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*ZA(gI1,2)*ZA(
      gI2,2),0) + IF(gO2 < 3,-0.5*Conj(Yu(gO2,gO2))*KroneckerDelta(gO1,3 + gO2)*
      Lambdax*ZA(gI1,2)*ZA(gI2,0),0) + IF(gO2 < 3,-0.5*Conj(Yu(gO2,gO2))*
      KroneckerDelta(gO1,3 + gO2)*Lambdax*ZA(gI1,0)*ZA(gI2,2),0) - 0.2*Sqr(g1)*SUM
      (j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,0)*ZA(
      gI2,0) + 0.075*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(
      gO2,3 + j1))*ZA(gI1,0)*ZA(gI2,0) + 0.2*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1
      ,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,1)*ZA(gI2,1) + 0.05*Sqr(gN)*SUM(
      j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,1)*ZA(
      gI2,1) - SUM(j2,0,2,AbsSqr(Yu(j2,j2))*KroneckerDelta(gO1,3 + j2)*
      KroneckerDelta(gO2,3 + j2))*ZA(gI1,1)*ZA(gI2,1) - 0.125*Sqr(gN)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,2)*ZA(gI2,2);
...
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,-0.25*KroneckerDelta(gO1,gO2)*
      Sqr(g2)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,0.075*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,0.5*Conj(Lambdax)*KroneckerDelta
      (3 + gO1,gO2)*Yu(gO1,gO1)*ZH(gI1,2)*ZH(gI2,0),0) + IF(gO1 < 3,-(AbsSqr(Yu(
      gO1,gO1))*KroneckerDelta(gO1,gO2)*ZH(gI1,1)*ZH(gI2,1)),0) + IF(gO1 < 3,-0.05
      *KroneckerDelta(gO1,gO2)*Sqr(g1)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 3,0.25*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 3,0.05*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 3,0.5*Conj
...
std::complex<double> CLASSNAME::CpSeUSuconjSeconjUSu(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,0.125*
      ...
      IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZE(gI1,3 +
      j2))*ZE(gI2,3 + j2)),0) + IF(gO1 < 3,-0.0125*KroneckerDelta(gO1,gO2)*Sqr(gN
      )*SUM(j2,0,2,Conj(ZE(gI1,3 + j2))*ZE(gI2,3 + j2)),0) - 0.1*Sqr(g1)*SUM(j1,0,
...
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-0.5*Conj(ZD(gI2,
      gO2))*Sqr(g2)*ZD(gI1,gO1),0),0) + IF(gO1 < 3,IF(gO2 < 3,-(Conj(Yd(gO2,gO2))*
      Conj(ZD(gI2,3 + gO2))*Yd(gO1,gO1)*ZD(gI1,3 + gO1)),0),0) + IF(gO1 < 3,-0.025
      *KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0)
      ...
      ))*ZD(gI1,j1)),0) + IF(gO1 < 3,-0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(
      ...
      3,-0.075*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(
      gI1,3 + j1)),0) + IF(gO1 < 3,-0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0
...
std::complex<double> CLASSNAME::CpUSuconjUSuconjSDXSDX(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)),0) + IF(gO1 < 3,0.075*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)),0)
      + IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,
      3 + j1))*ZDX(gI1,3 + j1)),0) + IF(gO1 < 3,0.1125*KroneckerDelta(gO1,gO2)*Sqr
...
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,
      -0.016666666666666666*Conj(ZU(gI2,gO2))*Sqr(g1)*ZU(gI1,gO1),0),0) + IF(gO1 <
      3,IF(gO2 < 3,-0.25*Conj(ZU(gI2,gO2))*Sqr(g2)*ZU(gI1,gO1),0),0) + IF(gO1 < 3
      ,IF(gO2 < 3,-1.3333333333333333*Conj(ZU(gI2,gO2))*Sqr(g3)*ZU(gI1,gO1),0),0)
      + IF(gO1 < 3,IF(gO2 < 3,-0.025*Conj(ZU(gI2,gO2))*Sqr(gN)*ZU(gI1,gO1),0),0) +
      IF(gO1 < 3,IF(gO2 < 3,-(Conj(Yu(gO2,gO2))*Conj(ZU(gI2,3 + gO2))*Yu(gO1,gO1)
      *ZU(gI1,3 + gO1)),0),0) + IF(gO1 < 3,-0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)),0) + IF(gO1 < 3,-0.375*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)),0) +
      IF(gO1 < 3,-0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI2,
      j1))*ZU(gI1,j1)),0) + IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,
      0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)),0) + IF(gO1 < 3,-0.0375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 +
      j1)),0) + IF(gO1 < 3,-0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(
      ZU(gI2,j2))*ZU(gI1,j2)),0) + IF(gO1 < 3,-0.375*KroneckerDelta(gO1,gO2)*Sqr(
      g2)*SUM(j2,0,2,Conj(ZU(gI2,j2))*ZU(gI1,j2)),0) + IF(gO1 < 3,-0.0375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZU(gI2,j2))*ZU(gI1,j2)),0) +
      IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZU(gI2,3 +
      j2))*ZU(gI1,3 + j2)),0) + IF(gO1 < 3,-0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)
      *SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*ZU(gI1,3 + j2)),0) + IF(gO1 < 3,-3*
      KroneckerDelta(3 + gO1,gO2)*SUM(j2,0,2,Conj(Yu(j2,j2))*Conj(ZU(gI2,3 + j2))*
      ZU(gI1,j2))*Yu(gO1,gO1),0) + IF(gO1 < 3,0.03333333333333333*Sqr(g1)*SUM(j1,0
      ,2,Conj(ZU(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZU(gI1,gO1),0) + IF(gO1
      < 3,0.6666666666666666*Sqr(g3)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*
      KroneckerDelta(gO2,3 + j1))*ZU(gI1,gO1),0) + IF(gO1 < 3,-0.0125*Sqr(gN)*SUM(
      j1,0,2,Conj(ZU(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZU(gI1,gO1),0) + IF(
      gO1 < 3,0.03333333333333333*Sqr(g1)*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*
      KroneckerDelta(gO2,3 + j2))*ZU(gI1,gO1),0) + IF(gO1 < 3,0.6666666666666666*
      Sqr(g3)*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2))*ZU(gI1,
      gO1),0) + IF(gO1 < 3,-0.0125*Sqr(gN)*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*
      ...
      ,KroneckerDelta(gO1,3 + j1)*ZU(gI1,3 + j1)),0) + IF(gO2 < 3,-0.0125*Conj(ZU(
      gI2,gO2))*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZU(gI1,3 + j1)),0) +
      IF(gO2 < 3,-3*Conj(Yu(gO2,gO2))*KroneckerDelta(gO1,3 + gO2)*SUM(j1,0,2,Conj
      (ZU(gI2,j1))*Yu(j1,j1)*ZU(gI1,3 + j1)),0) + IF(gO2 < 3,0.03333333333333333*
      Conj(ZU(gI2,gO2))*Sqr(g1)*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZU(gI1,3 +
      j2)),0) + IF(gO2 < 3,0.6666666666666666*Conj(ZU(gI2,gO2))*Sqr(g3)*SUM(j2,0,2
      ,KroneckerDelta(gO1,3 + j2)*ZU(gI1,3 + j2)),0) + IF(gO2 < 3,-0.0125*Conj(ZU(
      gI2,gO2))*Sqr(gN)*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZU(gI1,3 + j2)),0) -
      0.13333333333333333*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZU(gI1,3
      + j1))*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) -
      0.6666666666666666*Sqr(g3)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZU(gI1,3 +
      j1))*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) - 0.0125*
      Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZU(gI1,3 + j1))*SUM(j2,0,2,
      Conj(ZU(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) + 0.1*Sqr(g1)*SUM(j1,0,2,
...
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vs*Conj(Yu(gO2,gO2))*Conj(ZU(gI1,3 + gO2))*Lambdax*ZA(gI2,0),0) + IF(gO2 < 3
...
{
   const std::complex<double> result = IF(gO2 < 3,0.5*vs*Conj(Yu(gO2,gO2))*Conj
      (ZU(gI1,3 + gO2))*Lambdax*ZH(gI2,0),0) + IF(gO2 < 3,0.05*vd*Conj(ZU(gI1,gO2)
      )*Sqr(g1)*ZH(gI2,0),0) + IF(gO2 < 3,-0.25*vd*Conj(ZU(gI1,gO2))*Sqr(g2)*ZH(
      gI2,0),0) + IF(gO2 < 3,0.075*vd*Conj(ZU(gI1,gO2))*Sqr(gN)*ZH(gI2,0),0) + IF(
      gO2 < 3,-(vu*AbsSqr(Yu(gO2,gO2))*Conj(ZU(gI1,gO2))*ZH(gI2,1)),0) + IF(gO2 <
      3,-0.7071067811865475*Conj(ZU(gI1,3 + gO2))*Conj(TYu(gO2,gO2))*ZH(gI2,1),0)
      + IF(gO2 < 3,-0.05*vu*Conj(ZU(gI1,gO2))*Sqr(g1)*ZH(gI2,1),0) + IF(gO2 < 3,
      0.25*vu*Conj(ZU(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3,0.05*vu*Conj(ZU(
      gI1,gO2))*Sqr(gN)*ZH(gI2,1),0) + IF(gO2 < 3,0.5*vd*Conj(Yu(gO2,gO2))*Conj(ZU
      (gI1,3 + gO2))*Lambdax*ZH(gI2,2),0) + IF(gO2 < 3,-0.125*vs*Conj(ZU(gI1,gO2))
      *Sqr(gN)*ZH(gI2,2),0) - 0.2*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*
...
{
   const std::complex<double> result = IF(gO2 < 3,0.15811388300841897*gN*Conj(
      ZU(gI2,gO2))*Cos(ThetaWp()),0) + IF(gO2 < 3,-0.5*g2*Conj(ZU(gI2,gO2))*Cos(
...
std::complex<double> CLASSNAME::CpHpmUSeconjHpmconjUSe(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.15*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,-0.25*KroneckerDelta(gO1,gO2)*
      ...
      SUM(j2,0,2,AbsSqr(Ye(j2,j2))*KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,
      3 + j2))*ZP(gI1,0)*ZP(gI2,0) - 0.3*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 +
      j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1,1)*ZP(gI2,1) + 0.05*Sqr(gN)*SUM(j1,0
      ,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1,1)*ZP(gI2,1
      );
...
{
   const std::complex<double> result = IF(gO2 < 3,0.7071067811865475*vd*AbsSqr(
      Ye(gO2,gO2))*Conj(ZV(gI1,gO2))*ZP(gI2,0),0) + IF(gO2 < 3,
      -0.35355339059327373*vd*Conj(ZV(gI1,gO2))*Sqr(g2)*ZP(gI2,0),0) + IF(gO2 < 3,
      -0.35355339059327373*vu*Conj(ZV(gI1,gO2))*Sqr(g2)*ZP(gI2,1),0) + SUM(j1,0,2,
      Conj(ZV(gI1,j1))*KroneckerDelta(gO2,3 + j1)*TYe(j1,j1))*ZP(gI2,0) +
      0.7071067811865475*vs*Conj(Lambdax)*SUM(j1,0,2,Conj(ZV(gI1,j1))*
      KroneckerDelta(gO2,3 + j1)*Ye(j1,j1))*ZP(gI2,1);
...
{
   const std::complex<double> result = IF(gO2 < 3,-(Conj(Ye(gO2,gO2))*ZER(gI1,
      gO2)*ZN(gI2,2)),0) - 0.22360679774997896*SUM(j1,0,2,KroneckerDelta(gO2,3 +
      j1)*ZER(gI1,j1))*(4.898979485566356*g1*ZN(gI2,0) + gN*ZN(gI2,5));
...
std::complex<double> CLASSNAME::CpChiFeconjUSePL(int gI2, int gI1, int gO1) const
{
   const std::complex<double> result = IF(gO1 < 3,0.5477225575051661*g1*Conj(
      ...
      (gI1,gO1))*Conj(ZN(gI2,1)),0) + IF(gO1 < 3,-0.4472135954999579*gN*Conj(ZEL(
      gI1,gO1))*Conj(ZN(gI2,5)),0) - Conj(ZN(gI2,2))*SUM(j1,0,2,Conj(ZEL(gI1,j1))*
...
std::complex<double> CLASSNAME::CpSdUSeconjSdconjUSe(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)),0) + IF(gO1 < 3,-0.125*
      ...
      (gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)),0) + IF(
      gO1 < 3,0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZD(gI1,j2))*ZD
...
std::complex<double> CLASSNAME::CpSDXUSeconjSDXconjUSe(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2,j1)),0) + IF(gO1 < 3,0.05*
      ...
      + 0.0125*(80*IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,
      Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1)),0) + 80*IF(gO1 < 3,0.075*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 +
      j1)),0) + 80*IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,
      Conj(ZDX(gI1,j2))*ZDX(gI2,j2)),0) + 80*IF(gO1 < 3,0.05*KroneckerDelta(gO1,
      gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2)),0) + 80*IF(gO1 < 3,
      0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZDX(gI1,3 + j2))*ZDX(
      gI2,3 + j2)),0) + 80*IF(gO1 < 3,0.075*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2
      ,0,2,Conj(ZDX(gI1,3 + j2))*ZDX(gI2,3 + j2)),0) + 8*Sqr(g1)*SUM(j1,0,2,Conj(
      ZDX(gI1,j1))*ZDX(gI2,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*
      KroneckerDelta(gO2,3 + j2)) + 2*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2
      ,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 8*
      Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1))*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) + 3*Sqr(gN)*SUM(j1,0,
      2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 +
      j2)*KroneckerDelta(gO2,3 + j2)) + 8*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3
      + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2))
      + 2*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)
      )*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2)) - 8*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(
      gI1,3 + j2))*ZDX(gI2,3 + j2)) + 3*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 +
      j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI1,3 + j2))*ZDX(gI2,3 +
      j2)));
...
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-0.15*Conj(ZE(gI1,
      gO2))*Sqr(g1)*ZE(gI2,gO1),0),0) + IF(gO1 < 3,IF(gO2 < 3,-0.25*Conj(ZE(gI1,
      gO2))*Sqr(g2)*ZE(gI2,gO1),0),0) + IF(gO1 < 3,IF(gO2 < 3,-0.1*Conj(ZE(gI1,gO2
      ))*Sqr(gN)*ZE(gI2,gO1),0),0) + IF(gO1 < 3,IF(gO2 < 3,-(Conj(Ye(gO2,gO2))*
      Conj(ZE(gI1,3 + gO2))*Ye(gO1,gO1)*ZE(gI2,3 + gO1)),0),0) + IF(gO1 < 3,-0.075
      *KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0)
      + IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI1,
      j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(
      ...
      ,-0.025*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(
      gI2,3 + j1)),0) + IF(gO1 < 3,-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0
      ,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)),0) + IF(gO1 < 3,-0.125*KroneckerDelta(gO1,
      gO2)*Sqr(g2)*SUM(j2,0,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)),0) + IF(gO1 < 3,-0.05*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)),0) +
      ...
      0.3*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZE(gI2,3 + j1))*SUM(j2,0,
      2,Conj(ZE(gI1,3 + j2))*KroneckerDelta(gO2,3 + j2)) - 0.0125*Sqr(gN)*SUM(j1,0
...
std::complex<double> CLASSNAME::CpUSeSuconjUSeconjSu(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)),0) + IF(gO1 < 3,0.125*
      ...
      ,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)),0) + IF(gO1 < 3,-0.025*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 +
      j1)),0) + IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(
      ZU(gI1,j2))*ZU(gI2,j2)),0) + IF(gO1 < 3,0.125*KroneckerDelta(gO1,gO2)*Sqr(g2
      )*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)),0) + IF(gO1 < 3,-0.025*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)),0) +
      IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZU(gI1,3 +
      j2))*ZU(gI2,3 + j2)),0) + IF(gO1 < 3,-0.025*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      SUM(j2,0,2,Conj(ZU(gI1,3 + j2))*ZU(gI2,3 + j2)),0) - 0.05*Sqr(g1)*SUM(j1,0,2
      ,Conj(ZU(gI1,j1))*ZU(gI2,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*
      KroneckerDelta(gO2,3 + j2)) - 0.0125*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(
      gI2,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) +
      ...
      j2)) - 0.0125*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(
      gO2,3 + j1))*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)) + 0.2*Sqr(g1)*SUM(j1,0,
...
{
   const std::complex<double> result = IF(gO2 < 3,-(vd*AbsSqr(Ye(gO2,gO2))*Conj
      (ZE(gI1,gO2))*ZH(gI2,0)),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZE(gI1,3 +
      gO2))*Conj(TYe(gO2,gO2))*ZH(gI2,0),0) + IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2
      ))*Sqr(g1)*ZH(gI2,0),0) + IF(gO2 < 3,0.25*vd*Conj(ZE(gI1,gO2))*Sqr(g2)*ZH(
      gI2,0),0) + IF(gO2 < 3,0.15*vd*Conj(ZE(gI1,gO2))*Sqr(gN)*ZH(gI2,0),0) + IF(
      gO2 < 3,0.5*vs*Conj(Ye(gO2,gO2))*Conj(ZE(gI1,3 + gO2))*Lambdax*ZH(gI2,1),0)
      + IF(gO2 < 3,0.15*vu*Conj(ZE(gI1,gO2))*Sqr(g1)*ZH(gI2,1),0) + IF(gO2 < 3,
      -0.25*vu*Conj(ZE(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) + IF(gO2 < 3,0.1*vu*Conj(ZE(
      gI1,gO2))*Sqr(gN)*ZH(gI2,1),0) + IF(gO2 < 3,0.5*vu*Conj(Ye(gO2,gO2))*Conj(ZE
      (gI1,3 + gO2))*Lambdax*ZH(gI2,2),0) + IF(gO2 < 3,-0.25*vs*Conj(ZE(gI1,gO2))*
      Sqr(gN)*ZH(gI2,2),0) + 0.3*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*
...
{
   const std::complex<double> result = IF(gO2 < 3,0.31622776601683794*gN*Conj(
      ZE(gI2,gO2))*Cos(ThetaWp()),0) + IF(gO2 < 3,0.5*g2*Conj(ZE(gI2,gO2))*Cos(
      ThetaW())*Sin(ThetaWp()),0) + IF(gO2 < 3,-0.3872983346207417*g1*Conj(ZE(gI2,
      gO2))*Sin(ThetaW())*Sin(ThetaWp()),0) - 0.15811388300841897*gN*Cos(ThetaWp()
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.32659863237109044*g1*gN*
      Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*Sin(ThetaW())*Sin(ThetaWp()),0) + IF(
      gO1 < 3,0.13333333333333333*KroneckerDelta(gO1,gO2)*Sqr(g1)*Sqr(Cos(ThetaWp(
      )))*Sqr(Sin(ThetaW())),0) + IF(gO1 < 3,0.2*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      Sqr(Sin(ThetaWp())),0) + 0.4898979485566356*g1*gN*Cos(ThetaWp())*Sin(ThetaW(
      ))*Sin(ThetaWp())*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3
      + j1)) + 0.13333333333333333*Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW()))
      *SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) + 0.45*
      Sqr(gN)*Sqr(Sin(ThetaWp()))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      KroneckerDelta(gO2,3 + j1));
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,-0.15*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(
      g1)*ZP(gI1,1)*ZP(gI2,1),0) + IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*Sqr(gN)
      *ZP(gI1,1)*ZP(gI2,1),0) + IF(gO1 < 3,-(Conj(Lambdax)*KroneckerDelta(3 + gO1,
      gO2)*ZP(gI1,1)*ZP(gI2,0)*Kappa(gO1,gO1)),0) + IF(gO2 < 3,-(Conj(Kappa(gO2,
      gO2))*KroneckerDelta(gO1,3 + gO2)*Lambdax*ZP(gI1,0)*ZP(gI2,1)),0) + 0.1*Sqr(
      g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZP(gI1
      ,0)*ZP(gI2,0) - 0.225*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      ...
      0.15*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 +
      j1))*ZP(gI1,1)*ZP(gI2,1);
...
std::complex<double> CLASSNAME::CpUSDXSHp0conjUSDXconjSHp0(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.1*Conj(UHp0(gI1,0))*
      ...
      gI1,0))*KroneckerDelta(gO1,gO2)*Sqr(gN)*UHp0(gI2,0),0) + 0.05*(20*IF(gO1 < 3
      ,0.1*Conj(UHp0(gI1,1))*KroneckerDelta(gO1,gO2)*Sqr(g1)*UHp0(gI2,1),0) + 20*
      IF(gO1 < 3,-0.1*Conj(UHp0(gI1,1))*KroneckerDelta(gO1,gO2)*Sqr(gN)*UHp0(gI2,1
      ),0) + (2*Sqr(g1) + 3*Sqr(gN))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      KroneckerDelta(gO2,3 + j1))*(Conj(UHp0(gI1,0))*UHp0(gI2,0) - Conj(UHp0(gI1,1
      ))*UHp0(gI2,1)));
...
std::complex<double> CLASSNAME::CpUSDXSHppconjUSDXconjSHpp(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.1*Conj(UHpp(gI1,0))*
      ...
      gI1,0))*KroneckerDelta(gO1,gO2)*Sqr(gN)*UHpp(gI2,0),0) + 0.05*(20*IF(gO1 < 3
      ,0.1*Conj(UHpp(gI1,1))*KroneckerDelta(gO1,gO2)*Sqr(g1)*UHpp(gI2,1),0) + 20*
      IF(gO1 < 3,-0.1*Conj(UHpp(gI1,1))*KroneckerDelta(gO1,gO2)*Sqr(gN)*UHpp(gI2,1
      ),0) + (2*Sqr(g1) + 3*Sqr(gN))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      KroneckerDelta(gO2,3 + j1))*(Conj(UHpp(gI1,0))*UHpp(gI2,0) - Conj(UHpp(gI1,1
      ))*UHpp(gI2,1)));
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,-0.15*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(
      g1)*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*Sqr(gN)
      *ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 < 3,-(AbsSqr(Kappa(gO1,gO1))*KroneckerDelta
      (gO1,gO2)*ZA(gI1,2)*ZA(gI2,2)),0) + IF(gO1 < 3,0.25*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZA(gI1,2)*ZA(gI2,2),0) + IF(gO1 < 3,-0.5*Conj(Lambdax)*
      KroneckerDelta(3 + gO1,gO2)*ZA(gI1,1)*ZA(gI2,0)*Kappa(gO1,gO1),0) + IF(gO1 <
      3,-0.5*Conj(Lambdax)*KroneckerDelta(3 + gO1,gO2)*ZA(gI1,0)*ZA(gI2,1)*Kappa(
      gO1,gO1),0) + IF(gO2 < 3,-0.5*Conj(Kappa(gO2,gO2))*KroneckerDelta(gO1,3 +
      gO2)*Lambdax*ZA(gI1,1)*ZA(gI2,0),0) + IF(gO2 < 3,-0.5*Conj(Kappa(gO2,gO2))*
      KroneckerDelta(gO1,3 + gO2)*Lambdax*ZA(gI1,0)*ZA(gI2,1),0) + 0.1*Sqr(g1)*SUM
      (j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,0)*ZA(
      gI2,0) - 0.225*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(
      gO2,3 + j1))*ZA(gI1,0)*ZA(gI2,0) - 0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1
      ,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,1)*ZA(gI2,1) - 0.15*Sqr(gN)*SUM(
      j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZA(gI1,1)*ZA(
      gI2,1) + 0.375*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(
      gO2,3 + j1))*ZA(gI1,2)*ZA(gI2,2) - SUM(j2,0,2,AbsSqr(Kappa(j2,j2))*
      KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2))*ZA(gI1,2)*ZA(gI2,2);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,-0.15*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(
      g1)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*Sqr(gN)
      *ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 3,-(AbsSqr(Kappa(gO1,gO1))*KroneckerDelta
      (gO1,gO2)*ZH(gI1,2)*ZH(gI2,2)),0) + IF(gO1 < 3,0.25*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZH(gI1,2)*ZH(gI2,2),0) + IF(gO1 < 3,0.5*Conj(Lambdax)*KroneckerDelta
      (3 + gO1,gO2)*ZH(gI1,1)*ZH(gI2,0)*Kappa(gO1,gO1),0) + IF(gO1 < 3,0.5*Conj(
      Lambdax)*KroneckerDelta(3 + gO1,gO2)*ZH(gI1,0)*ZH(gI2,1)*Kappa(gO1,gO1),0) +
      IF(gO2 < 3,0.5*Conj(Kappa(gO2,gO2))*KroneckerDelta(gO1,3 + gO2)*Lambdax*ZH(
      gI1,1)*ZH(gI2,0),0) + IF(gO2 < 3,0.5*Conj(Kappa(gO2,gO2))*KroneckerDelta(gO1
      ,3 + gO2)*Lambdax*ZH(gI1,0)*ZH(gI2,1),0) + 0.1*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*ZH(gI1,0)*ZH(gI2,0) -
      0.225*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 +
      j1))*ZH(gI1,0)*ZH(gI2,0) - 0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)
      *KroneckerDelta(gO2,3 + j1))*ZH(gI1,1)*ZH(gI2,1) - 0.15*Sqr(gN)*SUM(j1,0,2,
      ...
      j1))*ZH(gI1,2)*ZH(gI2,2) - SUM(j2,0,2,AbsSqr(Kappa(j2,j2))*KroneckerDelta(
      gO1,3 + j2)*KroneckerDelta(gO2,3 + j2))*ZH(gI1,2)*ZH(gI2,2);
...
std::complex<double> CLASSNAME::CpUSDXSvconjUSDXconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.1*KroneckerDelta(gI1,gI2)*
      ...
      + 3*Sqr(gN))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 +
      j1));
...
{
   const std::complex<double> result = IF(gO2 < 3,-(Conj(Kappa(gO2,gO2))*ZDXR(
      gI1,gO2)*ZN(gI2,4)),0) + 0.07453559924999298*SUM(j1,0,2,KroneckerDelta(gO2,3
...
{
   const std::complex<double> result = IF(gO1 < 3,0.3651483716701107*g1*Conj(
      ZDXL(gI1,gO1))*Conj(ZN(gI2,0)),0) + IF(gO1 < 3,0.4472135954999579*gN*Conj(
      ZDXL(gI1,gO1))*Conj(ZN(gI2,5)),0) - Conj(ZN(gI2,4))*SUM(j1,0,2,Conj(ZDXL(gI1
      ,j1))*KroneckerDelta(gO1,3 + j1)*Kappa(j1,j1));
...
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0) + IF(gO1 < 3,0.075*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0) +
      IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 +
      j1))*ZD(gI1,3 + j1)),0) + IF(gO1 < 3,0.15*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)),0) + IF(gO1 < 3,0.05*
      ...
      ,Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2)),0) + IF(gO1 < 3,0.15*KroneckerDelta(
      gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2)),0) - 0.05*
      Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1))*SUM(j2,0,2,KroneckerDelta(
      gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) + 0.1125*Sqr(gN)*SUM(j1,0,2,Conj(ZD(
      gI2,j1))*ZD(gI1,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(
      gO2,3 + j2)) - 0.1*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1))*
      SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) + 0.225*
      Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1))*SUM(j2,0,2,
      ...
      ZD(gI2,j2))*ZD(gI1,j2)) + 0.1125*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 +
      j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZD(gI2,j2))*ZD(gI1,j2)) -
      0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)
      )*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2)) + 0.225*Sqr(gN)*SUM(j1,0,2
      ,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZD(
      gI2,3 + j2))*ZD(gI1,3 + j2));
...
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,
      -0.06666666666666667*Conj(ZDX(gI2,gO2))*Sqr(g1)*ZDX(gI1,gO1),0),0) + IF(gO1
      < 3,IF(gO2 < 3,-1.3333333333333333*Conj(ZDX(gI2,gO2))*Sqr(g3)*ZDX(gI1,gO1),0
      ),0) + IF(gO1 < 3,IF(gO2 < 3,-0.1*Conj(ZDX(gI2,gO2))*Sqr(gN)*ZDX(gI1,gO1),0)
      ,0) + IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZDX(gI2,3 + gO2))*Conj(Kappa(gO2,gO2))*
      ZDX(gI1,3 + gO1)*Kappa(gO1,gO1)),0),0) + IF(gO1 < 3,-0.1*KroneckerDelta(gO1,
      gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)),0) + IF(gO1 < 3,-0.15
      *KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)),0
      ) + IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,3
      + j1))*ZDX(gI1,3 + j1)),0) + IF(gO1 < 3,-0.225*KroneckerDelta(gO1,gO2)*Sqr(
      gN)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)),0) + IF(gO1 < 3,-0.1*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZDX(gI2,j2))*ZDX(gI1,j2)),0)
      + IF(gO1 < 3,-0.15*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(gI2,
      j2))*ZDX(gI1,j2)),0) + IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2
      ,0,2,Conj(ZDX(gI2,3 + j2))*ZDX(gI1,3 + j2)),0) + IF(gO1 < 3,-0.225*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*ZDX(gI1,3 +
      j2)),0) + IF(gO1 < 3,0.03333333333333333*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,3
      + j1))*KroneckerDelta(gO2,3 + j1))*ZDX(gI1,gO1),0) + IF(gO1 < 3,
      0.6666666666666666*Sqr(g3)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*KroneckerDelta(
      gO2,3 + j1))*ZDX(gI1,gO1),0) + IF(gO1 < 3,-0.075*Sqr(gN)*SUM(j1,0,2,Conj(ZDX
      (gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZDX(gI1,gO1),0) + IF(gO1 < 3,
      0.03333333333333333*Sqr(g1)*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*KroneckerDelta(
      gO2,3 + j2))*ZDX(gI1,gO1),0) + IF(gO1 < 3,0.6666666666666666*Sqr(g3)*SUM(j2,
      0,2,Conj(ZDX(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2))*ZDX(gI1,gO1),0) + IF(
      gO1 < 3,-0.075*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*KroneckerDelta(gO2,3
      + j2))*ZDX(gI1,gO1),0) + IF(gO1 < 3,-3*KroneckerDelta(3 + gO1,gO2)*SUM(j2,0
      ,2,Conj(ZDX(gI2,3 + j2))*Conj(Kappa(j2,j2))*ZDX(gI1,j2))*Kappa(gO1,gO1),0) +
      IF(gO2 < 3,0.03333333333333333*Conj(ZDX(gI2,gO2))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*ZDX(gI1,3 + j1)),0) + IF(gO2 < 3,
      0.6666666666666666*Conj(ZDX(gI2,gO2))*Sqr(g3)*SUM(j1,0,2,KroneckerDelta(gO1,
      3 + j1)*ZDX(gI1,3 + j1)),0) + IF(gO2 < 3,-0.075*Conj(ZDX(gI2,gO2))*Sqr(gN)*
      SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZDX(gI1,3 + j1)),0) + IF(gO2 < 3,-3*
      Conj(Kappa(gO2,gO2))*KroneckerDelta(gO1,3 + gO2)*SUM(j1,0,2,Conj(ZDX(gI2,j1)
      )*ZDX(gI1,3 + j1)*Kappa(j1,j1)),0) + IF(gO2 < 3,0.03333333333333333*Conj(ZDX
      (gI2,gO2))*Sqr(g1)*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZDX(gI1,3 + j2)),0)
      + IF(gO2 < 3,0.6666666666666666*Conj(ZDX(gI2,gO2))*Sqr(g3)*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*ZDX(gI1,3 + j2)),0) + IF(gO2 < 3,-0.075*Conj(ZDX(
      gI2,gO2))*Sqr(gN)*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZDX(gI1,3 + j2)),0)
      - 0.03333333333333333*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZDX(gI1,
      3 + j1))*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) -
      0.6666666666666666*Sqr(g3)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZDX(gI1,3 +
      j1))*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) - 0.1125*
      Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZDX(gI1,3 + j1))*SUM(j2,0,2,
      Conj(ZDX(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) + 0.1*Sqr(g1)*SUM(j1,0,2,
      Conj(ZDX(gI2,j1))*ZDX(gI1,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*
      KroneckerDelta(gO2,3 + j2)) - 0.225*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX
      (gI1,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2))
      - 0.1*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1))*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 0.3375*Sqr(gN)*SUM(
      j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,
      3 + j2)*KroneckerDelta(gO2,3 + j2)) + 0.1*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(
      gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI2,j2))*ZDX(gI1
      ,j2)) - 0.225*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(
      gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI2,j2))*ZDX(gI1,j2)) - SUM(j1,0,2,Conj(ZDX
      (gI2,j1))*KroneckerDelta(gO2,3 + j1)*Kappa(j1,j1))*SUM(j2,0,2,Conj(Kappa(j2,
      j2))*KroneckerDelta(gO1,3 + j2)*ZDX(gI1,j2)) - 0.1*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(
      gI2,3 + j2))*ZDX(gI1,3 + j2)) - 0.3375*Sqr(gN)*SUM(j1,0,2,KroneckerDelta(gO1
      ,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZDX(gI2,3 + j2))*ZDX(
      gI1,3 + j2)) - 0.03333333333333333*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*
      KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZDX(gI1,3
      + j2)) - 0.6666666666666666*Sqr(g3)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*
      KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZDX(gI1,3
      + j2)) - 0.1125*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*KroneckerDelta(gO2,
      3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZDX(gI1,3 + j2));
...
{
   const std::complex<double> result = IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*
      Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)),0) + IF(gO1 < 3,0.075*
      ...
      )*ZU(gI1,j2)),0) + IF(gO1 < 3,-0.2*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,
      2,Conj(ZU(gI2,3 + j2))*ZU(gI1,3 + j2)),0) + IF(gO1 < 3,0.075*KroneckerDelta(
...
std::complex<double> CLASSNAME::CpUSDXSeconjUSDXconjSe(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,0.05*
      ...
      0.0125*(80*IF(gO1 < 3,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(
      ZE(gI1,3 + j1))*ZE(gI2,3 + j1)),0) + 80*IF(gO1 < 3,0.025*KroneckerDelta(gO1,
...
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vu*Conj(ZDX(gI1,3 + gO2))*Conj(Kappa(gO2,gO2))*Lambdax*ZA(gI2,0),0) + IF(gO2
      < 3,std::complex<double>(0,0.5)*vd*Conj(ZDX(gI1,3 + gO2))*Conj(Kappa(gO2,
      gO2))*Lambdax*ZA(gI2,1),0) + IF(gO2 < 3,std::complex<double>(0.,
...
{
   const std::complex<double> result = 1.4142135623730951*g3*Conj(PhaseGlu)*SUM
      (j1,0,2,KroneckerDelta(gO2,3 + j1)*ZDXR(gI2,j1));
...
{
   const std::complex<double> result = IF(gI2 < 6,-0.2581988897471611*g1*Conj(
      ZDX(gI2,gO2))*Cos(ThetaW()),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,0.2581988897471611*g1*Conj(
      ZDX(gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gO2 < 3,
      -0.31622776601683794*gN*Conj(ZDX(gI2,gO2))*Sin(ThetaWp()),0) +
      0.03726779962499649*(6.928203230275509*g1*Cos(ThetaWp())*Sin(ThetaW()) +
      12.727922061357857*gN*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*
      KroneckerDelta(gO2,3 + j1));
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.31622776601683794*gN*Conj(
      ZDX(gI2,gO2))*Cos(ThetaWp()),0) + IF(gO2 < 3,-0.2581988897471611*g1*Conj(ZDX
...
{
   const std::complex<double> result = 0.025*(-25*vs*KroneckerDelta(2,gO1)*Sqr(
      gN)*Sqr(Sin(ThetaWp())) - vd*KroneckerDelta(0,gO1)*(-14.696938456699067*g1*
      gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + 10*Sqr(g2)*Sqr(Cos(ThetaW()
      ))*Sqr(Cos(ThetaWp())) + Cos(ThetaW())*(-18.973665961010276*g2*gN*Cos(
      ThetaWp())*Sin(ThetaWp()) + 15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Cos(
      ThetaWp()))) + 6*Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 9*Sqr(gN)*
      Sqr(Sin(ThetaWp()))) - 2*vu*KroneckerDelta(1,gO1)*(3.1622776601683795*g2*gN*
      Cos(ThetaW())*Sin(2*ThetaWp()) + g1*Sin(ThetaW())*(7.745966692414834*g2*Cos(
...
{
   const std::complex<double> result = 0.025*(-25*vs*Cos(ThetaWp())*
      KroneckerDelta(2,gO1)*Sin(ThetaWp())*Sqr(gN) + vd*KroneckerDelta(0,gO1)*(
      9.486832980505138*g2*gN*Cos(ThetaW())*Cos(2*ThetaWp()) - 9*Cos(ThetaWp())*
      Sin(ThetaWp())*Sqr(gN) + 5*Sin(2*ThetaWp())*Sqr(g2)*Sqr(Cos(ThetaW())) +
      7.348469228349534*g1*gN*Sin(ThetaW())*Sqr(Cos(ThetaWp())) + g1*(
      3.872983346207417*g2*Sin(2*ThetaW())*Sin(2*ThetaWp()) + 3*g1*Sin(2*ThetaWp()
      )*Sqr(Sin(ThetaW())) - 7.348469228349534*gN*Sin(ThetaW())*Sqr(Sin(ThetaWp())
      ))) + vu*KroneckerDelta(1,gO1)*(-6.324555320336759*g2*gN*Cos(ThetaW())*Cos(2
...
{
   const std::complex<double> result = 0.025*(-25*vs*KroneckerDelta(2,gO1)*Sqr(
      gN)*Sqr(Cos(ThetaWp())) - vd*KroneckerDelta(0,gO1)*(9*Sqr(gN)*Sqr(Cos(
      ThetaWp())) + 10*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())) + 3*g1*Sin(
      ThetaW())*(2.449489742783178*gN*Sin(2*ThetaWp()) + 2*g1*Sin(ThetaW())*Sqr(
      Sin(ThetaWp()))) + Cos(ThetaW())*(9.486832980505138*g2*gN*Sin(2*ThetaWp()) +
...
{
   const std::complex<double> result = 0.05*(25*vs*Cos(ThetaWp())*
      KroneckerDelta(2,gO2)*Sin(ThetaWp())*Sqr(gN) - vd*KroneckerDelta(0,gO2)*(
      9.486832980505138*g2*gN*Cos(ThetaW())*Cos(2*ThetaWp()) - 9*Cos(ThetaWp())*
      Sin(ThetaWp())*Sqr(gN) + 5*Sin(2*ThetaWp())*Sqr(g2)*Sqr(Cos(ThetaW())) +
      7.348469228349534*g1*gN*Sin(ThetaW())*Sqr(Cos(ThetaWp())) + g1*(
      3.872983346207417*g2*Sin(2*ThetaW())*Sin(2*ThetaWp()) + 3*g1*Sin(2*ThetaWp()
      )*Sqr(Sin(ThetaW())) - 7.348469228349534*gN*Sin(ThetaW())*Sqr(Sin(ThetaWp())
      ))) + vu*KroneckerDelta(1,gO2)*(6.324555320336759*g2*gN*Cos(ThetaW())*Cos(2*
      ThetaWp()) + 4*Cos(ThetaWp())*Sin(ThetaWp())*Sqr(gN) - 5*Sin(2*ThetaWp())*
      Sqr(g2)*Sqr(Cos(ThetaW())) + 4.898979485566356*g1*gN*Sin(ThetaW())*Sqr(Cos(
      ThetaWp())) - g1*(3.872983346207417*g2*Sin(2*ThetaW())*Sin(2*ThetaWp()) + 3*
      g1*Sin(2*ThetaWp())*Sqr(Sin(ThetaW())) + 4.898979485566356*gN*Sin(ThetaW())*
...
std::complex<double> CLASSNAME::CpUhhUhhSHp0conjSHp0(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2) - 3*Sqr(gN)) + 5*KroneckerDelta
      (2,gO1)*KroneckerDelta(2,gO2)*Sqr(gN) - KroneckerDelta(1,gO1)*KroneckerDelta
      (1,gO2)*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN)))*(Conj(UHp0(gI1,0))*UHp0(gI2,0)
...
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(3*Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN)) + KroneckerDelta(1
      ,gO1)*KroneckerDelta(1,gO2)*(-3*Sqr(g1) + 5*Sqr(g2) - 2*Sqr(gN)) + 5*
...
{
   const std::complex<double> result = -0.05*(vd*KroneckerDelta(0,gO2)*(3*Sqr(
      g1) + 5*Sqr(g2) - 3*Sqr(gN)) + 5*vs*KroneckerDelta(2,gO2)*Sqr(gN) - vu*
...
{
   const std::complex<double> result = -0.05*(vd*KroneckerDelta(0,gO2)*(3*Sqr(
      g1) - 5*Sqr(g2) - 3*Sqr(gN)) + vu*KroneckerDelta(1,gO2)*(-3*Sqr(g1) + 5*Sqr(
      g2) - 2*Sqr(gN)) + 5*vs*KroneckerDelta(2,gO2)*Sqr(gN))*(Conj(UHpp(gI2,0))*
      UHpp(gI1,0) - Conj(UHpp(gI2,1))*UHpp(gI1,1));
...
std::complex<double> CLASSNAME::CpAhAhUhhUhh(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.025*(-(KroneckerDelta(0,gO1)*
      ...
      ,gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2) - 3*Sqr(gN))*ZA(gI1,0)*
      ZA(gI2,0) - (3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*ZA(gI1,1)*ZA(gI2,1) + 5*(-4*
...
{
   const std::complex<double> result = 0.025*(2*KroneckerDelta(1,gO2)*(vu*(3*
      Sqr(g1) + 5*Sqr(g2) - 3*Sqr(gN))*SUM(j1,0,1,Conj(UHI0(gI2,j1))*UHI0(gI1,j1))
      - 10*vd*Lambdax*SUM(j1,0,1,Conj(UHI0(gI2,2 + j1))*Conj(Lambda12(j1,j1))*
      UHI0(gI1,j1)) - 3*vu*Sqr(g1)*SUM(j1,0,1,Conj(UHI0(gI2,2 + j1))*UHI0(gI1,2 +
      j1)) - 5*vu*Sqr(g2)*SUM(j1,0,1,Conj(UHI0(gI2,2 + j1))*UHI0(gI1,2 + j1)) - 2*
      vu*Sqr(gN)*SUM(j1,0,1,Conj(UHI0(gI2,2 + j1))*UHI0(gI1,2 + j1)) - 10*vd*Conj(
...
{
   const std::complex<double> result = 0.025*(2*KroneckerDelta(1,gO2)*(vu*(3*
      Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN))*SUM(j1,0,1,Conj(UHIp(gI2,j1))*UHIp(gI1,j1))
      + 10*vd*Lambdax*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*Conj(Lambda12(j1,j1))*
      UHIp(gI1,j1)) - 3*vu*Sqr(g1)*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*UHIp(gI1,2 +
      j1)) + 5*vu*Sqr(g2)*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*UHIp(gI1,2 + j1)) - 2*
      vu*Sqr(gN)*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*UHIp(gI1,2 + j1)) + 10*vd*Conj(
...
{
   const std::complex<double> result = 0.7071067811865475*KroneckerDelta(2,gO1)
      *(SUM(j1,0,1,Conj(ZNI(gI1,2 + j1))*Conj(ZNI(gI2,j1))*Lambda12(j1,j1)) + SUM(
      j1,0,1,Conj(ZNI(gI1,j1))*Conj(ZNI(gI2,2 + j1))*Lambda12(j1,j1)));
...
{
   const std::complex<double> result = 0.025*(-5*KroneckerDelta(2,gO2)*(vs*Sqr(
      gN)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) - 4*vu*Lambdax*SUM(j1,0,2,Conj(
      Yd(j1,j1))*Conj(ZD(gI2,3 + j1))*ZD(gI1,j1)) + 2*vs*Sqr(gN)*SUM(j1,0,2,Conj(
      ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) - 4*vu*Conj(Lambdax)*SUM(j1,0,2,Conj(ZD(gI2,
      j1))*Yd(j1,j1)*ZD(gI1,3 + j1))) + KroneckerDelta(1,gO2)*(-2*vu*(Sqr(g1) + 5*
      Sqr(g2) - Sqr(gN))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) + 4*(5*vs*Lambdax
      *SUM(j1,0,2,Conj(Yd(j1,j1))*Conj(ZD(gI2,3 + j1))*ZD(gI1,j1)) + vu*(-Sqr(g1)
      + Sqr(gN))*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) + 5*vs*Conj(
      Lambdax)*SUM(j1,0,2,Conj(ZD(gI2,j1))*Yd(j1,j1)*ZD(gI1,3 + j1)))) +
      KroneckerDelta(0,gO2)*(vd*(2*Sqr(g1) + 10*Sqr(g2) + 3*Sqr(gN))*SUM(j1,0,2,
      Conj(ZD(gI2,j1))*ZD(gI1,j1)) - 28.284271247461902*SUM(j1,0,2,Conj(ZD(gI2,3 +
      j1))*Conj(TYd(j1,j1))*ZD(gI1,j1)) + 4*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 +
      j1))*ZD(gI1,3 + j1)) + 6*vd*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,
      3 + j1)) - 28.284271247461902*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,3 + j1)*TYd
      (j1,j1)) - 40*vd*SUM(j2,0,2,AbsSqr(Yd(j2,j2))*Conj(ZD(gI2,j2))*ZD(gI1,j2)) -
      40*vd*SUM(j2,0,2,AbsSqr(Yd(j2,j2))*Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2))));
...
{
   const std::complex<double> result = 0.025*(KroneckerDelta(1,gO2)*(4*vu*(Sqr(
      g1) - Sqr(gN))*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)) + 20*vd*Lambdax*SUM
      (j1,0,2,Conj(ZDX(gI2,3 + j1))*Conj(Kappa(j1,j1))*ZDX(gI1,j1)) - 4*vu*Sqr(g1)
      *SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)) - 6*vu*Sqr(gN)*SUM(j1,0,2
      ,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)) + 20*vd*Conj(Lambdax)*SUM(j1,0,2,
      Conj(ZDX(gI2,j1))*ZDX(gI1,3 + j1)*Kappa(j1,j1))) + KroneckerDelta(0,gO2)*(-2
      *vd*(2*Sqr(g1) + 3*Sqr(gN))*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)) + 20*
      vu*Lambdax*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*Conj(Kappa(j1,j1))*ZDX(gI1,j1))
      + 4*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)) - 9*vd*Sqr(
      gN)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)) + 20*vu*Conj(Lambdax)*
      SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,3 + j1)*Kappa(j1,j1))) + 5*
      KroneckerDelta(2,gO2)*(2*vs*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)
      ) - 5.656854249492381*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*Conj(TKappa(j1,j1))*
      ZDX(gI1,j1)) + 3*vs*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)
      ) - 5.656854249492381*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,3 + j1)*TKappa(j1
      ,j1)) - 8*vs*SUM(j2,0,2,AbsSqr(Kappa(j2,j2))*Conj(ZDX(gI2,j2))*ZDX(gI1,j2))
      - 8*vs*SUM(j2,0,2,AbsSqr(Kappa(j2,j2))*Conj(ZDX(gI2,3 + j2))*ZDX(gI1,3 + j2)
      )));
...
{
   const std::complex<double> result = 0.025*(2*KroneckerDelta(1,gO2)*(vu*(3*
      Sqr(g1) - 5*Sqr(g2) + 2*Sqr(gN))*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) +
      10*vs*Lambdax*SUM(j1,0,2,Conj(Ye(j1,j1))*Conj(ZE(gI2,3 + j1))*ZE(gI1,j1)) -
      6*vu*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1)) + vu*Sqr(gN)*
      SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1)) + 10*vs*Conj(Lambdax)*SUM(j1
      ,0,2,Conj(ZE(gI2,j1))*Ye(j1,j1)*ZE(gI1,3 + j1))) - 5*KroneckerDelta(2,gO2)*(
      2*vs*Sqr(gN)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 4*vu*Lambdax*SUM(j1,0
      ,2,Conj(Ye(j1,j1))*Conj(ZE(gI2,3 + j1))*ZE(gI1,j1)) + vs*Sqr(gN)*SUM(j1,0,2,
...
{
   const std::complex<double> result = 0.025*(-5*KroneckerDelta(2,gO2)*(vs*Sqr(
      gN)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) - 4*vd*Lambdax*SUM(j1,0,2,Conj(
      Yu(j1,j1))*Conj(ZU(gI2,3 + j1))*ZU(gI1,j1)) + vs*Sqr(gN)*SUM(j1,0,2,Conj(ZU(
      gI2,3 + j1))*ZU(gI1,3 + j1)) - 4*vd*Conj(Lambdax)*SUM(j1,0,2,Conj(ZU(gI2,j1)
      )*Yu(j1,j1)*ZU(gI1,3 + j1))) + KroneckerDelta(0,gO2)*(vd*(2*Sqr(g1) - 10*Sqr
      (g2) + 3*Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) + 20*vs*Lambdax*
      SUM(j1,0,2,Conj(Yu(j1,j1))*Conj(ZU(gI2,3 + j1))*ZU(gI1,j1)) - 8*vd*Sqr(g1)*
      SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)) + 3*vd*Sqr(gN)*SUM(j1,0,2,
      Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)) + 20*vs*Conj(Lambdax)*SUM(j1,0,2,Conj(
      ZU(gI2,j1))*Yu(j1,j1)*ZU(gI1,3 + j1))) - 2*KroneckerDelta(1,gO2)*(vu*(Sqr(g1
      ) - 5*Sqr(g2) - Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) +
...
{
   const std::complex<double> result = 0.05*(-10*g2*Conj(ZN(gI1,1))*Conj(ZN(gI2
      ,2))*KroneckerDelta(0,gO1) + 9.486832980505138*gN*Conj(ZN(gI1,5))*Conj(ZN(
      gI2,2))*KroneckerDelta(0,gO1) - 7.745966692414834*g1*Conj(ZN(gI1,3))*Conj(ZN
      (gI2,0))*KroneckerDelta(1,gO1) + 10*g2*Conj(ZN(gI1,3))*Conj(ZN(gI2,1))*
      ...
      *Lambdax + 14.142135623730951*Conj(ZN(gI1,3))*Conj(ZN(gI2,4))*KroneckerDelta
      ...
      KroneckerDelta(0,gO1) + 1.4142135623730951*(6.708203932499369*gN*Conj(ZN(gI2
      ,5))*KroneckerDelta(0,gO1) + 10*(Conj(ZN(gI2,4))*KroneckerDelta(1,gO1) +
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*(g2*KroneckerDelta(0,gO2)*UM(gI1,1)*UP(gI2,0) + (g2*
      KroneckerDelta(1,gO2)*UM(gI1,0) - Conj(Lambdax)*KroneckerDelta(2,gO2)*UM(gI1
      ,1))*UP(gI2,1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*(g2*Conj(UM(gI2,0))*Conj(UP(gI1,1))*KroneckerDelta(1,gO1
      ) + Conj(UM(gI2,1))*(g2*Conj(UP(gI1,0))*KroneckerDelta(0,gO1) - Conj(UP(gI1,
      1))*KroneckerDelta(2,gO1)*Lambdax));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*KroneckerDelta(2,gO2)*SUM(j1,0,1,Conj(Lambda12(j1,j1))*
      ZMI(gI1,j1)*ZPI(gI2,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(2,gO1)*SUM(j1,0,1,Conj(ZMI(gI2,j1))*Conj
      (ZPI(gI1,j1))*Lambda12(j1,j1));
...
std::complex<double> CLASSNAME::CpUAhUAhhhhh(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.025*(-(KroneckerDelta(0,gO1)*
      ...
      ,gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2) - 3*Sqr(gN))*ZH(gI1,0)*
      ZH(gI2,0) - (3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*ZH(gI1,1)*ZH(gI2,1) + 5*(-4*
...
std::complex<double> CLASSNAME::CpAhAhUAh(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0.,
      0.35355339059327373)*(Conj(TLambdax) - TLambdax)*(KroneckerDelta(2,gO2)*(ZA(
      gI1,1)*ZA(gI2,0) + ZA(gI1,0)*ZA(gI2,1)) + KroneckerDelta(1,gO2)*(ZA(gI1,2)*
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*KroneckerDelta(0,gO2)*SUM(j1,0,2,Conj(Yd(j1,j1))*ZDL(gI1
      ,j1)*ZDR(gI2,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(0,gO1)*SUM(j1,0,2,Conj(ZDL(gI2,j1))*Conj
      (ZDR(gI1,j1))*Yd(j1,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*KroneckerDelta(2,gO2)*SUM(j1,0,2,Conj(Kappa(j1,j1))*ZDXL
      (gI1,j1)*ZDXR(gI2,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(2,gO1)*SUM(j1,0,2,Conj(ZDXL(gI2,j1))*
      Conj(ZDXR(gI1,j1))*Kappa(j1,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*KroneckerDelta(0,gO2)*SUM(j1,0,2,Conj(Ye(j1,j1))*ZEL(gI1
      ,j1)*ZER(gI2,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(0,gO1)*SUM(j1,0,2,Conj(ZEL(gI2,j1))*Conj
      (ZER(gI1,j1))*Ye(j1,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*KroneckerDelta(1,gO2)*SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(gI1
      ,j1)*ZUR(gI2,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(1,gO1)*SUM(j1,0,2,Conj(ZUL(gI2,j1))*Conj
      (ZUR(gI1,j1))*Yu(j1,j1));
...
std::complex<double> CLASSNAME::CpUAhUAhSHIpconjSHIp(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.025*(2*KroneckerDelta(1,gO1)*(
      ...
      )) + 20*KroneckerDelta(1,gO2)*(Lambdax*SUM(j1,0,1,Conj(UHIp(gI1,2 + j1))*
      Conj(Lambda12(j1,j1))*UHIp(gI2,j1)) + Conj(Lambdax)*SUM(j1,0,1,Conj(UHIp(gI1
      ,j1))*UHIp(gI2,2 + j1)*Lambda12(j1,j1)))) + 5*KroneckerDelta(2,gO1)*
      KroneckerDelta(2,gO2)*(3*Sqr(gN)*SUM(j1,0,1,Conj(UHIp(gI1,j1))*UHIp(gI2,j1))
      + 2*Sqr(gN)*SUM(j1,0,1,Conj(UHIp(gI1,2 + j1))*UHIp(gI2,2 + j1)) - 8*(SUM(j2
      ,0,1,AbsSqr(Lambda12(j2,j2))*Conj(UHIp(gI1,j2))*UHIp(gI2,j2)) + SUM(j2,0,1,
      AbsSqr(Lambda12(j2,j2))*Conj(UHIp(gI1,2 + j2))*UHIp(gI2,2 + j2)))));
...
std::complex<double> CLASSNAME::CpChiIChiIUAhPR(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(2,gO2)*(SUM(j1,0,1,Conj(Lambda12(j1,j1))
      *ZNI(gI1,2 + j1)*ZNI(gI2,j1)) + SUM(j1,0,1,Conj(Lambda12(j1,j1))*ZNI(gI1,j1)
      *ZNI(gI2,2 + j1)));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*KroneckerDelta(2,gO1)*(SUM(j1,0,1,Conj(ZNI(gI1,2 + j1))*
      Conj(ZNI(gI2,j1))*Lambda12(j1,j1)) + SUM(j1,0,1,Conj(ZNI(gI1,j1))*Conj(ZNI(
...
{
   const std::complex<double> result = std::complex<double>(0,0.05)*(10*g2*Conj
      (ZN(gI1,1))*Conj(ZN(gI2,2))*KroneckerDelta(0,gO1) - 9.486832980505138*gN*
      Conj(ZN(gI1,5))*Conj(ZN(gI2,2))*KroneckerDelta(0,gO1) + 7.745966692414834*g1
      *Conj(ZN(gI1,3))*Conj(ZN(gI2,0))*KroneckerDelta(1,gO1) - 10*g2*Conj(ZN(gI1,3
      ))*Conj(ZN(gI2,1))*KroneckerDelta(1,gO1) - 10*g2*Conj(ZN(gI1,1))*Conj(ZN(gI2
      ,3))*KroneckerDelta(1,gO1) - 6.324555320336759*gN*Conj(ZN(gI1,5))*Conj(ZN(
      gI2,3))*KroneckerDelta(1,gO1) - 6.324555320336759*gN*Conj(ZN(gI1,3))*Conj(ZN
      (gI2,5))*KroneckerDelta(1,gO1) + 7.745966692414834*g1*Conj(ZN(gI1,0))*(-(
      Conj(ZN(gI2,2))*KroneckerDelta(0,gO1)) + Conj(ZN(gI2,3))*KroneckerDelta(1,
      gO1)) + 15.811388300841898*gN*Conj(ZN(gI1,5))*Conj(ZN(gI2,4))*KroneckerDelta
      (2,gO1) + 15.811388300841898*gN*Conj(ZN(gI1,4))*Conj(ZN(gI2,5))*
      KroneckerDelta(2,gO1) + 14.142135623730951*Conj(ZN(gI1,4))*Conj(ZN(gI2,3))*
...
{
   const std::complex<double> result = 0.025*g2*(2*vu*KroneckerDelta(1,gO2)*(-5
...
{
   const std::complex<double> result = 0.025*g2*(2*vu*KroneckerDelta(1,gO1)*(5*
      g2*Cos(ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(
...
{
   const std::complex<double> result = 0.11180339887498948*g2*(vd*
      KroneckerDelta(0,gO2)*(3.4641016151377544*g1*Cos(ThetaWp())*Sin(ThetaW()) -
...
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(-9.486832980505138*g2*gN*Cos(ThetaW())*Sin(2*ThetaWp(
      )) + 9*Sqr(gN)*Sqr(Cos(ThetaWp())) - 15.491933384829668*g1*g2*Cos(ThetaW())*
      Sin(ThetaW())*Sqr(Sin(ThetaWp())) + 10*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(
      ThetaWp())) + 3*g1*Sin(ThetaW())*(2.449489742783178*gN*Sin(2*ThetaWp()) + 2*
      g1*Sin(ThetaW())*Sqr(Sin(ThetaWp())))) + 2*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*(-4.898979485566356*g1*gN*Cos(ThetaWp())*Sin(ThetaW())
      *Sin(ThetaWp()) + 2*Sqr(gN)*Sqr(Cos(ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(ThetaW()
      ))*Sqr(Sin(ThetaWp())) + 3*Sqr(g1)*Sqr(Sin(ThetaW()))*Sqr(Sin(ThetaWp())) +
      Cos(ThetaW())*(3.1622776601683795*g2*gN*Sin(2*ThetaWp()) - 7.745966692414834
      *g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp())))));
...
std::complex<double> CLASSNAME::CpHpmUHpmconjHpmconjUHpm(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      KroneckerDelta(0,gO2)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2) - 3*Sqr(
      gN))*ZP(gI1,0)*ZP(gI2,1) + KroneckerDelta(1,gO2)*((-20*AbsSqr(Lambdax) + 3*
      Sqr(g1) + 5*Sqr(g2) - 3*Sqr(gN))*ZP(gI1,0)*ZP(gI2,0) - 2*(3*Sqr(g1) + 5*Sqr(
      g2) + 2*Sqr(gN))*ZP(gI1,1)*ZP(gI2,1))) - KroneckerDelta(0,gO1)*(
      KroneckerDelta(1,gO2)*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2) + 3*Sqr(gN
      ))*ZP(gI1,1)*ZP(gI2,0) + KroneckerDelta(0,gO2)*((6*Sqr(g1) + 10*Sqr(g2) + 9*
      Sqr(gN))*ZP(gI1,0)*ZP(gI2,0) + (20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2) +
      3*Sqr(gN))*ZP(gI1,1)*ZP(gI2,1))));
...
std::complex<double> CLASSNAME::CpUHpmSHp0conjUHpmconjSHp0(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(3*Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN)) + KroneckerDelta(1
      ,gO1)*KroneckerDelta(1,gO2)*(-3*Sqr(g1) + 5*Sqr(g2) - 2*Sqr(gN)))*(Conj(UHp0
      (gI1,0))*UHp0(gI2,0) - Conj(UHp0(gI1,1))*UHp0(gI2,1));
...
std::complex<double> CLASSNAME::CpUHpmSHppconjUHpmconjSHpp(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2) - 3*Sqr(gN)) - KroneckerDelta(1
      ,gO1)*KroneckerDelta(1,gO2)*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN)))*(Conj(UHpp(
      gI1,0))*UHpp(gI2,0) - Conj(UHpp(gI1,1))*UHpp(gI2,1));
...
{
   const std::complex<double> result = -0.35355339059327373*(vd*KroneckerDelta(
      0,gO2) + vu*KroneckerDelta(1,gO2))*Sqr(g2)*(Conj(UHpp(gI2,0))*UHp0(gI1,0) +
...
{
   const std::complex<double> result = 0.025*(-(KroneckerDelta(0,gO2)*(5*ZH(gI2
      ,2)*((8*vs*AbsSqr(Lambdax) - 3*vs*Sqr(gN))*ZP(gI1,0) + 5.656854249492381*
      Conj(TLambdax)*ZP(gI1,1)) + ZH(gI2,1)*(2*vu*(-3*Sqr(g1) + 5*Sqr(g2) + 3*Sqr(
      gN))*ZP(gI1,0) + 10*vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,1)) + ZH(gI2,0)
      *(vd*(6*Sqr(g1) + 10*Sqr(g2) + 9*Sqr(gN))*ZP(gI1,0) + 10*vu*(-2*AbsSqr(
      Lambdax) + Sqr(g2))*ZP(gI1,1)))) - 2*KroneckerDelta(1,gO2)*(5*ZH(gI2,2)*(
...
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*KroneckerDelta(gI1,gI2)*(3*Sqr(g1) - 5*Sqr(g2) + 2*Sqr
      (gN)) + KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(KroneckerDelta(gI1,gI2)
      *(-3*Sqr(g1) + 5*Sqr(g2) + 3*Sqr(gN)) - 20*SUM(j2,0,2,AbsSqr(Ye(j2,j2))*Conj
      (ZV(gI1,j2))*ZV(gI2,j2))));
...
{
   const std::complex<double> result = KroneckerDelta(0,gO2)*SUM(j1,0,2,Conj(Yd
      (j1,j1))*ZDR(gI2,j1)*ZUL(gI1,j1));
...
{
   const std::complex<double> result = KroneckerDelta(1,gO1)*SUM(j1,0,2,Conj(
      ZDL(gI2,j1))*Conj(ZUR(gI1,j1))*Yu(j1,j1));
...
{
   const std::complex<double> result = IF(gI1 < 3,Conj(Ye(gI1,gI1))*
      KroneckerDelta(0,gO2)*ZER(gI2,gI1),0);
...
std::complex<double> CLASSNAME::CpSeconjUHpmconjSv(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.25*(1.4142135623730951*KroneckerDelta(
      1,gO2)*(-(vu*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZV(gI1,j1))) + 2*vs*Lambdax
...
{
   const std::complex<double> result = -0.35355339059327373*(vd*KroneckerDelta(
      0,gO2) + vu*KroneckerDelta(1,gO2))*Sqr(g2)*SUM(j1,0,3,Conj(UHIp(gI2,j1))*
      UHI0(gI1,j1));
...
std::complex<double> CLASSNAME::CpUHpmSdconjUHpmconjSd(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = 0.025*(2*KroneckerDelta(1,gO1)*
      ...
      *ZD(gI2,3 + j1)) - 20*SUM(j2,0,2,AbsSqr(Yu(j2,j2))*Conj(ZD(gI1,j2))*ZD(gI2,
      ...
      + 3*Sqr(gN))*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)) + (4*Sqr(g1) + 6*Sqr(
      gN))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)) - 40*SUM(j2,0,2,AbsSqr(
      Yd(j2,j2))*Conj(ZD(gI1,3 + j2))*ZD(gI2,3 + j2))));
...
{
   const std::complex<double> result = 0.025*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*((2*Sqr(g1) + 10*Sqr(g2) + 3*Sqr(gN))*SUM(j1,0,2,Conj(
      ZU(gI1,j1))*ZU(gI2,j1)) + (-8*Sqr(g1) + 3*Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI1,3
      + j1))*ZU(gI2,3 + j1)) - 40*SUM(j2,0,2,AbsSqr(Yd(j2,j2))*Conj(ZU(gI1,j2))*ZU
      (gI2,j2))) + 2*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*((-Sqr(g1) - 5*
      Sqr(g2) + Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)) + (4*Sqr(g1) +
      Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)) - 20*SUM(j2,0,2,
      AbsSqr(Yu(j2,j2))*Conj(ZU(gI1,3 + j2))*ZU(gI2,3 + j2))));
...
std::complex<double> CLASSNAME::CpSdconjUHpmconjSu(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.25*(KroneckerDelta(1,gO2)*(
      ...
      *Sqr(g2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZU(gI1,j1)) + 2*(2*SUM(j1,0,2,Conj(ZD(
      gI2,3 + j1))*Conj(TYd(j1,j1))*ZU(gI1,j1)) + 1.4142135623730951*(vs*Conj(
      Lambdax)*SUM(j1,0,2,Conj(ZD(gI2,j1))*Yu(j1,j1)*ZU(gI1,3 + j1)) + vd*SUM(j2,0
      ,2,AbsSqr(Yd(j2,j2))*Conj(ZD(gI2,j2))*ZU(gI1,j2)) + vu*SUM(j2,0,2,Conj(Yd(j2
      ,j2))*Conj(ZD(gI2,3 + j2))*Yu(j2,j2)*ZU(gI1,3 + j2))))));
...
std::complex<double> CLASSNAME::CpHpmconjUHpmVZ(int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO2)*(-10*g2*Cos(
      ...
      Sin(ThetaW()) + 3.1622776601683795*gN*Sin(ThetaWp()))*ZP(gI2,1));
...
std::complex<double> CLASSNAME::CpHpmUSHI0conjHpmconjUSHI0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 2,0.25*KroneckerDelta(gO1,gO2)*
      ...
      (g1)*ZP(gI1,1)*ZP(gI2,1),0) + IF(gO1 < 2,-0.25*KroneckerDelta(gO1,gO2)*Sqr(
      g2)*ZP(gI1,1)*ZP(gI2,1),0) + IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)*Sqr(gN
      )*ZP(gI1,1)*ZP(gI2,1),0) + IF(gO1 < 2,Conj(Lambdax)*KroneckerDelta(2 + gO1,
      gO2)*ZP(gI1,1)*ZP(gI2,0)*Lambda12(gO1,gO1),0) + IF(gO2 < 2,Conj(Lambda12(gO2
      ,gO2))*KroneckerDelta(gO1,2 + gO2)*Lambdax*ZP(gI1,0)*ZP(gI2,1),0) + 0.15*Sqr
      (g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*ZP(
      gI1,0)*ZP(gI2,0) - 0.25*Sqr(g2)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
      ...
      0.15*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 +
      j1))*ZP(gI1,1)*ZP(gI2,1) + 0.25*Sqr(g2)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1
...
{
   const std::complex<double> result = -(g2*SUM(j1,0,1,KroneckerDelta(gO2,2 +
      j1)*ZPI(gI2,j1))*UM(gI1,0));
...
std::complex<double> CLASSNAME::CphhhhUSHI0conjUSHI0(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)
      ...
      *Conj(Lambda12(gO2,gO2))*KroneckerDelta(gO1,2 + gO2)*Lambdax*ZH(gI1,0)*ZH(
      ...
      0.15*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 +
      j1))*ZH(gI1,0)*ZH(gI2,0) - 0.15*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1
...
std::complex<double> CLASSNAME::CpUSHI0SvconjUSHI0conjSv(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.15*KroneckerDelta(gI1,gI2)
      *KroneckerDelta(gO1,gO2)*Sqr(g1),0) + IF(gO1 < 2,-0.25*KroneckerDelta(gI1,
      gI2)*KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 2,0.15*KroneckerDelta(gI1
...
{
   const std::complex<double> result = IF(gO1 < 2,IF(gO2 < 2,-0.15*Conj(UHI0(
      gI1,gO2))*Sqr(g1)*UHI0(gI2,gO1),0),0) + IF(gO1 < 2,IF(gO2 < 2,-0.25*Conj(
      UHI0(gI1,gO2))*Sqr(g2)*UHI0(gI2,gO1),0),0) + IF(gO1 < 2,IF(gO2 < 2,-0.225*
      Conj(UHI0(gI1,gO2))*Sqr(gN)*UHI0(gI2,gO1),0),0) + IF(gO1 < 2,IF(gO2 < 2,-(
      Conj(UHI0(gI1,2 + gO2))*Conj(Lambda12(gO2,gO2))*UHI0(gI2,2 + gO1)*Lambda12(
      gO1,gO1)),0),0) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0
      ,1,Conj(UHI0(gI1,j1))*UHI0(gI2,j1)),0) + IF(gO1 < 2,-0.125*KroneckerDelta(
      gO1,gO2)*Sqr(g2)*SUM(j1,0,1,Conj(UHI0(gI1,j1))*UHI0(gI2,j1)),0) + IF(gO1 < 2
...
std::complex<double> CLASSNAME::CpUSHI0SHIpconjUSHI0conjSHIp(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 2,IF(gO2 < 2,-0.5*Conj(UHIp(gI1
      ,gO2))*Sqr(g2)*UHIp(gI2,gO1),0),0) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,
      gO2)*Sqr(g1)*SUM(j1,0,1,Conj(UHIp(gI1,j1))*UHIp(gI2,j1)),0) + IF(gO1 < 2,
      0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,1,Conj(UHIp(gI1,j1))*UHIp(gI2
      ,j1)),0) + IF(gO1 < 2,-0.1125*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,1,
      Conj(UHIp(gI1,j1))*UHIp(gI2,j1)),0) + IF(gO1 < 2,0.075*KroneckerDelta(gO1,
      gO2)*Sqr(g1)*SUM(j1,0,1,Conj(UHIp(gI1,2 + j1))*UHIp(gI2,2 + j1)),0) + IF(gO1
      < 2,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,1,Conj(UHIp(gI1,2 + j1)
      )*UHIp(gI2,2 + j1)),0) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      SUM(j1,0,1,Conj(UHIp(gI1,2 + j1))*UHIp(gI2,2 + j1)),0) + IF(gO1 < 2,-0.075*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,1,Conj(UHIp(gI1,j2))*UHIp(gI2,j2)),
...
{
   const std::complex<double> result = IF(gO2 < 2,std::complex<double>(0,-0.5)*
      vu*Conj(UHI0(gI1,2 + gO2))*Conj(Lambda12(gO2,gO2))*Lambdax*ZA(gI2,0),0) + IF
      ...
      UHI0(gI1,j1))*KroneckerDelta(gO2,2 + j1)*Lambda12(j1,j1))*ZA(gI2,0) +
      std::complex<double>(0,0.5)*vd*Conj(Lambdax)*SUM(j1,0,1,Conj(UHI0(gI1,j1))*
...
std::complex<double> CLASSNAME::CphhSHI0conjUSHI0(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 2,-0.5*vu*Conj(UHI0(gI1,2 + gO2
      ))*Conj(Lambda12(gO2,gO2))*Lambdax*ZH(gI2,0),0) + IF(gO2 < 2,-0.15*vd*Conj(
      UHI0(gI1,gO2))*Sqr(g1)*ZH(gI2,0),0) + IF(gO2 < 2,-0.25*vd*Conj(UHI0(gI1,gO2)
      )*Sqr(g2)*ZH(gI2,0),0) + IF(gO2 < 2,-0.225*vd*Conj(UHI0(gI1,gO2))*Sqr(gN)*ZH
      (gI2,0),0) + IF(gO2 < 2,-0.5*vd*Conj(UHI0(gI1,2 + gO2))*Conj(Lambda12(gO2,
      gO2))*Lambdax*ZH(gI2,1),0) + IF(gO2 < 2,0.15*vu*Conj(UHI0(gI1,gO2))*Sqr(g1)*
      ZH(gI2,1),0) + IF(gO2 < 2,0.25*vu*Conj(UHI0(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) +
      IF(gO2 < 2,-0.15*vu*Conj(UHI0(gI1,gO2))*Sqr(gN)*ZH(gI2,1),0) + IF(gO2 < 2,-
      (vs*AbsSqr(Lambda12(gO2,gO2))*Conj(UHI0(gI1,gO2))*ZH(gI2,2)),0) + IF(gO2 < 2
      ,0.7071067811865475*Conj(UHI0(gI1,2 + gO2))*Conj(TLambda12(gO2,gO2))*ZH(gI2,
      2),0) + IF(gO2 < 2,0.375*vs*Conj(UHI0(gI1,gO2))*Sqr(gN)*ZH(gI2,2),0) + 0.15*
...
{
   const std::complex<double> result = IF(gO2 < 2,Conj(Lambda12(gO2,gO2))*ZN(
      gI2,4)*ZNI(gI1,2 + gO2),0) + 0.1*SUM(j1,0,1,KroneckerDelta(gO2,2 + j1)*ZNI(
      gI1,2 + j1))*(-5.477225575051661*g1*ZN(gI2,0) + 7.0710678118654755*g2*ZN(gI2
      ,1) + 4.47213595499958*gN*ZN(gI2,5));
...
std::complex<double> CLASSNAME::CpSdUSHI0conjSdconjUSHI0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)),0) + IF(gO1 < 2,0.125*
      ...
      (g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)),0) + 40*IF(gO1 < 2,
      0.075*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2
      ,3 + j1)),0) + 40*IF(gO1 < 2,0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,
      2,Conj(ZD(gI1,j2))*ZD(gI2,j2)),0) + 40*IF(gO1 < 2,0.125*KroneckerDelta(gO1,
...
std::complex<double> CLASSNAME::CpSDXUSHI0conjSDXconjUSHI0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.05*KroneckerDelta(gO1,gO2)
      ...
      *KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2)),0
      ) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(
      gI1,j2))*ZDX(gI2,j2)),0) + IF(gO1 < 2,0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j2,0,2,Conj(ZDX(gI1,3 + j2))*ZDX(gI2,3 + j2)),0) + IF(gO1 < 2,-0.1125*
      ...
      j1))*ZDX(gI2,3 + j1)*Kappa(j1,j1)),0) + 0.05*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI1
      ,j1))*ZDX(gI2,j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,
      2 + j2)) - 0.05*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2,j1))*SUM(j2,0,1
      ,KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,2 + j2)) - 0.05*Sqr(g1)*SUM(
      j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,
      2 + j2)*KroneckerDelta(gO2,2 + j2)) - 0.075*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI1,
      3 + j1))*ZDX(gI2,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*
      ...
      0.05*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 +
      j1))*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2)) - 0.05*Sqr(g1)*SUM(j1,0,1,
...
std::complex<double> CLASSNAME::CpUSHI0SuconjUSHI0conjSu(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 2,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)),0) + IF(gO1 < 2,-0.125*
      ...
      ,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)),0) + IF(gO1 < 2,0.0375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 +
      j1)),0) + IF(gO1 < 2,0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(
      ZU(gI1,j2))*ZU(gI2,j2)),0) + IF(gO1 < 2,-0.125*KroneckerDelta(gO1,gO2)*Sqr(
      g2)*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)),0) + IF(gO1 < 2,0.0375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)),0) +
      IF(gO1 < 2,-0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZU(gI1,3 +
      j2))*ZU(gI2,3 + j2)),0) + IF(gO1 < 2,0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      SUM(j2,0,2,Conj(ZU(gI1,3 + j2))*ZU(gI2,3 + j2)),0) - 0.025*Sqr(g1)*SUM(j1,0,
      2,Conj(ZU(gI1,j1))*ZU(gI2,j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*
      KroneckerDelta(gO2,2 + j2)) + 0.125*Sqr(g2)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(
      gI2,j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,2 + j2)) +
      0.025*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1))*SUM(j2,0,1,
      KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,2 + j2)) + 0.1*Sqr(g1)*SUM(j1,
      0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 +
      j2)*KroneckerDelta(gO2,2 + j2)) + 0.025*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI1,3 +
      j1))*ZU(gI2,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*KroneckerDelta(
      gO2,2 + j2)) - 0.025*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
      KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)) + 0.125*
      Sqr(g2)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*
      SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)) + 0.025*Sqr(gN)*SUM(j1,0,1,
      KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZU(
      gI1,j2))*ZU(gI2,j2)) + 0.1*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
      KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZU(gI1,3 + j2))*ZU(gI2,3 + j2))
...
{
   const std::complex<double> result = IF(gO2 < 2,0.5*g2*Conj(UHI0(gI2,gO2))*
      Cos(ThetaW())*Cos(ThetaWp()),0) + IF(gO2 < 2,0.3872983346207417*g1*Conj(UHI0
      (gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gO2 < 2,-0.4743416490252569*
      gN*Conj(UHI0(gI2,gO2))*Sin(ThetaWp()),0) + 0.5*g2*Cos(ThetaW())*Cos(ThetaWp(
...
{
   const std::complex<double> result = IF(gO2 < 2,-0.4743416490252569*gN*Conj(
      UHI0(gI2,gO2))*Cos(ThetaWp()),0) + IF(gO2 < 2,-0.5*g2*Conj(UHI0(gI2,gO2))*
      Cos(ThetaW())*Sin(ThetaWp()),0) + IF(gO2 < 2,-0.3872983346207417*g1*Conj(
      UHI0(gI2,gO2))*Sin(ThetaW())*Sin(ThetaWp()),0) + 0.31622776601683794*gN*Cos(
...
{
   const std::complex<double> result = IF(gO2 < 2,0.7071067811865475*g2*Conj(
      UHIp(gI2,gO2)),0) - 0.7071067811865475*g2*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*
      KroneckerDelta(gO2,2 + j1));
...
std::complex<double> CLASSNAME::CpAhAhUSHIpconjUSHIp(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 2,0.25*KroneckerDelta(gO1,gO2)*
      Sqr(g2)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 2,-0.225*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZA(gI1,0)*ZA(gI2,0),0) + IF(gO1 < 2,0.15*KroneckerDelta(gO1,gO2)*Sqr
      (g1)*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 < 2,-0.25*KroneckerDelta(gO1,gO2)*Sqr(
      g2)*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)*Sqr(gN
      )*ZA(gI1,1)*ZA(gI2,1),0) + IF(gO1 < 2,-(AbsSqr(Lambda12(gO1,gO1))*
      KroneckerDelta(gO1,gO2)*ZA(gI1,2)*ZA(gI2,2)),0) + IF(gO1 < 2,0.375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*ZA(gI1,2)*ZA(gI2,2),0) + IF(gO1 < 2,-0.5*
      Conj(Lambdax)*KroneckerDelta(2 + gO1,gO2)*ZA(gI1,1)*ZA(gI2,0)*Lambda12(gO1,
      gO1),0) + IF(gO1 < 2,-0.5*Conj(Lambdax)*KroneckerDelta(2 + gO1,gO2)*ZA(gI1,0
      )*ZA(gI2,1)*Lambda12(gO1,gO1),0) + IF(gO2 < 2,-0.5*Conj(Lambda12(gO2,gO2))*
      KroneckerDelta(gO1,2 + gO2)*Lambdax*ZA(gI1,1)*ZA(gI2,0),0) + IF(gO2 < 2,-0.5
      *Conj(Lambda12(gO2,gO2))*KroneckerDelta(gO1,2 + gO2)*Lambdax*ZA(gI1,0)*ZA(
      ...
      0.15*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 +
      j1))*ZA(gI1,0)*ZA(gI2,0) - 0.15*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1
      )*KroneckerDelta(gO2,2 + j1))*ZA(gI1,1)*ZA(gI2,1) + 0.25*Sqr(g2)*SUM(j1,0,1,
      KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*ZA(gI1,1)*ZA(gI2,1) -
      0.1*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1
      ))*ZA(gI1,1)*ZA(gI2,1) + 0.25*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
...
std::complex<double> CLASSNAME::CphhhhUSHIpconjUSHIp(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 2,0.25*KroneckerDelta(gO1,gO2)*
      Sqr(g2)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 2,-0.225*KroneckerDelta(gO1,gO2)*
      Sqr(gN)*ZH(gI1,0)*ZH(gI2,0),0) + IF(gO1 < 2,0.15*KroneckerDelta(gO1,gO2)*Sqr
      (g1)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 2,-0.25*KroneckerDelta(gO1,gO2)*Sqr(
      g2)*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 2,-0.15*KroneckerDelta(gO1,gO2)*Sqr(gN
      )*ZH(gI1,1)*ZH(gI2,1),0) + IF(gO1 < 2,-(AbsSqr(Lambda12(gO1,gO1))*
      KroneckerDelta(gO1,gO2)*ZH(gI1,2)*ZH(gI2,2)),0) + IF(gO1 < 2,0.375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*ZH(gI1,2)*ZH(gI2,2),0) + IF(gO1 < 2,0.5*Conj
      (Lambdax)*KroneckerDelta(2 + gO1,gO2)*ZH(gI1,1)*ZH(gI2,0)*Lambda12(gO1,gO1),
      0) + IF(gO1 < 2,0.5*Conj(Lambdax)*KroneckerDelta(2 + gO1,gO2)*ZH(gI1,0)*ZH(
      gI2,1)*Lambda12(gO1,gO1),0) + IF(gO2 < 2,0.5*Conj(Lambda12(gO2,gO2))*
      KroneckerDelta(gO1,2 + gO2)*Lambdax*ZH(gI1,1)*ZH(gI2,0),0) + IF(gO2 < 2,0.5*
      Conj(Lambda12(gO2,gO2))*KroneckerDelta(gO1,2 + gO2)*Lambdax*ZH(gI1,0)*ZH(gI2
      ,1),0) + 0.15*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(
      gO2,2 + j1))*ZH(gI1,0)*ZH(gI2,0) - 0.25*Sqr(g2)*SUM(j1,0,1,KroneckerDelta(
      gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*ZH(gI1,0)*ZH(gI2,0) - 0.15*Sqr(gN)*
      SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*ZH(gI1,0)*
      ZH(gI2,0) - 0.15*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
      KroneckerDelta(gO2,2 + j1))*ZH(gI1,1)*ZH(gI2,1) + 0.25*Sqr(g2)*SUM(j1,0,1,
      KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*ZH(gI1,1)*ZH(gI2,1) -
      0.1*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1
      ))*ZH(gI1,1)*ZH(gI2,1) + 0.25*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
...
std::complex<double> CLASSNAME::CpSHI0USHIpconjSHI0conjUSHIp(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,IF(gO2 < 2,-0.5*Conj(UHI0(gI1
      ,gO2))*Sqr(g2)*UHI0(gI2,gO1),0),0) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,
      gO2)*Sqr(g1)*SUM(j1,0,1,Conj(UHI0(gI1,j1))*UHI0(gI2,j1)),0) + IF(gO1 < 2,
      0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,1,Conj(UHI0(gI1,j1))*UHI0(gI2
      ,j1)),0) + IF(gO1 < 2,-0.1125*KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,1,
      Conj(UHI0(gI1,j1))*UHI0(gI2,j1)),0) + IF(gO1 < 2,0.075*KroneckerDelta(gO1,
      gO2)*Sqr(g1)*SUM(j1,0,1,Conj(UHI0(gI1,2 + j1))*UHI0(gI2,2 + j1)),0) + IF(gO1
      < 2,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j1,0,1,Conj(UHI0(gI1,2 + j1)
      )*UHI0(gI2,2 + j1)),0) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      SUM(j1,0,1,Conj(UHI0(gI1,2 + j1))*UHI0(gI2,2 + j1)),0) + IF(gO1 < 2,-0.075*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,1,Conj(UHI0(gI1,j2))*UHI0(gI2,j2)),
      0) + IF(gO1 < 2,0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j2,0,1,Conj(UHI0(
      gI1,j2))*UHI0(gI2,j2)),0) + IF(gO1 < 2,-0.1125*KroneckerDelta(gO1,gO2)*Sqr(
      gN)*SUM(j2,0,1,Conj(UHI0(gI1,j2))*UHI0(gI2,j2)),0) + IF(gO1 < 2,0.075*
...
{
   const std::complex<double> result = IF(gO1 < 2,IF(gO2 < 2,-0.15*Conj(UHIp(
      gI1,gO2))*Sqr(g1)*UHIp(gI2,gO1),0),0) + IF(gO1 < 2,IF(gO2 < 2,-0.25*Conj(
      UHIp(gI1,gO2))*Sqr(g2)*UHIp(gI2,gO1),0),0) + IF(gO1 < 2,IF(gO2 < 2,-0.225*
      Conj(UHIp(gI1,gO2))*Sqr(gN)*UHIp(gI2,gO1),0),0) + IF(gO1 < 2,IF(gO2 < 2,-(
      Conj(UHIp(gI1,2 + gO2))*Conj(Lambda12(gO2,gO2))*UHIp(gI2,2 + gO1)*Lambda12(
      gO1,gO1)),0),0) + IF(gO1 < 2,-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0
      ,1,Conj(UHIp(gI1,j1))*UHIp(gI2,j1)),0) + IF(gO1 < 2,-0.125*KroneckerDelta(
      gO1,gO2)*Sqr(g2)*SUM(j1,0,1,Conj(UHIp(gI1,j1))*UHIp(gI2,j1)),0) + IF(gO1 < 2
...
{
   const std::complex<double> result = IF(gO2 < 2,std::complex<double>(0,0.5)*
      vu*Conj(UHIp(gI1,2 + gO2))*Conj(Lambda12(gO2,gO2))*Lambdax*ZA(gI2,0),0) + IF
      (gO2 < 2,std::complex<double>(0,0.5)*vd*Conj(UHIp(gI1,2 + gO2))*Conj(
      Lambda12(gO2,gO2))*Lambdax*ZA(gI2,1),0) + IF(gO2 < 2,std::complex<double>(0.
      ...
      gI1,j1))*KroneckerDelta(gO2,2 + j1)*Lambda12(j1,j1))*ZA(gI2,0) -
      std::complex<double>(0,0.5)*vd*Conj(Lambdax)*SUM(j1,0,1,Conj(UHIp(gI1,j1))*
      KroneckerDelta(gO2,2 + j1)*Lambda12(j1,j1))*ZA(gI2,1) - std::complex<double>
...
std::complex<double> CLASSNAME::CphhSHIpconjUSHIp(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 2,0.5*vu*Conj(UHIp(gI1,2 + gO2)
      ...
      UHIp(gI1,gO2))*Sqr(g1)*ZH(gI2,0),0) + IF(gO2 < 2,0.25*vd*Conj(UHIp(gI1,gO2))
      *Sqr(g2)*ZH(gI2,0),0) + IF(gO2 < 2,-0.225*vd*Conj(UHIp(gI1,gO2))*Sqr(gN)*ZH(
      gI2,0),0) + IF(gO2 < 2,0.5*vd*Conj(UHIp(gI1,2 + gO2))*Conj(Lambda12(gO2,gO2)
      )*Lambdax*ZH(gI2,1),0) + IF(gO2 < 2,0.15*vu*Conj(UHIp(gI1,gO2))*Sqr(g1)*ZH(
      gI2,1),0) + IF(gO2 < 2,-0.25*vu*Conj(UHIp(gI1,gO2))*Sqr(g2)*ZH(gI2,1),0) +
      IF(gO2 < 2,-0.15*vu*Conj(UHIp(gI1,gO2))*Sqr(gN)*ZH(gI2,1),0) + IF(gO2 < 2,-(
      vs*AbsSqr(Lambda12(gO2,gO2))*Conj(UHIp(gI1,gO2))*ZH(gI2,2)),0) + IF(gO2 < 2,
      -0.7071067811865475*Conj(UHIp(gI1,2 + gO2))*Conj(TLambda12(gO2,gO2))*ZH(gI2,
      2),0) + IF(gO2 < 2,0.375*vs*Conj(UHIp(gI1,gO2))*Sqr(gN)*ZH(gI2,2),0) + 0.15*
...
std::complex<double> CLASSNAME::CpSDXUSHIpconjSDXconjUSHIp(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.05*KroneckerDelta(gO1,gO2)
      ...
      *KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2)),0
      ...
      SUM(j2,0,2,Conj(ZDX(gI1,3 + j2))*ZDX(gI2,3 + j2)),0) + IF(gO1 < 2,-0.1125*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZDX(gI1,3 + j2))*ZDX(gI2,3 +
      j2)),0) + IF(gO1 < 2,-(KroneckerDelta(2 + gO1,gO2)*SUM(j2,0,2,Conj(ZDX(gI1,
      3 + j2))*Conj(Kappa(j2,j2))*ZDX(gI2,j2))*Lambda12(gO1,gO1)),0) + IF(gO2 < 2,
      -(Conj(Lambda12(gO2,gO2))*KroneckerDelta(gO1,2 + gO2)*SUM(j1,0,2,Conj(ZDX(
      gI1,j1))*ZDX(gI2,3 + j1)*Kappa(j1,j1))),0) + 0.05*Sqr(g1)*SUM(j1,0,2,Conj(
      ZDX(gI1,j1))*ZDX(gI2,j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*
      KroneckerDelta(gO2,2 + j2)) - 0.05*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(
      gI2,j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,2 + j2)) -
      0.05*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1))*SUM(j2,0,1,
      KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,2 + j2)) - 0.075*Sqr(gN)*SUM(
      j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,
      2 + j2)*KroneckerDelta(gO2,2 + j2)) + 0.05*Sqr(g1)*SUM(j1,0,1,KroneckerDelta
      (gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(
      gI2,j2)) - 0.05*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta
      (gO2,2 + j1))*SUM(j2,0,2,Conj(ZDX(gI1,j2))*ZDX(gI2,j2)) - 0.05*Sqr(g1)*SUM(
      j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,
      Conj(ZDX(gI1,3 + j2))*ZDX(gI2,3 + j2)) - 0.075*Sqr(gN)*SUM(j1,0,1,
      KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZDX(
...
std::complex<double> CLASSNAME::CpSeUSHIpconjSeconjUSHIp(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 2,-0.075*KroneckerDelta(gO1,gO2
      ...
      *SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 +
      ...
      (gO1,2 + j2)*KroneckerDelta(gO2,2 + j2)) - 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,
      3 + j1))*ZE(gI2,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*
      KroneckerDelta(gO2,2 + j2)) + Sqr(gN)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2
      ,3 + j1))*SUM(j2,0,1,KroneckerDelta(gO1,2 + j2)*KroneckerDelta(gO2,2 + j2))
      + 3*Sqr(g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1)
      )*SUM(j2,0,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)) + 5*Sqr(g2)*SUM(j1,0,1,
      KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZE(
      gI1,j2))*ZE(gI2,j2)) + 2*Sqr(gN)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*
      KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)) - 6*Sqr(
      g1)*SUM(j1,0,1,KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2
      ,0,2,Conj(ZE(gI1,3 + j2))*ZE(gI2,3 + j2)) + Sqr(gN)*SUM(j1,0,1,
      KroneckerDelta(gO1,2 + j1)*KroneckerDelta(gO2,2 + j1))*SUM(j2,0,2,Conj(ZE(
      gI1,3 + j2))*ZE(gI2,3 + j2)));
...
std::complex<double> CLASSNAME::CpUSHIpSuconjUSHIpconjSu(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 2,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)),0) + IF(gO1 < 2,0.125*
      ...
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 +
      j1)),0) + IF(gO1 < 2,0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(
      ZU(gI1,j2))*ZU(gI2,j2)),0) + IF(gO1 < 2,0.125*KroneckerDelta(gO1,gO2)*Sqr(g2
      )*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)),0) + IF(gO1 < 2,0.0375*
      KroneckerDelta(gO1,gO2)*Sqr(gN)*SUM(j2,0,2,Conj(ZU(gI1,j2))*ZU(gI2,j2)),0) +
      IF(gO1 < 2,-0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZU(gI1,3 +
      j2))*ZU(gI2,3 + j2)),0) + IF(gO1 < 2,0.0375*KroneckerDelta(gO1,gO2)*Sqr(gN)*
      SUM(j2,0,2,Conj(ZU(gI1,3 + j2))*ZU(gI2,3 + j2)),0) - 0.025*Sqr(g1)*SUM(j1,0,
...
{
   const std::complex<double> result = IF(gO2 < 2,-(Conj(Lambda12(gO2,gO2))*ZN(
      gI1,4)*ZPI(gI2,gO2)),0) - 0.1*SUM(j1,0,1,KroneckerDelta(gO2,2 + j1)*ZPI(gI2,
      j1))*(5.477225575051661*g1*ZN(gI1,0) + 7.0710678118654755*g2*ZN(gI1,1) -
      4.47213595499958*gN*ZN(gI1,5));
...
{
   const std::complex<double> result = IF(gO1 < 2,0.5477225575051661*g1*Conj(
      ZMI(gI2,gO1))*Conj(ZN(gI1,0)),0) + IF(gO1 < 2,0.7071067811865475*g2*Conj(ZMI
      (gI2,gO1))*Conj(ZN(gI1,1)),0) + IF(gO1 < 2,0.6708203932499369*gN*Conj(ZMI(
      gI2,gO1))*Conj(ZN(gI1,5)),0) - Conj(ZN(gI1,4))*SUM(j1,0,1,Conj(ZMI(gI2,j1))*
      KroneckerDelta(gO1,2 + j1)*Lambda12(j1,j1));
...
{
   const std::complex<double> result = IF(gO2 < 2,0.7071067811865475*g2*Conj(
      UHI0(gI2,gO2)),0) - 0.7071067811865475*g2*SUM(j1,0,1,Conj(UHI0(gI2,2 + j1))*
      KroneckerDelta(gO2,2 + j1));
...
{
   const std::complex<double> result = IF(gI2 < 4,-0.3872983346207417*g1*Conj(
      UHIp(gI2,gO2))*Cos(ThetaW()),0) + IF(gI2 < 4,-0.5*g2*Conj(UHIp(gI2,gO2))*Sin
      (ThetaW()),0);
...
{
   const std::complex<double> result = IF(gO2 < 2,-0.5*g2*Conj(UHIp(gI2,gO2))*
      Cos(ThetaW())*Cos(ThetaWp()),0) + IF(gO2 < 2,0.3872983346207417*g1*Conj(UHIp
      (gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gO2 < 2,-0.4743416490252569*
      gN*Conj(UHIp(gI2,gO2))*Sin(ThetaWp()),0) - 0.5*g2*Cos(ThetaW())*Cos(ThetaWp(
...
{
   const std::complex<double> result = IF(gO2 < 2,-0.4743416490252569*gN*Conj(
      UHIp(gI2,gO2))*Cos(ThetaWp()),0) + IF(gO2 < 2,0.5*g2*Conj(UHIp(gI2,gO2))*Cos
...
std::complex<double> CLASSNAME::CpHpmUSSI0conjHpmconjUSSI0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*(3
      *ZP(gI1,0)*ZP(gI2,0) + 2*ZP(gI1,1)*ZP(gI2,1));
...
{
   const std::complex<double> result = IF(gI1 < 2,IF(gI2 < 2,-0.625*Conj(ZSSI(
      gI1,gO2))*Sqr(gN)*ZSSI(gI2,gO1),0),0) - 0.625*KroneckerDelta(gI1,gI2)*
...
{
   const std::complex<double> result = IF(gI1 < 2,0.375*vd*Conj(ZSSI(gI1,gO2))*
      Sqr(gN)*ZH(gI2,0),0) + IF(gI1 < 2,0.25*vu*Conj(ZSSI(gI1,gO2))*Sqr(gN)*ZH(gI2
      ,1),0) + IF(gI1 < 2,-0.625*vs*Conj(ZSSI(gI1,gO2))*Sqr(gN)*ZH(gI2,2),0);
...
{
   const std::complex<double> result = IF(gO1 < 2,-1.118033988749895*gN*Conj(
      ZFSI(gI1,gO1))*Conj(ZN(gI2,5)),0);
...
{
   const std::complex<double> result = 0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*(3
      *ZA(gI1,0)*ZA(gI2,0) + 2*ZA(gI1,1)*ZA(gI2,1) - 5*ZA(gI1,2)*ZA(gI2,2));
...
{
   const std::complex<double> result = 0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*(3
      *ZH(gI1,0)*ZH(gI2,0) + 2*ZH(gI1,1)*ZH(gI2,1) - 5*ZH(gI1,2)*ZH(gI2,2));
...
{
   const std::complex<double> result = -0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*(
      SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)) + 2*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*
      ZD(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::CpSDXUSSI0conjSDXconjUSSI0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*(2
      *SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2,j1)) + 3*SUM(j1,0,2,Conj(ZDX(gI1,3 +
      j1))*ZDX(gI2,3 + j1)));
...
{
   const std::complex<double> result = -0.125*KroneckerDelta(gO1,gO2)*Sqr(gN)*(
      2*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)) + SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*
      ZE(gI2,3 + j1)));
...
{
   const std::complex<double> result = IF(gI2 < 2,0.7905694150420949*gN*Conj(
      ZSSI(gI2,gO2))*Sin(ThetaWp()),0);
...
std::complex<double> CLASSNAME::CpHpmUSHp0conjHpmconjUSHp0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      ...
      (g1) - 5*Sqr(g2) - 3*Sqr(gN))*ZP(gI1,0)*ZP(gI2,0) + (-3*Sqr(g1) + 5*Sqr(g2)
      - 2*Sqr(gN))*ZP(gI1,1)*ZP(gI2,1));
...
std::complex<double> CLASSNAME::CpSHp0USHp0conjSHp0conjUSHp0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = -0.05*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN)
      )*(-(Conj(UHp0(gI1,1))*(-2*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*UHp0(
      gI2,1) + KroneckerDelta(0,gO1)*(KroneckerDelta(1,gO2)*UHp0(gI2,0) +
...
{
   const std::complex<double> result = 0.05*(-(Conj(UHpp(gI1,0))*(
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(
      gN))*UHpp(gI2,0) + KroneckerDelta(1,gO1)*(KroneckerDelta(1,gO2)*(-3*Sqr(g1)
      + 5*Sqr(g2) - 2*Sqr(gN))*UHpp(gI2,0) + 10*KroneckerDelta(0,gO2)*Sqr(g2)*UHpp
      (gI2,1)))) - Conj(UHpp(gI1,1))*(KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      (3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*UHpp(gI2,1) + KroneckerDelta(0,gO1)*(10*
...
{
   const std::complex<double> result = -0.05*(Conj(UHp0(gI1,0))*KroneckerDelta(
      0,gO2) - Conj(UHp0(gI1,1))*KroneckerDelta(1,gO2))*(vd*(3*Sqr(g1) + 5*Sqr(g2)
      - 3*Sqr(gN))*ZH(gI2,0) - vu*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*ZH(gI2,1) +
      5*vs*Sqr(gN)*ZH(gI2,2));
...
std::complex<double> CLASSNAME::CpChiChiPconjUSHp0PL(int gI2, int gI1, int gO1) const
{
   const std::complex<double> result = 0.1*(5.477225575051661*g1*Conj(ZN(gI2,0)
      ) - 7.0710678118654755*g2*Conj(ZN(gI2,1)) - 4.47213595499958*gN*Conj(ZN(gI2,
      5)))*Conj(ZNp(gI1,0))*KroneckerDelta(0,gO1);
...
std::complex<double> CLASSNAME::CpAhAhUSHp0conjUSHp0(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      ...
      2*Sqr(gN))*ZA(gI1,1)*ZA(gI2,1) + 5*Sqr(gN)*ZA(gI1,2)*ZA(gI2,2));
...
std::complex<double> CLASSNAME::CphhhhUSHp0conjUSHp0(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      ...
      2*Sqr(gN))*ZH(gI1,1)*ZH(gI2,1) + 5*Sqr(gN)*ZH(gI1,2)*ZH(gI2,2));
...
std::complex<double> CLASSNAME::CpUSHp0SvconjUSHp0conjSv(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2))*
      KroneckerDelta(gI1,gI2)*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN));
...
std::complex<double> CLASSNAME::CpSHI0USHp0conjSHI0conjUSHp0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2))*((3*Sqr
      (g1) + 5*Sqr(g2) - 3*Sqr(gN))*SUM(j1,0,1,Conj(UHI0(gI1,j1))*UHI0(gI2,j1)) -
      (3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*SUM(j1,0,1,Conj(UHI0(gI1,2 + j1))*UHI0(
      gI2,2 + j1)));
...
std::complex<double> CLASSNAME::CpSHIpUSHp0conjSHIpconjUSHp0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2))*((3*Sqr
      (g1) - 5*Sqr(g2) - 3*Sqr(gN))*SUM(j1,0,1,Conj(UHIp(gI1,j1))*UHIp(gI2,j1)) +
      (-3*Sqr(g1) + 5*Sqr(g2) - 2*Sqr(gN))*SUM(j1,0,1,Conj(UHIp(gI1,2 + j1))*UHIp(
      gI2,2 + j1)));
...
std::complex<double> CLASSNAME::CpSdUSHp0conjSdconjUSHp0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*
      ...
      g1) + 5*Sqr(g2) - Sqr(gN))*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)) + 2*(Sqr(
      g1) - Sqr(gN))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)));
...
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2))*(2*(Sqr
      (g1) - Sqr(gN))*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2,j1)) - (2*Sqr(g1) + 3*
      Sqr(gN))*SUM(j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::CpSeUSHp0conjSeconjUSHp0(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = -0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2))*((3*Sqr
      (g1) - 5*Sqr(g2) + 2*Sqr(gN))*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)) + (-6*
      Sqr(g1) + Sqr(gN))*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::CpUSHp0SuconjUSHp0conjSu(int gO1, int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2))*((Sqr(
      g1) - 5*Sqr(g2) - Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)) - (4*Sqr(
      g1) + Sqr(gN))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)));
...
{
   const std::complex<double> result = IF(gI2 < 2,0.5*g2*Conj(UHp0(gI2,gO2))*
      Cos(ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 2,0.3872983346207417*g1*Conj(UHp0
      (gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 2,0.31622776601683794*
      gN*Conj(UHp0(gI2,gO2))*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gI2 < 2,0.31622776601683794*gN*Conj(
      UHp0(gI2,gO2))*Cos(ThetaWp()),0) + IF(gI2 < 2,-0.5*g2*Conj(UHp0(gI2,gO2))*
      Cos(ThetaW())*Sin(ThetaWp()),0) + IF(gI2 < 2,-0.3872983346207417*g1*Conj(
      UHp0(gI2,gO2))*Sin(ThetaW())*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = 0.05*(-(Conj(UHp0(gI1,0))*(
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(
      gN))*UHp0(gI2,0) + KroneckerDelta(1,gO1)*(KroneckerDelta(1,gO2)*(-3*Sqr(g1)
      + 5*Sqr(g2) - 2*Sqr(gN))*UHp0(gI2,0) + 10*KroneckerDelta(0,gO2)*Sqr(g2)*UHp0
      (gI2,1)))) - Conj(UHp0(gI1,1))*(KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*
      (3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*UHp0(gI2,1) + KroneckerDelta(0,gO1)*(10*
...
{
   const std::complex<double> result = -0.05*(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN)
      )*(-(Conj(UHpp(gI1,1))*(-2*KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*UHpp(
      gI2,1) + KroneckerDelta(0,gO1)*(KroneckerDelta(1,gO2)*UHpp(gI2,0) +
...
{
   const std::complex<double> result = -0.05*(Conj(UHpp(gI1,0))*KroneckerDelta(
      0,gO2) - Conj(UHpp(gI1,1))*KroneckerDelta(1,gO2))*(vd*(3*Sqr(g1) - 5*Sqr(g2)
      - 3*Sqr(gN))*ZH(gI2,0) + vu*(-3*Sqr(g1) + 5*Sqr(g2) - 2*Sqr(gN))*ZH(gI2,1)
      + 5*vs*Sqr(gN)*ZH(gI2,2));
...
std::complex<double> CLASSNAME::CpChiChaPconjUSHppPL(int gI1, int gO1) const
{
   const std::complex<double> result = 0.1*(5.477225575051661*g1*Conj(ZN(gI1,0)
      ) + 7.0710678118654755*g2*Conj(ZN(gI1,1)) - 4.47213595499958*gN*Conj(ZN(gI1,
      5)))*KroneckerDelta(0,gO1);
...
{
   const std::complex<double> result = IF(gI2 < 2,-0.3872983346207417*g1*Conj(
      UHpp(gI2,gO2))*Cos(ThetaW()),0) + IF(gI2 < 2,-0.5*g2*Conj(UHpp(gI2,gO2))*Sin
      (ThetaW()),0);
...
{
   const std::complex<double> result = IF(gI2 < 2,-0.5*g2*Conj(UHpp(gI2,gO2))*
      Cos(ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 2,0.3872983346207417*g1*Conj(UHpp
      (gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 2,0.31622776601683794*
      gN*Conj(UHpp(gI2,gO2))*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gI2 < 2,0.31622776601683794*gN*Conj(
      UHpp(gI2,gO2))*Cos(ThetaWp()),0) + IF(gI2 < 2,0.5*g2*Conj(UHpp(gI2,gO2))*Cos
...
{
   const std::complex<double> result = 0.1*KroneckerDelta(gI1,gI2)*(g2*Sin(
...
{
   const double result = 0.13333333333333333*KroneckerDelta(gI1,gI2)*Sqr(g1)*
      Sqr(Cos(ThetaW()));
...
{
   const double result = -0.2581988897471611*g1*Cos(ThetaW())*KroneckerDelta(
      gI1,gI2);
...
std::complex<double> CLASSNAME::CpHpmconjHpmVZ(int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*((-10*g2*Cos(ThetaW())*Cos(ThetaWp(
      ...
      gN*Sin(ThetaWp()))*ZP(gI1,0)*ZP(gI2,0) + 2*(-5*g2*Cos(ThetaW())*Cos(ThetaWp(
      )) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW()) + 3.1622776601683795*
      gN*Sin(ThetaWp()))*ZP(gI1,1)*ZP(gI2,1));
...
{
   const std::complex<double> result = 0.05*(20*g2*Conj(UM(gI2,0))*Cos(ThetaW()
      )*Cos(ThetaWp())*UM(gI1,0) + Conj(UM(gI2,1))*(10*g2*Cos(ThetaW())*Cos(
      ThetaWp()) - 7.745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) +
      9.486832980505138*gN*Sin(ThetaWp()))*UM(gI1,1));
...
{
   const std::complex<double> result = 0.1*(10*g2*Conj(UP(gI1,0))*Cos(ThetaW())
      *Cos(ThetaWp())*UP(gI2,0) + Conj(UP(gI1,1))*(5*g2*Cos(ThetaW())*Cos(ThetaWp(
      )) - 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW()) - 3.1622776601683795*
...
{
   const double result = 0.016666666666666666*KroneckerDelta(gI1,gI2)*(30*g2*
      Cos(ThetaW())*Cos(ThetaWp()) + 7.745966692414834*g1*Cos(ThetaWp())*Sin(
      ThetaW()) - 9.486832980505138*gN*Sin(ThetaWp()));
...
{
   const double result = -0.05*KroneckerDelta(gI1,gI2)*(15.491933384829668*g1*
...
std::complex<double> CLASSNAME::CpSHI0conjSHI0VZ(int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*((10*g2*Cos(ThetaW())*Cos(ThetaWp()
      ...
      *Sin(ThetaWp()))*SUM(j1,0,1,Conj(UHI0(gI2,j1))*UHI0(gI1,j1)) + 2*(5*g2*Cos(
      ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())
...
std::complex<double> CLASSNAME::CpSHIpconjSHIpVZ(int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*((-10*g2*Cos(ThetaW())*Cos(ThetaWp(
      ...
      gN*Sin(ThetaWp()))*SUM(j1,0,1,Conj(UHIp(gI2,j1))*UHIp(gI1,j1)) + 2*(-5*g2*
      Cos(ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(
      ThetaW()) + 3.1622776601683795*gN*Sin(ThetaWp()))*SUM(j1,0,1,Conj(UHIp(gI2,2
      + j1))*UHIp(gI1,2 + j1)));
...
std::complex<double> CLASSNAME::CpChiIChiIVZPL(int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*((-10*g2*Cos(ThetaW())*Cos(ThetaWp(
      ...
      gN*Sin(ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI2,j1))*ZNI(gI1,j1)) + 2*(5*g2*Cos(
      ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())
      + 3.1622776601683795*gN*Sin(ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI2,2 + j1))*
      ZNI(gI1,2 + j1)));
...
std::complex<double> CLASSNAME::CpChiIChiIVZPR(int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*((10*g2*Cos(ThetaW())*Cos(ThetaWp()
      ...
      *Sin(ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI1,j1))*ZNI(gI2,j1)) - 2*(5*g2*Cos(
      ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())
      + 3.1622776601683795*gN*Sin(ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI1,2 + j1))*
      ZNI(gI2,2 + j1)));
...
{
   const std::complex<double> result = 0.016666666666666666*((
      -4.898979485566356*g1*gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + 30*
      Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + Cos(ThetaW())*(
      -18.973665961010276*g2*gN*Cos(ThetaWp())*Sin(ThetaWp()) + 15.491933384829668
      *g1*g2*Sin(ThetaW())*Sqr(Cos(ThetaWp()))) + 2*Sqr(g1)*Sqr(Cos(ThetaWp()))*
      Sqr(Sin(ThetaW())) + 3*Sqr(gN)*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZD(gI1,
      j1))*ZD(gI2,j1)) + 4*(-4.898979485566356*g1*gN*Cos(ThetaWp())*Sin(ThetaW())*
      Sin(ThetaWp()) + 2*Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 3*Sqr(gN
      )*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)));
...
{
   const std::complex<double> result = 0.016666666666666666*(4*(
      ...
      *SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(gI2,j1)) + (8*Sqr(g1)*Sqr(Cos(ThetaWp()))*
      Sqr(Sin(ThetaW())) + 3*gN*(4.898979485566356*g1*Sin(ThetaW())*Sin(2*ThetaWp(
      )) + 9*gN*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,Conj(ZDX(gI1,3 + j1))*ZDX(gI2,3 +
      j1)));
...
{
   const std::complex<double> result = 0.05*(2*(2.449489742783178*g1*gN*Sin(
      ThetaW())*Sin(2*ThetaWp()) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())
      ) - 2*Cos(ThetaW())*(3.1622776601683795*g2*gN*Cos(ThetaWp())*Sin(ThetaWp())
      + 3.872983346207417*g1*g2*Sin(ThetaW())*Sqr(Cos(ThetaWp()))) + 3*Sqr(g1)*Sqr
      (Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 2*Sqr(gN)*Sqr(Sin(ThetaWp())))*SUM(j1,
      0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)) + (-9.797958971132712*g1*gN*Cos(ThetaWp())*
...
std::complex<double> CLASSNAME::CpSuconjSuVZVZ(int gI1, int gI2) const
{
   const std::complex<double> result = 0.016666666666666666*((
      ...
      Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + Cos(ThetaW())*(
      9.486832980505138*g2*gN*Sin(2*ThetaWp()) - 15.491933384829668*g1*g2*Sin(
      ThetaW())*Sqr(Cos(ThetaWp()))) + 2*Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(
      ThetaW())) + 3*Sqr(gN)*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(
      gI2,j1)) + (19.595917942265423*g1*gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(
      ThetaWp()) + 32*Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 3*Sqr(gN)*
      Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)));
...
{
   const std::complex<double> result = 0.016666666666666666*(-((30*g2*Cos(
      ThetaW())*Cos(ThetaWp()) + 7.745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW())
      - 9.486832980505138*gN*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,
      j1))) + 2*(7.745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) -
      9.486832980505138*gN*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,
      3 + j1)));
...
{
   const std::complex<double> result = 0.016666666666666666*((
      15.491933384829668*g1*Cos(ThetaWp())*Sin(ThetaW()) - 18.973665961010276*gN*
      Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)) + (
      15.491933384829668*g1*Cos(ThetaWp())*Sin(ThetaW()) + 28.460498941515414*gN*
      Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)));
...
std::complex<double> CLASSNAME::CpSeconjSeVZ(int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*(2*(-5*g2*Cos(ThetaW())*Cos(ThetaWp
      ()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW()) + 3.1622776601683795
      *gN*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) +
      2.23606797749979*(6.928203230275509*g1*Cos(ThetaWp())*Sin(ThetaW()) -
      1.4142135623730951*gN*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*ZE(gI1
      ,3 + j1)));
...
std::complex<double> CLASSNAME::CpSuconjSuVZ(int gI2, int gI1) const
{
   const std::complex<double> result = 0.016666666666666666*((30*g2*Cos(ThetaW(
      ...
      - (30.983866769659336*g1*Cos(ThetaWp())*Sin(ThetaW()) + 9.486832980505138*
      gN*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)));
...
{
   const std::complex<double> result = 0.05*((9*Sqr(gN)*Sqr(Cos(ThetaWp())) +
      10*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())) + 3*g1*Sin(ThetaW())*(
      2.449489742783178*gN*Sin(2*ThetaWp()) + 2*g1*Sin(ThetaW())*Sqr(Sin(ThetaWp()
      ))) - Cos(ThetaW())*(9.486832980505138*g2*gN*Sin(2*ThetaWp()) +
      15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*ZP(gI1,0)*ZP(
      gI2,0) + 2*(-4.898979485566356*g1*gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(
      ThetaWp()) + 2*Sqr(gN)*Sqr(Cos(ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*
      Sqr(Sin(ThetaWp())) + 3*Sqr(g1)*Sqr(Sin(ThetaW()))*Sqr(Sin(ThetaWp())) + Cos
      (ThetaW())*(3.1622776601683795*g2*gN*Sin(2*ThetaWp()) - 7.745966692414834*g1
      *g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*ZP(gI1,1)*ZP(gI2,1));
...
std::complex<double> CLASSNAME::CpHpmconjHpmVZp(int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*((-9.486832980505138*gN*Cos(ThetaWp
      ()) + 2*(5*g2*Cos(ThetaW()) - 3.872983346207417*g1*Sin(ThetaW()))*Sin(
      ThetaWp()))*ZP(gI1,0)*ZP(gI2,0) + 2*(3.1622776601683795*gN*Cos(ThetaWp()) +
...
{
   const double result = 0.7905694150420949*gN*Cos(ThetaWp())*KroneckerDelta(
      gI1,gI2);
...
{
   const std::complex<double> result = 0.05*(-20*g2*Conj(UM(gI2,0))*Cos(ThetaW(
      ))*Sin(ThetaWp())*UM(gI1,0) + Conj(UM(gI2,1))*(9.486832980505138*gN*Cos(
...
{
   const std::complex<double> result = 0.1*(-10*g2*Conj(UP(gI1,0))*Cos(ThetaW()
      )*Sin(ThetaWp())*UP(gI2,0) + Conj(UP(gI1,1))*(-3.1622776601683795*gN*Cos(
      ThetaWp()) + (-5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(
      ThetaWp()))*UP(gI2,1));
...
{
   const double result = -0.1*KroneckerDelta(gI1,gI2)*(3.1622776601683795*gN*
...
{
   const std::complex<double> result = 0.1*KroneckerDelta(gI1,gI2)*(
      -4.898979485566356*g1*gN*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) -
      3.1622776601683795*g2*gN*Cos(ThetaW())*Sin(2*ThetaWp()) + 2*Sqr(gN)*Sqr(Cos(
      ThetaWp())) + g1*Sin(ThetaW())*(7.745966692414834*g2*Cos(ThetaW()) + 3*g1*
      Sin(ThetaW()))*Sqr(Sin(ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(
      ThetaWp())));
...
{
   const double result = 0.05*KroneckerDelta(gI1,gI2)*(3.1622776601683795*gN*
      Cos(ThetaWp()) + 15.491933384829668*g1*Sin(ThetaW())*Sin(ThetaWp()));
...
std::complex<double> CLASSNAME::CpSHI0conjSHI0VZpVZp(int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*((9*Sqr(gN)*Sqr(Cos(ThetaWp())) +
      ...
      + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())))*SUM(j1,0,1,Conj(UHI0(
      gI1,2 + j1))*UHI0(gI2,2 + j1)));
...
std::complex<double> CLASSNAME::CpSHIpconjSHIpVZpVZp(int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*((9*Sqr(gN)*Sqr(Cos(ThetaWp())) +
      ...
      15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,1,Conj
      (UHIp(gI1,j1))*UHIp(gI2,j1)) + 2*(-4.898979485566356*g1*gN*Cos(ThetaWp())*
      Sin(ThetaW())*Sin(ThetaWp()) + 2*Sqr(gN)*Sqr(Cos(ThetaWp())) + 5*Sqr(g2)*Sqr
...
{
   const std::complex<double> result = 0.05*(-((9.486832980505138*gN*Cos(
      ThetaWp()) + 2*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin
      (ThetaWp()))*SUM(j1,0,1,Conj(UHI0(gI2,j1))*UHI0(gI1,j1))) + 2*(
      3.1622776601683795*gN*Cos(ThetaWp()) - (5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp()))*SUM(j1,0,1,Conj(UHI0(gI2
      ,2 + j1))*UHI0(gI1,2 + j1)));
...
std::complex<double> CLASSNAME::CpSHIpconjSHIpVZp(int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*((-9.486832980505138*gN*Cos(ThetaWp
      ()) + 2*(5*g2*Cos(ThetaW()) - 3.872983346207417*g1*Sin(ThetaW()))*Sin(
      ThetaWp()))*SUM(j1,0,1,Conj(UHIp(gI2,j1))*UHIp(gI1,j1)) + 2*(
      3.1622776601683795*gN*Cos(ThetaWp()) + (5*g2*Cos(ThetaW()) -
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp()))*SUM(j1,0,1,Conj(UHIp(gI2
      ,2 + j1))*UHIp(gI1,2 + j1)));
...
std::complex<double> CLASSNAME::CpChiIChiIVZpPL(int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*((9.486832980505138*gN*Cos(ThetaWp(
      ...
      ()))*SUM(j1,0,1,Conj(ZNI(gI2,j1))*ZNI(gI1,j1)) + 2*(3.1622776601683795*gN*
      Cos(ThetaWp()) - (5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*
      Sin(ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI2,2 + j1))*ZNI(gI1,2 + j1)));
...
std::complex<double> CLASSNAME::CpChiIChiIVZpPR(int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(-((9.486832980505138*gN*Cos(
      ThetaWp()) + 2*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin
      (ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI1,j1))*ZNI(gI2,j1))) + 2*(
      -3.1622776601683795*gN*Cos(ThetaWp()) + (5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp()))*SUM(j1,0,1,Conj(ZNI(gI1,
      2 + j1))*ZNI(gI2,2 + j1)));
...
{
   const std::complex<double> result = 0.016666666666666666*((3*Sqr(gN)*Sqr(Cos
      (ThetaWp())) + 30*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())) + g1*Sin(
      ThetaW())*(2.449489742783178*gN*Sin(2*ThetaWp()) + 2*g1*Sin(ThetaW())*Sqr(
      Sin(ThetaWp()))) + Cos(ThetaW())*(9.486832980505138*g2*gN*Sin(2*ThetaWp()) +
      15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,
      Conj(ZD(gI1,j1))*ZD(gI2,j1)) + 4*(3*Sqr(gN)*Sqr(Cos(ThetaWp())) + g1*Sin(
      ThetaW())*(2.449489742783178*gN*Sin(2*ThetaWp()) + 2*g1*Sin(ThetaW())*Sqr(
      Sin(ThetaWp()))))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)));
...
{
   const std::complex<double> result = 0.016666666666666666*(4*(3*Sqr(gN)*Sqr(
      Cos(ThetaWp())) + g1*Sin(ThetaW())*(2.449489742783178*gN*Sin(2*ThetaWp()) +
      2*g1*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,Conj(ZDX(gI1,j1))*ZDX(
      gI2,j1)) + (27*Sqr(gN)*Sqr(Cos(ThetaWp())) + 2*g1*Sin(ThetaW())*(
...
std::complex<double> CLASSNAME::CpSuconjSuVZpVZp(int gI1, int gI2) const
{
   const std::complex<double> result = 0.016666666666666666*((3*Sqr(gN)*Sqr(Cos
      ...
      Sin(ThetaWp()))) - Cos(ThetaW())*(9.486832980505138*g2*gN*Sin(2*ThetaWp()) +
      15.491933384829668*g1*g2*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,
      Conj(ZU(gI1,j1))*ZU(gI2,j1)) + (-19.595917942265423*g1*gN*Cos(ThetaWp())*Sin
      (ThetaW())*Sin(ThetaWp()) + 3*Sqr(gN)*Sqr(Cos(ThetaWp())) + 32*Sqr(g1)*Sqr(
      Sin(ThetaW()))*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3
      + j1)));
...
std::complex<double> CLASSNAME::CpSdconjSdVZp(int gI2, int gI1) const
{
   const std::complex<double> result = 0.016666666666666666*((9.486832980505138
      *gN*Cos(ThetaWp()) + 2*(15*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(
      ThetaW()))*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) - 2*(
...
{
   const std::complex<double> result = 0.016666666666666666*(-2*(
      9.486832980505138*gN*Cos(ThetaWp()) + 7.745966692414834*g1*Sin(ThetaW())*Sin
      (ThetaWp()))*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDX(gI1,j1)) + (28.460498941515414
      *gN*Cos(ThetaWp()) - 15.491933384829668*g1*Sin(ThetaW())*Sin(ThetaWp()))*SUM
      (j1,0,2,Conj(ZDX(gI2,3 + j1))*ZDX(gI1,3 + j1)));
...
{
   const std::complex<double> result = 0.05*(2*(3.1622776601683795*gN*Cos(
      ThetaWp()) + (5*g2*Cos(ThetaW()) - 3.872983346207417*g1*Sin(ThetaW()))*Sin(
      ThetaWp()))*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - (3.1622776601683795*gN
      *Cos(ThetaWp()) + 15.491933384829668*g1*Sin(ThetaW())*Sin(ThetaWp()))*SUM(j1
      ,0,2,Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1)));
...
std::complex<double> CLASSNAME::CpSuconjSuVZp(int gI2, int gI1) const
{
   const std::complex<double> result = 0.016666666666666666*((9.486832980505138
      *gN*Cos(ThetaWp()) + 2*(-15*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(
      ThetaW()))*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) + (
      -9.486832980505138*gN*Cos(ThetaWp()) + 30.983866769659336*g1*Sin(ThetaW())*
...
{
   const std::complex<double> result = 0.05*(Conj(ZN(gI2,2))*(9.486832980505138
      *gN*Cos(ThetaWp()) + 2*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW
      ()))*Sin(ThetaWp()))*ZN(gI1,2) + 2*Conj(ZN(gI2,3))*(3.1622776601683795*gN*
      Cos(ThetaWp()) - (5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*
      Sin(ThetaWp()))*ZN(gI1,3) - 15.811388300841898*gN*Conj(ZN(gI2,4))*Cos(
      ThetaWp())*ZN(gI1,4));
...
{
   const std::complex<double> result = 0.05*(-(Conj(ZN(gI1,2))*(
      9.486832980505138*gN*Cos(ThetaWp()) + 2*(5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp()))*ZN(gI2,2)) + 2*Conj(ZN(
      gI1,3))*(-3.1622776601683795*gN*Cos(ThetaWp()) + 5*g2*Cos(ThetaW())*Sin(
      ThetaWp()) + 3.872983346207417*g1*Sin(ThetaW())*Sin(ThetaWp()))*ZN(gI2,3) +
      15.811388300841898*gN*Conj(ZN(gI1,4))*Cos(ThetaWp())*ZN(gI2,4));
...
{
   const std::complex<double> result = 0.5*Sqr(g2)*(Conj(UHp0(gI1,0))*UHp0(gI2,
      0) + Conj(UHp0(gI1,1))*UHp0(gI2,1));
...
{
   const std::complex<double> result = 0.5*Sqr(g2)*(Conj(UHpp(gI1,0))*UHpp(gI2,
      0) + Conj(UHpp(gI1,1))*UHpp(gI2,1));
...
{
   const std::complex<double> result = -0.7071067811865475*g2*SUM(j1,0,1,Conj(
      ZMI(gI2,j1))*ZNI(gI1,j1));
...
{
   const std::complex<double> result = 0.7071067811865475*g2*(SUM(j1,0,1,Conj(
      UHIp(gI2,j1))*UHI0(gI1,j1)) - SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*UHI0(gI1,2 +
      j1)));
...
{
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*KroneckerDelta(3,
      gO2)*ZP(gI2,1)) - 0.1*Conj(UP(gI1,1))*(10*KroneckerDelta(4,gO2)*Lambdax*ZP(
      gI2,0) + (5.477225575051661*g1*KroneckerDelta(0,gO2) + 7.0710678118654755*g2
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(2,gO1)*UM(gI1,0)*ZP(
      gI2,0)) + 0.1*UM(gI1,1)*(5.477225575051661*g1*KroneckerDelta(0,gO1)*ZP(gI2,0
      ) + 7.0710678118654755*g2*KroneckerDelta(1,gO1)*ZP(gI2,0) +
      6.708203932499369*gN*KroneckerDelta(5,gO1)*ZP(gI2,0) - 10*Conj(Lambdax)*
...
{
   const std::complex<double> result = -(g2*Conj(UM(gI2,0))*KroneckerDelta(2,
      gO2)*ZP(gI1,0)) + 0.1*Conj(UM(gI2,1))*(5.477225575051661*g1*KroneckerDelta(0
      ,gO2)*ZP(gI1,0) + 7.0710678118654755*g2*KroneckerDelta(1,gO2)*ZP(gI1,0) +
...
{
   const std::complex<double> result = 0.1*Conj(ZNp(gI2,0))*(5.477225575051661*
...
{
   const std::complex<double> result = 0.1*(-5.477225575051661*g1*
      KroneckerDelta(0,gO1) + 7.0710678118654755*g2*KroneckerDelta(1,gO1) +
      4.47213595499958*gN*KroneckerDelta(5,gO1))*UHp0(gI1,1)*ZNp(gI2,1);
...
{
   const std::complex<double> result = 0.1*Conj(UHp0(gI1,0))*(5.477225575051661
      *g1*KroneckerDelta(0,gO1) - 7.0710678118654755*g2*KroneckerDelta(1,gO1) -
...
{
   const std::complex<double> result = -1.118033988749895*gN*KroneckerDelta(5,
      gO2)*SUM(j1,0,1,Conj(ZFSI(gI2,j1))*ZSSI(gI1,j1));
...
{
   const std::complex<double> result = -1.118033988749895*gN*KroneckerDelta(5,
      gO1)*SUM(j1,0,1,Conj(ZSSI(gI1,j1))*ZFSI(gI2,j1));
...
std::complex<double> CLASSNAME::CpbarChaIUChiSHIpPL(int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -0.5477225575051661*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1))*Conj(ZPI(gI1,j1))) -
      0.7071067811865475*g2*KroneckerDelta(1,gO2)*SUM(j1,0,1,Conj(UHIp(gI2,2 + j1)
      )*Conj(ZPI(gI1,j1))) + 0.4472135954999579*gN*KroneckerDelta(5,gO2)*SUM(j1,0,
      1,Conj(UHIp(gI2,2 + j1))*Conj(ZPI(gI1,j1))) - KroneckerDelta(4,gO2)*SUM(j1,0
      ,1,Conj(UHIp(gI2,j1))*Conj(ZPI(gI1,j1))*Lambda12(j1,j1));
...
{
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,
      gO1)*SUM(j1,0,1,Conj(UHIp(gI2,j1))*ZMI(gI1,j1)) + 0.7071067811865475*g2*
...
{
   const std::complex<double> result = 0.1*(5.477225575051661*g1*KroneckerDelta
      (0,gO2) + 7.0710678118654755*g2*KroneckerDelta(1,gO2) - 4.47213595499958*gN*
...
std::complex<double> CLASSNAME::CpUChiChaPconjSHppPR(int gO1, int gI1) const
{
   const std::complex<double> result = -0.1*(5.477225575051661*g1*
      KroneckerDelta(0,gO1) + 7.0710678118654755*g2*KroneckerDelta(1,gO1) -
      4.47213595499958*gN*KroneckerDelta(5,gO1))*UHpp(gI1,1);
...
std::complex<double> CLASSNAME::CpbarFdUChiSdPL(int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -0.3651483716701107*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(ZDR(gI1,j1))) - 0.4472135954999579
      *gN*KroneckerDelta(5,gO2)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(ZDR(gI1,j1)))
      - KroneckerDelta(2,gO2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*Conj(ZDR(gI1,j1))*Yd(j1
      ,j1));
...
{
   const std::complex<double> result = -0.3651483716701107*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))*Conj(ZDXR(gI1,j1))) +
      0.6708203932499369*gN*KroneckerDelta(5,gO2)*SUM(j1,0,2,Conj(ZDX(gI2,3 + j1))
      *Conj(ZDXR(gI1,j1))) - KroneckerDelta(4,gO2)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*
      Conj(ZDXR(gI1,j1))*Kappa(j1,j1));
...
{
   const std::complex<double> result = 0.3651483716701107*g1*KroneckerDelta(0,
      gO1)*SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDXL(gI1,j1)) + 0.4472135954999579*gN*
...
std::complex<double> CLASSNAME::CpbarFeUChiSePL(int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -1.0954451150103321*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*Conj(ZER(gI1,j1))) -
      0.22360679774997896*gN*KroneckerDelta(5,gO2)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))
      *Conj(ZER(gI1,j1))) - KroneckerDelta(2,gO2)*SUM(j1,0,2,Conj(ZE(gI2,j1))*Conj
      (ZER(gI1,j1))*Ye(j1,j1));
...
std::complex<double> CLASSNAME::CpbarFuUChiSuPL(int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = 0.7302967433402214*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*Conj(ZUR(gI1,j1))) -
      0.22360679774997896*gN*KroneckerDelta(5,gO2)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))
      *Conj(ZUR(gI1,j1))) - KroneckerDelta(3,gO2)*SUM(j1,0,2,Conj(ZU(gI2,j1))*Conj
      (ZUR(gI1,j1))*Yu(j1,j1));
...
{
   const std::complex<double> result = 0.05*(-10*g2*Conj(ZN(gI2,1))*
      KroneckerDelta(2,gO2)*ZH(gI1,0) + 9.486832980505138*gN*Conj(ZN(gI2,5))*
      KroneckerDelta(2,gO2)*ZH(gI1,0) + 14.142135623730951*Conj(ZN(gI2,4))*
      KroneckerDelta(3,gO2)*Lambdax*ZH(gI1,0) + 14.142135623730951*Conj(ZN(gI2,3))
      *KroneckerDelta(4,gO2)*Lambdax*ZH(gI1,0) - 7.745966692414834*g1*Conj(ZN(gI2,
      3))*KroneckerDelta(0,gO2)*ZH(gI1,1) + 10*g2*Conj(ZN(gI2,3))*KroneckerDelta(1
      ,gO2)*ZH(gI1,1) + 10*g2*Conj(ZN(gI2,1))*KroneckerDelta(3,gO2)*ZH(gI1,1) +
      6.324555320336759*gN*Conj(ZN(gI2,5))*KroneckerDelta(3,gO2)*ZH(gI1,1) +
      6.324555320336759*gN*Conj(ZN(gI2,3))*KroneckerDelta(5,gO2)*ZH(gI1,1) +
      14.142135623730951*Conj(ZN(gI2,4))*KroneckerDelta(2,gO2)*Lambdax*ZH(gI1,1) +
      7.745966692414834*g1*Conj(ZN(gI2,0))*(KroneckerDelta(2,gO2)*ZH(gI1,0) -
      KroneckerDelta(3,gO2)*ZH(gI1,1)) - 15.811388300841898*gN*Conj(ZN(gI2,5))*
      KroneckerDelta(4,gO2)*ZH(gI1,2) - 15.811388300841898*gN*Conj(ZN(gI2,4))*
      KroneckerDelta(5,gO2)*ZH(gI1,2) + 14.142135623730951*Conj(ZN(gI2,3))*
      KroneckerDelta(2,gO2)*Lambdax*ZH(gI1,2) + Conj(ZN(gI2,2))*(7.745966692414834
      *g1*KroneckerDelta(0,gO2)*ZH(gI1,0) - 10*g2*KroneckerDelta(1,gO2)*ZH(gI1,0)
      + 1.4142135623730951*(6.708203932499369*gN*KroneckerDelta(5,gO2)*ZH(gI1,0) +
      10*Lambdax*(KroneckerDelta(4,gO2)*ZH(gI1,1) + KroneckerDelta(3,gO2)*ZH(gI1,
      2)))));
...
{
   const std::complex<double> result = 0.05*(7.745966692414834*g1*
      KroneckerDelta(0,gO1)*ZH(gI1,0)*ZN(gI2,2) - 10*g2*KroneckerDelta(1,gO1)*ZH(
      gI1,0)*ZN(gI2,2) + 9.486832980505138*gN*KroneckerDelta(5,gO1)*ZH(gI1,0)*ZN(
      gI2,2) + 14.142135623730951*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZH(gI1,1)*ZN
      (gI2,2) + 14.142135623730951*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZH(gI1,0)*
      ZN(gI2,3) - 7.745966692414834*g1*KroneckerDelta(0,gO1)*ZH(gI1,1)*ZN(gI2,3) +
      10*g2*KroneckerDelta(1,gO1)*ZH(gI1,1)*ZN(gI2,3) + 6.324555320336759*gN*
...
{
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,1,Conj(ZMI(gI2,j1))*UHIp(gI1,j1)) + 0.7071067811865475*g2*
...
{
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,1,Conj(ZNI(gI2,j1))*UHI0(gI1,j1)) - 0.7071067811865475*g2*
...
{
   const std::complex<double> result = -0.5477225575051661*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,1,Conj(UHI0(gI1,2 + j1))*Conj(ZNI(gI2,2 + j1))) +
...
{
   const std::complex<double> result = 0.5477225575051661*g1*KroneckerDelta(0,
      gO1)*SUM(j1,0,1,Conj(UHI0(gI1,j1))*ZNI(gI2,j1)) - 0.7071067811865475*g2*
...
{
   const std::complex<double> result = std::complex<double>(0,0.05)*(10*g2*Conj
      (ZN(gI1,1))*KroneckerDelta(2,gO2)*ZA(gI2,0) - 9.486832980505138*gN*Conj(ZN(
      gI1,5))*KroneckerDelta(2,gO2)*ZA(gI2,0) + 14.142135623730951*Conj(ZN(gI1,4))
      *KroneckerDelta(3,gO2)*Lambdax*ZA(gI2,0) + 14.142135623730951*Conj(ZN(gI1,3)
      ...
      ,3))*KroneckerDelta(0,gO2)*ZA(gI2,1) - 10*g2*Conj(ZN(gI1,3))*KroneckerDelta(
      1,gO2)*ZA(gI2,1) - 10*g2*Conj(ZN(gI1,1))*KroneckerDelta(3,gO2)*ZA(gI2,1) -
      ...
      (1,gO2)*ZA(gI2,0) + 1.4142135623730951*(-6.708203932499369*gN*KroneckerDelta
      (5,gO2)*ZA(gI2,0) + 10*Lambdax*(KroneckerDelta(4,gO2)*ZA(gI2,1) +
...
std::complex<double> CLASSNAME::CpChiUChiAhPR(int gI1, int gO1, int gI2) const
{
   const std::complex<double> result = std::complex<double>(0,0.05)*(
      ...
      *KroneckerDelta(4,gO1)*ZA(gI2,1)*ZN(gI1,2) - 14.142135623730951*Conj(Lambdax
      ...
      + ZA(gI2,0)*ZN(gI1,4)) + ZA(gI2,1)*(3.872983346207417*g1*ZN(gI1,0) - 5*g2*
      ZN(gI1,1) - 3.1622776601683795*gN*ZN(gI1,5))) + KroneckerDelta(2,gO1)*(
...
{
   const std::complex<double> result = -(KroneckerDelta(2,gO1)*SUM(j1,0,2,Conj(
      Yd(j1,j1))*ZD(gI1,j1)*ZDR(gI2,j1))) - 0.14907119849998596*(2.449489742783178
      *g1*KroneckerDelta(0,gO1) + 3*gN*KroneckerDelta(5,gO1))*SUM(j1,0,2,ZD(gI1,3
      + j1)*ZDR(gI2,j1));
...
{
   const std::complex<double> result = 0.3651483716701107*g1*KroneckerDelta(0,
      gO2)*SUM(j1,0,2,Conj(ZDXL(gI2,j1))*ZDX(gI1,j1)) + 0.4472135954999579*gN*
...
std::complex<double> CLASSNAME::CpUChiFDXconjSDXPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = -(KroneckerDelta(4,gO1)*SUM(j1,0,2,Conj(
      ...
      -4.898979485566356*g1*KroneckerDelta(0,gO1) + 9*gN*KroneckerDelta(5,gO1))*
      SUM(j1,0,2,ZDX(gI1,3 + j1)*ZDXR(gI2,j1));
...
{
   const std::complex<double> result = -(KroneckerDelta(2,gO1)*SUM(j1,0,2,Conj(
      Ye(j1,j1))*ZE(gI1,j1)*ZER(gI2,j1))) - 0.22360679774997896*(4.898979485566356
      *g1*KroneckerDelta(0,gO1) + gN*KroneckerDelta(5,gO1))*SUM(j1,0,2,ZE(gI1,3 +
      j1)*ZER(gI2,j1));
...
{
   const std::complex<double> result = -(KroneckerDelta(3,gO1)*SUM(j1,0,2,Conj(
      Yu(j1,j1))*ZU(gI1,j1)*ZUR(gI2,j1))) + 0.07453559924999298*(9.797958971132712
      *g1*KroneckerDelta(0,gO1) - 3*gN*KroneckerDelta(5,gO1))*SUM(j1,0,2,ZU(gI1,3
      + j1)*ZUR(gI2,j1));
...
{
   const std::complex<double> result = -0.1*Conj(UHpp(gI2,1))*(
      5.477225575051661*g1*KroneckerDelta(0,gO2) + 7.0710678118654755*g2*
      KroneckerDelta(1,gO2) - 4.47213595499958*gN*KroneckerDelta(5,gO2));
...
{
   const std::complex<double> result = 0.1*Conj(UHpp(gI2,0))*(5.477225575051661
      *g1*KroneckerDelta(0,gO1) + 7.0710678118654755*g2*KroneckerDelta(1,gO1) -
...
{
   const std::complex<double> result = 0.05*(15.811388300841898*gN*Conj(ZN(gI2,
      4))*KroneckerDelta(4,gO1)*Sin(ThetaWp()) + Conj(ZN(gI2,2))*KroneckerDelta(2,
      gO1)*(10*g2*Cos(ThetaW())*Cos(ThetaWp()) + 7.745966692414834*g1*Cos(ThetaWp(
...
{
   const std::complex<double> result = 0.05*(15.811388300841898*gN*Conj(ZN(gI2,
      4))*Cos(ThetaWp())*KroneckerDelta(4,gO1) + 2*Conj(ZN(gI2,3))*KroneckerDelta(
      3,gO1)*(-3.1622776601683795*gN*Cos(ThetaWp()) + 5*g2*Cos(ThetaW())*Sin(
      ThetaWp()) + 3.872983346207417*g1*Sin(ThetaW())*Sin(ThetaWp())) - Conj(ZN(
      gI2,2))*KroneckerDelta(2,gO1)*(9.486832980505138*gN*Cos(ThetaWp()) + 2*(5*g2
      *Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp())));
...
{
   const std::complex<double> result = -(g2*Conj(UHpp(gI1,0))*KroneckerDelta(0,
      gO1)*ZNp(gI2,0));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*(g2*Conj(UM(gI1,0))*KroneckerDelta(1,gO2)*ZA(gI2,1) +
      Conj(UM(gI1,1))*(g2*KroneckerDelta(0,gO2)*ZA(gI2,0) - KroneckerDelta(1,gO2)*
      Lambdax*ZA(gI2,2)));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*(g2*KroneckerDelta(0,gO1)*UP(gI1,1)*ZA(gI2,1) +
      KroneckerDelta(1,gO1)*(g2*UP(gI1,0)*ZA(gI2,0) - Conj(Lambdax)*UP(gI1,1)*ZA(
      gI2,2)));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*ZN(gI2,2)*ZP(
      gI1,0)) + 0.1*KroneckerDelta(1,gO1)*(5.477225575051661*g1*ZN(gI2,0)*ZP(gI1,0
      ) + 7.0710678118654755*g2*ZN(gI2,1)*ZP(gI1,0) + 6.708203932499369*gN*ZN(gI2,
      5)*ZP(gI1,0) - 10*Conj(Lambdax)*ZN(gI2,4)*ZP(gI1,1));
...
{
   const std::complex<double> result = KroneckerDelta(1,gO1)*SUM(j1,0,2,Conj(Ye
      (j1,j1))*ZER(gI2,j1)*ZV(gI1,j1));
...
std::complex<double> CLASSNAME::CpbarUChabarFuSdPR(int gO1, int gI1, int gI2) const
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*SUM(j1,0,2,
      Conj(ZD(gI2,j1))*ZUL(gI1,j1))) + KroneckerDelta(1,gO1)*SUM(j1,0,2,Conj(Yd(j1
      ,j1))*Conj(ZD(gI2,3 + j1))*ZUL(gI1,j1));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO2)*SUM(j1,0,1,
      Conj(ZMI(gI2,j1))*UHI0(gI1,j1)));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*SUM(j1,0,1,
      UHI0(gI1,2 + j1)*ZPI(gI2,j1)));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO2)*SUM(j1,0,1,
      Conj(UHIp(gI1,2 + j1))*Conj(ZNI(gI2,2 + j1))));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO2)*SUM(j1,0,2,
      Conj(ZDL(gI2,j1))*ZU(gI1,j1))) + KroneckerDelta(1,gO2)*SUM(j1,0,2,Conj(ZDL(
      gI2,j1))*Yu(j1,j1)*ZU(gI1,3 + j1));
...
{
   const std::complex<double> result = KroneckerDelta(1,gO1)*SUM(j1,0,2,Conj(Yd
      (j1,j1))*ZDR(gI2,j1)*ZU(gI1,j1));
...
{
   const std::complex<double> result = 0.05*(20*g2*Conj(UM(gI2,0))*Cos(ThetaW()
      )*Cos(ThetaWp())*KroneckerDelta(0,gO1) + Conj(UM(gI2,1))*KroneckerDelta(1,
      gO1)*(10*g2*Cos(ThetaW())*Cos(ThetaWp()) - 7.745966692414834*g1*Cos(ThetaWp(
      ))*Sin(ThetaW()) + 9.486832980505138*gN*Sin(ThetaWp())));
...
{
   const std::complex<double> result = 0.1*(-10*g2*Cos(ThetaW())*KroneckerDelta
      (0,gO2)*Sin(ThetaWp())*UP(gI2,0) + KroneckerDelta(1,gO2)*(
      -3.1622776601683795*gN*Cos(ThetaWp()) + (-5*g2*Cos(ThetaW()) +
...
{
   const std::complex<double> result = 0.05*(-20*g2*Conj(UM(gI2,0))*Cos(ThetaW(
      ))*KroneckerDelta(0,gO1)*Sin(ThetaWp()) + Conj(UM(gI2,1))*KroneckerDelta(1,
      gO1)*(9.486832980505138*gN*Cos(ThetaWp()) + 2*(-5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp())));
...
{
   const std::complex<double> result = IF(gI2 < 3,KroneckerDelta(gI2,gO2)*Ye(
      gI2,gI2)*ZP(gI1,0),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(UM(gI2,1))*Conj(ZV(gI1,
      gO2))*Ye(gO2,gO2),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZEL(
      gI2,gO2))*Ye(gO2,gO2)*ZH(gI1,0),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(Ye(
      gO1,gO1))*ZER(gI2,gO1)*ZH(gI1,0),0);
...
std::complex<double> CLASSNAME::CpbarUFeChiSePL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO2 < 3,-1.0954451150103321*g1*Conj(
      ZE(gI1,3 + gO2))*Conj(ZN(gI2,0)),0) + IF(gO2 < 3,-0.22360679774997896*gN*
      Conj(ZE(gI1,3 + gO2))*Conj(ZN(gI2,5)),0) + IF(gO2 < 3,-(Conj(ZE(gI1,gO2))*
      Conj(ZN(gI2,2))*Ye(gO2,gO2)),0);
...
std::complex<double> CLASSNAME::CpbarUFeChiSePR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,0.5477225575051661*g1*Conj(ZE
      ...
      *ZN(gI2,1),0) + IF(gO1 < 3,-(Conj(Ye(gO1,gO1))*Conj(ZE(gI1,3 + gO1))*ZN(gI2,
      2)),0) + IF(gO1 < 3,-0.4472135954999579*gN*Conj(ZE(gI1,gO1))*ZN(gI2,5),0);
...
std::complex<double> CLASSNAME::CpbarUFeFeVZPL(int gO1, int gI2) const
{
   const std::complex<double> result = IF(gI2 < 3,0.5*g2*Conj(ZEL(gI2,gO1))*Cos
      (ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 3,-0.3872983346207417*g1*Conj(ZEL(
      gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-0.31622776601683794*
      gN*Conj(ZEL(gI2,gO1))*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gI2 < 3,-0.31622776601683794*gN*Conj(
      ZEL(gI2,gO1))*Cos(ThetaWp()),0) + IF(gI2 < 3,-0.5*g2*Conj(ZEL(gI2,gO1))*Cos(
...
{
   const std::complex<double> result = IF(gO1 < 3,Conj(Yu(gO1,gO1))*ZP(gI1,1)*
      ZUR(gI2,gO1),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZDL(
      gI2,gO2))*Yd(gO2,gO2)*ZH(gI1,0),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(Yd(
      gO1,gO1))*ZDR(gI2,gO1)*ZH(gI1,0),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(UM(gI2,1))*Conj(ZU(gI1,
      gO2))*Yd(gO2,gO2),0);
...
std::complex<double> CLASSNAME::CpbarUFdChaSuPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(ZU(gI1,gO1))*UP(gI2
      ,0)),0) + IF(gO1 < 3,Conj(Yu(gO1,gO1))*Conj(ZU(gI1,3 + gO1))*UP(gI2,1),0);
...
std::complex<double> CLASSNAME::CpbarUFdChiSdPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.3651483716701107*g1*Conj(
      ZD(gI1,3 + gO2))*Conj(ZN(gI2,0)),0) + IF(gO2 < 3,-0.4472135954999579*gN*Conj
      (ZD(gI1,3 + gO2))*Conj(ZN(gI2,5)),0) + IF(gO2 < 3,-(Conj(ZD(gI1,gO2))*Conj(
      ZN(gI2,2))*Yd(gO2,gO2)),0);
...
std::complex<double> CLASSNAME::CpbarUFdChiSdPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.18257418583505536*g1*Conj(
      ...
      ))*ZN(gI2,1),0) + IF(gO1 < 3,-(Conj(Yd(gO1,gO1))*Conj(ZD(gI1,3 + gO1))*ZN(
      gI2,2)),0) + IF(gO1 < 3,-0.22360679774997896*gN*Conj(ZD(gI1,gO1))*ZN(gI2,5),
      0);
...
std::complex<double> CLASSNAME::CpbarUFdFdVZPL(int gO1, int gI2) const
{
   const std::complex<double> result = IF(gI2 < 3,0.5*g2*Conj(ZDL(gI2,gO1))*Cos
      (ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 3,0.12909944487358055*g1*Conj(ZDL(
      gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-0.15811388300841897*
      gN*Conj(ZDL(gI2,gO1))*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gI2 < 3,-0.15811388300841897*gN*Conj(
      ZDL(gI2,gO1))*Cos(ThetaWp()),0) + IF(gI2 < 3,-0.5*g2*Conj(ZDL(gI2,gO1))*Cos(
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(UP(gI1,1))*Conj(ZD(gI2,
      gO2))*Yu(gO2,gO2),0);
...
std::complex<double> CLASSNAME::CpbarChabarUFuSdPR(int gI1, int gO1, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(ZD(gI2,gO1))*UM(gI1
      ,0)),0) + IF(gO1 < 3,Conj(Yd(gO1,gO1))*Conj(ZD(gI2,3 + gO1))*UM(gI1,1),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZUL(
      gI2,gO2))*Yu(gO2,gO2)*ZH(gI1,1),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(Yu(
      gO1,gO1))*ZH(gI1,1)*ZUR(gI2,gO1),0);
...
std::complex<double> CLASSNAME::CpbarUFuChiSuPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.18257418583505536*g1*Conj(
      ...
      gO1))*ZN(gI2,1),0) + IF(gO1 < 3,-(Conj(Yu(gO1,gO1))*Conj(ZU(gI1,3 + gO1))*ZN
      (gI2,3)),0) + IF(gO1 < 3,-0.22360679774997896*gN*Conj(ZU(gI1,gO1))*ZN(gI2,5)
      ,0);
...
std::complex<double> CLASSNAME::CpbarUFuFuVZPL(int gO1, int gI2) const
{
   const std::complex<double> result = IF(gI2 < 3,-0.5*g2*Conj(ZUL(gI2,gO1))*
      Cos(ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 3,0.12909944487358055*g1*Conj(ZUL
      (gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-0.15811388300841897
      *gN*Conj(ZUL(gI2,gO1))*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gI2 < 3,-0.15811388300841897*gN*Conj(
      ZUL(gI2,gO1))*Cos(ThetaWp()),0) + IF(gI2 < 3,0.5*g2*Conj(ZUL(gI2,gO1))*Cos(
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(
      Kappa(gO1,gO1))*ZDXR(gI2,gO1)*ZH(gI1,2),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.3651483716701107*g1*Conj(
      ZDX(gI1,3 + gO2))*Conj(ZN(gI2,0)),0) + IF(gO2 < 3,0.6708203932499369*gN*Conj
      (ZDX(gI1,3 + gO2))*Conj(ZN(gI2,5)),0) + IF(gO2 < 3,-(Conj(ZDX(gI1,gO2))*Conj
      (ZN(gI2,4))*Kappa(gO2,gO2)),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,0.3651483716701107*g1*Conj(
      ZDX(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 3,-(Conj(ZDX(gI1,3 + gO1))*Conj(Kappa(
      gO1,gO1))*ZN(gI2,4)),0) + IF(gO1 < 3,0.4472135954999579*gN*Conj(ZDX(gI1,gO1)
      )*ZN(gI2,5),0);
...
{
   const std::complex<double> result = IF(gI2 < 3,0.2581988897471611*g1*Conj(
      ZDXL(gI2,gO1))*Cos(ThetaW()),0);
...
{
   const std::complex<double> result = IF(gI2 < 3,-0.2581988897471611*g1*Conj(
      ZDXL(gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,
      0.31622776601683794*gN*Conj(ZDXL(gI2,gO1))*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gI2 < 3,0.31622776601683794*gN*Conj(
      ZDXL(gI2,gO1))*Cos(ThetaWp()),0) + IF(gI2 < 3,0.2581988897471611*g1*Conj(
      ZDXL(gI2,gO1))*Sin(ThetaW())*Sin(ThetaWp()),0);
...
{
   const std::complex<double> result = IF(gO2 < 2,-0.7071067811865475*Conj(ZMI(
      gI2,gO2))*ZH(gI1,2)*Lambda12(gO2,gO2),0);
...
{
   const std::complex<double> result = IF(gO1 < 2,-(g2*Conj(UHI0(gI1,gO1))*UP(
      gI2,0)),0);
...
{
   const std::complex<double> result = IF(gO2 < 2,-0.5477225575051661*g1*Conj(
      UHIp(gI1,2 + gO2))*Conj(ZN(gI2,0)),0) + IF(gO2 < 2,-0.7071067811865475*g2*
      Conj(UHIp(gI1,2 + gO2))*Conj(ZN(gI2,1)),0) + IF(gO2 < 2,0.4472135954999579*
      gN*Conj(UHIp(gI1,2 + gO2))*Conj(ZN(gI2,5)),0) + IF(gO2 < 2,-(Conj(UHIp(gI1,
      gO2))*Conj(ZN(gI2,4))*Lambda12(gO2,gO2)),0);
...
{
   const std::complex<double> result = IF(gO1 < 2,0.5477225575051661*g1*Conj(
      UHIp(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 2,0.7071067811865475*g2*Conj(UHIp(gI1
      ,gO1))*ZN(gI2,1),0) + IF(gO1 < 2,-(Conj(UHIp(gI1,2 + gO1))*Conj(Lambda12(gO1
      ,gO1))*ZN(gI2,4)),0) + IF(gO1 < 2,0.6708203932499369*gN*Conj(UHIp(gI1,gO1))*
      ZN(gI2,5),0);
...
{
   const std::complex<double> result = IF(gI2 < 2,0.3872983346207417*g1*Cos(
      ThetaW())*ZPI(gI2,gO2),0) + IF(gI2 < 2,0.5*g2*Sin(ThetaW())*ZPI(gI2,gO2),0);
...
{
   const std::complex<double> result = IF(gI2 < 2,0.3872983346207417*g1*Conj(
      ZMI(gI2,gO1))*Cos(ThetaW()),0) + IF(gI2 < 2,0.5*g2*Conj(ZMI(gI2,gO1))*Sin(
      ThetaW()),0);
...
{
   const std::complex<double> result = IF(gI2 < 2,0.5*g2*Cos(ThetaW())*Cos(
      ThetaWp())*ZPI(gI2,gO2),0) + IF(gI2 < 2,-0.3872983346207417*g1*Cos(ThetaWp()
      )*Sin(ThetaW())*ZPI(gI2,gO2),0) + IF(gI2 < 2,-0.31622776601683794*gN*Sin(
...
std::complex<double> CLASSNAME::CpbarUChaIChaIVZPL(int gO1, int gI2) const
{
   const std::complex<double> result = IF(gI2 < 2,0.5*g2*Conj(ZMI(gI2,gO1))*Cos
      (ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 2,-0.3872983346207417*g1*Conj(ZMI(
      gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 2,0.4743416490252569*gN
...
{
   const std::complex<double> result = IF(gI2 < 2,0.4743416490252569*gN*Conj(
      ZMI(gI2,gO1))*Cos(ThetaWp()),0) + IF(gI2 < 2,-0.5*g2*Conj(ZMI(gI2,gO1))*Cos(
...
{
   const std::complex<double> result = IF(gO2 < 2,0.7071067811865475*g2*ZNI(gI2
      ,2 + gO2),0);
...
{
   const std::complex<double> result = IF(gO1 < 2,-0.7071067811865475*g2*Conj(
      ZNI(gI2,gO1)),0);
...
{
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*SUM(j1,0,1,Conj(
      UHIp(gI2,2 + j1))*KroneckerDelta(gO2,2 + j1)));
...
{
   const std::complex<double> result = IF(gO1 < 2,-(g2*Conj(UHIp(gI2,gO1))*UM(
      gI1,0)),0);
...
{
   const std::complex<double> result = IF(gO2 < 2,-0.7071067811865475*g2*ZMI(
      gI1,gO2),0);
...
{
   const std::complex<double> result = 0.7071067811865475*g2*SUM(j1,0,1,Conj(
      ZPI(gI1,j1))*KroneckerDelta(gO1,2 + j1));
...
{
   const std::complex<double> result = IF(gO2 < 2,0.7071067811865475*Conj(ZNI(
      gI2,2 + gO2))*ZH(gI1,2)*Lambda12(gO2,gO2),0) + 0.7071067811865475*SUM(j1,0,1
...
{
   const std::complex<double> result = IF(gO1 < 2,0.7071067811865475*Conj(
      Lambda12(gO1,gO1))*ZH(gI1,2)*ZNI(gI2,2 + gO1),0) + 0.7071067811865475*SUM(j1
      ,0,1,Conj(Lambda12(j1,j1))*KroneckerDelta(gO1,2 + j1)*ZNI(gI2,j1))*ZH(gI1,2)
      ;
...
{
   const std::complex<double> result = -(g2*SUM(j1,0,1,KroneckerDelta(gO1,2 +
      j1)*UHIp(gI1,2 + j1))*UP(gI2,0));
...
std::complex<double> CLASSNAME::CpChiUChiISHI0PL(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = -0.5477225575051661*g1*Conj(ZN(gI2,0))*
      SUM(j1,0,1,Conj(UHI0(gI1,2 + j1))*KroneckerDelta(gO2,2 + j1)) +
...
{
   const std::complex<double> result = IF(gO1 < 2,0.5477225575051661*g1*Conj(
      UHI0(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 2,-0.7071067811865475*g2*Conj(UHI0(
      gI1,gO1))*ZN(gI2,1),0) + IF(gO1 < 2,Conj(UHI0(gI1,2 + gO1))*Conj(Lambda12(
      gO1,gO1))*ZN(gI2,4),0) + IF(gO1 < 2,0.6708203932499369*gN*Conj(UHI0(gI1,gO1)
      )*ZN(gI2,5),0);
...
{
   const std::complex<double> result = IF(gO1 < 2,-0.4743416490252569*gN*Conj(
      ZNI(gI2,gO1))*Cos(ThetaWp()),0) + IF(gO1 < 2,-0.5*g2*Conj(ZNI(gI2,gO1))*Cos(
...
{
   const std::complex<double> result = -(g2*Conj(UHpp(gI2,0))*KroneckerDelta(0,
      gO1)*UM(gI1,0));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(1,gO1)*UHpp(gI1,1)*
      UP(gI2,0));
...
std::complex<double> CLASSNAME::CpChiUChiPconjSHp0PL(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.1*(5.477225575051661*g1*Conj(ZN(gI2,0)
      ...
      5)))*KroneckerDelta(0,gO2)*UHp0(gI1,0);
...
{
   const std::complex<double> result = 0.1*Conj(UHp0(gI1,1))*(
      -5.477225575051661*g1*Conj(ZN(gI2,0)) + 7.0710678118654755*g2*Conj(ZN(gI2,1)
...
{
   const std::complex<double> result = 0.1*Conj(UHp0(gI1,0))*KroneckerDelta(0,
      gO1)*(5.477225575051661*g1*ZN(gI2,0) - 7.0710678118654755*g2*ZN(gI2,1) -
      4.47213595499958*gN*ZN(gI2,5));
...
{
   const std::complex<double> result = 0.1*(Conj(ZNp(gI2,0))*KroneckerDelta(0,
      gO1) - Conj(ZNp(gI2,1))*KroneckerDelta(1,gO1))*(5*g2*Cos(ThetaW())*Cos(
      ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW()) +
      3.1622776601683795*gN*Sin(ThetaWp()));
...
{
   const std::complex<double> result = 0.1*(Conj(ZNp(gI2,0))*KroneckerDelta(0,
      gO1) - Conj(ZNp(gI2,1))*KroneckerDelta(1,gO1))*(3.1622776601683795*gN*Cos(
      ThetaWp()) - (5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(
      ThetaWp()));
...
{
   const std::complex<double> result = 1.4142135623730951*g3*PhaseGlu*SUM(j1,0,
      2,Conj(ZDX(gI2,3 + j1))*Conj(ZDXR(gI1,j1)));
...
{
   const std::complex<double> result = -1.4142135623730951*g3*Conj(PhaseGlu)*
      SUM(j1,0,2,Conj(ZDX(gI2,j1))*ZDXL(gI1,j1));
...
std::complex<double> CLASSNAME::CpbarChabarFvSePR(int gI1, int gO1, int gI2) const
{
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(ZE(gI2,gO1))*UM(gI1
      ,0)),0) + IF(gO1 < 3,Conj(Ye(gO1,gO1))*Conj(ZE(gI2,3 + gO1))*UM(gI1,1),0);
...
std::complex<double> CLASSNAME::CpbarFvChiSvPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,0.5477225575051661*g1*Conj(ZV
      ...
      )*ZN(gI2,1),0) + IF(gO1 < 3,-0.4472135954999579*gN*Conj(ZV(gI1,gO1))*ZN(gI2,
      5),0);
...
{
   const std::complex<double> result = -0.1*Conj(UHpp(gI1,1))*(
      5.477225575051661*g1*Conj(ZN(gI2,0)) + 7.0710678118654755*g2*Conj(ZN(gI2,1))
...
{
   const std::complex<double> result = 0.1*Conj(UHpp(gI1,0))*(5.477225575051661
      *g1*ZN(gI2,0) + 7.0710678118654755*g2*ZN(gI2,1) - 4.47213595499958*gN*ZN(gI2
      ,5));
...
{
   const std::complex<double> result = Conj(UM(gI2,1))*SUM(j1,0,2,Conj(ZER(gO2,
      j1))*Conj(ZV(gI1,j1))*Ye(j1,j1));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*SUM(j1,0,2,Conj(ZEL(gI1,j1))*Conj(ZER(gO2,j1))*Ye(j1,j1
      ))*ZA(gI2,0);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*SUM(j1,0,2,Conj(Ye(j1,j1))*ZEL(gO1,j1)*ZER(gI1,j1))*ZA(
      gI2,0);
...
{
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(ZEL(
      gI2,j1))*Conj(ZER(gO2,j1))*Ye(j1,j1))*ZH(gI1,0);
...
{
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(Ye(
      j1,j1))*ZEL(gO1,j1)*ZER(gI2,j1))*ZH(gI1,0);
...
std::complex<double> CLASSNAME::CpbarFeChiSePL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = -1.0954451150103321*g1*Conj(ZN(gI2,0))*
      SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*Conj(ZER(gO2,j1))) - 0.22360679774997896*gN*
      Conj(ZN(gI2,5))*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*Conj(ZER(gO2,j1))) - Conj(ZN
      (gI2,2))*SUM(j1,0,2,Conj(ZE(gI1,j1))*Conj(ZER(gO2,j1))*Ye(j1,j1));
...
{
   const std::complex<double> result = -(SUM(j1,0,2,Conj(Ye(j1,j1))*Conj(ZE(gI1
      ,3 + j1))*ZEL(gO1,j1))*ZN(gI2,2)) + SUM(j1,0,2,Conj(ZE(gI1,j1))*ZEL(gO1,j1))
...
{
   const std::complex<double> result = SUM(j1,0,2,Conj(ZDR(gO2,j1))*Conj(ZUL(
      gI2,j1))*Yd(j1,j1))*ZP(gI1,0);
...
{
   const std::complex<double> result = SUM(j1,0,2,Conj(Yu(j1,j1))*ZDL(gO1,j1)*
      ZUR(gI2,j1))*ZP(gI1,1);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*SUM(j1,0,2,Conj(ZDL(gI1,j1))*Conj(ZDR(gO2,j1))*Yd(j1,j1
      ))*ZA(gI2,0);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*SUM(j1,0,2,Conj(Yd(j1,j1))*ZDL(gO1,j1)*ZDR(gI1,j1))*ZA(
      gI2,0);
...
{
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(ZDL(
      gI2,j1))*Conj(ZDR(gO2,j1))*Yd(j1,j1))*ZH(gI1,0);
...
{
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(Yd(
      j1,j1))*ZDL(gO1,j1)*ZDR(gI2,j1))*ZH(gI1,0);
...
{
   const std::complex<double> result = Conj(UM(gI2,1))*SUM(j1,0,2,Conj(ZDR(gO2,
      j1))*Conj(ZU(gI1,j1))*Yd(j1,j1));
...
std::complex<double> CLASSNAME::CpbarFdChaSuPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = -(g2*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZDL(gO1
      ,j1))*UP(gI2,0)) + SUM(j1,0,2,Conj(Yu(j1,j1))*Conj(ZU(gI1,3 + j1))*ZDL(gO1,
      j1))*UP(gI2,1);
...
std::complex<double> CLASSNAME::CpbarFdChiSdPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = -0.3651483716701107*g1*Conj(ZN(gI2,0))*
      SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*Conj(ZDR(gO2,j1))) - 0.4472135954999579*gN*
      Conj(ZN(gI2,5))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*Conj(ZDR(gO2,j1))) - Conj(ZN
      (gI2,2))*SUM(j1,0,2,Conj(ZD(gI1,j1))*Conj(ZDR(gO2,j1))*Yd(j1,j1));
...
{
   const std::complex<double> result = 0.03333333333333333*(-30*SUM(j1,0,2,Conj
      (Yd(j1,j1))*Conj(ZD(gI1,3 + j1))*ZDL(gO1,j1))*ZN(gI2,2) - SUM(j1,0,2,Conj(ZD
      (gI1,j1))*ZDL(gO1,j1))*(5.477225575051661*g1*ZN(gI2,0) - 21.213203435596427*
      g2*ZN(gI2,1) + 6.708203932499369*gN*ZN(gI2,5)));
...
{
   const std::complex<double> result = SUM(j1,0,2,Conj(ZDL(gI2,j1))*Conj(ZUR(
      gO2,j1))*Yu(j1,j1))*ZP(gI1,1);
...
{
   const std::complex<double> result = SUM(j1,0,2,Conj(Yd(j1,j1))*ZDR(gI2,j1)*
      ZUL(gO1,j1))*ZP(gI1,0);
...
{
   const std::complex<double> result = Conj(UP(gI1,1))*SUM(j1,0,2,Conj(ZD(gI2,
      j1))*Conj(ZUR(gO2,j1))*Yu(j1,j1));
...
std::complex<double> CLASSNAME::CpbarChabarFuSdPR(int gI1, int gO1, int gI2) const
{
   const std::complex<double> result = -(g2*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZUL(gO1
      ,j1))*UM(gI1,0)) + SUM(j1,0,2,Conj(Yd(j1,j1))*Conj(ZD(gI2,3 + j1))*ZUL(gO1,
      j1))*UM(gI1,1);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*SUM(j1,0,2,Conj(ZUL(gI1,j1))*Conj(ZUR(gO2,j1))*Yu(j1,j1
      ))*ZA(gI2,1);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*SUM(j1,0,2,Conj(Yu(j1,j1))*ZUL(gO1,j1)*ZUR(gI1,j1))*ZA(
      gI2,1);
...
{
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(ZUL(
      gI2,j1))*Conj(ZUR(gO2,j1))*Yu(j1,j1))*ZH(gI1,1);
...
{
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(Yu(
      j1,j1))*ZUL(gO1,j1)*ZUR(gI2,j1))*ZH(gI1,1);
...
std::complex<double> CLASSNAME::CpbarFuChiSuPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = 0.7302967433402214*g1*Conj(ZN(gI2,0))*
      SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(ZUR(gO2,j1))) - 0.22360679774997896*gN*
      Conj(ZN(gI2,5))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(ZUR(gO2,j1))) - Conj(ZN
      (gI2,3))*SUM(j1,0,2,Conj(ZU(gI1,j1))*Conj(ZUR(gO2,j1))*Yu(j1,j1));
...
{
   const std::complex<double> result = 0.03333333333333333*(-30*SUM(j1,0,2,Conj
      (Yu(j1,j1))*Conj(ZU(gI1,3 + j1))*ZUL(gO1,j1))*ZN(gI2,3) - SUM(j1,0,2,Conj(ZU
      (gI1,j1))*ZUL(gO1,j1))*(5.477225575051661*g1*ZN(gI2,0) + 21.213203435596427*
      g2*ZN(gI2,1) + 6.708203932499369*gN*ZN(gI2,5)));
...
std::complex<double> CLASSNAME::self_energy_Sd_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSdconjHpmconjUSd(gI1,gO1,gI1
      ,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUSdSHp0conjUSdconjSHp0(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUSdSHppconjUSdconjSHpp(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSdSSI0conjUSdconjSSI0(gO1,gI1,
      gO2,gI1));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSdconjUSd(gI1,gI1,gO1,
      gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSdconjUSd(gI1,gI1,gO1,
      gO2));
   ...
   result += -2*SUM(gI1,0,2,MFd(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFd(gI1)),Sqr(
      ...
      MChi(gI2)));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpUSdSHI0conjUSdconjSHI0(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUSdSHIpconjUSdconjSHIp(gO1,gI1,
      gO2,gI1));
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSd(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSdconjUSd(gI2,gI1,gO2))*CpAhSdconjUSd(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSd(gI1)),Sqr(Mhh(gI2)))*
   ...
   result += SUM(gI2,0,5,Conj(CpSdconjUSdVZp(gI2,gO2))*CpSdconjUSdVZp(gI2,gO1)*
      F0(Sqr(p),Sqr(MSd(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_Sv_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSvconjHpmconjUSv(gI1,gO1,gI1
      ,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpSHp0USvconjSHp0conjUSv(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpSHppUSvconjSHppconjUSv(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpSSI0USvconjSSI0conjUSv(gI1,gO1,
      gI1,gO2));
   ...
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSvconjUSv(gI1,gI1,gO1,
      gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSvconjUSv(gI1,gI1,gO1,
      gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpSvUSvconjSvconjUSv(gI1,gO1,gI1,
      gO2));
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(Mhh(gI2)))*
   ...
   result += -2*SUM(gI1,0,2,MFv(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(
      ...
      MChi(gI2)));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USvconjSHI0conjUSv(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpSHIpUSvconjSHIpconjUSv(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSvconjSdconjUSv(gI1,gO1,gI1,
      gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSvconjSDXconjUSv(gI1,gO1,
      gI1,gO2));
   ...
   result += SUM(gI2,0,2,Conj(CpSvconjUSvVZp(gI2,gO2))*CpSvconjUSvVZp(gI2,gO1)*
      F0(Sqr(p),Sqr(MSv(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_Su_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSuconjHpmconjUSu(gI1,gO1,gI1
      ,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpSHp0USuconjSHp0conjUSu(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpSHppUSuconjSHppconjUSu(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpSSI0USuconjSSI0conjUSu(gI1,gO1,
      gI1,gO2));
   ...
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSuconjUSu(gI1,gI1,gO1,
      gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSuconjUSu(gI1,gI1,gO1,
      gO2));
   ...
   result += -2*SUM(gI1,0,2,MFu(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFu(gI1)),Sqr(
      ...
      MChi(gI2)));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USuconjSHI0conjUSu(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpSHIpUSuconjSHIpconjUSu(gI1,gO1,
      gI1,gO2));
   ...
   result += -SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSuconjUSuconjSuSu(gO1,gO2,gI1,
      gI1));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSu(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSuconjUSu(gI2,gI1,gO2))*CpAhSuconjUSu(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSu(gI1)),Sqr(Mhh(gI2)))*
   ...
   result += SUM(gI2,0,5,Conj(CpSuconjUSuVZp(gI2,gO2))*CpSuconjUSuVZp(gI2,gO1)*
      F0(Sqr(p),Sqr(MSu(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_Se_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSeconjHpmconjUSe(gI1,gO1,gI1
      ,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUSeSHp0conjUSeconjSHp0(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUSeSHppconjUSeconjSHpp(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSeSSI0conjUSeconjSSI0(gO1,gI1,
      gO2,gI1));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSeconjUSe(gI1,gI1,gO1,
      gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSeconjUSe(gI1,gI1,gO1,
      gO2));
   ...
   result += -2*SUM(gI1,0,2,MFe(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFe(gI1)),Sqr(
      ...
      MChi(gI2)));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpUSeSHI0conjUSeconjSHI0(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUSeSHIpconjUSeconjSHIp(gO1,gI1,
      gO2,gI1));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSeconjSdconjUSe(gI1,gO1,gI1,
      gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSeconjSDXconjUSe(gI1,gO1,
      gI1,gO2));
   ...
   result += -3*SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSeSuconjUSeconjSu(gO1,gI1,gO2,
      gI1));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSe(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSeconjUSe(gI2,gI1,gO2))*CpAhSeconjUSe(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSe(gI1)),Sqr(Mhh(gI2)))*
   ...
   result += SUM(gI2,0,5,Conj(CpSeconjUSeVZp(gI2,gO2))*CpSeconjUSeVZp(gI2,gO1)*
      F0(Sqr(p),Sqr(MSe(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_SDX_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSDXconjHpmconjUSDX(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUSDXSHp0conjUSDXconjSHp0(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUSDXSHppconjUSDXconjSHpp(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSDXSSI0conjUSDXconjSSI0(gO1,
      gI1,gO2,gI1));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSDXconjUSDX(gI1,gI1,gO1,
      gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSDXconjUSDX(gI1,gI1,gO1,
      gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpUSDXSvconjUSDXconjSv(gO1,gI1,gO2,
      gI1));
   ...
   result += -2*SUM(gI1,0,2,MFDX(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFDX(gI1)),Sqr(
      ...
      gO1))*MChi(gI2)));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpUSDXSHI0conjUSDXconjSHI0(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUSDXSHIpconjUSDXconjSHIp(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpUSDXconjUSDXconjSdSd(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpUSDXconjUSDXconjSDXSDX(gO1,gO2,
      gI1,gI1));
   result += -SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSDXconjUSDXconjSuSu(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,5,A0(Sqr(MSe(gI1)))*CpUSDXSeconjUSDXconjSe(gO1,gI1,gO2,
      gI1));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSDX(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSDXconjUSDX(gI2,gI1,gO2))*CpAhSDXconjUSDX(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSDX(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhSDXconjUSDX(gI2,gI1,gO2))*CphhSDXconjUSDX(gI2,gI1,gO1)));
   ...
   result += -2.6666666666666665*MGlu*SUM(gI2,0,2,B0(Sqr(p),Sqr(MGlu),Sqr(MFDX(
      gI2)))*(Conj(CpGluFDXconjUSDXPR(gI2,gO2))*CpGluFDXconjUSDXPL(gI2,gO1) + Conj
   ...
   result += SUM(gI2,0,5,Conj(CpSDXconjUSDXVZp(gI2,gO2))*CpSDXconjUSDXVZp(gI2,
      gO1)*F0(Sqr(p),Sqr(MSDX(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_hh_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -(B0(Sqr(p),Sqr(MVZp),Sqr(MVZp))*CpbargZpgZpUhh(gO1)*
      CpbargZpgZpUhh(gO2));
   result += -2*B0(Sqr(p),Sqr(MVZ),Sqr(MVZp))*CpbargZpgZUhh(gO1)*CpbargZpgZUhh(
      gO2);
   ...
   result += 2*B0(Sqr(p),Sqr(MVZp),Sqr(MVZp))*Conj(CpUhhVZpVZp(gO2))*
      CpUhhVZpVZp(gO1);
   result += 2*B0(Sqr(p),Sqr(MVZ),Sqr(MVZ))*Conj(CpUhhVZVZ(gO2))*CpUhhVZVZ(gO1)
      ;
   result += 4*B0(Sqr(p),Sqr(MVZ),Sqr(MVZp))*Conj(CpUhhVZVZp(gO2))*CpUhhVZVZp(
      gO1);
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpUhhUhhHpmconjHpm(gO1,gO2,gI1,gI1
      ));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUhhUhhSHp0conjSHp0(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUhhUhhSHppconjSHpp(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUhhUhhSSI0conjSSI0(gO1,gO2,gI1,
      gI1));
   ...
   result += -2*SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(
      ...
      MCha(gI2)));
   result += -2*SUM(gI1,0,1,MChaI(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MChaI(gI1)),
      Sqr(MChaI(gI2)))*(Conj(CpbarChaIChaIUhhPR(gI1,gI2,gO2))*CpbarChaIChaIUhhPL(
      gI1,gI2,gO1) + Conj(CpbarChaIChaIUhhPL(gI1,gI2,gO2))*CpbarChaIChaIUhhPR(gI1,
      gI2,gO1))*MChaI(gI2)));
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(Mhh(gI1)),Sqr(MAh(gI2)))*
   ...
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpUhhUhhSHI0conjSHI0(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUhhUhhSHIpconjSHIp(gO1,gO2,gI1,
      gI1));
   ...
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpUhhUhhSDXconjSDX(gO1,gO2,gI1,
      gI1));
   ...
   result += -SUM(gI1,0,5,MChi(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI1)),Sqr(
   ...
   result += SUM(gI2,0,2,Conj(CpAhUhhVZ(gI2,gO2))*CpAhUhhVZ(gI2,gO1)*F0(Sqr(p),
      Sqr(MAh(gI2)),Sqr(MVZ)));
...
std::complex<double> CLASSNAME::self_energy_Ah_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUAhUAhSHp0conjSHp0(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUAhUAhSHppconjSHpp(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUAhUAhSSI0conjSSI0(gO1,gO2,gI1,
      gI1));
   result += SUM(gI1,0,1,SUM(gI2,0,1,B0(Sqr(p),Sqr(MHpm(gI1)),Sqr(MHpm(gI2)))*
   ...
   result += -2*SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(
      ...
      MCha(gI2)));
   result += -2*SUM(gI1,0,1,MChaI(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MChaI(gI1)),
      Sqr(MChaI(gI2)))*(Conj(CpbarChaIChaIUAhPR(gI1,gI2,gO2))*CpbarChaIChaIUAhPL(
      gI1,gI2,gO1) + Conj(CpbarChaIChaIUAhPL(gI1,gI2,gO2))*CpbarChaIChaIUAhPR(gI1,
      gI2,gO1))*MChaI(gI2)));
   ...
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpUAhUAhSHI0conjSHI0(gO1,gO2,gI1,
      gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUAhUAhSHIpconjSHIp(gO1,gO2,gI1,
      gI1));
   result += SUM(gI1,0,3,SUM(gI2,0,3,B0(Sqr(p),Sqr(MSHI0(gI1)),Sqr(MSHI0(gI2)))
   ...
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpUAhUAhSDXconjSDX(gO1,gO2,gI1,
      gI1));
   ...
   result += 2*SUM(gI2,0,1,Conj(CpUAhHpmconjVWm(gO2,gI2))*CpUAhHpmconjVWm(gO1,
      gI2)*F0(Sqr(p),Sqr(MHpm(gI2)),Sqr(MVWm)));
   result += SUM(gI2,0,2,Conj(CpUAhhhVZ(gO2,gI2))*CpUAhhhVZ(gO1,gI2)*F0(Sqr(p),
      Sqr(Mhh(gI2)),Sqr(MVZ)));
...
std::complex<double> CLASSNAME::self_energy_Hpm_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUHpmconjHpmconjUHpm(gI1,gO1,
      gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUHpmSHp0conjUHpmconjSHp0(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUHpmSHppconjUHpmconjSHpp(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUHpmSSI0conjUHpmconjSSI0(gO1,
      gI1,gO2,gI1));
   result += SUM(gI1,0,1,SUM(gI2,0,1,B0(Sqr(p),Sqr(MSHp0(gI1)),Sqr(MSHpp(gI2)))
      *Conj(CpSHppconjUHpmconjSHp0(gI2,gO2,gI1))*CpSHppconjUHpmconjSHp0(gI2,gO1,
      gI1)));
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MHpm(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhHpmconjUHpm(gI2,gI1,gO2))*CpAhHpmconjUHpm(gI2,gI1,gO1)));
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MHpm(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhHpmconjUHpm(gI2,gI1,gO2))*CphhHpmconjUHpm(gI2,gI1,gO1)));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUHpmconjUHpm(gI1,gI1,gO1,
      gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUHpmconjUHpm(gI1,gI1,gO1,
      gO2));
   ...
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpUHpmSHI0conjUHpmconjSHI0(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUHpmSHIpconjUHpmconjSHIp(gO1,
      gI1,gO2,gI1));
   result += SUM(gI1,0,3,SUM(gI2,0,3,B0(Sqr(p),Sqr(MSHI0(gI1)),Sqr(MSHIp(gI2)))
      *Conj(CpSHIpconjUHpmconjSHI0(gI2,gO2,gI1))*CpSHIpconjUHpmconjSHI0(gI2,gO1,
      gI1)));
   ...
   result += SUM(gI2,0,1,Conj(CpHpmconjUHpmVZp(gI2,gO2))*CpHpmconjUHpmVZp(gI2,
      gO1)*F0(Sqr(p),Sqr(MHpm(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_SHI0_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSHI0conjHpmconjUSHI0(gI1,gO1
      ,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUSHI0SHp0conjUSHI0conjSHp0(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUSHI0SHppconjUSHI0conjSHpp(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSHI0SSI0conjUSHI0conjSSI0(gO1,
      gI1,gO2,gI1));
   result += SUM(gI1,0,1,SUM(gI2,0,1,(Conj(CpbarChaChaIconjUSHI0PL(gI1,gI2,gO2)
      )*CpbarChaChaIconjUSHI0PL(gI1,gI2,gO1) + Conj(CpbarChaChaIconjUSHI0PR(gI1,
      gI2,gO2))*CpbarChaChaIconjUSHI0PR(gI1,gI2,gO1))*G0(Sqr(p),Sqr(MCha(gI1)),Sqr
      (MChaI(gI2)))));
   result += -2*SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(
   ...
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSHI0conjUSHI0(gI1,gI1,
      gO1,gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSHI0conjUSHI0(gI1,gI1,
      gO1,gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpUSHI0SvconjUSHI0conjSv(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USHI0conjSHI0conjUSHI0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpUSHI0SHIpconjUSHI0conjSHIp(gO1,
      gI1,gO2,gI1));
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSHI0(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSHI0conjUSHI0(gI2,gI1,gO2))*CpAhSHI0conjUSHI0(gI2,gI1,gO1)));
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSHI0(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhSHI0conjUSHI0(gI2,gI1,gO2))*CphhSHI0conjUSHI0(gI2,gI1,gO1)));
   ...
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSHI0conjSdconjUSHI0(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSHI0conjSDXconjUSHI0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,5,A0(Sqr(MSe(gI1)))*CpSeUSHI0conjSeconjUSHI0(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSHI0SuconjUSHI0conjSu(gO1,gI1,
      gO2,gI1));
   result += SUM(gI2,0,3,Conj(CpSHI0conjUSHI0VZ(gI2,gO2))*CpSHI0conjUSHI0VZ(gI2
      ,gO1)*F0(Sqr(p),Sqr(MSHI0(gI2)),Sqr(MVZ)));
   result += SUM(gI2,0,3,Conj(CpSHI0conjUSHI0VZp(gI2,gO2))*CpSHI0conjUSHI0VZp(
      gI2,gO1)*F0(Sqr(p),Sqr(MSHI0(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_SHIp_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSHIpconjHpmconjUSHIp(gI1,gO1
      ,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpUSHIpSHp0conjUSHIpconjSHp0(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUSHIpSHppconjUSHIpconjSHpp(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSHIpSSI0conjUSHIpconjSSI0(gO1,
      gI1,gO2,gI1));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSHIpconjUSHIp(gI1,gI1,
      gO1,gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSHIpconjUSHIp(gI1,gI1,
      gO1,gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpUSHIpSvconjUSHIpconjSv(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USHIpconjSHI0conjUSHIp(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpSHIpUSHIpconjSHIpconjUSHIp(gI1,
      gO1,gI1,gO2));
   ...
   result += -2*SUM(gI1,0,3,MChiI(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MChiI(gI1)),
      Sqr(MCha(gI2)))*(Conj(CpChiIChaconjUSHIpPR(gI1,gI2,gO2))*
      CpChiIChaconjUSHIpPL(gI1,gI2,gO1) + Conj(CpChiIChaconjUSHIpPL(gI1,gI2,gO2))*
      CpChiIChaconjUSHIpPR(gI1,gI2,gO1))*MCha(gI2)));
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSHIp(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSHIpconjUSHIp(gI2,gI1,gO2))*CpAhSHIpconjUSHIp(gI2,gI1,gO1)));
   result += SUM(gI1,0,3,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSHIp(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhSHIpconjUSHIp(gI2,gI1,gO2))*CphhSHIpconjUSHIp(gI2,gI1,gO1)));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSHIpconjSdconjUSHIp(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSHIpconjSDXconjUSHIp(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,5,A0(Sqr(MSe(gI1)))*CpSeUSHIpconjSeconjUSHIp(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSHIpSuconjUSHIpconjSu(gO1,gI1,
      gO2,gI1));
   ...
   result += SUM(gI2,0,3,Conj(CpSHI0conjUSHIpVWm(gI2,gO2))*CpSHI0conjUSHIpVWm(
      gI2,gO1)*F0(Sqr(p),Sqr(MSHI0(gI2)),Sqr(MVWm)));
   ...
   result += SUM(gI2,0,3,Conj(CpSHIpconjUSHIpVZp(gI2,gO2))*CpSHIpconjUSHIpVZp(
      gI2,gO1)*F0(Sqr(p),Sqr(MSHIp(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_SSI0_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSSI0conjHpmconjUSSI0(gI1,gO1
      ,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpSHp0USSI0conjSHp0conjUSSI0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpSHppUSSI0conjSHppconjUSSI0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpSSI0USSI0conjSSI0conjUSSI0(gI1,
      gO1,gI1,gO2));
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSSI0(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhSSI0conjUSSI0(gI2,gI1,gO2))*CphhSSI0conjUSSI0(gI2,gI1,gO1)));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,5,(Conj(CpChiFSIconjUSSI0PL(gI2,gI1,gO2)
      ...
      ;
   result += -SUM(gI1,0,1,MFSI(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFSI(gI1)),Sqr(
      MChi(gI2)))*(Conj(CpChiFSIconjUSSI0PR(gI2,gI1,gO2))*CpChiFSIconjUSSI0PL(gI2,
      gI1,gO1) + Conj(CpChiFSIconjUSSI0PL(gI2,gI1,gO2))*CpChiFSIconjUSSI0PR(gI2,
      gI1,gO1))*MChi(gI2)));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSSI0conjUSSI0(gI1,gI1,
      gO1,gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSSI0conjUSSI0(gI1,gI1,
      gO1,gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpUSSI0SvconjUSSI0conjSv(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USSI0conjSHI0conjUSSI0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpSHIpUSSI0conjSHIpconjUSSI0(gI1,
      gO1,gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSSI0conjSdconjUSSI0(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSSI0conjSDXconjUSSI0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,5,A0(Sqr(MSe(gI1)))*CpSeUSSI0conjSeconjUSSI0(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSSI0SuconjUSSI0conjSu(gO1,gI1,
      gO2,gI1));
   result += SUM(gI2,0,1,Conj(CpSSI0conjUSSI0VZ(gI2,gO2))*CpSSI0conjUSSI0VZ(gI2
      ,gO1)*F0(Sqr(p),Sqr(MSSI0(gI2)),Sqr(MVZ)));
   result += SUM(gI2,0,1,Conj(CpSSI0conjUSSI0VZp(gI2,gO2))*CpSSI0conjUSSI0VZp(
      gI2,gO1)*F0(Sqr(p),Sqr(MSSI0(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_SHp0_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSHp0conjHpmconjUSHp0(gI1,gO1
      ,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpSHp0USHp0conjSHp0conjUSHp0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpUSHp0SHppconjUSHp0conjSHpp(gO1,
      gI1,gO2,gI1));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSHp0SSI0conjUSHp0conjSSI0(gO1,
      gI1,gO2,gI1));
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSHp0(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhSHp0conjUSHp0(gI2,gI1,gO2))*CphhSHp0conjUSHp0(gI2,gI1,gO1)));
   ...
   result += -SUM(gI1,0,1,MChiP(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MChiP(gI1)),Sqr(
      ...
      gI2,gI1,gO1))*MChi(gI2)));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSHp0conjUSHp0(gI1,gI1,
      gO1,gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSHp0conjUSHp0(gI1,gI1,
      gO1,gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpUSHp0SvconjUSHp0conjSv(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USHp0conjSHI0conjUSHp0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpSHIpUSHp0conjSHIpconjUSHp0(gI1,
      gO1,gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSHp0conjSdconjUSHp0(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSHp0conjSDXconjUSHp0(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,5,A0(Sqr(MSe(gI1)))*CpSeUSHp0conjSeconjUSHp0(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSHp0SuconjUSHp0conjSu(gO1,gI1,
      gO2,gI1));
   result += SUM(gI2,0,1,Conj(CpSHp0conjUSHp0VZ(gI2,gO2))*CpSHp0conjUSHp0VZ(gI2
      ,gO1)*F0(Sqr(p),Sqr(MSHp0(gI2)),Sqr(MVZ)));
   result += SUM(gI2,0,1,Conj(CpSHp0conjUSHp0VZp(gI2,gO2))*CpSHp0conjUSHp0VZp(
      gI2,gO1)*F0(Sqr(p),Sqr(MSHp0(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_SHpp_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,1,A0(Sqr(MHpm(gI1)))*CpHpmUSHppconjHpmconjUSHpp(gI1,gO1
      ,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHp0(gI1)))*CpSHp0USHppconjSHp0conjUSHpp(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSHpp(gI1)))*CpSHppUSHppconjSHppconjUSHpp(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,1,A0(Sqr(MSSI0(gI1)))*CpUSHppSSI0conjUSHppconjSSI0(gO1,
      gI1,gO2,gI1));
   ...
   result += -2*SUM(gI1,0,1,MChiP(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MChiP(gI1)),
      Sqr(MCha(gI2)))*(Conj(CpChiPChaconjUSHppPR(gI1,gI2,gO2))*
      CpChiPChaconjUSHppPL(gI1,gI2,gO1) + Conj(CpChiPChaconjUSHppPL(gI1,gI2,gO2))*
      CpChiPChaconjUSHppPR(gI1,gI2,gO1))*MCha(gI2)));
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSHpp(gI1)),Sqr(Mhh(gI2)))*
      Conj(CphhSHppconjUSHpp(gI2,gI1,gO2))*CphhSHppconjUSHpp(gI2,gI1,gO1)));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(MAh(gI1)))*CpAhAhUSHppconjUSHpp(gI1,gI1,
      gO1,gO2));
   result += -0.5*SUM(gI1,0,2,A0(Sqr(Mhh(gI1)))*CphhhhUSHppconjUSHpp(gI1,gI1,
      gO1,gO2));
   result += -SUM(gI1,0,2,A0(Sqr(MSv(gI1)))*CpUSHppSvconjUSHppconjSv(gO1,gI1,
      gO2,gI1));
   result += -SUM(gI1,0,3,A0(Sqr(MSHI0(gI1)))*CpSHI0USHppconjSHI0conjUSHpp(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,3,A0(Sqr(MSHIp(gI1)))*CpSHIpUSHppconjSHIpconjUSHpp(gI1,
      gO1,gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSd(gI1)))*CpSdUSHppconjSdconjUSHpp(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSDX(gI1)))*CpSDXUSHppconjSDXconjUSHpp(gI1,
      gO1,gI1,gO2));
   result += -SUM(gI1,0,5,A0(Sqr(MSe(gI1)))*CpSeUSHppconjSeconjUSHpp(gI1,gO1,
      gI1,gO2));
   result += -3*SUM(gI1,0,5,A0(Sqr(MSu(gI1)))*CpUSHppSuconjUSHppconjSu(gO1,gI1,
      gO2,gI1));
   result += SUM(gI1,0,5,(Conj(CpChiChaPconjUSHppPL(gI1,gO2))*
      CpChiChaPconjUSHppPL(gI1,gO1) + Conj(CpChiChaPconjUSHppPR(gI1,gO2))*
      CpChiChaPconjUSHppPR(gI1,gO1))*G0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChaP)));
   ...
   result += SUM(gI2,0,1,Conj(CpSHp0conjUSHppVWm(gI2,gO2))*CpSHp0conjUSHppVWm(
      gI2,gO1)*F0(Sqr(p),Sqr(MSHp0(gI2)),Sqr(MVWm)));
   ...
   result += SUM(gI2,0,1,Conj(CpSHppconjUSHppVZp(gI2,gO2))*CpSHppconjUSHppVZp(
      gI2,gO1)*F0(Sqr(p),Sqr(MSHpp(gI2)),Sqr(MVZp)));
...
std::complex<double> CLASSNAME::self_energy_VG_1loop(double p ) const
{
   ...
   result += -2*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSDXconjSDXVG(gI2,gI1))*B00(Sqr
...
std::complex<double> CLASSNAME::self_energy_VP_1loop(double p ) const
{
   ...
   result += -(A0(Sqr(MVWm))*(CpconjVWmVPVPVWm1() + CpconjVWmVPVPVWm2() + 4*
      CpconjVWmVPVPVWm3()));
   result += (AbsSqr(CpbarChaPChaPVPPL()) + AbsSqr(CpbarChaPChaPVPPR()))*H0(Sqr
   ...
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSHppconjSHppVP(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHpp(gI1)),Sqr(MSHpp(gI2)))));
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpbarChaIChaIVPPL(gI1,gI2)) +
      AbsSqr(CpbarChaIChaIVPPR(gI1,gI2)))*H0(Sqr(p),Sqr(MChaI(gI1)),Sqr(MChaI(gI2)
      )) + 4*B0(Sqr(p),Sqr(MChaI(gI1)),Sqr(MChaI(gI2)))*MChaI(gI1)*MChaI(gI2)*Re(
      Conj(CpbarChaIChaIVPPL(gI1,gI2))*CpbarChaIChaIVPPR(gI1,gI2))));
   ...
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(CpbarFDXFDXVPPL(gI1,gI2)) +
      AbsSqr(CpbarFDXFDXVPPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFDX(gI1)),Sqr(MFDX(gI2))) +
      4*B0(Sqr(p),Sqr(MFDX(gI1)),Sqr(MFDX(gI2)))*MFDX(gI1)*MFDX(gI2)*Re(Conj(
   ...
   result += -4*SUM(gI1,0,3,SUM(gI2,0,3,AbsSqr(CpSHIpconjSHIpVP(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHIp(gI1)),Sqr(MSHIp(gI2)))));
   ...
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSDXconjSDXVP(gI2,gI1))*B00(
      Sqr(p),Sqr(MSDX(gI1)),Sqr(MSDX(gI2)))));
...
std::complex<double> CLASSNAME::self_energy_VZ_1loop(double p ) const
{
   ...
   result += -(A0(Sqr(MVWm))*(4*CpconjVWmVWmVZVZ1() + CpconjVWmVWmVZVZ2() +
      CpconjVWmVWmVZVZ3()));
   result += (AbsSqr(CpbarChaPChaPVZPL()) + AbsSqr(CpbarChaPChaPVZPR()))*H0(Sqr
      (p),Sqr(MChaP),Sqr(MChaP));
   ...
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpHpmconjHpmVZ(gI2,gI1))*B00(Sqr
      (p),Sqr(MHpm(gI1)),Sqr(MHpm(gI2)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSHp0conjSHp0VZ(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHp0(gI1)),Sqr(MSHp0(gI2)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSHppconjSHppVZ(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHpp(gI1)),Sqr(MSHpp(gI2)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSSI0conjSSI0VZ(gI2,gI1))*B00(
      Sqr(p),Sqr(MSSI0(gI1)),Sqr(MSSI0(gI2)))));
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpbarChaIChaIVZPL(gI1,gI2)) +
      AbsSqr(CpbarChaIChaIVZPR(gI1,gI2)))*H0(Sqr(p),Sqr(MChaI(gI1)),Sqr(MChaI(gI2)
      )) + 4*B0(Sqr(p),Sqr(MChaI(gI1)),Sqr(MChaI(gI2)))*MChaI(gI1)*MChaI(gI2)*Re(
      Conj(CpbarChaIChaIVZPL(gI1,gI2))*CpbarChaIChaIVZPR(gI1,gI2))));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpChiPChiPVZPL(gI1,gI2)) +
      AbsSqr(CpChiPChiPVZPR(gI1,gI2)))*H0(Sqr(p),Sqr(MChiP(gI1)),Sqr(MChiP(gI2)))
      + 4*B0(Sqr(p),Sqr(MChiP(gI1)),Sqr(MChiP(gI2)))*MChiP(gI1)*MChiP(gI2)*Re(Conj
      (CpChiPChiPVZPL(gI1,gI2))*CpChiPChiPVZPR(gI1,gI2))));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpFSIFSIVZPL(gI1,gI2)) +
      AbsSqr(CpFSIFSIVZPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFSI(gI1)),Sqr(MFSI(gI2))) + 4*
      B0(Sqr(p),Sqr(MFSI(gI1)),Sqr(MFSI(gI2)))*MFSI(gI1)*MFSI(gI2)*Re(Conj(
      CpFSIFSIVZPL(gI1,gI2))*CpFSIFSIVZPR(gI1,gI2))));
   ...
   result += -4*SUM(gI1,0,2,SUM(gI2,0,2,AbsSqr(CpAhhhVZ(gI2,gI1))*B00(Sqr(p),
   ...
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(CpbarFDXFDXVZPL(gI1,gI2)) +
      AbsSqr(CpbarFDXFDXVZPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFDX(gI1)),Sqr(MFDX(gI2))) +
      4*B0(Sqr(p),Sqr(MFDX(gI1)),Sqr(MFDX(gI2)))*MFDX(gI1)*MFDX(gI2)*Re(Conj(
   ...
   result += -4*SUM(gI1,0,3,SUM(gI2,0,3,AbsSqr(CpSHI0conjSHI0VZ(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHI0(gI1)),Sqr(MSHI0(gI2)))));
   result += -4*SUM(gI1,0,3,SUM(gI2,0,3,AbsSqr(CpSHIpconjSHIpVZ(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHIp(gI1)),Sqr(MSHIp(gI2)))));
   result += 0.5*SUM(gI1,0,3,SUM(gI2,0,3,(AbsSqr(CpChiIChiIVZPL(gI1,gI2)) +
      AbsSqr(CpChiIChiIVZPR(gI1,gI2)))*H0(Sqr(p),Sqr(MChiI(gI1)),Sqr(MChiI(gI2)))
   ...
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSdconjSdVZ(gI2,gI1))*B00(Sqr(
      p),Sqr(MSd(gI1)),Sqr(MSd(gI2)))));
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSDXconjSDXVZ(gI2,gI1))*B00(
      Sqr(p),Sqr(MSDX(gI1)),Sqr(MSDX(gI2)))));
   ...
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSuconjSuVZ(gI2,gI1))*B00(Sqr(
      p),Sqr(MSu(gI1)),Sqr(MSu(gI2)))));
   result += 0.5*SUM(gI1,0,5,SUM(gI2,0,5,(AbsSqr(CpChiChiVZPL(gI1,gI2)) +
...
std::complex<double> CLASSNAME::self_energy_VZp_1loop(double p ) const
{
   ...
   result += -(A0(Sqr(MVWm))*(4*CpconjVWmVWmVZpVZp1() + CpconjVWmVWmVZpVZp2() +
      CpconjVWmVWmVZpVZp3()));
   result += (AbsSqr(CpbarChaPChaPVZpPL()) + AbsSqr(CpbarChaPChaPVZpPR()))*H0(
      Sqr(p),Sqr(MChaP),Sqr(MChaP));
   result += -2*AbsSqr(CpconjVWmVWmVZp())*(A0(Sqr(MVWm)) + 5*B00(Sqr(p),Sqr(
      MVWm),Sqr(MVWm)) + B0(Sqr(p),Sqr(MVWm),Sqr(MVWm))*(Sqr(MVWm) + 2*Sqr(p)));
   ...
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpHpmconjHpmVZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MHpm(gI1)),Sqr(MHpm(gI2)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSHp0conjSHp0VZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHp0(gI1)),Sqr(MSHp0(gI2)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSHppconjSHppVZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHpp(gI1)),Sqr(MSHpp(gI2)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSSI0conjSSI0VZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MSSI0(gI1)),Sqr(MSSI0(gI2)))));
   result += SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpbarChaChaVZpPL(gI1,gI2)) +
      AbsSqr(CpbarChaChaVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MCha(gI1)),Sqr(MCha(gI2)))
      + 4*B0(Sqr(p),Sqr(MCha(gI1)),Sqr(MCha(gI2)))*MCha(gI1)*MCha(gI2)*Re(Conj(
      CpbarChaChaVZpPL(gI1,gI2))*CpbarChaChaVZpPR(gI1,gI2))));
   result += SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpbarChaIChaIVZpPL(gI1,gI2)) +
      AbsSqr(CpbarChaIChaIVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MChaI(gI1)),Sqr(MChaI(gI2
      ))) + 4*B0(Sqr(p),Sqr(MChaI(gI1)),Sqr(MChaI(gI2)))*MChaI(gI1)*MChaI(gI2)*Re(
      Conj(CpbarChaIChaIVZpPL(gI1,gI2))*CpbarChaIChaIVZpPR(gI1,gI2))));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpChiPChiPVZpPL(gI1,gI2)) +
      ...
      + 4*B0(Sqr(p),Sqr(MChiP(gI1)),Sqr(MChiP(gI2)))*MChiP(gI1)*MChiP(gI2)*Re(
      Conj(CpChiPChiPVZpPL(gI1,gI2))*CpChiPChiPVZpPR(gI1,gI2))));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,(AbsSqr(CpFSIFSIVZpPL(gI1,gI2)) +
      AbsSqr(CpFSIFSIVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFSI(gI1)),Sqr(MFSI(gI2))) + 4
      *B0(Sqr(p),Sqr(MFSI(gI1)),Sqr(MFSI(gI2)))*MFSI(gI1)*MFSI(gI2)*Re(Conj(
      CpFSIFSIVZpPL(gI1,gI2))*CpFSIFSIVZpPR(gI1,gI2))));
   ...
   result += -4*SUM(gI1,0,2,SUM(gI2,0,2,AbsSqr(CpAhhhVZp(gI2,gI1))*B00(Sqr(p),
      Sqr(MAh(gI2)),Sqr(Mhh(gI1)))));
   result += -4*SUM(gI1,0,2,SUM(gI2,0,2,AbsSqr(CpSvconjSvVZp(gI2,gI1))*B00(Sqr(
      p),Sqr(MSv(gI1)),Sqr(MSv(gI2)))));
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(CpbarFdFdVZpPL(gI1,gI2)) +
      AbsSqr(CpbarFdFdVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(gI2))) + 4*
      B0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(gI2)))*MFd(gI1)*MFd(gI2)*Re(Conj(
      CpbarFdFdVZpPL(gI1,gI2))*CpbarFdFdVZpPR(gI1,gI2))));
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(CpbarFDXFDXVZpPL(gI1,gI2)) +
      AbsSqr(CpbarFDXFDXVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFDX(gI1)),Sqr(MFDX(gI2)))
      + 4*B0(Sqr(p),Sqr(MFDX(gI1)),Sqr(MFDX(gI2)))*MFDX(gI1)*MFDX(gI2)*Re(Conj(
   ...
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(CpbarFuFuVZpPL(gI1,gI2)) +
      AbsSqr(CpbarFuFuVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(gI2))) + 4*
      B0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(gI2)))*MFu(gI1)*MFu(gI2)*Re(Conj(
      CpbarFuFuVZpPL(gI1,gI2))*CpbarFuFuVZpPR(gI1,gI2))));
   ...
   result += -4*SUM(gI1,0,3,SUM(gI2,0,3,AbsSqr(CpSHI0conjSHI0VZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHI0(gI1)),Sqr(MSHI0(gI2)))));
   result += -4*SUM(gI1,0,3,SUM(gI2,0,3,AbsSqr(CpSHIpconjSHIpVZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MSHIp(gI1)),Sqr(MSHIp(gI2)))));
   result += 0.5*SUM(gI1,0,3,SUM(gI2,0,3,(AbsSqr(CpChiIChiIVZpPL(gI1,gI2)) +
      ...
      + 4*B0(Sqr(p),Sqr(MChiI(gI1)),Sqr(MChiI(gI2)))*MChiI(gI1)*MChiI(gI2)*Re(
      Conj(CpChiIChiIVZpPL(gI1,gI2))*CpChiIChiIVZpPR(gI1,gI2))));
   ...
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSdconjSdVZp(gI2,gI1))*B00(Sqr
      (p),Sqr(MSd(gI1)),Sqr(MSd(gI2)))));
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSDXconjSDXVZp(gI2,gI1))*B00(
      Sqr(p),Sqr(MSDX(gI1)),Sqr(MSDX(gI2)))));
   result += -4*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSeconjSeVZp(gI2,gI1))*B00(Sqr(
      p),Sqr(MSe(gI1)),Sqr(MSe(gI2)))));
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSuconjSuVZp(gI2,gI1))*B00(Sqr
      (p),Sqr(MSu(gI1)),Sqr(MSu(gI2)))));
   result += 0.5*SUM(gI1,0,5,SUM(gI2,0,5,(AbsSqr(CpChiChiVZpPL(gI1,gI2)) +
      AbsSqr(CpChiChiVZpPR(gI1,gI2)))*H0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChi(gI2))) + 4
      *B0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChi(gI2)))*MChi(gI1)*MChi(gI2)*Re(Conj(
      CpChiChiVZpPL(gI1,gI2))*CpChiChiVZpPR(gI1,gI2))));
   result += 2*SUM(gI2,0,1,AbsSqr(CpHpmconjVWmVZp(gI2))*B0(Sqr(p),Sqr(MVWm),Sqr
      (MHpm(gI2))));
   result += SUM(gI2,0,2,AbsSqr(CphhVZpVZp(gI2))*B0(Sqr(p),Sqr(MVZp),Sqr(Mhh(
      gI2))));
...
std::complex<double> CLASSNAME::self_energy_VWm_1loop(double p ) const
{
   ...
   result += -(AbsSqr(CpconjVWmVWmVZ())*(A0(Sqr(MVWm)) + A0(Sqr(MVZ)) + 10*B00(
      ...
      MVZ) + 4*Sqr(p))));
   result += -(AbsSqr(CpconjVWmVWmVZp())*(A0(Sqr(MVWm)) + A0(Sqr(MVZp)) + 10*
      B00(Sqr(p),Sqr(MVZp),Sqr(MVWm)) + B0(Sqr(p),Sqr(MVZp),Sqr(MVWm))*(Sqr(MVWm)
      + Sqr(MVZp) + 4*Sqr(p))));
   ...
   result += -4*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpSHppconjSHp0conjVWm(gI2,gI1))*
      B00(Sqr(p),Sqr(MSHpp(gI2)),Sqr(MSHp0(gI1)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,2,AbsSqr(CpAhHpmconjVWm(gI2,gI1))*B00(Sqr
      (p),Sqr(MAh(gI2)),Sqr(MHpm(gI1)))));
   result += -4*SUM(gI1,0,1,SUM(gI2,0,2,AbsSqr(CphhHpmconjVWm(gI2,gI1))*B00(Sqr
   ...
   result += -4*SUM(gI1,0,3,SUM(gI2,0,3,AbsSqr(CpSHIpconjSHI0conjVWm(gI2,gI1))*
      B00(Sqr(p),Sqr(MSHIp(gI2)),Sqr(MSHI0(gI1)))));
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,1,(AbsSqr(CpChiChaconjVWmPL(gI1,gI2)) +
   ...
   result += SUM(gI2,0,1,AbsSqr(CpHpmconjVWmVZ(gI2))*B0(Sqr(p),Sqr(MVZ),Sqr(
      MHpm(gI2))));
   result += SUM(gI2,0,1,AbsSqr(CpHpmconjVWmVZp(gI2))*B0(Sqr(p),Sqr(MVZp),Sqr(
      MHpm(gI2))));
   result += SUM(gI2,0,2,AbsSqr(CphhconjVWmVWm(gI2))*B0(Sqr(p),Sqr(MVWm),Sqr(
      Mhh(gI2))));
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += 3*SUM(gI1,0,2,MFDX(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFDX(gI1)),Sqr(
      MSDX(gI2)))*Conj(CpbarFDXUChiSDXPL(gI1,gO2,gI2))*CpbarFDXUChiSDXPR(gI1,gO1,
      gI2)));
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(Mhh(gI1)))*
   ...
   result += -4*SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MVZ))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpUChiChiPconjSHp0PR(gO2,gI2,gI1))*CpUChiChiPconjSHp0PR(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpUChiChiPSHp0PR(gO2,gI2,gI1))*CpUChiChiPSHp0PR(gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpUChiFSIconjSSI0PR(gO2,gI2,gI1))*CpUChiFSIconjSSI0PR(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpUChiFSISSI0PR(gO2,gI2,gI1))*CpUChiFSISSI0PR(gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChaI(gI1)),Sqr(MSHIp(
      gI2)))*Conj(CpbarChaIUChiSHIpPR(gI1,gO2,gI2))*CpbarChaIUChiSHIpPR(gI1,gO1,
      gI2)));
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpUChiChaIconjSHIpPR(gO2,gI2,gI1))*CpUChiChaIconjSHIpPR(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpUChiChiIconjSHI0PR(gO2,gI2,gI1))*CpUChiChiIconjSHI0PR(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpUChiChiISHI0PR(gO2,gI2,gI1))*CpUChiChiISHI0PR(gO1,gI2,gI1)));
   ...
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MVZp))*Conj(
      CpChiUChiVZpPR(gI2,gO2))*CpChiUChiVZpPR(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpUChiChiPconjSHp0PL(gO2,gI2,gI1))*CpUChiChiPconjSHp0PL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpUChiChiPSHp0PL(gO2,gI2,gI1))*CpUChiChiPSHp0PL(gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpUChiFSIconjSSI0PL(gO2,gI2,gI1))*CpUChiFSIconjSSI0PL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpUChiFSISSI0PL(gO2,gI2,gI1))*CpUChiFSISSI0PL(gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChaI(gI1)),Sqr(MSHIp(
      gI2)))*Conj(CpbarChaIUChiSHIpPL(gI1,gO2,gI2))*CpbarChaIUChiSHIpPL(gI1,gO1,
      gI2)));
   result += -0.5*SUM(gI1,0,2,SUM(gI2,0,2,B1(Sqr(p),Sqr(MFv(gI1)),Sqr(MSv(gI2))
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpUChiChaIconjSHIpPL(gO2,gI2,gI1))*CpUChiChaIconjSHIpPL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpUChiChiIconjSHI0PL(gO2,gI2,gI1))*CpUChiChiIconjSHI0PL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpUChiChiISHI0PL(gO2,gI2,gI1))*CpUChiChiISHI0PL(gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,5,SUM(gI2,0,2,B1(Sqr(p),Sqr(MChi(gI1)),Sqr(MAh(gI2)
   ...
   result += -SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MVZp))*Conj(
      CpChiUChiVZpPL(gI2,gO2))*CpChiUChiVZpPL(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MHpm(gI1)))*
      Conj(CpbarUChaChiHpmPL(gO2,gI2,gI1))*CpbarUChaChiHpmPR(gO1,gI2,gI1)*MChi(gI2
      )));
   result += SUM(gI1,0,2,SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(Mhh(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MSHpp(
      gI1)))*Conj(CpbarUChaChiPSHppPR(gO2,gI2,gI1))*CpbarUChaChiPSHppPR(gO1,gI2,
      gI1)));
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpbarUChaChaIconjSHI0PR(gO2,gI2,gI1))*CpbarUChaChaIconjSHI0PR(
      gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpbarUChaChiISHIpPR(gO2,gI2,gI1))*CpbarUChaChiISHIpPR(gO1,gI2,
      gI1)));
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MSHpp(
      gI1)))*Conj(CpbarUChaChiPSHppPL(gO2,gI2,gI1))*CpbarUChaChiPSHppPL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,2,B1(Sqr(p),Sqr(MCha(gI1)),Sqr(MAh(gI2)
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpbarUChaChaIconjSHI0PL(gO2,gI2,gI1))*CpbarUChaChaIconjSHI0PL(
      gO1,gI2,gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpbarUChaChiISHIpPL(gO2,gI2,gI1))*CpbarUChaChiISHIpPL(gO1,gI2,
      gI1)));
   result += -1.5*SUM(gI1,0,5,SUM(gI2,0,2,B1(Sqr(p),Sqr(MFd(gI2)),Sqr(MSu(gI1))
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,MFe(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI1)),Sqr(MAh(
      gI2)))*Conj(CpbarUFeFeAhPL(gO2,gI1,gI2))*CpbarUFeFeAhPR(gO1,gI1,gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(Mhh(gI1)))*
      Conj(CpbarUFeFehhPL(gO2,gI2,gI1))*CpbarUFeFehhPR(gO1,gI2,gI1)*MFe(gI2)));
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSe(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVZp))*Conj(
      CpbarUFeFeVZpPL(gO2,gI2))*CpbarUFeFeVZpPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVZp))*Conj(
      CpbarUFeFeVZpPR(gO2,gI2))*CpbarUFeFeVZpPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,MFd(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFd(gI1)),Sqr(MAh(
      gI2)))*Conj(CpbarUFdFdAhPL(gO2,gI1,gI2))*CpbarUFdFdAhPR(gO1,gI1,gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFd(gI2)),Sqr(Mhh(gI1)))*
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSd(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFd(gI2)),Sqr(MVZp))*Conj(
      CpbarUFdFdVZpPL(gO2,gI2))*CpbarUFdFdVZpPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFd(gI2)),Sqr(MVZp))*Conj(
      CpbarUFdFdVZpPR(gO2,gI2))*CpbarUFdFdVZpPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,MFu(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI1)),Sqr(MAh(
      gI2)))*Conj(CpbarUFuFuAhPL(gO2,gI1,gI2))*CpbarUFuFuAhPR(gO1,gI1,gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI2)),Sqr(Mhh(gI1)))*
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSu(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFu(gI2)),Sqr(MVZp))*Conj(
      CpbarUFuFuVZpPL(gO2,gI2))*CpbarUFuFuVZpPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFu(gI2)),Sqr(MVZp))*Conj(
      CpbarUFuFuVZpPR(gO2,gI2))*CpbarUFuFuVZpPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_FDX_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFDX(gI2)),Sqr(Mhh(gI1)))*
      Conj(CpbarUFDXFDXhhPL(gO2,gI2,gI1))*CpbarUFDXFDXhhPR(gO1,gI2,gI1)*MFDX(gI2))
      );
   result += 1.3333333333333333*MGlu*SUM(gI1,0,5,B0(Sqr(p),Sqr(MGlu),Sqr(MSDX(
      gI1)))*Conj(CpbarUFDXGluSDXPL(gO2,gI1))*CpbarUFDXGluSDXPR(gO1,gI1));
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSDX(gI1)))*
      Conj(CpbarUFDXChiSDXPL(gO2,gI2,gI1))*CpbarUFDXChiSDXPR(gO1,gI2,gI1)*MChi(gI2
      )));
   ...
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFDX(gI2)),0)*Conj(CpbarUFDXFDXVPPR(
      gO2,gI2))*CpbarUFDXFDXVPPL(gO1,gI2)*MFDX(gI2));
...
std::complex<double> CLASSNAME::self_energy_FDX_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFDX(gI2)),Sqr(MVZ))*Conj(
      CpbarUFDXFDXVZPL(gO2,gI2))*CpbarUFDXFDXVZPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_FDX_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFDX(gI2)),Sqr(MVZ))*Conj(
      CpbarUFDXFDXVZPR(gO2,gI2))*CpbarUFDXFDXVZPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_ChaI_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,MChaI(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MChaI(gI1)),Sqr(
      MAh(gI2)))*Conj(CpbarUChaIChaIAhPL(gO2,gI1,gI2))*CpbarUChaIChaIAhPR(gO1,gI1,
      gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,1,B0(Sqr(p),Sqr(MChaI(gI2)),Sqr(Mhh(gI1)))*
      Conj(CpbarUChaIChaIhhPL(gO2,gI2,gI1))*CpbarUChaIChaIhhPR(gO1,gI2,gI1)*MChaI(
      gI2)));
   ...
   result += SUM(gI1,0,3,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHIp(gI1)))*
      ...
      (gI2)));
   result += -4*SUM(gI2,0,1,B0(Sqr(p),Sqr(MChaI(gI2)),0)*Conj(
      CpbarUChaIChaIVPPR(gO2,gI2))*CpbarUChaIChaIVPPL(gO1,gI2)*MChaI(gI2));
...
std::complex<double> CLASSNAME::self_energy_ChaI_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpbarUChaIChaSHI0PR(gO2,gI2,gI1))*CpbarUChaIChaSHI0PR(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpbarUChaIChiSHIpPR(gO2,gI2,gI1))*CpbarUChaIChiSHIpPR(gO1,gI2,
      gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),0)*Conj(CpbarUChaIChaIVPPL(
      gO2,gI2))*CpbarUChaIChaIVPPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_ChaI_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpbarUChaIChaSHI0PL(gO2,gI2,gI1))*CpbarUChaIChaSHI0PL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpbarUChaIChiSHIpPL(gO2,gI2,gI1))*CpbarUChaIChiSHIpPL(gO1,gI2,
      gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),0)*Conj(CpbarUChaIChaIVPPR(
      gO2,gI2))*CpbarUChaIChaIVPPR(gO1,gI2));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),Sqr(MVZp))*Conj(
...
std::complex<double> CLASSNAME::self_energy_ChiI_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,3,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(
      MSHIp(gI2)))*Conj(CpbarChaUChiISHIpPL(gI1,gO2,gI2))*CpbarChaUChiISHIpPR(gI1,
      gO1,gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,3,B0(Sqr(p),Sqr(MChiI(gI2)),Sqr(Mhh(gI1)))*
      Conj(CpChiIUChiIhhPL(gI2,gO2,gI1))*CpChiIUChiIhhPR(gI2,gO1,gI1)*MChiI(gI2)))
      ;
   result += SUM(gI1,0,3,SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHIp(gI1)))*
      ...
      MCha(gI2)));
   result += SUM(gI1,0,3,MChiI(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MChiI(gI1)),Sqr(
      MAh(gI2)))*Conj(CpChiIUChiIAhPL(gI1,gO2,gI2))*CpChiIUChiIAhPR(gI1,gO1,gI2)))
      ;
...
std::complex<double> CLASSNAME::self_energy_ChiI_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,3,B1(Sqr(p),Sqr(MCha(gI1)),Sqr(MSHIp(
      gI2)))*Conj(CpbarChaUChiISHIpPR(gI1,gO2,gI2))*CpbarChaUChiISHIpPR(gI1,gO1,
      gI2)));
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpUChiIChaconjSHIpPR(gO2,gI2,gI1))*CpUChiIChaconjSHIpPR(gO1,gI2,
      gI1)));
   ...
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpChiUChiIconjSHI0PR(gI2,gO2,gI1))*CpChiUChiIconjSHI0PR(gI2,gO1,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpChiUChiISHI0PR(gI2,gO2,gI1))*CpChiUChiISHI0PR(gI2,gO1,gI1)));
   ...
   result += -SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MVZ))*Conj(
      CpChiIUChiIVZPR(gI2,gO2))*CpChiIUChiIVZPR(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_ChiI_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,3,B1(Sqr(p),Sqr(MCha(gI1)),Sqr(MSHIp(
      gI2)))*Conj(CpbarChaUChiISHIpPL(gI1,gO2,gI2))*CpbarChaUChiISHIpPL(gI1,gO1,
      gI2)));
   result += -0.5*SUM(gI1,0,2,SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(Mhh(gI1
      )))*Conj(CpChiIUChiIhhPL(gI2,gO2,gI1))*CpChiIUChiIhhPL(gI2,gO1,gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHIp(
      gI1)))*Conj(CpUChiIChaconjSHIpPL(gO2,gI2,gI1))*CpUChiIChaconjSHIpPL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,2,B1(Sqr(p),Sqr(MChiI(gI1)),Sqr(MAh(gI2
      )))*Conj(CpChiIUChiIAhPL(gI1,gO2,gI2))*CpChiIUChiIAhPL(gI1,gO1,gI2)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpChiUChiIconjSHI0PL(gI2,gO2,gI1))*CpChiUChiIconjSHI0PL(gI2,gO1,
      gI1)));
   result += -0.5*SUM(gI1,0,3,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHI0(
      gI1)))*Conj(CpChiUChiISHI0PL(gI2,gO2,gI1))*CpChiUChiISHI0PL(gI2,gO1,gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChaI(gI2)),Sqr(MVWm))*Conj(
      CpUChiIChaIconjVWmPR(gO2,gI2))*CpUChiIChaIconjVWmPR(gO1,gI2));
   result += -SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MVZ))*Conj(
      CpChiIUChiIVZPL(gI2,gO2))*CpChiIUChiIVZPL(gI2,gO1));
   result += -SUM(gI2,0,3,B1(Sqr(p),Sqr(MChiI(gI2)),Sqr(MVZp))*Conj(
...
std::complex<double> CLASSNAME::self_energy_FSI_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += -4*SUM(gI2,0,1,B0(Sqr(p),Sqr(MFSI(gI2)),Sqr(MVZ))*Conj(
      CpFSIUFSIVZPL(gI2,gO2))*CpFSIUFSIVZPR(gI2,gO1)*MFSI(gI2));
...
std::complex<double> CLASSNAME::self_energy_FSI_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpChiUFSIconjSSI0PR(gI2,gO2,gI1))*CpChiUFSIconjSSI0PR(gI2,gO1,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpChiUFSISSI0PR(gI2,gO2,gI1))*CpChiUFSISSI0PR(gI2,gO1,gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MVZp))*Conj(
      CpFSIUFSIVZpPR(gI2,gO2))*CpFSIUFSIVZpPR(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_FSI_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpChiUFSIconjSSI0PL(gI2,gO2,gI1))*CpChiUFSIconjSSI0PL(gI2,gO1,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSSI0(
      gI1)))*Conj(CpChiUFSISSI0PL(gI2,gO2,gI1))*CpChiUFSISSI0PL(gI2,gO1,gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MVZ))*Conj(CpFSIUFSIVZPL
      (gI2,gO2))*CpFSIUFSIVZPL(gI2,gO1));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MFSI(gI2)),Sqr(MVZp))*Conj(
      CpFSIUFSIVZpPL(gI2,gO2))*CpFSIUFSIVZpPL(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_ChiP_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += -4*MChaP*B0(Sqr(p),Sqr(MChaP),Sqr(MVWm))*Conj(CpbarChaPUChiPVWmPL(
      gO2))*CpbarChaPUChiPVWmPR(gO1);
   result += -4*MChaP*B0(Sqr(p),Sqr(MChaP),Sqr(MVWm))*Conj(CpUChiPChaPconjVWmPR
      (gO2))*CpUChiPChaPconjVWmPL(gO1);
   result += SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,1,B0(Sqr(p),Sqr(MCha(gI1)),Sqr(
      MSHpp(gI2)))*Conj(CpbarChaUChiPSHppPL(gI1,gO2,gI2))*CpbarChaUChiPSHppPR(gI1,
      gO1,gI2)));
...
std::complex<double> CLASSNAME::self_energy_ChiP_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI1)),Sqr(MSHpp(
      gI2)))*Conj(CpbarChaUChiPSHppPR(gI1,gO2,gI2))*CpbarChaUChiPSHppPR(gI1,gO1,
      gI2)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHpp(
      gI1)))*Conj(CpUChiPChaconjSHppPR(gO2,gI2,gI1))*CpUChiPChaconjSHppPR(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpChiUChiPconjSHp0PR(gI2,gO2,gI1))*CpChiUChiPconjSHp0PR(gI2,gO1,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpChiUChiPSHp0PR(gI2,gO2,gI1))*CpChiUChiPSHp0PR(gI2,gO1,gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MVZp))*Conj(
      CpChiPUChiPVZpPR(gI2,gO2))*CpChiPUChiPVZpPR(gI2,gO1));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MVZ))*Conj(
      CpChiPUChiPVZPR(gI2,gO2))*CpChiPUChiPVZPR(gI2,gO1));
...
std::complex<double> CLASSNAME::self_energy_ChiP_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI1)),Sqr(MSHpp(
      gI2)))*Conj(CpbarChaUChiPSHppPL(gI1,gO2,gI2))*CpbarChaUChiPSHppPL(gI1,gO1,
      gI2)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHpp(
      gI1)))*Conj(CpUChiPChaconjSHppPL(gO2,gI2,gI1))*CpUChiPChaconjSHppPL(gO1,gI2,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpChiUChiPconjSHp0PL(gI2,gO2,gI1))*CpChiUChiPconjSHp0PL(gI2,gO1,
      gI1)));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHp0(
      gI1)))*Conj(CpChiUChiPSHp0PL(gI2,gO2,gI1))*CpChiUChiPSHp0PL(gI2,gO1,gI1)));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MVZ))*Conj(
      CpChiPUChiPVZPL(gI2,gO2))*CpChiPUChiPVZPL(gI2,gO1));
   result += -SUM(gI2,0,1,B1(Sqr(p),Sqr(MChiP(gI2)),Sqr(MVZp))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Glu_1loop_PR(double p ) const
{
   ...
   result += -0.25*SUM(gI1,0,5,SUM(gI2,0,2,AbsSqr(CpGluFDXconjSDXPR(gI2,gI1))*
      B1(Sqr(p),Sqr(MFDX(gI2)),Sqr(MSDX(gI1)))));
...
std::complex<double> CLASSNAME::self_energy_Glu_1loop_PL(double p ) const
{
   ...
   result += -0.25*SUM(gI1,0,5,SUM(gI2,0,2,AbsSqr(CpGluFdconjSdPL(gI2,gI1))*B1(
      Sqr(p),Sqr(MFd(gI2)),Sqr(MSd(gI1)))));
   result += -0.25*SUM(gI1,0,5,SUM(gI2,0,2,AbsSqr(CpGluFDXconjSDXPL(gI2,gI1))*
      B1(Sqr(p),Sqr(MFDX(gI2)),Sqr(MSDX(gI1)))));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSv(gI1)))*
   ...
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZp))*Conj(
      CpbarFvFvVZpPR(gO2,gI2))*CpbarFvFvVZpPL(gO1,gI2)*MFv(gI2));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZp))*Conj(
      CpbarFvFvVZpPL(gO2,gI2))*CpbarFvFvVZpPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZp))*Conj(
      CpbarFvFvVZpPR(gO2,gI2))*CpbarFvFvVZpPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_ChaP_1loop_PR(double p ) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpbarChaPChaSHp0PR(gI2,gI1))*
      B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHp0(gI1)))));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,AbsSqr(CpbarChaPChiSHppPR(gI2,gI1))*
      B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHpp(gI1)))));
   result += -SUM(gI2,0,1,AbsSqr(CpbarChaPChiPVWmPL(gI2))*B1(Sqr(p),Sqr(MChiP(
      gI2)),Sqr(MVWm)));
...
std::complex<double> CLASSNAME::self_energy_ChaP_1loop_PL(double p ) const
{
   ...
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,1,AbsSqr(CpbarChaPChaSHp0PL(gI2,gI1))*
      B1(Sqr(p),Sqr(MCha(gI2)),Sqr(MSHp0(gI1)))));
   result += -0.5*SUM(gI1,0,1,SUM(gI2,0,5,AbsSqr(CpbarChaPChiSHppPL(gI2,gI1))*
      B1(Sqr(p),Sqr(MChi(gI2)),Sqr(MSHpp(gI1)))));
   result += -SUM(gI2,0,1,AbsSqr(CpbarChaPChiPVWmPR(gI2))*B1(Sqr(p),Sqr(MChiP(
      gI2)),Sqr(MVWm)));
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_1_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(MVZp))*Conj(
      CpbarFeFeVZpPR(gO2,gI2))*CpbarFeFeVZpPL(gO1,gI2)*MFe(gI2));
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PR_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVZp))*Conj(
      CpbarFeFeVZpPL(gO2,gI2))*CpbarFeFeVZpPL(gO1,gI2));
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVWm))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_PL_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVZp))*Conj(
      CpbarFeFeVZpPR(gO2,gI2))*CpbarFeFeVZpPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_1_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFd(gI2)),Sqr(MVZp))*Conj(
      CpbarFdFdVZpPR(gO2,gI2))*CpbarFdFdVZpPL(gO1,gI2)*MFd(gI2));
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI2)),Sqr(MVWm))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_PR_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFd(gI2)),Sqr(MVZp))*Conj(
      CpbarFdFdVZpPL(gO2,gI2))*CpbarFdFdVZpPL(gO1,gI2));
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFu(gI2)),Sqr(MVWm))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_PL_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFd(gI2)),Sqr(MVZp))*Conj(
      CpbarFdFdVZpPR(gO2,gI2))*CpbarFdFdVZpPR(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_1_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI2)),Sqr(MVZp))*Conj(
      CpbarFuFuVZpPR(gO2,gI2))*CpbarFuFuVZpPL(gO1,gI2)*MFu(gI2));
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_PR_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFu(gI2)),Sqr(MVZp))*Conj(
      CpbarFuFuVZpPL(gO2,gI2))*CpbarFuFuVZpPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_PL_heavy_rotated(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFu(gI2)),Sqr(MVZp))*Conj(
      CpbarFuFuVZpPR(gO2,gI2))*CpbarFuFuVZpPR(gO1,gI2));
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VG)
         ;
}
...
void CLASSNAME::calculate_MGlu_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Glu);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Glu
         );
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fv)
         ;
}
...
void CLASSNAME::calculate_MChaP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChaP)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::ChaP);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VP)
         ;
}
...
void CLASSNAME::calculate_MVZ_pole()
{
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(E6SSMEFTHiggs_info::VZ);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VZ)
         ;
}
...
void CLASSNAME::calculate_MVZp_pole()
{
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(E6SSMEFTHiggs_info::VZp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VZp);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VZp
         );
}
...
void CLASSNAME::calculate_MSd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZD;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::Sd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Sd);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Sd)
         ;
}
...
void CLASSNAME::calculate_MSv_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZV;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::Sv,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZV);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Sv);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Sv)
         ;
}
...
void CLASSNAME::calculate_MSu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZU;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::Su,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZU);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Su);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Su)
         ;
}
...
void CLASSNAME::calculate_MSe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZE;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::Se,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZE);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Se);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Se)
         ;
}
...
void CLASSNAME::calculate_MSDX_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZDX;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::SDX,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZDX);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SDX);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SDX
         );
}
...
void CLASSNAME::calculate_Mhh_pole()
{
   ...
   Eigen::Matrix<double,3,3> self_energy_2l(Eigen::Matrix<double,3,3>
      ::Zero());
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(E6SSMEFTHiggs_info::hh)
                  ;
            }
         }
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::hh)
         ;
}
...
void CLASSNAME::calculate_MAh_pole()
{
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(E6SSMEFTHiggs_info::Ah)
                  ;
            }
         }
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Ah)
         ;
}
...
void CLASSNAME::calculate_MHpm_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Hpm
         );
}
...
void CLASSNAME::calculate_MChi_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         decltype(ZN) mix_ZN;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::Chi,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZN);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Chi);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Chi
         );
}
...
void CLASSNAME::calculate_MCha_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP,
            eigenvalue_error);
         problems.flag_bad_mass(E6SSMEFTHiggs_info::Cha,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Cha);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Cha
         );
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER,
            eigenvalue_error);
         problems.flag_bad_mass(E6SSMEFTHiggs_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fe)
         ;
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR,
            eigenvalue_error);
         problems.flag_bad_mass(E6SSMEFTHiggs_info::Fd,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fd)
         ;
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR,
            eigenvalue_error);
         problems.flag_bad_mass(E6SSMEFTHiggs_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::Fu)
         ;
}
...
void CLASSNAME::calculate_MFDX_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZDXL, mix_ZDXR,
            eigenvalue_error);
         problems.flag_bad_mass(E6SSMEFTHiggs_info::FDX,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZDXL, mix_ZDXR);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::FDX);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::FDX
         );
}
...
void CLASSNAME::calculate_MSHI0_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         Eigen::Matrix<double,4,4> mix_UHI0;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::SHI0,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_UHI0);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHI0)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::SHI0);
...
void CLASSNAME::calculate_MSHIp_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         Eigen::Matrix<double,4,4> mix_UHIp;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::SHIp,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_UHIp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHIp)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::SHIp);
...
void CLASSNAME::calculate_MChaI_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZMI, mix_ZPI,
            eigenvalue_error);
         problems.flag_bad_mass(E6SSMEFTHiggs_info::ChaI,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZMI, mix_ZPI);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChaI)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::ChaI);
}
...
void CLASSNAME::calculate_MChiI_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         decltype(ZNI) mix_ZNI;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::ChiI,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZNI);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChiI)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::ChiI);
}

void CLASSNAME::calculate_MSSI0_pole()
{
   if (!force_output && problems.is_running_tachyon(
      E6SSMEFTHiggs_info::SSI0))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZSSI;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::SSI0,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZSSI);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SSI0)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::SSI0);
...
void CLASSNAME::calculate_MFSI_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         decltype(ZFSI) mix_ZFSI;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::FSI,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZFSI);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::FSI);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::FSI
         );
}
...
void CLASSNAME::calculate_MSHp0_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_UHp0;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::SHp0,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_UHp0);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHp0)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::SHp0);
...
void CLASSNAME::calculate_MSHpp_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_UHpp;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::SHpp,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_UHpp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHpp)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::SHpp);
...
void CLASSNAME::calculate_MChiP_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         decltype(ZNp) mix_ZNp;
            ...
            problems.flag_bad_mass(E6SSMEFTHiggs_info::ChiP,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZNp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChiP)
         ;
   else
      problems.unflag_no_pole_mass_convergence(
         E6SSMEFTHiggs_info::ChiP);
}

void CLASSNAME::calculate_MVWm_pole()
{
   if (!force_output && problems.is_running_tachyon(
      E6SSMEFTHiggs_info::VWm))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(E6SSMEFTHiggs_info::VWm);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VWm);
   else
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::VWm
         );
}
...
std::ostream& operator<<(std::ostream& ostr, const E6SSMEFTHiggs_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
