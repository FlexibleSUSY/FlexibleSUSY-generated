 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:07:23 with FlexibleSUSY
...
void CLASSNAME::calculate_MChaP_pole()
{
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChaP);
}
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::VZ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::VZp))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::Sv))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::SDX))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::hh))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::Ah))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::SHI0))
      return;
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHI0);
}

void CLASSNAME::calculate_MSHIp_pole()
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::SHIp))
      return;
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHIp);
}
...
void CLASSNAME::calculate_MChaI_pole()
{
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChaI);
}
...
void CLASSNAME::calculate_MChiI_pole()
{
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChiI);
}

void CLASSNAME::calculate_MSSI0_pole()
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::SSI0))
      return;
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SSI0);
}
...
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::SHp0))
      return;
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHp0);
}

void CLASSNAME::calculate_MSHpp_pole()
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::SHpp))
      return;
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::SHpp);
}
...
void CLASSNAME::calculate_MChiP_pole()
{
   ...
   if (diff > precision)
      ...
      problems.unflag_no_pole_mass_convergence(E6SSMEFTHiggs_info::ChiP);
}

void CLASSNAME::calculate_MVWm_pole()
{
   if (!force_output && problems.is_running_tachyon(E6SSMEFTHiggs_info::VWm))
      return;
