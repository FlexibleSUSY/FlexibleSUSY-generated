 ...
 */
double E6SSMEFTHiggs_susy_parameters::calc_beta_Lambdax_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambdax = Re(0.1*Lambdax*(30*traceKappaAdjKappa + 20*
 ...
 */
double E6SSMEFTHiggs_susy_parameters::calc_beta_Lambdax_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambdax = Re(-0.005*Lambdax*(1200*traceKappaAdjKappaKappaAdjKappa + 800
 ...
 */
double E6SSMEFTHiggs_susy_parameters::calc_beta_Lambdax_3_loop(const Susy_traces& susy_traces) const
{
