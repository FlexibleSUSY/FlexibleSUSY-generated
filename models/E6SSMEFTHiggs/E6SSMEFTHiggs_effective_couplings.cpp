...
E6SSMEFTHiggs_effective_couplings::E6SSMEFTHiggs_effective_couplings(
   const E6SSMEFTHiggs_mass_eigenstates& model_,
...
void E6SSMEFTHiggs_effective_couplings::calculate_effective_couplings()
{
...
void E6SSMEFTHiggs_effective_couplings::set_model(const E6SSMEFTHiggs_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void E6SSMEFTHiggs_effective_couplings::copy_mixing_matrices_from_model()
{
...
standard_model::Standard_model E6SSMEFTHiggs_effective_couplings::initialise_SM() const
{
...
void E6SSMEFTHiggs_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double E6SSMEFTHiggs_effective_couplings::number_of_active_flavours(double m) const
{
...
double E6SSMEFTHiggs_effective_couplings::scalar_scaling_factor(double m) const
{
...
double E6SSMEFTHiggs_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double E6SSMEFTHiggs_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double E6SSMEFTHiggs_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double E6SSMEFTHiggs_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double E6SSMEFTHiggs_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFeFeAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFeFehhPL(int gO2, int gI2, int gI1) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFdFdAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFdFdhhPL(int gO2, int gI2, int gI1) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFuFuAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFuFuhhPL(int gO2, int gI2, int gI1) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.008333333333333333*(SUM(j1,0,2,Conj(ZD
      ...
      *(-42.42640687119285*SUM(j1,0,2,Conj(ZD(gt2,3 + j1))*Conj(TYd(j1,j1))*ZD(gt3
      ...
      (g1) + 9*Sqr(gN))*ZH(gt1,0) + 6*vu*(-Sqr(g1) + Sqr(gN))*ZH(gt1,1) - 15*vs*
      Sqr(gN)*ZH(gt1,2)) - 30*(1.4142135623730951*SUM(j1,0,2,Conj(ZD(gt2,j1))*ZD(
      gt3,3 + j1)*TYd(j1,j1))*ZH(gt1,0) + 2*vd*SUM(j2,0,2,AbsSqr(Yd(j2,j2))*Conj(
      ZD(gt2,j2))*ZD(gt3,j2))*ZH(gt1,0) + 2*vd*SUM(j2,0,2,AbsSqr(Yd(j2,j2))*Conj(
      ZD(gt2,3 + j2))*ZD(gt3,3 + j2))*ZH(gt1,0) - vs*Lambdax*SUM(j1,0,2,Conj(Yd(j1
      ,j1))*Conj(ZD(gt2,3 + j1))*ZD(gt3,j1))*ZH(gt1,1) - vs*Conj(Lambdax)*SUM(j1,0
      ,2,Conj(ZD(gt2,j1))*Yd(j1,j1)*ZD(gt3,3 + j1))*ZH(gt1,1) - vu*Lambdax*SUM(j1,
      0,2,Conj(Yd(j1,j1))*Conj(ZD(gt2,3 + j1))*ZD(gt3,j1))*ZH(gt1,2) - vu*Conj(
      Lambdax)*SUM(j1,0,2,Conj(ZD(gt2,j1))*Yd(j1,j1)*ZD(gt3,3 + j1))*ZH(gt1,2))));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.025*(-8*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZU(
      gt2,3 + j1))*ZU(gt3,3 + j1))*ZH(gt1,0) + 3*vd*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gt2
      ,3 + j1))*ZU(gt3,3 + j1))*ZH(gt1,0) + 20*vs*Conj(Lambdax)*SUM(j1,0,2,Conj(ZU
      (gt2,j1))*Yu(j1,j1)*ZU(gt3,3 + j1))*ZH(gt1,0) - 28.284271247461902*SUM(j1,0,
      2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j1))*ZU(gt3,j1))*ZH(gt1,1) + 8*vu*Sqr(g1)
      *SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1))*ZH(gt1,1) + 2*vu*Sqr(gN)*
      SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1))*ZH(gt1,1) -
      28.284271247461902*SUM(j1,0,2,Conj(ZU(gt2,j1))*ZU(gt3,3 + j1)*TYu(j1,j1))*ZH
      (gt1,1) - 40*vu*SUM(j2,0,2,AbsSqr(Yu(j2,j2))*Conj(ZU(gt2,j2))*ZU(gt3,j2))*ZH
      (gt1,1) - 40*vu*SUM(j2,0,2,AbsSqr(Yu(j2,j2))*Conj(ZU(gt2,3 + j2))*ZU(gt3,3 +
      j2))*ZH(gt1,1) - 5*vs*Sqr(gN)*SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1
      ))*ZH(gt1,2) + 20*vd*Conj(Lambdax)*SUM(j1,0,2,Conj(ZU(gt2,j1))*Yu(j1,j1)*ZU(
      gt3,3 + j1))*ZH(gt1,2) + 20*Lambdax*SUM(j1,0,2,Conj(Yu(j1,j1))*Conj(ZU(gt2,3
      + j1))*ZU(gt3,j1))*(vs*ZH(gt1,0) + vd*ZH(gt1,2)) + SUM(j1,0,2,Conj(ZU(gt2,
      j1))*ZU(gt3,j1))*(vd*(2*Sqr(g1) - 10*Sqr(g2) + 3*Sqr(gN))*ZH(gt1,0) + 2*vu*(
      -Sqr(g1) + 5*Sqr(g2) + Sqr(gN))*ZH(gt1,1) - 5*vs*Sqr(gN)*ZH(gt1,2)));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhSeconjSe(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.025*(-28.284271247461902*SUM(j1,0,2,
      Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j1))*ZE(gt3,j1))*ZH(gt1,0) + 12*vd*Sqr(g1)*
      SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*ZH(gt1,0) + 3*vd*Sqr(gN)*SUM
      (j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*ZH(gt1,0) - 28.284271247461902*
      SUM(j1,0,2,Conj(ZE(gt2,j1))*ZE(gt3,3 + j1)*TYe(j1,j1))*ZH(gt1,0) - 40*vd*SUM
      (j2,0,2,AbsSqr(Ye(j2,j2))*Conj(ZE(gt2,j2))*ZE(gt3,j2))*ZH(gt1,0) - 40*vd*SUM
      (j2,0,2,AbsSqr(Ye(j2,j2))*Conj(ZE(gt2,3 + j2))*ZE(gt3,3 + j2))*ZH(gt1,0) +
      20*vs*Lambdax*SUM(j1,0,2,Conj(Ye(j1,j1))*Conj(ZE(gt2,3 + j1))*ZE(gt3,j1))*ZH
      (gt1,1) - 12*vu*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*ZH(
      gt1,1) + 2*vu*Sqr(gN)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*ZH(gt1
      ,1) + 20*vs*Conj(Lambdax)*SUM(j1,0,2,Conj(ZE(gt2,j1))*Ye(j1,j1)*ZE(gt3,3 +
      j1))*ZH(gt1,1) + 20*vu*Lambdax*SUM(j1,0,2,Conj(Ye(j1,j1))*Conj(ZE(gt2,3 + j1
      ))*ZE(gt3,j1))*ZH(gt1,2) - 5*vs*Sqr(gN)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(
      gt3,3 + j1))*ZH(gt1,2) + 20*vu*Conj(Lambdax)*SUM(j1,0,2,Conj(ZE(gt2,j1))*Ye(
      j1,j1)*ZE(gt3,3 + j1))*ZH(gt1,2) - 2*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZE(gt3,j1))
      *(vd*(3*Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN))*ZH(gt1,0) + vu*(-3*Sqr(g1) + 5*Sqr(
      g2) - 2*Sqr(gN))*ZH(gt1,1) + 5*vs*Sqr(gN)*ZH(gt1,2)));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhSDXconjSDX(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.025*(4*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZDX(
      gt2,3 + j1))*ZDX(gt3,3 + j1))*ZH(gt1,0) - 9*vd*Sqr(gN)*SUM(j1,0,2,Conj(ZDX(
      gt2,3 + j1))*ZDX(gt3,3 + j1))*ZH(gt1,0) + 20*vu*Conj(Lambdax)*SUM(j1,0,2,
      Conj(ZDX(gt2,j1))*ZDX(gt3,3 + j1)*Kappa(j1,j1))*ZH(gt1,0) - 4*vu*Sqr(g1)*SUM
      (j1,0,2,Conj(ZDX(gt2,3 + j1))*ZDX(gt3,3 + j1))*ZH(gt1,1) - 6*vu*Sqr(gN)*SUM(
      j1,0,2,Conj(ZDX(gt2,3 + j1))*ZDX(gt3,3 + j1))*ZH(gt1,1) + 20*vd*Conj(Lambdax
      )*SUM(j1,0,2,Conj(ZDX(gt2,j1))*ZDX(gt3,3 + j1)*Kappa(j1,j1))*ZH(gt1,1) + 20*
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.025*(2*ZH(gt1,1)*(ZP(gt2,0)*(vu*(3*Sqr
      (g1) - 5*Sqr(g2) - 3*Sqr(gN))*ZP(gt3,0) - 5*vd*(-2*AbsSqr(Lambdax) + Sqr(g2)
      )*ZP(gt3,1)) - ZP(gt2,1)*(5*vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vu
      *(3*Sqr(g1) + 5*Sqr(g2) + 2*Sqr(gN))*ZP(gt3,1))) - ZH(gt1,0)*(ZP(gt2,0)*(vd*
      (6*Sqr(g1) + 10*Sqr(g2) + 9*Sqr(gN))*ZP(gt3,0) + 10*vu*(-2*AbsSqr(Lambdax) +
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarChaChahhPL(int gt3, int gt1, int gt2) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Lambdax = MODELPARAMETER(Lambdax);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFDXFDXhhPL(int gt3, int gt1, int gt2) const
{
   const auto Kappa = MODELPARAMETER(Kappa);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhSHIpconjSHIp(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.025*(SUM(j1,0,1,Conj(UHIp(gt2,j1))*
      UHIp(gt3,j1))*(vd*(-6*Sqr(g1) + 10*Sqr(g2) - 9*Sqr(gN))*ZH(gt1,0) + 2*vu*(3*
      Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN))*ZH(gt1,1) + 15*vs*Sqr(gN)*ZH(gt1,2)) + 2*(
      10*Lambdax*SUM(j1,0,1,Conj(UHIp(gt2,2 + j1))*Conj(Lambda12(j1,j1))*UHIp(gt3,
      j1))*(vu*ZH(gt1,0) + vd*ZH(gt1,1)) + SUM(j1,0,1,Conj(UHIp(gt2,2 + j1))*UHIp(
      gt3,2 + j1))*(vd*(3*Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN))*ZH(gt1,0) + vu*(-3*Sqr(
      g1) + 5*Sqr(g2) - 2*Sqr(gN))*ZH(gt1,1) + 5*vs*Sqr(gN)*ZH(gt1,2)) + 10*(Conj(
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarChaIChaIhhPL(int gt3, int gt1, int gt2) const
{
   const auto Lambda12 = MODELPARAMETER(Lambda12);

   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,1,Conj(ZMI(
      gt1,j1))*Conj(ZPI(gt3,j1))*Lambda12(j1,j1))*ZH(gt2,2);

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CphhSHppconjSHpp(int gt1, int gt2, int gt3) const
{
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
   const auto gN = MODELPARAMETER(gN);
   ...
   const std::complex<double> result = -0.05*(Conj(UHpp(gt2,0))*UHpp(gt3,0) -
      Conj(UHpp(gt2,1))*UHpp(gt3,1))*(vd*(3*Sqr(g1) - 5*Sqr(g2) - 3*Sqr(gN))*ZH(
      gt1,0) + vu*(-3*Sqr(g1) + 5*Sqr(g2) - 2*Sqr(gN))*ZH(gt1,1) + 5*vs*Sqr(gN)*ZH
      (gt1,2));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CpAhSdconjSd(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto vs = MODELPARAMETER(vs);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpAhSuconjSu(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto vd = MODELPARAMETER(vd);
   const auto vs = MODELPARAMETER(vs);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpAhSeconjSe(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto vs = MODELPARAMETER(vs);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpAhSDXconjSDX(int gt1, int gt2, int gt3) const
{
   const auto TKappa = MODELPARAMETER(TKappa);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(Lambdax*SUM
      (j1,0,2,Conj(ZDX(gt2,3 + j1))*Conj(Kappa(j1,j1))*ZDX(gt3,j1))*(vu*ZA(gt1,0)
      + vd*ZA(gt1,1)) - Conj(Lambdax)*SUM(j1,0,2,Conj(ZDX(gt2,j1))*ZDX(gt3,3 + j1)
      *Kappa(j1,j1))*(vu*ZA(gt1,0) + vd*ZA(gt1,1)) + 1.4142135623730951*(SUM(j1,0,
      2,Conj(ZDX(gt2,3 + j1))*Conj(TKappa(j1,j1))*ZDX(gt3,j1)) - SUM(j1,0,2,Conj(
      ZDX(gt2,j1))*ZDX(gt3,3 + j1)*TKappa(j1,j1)))*ZA(gt1,2));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CpAhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto TLambdax = MODELPARAMETER(TLambdax);
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
...
std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarChaChaAhPL(int gt3, int gt2, int gt1) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Lambdax = MODELPARAMETER(Lambdax);

   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*(g2*Conj(UM(gt2,0))*Conj(UP(gt3,1))*ZA(gt1,1) + Conj(UM(
      gt2,1))*(g2*Conj(UP(gt3,0))*ZA(gt1,0) - Conj(UP(gt3,1))*Lambdax*ZA(gt1,2)));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarFDXFDXAhPL(int gt3, int gt2, int gt1) const
{
   const auto Kappa = MODELPARAMETER(Kappa);

   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*SUM(j1,0,2,Conj(ZDXL(gt2,j1))*Conj(ZDXR(gt3,j1))*Kappa(
      j1,j1))*ZA(gt1,2);

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CpAhSHIpconjSHIp(int gt1, int gt2, int gt3) const
{
   const auto TLambda12 = MODELPARAMETER(TLambda12);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(Lambdax*SUM
      (j1,0,1,Conj(UHIp(gt2,2 + j1))*Conj(Lambda12(j1,j1))*UHIp(gt3,j1))*(vu*ZA(
      gt1,0) + vd*ZA(gt1,1)) - Conj(Lambdax)*SUM(j1,0,1,Conj(UHIp(gt2,j1))*UHIp(
      gt3,2 + j1)*Lambda12(j1,j1))*(vu*ZA(gt1,0) + vd*ZA(gt1,1)) +
      1.4142135623730951*(SUM(j1,0,1,Conj(UHIp(gt2,2 + j1))*Conj(TLambda12(j1,j1))
      *UHIp(gt3,j1)) - SUM(j1,0,1,Conj(UHIp(gt2,j1))*UHIp(gt3,2 + j1)*TLambda12(j1
      ,j1)))*ZA(gt1,2));

   return result;
}

std::complex<double> E6SSMEFTHiggs_effective_couplings::CpbarChaIChaIAhPL(int gt3, int gt2, int gt1) const
{
   const auto Lambda12 = MODELPARAMETER(Lambda12);

   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*SUM(j1,0,1,Conj(ZMI(gt2,j1))*Conj(ZPI(gt3,j1))*Lambda12
      (j1,j1))*ZA(gt1,2);

   return result;
}

void E6SSMEFTHiggs_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   ...
   for (int gI1 = 0; gI1 < 3; ++gI1) {
      result += 0.3333333333333333 * scalar_fermion_qcd_factor(decay_mass,
         MFDX(gI1)) * CpbarFDXFDXhhPL(gI1, gI1, gO1) * vev * AS12(decay_scale /
   ...
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += CpbarChaIChaIhhPL(gI1, gI1, gO1) * vev * AS12(decay_scale /
...
void E6SSMEFTHiggs_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
   ...
   for (int gI1 = 0; gI1 < 3; ++gI1) {
      result += CpbarFDXFDXhhPL(gI1, gI1, gO1) * vev * AS12(decay_scale /
         Sqr(MFDX(gI1))) / MFDX(gI1);
   }
   result *= 0.75;
...
void E6SSMEFTHiggs_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto MCha = MODELPARAMETER(MCha);
   ...
   for (int gI1 = 0; gI1 < 3; ++gI1) {
      result += 0.3333333333333333 * pseudoscalar_fermion_qcd_factor(
         decay_mass, MFDX(gI1)) * CpbarFDXFDXAhPL(gI1, gI1, gO1) * vev * AP12(
         decay_scale / Sqr(MFDX(gI1))) / MFDX(gI1);
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += CpbarChaIChaIAhPL(gI1, gI1, gO1) * vev * AP12(decay_scale /
         Sqr(MChaI(gI1))) / MChaI(gI1);
   }
   result *= 2.0;
...
void E6SSMEFTHiggs_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
   ...
   for (int gI1 = 0; gI1 < 3; ++gI1) {
      result += CpbarFDXFDXAhPL(gI1, gI1, gO1) * vev * AP12(decay_scale /
         Sqr(MFDX(gI1))) / MFDX(gI1);
   }
   result *= 1.5;
