...
#ifndef E6SSMEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H
#define E6SSMEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H

#include "E6SSMEFTHiggs_initial_guesser.hpp"
...
template <class T>
class E6SSMEFTHiggs_standard_model_initial_guesser;

/**
 * @class E6SSMEFTHiggs_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the E6SSMEFTHiggs tower
 */

template<>
class E6SSMEFTHiggs_standard_model_initial_guesser<Two_scale> : public Initial_guesser {
public:
   E6SSMEFTHiggs_standard_model_initial_guesser(E6SSMEFTHiggs<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const E6SSMEFTHiggs_susy_scale_constraint<Two_scale>&);
   virtual ~E6SSMEFTHiggs_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   E6SSMEFTHiggs<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   E6SSMEFTHiggs_susy_scale_constraint<Two_scale> susy_constraint{};
