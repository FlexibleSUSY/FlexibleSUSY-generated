...
E6SSMEFTHiggs_convergence_tester<Two_scale>::E6SSMEFTHiggs_convergence_tester(
   E6SSMEFTHiggs<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<E6SSMEFTHiggs<Two_scale> >(model, accuracy_goal, sg)
{
}

double E6SSMEFTHiggs_convergence_tester<Two_scale>::max_rel_diff() const
{
   const E6SSMEFTHiggs<Two_scale>& ol = get_last_iteration_model();
   const E6SSMEFTHiggs<Two_scale>& ne = get_current_iteration_model();
