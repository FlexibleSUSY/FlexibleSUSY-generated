...
// File generated at Tue 22 Jan 2019 14:42:55
...
/**
 * Calculates the 1-loop beta function of mHpbar2.
 *
 * @return 1-loop beta function
 */
double E6SSMEFTHiggs_soft_parameters::calc_beta_mHpbar2_1_loop(const Soft_traces& soft_traces) const
{
...
/**
 * Calculates the 2-loop beta function of mHpbar2.
 *
 * @return 2-loop beta function
 */
double E6SSMEFTHiggs_soft_parameters::calc_beta_mHpbar2_2_loop(const Soft_traces& soft_traces) const
{
...
/**
 * Calculates the 3-loop beta function of mHpbar2.
 *
 * @return 3-loop beta function
 */
double E6SSMEFTHiggs_soft_parameters::calc_beta_mHpbar2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double E6SSMEFTHiggs_soft_parameters::calc_beta_mHpbar2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double E6SSMEFTHiggs_soft_parameters::calc_beta_mHpbar2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
