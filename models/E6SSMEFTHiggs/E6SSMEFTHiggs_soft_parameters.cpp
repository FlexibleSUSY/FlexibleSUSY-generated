...
// File generated at Wed 16 Oct 2019 19:09:38
...
const int E6SSMEFTHiggs_soft_parameters::numberOfParameters;

E6SSMEFTHiggs_soft_parameters::E6SSMEFTHiggs_soft_parameters(const E6SSMEFTHiggs_input_parameters& input_)
   : E6SSMEFTHiggs_susy_parameters(input_)
{
...
Eigen::ArrayXd E6SSMEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

E6SSMEFTHiggs_soft_parameters E6SSMEFTHiggs_soft_parameters::calc_beta(int loops) const
{
...
Eigen::ArrayXd E6SSMEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(E6SSMEFTHiggs_susy_parameters::get());
...
void E6SSMEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   E6SSMEFTHiggs_susy_parameters::print(ostr);
...
void E6SSMEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   E6SSMEFTHiggs_susy_parameters::set(pars);
...
E6SSMEFTHiggs_soft_parameters::Soft_traces E6SSMEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const E6SSMEFTHiggs_soft_parameters& soft_pars)
{
