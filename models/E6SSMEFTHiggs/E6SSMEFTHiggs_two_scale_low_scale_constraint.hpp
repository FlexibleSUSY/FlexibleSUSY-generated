...
#ifndef E6SSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define E6SSMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "E6SSMEFTHiggs_low_scale_constraint.hpp"
...
template<>
class E6SSMEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   E6SSMEFTHiggs_low_scale_constraint() = default;
   E6SSMEFTHiggs_low_scale_constraint(E6SSMEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~E6SSMEFTHiggs_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "E6SSMEFTHiggs low-scale constraint"; }
