...
// File generated at Tue 22 Jan 2019 14:42:58
...
Eigen::ArrayXd E6SSMEFTHiggs_input_parameters::get() const
{
   ...
   pars(59) = mq2Input(0,0);
   pars(60) = mq2Input(0,1);
   pars(61) = mq2Input(0,2);
   pars(62) = mq2Input(1,0);
   pars(63) = mq2Input(1,1);
   pars(64) = mq2Input(1,2);
   pars(65) = mq2Input(2,0);
   pars(66) = mq2Input(2,1);
   pars(67) = mq2Input(2,2);
   pars(68) = md2Input(0,0);
   pars(69) = md2Input(0,1);
   pars(70) = md2Input(0,2);
   pars(71) = md2Input(1,0);
   pars(72) = md2Input(1,1);
   pars(73) = md2Input(1,2);
   pars(74) = md2Input(2,0);
   pars(75) = md2Input(2,1);
   pars(76) = md2Input(2,2);
   pars(77) = mu2Input(0,0);
   pars(78) = mu2Input(0,1);
   pars(79) = mu2Input(0,2);
   pars(80) = mu2Input(1,0);
   pars(81) = mu2Input(1,1);
   pars(82) = mu2Input(1,2);
   pars(83) = mu2Input(2,0);
   pars(84) = mu2Input(2,1);
   pars(85) = mu2Input(2,2);
...
void E6SSMEFTHiggs_input_parameters::set(const Eigen::ArrayXd& pars)
{
   MSUSY = pars(0);
   M1Input = pars(1);
   M2Input = pars(2);
   ...
   mq2Input(0,0) = pars(59);
   mq2Input(0,1) = pars(60);
   mq2Input(0,2) = pars(61);
   mq2Input(1,0) = pars(62);
   mq2Input(1,1) = pars(63);
   mq2Input(1,2) = pars(64);
   mq2Input(2,0) = pars(65);
   mq2Input(2,1) = pars(66);
   mq2Input(2,2) = pars(67);
   md2Input(0,0) = pars(68);
   md2Input(0,1) = pars(69);
   md2Input(0,2) = pars(70);
   md2Input(1,0) = pars(71);
   md2Input(1,1) = pars(72);
   md2Input(1,2) = pars(73);
   md2Input(2,0) = pars(74);
   md2Input(2,1) = pars(75);
   md2Input(2,2) = pars(76);
   mu2Input(0,0) = pars(77);
   mu2Input(0,1) = pars(78);
   mu2Input(0,2) = pars(79);
   mu2Input(1,0) = pars(80);
   mu2Input(1,1) = pars(81);
   mu2Input(1,2) = pars(82);
   mu2Input(2,0) = pars(83);
   mu2Input(2,1) = pars(84);
   mu2Input(2,2) = pars(85);
...
std::ostream& operator<<(std::ostream& ostr, const E6SSMEFTHiggs_input_parameters& input)
{
