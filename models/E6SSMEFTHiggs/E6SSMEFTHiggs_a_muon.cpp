...
#include "E6SSMEFTHiggs_FFV_form_factors.hpp"
...
double get_MSUSY(const E6SSMEFTHiggs_mass_eigenstates_interface& model)
{
...
void run_to_MSUSY(E6SSMEFTHiggs_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("E6SSMEFTHiggs_a_muon: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("E6SSMEFTHiggs_a_muon:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("E6SSMEFTHiggs_a_muon: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("E6SSMEFTHiggs_a_muon: run_to_MSUSY(): "
...
double calculate_a_muon_impl(const E6SSMEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   VERBOSE_MSG("E6SSMEFTHiggs_a_muon: calculating a_mu at Q = " << model.get_scale());

   context_base context{ model };

   using namespace E6SSMEFTHiggs_cxx_diagrams::fields;

   const auto form_factors = E6SSMEFTHiggs_FFV_form_factors::calculate_Fe_Fe_VP_form_factors(1, 1, model, true);
   ...
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Cha>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<ChaI>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Fd>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<FDX>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Fe>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Fu>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Hpm>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Sd>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SDX>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Se>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SHIp>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Su>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Cha>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<ChaI>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Fd>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<FDX>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Fe>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoop<typename bar<Fu>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Hpm>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Sd>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SDX>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Se>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SHIp>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<SHpp>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeScalarLoop<typename conj<Su>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeVectorLoop<typename conj<VWm>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Cha>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<ChaI>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Fd>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<FDX>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Fe>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Fu>::type, Ah>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Cha>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<ChaI>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Fd>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<FDX>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {1.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Fe>::type, hh>::value({1}, context, qedqcd);
   valBarZee += std::complex<double> {3.000000000000000, 0} * AMuonBarZeeFermionLoopZ<typename bar<Fu>::type, hh>::value({1}, context, qedqcd);
...
std::pair<double,double> vary_scale(const E6SSMEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model,&qedqcd] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("E6SSMEFTHiggs_a_muon: scale variation: " << e.what_detailed());
                     }
                     return amu;
                  });
...
double E6SSMEFTHiggs_a_muon::calculate_a_muon(const E6SSMEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   E6SSMEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("E6SSMEFTHiggs_a_muon: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("E6SSMEFTHiggs_a_muon:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
double E6SSMEFTHiggs_a_muon::calculate_a_muon_uncertainty(const E6SSMEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   E6SSMEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("E6SSMEFTHiggs_a_muon: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("E6SSMEFTHiggs_a_muon uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
