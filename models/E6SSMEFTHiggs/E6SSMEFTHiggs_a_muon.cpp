...
// File generated at Fri 20 Oct 2017 08:47:11

/**
 * @file E6SSMEFTHiggs_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 08:47:11 with FlexibleSUSY
...
#include "E6SSMEFTHiggs_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(E6SSMEFTHiggs_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const E6SSMEFTHiggs_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("E6SSMEFTHiggs_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double E6SSMEFTHiggs_a_muon::calculate_a_muon(const E6SSMEFTHiggs_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("E6SSMEFTHiggs_a_muon:" << e.what());
...
double E6SSMEFTHiggs_a_muon::calculate_a_muon_uncertainty(const E6SSMEFTHiggs_mass_eigenstates& model_)
{
   E6SSMEFTHiggs_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("E6SSMEFTHiggs_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
