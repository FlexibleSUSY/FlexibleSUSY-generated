...
// File generated at Fri 20 Oct 2017 08:47:49

/**
 * @file E6SSMEFTHiggs_cxx_diagrams.hpp
 *
 * This file was generated at Fri 20 Oct 2017 08:47:49 with FlexibleSUSY
 * 2.0.1 and SARAH 4.12.0 .
 */

#ifndef E6SSMEFTHiggs_CXXDIAGRAMS_H
#define E6SSMEFTHiggs_CXXDIAGRAMS_H
...
struct ChaP {
   ...
   using lorentz_conjugate = bar<ChaP>::type;
};
...
struct gZp {
   ...
   static constexpr int numberOfFieldIndices = 0;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = bar<gZp>::type;
};
...
struct SDX {
   ...
   static constexpr int numberOfFieldIndices = 2;
   static constexpr double electric_charge = -0.3333333333333333;
   using lorentz_conjugate = conj<SDX>::type;
};
...
struct FDX {
   ...
   static constexpr int numberOfFieldIndices = 2;
   static constexpr double electric_charge = -0.3333333333333333;
   using lorentz_conjugate = bar<FDX>::type;
};
...
struct SHI0 {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = conj<SHI0>::type;
};
...
struct SHIp {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = -1;
   using lorentz_conjugate = conj<SHIp>::type;
};
...
struct ChaI {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = -1;
   using lorentz_conjugate = bar<ChaI>::type;
};
...
struct SSI0 {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = conj<SSI0>::type;
};
...
struct SHp0 {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
   using lorentz_conjugate = conj<SHp0>::type;
};
...
struct SHpp {
   ...
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = -1;
   using lorentz_conjugate = conj<SHpp>::type;
};
...
*/
struct EvaluationContext {
   E6SSMEFTHiggs_mass_eigenstates& model; ///< The model object.
...
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 3, 3 } };
...
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 6, 6 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
};
...
Vertex<bar<Fe>::type, Ah, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,-0.7071067811865475)*SUM(j1,0,2,Conj(ZEL(gt3,j1))*Conj(ZER(gt1,j1))*Ye(j1,j1))*ZA(gt2,0);

   const std::complex<double> right = std::complex<double>(0.,0.7071067811865475)*SUM(j1,0,2,Conj(Ye(j1,j1))*ZEL(gt1,j1)*ZER(gt3,j1))*ZA(gt2,0);
...
Vertex<Fe, Ah, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,-0.7071067811865475)*SUM(j1,0,2,Conj(ZEL(gt1,j1))*Conj(ZER(gt3,j1))*Ye(j1,j1))*ZA(gt2,0);

   const std::complex<double> right = std::complex<double>(0.,0.7071067811865475)*SUM(j1,0,2,Conj(Ye(j1,j1))*ZEL(gt3,j1)*ZER(gt1,j1))*ZA(gt2,0);
...
Vertex<Fe, Chi, conj<Se>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = 0.5477225575051661*g1*Conj(ZN(gt2,0))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1)) + 0.7071067811865475*g2*Conj(ZN(gt2,1))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1)) - 0.4472135954999579*gN*Conj(ZN(gt2,5))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1)) - Conj(ZN(gt2,2))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*Ye(j1,j1)*ZE(gt3,3 + j1));

   const std::complex<double> right = -(SUM(j1,0,2,Conj(Ye(j1,j1))*ZE(gt3,j1)*ZER(gt1,j1))*ZN(gt2,2)) - 0.22360679774997896*SUM(j1,0,2,ZE(gt3,3 + j1)*ZER(gt1,j1))*(4.898979485566356*g1*ZN(gt2,0) + gN*ZN(gt2,5));
...
Vertex<Fe, bar<Fv>::type, conj<Hpm>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> right = IF(gt2 < 3,Conj(Ye(gt2,gt2))*ZER(gt1,gt2)*ZP(gt3,0),0);
...
Vertex<bar<Fe>::type, hh, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*SUM(j1,0,2,Conj(ZEL(gt3,j1))*Conj(ZER(gt1,j1))*Ye(j1,j1))*ZH(gt2,0);

   const std::complex<double> right = -0.7071067811865475*SUM(j1,0,2,Conj(Ye(j1,j1))*ZEL(gt1,j1)*ZER(gt3,j1))*ZH(gt2,0);
...
Vertex<Fe, hh, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*SUM(j1,0,2,Conj(ZEL(gt1,j1))*Conj(ZER(gt3,j1))*Ye(j1,j1))*ZH(gt2,0);

   const std::complex<double> right = -0.7071067811865475*SUM(j1,0,2,Conj(Ye(j1,j1))*ZEL(gt3,j1)*ZER(gt1,j1))*ZH(gt2,0);
...
Vertex<bar<Fe>::type, Sv, Cha>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = Conj(UM(gt3,1))*SUM(j1,0,2,Conj(ZER(gt1,j1))*Conj(ZV(gt2,j1))*Ye(j1,j1));
...
Vertex<Fe, conj<Sv>::type, bar<Cha>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> right = SUM(j1,0,2,Conj(Ye(j1,j1))*ZER(gt1,j1)*ZV(gt2,j1))*UM(gt3,1);
...
template<> inline
double EvaluationContext::mass_impl<ChaP>(const std::array<int, 0>& indices) const
...
template<> inline
double EvaluationContext::mass_impl<VZp>(const std::array<int, 0>& indices) const
...
template<> inline
double EvaluationContext::mass_impl<SDX>(const std::array<int, 2>& indices) const
...
template<> inline
double EvaluationContext::mass_impl<FDX>(const std::array<int, 2>& indices) const
{ return model.get_MFDX(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<SHI0>(const std::array<int, 1>& indices) const
{ return model.get_MSHI0(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<SHIp>(const std::array<int, 1>& indices) const
{ return model.get_MSHIp(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<ChaI>(const std::array<int, 1>& indices) const
{ return model.get_MChaI(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<ChiI>(const std::array<int, 1>& indices) const
{ return model.get_MChiI(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<SSI0>(const std::array<int, 1>& indices) const
{ return model.get_MSSI0(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<FSI>(const std::array<int, 1>& indices) const
{ return model.get_MFSI(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<SHp0>(const std::array<int, 1>& indices) const
{ return model.get_MSHp0(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<SHpp>(const std::array<int, 1>& indices) const
{ return model.get_MSHpp(indices[0]); }

template<> inline
double EvaluationContext::mass_impl<ChiP>(const std::array<int, 1>& indices) const
