...
E6SSMEFTHiggs_slha_io::E6SSMEFTHiggs_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void E6SSMEFTHiggs_slha_io::clear()
{
   slha_io.clear();
}
 ...
 */
void E6SSMEFTHiggs_slha_io::set_extpar(const E6SSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void E6SSMEFTHiggs_slha_io::set_imminpar(const E6SSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void E6SSMEFTHiggs_slha_io::set_imextpar(const E6SSMEFTHiggs_input_parameters& input)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void E6SSMEFTHiggs_slha_io::set_minpar(const E6SSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void E6SSMEFTHiggs_slha_io::set_input(const E6SSMEFTHiggs_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
   ...
   slha_io.set_block("AKAPPAIN", INPUTPARAMETER(AKappaInput), "AKappaInput");
   slha_io.set_block("ALAMBDA12IN", INPUTPARAMETER(ALambda12Input), "ALambda12Input");
   slha_io.set_block("AUIN", INPUTPARAMETER(AuInput), "AuInput");
   slha_io.set_block("KAPPAIN", INPUTPARAMETER(KappaInput), "KappaInput");
   slha_io.set_block("LAMBDA12IN", INPUTPARAMETER(Lambda12Input), "Lambda12Input");
   slha_io.set_block("MSD2IN", INPUTPARAMETER(md2Input), "md2Input");
   slha_io.set_block("MDX2IN", INPUTPARAMETER(mDx2Input), "mDx2Input");
   slha_io.set_block("MDXBAR2IN", INPUTPARAMETER(mDxbar2Input), "mDxbar2Input");
   slha_io.set_block("MSE2IN", INPUTPARAMETER(me2Input), "me2Input");
   slha_io.set_block("MH1I2IN", INPUTPARAMETER(mH1I2Input), "mH1I2Input");
   slha_io.set_block("MH2I2IN", INPUTPARAMETER(mH2I2Input), "mH2I2Input");
   slha_io.set_block("MSL2IN", INPUTPARAMETER(ml2Input), "ml2Input");
   slha_io.set_block("MSQ2IN", INPUTPARAMETER(mq2Input), "mq2Input");
   slha_io.set_block("MSI2IN", INPUTPARAMETER(msI2Input), "msI2Input");
 ...
 */
void E6SSMEFTHiggs_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void E6SSMEFTHiggs_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void E6SSMEFTHiggs_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::set_unitarity_infinite_s(
 ...
 */
void E6SSMEFTHiggs_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void E6SSMEFTHiggs_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void E6SSMEFTHiggs_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, E6SSMEFTHiggs_info::model_name)
 ...
 */
void E6SSMEFTHiggs_slha_io::set_mass(const E6SSMEFTHiggs_physical& physical,
 ...
 */
void E6SSMEFTHiggs_slha_io::set_mixing_matrices(const E6SSMEFTHiggs_physical& physical,
...
void E6SSMEFTHiggs_slha_io::set_ckm(
...
void E6SSMEFTHiggs_slha_io::set_pmns(
...
void E6SSMEFTHiggs_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void E6SSMEFTHiggs_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void E6SSMEFTHiggs_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void E6SSMEFTHiggs_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, E6SSMEFTHiggs_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void E6SSMEFTHiggs_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = E6SSMEFTHiggs_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + E6SSMEFTHiggs_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void E6SSMEFTHiggs_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double E6SSMEFTHiggs_slha_io::get_parameter_output_scale() const
{
 ...
 */
void E6SSMEFTHiggs_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void E6SSMEFTHiggs_slha_io::fill_drbar_parameters(E6SSMEFTHiggs_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void E6SSMEFTHiggs_slha_io::fill(E6SSMEFTHiggs_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   E6SSMEFTHiggs_physical physical_hk;
 ...
 */
void E6SSMEFTHiggs_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void E6SSMEFTHiggs_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void E6SSMEFTHiggs_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void E6SSMEFTHiggs_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void E6SSMEFTHiggs_slha_io::fill_minpar_tuple(E6SSMEFTHiggs_input_parameters& input,
...
void E6SSMEFTHiggs_slha_io::fill_extpar_tuple(E6SSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void E6SSMEFTHiggs_slha_io::fill_imminpar_tuple(E6SSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void E6SSMEFTHiggs_slha_io::fill_imextpar_tuple(E6SSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void E6SSMEFTHiggs_slha_io::fill_physical(E6SSMEFTHiggs_physical& physical) const
{
   {
