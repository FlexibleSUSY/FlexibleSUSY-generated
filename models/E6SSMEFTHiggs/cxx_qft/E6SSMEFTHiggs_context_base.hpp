...
namespace E6SSMEFTHiggs_cxx_diagrams {
   ...
   struct context_base {
      E6SSMEFTHiggs_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(E6SSMEFTHiggs_mass_eigenstates_interface const& m) : model(m) {}
      context_base(E6SSMEFTHiggs_mass_eigenstates_interface const* const m) : model(*m) {}
