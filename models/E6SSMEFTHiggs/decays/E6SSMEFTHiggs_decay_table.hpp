...
#ifndef E6SSMEFTHiggs_DECAY_TABLE_H
#define E6SSMEFTHiggs_DECAY_TABLE_H
...
class E6SSMEFTHiggs_decay_table {
private:
...
public:
   ...
   E6SSMEFTHiggs_decay_table();
   ~E6SSMEFTHiggs_decay_table() = default;
   E6SSMEFTHiggs_decay_table(const E6SSMEFTHiggs_decay_table&) = default;
   E6SSMEFTHiggs_decay_table(E6SSMEFTHiggs_decay_table&&) = default;
   E6SSMEFTHiggs_decay_table& operator=(const E6SSMEFTHiggs_decay_table&) = default;
   E6SSMEFTHiggs_decay_table& operator=(E6SSMEFTHiggs_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const E6SSMEFTHiggs_decay_table&);
