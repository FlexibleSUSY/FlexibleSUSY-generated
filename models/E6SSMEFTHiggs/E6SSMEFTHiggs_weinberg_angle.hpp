...
/**
 * @class E6SSMEFTHiggs_weinberg_angle
...
public:
   ...
   E6SSMEFTHiggs_weinberg_angle(const E6SSMEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const E6SSMEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const E6SSMEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
