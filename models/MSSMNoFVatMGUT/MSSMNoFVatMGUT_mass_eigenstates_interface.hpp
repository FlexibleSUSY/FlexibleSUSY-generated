...
/**
 * @file MSSMNoFVatMGUT_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSMNoFVatMGUT_MASS_EIGENSTATES_INTERFACE_H
#define MSSMNoFVatMGUT_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMNoFVatMGUT_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMNoFVatMGUT_mass_eigenstates_interface {
public:
   virtual ~MSSMNoFVatMGUT_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMNoFVatMGUT_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMNoFVatMGUT_input_parameters& get_input_parameters() const = 0;
   virtual MSSMNoFVatMGUT_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMNoFVatMGUT_physical& get_physical() const = 0;
   virtual MSSMNoFVatMGUT_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMNoFVatMGUT_physical&) = 0;
