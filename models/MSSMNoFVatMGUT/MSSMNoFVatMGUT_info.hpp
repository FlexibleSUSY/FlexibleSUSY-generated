...
namespace MSSMNoFVatMGUT_info {
   ...
   enum Input_parameters : int { TanBeta, SignMu, M1, M2, M3, AtIN, AbIN, AtauIN,
      ...
      mu33IN, md11IN, md22IN, md33IN, NUMBER_OF_INPUT_PARAMETERS };
   ...
   public:
      virtual ~MSSMNoFVatMGUT_particle_names() = default;
   ...
   class MSSMNoFVatMGUT_parameter_names : public Names {
   public:
      virtual ~MSSMNoFVatMGUT_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMNoFVatMGUT_particle_names  particle_names_getter{};
   const MSSMNoFVatMGUT_parameter_names parameter_names_getter{};
