Get["models/MSSMNoFVatMGUT/MSSMNoFVatMGUT_librarylink.m"];

handle = FSMSSMNoFVatMGUTOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMNoFVatMGUTCalculateSpectrum[handle];
observables = FSMSSMNoFVatMGUTCalculateObservables[handle];
FSMSSMNoFVatMGUTCloseHandle[handle];
