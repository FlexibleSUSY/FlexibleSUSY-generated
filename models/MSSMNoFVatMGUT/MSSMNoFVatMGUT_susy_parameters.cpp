...
// File generated at Tue 10 Oct 2017 23:33:24
...
const int MSSMNoFVatMGUT_susy_parameters::numberOfParameters;
...
MSSMNoFVatMGUT_susy_parameters MSSMNoFVatMGUT_susy_parameters::calc_beta(int loops) const
{
   ...
   return MSSMNoFVatMGUT_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
MSSMNoFVatMGUT_input_parameters& MSSMNoFVatMGUT_susy_parameters::get_input()
{
   return input;
}
...
MSSMNoFVatMGUT_susy_parameters::Susy_traces MSSMNoFVatMGUT_susy_parameters::calc_susy_traces(int loops) const
{
