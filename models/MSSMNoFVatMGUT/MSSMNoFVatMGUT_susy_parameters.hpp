...
public:
   ...
   MSSMNoFVatMGUT_susy_parameters& operator=(const MSSMNoFVatMGUT_susy_parameters&) = default;
   MSSMNoFVatMGUT_susy_parameters& operator=(MSSMNoFVatMGUT_susy_parameters&&) = default;
   ...
   MSSMNoFVatMGUT_susy_parameters calc_beta(int) const;
   virtual void clear();
