...
// File generated at Sat 27 Aug 2016 13:31:30
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUT_susy_parameters::calc_beta_Ye_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUT_susy_parameters::calc_beta_Ye_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUT_susy_parameters::calc_beta_Ye_three_loop(const Susy_traces& susy_traces) const
{
