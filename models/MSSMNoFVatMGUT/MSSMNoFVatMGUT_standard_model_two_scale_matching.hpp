...
#ifndef MSSMNoFVatMGUT_TWO_SCALE_MATCHING_H
#define MSSMNoFVatMGUT_TWO_SCALE_MATCHING_H
...
template <class T> class MSSMNoFVatMGUT;
template <class T> class MSSMNoFVatMGUT_standard_model_Matching;
...
template<>
class MSSMNoFVatMGUT_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MSSMNoFVatMGUT_standard_model_Matching();

   MSSMNoFVatMGUT_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MSSMNoFVatMGUT<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MSSMNoFVatMGUT_standard_model_Matching();
