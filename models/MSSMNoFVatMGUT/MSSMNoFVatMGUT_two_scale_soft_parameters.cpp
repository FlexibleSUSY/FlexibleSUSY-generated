...
// File generated at Sun 28 Aug 2016 15:22:01
...
MSSMNoFVatMGUT_soft_parameters MSSMNoFVatMGUT_soft_parameters::calc_beta() const
{
   ...
   const MSSMNoFVatMGUT_susy_parameters susy_betas(MSSMNoFVatMGUT_susy_parameters::calc_beta());
...
MSSMNoFVatMGUT_soft_parameters MSSMNoFVatMGUT_soft_parameters::calc_beta(unsigned loops) const
{
   MSSMNoFVatMGUT_soft_parameters p(*this);
   p.set_loops(loops);
...
void MSSMNoFVatMGUT_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
