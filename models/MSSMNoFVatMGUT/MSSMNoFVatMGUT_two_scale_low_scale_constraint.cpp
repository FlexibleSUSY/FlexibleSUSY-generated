...
// File generated at Mon 23 Feb 2015 14:11:32
...
MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::MSSMNoFVatMGUT_low_scale_constraint(
   ...
   const MSSMNoFVatMGUT_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::set_input_parameters(const MSSMNoFVatMGUT_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
