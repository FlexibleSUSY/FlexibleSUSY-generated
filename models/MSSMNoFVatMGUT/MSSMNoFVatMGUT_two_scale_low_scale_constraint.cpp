...
// File generated at Wed 29 Jun 2016 13:11:42
...
const Eigen::Matrix<std::complex<double>,3,3>& MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
...
void MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void MSSMNoFVatMGUT_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
