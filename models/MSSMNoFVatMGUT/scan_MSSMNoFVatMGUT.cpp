...
{
   std::cout <<
      "Usage: scan_MSSMNoFVatMGUT.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --M1=<value>\n"
...
struct MSSMNoFVatMGUT_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMNoFVatMGUT_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMNoFVatMGUT_input_parameters& input)
{
   ...
   MSSMNoFVatMGUT_scan_result result;
...
void scan(int solver_type, MSSMNoFVatMGUT_input_parameters& input,
