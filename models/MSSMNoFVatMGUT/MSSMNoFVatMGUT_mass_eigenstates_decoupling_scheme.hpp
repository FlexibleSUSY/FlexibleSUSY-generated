...
/**
 * @file MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSMNoFVatMGUT_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSMNoFVatMGUT_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
#define SUPER(p) MSSMNoFVatMGUT_soft_parameters::p
...
/**
 * @class MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme
   : private MSSMNoFVatMGUT_soft_parameters
   , public MSSMNoFVatMGUT_mass_eigenstates_interface
{
public:
   explicit MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme(const MSSMNoFVatMGUT_input_parameters& input_ = MSSMNoFVatMGUT_input_parameters());
   explicit MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme(const MSSMNoFVatMGUT_mass_eigenstates&);
   MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme(const MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme(MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme() = default;
   MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme& operator=(const MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme& operator=(MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSMNoFVatMGUT_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MSSMNoFVatMGUT_mass_eigenstates&);
   ...
   const MSSMNoFVatMGUT_input_parameters& get_input_parameters() const override;
   MSSMNoFVatMGUT_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSMNoFVatMGUT_physical& get_physical() const override;
   MSSMNoFVatMGUT_physical& get_physical() override;
   ...
   void set_physical(const MSSMNoFVatMGUT_physical&) override;
...
private:
   ...
   Problems problems{MSSMNoFVatMGUT_info::model_name,
                     &MSSMNoFVatMGUT_info::particle_names_getter,
                     &MSSMNoFVatMGUT_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme&);
