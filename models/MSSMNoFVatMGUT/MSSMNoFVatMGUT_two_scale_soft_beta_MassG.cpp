...
// File generated at Wed 29 Jun 2016 13:11:36
 ...
 */
double MSSMNoFVatMGUT_soft_parameters::calc_beta_MassG_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMNoFVatMGUT_soft_parameters::calc_beta_MassG_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMNoFVatMGUT_soft_parameters::calc_beta_MassG_three_loop(const Soft_traces& soft_traces) const
{
