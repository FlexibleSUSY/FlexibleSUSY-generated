...
/**
 * @class MSSMNoFVatMGUT_weinberg_angle
...
public:
   ...
   MSSMNoFVatMGUT_weinberg_angle(const MSSMNoFVatMGUT_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMNoFVatMGUT_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMNoFVatMGUT_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
