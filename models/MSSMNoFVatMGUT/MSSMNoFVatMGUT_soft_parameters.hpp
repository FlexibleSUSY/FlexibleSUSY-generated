...
public:
   ...
   MSSMNoFVatMGUT_soft_parameters& operator=(const MSSMNoFVatMGUT_soft_parameters&) = default;
   MSSMNoFVatMGUT_soft_parameters& operator=(MSSMNoFVatMGUT_soft_parameters&&) = default;
   ...
   MSSMNoFVatMGUT_soft_parameters calc_beta() const;
   MSSMNoFVatMGUT_soft_parameters calc_beta(int) const;
