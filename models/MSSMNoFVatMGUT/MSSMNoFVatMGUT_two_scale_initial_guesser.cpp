...
MSSMNoFVatMGUT_initial_guesser<Two_scale>::MSSMNoFVatMGUT_initial_guesser(
   ...
   const MSSMNoFVatMGUT_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("MSSMNoFVatMGUT_initial_guesser: Error: pointer to model"
                       " MSSMNoFVatMGUT<Two_scale> must not be zero");
}
 ...
 */
void MSSMNoFVatMGUT_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMNoFVatMGUT_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSMNoFVatMGUT_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void MSSMNoFVatMGUT_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 */
void MSSMNoFVatMGUT_initial_guesser<Two_scale>::guess_soft_parameters()
{
