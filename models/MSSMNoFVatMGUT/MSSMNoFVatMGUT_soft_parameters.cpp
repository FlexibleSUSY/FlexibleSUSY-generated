...
// File generated at Fri 10 Apr 2020 20:42:18
...
const int MSSMNoFVatMGUT_soft_parameters::numberOfParameters;

MSSMNoFVatMGUT_soft_parameters::MSSMNoFVatMGUT_soft_parameters(const MSSMNoFVatMGUT_input_parameters& input_)
   : MSSMNoFVatMGUT_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMNoFVatMGUT_soft_parameters::MSSMNoFVatMGUT_soft_parameters(
   const MSSMNoFVatMGUT_susy_parameters& susy_model
   ...
   : MSSMNoFVatMGUT_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMNoFVatMGUT_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMNoFVatMGUT_soft_parameters MSSMNoFVatMGUT_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMNoFVatMGUT_susy_parameters susy_betas(MSSMNoFVatMGUT_susy_parameters::calc_beta(loops));

   return MSSMNoFVatMGUT_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMNoFVatMGUT_soft_parameters MSSMNoFVatMGUT_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMNoFVatMGUT_soft_parameters::clear()
{
   MSSMNoFVatMGUT_susy_parameters::clear();
...
void MSSMNoFVatMGUT_soft_parameters::print(std::ostream& ostr) const
{
   MSSMNoFVatMGUT_susy_parameters::print(ostr);
...
void MSSMNoFVatMGUT_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMNoFVatMGUT_susy_parameters::set(pars);
...
MSSMNoFVatMGUT_soft_parameters::Soft_traces MSSMNoFVatMGUT_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUT_soft_parameters& soft_pars)
{
