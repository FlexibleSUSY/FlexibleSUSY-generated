...
// File generated at Wed 12 Apr 2017 13:46:59
...
Eigen::Matrix<double,3,3> MSSMNoFVatMGUT_soft_parameters::calc_beta_md2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_md2 = (twoLoop*(0.8*(-15*traceconjTYdTpTYd - 5*traceconjTYeTpTYe
      ...
      *(md2*Yd*Yu.adjoint()*Yu*Yd.adjoint()) - 4*(Yd*mq2*Yd.adjoint()*Yd*
      ...
      (g1)*(303*MassB*Sqr(g1) + 40*(2*MassB + MassG)*Sqr(g3)) + 5*(3*(20*Power(
      g3,4)*Tr23 + g1*(g1*Tr2U111 + 3.872983346207417*Tr31)) + 8*Conj(MassG)*
      Sqr(g3)*((MassB + 2*MassG)*Sqr(g1) - 30*MassG*Sqr(g3))))*UNITMATRIX(3)))
      .real();
...
Eigen::Matrix<double,3,3> MSSMNoFVatMGUT_soft_parameters::calc_beta_md2_three_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_md2_3 = ((threeLoop*(24.*
      ...
      traceAdjYeYeAdjYeYe + 24.*traceAdjYuYuAdjYdYd + Sqr(g2)*(54.*traceAdjYdYd
      + 18.*traceAdjYeYe - 176.*Sqr(g3)) + Sqr(g1)*(14.*traceAdjYdYd - 6.*
      traceAdjYeYe - 17.2*Sqr(g2) - 9.6*Sqr(g3)) - 32.*traceAdjYdYd*Sqr(g3) +
      32.*traceAdjYeYe*Sqr(g3) - 36.*Sqr(traceAdjYdYd) - 4.*Sqr(traceAdjYeYe))*
      (TYd*(TYd).adjoint()) + threeLoop*(-11.233333333333333*Power(g1,4) - 43.5
      *Power(g2,4) + 5.333333333333333*Power(g3,4) + 36.*traceAdjYdYdAdjYdYd -
      ...
      *Sqr(g3)) - 16.*traceAdjYdYd*Sqr(g3) + 16.*traceAdjYeYe*Sqr(g3) - 18.*Sqr
      (traceAdjYdYd) - 2.*Sqr(traceAdjYeYe))*(md2*Yd*Yd.adjoint()) + threeLoop*
      (-22.466666666666665*Power(g1,4) - 87.*Power(g2,4) + 10.666666666666666*
      Power(g3,4) + 72.*traceAdjYdYdAdjYdYd - 24.*traceAdjYdYd*traceAdjYeYe +
      24.*traceAdjYeYeAdjYeYe + 24.*traceAdjYuYuAdjYdYd + Sqr(g2)*(54.*
      ...
      MassG + 384.*MassWB)*Sqr(g2)*Sqr(g3) - 1.12*Power(g1,4)*Sqr(MassB) -
      2176.*Power(g3,4)*Sqr(MassG) - 108.*Power(g2,4)*Sqr(MassWB) + Sqr(g1)*(
      Sqr(g3)*(42.666666666666664*MassB*MassG + 42.666666666666664*Sqr(MassB) +
   ...
   const Eigen::Matrix<double,3,3> beta_md2_4 = ((threeLoop*(
      ...
      *Sqr(g3)) - 16.*traceAdjYdYd*Sqr(g3) + 16.*traceAdjYeYe*Sqr(g3) - 18.*Sqr
      ...
      (0.37333333333333335*Power(g1,4)*MassB + 36.*Power(g2,4)*MassWB + Sqr(g1)
      *(12.*MassB*traceAdjYdYd - 12.*MassB*traceAdjYeYe - 12.*traceTYdAdjYd +
      ...
      0.37333333333333335*Power(g1,4)*MassB + 36.*Power(g2,4)*MassWB + Sqr(g1)*
      (-12.*traceAdjTYdYd + 12.*traceAdjTYeYe + 12.*MassB*traceAdjYdYd - 12.*
      MassB*traceAdjYeYe + (-16.8*MassB - 16.8*MassWB)*Sqr(g2) + (
      -21.333333333333332*MassB - 21.333333333333332*MassG)*Sqr(g3)) + Sqr(g3)*
      (192.*traceAdjTYdYd - 192.*MassG*traceAdjYdYd + 725.3333333333334*MassG*
      Sqr(g3)) + Sqr(g2)*(-108.*traceAdjTYdYd - 36.*traceAdjTYeYe + 108.*MassWB
      *traceAdjYdYd + 36.*MassWB*traceAdjYeYe + (-192.*MassG - 192.*MassWB)*Sqr
      (g3)))*(TYd*Yd.adjoint()*1.2020569031595942) + threeLoop*(
      -0.18666666666666668*Power(g1,4) + 16.8*Sqr(g1)*Sqr(g2))*(TYd*(TYd)
      .adjoint()*1.2020569031595942))*UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_md2_5 = ((threeLoop*(-18.*Power(
      ...
      362.6666666666667*Power(g3,4) + 192.*traceAdjYdYd*Sqr(g3) + Sqr(g1)*(-12.
