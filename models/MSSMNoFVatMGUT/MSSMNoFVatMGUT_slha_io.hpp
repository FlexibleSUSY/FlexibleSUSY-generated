...
public:
   ...
   template <class T> void set_extra(const MSSMNoFVatMGUT_slha<T>&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&);
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MSSMNoFVatMGUT_slha<T>&, const softsusy::QedQcd&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMNoFVatMGUT_slha<T>&, const softsusy::QedQcd&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&);
