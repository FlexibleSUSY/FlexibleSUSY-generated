...
public:
   ...
   void set_extra(const MSSMNoFVatMGUT_slha&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&);
