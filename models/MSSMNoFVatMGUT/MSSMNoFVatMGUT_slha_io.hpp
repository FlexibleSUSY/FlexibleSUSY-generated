...
public:
   ...
   void fill(MSSMNoFVatMGUT_slha&) const;
   ...
   void set_extra(const MSSMNoFVatMGUT_slha&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const MSSMNoFVatMGUT_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMNoFVatMGUT_scales&, const MSSMNoFVatMGUT_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MSSMNoFVatMGUT_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const MSSMNoFVatMGUT_slha&);
 ...
 */
template <class... Ts>
void MSSMNoFVatMGUT_slha_io::fill(
   ...
   MSSMNoFVatMGUT_decays const * const decays)
{
