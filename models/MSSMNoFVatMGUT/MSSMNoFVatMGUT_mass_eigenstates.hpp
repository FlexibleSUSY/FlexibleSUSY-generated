...
class MSSMNoFVatMGUT_ewsb_solver_interface;
/**
 * @class MSSMNoFVatMGUT_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMNoFVatMGUT_mass_eigenstates
   : public MSSMNoFVatMGUT_soft_parameters
...
public:
   ...
   MSSMNoFVatMGUT_mass_eigenstates(const MSSMNoFVatMGUT_mass_eigenstates&) = default;
   MSSMNoFVatMGUT_mass_eigenstates(MSSMNoFVatMGUT_mass_eigenstates&&) = default;
   virtual ~MSSMNoFVatMGUT_mass_eigenstates() = default;
   MSSMNoFVatMGUT_mass_eigenstates& operator=(const MSSMNoFVatMGUT_mass_eigenstates&) = default;
   MSSMNoFVatMGUT_mass_eigenstates& operator=(MSSMNoFVatMGUT_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<MSSMNoFVatMGUT_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{MSSMNoFVatMGUT_info::model_name,
   ...
   std::shared_ptr<MSSMNoFVatMGUT_ewsb_solver_interface> ewsb_solver{};
