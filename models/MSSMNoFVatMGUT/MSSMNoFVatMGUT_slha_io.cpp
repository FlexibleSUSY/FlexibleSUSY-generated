 ...
 * SLHA output file.
 */
void MSSMNoFVatMGUT_slha_io::fill(MSSMNoFVatMGUT_slha& model) const
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_extpar(const MSSMNoFVatMGUT_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUT_slha_io::set_imminpar(const MSSMNoFVatMGUT_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUT_slha_io::set_imextpar(const MSSMNoFVatMGUT_input_parameters& input)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUT_slha_io::set_minpar(const MSSMNoFVatMGUT_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUT_slha_io::set_input(const MSSMNoFVatMGUT_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMNoFVatMGUT_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMNoFVatMGUT_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_unitarity_infinite_s(
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMNoFVatMGUT_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMNoFVatMGUT_info::model_name)
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_mass(const MSSMNoFVatMGUT_physical& physical,
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_mixing_matrices(const MSSMNoFVatMGUT_physical& physical,
...
void MSSMNoFVatMGUT_slha_io::set_ckm(
...
void MSSMNoFVatMGUT_slha_io::set_pmns(
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_model_parameters(const MSSMNoFVatMGUT_slha& model)
{
   {
...
void MSSMNoFVatMGUT_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void MSSMNoFVatMGUT_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void MSSMNoFVatMGUT_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void MSSMNoFVatMGUT_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void MSSMNoFVatMGUT_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, MSSMNoFVatMGUT_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = MSSMNoFVatMGUT_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + MSSMNoFVatMGUT_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void MSSMNoFVatMGUT_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::set_spectrum(const MSSMNoFVatMGUT_slha& model)
{
...
void MSSMNoFVatMGUT_slha_io::set_extra(
   const MSSMNoFVatMGUT_slha& model,
 ...
 */
void MSSMNoFVatMGUT_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void MSSMNoFVatMGUT_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void MSSMNoFVatMGUT_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void MSSMNoFVatMGUT_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::fill(MSSMNoFVatMGUT_input_parameters& input) const
{
 ...
 */
void MSSMNoFVatMGUT_slha_io::fill_drbar_parameters(MSSMNoFVatMGUT_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMNoFVatMGUT_slha_io::fill(MSSMNoFVatMGUT_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMNoFVatMGUT_physical physical_hk;
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMNoFVatMGUT_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMNoFVatMGUT_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}
...
void MSSMNoFVatMGUT_slha_io::fill_extpar_tuple(MSSMNoFVatMGUT_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMNoFVatMGUT_slha_io::fill_imminpar_tuple(MSSMNoFVatMGUT_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMNoFVatMGUT_slha_io::fill_imextpar_tuple(MSSMNoFVatMGUT_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMNoFVatMGUT_slha_io::fill_physical(MSSMNoFVatMGUT_physical& physical) const
{
   {
 ...
 */
double MSSMNoFVatMGUT_slha_io::read_scale() const
{
