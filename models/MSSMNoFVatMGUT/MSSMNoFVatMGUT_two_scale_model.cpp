 ...
 * parameters.
 *
 * This file was generated at Mon 23 Feb 2015 14:20:54 with FlexibleSUSY
...
int CLASSNAME::solve_ewsb_tree_level()
{
   ...
   Mu = LOCALINPUT(SignMu)*Sqrt((-(mHd2*vd) + vu*BMu - 0.075*Power(vd,3)*Sqr(g1
      ) - 0.125*Power(vd,3)*Sqr(g2) + 0.075*vd*Sqr(g1)*Sqr(vu) + 0.125*vd*Sqr(g2)*
      Sqr(vu))/vd);
...
int CLASSNAME::ewsb_step(double ewsb_parameters[number_of_ewsb_equations]) const
{
   ...
   Mu = LOCALINPUT(SignMu)*Sqrt((-(mHd2*vd) + vu*BMu + tadpole[0] - 0.075*Power
      (vd,3)*Sqr(g1) - 0.125*Power(vd,3)*Sqr(g2) + 0.075*vd*Sqr(g1)*Sqr(vu) +
...
{
   MFt = get_mass_matrix_Ft();
}

double CLASSNAME::get_mass_matrix_Fve() const
{
   const double mass_matrix_Fve = 0;
...
{
   MFve = get_mass_matrix_Fve();
}

double CLASSNAME::get_mass_matrix_Fvm() const
{
   const double mass_matrix_Fvm = 0;
...
{
   MFvm = get_mass_matrix_Fvm();
}

double CLASSNAME::get_mass_matrix_Fvt() const
{
   const double mass_matrix_Fvt = 0;
...
{
   MFtau = get_mass_matrix_Ftau();
}

double CLASSNAME::get_mass_matrix_SveL() const
{
   const double mass_matrix_SveL = 0.125*(8*ml2(0,0) - 0.6*Sqr(g1)*(-Sqr(
      vd) + Sqr(vu)) - Sqr(g2)*(-Sqr(vd) + Sqr(vu)));
...
{
   const double mass_matrix_SvmL = 0.125*(8*ml2(1,1) - 0.6*Sqr(g1)*(-Sqr(
      vd) + Sqr(vu)) - Sqr(g2)*(-Sqr(vd) + Sqr(vu)));
...
{
   const double mass_matrix_SvtL = 0.125*(8*ml2(2,2) - 0.6*Sqr(g1)*(-Sqr(
      vd) + Sqr(vu)) - Sqr(g2)*(-Sqr(vd) + Sqr(vu)));
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_Sm() const
{
   ...
   mass_matrix_Sm(1,0) = Conj(mass_matrix_Sm(0,1));
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_Stau() const
{
   ...
   mass_matrix_Stau(1,0) = Conj(mass_matrix_Stau(0,1));
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_Ss() const
{
   ...
   mass_matrix_Ss(1,0) = Conj(mass_matrix_Ss(0,1));
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_Sc() const
{
   ...
   mass_matrix_Sc(1,0) = Conj(mass_matrix_Sc(0,1));
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_Sb() const
{
   ...
   mass_matrix_Sb(1,0) = Conj(mass_matrix_Sb(0,1));
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_St() const
{
   ...
   mass_matrix_St(1,0) = Conj(mass_matrix_St(0,1));
...
std::complex<double> CLASSNAME::CpUhhbarFeFePR(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFeFePL(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFmFmPR(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFmFmPL(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFtauFtauPR(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFtauFtauPL(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFbFbPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFbFbPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFcFcPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFcFcPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFdFdPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFdFdPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFsFsPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFsFsPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFtFtPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFtFtPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFuFuPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpUhhbarFuFuPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFveFePR(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFvmFmPR(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFvtFtauPR(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFcFsPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFcFsPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFtFbPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFtFbPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFuFdPR(unsigned gO2, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpconjUHpmbarFuFdPL(unsigned gO1, unsigned , unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpbarUChaconjSveLFePR(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpbarUChaconjSvmLFmPR(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::CpbarUChaconjSvtLFtauPR(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CLASSNAME::tadpole_hh(unsigned gO1) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1579 += A0(MAh(gI1))*CpUhhAhAh(gO1,gI1,gI1);
   }
   tmp_1578 += tmp_1579;
   result += (-0.5) * tmp_1578;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1581 += A0(MHpm(gI1))*CpUhhconjHpmHpm(gO1,gI1,gI1);
   }
   tmp_1580 += tmp_1581;
   result += (-1) * tmp_1580;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1583 += A0(MSb(gI1))*CpUhhconjSbSb(gO1,gI1,gI1);
   }
   tmp_1582 += tmp_1583;
   result += (-3) * tmp_1582;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1585 += A0(MSc(gI1))*CpUhhconjScSc(gO1,gI1,gI1);
   }
   tmp_1584 += tmp_1585;
   result += (-3) * tmp_1584;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1587 += A0(MSd(gI1))*CpUhhconjSdSd(gO1,gI1,gI1);
   }
   tmp_1586 += tmp_1587;
   result += (-3) * tmp_1586;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1589 += A0(MSe(gI1))*CpUhhconjSeSe(gO1,gI1,gI1);
   }
   tmp_1588 += tmp_1589;
   result += (-1) * tmp_1588;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1591 += A0(MSm(gI1))*CpUhhconjSmSm(gO1,gI1,gI1);
   }
   tmp_1590 += tmp_1591;
   result += (-1) * tmp_1590;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1593 += A0(MSs(gI1))*CpUhhconjSsSs(gO1,gI1,gI1);
   }
   tmp_1592 += tmp_1593;
   result += (-3) * tmp_1592;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1595 += A0(MStau(gI1))*CpUhhconjStauStau(gO1,gI1,gI1);
   }
   tmp_1594 += tmp_1595;
   result += (-1) * tmp_1594;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1597 += A0(MSt(gI1))*CpUhhconjStSt(gO1,gI1,gI1);
   }
   tmp_1596 += tmp_1597;
   result += (-3) * tmp_1596;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1599 += A0(MSu(gI1))*CpUhhconjSuSu(gO1,gI1,gI1);
   }
   tmp_1598 += tmp_1599;
   result += (-3) * tmp_1598;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1601 += A0(Mhh(gI1))*CpUhhhhhh(gO1,gI1,gI1);
   }
   tmp_1600 += tmp_1601;
   result += (-0.5) * tmp_1600;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1603 += A0(MCha(gI1))*(CpUhhbarChaChaPL(gO1,gI1,gI1) +
   ...
   for (unsigned gI1 = 0; gI1 < 4; ++gI1) {
      tmp_1604 += A0(MChi(gI1))*(CpUhhChiChiPL(gO1,gI1,gI1) + CpUhhChiChiPR(
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   PHYSICAL(MFd) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFs_pole()
{
   ...
   PHYSICAL(MFs) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFb_pole()
{
   ...
   PHYSICAL(MFb) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   PHYSICAL(MFu) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFc_pole()
{
   ...
   PHYSICAL(MFc) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFt_pole()
{
   ...
   const double p = MFt;
   const double self_energy_1  = Re(self_energy_Ft_1(p));
   const double self_energy_PL = Re(self_energy_Ft_PL(p));
   const double self_energy_PR = Re(self_energy_Ft_PR(p));
   PHYSICAL(MFt) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   PHYSICAL(MFe) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFm_pole()
{
   ...
   PHYSICAL(MFm) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFtau_pole()
{
   ...
   PHYSICAL(MFtau) = M_tree - self_energy_1 - M_tree * (self_energy_PL +
      self_energy_PR);
}
