...
// File generated at Tue 22 Jan 2019 17:53:37

/**
 * @file MSSMNoFVatMGUT_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 17:53:37 with FlexibleSUSY
...
double get_MSUSY(const MSSMNoFVatMGUT_mass_eigenstates& model)
{
...
void run_to_MSUSY(MSSMNoFVatMGUT_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("MSSMNoFVatMGUT_a_muon: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("MSSMNoFVatMGUT_a_muon:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("MSSMNoFVatMGUT_a_muon: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("MSSMNoFVatMGUT_a_muon: run_to_MSUSY(): "
              "Iteration did not converge after " << Nmax
              << " iterations (precision goal: " << precision_goal << ")");
   }
}

double calculate_a_muon_impl(MSSMNoFVatMGUT_mass_eigenstates& model)
{
   VERBOSE_MSG("MSSMNoFVatMGUT_a_muon: calculating a_mu at Q = " << model.get_scale());
...
std::pair<double,double> vary_scale(const MSSMNoFVatMGUT_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMNoFVatMGUT_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MSSMNoFVatMGUT_a_muon::calculate_a_muon(const MSSMNoFVatMGUT_mass_eigenstates& model_)
{
   MSSMNoFVatMGUT_mass_eigenstates model(model_);

   VERBOSE_MSG("MSSMNoFVatMGUT_a_muon: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MSSMNoFVatMGUT_a_muon:" << e.what());
...
double MSSMNoFVatMGUT_a_muon::calculate_a_muon_uncertainty(const MSSMNoFVatMGUT_mass_eigenstates& model_)
{
   MSSMNoFVatMGUT_mass_eigenstates model(model_);

   VERBOSE_MSG("MSSMNoFVatMGUT_a_muon: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MSSMNoFVatMGUT_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
