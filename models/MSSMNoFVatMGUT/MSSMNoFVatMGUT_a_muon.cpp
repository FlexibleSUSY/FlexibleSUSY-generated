...
// File generated at Wed 16 Oct 2019 22:49:52

/**
 * @file MSSMNoFVatMGUT_a_muon.cpp
 *
 * This file was generated at Wed 16 Oct 2019 22:49:52 with FlexibleSUSY
...
double calculate_a_muon_impl(const MSSMNoFVatMGUT_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
...
std::pair<double,double> vary_scale(const MSSMNoFVatMGUT_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model,&qedqcd] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMNoFVatMGUT_a_muon: scale variation: " << e.what_detailed());
                     }
                     return amu;
                  });
...
double MSSMNoFVatMGUT_a_muon::calculate_a_muon(const MSSMNoFVatMGUT_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   ...
   try {
      ...
      ERROR("MSSMNoFVatMGUT_a_muon:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
double MSSMNoFVatMGUT_a_muon::calculate_a_muon_uncertainty(const MSSMNoFVatMGUT_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   MSSMNoFVatMGUT_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMNoFVatMGUT_a_muon uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
