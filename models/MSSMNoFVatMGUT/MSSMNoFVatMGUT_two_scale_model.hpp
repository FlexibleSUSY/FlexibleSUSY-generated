 ...
 */
template<>
class MSSMNoFVatMGUT<Two_scale> : public Two_scale_model, public MSSMNoFVatMGUT_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(MSSMNoFVatMGUT<Two_scale>::*Memfun_t)();
      MSSMNoFVatMGUT<Two_scale>* model;
      Memfun_t fun;

      Thread(MSSMNoFVatMGUT<Two_scale>* model_, Memfun_t fun_)
