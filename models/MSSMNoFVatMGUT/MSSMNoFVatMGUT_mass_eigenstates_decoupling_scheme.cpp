...
/**
 * @file MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the MSSMNoFVatMGUT model class in the decoupling scheme
 *
...
#include "MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme.hpp"
...
#define CLASSNAME MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const MSSMNoFVatMGUT_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const MSSMNoFVatMGUT_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUT_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
