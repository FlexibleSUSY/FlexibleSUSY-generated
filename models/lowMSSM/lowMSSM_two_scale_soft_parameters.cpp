...
// File generated at Mon 19 Sep 2016 10:08:25
...
lowMSSM_soft_parameters lowMSSM_soft_parameters::calc_beta() const
{
   ...
   const lowMSSM_susy_parameters susy_betas(lowMSSM_susy_parameters::calc_beta());
...
lowMSSM_soft_parameters lowMSSM_soft_parameters::calc_beta(unsigned loops) const
{
   lowMSSM_soft_parameters p(*this);
   p.set_loops(loops);
...
void lowMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
