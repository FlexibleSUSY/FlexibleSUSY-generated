...
int run_solver(const lowMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(lowMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const lowMSSM_input_parameters& input)
{
   int exit_code = 0;
