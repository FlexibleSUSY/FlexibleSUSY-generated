...
lowMSSM_convergence_tester<Two_scale>::lowMSSM_convergence_tester(
   lowMSSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<lowMSSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double lowMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const lowMSSM<Two_scale>& ne = get_current_iteration_model();
