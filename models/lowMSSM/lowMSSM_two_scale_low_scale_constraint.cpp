...
// File generated at Mon 23 Feb 2015 13:40:08
...
lowMSSM_low_scale_constraint<Two_scale>::lowMSSM_low_scale_constraint(
   ...
   const lowMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void lowMSSM_low_scale_constraint<Two_scale>::set_input_parameters(const lowMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
