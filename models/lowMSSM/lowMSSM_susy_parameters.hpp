...
#ifndef lowMSSM_susy_parameters_H
#define lowMSSM_susy_parameters_H
...
class lowMSSM_susy_parameters : public Beta_function {
public:
   explicit lowMSSM_susy_parameters(const lowMSSM_input_parameters& input_ = lowMSSM_input_parameters());
   lowMSSM_susy_parameters(double scale_, int loops_, int thresholds_, const lowMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   lowMSSM_susy_parameters(const lowMSSM_susy_parameters&) = default;
   lowMSSM_susy_parameters(lowMSSM_susy_parameters&&) = default;
   virtual ~lowMSSM_susy_parameters() = default;
   lowMSSM_susy_parameters& operator=(const lowMSSM_susy_parameters&) = default;
   lowMSSM_susy_parameters& operator=(lowMSSM_susy_parameters&&) = default;
   ...
   lowMSSM_susy_parameters calc_beta(int) const;
   virtual void clear();
