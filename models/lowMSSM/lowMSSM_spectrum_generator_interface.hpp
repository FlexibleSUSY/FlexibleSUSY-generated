...
public:
   ...
   virtual void run(const softsusy::QedQcd&, const lowMSSM_input_parameters&) = 0;
 ...
 */
template <class T>
void lowMSSM_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
