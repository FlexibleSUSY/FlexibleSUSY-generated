...
/**
 * @file lowMSSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Tue 22 Jan 2019 17:38:35 with FlexibleSUSY
 * 2.3.0 (git commit: b5dda61ad35a8ffff74bde70f63e1c2b815e751a) and SARAH 4.14.1 .
 */

#ifndef lowMSSM_EWSB_SOLVER_INTERFACE_H
#define lowMSSM_EWSB_SOLVER_INTERFACE_H
...
class lowMSSM_ewsb_solver_interface {
public:
   virtual ~lowMSSM_ewsb_solver_interface() {}
   ...
   virtual int solve(lowMSSM_mass_eigenstates&) = 0;
};
