...
// File generated at Wed 12 Apr 2017 13:03:45
...
lowMSSM_susy_parameters lowMSSM_susy_parameters::calc_beta() const
{
   ...
   return lowMSSM_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Yu, beta_Mu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu);
}

lowMSSM_susy_parameters lowMSSM_susy_parameters::calc_beta(unsigned loops) const
{
   lowMSSM_susy_parameters p(*this);
   p.set_loops(loops);
...
void lowMSSM_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
