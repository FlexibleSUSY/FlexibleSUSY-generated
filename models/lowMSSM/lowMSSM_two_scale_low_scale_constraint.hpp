...
template<>
class lowMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   lowMSSM_low_scale_constraint() = default;
   lowMSSM_low_scale_constraint(lowMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~lowMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "lowMSSM low-scale constraint"; }
...
private:
   ...
   lowMSSM<Two_scale>* model{nullptr};
