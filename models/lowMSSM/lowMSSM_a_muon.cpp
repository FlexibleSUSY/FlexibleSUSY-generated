...
// File generated at Sun 26 Aug 2018 14:55:20

/**
 * @file lowMSSM_a_muon.cpp
 *
 * This file was generated at Sun 26 Aug 2018 14:55:20 with FlexibleSUSY
...
#include "lowMSSM_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(lowMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const lowMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("lowMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double lowMSSM_a_muon::calculate_a_muon(const lowMSSM_mass_eigenstates& model_)
{
...
double lowMSSM_a_muon::calculate_a_muon_uncertainty(const lowMSSM_mass_eigenstates& model_)
{
   lowMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("lowMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
