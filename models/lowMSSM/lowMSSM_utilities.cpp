...
// File generated at Tue 12 Jul 2016 12:04:08
...
lowMSSM_spectrum_plotter::lowMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> lowMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const lowMSSM_observables* observables)
{
   ...
   append(names, lowMSSM_parameter_getter().get_mass_names());
   append(names, lowMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, lowMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = lowMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = lowMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = lowMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? lowMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
