...
#define CLASSNAME lowMSSM_weinberg_angle
 ...
 */
CLASSNAME::lowMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const lowMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * lowMSSM_info::normalization_g3 /
