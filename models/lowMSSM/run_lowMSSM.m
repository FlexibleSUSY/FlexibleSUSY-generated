Get["models/lowMSSM/lowMSSM_librarylink.m"];

handle = FSlowMSSMOpenHandle[
    fsSettings -> {
...
spectrum    = FSlowMSSMCalculateSpectrum[handle];
observables = FSlowMSSMCalculateObservables[handle];
FSlowMSSMCloseHandle[handle];
