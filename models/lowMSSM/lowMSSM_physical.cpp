...
lowMSSM_physical::lowMSSM_physical()
   :
 ...
 * to be complex.
 */
void lowMSSM_physical::convert_to_hk()
{
...
void lowMSSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd lowMSSM_physical::get_masses() const
{
...
void lowMSSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void lowMSSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const lowMSSM_physical& phys_pars)
{
