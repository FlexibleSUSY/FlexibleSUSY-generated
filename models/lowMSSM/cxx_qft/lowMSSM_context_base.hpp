...
/**
 * @file cxx_qft/lowMSSM_context_base.hpp
 *
 * This file was generated at Fri 10 Apr 2020 20:35:44 with FlexibleSUSY
 * 2.4.2 and SARAH 4.14.3 .
 */

#ifndef lowMSSM_CXXQFT_CONTEXT_BASE_H
#define lowMSSM_CXXQFT_CONTEXT_BASE_H
...
namespace lowMSSM_cxx_diagrams {
   ...
   struct context_base {
      lowMSSM_mass_eigenstates model; ///< The model object.
      ...
      context_base(const lowMSSM_mass_eigenstates& m) : model(m) {}
