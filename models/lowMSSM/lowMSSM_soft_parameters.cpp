...
// File generated at Wed 16 Oct 2019 22:35:21
...
const int lowMSSM_soft_parameters::numberOfParameters;

lowMSSM_soft_parameters::lowMSSM_soft_parameters(const lowMSSM_input_parameters& input_)
   : lowMSSM_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

lowMSSM_soft_parameters::lowMSSM_soft_parameters(
   const lowMSSM_susy_parameters& susy_model
   ...
   : lowMSSM_susy_parameters(susy_model)
...
Eigen::ArrayXd lowMSSM_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

lowMSSM_soft_parameters lowMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const lowMSSM_susy_parameters susy_betas(lowMSSM_susy_parameters::calc_beta(loops));

   return lowMSSM_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

lowMSSM_soft_parameters lowMSSM_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void lowMSSM_soft_parameters::clear()
{
   lowMSSM_susy_parameters::clear();
...
void lowMSSM_soft_parameters::print(std::ostream& ostr) const
{
   lowMSSM_susy_parameters::print(ostr);
...
void lowMSSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   lowMSSM_susy_parameters::set(pars);
...
lowMSSM_soft_parameters::Soft_traces lowMSSM_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowMSSM_soft_parameters& soft_pars)
{
