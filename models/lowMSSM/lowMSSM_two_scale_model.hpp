 ...
 */
template<>
class lowMSSM<Two_scale> : public Two_scale_model, public lowMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(lowMSSM<Two_scale>::*Memfun_t)();
      lowMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(lowMSSM<Two_scale>* model_, Memfun_t fun_)
