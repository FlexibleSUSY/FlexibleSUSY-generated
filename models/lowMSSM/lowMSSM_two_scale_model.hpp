 ...
 */
template<>
class lowMSSM<Two_scale> : public Model, public lowMSSM_slha {
public:
   explicit lowMSSM(const lowMSSM_input_parameters& input_ = lowMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit lowMSSM(const lowMSSM_slha&, bool do_convert_masses_to_slha = true);
