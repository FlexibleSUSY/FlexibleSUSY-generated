...
// File generated at Wed 29 Jun 2016 12:45:07
 ...
 */
double lowMSSM_susy_parameters::calc_beta_vd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double lowMSSM_susy_parameters::calc_beta_vd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double lowMSSM_susy_parameters::calc_beta_vd_three_loop(const Susy_traces& susy_traces) const
{
