...
#ifndef lowMSSM_WEINBERG_ANGLE_H
#define lowMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   lowMSSM_weinberg_angle(const lowMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const lowMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const lowMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
