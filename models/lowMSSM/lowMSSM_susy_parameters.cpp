...
// File generated at Tue 10 Oct 2017 22:42:54
...
lowMSSM_susy_parameters::lowMSSM_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const lowMSSM_input_parameters& input_
...
Eigen::ArrayXd lowMSSM_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

lowMSSM_susy_parameters lowMSSM_susy_parameters::calc_beta(int loops) const
{
   ...
   return lowMSSM_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
void lowMSSM_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd lowMSSM_susy_parameters::get() const
{
...
void lowMSSM_susy_parameters::print(std::ostream& ostr) const
{
...
void lowMSSM_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const lowMSSM_input_parameters& lowMSSM_susy_parameters::get_input() const
{
   return input;
}

lowMSSM_input_parameters& lowMSSM_susy_parameters::get_input()
{
   return input;
}

void lowMSSM_susy_parameters::set_input_parameters(const lowMSSM_input_parameters& input_)
{
   input = input_;
}

lowMSSM_susy_parameters::Susy_traces lowMSSM_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowMSSM_susy_parameters& susy_pars)
{
