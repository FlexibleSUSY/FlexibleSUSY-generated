...
#ifndef lowMSSM_TWO_SCALE_MATCHING_H
#define lowMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class lowMSSM;
template <class T> class lowMSSM_standard_model_Matching;
...
template<>
class lowMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   lowMSSM_standard_model_Matching();

   lowMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       lowMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~lowMSSM_standard_model_Matching();
