...
namespace lowMSSM_info {
   ...
   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      ...
      "ZH(1,0)", "ZH(1,1)", "ZA(0,0)", "ZA(0,1)", "ZA(1,0)", "ZA(1,1)", "ZP(0,0)",
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS> input_parameter_names
       = {"TanBeta", "MuInput", "TYdInput(0,0)", "TYdInput(0,1)", "TYdInput(0,2)",
      "TYdInput(1,0)", "TYdInput(1,1)", "TYdInput(1,2)", "TYdInput(2,0)",
      "TYdInput(2,1)", "TYdInput(2,2)", "TYeInput(0,0)", "TYeInput(0,1)",
      "TYeInput(0,2)", "TYeInput(1,0)", "TYeInput(1,1)", "TYeInput(1,2)",
      "TYeInput(2,0)", "TYeInput(2,1)", "TYeInput(2,2)", "TYuInput(0,0)",
      "TYuInput(0,1)", "TYuInput(0,2)", "TYuInput(1,0)", "TYuInput(1,1)",
      "TYuInput(1,2)", "TYuInput(2,0)", "TYuInput(2,1)", "TYuInput(2,2)",
      "BMuInput", "mq2Input(0,0)", "mq2Input(0,1)", "mq2Input(0,2)",
   ...
   const std::string model_name = "lowMSSM";
