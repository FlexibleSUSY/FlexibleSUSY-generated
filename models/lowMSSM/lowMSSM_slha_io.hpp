...
// File generated at Tue 27 Oct 2015 15:27:32
...
public:
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const lowMSSM_slha<T>&, const softsusy::QedQcd&, const lowMSSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const lowMSSM_slha<T>&, const softsusy::QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const lowMSSM_slha<T>&, const softsusy::QedQcd&, const lowMSSM_scales&);
...
SLHAea::Coll lowMSSM_slha_io::fill_slhaea(
   const lowMSSM_slha<T>& model, const softsusy::QedQcd& qedqcd)
{
