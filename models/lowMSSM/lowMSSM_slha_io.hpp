...
public:
   ...
   template <class T> void set_extra(const lowMSSM_slha<T>&, const lowMSSM_scales&, const Observables&);
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const lowMSSM_slha<T>&, const softsusy::QedQcd&, const lowMSSM_scales&, const Observables&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const lowMSSM_slha<T>&, const softsusy::QedQcd&, const lowMSSM_scales&, const Observables&);
...
SLHAea::Coll lowMSSM_slha_io::fill_slhaea(
   ...
   const lowMSSM_scales& scales, const Observables& observables)
{
   SLHAea::Coll slhaea;
