...
public:
   ...
   void set_extra(const lowMSSM_slha&, const lowMSSM_scales&, const lowMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const lowMSSM_scales&, const lowMSSM_observables&);
