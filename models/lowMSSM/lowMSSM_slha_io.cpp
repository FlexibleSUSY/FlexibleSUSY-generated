...
void lowMSSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void lowMSSM_slha_io::fill(lowMSSM_slha& model) const
{
 ...
 * @param input struct of input parameters
 */
void lowMSSM_slha_io::set_imminpar(const lowMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void lowMSSM_slha_io::set_imextpar(const lowMSSM_input_parameters& input)
{
 ...
 */
void lowMSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void lowMSSM_slha_io::set_input(const lowMSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
...

   {
      ...
      block << "Block HMIXIN" << '\n'
            ...
            << FORMAT_ELEMENT(1, (INPUTPARAMETER(MuInput)), "MuInput")
      ;
 ...
 */
void lowMSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void lowMSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void lowMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void lowMSSM_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void lowMSSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void lowMSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void lowMSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void lowMSSM_slha_io::set_model_parameters(const lowMSSM_slha& model)
{
   {
      std::ostringstream block;
...
void lowMSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void lowMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void lowMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void lowMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void lowMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void lowMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, lowMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void lowMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = lowMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + lowMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void lowMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void lowMSSM_slha_io::set_spectrum(const lowMSSM_slha& model)
{
 ...
 */
void lowMSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void lowMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void lowMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void lowMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
void lowMSSM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void lowMSSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void lowMSSM_slha_io::fill_drbar_parameters(lowMSSM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void lowMSSM_slha_io::fill(lowMSSM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   lowMSSM_physical physical_hk;
 ...
 */
void lowMSSM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void lowMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void lowMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}
...
void lowMSSM_slha_io::fill_imminpar_tuple(lowMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void lowMSSM_slha_io::fill_imextpar_tuple(lowMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void lowMSSM_slha_io::fill_physical(lowMSSM_physical& physical) const
{
   {
