...
/**
 * @file lowMSSM_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Wed 16 Oct 2019 22:37:23
...
class lowMSSM_slha : public Model {
public:
   explicit lowMSSM_slha(const lowMSSM_input_parameters& input_ = lowMSSM_input_parameters());
   explicit lowMSSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   lowMSSM_slha(const lowMSSM_slha&) = default;
   lowMSSM_slha(lowMSSM_slha&&) = default;
   virtual ~lowMSSM_slha() = default;
   lowMSSM_slha& operator=(const lowMSSM_slha&) = default;
   lowMSSM_slha& operator=(lowMSSM_slha&&) = default;
...
template <class Model>
lowMSSM_slha<Model>::lowMSSM_slha(const lowMSSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
lowMSSM_slha<Model>::lowMSSM_slha(const Model& model_,
...
template <class Model>
void lowMSSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void lowMSSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void lowMSSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void lowMSSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void lowMSSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void lowMSSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void lowMSSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const lowMSSM_physical& lowMSSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
lowMSSM_physical& lowMSSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void lowMSSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void lowMSSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const lowMSSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
