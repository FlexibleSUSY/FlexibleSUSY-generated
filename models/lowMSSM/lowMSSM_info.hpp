...
// File generated at Tue 22 Jan 2019 17:38:34
...
namespace lowMSSM_info {
   ...
   enum Input_parameters : int { TanBeta, MuInput, TYdInput0_0, TYdInput0_1,
      TYdInput0_2, TYdInput1_0, TYdInput1_1, TYdInput1_2, TYdInput2_0, TYdInput2_1
      , TYdInput2_2, TYeInput0_0, TYeInput0_1, TYeInput0_2, TYeInput1_0,
      TYeInput1_1, TYeInput1_2, TYeInput2_0, TYeInput2_1, TYeInput2_2, TYuInput0_0
      , TYuInput0_1, TYuInput0_2, TYuInput1_0, TYuInput1_1, TYuInput1_2,
      ...
      , me2Input1_2, me2Input2_0, me2Input2_1, me2Input2_2, MassBInput,
   ...
   class lowMSSM_particle_names : public Names {
   public:
      virtual ~lowMSSM_particle_names() = default;
   ...
   class lowMSSM_parameter_names : public Names {
   public:
      virtual ~lowMSSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const lowMSSM_particle_names  particle_names_getter{};
   const lowMSSM_parameter_names parameter_names_getter{};
