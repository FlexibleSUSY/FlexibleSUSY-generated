...
public:
   ...
   lowNMSSM_susy_parameters& operator=(const lowNMSSM_susy_parameters&) = default;
   lowNMSSM_susy_parameters& operator=(lowNMSSM_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const lowNMSSM_input_parameters& get_input() const;
   lowNMSSM_input_parameters& get_input();
   void set_input_parameters(const lowNMSSM_input_parameters&);

   lowNMSSM_susy_parameters calc_beta() const;
   lowNMSSM_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const lowNMSSM_susy_parameters&);
