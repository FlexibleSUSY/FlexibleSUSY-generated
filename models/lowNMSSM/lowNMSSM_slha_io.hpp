...
public:
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const lowNMSSM_slha<T>&, const QedQcd&, const lowNMSSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const lowNMSSM_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const lowNMSSM_slha<T>&, const QedQcd&, const lowNMSSM_scales&);
...
void lowNMSSM_slha_io::fill_slhaea(
   ...
   const QedQcd& qedqcd, const lowNMSSM_scales& scales)
{
...
SLHAea::Coll lowNMSSM_slha_io::fill_slhaea(
   const lowNMSSM_slha<T>& model, const QedQcd& qedqcd)
{
...
{
   SLHAea::Coll slhaea;
   lowNMSSM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
