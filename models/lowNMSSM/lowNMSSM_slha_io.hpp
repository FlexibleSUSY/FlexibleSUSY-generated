...
public:
   ...
   template <class Model> void fill(lowNMSSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const lowNMSSM_slha<Model>&, const lowNMSSM_scales&, const lowNMSSM_observables&);
   ...
   template <class Model> void set_spectrum(const lowNMSSM_slha<Model>&);
   ...
   static void fill_slhaea(SLHAea::Coll&, const lowNMSSM_slha<Model>&, const softsusy::QedQcd&, const lowNMSSM_scales&, const lowNMSSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const lowNMSSM_slha<Model>&, const softsusy::QedQcd&, const lowNMSSM_scales&, const lowNMSSM_observables&);
...
private:
   ...
   template <class Model> void set_model_parameters(const lowNMSSM_slha<Model>&);
 ...
 */
template <class Model>
void lowNMSSM_slha_io::fill(lowNMSSM_slha<Model>& model) const
{
...
void lowNMSSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const lowNMSSM_slha<Model>& model,
...
SLHAea::Coll lowNMSSM_slha_io::fill_slhaea(
   const lowNMSSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const lowNMSSM_scales& scales, const lowNMSSM_observables& observables)
{
   SLHAea::Coll slhaea;
 ...
 */
template <class Model>
void lowNMSSM_slha_io::set_model_parameters(const lowNMSSM_slha<Model>& model)
{
   {
...
void lowNMSSM_slha_io::set_extra(
   const lowNMSSM_slha<Model>& model, const lowNMSSM_scales& scales,
   const lowNMSSM_observables& observables)
{
...
{
   Set_spectrum<lowNMSSM_slha_io> ss(this);
...
{
   set_spectrum(lowNMSSM_slha<lowNMSSM<T> >(model));
}
 ...
 */
template <class Model>
void lowNMSSM_slha_io::set_spectrum(const lowNMSSM_slha<Model>& model)
{
   const lowNMSSM_physical physical(model.get_physical_slha());
