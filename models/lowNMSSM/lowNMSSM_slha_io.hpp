...
public:
   ...
   void set_extra(const lowNMSSM_slha&, const lowNMSSM_scales&, const lowNMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const lowNMSSM_scales&, const lowNMSSM_observables&);
