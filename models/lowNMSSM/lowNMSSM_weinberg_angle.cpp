...
#define CLASSNAME lowNMSSM_weinberg_angle
 ...
 */
CLASSNAME::lowNMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const lowNMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * lowNMSSM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * lowNMSSM_info::normalization_g2;
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * lowNMSSM_info::normalization_g3 /
