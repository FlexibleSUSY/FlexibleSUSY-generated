...
#ifndef lowNMSSM_TWO_SCALE_MATCHING_H
#define lowNMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class lowNMSSM;
template <class T> class lowNMSSM_standard_model_Matching;
...
template<>
class lowNMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   lowNMSSM_standard_model_Matching();

   lowNMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       lowNMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~lowNMSSM_standard_model_Matching();
