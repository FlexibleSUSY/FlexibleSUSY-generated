 ...
 */
double lowNMSSM_susy_parameters::calc_beta_vu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double lowNMSSM_susy_parameters::calc_beta_vu_two_loop(const Susy_traces& susy_traces) const
{
