...
// File generated at Fri 20 Oct 2017 08:53:59
...
lowNMSSM_soft_parameters lowNMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const lowNMSSM_susy_parameters susy_betas(lowNMSSM_susy_parameters::calc_beta(loops));
...
lowNMSSM_soft_parameters::Soft_traces lowNMSSM_soft_parameters::calc_soft_traces(int loops) const
{
