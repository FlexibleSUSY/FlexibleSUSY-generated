...
lowNMSSM_spectrum_plotter::lowNMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> lowNMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const lowNMSSM_observables* observables)
{
   ...
   append(names, lowNMSSM_parameter_getter().get_mass_names());
   append(names, lowNMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, lowNMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = lowNMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = lowNMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = lowNMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? lowNMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
