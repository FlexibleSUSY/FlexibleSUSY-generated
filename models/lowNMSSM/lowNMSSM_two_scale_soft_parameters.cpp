...
// File generated at Sun 28 Aug 2016 15:12:46
...
lowNMSSM_soft_parameters::lowNMSSM_soft_parameters(
   const lowNMSSM_susy_parameters& susy_model
   ...
   : lowNMSSM_susy_parameters(susy_model)
...
Eigen::ArrayXd lowNMSSM_soft_parameters::beta() const
{
...
lowNMSSM_soft_parameters lowNMSSM_soft_parameters::calc_beta() const
{
   ...
   const lowNMSSM_susy_parameters susy_betas(lowNMSSM_susy_parameters::calc_beta());

   return lowNMSSM_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TLambdax, beta_TKappa, beta_TYu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_MassB, beta_MassWB, beta_MassG);
}

lowNMSSM_soft_parameters lowNMSSM_soft_parameters::calc_beta(unsigned loops) const
{
   lowNMSSM_soft_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void lowNMSSM_soft_parameters::clear()
{
   lowNMSSM_susy_parameters::clear();
...
void lowNMSSM_soft_parameters::print(std::ostream& ostr) const
{
   lowNMSSM_susy_parameters::print(ostr);
...
void lowNMSSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   lowNMSSM_susy_parameters::set(pars);
...
void lowNMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const lowNMSSM_soft_parameters& soft_pars)
{
