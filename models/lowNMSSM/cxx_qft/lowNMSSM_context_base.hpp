...
/**
 * @file cxx_qft/lowNMSSM_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.4 .
 */

#ifndef lowNMSSM_CXXQFT_CONTEXT_BASE_H
#define lowNMSSM_CXXQFT_CONTEXT_BASE_H

#include "lowNMSSM_fields.hpp"
...
namespace lowNMSSM_cxx_diagrams {
   ...
   struct context_base {
      lowNMSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(lowNMSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(lowNMSSM_mass_eigenstates_interface const* const m) : model(*m) {}
