...
#ifndef lowNMSSM_TWO_SCALE_soft_parameters_H
#define lowNMSSM_TWO_SCALE_soft_parameters_H
...
public:
   ...
   virtual ~lowNMSSM_soft_parameters() {}
   ...
   lowNMSSM_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
