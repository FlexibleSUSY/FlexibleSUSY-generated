...
// File generated at Thu 15 Dec 2016 12:52:28
 ...
 */
double lowNMSSM_susy_parameters::calc_beta_vS_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double lowNMSSM_susy_parameters::calc_beta_vS_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double lowNMSSM_susy_parameters::calc_beta_vS_three_loop(const Susy_traces& susy_traces) const
{
