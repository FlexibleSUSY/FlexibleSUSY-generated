...
#ifndef lowNMSSM_DECAY_TABLE_H
#define lowNMSSM_DECAY_TABLE_H
...
public:
   ...
   lowNMSSM_decay_table();
   ~lowNMSSM_decay_table() = default;
   lowNMSSM_decay_table(const lowNMSSM_decay_table&) = default;
   lowNMSSM_decay_table(lowNMSSM_decay_table&&) = default;
   lowNMSSM_decay_table& operator=(const lowNMSSM_decay_table&) = default;
   lowNMSSM_decay_table& operator=(lowNMSSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const lowNMSSM_decay_table&);
