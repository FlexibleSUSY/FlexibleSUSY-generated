...
/**
 * @file lowNMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef lowNMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define lowNMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class lowNMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class lowNMSSM_mass_eigenstates_decoupling_scheme
   : private lowNMSSM_soft_parameters
   , public lowNMSSM_mass_eigenstates_interface
{
public:
   explicit lowNMSSM_mass_eigenstates_decoupling_scheme(const lowNMSSM_input_parameters& input_ = lowNMSSM_input_parameters());
   explicit lowNMSSM_mass_eigenstates_decoupling_scheme(const lowNMSSM_mass_eigenstates&);
   lowNMSSM_mass_eigenstates_decoupling_scheme(const lowNMSSM_mass_eigenstates_decoupling_scheme&) = default;
   lowNMSSM_mass_eigenstates_decoupling_scheme(lowNMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~lowNMSSM_mass_eigenstates_decoupling_scheme() = default;
   lowNMSSM_mass_eigenstates_decoupling_scheme& operator=(const lowNMSSM_mass_eigenstates_decoupling_scheme&) = default;
   lowNMSSM_mass_eigenstates_decoupling_scheme& operator=(lowNMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const lowNMSSM_mass_eigenstates&);
...
private:
   ...
   Problems problems{lowNMSSM_info::model_name,
...
std::ostream& operator<<(std::ostream&, const lowNMSSM_mass_eigenstates_decoupling_scheme&);
