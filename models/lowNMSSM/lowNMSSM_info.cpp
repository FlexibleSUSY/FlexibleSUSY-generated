...
namespace lowNMSSM_info {
   ...
   const char* input_parameter_names[NUMBER_OF_INPUT_PARAMETERS] = {"Qin",
      "M1Input", "M2Input", "M3Input", "AtInput", "AbInput", "ATauInput",
      "TanBeta", "ml1Input", "ml2Input", "ml3Input", "me1Input", "me2Input",
      "me3Input", "mq1Input", "mq2Input", "mq3Input", "md1Input", "md2Input",
