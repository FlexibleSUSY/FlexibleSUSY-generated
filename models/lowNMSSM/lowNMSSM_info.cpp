...
namespace lowNMSSM_info {
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS>
      input_parameter_names = {"Qin", "M1Input", "M2Input", "M3Input", "AtInput",
      "AbInput", "ATauInput", "TanBeta", "ml1Input", "ml2Input", "ml3Input",
      "me1Input", "me2Input", "me3Input", "mq1Input", "mq2Input", "mq3Input",
      "md1Input", "md2Input", "md3Input", "mu1Input", "mu2Input", "mu3Input",
      "LambdaInput", "KappaInput", "ALambdaInput", "AKappaInput", "MuEffInput"};

   const std::array<std::string, NUMBER_OF_EXTRA_PARAMETERS>
      extra_parameter_names = {};

   const std::string model_name = "lowNMSSM";
