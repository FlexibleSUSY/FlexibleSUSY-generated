...
#ifndef lowNMSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define lowNMSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "lowNMSSM_low_scale_constraint.hpp"
...
template<>
class lowNMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   lowNMSSM_low_scale_constraint() = default;
   lowNMSSM_low_scale_constraint(lowNMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~lowNMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "lowNMSSM low-scale constraint"; }
