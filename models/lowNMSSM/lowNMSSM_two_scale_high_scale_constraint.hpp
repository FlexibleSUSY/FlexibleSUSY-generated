...
template<>
class lowNMSSM_high_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "lowNMSSM high-scale constraint"; }
