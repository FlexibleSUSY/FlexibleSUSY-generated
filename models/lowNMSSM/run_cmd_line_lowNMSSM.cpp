...
int run_solver(const lowNMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(lowNMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const lowNMSSM_input_parameters& input)
{
   int exit_code = 0;
