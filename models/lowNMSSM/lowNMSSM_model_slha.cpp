...
lowNMSSM_slha::lowNMSSM_slha(const lowNMSSM_input_parameters& input_,
 ...
 */
lowNMSSM_slha::lowNMSSM_slha(const lowNMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : lowNMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void lowNMSSM_slha::clear()
{
   lowNMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void lowNMSSM_slha::calculate_spectrum()
{
   lowNMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void lowNMSSM_slha::convert_to_slha()
{
...
void lowNMSSM_slha::calculate_ckm_matrix()
{
...
void lowNMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void lowNMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void lowNMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void lowNMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const lowNMSSM_physical& lowNMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

lowNMSSM_physical& lowNMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void lowNMSSM_slha::print(std::ostream& ostr) const
{
   lowNMSSM_mass_eigenstates::print(ostr);
...
void lowNMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const lowNMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
