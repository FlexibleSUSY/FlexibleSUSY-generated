...
// File generated at Wed 12 Apr 2017 12:40:54
 ...
 * parameters.
 *
 * This file was generated at Wed 12 Apr 2017 12:40:54 with FlexibleSUSY
...
CLASSNAME::lowNMSSM_mass_eigenstates(const lowNMSSM_input_parameters& input_)
   ...
   , physical()
   , problems(lowNMSSM_info::particle_names)
...
CLASSNAME::~lowNMSSM_mass_eigenstates()
{
}
...
const Problems<lowNMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<lowNMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   lowNMSSM_mass_eigenstates* model = ewsb_args->model;
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_tachyon(lowNMSSM_info::Hpm);
...
void CLASSNAME::calculate_MSd()
{
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_tachyon(lowNMSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_tachyon(lowNMSSM_info::VWm);
   }
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_tachyon(lowNMSSM_info::VZ);
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::hh))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::Ah))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_tachyon(lowNMSSM_info::VWm))
      return;
