...
lowNMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBlowNMSSM_SRC += \
		$(DIR)/lowNMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/lowNMSSM_two_scale_ewsb_solver.cpp \
...
LIBlowNMSSM_HDR += \
		...
		$(DIR)/lowNMSSM_two_scale_spectrum_generator.hpp \
