...
// File generated at Tue 22 Jan 2019 17:16:08
   ...
   double start, double stop) const
{
   ...
   lowNMSSM_parameter_getter parameter_getter;
   Coupling_monitor<lowNMSSM_mass_eigenstates, lowNMSSM_parameter_getter>
