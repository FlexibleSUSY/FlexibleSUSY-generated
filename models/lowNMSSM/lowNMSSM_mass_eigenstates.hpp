...
#include "lowNMSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) lowNMSSM_soft_parameters::p

namespace flexiblesusy {

class lowNMSSM_ewsb_solver_interface;
/**
 * @class lowNMSSM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class lowNMSSM_mass_eigenstates
   : public lowNMSSM_soft_parameters
   , public lowNMSSM_mass_eigenstates_interface
{
public:
   explicit lowNMSSM_mass_eigenstates(const lowNMSSM_input_parameters& input_ = lowNMSSM_input_parameters());
   lowNMSSM_mass_eigenstates(const lowNMSSM_mass_eigenstates&) = default;
   lowNMSSM_mass_eigenstates(lowNMSSM_mass_eigenstates&&) = default;
   virtual ~lowNMSSM_mass_eigenstates() = default;
   lowNMSSM_mass_eigenstates& operator=(const lowNMSSM_mass_eigenstates&) = default;
   lowNMSSM_mass_eigenstates& operator=(lowNMSSM_mass_eigenstates&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<lowNMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void set_ewsb_solver(const std::shared_ptr<lowNMSSM_ewsb_solver_interface>&);
   ...
   const lowNMSSM_input_parameters& get_input_parameters() const override;
   lowNMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const lowNMSSM_physical& get_physical() const override;
   lowNMSSM_physical& get_physical() override;
   ...
   void set_physical(const lowNMSSM_physical&) override;
...
private:
   ...
   mutable Problems problems{lowNMSSM_info::model_name,
                             &lowNMSSM_info::particle_names_getter,
                             &lowNMSSM_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<lowNMSSM_ewsb_solver_interface> ewsb_solver{};
