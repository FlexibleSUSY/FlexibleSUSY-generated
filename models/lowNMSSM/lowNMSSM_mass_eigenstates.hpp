...
/**
 * @file lowNMSSM_mass_eigenstates.hpp
 *
...
#ifndef lowNMSSM_MASS_EIGENSTATES_H
#define lowNMSSM_MASS_EIGENSTATES_H
 ...
 */
class lowNMSSM_mass_eigenstates : public lowNMSSM_soft_parameters {
public:
   explicit lowNMSSM_mass_eigenstates(const lowNMSSM_input_parameters& input_ = lowNMSSM_input_parameters());
   virtual ~lowNMSSM_mass_eigenstates();
   ...
   void set_physical(const lowNMSSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const lowNMSSM_physical& get_physical() const;
   lowNMSSM_physical& get_physical();
   const Problems<lowNMSSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<lowNMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(lowNMSSM_info::Particles&) const;
...
private:
   ...
   lowNMSSM_physical physical; ///< contains the pole masses and mixings
   Problems<lowNMSSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const lowNMSSM_mass_eigenstates&);
