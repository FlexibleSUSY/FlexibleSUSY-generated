...
lowNMSSM_physical::lowNMSSM_physical()
   :
 ...
 * to be complex.
 */
void lowNMSSM_physical::convert_to_hk()
{
...
void lowNMSSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd lowNMSSM_physical::get_masses() const
{
...
void lowNMSSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void lowNMSSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const lowNMSSM_physical& phys_pars)
{
