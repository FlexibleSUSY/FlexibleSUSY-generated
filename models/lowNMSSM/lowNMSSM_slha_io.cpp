...
lowNMSSM_slha_io::lowNMSSM_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void lowNMSSM_slha_io::clear()
{
   slha_io.clear();
}
 ...
 */
void lowNMSSM_slha_io::set_extpar(const lowNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSM_slha_io::set_imminpar(const lowNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSM_slha_io::set_imextpar(const lowNMSSM_input_parameters& input)
{
 ...
 */
void lowNMSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSM_slha_io::set_minpar(const lowNMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSM_slha_io::set_input(const lowNMSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void lowNMSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void lowNMSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void lowNMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void lowNMSSM_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void lowNMSSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void lowNMSSM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void lowNMSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void lowNMSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void lowNMSSM_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, lowNMSSM_info::model_name)
 ...
 */
void lowNMSSM_slha_io::set_mass(const lowNMSSM_physical& physical,
 ...
 */
void lowNMSSM_slha_io::set_mixing_matrices(const lowNMSSM_physical& physical,
...
void lowNMSSM_slha_io::set_pmns(
...
void lowNMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void lowNMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void lowNMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void lowNMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void lowNMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, lowNMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void lowNMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = lowNMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + lowNMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void lowNMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void lowNMSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double lowNMSSM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void lowNMSSM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void lowNMSSM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void lowNMSSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void lowNMSSM_slha_io::fill_drbar_parameters(lowNMSSM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void lowNMSSM_slha_io::fill(lowNMSSM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   lowNMSSM_physical physical_hk;
 ...
 */
void lowNMSSM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void lowNMSSM_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void lowNMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void lowNMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void lowNMSSM_slha_io::fill_minpar_tuple(lowNMSSM_input_parameters& input,
...
void lowNMSSM_slha_io::fill_extpar_tuple(lowNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void lowNMSSM_slha_io::fill_imminpar_tuple(lowNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void lowNMSSM_slha_io::fill_imextpar_tuple(lowNMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void lowNMSSM_slha_io::fill_physical(lowNMSSM_physical& physical) const
{
   {
 ...
 */
double lowNMSSM_slha_io::read_scale() const
{
