...
lowNMSSM_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   lowNMSSM_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, lowNMSSM_input_parameters& input,
