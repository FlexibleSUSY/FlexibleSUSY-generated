...
// File generated at Sun 31 May 2015 12:40:06
...
lowNMSSM_low_scale_constraint<Two_scale>::lowNMSSM_low_scale_constraint(
   lowNMSSM<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void lowNMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& lowNMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
