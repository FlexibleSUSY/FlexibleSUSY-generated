...
// File generated at Tue 8 Sep 2015 13:06:43
...
lowNMSSM_low_scale_constraint<Two_scale>::lowNMSSM_low_scale_constraint(
   lowNMSSM<Two_scale>* model_, const softsusy::QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
{
   assert(model && "Error: lowNMSSM_low_scale_constraint::apply():"
...
void lowNMSSM_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
...
double lowNMSSM_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "lowNMSSM_low_scale_constraint<Two_scale>::"
