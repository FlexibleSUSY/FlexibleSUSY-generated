...
#ifndef lowNMSSM_WEINBERG_ANGLE_H
#define lowNMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   lowNMSSM_weinberg_angle(const lowNMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const lowNMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const lowNMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
