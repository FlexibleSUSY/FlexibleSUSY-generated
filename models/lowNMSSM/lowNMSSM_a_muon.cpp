 ...
 *
 * This file was generated at Tue 22 Jan 2019 17:16:29 with FlexibleSUSY
...
double calculate_a_muon_impl(lowNMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const lowNMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("lowNMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double lowNMSSM_a_muon::calculate_a_muon(const lowNMSSM_mass_eigenstates& model_)
{
...
double lowNMSSM_a_muon::calculate_a_muon_uncertainty(const lowNMSSM_mass_eigenstates& model_)
{
   lowNMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("lowNMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
