...
// File generated at Sat 27 Aug 2016 12:38:37
...
lowNMSSM_convergence_tester<Two_scale>::lowNMSSM_convergence_tester(lowNMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<lowNMSSM<Two_scale> >(model, accuracy_goal)
{
}

lowNMSSM_convergence_tester<Two_scale>::~lowNMSSM_convergence_tester()
{
}

double lowNMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const lowNMSSM<Two_scale>& ol = get_last_iteration_model();
   const lowNMSSM<Two_scale>& ne = get_model();
