...
// File generated at Sun 26 Aug 2018 14:39:25
...
lowNMSSM_convergence_tester<Two_scale>::lowNMSSM_convergence_tester(
   lowNMSSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<lowNMSSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double lowNMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const lowNMSSM<Two_scale>& ne = get_current_iteration_model();
