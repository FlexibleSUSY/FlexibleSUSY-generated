...
// File generated at Wed 29 Jun 2016 12:34:19

/**
 * @file lowNMSSM_two_scale_model_slha.cpp
 * @brief lowNMSSM model class wrapper for SLHA conversion
 */
...
#define CLASSNAME lowNMSSM_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::lowNMSSM_slha(const lowNMSSM_input_parameters& input_)
   : lowNMSSM<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::lowNMSSM_slha(const lowNMSSM<Two_scale>& model_,
...
CLASSNAME::~lowNMSSM_slha()
{
}

void CLASSNAME::clear()
{
   lowNMSSM<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   lowNMSSM<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const lowNMSSM_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

lowNMSSM_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
std::ostream& operator<<(std::ostream& ostr, const lowNMSSM_slha<Two_scale>& model)
{
   model.print(ostr);
   return ostr;
}
