...
/**
 * @file lowNMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef lowNMSSM_MASS_EIGENSTATES_INTERFACE_H
#define lowNMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class lowNMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class lowNMSSM_mass_eigenstates_interface {
public:
   virtual ~lowNMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<lowNMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const lowNMSSM_input_parameters& get_input_parameters() const = 0;
   virtual lowNMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const lowNMSSM_physical& get_physical() const = 0;
   virtual lowNMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const lowNMSSM_physical&) = 0;
