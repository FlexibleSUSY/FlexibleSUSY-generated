...
/**
 * @file SMSSM_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Sat 15 Oct 2016 15:34:50

#ifndef SMSSM_TWO_SCALE_SLHA_H
#define SMSSM_TWO_SCALE_SLHA_H
...
/**
 * @class SMSSM_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class SMSSM_slha<Two_scale> : public SMSSM<Two_scale> {
public:
   explicit SMSSM_slha(const SMSSM_input_parameters& input_ = SMSSM_input_parameters());
   explicit SMSSM_slha(const SMSSM<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~SMSSM_slha();
...
std::ostream& operator<<(std::ostream& ostr, const SMSSM_slha<Two_scale>& model);
