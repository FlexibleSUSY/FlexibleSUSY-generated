...
// File generated at Fri 20 Oct 2017 08:52:45
...
#define CLASSNAME SMSSM_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int SMSSM_susy_parameters::numberOfParameters;

SMSSM_susy_parameters::SMSSM_susy_parameters(const SMSSM_input_parameters& input_)
   : input(input_)
{
...
Eigen::ArrayXd SMSSM_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

SMSSM_susy_parameters SMSSM_susy_parameters::calc_beta(int loops) const
{
   ...
   return SMSSM_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Lambdax, beta_Kappa, beta_Yu, beta_Mu, beta_MS, beta_L1, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu, beta_vS);
}

SMSSM_susy_parameters SMSSM_susy_parameters::calc_beta() const
{
...
Eigen::ArrayXd SMSSM_susy_parameters::get() const
{
...
void SMSSM_susy_parameters::print(std::ostream& ostr) const
{
...
void SMSSM_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const SMSSM_input_parameters& SMSSM_susy_parameters::get_input() const
{
   return input;
}

SMSSM_input_parameters& SMSSM_susy_parameters::get_input()
{
   return input;
}

void SMSSM_susy_parameters::set_input_parameters(const SMSSM_input_parameters& input_)
{
   input = input_;
}

SMSSM_susy_parameters::Susy_traces SMSSM_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const SMSSM_susy_parameters& susy_pars)
{
