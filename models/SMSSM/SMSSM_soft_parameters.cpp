...
// File generated at Fri 20 Oct 2017 08:52:59
...
SMSSM_soft_parameters SMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const SMSSM_susy_parameters susy_betas(SMSSM_susy_parameters::calc_beta(loops));
...
SMSSM_soft_parameters::Soft_traces SMSSM_soft_parameters::calc_soft_traces(int loops) const
{
