 ...
 */
template<>
class SMSSM<Two_scale> : public Two_scale_model, public SMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(SMSSM<Two_scale>::*Memfun_t)();
      SMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(SMSSM<Two_scale>* model_, Memfun_t fun_)
