...
#ifndef SMSSM_WEINBERG_ANGLE_H
#define SMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   SMSSM_weinberg_angle(const SMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const SMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const SMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
