...
double SMSSM_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void SMSSM_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const SMSSM_input_parameters& input)
{
   ...
   SMSSM_high_scale_constraint<Two_scale> high_scale_constraint(&model);
   SMSSM_susy_scale_constraint<Two_scale> susy_scale_constraint(&model, qedqcd);
   SMSSM_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);

   high_scale_constraint.initialize();
   susy_scale_constraint.initialize();
   low_scale_constraint .initialize();

   SMSSM_convergence_tester<Two_scale> convergence_tester(
   ...
   SMSSM_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void SMSSM_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   SMSSM_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_high_scale());
}

void SMSSM_spectrum_generator<Two_scale>::calculate_spectrum()
{
