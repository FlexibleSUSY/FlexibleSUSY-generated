...
/**
 * @file SMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef SMSSM_MASS_EIGENSTATES_INTERFACE_H
#define SMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class SMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class SMSSM_mass_eigenstates_interface {
public:
   virtual ~SMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<SMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const SMSSM_input_parameters& get_input_parameters() const = 0;
   virtual SMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const SMSSM_physical& get_physical() const = 0;
   virtual SMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const SMSSM_physical&) = 0;
