...
SMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBSMSSM_SRC += \
		$(DIR)/SMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/SMSSM_two_scale_ewsb_solver.cpp \
...
LIBSMSSM_HDR += \
		...
		$(DIR)/SMSSM_two_scale_spectrum_generator.hpp \
