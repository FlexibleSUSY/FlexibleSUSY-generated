...
// File generated at Wed 16 Oct 2019 22:15:37
 ...
 */
double SMSSM_soft_parameters::calc_beta_BMS_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SMSSM_soft_parameters::calc_beta_BMS_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_BMS = Re(-0.8*twoLoop*(30*MS*traceAdjYdTYd*AbsSqr(Lambdax) + 10*MS*
      ...
      Lambdax)*Sqr(g1) - 3*AbsSqr(Lambdax)*BMS*Sqr(g1) - 6*BMu*Conj(Lambdax)*
      Kappa*Sqr(g1) + 6*MassB*Conj(Lambdax)*Kappa*Mu*Sqr(g1) + 30*MassWB*MS*
      AbsSqr(Lambdax)*Sqr(g2) - 15*AbsSqr(Lambdax)*BMS*Sqr(g2) - 30*BMu*Conj(
      Lambdax)*Kappa*Sqr(g2) + 30*MassWB*Conj(Lambdax)*Kappa*Mu*Sqr(g2) + 20*
 ...
 */
double SMSSM_soft_parameters::calc_beta_BMS_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SMSSM_soft_parameters::calc_beta_BMS_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double SMSSM_soft_parameters::calc_beta_BMS_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
