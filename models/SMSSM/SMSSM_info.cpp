...
namespace SMSSM_info {
   ...
   const char* parameter_names[NUMBER_OF_PARAMETERS] = {"Yd(0,0)", "Yd(0,1)",
      ...
      "Yu(1,0)", "Yu(1,1)", "Yu(1,2)", "Yu(2,0)", "Yu(2,1)", "Yu(2,2)", "Mu",
      "MS", "L1", "g1", "g2", "g3", "vd", "vu", "vS", "TYd(0,0)", "TYd(0,1)",
      ...
      "TYu(2,0)", "TYu(2,1)", "TYu(2,2)", "BMu", "BMS", "LL1", "mq2(0,0)",
      ...
      "me2(2,0)", "me2(2,1)", "me2(2,2)", "ms2", "MassB", "MassWB", "MassG"};
   ...
   const char* input_parameter_names[NUMBER_OF_INPUT_PARAMETERS] = {"m0", "m12"
      , "TanBeta", "SignMu", "Azero", "LambdaInput", "KappaInput", "LambdaSInput",
      "L1Input", "MSInput", "BMSInput"};

   const char* model_name = "SMSSM";
