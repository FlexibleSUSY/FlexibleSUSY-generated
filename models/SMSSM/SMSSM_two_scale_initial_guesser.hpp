...
template<>
class SMSSM_initial_guesser<Two_scale> : public Initial_guesser<Two_scale> {
public:
   SMSSM_initial_guesser(SMSSM<Two_scale>*,
                               const SMSSM_input_parameters&,
                               const QedQcd&,
...
private:
   ...
   SMSSM_input_parameters input_pars;
