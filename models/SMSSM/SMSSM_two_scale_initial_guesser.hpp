...
#include "SMSSM_initial_guesser.hpp"
...
/**
 * @class SMSSM_initial_guesser<Two_scale>
 * @brief initial guesser for the SMSSM
 */

template<>
class SMSSM_initial_guesser<Two_scale> : public Initial_guesser {
public:
   SMSSM_initial_guesser(SMSSM<Two_scale>*,
                               const softsusy::QedQcd&,
                               const SMSSM_low_scale_constraint<Two_scale>&,
                               const SMSSM_susy_scale_constraint<Two_scale>&,
                               const SMSSM_high_scale_constraint<Two_scale>&);
   virtual ~SMSSM_initial_guesser() = default;
...
private:
   SMSSM<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   SMSSM_low_scale_constraint<Two_scale> low_constraint{};
   SMSSM_susy_scale_constraint<Two_scale> susy_constraint{};
   SMSSM_high_scale_constraint<Two_scale> high_constraint{};
