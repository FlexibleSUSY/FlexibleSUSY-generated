                                ...
                                const SMSSM_input_parameters& input)
{
   ...
   SMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   SMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   SMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
   ...
   SMSSM_convergence_tester<T> convergence_tester(
