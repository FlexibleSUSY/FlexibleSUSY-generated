...
public:
   ...
   void set_extra(const SMSSM_slha&, const SMSSM_scales&, const SMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const SMSSM_scales&, const SMSSM_observables&);
