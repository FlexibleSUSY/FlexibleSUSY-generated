...
public:
   ...
   void set_decays(const SMSSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const SMSSM_slha&, const SMSSM_scales&, const SMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const SMSSM_slha&);
   ...
   void fill_decays_data(const SMSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const SMSSM_scales&, const SMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, SMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const SMSSM_slha&);
...
void SMSSM_slha_io::fill(
   ...
   SMSSM_decays const * const decays)
{
