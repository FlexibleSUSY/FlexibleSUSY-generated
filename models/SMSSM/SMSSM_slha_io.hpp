...
public:
   ...
   template <class T> void set_extra(const SMSSM_slha<T>&, const SMSSM_scales&);
   ...
   static void convert_to_slha_convention(SMSSM_physical&);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const SMSSM_slha<T>&, const QedQcd&, const SMSSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const SMSSM_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const SMSSM_slha<T>&, const QedQcd&, const SMSSM_scales&);
...
private:
   ...
   template <class T> void fill_drbar_parameters(SMSSM_slha<T>&) const;
   template <class T> void fill_physical(SMSSM_slha<T>&) const;
};
 ...
 */
template <class T>
void SMSSM_slha_io::fill_drbar_parameters(SMSSM_slha<T>& model) const
{
 ...
 */
template <class T>
void SMSSM_slha_io::fill_physical(SMSSM_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
...
void SMSSM_slha_io::fill_slhaea(
   ...
   const QedQcd& qedqcd, const SMSSM_scales& scales)
{
...
SLHAea::Coll SMSSM_slha_io::fill_slhaea(
   const SMSSM_slha<T>& model, const QedQcd& qedqcd)
{
   SMSSM_scales scales;
...
{
   SLHAea::Coll slhaea;
   SMSSM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
