...
public:
   ...
   template <class Model> void fill(SMSSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const SMSSM_slha<Model>&, const SMSSM_scales&, const SMSSM_observables&);
   void set_input(const SMSSM_input_parameters&);
   ...
   template <class Model> void set_spectrum(const SMSSM_slha<Model>&);
   ...
   static void fill_imminpar_tuple(SMSSM_input_parameters&, int, double);
   static void fill_imextpar_tuple(SMSSM_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const SMSSM_slha<Model>&, const softsusy::QedQcd&, const SMSSM_scales&, const SMSSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const SMSSM_slha<Model>&, const softsusy::QedQcd&, const SMSSM_scales&, const SMSSM_observables&);
...
private:
   ...
   void set_imminpar(const SMSSM_input_parameters&);
   void set_imextpar(const SMSSM_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const SMSSM_slha<Model>&);
 ...
 */
template <class Model>
void SMSSM_slha_io::fill(SMSSM_slha<Model>& model) const
{
...
void SMSSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const SMSSM_slha<Model>& model,
...
SLHAea::Coll SMSSM_slha_io::fill_slhaea(
   const SMSSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
 ...
 */
template <class Model>
void SMSSM_slha_io::set_model_parameters(const SMSSM_slha<Model>& model)
{
   {
...
void SMSSM_slha_io::set_extra(
   const SMSSM_slha<Model>& model, const SMSSM_scales& scales,
   const SMSSM_observables& observables)
{
 ...
 */
template <class... Ts>
void SMSSM_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<SMSSM_slha_io> ss(this);
...
{
   set_spectrum(SMSSM_slha<SMSSM<T> >(model));
}
 ...
 */
template <class Model>
void SMSSM_slha_io::set_spectrum(const SMSSM_slha<Model>& model)
{
   const SMSSM_physical physical(model.get_physical_slha());
