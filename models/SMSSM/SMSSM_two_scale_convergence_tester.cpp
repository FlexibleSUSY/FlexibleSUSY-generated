...
// File generated at Sat 15 Oct 2016 15:34:40
...
SMSSM_convergence_tester<Two_scale>::SMSSM_convergence_tester(SMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<SMSSM<Two_scale> >(model, accuracy_goal)
{
}

SMSSM_convergence_tester<Two_scale>::~SMSSM_convergence_tester()
{
}

double SMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const SMSSM<Two_scale>& ol = get_last_iteration_model();
   const SMSSM<Two_scale>& ne = get_model();
