...
// File generated at Fri 20 Oct 2017 08:55:44
...
SMSSM_convergence_tester<Two_scale>::SMSSM_convergence_tester(
   SMSSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<SMSSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double SMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const SMSSM<Two_scale>& ne = get_current_iteration_model();
