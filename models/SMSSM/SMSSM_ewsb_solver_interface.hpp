...
/**
 * @file SMSSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Sun 26 Aug 2018 14:33:49 with FlexibleSUSY
 * 2.2.0 (git commit: 8489097de2d6938a6da0149378457b5ad13d9425) and SARAH 4.13.0 .
 */

#ifndef SMSSM_EWSB_SOLVER_INTERFACE_H
#define SMSSM_EWSB_SOLVER_INTERFACE_H
...
class SMSSM_ewsb_solver_interface {
public:
   virtual ~SMSSM_ewsb_solver_interface() {}
   ...
   virtual int solve(SMSSM_mass_eigenstates&) = 0;
};
