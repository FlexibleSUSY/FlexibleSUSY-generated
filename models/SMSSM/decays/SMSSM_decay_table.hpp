...
#ifndef SMSSM_DECAY_TABLE_H
#define SMSSM_DECAY_TABLE_H
...
public:
   ...
   SMSSM_decay_table();
   ~SMSSM_decay_table() = default;
   SMSSM_decay_table(const SMSSM_decay_table&) = default;
   SMSSM_decay_table(SMSSM_decay_table&&) = default;
   SMSSM_decay_table& operator=(const SMSSM_decay_table&) = default;
   SMSSM_decay_table& operator=(SMSSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const SMSSM_decay_table&);
