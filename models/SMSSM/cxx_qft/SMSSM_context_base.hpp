...
/**
 * @file cxx_qft/SMSSM_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.1 and SARAH 4.14.5 .
 */

#ifndef SMSSM_CXXQFT_CONTEXT_BASE_H
#define SMSSM_CXXQFT_CONTEXT_BASE_H

#include "SMSSM_fields.hpp"
...
namespace SMSSM_cxx_diagrams {
   ...
   struct context_base {
      SMSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(SMSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(SMSSM_mass_eigenstates_interface const* const m) : model(*m) {}
