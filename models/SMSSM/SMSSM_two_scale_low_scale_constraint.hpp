...
#ifndef SMSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define SMSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "SMSSM_low_scale_constraint.hpp"
...
template<>
class SMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   SMSSM_low_scale_constraint() = default;
   SMSSM_low_scale_constraint(SMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~SMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "SMSSM low-scale constraint"; }
