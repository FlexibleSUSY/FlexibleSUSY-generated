...
#ifndef SMSSM_MASS_EIGENSTATES_H
#define SMSSM_MASS_EIGENSTATES_H
 ...
 */
class SMSSM_mass_eigenstates : public SMSSM_soft_parameters {
public:
   explicit SMSSM_mass_eigenstates(const SMSSM_input_parameters& input_ = SMSSM_input_parameters());
   virtual ~SMSSM_mass_eigenstates();
   ...
   void set_physical(const SMSSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const SMSSM_physical& get_physical() const;
   SMSSM_physical& get_physical();
   const Problems<SMSSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<SMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(SMSSM_info::Particles&) const;
...
private:
   ...
   SMSSM_physical physical; ///< contains the pole masses and mixings
   Problems<SMSSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const SMSSM_mass_eigenstates&);
