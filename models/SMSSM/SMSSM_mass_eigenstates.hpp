...
class SMSSM_ewsb_solver_interface;
/**
 * @class SMSSM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class SMSSM_mass_eigenstates
   : public SMSSM_soft_parameters
...
public:
   ...
   SMSSM_mass_eigenstates(const SMSSM_mass_eigenstates&) = default;
   SMSSM_mass_eigenstates(SMSSM_mass_eigenstates&&) = default;
   virtual ~SMSSM_mass_eigenstates() = default;
   SMSSM_mass_eigenstates& operator=(const SMSSM_mass_eigenstates&) = default;
   SMSSM_mass_eigenstates& operator=(SMSSM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<SMSSM_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{SMSSM_info::model_name,
   ...
   std::shared_ptr<SMSSM_ewsb_solver_interface> ewsb_solver{};
