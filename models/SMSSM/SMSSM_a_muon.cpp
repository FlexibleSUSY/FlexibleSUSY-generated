...
// File generated at Tue 10 Oct 2017 22:23:11

/**
 * @file SMSSM_a_muon.cpp
 *
 * This file was generated at Tue 10 Oct 2017 22:23:11 with FlexibleSUSY
...
#include "SMSSM_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(SMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const SMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("SMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double SMSSM_a_muon::calculate_a_muon(const SMSSM_mass_eigenstates& model_)
{
...
double SMSSM_a_muon::calculate_a_muon_uncertainty(const SMSSM_mass_eigenstates& model_)
{
   SMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("SMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
