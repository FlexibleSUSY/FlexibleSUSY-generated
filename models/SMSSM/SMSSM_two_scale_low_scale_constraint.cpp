...
// File generated at Tue 8 Sep 2015 12:56:57
...
SMSSM_low_scale_constraint<Two_scale>::SMSSM_low_scale_constraint(
   SMSSM<Two_scale>* model_, const softsusy::QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
{
   assert(model && "Error: SMSSM_low_scale_constraint::apply():"
...
void SMSSM_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
...
{
   assert(model && "SMSSM_low_scale_constraint<Two_scale>::"
...
double SMSSM_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "SMSSM_low_scale_constraint<Two_scale>::"
 ...
 */
void SMSSM_low_scale_constraint<Two_scale>::recalculate_mw_pole()
{
   assert(model && "SMSSM_low_scale_constraint<Two_scale>::"
