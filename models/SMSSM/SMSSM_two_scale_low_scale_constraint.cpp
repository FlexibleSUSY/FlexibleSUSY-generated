...
SMSSM_low_scale_constraint<Two_scale>::SMSSM_low_scale_constraint(
   ...
   const SMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void SMSSM_low_scale_constraint<Two_scale>::set_input_parameters(const SMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
