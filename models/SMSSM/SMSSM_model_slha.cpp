...
SMSSM_slha::SMSSM_slha(const SMSSM_input_parameters& input_,
 ...
 */
SMSSM_slha::SMSSM_slha(const SMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : SMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void SMSSM_slha::clear()
{
   SMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void SMSSM_slha::calculate_spectrum()
{
   SMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void SMSSM_slha::convert_to_slha()
{
...
void SMSSM_slha::calculate_ckm_matrix()
{
...
void SMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void SMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void SMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void SMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const SMSSM_physical& SMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

SMSSM_physical& SMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void SMSSM_slha::print(std::ostream& ostr) const
{
   SMSSM_mass_eigenstates::print(ostr);
...
void SMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const SMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
