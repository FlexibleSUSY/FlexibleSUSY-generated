...
class SMSSM_slha : public SMSSM_mass_eigenstates {
public:
   explicit SMSSM_slha(const SMSSM_input_parameters& input_ = SMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit SMSSM_slha(const SMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
