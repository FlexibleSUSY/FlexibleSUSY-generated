...
/**
 * @file SMSSM_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 22 Jan 2019 17:30:32
...
class SMSSM_slha : public Model {
public:
   explicit SMSSM_slha(const SMSSM_input_parameters& input_ = SMSSM_input_parameters());
   explicit SMSSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   SMSSM_slha(const SMSSM_slha&) = default;
   SMSSM_slha(SMSSM_slha&&) = default;
   virtual ~SMSSM_slha() = default;
   SMSSM_slha& operator=(const SMSSM_slha&) = default;
   SMSSM_slha& operator=(SMSSM_slha&&) = default;
   ...
   const SMSSM_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   SMSSM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   SMSSM_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
SMSSM_slha<Model>::SMSSM_slha(const SMSSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
SMSSM_slha<Model>::SMSSM_slha(const Model& model_,
...
template <class Model>
void SMSSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void SMSSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void SMSSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void SMSSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void SMSSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void SMSSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void SMSSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const SMSSM_physical& SMSSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
SMSSM_physical& SMSSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void SMSSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void SMSSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const SMSSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
