...
/**
 * @file SMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef SMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define SMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "SMSSM_info.hpp"
#include "SMSSM_physical.hpp"
#include "SMSSM_soft_parameters.hpp"
#include "SMSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) SMSSM_soft_parameters::p
...
/**
 * @class SMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class SMSSM_mass_eigenstates_decoupling_scheme
   : private SMSSM_soft_parameters
   , public SMSSM_mass_eigenstates_interface
{
public:
   explicit SMSSM_mass_eigenstates_decoupling_scheme(const SMSSM_input_parameters& input_ = SMSSM_input_parameters());
   explicit SMSSM_mass_eigenstates_decoupling_scheme(const SMSSM_mass_eigenstates&);
   SMSSM_mass_eigenstates_decoupling_scheme(const SMSSM_mass_eigenstates_decoupling_scheme&) = default;
   SMSSM_mass_eigenstates_decoupling_scheme(SMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~SMSSM_mass_eigenstates_decoupling_scheme() = default;
   SMSSM_mass_eigenstates_decoupling_scheme& operator=(const SMSSM_mass_eigenstates_decoupling_scheme&) = default;
   SMSSM_mass_eigenstates_decoupling_scheme& operator=(SMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<SMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const SMSSM_mass_eigenstates&);
   ...
   const SMSSM_input_parameters& get_input_parameters() const override;
   SMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const SMSSM_physical& get_physical() const override;
   SMSSM_physical& get_physical() override;
   ...
   void set_physical(const SMSSM_physical&) override;
...
private:
   ...
   Problems problems{SMSSM_info::model_name,
                     &SMSSM_info::particle_names_getter,
                     &SMSSM_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const SMSSM_mass_eigenstates_decoupling_scheme&);
