...
#ifndef SMSSM_TWO_SCALE_MATCHING_H
#define SMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class SMSSM;
template <class T> class SMSSM_standard_model_Matching;
...
template<>
class SMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   SMSSM_standard_model_Matching();

   SMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       SMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~SMSSM_standard_model_Matching();
