...
// SMSSM_parameter_getter ////////////////////////////////////////

std::vector<std::string> SMSSM_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, SMSSM_info::NUMBER_OF_MIXINGS> SMSSM_parameter_getter::get_mixing_names()
{
   return SMSSM_info::particle_mixing_names;
}

Eigen::ArrayXd SMSSM_parameter_getter::get_parameters(const SMSSM_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, SMSSM_info::NUMBER_OF_PARAMETERS> SMSSM_parameter_getter::get_parameter_names()
{
   return SMSSM_info::parameter_names;
}

std::array<std::string, SMSSM_info::NUMBER_OF_PARTICLES> SMSSM_parameter_getter::get_particle_names()
{
   return SMSSM_info::particle_names;
}

std::vector<std::string> SMSSM_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> SMSSM_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, SMSSM_info::NUMBER_OF_MIXINGS> SMSSM_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, SMSSM_info::NUMBER_OF_MIXINGS> SMSSM_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, SMSSM_info::NUMBER_OF_INPUT_PARAMETERS> SMSSM_parameter_getter::get_input_parameter_names()
{
   return SMSSM_info::input_parameter_names;
}

std::array<std::string, SMSSM_info::NUMBER_OF_EXTRA_PARAMETERS> SMSSM_parameter_getter::get_extra_parameter_names()
{
   return SMSSM_info::extra_parameter_names;
}

decltype(SMSSM_info::NUMBER_OF_MASSES) SMSSM_parameter_getter::get_number_of_masses()
{
   return SMSSM_info::NUMBER_OF_MASSES;
}

// SMSSM_spectrum_plotter ////////////////////////////////////////

SMSSM_spectrum_plotter::SMSSM_spectrum_plotter(const SMSSM_mass_eigenstates& model)
{
...
void SMSSM_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   ...
   VERBOSE_MSG("SMSSM_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("SMSSM_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("SMSSM_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void SMSSM_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("SMSSM_spectrum_plotter::write_spectrum: "
 ...
 */
void to_database(
   const std::string& file_name, const SMSSM_mass_eigenstates& model,
   ...
   const SMSSM_observables* observables)
{
   ...
   append(names, SMSSM_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, SMSSM_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, SMSSM_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, SMSSM_parameter_getter::get_DRbar_mass_names());
   append(names, SMSSM_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, SMSSM_parameter_getter::get_pole_mass_names());
   append(names, SMSSM_parameter_getter::get_pole_mixing_names());
   ...
   if (SMSSM_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, SMSSM_observables::get_names());
 ...
 */
SMSSM_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, SMSSM_observables* observables)
{
   SMSSM_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = SMSSM_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = SMSSM_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = SMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = SMSSM_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? SMSSM_observables::NUMBER_OF_OBSERVABLES : 0);
