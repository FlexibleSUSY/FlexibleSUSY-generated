...
// File generated at Mon 19 Sep 2016 09:59:25
...
SMSSM_spectrum_plotter::SMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> SMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const SMSSM_observables* observables)
{
   ...
   append(names, SMSSM_parameter_getter().get_mass_names());
   append(names, SMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, SMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = SMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = SMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = SMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? SMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
