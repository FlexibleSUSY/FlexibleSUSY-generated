...
// File generated at Tue 22 Jan 2019 17:18:04
 ...
 */
double SMSSM_soft_parameters::calc_beta_LL1_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SMSSM_soft_parameters::calc_beta_LL1_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SMSSM_soft_parameters::calc_beta_LL1_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SMSSM_soft_parameters::calc_beta_LL1_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double SMSSM_soft_parameters::calc_beta_LL1_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
