...
// File generated at Sat 15 Oct 2016 15:36:32
...
public:
   ...
   virtual void run(const softsusy::QedQcd&, const SMSSM_input_parameters&) = 0;
 ...
 */
template <class T>
void SMSSM_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
