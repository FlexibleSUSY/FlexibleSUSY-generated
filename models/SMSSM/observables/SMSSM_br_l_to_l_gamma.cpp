...
/**
 * @file SMSSM_br_l_to_l_gamma.cpp
 *
...
#include "SMSSM_br_l_to_l_gamma.hpp"
...
void run_to_MSUSY(SMSSM_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("SMSSM_l_to_lgamma: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("SMSSM_l_to_lgamma:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("SMSSM_l_to_lgamma: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("SMSSM_l_to_lgamma: run_to_MSUSY(): "
...
namespace SMSSM_br_l_to_l_gamma {
