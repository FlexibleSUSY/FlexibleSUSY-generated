...
// File generated at Tue 10 Oct 2017 22:22:37
...
namespace SMSSM_info {
   ...
   enum Input_parameters : int { m0, m12, TanBeta, SignMu, Azero, LambdaInput,
      KappaInput, LambdaSInput, L1Input, MSInput, BMSInput,
   ...
   class SMSSM_particle_names : public Names {
   public:
      virtual ~SMSSM_particle_names() = default;
   ...
   class SMSSM_parameter_names : public Names {
   public:
      virtual ~SMSSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const SMSSM_particle_names  particle_names_getter{};
   const SMSSM_parameter_names parameter_names_getter{};
