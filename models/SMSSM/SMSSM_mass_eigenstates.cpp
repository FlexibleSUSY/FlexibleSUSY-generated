...
// File generated at Fri 20 Oct 2017 08:55:23
 ...
 * parameters.
 *
 * This file was generated at Fri 20 Oct 2017 08:55:23 with FlexibleSUSY
 * 2.0.1 (git commit: 5296739235bd0ef7020eda218da9c069270c3f45) and SARAH 4.12.0 .
 */

#include "SMSSM_mass_eigenstates.hpp"
#include "SMSSM_ewsb_solver_interface.hpp"
...
CLASSNAME::SMSSM_mass_eigenstates(const SMSSM_input_parameters& input_)
   ...
   , ewsb_solver(new SMSSM_ewsb_solver<Two_scale>())
#endif
{
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<SMSSM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("SMSSM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SMSSM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SMSSM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving SMSSM EWSB at " << ewsb_loop_order << "-loop order");
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(SMSSM_info::Hpm);
...
void CLASSNAME::calculate_MSd()
{
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(SMSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(SMSSM_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(SMSSM_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::hh))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::Ah))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(SMSSM_info::VWm))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(SMSSM_info::VWm);
