...
// File generated at Wed 12 Apr 2017 12:50:40
 ...
 * parameters.
 *
 * This file was generated at Wed 12 Apr 2017 12:50:40 with FlexibleSUSY
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_tachyon(SMSSM_info::Hpm);
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_tachyon(SMSSM_info::VZ);
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::hh))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::Ah))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_tachyon(SMSSM_info::VWm))
      return;
