...
int run_solver(const SMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(SMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const SMSSM_input_parameters& input)
{
   int exit_code = 0;
