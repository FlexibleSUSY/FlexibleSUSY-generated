...
/**
 * @file SMSSM_f_to_f_conversion.cpp
 *
...
#include "SMSSM_f_to_f_conversion.hpp"
...
namespace SMSSM_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const SMSSM_mass_eigenstates& model) {
