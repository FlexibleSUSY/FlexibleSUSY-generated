...
// File generated at Tue 24 Feb 2015 17:42:11
...
void SMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   ...
   TRACE_STRUCT.traceconjTYuTpTYu = (TYu.conjugate()*(TYu).transpose()).trace()
      ;
   TRACE_STRUCT.traceYdAdjYdconjmd2 = (Yd*Yd.adjoint()*md2.conjugate()).trace()
      ;
   TRACE_STRUCT.traceYdconjmq2AdjYd = (Yd*mq2.conjugate()*Yd.adjoint()).trace()
      ;
   TRACE_STRUCT.traceYeAdjYeconjme2 = (Ye*Ye.adjoint()*me2.conjugate()).trace()
      ;
   TRACE_STRUCT.traceYeconjml2AdjYe = (Ye*ml2.conjugate()*Ye.adjoint()).trace()
      ;
   TRACE_STRUCT.traceYuAdjYuconjmu2 = (Yu*Yu.adjoint()*mu2.conjugate()).trace()
      ;
   TRACE_STRUCT.traceYuconjmq2AdjYu = (Yu*mq2.conjugate()*Yu.adjoint()).trace()
      ;
