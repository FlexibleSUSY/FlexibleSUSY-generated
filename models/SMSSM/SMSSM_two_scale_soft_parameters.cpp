...
const int SMSSM_soft_parameters::numberOfParameters;

SMSSM_soft_parameters::SMSSM_soft_parameters(const SMSSM_input_parameters& input_)
   : SMSSM_susy_parameters(input_)
   , TYd(Eigen::Matrix<double,3,3>::Zero()), TYe(Eigen::Matrix<double,3,3>
   ::Zero()), TLambdax(0), TKappa(0), TYu(Eigen::Matrix<double,3,3>::Zero()),
   BMu(0), BMS(0), LL1(0), mq2(Eigen::Matrix<double,3,3>::Zero()), ml2(
   Eigen::Matrix<double,3,3>::Zero()), mHd2(0), mHu2(0), md2(Eigen::Matrix<
   double,3,3>::Zero()), mu2(Eigen::Matrix<double,3,3>::Zero()), me2(
   Eigen::Matrix<double,3,3>::Zero()), ms2(0), MassB(0), MassWB(0), MassG(0)

{
   set_number_of_parameters(numberOfParameters);
}

SMSSM_soft_parameters::SMSSM_soft_parameters(
   const SMSSM_susy_parameters& susy_model
   ...
   TYu_, double BMu_, double BMS_, double LL1_, const Eigen::Matrix<double,3,3>
   ...
   : SMSSM_susy_parameters(susy_model)
...
Eigen::ArrayXd SMSSM_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

SMSSM_soft_parameters SMSSM_soft_parameters::calc_beta() const
{
   ...
   if (get_loops() > 0) {
      ...
      beta_BMS += calc_beta_BMS_one_loop(TRACE_STRUCT);
      beta_LL1 += calc_beta_LL1_one_loop(TRACE_STRUCT);
      ...
      if (get_loops() > 1) {
         ...
         beta_BMS += calc_beta_BMS_two_loop(TRACE_STRUCT);
         beta_LL1 += calc_beta_LL1_two_loop(TRACE_STRUCT);
   ...
   const SMSSM_susy_parameters susy_betas(SMSSM_susy_parameters::calc_beta());

   return SMSSM_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TLambdax, beta_TKappa, beta_TYu, beta_BMu, beta_BMS, beta_LL1, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_MassB, beta_MassWB, beta_MassG);
}

SMSSM_soft_parameters SMSSM_soft_parameters::calc_beta(unsigned loops) const
{
   SMSSM_soft_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void SMSSM_soft_parameters::clear()
{
   SMSSM_susy_parameters::clear();
...
void SMSSM_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   SMSSM_susy_parameters::set(pars);
...
void SMSSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
      ...
      TRACE_STRUCT.Tr31 = Re(0.012909944487358056*g1*(30*(mHd2 - mHu2)*AbsSqr(
         ...
         g2) + 4*(Sqr(g1) + 20*Sqr(g3))*(md2).trace() + 36*Sqr(g1)*(me2).trace() - 9*
         Sqr(g1)*(ml2).trace() - 45*Sqr(g2)*(ml2).trace() + Sqr(g1)*(mq2).trace() +
         45*Sqr(g2)*(mq2).trace() + 80*Sqr(g3)*(mq2).trace() - 32*Sqr(g1)*(mu2).trace
         () - 160*Sqr(g3)*(mu2).trace() + 90*mHd2*(Yd*Yd.adjoint()).trace() + 30*mHd2
         *(Ye*Ye.adjoint()).trace() - 90*mHu2*(Yu*Yu.adjoint()).trace() - 60*(Yd*
   ...
   if (get_loops() > 1) {
      ...
      TRACE_STRUCT.traceconjTYuTpYu = Re((TYu.conjugate()*Yu.transpose()).trace())
         ;
      TRACE_STRUCT.traceYdAdjYdconjmd2 = Re((Yd*Yd.adjoint()*md2.conjugate())
         .trace());
      TRACE_STRUCT.traceYdconjmq2AdjYd = Re((Yd*mq2.conjugate()*Yd.adjoint())
         .trace());
      TRACE_STRUCT.traceYeAdjYeconjme2 = Re((Ye*Ye.adjoint()*me2.conjugate())
         .trace());
      TRACE_STRUCT.traceYeconjml2AdjYe = Re((Ye*ml2.conjugate()*Ye.adjoint())
         .trace());
      TRACE_STRUCT.traceYuAdjYuconjmu2 = Re((Yu*Yu.adjoint()*mu2.conjugate())
         .trace());
      TRACE_STRUCT.traceYuconjmq2AdjYu = Re((Yu*mq2.conjugate()*Yu.adjoint())
         .trace());
