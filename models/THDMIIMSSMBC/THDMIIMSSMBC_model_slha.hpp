...
class THDMIIMSSMBC_slha : public THDMIIMSSMBC_mass_eigenstates {
public:
   explicit THDMIIMSSMBC_slha(const THDMIIMSSMBC_input_parameters& input_ = THDMIIMSSMBC_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit THDMIIMSSMBC_slha(const THDMIIMSSMBC_mass_eigenstates&, bool do_convert_masses_to_slha = true);
