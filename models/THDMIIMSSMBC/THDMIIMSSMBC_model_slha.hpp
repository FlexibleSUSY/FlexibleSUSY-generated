...
/**
 * @file THDMIIMSSMBC_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Fri 10 Apr 2020 19:44:38

#ifndef THDMIIMSSMBC_SLHA_H
#define THDMIIMSSMBC_SLHA_H
...
class THDMIIMSSMBC_slha : public Model {
public:
   explicit THDMIIMSSMBC_slha(const THDMIIMSSMBC_input_parameters& input_ = THDMIIMSSMBC_input_parameters());
   explicit THDMIIMSSMBC_slha(const Model&, bool do_convert_masses_to_slha = true);
   THDMIIMSSMBC_slha(const THDMIIMSSMBC_slha&) = default;
   THDMIIMSSMBC_slha(THDMIIMSSMBC_slha&&) = default;
   virtual ~THDMIIMSSMBC_slha() = default;
   THDMIIMSSMBC_slha& operator=(const THDMIIMSSMBC_slha&) = default;
   THDMIIMSSMBC_slha& operator=(THDMIIMSSMBC_slha&&) = default;
   ...
   const THDMIIMSSMBC_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   THDMIIMSSMBC_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   THDMIIMSSMBC_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
THDMIIMSSMBC_slha<Model>::THDMIIMSSMBC_slha(const THDMIIMSSMBC_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
THDMIIMSSMBC_slha<Model>::THDMIIMSSMBC_slha(const Model& model_,
...
template <class Model>
void THDMIIMSSMBC_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void THDMIIMSSMBC_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void THDMIIMSSMBC_slha<Model>::convert_to_slha()
{
...
template <class Model>
void THDMIIMSSMBC_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void THDMIIMSSMBC_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void THDMIIMSSMBC_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDMIIMSSMBC_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDMIIMSSMBC_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const THDMIIMSSMBC_physical& THDMIIMSSMBC_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
THDMIIMSSMBC_physical& THDMIIMSSMBC_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void THDMIIMSSMBC_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void THDMIIMSSMBC_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const THDMIIMSSMBC_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
