...
// File generated at Mon 27 Feb 2017 13:23:59
 ...
 */
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda6_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda6_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda6 = Re(twoLoop*(-132*Lambda1*Lambda3*Lambda6 - 36*Lambda2*
      ...
      *Lambda6 - 111*Power(Lambda6,3) - 0.375*Power(g2,4)*(47*Lambda6 - 30*
      ...
      *Lambda7 - 20*Lambda1*Lambda5*Lambda7 - 20*Lambda2*Lambda5*Lambda7 - 40*
      ...
      ) + 0.045*Power(g1,4)*(187*Lambda6 + 30*Lambda7) - 144*Lambda1*Lambda6*
 ...
 */
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda6_three_loop(const Susy_traces& susy_traces) const
{
