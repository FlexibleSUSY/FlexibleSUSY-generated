...
// File generated at Wed 29 Jun 2016 11:21:14
...
Eigen::Matrix<double,3,3> THDMIIMSSMBC_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yd = (twoLoop*(Yd*(-0.18833333333333332*Power(g1,4) - 5.25*Power(
      ...
      Lambda5) + 4.5*Sqr(Lambda6) + 1.5*Sqr(Lambda7)) + 0.004166666666666667*(3
      *(-960*Lambda1 - 540*traceYdAdjYd - 180*traceYeAdjYe + 187*Sqr(g1) + 675*
      Sqr(g2) + 1280*Sqr(g3))*(Yd*Yd.adjoint()*Yd) + (-540*traceYuAdjYu - 53*
      Sqr(g1) + 5*(-96*Lambda3 + 96*Lambda4 + 99*Sqr(g2) + 256*Sqr(g3)))*(Yd*
      Yu.adjoint()*Yu) + 60*(6*(Yd*Yd.adjoint()*Yd*Yd.adjoint()*Yd) - Yd*
      Yu.adjoint()*Yu*Yd.adjoint()*Yd - Yd*Yu.adjoint()*Yu*Yu.adjoint()*Yu))))
      .real();
