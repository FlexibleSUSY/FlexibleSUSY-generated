...
// File generated at Wed 29 Jun 2016 11:21:13
...
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda2_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda2 = Re(twoLoop*(-1.7685*Power(g1,6) + 18.1875*Power(g2,6) +
      9.765*Power(g1,4)*Lambda2 - 6.375*Power(g2,4)*Lambda2 - 312*Power(
      ...
      traceYuAdjYuYuAdjYu + 30*traceYuAdjYuYuAdjYuYuAdjYu - 3.7875*Power(g2,4)*
      Sqr(g1) + 2.4*Lambda3*Lambda4*Sqr(g1) + 8.5*Lambda2*traceYuAdjYu*Sqr(g1)
      - 1.6*traceYuAdjYuYuAdjYu*Sqr(g1) - 4.2975*Power(g1,4)*Sqr(g2) + 12*
