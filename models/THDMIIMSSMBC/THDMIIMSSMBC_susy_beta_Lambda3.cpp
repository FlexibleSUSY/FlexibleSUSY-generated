...
// File generated at Tue 10 Oct 2017 21:12:29
...
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda3_2_loop(const Susy_traces& susy_traces) const
{
   ...
   const double beta_Lambda3_1 = Re(-0.001*twoLoop*(3537*Power6(g1) - 45*
      Quad(g1)*(60*Lambda1 + 60*Lambda2 + 197*Lambda3 + 20*Lambda4 + 10*
      traceYdAdjYd - 50*traceYeAdjYe + 101*Sqr(g2)) - 25*Sqr(g1)*(33*Quad(g2) -
      ...
      Lambda7))) - 125*(291*Power6(g2) + 3*(60*Lambda1 + 60*Lambda2 - 37*
      Lambda3 + 20*Lambda4 - 6*traceYdAdjYd - 2*traceYeAdjYe)*Quad(g2) + 6*Sqr(
      g2)*(-16*Lambda3*Lambda4 + 48*Lambda1*(2*Lambda3 + Lambda4) + 48*Lambda2*
