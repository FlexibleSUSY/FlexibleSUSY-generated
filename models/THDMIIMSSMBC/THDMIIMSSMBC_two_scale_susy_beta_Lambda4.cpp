...
// File generated at Tue 12 Jul 2016 10:31:00
...
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda4_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(twoLoop*(7.065*Power(g1,4)*Lambda4 - 28.875*Power(g2
      ...
      *Lambda4*traceYuAdjYu - 24*Lambda3*Lambda4*traceYuAdjYu - 12*Lambda6*
      Lambda7*traceYuAdjYu - 13.5*Lambda4*traceYuAdjYuYuAdjYu - 8.4*Power(g2,4)
      *Sqr(g1) + 4.8*Lambda1*Lambda4*Sqr(g1) + 4.8*Lambda2*Lambda4*Sqr(g1) +
      2.4*Lambda3*Lambda4*Sqr(g1) + 4.8*Lambda6*Lambda7*Sqr(g1) + 0.8*
      traceYdAdjYuYuAdjYd*Sqr(g1) + 4.25*Lambda4*traceYuAdjYu*Sqr(g1) - 13.14*
