...
template<>
struct is_vector<THDMIIMSSMBC_cxx_diagrams::fields::VG > : public std::true_type {};
template<>
struct is_ghost<THDMIIMSSMBC_cxx_diagrams::fields::gG > : public std::true_type {};
template<>
struct is_fermion<THDMIIMSSMBC_cxx_diagrams::fields::Fv > : public std::true_type {};
template<>
struct is_vector<THDMIIMSSMBC_cxx_diagrams::fields::VP > : public std::true_type {};
template<>
struct is_vector<THDMIIMSSMBC_cxx_diagrams::fields::VZ > : public std::true_type {};
template<>
struct is_ghost<THDMIIMSSMBC_cxx_diagrams::fields::gP > : public std::true_type {};
template<>
struct is_ghost<THDMIIMSSMBC_cxx_diagrams::fields::gZ > : public std::true_type {};
template<>
struct is_ghost<THDMIIMSSMBC_cxx_diagrams::fields::gWm > : public std::true_type {};
template<>
struct is_ghost<THDMIIMSSMBC_cxx_diagrams::fields::gWmC > : public std::true_type {};
template<>
struct is_scalar<THDMIIMSSMBC_cxx_diagrams::fields::hh > : public std::true_type {};
template<>
struct is_scalar<THDMIIMSSMBC_cxx_diagrams::fields::Ah > : public std::true_type {};
template<>
struct is_scalar<THDMIIMSSMBC_cxx_diagrams::fields::Hm > : public std::true_type {};
template<>
struct is_fermion<THDMIIMSSMBC_cxx_diagrams::fields::Fd > : public std::true_type {};
template<>
struct is_fermion<THDMIIMSSMBC_cxx_diagrams::fields::Fu > : public std::true_type {};
template<>
struct is_fermion<THDMIIMSSMBC_cxx_diagrams::fields::Fe > : public std::true_type {};
template<>
struct is_vector<THDMIIMSSMBC_cxx_diagrams::fields::VWm > : public std::true_type {};
