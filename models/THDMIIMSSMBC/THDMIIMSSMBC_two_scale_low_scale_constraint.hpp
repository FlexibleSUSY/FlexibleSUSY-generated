...
template<>
class THDMIIMSSMBC_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   THDMIIMSSMBC_low_scale_constraint();
   THDMIIMSSMBC_low_scale_constraint(THDMIIMSSMBC<Two_scale>*, const softsusy::QedQcd&);
   virtual ~THDMIIMSSMBC_low_scale_constraint();
   virtual void apply();
