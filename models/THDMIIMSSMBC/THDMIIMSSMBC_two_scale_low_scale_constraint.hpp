...
#ifndef THDMIIMSSMBC_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define THDMIIMSSMBC_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "THDMIIMSSMBC_low_scale_constraint.hpp"
...
template<>
class THDMIIMSSMBC_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "THDMIIMSSMBC low-scale constraint"; }
