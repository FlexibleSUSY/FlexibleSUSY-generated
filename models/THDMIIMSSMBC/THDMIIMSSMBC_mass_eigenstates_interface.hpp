...
/**
 * @file THDMIIMSSMBC_mass_eigenstates_interface.hpp
 *
...
#ifndef THDMIIMSSMBC_MASS_EIGENSTATES_INTERFACE_H
#define THDMIIMSSMBC_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class THDMIIMSSMBC_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class THDMIIMSSMBC_mass_eigenstates_interface {
public:
   virtual ~THDMIIMSSMBC_mass_eigenstates_interface() {}

   virtual std::unique_ptr<THDMIIMSSMBC_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const THDMIIMSSMBC_input_parameters& get_input_parameters() const = 0;
   virtual THDMIIMSSMBC_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const THDMIIMSSMBC_physical& get_physical() const = 0;
   virtual THDMIIMSSMBC_physical& get_physical() = 0;
   ...
   virtual void set_physical(const THDMIIMSSMBC_physical&) = 0;
