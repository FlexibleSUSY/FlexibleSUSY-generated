...
THDMIIMSSMBC_initial_guesser<Two_scale>::THDMIIMSSMBC_initial_guesser(
   THDMIIMSSMBC<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const THDMIIMSSMBC_low_scale_constraint<Two_scale>& low_constraint_,
   const THDMIIMSSMBC_susy_scale_constraint<Two_scale>& susy_constraint_,
   const THDMIIMSSMBC_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "THDMIIMSSMBC_initial_guesser: Error: pointer to model"
          " THDMIIMSSMBC<Two_scale> must not be zero");
}
 ...
 */
void THDMIIMSSMBC_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void THDMIIMSSMBC_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void THDMIIMSSMBC_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void THDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void THDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void THDMIIMSSMBC_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void THDMIIMSSMBC_initial_guesser<Two_scale>::guess_soft_parameters()
{
