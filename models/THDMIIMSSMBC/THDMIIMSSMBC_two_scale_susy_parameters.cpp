...
#define CLASSNAME THDMIIMSSMBC_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES() calc_susy_traces(TRACE_STRUCT);

const int THDMIIMSSMBC_susy_parameters::numberOfParameters;

THDMIIMSSMBC_susy_parameters::THDMIIMSSMBC_susy_parameters(const THDMIIMSSMBC_input_parameters& input_)
   : Beta_function()
...
Eigen::ArrayXd THDMIIMSSMBC_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

THDMIIMSSMBC_susy_parameters THDMIIMSSMBC_susy_parameters::calc_beta() const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return THDMIIMSSMBC_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
...
THDMIIMSSMBC_susy_parameters THDMIIMSSMBC_susy_parameters::calc_beta(unsigned loops) const
{
   THDMIIMSSMBC_susy_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void THDMIIMSSMBC_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd THDMIIMSSMBC_susy_parameters::get() const
{
...
void THDMIIMSSMBC_susy_parameters::print(std::ostream& ostr) const
{
...
void THDMIIMSSMBC_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const THDMIIMSSMBC_input_parameters& THDMIIMSSMBC_susy_parameters::get_input() const
{
   return input;
}

THDMIIMSSMBC_input_parameters& THDMIIMSSMBC_susy_parameters::get_input()
{
   return input;
}

void THDMIIMSSMBC_susy_parameters::set_input_parameters(const THDMIIMSSMBC_input_parameters& input_)
{
   input = input_;
}

void THDMIIMSSMBC_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const THDMIIMSSMBC_susy_parameters& susy_pars)
{
