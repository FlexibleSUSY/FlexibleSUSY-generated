...
class THDMIIMSSMBC_observables;
...
template <class Scalar, int M, int N>
std::valarray<double> THDMIIMSSMBC_spectrum_plotter::to_valarray(const Eigen::Array<Scalar, M, N>& v)
{
...
void to_database(
   ...
   const THDMIIMSSMBC_observables* observables = 0);
...
THDMIIMSSMBC_mass_eigenstates from_database(
   ...
   THDMIIMSSMBC_observables* observables = 0);
