...
public:
   ...
   void set_extra(const THDMIIMSSMBC_slha&, const THDMIIMSSMBC_scales&, const THDMIIMSSMBC_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const THDMIIMSSMBC_scales&, const THDMIIMSSMBC_observables&);
