...
struct THDMIIMSSMBC_physical;
class THDMIIMSSMBC_slha;
...
public:
   ...
   void fill(THDMIIMSSMBC_slha&) const;
   ...
   void set_extra(const THDMIIMSSMBC_slha&, const THDMIIMSSMBC_scales&, const THDMIIMSSMBC_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const THDMIIMSSMBC_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const THDMIIMSSMBC_scales&, const THDMIIMSSMBC_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, THDMIIMSSMBC_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const THDMIIMSSMBC_slha&);
 ...
 */
template <class... Ts>
void THDMIIMSSMBC_slha_io::fill(
   ...
   THDMIIMSSMBC_decays const * const decays)
{
