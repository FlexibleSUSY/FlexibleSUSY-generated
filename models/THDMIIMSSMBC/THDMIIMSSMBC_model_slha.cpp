...
THDMIIMSSMBC_slha::THDMIIMSSMBC_slha(const THDMIIMSSMBC_input_parameters& input_,
 ...
 */
THDMIIMSSMBC_slha::THDMIIMSSMBC_slha(const THDMIIMSSMBC_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : THDMIIMSSMBC_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void THDMIIMSSMBC_slha::clear()
{
   THDMIIMSSMBC_mass_eigenstates::clear();
   physical_slha.clear();
}

void THDMIIMSSMBC_slha::calculate_spectrum()
{
   THDMIIMSSMBC_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void THDMIIMSSMBC_slha::convert_to_slha()
{
...
void THDMIIMSSMBC_slha::calculate_ckm_matrix()
{
...
void THDMIIMSSMBC_slha::calculate_pmns_matrix()
{
 ...
 */
void THDMIIMSSMBC_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void THDMIIMSSMBC_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void THDMIIMSSMBC_slha::convert_soft_squared_masses_to_slha()
{

}

const THDMIIMSSMBC_physical& THDMIIMSSMBC_slha::get_physical_slha() const
{
   return physical_slha;
}

THDMIIMSSMBC_physical& THDMIIMSSMBC_slha::get_physical_slha()
{
   return physical_slha;
}

void THDMIIMSSMBC_slha::print(std::ostream& ostr) const
{
   THDMIIMSSMBC_mass_eigenstates::print(ostr);
...
void THDMIIMSSMBC_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const THDMIIMSSMBC_slha& model)
{
   model.print(ostr);
   return ostr;
}
