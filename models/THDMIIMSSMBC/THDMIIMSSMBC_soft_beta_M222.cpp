...
// File generated at Sun 26 Aug 2018 14:08:53
...
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(twoLoop*(-8*Lambda3*Lambda4*M112 + 6*Lambda5*Lambda6*M122 +
      ...
      )*Conj(M122)) + 0.9*M112*Quad(g1) + 4.3425*M222*Quad(g1) + 7.5*M112*Quad(
      g2) - 7.6875*M222*Quad(g2) + 4.8*Lambda3*M112*Sqr(g1) + 2.4*Lambda4*M112*
