 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(0.0025*(-3200*Lambda3*Lambda4*M112 + 1800*Lambda5*Lambda6*
      M122 + 4200*Lambda5*Lambda7*M122 - 800*Lambda3*Lambda4*M222 - 9600*
      Lambda3*M112*traceYdAdjYd - 4800*Lambda4*M112*traceYdAdjYd - 1800*M222*
      traceYdAdjYuYuAdjYd - 3200*Lambda3*M112*traceYeAdjYe - 1600*Lambda4*M112*
      traceYeAdjYe - 28800*Lambda2*M222*traceYuAdjYu - 5400*M222*
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
