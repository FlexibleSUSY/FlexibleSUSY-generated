...
THDMIIMSSMBC_INCLUDE_MK += $(DIR)/two_scale.mk

LIBTHDMIIMSSMBC_SRC += \
		$(DIR)/THDMIIMSSMBC_two_scale_convergence_tester.cpp \
		$(DIR)/THDMIIMSSMBC_two_scale_ewsb_solver.cpp \
...
LIBTHDMIIMSSMBC_HDR += \
		...
		$(DIR)/THDMIIMSSMBC_two_scale_spectrum_generator.hpp \
