...
// File generated at Tue 10 Oct 2017 21:16:59
...
#include "THDMIIMSSMBC_weinberg_angle.hpp"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
double THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();

   double theta_w = std::asin(Electroweak_constants::sinThetaW);

   THDMIIMSSMBC_weinberg_angle::Sm_parameters sm_pars;
   ...
   THDMIIMSSMBC_weinberg_angle weinberg(MODEL, sm_pars);
...
double THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("THDMIIMSSMBC_low_scale_constraint<Two_scale>: "
