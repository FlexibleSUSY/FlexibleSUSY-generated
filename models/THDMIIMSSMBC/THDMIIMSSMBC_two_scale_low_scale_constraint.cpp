...
// File generated at Wed 29 Jun 2016 11:21:23
...
THDMIIMSSMBC_low_scale_constraint<Two_scale>::THDMIIMSSMBC_low_scale_constraint()
...
THDMIIMSSMBC_low_scale_constraint<Two_scale>::THDMIIMSSMBC_low_scale_constraint(
   THDMIIMSSMBC<Two_scale>* model_, const softsusy::QedQcd& qedqcd_)
   : Constraint<Two_scale>()
   , model(model_)
   , qedqcd(qedqcd_)
   , new_g1(0.)
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::apply()
{
   assert(model && "Error: THDMIIMSSMBC_low_scale_constraint::apply():"
...
const Eigen::Matrix<std::complex<double>,3,3>& THDMIIMSSMBC_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& THDMIIMSSMBC_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double THDMIIMSSMBC_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double THDMIIMSSMBC_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void THDMIIMSSMBC_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
   model = cast_model<THDMIIMSSMBC<Two_scale>*>(model_);
}

void THDMIIMSSMBC_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& THDMIIMSSMBC_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void THDMIIMSSMBC_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::initialize()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::update_scale()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
...
double THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
double THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_delta_alpha_em(double alphaEm) const
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
   ...
   const double delta_alpha_em = -0.05305164769729845*alphaEm*FiniteLog(Abs(MHm
      (1)/currentScale));
...
double THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_Yu_DRbar()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_Ye_DRbar()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
...
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::calculate_MNeutrino_DRbar()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
 ...
 */
void THDMIIMSSMBC_low_scale_constraint<Two_scale>::recalculate_mw_pole()
{
   assert(model && "THDMIIMSSMBC_low_scale_constraint<Two_scale>::"
   ...
   if (mw_pole_sqr < 0.)
      MODEL->get_problems().flag_tachyon(THDMIIMSSMBC_info::VWm);
