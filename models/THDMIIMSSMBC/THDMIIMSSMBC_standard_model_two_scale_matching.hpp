...
#ifndef THDMIIMSSMBC_TWO_SCALE_MATCHING_H
#define THDMIIMSSMBC_TWO_SCALE_MATCHING_H
...
template <class T> class THDMIIMSSMBC;
template <class T> class THDMIIMSSMBC_standard_model_Matching;
...
template<>
class THDMIIMSSMBC_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   THDMIIMSSMBC_standard_model_Matching();

   THDMIIMSSMBC_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       THDMIIMSSMBC<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~THDMIIMSSMBC_standard_model_Matching();
