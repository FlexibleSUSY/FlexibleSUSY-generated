...
int run_solver(const THDMIIMSSMBC_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(THDMIIMSSMBC_slha_io::fill_slhaea(
...
int run(int solver_type, const THDMIIMSSMBC_input_parameters& input)
{
   int exit_code = 0;
