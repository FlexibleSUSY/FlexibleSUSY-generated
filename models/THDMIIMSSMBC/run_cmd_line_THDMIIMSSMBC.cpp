...
int run_solver(int loop_library, const THDMIIMSSMBC_input_parameters& input)
{
...
int run(int solver_type, int loop_library, const THDMIIMSSMBC_input_parameters& input)
{
   int exit_code = 0;
