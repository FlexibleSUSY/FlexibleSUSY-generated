...
// File generated at Wed 29 Jun 2016 11:21:17
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M122_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M122_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_M122 = Re(twoLoop*(36*Lambda1*Lambda6*M112 + 12*Lambda3*Lambda6*
      ...
      Lambda7*M112 + 6*Lambda4*Lambda7*M112 + 6*Lambda5*Lambda7*M112 + 3.4425*
      Power(g1,4)*M122 - 15.1875*Power(g2,4)*M122 - 12*Lambda1*Lambda3*M122 -
 ...
 */
double THDMIIMSSMBC_soft_parameters::calc_beta_M122_three_loop(const Soft_traces& soft_traces) const
{
