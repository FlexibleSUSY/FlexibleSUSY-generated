...
/**
 * @file THDMIIMSSMBC_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Sat 27 Aug 2016 11:44:10

#ifndef THDMIIMSSMBC_TWO_SCALE_SLHA_H
#define THDMIIMSSMBC_TWO_SCALE_SLHA_H
...
/**
 * @class THDMIIMSSMBC_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class THDMIIMSSMBC_slha<Two_scale> : public THDMIIMSSMBC<Two_scale> {
public:
   explicit THDMIIMSSMBC_slha(const THDMIIMSSMBC_input_parameters& input_ = THDMIIMSSMBC_input_parameters());
   explicit THDMIIMSSMBC_slha(const THDMIIMSSMBC<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~THDMIIMSSMBC_slha();
