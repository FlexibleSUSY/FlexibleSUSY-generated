...
// File generated at Wed 12 Apr 2017 11:15:52
...
double THDMIIMSSMBC_soft_parameters::calc_beta_M222_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M222 = Re(twoLoop*(-8*Lambda3*Lambda4*M112 + 12*Lambda3*Lambda6*
      ...
      Lambda5*Lambda7*M122 + 0.1875*Power(g2,4)*(40*M112 - 41*M222) - 2*Lambda3
      *Lambda4*M222 + 0.0225*Power(g1,4)*(40*M112 + 193*M222) - 24*Lambda3*M112
      ...
      *(192*Lambda3*M112 + 96*Lambda4*M112 - 576*Lambda7*M122 + 576*Lambda2*
      ...
      Sqr(Lambda7) - 27*M222*Sqr(Lambda7)));
