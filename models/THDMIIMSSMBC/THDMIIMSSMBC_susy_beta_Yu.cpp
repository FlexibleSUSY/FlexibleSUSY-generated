...
// File generated at Wed 16 Oct 2019 21:23:55
...
Eigen::Matrix<double,3,3> THDMIIMSSMBC_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (twoLoop*(0.0016666666666666668*Yu*(600*Lambda3*Lambda4 - 1350*
      ...
      900*AbsSqr(Lambda6) + 2700*AbsSqr(Lambda7) + 1267*Quad(g1) - 3150*Quad(g2
 ...
 */
Eigen::Matrix<double,3,3> THDMIIMSSMBC_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> THDMIIMSSMBC_susy_parameters::calc_beta_Yu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
