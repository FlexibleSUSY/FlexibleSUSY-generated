...
// File generated at Fri 20 Oct 2017 08:38:21

/**
 * @file THDMIIMSSMBC_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 08:38:21 with FlexibleSUSY
...
#include "THDMIIMSSMBC_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(THDMIIMSSMBC_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const THDMIIMSSMBC_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("THDMIIMSSMBC_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double THDMIIMSSMBC_a_muon::calculate_a_muon(const THDMIIMSSMBC_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("THDMIIMSSMBC_a_muon:" << e.what());
...
double THDMIIMSSMBC_a_muon::calculate_a_muon_uncertainty(const THDMIIMSSMBC_mass_eigenstates& model_)
{
   THDMIIMSSMBC_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("THDMIIMSSMBC_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
