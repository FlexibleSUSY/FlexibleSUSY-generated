...
#ifndef THDMIIMSSMBC_TWO_SCALE_INITIAL_GUESSER_H
#define THDMIIMSSMBC_TWO_SCALE_INITIAL_GUESSER_H

#include "THDMIIMSSMBC_initial_guesser.hpp"
...
/**
 * @class THDMIIMSSMBC_initial_guesser<Two_scale>
 * @brief initial guesser for the THDMIIMSSMBC
 */

template<>
class THDMIIMSSMBC_initial_guesser<Two_scale> : public Initial_guesser {
public:
   THDMIIMSSMBC_initial_guesser(THDMIIMSSMBC<Two_scale>*,
                               const softsusy::QedQcd&,
                               const THDMIIMSSMBC_low_scale_constraint<Two_scale>&,
                               const THDMIIMSSMBC_susy_scale_constraint<Two_scale>&,
                               const THDMIIMSSMBC_high_scale_constraint<Two_scale>&);
   virtual ~THDMIIMSSMBC_initial_guesser() = default;
...
private:
   THDMIIMSSMBC<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   THDMIIMSSMBC_low_scale_constraint<Two_scale> low_constraint{};
   THDMIIMSSMBC_susy_scale_constraint<Two_scale> susy_constraint{};
   THDMIIMSSMBC_high_scale_constraint<Two_scale> high_constraint{};
