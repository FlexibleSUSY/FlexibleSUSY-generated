...
// File generated at Mon 19 Sep 2016 09:50:47
...
THDMIIMSSMBC_spectrum_plotter::THDMIIMSSMBC_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
void THDMIIMSSMBC_spectrum_plotter::extract_spectrum(const THDMIIMSSMBC_mass_eigenstates& model)
{
   ...
   spectrum.push_back(TParticle("Hm", "H^-", to_valarray(PHYSICAL(MHm))));
...
std::valarray<double> THDMIIMSSMBC_spectrum_plotter::to_valarray(double v)
{
   ...
   const THDMIIMSSMBC_observables* observables)
{
   ...
   append(names, THDMIIMSSMBC_parameter_getter().get_mass_names());
   append(names, THDMIIMSSMBC_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, THDMIIMSSMBC_observables* observables)
{
   ...
   const std::size_t number_of_masses = THDMIIMSSMBC_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = THDMIIMSSMBC_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = THDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? THDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES : 0u);
