...
// THDMIIMSSMBC_parameter_getter ////////////////////////////////////////

std::vector<std::string> THDMIIMSSMBC_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_MIXINGS> THDMIIMSSMBC_parameter_getter::get_mixing_names()
{
   return THDMIIMSSMBC_info::particle_mixing_names;
}

Eigen::ArrayXd THDMIIMSSMBC_parameter_getter::get_parameters(const THDMIIMSSMBC_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_PARAMETERS> THDMIIMSSMBC_parameter_getter::get_parameter_names()
{
   return THDMIIMSSMBC_info::parameter_names;
}

std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_PARTICLES> THDMIIMSSMBC_parameter_getter::get_particle_names()
{
   return THDMIIMSSMBC_info::particle_names;
}

std::vector<std::string> THDMIIMSSMBC_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> THDMIIMSSMBC_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_MIXINGS> THDMIIMSSMBC_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_MIXINGS> THDMIIMSSMBC_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS> THDMIIMSSMBC_parameter_getter::get_input_parameter_names()
{
   return THDMIIMSSMBC_info::input_parameter_names;
}

std::array<std::string, THDMIIMSSMBC_info::NUMBER_OF_EXTRA_PARAMETERS> THDMIIMSSMBC_parameter_getter::get_extra_parameter_names()
{
   return THDMIIMSSMBC_info::extra_parameter_names;
}

decltype(THDMIIMSSMBC_info::NUMBER_OF_MASSES) THDMIIMSSMBC_parameter_getter::get_number_of_masses()
{
   return THDMIIMSSMBC_info::NUMBER_OF_MASSES;
}

// THDMIIMSSMBC_spectrum_plotter ////////////////////////////////////////

THDMIIMSSMBC_spectrum_plotter::THDMIIMSSMBC_spectrum_plotter(const THDMIIMSSMBC_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void THDMIIMSSMBC_spectrum_plotter::extract_spectrum(const THDMIIMSSMBC_mass_eigenstates& model)
{
   spectrum.clear();
   ...
   spectrum.emplace_back(TParticle("Hm", "H^-", to_valarray(PHYSICAL(MHm))));
...
void THDMIIMSSMBC_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("THDMIIMSSMBC_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("THDMIIMSSMBC_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("THDMIIMSSMBC_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void THDMIIMSSMBC_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("THDMIIMSSMBC_spectrum_plotter::write_spectrum: "
...
namespace THDMIIMSSMBC_database {
 ...
 */
void to_database(
   const std::string& file_name, const THDMIIMSSMBC_mass_eigenstates& model,
   ...
   const THDMIIMSSMBC_observables* observables)
{
   ...
   append(names, THDMIIMSSMBC_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, THDMIIMSSMBC_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, THDMIIMSSMBC_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, THDMIIMSSMBC_parameter_getter::get_DRbar_mass_names());
   append(names, THDMIIMSSMBC_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, THDMIIMSSMBC_parameter_getter::get_pole_mass_names());
   append(names, THDMIIMSSMBC_parameter_getter::get_pole_mixing_names());
   ...
   if (THDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, THDMIIMSSMBC_observables::get_names());
 ...
 */
THDMIIMSSMBC_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, THDMIIMSSMBC_observables* observables)
{
   THDMIIMSSMBC_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = THDMIIMSSMBC_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = THDMIIMSSMBC_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = THDMIIMSSMBC_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = THDMIIMSSMBC_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? THDMIIMSSMBC_observables::NUMBER_OF_OBSERVABLES : 0);
