...
THDMIIMSSMBC_physical::THDMIIMSSMBC_physical()
   :
...
void THDMIIMSSMBC_physical::clear()
{
   MVG = 0.;
 ...
 * to be complex.
 */
void THDMIIMSSMBC_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void THDMIIMSSMBC_physical::convert_to_slha()
{

}

Eigen::ArrayXd THDMIIMSSMBC_physical::get() const
{
...
void THDMIIMSSMBC_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd THDMIIMSSMBC_physical::get_masses() const
{
...
void THDMIIMSSMBC_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MFv(0) = pars(1);
   MFv(1) = pars(2);
...
void THDMIIMSSMBC_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const THDMIIMSSMBC_physical& phys_pars)
{
