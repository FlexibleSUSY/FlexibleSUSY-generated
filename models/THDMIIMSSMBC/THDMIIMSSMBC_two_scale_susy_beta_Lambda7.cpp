...
// File generated at Wed 12 Apr 2017 11:15:40
 ...
 */
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda7_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda7_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda7 = Re(twoLoop*(-36*Lambda1*Lambda3*Lambda6 - 36*Lambda2*
      ...
      - 42*Power(Lambda6,3) + 0.375*Power(g2,4)*(30*Lambda6 - 47*Lambda7) - 36
      *Lambda1*Lambda3*Lambda7 - 132*Lambda2*Lambda3*Lambda7 - 28*Lambda1*
      ...
      Lambda3*Lambda5*Lambda7 - 76*Lambda4*Lambda5*Lambda7 - 111*Power(Lambda7,
      3) + 0.045*Power(g1,4)*(30*Lambda6 + 187*Lambda7) - 36*Lambda3*Lambda6*
      ...
      *traceYeAdjYe - 8*Lambda4*Lambda6*traceYeAdjYe - 4*Lambda5*Lambda6*
      ...
      Lambda7*traceYuAdjYu - 8.25*Lambda7*traceYuAdjYuYuAdjYu + 0.375*(48*
      Lambda3*(2*Lambda6 + Lambda7) + 48*Lambda4*(Lambda6 + 2*Lambda7) +
      Lambda7*(288*Lambda2 + 144*Lambda5 + 5*(3*traceYdAdjYd + traceYeAdjYe + 9
      *traceYuAdjYu)))*Sqr(g2) + 0.025*Sqr(g1)*(192*Lambda4*Lambda6 - 48*
      Lambda5*Lambda6 + 864*Lambda2*Lambda7 + 240*Lambda4*Lambda7 + 480*Lambda5
      *Lambda7 + 144*Lambda3*(2*Lambda6 + Lambda7) + 25*Lambda7*traceYdAdjYd +
      75*Lambda7*traceYeAdjYe + 255*Lambda7*traceYuAdjYu + 6*(10*Lambda6 + 29*
      Lambda7)*Sqr(g2)) + 20*Lambda7*traceYdAdjYd*Sqr(g3) + 60*Lambda7*
      ...
      Lambda4) - 34*Lambda7*Sqr(Lambda4) - 42*Lambda6*Sqr(Lambda5) - 36*Lambda7
      *Sqr(Lambda5) - 33*Lambda7*Sqr(Lambda6) - 126*Lambda6*Sqr(Lambda7)));
 ...
 */
double THDMIIMSSMBC_susy_parameters::calc_beta_Lambda7_three_loop(const Susy_traces& susy_traces) const
{
