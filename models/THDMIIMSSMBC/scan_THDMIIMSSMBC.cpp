...
{
   std::cout <<
      "Usage: scan_THDMIIMSSMBC.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MSUSY=<value>\n"
      "  --MEWSB=<value>\n"
...
struct THDMIIMSSMBC_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
THDMIIMSSMBC_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   THDMIIMSSMBC_input_parameters& input)
{
   ...
   THDMIIMSSMBC_scan_result result;
...
void scan(int solver_type, THDMIIMSSMBC_input_parameters& input,
