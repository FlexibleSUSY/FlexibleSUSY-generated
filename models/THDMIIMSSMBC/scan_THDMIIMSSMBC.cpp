...
THDMIIMSSMBC_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   THDMIIMSSMBC_input_parameters& input)
{
...
void scan(int solver_type, int loop_library, THDMIIMSSMBC_input_parameters& input,
