...
#ifndef THDMIIMSSMBC_WEINBERG_ANGLE_H
#define THDMIIMSSMBC_WEINBERG_ANGLE_H
...
/**
 * @class THDMIIMSSMBC_weinberg_angle
...
public:
   ...
   THDMIIMSSMBC_weinberg_angle(const THDMIIMSSMBC_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDMIIMSSMBC_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDMIIMSSMBC_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
