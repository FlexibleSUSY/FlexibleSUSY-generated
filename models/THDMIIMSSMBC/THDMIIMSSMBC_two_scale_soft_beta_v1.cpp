...
// File generated at Thu 15 Dec 2016 12:41:39
...
double THDMIIMSSMBC_soft_parameters::calc_beta_v1_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_v1 = Re(0.00125*twoLoop*(-1323*Power(g1,4)*v1 + 10*v1*Sqr(g1)*(
      -86*traceYdAdjYd - 162*traceYeAdjYe + 9*Sqr(g2)) + 25*(321*Power(g2,4)*v1
