...
// File generated at Tue 5 Sep 2017 10:33:48
...
double THDMIIMSSMBC_soft_parameters::calc_beta_v1_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_v1 = Re(0.00125*twoLoop*(-1287*Power(g1,4)*v1 + 10*v1*Sqr(g1)*(-2
      *(61*traceYdAdjYd + 87*traceYeAdjYe) + 45*Sqr(g2)) + 25*(357*Power(g2,4)*
