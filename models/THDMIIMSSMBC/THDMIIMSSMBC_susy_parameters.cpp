...
THDMIIMSSMBC_susy_parameters THDMIIMSSMBC_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return THDMIIMSSMBC_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
void THDMIIMSSMBC_susy_parameters::print() const
{
   this->print(std::cerr);
}
...
THDMIIMSSMBC_susy_parameters::Susy_traces THDMIIMSSMBC_susy_parameters::calc_susy_traces(int loops) const
{
