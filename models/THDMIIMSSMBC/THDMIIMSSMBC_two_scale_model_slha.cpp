 ...
 * @brief THDMIIMSSMBC model class wrapper for SLHA conversion
 */
...
#define CLASSNAME THDMIIMSSMBC_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::THDMIIMSSMBC_slha(const THDMIIMSSMBC_input_parameters& input_)
   : THDMIIMSSMBC<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::THDMIIMSSMBC_slha(const THDMIIMSSMBC<Two_scale>& model_,
...
CLASSNAME::~THDMIIMSSMBC_slha()
{
}

void CLASSNAME::clear()
{
   THDMIIMSSMBC<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   THDMIIMSSMBC<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const THDMIIMSSMBC_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

THDMIIMSSMBC_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   THDMIIMSSMBC<Two_scale>::print(ostr);
