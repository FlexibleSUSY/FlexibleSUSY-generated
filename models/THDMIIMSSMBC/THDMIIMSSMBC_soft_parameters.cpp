...
// File generated at Fri 20 Oct 2017 08:37:30
...
THDMIIMSSMBC_soft_parameters THDMIIMSSMBC_soft_parameters::calc_beta(int loops) const
{
   double beta_M122 = 0.;
   double beta_M112 = 0.;
   double beta_M222 = 0.;
   ...
   const THDMIIMSSMBC_susy_parameters susy_betas(THDMIIMSSMBC_susy_parameters::calc_beta(loops));
...
THDMIIMSSMBC_soft_parameters::Soft_traces THDMIIMSSMBC_soft_parameters::calc_soft_traces(int loops) const
{
