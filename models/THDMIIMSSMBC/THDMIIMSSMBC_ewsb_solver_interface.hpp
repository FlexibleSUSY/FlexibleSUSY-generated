...
class THDMIIMSSMBC_ewsb_solver_interface {
public:
   virtual ~THDMIIMSSMBC_ewsb_solver_interface() {}
   ...
   virtual int solve(THDMIIMSSMBC_mass_eigenstates&) = 0;
};
