...
void THDMIIMSSMBC_high_scale_constraint<Two_scale>::apply()
{
   ...
   MODEL->set_Lambda2(Re(0.5*(0.25*(0.6*Sqr(g1) + Sqr(g2)) +
      ...
      ))*Sqr(g3)*UnitStep(-2 + LambdaLoopOrder) + ((-0.0031662869888230555*Quad(
      MuInput)*Quad(Yd(2,2)))/Quad(MSUSY) - (0.0010554289962743518*Quad(MuInput)*
      Quad(Ye(2,2)))/Quad(MSUSY) + (0.037995443865876666*Quad(Yu(2,2))*Sqr(AtInput
      )*(1 - (0.08333333333333333*Sqr(AtInput))/Sqr(MSUSY)))/Sqr(MSUSY) -
   ...
   MODEL->set_Lambda3(Re(0.25*(-0.6*Sqr(g1) + Sqr(g2)) + (
      ...
      g3)*Sqr(MuInput)*UnitStep(-2 + LambdaLoopOrder))/Cube(MSUSY) + ((
      ...
      /Sqr(MSUSY)))*Sqr(MuInput))/Sqr(MSUSY) + 0.0031662869888230555*(3*Sqr(
      AbInput/MSUSY + AtInput/MSUSY) - (6*Sqr(MuInput))/Sqr(MSUSY) - Sqr(-((
      AbInput*AtInput)/Sqr(MSUSY)) + Sqr(MuInput)/Sqr(MSUSY)))*Sqr(Yd(2,2))*Sqr(Yu
      (2,2)) - 0.0007915717472057639*(-0.6*Sqr(g1) + Sqr(g2))*(3*(Sqr(AbInput)/Sqr
      (MSUSY) - Sqr(MuInput)/Sqr(MSUSY))*Sqr(Yd(2,2)) + (Sqr(AtauInput)/Sqr(MSUSY)
      - Sqr(MuInput)/Sqr(MSUSY))*Sqr(Ye(2,2)) + 3*(Sqr(AtInput)/Sqr(MSUSY) - Sqr(
      MuInput)/Sqr(MSUSY))*Sqr(Yu(2,2))) - 0.00026385724906858796*(-0.6*Sqr(g1) +
      ...
      Sqr(AtInput)/Sqr(MSUSY) + Sqr(MuInput)/Sqr(MSUSY))*Sqr(Yu(2,2))))*UnitStep(
      -1 + LambdaLoopOrder)));
   MODEL->set_Lambda4(Re(-0.5*Sqr(g2) + (0.00016040597272944275*AtInput*(1 - (
      0.5*AtInput)/MSUSY)*Quad(Yu(2,2))*Sqr(g3)*Sqr(MuInput)*UnitStep(-2 +
   ...
   MODEL->set_Lambda5(Re((0.00016040597272944275*AtInput*(1 - (0.5*AtInput)
      /MSUSY)*Quad(Yu(2,2))*Sqr(g3)*Sqr(MuInput)*UnitStep(-2 + LambdaLoopOrder))
      /Cube(MSUSY) - (0.0010554289962743518*((3*Quad(Yd(2,2))*Sqr(AbInput))/Sqr(
      MSUSY) + (Quad(Ye(2,2))*Sqr(AtauInput))/Sqr(MSUSY) + (3*Quad(Yu(2,2))*Sqr(
      AtInput))/Sqr(MSUSY))*Sqr(MuInput)*UnitStep(-1 + LambdaLoopOrder))/Sqr(MSUSY
      )));
   ...
   MODEL->set_Lambda7(Re((0.00016040597272944275*MuInput*Quad(Yu(2,2))*Sqr(g3)*
      (2 + (0.3333333333333333*Cube(AtInput))/Cube(MSUSY) - Sqr(AtInput)/Sqr(MSUSY
      ))*UnitStep(-2 + LambdaLoopOrder))/MSUSY + ((0.0010554289962743518*MuInput*(
      (3*AtInput*Quad(Yu(2,2))*(-6 + Sqr(AtInput)/Sqr(MSUSY)))/MSUSY + (3*AbInput*
