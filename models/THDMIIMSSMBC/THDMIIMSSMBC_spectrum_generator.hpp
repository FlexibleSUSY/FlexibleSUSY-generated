                                ...
                                const THDMIIMSSMBC_input_parameters& input)
{
   ...
   THDMIIMSSMBC_high_scale_constraint<T> high_scale_constraint(&model);
   THDMIIMSSMBC_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   THDMIIMSSMBC_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
   ...
   THDMIIMSSMBC_convergence_tester<T> convergence_tester(
