...
/**
 * @file NMSSMtower_two_scale_model_slha.cpp
 * @brief NMSSMtower model class wrapper for SLHA conversion
 */
...
#define CLASSNAME NMSSMtower_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::NMSSMtower_slha(const NMSSMtower_input_parameters& input_)
   : NMSSMtower<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::NMSSMtower_slha(const NMSSMtower<Two_scale>& model_,
...
CLASSNAME::~NMSSMtower_slha()
{
}

void CLASSNAME::clear()
{
   NMSSMtower<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   NMSSMtower<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const NMSSMtower_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

NMSSMtower_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   NMSSMtower<Two_scale>::print(ostr);
