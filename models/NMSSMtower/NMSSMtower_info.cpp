...
namespace NMSSMtower_info {
   ...
   const char* parameter_names[NUMBER_OF_PARAMETERS] = {"Yd(0,0)", "Yd(0,1)",
      ...
      , "Ye(2,1)", "Ye(2,2)", "Lambdax", "Kappa", "Yu(0,0)", "Yu(0,1)", "Yu(0,2)",
      "Yu(1,0)", "Yu(1,1)", "Yu(1,2)", "Yu(2,0)", "Yu(2,1)", "Yu(2,2)", "g1",
      "g2", "g3", "vd", "vu", "vS", "TYd(0,0)", "TYd(0,1)", "TYd(0,2)", "TYd(1,0)"
      , "TYd(1,1)", "TYd(1,2)", "TYd(2,0)", "TYd(2,1)", "TYd(2,2)", "TYe(0,0)",
      "TYe(0,1)", "TYe(0,2)", "TYe(1,0)", "TYe(1,1)", "TYe(1,2)", "TYe(2,0)",
      "TYe(2,1)", "TYe(2,2)", "TLambdax", "TKappa", "TYu(0,0)", "TYu(0,1)",
      ...
      "me2(1,1)", "me2(1,2)", "me2(2,0)", "me2(2,1)", "me2(2,2)", "ms2", "MassB",
      "MassWB", "MassG"};
   ...
   const char* particle_mixing_names[NUMBER_OF_MIXINGS] = {   "ZD(0,0)",
      ...
      , "ZE(5,4)", "ZE(5,5)", "ZH(0,0)", "ZH(0,1)", "ZH(0,2)", "ZH(1,0)",
   ...
   const char* input_parameter_names[NUMBER_OF_INPUT_PARAMETERS] = {"MSUSY",
      "M1Input", "M2Input", "M3Input", "MuInput", "TanBeta", "LambdaInput",
      "KappaInput", "ALambdaInput", "AKappaInput", "mq2Input(0,0)",
      ...
      "mu2Input(2,2)", "md2Input(0,0)", "md2Input(0,1)", "md2Input(0,2)",
      "md2Input(1,0)", "md2Input(1,1)", "md2Input(1,2)", "md2Input(2,0)",
      "md2Input(2,1)", "md2Input(2,2)", "ml2Input(0,0)", "ml2Input(0,1)",
      "ml2Input(0,2)", "ml2Input(1,0)", "ml2Input(1,1)", "ml2Input(1,2)",
      "ml2Input(2,0)", "ml2Input(2,1)", "ml2Input(2,2)", "me2Input(0,0)",
      ...
      "AuInput(2,2)", "AdInput(0,0)", "AdInput(0,1)", "AdInput(0,2)",
      "AdInput(1,0)", "AdInput(1,1)", "AdInput(1,2)", "AdInput(2,0)",
      "AdInput(2,1)", "AdInput(2,2)", "AeInput(0,0)", "AeInput(0,1)",
      "AeInput(0,2)", "AeInput(1,0)", "AeInput(1,1)", "AeInput(1,2)",
      "AeInput(2,0)", "AeInput(2,1)", "AeInput(2,2)"};

   const char* model_name = "NMSSMtower";
