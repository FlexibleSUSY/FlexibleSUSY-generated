...
#ifndef NMSSMtower_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define NMSSMtower_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "NMSSMtower_low_scale_constraint.hpp"
...
template<>
class NMSSMtower_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   NMSSMtower_low_scale_constraint();
   NMSSMtower_low_scale_constraint(NMSSMtower<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NMSSMtower_low_scale_constraint();
   virtual void apply();
