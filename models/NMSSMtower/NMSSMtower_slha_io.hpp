...
// File generated at Mon 19 Sep 2016 09:36:19

#ifndef NMSSMtower_SLHA_IO_H
#define NMSSMtower_SLHA_IO_H
...
struct NMSSMtower_scales {
   NMSSMtower_scales() : HighScale(0.), SUSYScale(0.), LowScale(0.) {}
   double HighScale, SUSYScale, LowScale;
};

class NMSSMtower_slha_io {
public:
   NMSSMtower_slha_io();
   ~NMSSMtower_slha_io() {}
   ...
   void fill(NMSSMtower_input_parameters&) const;
   void fill(NMSSMtower_mass_eigenstates&) const;
   template <class T> void fill(NMSSMtower_slha<T>&) const;
   ...
   void set_extpar(const NMSSMtower_input_parameters&);
   template <class T> void set_extra(const NMSSMtower_slha<T>&, const NMSSMtower_scales&, const NMSSMtower_observables&);
   void set_minpar(const NMSSMtower_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const NMSSMtower_slha<T>&);
   template <class T> void set_spectrum(const NMSSMtower<T>&);
   void set_spinfo(const Problems<NMSSMtower_info::NUMBER_OF_PARTICLES>&);
   void set_print_imaginary_parts_of_majorana_mixings(bool);
   void write_to_file(const std::string&);
   void write_to_stream(std::ostream& ostr = std::cout) { slha_io.write_to_stream(ostr); }

   static void fill_minpar_tuple(NMSSMtower_input_parameters&, int, double);
   static void fill_extpar_tuple(NMSSMtower_input_parameters&, int, double);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const NMSSMtower_slha<T>&, const softsusy::QedQcd&, const NMSSMtower_scales&, const NMSSMtower_observables&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const NMSSMtower_slha<T>&, const softsusy::QedQcd&, const NMSSMtower_scales&, const NMSSMtower_observables&);
...
private:
   ...
   void set_mass(const NMSSMtower_physical&, bool);
   void set_mixing_matrices(const NMSSMtower_physical&, bool);
   template <class T> void set_model_parameters(const NMSSMtower_slha<T>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(NMSSMtower_mass_eigenstates&) const;
   void fill_physical(NMSSMtower_physical&) const;
};
 ...
 */
template <class T>
void NMSSMtower_slha_io::fill(NMSSMtower_slha<T>& model) const
{
   fill(static_cast<NMSSMtower_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class T>
void NMSSMtower_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const NMSSMtower_slha<T>& model,
   const softsusy::QedQcd& qedqcd, const NMSSMtower_scales& scales,
   const NMSSMtower_observables& observables)
{
   NMSSMtower_slha_io slha_io;
   const NMSSMtower_input_parameters& input = model.get_input();
...
template <class T>
SLHAea::Coll NMSSMtower_slha_io::fill_slhaea(
   const NMSSMtower_slha<T>& model, const softsusy::QedQcd& qedqcd,
   const NMSSMtower_scales& scales, const NMSSMtower_observables& observables)
{
   SLHAea::Coll slhaea;
   NMSSMtower_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class T>
void NMSSMtower_slha_io::set_model_parameters(const NMSSMtower_slha<T>& model)
{
   {
 ...
 */
template <class T>
void NMSSMtower_slha_io::set_extra(
   const NMSSMtower_slha<T>& model, const NMSSMtower_scales& scales,
   const NMSSMtower_observables& observables)
{
   const NMSSMtower_physical physical(model.get_physical_slha());
 ...
 */
template <class T>
void NMSSMtower_slha_io::set_spectrum(const NMSSMtower<T>& model)
{
   const NMSSMtower_slha<T> model_slha(model);
 ...
 */
template <class T>
void NMSSMtower_slha_io::set_spectrum(const NMSSMtower_slha<T>& model)
{
   const NMSSMtower_physical physical(model.get_physical_slha());
