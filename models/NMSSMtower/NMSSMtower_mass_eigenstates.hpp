...
/**
 * @file NMSSMtower_mass_eigenstates.hpp
 *
...
#ifndef NMSSMtower_MASS_EIGENSTATES_H
#define NMSSMtower_MASS_EIGENSTATES_H

#include "NMSSMtower_two_scale_soft_parameters.hpp"
#include "NMSSMtower_physical.hpp"
...
class EWSB_solver;
/**
 * @class NMSSMtower_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class NMSSMtower_mass_eigenstates : public NMSSMtower_soft_parameters {
public:
   explicit NMSSMtower_mass_eigenstates(const NMSSMtower_input_parameters& input_ = NMSSMtower_input_parameters());
   virtual ~NMSSMtower_mass_eigenstates();
   ...
   void set_physical(const NMSSMtower_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const NMSSMtower_physical& get_physical() const;
   NMSSMtower_physical& get_physical();
   const Problems<NMSSMtower_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<NMSSMtower_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(NMSSMtower_info::Particles&) const;
   ...
   const Eigen::Array<double,5,1>& get_MChi() const { return MChi; }
   ...
   const Eigen::Matrix<std::complex<double>,5,5>& get_ZN() const { return ZN; }
   ...
   void calculate_MHpm();
   Eigen::Matrix<double,5,5> get_mass_matrix_Chi() const;
   void calculate_MChi();
...
private:
   struct EWSB_args {
      NMSSMtower_mass_eigenstates* model;
   ...
   NMSSMtower_physical physical; ///< contains the pole masses and mixings
   Problems<NMSSMtower_info::NUMBER_OF_PARTICLES> problems;
   ...
   Eigen::Matrix<std::complex<double>,5,5> ZN;
...
std::ostream& operator<<(std::ostream&, const NMSSMtower_mass_eigenstates&);
