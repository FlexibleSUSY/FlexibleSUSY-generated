...
/**
 * @file NMSSMtower_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Thu 15 Dec 2016 12:38:43

#ifndef NMSSMtower_TWO_SCALE_SLHA_H
#define NMSSMtower_TWO_SCALE_SLHA_H

#include "NMSSMtower_two_scale_model.hpp"
#include "NMSSMtower_physical.hpp"
#include "NMSSMtower_model_slha.hpp"
...
/**
 * @class NMSSMtower_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class NMSSMtower_slha<Two_scale> : public NMSSMtower<Two_scale> {
public:
   explicit NMSSMtower_slha(const NMSSMtower_input_parameters& input_ = NMSSMtower_input_parameters());
   explicit NMSSMtower_slha(const NMSSMtower<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~NMSSMtower_slha();
   ...
   const NMSSMtower_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   NMSSMtower_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   NMSSMtower_physical physical_slha; ///< contains the pole masses and mixings in slha convention
...
std::ostream& operator<<(std::ostream& ostr, const NMSSMtower_slha<Two_scale>& model);
