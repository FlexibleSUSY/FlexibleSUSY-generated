...
class NMSSMtower_susy_parameters : public Beta_function {
public:
   explicit NMSSMtower_susy_parameters(const NMSSMtower_input_parameters& input_ = NMSSMtower_input_parameters());
   NMSSMtower_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const NMSSMtower_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   virtual ~NMSSMtower_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const NMSSMtower_input_parameters& get_input() const;
   NMSSMtower_input_parameters& get_input();
   void set_input_parameters(const NMSSMtower_input_parameters&);

   NMSSMtower_susy_parameters calc_beta() const;
   NMSSMtower_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const NMSSMtower_susy_parameters&);
