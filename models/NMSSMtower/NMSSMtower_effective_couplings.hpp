...
class NMSSMtower_effective_couplings {
public:
   NMSSMtower_effective_couplings(const NMSSMtower_mass_eigenstates&,
   ...
   void set_model(const NMSSMtower_mass_eigenstates& model_);
