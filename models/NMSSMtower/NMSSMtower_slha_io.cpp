...
char const * const NMSSMtower_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "Te", "Td", "Tu", "MSQ2", "MSE2", "MSL2",
   "MSU2", "MSD2", "MSOFT", "HMIX", "NMSSMRUN" }
;

NMSSMtower_slha_io::NMSSMtower_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void NMSSMtower_slha_io::clear()
{
   slha_io.clear();
}

void NMSSMtower_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void NMSSMtower_slha_io::set_extpar(const NMSSMtower_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NMSSMtower_slha_io::set_minpar(const NMSSMtower_input_parameters& input)
{
 ...
 */
void NMSSMtower_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void NMSSMtower_slha_io::set_spinfo(const Problems<NMSSMtower_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void NMSSMtower_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, NMSSMtower_info::model_name)
 ...
 */
void NMSSMtower_slha_io::set_mass(const NMSSMtower_physical& physical,
 ...
 */
void NMSSMtower_slha_io::set_mixing_matrices(const NMSSMtower_physical& physical,
...
void NMSSMtower_slha_io::set_ckm(
...
void NMSSMtower_slha_io::set_pmns(
 ...
 */
void NMSSMtower_slha_io::write_to(const std::string& output)
{
   if (output == "-")
 ...
 */
double NMSSMtower_slha_io::get_parameter_output_scale() const
{
 ...
 */
void NMSSMtower_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void NMSSMtower_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void NMSSMtower_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void NMSSMtower_slha_io::fill(NMSSMtower_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&NMSSMtower_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&NMSSMtower_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void NMSSMtower_slha_io::fill_drbar_parameters(NMSSMtower_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void NMSSMtower_slha_io::fill(NMSSMtower_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   NMSSMtower_physical physical_hk;
 ...
 */
void NMSSMtower_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void NMSSMtower_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void NMSSMtower_slha_io::fill_minpar_tuple(NMSSMtower_input_parameters& input,
...
void NMSSMtower_slha_io::fill_extpar_tuple(NMSSMtower_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void NMSSMtower_slha_io::fill_physical(NMSSMtower_physical& physical) const
{
   {
 ...
 */
double NMSSMtower_slha_io::read_scale() const
{
   double scale = 0.;
