...
// File generated at Sat 15 Oct 2016 15:07:45
...
NMSSMtower_convergence_tester<Two_scale>::NMSSMtower_convergence_tester(NMSSMtower<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<NMSSMtower<Two_scale> >(model, accuracy_goal)
{
}

NMSSMtower_convergence_tester<Two_scale>::~NMSSMtower_convergence_tester()
{
}

double NMSSMtower_convergence_tester<Two_scale>::max_rel_diff() const
{
   const NMSSMtower<Two_scale>& ol = get_last_iteration_model();
   const NMSSMtower<Two_scale>& ne = get_model();
