...
// File generated at Mon 27 Feb 2017 13:53:45
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_mHu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_mHu2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_mHu2_three_loop(const Soft_traces& soft_traces) const
{
