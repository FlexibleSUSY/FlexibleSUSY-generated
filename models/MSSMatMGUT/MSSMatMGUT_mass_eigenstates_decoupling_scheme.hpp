...
/**
 * @file MSSMatMGUT_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSMatMGUT_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSMatMGUT_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "MSSMatMGUT_info.hpp"
#include "MSSMatMGUT_physical.hpp"
#include "MSSMatMGUT_soft_parameters.hpp"
#include "MSSMatMGUT_mass_eigenstates_interface.hpp"
...
#define SUPER(p) MSSMatMGUT_soft_parameters::p
...
/**
 * @class MSSMatMGUT_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMatMGUT_mass_eigenstates_decoupling_scheme
   : private MSSMatMGUT_soft_parameters
   , public MSSMatMGUT_mass_eigenstates_interface
{
public:
   explicit MSSMatMGUT_mass_eigenstates_decoupling_scheme(const MSSMatMGUT_input_parameters& input_ = MSSMatMGUT_input_parameters());
   explicit MSSMatMGUT_mass_eigenstates_decoupling_scheme(const MSSMatMGUT_mass_eigenstates&);
   MSSMatMGUT_mass_eigenstates_decoupling_scheme(const MSSMatMGUT_mass_eigenstates_decoupling_scheme&) = default;
   MSSMatMGUT_mass_eigenstates_decoupling_scheme(MSSMatMGUT_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSMatMGUT_mass_eigenstates_decoupling_scheme() = default;
   MSSMatMGUT_mass_eigenstates_decoupling_scheme& operator=(const MSSMatMGUT_mass_eigenstates_decoupling_scheme&) = default;
   MSSMatMGUT_mass_eigenstates_decoupling_scheme& operator=(MSSMatMGUT_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSMatMGUT_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MSSMatMGUT_mass_eigenstates&);
   ...
   const MSSMatMGUT_input_parameters& get_input_parameters() const override;
   MSSMatMGUT_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSMatMGUT_physical& get_physical() const override;
   MSSMatMGUT_physical& get_physical() override;
   ...
   void set_physical(const MSSMatMGUT_physical&) override;
...
private:
   ...
   Problems problems{MSSMatMGUT_info::model_name,
                     &MSSMatMGUT_info::particle_names_getter,
                     &MSSMatMGUT_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUT_mass_eigenstates_decoupling_scheme&);
