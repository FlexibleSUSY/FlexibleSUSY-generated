...
// File generated at Mon 27 Feb 2017 13:53:19
...
Eigen::Matrix<double,3,3> MSSMatMGUT_soft_parameters::calc_beta_mq2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mq2 = (twoLoop*((-2*(3*traceconjTYdTpTYd + traceconjTYeTpTYe + 3*
      ...
      (2*MassG + MassWB)*Sqr(g2) - 8*MassG*Sqr(g3))) + 3*(2*(45*Power(g2,4)*
      Tr22 + 80*Power(g3,4)*Tr23 + 7.745966692414834*g1*Tr31 + Tr2U111*Sqr(g1))
      + 3*Conj(MassWB)*Sqr(g2)*((MassB + 2*MassWB)*Sqr(g1) + 5*(33*MassWB*Sqr(
      g2) + 16*(MassG + 2*MassWB)*Sqr(g3))))))*UNITMATRIX(3))).real();
...
Eigen::Matrix<double,3,3> MSSMatMGUT_soft_parameters::calc_beta_mq2_three_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_2 = ((threeLoop*(
      35.55555555555556*Power(g3,6)*tracemu2 + Power(g3,4)*(-64.*traceTYdAdjTYd
      + 106.66666666666667*MassG*traceTYdAdjYd - 64.*traceTYuAdjTYu +
      106.66666666666667*MassG*traceTYuAdjYu - 64.*traceYdAdjYdmd2 - 64.*
      traceYuAdjYumu2) + Power(g2,4)*(-54.*traceTYdAdjTYd + 90.*MassWB*
      traceTYdAdjYd - 18.*traceTYeAdjTYe + 30.000000000000004*MassWB*
      traceTYeAdjYe - 54.*traceTYuAdjTYu + 90.*MassWB*traceTYuAdjYu - 54.*
      traceYdAdjYdmd2 - 18.*traceYeAdjYeme2 - 54.*traceYuAdjYumu2) + Power(g1,4
      )*(-0.56*traceTYdAdjTYd + 0.9333333333333333*MassB*traceTYdAdjYd - 0.72*
      traceTYeAdjTYe + 1.2*MassB*traceTYeAdjYe - 1.04*traceTYuAdjTYu +
      1.7333333333333334*MassB*traceTYuAdjYu - 0.56*traceYdAdjYdmd2 - 0.72*
      traceYeAdjYeme2 - 1.04*traceYuAdjYumu2)) + threeLoop*(5.333333333333333*
      Power(g3,4)*mHd2 + 72.*traceAdjTYdTYdAdjYdYd + 12.*traceAdjTYdTYdAdjYuYu
      + 24.*traceAdjTYeTYeAdjYeYe + 12.*traceAdjTYuTYuAdjYdYd + 72.*
      ...
      traceTYdAdjTYd - 12.*traceAdjYeYe*traceTYdAdjTYd + 16.*MassG*
      traceAdjTYdYd*Sqr(g3) - 16.*MassG*traceAdjTYeYe*Sqr(g3) - 32.*mHd2*
      traceAdjYdYd*Sqr(g3) - 16.*traceAdjYdYdmq2*Sqr(g3) + 32.*mHd2*
      traceAdjYeYe*Sqr(g3) + 16.*traceAdjYeYeml2*Sqr(g3) - 16.*traceTYdAdjTYd*
      Sqr(g3) + Power(g1,4)*(-13.14*mHd2 - 0.48*mHu2 - 0.32*tracemd2 - 0.96*
      traceme2 - 0.48*traceml2 - 0.16*tracemq2 - 1.28*tracemu2 - 75.96*Sqr(
      MassB)) + 32.*Power(g3,4)*Sqr(MassG) - 32.*traceAdjYdYd*Sqr(g3)*Sqr(MassG
      ) + 32.*traceAdjYeYe*Sqr(g3)*Sqr(MassG) + Sqr(g1)*(-6.4*MassB*
      ...
      MassWB))) + Power(g2,4)*(-22.5*mHd2 - 135.*Sqr(MassWB)) + Sqr(g2)*(MassWB
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_4 = ((threeLoop*(-36.*
      ...
      *Sqr(g3)))*(Yu.adjoint()*TYu) + threeLoop*(25.32*Power(g1,4)*MassB -
      ...
      - 4.*traceAdjYeYe*traceTYeAdjYe + 16.*MassG*traceAdjYdYd*Sqr(g3) - 16.*
      MassG*traceAdjYeYe*Sqr(g3) - 16.*traceTYdAdjYd*Sqr(g3) + 16.*
      traceTYeAdjYe*Sqr(g3) + Sqr(g1)*(-6.4*MassB*traceAdjYdYd + 3.2*MassB*
      traceAdjYeYe + 6.4*traceTYdAdjYd - 3.2*traceTYeAdjYe + (8.2*MassB + 8.2*
      MassWB)*Sqr(g2) + (10.133333333333333*MassB + 10.133333333333333*MassG)*
      Sqr(g3)) + Sqr(g2)*(-36.*MassWB*traceAdjYdYd - 12.*MassWB*traceAdjYeYe +
      36.*traceTYdAdjYd + 12.*traceTYeAdjYe + (8.*MassG + 8.*MassWB)*Sqr(g3)))*
      ((TYd).adjoint()*Yd) + threeLoop*(-12.66*Power(g1,4) - 22.5*Power(g2,4) +
      5.333333333333333*Power(g3,4) + 36.*traceAdjYdYdAdjYdYd - 12.*
      traceAdjYdYd*traceAdjYeYe + 12.*traceAdjYeYeAdjYeYe + 12.*
      traceAdjYuYuAdjYdYd + Sqr(g1)*(6.4*traceAdjYdYd - 3.2*traceAdjYeYe - 8.2*
      Sqr(g2) - 10.133333333333333*Sqr(g3)) + Sqr(g2)*(36.*traceAdjYdYd + 12.*
      ...
      traceAdjYuTYuAdjYdYd + (8.*MassG + 8.*MassWB)*Sqr(g2)*Sqr(g3) + Sqr(g1)*(
      (11.8*MassB + 11.8*MassWB)*Sqr(g2) + (27.2*MassB + 27.2*MassG)*Sqr(g3)))*
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_5 = ((threeLoop*(72.*
      ...
      *MassWB*traceAdjYuYu*Sqr(g2) + 36.*traceTYuAdjYu*Sqr(g2) + 16.*MassG*
      ...
      )*(mq2*Yd.adjoint()*Yd) + threeLoop*(-12.556666666666667*Power(g1,4) -
      11.25*Power(g2,4) + 2.6666666666666665*Power(g3,4) + 6.*
      traceAdjYuYuAdjYdYd + 18.*traceAdjYuYuAdjYuYu + Sqr(g1)*(2.*traceAdjYuYu
      - 5.9*Sqr(g2) - 13.6*Sqr(g3)) + Sqr(g2)*(18.*traceAdjYuYu - 4.*Sqr(g3)) -
      8.*traceAdjYuYu*Sqr(g3) - 9.*Sqr(traceAdjYuYu))*(mq2*Yu.adjoint()*Yu) +
      ...
      12.*traceAdjYeYeAdjYeYe + 12.*traceAdjYuYuAdjYdYd + Sqr(g1)*(6.4*
      traceAdjYdYd - 3.2*traceAdjYeYe - 8.2*Sqr(g2) - 10.133333333333333*Sqr(g3
      )) + Sqr(g2)*(36.*traceAdjYdYd + 12.*traceAdjYeYe - 8.*Sqr(g3)) - 16.*
      traceAdjYdYd*Sqr(g3) + 16.*traceAdjYeYe*Sqr(g3) - 18.*Sqr(traceAdjYdYd) -
      2.*Sqr(traceAdjYeYe))*(Yd.adjoint()*md2*Yd) + threeLoop*(Power(g1,4)*(
      0.4666666666666667*mHd2 + 2.8*Sqr(MassB)) + Power(g3,4)*(
      -181.33333333333334*mHd2 - 1088.*Sqr(MassG)) + Sqr(g3)*(-96.*MassG*
      traceAdjTYdYd + 192.*mHd2*traceAdjYdYd + 96.*traceAdjYdYdmq2 + 96.*
      traceTYdAdjTYd - 96.*MassG*traceTYdAdjYd + 192.*traceAdjYdYd*Sqr(MassG))
      + Power(g2,4)*(-62.99999999999999*mHd2 - 378.*Sqr(MassWB)) + Sqr(g1)*(9.6
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_6 = ((threeLoop*((-4.8*MassB*
      ...
      *(-6.33*Power(g1,4) - 11.25*Power(g2,4) + 2.6666666666666665*Power(g3,4)
      ...
      ,4)*MassWB + (96.*traceAdjTYdYd - 96.*MassG*traceAdjYdYd)*Sqr(g3) + Sqr(
      g1)*(-9.6*traceAdjTYdYd + 4.8*traceAdjTYeYe + 9.6*MassB*traceAdjYdYd -
      4.8*MassB*traceAdjYeYe + (-3.6000000000000005*MassB - 3.6000000000000005*
      MassWB)*Sqr(g2) + (-17.066666666666666*MassB - 17.066666666666666*MassG)*
      Sqr(g3)))*(Yd.adjoint()*TYd*1.2020569031595942) + threeLoop*(
      ...
      *(4.*traceAdjYuYu - 11.8*Sqr(g2) - 27.2*Sqr(g3)) + Sqr(g2)*(36.*
      ...
      traceAdjYuYu))*(Yu.adjoint()*mu2*Yu) + threeLoop*(Power(g1,4)*(
      1.906666666666667*mHu2 + 11.44*Sqr(MassB)) + Power(g3,4)*(
      -181.33333333333334*mHu2 - 1088.*Sqr(MassG)) + Sqr(g3)*(-96.*MassG*
      traceAdjTYuYu + 192.*mHu2*traceAdjYuYu + 96.*traceAdjYuYumq2 + 96.*
      traceTYuAdjTYu - 96.*MassG*traceTYuAdjYu + 96.*traceYuAdjYumu2 + 192.*
      traceAdjYuYu*Sqr(MassG)) + Power(g2,4)*(-62.99999999999999*mHu2 - 378.*
      Sqr(MassWB)) + Sqr(g1)*(9.6*MassB*traceAdjTYuYu - 19.2*mHu2*traceAdjYuYu
      - 9.6*traceAdjYuYumq2 - 9.6*traceTYuAdjTYu + 9.6*MassB*traceTYuAdjYu -
      9.6*traceYuAdjYumu2 - 19.2*traceAdjYuYu*Sqr(MassB) + Sqr(g3)*(
      34.13333333333333*MassB*MassG + 17.066666666666666*mHu2 +
      34.13333333333333*Sqr(MassB) + 34.13333333333333*Sqr(MassG)) + Sqr(g2)*(
      36.*MassB*MassWB + 18.*mHu2 + 36.*Sqr(MassB) + 36.*Sqr(MassWB))))*(
      Yu.adjoint()*Yu*1.2020569031595942) + threeLoop*(-12.556666666666667*
      Power(g1,4) - 11.25*Power(g2,4) + 2.6666666666666665*Power(g3,4) + 6.*
      traceAdjYuYuAdjYdYd + 18.*traceAdjYuYuAdjYuYu + Sqr(g1)*(2.*traceAdjYuYu
      - 5.9*Sqr(g2) - 13.6*Sqr(g3)) + Sqr(g2)*(18.*traceAdjYuYu - 4.*Sqr(g3)) -
      8.*traceAdjYuYu*Sqr(g3) - 9.*Sqr(traceAdjYuYu))*(Yu.adjoint()*Yu*mq2) +
      threeLoop*(-3.813333333333334*Power(g1,4)*MassB + 362.6666666666667*Power
      (g3,4)*MassG + 125.99999999999999*Power(g2,4)*MassWB + (96.*traceAdjTYuYu
      - 96.*MassG*traceAdjYuYu)*Sqr(g3) + Sqr(g1)*(-9.6*traceAdjTYuYu + 9.6*
      MassB*traceAdjYuYu + (-18.*MassB - 18.*MassWB)*Sqr(g2) + (
      -17.066666666666666*MassB - 17.066666666666666*MassG)*Sqr(g3)))*(
      Yu.adjoint()*TYu*1.2020569031595942) + threeLoop*(-0.9333333333333333*
      Power(g1,4)*MassB - 3.6000000000000005*MassB*Sqr(g1)*Sqr(g2))*((TYd)
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_7 = ((threeLoop*(
      ...
      Power(g2,4)*MassWB + (-96.*MassG*traceAdjYuYu + 96.*traceTYuAdjYu)*Sqr(g3
      ) + Sqr(g1)*(9.6*MassB*traceAdjYuYu - 9.6*traceTYuAdjYu + (-18.*MassB -
      18.*MassWB)*Sqr(g2) + (-17.066666666666666*MassB - 17.066666666666666*
      MassG)*Sqr(g3)))*((TYu).adjoint()*Yu*1.2020569031595942) + threeLoop*(
      1.906666666666667*Power(g1,4) - 62.99999999999999*Power(g2,4) -
      181.33333333333334*Power(g3,4) + 96.*traceAdjYuYu*Sqr(g3) + Sqr(g1)*(-9.6
      *traceAdjYuYu + 18.*Sqr(g2) + 17.066666666666666*Sqr(g3)))*((TYu).adjoint
      ()*TYu*1.2020569031595942) + threeLoop*(0.23333333333333334*Power(g1,4) -
      31.499999999999996*Power(g2,4) - 90.66666666666667*Power(g3,4) + 48.*
      traceAdjYdYd*Sqr(g3) + Sqr(g1)*(-4.8*traceAdjYdYd + 2.4*traceAdjYeYe +
      1.8000000000000003*Sqr(g2) + 8.533333333333333*Sqr(g3)))*(mq2*Yd.adjoint(
      )*Yd*1.2020569031595942) + threeLoop*(0.9533333333333335*Power(g1,4) -
      31.499999999999996*Power(g2,4) - 90.66666666666667*Power(g3,4) + 48.*
      traceAdjYuYu*Sqr(g3) + Sqr(g1)*(-4.8*traceAdjYuYu + 9.*Sqr(g2) +
      8.533333333333333*Sqr(g3)))*(mq2*Yu.adjoint()*Yu*1.2020569031595942) +
      threeLoop*(0.4666666666666667*Power(g1,4) - 62.99999999999999*Power(g2,4)
      - 181.33333333333334*Power(g3,4) + 96.*traceAdjYdYd*Sqr(g3) + Sqr(g1)*(
      -9.6*traceAdjYdYd + 4.8*traceAdjYeYe + 3.6000000000000005*Sqr(g2) +
      17.066666666666666*Sqr(g3)))*(Yd.adjoint()*md2*Yd*1.2020569031595942) +
      threeLoop*(0.23333333333333334*Power(g1,4) - 31.499999999999996*Power(g2,
      4) - 90.66666666666667*Power(g3,4) + 48.*traceAdjYdYd*Sqr(g3) + Sqr(g1)*(
      -4.8*traceAdjYdYd + 2.4*traceAdjYeYe + 1.8000000000000003*Sqr(g2) +
      8.533333333333333*Sqr(g3)))*(Yd.adjoint()*Yd*mq2*1.2020569031595942) +
      threeLoop*(36.*mHd2*traceAdjYdYd + 12.*traceAdjYdYdmq2 + 12.*mHd2*
      traceAdjYeYe + 4.*traceAdjYeYeml2 + 12.*traceTYdAdjTYd + 4.*
      traceTYeAdjTYe + 12.*traceYdAdjYdmd2 + 4.*traceYeAdjYeme2 - 12.*mHd2*Sqr(
      g2) + Sqr(g1)*(1.8666666666666667*mHd2 + 1.8666666666666667*Sqr(MassB)) +
      Sqr(g3)*(85.33333333333333*mHd2 + 85.33333333333333*Sqr(MassG)) - 12.*
      Sqr(g2)*Sqr(MassWB))*(Yd.adjoint()*Yd*Yd.adjoint()*Yd) + threeLoop*(12.*
      traceAdjTYdYd + 4.*traceAdjTYeYe - 0.9333333333333333*MassB*Sqr(g1) + 6.*
      MassWB*Sqr(g2) - 42.666666666666664*MassG*Sqr(g3))*(Yd.adjoint()*Yd*
      Yd.adjoint()*TYd) + threeLoop*(12.*traceTYdAdjYd + 4.*traceTYeAdjYe -
      0.9333333333333333*MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) - 42.666666666666664
      *MassG*Sqr(g3))*(Yd.adjoint()*Yd*(TYd).adjoint()*Yd) + threeLoop*(12.*
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_8 = ((threeLoop*(12.*
      ...
      threeLoop*(0.9533333333333335*Power(g1,4) - 31.499999999999996*Power(g2,4
      ) - 90.66666666666667*Power(g3,4) + 48.*traceAdjYuYu*Sqr(g3) + Sqr(g1)*(
      -4.8*traceAdjYuYu + 9.*Sqr(g2) + 8.533333333333333*Sqr(g3)))*(Yu.adjoint(
      )*Yu*mq2*1.2020569031595942) + threeLoop*(36.*mHu2*traceAdjYuYu + 12.*
