...
// File generated at Sat 15 Oct 2016 16:02:39
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMGUT_soft_parameters::calc_beta_mq2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMGUT_soft_parameters::calc_beta_mq2_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mq2 = (twoLoop*((-6*traceconjTYdTpTYd - 2*traceconjTYeTpTYe - 6*
      tracemd2YdAdjYd - 2*traceme2YeAdjYe - 2*traceml2AdjYeYe - 6*
      tracemq2AdjYdYd - 12*mHd2*traceYdAdjYd - 4*mHd2*traceYeAdjYe + 0.8*mHd2*
      Sqr(g1) + 1.6*AbsSqr(MassB)*Sqr(g1))*(Yd.adjoint()*Yd) + (-6*
      traceconjTYdTpYd - 2*traceconjTYeTpYe - 0.8*Conj(MassB)*Sqr(g1))*(
      Yd.adjoint()*TYd) + (-6*traceconjTYuTpTYu - 6*tracemq2AdjYuYu - 6*
      tracemu2YuAdjYu - 12*mHu2*traceYuAdjYu + 1.6*mHu2*Sqr(g1) + 3.2*AbsSqr(
      MassB)*Sqr(g1))*(Yu.adjoint()*Yu) + (-6*traceconjTYuTpYu - 1.6*Conj(MassB
      )*Sqr(g1))*(Yu.adjoint()*TYu) + (-6*traceAdjYdTYd - 2*traceAdjYeTYe - 0.8
      *MassB*Sqr(g1))*((TYd).adjoint()*Yd) + (-6*traceYdAdjYd - 2*traceYeAdjYe
      + 0.8*Sqr(g1))*((TYd).adjoint()*TYd) + (-6*traceAdjYuTYu - 1.6*MassB*Sqr(
      g1))*((TYu).adjoint()*Yu) + (-6*traceYuAdjYu + 1.6*Sqr(g1))*((TYu)
      .adjoint()*TYu) + (-3*traceYdAdjYd - traceYeAdjYe + 0.4*Sqr(g1))*(mq2*
      Yd.adjoint()*Yd) + (-3*traceYuAdjYu + 0.8*Sqr(g1))*(mq2*Yu.adjoint()*Yu)
      + (-6*traceYdAdjYd - 2*traceYeAdjYe + 0.8*Sqr(g1))*(Yd.adjoint()*md2*Yd)
      + (-3*traceYdAdjYd - traceYeAdjYe + 0.4*Sqr(g1))*(Yd.adjoint()*Yd*mq2) +
      (-6*traceYuAdjYu + 1.6*Sqr(g1))*(Yu.adjoint()*mu2*Yu) + (-3*traceYuAdjYu
      + 0.8*Sqr(g1))*(Yu.adjoint()*Yu*mq2) - 8*mHd2*(Yd.adjoint()*Yd*Yd.adjoint
      ()*Yd) - 4*(Yd.adjoint()*Yd*(TYd).adjoint()*TYd) - 4*(Yd.adjoint()*TYd*(
      TYd).adjoint()*Yd) - 8*mHu2*(Yu.adjoint()*Yu*Yu.adjoint()*Yu) - 4*(
      Yu.adjoint()*Yu*(TYu).adjoint()*TYu) - 4*(Yu.adjoint()*TYu*(TYu).adjoint(
      )*Yu) - 4*((TYd).adjoint()*Yd*Yd.adjoint()*TYd) - 4*((TYd).adjoint()*TYd*
      Yd.adjoint()*Yd) - 4*((TYu).adjoint()*Yu*Yu.adjoint()*TYu) - 4*((TYu)
      .adjoint()*TYu*Yu.adjoint()*Yu) - 2*(mq2*Yd.adjoint()*Yd*Yd.adjoint()*Yd)
      - 2*(mq2*Yu.adjoint()*Yu*Yu.adjoint()*Yu) - 4*(Yd.adjoint()*md2*Yd*
      ...
      *mq2) - 4*(Yu.adjoint()*mu2*Yu*Yu.adjoint()*Yu) - 4*(Yu.adjoint()*Yu*mq2*
      ...
      Yu.adjoint()*Yu*Yu.adjoint()*Yu*mq2) + 6*Power(g2,4)*Tr22*UNITMATRIX(3) +
      10.666666666666666*Power(g3,4)*Tr23*UNITMATRIX(3) + 1.0327955589886444*
      g1*Tr31*UNITMATRIX(3) + 33*Power(g2,4)*AbsSqr(MassWB)*UNITMATRIX(3) +
      ...
      *Sqr(g2) - 8*MassG*Sqr(g3)))*UNITMATRIX(3) + 0.0044444444444444444*Conj(
      MassB)*Sqr(g1)*(597*MassB*Sqr(g1) + 5*(9*(2*MassB + MassWB)*Sqr(g2) + 16*
      (2*MassB + MassG)*Sqr(g3)))*UNITMATRIX(3))).real();
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMGUT_soft_parameters::calc_beta_mq2_three_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_2 = ((threeLoop*(
      ...
      *traceYdAdjYdmd2 - 0.72*Power(g1,4)*traceYeAdjYeme2 - 18.*Power(g2,4)*
      ...
      g1,4)*traceYuAdjYumu2 - 54.*Power(g2,4)*traceYuAdjYumu2) + threeLoop*(
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_3 = ((threeLoop*(12.*
      ...
      + threeLoop*(25.32*Power(g1,4)*MassB - 10.666666666666666*Power(g3,4)*
      MassG + 45.*Power(g2,4)*MassWB + 12.*traceAdjTYuYuAdjYdYd - 36.*
      traceAdjTYdYd*traceAdjYdYd - 12.*traceAdjTYeYe*traceAdjYdYd + 72.*
      traceAdjYdYdAdjTYdYd - 12.*traceAdjTYdYd*traceAdjYeYe - 4.*traceAdjTYeYe*
      traceAdjYeYe + 24.*traceAdjYeYeAdjTYeYe + 12.*traceAdjYuYuAdjTYdYd - 16.*
      ...
      (8.*MassG + 8.*MassWB)*Sqr(g3)))*(Yd.adjoint()*TYd) + threeLoop*(
      5.333333333333333*Power(g3,4)*mHu2 + 12.*traceAdjTYdTYdAdjYuYu + 12.*
      traceAdjTYuTYuAdjYdYd + 72.*traceAdjTYuTYuAdjYuYu + 12.*
      traceAdjYdYdAdjYuYumq2 + 12.*traceAdjYuTYuAdjTYdYd + 72.*
      traceAdjYuTYuAdjTYuYu + 12.*mHd2*traceAdjYuYuAdjYdYd + 24.*mHu2*
      traceAdjYuYuAdjYdYd + 12.*traceAdjYuYuAdjYdYdmq2 + 108.*mHu2*
      traceAdjYuYuAdjYuYu + 72.*traceAdjYuYuAdjYuYumq2 + 16.*MassG*
      traceAdjTYuYu*Sqr(g3) - 32.*mHu2*traceAdjYuYu*Sqr(g3) + Power(g1,4)*(
      -0.96*mHd2 - 26.073333333333334*mHu2 - 150.68*Sqr(MassB)) + 32.*Power(g3,
      4)*Sqr(MassG) - 32.*traceAdjYuYu*Sqr(g3)*Sqr(MassG) + Sqr(g1)*(-4.*MassB*
      ...
      23.6*Sqr(MassB) - 23.6*Sqr(MassWB))) + Power(g2,4)*(-22.5*mHu2 - 135.*
      Sqr(MassWB)) + Sqr(g2)*(-36.*MassWB*traceAdjTYuYu + 72.*mHu2*traceAdjYuYu
      + Sqr(g3)*(-16.*MassG*MassWB - 8.*mHu2 - 16.*Sqr(MassG) - 16.*Sqr(MassWB
      )) + 72.*traceAdjYuYu*Sqr(MassWB)) - 54.*mHu2*Sqr(traceAdjYuYu))*(
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_4 = ((threeLoop*(-36.*
      ...
      + threeLoop*(50.22666666666667*Power(g1,4)*MassB - 10.666666666666666*
      Power(g3,4)*MassG + 45.*Power(g2,4)*MassWB + 12.*traceAdjTYuYuAdjYdYd -
      36.*traceAdjTYuYu*traceAdjYuYu + 12.*traceAdjYuYuAdjTYdYd + 72.*
      ...
      *Sqr(g3)))*(Yu.adjoint()*TYu) + threeLoop*(25.32*Power(g1,4)*MassB -
      10.666666666666666*Power(g3,4)*MassG + 45.*Power(g2,4)*MassWB + 72.*
      traceAdjYdTYdAdjYdYd + 24.*traceAdjYeTYeAdjYeYe + 12.*
      ...
      - 4.*traceAdjYeYe*traceTYeAdjYe - 6.4*MassB*traceAdjYdYd*Sqr(g1) + 3.2*
      MassB*traceAdjYeYe*Sqr(g1) + 6.4*traceTYdAdjYd*Sqr(g1) - 3.2*
      traceTYeAdjYe*Sqr(g1) - 36.*MassWB*traceAdjYdYd*Sqr(g2) - 12.*MassWB*
      traceAdjYeYe*Sqr(g2) + 36.*traceTYdAdjYd*Sqr(g2) + 12.*traceTYeAdjYe*Sqr(
      g2) + 8.2*MassB*Sqr(g1)*Sqr(g2) + 8.2*MassWB*Sqr(g1)*Sqr(g2) + 16.*MassG*
      traceAdjYdYd*Sqr(g3) - 16.*MassG*traceAdjYeYe*Sqr(g3) - 16.*traceTYdAdjYd
      *Sqr(g3) + 16.*traceTYeAdjYe*Sqr(g3) + 10.133333333333333*MassB*Sqr(g1)*
      Sqr(g3) + 10.133333333333333*MassG*Sqr(g1)*Sqr(g3) + 8.*MassG*Sqr(g2)*Sqr
      (g3) + 8.*MassWB*Sqr(g2)*Sqr(g3))*((TYd).adjoint()*Yd) + threeLoop*(
      -12.66*Power(g1,4) - 22.5*Power(g2,4) + 5.333333333333333*Power(g3,4) +
      36.*traceAdjYdYdAdjYdYd - 12.*traceAdjYdYd*traceAdjYeYe + 12.*
      traceAdjYeYeAdjYeYe + 12.*traceAdjYuYuAdjYdYd + 6.4*traceAdjYdYd*Sqr(g1)
      - 3.2*traceAdjYeYe*Sqr(g1) + 36.*traceAdjYdYd*Sqr(g2) + 12.*traceAdjYeYe*
      Sqr(g2) - 8.2*Sqr(g1)*Sqr(g2) - 16.*traceAdjYdYd*Sqr(g3) + 16.*
      traceAdjYeYe*Sqr(g3) - 10.133333333333333*Sqr(g1)*Sqr(g3) - 8.*Sqr(g2)*
      Sqr(g3) - 18.*Sqr(traceAdjYdYd) - 2.*Sqr(traceAdjYeYe))*((TYd).adjoint()*
      TYd) + threeLoop*(50.22666666666667*Power(g1,4)*MassB -
      10.666666666666666*Power(g3,4)*MassG + 45.*Power(g2,4)*MassWB + 12.*
      traceAdjYuTYuAdjYdYd + 11.8*MassB*Sqr(g1)*Sqr(g2) + 11.8*MassWB*Sqr(g1)*
      Sqr(g2) + 27.2*MassB*Sqr(g1)*Sqr(g3) + 27.2*MassG*Sqr(g1)*Sqr(g3) + 8.*
      MassG*Sqr(g2)*Sqr(g3) + 8.*MassWB*Sqr(g2)*Sqr(g3))*((TYu).adjoint()*Yu))*
      UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_mq2_5 = ((threeLoop*(72.*
      ...
      *MassWB*traceAdjYuYu*Sqr(g2) + 36.*traceTYuAdjYu*Sqr(g2) + 16.*MassG*
      ...
      threeLoop*(-25.113333333333333*Power(g1,4) - 22.5*Power(g2,4) +
      5.333333333333333*Power(g3,4) + 12.*traceAdjYuYuAdjYdYd + 36.*
      traceAdjYuYuAdjYuYu + Sqr(g1)*(4.*traceAdjYuYu - 11.8*Sqr(g2) - 27.2*Sqr(
      g3)) + Sqr(g2)*(36.*traceAdjYuYu - 8.*Sqr(g3)) - 16.*traceAdjYuYu*Sqr(g3)
      - 18.*Sqr(traceAdjYuYu))*((TYu).adjoint()*TYu) + threeLoop*(-6.33*Power(
      g1,4) - 11.25*Power(g2,4) + 2.6666666666666665*Power(g3,4) + 18.*
      traceAdjYdYdAdjYdYd - 6.*traceAdjYdYd*traceAdjYeYe + 6.*
      traceAdjYeYeAdjYeYe + 6.*traceAdjYuYuAdjYdYd + 3.2*traceAdjYdYd*Sqr(g1) -
      1.6*traceAdjYeYe*Sqr(g1) + 18.*traceAdjYdYd*Sqr(g2) + 6.*traceAdjYeYe*
      Sqr(g2) - 4.1*Sqr(g1)*Sqr(g2) - 8.*traceAdjYdYd*Sqr(g3) + 8.*traceAdjYeYe
      *Sqr(g3) - 5.066666666666666*Sqr(g1)*Sqr(g3) - 4.*Sqr(g2)*Sqr(g3) - 9.*
      Sqr(traceAdjYdYd) - 1.*Sqr(traceAdjYeYe))*(mq2*Yd.adjoint()*Yd) +
      threeLoop*(-12.556666666666667*Power(g1,4) - 11.25*Power(g2,4) +
      2.6666666666666665*Power(g3,4) + 6.*traceAdjYuYuAdjYdYd + 18.*
      traceAdjYuYuAdjYuYu + 2.*traceAdjYuYu*Sqr(g1) + 18.*traceAdjYuYu*Sqr(g2)
      - 5.9*Sqr(g1)*Sqr(g2) - 8.*traceAdjYuYu*Sqr(g3) - 13.6*Sqr(g1)*Sqr(g3) -
      4.*Sqr(g2)*Sqr(g3) - 9.*Sqr(traceAdjYuYu))*(mq2*Yu.adjoint()*Yu) +
      threeLoop*(-12.66*Power(g1,4) - 22.5*Power(g2,4) + 5.333333333333333*
      Power(g3,4) + 36.*traceAdjYdYdAdjYdYd - 12.*traceAdjYdYd*traceAdjYeYe +
      12.*traceAdjYeYeAdjYeYe + 12.*traceAdjYuYuAdjYdYd + 6.4*traceAdjYdYd*Sqr(
      g1) - 3.2*traceAdjYeYe*Sqr(g1) + 36.*traceAdjYdYd*Sqr(g2) + 12.*
      traceAdjYeYe*Sqr(g2) - 8.2*Sqr(g1)*Sqr(g2) - 16.*traceAdjYdYd*Sqr(g3) +
      16.*traceAdjYeYe*Sqr(g3) - 10.133333333333333*Sqr(g1)*Sqr(g3) - 8.*Sqr(g2
      )*Sqr(g3) - 18.*Sqr(traceAdjYdYd) - 2.*Sqr(traceAdjYeYe))*(Yd.adjoint()*
      md2*Yd) + threeLoop*(0.4666666666666667*Power(g1,4)*mHd2 -
      62.99999999999999*Power(g2,4)*mHd2 - 181.33333333333334*Power(g3,4)*mHd2
      + 9.6*MassB*traceAdjTYdYd*Sqr(g1) - 4.8*MassB*traceAdjTYeYe*Sqr(g1) -
      19.2*mHd2*traceAdjYdYd*Sqr(g1) - 9.6*traceAdjYdYdmq2*Sqr(g1) + 9.6*mHd2*
      traceAdjYeYe*Sqr(g1) + 4.8*traceAdjYeYeml2*Sqr(g1) - 9.6*traceTYdAdjTYd*
      Sqr(g1) + 9.6*MassB*traceTYdAdjYd*Sqr(g1) + 4.8*traceTYeAdjTYe*Sqr(g1) +
      7.200000000000001*MassB*MassWB*Sqr(g1)*Sqr(g2) + 3.6000000000000005*mHd2*
      Sqr(g1)*Sqr(g2) - 96.*MassG*traceAdjTYdYd*Sqr(g3) + 192.*mHd2*
      traceAdjYdYd*Sqr(g3) + 96.*traceAdjYdYdmq2*Sqr(g3) + 96.*traceTYdAdjTYd*
      Sqr(g3) - 96.*MassG*traceTYdAdjYd*Sqr(g3) + 34.13333333333333*MassB*MassG
      *Sqr(g1)*Sqr(g3) + 17.066666666666666*mHd2*Sqr(g1)*Sqr(g3) + 2.8*Power(g1
      ,4)*Sqr(MassB) - 19.2*traceAdjYdYd*Sqr(g1)*Sqr(MassB) + 9.6*traceAdjYeYe*
      Sqr(g1)*Sqr(MassB) + 7.200000000000001*Sqr(g1)*Sqr(g2)*Sqr(MassB) +
      34.13333333333333*Sqr(g1)*Sqr(g3)*Sqr(MassB) - 1088.*Power(g3,4)*Sqr(
      MassG) + 192.*traceAdjYdYd*Sqr(g3)*Sqr(MassG) + 34.13333333333333*Sqr(g1)
      *Sqr(g3)*Sqr(MassG) - 378.*Power(g2,4)*Sqr(MassWB) + 7.200000000000001*
      Sqr(g1)*Sqr(g2)*Sqr(MassWB))*(Yd.adjoint()*Yd*1.2020569031595942))*
      UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_mq2_6 = ((threeLoop*((-4.8*MassB*
      ...
      *(-6.33*Power(g1,4) - 11.25*Power(g2,4) + 2.6666666666666665*Power(g3,4)
      ...
      )*(Yd.adjoint()*Yd*mq2) + threeLoop*(-0.9333333333333333*Power(g1,4)*
      MassB + 362.6666666666667*Power(g3,4)*MassG + 125.99999999999999*Power(g2
      ,4)*MassWB - 9.6*traceAdjTYdYd*Sqr(g1) + 4.8*traceAdjTYeYe*Sqr(g1) + 9.6*
      MassB*traceAdjYdYd*Sqr(g1) - 4.8*MassB*traceAdjYeYe*Sqr(g1) -
      3.6000000000000005*MassB*Sqr(g1)*Sqr(g2) - 3.6000000000000005*MassWB*Sqr(
      g1)*Sqr(g2) + 96.*traceAdjTYdYd*Sqr(g3) - 96.*MassG*traceAdjYdYd*Sqr(g3)
      - 17.066666666666666*MassB*Sqr(g1)*Sqr(g3) - 17.066666666666666*MassG*Sqr
      (g1)*Sqr(g3))*(Yd.adjoint()*TYd*1.2020569031595942) + threeLoop*(
      -25.113333333333333*Power(g1,4) - 22.5*Power(g2,4) + 5.333333333333333*
      Power(g3,4) + 12.*traceAdjYuYuAdjYdYd + 36.*traceAdjYuYuAdjYuYu + 4.*
      traceAdjYuYu*Sqr(g1) + 36.*traceAdjYuYu*Sqr(g2) - 11.8*Sqr(g1)*Sqr(g2) -
      16.*traceAdjYuYu*Sqr(g3) - 27.2*Sqr(g1)*Sqr(g3) - 8.*Sqr(g2)*Sqr(g3) -
      18.*Sqr(traceAdjYuYu))*(Yu.adjoint()*mu2*Yu) + threeLoop*(
      1.906666666666667*Power(g1,4)*mHu2 - 62.99999999999999*Power(g2,4)*mHu2 -
      181.33333333333334*Power(g3,4)*mHu2 + 9.6*MassB*traceAdjTYuYu*Sqr(g1) -
      19.2*mHu2*traceAdjYuYu*Sqr(g1) - 9.6*traceAdjYuYumq2*Sqr(g1) - 9.6*
      traceTYuAdjTYu*Sqr(g1) + 9.6*MassB*traceTYuAdjYu*Sqr(g1) - 9.6*
      traceYuAdjYumu2*Sqr(g1) + 36.*MassB*MassWB*Sqr(g1)*Sqr(g2) + 18.*mHu2*Sqr
      (g1)*Sqr(g2) - 96.*MassG*traceAdjTYuYu*Sqr(g3) + 192.*mHu2*traceAdjYuYu*
      Sqr(g3) + 96.*traceAdjYuYumq2*Sqr(g3) + 96.*traceTYuAdjTYu*Sqr(g3) - 96.*
      MassG*traceTYuAdjYu*Sqr(g3) + 96.*traceYuAdjYumu2*Sqr(g3) +
      34.13333333333333*MassB*MassG*Sqr(g1)*Sqr(g3) + 17.066666666666666*mHu2*
      Sqr(g1)*Sqr(g3) + 11.44*Power(g1,4)*Sqr(MassB) - 19.2*traceAdjYuYu*Sqr(g1
      )*Sqr(MassB) + 36.*Sqr(g1)*Sqr(g2)*Sqr(MassB) + 34.13333333333333*Sqr(g1)
      *Sqr(g3)*Sqr(MassB) - 1088.*Power(g3,4)*Sqr(MassG) + 192.*traceAdjYuYu*
      Sqr(g3)*Sqr(MassG) + 34.13333333333333*Sqr(g1)*Sqr(g3)*Sqr(MassG) - 378.*
      Power(g2,4)*Sqr(MassWB) + 36.*Sqr(g1)*Sqr(g2)*Sqr(MassWB))*(Yu.adjoint()*
      Yu*1.2020569031595942) + threeLoop*(-12.556666666666667*Power(g1,4) -
      11.25*Power(g2,4) + 2.6666666666666665*Power(g3,4) + 6.*
      traceAdjYuYuAdjYdYd + 18.*traceAdjYuYuAdjYuYu + 2.*traceAdjYuYu*Sqr(g1) +
      18.*traceAdjYuYu*Sqr(g2) - 5.9*Sqr(g1)*Sqr(g2) - 8.*traceAdjYuYu*Sqr(g3)
      - 13.6*Sqr(g1)*Sqr(g3) - 4.*Sqr(g2)*Sqr(g3) - 9.*Sqr(traceAdjYuYu))*(
      Yu.adjoint()*Yu*mq2) + threeLoop*(-3.813333333333334*Power(g1,4)*MassB +
      362.6666666666667*Power(g3,4)*MassG + 125.99999999999999*Power(g2,4)*
      MassWB - 9.6*traceAdjTYuYu*Sqr(g1) + 9.6*MassB*traceAdjYuYu*Sqr(g1) - 18.
      *MassB*Sqr(g1)*Sqr(g2) - 18.*MassWB*Sqr(g1)*Sqr(g2) + 96.*traceAdjTYuYu*
      Sqr(g3) - 96.*MassG*traceAdjYuYu*Sqr(g3) - 17.066666666666666*MassB*Sqr(
      g1)*Sqr(g3) - 17.066666666666666*MassG*Sqr(g1)*Sqr(g3))*(Yu.adjoint()*TYu
      *1.2020569031595942) + threeLoop*(-0.9333333333333333*Power(g1,4)*MassB -
      3.6000000000000005*MassB*Sqr(g1)*Sqr(g2))*((TYd).adjoint()*Yd*
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_7 = ((threeLoop*(
      ...
      .adjoint()*Yd*1.2020569031595942) + threeLoop*(0.4666666666666667*Power(
      g1,4) - 62.99999999999999*Power(g2,4) - 181.33333333333334*Power(g3,4) +
      96.*traceAdjYdYd*Sqr(g3) + Sqr(g1)*(-9.6*traceAdjYdYd + 4.8*traceAdjYeYe
      + 3.6000000000000005*Sqr(g2) + 17.066666666666666*Sqr(g3)))*((TYd)
      .adjoint()*TYd*1.2020569031595942) + threeLoop*(-3.813333333333334*Power(
      g1,4)*MassB + 362.6666666666667*Power(g3,4)*MassG + 125.99999999999999*
      Power(g2,4)*MassWB + 9.6*MassB*traceAdjYuYu*Sqr(g1) - 9.6*traceTYuAdjYu*
      Sqr(g1) - 18.*MassB*Sqr(g1)*Sqr(g2) - 18.*MassWB*Sqr(g1)*Sqr(g2) - 96.*
      MassG*traceAdjYuYu*Sqr(g3) + 96.*traceTYuAdjYu*Sqr(g3) -
      17.066666666666666*MassB*Sqr(g1)*Sqr(g3) - 17.066666666666666*MassG*Sqr(
      g1)*Sqr(g3))*((TYu).adjoint()*Yu*1.2020569031595942) + threeLoop*(
      1.906666666666667*Power(g1,4) - 62.99999999999999*Power(g2,4) -
      181.33333333333334*Power(g3,4) - 9.6*traceAdjYuYu*Sqr(g1) + 18.*Sqr(g1)*
      Sqr(g2) + 96.*traceAdjYuYu*Sqr(g3) + 17.066666666666666*Sqr(g1)*Sqr(g3))*
      ((TYu).adjoint()*TYu*1.2020569031595942) + threeLoop*(0.23333333333333334
      *Power(g1,4) - 31.499999999999996*Power(g2,4) - 90.66666666666667*Power(
      g3,4) - 4.8*traceAdjYdYd*Sqr(g1) + 2.4*traceAdjYeYe*Sqr(g1) +
      1.8000000000000003*Sqr(g1)*Sqr(g2) + 48.*traceAdjYdYd*Sqr(g3) +
      8.533333333333333*Sqr(g1)*Sqr(g3))*(mq2*Yd.adjoint()*Yd*
      1.2020569031595942) + threeLoop*(0.9533333333333335*Power(g1,4) -
      31.499999999999996*Power(g2,4) - 90.66666666666667*Power(g3,4) - 4.8*
      traceAdjYuYu*Sqr(g1) + 9.*Sqr(g1)*Sqr(g2) + 48.*traceAdjYuYu*Sqr(g3) +
      8.533333333333333*Sqr(g1)*Sqr(g3))*(mq2*Yu.adjoint()*Yu*
      1.2020569031595942) + threeLoop*(0.4666666666666667*Power(g1,4) -
      62.99999999999999*Power(g2,4) - 181.33333333333334*Power(g3,4) - 9.6*
      traceAdjYdYd*Sqr(g1) + 4.8*traceAdjYeYe*Sqr(g1) + 3.6000000000000005*Sqr(
      g1)*Sqr(g2) + 96.*traceAdjYdYd*Sqr(g3) + 17.066666666666666*Sqr(g1)*Sqr(
      g3))*(Yd.adjoint()*md2*Yd*1.2020569031595942) + threeLoop*(
      0.23333333333333334*Power(g1,4) - 31.499999999999996*Power(g2,4) -
      90.66666666666667*Power(g3,4) - 4.8*traceAdjYdYd*Sqr(g1) + 2.4*
      traceAdjYeYe*Sqr(g1) + 1.8000000000000003*Sqr(g1)*Sqr(g2) + 48.*
      traceAdjYdYd*Sqr(g3) + 8.533333333333333*Sqr(g1)*Sqr(g3))*(Yd.adjoint()*
      Yd*mq2*1.2020569031595942) + threeLoop*(36.*mHd2*traceAdjYdYd + 12.*
      traceAdjYdYdmq2 + 12.*mHd2*traceAdjYeYe + 4.*traceAdjYeYeml2 + 12.*
      traceTYdAdjTYd + 4.*traceTYeAdjTYe + 12.*traceYdAdjYdmd2 + 4.*
      traceYeAdjYeme2 + 1.8666666666666667*mHd2*Sqr(g1) - 12.*mHd2*Sqr(g2) +
      85.33333333333333*mHd2*Sqr(g3) + 1.8666666666666667*Sqr(g1)*Sqr(MassB) +
      85.33333333333333*Sqr(g3)*Sqr(MassG) - 12.*Sqr(g2)*Sqr(MassWB))*(
      Yd.adjoint()*Yd*Yd.adjoint()*Yd) + threeLoop*(12.*traceAdjTYdYd + 4.*
      traceAdjTYeYe - 0.9333333333333333*MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) -
      42.666666666666664*MassG*Sqr(g3))*(Yd.adjoint()*Yd*Yd.adjoint()*TYd) +
      threeLoop*(12.*traceTYdAdjYd + 4.*traceTYeAdjYe - 0.9333333333333333*
      MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) - 42.666666666666664*MassG*Sqr(g3))*(
      Yd.adjoint()*Yd*(TYd).adjoint()*Yd) + threeLoop*(12.*traceAdjYdYd + 4.*
      traceAdjYeYe + 0.9333333333333333*Sqr(g1) - 6.*Sqr(g2) +
      42.666666666666664*Sqr(g3))*(Yd.adjoint()*Yd*(TYd).adjoint()*TYd) +
      threeLoop*(-0.9333333333333333*MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) -
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_8 = ((threeLoop*(12.*
      ...
      .adjoint()*Yd) + threeLoop*(1.906666666666667*Power(g1,4) -
      62.99999999999999*Power(g2,4) - 181.33333333333334*Power(g3,4) - 9.6*
      traceAdjYuYu*Sqr(g1) + 18.*Sqr(g1)*Sqr(g2) + 96.*traceAdjYuYu*Sqr(g3) +
      17.066666666666666*Sqr(g1)*Sqr(g3))*(Yu.adjoint()*mu2*Yu*
      1.2020569031595942) + threeLoop*(0.9533333333333335*Power(g1,4) -
      31.499999999999996*Power(g2,4) - 90.66666666666667*Power(g3,4) - 4.8*
      traceAdjYuYu*Sqr(g1) + 9.*Sqr(g1)*Sqr(g2) + 48.*traceAdjYuYu*Sqr(g3) +
      8.533333333333333*Sqr(g1)*Sqr(g3))*(Yu.adjoint()*Yu*mq2*
      1.2020569031595942) + threeLoop*(36.*mHu2*traceAdjYuYu + 12.*
      traceAdjYuYumq2 + 12.*traceTYuAdjTYu + 12.*traceYuAdjYumu2 +
      14.666666666666666*mHu2*Sqr(g1) - 12.*mHu2*Sqr(g2) + 85.33333333333333*
      mHu2*Sqr(g3) + 14.666666666666666*Sqr(g1)*Sqr(MassB) + 85.33333333333333*
      Sqr(g3)*Sqr(MassG) - 12.*Sqr(g2)*Sqr(MassWB))*(Yu.adjoint()*Yu*Yu.adjoint
      ()*Yu) + threeLoop*(12.*traceAdjTYuYu - 7.333333333333333*MassB*Sqr(g1) +
      6.*MassWB*Sqr(g2) - 42.666666666666664*MassG*Sqr(g3))*(Yu.adjoint()*Yu*
      Yu.adjoint()*TYu) + threeLoop*(12.*traceTYuAdjYu - 7.333333333333333*
      MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) - 42.666666666666664*MassG*Sqr(g3))*(
      Yu.adjoint()*Yu*(TYu).adjoint()*Yu) + threeLoop*(12.*traceAdjYuYu +
      7.333333333333333*Sqr(g1) - 6.*Sqr(g2) + 42.666666666666664*Sqr(g3))*(
      Yu.adjoint()*Yu*(TYu).adjoint()*TYu) + threeLoop*(12.*traceAdjTYuYu -
      7.333333333333333*MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) - 42.666666666666664*
      MassG*Sqr(g3))*(Yu.adjoint()*TYu*Yu.adjoint()*Yu) + threeLoop*(12.*
      traceAdjYuYu + 7.333333333333333*Sqr(g1) - 6.*Sqr(g2) +
      42.666666666666664*Sqr(g3))*(Yu.adjoint()*TYu*(TYu).adjoint()*Yu) +
      threeLoop*(12.*traceTYdAdjYd + 4.*traceTYeAdjYe - 0.9333333333333333*
      MassB*Sqr(g1) + 6.*MassWB*Sqr(g2) - 42.666666666666664*MassG*Sqr(g3))*((
      TYd).adjoint()*Yd*Yd.adjoint()*Yd) + threeLoop*(12.*traceAdjYdYd + 4.*
      traceAdjYeYe + 0.9333333333333333*Sqr(g1) - 6.*Sqr(g2) +
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_9 = ((threeLoop*(12.*
      ...
      *Yd*mq2) + threeLoop*(2.4*MassB*Sqr(g1) - 36.*MassWB*Sqr(g2))*(Yd.adjoint
      ...
      threeLoop*(-24.*mHu2*Sqr(g1) + 72.*mHu2*Sqr(g2) - 24.*Sqr(g1)*Sqr(MassB)
      + 72.*Sqr(g2)*Sqr(MassWB))*(Yu.adjoint()*Yu*Yu.adjoint()*Yu*
      1.2020569031595942) + threeLoop*(6.*traceAdjYuYu + 3.6666666666666665*Sqr
      (g1) - 3.*Sqr(g2) + 21.333333333333332*Sqr(g3))*(Yu.adjoint()*Yu*
      Yu.adjoint()*Yu*mq2) + threeLoop*(12.*MassB*Sqr(g1) - 36.*MassWB*Sqr(g2))
      *(Yu.adjoint()*Yu*Yu.adjoint()*TYu*1.2020569031595942) + threeLoop*(12.*
      MassB*Sqr(g1) - 36.*MassWB*Sqr(g2))*(Yu.adjoint()*Yu*(TYu).adjoint()*Yu*
      1.2020569031595942) + threeLoop*(-12.*Sqr(g1) + 36.*Sqr(g2))*(Yu.adjoint(
      )*Yu*(TYu).adjoint()*TYu*1.2020569031595942) + threeLoop*(12.*MassB*Sqr(
      g1) - 36.*MassWB*Sqr(g2))*(Yu.adjoint()*TYu*Yu.adjoint()*Yu*
      1.2020569031595942) + threeLoop*(-12.*Sqr(g1) + 36.*Sqr(g2))*(Yu.adjoint(
      )*TYu*(TYu).adjoint()*Yu*1.2020569031595942) + threeLoop*(2.4*MassB*Sqr(
      g1) - 36.*MassWB*Sqr(g2))*((TYd).adjoint()*Yd*Yd.adjoint()*Yd*
      1.2020569031595942) + threeLoop*(-2.4*Sqr(g1) + 36.*Sqr(g2))*((TYd)
      .adjoint()*Yd*Yd.adjoint()*TYd*1.2020569031595942) + threeLoop*(-2.4*Sqr(
      g1) + 36.*Sqr(g2))*((TYd).adjoint()*TYd*Yd.adjoint()*Yd*
      1.2020569031595942) + threeLoop*(12.*MassB*Sqr(g1) - 36.*MassWB*Sqr(g2))*
      ((TYu).adjoint()*Yu*Yu.adjoint()*Yu*1.2020569031595942) + threeLoop*(-12.
      *Sqr(g1) + 36.*Sqr(g2))*((TYu).adjoint()*Yu*Yu.adjoint()*TYu*
      1.2020569031595942) + threeLoop*(-12.*Sqr(g1) + 36.*Sqr(g2))*((TYu)
      .adjoint()*TYu*Yu.adjoint()*Yu*1.2020569031595942) + threeLoop*(-1.2*Sqr(
      g1) + 18.*Sqr(g2))*(mq2*Yd.adjoint()*Yd*Yd.adjoint()*Yd*
      1.2020569031595942) + threeLoop*(-6.*Sqr(g1) + 18.*Sqr(g2))*(mq2*
      Yu.adjoint()*Yu*Yu.adjoint()*Yu*1.2020569031595942) + threeLoop*(-2.4*Sqr
      (g1) + 36.*Sqr(g2))*(Yd.adjoint()*md2*Yd*Yd.adjoint()*Yd*
      1.2020569031595942) + threeLoop*(-2.4*Sqr(g1) + 36.*Sqr(g2))*(Yd.adjoint(
      )*Yd*mq2*Yd.adjoint()*Yd*1.2020569031595942) + threeLoop*(-2.4*Sqr(g1) +
      36.*Sqr(g2))*(Yd.adjoint()*Yd*Yd.adjoint()*md2*Yd*1.2020569031595942) +
      threeLoop*(-1.2*Sqr(g1) + 18.*Sqr(g2))*(Yd.adjoint()*Yd*Yd.adjoint()*Yd*
      mq2*1.2020569031595942) + (16.*mHd2 + 8.*mHu2)*threeLoop*(Yd.adjoint()*Yd
      *Yu.adjoint()*Yu*Yd.adjoint()*Yd) + 8.*threeLoop*(Yd.adjoint()*Yd*
      Yu.adjoint()*Yu*(TYd).adjoint()*TYd) + 8.*threeLoop*(Yd.adjoint()*Yd*
      Yu.adjoint()*TYu*(TYd).adjoint()*Yd) + 8.*threeLoop*(Yd.adjoint()*Yd*(TYu
      ).adjoint()*Yu*Yd.adjoint()*TYd) + 8.*threeLoop*(Yd.adjoint()*Yd*(TYu)
      .adjoint()*TYu*Yd.adjoint()*Yd) + 8.*threeLoop*(Yd.adjoint()*TYd*
      Yu.adjoint()*Yu*(TYd).adjoint()*Yd) + 8.*threeLoop*(Yd.adjoint()*TYd*(TYu
      ).adjoint()*Yu*Yd.adjoint()*Yd) + threeLoop*(-12.*Sqr(g1) + 36.*Sqr(g2))*
      (Yu.adjoint()*mu2*Yu*Yu.adjoint()*Yu*1.2020569031595942) + threeLoop*(
      -12.*Sqr(g1) + 36.*Sqr(g2))*(Yu.adjoint()*Yu*mq2*Yu.adjoint()*Yu*
      1.2020569031595942) + (8.*mHd2 + 16.*mHu2)*threeLoop*(Yu.adjoint()*Yu*
      Yd.adjoint()*Yd*Yu.adjoint()*Yu) + 8.*threeLoop*(Yu.adjoint()*Yu*
      Yd.adjoint()*Yd*(TYu).adjoint()*TYu) + 8.*threeLoop*(Yu.adjoint()*Yu*
      Yd.adjoint()*TYd*(TYu).adjoint()*Yu) + threeLoop*(-12.*Sqr(g1) + 36.*Sqr(
      g2))*(Yu.adjoint()*Yu*Yu.adjoint()*mu2*Yu*1.2020569031595942) + threeLoop
      *(-6.*Sqr(g1) + 18.*Sqr(g2))*(Yu.adjoint()*Yu*Yu.adjoint()*Yu*mq2*
      1.2020569031595942) + 8.*threeLoop*(Yu.adjoint()*Yu*(TYd).adjoint()*Yd*
      Yu.adjoint()*TYu) + 8.*threeLoop*(Yu.adjoint()*Yu*(TYd).adjoint()*TYd*
      Yu.adjoint()*Yu) + 8.*threeLoop*(Yu.adjoint()*TYu*Yd.adjoint()*Yd*(TYu)
      .adjoint()*Yu) + 8.*threeLoop*(Yu.adjoint()*TYu*(TYd).adjoint()*Yd*
      Yu.adjoint()*Yu) + 8.*threeLoop*((TYd).adjoint()*Yd*Yu.adjoint()*Yu*
      Yd.adjoint()*TYd))*UNITMATRIX(3)).real();
