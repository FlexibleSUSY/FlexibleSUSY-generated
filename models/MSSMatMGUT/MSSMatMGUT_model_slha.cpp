...
MSSMatMGUT_slha::MSSMatMGUT_slha(const MSSMatMGUT_input_parameters& input_,
 ...
 */
MSSMatMGUT_slha::MSSMatMGUT_slha(const MSSMatMGUT_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MSSMatMGUT_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MSSMatMGUT_slha::clear()
{
   MSSMatMGUT_mass_eigenstates::clear();
   physical_slha.clear();
}

void MSSMatMGUT_slha::calculate_spectrum()
{
   MSSMatMGUT_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MSSMatMGUT_slha::convert_to_slha()
{
...
void MSSMatMGUT_slha::calculate_ckm_matrix()
{
...
void MSSMatMGUT_slha::calculate_pmns_matrix()
{
 ...
 */
void MSSMatMGUT_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MSSMatMGUT_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MSSMatMGUT_slha::convert_soft_squared_masses_to_slha()
{
...
const MSSMatMGUT_physical& MSSMatMGUT_slha::get_physical_slha() const
{
   return physical_slha;
}

MSSMatMGUT_physical& MSSMatMGUT_slha::get_physical_slha()
{
   return physical_slha;
}

void MSSMatMGUT_slha::print(std::ostream& ostr) const
{
   MSSMatMGUT_mass_eigenstates::print(ostr);
...
void MSSMatMGUT_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUT_slha& model)
{
   model.print(ostr);
   return ostr;
}
