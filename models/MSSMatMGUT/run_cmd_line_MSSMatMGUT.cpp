...
int run_solver(const MSSMatMGUT_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMatMGUT_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMatMGUT_input_parameters& input)
{
   int exit_code = 0;
