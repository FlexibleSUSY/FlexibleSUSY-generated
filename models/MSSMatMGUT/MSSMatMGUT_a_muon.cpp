...
// File generated at Tue 22 Jan 2019 17:57:15

/**
 * @file MSSMatMGUT_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 17:57:15 with FlexibleSUSY
...
double calculate_a_muon_impl(MSSMatMGUT_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const MSSMatMGUT_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMatMGUT_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double MSSMatMGUT_a_muon::calculate_a_muon(const MSSMatMGUT_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("MSSMatMGUT_a_muon:" << e.what());
...
double MSSMatMGUT_a_muon::calculate_a_muon_uncertainty(const MSSMatMGUT_mass_eigenstates& model_)
{
   MSSMatMGUT_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMatMGUT_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
