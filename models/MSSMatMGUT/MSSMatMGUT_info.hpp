...
// File generated at Wed 16 Oct 2019 22:51:53
...
namespace MSSMatMGUT_info {
   ...
   enum Input_parameters : int { TanBeta, SignMu, mHd2IN, mHu2IN, Aeij0_0, Aeij0_1
   ...
   class MSSMatMGUT_particle_names : public Names {
   public:
      virtual ~MSSMatMGUT_particle_names() = default;
   ...
   class MSSMatMGUT_parameter_names : public Names {
   public:
      virtual ~MSSMatMGUT_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMatMGUT_particle_names  particle_names_getter{};
   const MSSMatMGUT_parameter_names parameter_names_getter{};
