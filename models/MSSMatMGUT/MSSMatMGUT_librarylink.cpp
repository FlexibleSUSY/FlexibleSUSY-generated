...
public:
   ...
   virtual void fill_slha_io(MSSMatMGUT_slha_io&, const Spectrum_generator_settings&) const = 0;
...
public:
   ...
   virtual void fill_slha_io(MSSMatMGUT_slha_io&, const Spectrum_generator_settings&) const override;
