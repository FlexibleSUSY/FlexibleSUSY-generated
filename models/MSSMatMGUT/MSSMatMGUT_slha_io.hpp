...
// File generated at Sun 18 Oct 2015 13:47:34
...
public:
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MSSMatMGUT_slha<T>&, const softsusy::QedQcd&, const MSSMatMGUT_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMatMGUT_slha<T>&, const softsusy::QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMatMGUT_slha<T>&, const softsusy::QedQcd&, const MSSMatMGUT_scales&);
