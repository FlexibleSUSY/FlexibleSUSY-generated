...
public:
   ...
   static void convert_to_slha_convention(MSSMatMGUT_physical&);
...
private:
   ...
   template <class T> void fill_drbar_parameters(MSSMatMGUT_slha<T>&) const;
   template <class T> void fill_physical(MSSMatMGUT_slha<T>&) const;
};
 ...
 */
template <class T>
void MSSMatMGUT_slha_io::fill_drbar_parameters(MSSMatMGUT_slha<T>& model) const
{
 ...
 */
template <class T>
void MSSMatMGUT_slha_io::fill_physical(MSSMatMGUT_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
