...
public:
   ...
   void set_extra(const MSSMatMGUT_slha&, const MSSMatMGUT_scales&, const MSSMatMGUT_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMatMGUT_scales&, const MSSMatMGUT_observables&);
