Get["models/MSSMatMGUT/MSSMatMGUT_librarylink.m"];

handle = FSMSSMatMGUTOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMGUTCalculateSpectrum[handle];
observables = FSMSSMatMGUTCalculateObservables[handle];

FSMSSMatMGUTCloseHandle[handle];
