...
#ifndef MSSMatMGUT_TWO_SCALE_soft_parameters_H
#define MSSMatMGUT_TWO_SCALE_soft_parameters_H
...
public:
   ...
   virtual ~MSSMatMGUT_soft_parameters() {}
   ...
   MSSMatMGUT_soft_parameters calc_beta(unsigned) const;
   virtual void clear();
