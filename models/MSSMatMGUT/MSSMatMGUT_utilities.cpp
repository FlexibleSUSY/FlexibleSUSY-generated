...
// MSSMatMGUT_parameter_getter ////////////////////////////////////////

std::vector<std::string> MSSMatMGUT_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, MSSMatMGUT_info::NUMBER_OF_MIXINGS> MSSMatMGUT_parameter_getter::get_mixing_names()
{
   return MSSMatMGUT_info::particle_mixing_names;
}

Eigen::ArrayXd MSSMatMGUT_parameter_getter::get_parameters(const MSSMatMGUT_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, MSSMatMGUT_info::NUMBER_OF_PARAMETERS> MSSMatMGUT_parameter_getter::get_parameter_names()
{
   return MSSMatMGUT_info::parameter_names;
}

std::array<std::string, MSSMatMGUT_info::NUMBER_OF_PARTICLES> MSSMatMGUT_parameter_getter::get_particle_names()
{
   return MSSMatMGUT_info::particle_names;
}

std::vector<std::string> MSSMatMGUT_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> MSSMatMGUT_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, MSSMatMGUT_info::NUMBER_OF_MIXINGS> MSSMatMGUT_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, MSSMatMGUT_info::NUMBER_OF_MIXINGS> MSSMatMGUT_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, MSSMatMGUT_info::NUMBER_OF_INPUT_PARAMETERS> MSSMatMGUT_parameter_getter::get_input_parameter_names()
{
   return MSSMatMGUT_info::input_parameter_names;
}

std::array<std::string, MSSMatMGUT_info::NUMBER_OF_EXTRA_PARAMETERS> MSSMatMGUT_parameter_getter::get_extra_parameter_names()
{
   return MSSMatMGUT_info::extra_parameter_names;
}

decltype(MSSMatMGUT_info::NUMBER_OF_MASSES) MSSMatMGUT_parameter_getter::get_number_of_masses()
{
   return MSSMatMGUT_info::NUMBER_OF_MASSES;
}
   ...
   const MSSMatMGUT_observables* observables)
{
   ...
   append(names, MSSMatMGUT_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, MSSMatMGUT_parameter_getter::get_DRbar_mass_names());
   append(names, MSSMatMGUT_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, MSSMatMGUT_parameter_getter::get_pole_mass_names());
   append(names, MSSMatMGUT_parameter_getter::get_pole_mixing_names());
   ...
   if (MSSMatMGUT_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, MSSMatMGUT_observables::get_names());
...
MSSMatMGUT_mass_eigenstates from_database(
   ...
   Physical_input* physical_input, MSSMatMGUT_observables* observables)
{
   MSSMatMGUT_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = MSSMatMGUT_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = MSSMatMGUT_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = MSSMatMGUT_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = MSSMatMGUT_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? MSSMatMGUT_observables::NUMBER_OF_OBSERVABLES : 0);
