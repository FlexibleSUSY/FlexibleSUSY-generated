...
// File generated at Wed 29 Jun 2016 13:28:24
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_BMu_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_BMu_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_BMu_three_loop(const Soft_traces& soft_traces) const
{
