...
#ifndef MSSMatMGUT_WEINBERG_ANGLE_H
#define MSSMatMGUT_WEINBERG_ANGLE_H
...
/**
 * @class MSSMatMGUT_weinberg_angle
...
public:
   ...
   MSSMatMGUT_weinberg_angle(const MSSMatMGUT_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMatMGUT_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMatMGUT_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
