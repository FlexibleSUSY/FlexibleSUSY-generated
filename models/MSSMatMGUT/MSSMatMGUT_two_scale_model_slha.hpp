...
// File generated at Sat 15 Oct 2016 16:03:39
...
public:
   ...
   explicit MSSMatMGUT_slha(const MSSMatMGUT<Two_scale>&, bool do_convert_masses_to_slha = true);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUT_slha<Two_scale>& model);
