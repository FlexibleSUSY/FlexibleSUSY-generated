...
/**
 * @file MSSMatMGUT_mass_eigenstates_interface.hpp
 *
...
#define MSSMatMGUT_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMatMGUT_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMatMGUT_mass_eigenstates_interface {
public:
   virtual ~MSSMatMGUT_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMatMGUT_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMatMGUT_input_parameters& get_input_parameters() const = 0;
   virtual MSSMatMGUT_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMatMGUT_physical& get_physical() const = 0;
   virtual MSSMatMGUT_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMatMGUT_physical&) = 0;
