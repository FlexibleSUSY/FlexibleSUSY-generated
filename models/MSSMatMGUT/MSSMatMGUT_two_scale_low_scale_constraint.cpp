...
// File generated at Fri 26 Jun 2015 19:20:54
...
MSSMatMGUT_low_scale_constraint<Two_scale>::MSSMatMGUT_low_scale_constraint(
   MSSMatMGUT<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void MSSMatMGUT_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& MSSMatMGUT_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
