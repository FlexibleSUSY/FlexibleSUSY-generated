...
MSSMatMGUT_low_scale_constraint<Two_scale>::MSSMatMGUT_low_scale_constraint(
   ...
   const MSSMatMGUT_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void MSSMatMGUT_low_scale_constraint<Two_scale>::set_input_parameters(const MSSMatMGUT_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
