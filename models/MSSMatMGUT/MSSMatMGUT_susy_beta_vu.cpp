 ...
 */
double MSSMatMGUT_susy_parameters::calc_beta_vu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMatMGUT_susy_parameters::calc_beta_vu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMatMGUT_susy_parameters::calc_beta_vu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMatMGUT_susy_parameters::calc_beta_vu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double MSSMatMGUT_susy_parameters::calc_beta_vu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
