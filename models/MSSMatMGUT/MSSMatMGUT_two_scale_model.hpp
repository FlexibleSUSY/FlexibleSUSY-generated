 ...
 */
template<>
class MSSMatMGUT<Two_scale> : public Two_scale_model, public MSSMatMGUT_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(MSSMatMGUT<Two_scale>::*Memfun_t)();
      MSSMatMGUT<Two_scale>* model;
      Memfun_t fun;

      Thread(MSSMatMGUT<Two_scale>* model_, Memfun_t fun_)
