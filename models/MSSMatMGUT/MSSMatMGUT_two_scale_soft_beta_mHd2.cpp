...
// File generated at Thu 15 Dec 2016 13:09:45
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_mHd2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_mHd2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSMatMGUT_soft_parameters::calc_beta_mHd2_three_loop(const Soft_traces& soft_traces) const
{
