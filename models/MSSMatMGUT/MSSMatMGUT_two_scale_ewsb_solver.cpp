...
// File generated at Fri 20 Oct 2017 09:15:39
 ...
 *
 * This file was generated at Fri 20 Oct 2017 09:15:39 with FlexibleSUSY
...
#define CLASSNAME MSSMatMGUT_ewsb_solver<Two_scale>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(MSSMatMGUT_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   MSSMatMGUT_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(MSSMatMGUT_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(MSSMatMGUT_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(MSSMatMGUT_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(MSSMatMGUT_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(MSSMatMGUT_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const MSSMatMGUT_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const MSSMatMGUT_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const MSSMatMGUT_mass_eigenstates& model) const
{
