...
void MSSMatMGUT_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void MSSMatMGUT_slha_io::fill(MSSMatMGUT_slha& model) const
{
 ...
 * @param settings class of settings
 */
void MSSMatMGUT_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMatMGUT_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void MSSMatMGUT_slha_io::set_unitarity_infinite_s(
 ...
 */
void MSSMatMGUT_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMatMGUT_info::model_name)
 ...
 */
void MSSMatMGUT_slha_io::set_model_parameters(const MSSMatMGUT_slha& model)
{
   {
      std::ostringstream block;
...
void MSSMatMGUT_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void MSSMatMGUT_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void MSSMatMGUT_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void MSSMatMGUT_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void MSSMatMGUT_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void MSSMatMGUT_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, MSSMatMGUT_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void MSSMatMGUT_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = MSSMatMGUT_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + MSSMatMGUT_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void MSSMatMGUT_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void MSSMatMGUT_slha_io::set_spectrum(const MSSMatMGUT_slha& model)
{
...
void MSSMatMGUT_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void MSSMatMGUT_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void MSSMatMGUT_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
void MSSMatMGUT_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMatMGUT_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMatMGUT_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMatMGUT_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}
