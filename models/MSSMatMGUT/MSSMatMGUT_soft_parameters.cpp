...
// File generated at Tue 22 Jan 2019 17:55:19
...
const int MSSMatMGUT_soft_parameters::numberOfParameters;

MSSMatMGUT_soft_parameters::MSSMatMGUT_soft_parameters(const MSSMatMGUT_input_parameters& input_)
   : MSSMatMGUT_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMatMGUT_soft_parameters::MSSMatMGUT_soft_parameters(
   const MSSMatMGUT_susy_parameters& susy_model
   ...
   : MSSMatMGUT_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMatMGUT_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMatMGUT_soft_parameters MSSMatMGUT_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMatMGUT_susy_parameters susy_betas(MSSMatMGUT_susy_parameters::calc_beta(loops));
...
MSSMatMGUT_soft_parameters MSSMatMGUT_soft_parameters::calc_beta() const
{
...
{
   MSSMatMGUT_susy_parameters::clear();
...
Eigen::ArrayXd MSSMatMGUT_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMatMGUT_susy_parameters::get());
...
void MSSMatMGUT_soft_parameters::print(std::ostream& ostr) const
{
   MSSMatMGUT_susy_parameters::print(ostr);
...
void MSSMatMGUT_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMatMGUT_susy_parameters::set(pars);
...
MSSMatMGUT_soft_parameters::Soft_traces MSSMatMGUT_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUT_soft_parameters& soft_pars)
{
