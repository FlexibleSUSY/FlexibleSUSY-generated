...
MSSMatMGUT_initial_guesser<Two_scale>::MSSMatMGUT_initial_guesser(
   MSSMatMGUT<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MSSMatMGUT_low_scale_constraint<Two_scale>& low_constraint_,
   const MSSMatMGUT_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSMatMGUT_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("MSSMatMGUT_initial_guesser: Error: pointer to model"
                       " MSSMatMGUT<Two_scale> must not be zero");
}
 ...
 */
void MSSMatMGUT_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMatMGUT_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSMatMGUT_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void MSSMatMGUT_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void MSSMatMGUT_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMatMGUT_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMatMGUT_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void MSSMatMGUT_initial_guesser<Two_scale>::guess_soft_parameters()
{
