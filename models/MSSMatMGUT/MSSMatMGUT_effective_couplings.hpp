...
class MSSMatMGUT_effective_couplings {
public:
   MSSMatMGUT_effective_couplings(const MSSMatMGUT_mass_eigenstates&,
                                   const softsusy::QedQcd&,
                                   const Physical_input&);
   ~MSSMatMGUT_effective_couplings();
   ...
   void set_model(const MSSMatMGUT_mass_eigenstates& model_);
