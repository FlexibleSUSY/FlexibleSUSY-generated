...
#ifndef MSSMatMGUT_TWO_SCALE_MATCHING_H
#define MSSMatMGUT_TWO_SCALE_MATCHING_H
...
template <class T> class MSSMatMGUT;
template <class T> class MSSMatMGUT_standard_model_Matching;
...
template<>
class MSSMatMGUT_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MSSMatMGUT_standard_model_Matching();

   MSSMatMGUT_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MSSMatMGUT<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MSSMatMGUT_standard_model_Matching();
