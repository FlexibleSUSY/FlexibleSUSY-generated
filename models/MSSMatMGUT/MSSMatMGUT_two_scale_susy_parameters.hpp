...
public:
   ...
   MSSMatMGUT_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const MSSMatMGUT_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   MSSMatMGUT_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
