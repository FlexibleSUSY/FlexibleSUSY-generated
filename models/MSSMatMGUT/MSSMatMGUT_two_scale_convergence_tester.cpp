...
// File generated at Tue 24 Feb 2015 17:51:08
...
MSSMatMGUT_convergence_tester<Two_scale>::MSSMatMGUT_convergence_tester(MSSMatMGUT<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<MSSMatMGUT<Two_scale> >(model, accuracy_goal)
{
}

MSSMatMGUT_convergence_tester<Two_scale>::~MSSMatMGUT_convergence_tester()
{
}

double MSSMatMGUT_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMatMGUT<Two_scale>& ol = get_last_iteration_model();
   const MSSMatMGUT<Two_scale>& ne = get_model();
