...
MSSMatMGUT_convergence_tester<Two_scale>::MSSMatMGUT_convergence_tester(
   MSSMatMGUT<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMatMGUT<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double MSSMatMGUT_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const MSSMatMGUT<Two_scale>& ne = get_current_iteration_model();
