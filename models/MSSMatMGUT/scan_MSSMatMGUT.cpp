...
{
   std::cout <<
      "Usage: scan_MSSMatMGUT.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --mHd2IN=<value>\n"
...
struct MSSMatMGUT_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMatMGUT_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMatMGUT_input_parameters& input)
{
...
void scan(int solver_type, MSSMatMGUT_input_parameters& input,
