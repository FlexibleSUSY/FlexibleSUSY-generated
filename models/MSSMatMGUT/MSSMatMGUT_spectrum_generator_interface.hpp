...
public:
   ...
   virtual void run(const softsusy::QedQcd&, const MSSMatMGUT_input_parameters&) = 0;
 ...
 */
template <class T>
void MSSMatMGUT_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
