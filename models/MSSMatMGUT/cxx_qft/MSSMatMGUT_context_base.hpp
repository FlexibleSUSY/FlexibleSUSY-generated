...
/**
 * @file cxx_qft/MSSMatMGUT_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.0 and SARAH 4.14.4 .
 */

#ifndef MSSMatMGUT_CXXQFT_CONTEXT_BASE_H
#define MSSMatMGUT_CXXQFT_CONTEXT_BASE_H

#include "MSSMatMGUT_fields.hpp"
...
namespace MSSMatMGUT_cxx_diagrams {
   ...
   struct context_base {
      MSSMatMGUT_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MSSMatMGUT_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MSSMatMGUT_mass_eigenstates_interface const* const m) : model(*m) {}
