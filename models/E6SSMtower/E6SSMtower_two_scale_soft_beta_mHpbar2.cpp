 ...
 */
double E6SSMtower_soft_parameters::calc_beta_mHpbar2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double E6SSMtower_soft_parameters::calc_beta_mHpbar2_two_loop(const Soft_traces& soft_traces) const
{
...
/**
 * Calculates the three-loop beta function of mHpbar2.
 *
 * @return three-loop beta function
 */
double E6SSMtower_soft_parameters::calc_beta_mHpbar2_three_loop(const Soft_traces& soft_traces) const
{
