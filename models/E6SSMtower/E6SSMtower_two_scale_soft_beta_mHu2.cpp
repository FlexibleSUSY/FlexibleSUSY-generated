 ...
 */
double E6SSMtower_soft_parameters::calc_beta_mHu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double E6SSMtower_soft_parameters::calc_beta_mHu2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double E6SSMtower_soft_parameters::calc_beta_mHu2_three_loop(const Soft_traces& soft_traces) const
{
