...
// File generated at Wed 12 Apr 2017 11:25:48
 ...
 */
Eigen::Matrix<double,3,3> E6SSMtower_susy_parameters::calc_beta_Kappa_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSMtower_susy_parameters::calc_beta_Kappa_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSMtower_susy_parameters::calc_beta_Kappa_three_loop(const Susy_traces& susy_traces) const
{
