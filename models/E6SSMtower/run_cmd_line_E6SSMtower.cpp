...
{
   std::cout <<
      "Usage: run_cmd_line_E6SSMtower.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
int main(int argc, char* argv[])
{
   ...
   const E6SSMtower_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(E6SSMtower_slha_io::fill_slhaea(model, qedqcd, scales, observables));
