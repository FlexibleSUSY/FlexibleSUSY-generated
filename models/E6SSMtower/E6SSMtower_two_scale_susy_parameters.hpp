...
#ifndef E6SSMtower_TWO_SCALE_susy_parameters_H
#define E6SSMtower_TWO_SCALE_susy_parameters_H
...
class E6SSMtower_susy_parameters : public Beta_function {
public:
   explicit E6SSMtower_susy_parameters(const E6SSMtower_input_parameters& input_ = E6SSMtower_input_parameters());
   E6SSMtower_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const E6SSMtower_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   virtual ~E6SSMtower_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const E6SSMtower_input_parameters& get_input() const;
   E6SSMtower_input_parameters& get_input();
   void set_input_parameters(const E6SSMtower_input_parameters&);

   E6SSMtower_susy_parameters calc_beta() const;
   E6SSMtower_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
private:
   ...
   Eigen::Matrix<double,3,3> calc_beta_Kappa_three_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   Eigen::Matrix<double,2,2> calc_beta_Lambda12_three_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_MuPr_three_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_gN_three_loop(const TRACE_STRUCT_TYPE&) const;
...
std::ostream& operator<<(std::ostream&, const E6SSMtower_susy_parameters&);
