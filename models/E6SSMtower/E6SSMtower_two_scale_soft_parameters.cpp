...
// File generated at Thu 15 Dec 2016 12:42:39
...
const int E6SSMtower_soft_parameters::numberOfParameters;

E6SSMtower_soft_parameters::E6SSMtower_soft_parameters(const E6SSMtower_input_parameters& input_)
   : E6SSMtower_susy_parameters(input_)
...
E6SSMtower_soft_parameters::E6SSMtower_soft_parameters(
   const E6SSMtower_susy_parameters& susy_model
   ...
   : E6SSMtower_susy_parameters(susy_model)
...
Eigen::ArrayXd E6SSMtower_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

E6SSMtower_soft_parameters E6SSMtower_soft_parameters::calc_beta() const
{
   ...
   if (get_loops() > 0) {
      ...
      beta_TLambda12 += calc_beta_TLambda12_one_loop(TRACE_STRUCT);
      beta_TLambdax += calc_beta_TLambdax_one_loop(TRACE_STRUCT);
      beta_TYu += calc_beta_TYu_one_loop(TRACE_STRUCT);
      beta_BMuPr += calc_beta_BMuPr_one_loop(TRACE_STRUCT);
      ...
      beta_mH1I2 += calc_beta_mH1I2_one_loop(TRACE_STRUCT);
      beta_mH2I2 += calc_beta_mH2I2_one_loop(TRACE_STRUCT);
      beta_msI2 += calc_beta_msI2_one_loop(TRACE_STRUCT);
      beta_mDx2 += calc_beta_mDx2_one_loop(TRACE_STRUCT);
      beta_mDxbar2 += calc_beta_mDxbar2_one_loop(TRACE_STRUCT);
      beta_mHp2 += calc_beta_mHp2_one_loop(TRACE_STRUCT);
      beta_mHpbar2 += calc_beta_mHpbar2_one_loop(TRACE_STRUCT);
      ...
      beta_MassBp += calc_beta_MassBp_one_loop(TRACE_STRUCT);
   ...
   const E6SSMtower_susy_parameters susy_betas(E6SSMtower_susy_parameters::calc_beta());

   return E6SSMtower_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TKappa, beta_TLambda12, beta_TLambdax, beta_TYu, beta_BMuPr, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_mH1I2, beta_mH2I2, beta_msI2, beta_mDx2, beta_mDxbar2, beta_mHp2, beta_mHpbar2, beta_MassB, beta_MassWB, beta_MassG, beta_MassBp);
}

E6SSMtower_soft_parameters E6SSMtower_soft_parameters::calc_beta(unsigned loops) const
{
   E6SSMtower_soft_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void E6SSMtower_soft_parameters::clear()
{
   E6SSMtower_susy_parameters::clear();
...
Eigen::ArrayXd E6SSMtower_soft_parameters::get() const
{
   Eigen::ArrayXd pars(E6SSMtower_susy_parameters::get());
...
void E6SSMtower_soft_parameters::print(std::ostream& ostr) const
{
   E6SSMtower_susy_parameters::print(ostr);
...
void E6SSMtower_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   E6SSMtower_susy_parameters::set(pars);
...
void E6SSMtower_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const E6SSMtower_soft_parameters& soft_pars)
{
