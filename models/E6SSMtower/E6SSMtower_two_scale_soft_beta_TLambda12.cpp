...
// File generated at Mon 19 Sep 2016 09:40:31
 ...
 */
Eigen::Matrix<double,2,2> E6SSMtower_soft_parameters::calc_beta_TLambda12_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> E6SSMtower_soft_parameters::calc_beta_TLambda12_two_loop(const Soft_traces& soft_traces) const
{
   const double traceKappaAdjKappa = TRACE_STRUCT.traceKappaAdjKappa;
   const double traceLambda12AdjLambda12 =
      TRACE_STRUCT.traceLambda12AdjLambda12;
   ...
   beta_TLambda12 = (twoLoop*(-0.02*Lambda12*(1188*Power(g1,4)*MassB +
      ...
      *MassBp*traceLambda12AdjLambda12*Sqr(gN) + 27*MassB*Sqr(g1)*Sqr(gN) + 27*
 ...
 */
Eigen::Matrix<double,2,2> E6SSMtower_soft_parameters::calc_beta_TLambda12_three_loop(const Soft_traces& soft_traces) const
{
