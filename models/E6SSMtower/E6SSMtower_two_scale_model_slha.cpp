...
// File generated at Sat 15 Oct 2016 16:30:06

/**
 * @file E6SSMtower_two_scale_model_slha.cpp
 * @brief E6SSMtower model class wrapper for SLHA conversion
 */
...
#define CLASSNAME E6SSMtower_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::E6SSMtower_slha(const E6SSMtower_input_parameters& input_)
   : E6SSMtower<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::E6SSMtower_slha(const E6SSMtower<Two_scale>& model_,
...
CLASSNAME::~E6SSMtower_slha()
{
}

void CLASSNAME::clear()
{
   E6SSMtower<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   E6SSMtower<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const E6SSMtower_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

E6SSMtower_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   E6SSMtower<Two_scale>::print(ostr);
