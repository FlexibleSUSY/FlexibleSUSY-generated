...
// File generated at Tue 5 Sep 2017 10:45:13

#ifndef E6SSMtower_SLHA_IO_H
#define E6SSMtower_SLHA_IO_H
...
struct E6SSMtower_scales {
   E6SSMtower_scales() : HighScale(0.), SUSYScale(0.), LowScale(0.) {}
   double HighScale, SUSYScale, LowScale;
};

class E6SSMtower_slha_io {
public:
   E6SSMtower_slha_io();
   ...
   void fill(E6SSMtower_input_parameters&) const;
   void fill(E6SSMtower_mass_eigenstates&) const;
   template <class T> void fill(E6SSMtower_slha<T>&) const;
   ...
   void set_extpar(const E6SSMtower_input_parameters&);
   template <class T> void set_extra(const E6SSMtower_slha<T>&, const E6SSMtower_scales&, const E6SSMtower_observables&);
   void set_minpar(const E6SSMtower_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const E6SSMtower_slha<T>&);
   template <class T> void set_spectrum(const E6SSMtower<T>&);
   void set_spinfo(const Problems<E6SSMtower_info::NUMBER_OF_PARTICLES>&);
   ...
   static void fill_minpar_tuple(E6SSMtower_input_parameters&, int, double);
   static void fill_extpar_tuple(E6SSMtower_input_parameters&, int, double);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const E6SSMtower_slha<T>&, const softsusy::QedQcd&, const E6SSMtower_scales&, const E6SSMtower_observables&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const E6SSMtower_slha<T>&, const softsusy::QedQcd&, const E6SSMtower_scales&, const E6SSMtower_observables&);
...
private:
   ...
   void set_mass(const E6SSMtower_physical&, bool);
   void set_mixing_matrices(const E6SSMtower_physical&, bool);
   template <class T> void set_model_parameters(const E6SSMtower_slha<T>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(E6SSMtower_mass_eigenstates&) const;
   void fill_physical(E6SSMtower_physical&) const;
};
 ...
 */
template <class T>
void E6SSMtower_slha_io::fill(E6SSMtower_slha<T>& model) const
{
   fill(static_cast<E6SSMtower_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class T>
void E6SSMtower_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const E6SSMtower_slha<T>& model,
   const softsusy::QedQcd& qedqcd, const E6SSMtower_scales& scales,
   const E6SSMtower_observables& observables)
{
   E6SSMtower_slha_io slha_io;
   const E6SSMtower_input_parameters& input = model.get_input();
...
template <class T>
SLHAea::Coll E6SSMtower_slha_io::fill_slhaea(
   const E6SSMtower_slha<T>& model, const softsusy::QedQcd& qedqcd,
   const E6SSMtower_scales& scales, const E6SSMtower_observables& observables)
{
   SLHAea::Coll slhaea;
   E6SSMtower_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class T>
void E6SSMtower_slha_io::set_model_parameters(const E6SSMtower_slha<T>& model)
{
   {
 ...
 */
template <class T>
void E6SSMtower_slha_io::set_extra(
   const E6SSMtower_slha<T>& model, const E6SSMtower_scales& scales,
   const E6SSMtower_observables& observables)
{
   const E6SSMtower_physical physical(model.get_physical_slha());
 ...
 */
template <class T>
void E6SSMtower_slha_io::set_spectrum(const E6SSMtower<T>& model)
{
   const E6SSMtower_slha<T> model_slha(model);
 ...
 */
template <class T>
void E6SSMtower_slha_io::set_spectrum(const E6SSMtower_slha<T>& model)
{
   const E6SSMtower_physical physical(model.get_physical_slha());
