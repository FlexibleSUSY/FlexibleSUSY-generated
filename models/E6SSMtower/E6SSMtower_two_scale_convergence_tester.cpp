...
// File generated at Sat 15 Oct 2016 16:01:47
...
E6SSMtower_convergence_tester<Two_scale>::E6SSMtower_convergence_tester(E6SSMtower<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<E6SSMtower<Two_scale> >(model, accuracy_goal)
{
}

E6SSMtower_convergence_tester<Two_scale>::~E6SSMtower_convergence_tester()
{
}

double E6SSMtower_convergence_tester<Two_scale>::max_rel_diff() const
{
   const E6SSMtower<Two_scale>& ol = get_last_iteration_model();
   const E6SSMtower<Two_scale>& ne = get_model();
