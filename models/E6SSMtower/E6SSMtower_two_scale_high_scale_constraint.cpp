...
// File generated at Wed 12 Apr 2017 11:27:27
...
E6SSMtower_high_scale_constraint<Two_scale>::E6SSMtower_high_scale_constraint()
...
void E6SSMtower_high_scale_constraint<Two_scale>::apply()
{
   assert(model && "Error: E6SSMtower_high_scale_constraint::apply():"
...
bool E6SSMtower_high_scale_constraint<Two_scale>::check_non_perturbative()
{
   bool problem = false;
...
double E6SSMtower_high_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double E6SSMtower_high_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const E6SSMtower_input_parameters& E6SSMtower_high_scale_constraint<Two_scale>::get_input_parameters() const
{
   return model->get_input();
}

E6SSMtower<Two_scale>* E6SSMtower_high_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void E6SSMtower_high_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
   model = cast_model<E6SSMtower<Two_scale>*>(model_);
}

void E6SSMtower_high_scale_constraint<Two_scale>::set_scale(double s)
{
   scale = s;
}

void E6SSMtower_high_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
...
void E6SSMtower_high_scale_constraint<Two_scale>::initialize()
{
   assert(model && "E6SSMtower_high_scale_constraint<Two_scale>::"
...
void E6SSMtower_high_scale_constraint<Two_scale>::update_scale()
{
   assert(model && "E6SSMtower_high_scale_constraint<Two_scale>::"
          "update_scale(): model pointer is zero.");

   const double currentScale = model->get_scale();
   const E6SSMtower_soft_parameters beta_functions(model->calc_beta());
   ...
   if (errno == ERANGE) {
      ...
      ERROR("E6SSMtower_high_scale_constraint<Two_scale>: Overflow error"
