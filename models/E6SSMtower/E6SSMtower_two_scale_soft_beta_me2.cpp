...
// File generated at Mon 19 Sep 2016 09:41:01
 ...
 */
Eigen::Matrix<double,3,3> E6SSMtower_soft_parameters::calc_beta_me2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSMtower_soft_parameters::calc_beta_me2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> E6SSMtower_soft_parameters::calc_beta_me2_three_loop(const Soft_traces& soft_traces) const
{
