...
#include "E6SSMtower_initial_guesser.hpp"
...
template <class T>
class E6SSMtower_standard_model_initial_guesser;

/**
 * @class E6SSMtower_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the E6SSMtower tower
 */

template<>
class E6SSMtower_standard_model_initial_guesser<Two_scale> : public Initial_guesser<Two_scale> {
public:
   E6SSMtower_standard_model_initial_guesser(E6SSMtower<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const E6SSMtower_susy_scale_constraint<Two_scale>&);
   virtual ~E6SSMtower_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   E6SSMtower<Two_scale>* model; ///< pointer to model class
   ...
   E6SSMtower_susy_scale_constraint<Two_scale> susy_constraint;
