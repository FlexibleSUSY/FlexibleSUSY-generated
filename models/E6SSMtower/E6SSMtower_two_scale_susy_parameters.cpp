...
// File generated at Wed 12 Apr 2017 11:25:46
...
#define CLASSNAME E6SSMtower_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES() calc_susy_traces(TRACE_STRUCT);

const int E6SSMtower_susy_parameters::numberOfParameters;

E6SSMtower_susy_parameters::E6SSMtower_susy_parameters(const E6SSMtower_input_parameters& input_)
   : Beta_function()
...
E6SSMtower_susy_parameters::E6SSMtower_susy_parameters(
   double scale_, unsigned loops_, unsigned thresholds_,
   const E6SSMtower_input_parameters& input_
...
Eigen::ArrayXd E6SSMtower_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

E6SSMtower_susy_parameters E6SSMtower_susy_parameters::calc_beta() const
{
   ...
   if (get_loops() > 0) {
      ...
      beta_gN += calc_beta_gN_one_loop(TRACE_STRUCT);
   ...
   return E6SSMtower_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
...
E6SSMtower_susy_parameters E6SSMtower_susy_parameters::calc_beta(unsigned loops) const
{
   E6SSMtower_susy_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void E6SSMtower_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd E6SSMtower_susy_parameters::get() const
{
...
void E6SSMtower_susy_parameters::print(std::ostream& ostr) const
{
...
void E6SSMtower_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const E6SSMtower_input_parameters& E6SSMtower_susy_parameters::get_input() const
{
   return input;
}

E6SSMtower_input_parameters& E6SSMtower_susy_parameters::get_input()
{
   return input;
}

void E6SSMtower_susy_parameters::set_input_parameters(const E6SSMtower_input_parameters& input_)
{
   input = input_;
}

void E6SSMtower_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const E6SSMtower_susy_parameters& susy_pars)
{
