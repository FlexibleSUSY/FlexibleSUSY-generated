Get["models/E6SSMtower/E6SSMtower_librarylink.m"];

handle = FSE6SSMtowerOpenHandle[
    fsSettings -> {
...
spectrum    = FSE6SSMtowerCalculateSpectrum[handle];
observables = FSE6SSMtowerCalculateObservables[handle];
FSE6SSMtowerCloseHandle[handle];
