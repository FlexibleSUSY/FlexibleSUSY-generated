...
// File generated at Mon 27 Feb 2017 13:26:13
 ...
 */
double E6SSMtower_soft_parameters::calc_beta_ms2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double E6SSMtower_soft_parameters::calc_beta_ms2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceKappaAdjKappa = TRACE_STRUCT.traceKappaAdjKappa;
   const double traceLambda12AdjLambda12 =
      TRACE_STRUCT.traceLambda12AdjLambda12;
 ...
 */
double E6SSMtower_soft_parameters::calc_beta_ms2_three_loop(const Soft_traces& soft_traces) const
{
