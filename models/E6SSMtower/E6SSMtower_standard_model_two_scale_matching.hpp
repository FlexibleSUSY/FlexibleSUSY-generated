...
#ifndef E6SSMtower_TWO_SCALE_MATCHING_H
#define E6SSMtower_TWO_SCALE_MATCHING_H
...
template <class T> class E6SSMtower;
template <class T> class E6SSMtower_standard_model_Matching;
...
template<>
class E6SSMtower_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   E6SSMtower_standard_model_Matching();

   E6SSMtower_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       E6SSMtower<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~E6SSMtower_standard_model_Matching();
