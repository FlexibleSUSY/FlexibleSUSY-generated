...
#ifndef NUTSMSSM_EFFECTIVE_COUPLINGS_H
#define NUTSMSSM_EFFECTIVE_COUPLINGS_H
...
class NUTSMSSM_effective_couplings {
public:
   NUTSMSSM_effective_couplings(const NUTSMSSM_mass_eigenstates&,
                                   const softsusy::QedQcd&,
                                   const Physical_input&);
   ~NUTSMSSM_effective_couplings();
   ...
   void set_model(const NUTSMSSM_mass_eigenstates& model_);
