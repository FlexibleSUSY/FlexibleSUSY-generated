...
NUTSMSSM_spectrum_plotter::NUTSMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> NUTSMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const NUTSMSSM_observables* observables)
{
   ...
   append(names, NUTSMSSM_parameter_getter().get_mass_names());
   append(names, NUTSMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, NUTSMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = NUTSMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = NUTSMSSM_info::NUMBER_OF_MIXINGS;
   ...
   const std::size_t number_of_observables =
      (observables ? NUTSMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
