...
// File generated at Sun 26 Aug 2018 14:42:25
...
NUTSMSSM_initial_guesser<Two_scale>::NUTSMSSM_initial_guesser(
   NUTSMSSM<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const NUTSMSSM_low_scale_constraint<Two_scale>& low_constraint_,
   const NUTSMSSM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const NUTSMSSM_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("NUTSMSSM_initial_guesser: Error: pointer to model"
                       " NUTSMSSM<Two_scale> must not be zero");
}
 ...
 */
void NUTSMSSM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void NUTSMSSM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void NUTSMSSM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void NUTSMSSM_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void NUTSMSSM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void NUTSMSSM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void NUTSMSSM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void NUTSMSSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
