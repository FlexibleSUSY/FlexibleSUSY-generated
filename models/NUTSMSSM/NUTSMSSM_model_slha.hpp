...
class NUTSMSSM_slha : public NUTSMSSM_mass_eigenstates {
public:
   explicit NUTSMSSM_slha(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NUTSMSSM_slha(const NUTSMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
