...
class NUTSMSSM_slha : public Model {
public:
   explicit NUTSMSSM_slha(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters());
   explicit NUTSMSSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   NUTSMSSM_slha(const NUTSMSSM_slha&) = default;
   NUTSMSSM_slha(NUTSMSSM_slha&&) = default;
   virtual ~NUTSMSSM_slha() = default;
   NUTSMSSM_slha& operator=(const NUTSMSSM_slha&) = default;
   NUTSMSSM_slha& operator=(NUTSMSSM_slha&&) = default;
   ...
   const NUTSMSSM_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   NUTSMSSM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   NUTSMSSM_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
NUTSMSSM_slha<Model>::NUTSMSSM_slha(const NUTSMSSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
NUTSMSSM_slha<Model>::NUTSMSSM_slha(const Model& model_,
...
template <class Model>
void NUTSMSSM_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void NUTSMSSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void NUTSMSSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void NUTSMSSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void NUTSMSSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void NUTSMSSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void NUTSMSSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void NUTSMSSM_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const NUTSMSSM_physical& NUTSMSSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
NUTSMSSM_physical& NUTSMSSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void NUTSMSSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void NUTSMSSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const NUTSMSSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
