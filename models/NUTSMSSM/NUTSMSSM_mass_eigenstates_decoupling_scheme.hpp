...
/**
 * @file NUTSMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef NUTSMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define NUTSMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class NUTSMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class NUTSMSSM_mass_eigenstates_decoupling_scheme
   : private NUTSMSSM_soft_parameters
   , public NUTSMSSM_mass_eigenstates_interface
{
public:
   explicit NUTSMSSM_mass_eigenstates_decoupling_scheme(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters());
   explicit NUTSMSSM_mass_eigenstates_decoupling_scheme(const NUTSMSSM_mass_eigenstates&);
   NUTSMSSM_mass_eigenstates_decoupling_scheme(const NUTSMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NUTSMSSM_mass_eigenstates_decoupling_scheme(NUTSMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~NUTSMSSM_mass_eigenstates_decoupling_scheme() = default;
   NUTSMSSM_mass_eigenstates_decoupling_scheme& operator=(const NUTSMSSM_mass_eigenstates_decoupling_scheme&) = default;
   NUTSMSSM_mass_eigenstates_decoupling_scheme& operator=(NUTSMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const NUTSMSSM_mass_eigenstates&);
...
private:
   ...
   Problems problems{NUTSMSSM_info::model_name,
...
std::ostream& operator<<(std::ostream&, const NUTSMSSM_mass_eigenstates_decoupling_scheme&);
