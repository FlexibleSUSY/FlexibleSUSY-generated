...
#ifndef NUTSMSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define NUTSMSSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "NUTSMSSM_low_scale_constraint.hpp"
...
template<>
class NUTSMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   NUTSMSSM_low_scale_constraint() = default;
   NUTSMSSM_low_scale_constraint(NUTSMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NUTSMSSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "NUTSMSSM low-scale constraint"; }
