...
template<>
class NUTSMSSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   NUTSMSSM_low_scale_constraint();
   NUTSMSSM_low_scale_constraint(NUTSMSSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NUTSMSSM_low_scale_constraint();
   virtual void apply();
