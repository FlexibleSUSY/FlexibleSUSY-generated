...
/**
 * @file NUTSMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef NUTSMSSM_MASS_EIGENSTATES_INTERFACE_H
#define NUTSMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class NUTSMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class NUTSMSSM_mass_eigenstates_interface {
public:
   virtual ~NUTSMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<NUTSMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const NUTSMSSM_input_parameters& get_input_parameters() const = 0;
   virtual NUTSMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const NUTSMSSM_physical& get_physical() const = 0;
   virtual NUTSMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const NUTSMSSM_physical&) = 0;
   ...
   virtual double get_BMS() const = 0;
   virtual double get_LL1() const = 0;
   ...
   virtual void set_MS(double MS_) = 0;
   virtual void set_L1(double L1_) = 0;
   ...
   virtual void set_BMS(double BMS_) = 0;
   virtual void set_LL1(double LL1_) = 0;
