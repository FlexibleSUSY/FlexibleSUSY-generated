Get["models/NUTSMSSM/NUTSMSSM_librarylink.m"];

handle = FSNUTSMSSMOpenHandle[
    fsSettings -> {
...
spectrum    = FSNUTSMSSMCalculateSpectrum[handle];
observables = FSNUTSMSSMCalculateObservables[handle];
FSNUTSMSSMCloseHandle[handle];
