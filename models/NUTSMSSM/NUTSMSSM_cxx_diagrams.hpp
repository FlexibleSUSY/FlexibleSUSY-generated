...
// File generated at Fri 20 Oct 2017 09:01:54

/**
 * @file NUTSMSSM_cxx_diagrams.hpp
 *
 * This file was generated at Fri 20 Oct 2017 09:01:54 with FlexibleSUSY
 * 2.0.1 and SARAH 4.12.0 .
 */

#ifndef NUTSMSSM_CXXDIAGRAMS_H
#define NUTSMSSM_CXXDIAGRAMS_H
...
struct Chi {
   ...
   using smFlags = boost::mpl::vector_c<bool, false, false, false, false, false>;
   static constexpr int numberOfFieldIndices = 1;
   static constexpr double electric_charge = 0;
...
*/
struct EvaluationContext {
   NUTSMSSM_mass_eigenstates& model; ///< The model object.
...
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 5, 6 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
};
