...
// File generated at Mon 27 Feb 2017 13:40:02
...
{
   assert(model && "Error: NUTSMSSM_low_scale_constraint::apply():"
...
void NUTSMSSM_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
...
{
   assert(model && "NUTSMSSM_low_scale_constraint<Two_scale>::"
...
double NUTSMSSM_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "NUTSMSSM_low_scale_constraint<Two_scale>::"
 ...
 */
double NUTSMSSM_low_scale_constraint<Two_scale>::recalculate_mw_pole(double mw_pole)
{
   assert(model && "NUTSMSSM_low_scale_constraint<Two_scale>::"
