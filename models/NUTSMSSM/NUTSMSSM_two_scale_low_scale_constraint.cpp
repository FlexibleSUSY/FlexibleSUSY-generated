...
NUTSMSSM_low_scale_constraint<Two_scale>::NUTSMSSM_low_scale_constraint(
   NUTSMSSM<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void NUTSMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& NUTSMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
