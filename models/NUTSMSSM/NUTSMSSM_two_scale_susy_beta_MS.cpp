 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_MS_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_MS_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_MS_three_loop(const Susy_traces& susy_traces) const
{
