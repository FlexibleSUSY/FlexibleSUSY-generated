 ...
 */
double NUTSMSSM_soft_parameters::calc_beta_TKappa_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTSMSSM_soft_parameters::calc_beta_TKappa_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTSMSSM_soft_parameters::calc_beta_TKappa_three_loop(const Soft_traces& soft_traces) const
{
