...
RUN_NUTSMSSM_OBJ := $(DIR)/run_NUTSMSSM.o
RUN_NUTSMSSM_EXE := $(DIR)/run_NUTSMSSM.x

RUN_CMD_LINE_NUTSMSSM_OBJ := $(DIR)/run_cmd_line_NUTSMSSM.o
RUN_CMD_LINE_NUTSMSSM_EXE := $(DIR)/run_cmd_line_NUTSMSSM.x

SCAN_NUTSMSSM_OBJ := $(DIR)/scan_NUTSMSSM.o
SCAN_NUTSMSSM_EXE := $(DIR)/scan_NUTSMSSM.x
...
clean-$(MODNAME): clean-$(MODNAME)-dep clean-$(MODNAME)-obj
		-rm -f $(LIBNUTSMSSM)
		-rm -f $(RUN_NUTSMSSM_EXE)
		-rm -f $(RUN_CMD_LINE_NUTSMSSM_EXE)
		-rm -f $(SCAN_NUTSMSSM_EXE)
...
$(RUN_NUTSMSSM_EXE): $(RUN_NUTSMSSM_OBJ) $(LIBNUTSMSSM) $(LIBFLEXI) $(LIBLEGACY) $(filter-out -%,$(LOOPFUNCLIBS))
		$(CXX) $(LDFLAGS) -o $@ $(call abspathx,$^) $(filter -%,$(LOOPFUNCLIBS)) $(GSLLIBS) $(BOOSTTHREADLIBS) $(THREADLIBS) $(LAPACKLIBS) $(BLASLIBS) $(FLIBS) $(LDLIBS)

$(RUN_CMD_LINE_NUTSMSSM_EXE): $(RUN_CMD_LINE_NUTSMSSM_OBJ) $(LIBNUTSMSSM) $(LIBFLEXI) $(LIBLEGACY) $(filter-out -%,$(LOOPFUNCLIBS))
		$(CXX) $(LDFLAGS) -o $@ $(call abspathx,$^) $(filter -%,$(LOOPFUNCLIBS)) $(GSLLIBS) $(BOOSTTHREADLIBS) $(THREADLIBS) $(LAPACKLIBS) $(BLASLIBS) $(FLIBS) $(LDLIBS)

$(SCAN_NUTSMSSM_EXE): $(SCAN_NUTSMSSM_OBJ) $(LIBNUTSMSSM) $(LIBFLEXI) $(LIBLEGACY) $(filter-out -%,$(LOOPFUNCLIBS))
		$(CXX) $(LDFLAGS) -o $@ $(call abspathx,$^) $(filter -%,$(LOOPFUNCLIBS)) $(GSLLIBS) $(BOOSTTHREADLIBS) $(THREADLIBS) $(LAPACKLIBS) $(BLASLIBS) $(FLIBS) $(LDLIBS)

ALLDEP += $(LIBNUTSMSSM_DEP) $(EXENUTSMSSM_DEP)
ALLSRC += $(LIBNUTSMSSM_SRC) $(EXENUTSMSSM_SRC)
ALLLIB += $(LIBNUTSMSSM)
ALLEXE += $(RUN_NUTSMSSM_EXE) $(RUN_CMD_LINE_NUTSMSSM_EXE) $(SCAN_NUTSMSSM_EXE)
