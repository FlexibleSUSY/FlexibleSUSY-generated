...
#ifndef NUTSMSSM_TWO_SCALE_INITIAL_GUESSER_H
#define NUTSMSSM_TWO_SCALE_INITIAL_GUESSER_H

#include "NUTSMSSM_initial_guesser.hpp"
...
/**
 * @class NUTSMSSM_initial_guesser<Two_scale>
 * @brief initial guesser for the NUTSMSSM
 */

template<>
class NUTSMSSM_initial_guesser<Two_scale> : public Initial_guesser {
public:
   NUTSMSSM_initial_guesser(NUTSMSSM<Two_scale>*,
                               const softsusy::QedQcd&,
                               const NUTSMSSM_low_scale_constraint<Two_scale>&,
                               const NUTSMSSM_susy_scale_constraint<Two_scale>&,
                               const NUTSMSSM_high_scale_constraint<Two_scale>&);
   virtual ~NUTSMSSM_initial_guesser() = default;
...
private:
   NUTSMSSM<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   NUTSMSSM_low_scale_constraint<Two_scale> low_constraint{};
   NUTSMSSM_susy_scale_constraint<Two_scale> susy_constraint{};
   NUTSMSSM_high_scale_constraint<Two_scale> high_constraint{};
