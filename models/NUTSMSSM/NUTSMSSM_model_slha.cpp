...
NUTSMSSM_slha::NUTSMSSM_slha(const NUTSMSSM_input_parameters& input_,
 ...
 */
NUTSMSSM_slha::NUTSMSSM_slha(const NUTSMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : NUTSMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void NUTSMSSM_slha::clear()
{
   NUTSMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void NUTSMSSM_slha::calculate_spectrum()
{
   NUTSMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void NUTSMSSM_slha::convert_to_slha()
{
...
void NUTSMSSM_slha::calculate_ckm_matrix()
{
...
void NUTSMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void NUTSMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void NUTSMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void NUTSMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const NUTSMSSM_physical& NUTSMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

NUTSMSSM_physical& NUTSMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void NUTSMSSM_slha::print(std::ostream& ostr) const
{
   NUTSMSSM_mass_eigenstates::print(ostr);
...
void NUTSMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const NUTSMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
