...
#ifndef NUTSMSSM_INFO_H
#define NUTSMSSM_INFO_H
...
namespace NUTSMSSM_info {
   ...
   enum Parameters : int { Yd0_0, Yd0_1, Yd0_2, Yd1_0, Yd1_1, Yd1_2, Yd2_0,
      ...
      Yu2_2, Mu, MS, L1, g1, g2, g3, vd, vu, vS, TYd0_0, TYd0_1, TYd0_2, TYd1_0,
      TYd1_1, TYd1_2, TYd2_0, TYd2_1, TYd2_2, TYe0_0, TYe0_1, TYe0_2, TYe1_0,
      TYe1_1, TYe1_2, TYe2_0, TYe2_1, TYe2_2, TLambdax, TKappa, TYu0_0, TYu0_1,
      TYu0_2, TYu1_0, TYu1_1, TYu1_2, TYu2_0, TYu2_1, TYu2_2, BMu, BMS, LL1,
      ...
      me22_2, ms2, MassB, MassWB, MassG, NUMBER_OF_PARAMETERS };
   ...
   enum Input_parameters : int { m0, m12, TanBeta, Azero, LambdaInput,
      KappaInput, LambdaSInput, L1Input, MSInput, BInput, MuInput, LInput,
   ...
   class NUTSMSSM_particle_names : public Names {
   public:
      virtual ~NUTSMSSM_particle_names() = default;
   ...
   class NUTSMSSM_parameter_names : public Names {
   public:
      virtual ~NUTSMSSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const NUTSMSSM_particle_names  particle_names_getter{};
   const NUTSMSSM_parameter_names parameter_names_getter{};
