...
// File generated at Wed 16 Oct 2019 22:40:19
...
std::complex<double> NUTSMSSM_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.05*(10*vu*Conj(ZH(gt1,2))*(Conj(Lambdax)*
...
std::complex<double> NUTSMSSM_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.05*(10*vd*Conj(ZH(gt1,2))*(Conj(Lambdax)*
...
std::complex<double> NUTSMSSM_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.25*(-(Conj(ZH(gt1,0))*(ZP(gt2,0)*(vd*(0.6
      *Sqr(g1) + Sqr(g2))*ZP(gt3,0) + vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1))
      ...
      + Sqr(g2))*ZP(gt3,1)))) + Conj(ZH(gt1,1))*(ZP(gt2,0)*(vu*(0.6*Sqr(g1) - Sqr(
      g2))*ZP(gt3,0) - vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1)) - ZP(gt2,1)*(
      vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vu*(0.6*Sqr(g1) + Sqr(g2))*ZP(
      gt3,1))) - 2*Conj(ZH(gt1,2))*(1.4142135623730951*Conj(TLambdax)*ZP(gt2,1)*ZP
      (gt3,0) + 1.4142135623730951*Conj(MS)*Lambdax*ZP(gt2,0)*ZP(gt3,1) + 2*vS*
