...
#include "NUTSMSSM_weinberg_angle.hpp"
...
#define CLASSNAME NUTSMSSM_weinberg_angle
 ...
 */
CLASSNAME::NUTSMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const NUTSMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * NUTSMSSM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * NUTSMSSM_info::normalization_g2;
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-
         ...
         Sqr(vu))*(RHO2(MAh(1)/MT)*(Sqr(Abs(Conj(ZA(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))
         *SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,
         j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(1,1))*(SUM(j2,0,2,Conj(ZUL(2
         ,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu
         (j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) + RHO2(MAh(2)/MT)*(Sqr(Abs(Conj(ZA(2,1))*
         (SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,
         0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(2,
         1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM
         (j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(0)/
         MT)*(Sqr(Abs(Conj(ZH(0,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2
         ,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,
         j2))))) - Sqr(Abs(Conj(ZH(0,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(
         ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*
         ZUL(2,j2)))))) - RHO2(Mhh(1)/MT)*(Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL
         (2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(
         Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj
         (ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,
         Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(2)/MT)*(Sqr(Abs(Conj(ZH
         (2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) -
         SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(
         Conj(ZH(2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,
         j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))))))/(
         1 + PIZZTMZ/Sqr(MZ));   }
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-0.224
         ...
         MAh(1)/MT)*(Sqr(Abs(Conj(ZA(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,
         Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1
         ))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,
         0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(
         2,j1))*ZUL(2,j2)))))) + RHO2(MAh(2)/MT)*(Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,0,2,
         Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0
         ,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,
         0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(
         j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(0)/MT)*(Sqr(Abs(
         Conj(ZH(0,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,
         j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr
         (Abs(Conj(ZH(0,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu
         (j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))))
         - RHO2(Mhh(1)/MT)*(Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,
         0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(
         2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM
         (j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*
         ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(2)/MT)*(Sqr(Abs(Conj(ZH(2,1))*(SUM(j2,0
         ,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(
         j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(2,1))*(SUM
         (j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,
         SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))))));   }
...
std::complex<double> CLASSNAME::CpChaFvconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(UM(gI1,0))*ZE(gI2,gO1)
      ),0) + Conj(UM(gI1,1))*SUM(j1,0,2,Ye(j1,gO1)*ZE(gI2,3 + j1));
...
std::complex<double> CLASSNAME::CpChiFeconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5477225575051661*g1*Conj(ZN(gI1,0))*SUM(
      ...
      *SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - Conj(ZN(gI1,2))*SUM(j2,0,2,Conj(
      ZEL(gO1,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::delta_vb_wave_Fv(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,-(AbsSqr(
      ...
      gI1,0,4,SUM(gI2,0,2,-(AbsSqr(CpChiFvconjSvPL(gI1,gO1,gI2))*B1(0,Sqr(MChi(gI1
...
std::complex<double> CLASSNAME::delta_vb_wave_Fe(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,2,-(AbsSqr(
      ...
      ,gO1,gI2))*B1(0,Sqr(MFv(gI1)),Sqr(MHpm(gI2)))))) + SUM(gI1,0,4,SUM(gI2,0,5,-
      (AbsSqr(CpChiFeconjSePL(gI1,gO1,gI2))*B1(0,Sqr(MChi(gI1)),Sqr(MSe(gI2))))))
      + SUM(gI1,1,2,SUM(gI2,0,2,-(AbsSqr(CpbarFeFeAhPL(gI2,gO1,gI1))*B1(0,Sqr(MFe(
      gI2)),Sqr(MAh(gI1))))));
...
std::complex<double> CLASSNAME::delta_vb_vertex(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = (SUM(gI1,0,1,SUM(gI2,0,4,SUM(gI3,0,5,
      ...
      + SUM(gI1,0,2,SUM(gI2,0,5,SUM(gI3,0,4,-0.5*CpbarFvChiSvPR(gO2,gI3,gI1)*
      ...
      MChi(gI3)))))) + SUM(gI1,0,4,SUM(gI2,0,1,SUM(gI3,0,2,CpbarChaFeconjSvPL(gI2,
      ...
      (gI1,1,1,SUM(gI2,1,2,SUM(gI3,0,2,-0.5*CpAhHpmconjVWm(gI2,gI1)*CpbarFeFeAhPL(
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,1,SUM(gI4
      ...
      gI1,0,2,SUM(gI2,0,4,SUM(gI3,0,2,SUM(gI4,0,1,CpbarChaFeconjSvPL(gI4,gO1,gI1)*
      ...
      + SUM(gI1,0,2,SUM(gI2,0,4,SUM(gI3,0,5,SUM(gI4,0,1,0.5*CpbarChaFeconjSvPL(gI4
      ...
      SUM(gI3,0,2,SUM(gI4,1,2,CpbarFeFeAhPL(gI1,gO1,gI4)*CpbarFeFeAhPR(gO4,gI3,gI4
      )*CpbarFeFvHpmPL(gI3,gO3,gI2)*CpbarFvFeconjHpmPR(gO2,gI1,gI2)*D27(Sqr(MFe(
      gI1)),Sqr(MHpm(gI2)),Sqr(MFe(gI3)),Sqr(MAh(gI4))))))) + SUM(gI1,0,4,SUM(gI2,
      0,2,SUM(gI3,0,4,SUM(gI4,0,5,CpbarFeChiSePR(gO4,gI3,gI4)*CpbarFvChiSvPR(gO2,
      gI1,gI2)*CpChiFeconjSePL(gI1,gO1,gI4)*CpChiFvconjSvPL(gI3,gO3,gI2)*D27(Sqr(
      MChi(gI1)),Sqr(MSv(gI2)),Sqr(MChi(gI3)),Sqr(MSe(gI4))))))) + SUM(gI1,0,4,SUM
      (gI2,0,2,SUM(gI3,0,4,SUM(gI4,0,5,0.5*CpbarFeChiSePR(gO4,gI3,gI4)*
      ...
      (gI1)*MChi(gI3))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,2,SUM(gI4,0,4,0.5*
      ...
      0,1,SUM(gI3,0,5,SUM(gI4,0,4,CpbarChabarFvSePR(gI2,gO2,gI1)*CpbarFeChiSePR(
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * NUTSMSSM_info::normalization_g3 /
