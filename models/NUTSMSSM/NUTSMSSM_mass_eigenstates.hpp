...
#include "NUTSMSSM_mass_eigenstates_interface.hpp"
...
#define SUPER(p) NUTSMSSM_soft_parameters::p

namespace flexiblesusy {

class NUTSMSSM_ewsb_solver_interface;
/**
 * @class NUTSMSSM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class NUTSMSSM_mass_eigenstates
   : public NUTSMSSM_soft_parameters
   , public NUTSMSSM_mass_eigenstates_interface
{
public:
   explicit NUTSMSSM_mass_eigenstates(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters());
   NUTSMSSM_mass_eigenstates(const NUTSMSSM_mass_eigenstates&) = default;
   NUTSMSSM_mass_eigenstates(NUTSMSSM_mass_eigenstates&&) = default;
   virtual ~NUTSMSSM_mass_eigenstates() = default;
   NUTSMSSM_mass_eigenstates& operator=(const NUTSMSSM_mass_eigenstates&) = default;
   NUTSMSSM_mass_eigenstates& operator=(NUTSMSSM_mass_eigenstates&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<NUTSMSSM_mass_eigenstates_interface> clone() const override;
   ...
   void set_ewsb_solver(const std::shared_ptr<NUTSMSSM_ewsb_solver_interface>&);
   ...
   const NUTSMSSM_input_parameters& get_input_parameters() const override;
   NUTSMSSM_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const NUTSMSSM_physical& get_physical() const override;
   NUTSMSSM_physical& get_physical() override;
   ...
   void set_physical(const NUTSMSSM_physical&) override;
   ...
   double get_MS() const override { return SUPER(MS); }
   double get_L1() const override { return SUPER(L1); }
   ...
   double get_BMS() const override { return SUPER(BMS); }
   double get_LL1() const override { return SUPER(LL1); }
   ...
   void set_MS(double MS_) override { MS = MS_; }
   void set_L1(double L1_) override { L1 = L1_; }
   ...
   void set_BMS(double BMS_) override { BMS = BMS_; }
   void set_LL1(double LL1_) override { LL1 = LL1_; }
...
private:
   ...
   mutable Problems problems{NUTSMSSM_info::model_name,
                             &NUTSMSSM_info::particle_names_getter,
                             &NUTSMSSM_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<NUTSMSSM_ewsb_solver_interface> ewsb_solver{};
