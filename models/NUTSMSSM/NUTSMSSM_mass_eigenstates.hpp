...
/**
 * @file NUTSMSSM_mass_eigenstates.hpp
 *
...
#ifndef NUTSMSSM_MASS_EIGENSTATES_H
#define NUTSMSSM_MASS_EIGENSTATES_H
 ...
 */
class NUTSMSSM_mass_eigenstates : public NUTSMSSM_soft_parameters {
public:
   explicit NUTSMSSM_mass_eigenstates(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters());
   virtual ~NUTSMSSM_mass_eigenstates();
   ...
   void set_physical(const NUTSMSSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const NUTSMSSM_physical& get_physical() const;
   NUTSMSSM_physical& get_physical();
   const Problems<NUTSMSSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<NUTSMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_lsp(NUTSMSSM_info::Particles&) const;
...
private:
   struct EWSB_args {
      NUTSMSSM_mass_eigenstates* model;
   ...
   NUTSMSSM_physical physical; ///< contains the pole masses and mixings
   Problems<NUTSMSSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const NUTSMSSM_mass_eigenstates&);
