...
NUTSMSSM_convergence_tester<Two_scale>::NUTSMSSM_convergence_tester(NUTSMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<NUTSMSSM<Two_scale> >(model, accuracy_goal)
{
}

NUTSMSSM_convergence_tester<Two_scale>::~NUTSMSSM_convergence_tester()
{
}

double NUTSMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const NUTSMSSM<Two_scale>& ol = get_last_iteration_model();
   const NUTSMSSM<Two_scale>& ne = get_model();
