...
NUTSMSSM_physical::NUTSMSSM_physical()
   :
 ...
 * to be complex.
 */
void NUTSMSSM_physical::convert_to_hk()
{
...
void NUTSMSSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd NUTSMSSM_physical::get_masses() const
{
...
void NUTSMSSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void NUTSMSSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const NUTSMSSM_physical& phys_pars)
{
