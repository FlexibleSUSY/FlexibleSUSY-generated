...
// File generated at Mon 27 Feb 2017 13:39:58
...
char const * const NUTSMSSM_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
 ...
 */
void NUTSMSSM_slha_io::set_spinfo(const Problems<NUTSMSSM_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void NUTSMSSM_slha_io::write_to(const std::string& output)
{
   if (output == "-")
...
void NUTSMSSM_slha_io::fill(NUTSMSSM_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&NUTSMSSM_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&NUTSMSSM_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
