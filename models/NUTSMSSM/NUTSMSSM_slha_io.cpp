...
NUTSMSSM_slha_io::NUTSMSSM_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void NUTSMSSM_slha_io::clear()
{
   slha_io.clear();
}

void NUTSMSSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void NUTSMSSM_slha_io::fill(NUTSMSSM_slha& model) const
{
   fill(static_cast<NUTSMSSM_mass_eigenstates&>(model));
 ...
 */
void NUTSMSSM_slha_io::set_extpar(const NUTSMSSM_input_parameters& input)
{
   ...
   extpar << FORMAT_ELEMENT(69, input.BInput, "BInput");
   extpar << FORMAT_ELEMENT(70, input.MuInput, "MuInput");
   extpar << FORMAT_ELEMENT(71, input.LInput, "LInput");
 ...
 * @param input struct of input parameters
 */
void NUTSMSSM_slha_io::set_imminpar(const NUTSMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUTSMSSM_slha_io::set_imextpar(const NUTSMSSM_input_parameters& input)
{
 ...
 */
void NUTSMSSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void NUTSMSSM_slha_io::set_minpar(const NUTSMSSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUTSMSSM_slha_io::set_input(const NUTSMSSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void NUTSMSSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void NUTSMSSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void NUTSMSSM_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void NUTSMSSM_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void NUTSMSSM_slha_io::set_unitarity_infinite_s(
 ...
 */
void NUTSMSSM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void NUTSMSSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void NUTSMSSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void NUTSMSSM_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, NUTSMSSM_info::model_name)
 ...
 */
void NUTSMSSM_slha_io::set_mass(const NUTSMSSM_physical& physical,
 ...
 */
void NUTSMSSM_slha_io::set_mixing_matrices(const NUTSMSSM_physical& physical,
...
void NUTSMSSM_slha_io::set_pmns(
 ...
 */
void NUTSMSSM_slha_io::set_model_parameters(const NUTSMSSM_slha& model)
{
   {
...
void NUTSMSSM_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void NUTSMSSM_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void NUTSMSSM_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void NUTSMSSM_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void NUTSMSSM_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void NUTSMSSM_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, NUTSMSSM_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void NUTSMSSM_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = NUTSMSSM_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + NUTSMSSM_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void NUTSMSSM_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void NUTSMSSM_slha_io::set_spectrum(const NUTSMSSM_slha& model)
{
 ...
 */
void NUTSMSSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void NUTSMSSM_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void NUTSMSSM_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void NUTSMSSM_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double NUTSMSSM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void NUTSMSSM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void NUTSMSSM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void NUTSMSSM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void NUTSMSSM_slha_io::fill(NUTSMSSM_input_parameters& input) const
{
 ...
 */
void NUTSMSSM_slha_io::fill_drbar_parameters(NUTSMSSM_mass_eigenstates& model) const
{
   ...
   model.set_L1(slha_io.read_entry("HMIX", 30));
   model.set_MS(slha_io.read_entry("HMIX", 31));
   model.set_LL1(slha_io.read_entry("HMIX", 32));
   model.set_BMS(slha_io.read_entry("HMIX", 33));
 ...
 * @param model model class to be filled
 */
void NUTSMSSM_slha_io::fill(NUTSMSSM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   NUTSMSSM_physical physical_hk;
 ...
 */
void NUTSMSSM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void NUTSMSSM_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NUTSMSSM_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NUTSMSSM_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void NUTSMSSM_slha_io::fill_minpar_tuple(NUTSMSSM_input_parameters& input,
...
void NUTSMSSM_slha_io::fill_extpar_tuple(NUTSMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
   ...
   case 69: input.BInput = value; break;
   case 70: input.MuInput = value; break;
   case 71: input.LInput = value; break;
   default: WARNING("Unrecognized entry in block EXTPAR: " << key); break;
   }

}

void NUTSMSSM_slha_io::fill_imminpar_tuple(NUTSMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NUTSMSSM_slha_io::fill_imextpar_tuple(NUTSMSSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void NUTSMSSM_slha_io::fill_physical(NUTSMSSM_physical& physical) const
{
   {
 ...
 */
double NUTSMSSM_slha_io::read_scale() const
{
