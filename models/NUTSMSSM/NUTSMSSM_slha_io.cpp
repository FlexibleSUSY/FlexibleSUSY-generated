...
void NUTSMSSM_slha_io::fill(Spectrum_generator_settings& settings) const
{
   SLHA_io::Tuple_processor flexiblesusy_processor
      = boost::bind(&NUTSMSSM_slha_io::fill_flexiblesusy_tuple, boost::ref(settings), _1, _2);
...
void NUTSMSSM_slha_io::fill_flexiblesusy_tuple(Spectrum_generator_settings& settings,
                                                  int key, double value)
{
