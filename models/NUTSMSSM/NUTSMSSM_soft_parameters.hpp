...
// File generated at Wed 16 Oct 2019 22:22:55
...
class NUTSMSSM_soft_parameters : public NUTSMSSM_susy_parameters {
public:
   explicit NUTSMSSM_soft_parameters(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters());
   NUTSMSSM_soft_parameters(const NUTSMSSM_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>& TYe_,
   ...
   NUTSMSSM_soft_parameters(const NUTSMSSM_soft_parameters&) = default;
   NUTSMSSM_soft_parameters(NUTSMSSM_soft_parameters&&) = default;
   virtual ~NUTSMSSM_soft_parameters() = default;
   NUTSMSSM_soft_parameters& operator=(const NUTSMSSM_soft_parameters&) = default;
   NUTSMSSM_soft_parameters& operator=(NUTSMSSM_soft_parameters&&) = default;
   ...
   NUTSMSSM_soft_parameters calc_beta() const;
   NUTSMSSM_soft_parameters calc_beta(int) const;
   ...
   void set_BMS(double BMS_) { BMS = BMS_; }
   void set_LL1(double LL1_) { LL1 = LL1_; }
   ...
   double get_BMS() const { return BMS; }
   double get_LL1() const { return LL1; }
...
private:
   static const int numberOfParameters = 121;
   ...
   struct Soft_traces {
      ...
      double traceYdAdjYdconjmd2{};
      double traceYdconjmq2AdjYd{};
      double traceYeAdjYeconjme2{};
      double traceYeconjml2AdjYe{};
      double traceYuAdjYuconjmu2{};
      double traceYuconjmq2AdjYu{};
   ...
   double calc_beta_BMS_1_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMS_2_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMS_3_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMS_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_BMS_5_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LL1_1_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LL1_2_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LL1_3_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LL1_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LL1_5_loop(const TRACE_STRUCT_TYPE&) const;
...
std::ostream& operator<<(std::ostream&, const NUTSMSSM_soft_parameters&);
