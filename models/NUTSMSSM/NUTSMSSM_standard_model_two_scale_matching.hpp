...
#ifndef NUTSMSSM_TWO_SCALE_MATCHING_H
#define NUTSMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class NUTSMSSM;
template <class T> class NUTSMSSM_standard_model_Matching;
...
template<>
class NUTSMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   NUTSMSSM_standard_model_Matching();

   NUTSMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       NUTSMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~NUTSMSSM_standard_model_Matching();
