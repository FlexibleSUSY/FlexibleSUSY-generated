 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_vS_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_vS_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_vS_three_loop(const Susy_traces& susy_traces) const
{
