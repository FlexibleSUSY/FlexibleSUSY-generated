...
int run_solver(const NUTSMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(NUTSMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const NUTSMSSM_input_parameters& input)
{
   int exit_code = 0;
