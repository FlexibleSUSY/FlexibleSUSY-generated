...
// File generated at Sat 15 Oct 2016 15:41:53
 ...
 */
double NUTSMSSM_soft_parameters::calc_beta_MassB_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUTSMSSM_soft_parameters::calc_beta_MassB_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_MassB = Re(0.08*twoLoop*Sqr(g1)*(70*traceAdjYdTYd + 90*
      ...
      (g2) + 135*MassWB*Sqr(g2) + 440*MassB*Sqr(g3) + 440*MassG*Sqr(g3) - 30*
 ...
 */
double NUTSMSSM_soft_parameters::calc_beta_MassB_three_loop(const Soft_traces& soft_traces) const
{
