...
// File generated at Wed 29 Jun 2016 12:28:47
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_vu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_vu_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double NUTSMSSM_susy_parameters::calc_beta_vu_three_loop(const Susy_traces& susy_traces) const
{
