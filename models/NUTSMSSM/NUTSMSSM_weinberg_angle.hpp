...
#ifndef NUTSMSSM_WEINBERG_ANGLE_H
#define NUTSMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   NUTSMSSM_weinberg_angle(const NUTSMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NUTSMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NUTSMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
