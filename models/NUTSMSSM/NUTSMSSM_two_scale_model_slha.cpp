...
/**
 * @file NUTSMSSM_two_scale_model_slha.cpp
 * @brief NUTSMSSM model class wrapper for SLHA conversion
 */
...
#define CLASSNAME NUTSMSSM_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::NUTSMSSM_slha(const NUTSMSSM_input_parameters& input_)
   : NUTSMSSM<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::NUTSMSSM_slha(const NUTSMSSM<Two_scale>& model_,
...
CLASSNAME::~NUTSMSSM_slha()
{
}

void CLASSNAME::clear()
{
   NUTSMSSM<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   NUTSMSSM<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const NUTSMSSM_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

NUTSMSSM_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
