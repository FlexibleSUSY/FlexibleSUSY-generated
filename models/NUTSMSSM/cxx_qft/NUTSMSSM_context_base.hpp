...
/**
 * @file cxx_qft/NUTSMSSM_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.2 and SARAH 4.14.5 .
 */

#ifndef NUTSMSSM_CXXQFT_CONTEXT_BASE_H
#define NUTSMSSM_CXXQFT_CONTEXT_BASE_H

#include "NUTSMSSM_fields.hpp"
...
namespace NUTSMSSM_cxx_diagrams {
   ...
   struct context_base {
      NUTSMSSM_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(NUTSMSSM_mass_eigenstates_interface const& m) : model(m) {}
      context_base(NUTSMSSM_mass_eigenstates_interface const* const m) : model(*m) {}
