...
private:
   ...
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_MIXINGS> get_mixing_names() const {
...
public:
   ...
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_PARAMETERS> get_parameter_names() const {
      return NUTSMSSM_info::parameter_names;
   }

   /// returns names of particles
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_PARTICLES> get_particle_names() const {
   ...
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_MIXINGS> get_DRbar_mixing_names() const {
      return get_mixing_names();
   }

   /// returns names of pole mixing matrices
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_MIXINGS> get_pole_mixing_names() const {
   ...
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_INPUT_PARAMETERS> get_input_parameter_names() const {
      return NUTSMSSM_info::input_parameter_names;
   }

   /// returns names of input parameters
   std::array<std::string, NUTSMSSM_info::NUMBER_OF_EXTRA_PARAMETERS> get_extra_parameter_names() const {
      return NUTSMSSM_info::extra_parameter_names;
   }

   /// returns number of particle masses
   decltype(NUTSMSSM_info::NUMBER_OF_MASSES) get_number_of_masses() const {
...
public:
   NUTSMSSM_spectrum_plotter() = default;
   explicit NUTSMSSM_spectrum_plotter(const NUTSMSSM_mass_eigenstates&);
...
void to_database(
   ...
   const NUTSMSSM_observables* observables = nullptr);
...
NUTSMSSM_mass_eigenstates from_database(
   ...
   NUTSMSSM_observables* observables = nullptr);
