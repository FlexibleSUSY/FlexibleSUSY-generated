...
namespace NUTSMSSM_info {
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {
      ...
      , "Yu(2,2)", "Mu", "MS", "L1", "g1", "g2", "g3", "vd", "vu", "vS",
      ...
      "TLambdax", "TKappa", "TYu(0,0)", "TYu(0,1)", "TYu(0,2)", "TYu(1,0)",
      "TYu(1,1)", "TYu(1,2)", "TYu(2,0)", "TYu(2,1)", "TYu(2,2)", "BMu", "BMS",
      "LL1", "mq2(0,0)", "mq2(0,1)", "mq2(0,2)", "mq2(1,0)", "mq2(1,1)",
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS>
      ...
      "KappaInput", "LambdaSInput", "L1Input", "MSInput", "BInput", "MuInput",
      "LInput"};

   const std::array<std::string, NUMBER_OF_EXTRA_PARAMETERS>
      extra_parameter_names = {};

   const std::string model_name = "NUTSMSSM";
