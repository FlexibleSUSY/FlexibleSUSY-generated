...
namespace NUTSMSSM_info {
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {
      ...
      "Yu(2,2)", "Mu", "MS", "L1", "g1", "g2", "g3", "vd", "vu", "vS", "TYd(0,0)",
      ...
      "TKappa", "TYu(0,0)", "TYu(0,1)", "TYu(0,2)", "TYu(1,0)", "TYu(1,1)",
      "TYu(1,2)", "TYu(2,0)", "TYu(2,1)", "TYu(2,2)", "BMu", "BMS", "LL1",
      ...
      "me2(1,2)", "me2(2,0)", "me2(2,1)", "me2(2,2)", "ms2", "MassB", "MassWB",
      "MassG"};
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS> input_parameter_names
       = {"m0", "m12", "TanBeta", "Azero", "LambdaInput", "KappaInput",
