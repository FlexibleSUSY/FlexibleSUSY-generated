...
// File generated at Sun 26 Aug 2018 14:41:56
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:41:56 with FlexibleSUSY
...
Eigen::Matrix<double,6,6> CLASSNAME::get_mass_matrix_Sd() const
{
   ...
   mass_matrix_Sd(0,3) = 0.7071067811865475*vd*Conj(TYd(0,0)) - 0.5*vS*vu*Conj(
      Yd(0,0))*Lambdax - 0.7071067811865475*vu*Conj(Yd(0,0))*Mu;
   mass_matrix_Sd(0,4) = 0.7071067811865475*vd*Conj(TYd(1,0)) - 0.5*vS*vu*Conj(
      Yd(1,0))*Lambdax - 0.7071067811865475*vu*Conj(Yd(1,0))*Mu;
   mass_matrix_Sd(0,5) = 0.7071067811865475*vd*Conj(TYd(2,0)) - 0.5*vS*vu*Conj(
      Yd(2,0))*Lambdax - 0.7071067811865475*vu*Conj(Yd(2,0))*Mu;
   ...
   mass_matrix_Sd(1,3) = 0.7071067811865475*vd*Conj(TYd(0,1)) - 0.5*vS*vu*Conj(
      Yd(0,1))*Lambdax - 0.7071067811865475*vu*Conj(Yd(0,1))*Mu;
   mass_matrix_Sd(1,4) = 0.7071067811865475*vd*Conj(TYd(1,1)) - 0.5*vS*vu*Conj(
      Yd(1,1))*Lambdax - 0.7071067811865475*vu*Conj(Yd(1,1))*Mu;
   mass_matrix_Sd(1,5) = 0.7071067811865475*vd*Conj(TYd(2,1)) - 0.5*vS*vu*Conj(
      Yd(2,1))*Lambdax - 0.7071067811865475*vu*Conj(Yd(2,1))*Mu;
   ...
   mass_matrix_Sd(2,3) = 0.7071067811865475*vd*Conj(TYd(0,2)) - 0.5*vS*vu*Conj(
      Yd(0,2))*Lambdax - 0.7071067811865475*vu*Conj(Yd(0,2))*Mu;
   mass_matrix_Sd(2,4) = 0.7071067811865475*vd*Conj(TYd(1,2)) - 0.5*vS*vu*Conj(
      Yd(1,2))*Lambdax - 0.7071067811865475*vu*Conj(Yd(1,2))*Mu;
   mass_matrix_Sd(2,5) = 0.7071067811865475*vd*Conj(TYd(2,2)) - 0.5*vS*vu*Conj(
      Yd(2,2))*Lambdax - 0.7071067811865475*vu*Conj(Yd(2,2))*Mu;
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Sd, eigenvalue_error > precision * Abs
      (MSd(0)));
#else
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Sv, eigenvalue_error > precision * Abs
      (MSv(0)));
#else
...
Eigen::Matrix<double,6,6> CLASSNAME::get_mass_matrix_Su() const
{
   ...
   mass_matrix_Su(0,3) = 0.7071067811865475*vu*Conj(TYu(0,0)) - 0.5*vd*vS*Conj(
      Yu(0,0))*Lambdax - 0.7071067811865475*vd*Conj(Yu(0,0))*Mu;
   mass_matrix_Su(0,4) = 0.7071067811865475*vu*Conj(TYu(1,0)) - 0.5*vd*vS*Conj(
      Yu(1,0))*Lambdax - 0.7071067811865475*vd*Conj(Yu(1,0))*Mu;
   mass_matrix_Su(0,5) = 0.7071067811865475*vu*Conj(TYu(2,0)) - 0.5*vd*vS*Conj(
      Yu(2,0))*Lambdax - 0.7071067811865475*vd*Conj(Yu(2,0))*Mu;
   ...
   mass_matrix_Su(1,3) = 0.7071067811865475*vu*Conj(TYu(0,1)) - 0.5*vd*vS*Conj(
      Yu(0,1))*Lambdax - 0.7071067811865475*vd*Conj(Yu(0,1))*Mu;
   mass_matrix_Su(1,4) = 0.7071067811865475*vu*Conj(TYu(1,1)) - 0.5*vd*vS*Conj(
      Yu(1,1))*Lambdax - 0.7071067811865475*vd*Conj(Yu(1,1))*Mu;
   mass_matrix_Su(1,5) = 0.7071067811865475*vu*Conj(TYu(2,1)) - 0.5*vd*vS*Conj(
      Yu(2,1))*Lambdax - 0.7071067811865475*vd*Conj(Yu(2,1))*Mu;
   ...
   mass_matrix_Su(2,3) = 0.7071067811865475*vu*Conj(TYu(0,2)) - 0.5*vd*vS*Conj(
      Yu(0,2))*Lambdax - 0.7071067811865475*vd*Conj(Yu(0,2))*Mu;
   mass_matrix_Su(2,4) = 0.7071067811865475*vu*Conj(TYu(1,2)) - 0.5*vd*vS*Conj(
      Yu(1,2))*Lambdax - 0.7071067811865475*vd*Conj(Yu(1,2))*Mu;
   mass_matrix_Su(2,5) = 0.7071067811865475*vu*Conj(TYu(2,2)) - 0.5*vd*vS*Conj(
      Yu(2,2))*Lambdax - 0.7071067811865475*vd*Conj(Yu(2,2))*Mu;
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Su, eigenvalue_error > precision * Abs
      (MSu(0)));
#else
...
Eigen::Matrix<double,6,6> CLASSNAME::get_mass_matrix_Se() const
{
   ...
   mass_matrix_Se(0,3) = 0.7071067811865475*vd*Conj(TYe(0,0)) - 0.5*vS*vu*Conj(
      Ye(0,0))*Lambdax - 0.7071067811865475*vu*Conj(Ye(0,0))*Mu;
   mass_matrix_Se(0,4) = 0.7071067811865475*vd*Conj(TYe(1,0)) - 0.5*vS*vu*Conj(
      Ye(1,0))*Lambdax - 0.7071067811865475*vu*Conj(Ye(1,0))*Mu;
   mass_matrix_Se(0,5) = 0.7071067811865475*vd*Conj(TYe(2,0)) - 0.5*vS*vu*Conj(
      Ye(2,0))*Lambdax - 0.7071067811865475*vu*Conj(Ye(2,0))*Mu;
   ...
   mass_matrix_Se(1,3) = 0.7071067811865475*vd*Conj(TYe(0,1)) - 0.5*vS*vu*Conj(
      Ye(0,1))*Lambdax - 0.7071067811865475*vu*Conj(Ye(0,1))*Mu;
   mass_matrix_Se(1,4) = 0.7071067811865475*vd*Conj(TYe(1,1)) - 0.5*vS*vu*Conj(
      Ye(1,1))*Lambdax - 0.7071067811865475*vu*Conj(Ye(1,1))*Mu;
   mass_matrix_Se(1,5) = 0.7071067811865475*vd*Conj(TYe(2,1)) - 0.5*vS*vu*Conj(
      Ye(2,1))*Lambdax - 0.7071067811865475*vu*Conj(Ye(2,1))*Mu;
   ...
   mass_matrix_Se(2,3) = 0.7071067811865475*vd*Conj(TYe(0,2)) - 0.5*vS*vu*Conj(
      Ye(0,2))*Lambdax - 0.7071067811865475*vu*Conj(Ye(0,2))*Mu;
   mass_matrix_Se(2,4) = 0.7071067811865475*vd*Conj(TYe(1,2)) - 0.5*vS*vu*Conj(
      Ye(1,2))*Lambdax - 0.7071067811865475*vu*Conj(Ye(1,2))*Mu;
   mass_matrix_Se(2,5) = 0.7071067811865475*vd*Conj(TYe(2,2)) - 0.5*vS*vu*Conj(
      Ye(2,2))*Lambdax - 0.7071067811865475*vu*Conj(Ye(2,2))*Mu;
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Se, eigenvalue_error > precision * Abs
      (MSe(0)));
#else
...
Eigen::Matrix<double,3,3> CLASSNAME::get_mass_matrix_hh() const
{
   ...
   mass_matrix_hh(0,0) = mHd2 + AbsSqr(Mu) + 0.7071067811865475*vS*Conj(Mu)*
      Lambdax + 0.7071067811865475*vS*Conj(Lambdax)*Mu + 0.225*Sqr(g1)*Sqr(vd)
      + 0.375*Sqr(g2)*Sqr(vd) + 0.5*AbsSqr(Lambdax)*Sqr(vS) + 0.5*AbsSqr(
      Lambdax)*Sqr(vu) - 0.075*Sqr(g1)*Sqr(vu) - 0.125*Sqr(g2)*Sqr(vu);
   mass_matrix_hh(0,1) = vd*vu*AbsSqr(Lambdax) - 0.5*BMu - 0.5*Conj(BMu) - 0.5*
      L1*Conj(Lambdax) - 0.35355339059327373*MS*vS*Conj(Lambdax) -
   ...
   mass_matrix_hh(0,2) = vd*vS*AbsSqr(Lambdax) - 0.35355339059327373*MS*vu*Conj
      (Lambdax) - 0.35355339059327373*vu*Conj(TLambdax) - 0.5*vS*vu*Conj(
      Lambdax)*Kappa - 0.35355339059327373*vu*Conj(MS)*Lambdax - 0.5*vS*vu*Conj
      (Kappa)*Lambdax + 0.7071067811865475*vd*Conj(Mu)*Lambdax +
      0.7071067811865475*vd*Conj(Lambdax)*Mu - 0.35355339059327373*vu*TLambdax;
   mass_matrix_hh(1,1) = mHu2 + AbsSqr(Mu) + 0.7071067811865475*vS*Conj(Mu)*
      Lambdax + 0.7071067811865475*vS*Conj(Lambdax)*Mu + 0.5*AbsSqr(Lambdax)*
      Sqr(vd) - 0.075*Sqr(g1)*Sqr(vd) - 0.125*Sqr(g2)*Sqr(vd) + 0.5*AbsSqr(
      Lambdax)*Sqr(vS) + 0.225*Sqr(g1)*Sqr(vu) + 0.375*Sqr(g2)*Sqr(vu);
   mass_matrix_hh(1,2) = vS*vu*AbsSqr(Lambdax) - 0.35355339059327373*MS*vd*Conj
      (Lambdax) - 0.35355339059327373*vd*Conj(TLambdax) - 0.5*vd*vS*Conj(
      Lambdax)*Kappa - 0.35355339059327373*vd*Conj(MS)*Lambdax - 0.5*vd*vS*Conj
      (Kappa)*Lambdax + 0.7071067811865475*vu*Conj(Mu)*Lambdax +
      0.7071067811865475*vu*Conj(Lambdax)*Mu - 0.35355339059327373*vd*TLambdax;
   mass_matrix_hh(2,2) = ms2 + AbsSqr(MS) + 0.5*BMS + 0.5*Conj(BMS) + L1*Conj(
      Kappa) + 2.1213203435596424*MS*vS*Conj(Kappa) + 0.7071067811865475*vS*
      Conj(TKappa) + Conj(L1)*Kappa + 2.1213203435596424*vS*Conj(MS)*Kappa -
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::hh, eigenvalue_error > precision * Abs
      (Mhh(0)));
#else
...
Eigen::Matrix<double,3,3> CLASSNAME::get_mass_matrix_Ah() const
{
   ...
   mass_matrix_Ah(0,0) = mHd2 + AbsSqr(Mu) + 0.7071067811865475*vS*Conj(Mu)*
      Lambdax + 0.7071067811865475*vS*Conj(Lambdax)*Mu + 0.3872983346207417*g1*
      g2*Cos(ThetaW())*Sin(ThetaW())*Sqr(vd) + 0.075*Sqr(g1)*Sqr(vd) + 0.125*
      Sqr(g2)*Sqr(vd) + 0.5*AbsSqr(Lambdax)*Sqr(vS) + 0.5*AbsSqr(Lambdax)*Sqr(
      vu) - 0.075*Sqr(g1)*Sqr(vu) - 0.125*Sqr(g2)*Sqr(vu) + 0.25*Sqr(g2)*Sqr(vd
      )*Sqr(Cos(ThetaW())) + 0.15*Sqr(g1)*Sqr(vd)*Sqr(Sin(ThetaW()));
   ...
   mass_matrix_Ah(1,1) = mHu2 + AbsSqr(Mu) + 0.7071067811865475*vS*Conj(Mu)*
      Lambdax + 0.7071067811865475*vS*Conj(Lambdax)*Mu + 0.5*AbsSqr(Lambdax)*
      Sqr(vd) - 0.075*Sqr(g1)*Sqr(vd) - 0.125*Sqr(g2)*Sqr(vd) + 0.5*AbsSqr(
   ...
   mass_matrix_Ah(2,2) = ms2 + AbsSqr(MS) - 0.5*BMS - 0.5*Conj(BMS) - L1*Conj(
      Kappa) + 0.7071067811865475*MS*vS*Conj(Kappa) - 0.7071067811865475*vS*
      Conj(TKappa) - Conj(L1)*Kappa + 0.7071067811865475*vS*Conj(MS)*Kappa +
      0.5*vd*vu*Conj(Lambdax)*Kappa + 0.5*vd*vu*Conj(Kappa)*Lambdax + 0.5*
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Ah, eigenvalue_error > precision * Abs
      (MAh(0)));
#else
...
Eigen::Matrix<double,2,2> CLASSNAME::get_mass_matrix_Hpm() const
{
   ...
   mass_matrix_Hpm(0,0) = mHd2 + AbsSqr(Mu) + 0.7071067811865475*vS*Conj(Mu)*
      Lambdax + 0.7071067811865475*vS*Conj(Lambdax)*Mu + 0.075*Sqr(g1)*Sqr(vd)
      + 0.375*Sqr(g2)*Sqr(vd) + 0.5*AbsSqr(Lambdax)*Sqr(vS) - 0.075*Sqr(g1)*Sqr
      (vu) + 0.125*Sqr(g2)*Sqr(vu);
   mass_matrix_Hpm(0,1) = -0.5*vd*vu*AbsSqr(Lambdax) + Conj(BMu) + L1*Conj(
      Lambdax) + 0.7071067811865475*MS*vS*Conj(Lambdax) + 0.7071067811865475*vS
      *Conj(TLambdax) + 0.5*Conj(Lambdax)*Kappa*Sqr(vS);
   mass_matrix_Hpm(1,1) = mHu2 + AbsSqr(Mu) + 0.7071067811865475*vS*Conj(Mu)*
      Lambdax + 0.7071067811865475*vS*Conj(Lambdax)*Mu - 0.075*Sqr(g1)*Sqr(vd)
      + 0.125*Sqr(g2)*Sqr(vd) + 0.5*AbsSqr(Lambdax)*Sqr(vS) + 0.075*Sqr(g1)*Sqr
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Hpm, eigenvalue_error > precision *
      Abs(MHpm(0)));
#else
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Chi, eigenvalue_error > precision *
      Abs(MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Cha, eigenvalue_error > precision *
      Abs(MCha(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Fe, eigenvalue_error > precision * Abs
      (MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Fd, eigenvalue_error > precision * Abs
      (MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Fu, eigenvalue_error > precision * Abs
      (MFu(0)));
#else
...
double CLASSNAME::get_ewsb_eq_hh_3() const
{
   ...
   double result = Re(ms2*vS + vS*AbsSqr(MS) + 0.5*vS*BMS + 0.7071067811865475*MS*
      Conj(L1) + 0.7071067811865475*L1*Conj(MS) + 0.5*vS*Conj(BMS) + L1*vS*Conj(
...
std::complex<double> CLASSNAME::CpAhSdconjUSd(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*vS*
      ...
      *SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)
      ...
      Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))) - std::
      complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,Conj(ZD(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYd(j1,j2)));
...
std::complex<double> CLASSNAME::CphhSdconjUSd(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZD(gI1,gO2))*Conj(
      ...
      gO2 < 3,0.5*vS*Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(
      gI1,3 + j1))),0) + IF(gO2 < 3,0.5*vu*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,Conj
      (Yd(j1,gO2))*Conj(ZD(gI1,3 + j1))),0) + IF(gO2 < 3,0.7071067811865475*Conj(
      ZH(gI2,1))*Mu*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI1,3 + j1))),0) + IF(gO2
      < 3,-0.7071067811865475*Conj(ZH(gI2,0))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*Conj
      (TYd(j1,gO2))),0) + IF(gO2 < 3,-(vd*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZD(gI1,
      j2))*SUM(j1,0,2,Conj(Yd(j1,gO2))*Yd(j1,j2)))),0) + 0.1*vd*Conj(ZH(gI2,0))*
      Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) - 0.1*vu
      *Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*KroneckerDelta(gO2,
      3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZD(gI1,j2))*
      SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))) + 0.7071067811865475*Conj(
      Mu)*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(
      gO2,3 + j1)*Yd(j1,j2))) + 0.5*vu*Conj(Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,
      Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))) -
      0.7071067811865475*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*TYd(j1,j2))) - vd*Conj(ZH(gI2,0))*SUM(j3,0,2,Conj
      (ZD(gI1,3 + j3))*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yd(j3
      ,j1))*Yd(j2,j1))));
...
std::complex<double> CLASSNAME::CpSeconjHpmconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZE(
      ...
      gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(
      ZE(gI2,3 + j1)))*ZP(gI1,1),0);
...
std::complex<double> CLASSNAME::CphhSvconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gI1 < 3,-0.15*vd*Conj(ZH(gI2,0))*Conj(ZV
      (gI1,gO2))*Sqr(g1),0) + IF(gI1 < 3,0.15*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,gO2))
      *Sqr(g1),0) + IF(gI1 < 3,-0.25*vd*Conj(ZH(gI2,0))*Conj(ZV(gI1,gO2))*Sqr(g2),
      0) + IF(gI1 < 3,0.25*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,gO2))*Sqr(g2),0);
...
std::complex<double> CLASSNAME::CpSdconjHpmconjUSu(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZD(
      ...
      gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(
      ZD(gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CpAhSuconjUSu(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*vS*
      ...
      *SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)
      ...
      Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))) - std::
      complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,1))*SUM(j2,0,2,Conj(ZU(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYu(j1,j2)));
...
std::complex<double> CLASSNAME::CphhSuconjUSu(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZH(gI2,0))*Conj(ZU(
      ...
      *Sqr(g1),0) + IF(gO2 < 3,-0.25*vd*Conj(ZH(gI2,0))*Conj(ZU(gI1,gO2))*Sqr(g2),
      ...
      gO2 < 3,0.5*vS*Conj(ZH(gI2,0))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(
      gI1,3 + j1))),0) + IF(gO2 < 3,0.5*vd*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,Conj
      (Yu(j1,gO2))*Conj(ZU(gI1,3 + j1))),0) + IF(gO2 < 3,0.7071067811865475*Conj(
      ZH(gI2,0))*Mu*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1))),0) + IF(gO2
      < 3,-0.7071067811865475*Conj(ZH(gI2,1))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj
      (TYu(j1,gO2))),0) + IF(gO2 < 3,-(vu*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZU(gI1,
      j2))*SUM(j1,0,2,Conj(Yu(j1,gO2))*Yu(j1,j2)))),0) - 0.2*vd*Conj(ZH(gI2,0))*
      Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) + 0.2*vu
      *Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*KroneckerDelta(gO2,
      3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZU(gI1,j2))*
      SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))) + 0.7071067811865475*Conj(
      Mu)*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(
      gO2,3 + j1)*Yu(j1,j2))) + 0.5*vd*Conj(Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,
      Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))) -
      0.7071067811865475*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*TYu(j1,j2))) - vu*Conj(ZH(gI2,1))*SUM(j3,0,2,Conj
      (ZU(gI1,3 + j3))*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yu(j3
      ,j1))*Yu(j2,j1))));
...
std::complex<double> CLASSNAME::CpHpmSvconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(ZV(
      ...
      SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZP(gI2,1) + Conj(Mu)*SUM(
      j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZP
      (gI2,1);
...
std::complex<double> CLASSNAME::CpAhSeconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*vS*
      ...
      *SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)
      ...
      Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))) - std::
      complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,Conj(ZE(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYe(j1,j2)));
...
std::complex<double> CLASSNAME::CphhSeconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2))*Conj(
      ...
      *Sqr(g1),0) + IF(gO2 < 3,0.25*vd*Conj(ZE(gI1,gO2))*Conj(ZH(gI2,0))*Sqr(g2),0
      ...
      gO2 < 3,0.5*vS*Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(
      gI1,3 + j1))),0) + IF(gO2 < 3,0.5*vu*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,Conj
      (Ye(j1,gO2))*Conj(ZE(gI1,3 + j1))),0) + IF(gO2 < 3,0.7071067811865475*Conj(
      ZH(gI2,1))*Mu*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 + j1))),0) + IF(gO2
      < 3,-0.7071067811865475*Conj(ZH(gI2,0))*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*Conj
      (TYe(j1,gO2))),0) + IF(gO2 < 3,-(vd*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZE(gI1,
      j2))*SUM(j1,0,2,Conj(Ye(j1,gO2))*Ye(j1,j2)))),0) + 0.3*vd*Conj(ZH(gI2,0))*
      Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) - 0.3*vu
      *Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*KroneckerDelta(gO2,
      3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZE(gI1,j2))*
      SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))) + 0.7071067811865475*Conj(
      Mu)*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(
      gO2,3 + j1)*Ye(j1,j2))) + 0.5*vu*Conj(Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,
      Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))) -
      0.7071067811865475*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*TYe(j1,j2))) - vd*Conj(ZH(gI2,0))*SUM(j3,0,2,Conj
      (ZE(gI1,3 + j3))*SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Ye(j3
      ,j1))*Ye(j2,j1))));
...
std::complex<double> CLASSNAME::CpAhAhUhh(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(5*Conj(ZA(gI1,2))*(1.4142135623730951
      *MS*Conj(Lambdax)*Conj(ZA(gI2,1))*KroneckerDelta(0,gO2) - 1.4142135623730951
      *Conj(TLambdax)*Conj(ZA(gI2,1))*KroneckerDelta(0,gO2) - 4*vd*AbsSqr(Lambdax)
      *Conj(ZA(gI2,2))*KroneckerDelta(0,gO2) + 1.4142135623730951*MS*Conj(Lambdax)
      *Conj(ZA(gI2,0))*KroneckerDelta(1,gO2) - 1.4142135623730951*Conj(TLambdax)*
      Conj(ZA(gI2,0))*KroneckerDelta(1,gO2) - 4*vu*AbsSqr(Lambdax)*Conj(ZA(gI2,2))
      *KroneckerDelta(1,gO2) + 2.8284271247461903*Conj(TKappa)*Conj(ZA(gI2,2))*
      KroneckerDelta(2,gO2) + 2*vS*Conj(Lambdax)*Conj(ZA(gI2,1))*KroneckerDelta(0,
      gO2)*Kappa - 2*vu*Conj(Lambdax)*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2)*Kappa
      + 2*vS*Conj(Lambdax)*Conj(ZA(gI2,0))*KroneckerDelta(1,gO2)*Kappa - 2*vd*Conj
      (Lambdax)*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*Kappa + 2*vu*Conj(Lambdax)*
      Conj(ZA(gI2,0))*KroneckerDelta(2,gO2)*Kappa + 2*vd*Conj(Lambdax)*Conj(ZA(gI2
      ,1))*KroneckerDelta(2,gO2)*Kappa + 1.4142135623730951*Conj(MS)*(-2*Conj(ZA(
      gI2,2))*KroneckerDelta(2,gO2)*Kappa + Conj(ZA(gI2,1))*KroneckerDelta(0,gO2)*
      ...
      1.4142135623730951*Conj(ZA(gI2,0))*KroneckerDelta(1,gO2)*TLambdax) + Conj(ZA
      (gI1,1))*(Conj(ZA(gI2,1))*(-10*KroneckerDelta(2,gO2)*(2*vS*AbsSqr(Lambdax) +
      1.4142135623730951*Conj(Mu)*Lambdax + 1.4142135623730951*Conj(Lambdax)*Mu) -
      vu*KroneckerDelta(1,gO2)*(3*Sqr(g1) + 5*Sqr(g2)) + vd*KroneckerDelta(0,gO2)*
      (-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))) + 5*(1.4142135623730951*MS*
      Conj(Lambdax)*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2) - 1.4142135623730951*
      ...
      *Conj(Lambdax)*Conj(ZA(gI2,0))*KroneckerDelta(2,gO2) - 1.4142135623730951*
      ...
      + 1.4142135623730951*Conj(Mu)*Lambdax + 1.4142135623730951*Conj(Lambdax)*Mu)
      + vu*KroneckerDelta(1,gO2)*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2)) + vd
      *KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2))) - 5*(1.4142135623730951*MS*
...
std::complex<double> CLASSNAME::CphhhhUhh(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-5*Conj(ZH(gI1,2))*(-
      ...
      *vd*Lambdax) + 2*KroneckerDelta(0,gO2)*(2*vS*Lambdax + 1.4142135623730951*Mu
      ...
      1.4142135623730951*Conj(Mu)*Lambdax + 1.4142135623730951*Conj(Lambdax)*Mu) -
      3*vu*KroneckerDelta(1,gO2)*(3*Sqr(g1) + 5*Sqr(g2)) + vd*KroneckerDelta(0,gO2
      )*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))) + 5*Conj(ZH(gI2,2))*(
...
std::complex<double> CLASSNAME::CpUhhSeconjSe(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(10*vu*KroneckerDelta(2,gO2)*(Conj(
      ...
      j1)))*ZE(gI1,j2))))) - KroneckerDelta(0,gO2)*(vd*(3*Sqr(g1) - 5*Sqr(g2))*SUM
      (j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 6*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI2,3
       + j1))*ZE(gI1,3 + j1)) + 10*(1.4142135623730951*SUM(j2,0,2,Conj(ZE(gI2,j2))
      *SUM(j1,0,2,ZE(gI1,3 + j1)*TYe(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(
      j1,0,2,Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gI1,j2)) + 2*vd*(SUM(j3,0,2
      ,Conj(ZE(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(
      gI1,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj(Ye(j1
      ,j3))*Ye(j1,j2)))*ZE(gI1,j3))))));
...
std::complex<double> CLASSNAME::CpAhUhhVZ(int gI2, int gO2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(Conj(ZA(gI2,0)
      )*KroneckerDelta(0,gO2) - Conj(ZA(gI2,1))*KroneckerDelta(1,gO2))*(5*g2*Cos(
...
std::complex<double> CLASSNAME::CpUAhHpmconjHpm(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*(
      ...
      *ZP(gI1,0)*ZP(gI2,1) - vd*KroneckerDelta(1,gO2)*Sqr(g2)*ZP(gI1,0)*ZP(gI2,1)
      ...
      1))) + KroneckerDelta(2,gO2)*(1.4142135623730951*Mu*ZP(gI1,1)*ZP(gI2,1) + ZP
      (gI1,0)*(1.4142135623730951*Mu*ZP(gI2,0) - (1.4142135623730951*MS + 2*vS*
      Kappa)*ZP(gI2,1)))));
...
std::complex<double> CLASSNAME::CpUAhhhVZ(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(Conj(ZH(gI2,0)
      )*KroneckerDelta(0,gO2) - Conj(ZH(gI2,1))*KroneckerDelta(1,gO2))*(5*g2*Cos(
      ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()));
...
std::complex<double> CLASSNAME::CphhHpmconjUHpm(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-(Conj(ZH(gI2,0))*(KroneckerDelta(0,
      gO2)*(vd*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,0) + 5*vu*(-2*AbsSqr(Lambdax) + Sqr(
      g2))*ZP(gI1,1)) + KroneckerDelta(1,gO2)*(5*vu*(-2*AbsSqr(Lambdax) + Sqr(g2))
      *ZP(gI1,0) + vd*(-3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,1)))) + Conj(ZH(gI2,1))*(
...
std::complex<double> CLASSNAME::CpSdconjUHpmconjSu(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = KroneckerDelta(0,gO2)*(-0.35355339059327373
      *vd*Sqr(g2)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZU(gI1,j1)) + 0.7071067811865475*vS*
      Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1
      ))) + Conj(Mu)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 +
      j1))) + SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2)))*ZU(gI1,
      j2)) + 0.7071067811865475*vu*SUM(j3,0,2,Conj(ZD(gI2,3 + j3))*SUM(j2,0,2,SUM(
      j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gI1,3 + j2))) + 0.7071067811865475*vd*
      SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2))
      )*ZU(gI1,j3))) - 0.25*KroneckerDelta(1,gO2)*(1.4142135623730951*vu*Sqr(g2)*
      SUM(j1,0,2,Conj(ZD(gI2,j1))*ZU(gI1,j1)) - 2*(2*SUM(j2,0,2,Conj(ZD(gI2,j2))*
      SUM(j1,0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) + (1.4142135623730951*vS*Lambdax + 2*
...
std::complex<double> CLASSNAME::CpAhhhVZ(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(Conj(ZA(gI2,0)
      )*Conj(ZH(gI1,0)) - Conj(ZA(gI2,1))*Conj(ZH(gI1,1)))*(g2*Cos(ThetaW()) +
...
std::complex<double> CLASSNAME::CpChiUChihhPL(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = 0.1*(7.0710678118654755*Conj(ZH(gI1,2))*(-2
      *Conj(ZN(gI2,4))*KroneckerDelta(4,gO2)*Kappa + Conj(ZN(gI2,3))*
...
std::complex<double> CLASSNAME::CpChiUChihhPR(int gI2, int gO1, int gI1) const
{
   ...
   const std::complex<double> result = 0.1*(Conj(ZH(gI1,0))*(KroneckerDelta(2,gO1)
      *(3.872983346207417*g1*ZN(gI2,0) - 5*g2*ZN(gI2,1)) + 3.872983346207417*g1*
      KroneckerDelta(0,gO1)*ZN(gI2,2) - 5*g2*KroneckerDelta(1,gO1)*ZN(gI2,2) +
...
std::complex<double> CLASSNAME::CpbarFdChiSdPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*(SUM(j1,0,2,Conj(ZD(gI1
      ,j1))*ZDL(gO1,j1))*(-1.0954451150103321*g1*ZN(gI2,0) + 4.242640687119286*g2*
      ZN(gI2,1)) - 6*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gI1,3 + j1)))*
      ZDL(gO1,j2))*ZN(gI2,2));
...
std::complex<double> CLASSNAME::CpbarFuChiSuPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*(-1.4142135623730951*
      ...
      3*g2*ZN(gI2,1)) - 6*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gI1,3 + j1
      )))*ZUL(gO1,j2))*ZN(gI2,3));
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(NUTSMSSM_info::hh, eigenvalue_error >
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(NUTSMSSM_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
