...
// File generated at Wed 12 Apr 2017 13:01:14
 ...
 * parameters.
 *
 * This file was generated at Wed 12 Apr 2017 13:01:14 with FlexibleSUSY
...
#define CLASSNAME NUTSMSSM_mass_eigenstates
...
CLASSNAME::NUTSMSSM_mass_eigenstates(const NUTSMSSM_input_parameters& input_)
   : NUTSMSSM_soft_parameters(input_)
   ...
   , physical()
   , problems(NUTSMSSM_info::particle_names)
...
CLASSNAME::~NUTSMSSM_mass_eigenstates()
{
}
...
const NUTSMSSM_physical& CLASSNAME::get_physical() const
{
   return physical;
}

NUTSMSSM_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const NUTSMSSM_physical& physical_)
{
   physical = physical_;
}

const Problems<NUTSMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<NUTSMSSM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   NUTSMSSM_mass_eigenstates* model = ewsb_args->model;
...
Eigen::Matrix<double, CLASSNAME::number_of_ewsb_equations, 1> CLASSNAME::ewsb_step() const
{
   ...
   mHd2 = Re((0.025*(-40*vd*AbsSqr(Mu) + 20*vu*BMu + 20*vu*Conj(BMu) + 20*L1*vu
      *Conj(Lambdax) + 14.142135623730951*MS*vS*vu*Conj(Lambdax) +
      14.142135623730951*vS*vu*Conj(TLambdax) + 20*vu*Conj(L1)*Lambdax +
      14.142135623730951*vS*vu*Conj(MS)*Lambdax - 28.284271247461902*vd*vS*Conj(Mu
      )*Lambdax - 28.284271247461902*vd*vS*Conj(Lambdax)*Mu + 40*tadpole[0] - 3*
   ...
   mHu2 = Re((0.025*(-40*vu*AbsSqr(Mu) + 20*vd*BMu + 20*vd*Conj(BMu) + 20*L1*vd
      *Conj(Lambdax) + 14.142135623730951*MS*vd*vS*Conj(Lambdax) +
      14.142135623730951*vd*vS*Conj(TLambdax) + 20*vd*Conj(L1)*Lambdax +
      14.142135623730951*vd*vS*Conj(MS)*Lambdax - 28.284271247461902*vS*vu*Conj(Mu
      )*Lambdax - 28.284271247461902*vS*vu*Conj(Lambdax)*Mu + 40*tadpole[1] - 3*
   ...
   ms2 = Re((0.25*(-4*vS*AbsSqr(MS) - 4*Power(vS,3)*AbsSqr(Kappa) - 2*vS*BMS -
      ...
      2.8284271247461903*Conj(LL1) + 1.4142135623730951*vd*vu*Conj(TLambdax) - 4*
      vS*Conj(L1)*Kappa + 2*vd*vS*vu*Conj(Lambdax)*Kappa + 1.4142135623730951*vd*
      vu*Conj(MS)*Lambdax + 2*vd*vS*vu*Conj(Kappa)*Lambdax + 4*tadpole[2] -
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "NUTSMSSM\n"
           "========================================\n";
   NUTSMSSM_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_tachyon(NUTSMSSM_info::Hpm);
...
{
   NUTSMSSM_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   NUTSMSSM_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(NUTSMSSM_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = NUTSMSSM_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = NUTSMSSM_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Sd, eigenvalue_error > precision
      * Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Sv, eigenvalue_error > precision
      * Abs(MSv(0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Su, eigenvalue_error > precision
      * Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Se, eigenvalue_error > precision
      * Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::hh, eigenvalue_error > precision
      * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Ah, eigenvalue_error > precision
      * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Hpm, eigenvalue_error >
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Fe, eigenvalue_error > precision
      * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Fd, eigenvalue_error > precision
      * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(NUTSMSSM_info::Fu, eigenvalue_error > precision
      * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_tachyon(NUTSMSSM_info::VWm);
   }
...
std::complex<double> CLASSNAME::CpUSdconjUSdconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_112 += KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1);
      }
      tmp_110 += tmp_112;
      ...
      for (unsigned j4 = 0; j4 < 3; ++j4) {
         ...
         for (unsigned j3 = 0; j3 < 3; ++j3) {
            tmp_115 += Conj(Yd(j3,j4))*Conj(ZD(gI2,3 + j3));
         }
         tmp_114 += tmp_115;
         tmp_113 += (ZD(gI1,j4)) * tmp_114;
      }
      tmp_111 += tmp_113;
      result += (-3) * tmp_110 * tmp_111;
   }
   if (gO1 < 3) {
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_121 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
      }
      tmp_120 += tmp_121;
   ...
   if (gO1 < 3) {
      ...
      tmp_122 += tmp_123;
      result += (-0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_122;
   }
   if (gO1 < 3) {
      ...
      tmp_124 += tmp_125;
      result += (-0.375*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_124;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_126;
      std::complex<double> tmp_127;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_127 += Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2);
      }
      tmp_126 += tmp_127;
      result += (-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_126;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUSdconjUSdconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_172 += KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1);
      }
      tmp_170 += tmp_172;
      ...
      for (unsigned j4 = 0; j4 < 3; ++j4) {
         ...
         for (unsigned j3 = 0; j3 < 3; ++j3) {
            tmp_175 += Conj(Ye(j3,j4))*Conj(ZE(gI2,3 + j3));
         }
         tmp_174 += tmp_175;
         tmp_173 += (ZE(gI1,j4)) * tmp_174;
      }
      tmp_171 += tmp_173;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_181 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
      }
      tmp_180 += tmp_181;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_187 += Conj(ZE(gI2,3 + j2))*ZE(gI1,3 + j2);
      }
      tmp_186 += tmp_187;
      result += (-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_186;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUSuconjUSuconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_596 += KroneckerDelta(gO2,3 + j1)*Yu(j1,gO1);
      }
      tmp_594 += tmp_596;
      ...
      for (unsigned j4 = 0; j4 < 3; ++j4) {
         ...
         for (unsigned j3 = 0; j3 < 3; ++j3) {
            tmp_599 += Conj(Yu(j3,j4))*Conj(ZU(gI2,3 + j3));
         }
         tmp_598 += tmp_599;
         tmp_597 += (ZU(gI1,j4)) * tmp_598;
      }
      tmp_595 += tmp_597;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_601 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
      }
      tmp_600 += tmp_601;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_603 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
      }
      tmp_602 += tmp_603;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_605 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
      }
      tmp_604 += tmp_605;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_607 += Conj(ZU(gI2,j2))*ZU(gI1,j2);
      }
      tmp_606 += tmp_607;
      result += (-0.025*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_606;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_608;
      std::complex<double> tmp_609;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_609 += Conj(ZU(gI2,j2))*ZU(gI1,j2);
      }
      tmp_608 += tmp_609;
      result += (-0.375*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_608;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_610;
      std::complex<double> tmp_611;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_611 += Conj(ZU(gI2,3 + j2))*ZU(gI1,3 + j2);
      }
      tmp_610 += tmp_611;
      result += (0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_610;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_742 += KroneckerDelta(gO2,3 + j1)*Ye(j1,j2);
      }
      tmp_741 += tmp_742;
      tmp_740 += (Conj(ZV(gI2,j2))) * tmp_741;
   }
   tmp_738 += tmp_740;
   ...
   for (unsigned j4 = 0; j4 < 3; ++j4) {
      ...
      for (unsigned j3 = 0; j3 < 3; ++j3) {
         tmp_745 += Conj(Ye(j3,j4))*KroneckerDelta(gO1,3 + j3);
      }
      tmp_744 += tmp_745;
      tmp_743 += (ZV(gI1,j4)) * tmp_744;
   }
   tmp_739 += tmp_743;
   result += (-1) * tmp_738 * tmp_739;
   std::complex<double> tmp_746;
   std::complex<double> tmp_747;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_747 += KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1);
   }
   tmp_746 += tmp_747;
   result += (0.3*KroneckerDelta(gI1,gI2)*Sqr(g1)) * tmp_746;
   if (gO1 < 3) {
      result += -0.15*KroneckerDelta(gI1,gI2)*KroneckerDelta(gO1,gO2)*Sqr(g1
         );
   }
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_812 += KroneckerDelta(gO2,3 + j1)*Ye(j1,gO1);
      }
      tmp_810 += tmp_812;
      ...
      for (unsigned j4 = 0; j4 < 3; ++j4) {
         ...
         for (unsigned j3 = 0; j3 < 3; ++j3) {
            tmp_815 += Conj(Yd(j3,j4))*Conj(ZD(gI2,3 + j3));
         }
         tmp_814 += tmp_815;
         tmp_813 += (ZD(gI1,j4)) * tmp_814;
      }
      tmp_811 += tmp_813;
      result += (-1) * tmp_810 * tmp_811;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_816;
      std::complex<double> tmp_817;
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_817 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
      }
      tmp_816 += tmp_817;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_819 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
      }
      tmp_818 += tmp_819;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_821 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
      }
      tmp_820 += tmp_821;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_823 += Conj(ZD(gI2,j2))*ZD(gI1,j2);
      }
      tmp_822 += tmp_823;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_825 += Conj(ZD(gI2,j2))*ZD(gI1,j2);
      }
      tmp_824 += tmp_825;
      result += (-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_824;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_826;
      std::complex<double> tmp_827;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_827 += Conj(ZD(gI2,3 + j2))*ZD(gI1,3 + j2);
      }
      tmp_826 += tmp_827;
      result += (0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_826;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUSeconjUSeconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_868 += KroneckerDelta(gO2,3 + j1)*Ye(j1,gO1);
      }
      tmp_866 += tmp_868;
      ...
      for (unsigned j4 = 0; j4 < 3; ++j4) {
         ...
         for (unsigned j3 = 0; j3 < 3; ++j3) {
            tmp_871 += Conj(Ye(j3,j4))*Conj(ZE(gI2,3 + j3));
         }
         tmp_870 += tmp_871;
         tmp_869 += (ZE(gI1,j4)) * tmp_870;
      }
      tmp_867 += tmp_869;
      result += (-1) * tmp_866 * tmp_867;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_872;
      std::complex<double> tmp_873;
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_873 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
      }
      tmp_872 += tmp_873;
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_877 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
      }
      tmp_876 += tmp_877;
   ...
   if (gO1 < 3) {
      ...
      tmp_878 += tmp_879;
      result += (-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_878;
   }
   if (gO1 < 3) {
      std::complex<double> tmp_880;
      std::complex<double> tmp_881;
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_881 += Conj(ZE(gI2,j2))*ZE(gI1,j2);
      }
      tmp_880 += tmp_881;
      result += (-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)) * tmp_880;
   }
   if (gO1 < 3) {
      ...
      tmp_882 += tmp_883;
      result += (0.15*KroneckerDelta(gO1,gO2)*Sqr(g1)) * tmp_882;
   }
   if (gO2 < 3) {
...
std::complex<double> CLASSNAME::CpUhhUhhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1026 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1025 += tmp_1026;
   tmp_1020 += (std::complex<double>(0,0.1)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1025;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1032 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1031 += tmp_1032;
         tmp_1030 += (ZD(gI1,3 + j2)) * tmp_1031;
      }
      tmp_1029 += tmp_1030;
      tmp_1028 += (Conj(ZD(gI2,3 + j3))) * tmp_1029;
   }
   tmp_1027 += tmp_1028;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1038 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1037 += tmp_1038;
         tmp_1036 += (Conj(ZD(gI2,j2))) * tmp_1037;
      }
      tmp_1035 += tmp_1036;
      tmp_1034 += (ZD(gI1,j3)) * tmp_1035;
   }
   tmp_1033 += tmp_1034;
   tmp_1020 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1033;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1048 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1047 += tmp_1048;
      tmp_1046 += (Conj(ZD(gI2,j2))) * tmp_1047;
   }
   tmp_1045 += tmp_1046;
   tmp_1020 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2)
      *KroneckerDelta(2,gO1)) * tmp_1045;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1052 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1051 += tmp_1052;
      tmp_1050 += (ZD(gI1,j2)) * tmp_1051;
   }
   tmp_1049 += tmp_1050;
   tmp_1020 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1049;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1056 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1055 += tmp_1056;
      tmp_1054 += (Conj(ZD(gI2,j2))) * tmp_1055;
   }
   tmp_1053 += tmp_1054;
   tmp_1020 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1)
      *KroneckerDelta(2,gO2)) * tmp_1053;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1060 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1059 += tmp_1060;
      tmp_1058 += (ZD(gI1,j2)) * tmp_1059;
   }
   tmp_1057 += tmp_1058;
   tmp_1020 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1057;
...
std::complex<double> CLASSNAME::CpUhhUhhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1067 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1066 += tmp_1067;
   tmp_1061 += (std::complex<double>(0,0.3)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1066;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1073 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1072 += tmp_1073;
         tmp_1071 += (ZE(gI1,3 + j2)) * tmp_1072;
      }
      tmp_1070 += tmp_1071;
      tmp_1069 += (Conj(ZE(gI2,3 + j3))) * tmp_1070;
   }
   tmp_1068 += tmp_1069;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1079 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1078 += tmp_1079;
         tmp_1077 += (Conj(ZE(gI2,j2))) * tmp_1078;
      }
      tmp_1076 += tmp_1077;
      tmp_1075 += (ZE(gI1,j3)) * tmp_1076;
   }
   tmp_1074 += tmp_1075;
   tmp_1061 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1074;
   ...
   tmp_1061 += (std::complex<double>(0,0.15)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1080;
   ...
   tmp_1061 += (std::complex<double>(0,-0.25)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1082;
   ...
   tmp_1061 += (std::complex<double>(0,-0.3)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1084;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1089 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1088 += tmp_1089;
      tmp_1087 += (Conj(ZE(gI2,j2))) * tmp_1088;
   }
   tmp_1086 += tmp_1087;
   tmp_1061 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2)
      *KroneckerDelta(2,gO1)) * tmp_1086;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1093 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1092 += tmp_1093;
      tmp_1091 += (ZE(gI1,j2)) * tmp_1092;
   }
   tmp_1090 += tmp_1091;
   tmp_1061 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1090;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1097 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1096 += tmp_1097;
      tmp_1095 += (Conj(ZE(gI2,j2))) * tmp_1096;
   }
   tmp_1094 += tmp_1095;
   tmp_1061 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1)
      *KroneckerDelta(2,gO2)) * tmp_1094;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1101 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1100 += tmp_1101;
      tmp_1099 += (ZE(gI1,j2)) * tmp_1100;
   }
   tmp_1098 += tmp_1099;
   tmp_1061 += (std::complex<double>(0,0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1098;
...
std::complex<double> CLASSNAME::CpUhhUhhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1108 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1107 += tmp_1108;
   tmp_1102 += (std::complex<double>(0,-0.2)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1107;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1120 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1119 += tmp_1120;
         tmp_1118 += (ZU(gI1,3 + j2)) * tmp_1119;
      }
      tmp_1117 += tmp_1118;
      tmp_1116 += (Conj(ZU(gI2,3 + j3))) * tmp_1117;
   }
   tmp_1115 += tmp_1116;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1126 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_1125 += tmp_1126;
         tmp_1124 += (Conj(ZU(gI2,j2))) * tmp_1125;
      }
      tmp_1123 += tmp_1124;
      tmp_1122 += (ZU(gI1,j3)) * tmp_1123;
   }
   tmp_1121 += tmp_1122;
   tmp_1102 += (std::complex<double>(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta
      (1,gO2)) * tmp_1121;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1130 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1129 += tmp_1130;
      tmp_1128 += (Conj(ZU(gI2,j2))) * tmp_1129;
   }
   tmp_1127 += tmp_1128;
   tmp_1102 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(0,gO2)
      *KroneckerDelta(2,gO1)) * tmp_1127;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1134 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1133 += tmp_1134;
      tmp_1132 += (ZU(gI1,j2)) * tmp_1133;
   }
   tmp_1131 += tmp_1132;
   tmp_1102 += (std::complex<double>(0,0.5)*KroneckerDelta(0,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1131;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1138 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1137 += tmp_1138;
      tmp_1136 += (Conj(ZU(gI2,j2))) * tmp_1137;
   }
   tmp_1135 += tmp_1136;
   tmp_1102 += (std::complex<double>(0,0.5)*Conj(Lambdax)*KroneckerDelta(0,gO1)
      *KroneckerDelta(2,gO2)) * tmp_1135;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1142 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1141 += tmp_1142;
      tmp_1140 += (ZU(gI1,j2)) * tmp_1141;
   }
   tmp_1139 += tmp_1140;
   tmp_1102 += (std::complex<double>(0,0.5)*KroneckerDelta(0,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1139;
...
std::complex<double> CLASSNAME::CpUhhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1149 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1148 += tmp_1149;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1153 += ZD(gI1,3 + j1)*TYd(j1,j2);
      }
      tmp_1152 += tmp_1153;
      tmp_1151 += (Conj(ZD(gI2,j2))) * tmp_1152;
   }
   tmp_1150 += tmp_1151;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1157 += Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_1156 += tmp_1157;
      tmp_1155 += (ZD(gI1,j2)) * tmp_1156;
   }
   tmp_1154 += tmp_1155;
   tmp_1143 += (std::complex<double>(0.,-0.7071067811865475)*KroneckerDelta(0,
      gO2)) * tmp_1154;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1163 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1162 += tmp_1163;
         tmp_1161 += (ZD(gI1,3 + j2)) * tmp_1162;
      }
      tmp_1160 += tmp_1161;
      tmp_1159 += (Conj(ZD(gI2,3 + j3))) * tmp_1160;
   }
   tmp_1158 += tmp_1159;
   tmp_1143 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1158
      ;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1169 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1168 += tmp_1169;
         tmp_1167 += (Conj(ZD(gI2,j2))) * tmp_1168;
      }
      tmp_1166 += tmp_1167;
      tmp_1165 += (ZD(gI1,j3)) * tmp_1166;
   }
   tmp_1164 += tmp_1165;
   tmp_1143 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1164
      ;
   std::complex<double> tmp_1170;
   std::complex<double> tmp_1171;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1171 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1170 += tmp_1171;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1173 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1172 += tmp_1173;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1175 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1174 += tmp_1175;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1179 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1178 += tmp_1179;
      tmp_1177 += (Conj(ZD(gI2,j2))) * tmp_1178;
   }
   tmp_1176 += tmp_1177;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1187 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1186 += tmp_1187;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1195 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1194 += tmp_1195;
      tmp_1193 += (Conj(ZD(gI2,j2))) * tmp_1194;
   }
   tmp_1192 += tmp_1193;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1199 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1198 += tmp_1199;
      tmp_1197 += (ZD(gI1,j2)) * tmp_1198;
   }
   tmp_1196 += tmp_1197;
...
std::complex<double> CLASSNAME::CpUhhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1206 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1205 += tmp_1206;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1210 += ZE(gI1,3 + j1)*TYe(j1,j2);
      }
      tmp_1209 += tmp_1210;
      tmp_1208 += (Conj(ZE(gI2,j2))) * tmp_1209;
   }
   tmp_1207 += tmp_1208;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1214 += Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_1213 += tmp_1214;
      tmp_1212 += (ZE(gI1,j2)) * tmp_1213;
   }
   tmp_1211 += tmp_1212;
   tmp_1200 += (std::complex<double>(0.,-0.7071067811865475)*KroneckerDelta(0,
      gO2)) * tmp_1211;
   ...
   tmp_1215 += tmp_1216;
   tmp_1200 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1215
      ;
   ...
   tmp_1221 += tmp_1222;
   tmp_1200 += (std::complex<double>(0,-1)*vd*KroneckerDelta(0,gO2)) * tmp_1221
      ;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1236 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1235 += tmp_1236;
      tmp_1234 += (Conj(ZE(gI2,j2))) * tmp_1235;
   }
   tmp_1233 += tmp_1234;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1244 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1243 += tmp_1244;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1248 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1247 += tmp_1248;
      tmp_1246 += (ZE(gI1,j2)) * tmp_1247;
   }
   tmp_1245 += tmp_1246;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1252 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1251 += tmp_1252;
      tmp_1250 += (Conj(ZE(gI2,j2))) * tmp_1251;
   }
   tmp_1249 += tmp_1250;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1256 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1255 += tmp_1256;
      tmp_1254 += (ZE(gI1,j2)) * tmp_1255;
   }
   tmp_1253 += tmp_1254;
...
std::complex<double> CLASSNAME::CpUhhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1263 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1262 += tmp_1263;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1267 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1266 += tmp_1267;
      tmp_1265 += (Conj(ZU(gI2,j2))) * tmp_1266;
   }
   tmp_1264 += tmp_1265;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1271 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1270 += tmp_1271;
      tmp_1269 += (Conj(ZU(gI2,j2))) * tmp_1270;
   }
   tmp_1268 += tmp_1269;
   tmp_1257 += (std::complex<double>(0.,0.7071067811865475)*Conj(Mu)*
      KroneckerDelta(0,gO2)) * tmp_1268;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1275 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1274 += tmp_1275;
      tmp_1273 += (ZU(gI1,j2)) * tmp_1274;
   }
   tmp_1272 += tmp_1273;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1279 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1278 += tmp_1279;
      tmp_1277 += (ZU(gI1,j2)) * tmp_1278;
   }
   tmp_1276 += tmp_1277;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1281 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1280 += tmp_1281;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1283 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1282 += tmp_1283;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1285 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1284 += tmp_1285;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1289 += ZU(gI1,3 + j1)*TYu(j1,j2);
      }
      tmp_1288 += tmp_1289;
      tmp_1287 += (Conj(ZU(gI2,j2))) * tmp_1288;
   }
   tmp_1286 += tmp_1287;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1293 += Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2));
      }
      tmp_1292 += tmp_1293;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1299 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1298 += tmp_1299;
         tmp_1297 += (ZU(gI1,3 + j2)) * tmp_1298;
      }
      tmp_1296 += tmp_1297;
      tmp_1295 += (Conj(ZU(gI2,3 + j3))) * tmp_1296;
   }
   tmp_1294 += tmp_1295;
   tmp_1257 += (std::complex<double>(0,-1)*vu*KroneckerDelta(1,gO2)) * tmp_1294
      ;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1305 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_1304 += tmp_1305;
         tmp_1303 += (Conj(ZU(gI2,j2))) * tmp_1304;
      }
      tmp_1302 += tmp_1303;
      tmp_1301 += (ZU(gI1,j3)) * tmp_1302;
   }
   tmp_1300 += tmp_1301;
   tmp_1257 += (std::complex<double>(0,-1)*vu*KroneckerDelta(1,gO2)) * tmp_1300
      ;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1309 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1308 += tmp_1309;
      tmp_1307 += (Conj(ZU(gI2,j2))) * tmp_1308;
   }
   tmp_1306 += tmp_1307;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1313 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1312 += tmp_1313;
      tmp_1311 += (ZU(gI1,j2)) * tmp_1312;
   }
   tmp_1310 += tmp_1311;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1344 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1343 += tmp_1344;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1350 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1349 += tmp_1350;
         tmp_1348 += (ZD(gI1,3 + j2)) * tmp_1349;
      }
      tmp_1347 += tmp_1348;
      tmp_1346 += (Conj(ZD(gI2,3 + j3))) * tmp_1347;
   }
   tmp_1345 += tmp_1346;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1356 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1355 += tmp_1356;
         tmp_1354 += (Conj(ZD(gI2,j2))) * tmp_1355;
      }
      tmp_1353 += tmp_1354;
      tmp_1352 += (ZD(gI1,j3)) * tmp_1353;
   }
   tmp_1351 += tmp_1352;
   tmp_1338 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1351;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1366 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1365 += tmp_1366;
      tmp_1364 += (Conj(ZD(gI2,j2))) * tmp_1365;
   }
   tmp_1363 += tmp_1364;
   tmp_1338 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2
      )*KroneckerDelta(2,gO1)) * tmp_1363;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1370 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1369 += tmp_1370;
      tmp_1368 += (ZD(gI1,j2)) * tmp_1369;
   }
   tmp_1367 += tmp_1368;
   tmp_1338 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1367;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1374 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1373 += tmp_1374;
      tmp_1372 += (Conj(ZD(gI2,j2))) * tmp_1373;
   }
   tmp_1371 += tmp_1372;
   tmp_1338 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1
      )*KroneckerDelta(2,gO2)) * tmp_1371;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1378 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1377 += tmp_1378;
      tmp_1376 += (ZD(gI1,j2)) * tmp_1377;
   }
   tmp_1375 += tmp_1376;
   tmp_1338 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1375;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1385 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1384 += tmp_1385;
   tmp_1379 += (std::complex<double>(0,0.3)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1384;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1391 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1390 += tmp_1391;
         tmp_1389 += (ZE(gI1,3 + j2)) * tmp_1390;
      }
      tmp_1388 += tmp_1389;
      tmp_1387 += (Conj(ZE(gI2,3 + j3))) * tmp_1388;
   }
   tmp_1386 += tmp_1387;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1397 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1396 += tmp_1397;
         tmp_1395 += (Conj(ZE(gI2,j2))) * tmp_1396;
      }
      tmp_1394 += tmp_1395;
      tmp_1393 += (ZE(gI1,j3)) * tmp_1394;
   }
   tmp_1392 += tmp_1393;
   tmp_1379 += (std::complex<double>(0,-1)*KroneckerDelta(0,gO1)*KroneckerDelta
      (0,gO2)) * tmp_1392;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1407 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1406 += tmp_1407;
      tmp_1405 += (Conj(ZE(gI2,j2))) * tmp_1406;
   }
   tmp_1404 += tmp_1405;
   tmp_1379 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO2
      )*KroneckerDelta(2,gO1)) * tmp_1404;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1411 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1410 += tmp_1411;
      tmp_1409 += (ZE(gI1,j2)) * tmp_1410;
   }
   tmp_1408 += tmp_1409;
   tmp_1379 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1408;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1415 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1414 += tmp_1415;
      tmp_1413 += (Conj(ZE(gI2,j2))) * tmp_1414;
   }
   tmp_1412 += tmp_1413;
   tmp_1379 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(1,gO1
      )*KroneckerDelta(2,gO2)) * tmp_1412;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1419 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1418 += tmp_1419;
      tmp_1417 += (ZE(gI1,j2)) * tmp_1418;
   }
   tmp_1416 += tmp_1417;
   tmp_1379 += (std::complex<double>(0,-0.5)*KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1416;
...
std::complex<double> CLASSNAME::CpUAhUAhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1426 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1425 += tmp_1426;
   tmp_1420 += (std::complex<double>(0,-0.2)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1425;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1438 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1437 += tmp_1438;
         tmp_1436 += (ZU(gI1,3 + j2)) * tmp_1437;
      }
      tmp_1435 += tmp_1436;
      tmp_1434 += (Conj(ZU(gI2,3 + j3))) * tmp_1435;
   }
   tmp_1433 += tmp_1434;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1444 += Conj(Yu(j1,j3))*Yu(j1,j2);
         }
         tmp_1443 += tmp_1444;
         tmp_1442 += (Conj(ZU(gI2,j2))) * tmp_1443;
      }
      tmp_1441 += tmp_1442;
      tmp_1440 += (ZU(gI1,j3)) * tmp_1441;
   }
   tmp_1439 += tmp_1440;
   tmp_1420 += (std::complex<double>(0,-1)*KroneckerDelta(1,gO1)*KroneckerDelta
      (1,gO2)) * tmp_1439;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1448 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1447 += tmp_1448;
      tmp_1446 += (Conj(ZU(gI2,j2))) * tmp_1447;
   }
   tmp_1445 += tmp_1446;
   tmp_1420 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(0,gO2
      )*KroneckerDelta(2,gO1)) * tmp_1445;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1452 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1451 += tmp_1452;
      tmp_1450 += (ZU(gI1,j2)) * tmp_1451;
   }
   tmp_1449 += tmp_1450;
   tmp_1420 += (std::complex<double>(0,-0.5)*KroneckerDelta(0,gO2)*
      KroneckerDelta(2,gO1)*Lambdax) * tmp_1449;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1456 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1455 += tmp_1456;
      tmp_1454 += (Conj(ZU(gI2,j2))) * tmp_1455;
   }
   tmp_1453 += tmp_1454;
   tmp_1420 += (std::complex<double>(0,-0.5)*Conj(Lambdax)*KroneckerDelta(0,gO1
      )*KroneckerDelta(2,gO2)) * tmp_1453;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1460 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1459 += tmp_1460;
      tmp_1458 += (ZU(gI1,j2)) * tmp_1459;
   }
   tmp_1457 += tmp_1458;
   tmp_1420 += (std::complex<double>(0,-0.5)*KroneckerDelta(0,gO1)*
      KroneckerDelta(2,gO2)*Lambdax) * tmp_1457;
...
std::complex<double> CLASSNAME::CpUAhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1465 += ZD(gI1,3 + j1)*TYd(j1,j2);
      }
      tmp_1464 += tmp_1465;
      tmp_1463 += (Conj(ZD(gI2,j2))) * tmp_1464;
   }
   tmp_1462 += tmp_1463;
   tmp_1461 += (0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1462;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1469 += Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_1468 += tmp_1469;
      tmp_1467 += (ZD(gI1,j2)) * tmp_1468;
   }
   tmp_1466 += tmp_1467;
   tmp_1461 += (-0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1466;
   ...
   tmp_1470 += tmp_1471;
   tmp_1461 += (0.5*vS*Conj(Lambdax)*KroneckerDelta(1,gO2)) * tmp_1470;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1477 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1476 += tmp_1477;
      tmp_1475 += (Conj(ZD(gI2,j2))) * tmp_1476;
   }
   tmp_1474 += tmp_1475;
   tmp_1461 += (0.7071067811865475*Conj(Mu)*KroneckerDelta(1,gO2)) * tmp_1474;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1489 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1488 += tmp_1489;
      tmp_1487 += (Conj(ZD(gI2,j2))) * tmp_1488;
   }
   tmp_1486 += tmp_1487;
   tmp_1461 += (0.5*vu*Conj(Lambdax)*KroneckerDelta(2,gO2)) * tmp_1486;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1493 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1492 += tmp_1493;
      tmp_1491 += (ZD(gI1,j2)) * tmp_1492;
   }
   tmp_1490 += tmp_1491;
   tmp_1461 += (-0.5*vu*KroneckerDelta(2,gO2)*Lambdax) * tmp_1490;
...
std::complex<double> CLASSNAME::CpUAhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1498 += ZE(gI1,3 + j1)*TYe(j1,j2);
      }
      tmp_1497 += tmp_1498;
      tmp_1496 += (Conj(ZE(gI2,j2))) * tmp_1497;
   }
   tmp_1495 += tmp_1496;
   tmp_1494 += (0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1495;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1502 += Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_1501 += tmp_1502;
      tmp_1500 += (ZE(gI1,j2)) * tmp_1501;
   }
   tmp_1499 += tmp_1500;
   tmp_1494 += (-0.7071067811865475*KroneckerDelta(0,gO2)) * tmp_1499;
   ...
   tmp_1503 += tmp_1504;
   tmp_1494 += (0.5*vS*Conj(Lambdax)*KroneckerDelta(1,gO2)) * tmp_1503;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1510 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1509 += tmp_1510;
      tmp_1508 += (Conj(ZE(gI2,j2))) * tmp_1509;
   }
   tmp_1507 += tmp_1508;
   tmp_1494 += (0.7071067811865475*Conj(Mu)*KroneckerDelta(1,gO2)) * tmp_1507;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1522 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1521 += tmp_1522;
      tmp_1520 += (Conj(ZE(gI2,j2))) * tmp_1521;
   }
   tmp_1519 += tmp_1520;
   tmp_1494 += (0.5*vu*Conj(Lambdax)*KroneckerDelta(2,gO2)) * tmp_1519;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1526 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1525 += tmp_1526;
      tmp_1524 += (ZE(gI1,j2)) * tmp_1525;
   }
   tmp_1523 += tmp_1524;
   tmp_1494 += (-0.5*vu*KroneckerDelta(2,gO2)*Lambdax) * tmp_1523;
...
std::complex<double> CLASSNAME::CpUAhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1539 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1538 += tmp_1539;
      tmp_1537 += (ZU(gI1,j2)) * tmp_1538;
   }
   tmp_1536 += tmp_1537;
   tmp_1527 += (-0.5*vS*KroneckerDelta(0,gO2)*Lambdax) * tmp_1536;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1543 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1542 += tmp_1543;
      tmp_1541 += (ZU(gI1,j2)) * tmp_1542;
   }
   tmp_1540 += tmp_1541;
   tmp_1527 += (-0.7071067811865475*KroneckerDelta(0,gO2)*Mu) * tmp_1540;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1547 += ZU(gI1,3 + j1)*TYu(j1,j2);
      }
      tmp_1546 += tmp_1547;
      tmp_1545 += (Conj(ZU(gI2,j2))) * tmp_1546;
   }
   tmp_1544 += tmp_1545;
   tmp_1527 += (0.7071067811865475*KroneckerDelta(1,gO2)) * tmp_1544;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1551 += Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2));
      }
      tmp_1550 += tmp_1551;
      tmp_1549 += (ZU(gI1,j2)) * tmp_1550;
   }
   tmp_1548 += tmp_1549;
   tmp_1527 += (-0.7071067811865475*KroneckerDelta(1,gO2)) * tmp_1548;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1555 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1554 += tmp_1555;
      tmp_1553 += (Conj(ZU(gI2,j2))) * tmp_1554;
   }
   tmp_1552 += tmp_1553;
   tmp_1527 += (0.5*vd*Conj(Lambdax)*KroneckerDelta(2,gO2)) * tmp_1552;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1559 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1558 += tmp_1559;
      tmp_1557 += (ZU(gI1,j2)) * tmp_1558;
   }
   tmp_1556 += tmp_1557;
   tmp_1527 += (-0.5*vd*KroneckerDelta(2,gO2)*Lambdax) * tmp_1556;
...
std::complex<double> CLASSNAME::CpconjUHpmconjSvSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1583 += Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2));
      }
      tmp_1582 += tmp_1583;
      tmp_1581 += (ZV(gI1,j2)) * tmp_1582;
   }
   tmp_1580 += tmp_1581;
   tmp_1577 += (std::complex<double>(0,1)*KroneckerDelta(0,gO2)) * tmp_1580;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1589 += Conj(Ye(j1,j3))*Ye(j1,j2);
         }
         tmp_1588 += tmp_1589;
         tmp_1587 += (Conj(ZE(gI2,j2))) * tmp_1588;
      }
      tmp_1586 += tmp_1587;
      tmp_1585 += (ZV(gI1,j3)) * tmp_1586;
   }
   tmp_1584 += tmp_1585;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1595 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1594 += tmp_1595;
      tmp_1593 += (ZV(gI1,j2)) * tmp_1594;
   }
   tmp_1592 += tmp_1593;
   tmp_1577 += (std::complex<double>(0.,0.7071067811865475)*vS*KroneckerDelta(1
      ,gO2)*Lambdax) * tmp_1592;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1599 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1598 += tmp_1599;
      tmp_1597 += (ZV(gI1,j2)) * tmp_1598;
   }
   tmp_1596 += tmp_1597;
   tmp_1577 += (std::complex<double>(0,1)*KroneckerDelta(1,gO2)*Mu) * tmp_1596;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1606 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1605 += tmp_1606;
   tmp_1600 += (std::complex<double>(0,0.1)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1605;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1612 += Conj(Yd(j3,j1))*Yd(j2,j1);
         }
         tmp_1611 += tmp_1612;
         tmp_1610 += (ZD(gI1,3 + j2)) * tmp_1611;
      }
      tmp_1609 += tmp_1610;
      tmp_1608 += (Conj(ZD(gI2,3 + j3))) * tmp_1609;
   }
   tmp_1607 += tmp_1608;
   ...
   tmp_1600 += (std::complex<double>(0,-0.05)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1613;
   ...
   tmp_1600 += (std::complex<double>(0,0.25)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1615;
   std::complex<double> tmp_1617;
   std::complex<double> tmp_1618;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1618 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1617 += tmp_1618;
   tmp_1600 += (std::complex<double>(0,-0.1)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1617;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1631 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1630 += tmp_1631;
   tmp_1625 += (std::complex<double>(0,0.3)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1630;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1637 += Conj(Ye(j3,j1))*Ye(j2,j1);
         }
         tmp_1636 += tmp_1637;
         tmp_1635 += (ZE(gI1,3 + j2)) * tmp_1636;
      }
      tmp_1634 += tmp_1635;
      tmp_1633 += (Conj(ZE(gI2,3 + j3))) * tmp_1634;
   }
   tmp_1632 += tmp_1633;
   ...
   tmp_1625 += (std::complex<double>(0,-0.3)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1642;
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1650 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1649 += tmp_1650;
   tmp_1644 += (std::complex<double>(0,-0.2)*KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*Sqr(g1)) * tmp_1649;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1656 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1655 += tmp_1656;
         tmp_1654 += (Conj(ZU(gI2,j2))) * tmp_1655;
      }
      tmp_1653 += tmp_1654;
      tmp_1652 += (ZU(gI1,j3)) * tmp_1653;
   }
   tmp_1651 += tmp_1652;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1658 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1657 += tmp_1658;
   tmp_1644 += (std::complex<double>(0,-0.05)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1657;
   ...
   tmp_1644 += (std::complex<double>(0,-0.25)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g2)) * tmp_1659;
   std::complex<double> tmp_1661;
   std::complex<double> tmp_1662;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1662 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1661 += tmp_1662;
   tmp_1644 += (std::complex<double>(0,0.2)*KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*Sqr(g1)) * tmp_1661;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1668 += Conj(Yu(j3,j1))*Yu(j2,j1);
         }
         tmp_1667 += tmp_1668;
         tmp_1666 += (ZU(gI1,3 + j2)) * tmp_1667;
      }
      tmp_1665 += tmp_1666;
      tmp_1664 += (Conj(ZU(gI2,3 + j3))) * tmp_1665;
   }
   tmp_1663 += tmp_1664;
...
std::complex<double> CLASSNAME::CpconjUHpmconjSuSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1675 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1674 += tmp_1675;
      tmp_1673 += (Conj(ZD(gI2,j2))) * tmp_1674;
   }
   tmp_1672 += tmp_1673;
   tmp_1669 += (std::complex<double>(0.,0.7071067811865475)*vS*Conj(Lambdax)*
      KroneckerDelta(0,gO2)) * tmp_1672;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1679 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1678 += tmp_1679;
      tmp_1677 += (Conj(ZD(gI2,j2))) * tmp_1678;
   }
   tmp_1676 += tmp_1677;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1683 += Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2));
      }
      tmp_1682 += tmp_1683;
      tmp_1681 += (ZU(gI1,j2)) * tmp_1682;
   }
   tmp_1680 += tmp_1681;
   tmp_1669 += (std::complex<double>(0,1)*KroneckerDelta(0,gO2)) * tmp_1680;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1689 += Conj(Yd(j3,j1))*Yu(j2,j1);
         }
         tmp_1688 += tmp_1689;
         tmp_1687 += (ZU(gI1,3 + j2)) * tmp_1688;
      }
      tmp_1686 += tmp_1687;
      tmp_1685 += (Conj(ZD(gI2,3 + j3))) * tmp_1686;
   }
   tmp_1684 += tmp_1685;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1695 += Conj(Yd(j1,j3))*Yd(j1,j2);
         }
         tmp_1694 += tmp_1695;
         tmp_1693 += (Conj(ZD(gI2,j2))) * tmp_1694;
      }
      tmp_1692 += tmp_1693;
      tmp_1691 += (ZU(gI1,j3)) * tmp_1692;
   }
   tmp_1690 += tmp_1691;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1701 += ZU(gI1,3 + j1)*TYu(j1,j2);
      }
      tmp_1700 += tmp_1701;
      tmp_1699 += (Conj(ZD(gI2,j2))) * tmp_1700;
   }
   tmp_1698 += tmp_1699;
   tmp_1669 += (std::complex<double>(0,1)*KroneckerDelta(1,gO2)) * tmp_1698;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1705 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1704 += tmp_1705;
      tmp_1703 += (ZU(gI1,j2)) * tmp_1704;
   }
   tmp_1702 += tmp_1703;
   tmp_1669 += (std::complex<double>(0.,0.7071067811865475)*vS*KroneckerDelta(1
      ,gO2)*Lambdax) * tmp_1702;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1709 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1708 += tmp_1709;
      tmp_1707 += (ZU(gI1,j2)) * tmp_1708;
   }
   tmp_1706 += tmp_1707;
   tmp_1669 += (std::complex<double>(0,1)*KroneckerDelta(1,gO2)*Mu) * tmp_1706;
   ...
   for (unsigned j3 = 0; j3 < 3; ++j3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         ...
         for (unsigned j1 = 0; j1 < 3; ++j1) {
            tmp_1715 += Conj(Yd(j3,j1))*Yu(j2,j1);
         }
         tmp_1714 += tmp_1715;
         tmp_1713 += (ZU(gI1,3 + j2)) * tmp_1714;
      }
      tmp_1712 += tmp_1713;
      tmp_1711 += (Conj(ZD(gI2,3 + j3))) * tmp_1712;
   }
   tmp_1710 += tmp_1711;
...
std::complex<double> CLASSNAME::CpVPVPconjSdSd(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1723 += tmp_1724;
   tmp_1722 += (std::complex<double>(0,0.03333333333333333)*Sqr(g1)*Sqr(Cos(
      ThetaW()))) * tmp_1723;
   std::complex<double> tmp_1725;
   std::complex<double> tmp_1726;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1726 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1725 += tmp_1726;
   tmp_1722 += (std::complex<double>(0,0.13333333333333333)*Sqr(g1)*Sqr(Cos(
      ThetaW()))) * tmp_1725;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1730 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1729 += tmp_1730;
   tmp_1722 += (std::complex<double>(0,0.5)*Sqr(g2)*Sqr(Sin(ThetaW()))) *
      tmp_1729;
...
std::complex<double> CLASSNAME::CpVPVPconjSeSe(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1732 += tmp_1733;
   tmp_1731 += (std::complex<double>(0,0.3)*Sqr(g1)*Sqr(Cos(ThetaW()))) *
      tmp_1732;
   std::complex<double> tmp_1734;
   std::complex<double> tmp_1735;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1735 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1734 += tmp_1735;
   tmp_1731 += (std::complex<double>(0,1.2)*Sqr(g1)*Sqr(Cos(ThetaW()))) *
      tmp_1734;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1739 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1738 += tmp_1739;
   tmp_1731 += (std::complex<double>(0,0.5)*Sqr(g2)*Sqr(Sin(ThetaW()))) *
      tmp_1738;
...
std::complex<double> CLASSNAME::CpVPVPconjSuSu(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1741 += tmp_1742;
   tmp_1740 += (std::complex<double>(0,0.03333333333333333)*Sqr(g1)*Sqr(Cos(
      ThetaW()))) * tmp_1741;
   std::complex<double> tmp_1743;
   std::complex<double> tmp_1744;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1744 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1743 += tmp_1744;
   tmp_1740 += (std::complex<double>(0,0.5333333333333333)*Sqr(g1)*Sqr(Cos(
      ThetaW()))) * tmp_1743;
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1748 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1747 += tmp_1748;
   tmp_1740 += (std::complex<double>(0,0.5)*Sqr(g2)*Sqr(Sin(ThetaW()))) *
      tmp_1747;
...
std::complex<double> CLASSNAME::CpVPconjSdSd(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1750 += tmp_1751;
   tmp_1749 += (-1.5491933384829668*g1*Cos(ThetaW())) * tmp_1750;
   ...
   tmp_1752 += tmp_1753;
   tmp_1749 += (0.7745966692414834*g1*Cos(ThetaW()) - 3*g2*Sin(ThetaW())) *
      tmp_1752;
...
std::complex<double> CLASSNAME::CpVPconjSeSe(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1755 += tmp_1756;
   tmp_1754 += (-1.5491933384829668*g1*Cos(ThetaW())) * tmp_1755;
   ...
   tmp_1757 += tmp_1758;
   tmp_1754 += (-0.7745966692414834*g1*Cos(ThetaW()) - g2*Sin(ThetaW())) *
      tmp_1757;
   result += (0.5) * tmp_1754;
...
std::complex<double> CLASSNAME::CpVPconjSuSu(unsigned gI1, unsigned gI2) const
{
   ...
   tmp_1760 += tmp_1761;
   tmp_1759 += (3.0983866769659336*g1*Cos(ThetaW())) * tmp_1760;
   ...
   tmp_1762 += tmp_1763;
   tmp_1759 += (0.7745966692414834*g1*Cos(ThetaW()) + 3*g2*Sin(ThetaW())) *
      tmp_1762;
...
std::complex<double> CLASSNAME::CpVZVZconjSdSd(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1766 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1765 += tmp_1766;
   tmp_1764 += (std::complex<double>(0,0.5)*Sqr(g2)*Sqr(Cos(ThetaW()))) *
      tmp_1765;
   std::complex<double> tmp_1767;
   std::complex<double> tmp_1768;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1768 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1767 += tmp_1768;
   tmp_1764 += (std::complex<double>(0.,0.2581988897471611)*g1*g2*Cos(ThetaW())
      *Sin(ThetaW())) * tmp_1767;
   std::complex<double> tmp_1769;
   std::complex<double> tmp_1770;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1770 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1769 += tmp_1770;
   tmp_1764 += (std::complex<double>(0,0.03333333333333333)*Sqr(g1)*Sqr(Sin(
      ThetaW()))) * tmp_1769;
   std::complex<double> tmp_1771;
   std::complex<double> tmp_1772;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1772 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1771 += tmp_1772;
   tmp_1764 += (std::complex<double>(0,0.13333333333333333)*Sqr(g1)*Sqr(Sin(
      ThetaW()))) * tmp_1771;
   result += (std::complex<double>(0,-1)) * tmp_1764;
...
std::complex<double> CLASSNAME::CpVZVZconjSeSe(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1775 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1774 += tmp_1775;
   tmp_1773 += (std::complex<double>(0,0.5)*Sqr(g2)*Sqr(Cos(ThetaW()))) *
      tmp_1774;
   std::complex<double> tmp_1776;
   std::complex<double> tmp_1777;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1777 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1776 += tmp_1777;
   tmp_1773 += (std::complex<double>(0.,-0.7745966692414834)*g1*g2*Cos(ThetaW()
      )*Sin(ThetaW())) * tmp_1776;
   std::complex<double> tmp_1778;
   std::complex<double> tmp_1779;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1779 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1778 += tmp_1779;
   tmp_1773 += (std::complex<double>(0,0.3)*Sqr(g1)*Sqr(Sin(ThetaW()))) *
      tmp_1778;
   std::complex<double> tmp_1780;
   std::complex<double> tmp_1781;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1781 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1780 += tmp_1781;
   tmp_1773 += (std::complex<double>(0,1.2)*Sqr(g1)*Sqr(Sin(ThetaW()))) *
      tmp_1780;
   result += (std::complex<double>(0,-1)) * tmp_1773;
...
std::complex<double> CLASSNAME::CpVZVZconjSuSu(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1784 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1783 += tmp_1784;
   tmp_1782 += (std::complex<double>(0,0.5)*Sqr(g2)*Sqr(Cos(ThetaW()))) *
      tmp_1783;
   std::complex<double> tmp_1785;
   std::complex<double> tmp_1786;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1786 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1785 += tmp_1786;
   tmp_1782 += (std::complex<double>(0.,-0.2581988897471611)*g1*g2*Cos(ThetaW()
      )*Sin(ThetaW())) * tmp_1785;
   std::complex<double> tmp_1787;
   std::complex<double> tmp_1788;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1788 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1787 += tmp_1788;
   tmp_1782 += (std::complex<double>(0,0.03333333333333333)*Sqr(g1)*Sqr(Sin(
      ThetaW()))) * tmp_1787;
   std::complex<double> tmp_1789;
   std::complex<double> tmp_1790;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1790 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1789 += tmp_1790;
   tmp_1782 += (std::complex<double>(0,0.5333333333333333)*Sqr(g1)*Sqr(Sin(
      ThetaW()))) * tmp_1789;
...
std::complex<double> CLASSNAME::CpVZconjSdSd(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1793 += Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1);
   }
   tmp_1792 += tmp_1793;
   tmp_1791 += (1.5491933384829668*g1*Sin(ThetaW())) * tmp_1792;
   std::complex<double> tmp_1794;
   std::complex<double> tmp_1795;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1795 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1794 += tmp_1795;
   tmp_1791 += (-3*g2*Cos(ThetaW()) - 0.7745966692414834*g1*Sin(ThetaW())) *
      tmp_1794;
   result += (0.16666666666666666) * tmp_1791;
...
std::complex<double> CLASSNAME::CpVZconjSeSe(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1798 += Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1);
   }
   tmp_1797 += tmp_1798;
   tmp_1796 += (1.5491933384829668*g1*Sin(ThetaW())) * tmp_1797;
   std::complex<double> tmp_1799;
   std::complex<double> tmp_1800;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1800 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1799 += tmp_1800;
   tmp_1796 += (-(g2*Cos(ThetaW())) + 0.7745966692414834*g1*Sin(ThetaW())) *
      tmp_1799;
   result += (0.5) * tmp_1796;
...
std::complex<double> CLASSNAME::CpVZconjSuSu(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1803 += Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1);
   }
   tmp_1802 += tmp_1803;
   tmp_1801 += (-3.0983866769659336*g1*Sin(ThetaW())) * tmp_1802;
   std::complex<double> tmp_1804;
   std::complex<double> tmp_1805;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1805 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1804 += tmp_1805;
   tmp_1801 += (3*g2*Cos(ThetaW()) - 0.7745966692414834*g1*Sin(ThetaW())) *
      tmp_1804;
   result += (0.16666666666666666) * tmp_1801;
...
std::complex<double> CLASSNAME::CpconjVWmbarFuFdPL(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1807 += Conj(ZDL(gI2,j1))*ZUL(gI1,j1);
   }
   tmp_1806 += tmp_1807;
   result += (-0.7071067811865475*g2) * tmp_1806;
...
std::complex<double> CLASSNAME::CpconjVWmconjSvSe(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1809 += Conj(ZE(gI2,j1))*ZV(gI1,j1);
   }
   tmp_1808 += tmp_1809;
   result += (0.7071067811865475*g2) * tmp_1808;
...
std::complex<double> CLASSNAME::CpVWmconjVWmconjSdSd(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1811 += Conj(ZD(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1810 += tmp_1811;
   result += (0.5*Sqr(g2)) * tmp_1810;
...
std::complex<double> CLASSNAME::CpVWmconjVWmconjSeSe(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1813 += Conj(ZE(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1812 += tmp_1813;
   result += (0.5*Sqr(g2)) * tmp_1812;
...
std::complex<double> CLASSNAME::CpVWmconjVWmconjSuSu(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1815 += Conj(ZU(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1814 += tmp_1815;
   result += (0.5*Sqr(g2)) * tmp_1814;
...
std::complex<double> CLASSNAME::CpconjVWmconjSuSd(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1817 += Conj(ZD(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1816 += tmp_1817;
   result += (0.7071067811865475*g2) * tmp_1816;
...
std::complex<double> CLASSNAME::CpUChibarFdSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1820 += Conj(ZD(gI2,3 + j1))*Conj(ZDR(gI1,j1));
   }
   tmp_1819 += tmp_1820;
   tmp_1818 += (std::complex<double>(0.,-0.3651483716701107)*g1*KroneckerDelta(
      0,gO2)) * tmp_1819;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1824 += Conj(ZDR(gI1,j1))*Yd(j1,j2);
      }
      tmp_1823 += tmp_1824;
      tmp_1822 += (Conj(ZD(gI2,j2))) * tmp_1823;
   }
   tmp_1821 += tmp_1822;
   tmp_1818 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO2)) * tmp_1821;
   result += (std::complex<double>(0,-1)) * tmp_1818;
...
std::complex<double> CLASSNAME::CpUChibarFdSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1827 += Conj(ZD(gI2,j1))*ZDL(gI1,j1);
   }
   tmp_1826 += tmp_1827;
   tmp_1825 += (std::complex<double>(0.,-0.18257418583505536)*g1*KroneckerDelta
      (0,gO1)) * tmp_1826;
   std::complex<double> tmp_1828;
   std::complex<double> tmp_1829;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1829 += Conj(ZD(gI2,j1))*ZDL(gI1,j1);
   }
   tmp_1828 += tmp_1829;
   tmp_1825 += (std::complex<double>(0.,0.7071067811865475)*g2*KroneckerDelta(1
      ,gO1)) * tmp_1828;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1833 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1832 += tmp_1833;
      tmp_1831 += (ZDL(gI1,j2)) * tmp_1832;
   }
   tmp_1830 += tmp_1831;
   tmp_1825 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO1)) * tmp_1830;
   result += (std::complex<double>(0,-1)) * tmp_1825;
...
std::complex<double> CLASSNAME::CpUChibarFeSePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1836 += Conj(ZE(gI2,3 + j1))*Conj(ZER(gI1,j1));
   }
   tmp_1835 += tmp_1836;
   tmp_1834 += (std::complex<double>(0.,-1.0954451150103321)*g1*KroneckerDelta(
      0,gO2)) * tmp_1835;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1840 += Conj(ZER(gI1,j1))*Ye(j1,j2);
      }
      tmp_1839 += tmp_1840;
      tmp_1838 += (Conj(ZE(gI2,j2))) * tmp_1839;
   }
   tmp_1837 += tmp_1838;
   tmp_1834 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO2)) * tmp_1837;
...
std::complex<double> CLASSNAME::CpUChibarFeSePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1843 += Conj(ZE(gI2,j1))*ZEL(gI1,j1);
   }
   tmp_1842 += tmp_1843;
   tmp_1841 += (std::complex<double>(0.,0.5477225575051661)*g1*KroneckerDelta(0
      ,gO1)) * tmp_1842;
   std::complex<double> tmp_1844;
   std::complex<double> tmp_1845;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1845 += Conj(ZE(gI2,j1))*ZEL(gI1,j1);
   }
   tmp_1844 += tmp_1845;
   tmp_1841 += (std::complex<double>(0.,0.7071067811865475)*g2*KroneckerDelta(1
      ,gO1)) * tmp_1844;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1849 += Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1));
      }
      tmp_1848 += tmp_1849;
      tmp_1847 += (ZEL(gI1,j2)) * tmp_1848;
   }
   tmp_1846 += tmp_1847;
   tmp_1841 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO1)) * tmp_1846;
   result += (std::complex<double>(0,-1)) * tmp_1841;
...
std::complex<double> CLASSNAME::CpUChibarFuSuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1852 += Conj(ZU(gI2,3 + j1))*Conj(ZUR(gI1,j1));
   }
   tmp_1851 += tmp_1852;
   tmp_1850 += (std::complex<double>(0.,0.7302967433402214)*g1*KroneckerDelta(0
      ,gO2)) * tmp_1851;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1856 += Conj(ZUR(gI1,j1))*Yu(j1,j2);
      }
      tmp_1855 += tmp_1856;
      tmp_1854 += (Conj(ZU(gI2,j2))) * tmp_1855;
   }
   tmp_1853 += tmp_1854;
   tmp_1850 += (std::complex<double>(0,-1)*KroneckerDelta(3,gO2)) * tmp_1853;
...
std::complex<double> CLASSNAME::CpUChibarFuSuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1859 += Conj(ZU(gI2,j1))*ZUL(gI1,j1);
   }
   tmp_1858 += tmp_1859;
   tmp_1857 += (std::complex<double>(0.,-0.18257418583505536)*g1*KroneckerDelta
      (0,gO1)) * tmp_1858;
   std::complex<double> tmp_1860;
   std::complex<double> tmp_1861;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1861 += Conj(ZU(gI2,j1))*ZUL(gI1,j1);
   }
   tmp_1860 += tmp_1861;
   tmp_1857 += (std::complex<double>(0.,-0.7071067811865475)*g2*KroneckerDelta(
      1,gO1)) * tmp_1860;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1865 += Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1));
      }
      tmp_1864 += tmp_1865;
      tmp_1863 += (ZUL(gI1,j2)) * tmp_1864;
   }
   tmp_1862 += tmp_1863;
   tmp_1857 += (std::complex<double>(0,-1)*KroneckerDelta(3,gO1)) * tmp_1862;
   result += (std::complex<double>(0,-1)) * tmp_1857;
...
std::complex<double> CLASSNAME::CpUChiconjSdFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1868 += Conj(ZDL(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1867 += tmp_1868;
   tmp_1866 += (std::complex<double>(0.,-0.18257418583505536)*g1*KroneckerDelta
      (0,gO2)) * tmp_1867;
   std::complex<double> tmp_1869;
   std::complex<double> tmp_1870;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1870 += Conj(ZDL(gI2,j1))*ZD(gI1,j1);
   }
   tmp_1869 += tmp_1870;
   tmp_1866 += (std::complex<double>(0.,0.7071067811865475)*g2*KroneckerDelta(1
      ,gO2)) * tmp_1869;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1874 += Yd(j1,j2)*ZD(gI1,3 + j1);
      }
      tmp_1873 += tmp_1874;
      tmp_1872 += (Conj(ZDL(gI2,j2))) * tmp_1873;
   }
   tmp_1871 += tmp_1872;
   tmp_1866 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO2)) * tmp_1871;
   result += (std::complex<double>(0,-1)) * tmp_1866;
...
std::complex<double> CLASSNAME::CpUChiconjSdFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1877 += ZD(gI1,3 + j1)*ZDR(gI2,j1);
   }
   tmp_1876 += tmp_1877;
   tmp_1875 += (std::complex<double>(0.,-0.3651483716701107)*g1*KroneckerDelta(
      0,gO1)) * tmp_1876;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1881 += Conj(Yd(j1,j2))*ZDR(gI2,j1);
      }
      tmp_1880 += tmp_1881;
      tmp_1879 += (ZD(gI1,j2)) * tmp_1880;
   }
   tmp_1878 += tmp_1879;
   tmp_1875 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO1)) * tmp_1878;
   result += (std::complex<double>(0,-1)) * tmp_1875;
...
std::complex<double> CLASSNAME::CpUChiconjSeFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1884 += Conj(ZEL(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1883 += tmp_1884;
   tmp_1882 += (std::complex<double>(0.,0.5477225575051661)*g1*KroneckerDelta(0
      ,gO2)) * tmp_1883;
   std::complex<double> tmp_1885;
   std::complex<double> tmp_1886;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1886 += Conj(ZEL(gI2,j1))*ZE(gI1,j1);
   }
   tmp_1885 += tmp_1886;
   tmp_1882 += (std::complex<double>(0.,0.7071067811865475)*g2*KroneckerDelta(1
      ,gO2)) * tmp_1885;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1890 += Ye(j1,j2)*ZE(gI1,3 + j1);
      }
      tmp_1889 += tmp_1890;
      tmp_1888 += (Conj(ZEL(gI2,j2))) * tmp_1889;
   }
   tmp_1887 += tmp_1888;
   tmp_1882 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO2)) * tmp_1887;
   result += (std::complex<double>(0,-1)) * tmp_1882;
...
std::complex<double> CLASSNAME::CpUChiconjSeFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1893 += ZE(gI1,3 + j1)*ZER(gI2,j1);
   }
   tmp_1892 += tmp_1893;
   tmp_1891 += (std::complex<double>(0.,-1.0954451150103321)*g1*KroneckerDelta(
      0,gO1)) * tmp_1892;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1897 += Conj(Ye(j1,j2))*ZER(gI2,j1);
      }
      tmp_1896 += tmp_1897;
      tmp_1895 += (ZE(gI1,j2)) * tmp_1896;
   }
   tmp_1894 += tmp_1895;
   tmp_1891 += (std::complex<double>(0,-1)*KroneckerDelta(2,gO1)) * tmp_1894;
   result += (std::complex<double>(0,-1)) * tmp_1891;
...
std::complex<double> CLASSNAME::CpUChiconjSuFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1900 += Conj(ZUL(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1899 += tmp_1900;
   tmp_1898 += (std::complex<double>(0.,-0.18257418583505536)*g1*KroneckerDelta
      (0,gO2)) * tmp_1899;
   std::complex<double> tmp_1901;
   std::complex<double> tmp_1902;
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1902 += Conj(ZUL(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1901 += tmp_1902;
   tmp_1898 += (std::complex<double>(0.,-0.7071067811865475)*g2*KroneckerDelta(
      1,gO2)) * tmp_1901;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1906 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1905 += tmp_1906;
      tmp_1904 += (Conj(ZUL(gI2,j2))) * tmp_1905;
   }
   tmp_1903 += tmp_1904;
   tmp_1898 += (std::complex<double>(0,-1)*KroneckerDelta(3,gO2)) * tmp_1903;
   result += (std::complex<double>(0,-1)) * tmp_1898;
...
std::complex<double> CLASSNAME::CpUChiconjSuFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1909 += ZU(gI1,3 + j1)*ZUR(gI2,j1);
   }
   tmp_1908 += tmp_1909;
   tmp_1907 += (std::complex<double>(0.,0.7302967433402214)*g1*KroneckerDelta(0
      ,gO1)) * tmp_1908;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1913 += Conj(Yu(j1,j2))*ZUR(gI2,j1);
      }
      tmp_1912 += tmp_1913;
      tmp_1911 += (ZU(gI1,j2)) * tmp_1912;
   }
   tmp_1910 += tmp_1911;
   tmp_1907 += (std::complex<double>(0,-1)*KroneckerDelta(3,gO1)) * tmp_1910;
   result += (std::complex<double>(0,-1)) * tmp_1907;
...
std::complex<double> CLASSNAME::CpbarUChaconjSvFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1915 += Conj(ZEL(gI2,j1))*ZV(gI1,j1);
   }
   tmp_1914 += tmp_1915;
   result += (-(g2*KroneckerDelta(0,gO2))) * tmp_1914;
...
std::complex<double> CLASSNAME::CpbarUChaconjSvFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1919 += Conj(Ye(j1,j2))*ZER(gI2,j1);
      }
      tmp_1918 += tmp_1919;
      tmp_1917 += (ZV(gI1,j2)) * tmp_1918;
   }
   tmp_1916 += tmp_1917;
   result += (KroneckerDelta(1,gO1)) * tmp_1916;
...
std::complex<double> CLASSNAME::CpbarUChabarFuSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1923 += Conj(ZUR(gI1,j1))*Yu(j1,j2);
      }
      tmp_1922 += tmp_1923;
      tmp_1921 += (Conj(ZD(gI2,j2))) * tmp_1922;
   }
   tmp_1920 += tmp_1921;
   result += (KroneckerDelta(1,gO2)) * tmp_1920;
...
std::complex<double> CLASSNAME::CpbarUChabarFuSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1926 += Conj(ZD(gI2,j1))*ZUL(gI1,j1);
   }
   tmp_1925 += tmp_1926;
   tmp_1924 += (std::complex<double>(0,-1)*g2*KroneckerDelta(0,gO1)) * tmp_1925
      ;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1930 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_1929 += tmp_1930;
      tmp_1928 += (ZUL(gI1,j2)) * tmp_1929;
   }
   tmp_1927 += tmp_1928;
   tmp_1924 += (std::complex<double>(0,1)*KroneckerDelta(1,gO1)) * tmp_1927;
   result += (std::complex<double>(0,-1)) * tmp_1924;
...
std::complex<double> CLASSNAME::CpbarUChabarFvSePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1932 += Conj(Ye(j1,gI1))*Conj(ZE(gI2,3 + j1));
   }
   tmp_1931 += tmp_1932;
   result += (KroneckerDelta(1,gO1)) * tmp_1931;
   if (gI1 < 3) {
...
std::complex<double> CLASSNAME::CpbarUChaconjSuFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1935 += Conj(ZDL(gI2,j1))*ZU(gI1,j1);
   }
   tmp_1934 += tmp_1935;
   tmp_1933 += (std::complex<double>(0,-1)*g2*KroneckerDelta(0,gO2)) * tmp_1934
      ;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1939 += Yu(j1,j2)*ZU(gI1,3 + j1);
      }
      tmp_1938 += tmp_1939;
      tmp_1937 += (Conj(ZDL(gI2,j2))) * tmp_1938;
   }
   tmp_1936 += tmp_1937;
   tmp_1933 += (std::complex<double>(0,1)*KroneckerDelta(1,gO2)) * tmp_1936;
   result += (std::complex<double>(0,-1)) * tmp_1933;
...
std::complex<double> CLASSNAME::CpbarUChaconjSuFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1943 += Conj(Yd(j1,j2))*ZDR(gI2,j1);
      }
      tmp_1942 += tmp_1943;
      tmp_1941 += (ZU(gI1,j2)) * tmp_1942;
   }
   tmp_1940 += tmp_1941;
   result += (KroneckerDelta(1,gO1)) * tmp_1940;
...
std::complex<double> CLASSNAME::CpbarUFeSvChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1945 += Conj(ZV(gI1,j2))*Ye(gO2,j2);
      }
      tmp_1944 += tmp_1945;
      result += (Conj(UM(gI2,1))) * tmp_1944;
   }
...
std::complex<double> CLASSNAME::CpbarUFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1947 += Conj(ZEL(gI1,j2))*Ye(gO2,j2);
      }
      tmp_1946 += tmp_1947;
      result += (std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gI2,0)
         )) * tmp_1946;
...
std::complex<double> CLASSNAME::CpbarUFeFeAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1949 += Conj(Ye(j1,gO1))*ZER(gI1,j1);
      }
      tmp_1948 += tmp_1949;
      result += (std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))
         ) * tmp_1948;
...
std::complex<double> CLASSNAME::CpbarUFehhFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1951 += Conj(ZEL(gI2,j2))*Ye(gO2,j2);
      }
      tmp_1950 += tmp_1951;
      result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_1950;
   }
...
std::complex<double> CLASSNAME::CpbarUFehhFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1953 += Conj(Ye(j1,gO1))*ZER(gI2,j1);
      }
      tmp_1952 += tmp_1953;
      result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_1952;
   }
...
std::complex<double> CLASSNAME::CpbarUFeSeChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1955 += Conj(ZE(gI1,j2))*Ye(gO2,j2);
      }
      tmp_1954 += tmp_1955;
      result += (-Conj(ZN(gI2,2))) * tmp_1954;
   }
...
std::complex<double> CLASSNAME::CpbarUFeSeChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1957 += Conj(Ye(j1,gO1))*Conj(ZE(gI1,3 + j1));
      }
      tmp_1956 += tmp_1957;
      result += (-ZN(gI2,2)) * tmp_1956;
   }
...
std::complex<double> CLASSNAME::CpbarUFdHpmFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1959 += Conj(ZUL(gI2,j2))*Yd(gO2,j2);
      }
      tmp_1958 += tmp_1959;
...
std::complex<double> CLASSNAME::CpbarUFdHpmFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1961 += Conj(Yu(j1,gO1))*ZUR(gI2,j1);
      }
      tmp_1960 += tmp_1961;
      result += (ZP(gI1,1)) * tmp_1960;
   }
...
std::complex<double> CLASSNAME::CpbarUFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1963 += Conj(ZDL(gI1,j2))*Yd(gO2,j2);
      }
      tmp_1962 += tmp_1963;
      result += (std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gI2,0)
         )) * tmp_1962;
...
std::complex<double> CLASSNAME::CpbarUFdFdAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1965 += Conj(Yd(j1,gO1))*ZDR(gI1,j1);
      }
      tmp_1964 += tmp_1965;
      result += (std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))
         ) * tmp_1964;
...
std::complex<double> CLASSNAME::CpbarUFdhhFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1967 += Conj(ZDL(gI2,j2))*Yd(gO2,j2);
      }
      tmp_1966 += tmp_1967;
      result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_1966;
   }
...
std::complex<double> CLASSNAME::CpbarUFdhhFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1969 += Conj(Yd(j1,gO1))*ZDR(gI2,j1);
      }
      tmp_1968 += tmp_1969;
...
std::complex<double> CLASSNAME::CpbarUFdSuChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1971 += Conj(ZU(gI1,j2))*Yd(gO2,j2);
      }
      tmp_1970 += tmp_1971;
      result += (Conj(UM(gI2,1))) * tmp_1970;
   }
...
std::complex<double> CLASSNAME::CpbarUFdSuChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1973 += Conj(Yu(j1,gO1))*Conj(ZU(gI1,3 + j1));
      }
      tmp_1972 += tmp_1973;
      result += (UP(gI2,1)) * tmp_1972;
   }
...
std::complex<double> CLASSNAME::CpbarUFdSdChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1975 += Conj(ZD(gI1,j2))*Yd(gO2,j2);
      }
      tmp_1974 += tmp_1975;
      result += (-Conj(ZN(gI2,2))) * tmp_1974;
   }
...
std::complex<double> CLASSNAME::CpbarUFdSdChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1977 += Conj(Yd(j1,gO1))*Conj(ZD(gI1,3 + j1));
      }
      tmp_1976 += tmp_1977;
      result += (-ZN(gI2,2)) * tmp_1976;
   }
...
std::complex<double> CLASSNAME::CpbarUFuconjHpmFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1979 += Conj(ZDL(gI2,j2))*Yu(gO2,j2);
      }
      tmp_1978 += tmp_1979;
...
std::complex<double> CLASSNAME::CpbarUFuconjHpmFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1981 += Conj(Yd(j1,gO1))*ZDR(gI2,j1);
      }
      tmp_1980 += tmp_1981;
...
std::complex<double> CLASSNAME::CpbarUFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1987 += Conj(ZUL(gI1,j2))*Yu(gO2,j2);
      }
      tmp_1986 += tmp_1987;
      result += (std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gI2,1)
         )) * tmp_1986;
...
std::complex<double> CLASSNAME::CpbarUFuFuAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1989 += Conj(Yu(j1,gO1))*ZUR(gI1,j1);
      }
      tmp_1988 += tmp_1989;
      result += (std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,1))
         ) * tmp_1988;
...
std::complex<double> CLASSNAME::CpbarUFuhhFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1991 += Conj(ZUL(gI2,j2))*Yu(gO2,j2);
      }
      tmp_1990 += tmp_1991;
      result += (-0.7071067811865475*Conj(ZH(gI1,1))) * tmp_1990;
   }
...
std::complex<double> CLASSNAME::CpbarUFuhhFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1993 += Conj(Yu(j1,gO1))*ZUR(gI2,j1);
      }
      tmp_1992 += tmp_1993;
      result += (-0.7071067811865475*Conj(ZH(gI1,1))) * tmp_1992;
   }
...
std::complex<double> CLASSNAME::CpbarUFuSuChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO2 < 3) {
      ...
      for (unsigned j2 = 0; j2 < 3; ++j2) {
         tmp_1995 += Conj(ZU(gI1,j2))*Yu(gO2,j2);
      }
      tmp_1994 += tmp_1995;
      result += (-Conj(ZN(gI2,3))) * tmp_1994;
   }
...
std::complex<double> CLASSNAME::CpbarUFuSuChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   if (gO1 < 3) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_1997 += Conj(Yu(j1,gO1))*Conj(ZU(gI1,3 + j1));
      }
      tmp_1996 += tmp_1997;
      result += (-ZN(gI2,3)) * tmp_1996;
   }
...
std::complex<double> CLASSNAME::CpGlubarFdSdPL(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_1999 += Conj(ZD(gI2,3 + j1))*Conj(ZDR(gI1,j1));
   }
   tmp_1998 += tmp_1999;
...
std::complex<double> CLASSNAME::CpGlubarFdSdPR(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2001 += Conj(ZD(gI2,j1))*ZDL(gI1,j1);
   }
   tmp_2000 += tmp_2001;
...
std::complex<double> CLASSNAME::CpGlubarFuSuPL(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2003 += Conj(ZU(gI2,3 + j1))*Conj(ZUR(gI1,j1));
   }
   tmp_2002 += tmp_2003;
   result += (1.4142135623730951*g3*PhaseGlu) * tmp_2002;
...
std::complex<double> CLASSNAME::CpGlubarFuSuPR(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2005 += Conj(ZU(gI2,j1))*ZUL(gI1,j1);
   }
   tmp_2004 += tmp_2005;
   result += (-1.4142135623730951*g3*Conj(PhaseGlu)) * tmp_2004;
...
std::complex<double> CLASSNAME::CpGluconjSdFdPL(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2007 += Conj(ZDL(gI2,j1))*ZD(gI1,j1);
   }
   tmp_2006 += tmp_2007;
   result += (-1.4142135623730951*g3*PhaseGlu) * tmp_2006;
...
std::complex<double> CLASSNAME::CpGluconjSdFdPR(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2009 += ZD(gI1,3 + j1)*ZDR(gI2,j1);
   }
   tmp_2008 += tmp_2009;
   result += (1.4142135623730951*g3*Conj(PhaseGlu)) * tmp_2008;
...
std::complex<double> CLASSNAME::CpGluconjSuFuPL(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2011 += Conj(ZUL(gI2,j1))*ZU(gI1,j1);
   }
   tmp_2010 += tmp_2011;
   result += (-1.4142135623730951*g3*PhaseGlu) * tmp_2010;
...
std::complex<double> CLASSNAME::CpGluconjSuFuPR(unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2013 += ZU(gI1,3 + j1)*ZUR(gI2,j1);
   }
   tmp_2012 += tmp_2013;
   result += (1.4142135623730951*g3*Conj(PhaseGlu)) * tmp_2012;
...
std::complex<double> CLASSNAME::CpbarFvconjHpmFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2015 += Conj(Ye(j1,gO1))*ZER(gI2,j1);
   }
   tmp_2014 += tmp_2015;
   result += (ZP(gI1,0)) * tmp_2014;
...
std::complex<double> CLASSNAME::CpbarFvbarChaSePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2017 += Conj(Ye(j1,gO1))*Conj(ZE(gI2,3 + j1));
   }
   tmp_2016 += tmp_2017;
   result += (UM(gI1,1)) * tmp_2016;
...
std::complex<double> CLASSNAME::CpbarFeHpmFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2019 += Conj(ZER(gO2,j1))*Ye(j1,gI2);
   }
   tmp_2018 += tmp_2019;
   result += (ZP(gI1,0)) * tmp_2018;
...
std::complex<double> CLASSNAME::CpbarFeSvChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2023 += Conj(ZER(gO2,j1))*Ye(j1,j2);
      }
      tmp_2022 += tmp_2023;
      tmp_2021 += (Conj(ZV(gI1,j2))) * tmp_2022;
   }
   tmp_2020 += tmp_2021;
   result += (Conj(UM(gI2,1))) * tmp_2020;
...
std::complex<double> CLASSNAME::CpbarFeSvChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2025 += Conj(ZV(gI1,j1))*ZEL(gO1,j1);
   }
   tmp_2024 += tmp_2025;
   result += (-(g2*UP(gI2,0))) * tmp_2024;
...
std::complex<double> CLASSNAME::CpbarFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2029 += Conj(ZER(gO2,j1))*Ye(j1,j2);
      }
      tmp_2028 += tmp_2029;
      tmp_2027 += (Conj(ZEL(gI1,j2))) * tmp_2028;
   }
   tmp_2026 += tmp_2027;
   result += (std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gI2,0))) *
      tmp_2026;
...
std::complex<double> CLASSNAME::CpbarFeFeAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2033 += Conj(Ye(j1,j2))*ZER(gI1,j1);
      }
      tmp_2032 += tmp_2033;
      tmp_2031 += (ZEL(gO1,j2)) * tmp_2032;
   }
   tmp_2030 += tmp_2031;
   result += (std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))) *
      tmp_2030;
...
std::complex<double> CLASSNAME::CpbarFehhFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2037 += Conj(ZER(gO2,j1))*Ye(j1,j2);
      }
      tmp_2036 += tmp_2037;
      tmp_2035 += (Conj(ZEL(gI2,j2))) * tmp_2036;
   }
   tmp_2034 += tmp_2035;
   result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_2034;
...
std::complex<double> CLASSNAME::CpbarFehhFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2041 += Conj(Ye(j1,j2))*ZER(gI2,j1);
      }
      tmp_2040 += tmp_2041;
      tmp_2039 += (ZEL(gO1,j2)) * tmp_2040;
   }
   tmp_2038 += tmp_2039;
   result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_2038;
...
std::complex<double> CLASSNAME::CpbarFeSeChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2043 += Conj(ZE(gI1,3 + j1))*Conj(ZER(gO2,j1));
   }
   tmp_2042 += tmp_2043;
   result += (-1.0954451150103321*g1*Conj(ZN(gI2,0))) * tmp_2042;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2047 += Conj(ZER(gO2,j1))*Ye(j1,j2);
      }
      tmp_2046 += tmp_2047;
      tmp_2045 += (Conj(ZE(gI1,j2))) * tmp_2046;
   }
   tmp_2044 += tmp_2045;
   result += (-Conj(ZN(gI2,2))) * tmp_2044;
...
std::complex<double> CLASSNAME::CpbarFeSeChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2049 += Conj(ZE(gI1,j1))*ZEL(gO1,j1);
   }
   tmp_2048 += tmp_2049;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2053 += Conj(Ye(j1,j2))*Conj(ZE(gI1,3 + j1));
      }
      tmp_2052 += tmp_2053;
      tmp_2051 += (ZEL(gO1,j2)) * tmp_2052;
   }
   tmp_2050 += tmp_2051;
   result += (-ZN(gI2,2)) * tmp_2050;
...
std::complex<double> CLASSNAME::CpbarFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      tmp_2064 += tmp_2065;
      tmp_2063 += (Conj(ZDL(gI1,j2))) * tmp_2064;
   }
   tmp_2062 += tmp_2063;
   result += (std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gI2,0))) *
      tmp_2062;
...
std::complex<double> CLASSNAME::CpbarFdFdAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2069 += Conj(Yd(j1,j2))*ZDR(gI1,j1);
      }
      tmp_2068 += tmp_2069;
      tmp_2067 += (ZDL(gO1,j2)) * tmp_2068;
   }
   tmp_2066 += tmp_2067;
   result += (std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))) *
      tmp_2066;
...
std::complex<double> CLASSNAME::CpbarFdhhFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2073 += Conj(ZDR(gO2,j1))*Yd(j1,j2);
      }
      tmp_2072 += tmp_2073;
      tmp_2071 += (Conj(ZDL(gI2,j2))) * tmp_2072;
   }
   tmp_2070 += tmp_2071;
   result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_2070;
...
std::complex<double> CLASSNAME::CpbarFdhhFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2077 += Conj(Yd(j1,j2))*ZDR(gI2,j1);
      }
      tmp_2076 += tmp_2077;
      tmp_2075 += (ZDL(gO1,j2)) * tmp_2076;
   }
   tmp_2074 += tmp_2075;
   result += (-0.7071067811865475*Conj(ZH(gI1,0))) * tmp_2074;
...
std::complex<double> CLASSNAME::CpbarFdSuChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2081 += Conj(ZDR(gO2,j1))*Yd(j1,j2);
      }
      tmp_2080 += tmp_2081;
      tmp_2079 += (Conj(ZU(gI1,j2))) * tmp_2080;
   }
   tmp_2078 += tmp_2079;
   result += (Conj(UM(gI2,1))) * tmp_2078;
...
std::complex<double> CLASSNAME::CpbarFdSuChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2083 += Conj(ZU(gI1,j1))*ZDL(gO1,j1);
   }
   tmp_2082 += tmp_2083;
   result += (-(g2*UP(gI2,0))) * tmp_2082;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2087 += Conj(Yu(j1,j2))*Conj(ZU(gI1,3 + j1));
      }
      tmp_2086 += tmp_2087;
      tmp_2085 += (ZDL(gO1,j2)) * tmp_2086;
   }
   tmp_2084 += tmp_2085;
   result += (UP(gI2,1)) * tmp_2084;
...
std::complex<double> CLASSNAME::CpbarFdSdChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2090 += Conj(ZD(gI1,3 + j1))*Conj(ZDR(gO2,j1));
   }
   tmp_2089 += tmp_2090;
   tmp_2088 += (-1.0954451150103321*g1*Conj(ZN(gI2,0))) * tmp_2089;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2094 += Conj(ZDR(gO2,j1))*Yd(j1,j2);
      }
      tmp_2093 += tmp_2094;
      tmp_2092 += (Conj(ZD(gI1,j2))) * tmp_2093;
   }
   tmp_2091 += tmp_2092;
   tmp_2088 += (-3*Conj(ZN(gI2,2))) * tmp_2091;
   result += (0.3333333333333333) * tmp_2088;
...
std::complex<double> CLASSNAME::CpbarFdSdChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2097 += Conj(ZD(gI1,j1))*ZDL(gO1,j1);
   }
   tmp_2096 += tmp_2097;
   tmp_2095 += (-1.4142135623730951*(0.7745966692414834*g1*ZN(gI2,0) - 3*g2*ZN(
      gI2,1))) * tmp_2096;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2101 += Conj(Yd(j1,j2))*Conj(ZD(gI1,3 + j1));
      }
      tmp_2100 += tmp_2101;
      tmp_2099 += (ZDL(gO1,j2)) * tmp_2100;
   }
   tmp_2098 += tmp_2099;
   tmp_2095 += (-6*ZN(gI2,2)) * tmp_2098;
   result += (0.16666666666666666) * tmp_2095;
...
std::complex<double> CLASSNAME::CpbarFdSdGluPL(unsigned gO2, unsigned gI1, unsigned ) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2103 += Conj(ZD(gI1,3 + j1))*Conj(ZDR(gO2,j1));
   }
   tmp_2102 += tmp_2103;
   result += (1.4142135623730951*g3*PhaseGlu) * tmp_2102;
...
std::complex<double> CLASSNAME::CpbarFdSdGluPR(unsigned gO1, unsigned gI1, unsigned ) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2105 += Conj(ZD(gI1,j1))*ZDL(gO1,j1);
   }
   tmp_2104 += tmp_2105;
   result += (-1.4142135623730951*g3*Conj(PhaseGlu)) * tmp_2104;
...
std::complex<double> CLASSNAME::CpbarFdVWmFuPL(unsigned gO1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2107 += Conj(ZUL(gI2,j1))*ZDL(gO1,j1);
   }
   tmp_2106 += tmp_2107;
   result += (-0.7071067811865475*g2) * tmp_2106;
...
std::complex<double> CLASSNAME::CpbarFuconjHpmFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      tmp_2110 += tmp_2111;
      tmp_2109 += (Conj(ZDL(gI2,j2))) * tmp_2110;
   }
   tmp_2108 += tmp_2109;
   result += (ZP(gI1,1)) * tmp_2108;
...
std::complex<double> CLASSNAME::CpbarFuconjHpmFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2115 += Conj(Yd(j1,j2))*ZDR(gI2,j1);
      }
      tmp_2114 += tmp_2115;
      tmp_2113 += (ZUL(gO1,j2)) * tmp_2114;
   }
   tmp_2112 += tmp_2113;
   result += (ZP(gI1,0)) * tmp_2112;
...
std::complex<double> CLASSNAME::CpbarFubarChaSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2119 += Conj(ZUR(gO2,j1))*Yu(j1,j2);
      }
      tmp_2118 += tmp_2119;
      tmp_2117 += (Conj(ZD(gI2,j2))) * tmp_2118;
   }
   tmp_2116 += tmp_2117;
   result += (Conj(UP(gI1,1))) * tmp_2116;
...
std::complex<double> CLASSNAME::CpbarFubarChaSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2121 += Conj(ZD(gI2,j1))*ZUL(gO1,j1);
   }
   tmp_2120 += tmp_2121;
   result += (-(g2*UM(gI1,0))) * tmp_2120;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2125 += Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1));
      }
      tmp_2124 += tmp_2125;
      tmp_2123 += (ZUL(gO1,j2)) * tmp_2124;
   }
   tmp_2122 += tmp_2123;
   result += (UM(gI1,1)) * tmp_2122;
...
std::complex<double> CLASSNAME::CpbarFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2129 += Conj(ZUR(gO2,j1))*Yu(j1,j2);
      }
      tmp_2128 += tmp_2129;
      tmp_2127 += (Conj(ZUL(gI1,j2))) * tmp_2128;
   }
   tmp_2126 += tmp_2127;
   result += (std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gI2,1))) *
      tmp_2126;
...
std::complex<double> CLASSNAME::CpbarFuFuAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2133 += Conj(Yu(j1,j2))*ZUR(gI1,j1);
      }
      tmp_2132 += tmp_2133;
      tmp_2131 += (ZUL(gO1,j2)) * tmp_2132;
   }
   tmp_2130 += tmp_2131;
   result += (std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,1))) *
      tmp_2130;
...
std::complex<double> CLASSNAME::CpbarFuhhFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2137 += Conj(ZUR(gO2,j1))*Yu(j1,j2);
      }
      tmp_2136 += tmp_2137;
      tmp_2135 += (Conj(ZUL(gI2,j2))) * tmp_2136;
   }
   tmp_2134 += tmp_2135;
   result += (-0.7071067811865475*Conj(ZH(gI1,1))) * tmp_2134;
...
std::complex<double> CLASSNAME::CpbarFuhhFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2141 += Conj(Yu(j1,j2))*ZUR(gI2,j1);
      }
      tmp_2140 += tmp_2141;
      tmp_2139 += (ZUL(gO1,j2)) * tmp_2140;
   }
   tmp_2138 += tmp_2139;
   result += (-0.7071067811865475*Conj(ZH(gI1,1))) * tmp_2138;
...
std::complex<double> CLASSNAME::CpbarFuSuChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2144 += Conj(ZU(gI1,3 + j1))*Conj(ZUR(gO2,j1));
   }
   tmp_2143 += tmp_2144;
   tmp_2142 += (2.1908902300206643*g1*Conj(ZN(gI2,0))) * tmp_2143;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2148 += Conj(ZUR(gO2,j1))*Yu(j1,j2);
      }
      tmp_2147 += tmp_2148;
      tmp_2146 += (Conj(ZU(gI1,j2))) * tmp_2147;
   }
   tmp_2145 += tmp_2146;
   tmp_2142 += (-3*Conj(ZN(gI2,3))) * tmp_2145;
   result += (0.3333333333333333) * tmp_2142;
...
std::complex<double> CLASSNAME::CpbarFuSuChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2151 += Conj(ZU(gI1,j1))*ZUL(gO1,j1);
   }
   tmp_2150 += tmp_2151;
   tmp_2149 += (-1.4142135623730951*(0.7745966692414834*g1*ZN(gI2,0) + 3*g2*ZN(
      gI2,1))) * tmp_2150;
   ...
   for (unsigned j2 = 0; j2 < 3; ++j2) {
      ...
      for (unsigned j1 = 0; j1 < 3; ++j1) {
         tmp_2155 += Conj(Yu(j1,j2))*Conj(ZU(gI1,3 + j1));
      }
      tmp_2154 += tmp_2155;
      tmp_2153 += (ZUL(gO1,j2)) * tmp_2154;
   }
   tmp_2152 += tmp_2153;
   tmp_2149 += (-6*ZN(gI2,3)) * tmp_2152;
   result += (0.16666666666666666) * tmp_2149;
...
std::complex<double> CLASSNAME::CpbarFuSuGluPL(unsigned gO2, unsigned gI1, unsigned ) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2157 += Conj(ZU(gI1,3 + j1))*Conj(ZUR(gO2,j1));
   }
   tmp_2156 += tmp_2157;
   result += (1.4142135623730951*g3*PhaseGlu) * tmp_2156;
...
std::complex<double> CLASSNAME::CpbarFuSuGluPR(unsigned gO1, unsigned gI1, unsigned ) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2159 += Conj(ZU(gI1,j1))*ZUL(gO1,j1);
   }
   tmp_2158 += tmp_2159;
   result += (-1.4142135623730951*g3*Conj(PhaseGlu)) * tmp_2158;
...
std::complex<double> CLASSNAME::CpbarFuconjVWmFdPL(unsigned gO1, unsigned gI2) const
{
   ...
   for (unsigned j1 = 0; j1 < 3; ++j1) {
      tmp_2161 += Conj(ZDL(gI2,j1))*ZUL(gO1,j1);
   }
   tmp_2160 += tmp_2161;
   result += (-0.7071067811865475*g2) * tmp_2160;
...
std::complex<double> CLASSNAME::self_energy_Sd(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2163 += A0(MHpm(gI1))*CpUSdconjUSdconjHpmHpm(gO1,gO2,gI1,gI1);
   }
   tmp_2162 += tmp_2163;
   result += (-1) * tmp_2162;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2165 += A0(MAh(gI1))*CpUSdconjUSdAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2164 += tmp_2165;
   result += (-0.5) * tmp_2164;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2167 += A0(MSv(gI1))*CpUSdconjUSdconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2166 += tmp_2167;
   result += (-1) * tmp_2166;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2169 += A0(Mhh(gI1))*CpUSdconjUSdhhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2168 += tmp_2169;
   result += (-0.5) * tmp_2168;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2171 += (Conj(CpconjUSdFuChaPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2173 += (Conj(CpconjUSdFdChiPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2177 += B0(p,MFd(gI1),MChi(gI2))*(Conj(CpconjUSdFdChiPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2181 += B0(p,MFu(gI1),MCha(gI2))*(Conj(CpconjUSdFuChaPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2183 += A0(MSd(gI1))*CpUSdconjUSdconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2182 += tmp_2183;
   result += (-1) * tmp_2182;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2185 += A0(MSe(gI1))*CpUSdconjUSdconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2184 += tmp_2185;
   result += (-1) * tmp_2184;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2187 += A0(MSu(gI1))*CpUSdconjUSdconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2186 += tmp_2187;
   result += (-1) * tmp_2186;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2189 += B0(p,MSu(gI1),MHpm(gI2))*Conj(CpconjUSdSuHpm(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2191 += B0(p,MSd(gI1),MAh(gI2))*Conj(CpconjUSdSdAh(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2193 += B0(p,MSd(gI1),Mhh(gI2))*Conj(CpconjUSdSdhh(gO2,gI1,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2195 += (Conj(CpconjUSdGluFdPL(gO2,0,gI2))*CpconjUSdGluFdPL(gO1,0,
         gI2) + Conj(CpconjUSdGluFdPR(gO2,0,gI2))*CpconjUSdGluFdPR(gO1,0,gI2))*G0(
         p,MGlu,MFd(gI2));
   }
   tmp_2194 += tmp_2195;
   result += (1.3333333333333333) * tmp_2194;
   std::complex<double> tmp_2196;
   std::complex<double> tmp_2197;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2197 += Conj(CpconjUSdVGSd(gO2,gI2))*CpconjUSdVGSd(gO1,gI2)*F0(p,
         MSd(gI2),0);
   }
   tmp_2196 += tmp_2197;
   ...
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2198 += Conj(CpconjUSdVPSd(gO2,gI2))*CpconjUSdVPSd(gO1,gI2)*F0(p,
         MSd(gI2),0);
   }
   result += tmp_2198;
   std::complex<double> tmp_2199;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2199 += Conj(CpconjUSdVZSd(gO2,gI2))*CpconjUSdVZSd(gO1,gI2)*F0(p,
         MSd(gI2),MVZ);
   }
   result += tmp_2199;
   std::complex<double> tmp_2200;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2200 += Conj(CpconjUSdVWmSu(gO2,gI2))*CpconjUSdVWmSu(gO1,gI2)*F0(p
         ,MSu(gI2),MVWm);
   }
   result += tmp_2200;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2202 += B0(p,MGlu,MFd(gI2))*(Conj(CpconjUSdGluFdPR(gO2,0,gI2))*
         CpconjUSdGluFdPL(gO1,0,gI2) + Conj(CpconjUSdGluFdPL(gO2,0,gI2))*
         CpconjUSdGluFdPR(gO1,0,gI2))*MFd(gI2);
   }
   tmp_2201 += tmp_2202;
   result += (-2.6666666666666665*MGlu) * tmp_2201;
...
std::complex<double> CLASSNAME::self_energy_Sv(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2204 += A0(MHpm(gI1))*CpUSvconjUSvconjHpmHpm(gO1,gO2,gI1,gI1);
   }
   tmp_2203 += tmp_2204;
   result += (-1) * tmp_2203;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2206 += (Conj(CpconjUSvbarChaFePL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2208 += B0(p,MHpm(gI1),MSe(gI2))*Conj(CpconjUSvconjHpmSe(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2214 += A0(MAh(gI1))*CpUSvconjUSvAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2213 += tmp_2214;
   result += (-0.5) * tmp_2213;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2216 += A0(MSv(gI1))*CpUSvconjUSvconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2215 += tmp_2216;
   result += (-1) * tmp_2215;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2218 += A0(Mhh(gI1))*CpUSvconjUSvhhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2217 += tmp_2218;
   result += (-0.5) * tmp_2217;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2220 += B0(p,MSv(gI1),Mhh(gI2))*Conj(CpconjUSvSvhh(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2222 += (Conj(CpconjUSvFvChiPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2228 += A0(MSd(gI1))*CpUSvconjUSvconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2227 += tmp_2228;
   result += (-3) * tmp_2227;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2230 += A0(MSe(gI1))*CpUSvconjUSvconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2229 += tmp_2230;
   result += (-1) * tmp_2229;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2232 += A0(MSu(gI1))*CpUSvconjUSvconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2231 += tmp_2232;
   result += (-3) * tmp_2231;
   std::complex<double> tmp_2233;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2233 += Conj(CpconjUSvVZSv(gO2,gI2))*CpconjUSvVZSv(gO1,gI2)*F0(p,
         MSv(gI2),MVZ);
   }
   result += tmp_2233;
   std::complex<double> tmp_2234;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2234 += Conj(CpconjUSvconjVWmSe(gO2,gI2))*CpconjUSvconjVWmSe(gO1,
...
std::complex<double> CLASSNAME::self_energy_Su(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2238 += (Conj(CpconjUSubarChaFdPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2246 += A0(MAh(gI1))*CpUSuconjUSuAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2245 += tmp_2246;
   result += (-0.5) * tmp_2245;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2248 += A0(MSv(gI1))*CpUSuconjUSuconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2247 += tmp_2248;
   result += (-1) * tmp_2247;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2250 += A0(Mhh(gI1))*CpUSuconjUSuhhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2249 += tmp_2250;
   result += (-0.5) * tmp_2249;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2252 += (Conj(CpconjUSuFuChiPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2258 += A0(MSd(gI1))*CpUSuconjUSuconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2257 += tmp_2258;
   result += (-1) * tmp_2257;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2260 += A0(MSe(gI1))*CpUSuconjUSuconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2259 += tmp_2260;
   result += (-1) * tmp_2259;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2262 += A0(MSu(gI1))*CpUSuconjUSuconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2261 += tmp_2262;
   result += (-1) * tmp_2261;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2264 += B0(p,MSu(gI1),MAh(gI2))*Conj(CpconjUSuSuAh(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2266 += B0(p,MSu(gI1),Mhh(gI2))*Conj(CpconjUSuSuhh(gO2,gI1,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2268 += (Conj(CpconjUSuGluFuPL(gO2,0,gI2))*CpconjUSuGluFuPL(gO1,0,
         gI2) + Conj(CpconjUSuGluFuPR(gO2,0,gI2))*CpconjUSuGluFuPR(gO1,0,gI2))*G0(
         p,MGlu,MFu(gI2));
   }
   tmp_2267 += tmp_2268;
   result += (1.3333333333333333) * tmp_2267;
   std::complex<double> tmp_2269;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2269 += Conj(CpconjUSuconjVWmSd(gO2,gI2))*CpconjUSuconjVWmSd(gO1,
   ...
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2271 += Conj(CpconjUSuVGSu(gO2,gI2))*CpconjUSuVGSu(gO1,gI2)*F0(p,
         MSu(gI2),0);
   }
   tmp_2270 += tmp_2271;
   result += (1.3333333333333333) * tmp_2270;
   std::complex<double> tmp_2272;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2272 += Conj(CpconjUSuVPSu(gO2,gI2))*CpconjUSuVPSu(gO1,gI2)*F0(p,
         MSu(gI2),0);
   }
   result += tmp_2272;
   std::complex<double> tmp_2273;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2273 += Conj(CpconjUSuVZSu(gO2,gI2))*CpconjUSuVZSu(gO1,gI2)*F0(p,
         MSu(gI2),MVZ);
   }
   result += tmp_2273;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2275 += B0(p,MGlu,MFu(gI2))*(Conj(CpconjUSuGluFuPR(gO2,0,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Se(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2277 += A0(MHpm(gI1))*CpUSeconjUSeconjHpmHpm(gO1,gO2,gI1,gI1);
   }
   tmp_2276 += tmp_2277;
   result += (-1) * tmp_2276;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2279 += A0(MAh(gI1))*CpUSeconjUSeAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2278 += tmp_2279;
   result += (-0.5) * tmp_2278;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2281 += A0(MSv(gI1))*CpUSeconjUSeconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2280 += tmp_2281;
   result += (-1) * tmp_2280;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2283 += A0(Mhh(gI1))*CpUSeconjUSehhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2282 += tmp_2283;
   result += (-0.5) * tmp_2282;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2285 += B0(p,MSv(gI1),MHpm(gI2))*Conj(CpconjUSeSvHpm(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2287 += (Conj(CpconjUSeFvChaPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2289 += (Conj(CpconjUSeFeChiPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2299 += A0(MSd(gI1))*CpUSeconjUSeconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2298 += tmp_2299;
   result += (-3) * tmp_2298;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2301 += A0(MSe(gI1))*CpUSeconjUSeconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2300 += tmp_2301;
   result += (-1) * tmp_2300;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2303 += A0(MSu(gI1))*CpUSeconjUSeconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2302 += tmp_2303;
   result += (-3) * tmp_2302;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2305 += B0(p,MSe(gI1),MAh(gI2))*Conj(CpconjUSeSeAh(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2307 += B0(p,MSe(gI1),Mhh(gI2))*Conj(CpconjUSeSehh(gO2,gI1,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2308 += Conj(CpconjUSeVWmSv(gO2,gI2))*CpconjUSeVWmSv(gO1,gI2)*F0(p
         ,MSv(gI2),MVWm);
   }
   result += tmp_2308;
   std::complex<double> tmp_2309;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2309 += Conj(CpconjUSeVPSe(gO2,gI2))*CpconjUSeVPSe(gO1,gI2)*F0(p,
         MSe(gI2),0);
   }
   result += tmp_2309;
   std::complex<double> tmp_2310;
   for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
      tmp_2310 += Conj(CpconjUSeVZSe(gO2,gI2))*CpconjUSeVZSe(gO1,gI2)*F0(p,
         MSe(gI2),MVZ);
   }
   result += tmp_2310;
...
std::complex<double> CLASSNAME::self_energy_hh(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2312 += A0(MHpm(gI1))*CpUhhUhhconjHpmHpm(gO1,gO2,gI1,gI1);
   }
   tmp_2311 += tmp_2312;
   result += (-1) * tmp_2311;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2314 += B0(p,MHpm(gI1),MHpm(gI2))*Conj(CpUhhconjHpmHpm(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2316 += (Conj(CpUhhbarChaChaPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2322 += A0(MAh(gI1))*CpUhhUhhAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2321 += tmp_2322;
   result += (-0.5) * tmp_2321;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2324 += A0(MSv(gI1))*CpUhhUhhconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2323 += tmp_2324;
   result += (-1) * tmp_2323;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2326 += A0(Mhh(gI1))*CpUhhUhhhhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2325 += tmp_2326;
   result += (-0.5) * tmp_2325;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2329 += B0(p,MAh(gI1),MAh(gI2))*Conj(CpUhhAhAh(gO2,gI1,gI2))
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2331 += B0(p,MSv(gI1),MSv(gI2))*Conj(CpUhhconjSvSv(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2333 += B0(p,Mhh(gI1),MAh(gI2))*Conj(CpUhhhhAh(gO2,gI1,gI2))
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2336 += B0(p,Mhh(gI1),Mhh(gI2))*Conj(CpUhhhhhh(gO2,gI1,gI2))
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2339 += (Conj(CpUhhbarFdFdPL(gO2,gI1,gI2))*CpUhhbarFdFdPL(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2341 += (Conj(CpUhhbarFeFePL(gO2,gI1,gI2))*CpUhhbarFeFePL(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2344 += (Conj(CpUhhbarFuFuPL(gO2,gI1,gI2))*CpUhhbarFuFuPL(
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2359 += (Conj(CpUhhChiChiPL(gO2,gI1,gI2))*CpUhhChiChiPL(gO1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2365 += A0(MSd(gI1))*CpUhhUhhconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2364 += tmp_2365;
   result += (-3) * tmp_2364;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2367 += A0(MSe(gI1))*CpUhhUhhconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2366 += tmp_2367;
   result += (-1) * tmp_2366;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2369 += A0(MSu(gI1))*CpUhhUhhconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2368 += tmp_2369;
   result += (-3) * tmp_2368;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2372 += B0(p,MSd(gI1),MSd(gI2))*Conj(CpUhhconjSdSd(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2374 += B0(p,MSe(gI1),MSe(gI2))*Conj(CpUhhconjSeSe(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2377 += B0(p,MSu(gI1),MSu(gI2))*Conj(CpUhhconjSuSu(gO2,gI1,
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2379 += Conj(CpUhhconjVWmHpm(gO2,gI2))*CpUhhconjVWmHpm(gO1,gI2)*F0
         (p,MHpm(gI2),MVWm);
   }
   tmp_2378 += tmp_2379;
   result += (2) * tmp_2378;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2380 += Conj(CpUhhVZAh(gO2,gI2))*CpUhhVZAh(gO1,gI2)*F0(p,MAh(gI2),
         MVZ);
   }
   result += tmp_2380;
...
std::complex<double> CLASSNAME::self_energy_Ah(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2382 += A0(MHpm(gI1))*CpUAhUAhconjHpmHpm(gO1,gO2,gI1,gI1);
   }
   tmp_2381 += tmp_2382;
   result += (-1) * tmp_2381;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2384 += B0(p,MHpm(gI1),MHpm(gI2))*Conj(CpUAhconjHpmHpm(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2386 += (Conj(CpUAhbarChaChaPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2392 += A0(MAh(gI1))*CpUAhUAhAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2391 += tmp_2392;
   result += (-0.5) * tmp_2391;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2394 += A0(MSv(gI1))*CpUAhUAhconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2393 += tmp_2394;
   result += (-1) * tmp_2393;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2396 += A0(Mhh(gI1))*CpUAhUAhhhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2395 += tmp_2396;
   result += (-0.5) * tmp_2395;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2399 += B0(p,MAh(gI1),MAh(gI2))*Conj(CpUAhAhAh(gO2,gI1,gI2))
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2401 += B0(p,Mhh(gI1),MAh(gI2))*Conj(CpUAhhhAh(gO2,gI1,gI2))
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2404 += B0(p,Mhh(gI1),Mhh(gI2))*Conj(CpUAhhhhh(gO2,gI1,gI2))
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2407 += (Conj(CpUAhbarFdFdPL(gO2,gI1,gI2))*CpUAhbarFdFdPL(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2409 += (Conj(CpUAhbarFeFePL(gO2,gI1,gI2))*CpUAhbarFeFePL(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2412 += (Conj(CpUAhbarFuFuPL(gO2,gI1,gI2))*CpUAhbarFuFuPL(
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2427 += (Conj(CpUAhChiChiPL(gO2,gI1,gI2))*CpUAhChiChiPL(gO1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2433 += A0(MSd(gI1))*CpUAhUAhconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2432 += tmp_2433;
   result += (-3) * tmp_2432;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2435 += A0(MSe(gI1))*CpUAhUAhconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2434 += tmp_2435;
   result += (-1) * tmp_2434;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2437 += A0(MSu(gI1))*CpUAhUAhconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2436 += tmp_2437;
   result += (-3) * tmp_2436;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2440 += B0(p,MSd(gI1),MSd(gI2))*Conj(CpUAhconjSdSd(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2442 += B0(p,MSe(gI1),MSe(gI2))*Conj(CpUAhconjSeSe(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2445 += B0(p,MSu(gI1),MSu(gI2))*Conj(CpUAhconjSuSu(gO2,gI1,
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2447 += Conj(CpUAhconjVWmHpm(gO2,gI2))*CpUAhconjVWmHpm(gO1,gI2)*F0
         (p,MHpm(gI2),MVWm);
   }
   tmp_2446 += tmp_2447;
   result += (2) * tmp_2446;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2448 += Conj(CpUAhVZhh(gO2,gI2))*CpUAhVZhh(gO1,gI2)*F0(p,Mhh(gI2),
         MVZ);
   }
   result += tmp_2448;
...
std::complex<double> CLASSNAME::self_energy_Hpm(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2450 += A0(MHpm(gI1))*CpUHpmconjUHpmconjHpmHpm(gO1,gO2,gI1,gI1);
   }
   tmp_2449 += tmp_2450;
   result += (-1) * tmp_2449;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2452 += B0(p,MHpm(gI1),MAh(gI2))*Conj(CpconjUHpmHpmAh(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2454 += B0(p,MHpm(gI1),Mhh(gI2))*Conj(CpconjUHpmHpmhh(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2456 += A0(MAh(gI1))*CpUHpmconjUHpmAhAh(gO1,gO2,gI1,gI1);
   }
   tmp_2455 += tmp_2456;
   result += (-0.5) * tmp_2455;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2458 += A0(MSv(gI1))*CpUHpmconjUHpmconjSvSv(gO1,gO2,gI1,gI1);
   }
   tmp_2457 += tmp_2458;
   result += (-1) * tmp_2457;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2460 += A0(Mhh(gI1))*CpUHpmconjUHpmhhhh(gO1,gO2,gI1,gI1);
   }
   tmp_2459 += tmp_2460;
   result += (-0.5) * tmp_2459;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2463 += (Conj(CpconjUHpmbarFuFdPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2465 += (Conj(CpconjUHpmbarFvFePL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2467 += B0(p,MSv(gI1),MSe(gI2))*Conj(CpconjUHpmconjSvSe(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2477 += (Conj(CpconjUHpmChiChaPL(gO2,gI1,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2481 += B0(p,MChi(gI1),MCha(gI2))*(Conj(CpconjUHpmChiChaPR(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2483 += A0(MSd(gI1))*CpUHpmconjUHpmconjSdSd(gO1,gO2,gI1,gI1);
   }
   tmp_2482 += tmp_2483;
   result += (-3) * tmp_2482;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2485 += A0(MSe(gI1))*CpUHpmconjUHpmconjSeSe(gO1,gO2,gI1,gI1);
   }
   tmp_2484 += tmp_2485;
   result += (-1) * tmp_2484;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2487 += A0(MSu(gI1))*CpUHpmconjUHpmconjSuSu(gO1,gO2,gI1,gI1);
   }
   tmp_2486 += tmp_2487;
   result += (-3) * tmp_2486;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2490 += B0(p,MSu(gI1),MSd(gI2))*Conj(CpconjUHpmconjSuSd(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2491 += Conj(CpconjUHpmVPHpm(gO2,gI2))*CpconjUHpmVPHpm(gO1,gI2)*F0
         (p,MHpm(gI2),0);
   }
   result += tmp_2491;
   std::complex<double> tmp_2492;
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2492 += Conj(CpconjUHpmVZHpm(gO2,gI2))*CpconjUHpmVZHpm(gO1,gI2)*F0
         (p,MHpm(gI2),MVZ);
   }
   result += tmp_2492;
   std::complex<double> tmp_2493;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2493 += Conj(CpconjUHpmVWmAh(gO2,gI2))*CpconjUHpmVWmAh(gO1,gI2)*F0
         (p,MAh(gI2),MVWm);
   }
   result += tmp_2493;
   std::complex<double> tmp_2494;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2494 += Conj(CpconjUHpmVWmhh(gO2,gI2))*CpconjUHpmVWmhh(gO1,gI2)*F0
         (p,Mhh(gI2),MVWm);
   }
   result += tmp_2494;
...
std::complex<double> CLASSNAME::self_energy_VG(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2497 += (AbsSqr(CpVGbarFdFdPL(gI1,gI2)) + AbsSqr(
            CpVGbarFdFdPR(gI1,gI2)))*H0(p,MFd(gI1),MFd(gI2));
         tmp_2497 += 4*B0(p,MFd(gI1),MFd(gI2))*MFd(gI1)*MFd(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2500 += (AbsSqr(CpVGbarFuFuPL(gI1,gI2)) + AbsSqr(
            CpVGbarFuFuPR(gI1,gI2)))*H0(p,MFu(gI1),MFu(gI2));
         tmp_2500 += 4*B0(p,MFu(gI1),MFu(gI2))*MFu(gI1)*MFu(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2502 += A0(MSd(gI1))*CpVGVGconjSdSd(gI1,gI1);
   }
   tmp_2501 += tmp_2502;
   result += (999) * tmp_2501;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2504 += A0(MSu(gI1))*CpVGVGconjSuSu(gI1,gI1);
   }
   tmp_2503 += tmp_2504;
   result += (999) * tmp_2503;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2507 += AbsSqr(CpVGconjSdSd(gI1,gI2))*B00(p,MSd(gI1),MSd(gI2
            ));
      }
      tmp_2506 += tmp_2507;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2510 += AbsSqr(CpVGconjSuSu(gI1,gI2))*B00(p,MSu(gI1),MSu(gI2
            ));
      }
      tmp_2509 += tmp_2510;
   }
...
std::complex<double> CLASSNAME::self_energy_VP(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2511 += A0(MHpm(gI1))*CpVPVPconjHpmHpm(gI1,gI1);
   }
   result += tmp_2511;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2514 += AbsSqr(CpVPconjHpmHpm(gI1,gI2))*B00(p,MHpm(gI1),MHpm
            (gI2));
      }
      tmp_2513 += tmp_2514;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2516 += (AbsSqr(CpVPbarChaChaPL(gI1,gI2)) + AbsSqr(
            CpVPbarChaChaPR(gI1,gI2)))*H0(p,MCha(gI1),MCha(gI2));
         tmp_2516 += 4*B0(p,MCha(gI1),MCha(gI2))*MCha(gI1)*MCha(gI2)*Re(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2519 += (AbsSqr(CpVPbarFdFdPL(gI1,gI2)) + AbsSqr(
            CpVPbarFdFdPR(gI1,gI2)))*H0(p,MFd(gI1),MFd(gI2));
         tmp_2519 += 4*B0(p,MFd(gI1),MFd(gI2))*MFd(gI1)*MFd(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2521 += (AbsSqr(CpVPbarFeFePL(gI1,gI2)) + AbsSqr(
            CpVPbarFeFePR(gI1,gI2)))*H0(p,MFe(gI1),MFe(gI2));
         tmp_2521 += 4*B0(p,MFe(gI1),MFe(gI2))*MFe(gI1)*MFe(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2524 += (AbsSqr(CpVPbarFuFuPL(gI1,gI2)) + AbsSqr(
            CpVPbarFuFuPR(gI1,gI2)))*H0(p,MFu(gI1),MFu(gI2));
         tmp_2524 += 4*B0(p,MFu(gI1),MFu(gI2))*MFu(gI1)*MFu(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2526 += A0(MSd(gI1))*CpVPVPconjSdSd(gI1,gI1);
   }
   tmp_2525 += tmp_2526;
   result += (3) * tmp_2525;
   std::complex<double> tmp_2527;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2527 += A0(MSe(gI1))*CpVPVPconjSeSe(gI1,gI1);
   }
   result += tmp_2527;
   std::complex<double> tmp_2528;
   std::complex<double> tmp_2529;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2529 += A0(MSu(gI1))*CpVPVPconjSuSu(gI1,gI1);
   }
   tmp_2528 += tmp_2529;
   result += (3) * tmp_2528;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2532 += AbsSqr(CpVPconjSdSd(gI1,gI2))*B00(p,MSd(gI1),MSd(gI2
            ));
      }
      tmp_2531 += tmp_2532;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2535 += AbsSqr(CpVPconjSeSe(gI1,gI2))*B00(p,MSe(gI1),MSe(gI2
            ));
      }
      tmp_2534 += tmp_2535;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2538 += AbsSqr(CpVPconjSuSu(gI1,gI2))*B00(p,MSu(gI1),MSu(gI2
            ));
      }
      tmp_2537 += tmp_2538;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2540 += AbsSqr(CpVPconjVWmHpm(gI2))*B0(p,MVWm,MHpm(gI2));
   }
   tmp_2539 += tmp_2540;
   result += (2) * tmp_2539;
...
std::complex<double> CLASSNAME::self_energy_VZ(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2541 += A0(MHpm(gI1))*CpVZVZconjHpmHpm(gI1,gI1);
   }
   result += tmp_2541;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2544 += AbsSqr(CpVZconjHpmHpm(gI1,gI2))*B00(p,MHpm(gI1),MHpm
            (gI2));
      }
      tmp_2543 += tmp_2544;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2546 += (AbsSqr(CpVZbarChaChaPL(gI1,gI2)) + AbsSqr(
            CpVZbarChaChaPR(gI1,gI2)))*H0(p,MCha(gI1),MCha(gI2));
         tmp_2546 += 4*B0(p,MCha(gI1),MCha(gI2))*MCha(gI1)*MCha(gI2)*Re(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2548 += A0(MAh(gI1))*CpVZVZAhAh(gI1,gI1);
   }
   tmp_2547 += tmp_2548;
   result += (0.5) * tmp_2547;
   std::complex<double> tmp_2549;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2549 += A0(MSv(gI1))*CpVZVZconjSvSv(gI1,gI1);
   }
   result += tmp_2549;
   std::complex<double> tmp_2550;
   std::complex<double> tmp_2551;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2551 += A0(Mhh(gI1))*CpVZVZhhhh(gI1,gI1);
   }
   tmp_2550 += tmp_2551;
   result += (0.5) * tmp_2550;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2554 += AbsSqr(CpVZconjSvSv(gI1,gI2))*B00(p,MSv(gI1),MSv(gI2
            ));
      }
      tmp_2553 += tmp_2554;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2557 += AbsSqr(CpVZhhAh(gI1,gI2))*B00(p,MAh(gI2),Mhh(gI1));
      }
      tmp_2556 += tmp_2557;
   }
   tmp_2555 += tmp_2556;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2560 += (AbsSqr(CpVZbarFdFdPL(gI1,gI2)) + AbsSqr(
            CpVZbarFdFdPR(gI1,gI2)))*H0(p,MFd(gI1),MFd(gI2));
         tmp_2560 += 4*B0(p,MFd(gI1),MFd(gI2))*MFd(gI1)*MFd(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2562 += (AbsSqr(CpVZbarFeFePL(gI1,gI2)) + AbsSqr(
            CpVZbarFeFePR(gI1,gI2)))*H0(p,MFe(gI1),MFe(gI2));
         tmp_2562 += 4*B0(p,MFe(gI1),MFe(gI2))*MFe(gI1)*MFe(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2565 += (AbsSqr(CpVZbarFuFuPL(gI1,gI2)) + AbsSqr(
            CpVZbarFuFuPR(gI1,gI2)))*H0(p,MFu(gI1),MFu(gI2));
         tmp_2565 += 4*B0(p,MFu(gI1),MFu(gI2))*MFu(gI1)*MFu(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2567 += (AbsSqr(CpVZbarFvFvPL(gI1,gI2)) + AbsSqr(
            CpVZbarFvFvPR(gI1,gI2)))*H0(p,MFv(gI1),MFv(gI2));
         tmp_2567 += 4*B0(p,MFv(gI1),MFv(gI2))*MFv(gI1)*MFv(gI2)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2570 += (AbsSqr(CpVZChiChiPL(gI1,gI2)) + AbsSqr(CpVZChiChiPR
            (gI1,gI2)))*H0(p,MChi(gI1),MChi(gI2));
         tmp_2570 += 4*B0(p,MChi(gI1),MChi(gI2))*MChi(gI1)*MChi(gI2)*Re(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2572 += A0(MSd(gI1))*CpVZVZconjSdSd(gI1,gI1);
   }
   tmp_2571 += tmp_2572;
   result += (3) * tmp_2571;
   std::complex<double> tmp_2573;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2573 += A0(MSe(gI1))*CpVZVZconjSeSe(gI1,gI1);
   }
   result += tmp_2573;
   std::complex<double> tmp_2574;
   std::complex<double> tmp_2575;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2575 += A0(MSu(gI1))*CpVZVZconjSuSu(gI1,gI1);
   }
   tmp_2574 += tmp_2575;
   result += (3) * tmp_2574;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2578 += AbsSqr(CpVZconjSdSd(gI1,gI2))*B00(p,MSd(gI1),MSd(gI2
            ));
      }
      tmp_2577 += tmp_2578;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2581 += AbsSqr(CpVZconjSeSe(gI1,gI2))*B00(p,MSe(gI1),MSe(gI2
            ));
      }
      tmp_2580 += tmp_2581;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2584 += AbsSqr(CpVZconjSuSu(gI1,gI2))*B00(p,MSu(gI1),MSu(gI2
            ));
      }
      tmp_2583 += tmp_2584;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2586 += AbsSqr(CpVZconjVWmHpm(gI2))*B0(p,MVWm,MHpm(gI2));
   }
   tmp_2585 += tmp_2586;
   result += (2) * tmp_2585;
   std::complex<double> tmp_2587;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2587 += AbsSqr(CpVZVZhh(gI2))*B0(p,MVZ,Mhh(gI2));
   }
   result += tmp_2587;
...
std::complex<double> CLASSNAME::self_energy_VWm(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2588 += A0(MHpm(gI1))*CpVWmconjVWmconjHpmHpm(gI1,gI1);
   }
   result += tmp_2588;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2591 += AbsSqr(CpconjVWmHpmAh(gI1,gI2))*B00(p,MAh(gI2),MHpm(
            gI1));
      }
      tmp_2590 += tmp_2591;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2594 += AbsSqr(CpconjVWmHpmhh(gI1,gI2))*B00(p,Mhh(gI2),MHpm(
            gI1));
      }
      tmp_2593 += tmp_2594;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2596 += A0(MAh(gI1))*CpVWmconjVWmAhAh(gI1,gI1);
   }
   tmp_2595 += tmp_2596;
   result += (0.5) * tmp_2595;
   std::complex<double> tmp_2597;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2597 += A0(MSv(gI1))*CpVWmconjVWmconjSvSv(gI1,gI1);
   }
   result += tmp_2597;
   std::complex<double> tmp_2598;
   std::complex<double> tmp_2599;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_2599 += A0(Mhh(gI1))*CpVWmconjVWmhhhh(gI1,gI1);
   }
   tmp_2598 += tmp_2599;
   result += (0.5) * tmp_2598;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2602 += (AbsSqr(CpconjVWmbarFuFdPL(gI1,gI2)) + AbsSqr(
            CpconjVWmbarFuFdPR(gI1,gI2)))*H0(p,MFu(gI1),MFd(gI2));
         tmp_2602 += 4*B0(p,MFu(gI1),MFd(gI2))*MFd(gI2)*MFu(gI1)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2604 += (AbsSqr(CpconjVWmbarFvFePL(gI1,gI2)) + AbsSqr(
            CpconjVWmbarFvFePR(gI1,gI2)))*H0(p,MFv(gI1),MFe(gI2));
         tmp_2604 += 4*B0(p,MFv(gI1),MFe(gI2))*MFe(gI2)*MFv(gI1)*Re(Conj(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2607 += AbsSqr(CpconjVWmconjSvSe(gI1,gI2))*B00(p,MSe(gI2),
            MSv(gI1));
      }
      tmp_2606 += tmp_2607;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2609 += (AbsSqr(CpconjVWmChiChaPL(gI1,gI2)) + AbsSqr(
            CpconjVWmChiChaPR(gI1,gI2)))*H0(p,MChi(gI1),MCha(gI2));
         tmp_2609 += 4*B0(p,MChi(gI1),MCha(gI2))*MCha(gI2)*MChi(gI1)*Re(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2611 += A0(MSd(gI1))*CpVWmconjVWmconjSdSd(gI1,gI1);
   }
   tmp_2610 += tmp_2611;
   result += (3) * tmp_2610;
   std::complex<double> tmp_2612;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2612 += A0(MSe(gI1))*CpVWmconjVWmconjSeSe(gI1,gI1);
   }
   result += tmp_2612;
   std::complex<double> tmp_2613;
   std::complex<double> tmp_2614;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2614 += A0(MSu(gI1))*CpVWmconjVWmconjSuSu(gI1,gI1);
   }
   tmp_2613 += tmp_2614;
   result += (3) * tmp_2613;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2617 += AbsSqr(CpconjVWmconjSuSd(gI1,gI2))*B00(p,MSd(gI2),
            MSu(gI1));
      }
      tmp_2616 += tmp_2617;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2618 += AbsSqr(CpconjVWmVPHpm(gI2))*B0(p,0,MHpm(gI2));
   }
   result += tmp_2618;
   std::complex<double> tmp_2619;
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2619 += AbsSqr(CpconjVWmVZHpm(gI2))*B0(p,MVZ,MHpm(gI2));
   }
   result += tmp_2619;
   std::complex<double> tmp_2620;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2620 += AbsSqr(CpconjVWmVWmhh(gI2))*B0(p,MVWm,Mhh(gI2));
   }
   result += tmp_2620;
...
std::complex<double> CLASSNAME::self_energy_Chi_1(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2622 += B0(p,MCha(gI2),MHpm(gI1))*Conj(CpUChiconjHpmChaPL(
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2624 += B0(p,MCha(gI1),MVWm)*Conj(CpUChibarChaVWmPR(gO2,gI1))*
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2627 += B0(p,MCha(gI1),MHpm(gI2))*Conj(CpUChibarChaHpmPL(gO2
            ,gI1,gI2))*CpUChibarChaHpmPR(gO1,gI1,gI2);
      }
      tmp_2626 += tmp_2627;
      tmp_2625 += (MCha(gI1)) * tmp_2626;
   }
   result += tmp_2625;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2629 += B0(p,MFv(gI2),MSv(gI1))*Conj(CpUChiconjSvFvPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2631 += B0(p,MChi(gI2),Mhh(gI1))*Conj(CpUChihhChiPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2635 += B0(p,MFd(gI1),MSd(gI2))*Conj(CpUChibarFdSdPL(gO2,gI1
            ,gI2))*CpUChibarFdSdPR(gO1,gI1,gI2);
      }
      tmp_2634 += tmp_2635;
      tmp_2633 += (MFd(gI1)) * tmp_2634;
   }
   tmp_2632 += tmp_2633;
   result += (3) * tmp_2632;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2638 += B0(p,MFe(gI1),MSe(gI2))*Conj(CpUChibarFeSePL(gO2,gI1
            ,gI2))*CpUChibarFeSePR(gO1,gI1,gI2);
      }
      tmp_2637 += tmp_2638;
      tmp_2636 += (MFe(gI1)) * tmp_2637;
   }
   result += tmp_2636;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2642 += B0(p,MFu(gI1),MSu(gI2))*Conj(CpUChibarFuSuPL(gO2,gI1
            ,gI2))*CpUChibarFuSuPR(gO1,gI1,gI2);
      }
      tmp_2641 += tmp_2642;
      tmp_2640 += (MFu(gI1)) * tmp_2641;
   }
   tmp_2639 += tmp_2640;
   result += (3) * tmp_2639;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2645 += B0(p,MFv(gI1),MSv(gI2))*Conj(CpUChibarFvSvPL(gO2,gI1
            ,gI2))*CpUChibarFvSvPR(gO1,gI1,gI2);
      }
      tmp_2644 += tmp_2645;
      tmp_2643 += (MFv(gI1)) * tmp_2644;
   }
   result += tmp_2643;
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2648 += B0(p,MChi(gI1),MAh(gI2))*Conj(CpUChiChiAhPL(gO2,gI1,
            gI2))*CpUChiChiAhPR(gO1,gI1,gI2);
      }
      tmp_2647 += tmp_2648;
      tmp_2646 += (MChi(gI1)) * tmp_2647;
   }
   result += tmp_2646;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2651 += B0(p,MFd(gI2),MSd(gI1))*Conj(CpUChiconjSdFdPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2653 += B0(p,MFe(gI2),MSe(gI1))*Conj(CpUChiconjSeFePL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2656 += B0(p,MFu(gI2),MSu(gI1))*Conj(CpUChiconjSuFuPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2658 += B0(p,MCha(gI2),MVWm)*Conj(CpUChiconjVWmChaPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
      tmp_2660 += B0(p,MChi(gI2),MVZ)*Conj(CpUChiVZChiPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Chi_PR(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2662 += B1(p,MCha(gI1),MVWm)*Conj(CpUChibarChaVWmPL(gO2,gI1))*
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2665 += B1(p,MCha(gI1),MHpm(gI2))*Conj(CpUChibarChaHpmPR(gO2
            ,gI1,gI2))*CpUChibarChaHpmPR(gO1,gI1,gI2);
      }
      tmp_2664 += tmp_2665;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2668 += B1(p,MCha(gI2),MHpm(gI1))*Conj(CpUChiconjHpmChaPR(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2671 += B1(p,MFv(gI1),MSv(gI2))*Conj(CpUChibarFvSvPR(gO2,gI1
            ,gI2))*CpUChibarFvSvPR(gO1,gI1,gI2);
      }
      tmp_2670 += tmp_2671;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2674 += B1(p,MFv(gI2),MSv(gI1))*Conj(CpUChiconjSvFvPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2677 += B1(p,MChi(gI2),Mhh(gI1))*Conj(CpUChihhChiPR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2680 += B1(p,MFd(gI1),MSd(gI2))*Conj(CpUChibarFdSdPR(gO2,gI1
            ,gI2))*CpUChibarFdSdPR(gO1,gI1,gI2);
      }
      tmp_2679 += tmp_2680;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2683 += B1(p,MFe(gI1),MSe(gI2))*Conj(CpUChibarFeSePR(gO2,gI1
            ,gI2))*CpUChibarFeSePR(gO1,gI1,gI2);
      }
      tmp_2682 += tmp_2683;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2686 += B1(p,MFu(gI1),MSu(gI2))*Conj(CpUChibarFuSuPR(gO2,gI1
            ,gI2))*CpUChibarFuSuPR(gO1,gI1,gI2);
      }
      tmp_2685 += tmp_2686;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2689 += B1(p,MChi(gI1),MAh(gI2))*Conj(CpUChiChiAhPR(gO2,gI1,
            gI2))*CpUChiChiAhPR(gO1,gI1,gI2);
      }
      tmp_2688 += tmp_2689;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2692 += B1(p,MFd(gI2),MSd(gI1))*Conj(CpUChiconjSdFdPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2695 += B1(p,MFe(gI2),MSe(gI1))*Conj(CpUChiconjSeFePR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2698 += B1(p,MFu(gI2),MSu(gI1))*Conj(CpUChiconjSuFuPR(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2700 += B1(p,MCha(gI2),MVWm)*Conj(CpUChiconjVWmChaPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
      tmp_2702 += B1(p,MChi(gI2),MVZ)*Conj(CpUChiVZChiPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Chi_PL(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_2704 += B1(p,MCha(gI1),MVWm)*Conj(CpUChibarChaVWmPR(gO2,gI1))*
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2707 += B1(p,MCha(gI1),MHpm(gI2))*Conj(CpUChibarChaHpmPL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2710 += B1(p,MCha(gI2),MHpm(gI1))*Conj(CpUChiconjHpmChaPL(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2713 += B1(p,MFv(gI1),MSv(gI2))*Conj(CpUChibarFvSvPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2716 += B1(p,MFv(gI2),MSv(gI1))*Conj(CpUChiconjSvFvPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2719 += B1(p,MChi(gI2),Mhh(gI1))*Conj(CpUChihhChiPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2722 += B1(p,MFd(gI1),MSd(gI2))*Conj(CpUChibarFdSdPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2725 += B1(p,MFe(gI1),MSe(gI2))*Conj(CpUChibarFeSePL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2728 += B1(p,MFu(gI1),MSu(gI2))*Conj(CpUChibarFuSuPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2731 += B1(p,MChi(gI1),MAh(gI2))*Conj(CpUChiChiAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2734 += B1(p,MFd(gI2),MSd(gI1))*Conj(CpUChiconjSdFdPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2737 += B1(p,MFe(gI2),MSe(gI1))*Conj(CpUChiconjSeFePL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2740 += B1(p,MFu(gI2),MSu(gI1))*Conj(CpUChiconjSuFuPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2742 += B1(p,MCha(gI2),MVWm)*Conj(CpUChiconjVWmChaPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
      tmp_2744 += B1(p,MChi(gI2),MVZ)*Conj(CpUChiVZChiPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Cha_1(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2746 += B0(p,MChi(gI2),MHpm(gI1))*Conj(CpbarUChaHpmChiPL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2749 += B0(p,MCha(gI1),MAh(gI2))*Conj(CpbarUChaChaAhPL(gO2,
            gI1,gI2))*CpbarUChaChaAhPR(gO1,gI1,gI2);
      }
      tmp_2748 += tmp_2749;
      tmp_2747 += (MCha(gI1)) * tmp_2748;
   }
   result += tmp_2747;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2751 += B0(p,MCha(gI2),Mhh(gI1))*Conj(CpbarUChahhChaPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2753 += B0(p,MFe(gI2),MSv(gI1))*Conj(CpbarUChaconjSvFePL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2757 += B0(p,MFu(gI1),MSd(gI2))*Conj(CpbarUChabarFuSdPL(gO2,
            gI1,gI2))*CpbarUChabarFuSdPR(gO1,gI1,gI2);
      }
      tmp_2756 += tmp_2757;
      tmp_2755 += (MFu(gI1)) * tmp_2756;
   }
   tmp_2754 += tmp_2755;
   result += (3) * tmp_2754;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2760 += B0(p,MFv(gI1),MSe(gI2))*Conj(CpbarUChabarFvSePL(gO2,
            gI1,gI2))*CpbarUChabarFvSePR(gO1,gI1,gI2);
      }
      tmp_2759 += tmp_2760;
      tmp_2758 += (MFv(gI1)) * tmp_2759;
   }
   result += tmp_2758;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2763 += B0(p,MFd(gI2),MSu(gI1))*Conj(CpbarUChaconjSuFdPL(gO2
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2765 += B0(p,MCha(gI2),0)*Conj(CpbarUChaVPChaPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2767 += B0(p,MCha(gI2),MVZ)*Conj(CpbarUChaVZChaPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
      tmp_2769 += B0(p,MChi(gI2),MVWm)*Conj(CpbarUChaVWmChiPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Cha_PR(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2772 += B1(p,MCha(gI1),MAh(gI2))*Conj(CpbarUChaChaAhPR(gO2,
            gI1,gI2))*CpbarUChaChaAhPR(gO1,gI1,gI2);
      }
      tmp_2771 += tmp_2772;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2775 += B1(p,MChi(gI2),MHpm(gI1))*Conj(CpbarUChaHpmChiPR(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2778 += B1(p,MCha(gI2),Mhh(gI1))*Conj(CpbarUChahhChaPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2781 += B1(p,MFe(gI2),MSv(gI1))*Conj(CpbarUChaconjSvFePR(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2784 += B1(p,MFu(gI1),MSd(gI2))*Conj(CpbarUChabarFuSdPR(gO2,
            gI1,gI2))*CpbarUChabarFuSdPR(gO1,gI1,gI2);
      }
      tmp_2783 += tmp_2784;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2787 += B1(p,MFv(gI1),MSe(gI2))*Conj(CpbarUChabarFvSePR(gO2,
            gI1,gI2))*CpbarUChabarFvSePR(gO1,gI1,gI2);
      }
      tmp_2786 += tmp_2787;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2790 += B1(p,MFd(gI2),MSu(gI1))*Conj(CpbarUChaconjSuFdPR(gO2
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2792 += B1(p,MCha(gI2),0)*Conj(CpbarUChaVPChaPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2794 += B1(p,MCha(gI2),MVZ)*Conj(CpbarUChaVZChaPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
      tmp_2796 += B1(p,MChi(gI2),MVWm)*Conj(CpbarUChaVWmChiPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Cha_PL(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2799 += B1(p,MCha(gI1),MAh(gI2))*Conj(CpbarUChaChaAhPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2802 += B1(p,MChi(gI2),MHpm(gI1))*Conj(CpbarUChaHpmChiPL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2805 += B1(p,MCha(gI2),Mhh(gI1))*Conj(CpbarUChahhChaPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2808 += B1(p,MFe(gI2),MSv(gI1))*Conj(CpbarUChaconjSvFePL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2811 += B1(p,MFu(gI1),MSd(gI2))*Conj(CpbarUChabarFuSdPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2814 += B1(p,MFv(gI1),MSe(gI2))*Conj(CpbarUChabarFvSePL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2817 += B1(p,MFd(gI2),MSu(gI1))*Conj(CpbarUChaconjSuFdPL(gO2
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2819 += B1(p,MCha(gI2),0)*Conj(CpbarUChaVPChaPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_2821 += B1(p,MCha(gI2),MVZ)*Conj(CpbarUChaVZChaPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
      tmp_2823 += B1(p,MChi(gI2),MVWm)*Conj(CpbarUChaVWmChiPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fe_1(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2825 += B0(p,MFv(gI2),MHpm(gI1))*Conj(CpbarUFeHpmFvPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2827 += B0(p,MCha(gI2),MSv(gI1))*Conj(CpbarUFeSvChaPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2829 += B0(p,MFe(gI2),Mhh(gI1))*Conj(CpbarUFehhFePL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2832 += B0(p,MFe(gI1),MAh(gI2))*Conj(CpbarUFeFeAhPL(gO2,gI1,
            gI2))*CpbarUFeFeAhPR(gO1,gI1,gI2);
      }
      tmp_2831 += tmp_2832;
      tmp_2830 += (MFe(gI1)) * tmp_2831;
   }
   result += tmp_2830;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2834 += B0(p,MChi(gI2),MSe(gI1))*Conj(CpbarUFeSeChiPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2836 += B0(p,MFe(gI2),0)*Conj(CpbarUFeVPFePR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2838 += B0(p,MFe(gI2),MVZ)*Conj(CpbarUFeVZFePR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2840 += B0(p,MFv(gI2),MVWm)*Conj(CpbarUFeVWmFvPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fe_PR(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2843 += B1(p,MFv(gI2),MHpm(gI1))*Conj(CpbarUFeHpmFvPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2846 += B1(p,MCha(gI2),MSv(gI1))*Conj(CpbarUFeSvChaPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2849 += B1(p,MFe(gI1),MAh(gI2))*Conj(CpbarUFeFeAhPR(gO2,gI1,
            gI2))*CpbarUFeFeAhPR(gO1,gI1,gI2);
      }
      tmp_2848 += tmp_2849;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2852 += B1(p,MFe(gI2),Mhh(gI1))*Conj(CpbarUFehhFePR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2855 += B1(p,MChi(gI2),MSe(gI1))*Conj(CpbarUFeSeChiPR(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2857 += B1(p,MFe(gI2),0)*Conj(CpbarUFeVPFePL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2859 += B1(p,MFv(gI2),MVWm)*Conj(CpbarUFeVWmFvPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2861 += B1(p,MFe(gI2),MVZ)*Conj(CpbarUFeVZFePL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fe_PL(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2864 += B1(p,MFv(gI2),MHpm(gI1))*Conj(CpbarUFeHpmFvPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2867 += B1(p,MCha(gI2),MSv(gI1))*Conj(CpbarUFeSvChaPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2870 += B1(p,MFe(gI1),MAh(gI2))*Conj(CpbarUFeFeAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2873 += B1(p,MFe(gI2),Mhh(gI1))*Conj(CpbarUFehhFePL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2876 += B1(p,MChi(gI2),MSe(gI1))*Conj(CpbarUFeSeChiPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2878 += B1(p,MFe(gI2),0)*Conj(CpbarUFeVPFePR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2880 += B1(p,MFv(gI2),MVWm)*Conj(CpbarUFeVWmFvPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2882 += B1(p,MFe(gI2),MVZ)*Conj(CpbarUFeVZFePR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fd_1(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2884 += B0(p,MFu(gI2),MHpm(gI1))*Conj(CpbarUFdHpmFuPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2886 += B0(p,MFd(gI2),Mhh(gI1))*Conj(CpbarUFdhhFdPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2889 += B0(p,MFd(gI1),MAh(gI2))*Conj(CpbarUFdFdAhPL(gO2,gI1,
            gI2))*CpbarUFdFdAhPR(gO1,gI1,gI2);
      }
      tmp_2888 += tmp_2889;
      tmp_2887 += (MFd(gI1)) * tmp_2888;
   }
   result += tmp_2887;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2891 += B0(p,MCha(gI2),MSu(gI1))*Conj(CpbarUFdSuChaPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2893 += B0(p,MChi(gI2),MSd(gI1))*Conj(CpbarUFdSdChiPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2895 += B0(p,MFd(gI2),0)*Conj(CpbarUFdVGFdPR(gO2,gI2))*
         CpbarUFdVGFdPL(gO1,gI2)*MFd(gI2);
   }
   tmp_2894 += tmp_2895;
   result += (-5.333333333333333) * tmp_2894;
   std::complex<double> tmp_2896;
   std::complex<double> tmp_2897;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2897 += B0(p,MFd(gI2),0)*Conj(CpbarUFdVPFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2899 += B0(p,MFd(gI2),MVZ)*Conj(CpbarUFdVZFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2901 += B0(p,MFu(gI2),MVWm)*Conj(CpbarUFdVWmFuPR(gO2,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2903 += B0(p,MGlu,MSd(gI1))*Conj(CpbarUFdSdGluPL(gO2,gI1,0))*
         CpbarUFdSdGluPR(gO1,gI1,0);
   }
   tmp_2902 += tmp_2903;
   result += (1.3333333333333333*MGlu) * tmp_2902;
...
std::complex<double> CLASSNAME::self_energy_Fd_PR(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2906 += B1(p,MFu(gI2),MHpm(gI1))*Conj(CpbarUFdHpmFuPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2909 += B1(p,MFd(gI1),MAh(gI2))*Conj(CpbarUFdFdAhPR(gO2,gI1,
            gI2))*CpbarUFdFdAhPR(gO1,gI1,gI2);
      }
      tmp_2908 += tmp_2909;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2912 += B1(p,MFd(gI2),Mhh(gI1))*Conj(CpbarUFdhhFdPR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2914 += B1(p,MGlu,MSd(gI1))*Conj(CpbarUFdSdGluPR(gO2,gI1,0))*
         CpbarUFdSdGluPR(gO1,gI1,0);
   }
   tmp_2913 += tmp_2914;
   result += (-0.6666666666666666) * tmp_2913;
   std::complex<double> tmp_2915;
   std::complex<double> tmp_2916;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_2917;
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2917 += B1(p,MCha(gI2),MSu(gI1))*Conj(CpbarUFdSuChaPR(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2920 += B1(p,MChi(gI2),MSd(gI1))*Conj(CpbarUFdSdChiPR(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2922 += B1(p,MFd(gI2),0)*Conj(CpbarUFdVGFdPL(gO2,gI2))*
         CpbarUFdVGFdPL(gO1,gI2);
   }
   tmp_2921 += tmp_2922;
   result += (-1.3333333333333333) * tmp_2921;
   std::complex<double> tmp_2923;
   std::complex<double> tmp_2924;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2924 += B1(p,MFd(gI2),0)*Conj(CpbarUFdVPFdPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2926 += B1(p,MFu(gI2),MVWm)*Conj(CpbarUFdVWmFuPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2928 += B1(p,MFd(gI2),MVZ)*Conj(CpbarUFdVZFdPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fd_PL(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2931 += B1(p,MFu(gI2),MHpm(gI1))*Conj(CpbarUFdHpmFuPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2934 += B1(p,MFd(gI1),MAh(gI2))*Conj(CpbarUFdFdAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2937 += B1(p,MFd(gI2),Mhh(gI1))*Conj(CpbarUFdhhFdPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2939 += B1(p,MGlu,MSd(gI1))*Conj(CpbarUFdSdGluPL(gO2,gI1,0))*
         CpbarUFdSdGluPL(gO1,gI1,0);
   }
   tmp_2938 += tmp_2939;
   result += (-0.6666666666666666) * tmp_2938;
   std::complex<double> tmp_2940;
   std::complex<double> tmp_2941;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_2942;
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_2942 += B1(p,MCha(gI2),MSu(gI1))*Conj(CpbarUFdSuChaPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2945 += B1(p,MChi(gI2),MSd(gI1))*Conj(CpbarUFdSdChiPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2947 += B1(p,MFd(gI2),0)*Conj(CpbarUFdVGFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2949 += B1(p,MFd(gI2),0)*Conj(CpbarUFdVPFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2951 += B1(p,MFu(gI2),MVWm)*Conj(CpbarUFdVWmFuPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2953 += B1(p,MFd(gI2),MVZ)*Conj(CpbarUFdVZFdPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2955 += B0(p,MFd(gI2),MHpm(gI1))*Conj(CpbarUFuconjHpmFdPL(
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2958 += B0(p,MCha(gI1),MSd(gI2))*Conj(CpbarUFubarChaSdPL(gO2
            ,gI1,gI2))*CpbarUFubarChaSdPR(gO1,gI1,gI2);
      }
      tmp_2957 += tmp_2958;
      tmp_2956 += (MCha(gI1)) * tmp_2957;
   }
   result += tmp_2956;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2960 += B0(p,MFu(gI2),Mhh(gI1))*Conj(CpbarUFuhhFuPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2963 += B0(p,MFu(gI1),MAh(gI2))*Conj(CpbarUFuFuAhPL(gO2,gI1,
            gI2))*CpbarUFuFuAhPR(gO1,gI1,gI2);
      }
      tmp_2962 += tmp_2963;
      tmp_2961 += (MFu(gI1)) * tmp_2962;
   }
   result += tmp_2961;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2965 += B0(p,MChi(gI2),MSu(gI1))*Conj(CpbarUFuSuChiPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2967 += B0(p,MFd(gI2),MVWm)*Conj(CpbarUFuconjVWmFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2969 += B0(p,MFu(gI2),0)*Conj(CpbarUFuVGFuPR(gO2,gI2))*
         CpbarUFuVGFuPL(gO1,gI2)*MFu(gI2);
   }
   tmp_2968 += tmp_2969;
   result += (-5.333333333333333) * tmp_2968;
   std::complex<double> tmp_2970;
   std::complex<double> tmp_2971;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2971 += B0(p,MFu(gI2),0)*Conj(CpbarUFuVPFuPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2973 += B0(p,MFu(gI2),MVZ)*Conj(CpbarUFuVZFuPR(gO2,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2975 += B0(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPL(gO2,gI1,0))*
         CpbarUFuSuGluPR(gO1,gI1,0);
   }
   tmp_2974 += tmp_2975;
   result += (1.3333333333333333*MGlu) * tmp_2974;
...
std::complex<double> CLASSNAME::self_energy_Fu_PR(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2978 += B1(p,MFd(gI2),MHpm(gI1))*Conj(CpbarUFuconjHpmFdPR(
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_2981 += B1(p,MCha(gI1),MSd(gI2))*Conj(CpbarUFubarChaSdPR(gO2
            ,gI1,gI2))*CpbarUFubarChaSdPR(gO1,gI1,gI2);
      }
      tmp_2980 += tmp_2981;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2984 += B1(p,MFu(gI1),MAh(gI2))*Conj(CpbarUFuFuAhPR(gO2,gI1,
            gI2))*CpbarUFuFuAhPR(gO1,gI1,gI2);
      }
      tmp_2983 += tmp_2984;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_2987 += B1(p,MFu(gI2),Mhh(gI1))*Conj(CpbarUFuhhFuPR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_2989 += B1(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPR(gO2,gI1,0))*
         CpbarUFuSuGluPR(gO1,gI1,0);
   }
   tmp_2988 += tmp_2989;
   result += (-0.6666666666666666) * tmp_2988;
   std::complex<double> tmp_2990;
   std::complex<double> tmp_2991;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_2992;
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_2992 += B1(p,MChi(gI2),MSu(gI1))*Conj(CpbarUFuSuChiPR(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2994 += B1(p,MFd(gI2),MVWm)*Conj(CpbarUFuconjVWmFdPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2996 += B1(p,MFu(gI2),0)*Conj(CpbarUFuVGFuPL(gO2,gI2))*
         CpbarUFuVGFuPL(gO1,gI2);
   }
   tmp_2995 += tmp_2996;
   result += (-1.3333333333333333) * tmp_2995;
   std::complex<double> tmp_2997;
   std::complex<double> tmp_2998;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_2998 += B1(p,MFu(gI2),0)*Conj(CpbarUFuVPFuPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3000 += B1(p,MFu(gI2),MVZ)*Conj(CpbarUFuVZFuPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fu_PL(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3003 += B1(p,MFd(gI2),MHpm(gI1))*Conj(CpbarUFuconjHpmFdPL(
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3006 += B1(p,MCha(gI1),MSd(gI2))*Conj(CpbarUFubarChaSdPL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3009 += B1(p,MFu(gI1),MAh(gI2))*Conj(CpbarUFuFuAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3012 += B1(p,MFu(gI2),Mhh(gI1))*Conj(CpbarUFuhhFuPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3014 += B1(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPL(gO2,gI1,0))*
         CpbarUFuSuGluPL(gO1,gI1,0);
   }
   tmp_3013 += tmp_3014;
   result += (-0.6666666666666666) * tmp_3013;
   std::complex<double> tmp_3015;
   std::complex<double> tmp_3016;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3017;
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3017 += B1(p,MChi(gI2),MSu(gI1))*Conj(CpbarUFuSuChiPL(gO2,
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3019 += B1(p,MFd(gI2),MVWm)*Conj(CpbarUFuconjVWmFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3021 += B1(p,MFu(gI2),0)*Conj(CpbarUFuVGFuPR(gO2,gI2))*
         CpbarUFuVGFuPR(gO1,gI2);
   }
   tmp_3020 += tmp_3021;
   result += (-1.3333333333333333) * tmp_3020;
   std::complex<double> tmp_3022;
   std::complex<double> tmp_3023;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3023 += B1(p,MFu(gI2),0)*Conj(CpbarUFuVPFuPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3025 += B1(p,MFu(gI2),MVZ)*Conj(CpbarUFuVZFuPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Glu_1(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3029 += B0(p,MFd(gI1),MSd(gI2))*Conj(CpGlubarFdSdPL(gI1,gI2)
            )*CpGlubarFdSdPR(gI1,gI2);
      }
      tmp_3028 += tmp_3029;
      tmp_3027 += (MFd(gI1)) * tmp_3028;
   }
   tmp_3026 += tmp_3027;
   result += (0.5) * tmp_3026;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3033 += B0(p,MFu(gI1),MSu(gI2))*Conj(CpGlubarFuSuPL(gI1,gI2)
            )*CpGlubarFuSuPR(gI1,gI2);
      }
      tmp_3032 += tmp_3033;
      tmp_3031 += (MFu(gI1)) * tmp_3032;
   }
   tmp_3030 += tmp_3031;
   result += (0.5) * tmp_3030;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3036 += B0(p,MFd(gI2),MSd(gI1))*Conj(CpGluconjSdFdPL(gI1,gI2
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3039 += B0(p,MFu(gI2),MSu(gI1))*Conj(CpGluconjSuFuPL(gI1,gI2
...
std::complex<double> CLASSNAME::self_energy_Glu_PR(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3042 += AbsSqr(CpGlubarFdSdPR(gI1,gI2))*B1(p,MFd(gI1),MSd(
            gI2));
      }
      tmp_3041 += tmp_3042;
   }
   tmp_3040 += tmp_3041;
   result += (-0.25) * tmp_3040;
   std::complex<double> tmp_3043;
   std::complex<double> tmp_3044;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      std::complex<double> tmp_3045;
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3045 += AbsSqr(CpGlubarFuSuPR(gI1,gI2))*B1(p,MFu(gI1),MSu(
            gI2));
      }
      tmp_3044 += tmp_3045;
   }
   tmp_3043 += tmp_3044;
   result += (-0.25) * tmp_3043;
   std::complex<double> tmp_3046;
   std::complex<double> tmp_3047;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3048;
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3048 += AbsSqr(CpGluconjSdFdPR(gI1,gI2))*B1(p,MFd(gI2),MSd(
            gI1));
      }
      tmp_3047 += tmp_3048;
   }
   tmp_3046 += tmp_3047;
   result += (-0.25) * tmp_3046;
   std::complex<double> tmp_3049;
   std::complex<double> tmp_3050;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3051;
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3051 += AbsSqr(CpGluconjSuFuPR(gI1,gI2))*B1(p,MFu(gI2),MSu(
            gI1));
      }
      tmp_3050 += tmp_3051;
   }
   tmp_3049 += tmp_3050;
   result += (-0.25) * tmp_3049;
...
std::complex<double> CLASSNAME::self_energy_Glu_PL(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3054 += AbsSqr(CpGlubarFdSdPL(gI1,gI2))*B1(p,MFd(gI1),MSd(
            gI2));
      }
      tmp_3053 += tmp_3054;
   }
   tmp_3052 += tmp_3053;
   result += (-0.25) * tmp_3052;
   std::complex<double> tmp_3055;
   std::complex<double> tmp_3056;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      std::complex<double> tmp_3057;
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3057 += AbsSqr(CpGlubarFuSuPL(gI1,gI2))*B1(p,MFu(gI1),MSu(
            gI2));
      }
      tmp_3056 += tmp_3057;
   }
   tmp_3055 += tmp_3056;
   result += (-0.25) * tmp_3055;
   std::complex<double> tmp_3058;
   std::complex<double> tmp_3059;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3060;
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3060 += AbsSqr(CpGluconjSdFdPL(gI1,gI2))*B1(p,MFd(gI2),MSd(
            gI1));
      }
      tmp_3059 += tmp_3060;
   }
   tmp_3058 += tmp_3059;
   result += (-0.25) * tmp_3058;
   std::complex<double> tmp_3061;
   std::complex<double> tmp_3062;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3063;
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3063 += AbsSqr(CpGluconjSuFuPL(gI1,gI2))*B1(p,MFu(gI2),MSu(
            gI1));
      }
      tmp_3062 += tmp_3063;
   }
   tmp_3061 += tmp_3062;
   result += (-0.25) * tmp_3061;
...
std::complex<double> CLASSNAME::self_energy_Fv_1(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3065 += B0(p,MFe(gI2),MHpm(gI1))*Conj(CpbarFvconjHpmFePL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3068 += B0(p,MCha(gI1),MSe(gI2))*Conj(CpbarFvbarChaSePL(gO2,
            gI1,gI2))*CpbarFvbarChaSePR(gO1,gI1,gI2);
      }
      tmp_3067 += tmp_3068;
      tmp_3066 += (MCha(gI1)) * tmp_3067;
   }
   result += tmp_3066;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3070 += B0(p,MChi(gI2),MSv(gI1))*Conj(CpbarFvSvChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3072 += B0(p,MFe(gI2),MVWm)*Conj(CpbarFvconjVWmFePR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3074 += B0(p,MFv(gI2),MVZ)*Conj(CpbarFvVZFvPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fv_PR(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3077 += B1(p,MFe(gI2),MHpm(gI1))*Conj(CpbarFvconjHpmFePR(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3080 += B1(p,MCha(gI1),MSe(gI2))*Conj(CpbarFvbarChaSePR(gO2,
            gI1,gI2))*CpbarFvbarChaSePR(gO1,gI1,gI2);
      }
      tmp_3079 += tmp_3080;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3083 += B1(p,MChi(gI2),MSv(gI1))*Conj(CpbarFvSvChiPR(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3085 += B1(p,MFe(gI2),MVWm)*Conj(CpbarFvconjVWmFePL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3087 += B1(p,MFv(gI2),MVZ)*Conj(CpbarFvVZFvPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fv_PL(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3090 += B1(p,MFe(gI2),MHpm(gI1))*Conj(CpbarFvconjHpmFePL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3093 += B1(p,MCha(gI1),MSe(gI2))*Conj(CpbarFvbarChaSePL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3096 += B1(p,MChi(gI2),MSv(gI1))*Conj(CpbarFvSvChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3098 += B1(p,MFe(gI2),MVWm)*Conj(CpbarFvconjVWmFePR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3100 += B1(p,MFv(gI2),MVZ)*Conj(CpbarFvVZFvPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_VZ_heavy(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3102 += (AbsSqr(CpVZbarChaChaPL(gI1,gI2)) + AbsSqr(
            CpVZbarChaChaPR(gI1,gI2)))*H0(p,MCha(gI1),MCha(gI2));
         tmp_3102 += 4*B0(p,MCha(gI1),MCha(gI2))*MCha(gI1)*MCha(gI2)*Re(
            Conj(CpVZbarChaChaPL(gI1,gI2))*CpVZbarChaChaPR(gI1,gI2));
      }
      tmp_3101 += tmp_3102;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3103 += A0(MSv(gI1))*CpVZVZconjSvSv(gI1,gI1);
   }
   result += tmp_3103;
   std::complex<double> tmp_3104;
   std::complex<double> tmp_3105;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3105 += A0(Mhh(gI1))*CpVZVZhhhh(gI1,gI1);
   }
   tmp_3104 += tmp_3105;
   result += (0.5) * tmp_3104;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3108 += AbsSqr(CpVZhhAh(gI1,1 + gI2))*B00(p,MAh(1 + gI2),Mhh
            (gI1));
      }
      tmp_3107 += tmp_3108;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3111 += AbsSqr(CpVZconjSvSv(gI1,gI2))*B00(p,MSv(gI1),MSv(gI2
            ));
      }
      tmp_3110 += tmp_3111;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3114 += (AbsSqr(CpVZChiChiPL(gI1,gI2)) + AbsSqr(CpVZChiChiPR
            (gI1,gI2)))*H0(p,MChi(gI1),MChi(gI2));
         tmp_3114 += 4*B0(p,MChi(gI1),MChi(gI2))*MChi(gI1)*MChi(gI2)*Re(
            Conj(CpVZChiChiPL(gI1,gI2))*CpVZChiChiPR(gI1,gI2));
      }
      tmp_3113 += tmp_3114;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3116 += A0(MSd(gI1))*CpVZVZconjSdSd(gI1,gI1);
   }
   tmp_3115 += tmp_3116;
   result += (3) * tmp_3115;
   std::complex<double> tmp_3117;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3117 += A0(MSe(gI1))*CpVZVZconjSeSe(gI1,gI1);
   }
   result += tmp_3117;
   std::complex<double> tmp_3118;
   std::complex<double> tmp_3119;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3119 += A0(MSu(gI1))*CpVZVZconjSuSu(gI1,gI1);
   }
   tmp_3118 += tmp_3119;
   result += (3) * tmp_3118;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3122 += AbsSqr(CpVZconjSdSd(gI1,gI2))*B00(p,MSd(gI1),MSd(gI2
            ));
      }
      tmp_3121 += tmp_3122;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3125 += AbsSqr(CpVZconjSeSe(gI1,gI2))*B00(p,MSe(gI1),MSe(gI2
            ));
      }
      tmp_3124 += tmp_3125;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3128 += AbsSqr(CpVZconjSuSu(gI1,gI2))*B00(p,MSu(gI1),MSu(gI2
            ));
      }
      tmp_3127 += tmp_3128;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3129 += AbsSqr(CpVZVZhh(gI2))*B0(p,MVZ,Mhh(gI2));
   }
   result += tmp_3129;
...
std::complex<double> CLASSNAME::self_energy_VWm_heavy(double p ) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3130 += A0(MSv(gI1))*CpVWmconjVWmconjSvSv(gI1,gI1);
   }
   result += tmp_3130;
   std::complex<double> tmp_3131;
   std::complex<double> tmp_3132;
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3132 += A0(Mhh(gI1))*CpVWmconjVWmhhhh(gI1,gI1);
   }
   tmp_3131 += tmp_3132;
   result += (0.5) * tmp_3131;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3135 += AbsSqr(CpconjVWmconjSvSe(gI1,gI2))*B00(p,MSe(gI2),
            MSv(gI1));
      }
      tmp_3134 += tmp_3135;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3137 += (AbsSqr(CpconjVWmChiChaPL(gI1,gI2)) + AbsSqr(
            CpconjVWmChiChaPR(gI1,gI2)))*H0(p,MChi(gI1),MCha(gI2));
         tmp_3137 += 4*B0(p,MChi(gI1),MCha(gI2))*MCha(gI2)*MChi(gI1)*Re(
            Conj(CpconjVWmChiChaPL(gI1,gI2))*CpconjVWmChiChaPR(gI1,gI2));
      }
      tmp_3136 += tmp_3137;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3139 += A0(MSd(gI1))*CpVWmconjVWmconjSdSd(gI1,gI1);
   }
   tmp_3138 += tmp_3139;
   result += (3) * tmp_3138;
   std::complex<double> tmp_3140;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3140 += A0(MSe(gI1))*CpVWmconjVWmconjSeSe(gI1,gI1);
   }
   result += tmp_3140;
   std::complex<double> tmp_3141;
   std::complex<double> tmp_3142;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3142 += A0(MSu(gI1))*CpVWmconjVWmconjSuSu(gI1,gI1);
   }
   tmp_3141 += tmp_3142;
   result += (3) * tmp_3141;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3145 += AbsSqr(CpconjVWmconjSuSd(gI1,gI2))*B00(p,MSd(gI2),
            MSu(gI1));
      }
      tmp_3144 += tmp_3145;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3147 += AbsSqr(CpconjVWmHpmhh(1,gI2))*B00(p,Mhh(gI2),MHpm(1));
   }
   tmp_3146 += tmp_3147;
   result += (-4) * tmp_3146;
   std::complex<double> tmp_3148;
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3148 += AbsSqr(CpconjVWmVWmhh(gI2))*B0(p,MVWm,Mhh(gI2));
   }
   result += tmp_3148;
...
std::complex<double> CLASSNAME::self_energy_Fe_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3150 += B0(p,MFv(gI2),MHpm(gI1))*Conj(CpbarFeHpmFvPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3152 += B0(p,MCha(gI2),MSv(gI1))*Conj(CpbarFeSvChaPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3154 += B0(p,MFe(gI2),Mhh(gI1))*Conj(CpbarFehhFePL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3157 += B0(p,MFe(gI1),MAh(gI2))*Conj(CpbarFeFeAhPL(gO2,gI1,
            gI2))*CpbarFeFeAhPR(gO1,gI1,gI2);
      }
      tmp_3156 += tmp_3157;
      tmp_3155 += (MFe(gI1)) * tmp_3156;
   }
   result += tmp_3155;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3159 += B0(p,MChi(gI2),MSe(gI1))*Conj(CpbarFeSeChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3161 += B0(p,MFe(gI2),MVZ)*Conj(CpbarFeVZFePR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3163 += B0(p,MFv(gI2),MVWm)*Conj(CpbarFeVWmFvPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fe_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3166 += B1(p,MFv(gI2),MHpm(gI1))*Conj(CpbarFeHpmFvPR(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3169 += B1(p,MCha(gI2),MSv(gI1))*Conj(CpbarFeSvChaPR(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3172 += B1(p,MFe(gI1),MAh(gI2))*Conj(CpbarFeFeAhPR(gO2,gI1,
            gI2))*CpbarFeFeAhPR(gO1,gI1,gI2);
      }
      tmp_3171 += tmp_3172;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3175 += B1(p,MFe(gI2),Mhh(gI1))*Conj(CpbarFehhFePR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3178 += B1(p,MChi(gI2),MSe(gI1))*Conj(CpbarFeSeChiPR(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3180 += B1(p,MFv(gI2),MVWm)*Conj(CpbarFeVWmFvPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3182 += B1(p,MFe(gI2),MVZ)*Conj(CpbarFeVZFePL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fe_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3185 += B1(p,MFv(gI2),MHpm(gI1))*Conj(CpbarFeHpmFvPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3188 += B1(p,MCha(gI2),MSv(gI1))*Conj(CpbarFeSvChaPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3191 += B1(p,MFe(gI1),MAh(gI2))*Conj(CpbarFeFeAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3194 += B1(p,MFe(gI2),Mhh(gI1))*Conj(CpbarFehhFePL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3197 += B1(p,MChi(gI2),MSe(gI1))*Conj(CpbarFeSeChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3199 += B1(p,MFv(gI2),MVWm)*Conj(CpbarFeVWmFvPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3201 += B1(p,MFe(gI2),MVZ)*Conj(CpbarFeVZFePR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fd_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3203 += B0(p,MFu(gI2),MHpm(gI1))*Conj(CpbarFdHpmFuPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3205 += B0(p,MFd(gI2),Mhh(gI1))*Conj(CpbarFdhhFdPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3208 += B0(p,MFd(gI1),MAh(gI2))*Conj(CpbarFdFdAhPL(gO2,gI1,
            gI2))*CpbarFdFdAhPR(gO1,gI1,gI2);
      }
      tmp_3207 += tmp_3208;
      tmp_3206 += (MFd(gI1)) * tmp_3207;
   }
   result += tmp_3206;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3210 += B0(p,MCha(gI2),MSu(gI1))*Conj(CpbarFdSuChaPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3212 += B0(p,MChi(gI2),MSd(gI1))*Conj(CpbarFdSdChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3214 += B0(p,MFd(gI2),MVZ)*Conj(CpbarFdVZFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3216 += B0(p,MFu(gI2),MVWm)*Conj(CpbarFdVWmFuPR(gO2,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3218 += B0(p,MGlu,MSd(gI1))*Conj(CpbarFdSdGluPL(gO2,gI1,0))*
         CpbarFdSdGluPR(gO1,gI1,0);
   }
   tmp_3217 += tmp_3218;
   result += (1.3333333333333333*MGlu) * tmp_3217;
...
std::complex<double> CLASSNAME::self_energy_Fd_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3221 += B1(p,MFu(gI2),MHpm(gI1))*Conj(CpbarFdHpmFuPR(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3224 += B1(p,MFd(gI1),MAh(gI2))*Conj(CpbarFdFdAhPR(gO2,gI1,
            gI2))*CpbarFdFdAhPR(gO1,gI1,gI2);
      }
      tmp_3223 += tmp_3224;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3227 += B1(p,MFd(gI2),Mhh(gI1))*Conj(CpbarFdhhFdPR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3229 += B1(p,MGlu,MSd(gI1))*Conj(CpbarFdSdGluPR(gO2,gI1,0))*
         CpbarFdSdGluPR(gO1,gI1,0);
   }
   tmp_3228 += tmp_3229;
   result += (-0.6666666666666666) * tmp_3228;
   std::complex<double> tmp_3230;
   std::complex<double> tmp_3231;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3232;
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3232 += B1(p,MCha(gI2),MSu(gI1))*Conj(CpbarFdSuChaPR(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3235 += B1(p,MChi(gI2),MSd(gI1))*Conj(CpbarFdSdChiPR(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3237 += B1(p,MFu(gI2),MVWm)*Conj(CpbarFdVWmFuPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3239 += B1(p,MFd(gI2),MVZ)*Conj(CpbarFdVZFdPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fd_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3242 += B1(p,MFu(gI2),MHpm(gI1))*Conj(CpbarFdHpmFuPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3245 += B1(p,MFd(gI1),MAh(gI2))*Conj(CpbarFdFdAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3248 += B1(p,MFd(gI2),Mhh(gI1))*Conj(CpbarFdhhFdPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3250 += B1(p,MGlu,MSd(gI1))*Conj(CpbarFdSdGluPL(gO2,gI1,0))*
         CpbarFdSdGluPL(gO1,gI1,0);
   }
   tmp_3249 += tmp_3250;
   result += (-0.6666666666666666) * tmp_3249;
   std::complex<double> tmp_3251;
   std::complex<double> tmp_3252;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3253;
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         tmp_3253 += B1(p,MCha(gI2),MSu(gI1))*Conj(CpbarFdSuChaPL(gO2,gI1
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3256 += B1(p,MChi(gI2),MSd(gI1))*Conj(CpbarFdSdChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3258 += B1(p,MFu(gI2),MVWm)*Conj(CpbarFdVWmFuPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3260 += B1(p,MFd(gI2),MVZ)*Conj(CpbarFdVZFdPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3262 += B0(p,MFd(gI2),MHpm(gI1))*Conj(CpbarFuconjHpmFdPL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3265 += B0(p,MCha(gI1),MSd(gI2))*Conj(CpbarFubarChaSdPL(gO2,
            gI1,gI2))*CpbarFubarChaSdPR(gO1,gI1,gI2);
      }
      tmp_3264 += tmp_3265;
      tmp_3263 += (MCha(gI1)) * tmp_3264;
   }
   result += tmp_3263;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3267 += B0(p,MFu(gI2),Mhh(gI1))*Conj(CpbarFuhhFuPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3270 += B0(p,MFu(gI1),MAh(gI2))*Conj(CpbarFuFuAhPL(gO2,gI1,
            gI2))*CpbarFuFuAhPR(gO1,gI1,gI2);
      }
      tmp_3269 += tmp_3270;
      tmp_3268 += (MFu(gI1)) * tmp_3269;
   }
   result += tmp_3268;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3272 += B0(p,MChi(gI2),MSu(gI1))*Conj(CpbarFuSuChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3274 += B0(p,MFd(gI2),MVWm)*Conj(CpbarFuconjVWmFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3276 += B0(p,MFu(gI2),0)*Conj(CpbarFuVPFuPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3278 += B0(p,MFu(gI2),MVZ)*Conj(CpbarFuVZFuPR(gO2,gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3280 += B0(p,MGlu,MSu(gI1))*Conj(CpbarFuSuGluPL(gO2,gI1,0))*
         CpbarFuSuGluPR(gO1,gI1,0);
   }
   tmp_3279 += tmp_3280;
   result += (1.3333333333333333*MGlu) * tmp_3279;
...
std::complex<double> CLASSNAME::self_energy_Fu_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3283 += B1(p,MFd(gI2),MHpm(gI1))*Conj(CpbarFuconjHpmFdPR(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3286 += B1(p,MCha(gI1),MSd(gI2))*Conj(CpbarFubarChaSdPR(gO2,
            gI1,gI2))*CpbarFubarChaSdPR(gO1,gI1,gI2);
      }
      tmp_3285 += tmp_3286;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3289 += B1(p,MFu(gI1),MAh(gI2))*Conj(CpbarFuFuAhPR(gO2,gI1,
            gI2))*CpbarFuFuAhPR(gO1,gI1,gI2);
      }
      tmp_3288 += tmp_3289;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3292 += B1(p,MFu(gI2),Mhh(gI1))*Conj(CpbarFuhhFuPR(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3294 += B1(p,MGlu,MSu(gI1))*Conj(CpbarFuSuGluPR(gO2,gI1,0))*
         CpbarFuSuGluPR(gO1,gI1,0);
   }
   tmp_3293 += tmp_3294;
   result += (-0.6666666666666666) * tmp_3293;
   std::complex<double> tmp_3295;
   std::complex<double> tmp_3296;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3297;
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3297 += B1(p,MChi(gI2),MSu(gI1))*Conj(CpbarFuSuChiPR(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3299 += B1(p,MFd(gI2),MVWm)*Conj(CpbarFuconjVWmFdPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3301 += B1(p,MFu(gI2),0)*Conj(CpbarFuVPFuPL(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3303 += B1(p,MFu(gI2),MVZ)*Conj(CpbarFuVZFuPL(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fu_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3306 += B1(p,MFd(gI2),MHpm(gI1))*Conj(CpbarFuconjHpmFdPL(gO2
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3309 += B1(p,MCha(gI1),MSd(gI2))*Conj(CpbarFubarChaSdPL(gO2,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3312 += B1(p,MFu(gI1),MAh(gI2))*Conj(CpbarFuFuAhPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3315 += B1(p,MFu(gI2),Mhh(gI1))*Conj(CpbarFuhhFuPL(gO2,gI1,
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3317 += B1(p,MGlu,MSu(gI1))*Conj(CpbarFuSuGluPL(gO2,gI1,0))*
         CpbarFuSuGluPL(gO1,gI1,0);
   }
   tmp_3316 += tmp_3317;
   result += (-0.6666666666666666) * tmp_3316;
   std::complex<double> tmp_3318;
   std::complex<double> tmp_3319;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3320;
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3320 += B1(p,MChi(gI2),MSu(gI1))*Conj(CpbarFuSuChiPL(gO2,gI1
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3322 += B1(p,MFd(gI2),MVWm)*Conj(CpbarFuconjVWmFdPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3324 += B1(p,MFu(gI2),0)*Conj(CpbarFuVPFuPR(gO2,gI2))*
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3326 += B1(p,MFu(gI2),MVZ)*Conj(CpbarFuVZFuPR(gO2,gI2))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1_heavy(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3328 += B0(p,MFd(gI2),MHpm(gI1))*Conj(CpbarUFuconjHpmFdPL(
            gO2,gI1,gI2))*CpbarUFuconjHpmFdPR(gO1,gI1,gI2)*MFd(gI2);
      }
      tmp_3327 += tmp_3328;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3331 += B0(p,MCha(gI1),MSd(gI2))*Conj(CpbarUFubarChaSdPL(gO2
            ,gI1,gI2))*CpbarUFubarChaSdPR(gO1,gI1,gI2);
      }
      tmp_3330 += tmp_3331;
      tmp_3329 += (MCha(gI1)) * tmp_3330;
   }
   result += tmp_3329;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3333 += B0(p,MFu(gI2),Mhh(gI1))*Conj(CpbarUFuhhFuPL(gO2,gI1,
            gI2))*CpbarUFuhhFuPR(gO1,gI1,gI2)*MFu(gI2);
      }
      tmp_3332 += tmp_3333;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3336 += B0(p,MFu(gI1),MAh(gI2))*Conj(CpbarUFuFuAhPL(gO2,gI1,
            gI2))*CpbarUFuFuAhPR(gO1,gI1,gI2);
      }
      tmp_3335 += tmp_3336;
      tmp_3334 += (MFu(gI1)) * tmp_3335;
   }
   result += tmp_3334;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3338 += B0(p,MChi(gI2),MSu(gI1))*Conj(CpbarUFuSuChiPL(gO2,
            gI1,gI2))*CpbarUFuSuChiPR(gO1,gI1,gI2)*MChi(gI2);
      }
      tmp_3337 += tmp_3338;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3340 += B0(p,MFd(gI2),MVWm)*Conj(CpbarUFuconjVWmFdPR(gO2,gI2))*
         CpbarUFuconjVWmFdPL(gO1,gI2)*MFd(gI2);
   }
   tmp_3339 += tmp_3340;
   result += (-4) * tmp_3339;
...
std::complex<double> CLASSNAME::self_energy_Fu_PR_heavy(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3349 += B1(p,MFd(gI2),MHpm(gI1))*Conj(CpbarUFuconjHpmFdPR(
            gO2,gI1,gI2))*CpbarUFuconjHpmFdPR(gO1,gI1,gI2);
      }
      tmp_3348 += tmp_3349;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3352 += B1(p,MCha(gI1),MSd(gI2))*Conj(CpbarUFubarChaSdPR(gO2
            ,gI1,gI2))*CpbarUFubarChaSdPR(gO1,gI1,gI2);
      }
      tmp_3351 += tmp_3352;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3355 += B1(p,MFu(gI1),MAh(gI2))*Conj(CpbarUFuFuAhPR(gO2,gI1,
            gI2))*CpbarUFuFuAhPR(gO1,gI1,gI2);
      }
      tmp_3354 += tmp_3355;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3358 += B1(p,MFu(gI2),Mhh(gI1))*Conj(CpbarUFuhhFuPR(gO2,gI1,
            gI2))*CpbarUFuhhFuPR(gO1,gI1,gI2);
      }
      tmp_3357 += tmp_3358;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3360 += B1(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPR(gO2,gI1,0))*
         CpbarUFuSuGluPR(gO1,gI1,0);
   }
   tmp_3359 += tmp_3360;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3363 += B1(p,MChi(gI2),MSu(gI1))*Conj(CpbarUFuSuChiPR(gO2,
            gI1,gI2))*CpbarUFuSuChiPR(gO1,gI1,gI2);
      }
      tmp_3362 += tmp_3363;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3365 += B1(p,MFd(gI2),MVWm)*Conj(CpbarUFuconjVWmFdPL(gO2,gI2))*
         CpbarUFuconjVWmFdPL(gO1,gI2);
   }
   tmp_3364 += tmp_3365;
   result += (-1) * tmp_3364;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3367 += B1(p,MFu(gI2),0)*Conj(CpbarUFuVPFuPL(gO2,gI2))*
         CpbarUFuVPFuPL(gO1,gI2);
   }
   tmp_3366 += tmp_3367;
   result += (-1) * tmp_3366;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3369 += B1(p,MFu(gI2),MVZ)*Conj(CpbarUFuVZFuPL(gO2,gI2))*
         CpbarUFuVZFuPL(gO1,gI2);
   }
   tmp_3368 += tmp_3369;
   result += (-1) * tmp_3368;
...
std::complex<double> CLASSNAME::self_energy_Fu_PL_heavy(double p , unsigned gO1, unsigned gO2) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3372 += B1(p,MFd(gI2),MHpm(gI1))*Conj(CpbarUFuconjHpmFdPL(
            gO2,gI1,gI2))*CpbarUFuconjHpmFdPL(gO1,gI1,gI2);
      }
      tmp_3371 += tmp_3372;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         tmp_3375 += B1(p,MCha(gI1),MSd(gI2))*Conj(CpbarUFubarChaSdPL(gO2
            ,gI1,gI2))*CpbarUFubarChaSdPL(gO1,gI1,gI2);
      }
      tmp_3374 += tmp_3375;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3378 += B1(p,MFu(gI1),MAh(gI2))*Conj(CpbarUFuFuAhPL(gO2,gI1,
            gI2))*CpbarUFuFuAhPL(gO1,gI1,gI2);
      }
      tmp_3377 += tmp_3378;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         tmp_3381 += B1(p,MFu(gI2),Mhh(gI1))*Conj(CpbarUFuhhFuPL(gO2,gI1,
            gI2))*CpbarUFuhhFuPL(gO1,gI1,gI2);
      }
      tmp_3380 += tmp_3381;
   }
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3383 += B1(p,MGlu,MSu(gI1))*Conj(CpbarUFuSuGluPL(gO2,gI1,0))*
         CpbarUFuSuGluPL(gO1,gI1,0);
   }
   tmp_3382 += tmp_3383;
   result += (-0.6666666666666666) * tmp_3382;
   std::complex<double> tmp_3384;
   std::complex<double> tmp_3385;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      std::complex<double> tmp_3386;
      for (unsigned gI2 = 0; gI2 < 5; ++gI2) {
         tmp_3386 += B1(p,MChi(gI2),MSu(gI1))*Conj(CpbarUFuSuChiPL(gO2,
            gI1,gI2))*CpbarUFuSuChiPL(gO1,gI1,gI2);
      }
      tmp_3385 += tmp_3386;
   }
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3388 += B1(p,MFd(gI2),MVWm)*Conj(CpbarUFuconjVWmFdPR(gO2,gI2))*
         CpbarUFuconjVWmFdPR(gO1,gI2);
   }
   tmp_3387 += tmp_3388;
   result += (-1) * tmp_3387;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3390 += B1(p,MFu(gI2),0)*Conj(CpbarUFuVPFuPR(gO2,gI2))*
         CpbarUFuVPFuPR(gO1,gI2);
   }
   tmp_3389 += tmp_3390;
   result += (-1) * tmp_3389;
   ...
   for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
      tmp_3392 += B1(p,MFu(gI2),MVZ)*Conj(CpbarUFuVZFuPR(gO2,gI2))*
         CpbarUFuVZFuPR(gO1,gI2);
   }
   tmp_3391 += tmp_3392;
   result += (-1) * tmp_3391;
...
std::complex<double> CLASSNAME::tadpole_hh(unsigned gO1) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3394 += A0(MHpm(gI1))*CpUhhconjHpmHpm(gO1,gI1,gI1);
   }
   tmp_3393 += tmp_3394;
   result += (-1) * tmp_3393;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3396 += A0(MCha(gI1))*(CpUhhbarChaChaPL(gO1,gI1,gI1) +
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3398 += A0(MAh(gI1))*CpUhhAhAh(gO1,gI1,gI1);
   }
   tmp_3397 += tmp_3398;
   result += (-0.5) * tmp_3397;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3400 += A0(MSv(gI1))*CpUhhconjSvSv(gO1,gI1,gI1);
   }
   tmp_3399 += tmp_3400;
   result += (-1) * tmp_3399;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3402 += A0(Mhh(gI1))*CpUhhhhhh(gO1,gI1,gI1);
   }
   tmp_3401 += tmp_3402;
   result += (-0.5) * tmp_3401;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3404 += A0(MFd(gI1))*(CpUhhbarFdFdPL(gO1,gI1,gI1) + CpUhhbarFdFdPR
         (gO1,gI1,gI1))*MFd(gI1);
   }
   tmp_3403 += tmp_3404;
   result += (6) * tmp_3403;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3406 += A0(MFe(gI1))*(CpUhhbarFeFePL(gO1,gI1,gI1) + CpUhhbarFeFePR
         (gO1,gI1,gI1))*MFe(gI1);
   }
   tmp_3405 += tmp_3406;
   result += (2) * tmp_3405;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3408 += A0(MFu(gI1))*(CpUhhbarFuFuPL(gO1,gI1,gI1) + CpUhhbarFuFuPR
         (gO1,gI1,gI1))*MFu(gI1);
   }
   tmp_3407 += tmp_3408;
   result += (6) * tmp_3407;
   ...
   for (unsigned gI1 = 0; gI1 < 5; ++gI1) {
      tmp_3409 += A0(MChi(gI1))*(CpUhhChiChiPL(gO1,gI1,gI1) + CpUhhChiChiPR(
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3411 += A0(MSd(gI1))*CpUhhconjSdSd(gO1,gI1,gI1);
   }
   tmp_3410 += tmp_3411;
   result += (-3) * tmp_3410;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3413 += A0(MSe(gI1))*CpUhhconjSeSe(gO1,gI1,gI1);
   }
   tmp_3412 += tmp_3413;
   result += (-1) * tmp_3412;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3415 += A0(MSu(gI1))*CpUhhconjSuSu(gO1,gI1,gI1);
   }
   tmp_3414 += tmp_3415;
   result += (-3) * tmp_3414;
...
Eigen::Matrix<double,3,3> CLASSNAME::self_energy_hh_2loop() const
{
   ...
   const double amu = Re(-0.7071067811865475*vS*Lambdax - Mu);
   const double mg = MGlu;
   const double mAsq = ((Sqr(vd) + Sqr(vu))*(BMu + (L1 + 0.7071067811865475*MS*vS)*Lambdax + 0.5*Kappa*Lambdax*Sqr(vS) + 0.7071067811865475*vS*TLambdax))/(vd*vu);
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_tachyon(NUTSMSSM_info::VZ);
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::Sd))
      return;
   ...
   for (unsigned es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZD;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZD,
            eigenvalue_error);
         problems.flag_bad_mass(NUTSMSSM_info::Sd, eigenvalue_error
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::Sv))
      return;
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      Eigen::Matrix<double,3,3> mix_ZV;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV,
            eigenvalue_error);
         problems.flag_bad_mass(NUTSMSSM_info::Sv, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV);
      #endif
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::Su))
      return;
   ...
   for (unsigned es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZU;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU,
            eigenvalue_error);
         problems.flag_bad_mass(NUTSMSSM_info::Su, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU);
      #endif
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::Se))
      return;
   ...
   for (unsigned es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZE;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE,
            eigenvalue_error);
         problems.flag_bad_mass(NUTSMSSM_info::Se, eigenvalue_error
            > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE);
      #endif
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::hh))
      return;
         ...
         for (unsigned i = 0; i < 3; i++) {
            for (unsigned k = 0; k < 3; k++) {
               if (!std::isfinite(self_energy_2l(i,k))) {
                  ...
                  problems.flag_bad_mass(NUTSMSSM_info::hh
                     );
               }
            }
         }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NUTSMSSM_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(NUTSMSSM_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::Ah))
      return;
      ...
      if (pole_mass_loop_order > 1) {
         ...
         for (unsigned i = 0; i < 3; i++) {
            for (unsigned k = 0; k < 3; k++) {
               if (!std::isfinite(self_energy_2l(i,k))) {
                  self_energy_2l(i,k) = 0.;
                  problems.flag_bad_mass(NUTSMSSM_info::Ah
                     );
               }
            }
         }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NUTSMSSM_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(NUTSMSSM_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::Hpm))
      return;
   ...
   do {
      ...
      for (unsigned es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(NUTSMSSM_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(NUTSMSSM_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(NUTSMSSM_info::Hpm);
}
   ...
   for (unsigned es = 0; es < 5; ++es) {
      ...
      decltype(ZN) mix_ZN;
         ...
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZN,
            eigenvalue_error);
         problems.flag_bad_mass(NUTSMSSM_info::Chi,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZN);
      #endif
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER, eigenvalue_error)
         ;
      problems.flag_bad_mass(NUTSMSSM_info::Fe, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR, eigenvalue_error)
         ;
      problems.flag_bad_mass(NUTSMSSM_info::Fd, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (unsigned es = 0; es < 3; ++es) {
      ...
      fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR, eigenvalue_error)
         ;
      problems.flag_bad_mass(NUTSMSSM_info::Fu, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
{
   if (!force_output && problems.is_tachyon(NUTSMSSM_info::VWm))
      return;
...
std::ostream& operator<<(std::ostream& ostr, const NUTSMSSM_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
