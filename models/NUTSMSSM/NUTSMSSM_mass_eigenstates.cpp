...
// File generated at Tue 10 Oct 2017 22:32:37
 ...
 * parameters.
 *
 * This file was generated at Tue 10 Oct 2017 22:32:37 with FlexibleSUSY
...
#include "NUTSMSSM_two_scale_ewsb_solver.hpp"
#endif
...
CLASSNAME::NUTSMSSM_mass_eigenstates(const NUTSMSSM_input_parameters& input_)
   ...
   , ewsb_solver(new NUTSMSSM_ewsb_solver<Two_scale>())
#endif
{
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<NUTSMSSM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb_tree_level_custom()
{
   ...
   mHd2 = Re((0.025*(-40*vd*AbsSqr(Mu) + 20*vu*BMu + 20*vu*Conj(BMu) + 20*L1*vu
      *Conj(Lambdax) + 14.142135623730951*MS*vS*vu*Conj(Lambdax) +
      ...
      )*Lambdax - 28.284271247461902*vd*vS*Conj(Lambdax)*Mu - 3*Cube(vd)*Sqr(g1) -
   ...
   mHu2 = Re((0.025*(-40*vu*AbsSqr(Mu) + 20*vd*BMu + 20*vd*Conj(BMu) + 20*L1*vd
      *Conj(Lambdax) + 14.142135623730951*MS*vd*vS*Conj(Lambdax) +
      ...
      )*Lambdax - 28.284271247461902*vS*vu*Conj(Lambdax)*Mu - 3*Cube(vu)*Sqr(g1) -
      ...
      Kappa*Sqr(vS) + 10*vd*Conj(Kappa)*Lambdax*Sqr(vS) + 14.142135623730951*vd*vS
      *TLambdax))/vu);
   ms2 = Re((0.25*(-4*vS*AbsSqr(MS) - 2*vS*BMS - 2.8284271247461903*MS*Conj(L1)
      - 2.8284271247461903*L1*Conj(MS) - 2*vS*Conj(BMS) - 4*L1*vS*Conj(Kappa) +
      1.4142135623730951*MS*vd*vu*Conj(Lambdax) - 2.8284271247461903*Conj(LL1) +
      ...
      Conj(MS)*Lambdax + 2*vd*vS*vu*Conj(Kappa)*Lambdax - 2.8284271247461903*LL1 -
      2*vS*AbsSqr(Lambdax)*Sqr(vd) - 1.4142135623730951*Conj(Mu)*Lambdax*Sqr(vd)
      - 1.4142135623730951*Conj(Lambdax)*Mu*Sqr(vd) - 4.242640687119286*MS*Conj(
      Kappa)*Sqr(vS) - 1.4142135623730951*Conj(TKappa)*Sqr(vS) - 4.242640687119286
      *Conj(MS)*Kappa*Sqr(vS) - 2*vS*AbsSqr(Lambdax)*Sqr(vu) - 1.4142135623730951*
      Conj(Mu)*Lambdax*Sqr(vu) - 1.4142135623730951*Conj(Lambdax)*Mu*Sqr(vu) -
...
{
   if (!ewsb_solver) {
      throw SetupError("NUTSMSSM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("NUTSMSSM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("NUTSMSSM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving NUTSMSSM EWSB at " << ewsb_loop_order << "-loop order");
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(NUTSMSSM_info::Hpm);
...
void CLASSNAME::calculate_MSd()
{
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::Hpm);
   }
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(NUTSMSSM_info::VWm);
   }
...
double CLASSNAME::get_ewsb_eq_hh_1() const
{
   double result = Re(mHd2*vd + vd*AbsSqr(Mu) - 0.5*vu*BMu - 0.5*vu*Conj(BMu) -
      ...
      Mu)*Lambdax + 0.7071067811865475*vd*vS*Conj(Lambdax)*Mu + 0.075*Cube(vd)*Sqr
      (g1) + 0.125*Cube(vd)*Sqr(g2) + 0.5*vd*AbsSqr(Lambdax)*Sqr(vS) - 0.25*vu*
      Conj(Lambdax)*Kappa*Sqr(vS) - 0.25*vu*Conj(Kappa)*Lambdax*Sqr(vS) + 0.5*vd*
...
double CLASSNAME::get_ewsb_eq_hh_2() const
{
   double result = Re(mHu2*vu + vu*AbsSqr(Mu) - 0.5*vd*BMu - 0.5*vd*Conj(BMu) -
      ...
      Mu)*Lambdax + 0.7071067811865475*vS*vu*Conj(Lambdax)*Mu + 0.075*Cube(vu)*Sqr
      (g1) + 0.125*Cube(vu)*Sqr(g2) + 0.5*vu*AbsSqr(Lambdax)*Sqr(vd) - 0.075*vu*
      Sqr(g1)*Sqr(vd) - 0.125*vu*Sqr(g2)*Sqr(vd) + 0.5*vu*AbsSqr(Lambdax)*Sqr(vS)
      - 0.25*vd*Conj(Lambdax)*Kappa*Sqr(vS) - 0.25*vd*Conj(Kappa)*Lambdax*Sqr(vS)
...
{
   double result = Re(ms2*vS + vS*AbsSqr(MS) + 0.5*vS*BMS + 0.7071067811865475*
      MS*Conj(L1) + 0.7071067811865475*L1*Conj(MS) + 0.5*vS*Conj(BMS) + L1*vS*Conj
      (Kappa) - 0.35355339059327373*MS*vd*vu*Conj(Lambdax) + 0.7071067811865475*
      Conj(LL1) - 0.35355339059327373*vd*vu*Conj(TLambdax) + AbsSqr(Kappa)*Cube(vS
      ) + vS*Conj(L1)*Kappa - 0.5*vd*vS*vu*Conj(Lambdax)*Kappa -
...
std::complex<double> CLASSNAME::CpAhAhUSdconjUSd(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZA(gI1,0))*
      ...
      KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 3,-0.5*Conj(Lambdax)*Conj(ZA(
      gI1,2))*Conj(ZA(gI2,1))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1)),0)
      + IF(gO1 < 3,-0.5*Conj(Lambdax)*Conj(ZA(gI1,1))*Conj(ZA(gI2,2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1)),0) + IF(gO2 < 3,-0.5*Conj(ZA(gI1,2))*
      Conj(ZA(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*KroneckerDelta(gO1,3 +
      j1)),0) + IF(gO2 < 3,-0.5*Conj(ZA(gI1,1))*Conj(ZA(gI2,2))*Lambdax*SUM(j1,0,2
      ,Conj(Yd(j1,gO2))*KroneckerDelta(gO1,3 + j1)),0) + 0.1*Conj(ZA(gI1,0))*Conj(
      ZA(gI2,0))*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,
      3 + j1)) - 0.1*Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) - Conj(ZA(gI1,0))*
      Conj(ZA(gI2,0))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CphhhhUSdconjUSd(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZH(gI1,0))*
      ...
      KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 3,0.5*Conj(Lambdax)*Conj(ZH(
      gI1,2))*Conj(ZH(gI2,1))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1)),0)
      + IF(gO1 < 3,0.5*Conj(Lambdax)*Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1)),0) + IF(gO2 < 3,0.5*Conj(ZH(gI1,2))*
      Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*KroneckerDelta(gO1,3 +
      j1)),0) + IF(gO2 < 3,0.5*Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,
      Conj(Yd(j1,gO2))*KroneckerDelta(gO1,3 + j1)),0) + 0.1*Conj(ZH(gI1,0))*Conj(
      ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,
      3 + j1)) - 0.1*Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) - Conj(ZH(gI1,0))*
      Conj(ZH(gI2,0))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,
      KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))));
...
std::complex<double> CLASSNAME::CpHpmSuconjUSd(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ZU(gI1,gO2))*Sqr(g2)*ZP(gI2,0),0) + IF(gO2 < 3,0.7071067811865475*vS*Lambdax
      *SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZP(gI2,0),0) + IF(gO2 < 3
      ,Mu*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZP(gI2,0),0) + IF(gO2
      < 3,0.7071067811865475*vd*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,Conj(Yd(j1,
      gO2))*Yd(j1,j2)))*ZP(gI2,0),0) + IF(gO2 < 3,-0.35355339059327373*vu*Conj(ZU(
      gI1,gO2))*Sqr(g2)*ZP(gI2,1),0) + IF(gO2 < 3,SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*
      Conj(TYu(j1,gO2)))*ZP(gI2,1),0) + IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,
      2,Conj(ZU(gI1,j2))*SUM(j1,0,2,Conj(Yu(j1,gO2))*Yu(j1,j2)))*ZP(gI2,1),0) +
      SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYd(j1,j2)
      ))*ZP(gI2,0) + 0.7071067811865475*vu*SUM(j3,0,2,Conj(ZU(gI1,3 + j3))*SUM(j2,
      0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))))*ZP(
      gI2,0) + 0.7071067811865475*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM
      (j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)))*ZP(gI2,1) + Conj(Mu)*SUM(j2,0
      ,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)))*ZP(gI2
      ,1) + 0.7071067811865475*vd*SUM(j3,0,2,Conj(ZU(gI1,3 + j3))*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CpAhSdconjUSd(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vS*Conj(ZA(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI1,3 + j1)))
      ,0) + IF(gO2 < 3,std::complex<double>(0,0.5)*vu*Conj(ZA(gI2,2))*Lambdax*SUM(
      j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI1,3 + j1))),0) + IF(gO2 < 3,std::complex<
      double>(0.,0.7071067811865475)*Conj(ZA(gI2,1))*Mu*SUM(j1,0,2,Conj(Yd(j1,gO2)
      )*Conj(ZD(gI1,3 + j1))),0) + IF(gO2 < 3,std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*Conj(TYd
      (j1,gO2))),0) - std::complex<double>(0,0.5)*vS*Conj(Lambdax)*Conj(ZA(gI2,1))
      *SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)
      )) - std::complex<double>(0.,0.7071067811865475)*Conj(Mu)*Conj(ZA(gI2,1))*
      SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))
      ) - std::complex<double>(0,0.5)*vu*Conj(Lambdax)*Conj(ZA(gI2,2))*SUM(j2,0,2,
      Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))) -
      std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,Conj(
      ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYd(j1,j2)));
...
{
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZD(gI1,gO2))*
      Conj(ZH(gI2,0))*Sqr(g1),0) + IF(gO2 < 3,-0.05*vu*Conj(ZD(gI1,gO2))*Conj(ZH(
      gI2,1))*Sqr(g1),0) + IF(gO2 < 3,0.25*vd*Conj(ZD(gI1,gO2))*Conj(ZH(gI2,0))*
      Sqr(g2),0) + IF(gO2 < 3,-0.25*vu*Conj(ZD(gI1,gO2))*Conj(ZH(gI2,1))*Sqr(g2),0
      ) + IF(gO2 < 3,0.5*vS*Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*
      Conj(ZD(gI1,3 + j1))),0) + IF(gO2 < 3,0.5*vu*Conj(ZH(gI2,2))*Lambdax*SUM(j1,
      0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI1,3 + j1))),0) + IF(gO2 < 3,
      0.7071067811865475*Conj(ZH(gI2,1))*Mu*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(
      gI1,3 + j1))),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,0))*SUM(j1,0,2
      ,Conj(ZD(gI1,3 + j1))*Conj(TYd(j1,gO2))),0) + IF(gO2 < 3,-(vd*Conj(ZH(gI2,0)
      )*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,Conj(Yd(j1,gO2))*Yd(j1,j2)))),0) +
      0.1*vd*Conj(ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*
      KroneckerDelta(gO2,3 + j1)) - 0.1*vu*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,Conj
      (ZD(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj(ZH(
      gI2,1))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd
      (j1,j2))) + 0.7071067811865475*Conj(Mu)*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZD(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))) + 0.5*vu*Conj(
      Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpHpmUSvconjHpmconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(20*IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,
      ...
      (gO1,gO2)*(3*Sqr(g1) - 5*Sqr(g2))*(ZP(gI1,0)*ZP(gI2,0) - ZP(gI1,1)*ZP(gI2,1)
      ));
...
std::complex<double> CLASSNAME::CpSeconjHpmconjUSv(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      IF(gO2 < 3,0.7071067811865475*vS*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(
      ZE(gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Ye(j1,gO2))*
      Conj(ZE(gI2,3 + j1)))*ZP(gI1,1),0);
...
std::complex<double> CLASSNAME::CpAhAhUSvconjUSv(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = -0.05*(Conj(ZA(gI1,0))*Conj(ZA(gI2,0)) -
      Conj(ZA(gI1,1))*Conj(ZA(gI2,1)))*KroneckerDelta(gO1,gO2)*(3*Sqr(g1) + 5*Sqr
      (g2));
...
std::complex<double> CLASSNAME::CphhhhUSvconjUSv(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = -0.05*(Conj(ZH(gI1,0))*Conj(ZH(gI2,0)) -
      Conj(ZH(gI1,1))*Conj(ZH(gI2,1)))*KroneckerDelta(gO1,gO2)*(3*Sqr(g1) + 5*Sqr
      (g2));
...
{
   const std::complex<double> result = IF(gI1 < 3,-0.15*vd*Conj(ZH(gI2,0))*Conj
      (ZV(gI1,gO2))*Sqr(g1),0) + IF(gI1 < 3,0.15*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,
      gO2))*Sqr(g1),0) + IF(gI1 < 3,-0.25*vd*Conj(ZH(gI2,0))*Conj(ZV(gI1,gO2))*Sqr
      (g2),0) + IF(gI1 < 3,0.25*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,gO2))*Sqr(g2),0);
...
std::complex<double> CLASSNAME::CpSdconjHpmconjUSu(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      IF(gO2 < 3,0.7071067811865475*vS*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(
      ZD(gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,Mu*SUM(j1,0,2,Conj(Yd(j1,gO2))*
      Conj(ZD(gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,0.7071067811865475*vu*SUM(j2
      ,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Conj(Yu(j1,gO2))*Yu(j1,j2)))*ZP(gI1,1),0) +
      0.7071067811865475*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)))*ZP(gI1,0) + Conj(Mu)*SUM(j2,0,2,Conj(
...
std::complex<double> CLASSNAME::CpAhAhUSuconjUSu(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZA(gI1,1))*
      ...
      ,gO2)*Sqr(g2),0) + IF(gO1 < 3,0.25*Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*
      KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 3,-0.5*Conj(Lambdax)*Conj(ZA(
      gI1,2))*Conj(ZA(gI2,0))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,gO1)),0)
      + IF(gO1 < 3,-0.5*Conj(Lambdax)*Conj(ZA(gI1,0))*Conj(ZA(gI2,2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yu(j1,gO1)),0) + IF(gO2 < 3,-0.5*Conj(ZA(gI1,2))*
      Conj(ZA(gI2,0))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*KroneckerDelta(gO1,3 +
      j1)),0) + IF(gO2 < 3,-0.5*Conj(ZA(gI1,0))*Conj(ZA(gI2,2))*Lambdax*SUM(j1,0,2
      ,Conj(Yu(j1,gO2))*KroneckerDelta(gO1,3 + j1)),0) - 0.2*Conj(ZA(gI1,0))*Conj(
      ZA(gI2,0))*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,
      3 + j1)) + 0.2*Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) - Conj(ZA(gI1,1))*
      Conj(ZA(gI2,1))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CphhhhUSuconjUSu(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZH(gI1,1))*
      ...
      ,gO2)*Sqr(g2),0) + IF(gO1 < 3,0.25*Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*
      KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 3,0.5*Conj(Lambdax)*Conj(ZH(
      gI1,2))*Conj(ZH(gI2,0))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,gO1)),0)
      + IF(gO1 < 3,0.5*Conj(Lambdax)*Conj(ZH(gI1,0))*Conj(ZH(gI2,2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yu(j1,gO1)),0) + IF(gO2 < 3,0.5*Conj(ZH(gI1,2))*
      Conj(ZH(gI2,0))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*KroneckerDelta(gO1,3 +
      j1)),0) + IF(gO2 < 3,0.5*Conj(ZH(gI1,0))*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,
      Conj(Yu(j1,gO2))*KroneckerDelta(gO1,3 + j1)),0) - 0.2*Conj(ZH(gI1,0))*Conj(
      ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,
      3 + j1)) + 0.2*Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) - Conj(ZH(gI1,1))*
      Conj(ZH(gI2,1))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,
      KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))));
...
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vS*Conj(ZA(gI2,0))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))
      ,0) + IF(gO2 < 3,std::complex<double>(0,0.5)*vd*Conj(ZA(gI2,2))*Lambdax*SUM(
      j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1))),0) + IF(gO2 < 3,std::complex<
      double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))*Mu*SUM(j1,0,2,Conj(Yu(j1,gO2)
      )*Conj(ZU(gI1,3 + j1))),0) + IF(gO2 < 3,std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI2,1))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(TYu
      (j1,gO2))),0) - std::complex<double>(0,0.5)*vS*Conj(Lambdax)*Conj(ZA(gI2,0))
      *SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2)
      )) - std::complex<double>(0.,0.7071067811865475)*Conj(Mu)*Conj(ZA(gI2,0))*
      SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))
      ) - std::complex<double>(0,0.5)*vd*Conj(Lambdax)*Conj(ZA(gI2,2))*SUM(j2,0,2,
      Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))) -
      std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,1))*SUM(j2,0,2,Conj(
      ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYu(j1,j2)));
...
{
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZH(gI2,0))*Conj(
      ZU(gI1,gO2))*Sqr(g1),0) + IF(gO2 < 3,-0.05*vu*Conj(ZH(gI2,1))*Conj(ZU(gI1,
      gO2))*Sqr(g1),0) + IF(gO2 < 3,-0.25*vd*Conj(ZH(gI2,0))*Conj(ZU(gI1,gO2))*Sqr
      (g2),0) + IF(gO2 < 3,0.25*vu*Conj(ZH(gI2,1))*Conj(ZU(gI1,gO2))*Sqr(g2),0) +
      IF(gO2 < 3,0.5*vS*Conj(ZH(gI2,0))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(
      ZU(gI1,3 + j1))),0) + IF(gO2 < 3,0.5*vd*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,
      Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1))),0) + IF(gO2 < 3,0.7071067811865475*
      Conj(ZH(gI2,0))*Mu*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1))),0) + IF
      (gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,1))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))
      *Conj(TYu(j1,gO2))),0) + IF(gO2 < 3,-(vu*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZU(
      gI1,j2))*SUM(j1,0,2,Conj(Yu(j1,gO2))*Yu(j1,j2)))),0) - 0.2*vd*Conj(ZH(gI2,0)
      )*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) + 0.2*
      vu*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*KroneckerDelta(
      gO2,3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZU(gI1,
      j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))) + 0.7071067811865475*
      Conj(Mu)*Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Yu(j1,j2))) + 0.5*vd*Conj(Lambdax)*Conj(ZH(gI2,2)
      )*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yu(j1,j2
      ))) - 0.7071067811865475*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,
      0,2,KroneckerDelta(gO2,3 + j1)*TYu(j1,j2))) - vu*Conj(ZH(gI2,1))*SUM(j3,0,2,
...
std::complex<double> CLASSNAME::CpAhAhUSeconjUSe(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZA(gI1,0))*
      ...
      gO2)*Sqr(g2),0) + IF(gO1 < 3,-0.25*Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*
      KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 3,-0.5*Conj(Lambdax)*Conj(ZA(
      gI1,2))*Conj(ZA(gI2,1))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,gO1)),0)
      + IF(gO1 < 3,-0.5*Conj(Lambdax)*Conj(ZA(gI1,1))*Conj(ZA(gI2,2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Ye(j1,gO1)),0) + IF(gO2 < 3,-0.5*Conj(ZA(gI1,2))*
      Conj(ZA(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*KroneckerDelta(gO1,3 +
      j1)),0) + IF(gO2 < 3,-0.5*Conj(ZA(gI1,1))*Conj(ZA(gI2,2))*Lambdax*SUM(j1,0,2
      ,Conj(Ye(j1,gO2))*KroneckerDelta(gO1,3 + j1)),0) + 0.3*Conj(ZA(gI1,0))*Conj(
      ZA(gI2,0))*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,
      3 + j1)) - 0.3*Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) - Conj(ZA(gI1,0))*
      Conj(ZA(gI2,0))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CphhhhUSeconjUSe(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZH(gI1,0))*
      ...
      gO2)*Sqr(g2),0) + IF(gO1 < 3,-0.25*Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*
      KroneckerDelta(gO1,gO2)*Sqr(g2),0) + IF(gO1 < 3,0.5*Conj(Lambdax)*Conj(ZH(
      gI1,2))*Conj(ZH(gI2,1))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,gO1)),0)
      + IF(gO1 < 3,0.5*Conj(Lambdax)*Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*SUM(j1,0,2,
      KroneckerDelta(gO2,3 + j1)*Ye(j1,gO1)),0) + IF(gO2 < 3,0.5*Conj(ZH(gI1,2))*
      Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*KroneckerDelta(gO1,3 +
      j1)),0) + IF(gO2 < 3,0.5*Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,
      Conj(Ye(j1,gO2))*KroneckerDelta(gO1,3 + j1)),0) + 0.3*Conj(ZH(gI1,0))*Conj(
      ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,
      3 + j1)) - 0.3*Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) - Conj(ZH(gI1,0))*
      Conj(ZH(gI2,0))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2,0,2,
      KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))));
...
std::complex<double> CLASSNAME::CpHpmSvconjUSe(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      ))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZP(gI2,1) + Conj(Mu)*
...
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vS*Conj(ZA(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 + j1)))
      ,0) + IF(gO2 < 3,std::complex<double>(0,0.5)*vu*Conj(ZA(gI2,2))*Lambdax*SUM(
      j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 + j1))),0) + IF(gO2 < 3,std::complex<
      double>(0.,0.7071067811865475)*Conj(ZA(gI2,1))*Mu*SUM(j1,0,2,Conj(Ye(j1,gO2)
      )*Conj(ZE(gI1,3 + j1))),0) + IF(gO2 < 3,std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*Conj(TYe
      (j1,gO2))),0) - std::complex<double>(0,0.5)*vS*Conj(Lambdax)*Conj(ZA(gI2,1))
      *SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)
      )) - std::complex<double>(0.,0.7071067811865475)*Conj(Mu)*Conj(ZA(gI2,1))*
      SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))
      ) - std::complex<double>(0,0.5)*vu*Conj(Lambdax)*Conj(ZA(gI2,2))*SUM(j2,0,2,
      Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))) -
      std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,Conj(
      ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYe(j1,j2)));
...
std::complex<double> CLASSNAME::CphhSeconjUSe(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2))*
      Conj(ZH(gI2,0))*Sqr(g1),0) + IF(gO2 < 3,0.15*vu*Conj(ZE(gI1,gO2))*Conj(ZH(
      gI2,1))*Sqr(g1),0) + IF(gO2 < 3,0.25*vd*Conj(ZE(gI1,gO2))*Conj(ZH(gI2,0))*
      Sqr(g2),0) + IF(gO2 < 3,-0.25*vu*Conj(ZE(gI1,gO2))*Conj(ZH(gI2,1))*Sqr(g2),0
      ) + IF(gO2 < 3,0.5*vS*Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*
      Conj(ZE(gI1,3 + j1))),0) + IF(gO2 < 3,0.5*vu*Conj(ZH(gI2,2))*Lambdax*SUM(j1,
      0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 + j1))),0) + IF(gO2 < 3,
      0.7071067811865475*Conj(ZH(gI2,1))*Mu*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(
      gI1,3 + j1))),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,0))*SUM(j1,0,2
      ,Conj(ZE(gI1,3 + j1))*Conj(TYe(j1,gO2))),0) + IF(gO2 < 3,-(vd*Conj(ZH(gI2,0)
      )*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,Conj(Ye(j1,gO2))*Ye(j1,j2)))),0) +
      0.3*vd*Conj(ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*
      KroneckerDelta(gO2,3 + j1)) - 0.3*vu*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,Conj
      (ZE(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj(ZH(
      gI2,1))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye
      (j1,j2))) + 0.7071067811865475*Conj(Mu)*Conj(ZH(gI2,1))*SUM(j2,0,2,Conj(ZE(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))) + 0.5*vu*Conj(
      Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpUhhHpmconjHpm(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*(-(KroneckerDelta(0,gO2)*(ZP(gI1,0)
      ...
      *(3*Sqr(g1) - 5*Sqr(g2))*ZP(gI2,0) - 5*vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(
      ...
      Sqr(g1) + 5*Sqr(g2))*ZP(gI2,1))) - 10*KroneckerDelta(2,gO2)*(
      1.4142135623730951*Conj(MS)*Lambdax*ZP(gI1,1)*ZP(gI2,0) + 2*vS*Conj(Kappa)*
      Lambdax*ZP(gI1,1)*ZP(gI2,0) + 1.4142135623730951*TLambdax*ZP(gI1,1)*ZP(gI2,0
      ) + 1.4142135623730951*Conj(TLambdax)*ZP(gI1,0)*ZP(gI2,1) +
      1.4142135623730951*Conj(Mu)*Lambdax*(ZP(gI1,0)*ZP(gI2,0) + ZP(gI1,1)*ZP(gI2,
      1)) + Conj(Lambdax)*((2*vS*Lambdax + 1.4142135623730951*Mu)*ZP(gI1,1)*ZP(gI2
      ,1) + ZP(gI1,0)*((2*vS*Lambdax + 1.4142135623730951*Mu)*ZP(gI2,0) + (
      1.4142135623730951*MS + 2*vS*Kappa)*ZP(gI2,1)))));
...
{
   const std::complex<double> result = 0.05*(-10*Conj(ZA(gI1,2))*(Conj(Kappa)*(
      -((Conj(ZA(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)) + Conj(ZA(gI2,0))*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)))*Lambdax) + Conj(ZA(gI2,2))*(4*KroneckerDelta(2,gO1)*
      KroneckerDelta(2,gO2)*Kappa + KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1)*
      Lambdax + KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2)*Lambdax)) + Conj(
      Lambdax)*(-((Conj(ZA(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)) + Conj(ZA(gI2,0))*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)))*Kappa) + Conj(ZA(gI2,2))*(KroneckerDelta(0,gO1)*(
      KroneckerDelta(1,gO2)*Kappa + 2*KroneckerDelta(0,gO2)*Lambdax) +
      KroneckerDelta(1,gO1)*(KroneckerDelta(0,gO2)*Kappa + 2*KroneckerDelta(1,gO2)
      *Lambdax)))) + Conj(ZA(gI1,0))*(10*(-(Conj(ZA(gI2,1))*KroneckerDelta(2,gO1)*
      KroneckerDelta(2,gO2)) + Conj(ZA(gI2,2))*(KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*KroneckerDelta(2,gO2)))*(Conj(
      Lambdax)*Kappa + Conj(Kappa)*Lambdax) - Conj(ZA(gI2,0))*(20*AbsSqr(Lambdax)*
      KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2) + KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2)) +
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2)))) + Conj
      (ZA(gI1,1))*(10*(-(Conj(ZA(gI2,0))*KroneckerDelta(2,gO1)*KroneckerDelta(2,
      gO2)) + Conj(ZA(gI2,2))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)))*(Conj(Lambdax)*Kappa + Conj(
      Kappa)*Lambdax) + Conj(ZA(gI2,1))*(-20*AbsSqr(Lambdax)*KroneckerDelta(2,gO1)
      *KroneckerDelta(2,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(3*Sqr(
      g1) + 5*Sqr(g2)) + KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(-20*AbsSqr(
      Lambdax) + 3*Sqr(g1) + 5*Sqr(g2)))));
...
{
   const std::complex<double> result = 0.05*(-10*Conj(ZH(gI1,2))*(-(Conj(Kappa)
      *((Conj(ZH(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)) + Conj(ZH(gI2,0))*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)))*Lambdax + Conj(ZH(gI2,2))*(-12*KroneckerDelta(2,gO1)
      *KroneckerDelta(2,gO2)*Kappa + KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1)*
      Lambdax + KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2)*Lambdax))) + Conj(
      Lambdax)*(Conj(ZH(gI2,0))*(-(KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1)*
      Kappa) + 2*KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1)*Lambdax +
      KroneckerDelta(2,gO2)*(-(KroneckerDelta(1,gO1)*Kappa) + 2*KroneckerDelta(0,
      gO1)*Lambdax)) - Conj(ZH(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1
      )*Kappa - 2*KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1)*Lambdax +
      KroneckerDelta(2,gO2)*(KroneckerDelta(0,gO1)*Kappa - 2*KroneckerDelta(1,gO1)
      *Lambdax)) + Conj(ZH(gI2,2))*(KroneckerDelta(0,gO1)*(-(KroneckerDelta(1,gO2)
      *Kappa) + 2*KroneckerDelta(0,gO2)*Lambdax) + KroneckerDelta(1,gO1)*(-(
      KroneckerDelta(0,gO2)*Kappa) + 2*KroneckerDelta(1,gO2)*Lambdax)))) + Conj(ZH
      (gI1,1))*(10*Conj(ZH(gI2,2))*(Conj(Kappa)*(KroneckerDelta(0,gO2)*
      KroneckerDelta(2,gO1) + KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2))*Lambdax
      + Conj(Lambdax)*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1)*Kappa - 2*
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1)*Lambdax + KroneckerDelta(2,gO2)*
      (KroneckerDelta(0,gO1)*Kappa - 2*KroneckerDelta(1,gO1)*Lambdax))) + Conj(ZH(
      gI2,1))*(-20*AbsSqr(Lambdax)*KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2) - 3
      *KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(3*Sqr(g1) + 5*Sqr(g2)) +
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1)
      + 5*Sqr(g2))) + Conj(ZH(gI2,0))*(10*KroneckerDelta(2,gO1)*KroneckerDelta(2,
      gO2)*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax) + KroneckerDelta(0,gO2)*
      ...
      + 5*Sqr(g2)))) + Conj(ZH(gI1,0))*(10*Conj(ZH(gI2,2))*(Conj(Kappa)*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2))*Lambdax + Conj(Lambdax)*(KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Kappa - 2*KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1)*
      Lambdax + KroneckerDelta(2,gO2)*(KroneckerDelta(1,gO1)*Kappa - 2*
      KroneckerDelta(0,gO1)*Lambdax))) - Conj(ZH(gI2,0))*(20*AbsSqr(Lambdax)*
      KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2) + KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2)) + 3*
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2))) + Conj(
      ZH(gI2,1))*(10*KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2)*(Conj(Lambdax)*
...
std::complex<double> CLASSNAME::CpAhAhUhh(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(5*Conj(ZA(gI1,2))*(
      1.4142135623730951*MS*Conj(Lambdax)*Conj(ZA(gI2,1))*KroneckerDelta(0,gO2) -
      1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI2,1))*KroneckerDelta(0,gO2) - 4*
      vd*AbsSqr(Lambdax)*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2) +
      1.4142135623730951*MS*Conj(Lambdax)*Conj(ZA(gI2,0))*KroneckerDelta(1,gO2) -
      1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI2,0))*KroneckerDelta(1,gO2) - 4*
      vu*AbsSqr(Lambdax)*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2) +
      2.8284271247461903*Conj(TKappa)*Conj(ZA(gI2,2))*KroneckerDelta(2,gO2) + 2*vS
      *Conj(Lambdax)*Conj(ZA(gI2,1))*KroneckerDelta(0,gO2)*Kappa - 2*vu*Conj(
      Lambdax)*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2)*Kappa + 2*vS*Conj(Lambdax)*
      Conj(ZA(gI2,0))*KroneckerDelta(1,gO2)*Kappa - 2*vd*Conj(Lambdax)*Conj(ZA(gI2
      ,2))*KroneckerDelta(1,gO2)*Kappa + 2*vu*Conj(Lambdax)*Conj(ZA(gI2,0))*
      KroneckerDelta(2,gO2)*Kappa + 2*vd*Conj(Lambdax)*Conj(ZA(gI2,1))*
...
std::complex<double> CLASSNAME::CpAhhhUhh(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(
      -1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*
      KroneckerDelta(0,gO2) - 1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI2,1))*
      Conj(ZH(gI1,2))*KroneckerDelta(0,gO2) - 1.4142135623730951*Conj(TLambdax)*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(1,gO2) - 1.4142135623730951*
      Conj(TLambdax)*Conj(ZA(gI2,0))*Conj(ZH(gI1,2))*KroneckerDelta(1,gO2) -
      1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI2,1))*Conj(ZH(gI1,0))*
      KroneckerDelta(2,gO2) - 1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI2,0))*
      Conj(ZH(gI1,1))*KroneckerDelta(2,gO2) + 2.8284271247461903*MS*Conj(Kappa)*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2) + 2.8284271247461903*
      Conj(TKappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2) -
      2.8284271247461903*Conj(MS)*Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(2
      ,gO2)*Kappa - 1.4142135623730951*Conj(MS)*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*
      KroneckerDelta(0,gO2)*Lambdax - 2*vS*Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1
      ,1))*KroneckerDelta(0,gO2)*Lambdax + 1.4142135623730951*Conj(MS)*Conj(ZA(gI2
      ,1))*Conj(ZH(gI1,2))*KroneckerDelta(0,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(
      ZA(gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(0,gO2)*Lambdax - 2*vu*Conj(Kappa)*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(0,gO2)*Lambdax -
      1.4142135623730951*Conj(MS)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(1
      ,gO2)*Lambdax - 2*vS*Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*
      KroneckerDelta(1,gO2)*Lambdax + 1.4142135623730951*Conj(MS)*Conj(ZA(gI2,0))*
      Conj(ZH(gI1,2))*KroneckerDelta(1,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(ZA(gI2
      ,0))*Conj(ZH(gI1,2))*KroneckerDelta(1,gO2)*Lambdax - 2*vd*Conj(Kappa)*Conj(
      ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(1,gO2)*Lambdax -
      2.8284271247461903*Conj(Mu)*Conj(ZA(gI2,2))*(Conj(ZH(gI1,0))*KroneckerDelta(
      0,gO2) + Conj(ZH(gI1,1))*KroneckerDelta(1,gO2))*Lambdax + 1.4142135623730951
      *Conj(MS)*Conj(ZA(gI2,1))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*Lambdax + 2*
      vS*Conj(Kappa)*Conj(ZA(gI2,1))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*Lambdax
      - 2*vu*Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*
      Lambdax + 1.4142135623730951*Conj(MS)*Conj(ZA(gI2,0))*Conj(ZH(gI1,1))*
      KroneckerDelta(2,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(ZA(gI2,0))*Conj(ZH(gI1
      ,1))*KroneckerDelta(2,gO2)*Lambdax - 2*vd*Conj(Kappa)*Conj(ZA(gI2,2))*Conj(
      ZH(gI1,1))*KroneckerDelta(2,gO2)*Lambdax + 2*vu*Conj(Kappa)*Conj(ZA(gI2,0))*
      Conj(ZH(gI1,2))*KroneckerDelta(2,gO2)*Lambdax + 2*vd*Conj(Kappa)*Conj(ZA(gI2
      ,1))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2)*Lambdax + Conj(Lambdax)*(-(Conj(
      ZA(gI2,1))*(Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*(1.4142135623730951*MS + 2
      *vS*Kappa) + Conj(ZH(gI1,2))*(2*vd*KroneckerDelta(2,gO2)*Kappa +
      KroneckerDelta(0,gO2)*(1.4142135623730951*MS + 2*vS*Kappa)))) - Conj(ZA(gI2,
      0))*(Conj(ZH(gI1,1))*KroneckerDelta(2,gO2)*(1.4142135623730951*MS + 2*vS*
      Kappa) + Conj(ZH(gI1,2))*(2*vu*KroneckerDelta(2,gO2)*Kappa + KroneckerDelta(
      1,gO2)*(1.4142135623730951*MS + 2*vS*Kappa))) + Conj(ZA(gI2,2))*(2*Conj(ZH(
      gI1,2))*(vu*KroneckerDelta(0,gO2) + vd*KroneckerDelta(1,gO2))*Kappa + Conj(
      ZH(gI1,0))*(2*vu*KroneckerDelta(2,gO2)*Kappa + KroneckerDelta(1,gO2)*(
...
std::complex<double> CLASSNAME::CphhhhUhh(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(-5*Conj(ZH(gI1,2))*(
      -1.4142135623730951*Conj(TLambdax)*Conj(ZH(gI2,1))*KroneckerDelta(0,gO2) -
      1.4142135623730951*Conj(TLambdax)*Conj(ZH(gI2,0))*KroneckerDelta(1,gO2) + 24
      *vS*AbsSqr(Kappa)*Conj(ZH(gI2,2))*KroneckerDelta(2,gO2) + 8.485281374238571*
      MS*Conj(Kappa)*Conj(ZH(gI2,2))*KroneckerDelta(2,gO2) + 2.8284271247461903*
      Conj(TKappa)*Conj(ZH(gI2,2))*KroneckerDelta(2,gO2) + 8.485281374238571*Conj(
      MS)*Conj(ZH(gI2,2))*KroneckerDelta(2,gO2)*Kappa + 2.8284271247461903*Conj(Mu
      )*Conj(ZH(gI2,0))*KroneckerDelta(0,gO2)*Lambdax - 1.4142135623730951*Conj(MS
      )*Conj(ZH(gI2,1))*KroneckerDelta(0,gO2)*Lambdax - 2*vS*Conj(Kappa)*Conj(ZH(
      gI2,1))*KroneckerDelta(0,gO2)*Lambdax - 2*vu*Conj(Kappa)*Conj(ZH(gI2,2))*
...
std::complex<double> CLASSNAME::CpChiChiUhhPL(int gI1, int gI2, int gO1) const
{
   const std::complex<double> result = 0.1*(-5*g2*Conj(ZN(gI1,1))*Conj(ZN(gI2,2
      ))*KroneckerDelta(0,gO1) - 3.872983346207417*g1*Conj(ZN(gI1,3))*Conj(ZN(gI2,
      0))*KroneckerDelta(1,gO1) + 5*g2*Conj(ZN(gI1,3))*Conj(ZN(gI2,1))*
...
std::complex<double> CLASSNAME::CpUhhSdconjSd(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*(10*vu*KroneckerDelta(2,gO2)*(Conj(
      ...
      (gI2,j1))*ZD(gI1,j1))) + 2*(-(vu*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(
      gI1,3 + j1))) + 5*(vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,
      Yd(j1,j2)*ZD(gI1,3 + j1))) + 1.4142135623730951*Conj(Mu)*SUM(j2,0,2,Conj(ZD(
      gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) + (vS*Lambdax +
      1.4142135623730951*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gI2,3 +
      j1)))*ZD(gI1,j2))))) + KroneckerDelta(0,gO2)*(vd*(Sqr(g1) + 5*Sqr(g2))*SUM(
      j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) + 2*(vd*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3
      + j1))*ZD(gI1,3 + j1)) - 5*(1.4142135623730951*SUM(j2,0,2,Conj(ZD(gI2,j2))*
      SUM(j1,0,2,ZD(gI1,3 + j1)*TYd(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(
      j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gI1,j2)) + 2*vd*(SUM(j3,0,2
      ,Conj(ZD(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(
      gI1,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Conj(Yd(j1
      ,j3))*Yd(j1,j2)))*ZD(gI1,j3)))))));
...
std::complex<double> CLASSNAME::CpUhhSeconjSe(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*(10*vu*KroneckerDelta(2,gO2)*(Conj(
      ...
      (gI2,j1))*ZE(gI1,j1)) + 2*(-3*vu*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*ZE(
      gI1,3 + j1)) + 5*(vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye
      (j1,j2)*ZE(gI1,3 + j1))) + 1.4142135623730951*Conj(Mu)*SUM(j2,0,2,Conj(ZE(
      gI2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) + (vS*Lambdax +
      1.4142135623730951*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI2,3 +
      j1)))*ZE(gI1,j2))))) - KroneckerDelta(0,gO2)*(vd*(3*Sqr(g1) - 5*Sqr(g2))*
      SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 6*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZE(
      gI2,3 + j1))*ZE(gI1,3 + j1)) + 10*(1.4142135623730951*SUM(j2,0,2,Conj(ZE(gI2
      ,j2))*SUM(j1,0,2,ZE(gI1,3 + j1)*TYe(j1,j2))) + 1.4142135623730951*SUM(j2,0,2
      ,SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gI1,j2)) + 2*vd*(SUM(
      j3,0,2,Conj(ZE(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))
      *ZE(gI1,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj(
      Ye(j1,j3))*Ye(j1,j2)))*ZE(gI1,j3))))));
...
std::complex<double> CLASSNAME::CpUhhSuconjSu(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = 0.05*(10*vd*KroneckerDelta(2,gO2)*(Conj(
      ...
      gI2,j1))*ZU(gI1,j1)) + 2*(-2*vd*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(
      gI1,3 + j1)) + 5*(vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu
      (j1,j2)*ZU(gI1,3 + j1))) + 1.4142135623730951*Conj(Mu)*SUM(j2,0,2,Conj(ZU(
      gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + (vS*Lambdax +
      1.4142135623730951*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gI2,3 +
      j1)))*ZU(gI1,j2))))) - KroneckerDelta(1,gO2)*(vu*(Sqr(g1) - 5*Sqr(g2))*SUM(
      j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) - 4*vu*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,3
      + j1))*ZU(gI1,3 + j1)) + 10*(1.4142135623730951*SUM(j2,0,2,Conj(ZU(gI2,j2))*
      SUM(j1,0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(
      j1,0,2,Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gI1,j2)) + 2*vu*(SUM(j3,0,2
      ,Conj(ZU(gI2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(
      gI1,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Conj(Yu(j1
      ,j3))*Yu(j1,j2)))*ZU(gI1,j3))))));
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(Conj(ZA(gI2
      ,0))*KroneckerDelta(0,gO2) - Conj(ZA(gI2,1))*KroneckerDelta(1,gO2))*(5*g2*
...
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(
      2.8284271247461903*Conj(MS)*KroneckerDelta(2,gO2)*Lambdax*ZP(gI1,1)*ZP(gI2,0
      ) + 4*vS*Conj(Kappa)*KroneckerDelta(2,gO2)*Lambdax*ZP(gI1,1)*ZP(gI2,0) + vu*
      KroneckerDelta(0,gO2)*Sqr(g2)*ZP(gI1,1)*ZP(gI2,0) + vd*KroneckerDelta(1,gO2)
      *Sqr(g2)*ZP(gI1,1)*ZP(gI2,0) - 2.8284271247461903*KroneckerDelta(2,gO2)*
      TLambdax*ZP(gI1,1)*ZP(gI2,0) + 2.8284271247461903*Conj(TLambdax)*
      ...
      *ZP(gI1,0)*ZP(gI2,1) - vd*KroneckerDelta(1,gO2)*Sqr(g2)*ZP(gI1,0)*ZP(gI2,1)
      - 2.8284271247461903*Conj(Mu)*KroneckerDelta(2,gO2)*Lambdax*(ZP(gI1,0)*ZP(
      gI2,0) + ZP(gI1,1)*ZP(gI2,1)) + 2*Conj(Lambdax)*(-((vu*KroneckerDelta(0,gO2)
      + vd*KroneckerDelta(1,gO2))*Lambdax*(ZP(gI1,1)*ZP(gI2,0) - ZP(gI1,0)*ZP(gI2
      ,1))) + KroneckerDelta(2,gO2)*(1.4142135623730951*Mu*ZP(gI1,1)*ZP(gI2,1) +
      ZP(gI1,0)*(1.4142135623730951*Mu*ZP(gI2,0) - (1.4142135623730951*MS + 2*vS*
      Kappa)*ZP(gI2,1)))));
...
std::complex<double> CLASSNAME::CpAhAhUAhUAh(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(-10*Conj(ZA(gI1,2))*(-(Conj(Kappa)
      *((Conj(ZA(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)) + Conj(ZA(gI2,0))*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)))*Lambdax + Conj(ZA(gI2,2))*(-12*KroneckerDelta(2,gO1)
      *KroneckerDelta(2,gO2)*Kappa + KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1)*
      Lambdax + KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2)*Lambdax))) + Conj(
      Lambdax)*(Conj(ZA(gI2,0))*(-(KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1)*
      Kappa) + 2*KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1)*Lambdax +
      KroneckerDelta(2,gO2)*(-(KroneckerDelta(1,gO1)*Kappa) + 2*KroneckerDelta(0,
      gO1)*Lambdax)) - Conj(ZA(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1
      )*Kappa - 2*KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1)*Lambdax +
      KroneckerDelta(2,gO2)*(KroneckerDelta(0,gO1)*Kappa - 2*KroneckerDelta(1,gO1)
      *Lambdax)) + Conj(ZA(gI2,2))*(KroneckerDelta(0,gO1)*(-(KroneckerDelta(1,gO2)
      *Kappa) + 2*KroneckerDelta(0,gO2)*Lambdax) + KroneckerDelta(1,gO1)*(-(
      KroneckerDelta(0,gO2)*Kappa) + 2*KroneckerDelta(1,gO2)*Lambdax)))) + Conj(ZA
      (gI1,1))*(10*Conj(ZA(gI2,2))*(Conj(Kappa)*(KroneckerDelta(0,gO2)*
      KroneckerDelta(2,gO1) + KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2))*Lambdax
      + Conj(Lambdax)*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1)*Kappa - 2*
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1)*Lambdax + KroneckerDelta(2,gO2)*
      (KroneckerDelta(0,gO1)*Kappa - 2*KroneckerDelta(1,gO1)*Lambdax))) + Conj(ZA(
      gI2,1))*(-20*AbsSqr(Lambdax)*KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2) - 3
      *KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(3*Sqr(g1) + 5*Sqr(g2)) +
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1)
      + 5*Sqr(g2))) + Conj(ZA(gI2,0))*(10*KroneckerDelta(2,gO1)*KroneckerDelta(2,
      gO2)*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax) + KroneckerDelta(0,gO2)*
      KroneckerDelta(1,gO1)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2)) +
      KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1)
      + 5*Sqr(g2)))) + Conj(ZA(gI1,0))*(10*Conj(ZA(gI2,2))*(Conj(Kappa)*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2))*Lambdax + Conj(Lambdax)*(KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1)*Kappa - 2*KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1)*
      Lambdax + KroneckerDelta(2,gO2)*(KroneckerDelta(1,gO1)*Kappa - 2*
      KroneckerDelta(0,gO1)*Lambdax))) - Conj(ZA(gI2,0))*(20*AbsSqr(Lambdax)*
      KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2) + KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2)) + 3*
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2))) + Conj(
      ZA(gI2,1))*(10*KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2)*(Conj(Lambdax)*
      Kappa + Conj(Kappa)*Lambdax) + KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1)*(
      -20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2)) + KroneckerDelta(0,gO1)*
      KroneckerDelta(1,gO2)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2)))));
...
std::complex<double> CLASSNAME::CpUAhUAhhhhh(int gO1, int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = 0.05*(-10*Conj(ZH(gI1,2))*(Conj(Kappa)*(
      ...
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)) + Conj(ZH(gI2,0))*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)))*Lambdax) + Conj(ZH(gI2,2))*(4*KroneckerDelta(2,gO1)*
      KroneckerDelta(2,gO2)*Kappa + KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1)*
      Lambdax + KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2)*Lambdax)) + Conj(
      Lambdax)*(-((Conj(ZH(gI2,1))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)) + Conj(ZH(gI2,0))*(
      KroneckerDelta(1,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*
      KroneckerDelta(2,gO2)))*Kappa) + Conj(ZH(gI2,2))*(KroneckerDelta(0,gO1)*(
      KroneckerDelta(1,gO2)*Kappa + 2*KroneckerDelta(0,gO2)*Lambdax) +
      KroneckerDelta(1,gO1)*(KroneckerDelta(0,gO2)*Kappa + 2*KroneckerDelta(1,gO2)
      *Lambdax)))) + Conj(ZH(gI1,0))*(10*(-(Conj(ZH(gI2,1))*KroneckerDelta(2,gO1)*
      KroneckerDelta(2,gO2)) + Conj(ZH(gI2,2))*(KroneckerDelta(1,gO2)*
      KroneckerDelta(2,gO1) + KroneckerDelta(1,gO1)*KroneckerDelta(2,gO2)))*(Conj(
      Lambdax)*Kappa + Conj(Kappa)*Lambdax) - Conj(ZH(gI2,0))*(20*AbsSqr(Lambdax)*
      KroneckerDelta(2,gO1)*KroneckerDelta(2,gO2) + KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2)) +
      KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2)))) + Conj
      (ZH(gI1,1))*(10*(-(Conj(ZH(gI2,0))*KroneckerDelta(2,gO1)*KroneckerDelta(2,
      gO2)) + Conj(ZH(gI2,2))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) +
      KroneckerDelta(0,gO1)*KroneckerDelta(2,gO2)))*(Conj(Lambdax)*Kappa + Conj(
      Kappa)*Lambdax) + Conj(ZH(gI2,1))*(-20*AbsSqr(Lambdax)*KroneckerDelta(2,gO1)
      *KroneckerDelta(2,gO2) - KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(3*Sqr(
      g1) + 5*Sqr(g2)) + KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(-20*AbsSqr(
      Lambdax) + 3*Sqr(g1) + 5*Sqr(g2)))));
...
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(
      1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI1,2))*Conj(ZA(gI2,1))*
      KroneckerDelta(0,gO2) + 1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI1,1))*
      Conj(ZA(gI2,2))*KroneckerDelta(0,gO2) + 1.4142135623730951*Conj(TLambdax)*
      Conj(ZA(gI1,2))*Conj(ZA(gI2,0))*KroneckerDelta(1,gO2) + 1.4142135623730951*
      Conj(TLambdax)*Conj(ZA(gI1,0))*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2) +
      1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI1,1))*Conj(ZA(gI2,0))*
      KroneckerDelta(2,gO2) + 1.4142135623730951*Conj(TLambdax)*Conj(ZA(gI1,0))*
      Conj(ZA(gI2,1))*KroneckerDelta(2,gO2) + 8.485281374238571*MS*Conj(Kappa)*
      Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*KroneckerDelta(2,gO2) - 2.8284271247461903*
      Conj(TKappa)*Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*KroneckerDelta(2,gO2) -
      8.485281374238571*Conj(MS)*Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*KroneckerDelta(2,
      gO2)*Kappa + 1.4142135623730951*Conj(MS)*Conj(ZA(gI1,2))*Conj(ZA(gI2,1))*
      KroneckerDelta(0,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(ZA(gI1,2))*Conj(ZA(gI2
      ,1))*KroneckerDelta(0,gO2)*Lambdax + 1.4142135623730951*Conj(MS)*Conj(ZA(gI1
      ,1))*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(
      ZA(gI1,1))*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2)*Lambdax - 2*vu*Conj(Kappa)*
      Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2)*Lambdax +
      1.4142135623730951*Conj(MS)*Conj(ZA(gI1,2))*Conj(ZA(gI2,0))*KroneckerDelta(1
      ,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(ZA(gI1,2))*Conj(ZA(gI2,0))*
      KroneckerDelta(1,gO2)*Lambdax + 1.4142135623730951*Conj(MS)*Conj(ZA(gI1,0))*
      Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(ZA(gI1
      ,0))*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*Lambdax - 2*vd*Conj(Kappa)*Conj(
      ZA(gI1,2))*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*Lambdax +
      1.4142135623730951*Conj(MS)*Conj(ZA(gI1,1))*Conj(ZA(gI2,0))*KroneckerDelta(2
      ,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(ZA(gI1,1))*Conj(ZA(gI2,0))*
      KroneckerDelta(2,gO2)*Lambdax - 2*vu*Conj(Kappa)*Conj(ZA(gI1,2))*Conj(ZA(gI2
      ,0))*KroneckerDelta(2,gO2)*Lambdax + 1.4142135623730951*Conj(MS)*Conj(ZA(gI1
      ,0))*Conj(ZA(gI2,1))*KroneckerDelta(2,gO2)*Lambdax + 2*vS*Conj(Kappa)*Conj(
      ZA(gI1,0))*Conj(ZA(gI2,1))*KroneckerDelta(2,gO2)*Lambdax - 2*vd*Conj(Kappa)*
      Conj(ZA(gI1,2))*Conj(ZA(gI2,1))*KroneckerDelta(2,gO2)*Lambdax - 2*vu*Conj(
      Kappa)*Conj(ZA(gI1,0))*Conj(ZA(gI2,2))*KroneckerDelta(2,gO2)*Lambdax - 2*vd*
      Conj(Kappa)*Conj(ZA(gI1,1))*Conj(ZA(gI2,2))*KroneckerDelta(2,gO2)*Lambdax -
      2.8284271247461903*Conj(Mu)*(Conj(ZA(gI1,2))*(Conj(ZA(gI2,0))*KroneckerDelta
      (0,gO2) + Conj(ZA(gI2,1))*KroneckerDelta(1,gO2)) + Conj(ZA(gI1,0))*(Conj(ZA(
      gI2,2))*KroneckerDelta(0,gO2) + Conj(ZA(gI2,0))*KroneckerDelta(2,gO2)) +
      Conj(ZA(gI1,1))*(Conj(ZA(gI2,2))*KroneckerDelta(1,gO2) + Conj(ZA(gI2,1))*
      KroneckerDelta(2,gO2)))*Lambdax + Conj(Lambdax)*(Conj(ZA(gI1,0))*(
      KroneckerDelta(2,gO2)*(-(Conj(ZA(gI2,1))*(1.4142135623730951*MS + 2*vS*Kappa
      )) + 2.8284271247461903*Conj(ZA(gI2,0))*Mu) + Conj(ZA(gI2,2))*(2*vu*
      KroneckerDelta(2,gO2)*Kappa - KroneckerDelta(1,gO2)*(1.4142135623730951*MS +
      2*vS*Kappa) + 2.8284271247461903*KroneckerDelta(0,gO2)*Mu)) - Conj(ZA(gI1,1
      ))*(KroneckerDelta(2,gO2)*(Conj(ZA(gI2,0))*(1.4142135623730951*MS + 2*vS*
      Kappa) - 2.8284271247461903*Conj(ZA(gI2,1))*Mu) + Conj(ZA(gI2,2))*(
      KroneckerDelta(0,gO2)*(1.4142135623730951*MS + 2*vS*Kappa) - 2*(vd*
      KroneckerDelta(2,gO2)*Kappa + 1.4142135623730951*KroneckerDelta(1,gO2)*Mu)))
      + Conj(ZA(gI1,2))*(2*Conj(ZA(gI2,2))*(vu*KroneckerDelta(0,gO2) + vd*
      KroneckerDelta(1,gO2))*Kappa + Conj(ZA(gI2,0))*(2*vu*KroneckerDelta(2,gO2)*
      Kappa - KroneckerDelta(1,gO2)*(1.4142135623730951*MS + 2*vS*Kappa) +
      2.8284271247461903*KroneckerDelta(0,gO2)*Mu) + Conj(ZA(gI2,1))*(-(
      KroneckerDelta(0,gO2)*(1.4142135623730951*MS + 2*vS*Kappa)) + 2*(vd*
      KroneckerDelta(2,gO2)*Kappa + 1.4142135623730951*KroneckerDelta(1,gO2)*Mu)))
      ) + 2.8284271247461903*Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*KroneckerDelta(2,gO2)
      *TKappa - 1.4142135623730951*Conj(ZA(gI1,2))*Conj(ZA(gI2,1))*KroneckerDelta(
      0,gO2)*TLambdax - 1.4142135623730951*Conj(ZA(gI1,1))*Conj(ZA(gI2,2))*
      KroneckerDelta(0,gO2)*TLambdax - 1.4142135623730951*Conj(ZA(gI1,2))*Conj(ZA(
      gI2,0))*KroneckerDelta(1,gO2)*TLambdax - 1.4142135623730951*Conj(ZA(gI1,0))*
      Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*TLambdax - 1.4142135623730951*Conj(ZA(
      gI1,1))*Conj(ZA(gI2,0))*KroneckerDelta(2,gO2)*TLambdax - 1.4142135623730951*
      Conj(ZA(gI1,0))*Conj(ZA(gI2,1))*KroneckerDelta(2,gO2)*TLambdax);
...
{
   const std::complex<double> result = 0.05*(7.0710678118654755*MS*Conj(Lambdax
      )*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(0,gO2) - 7.0710678118654755
      *Conj(TLambdax)*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(0,gO2) -
      7.0710678118654755*MS*Conj(Lambdax)*Conj(ZA(gI2,1))*Conj(ZH(gI1,2))*
      KroneckerDelta(0,gO2) - 7.0710678118654755*Conj(TLambdax)*Conj(ZA(gI2,1))*
      Conj(ZH(gI1,2))*KroneckerDelta(0,gO2) - 20*vd*AbsSqr(Lambdax)*Conj(ZA(gI2,1)
      )*Conj(ZH(gI1,0))*KroneckerDelta(1,gO2) + 7.0710678118654755*MS*Conj(Lambdax
      )*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(1,gO2) - 7.0710678118654755
      *Conj(TLambdax)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(1,gO2) - 20*
      vS*AbsSqr(Lambdax)*Conj(ZA(gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(1,gO2) +
      7.0710678118654755*MS*Conj(Lambdax)*Conj(ZA(gI2,1))*Conj(ZH(gI1,0))*
      KroneckerDelta(2,gO2) - 7.0710678118654755*Conj(TLambdax)*Conj(ZA(gI2,1))*
      Conj(ZH(gI1,0))*KroneckerDelta(2,gO2) - 20*vd*AbsSqr(Lambdax)*Conj(ZA(gI2,2)
      )*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2) - 20*vu*AbsSqr(Lambdax)*Conj(ZA(gI2,
      2))*Conj(ZH(gI1,1))*KroneckerDelta(2,gO2) - 40*vS*AbsSqr(Kappa)*Conj(ZA(gI2,
      2))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2) - 14.142135623730951*MS*Conj(Kappa
      )*Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2) + 14.142135623730951
      *Conj(TKappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2) + 10*vS*
      Conj(Lambdax)*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(0,gO2)*Kappa -
      10*vS*Conj(Lambdax)*Conj(ZA(gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(0,gO2)*
      Kappa + 10*vu*Conj(Lambdax)*Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(0
      ,gO2)*Kappa + 10*vS*Conj(Lambdax)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*
      KroneckerDelta(1,gO2)*Kappa + 10*vd*Conj(Lambdax)*Conj(ZA(gI2,2))*Conj(ZH(
      gI1,2))*KroneckerDelta(1,gO2)*Kappa + 10*vS*Conj(Lambdax)*Conj(ZA(gI2,1))*
      Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*Kappa - 10*vu*Conj(Lambdax)*Conj(ZA(
      gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*Kappa - 10*vd*Conj(Lambdax)*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(2,gO2)*Kappa + 10*vd*Conj(
      Lambdax)*Conj(ZA(gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2)*Kappa + 10*vS
      *Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(0,gO2)*Lambdax -
      10*vS*Conj(Kappa)*Conj(ZA(gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(0,gO2)*
      Lambdax + 10*vu*Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(0
      ,gO2)*Lambdax + 10*vS*Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*
      KroneckerDelta(1,gO2)*Lambdax - 14.142135623730951*Conj(Mu)*Conj(ZA(gI2,1))*
      Conj(ZH(gI1,2))*KroneckerDelta(1,gO2)*Lambdax + 10*vd*Conj(Kappa)*Conj(ZA(
      gI2,2))*Conj(ZH(gI1,2))*KroneckerDelta(1,gO2)*Lambdax + 10*vS*Conj(Kappa)*
      Conj(ZA(gI2,1))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*Lambdax - 10*vu*Conj(
      Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)*Lambdax - 10*vd
      *Conj(Kappa)*Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(2,gO2)*Lambdax +
      10*vd*Conj(Kappa)*Conj(ZA(gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(2,gO2)*
      Lambdax + 7.0710678118654755*Conj(MS)*(Conj(ZA(gI2,1))*(-(Conj(ZH(gI1,2))*
...
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(
      -1.4142135623730951*MS*Conj(Lambdax)*Conj(ZH(gI1,2))*Conj(ZH(gI2,1))*
      KroneckerDelta(0,gO2) - 1.4142135623730951*Conj(TLambdax)*Conj(ZH(gI1,2))*
      Conj(ZH(gI2,1))*KroneckerDelta(0,gO2) - 1.4142135623730951*MS*Conj(Lambdax)*
      Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*KroneckerDelta(0,gO2) - 1.4142135623730951*
      Conj(TLambdax)*Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*KroneckerDelta(0,gO2) -
      1.4142135623730951*MS*Conj(Lambdax)*Conj(ZH(gI1,2))*Conj(ZH(gI2,0))*
      KroneckerDelta(1,gO2) - 1.4142135623730951*Conj(TLambdax)*Conj(ZH(gI1,2))*
      Conj(ZH(gI2,0))*KroneckerDelta(1,gO2) - 1.4142135623730951*MS*Conj(Lambdax)*
      Conj(ZH(gI1,0))*Conj(ZH(gI2,2))*KroneckerDelta(1,gO2) - 1.4142135623730951*
      Conj(TLambdax)*Conj(ZH(gI1,0))*Conj(ZH(gI2,2))*KroneckerDelta(1,gO2) +
      1.4142135623730951*MS*Conj(Lambdax)*Conj(ZH(gI1,1))*Conj(ZH(gI2,0))*
      KroneckerDelta(2,gO2) - 1.4142135623730951*Conj(TLambdax)*Conj(ZH(gI1,1))*
      Conj(ZH(gI2,0))*KroneckerDelta(2,gO2) + 1.4142135623730951*MS*Conj(Lambdax)*
      Conj(ZH(gI1,0))*Conj(ZH(gI2,1))*KroneckerDelta(2,gO2) - 1.4142135623730951*
      Conj(TLambdax)*Conj(ZH(gI1,0))*Conj(ZH(gI2,1))*KroneckerDelta(2,gO2) +
      2.8284271247461903*Conj(TKappa)*Conj(ZH(gI1,2))*Conj(ZH(gI2,2))*
      KroneckerDelta(2,gO2) - 2*vS*Conj(Lambdax)*Conj(ZH(gI1,2))*Conj(ZH(gI2,1))*
      KroneckerDelta(0,gO2)*Kappa - 2*vS*Conj(Lambdax)*Conj(ZH(gI1,1))*Conj(ZH(gI2
      ,2))*KroneckerDelta(0,gO2)*Kappa - 2*vu*Conj(Lambdax)*Conj(ZH(gI1,2))*Conj(
      ZH(gI2,2))*KroneckerDelta(0,gO2)*Kappa - 2*vS*Conj(Lambdax)*Conj(ZH(gI1,2))*
      Conj(ZH(gI2,0))*KroneckerDelta(1,gO2)*Kappa - 2*vS*Conj(Lambdax)*Conj(ZH(gI1
      ,0))*Conj(ZH(gI2,2))*KroneckerDelta(1,gO2)*Kappa - 2*vd*Conj(Lambdax)*Conj(
      ZH(gI1,2))*Conj(ZH(gI2,2))*KroneckerDelta(1,gO2)*Kappa + 2*vS*Conj(Lambdax)*
      Conj(ZH(gI1,1))*Conj(ZH(gI2,0))*KroneckerDelta(2,gO2)*Kappa + 2*vu*Conj(
      Lambdax)*Conj(ZH(gI1,2))*Conj(ZH(gI2,0))*KroneckerDelta(2,gO2)*Kappa + 2*vS*
      Conj(Lambdax)*Conj(ZH(gI1,0))*Conj(ZH(gI2,1))*KroneckerDelta(2,gO2)*Kappa +
      2*vd*Conj(Lambdax)*Conj(ZH(gI1,2))*Conj(ZH(gI2,1))*KroneckerDelta(2,gO2)*
      Kappa + 2*vu*Conj(Lambdax)*Conj(ZH(gI1,0))*Conj(ZH(gI2,2))*KroneckerDelta(2,
      gO2)*Kappa + 2*vd*Conj(Lambdax)*Conj(ZH(gI1,1))*Conj(ZH(gI2,2))*
      KroneckerDelta(2,gO2)*Kappa - 2.8284271247461903*Conj(Mu)*Conj(ZH(gI1,0))*
      Conj(ZH(gI2,0))*KroneckerDelta(2,gO2)*Lambdax - 2.8284271247461903*Conj(Mu)*
      Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*KroneckerDelta(2,gO2)*Lambdax +
      1.4142135623730951*Conj(MS)*((Conj(ZH(gI1,1))*(Conj(ZH(gI2,2))*
      ...
      (2,gO2)))*Lambdax + Conj(ZH(gI1,2))*(-2*Conj(ZH(gI2,2))*KroneckerDelta(2,gO2
      )*Kappa + Conj(ZH(gI2,1))*KroneckerDelta(0,gO2)*Lambdax + Conj(ZH(gI2,0))*
      KroneckerDelta(1,gO2)*Lambdax)) + 2*Conj(Kappa)*((Conj(ZH(gI1,1))*(-(vS*Conj
      (ZH(gI2,0))*KroneckerDelta(2,gO2)) + Conj(ZH(gI2,2))*(vS*KroneckerDelta(0,
      gO2) - vd*KroneckerDelta(2,gO2))) + Conj(ZH(gI1,0))*(-(vS*Conj(ZH(gI2,1))*
      KroneckerDelta(2,gO2)) + Conj(ZH(gI2,2))*(vS*KroneckerDelta(1,gO2) - vu*
      KroneckerDelta(2,gO2))))*Lambdax + Conj(ZH(gI1,2))*(Conj(ZH(gI2,1))*(vS*
      KroneckerDelta(0,gO2) - vd*KroneckerDelta(2,gO2))*Lambdax + Conj(ZH(gI2,0))*
      (vS*KroneckerDelta(1,gO2) - vu*KroneckerDelta(2,gO2))*Lambdax + Conj(ZH(gI2,
      2))*(1.4142135623730951*MS*KroneckerDelta(2,gO2) + vu*KroneckerDelta(0,gO2)*
      Lambdax + vd*KroneckerDelta(1,gO2)*Lambdax))) + 2.8284271247461903*Conj(
      Lambdax)*Conj(ZH(gI1,0))*Conj(ZH(gI2,0))*KroneckerDelta(2,gO2)*Mu +
...
std::complex<double> CLASSNAME::CpChiChiUAhPR(int gI1, int gI2, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(
      ...
      ) + ZN(gI1,2)*ZN(gI2,3)) - 2*Conj(Kappa)*ZN(gI1,4)*ZN(gI2,4)) -
      KroneckerDelta(1,gO2)*(ZN(gI1,3)*(3.872983346207417*g1*ZN(gI2,0) - 5*g2*ZN(
      gI2,1)) + (3.872983346207417*g1*ZN(gI1,0) - 5*g2*ZN(gI1,1))*ZN(gI2,3) +
      7.0710678118654755*Conj(Lambdax)*(ZN(gI1,4)*ZN(gI2,2) + ZN(gI1,2)*ZN(gI2,4))
      ...
      gI2,2) + 1.4142135623730951*Conj(Lambdax)*(ZN(gI1,4)*ZN(gI2,3) + ZN(gI1,3)*
      ZN(gI2,4)))));
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(5*g2*Conj(
      ...
      *KroneckerDelta(1,gO1) + 3.872983346207417*g1*Conj(ZN(gI1,0))*(-(Conj(ZN(gI2
      ...
      Conj(ZN(gI2,2))*KroneckerDelta(2,gO1)*Lambdax + Conj(ZN(gI1,2))*(
      -3.872983346207417*g1*Conj(ZN(gI2,0))*KroneckerDelta(0,gO1) + 5*(g2*Conj(ZN(
      gI2,1))*KroneckerDelta(0,gO1) + 1.4142135623730951*(Conj(ZN(gI2,4))*
      KroneckerDelta(1,gO1) + Conj(ZN(gI2,3))*KroneckerDelta(2,gO1))*Lambdax)));
...
std::complex<double> CLASSNAME::CpUAhSdconjSd(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = std::complex<double>(0,-0.5)*(
      1.4142135623730951*Conj(Mu)*KroneckerDelta(1,gO2)*SUM(j2,0,2,Conj(ZD(gI2,j2)
      )*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) + Conj(Lambdax)*(vS*KroneckerDelta(1
      ,gO2) + vu*KroneckerDelta(2,gO2))*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(
      j1,j2)*ZD(gI1,3 + j1))) + 1.4142135623730951*KroneckerDelta(0,gO2)*SUM(j2,0,
      2,Conj(ZD(gI2,j2))*SUM(j1,0,2,ZD(gI1,3 + j1)*TYd(j1,j2))) - vS*
      KroneckerDelta(1,gO2)*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(
      gI2,3 + j1)))*ZD(gI1,j2)) - vu*KroneckerDelta(2,gO2)*Lambdax*SUM(j2,0,2,SUM(
      j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1)))*ZD(gI1,j2)) -
      1.4142135623730951*KroneckerDelta(1,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1
      ,j2))*Conj(ZD(gI2,3 + j1)))*ZD(gI1,j2)) - 1.4142135623730951*KroneckerDelta(
      0,gO2)*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gI1,
      j2)));
...
{
   const std::complex<double> result = std::complex<double>(0,-0.5)*(
      1.4142135623730951*Conj(Mu)*KroneckerDelta(1,gO2)*SUM(j2,0,2,Conj(ZE(gI2,j2)
      )*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) + Conj(Lambdax)*(vS*KroneckerDelta(1
      ,gO2) + vu*KroneckerDelta(2,gO2))*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(
      j1,j2)*ZE(gI1,3 + j1))) + 1.4142135623730951*KroneckerDelta(0,gO2)*SUM(j2,0,
      2,Conj(ZE(gI2,j2))*SUM(j1,0,2,ZE(gI1,3 + j1)*TYe(j1,j2))) - vS*
      KroneckerDelta(1,gO2)*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(
      gI2,3 + j1)))*ZE(gI1,j2)) - vu*KroneckerDelta(2,gO2)*Lambdax*SUM(j2,0,2,SUM(
      j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1)))*ZE(gI1,j2)) -
      1.4142135623730951*KroneckerDelta(1,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1
      ,j2))*Conj(ZE(gI2,3 + j1)))*ZE(gI1,j2)) - 1.4142135623730951*KroneckerDelta(
      0,gO2)*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gI1,
      j2)));
...
{
   const std::complex<double> result = std::complex<double>(0,-0.5)*(
      1.4142135623730951*Conj(Mu)*KroneckerDelta(0,gO2)*SUM(j2,0,2,Conj(ZU(gI2,j2)
      )*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + Conj(Lambdax)*(vS*KroneckerDelta(0
      ,gO2) + vd*KroneckerDelta(2,gO2))*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(
      j1,j2)*ZU(gI1,3 + j1))) + 1.4142135623730951*KroneckerDelta(1,gO2)*SUM(j2,0,
      2,Conj(ZU(gI2,j2))*SUM(j1,0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) - vS*
      KroneckerDelta(0,gO2)*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(
      gI2,3 + j1)))*ZU(gI1,j2)) - vd*KroneckerDelta(2,gO2)*Lambdax*SUM(j2,0,2,SUM(
      j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gI2,3 + j1)))*ZU(gI1,j2)) -
      1.4142135623730951*KroneckerDelta(0,gO2)*Mu*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1
      ,j2))*Conj(ZU(gI2,3 + j1)))*ZU(gI1,j2)) - 1.4142135623730951*KroneckerDelta(
      1,gO2)*SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gI1,
      j2)));
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(Conj(ZH(gI2
      ,0))*KroneckerDelta(0,gO2) - Conj(ZH(gI2,1))*KroneckerDelta(1,gO2))*(5*g2*
      Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()));
...
std::complex<double> CLASSNAME::CpHpmUHpmconjHpmconjUHpm(int gI1, int gO1, int gI2, int gO2) const
{
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*(
      KroneckerDelta(0,gO2)*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,0
      )*ZP(gI2,1) + KroneckerDelta(1,gO2)*((-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*
      Sqr(g2))*ZP(gI1,0)*ZP(gI2,0) - 2*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,1)*ZP(gI2,1)
      )) + KroneckerDelta(0,gO1)*(KroneckerDelta(1,gO2)*(-20*AbsSqr(Lambdax) + 3*
      Sqr(g1) + 5*Sqr(g2))*ZP(gI1,1)*ZP(gI2,0) + KroneckerDelta(0,gO2)*(-2*(3*Sqr(
      g1) + 5*Sqr(g2))*ZP(gI1,0)*ZP(gI2,0) + (-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*
      Sqr(g2))*ZP(gI1,1)*ZP(gI2,1))));
...
{
   const std::complex<double> result = std::complex<double>(0,0.25)*(
      2.8284271247461903*Conj(MS)*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*Lambdax*ZP
      (gI1,0) + 4*vS*Conj(Kappa)*Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*Lambdax*ZP(
      gI1,0) + vu*Conj(ZA(gI2,0))*KroneckerDelta(1,gO2)*Sqr(g2)*ZP(gI1,0) + vd*
      Conj(ZA(gI2,1))*KroneckerDelta(1,gO2)*Sqr(g2)*ZP(gI1,0) - 2.8284271247461903
      *Conj(ZA(gI2,2))*KroneckerDelta(1,gO2)*TLambdax*ZP(gI1,0) +
      2.8284271247461903*Conj(TLambdax)*Conj(ZA(gI2,2))*KroneckerDelta(0,gO2)*ZP(
      gI1,1) - vu*Conj(ZA(gI2,0))*KroneckerDelta(0,gO2)*Sqr(g2)*ZP(gI1,1) - vd*
      Conj(ZA(gI2,1))*KroneckerDelta(0,gO2)*Sqr(g2)*ZP(gI1,1) - 2.8284271247461903
      *Conj(Mu)*Conj(ZA(gI2,2))*Lambdax*(KroneckerDelta(0,gO2)*ZP(gI1,0) +
      KroneckerDelta(1,gO2)*ZP(gI1,1)) + 2*Conj(Lambdax)*(-((vu*Conj(ZA(gI2,0)) +
      vd*Conj(ZA(gI2,1)))*Lambdax*(KroneckerDelta(1,gO2)*ZP(gI1,0) -
      KroneckerDelta(0,gO2)*ZP(gI1,1))) + Conj(ZA(gI2,2))*(1.4142135623730951*
      KroneckerDelta(1,gO2)*Mu*ZP(gI1,1) + KroneckerDelta(0,gO2)*(
...
{
   const std::complex<double> result = 0.05*(-(Conj(ZH(gI2,0))*(KroneckerDelta(
      0,gO2)*(vd*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,0) + 5*vu*(-2*AbsSqr(Lambdax) +
      Sqr(g2))*ZP(gI1,1)) + KroneckerDelta(1,gO2)*(5*vu*(-2*AbsSqr(Lambdax) + Sqr(
      g2))*ZP(gI1,0) + vd*(-3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,1)))) + Conj(ZH(gI2,1))*
      (KroneckerDelta(0,gO2)*(vu*(3*Sqr(g1) - 5*Sqr(g2))*ZP(gI1,0) - 5*vd*(-2*
      AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,1)) - KroneckerDelta(1,gO2)*(5*vd*(-2*
      AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,0) + vu*(3*Sqr(g1) + 5*Sqr(g2))*ZP(gI1,1))
      ) - 10*Conj(ZH(gI2,2))*(1.4142135623730951*Conj(MS)*KroneckerDelta(1,gO2)*
      Lambdax*ZP(gI1,0) + 2*vS*Conj(Kappa)*KroneckerDelta(1,gO2)*Lambdax*ZP(gI1,0)
      + 1.4142135623730951*KroneckerDelta(1,gO2)*TLambdax*ZP(gI1,0) +
      1.4142135623730951*Conj(TLambdax)*KroneckerDelta(0,gO2)*ZP(gI1,1) +
      1.4142135623730951*Conj(Mu)*Lambdax*(KroneckerDelta(0,gO2)*ZP(gI1,0) +
      KroneckerDelta(1,gO2)*ZP(gI1,1)) + Conj(Lambdax)*(KroneckerDelta(1,gO2)*(2*
      vS*Lambdax + 1.4142135623730951*Mu)*ZP(gI1,1) + KroneckerDelta(0,gO2)*((2*vS
      *Lambdax + 1.4142135623730951*Mu)*ZP(gI1,0) + (1.4142135623730951*MS + 2*vS*
      Kappa)*ZP(gI1,1)))));
...
std::complex<double> CLASSNAME::CpAhAhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(-20*Conj(ZA(gI1,2))*Conj(ZA(gI2,2)
      )*(-(Conj(Kappa)*KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2)*Lambdax) + Conj
      (Lambdax)*(KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Lambdax +
      KroneckerDelta(1,gO1)*(-(KroneckerDelta(0,gO2)*Kappa) + KroneckerDelta(1,gO2
      )*Lambdax))) - Conj(ZA(gI1,0))*(-5*Conj(ZA(gI2,1))*(KroneckerDelta(0,gO2)*
      ...
      KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2)))) + Conj(ZA(gI1,1))*(5*Conj(ZA
      (gI2,0))*(KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1) + KroneckerDelta(0,gO1
      )*KroneckerDelta(1,gO2))*(-2*AbsSqr(Lambdax) + Sqr(g2)) + Conj(ZA(gI2,1))*(
...
std::complex<double> CLASSNAME::CphhhhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   const std::complex<double> result = 0.05*(-20*Conj(ZH(gI1,2))*Conj(ZH(gI2,2)
      ...
      Lambdax)*(KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*Lambdax +
      KroneckerDelta(1,gO1)*(KroneckerDelta(0,gO2)*Kappa + KroneckerDelta(1,gO2)*
      Lambdax))) - Conj(ZH(gI1,0))*(5*Conj(ZH(gI2,1))*(KroneckerDelta(0,gO2)*
      KroneckerDelta(1,gO1) + KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2))*(-2*
      AbsSqr(Lambdax) + Sqr(g2)) + Conj(ZH(gI2,0))*(KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*(-3*Sqr(g1) + 5*Sqr(g2)) + KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(3*Sqr(g1) + 5*Sqr(g2)))) + Conj(ZH(gI1,1))*(-5*Conj(
      ZH(gI2,0))*(KroneckerDelta(0,gO2)*KroneckerDelta(1,gO1) + KroneckerDelta(0,
      gO1)*KroneckerDelta(1,gO2))*(-2*AbsSqr(Lambdax) + Sqr(g2)) + Conj(ZH(gI2,1))
      *(KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(3*Sqr(g1) - 5*Sqr(g2)) -
      KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(3*Sqr(g1) + 5*Sqr(g2)))));
...
std::complex<double> CLASSNAME::CpSeconjUHpmconjSv(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.25*(KroneckerDelta(1,gO2)*(
      ...
      1.4142135623730951*vS*Lambdax + 2*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*
      Conj(ZE(gI2,3 + j1)))*ZV(gI1,j2))) + KroneckerDelta(0,gO2)*(
      ...
      2.8284271247461903*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,Conj
      (Ye(j1,j3))*Ye(j1,j2)))*ZV(gI1,j3))));
...
std::complex<double> CLASSNAME::CpSdconjUHpmconjSu(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = KroneckerDelta(0,gO2)*(
      ...
      0.7071067811865475*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,
      Yu(j1,j2)*ZU(gI1,3 + j1))) + Conj(Mu)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2
      ,Yu(j1,j2)*ZU(gI1,3 + j1))) + SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*
      Conj(TYd(j1,j2)))*ZU(gI1,j2)) + 0.7071067811865475*vu*SUM(j3,0,2,Conj(ZD(gI2
      ,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gI1,3 + j2)))
      + 0.7071067811865475*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,
      Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gI1,j3))) - 0.25*KroneckerDelta(1,gO2)*(
      ...
      *SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) + (
      1.4142135623730951*vS*Lambdax + 2*Mu)*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*
...
{
   const std::complex<double> result = std::complex<double>(0,0.5)*g2*(Conj(ZA(
      gI2,0))*KroneckerDelta(0,gO2) + Conj(ZA(gI2,1))*KroneckerDelta(1,gO2));
...
{
   const std::complex<double> result = 0.05*(Conj(ZA(gI1,0))*Conj(ZA(gI2,0)) +
      Conj(ZA(gI1,1))*Conj(ZA(gI2,1)))*(7.745966692414834*g1*g2*Sin(2*ThetaW()) +
      3*Sqr(g1) + 5*Sqr(g2) + Cos(2*ThetaW())*(-3*Sqr(g1) + 5*Sqr(g2)));
...
{
   const std::complex<double> result = 0.05*(Conj(ZH(gI1,0))*Conj(ZH(gI2,0)) +
      Conj(ZH(gI1,1))*Conj(ZH(gI2,1)))*(7.745966692414834*g1*g2*Sin(2*ThetaW()) +
      3*Sqr(g1) + 5*Sqr(g2) + Cos(2*ThetaW())*(-3*Sqr(g1) + 5*Sqr(g2)));
...
{
   const std::complex<double> result = std::complex<double>(0,0.5)*(Conj(ZA(gI2
      ,0))*Conj(ZH(gI1,0)) - Conj(ZA(gI2,1))*Conj(ZH(gI1,1)))*(g2*Cos(ThetaW()) +
...
{
   const std::complex<double> result = 0.5*(vd*Conj(ZH(gI2,0)) + vu*Conj(ZH(gI2
      ,1)))*Sqr(g2*Cos(ThetaW()) + 0.7745966692414834*g1*Sin(ThetaW()));
...
{
   const std::complex<double> result = std::complex<double>(0,0.5)*g2*(Conj(ZA(
      gI2,0))*ZP(gI1,0) + Conj(ZA(gI2,1))*ZP(gI1,1));
...
{
   const std::complex<double> result = -0.5*g2*(Conj(ZH(gI2,0))*ZP(gI1,0) -
      Conj(ZH(gI2,1))*ZP(gI1,1));
...
{
   const std::complex<double> result = 0.5*(Conj(ZA(gI1,0))*Conj(ZA(gI2,0)) +
      Conj(ZA(gI1,1))*Conj(ZA(gI2,1)))*Sqr(g2);
...
{
   const std::complex<double> result = 0.5*(Conj(ZH(gI1,0))*Conj(ZH(gI2,0)) +
      Conj(ZH(gI1,1))*Conj(ZH(gI2,1)))*Sqr(g2);
...
std::complex<double> CLASSNAME::CpbarChaUChiHpmPL(int gI1, int gO2, int gI2) const
{
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*KroneckerDelta(3,
      ...
      gI2,0) + 1.4142135623730951*(3.872983346207417*g1*KroneckerDelta(0,gO2) + 5*
      g2*KroneckerDelta(1,gO2))*ZP(gI2,1));
...
std::complex<double> CLASSNAME::CpUChiChaconjHpmPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = -(g2*Conj(UM(gI2,0))*KroneckerDelta(2,
      gO2)*ZP(gI1,0)) + Conj(UM(gI2,1))*(0.5477225575051661*g1*KroneckerDelta(0,
      gO2)*ZP(gI1,0) + 0.7071067811865475*g2*KroneckerDelta(1,gO2)*ZP(gI1,0) -
...
{
   const std::complex<double> result = 0.1*(7.0710678118654755*Conj(ZH(gI1,2))*
      (-2*Conj(ZN(gI2,4))*KroneckerDelta(4,gO2)*Kappa + Conj(ZN(gI2,3))*
      KroneckerDelta(2,gO2)*Lambdax + Conj(ZN(gI2,2))*KroneckerDelta(3,gO2)*
      Lambdax) + Conj(ZH(gI1,1))*(Conj(ZN(gI2,3))*(-3.872983346207417*g1*
      KroneckerDelta(0,gO2) + 5*g2*KroneckerDelta(1,gO2)) - 3.872983346207417*g1*
      Conj(ZN(gI2,0))*KroneckerDelta(3,gO2) + 5*g2*Conj(ZN(gI2,1))*KroneckerDelta(
      3,gO2) + 7.0710678118654755*Conj(ZN(gI2,4))*KroneckerDelta(2,gO2)*Lambdax +
      7.0710678118654755*Conj(ZN(gI2,2))*KroneckerDelta(4,gO2)*Lambdax) + Conj(ZH(
      gI1,0))*(Conj(ZN(gI2,2))*(3.872983346207417*g1*KroneckerDelta(0,gO2) - 5*g2*
      KroneckerDelta(1,gO2)) + 3.872983346207417*g1*Conj(ZN(gI2,0))*KroneckerDelta
      (2,gO2) - 5*g2*Conj(ZN(gI2,1))*KroneckerDelta(2,gO2) + 7.0710678118654755*
      Conj(ZN(gI2,4))*KroneckerDelta(3,gO2)*Lambdax + 7.0710678118654755*Conj(ZN(
      gI2,3))*KroneckerDelta(4,gO2)*Lambdax));
...
{
   const std::complex<double> result = 0.1*(Conj(ZH(gI1,0))*(KroneckerDelta(2,
      gO1)*(3.872983346207417*g1*ZN(gI2,0) - 5*g2*ZN(gI2,1)) + 3.872983346207417*
      g1*KroneckerDelta(0,gO1)*ZN(gI2,2) - 5*g2*KroneckerDelta(1,gO1)*ZN(gI2,2) +
      7.0710678118654755*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZN(gI2,3) +
      7.0710678118654755*Conj(Lambdax)*KroneckerDelta(3,gO1)*ZN(gI2,4)) +
      7.0710678118654755*Conj(ZH(gI1,2))*(Conj(Lambdax)*(KroneckerDelta(3,gO1)*ZN(
      gI2,2) + KroneckerDelta(2,gO1)*ZN(gI2,3)) - 2*Conj(Kappa)*KroneckerDelta(4,
      gO1)*ZN(gI2,4)) + Conj(ZH(gI1,1))*(KroneckerDelta(3,gO1)*(-3.872983346207417
      *g1*ZN(gI2,0) + 5*g2*ZN(gI2,1)) + (-3.872983346207417*g1*KroneckerDelta(0,
      gO1) + 5*g2*KroneckerDelta(1,gO1))*ZN(gI2,3) + 7.0710678118654755*Conj(
      Lambdax)*(KroneckerDelta(4,gO1)*ZN(gI2,2) + KroneckerDelta(2,gO1)*ZN(gI2,4))
      ));
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(
      7.0710678118654755*Conj(ZA(gI2,2))*(-2*Conj(ZN(gI1,4))*KroneckerDelta(4,gO2)
      *Kappa + Conj(ZN(gI1,3))*KroneckerDelta(2,gO2)*Lambdax + Conj(ZN(gI1,2))*
      KroneckerDelta(3,gO2)*Lambdax) + Conj(ZA(gI2,1))*(Conj(ZN(gI1,3))*(
      3.872983346207417*g1*KroneckerDelta(0,gO2) - 5*g2*KroneckerDelta(1,gO2)) +
      3.872983346207417*g1*Conj(ZN(gI1,0))*KroneckerDelta(3,gO2) - 5*g2*Conj(ZN(
      gI1,1))*KroneckerDelta(3,gO2) + 7.0710678118654755*Conj(ZN(gI1,4))*
      KroneckerDelta(2,gO2)*Lambdax + 7.0710678118654755*Conj(ZN(gI1,2))*
      KroneckerDelta(4,gO2)*Lambdax) + Conj(ZA(gI2,0))*(Conj(ZN(gI1,2))*(
      -3.872983346207417*g1*KroneckerDelta(0,gO2) + 5*g2*KroneckerDelta(1,gO2)) -
      3.872983346207417*g1*Conj(ZN(gI1,0))*KroneckerDelta(2,gO2) + 5*(g2*Conj(ZN(
      gI1,1))*KroneckerDelta(2,gO2) + 1.4142135623730951*(Conj(ZN(gI1,4))*
      KroneckerDelta(3,gO2) + Conj(ZN(gI1,3))*KroneckerDelta(4,gO2))*Lambdax)));
...
{
   const std::complex<double> result = std::complex<double>(0,0.1)*(
      -7.0710678118654755*Conj(ZA(gI2,2))*(Conj(Lambdax)*(KroneckerDelta(3,gO1)*ZN
      (gI1,2) + KroneckerDelta(2,gO1)*ZN(gI1,3)) - 2*Conj(Kappa)*KroneckerDelta(4,
      gO1)*ZN(gI1,4)) - Conj(ZA(gI2,1))*(KroneckerDelta(3,gO1)*(3.872983346207417*
      g1*ZN(gI1,0) - 5*g2*ZN(gI1,1)) + (3.872983346207417*g1*KroneckerDelta(0,gO1)
      - 5*g2*KroneckerDelta(1,gO1))*ZN(gI1,3) + 7.0710678118654755*Conj(Lambdax)*
      (KroneckerDelta(4,gO1)*ZN(gI1,2) + KroneckerDelta(2,gO1)*ZN(gI1,4))) + Conj(
      ZA(gI2,0))*(KroneckerDelta(2,gO1)*(3.872983346207417*g1*ZN(gI1,0) - 5*g2*ZN(
      gI1,1)) + 3.872983346207417*g1*KroneckerDelta(0,gO1)*ZN(gI1,2) - 5*(g2*
      KroneckerDelta(1,gO1)*ZN(gI1,2) + 1.4142135623730951*Conj(Lambdax)*(
      KroneckerDelta(4,gO1)*ZN(gI1,3) + KroneckerDelta(3,gO1)*ZN(gI1,4)))));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*(g2*Conj(UM(gI1,0))*Conj(ZA(gI2,1))*KroneckerDelta(1,gO2
      ) + Conj(UM(gI1,1))*(g2*Conj(ZA(gI2,0))*KroneckerDelta(0,gO2) - Conj(ZA(gI2,
      2))*KroneckerDelta(1,gO2)*Lambdax));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*(g2*Conj(ZA(gI2,0))*KroneckerDelta(1,gO1)*UP(gI1,0) + (
      g2*Conj(ZA(gI2,1))*KroneckerDelta(0,gO1) - Conj(Lambdax)*Conj(ZA(gI2,2))*
      KroneckerDelta(1,gO1))*UP(gI1,1));
...
std::complex<double> CLASSNAME::CpbarUChaChiHpmPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*ZN(gI2,2)*ZP(
      gI1,0)) + KroneckerDelta(1,gO1)*(0.5477225575051661*g1*ZN(gI2,0)*ZP(gI1,0) +
      0.7071067811865475*g2*ZN(gI2,1)*ZP(gI1,0) - Conj(Lambdax)*ZN(gI2,4)*ZP(gI1,
      1));
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZH(
      gI1,0))*SUM(j2,0,2,Conj(ZEL(gI2,j2))*Ye(gO2,j2)),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(ZH(
      gI1,0))*SUM(j1,0,2,Conj(Ye(j1,gO1))*ZER(gI2,j1)),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZH(
      gI1,0))*SUM(j2,0,2,Conj(ZDL(gI2,j2))*Yd(gO2,j2)),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(ZH(
      gI1,0))*SUM(j1,0,2,Conj(Yd(j1,gO1))*ZDR(gI2,j1)),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZH(
      gI1,1))*SUM(j2,0,2,Conj(ZUL(gI2,j2))*Yu(gO2,j2)),0);
...
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(ZH(
      gI1,1))*SUM(j1,0,2,Conj(Yu(j1,gO1))*ZUR(gI2,j1)),0);
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,Conj(ZEL(gI1,j2))*SUM(j1,0,2
      ,Conj(ZER(gO2,j1))*Ye(j1,j2)));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*
      ZER(gI1,j1))*ZEL(gO1,j2));
...
std::complex<double> CLASSNAME::CpbarFeFehhPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,0))*SUM(
      j2,0,2,Conj(ZEL(gI2,j2))*SUM(j1,0,2,Conj(ZER(gO2,j1))*Ye(j1,j2)));
...
{
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,0))*SUM(
      j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gI2,j1))*ZEL(gO1,j2));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,Conj(ZDL(gI1,j2))*SUM(j1,0,2
      ,Conj(ZDR(gO2,j1))*Yd(j1,j2)));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*
      ZDR(gI1,j1))*ZDL(gO1,j2));
...
{
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,0))*SUM(
      j2,0,2,Conj(ZDL(gI2,j2))*SUM(j1,0,2,Conj(ZDR(gO2,j1))*Yd(j1,j2)));
...
{
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,0))*SUM(
      j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*ZDR(gI2,j1))*ZDL(gO1,j2));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*Conj(ZA(gI2,1))*SUM(j2,0,2,Conj(ZUL(gI1,j2))*SUM(j1,0,2
      ,Conj(ZUR(gO2,j1))*Yu(j1,j2)));
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI2,1))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*
      ZUR(gI1,j1))*ZUL(gO1,j2));
...
{
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,1))*SUM(
      j2,0,2,Conj(ZUL(gI2,j2))*SUM(j1,0,2,Conj(ZUR(gO2,j1))*Yu(j1,j2)));
...
{
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,1))*SUM(
      j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(gI2,j1))*ZUL(gO1,j2));
...
std::complex<double> CLASSNAME::self_energy_Sd_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFd(gI1)*SUM(gI2,0,4,B0(Sqr(p),Sqr(MFd(gI1)),Sqr(
...
std::complex<double> CLASSNAME::self_energy_Sv_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFv(gI1)*SUM(gI2,0,4,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(
...
std::complex<double> CLASSNAME::self_energy_Su_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFu(gI1)*SUM(gI2,0,4,B0(Sqr(p),Sqr(MFu(gI1)),Sqr(
...
std::complex<double> CLASSNAME::self_energy_Se_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFe(gI1)*SUM(gI2,0,4,B0(Sqr(p),Sqr(MFe(gI1)),Sqr(
...
std::complex<double> CLASSNAME::self_energy_hh_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,4,MChi(gI1)*SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI1)),Sqr(
...
std::complex<double> CLASSNAME::self_energy_VZ_1loop(double p ) const
{
   ...
   result += 0.5*SUM(gI1,0,4,SUM(gI2,0,4,(AbsSqr(CpChiChiVZPL(gI1,gI2)) +
...
std::complex<double> CLASSNAME::self_energy_VWm_1loop(double p ) const
{
   ...
   result += SUM(gI1,0,4,SUM(gI2,0,1,(AbsSqr(CpChiChaconjVWmPL(gI1,gI2)) +
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MSv(gI1)))*
      ...
      ;
   result += SUM(gI1,0,2,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(Mhh(gI1)))*
   ...
   result += -4*SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MVZ))*Conj(
...
std::complex<double> CLASSNAME::self_energy_Cha_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MHpm(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fe_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSe(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fd_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSd(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fu_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,5,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSu(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,SUM(gI2,0,4,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSv(gI1)))*
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(NUTSMSSM_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::Sv))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::hh))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::Ah))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::Hpm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(NUTSMSSM_info::VWm))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(NUTSMSSM_info::VWm);
