...
// File generated at Wed 16 Oct 2019 22:22:16

#ifndef NUTSMSSM_susy_parameters_H
#define NUTSMSSM_susy_parameters_H
...
class NUTSMSSM_susy_parameters : public Beta_function {
public:
   explicit NUTSMSSM_susy_parameters(const NUTSMSSM_input_parameters& input_ = NUTSMSSM_input_parameters());
   NUTSMSSM_susy_parameters(double scale_, int loops_, int thresholds_, const NUTSMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_,
   double Lambdax_, double Kappa_, const Eigen::Matrix<double,3,3>& Yu_, double
    Mu_, double MS_, double L1_, double g1_, double g2_, double g3_, double vd_
   , double vu_, double vS_);
   NUTSMSSM_susy_parameters(const NUTSMSSM_susy_parameters&) = default;
   NUTSMSSM_susy_parameters(NUTSMSSM_susy_parameters&&) = default;
   virtual ~NUTSMSSM_susy_parameters() = default;
   NUTSMSSM_susy_parameters& operator=(const NUTSMSSM_susy_parameters&) = default;
   NUTSMSSM_susy_parameters& operator=(NUTSMSSM_susy_parameters&&) = default;
   ...
   NUTSMSSM_input_parameters& get_input();
   void set_input_parameters(const NUTSMSSM_input_parameters&);

   NUTSMSSM_susy_parameters calc_beta() const;
   NUTSMSSM_susy_parameters calc_beta(int) const;
   virtual void clear();
...
private:
   ...
   double calc_beta_MS_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MS_5_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_L1_1_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_L1_2_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_L1_3_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_L1_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_L1_5_loop(const TRACE_STRUCT_TYPE&) const;
...
std::ostream& operator<<(std::ostream&, const NUTSMSSM_susy_parameters&);
