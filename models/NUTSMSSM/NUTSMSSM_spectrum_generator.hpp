...
// File generated at Fri 26 Jun 2015 19:13:37
 ...
 */
template <class T>
void NUTSMSSM_spectrum_generator<T>::run(const softsusy::QedQcd& oneset,
                                const NUTSMSSM_input_parameters& input)
{
   ...
   NUTSMSSM_initial_guesser<T> initial_guesser(&model, oneset,
                                                  low_scale_constraint,
                                                  susy_scale_constraint,
                                                  high_scale_constraint);
