                                ...
                                const NUTSMSSM_input_parameters& input)
{
   ...
   NUTSMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   NUTSMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   NUTSMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
