...
public:
   using Scale_getter = Convergence_tester_DRbar<NUTSMSSM<Two_scale>>::Scale_getter;

   NUTSMSSM_convergence_tester(NUTSMSSM<Two_scale>*, double, const Scale_getter& sg = Scale_getter());
   virtual ~NUTSMSSM_convergence_tester() = default;
