...
public:
   ...
   void set_extra(const NUTSMSSM_slha&, const NUTSMSSM_scales&, const NUTSMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NUTSMSSM_scales&, const NUTSMSSM_observables&);
