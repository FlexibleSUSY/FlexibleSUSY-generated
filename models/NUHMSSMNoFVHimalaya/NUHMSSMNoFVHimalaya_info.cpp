...
namespace NUHMSSMNoFVHimalaya_info {
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS> input_parameter_names
       = {"TanBeta", "Qin", "M1", "M2", "M3", "AtIN", "AbIN", "AtauIN", "AcIN",
      "AsIN", "AmuonIN", "AuIN", "AdIN", "AeIN", "MuIN", "mA2IN", "ml11IN",
      "ml22IN", "ml33IN", "me11IN", "me22IN", "me33IN", "mq11IN", "mq22IN",
      "mq33IN", "mu11IN", "mu22IN", "mu33IN", "md11IN", "md22IN", "md33IN", "Mlow"
      };
