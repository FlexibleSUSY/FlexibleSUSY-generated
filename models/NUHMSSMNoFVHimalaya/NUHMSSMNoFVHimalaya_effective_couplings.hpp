...
#ifndef NUHMSSMNoFVHimalaya_EFFECTIVE_COUPLINGS_H
#define NUHMSSMNoFVHimalaya_EFFECTIVE_COUPLINGS_H
...
class NUHMSSMNoFVHimalaya_effective_couplings {
public:
   NUHMSSMNoFVHimalaya_effective_couplings(const NUHMSSMNoFVHimalaya_mass_eigenstates&,
   ...
   void set_model(const NUHMSSMNoFVHimalaya_mass_eigenstates& model_);
