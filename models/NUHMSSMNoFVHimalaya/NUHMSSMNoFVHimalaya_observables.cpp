...
#include "observables/NUHMSSMNoFVHimalaya_br_l_to_3l.hpp"
#include "observables/NUHMSSMNoFVHimalaya_br_l_to_l_gamma.hpp"
#include "observables/NUHMSSMNoFVHimalaya_l_to_l_conversion.hpp"
                                              ...
                                              const Spectrum_generator_settings& settings)
{
   ...
   try {
      ...
      observables.AMM0(Fm) = NUHMSSMNoFVHimalaya_amm::calculate_amm<NUHMSSMNoFVHimalaya_cxx_diagrams::fields::Fm>(MODEL, qedqcd, settings);
      observables.AMMUNCERTAINTY0(Fm) = NUHMSSMNoFVHimalaya_amm::calculate_amm_uncertainty<NUHMSSMNoFVHimalaya_cxx_diagrams::fields::Fm>(MODEL, qedqcd, settings);
      #ifdef ENABLE_GM2CALC
