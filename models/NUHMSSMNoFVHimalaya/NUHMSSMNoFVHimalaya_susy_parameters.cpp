...
// File generated at Mon 5 Mar 2018 14:29:57
...
#define CLASSNAME NUHMSSMNoFVHimalaya_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int NUHMSSMNoFVHimalaya_susy_parameters::numberOfParameters;

NUHMSSMNoFVHimalaya_susy_parameters::NUHMSSMNoFVHimalaya_susy_parameters(const NUHMSSMNoFVHimalaya_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

NUHMSSMNoFVHimalaya_susy_parameters::NUHMSSMNoFVHimalaya_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const NUHMSSMNoFVHimalaya_input_parameters& input_
...
Eigen::ArrayXd NUHMSSMNoFVHimalaya_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

NUHMSSMNoFVHimalaya_susy_parameters NUHMSSMNoFVHimalaya_susy_parameters::calc_beta(int loops) const
{
   ...
   return NUHMSSMNoFVHimalaya_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Yu, beta_Mu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu);
}

NUHMSSMNoFVHimalaya_susy_parameters NUHMSSMNoFVHimalaya_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void NUHMSSMNoFVHimalaya_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd NUHMSSMNoFVHimalaya_susy_parameters::get() const
{
...
void NUHMSSMNoFVHimalaya_susy_parameters::print(std::ostream& ostr) const
{
...
void NUHMSSMNoFVHimalaya_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const NUHMSSMNoFVHimalaya_input_parameters& NUHMSSMNoFVHimalaya_susy_parameters::get_input() const
{
   return input;
}

NUHMSSMNoFVHimalaya_input_parameters& NUHMSSMNoFVHimalaya_susy_parameters::get_input()
{
   return input;
}

void NUHMSSMNoFVHimalaya_susy_parameters::set_input_parameters(const NUHMSSMNoFVHimalaya_input_parameters& input_)
{
   input = input_;
}

NUHMSSMNoFVHimalaya_susy_parameters::Susy_traces NUHMSSMNoFVHimalaya_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSMNoFVHimalaya_susy_parameters& susy_pars)
{
