...
// File generated at Mon 5 Mar 2018 15:00:23

/**
 * @file NUHMSSMNoFVHimalaya_a_muon.cpp
 *
 * This file was generated at Mon 5 Mar 2018 15:00:23 with FlexibleSUSY
...
double calculate_a_muon_impl(NUHMSSMNoFVHimalaya_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const NUHMSSMNoFVHimalaya_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("NUHMSSMNoFVHimalaya_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double NUHMSSMNoFVHimalaya_a_muon::calculate_a_muon(const NUHMSSMNoFVHimalaya_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("NUHMSSMNoFVHimalaya_a_muon:" << e.what());
...
double NUHMSSMNoFVHimalaya_a_muon::calculate_a_muon_uncertainty(const NUHMSSMNoFVHimalaya_mass_eigenstates& model_)
{
   NUHMSSMNoFVHimalaya_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("NUHMSSMNoFVHimalaya_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
