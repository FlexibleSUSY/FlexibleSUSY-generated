...
// File generated at Sun 26 Aug 2018 13:44:57
...
const int NUHMSSMNoFVHimalaya_soft_parameters::numberOfParameters;

NUHMSSMNoFVHimalaya_soft_parameters::NUHMSSMNoFVHimalaya_soft_parameters(const NUHMSSMNoFVHimalaya_input_parameters& input_)
   : NUHMSSMNoFVHimalaya_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

NUHMSSMNoFVHimalaya_soft_parameters::NUHMSSMNoFVHimalaya_soft_parameters(
   const NUHMSSMNoFVHimalaya_susy_parameters& susy_model
   ...
   : NUHMSSMNoFVHimalaya_susy_parameters(susy_model)
...
Eigen::ArrayXd NUHMSSMNoFVHimalaya_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

NUHMSSMNoFVHimalaya_soft_parameters NUHMSSMNoFVHimalaya_soft_parameters::calc_beta(int loops) const
{
   ...
   const NUHMSSMNoFVHimalaya_susy_parameters susy_betas(NUHMSSMNoFVHimalaya_susy_parameters::calc_beta(loops));

   return NUHMSSMNoFVHimalaya_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

NUHMSSMNoFVHimalaya_soft_parameters NUHMSSMNoFVHimalaya_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void NUHMSSMNoFVHimalaya_soft_parameters::clear()
{
   NUHMSSMNoFVHimalaya_susy_parameters::clear();
...
Eigen::ArrayXd NUHMSSMNoFVHimalaya_soft_parameters::get() const
{
   Eigen::ArrayXd pars(NUHMSSMNoFVHimalaya_susy_parameters::get());
...
void NUHMSSMNoFVHimalaya_soft_parameters::print(std::ostream& ostr) const
{
   NUHMSSMNoFVHimalaya_susy_parameters::print(ostr);
...
void NUHMSSMNoFVHimalaya_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   NUHMSSMNoFVHimalaya_susy_parameters::set(pars);
...
NUHMSSMNoFVHimalaya_soft_parameters::Soft_traces NUHMSSMNoFVHimalaya_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSMNoFVHimalaya_soft_parameters& soft_pars)
{
