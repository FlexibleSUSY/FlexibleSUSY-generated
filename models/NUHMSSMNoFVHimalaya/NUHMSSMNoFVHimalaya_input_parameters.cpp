...
// File generated at Wed 16 Oct 2019 18:33:49
...
Eigen::ArrayXd NUHMSSMNoFVHimalaya_input_parameters::get() const
{
...
void NUHMSSMNoFVHimalaya_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   Qin = pars(1);
   M1 = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSMNoFVHimalaya_input_parameters& input)
{
   ...
   ostr << "MuIN = " << INPUT(MuIN) << ", ";
   ostr << "mA2IN = " << INPUT(mA2IN) << ", ";
