...
/**
 * @file NUHMSSMNoFVHimalaya_unitarity.cpp
 *
...
namespace NUHMSSMNoFVHimalaya_unitarity {
...
// s -> infinity limit
UnitarityInfiniteS
max_scattering_eigenvalue_infinite_s(NUHMSSMNoFVHimalaya_mass_eigenstates const& model) {
