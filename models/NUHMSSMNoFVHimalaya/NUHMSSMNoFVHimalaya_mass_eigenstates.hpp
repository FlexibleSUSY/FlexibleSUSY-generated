...
/**
 * @file NUHMSSMNoFVHimalaya_mass_eigenstates.hpp
 *
...
#define NUHMSSMNoFVHimalaya_MASS_EIGENSTATES_H
...
class NUHMSSMNoFVHimalaya_ewsb_solver_interface;
/**
 * @class NUHMSSMNoFVHimalaya_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class NUHMSSMNoFVHimalaya_mass_eigenstates
   : public NUHMSSMNoFVHimalaya_soft_parameters
   , public NUHMSSMNoFVHimalaya_mass_eigenstates_interface
{
public:
   explicit NUHMSSMNoFVHimalaya_mass_eigenstates(const NUHMSSMNoFVHimalaya_input_parameters& input_ = NUHMSSMNoFVHimalaya_input_parameters());
   NUHMSSMNoFVHimalaya_mass_eigenstates(const NUHMSSMNoFVHimalaya_mass_eigenstates&) = default;
   NUHMSSMNoFVHimalaya_mass_eigenstates(NUHMSSMNoFVHimalaya_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<NUHMSSMNoFVHimalaya_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{NUHMSSMNoFVHimalaya_info::model_name,
   ...
   std::shared_ptr<NUHMSSMNoFVHimalaya_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const NUHMSSMNoFVHimalaya_mass_eigenstates&);
