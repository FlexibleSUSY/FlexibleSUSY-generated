 ...
 */
class NUHMSSMNoFVHimalaya_mass_eigenstates : public NUHMSSMNoFVHimalaya_soft_parameters {
public:
   ...
   void set_physical(const NUHMSSMNoFVHimalaya_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const NUHMSSMNoFVHimalaya_physical& get_physical() const;
   NUHMSSMNoFVHimalaya_physical& get_physical();
