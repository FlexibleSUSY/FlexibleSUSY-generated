...
#ifndef NUHMSSMNoFVHimalaya_TWO_SCALE_INITIAL_GUESSER_H
#define NUHMSSMNoFVHimalaya_TWO_SCALE_INITIAL_GUESSER_H

#include "NUHMSSMNoFVHimalaya_initial_guesser.hpp"
...
/**
 * @class NUHMSSMNoFVHimalaya_initial_guesser<Two_scale>
 * @brief initial guesser for the NUHMSSMNoFVHimalaya
 */

template<>
class NUHMSSMNoFVHimalaya_initial_guesser<Two_scale> : public Initial_guesser {
public:
   NUHMSSMNoFVHimalaya_initial_guesser(NUHMSSMNoFVHimalaya<Two_scale>*,
                               const softsusy::QedQcd&,
                               const NUHMSSMNoFVHimalaya_low_scale_constraint<Two_scale>&,
                               const NUHMSSMNoFVHimalaya_susy_scale_constraint<Two_scale>&,
                               const NUHMSSMNoFVHimalaya_high_scale_constraint<Two_scale>&);
   virtual ~NUHMSSMNoFVHimalaya_initial_guesser() = default;
...
private:
   NUHMSSMNoFVHimalaya<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   NUHMSSMNoFVHimalaya_low_scale_constraint<Two_scale> low_constraint{};
   NUHMSSMNoFVHimalaya_susy_scale_constraint<Two_scale> susy_constraint{};
   NUHMSSMNoFVHimalaya_high_scale_constraint<Two_scale> high_constraint{};
