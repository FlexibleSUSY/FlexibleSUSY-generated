...
#include "NUHMSSMNoFVHimalaya_slha_io.hpp"
...
#include "NUHMSSMNoFVHimalaya_physical.hpp"
...
NUHMSSMNoFVHimalaya_slha_io::NUHMSSMNoFVHimalaya_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void NUHMSSMNoFVHimalaya_slha_io::clear()
{
   slha_io.clear();
}

void NUHMSSMNoFVHimalaya_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void NUHMSSMNoFVHimalaya_slha_io::fill(NUHMSSMNoFVHimalaya_slha& model) const
{
   fill(static_cast<NUHMSSMNoFVHimalaya_mass_eigenstates&>(model));
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_extpar(const NUHMSSMNoFVHimalaya_input_parameters& input)
{
   ...
   extpar << FORMAT_ELEMENT(23, input.MuIN, "MuIN");
   extpar << FORMAT_ELEMENT(24, input.mA2IN, "mA2IN");
 ...
 * @param input struct of input parameters
 */
void NUHMSSMNoFVHimalaya_slha_io::set_imminpar(const NUHMSSMNoFVHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSMNoFVHimalaya_slha_io::set_imextpar(const NUHMSSMNoFVHimalaya_input_parameters& input)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSMNoFVHimalaya_slha_io::set_minpar(const NUHMSSMNoFVHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NUHMSSMNoFVHimalaya_slha_io::set_input(const NUHMSSMNoFVHimalaya_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void NUHMSSMNoFVHimalaya_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, NUHMSSMNoFVHimalaya_info::model_name)
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_mass(const NUHMSSMNoFVHimalaya_physical& physical,
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_mixing_matrices(const NUHMSSMNoFVHimalaya_physical& physical,
...
void NUHMSSMNoFVHimalaya_slha_io::set_ckm(
...
void NUHMSSMNoFVHimalaya_slha_io::set_pmns(
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_model_parameters(const NUHMSSMNoFVHimalaya_slha& model)
{
   {
...
void NUHMSSMNoFVHimalaya_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void NUHMSSMNoFVHimalaya_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void NUHMSSMNoFVHimalaya_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void NUHMSSMNoFVHimalaya_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void NUHMSSMNoFVHimalaya_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, NUHMSSMNoFVHimalaya_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = NUHMSSMNoFVHimalaya_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + NUHMSSMNoFVHimalaya_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_spectrum(const NUHMSSMNoFVHimalaya_slha& model)
{
   const NUHMSSMNoFVHimalaya_physical physical(model.get_physical_slha());
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::set_extra(
   const NUHMSSMNoFVHimalaya_slha& model,
   const NUHMSSMNoFVHimalaya_scales& scales,
   const NUHMSSMNoFVHimalaya_observables& observables,
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void NUHMSSMNoFVHimalaya_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void NUHMSSMNoFVHimalaya_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void NUHMSSMNoFVHimalaya_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double NUHMSSMNoFVHimalaya_slha_io::get_parameter_output_scale() const
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::fill(NUHMSSMNoFVHimalaya_input_parameters& input) const
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::fill_drbar_parameters(NUHMSSMNoFVHimalaya_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void NUHMSSMNoFVHimalaya_slha_io::fill(NUHMSSMNoFVHimalaya_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   NUHMSSMNoFVHimalaya_physical physical_hk;
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void NUHMSSMNoFVHimalaya_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void NUHMSSMNoFVHimalaya_slha_io::fill_minpar_tuple(NUHMSSMNoFVHimalaya_input_parameters& input,
...
void NUHMSSMNoFVHimalaya_slha_io::fill_extpar_tuple(NUHMSSMNoFVHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
   ...
   case 23: input.MuIN = value; break;
   case 24: input.mA2IN = value; break;
...
void NUHMSSMNoFVHimalaya_slha_io::fill_imminpar_tuple(NUHMSSMNoFVHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NUHMSSMNoFVHimalaya_slha_io::fill_imextpar_tuple(NUHMSSMNoFVHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void NUHMSSMNoFVHimalaya_slha_io::fill_physical(NUHMSSMNoFVHimalaya_physical& physical) const
{
   {
 ...
 */
double NUHMSSMNoFVHimalaya_slha_io::read_scale() const
{
