...
/**
 * @file NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef NUHMSSMNoFVHimalaya_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define NUHMSSMNoFVHimalaya_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
#define SUPER(p) NUHMSSMNoFVHimalaya_soft_parameters::p
...
/**
 * @class NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme
   : private NUHMSSMNoFVHimalaya_soft_parameters
   , public NUHMSSMNoFVHimalaya_mass_eigenstates_interface
{
public:
   explicit NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(const NUHMSSMNoFVHimalaya_input_parameters& input_ = NUHMSSMNoFVHimalaya_input_parameters());
   explicit NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(const NUHMSSMNoFVHimalaya_mass_eigenstates&);
   NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(const NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&) = default;
   NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme() = default;
   NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme& operator=(const NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&) = default;
   NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme& operator=(NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const NUHMSSMNoFVHimalaya_mass_eigenstates&);
   ...
   const NUHMSSMNoFVHimalaya_input_parameters& get_input_parameters() const override;
   NUHMSSMNoFVHimalaya_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const NUHMSSMNoFVHimalaya_physical& get_physical() const override;
   NUHMSSMNoFVHimalaya_physical& get_physical() override;
   ...
   void set_physical(const NUHMSSMNoFVHimalaya_physical&) override;
...
private:
   ...
   NUHMSSMNoFVHimalaya_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{NUHMSSMNoFVHimalaya_info::model_name,
                     &NUHMSSMNoFVHimalaya_info::particle_names_getter,
                     &NUHMSSMNoFVHimalaya_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const NUHMSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&);
