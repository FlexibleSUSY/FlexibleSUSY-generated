...
NUHMSSMNoFVHimalaya_slha::NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_input_parameters& input_,
 ...
 */
NUHMSSMNoFVHimalaya_slha::NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : NUHMSSMNoFVHimalaya_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void NUHMSSMNoFVHimalaya_slha::clear()
{
   NUHMSSMNoFVHimalaya_mass_eigenstates::clear();
   physical_slha.clear();
}

void NUHMSSMNoFVHimalaya_slha::calculate_spectrum()
{
   NUHMSSMNoFVHimalaya_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void NUHMSSMNoFVHimalaya_slha::convert_to_slha()
{
...
void NUHMSSMNoFVHimalaya_slha::calculate_ckm_matrix()
{

}

void NUHMSSMNoFVHimalaya_slha::calculate_pmns_matrix()
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void NUHMSSMNoFVHimalaya_slha::convert_soft_squared_masses_to_slha()
{
...
const NUHMSSMNoFVHimalaya_physical& NUHMSSMNoFVHimalaya_slha::get_physical_slha() const
{
   return physical_slha;
}

NUHMSSMNoFVHimalaya_physical& NUHMSSMNoFVHimalaya_slha::get_physical_slha()
{
   return physical_slha;
}

void NUHMSSMNoFVHimalaya_slha::print(std::ostream& ostr) const
{
   NUHMSSMNoFVHimalaya_mass_eigenstates::print(ostr);
...
void NUHMSSMNoFVHimalaya_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const NUHMSSMNoFVHimalaya_slha& model)
{
   model.print(ostr);
   return ostr;
}
