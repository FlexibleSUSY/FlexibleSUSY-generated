...
/**
 * @file NUHMSSMNoFVHimalaya_f_to_f_conversion.cpp
 *
...
namespace NUHMSSMNoFVHimalaya_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const NUHMSSMNoFVHimalaya_mass_eigenstates& model) {
