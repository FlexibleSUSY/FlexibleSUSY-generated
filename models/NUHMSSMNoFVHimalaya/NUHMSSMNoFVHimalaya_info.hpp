...
#ifndef NUHMSSMNoFVHimalaya_INFO_H
#define NUHMSSMNoFVHimalaya_INFO_H
...
namespace NUHMSSMNoFVHimalaya_info {
   ...
   enum Input_parameters : int { TanBeta, Qin, M1, M2, M3, AtIN, AbIN, AtauIN,
      AcIN, AsIN, AmuonIN, AuIN, AdIN, AeIN, MuIN, mA2IN, ml11IN, ml22IN, ml33IN,
      me11IN, me22IN, me33IN, mq11IN, mq22IN, mq33IN, mu11IN, mu22IN, mu33IN,
      md11IN, md22IN, md33IN, Mlow, NUMBER_OF_INPUT_PARAMETERS };
   ...
   class NUHMSSMNoFVHimalaya_particle_names : public Names {
   public:
      virtual ~NUHMSSMNoFVHimalaya_particle_names() = default;
   ...
   class NUHMSSMNoFVHimalaya_parameter_names : public Names {
   public:
      virtual ~NUHMSSMNoFVHimalaya_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const NUHMSSMNoFVHimalaya_particle_names  particle_names_getter{};
   const NUHMSSMNoFVHimalaya_parameter_names parameter_names_getter{};
