...
#ifndef NUHMSSMNoFVHimalaya_SLHA_IO_H
#define NUHMSSMNoFVHimalaya_SLHA_IO_H
...
struct NUHMSSMNoFVHimalaya_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class NUHMSSMNoFVHimalaya_slha_io {
public:
   NUHMSSMNoFVHimalaya_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(NUHMSSMNoFVHimalaya_input_parameters&) const;
   void fill(NUHMSSMNoFVHimalaya_mass_eigenstates&) const;
   template <class Model> void fill(NUHMSSMNoFVHimalaya_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const NUHMSSMNoFVHimalaya_slha<Model>&, const NUHMSSMNoFVHimalaya_scales&, const NUHMSSMNoFVHimalaya_observables&);
   void set_input(const NUHMSSMNoFVHimalaya_input_parameters&);
   ...
   template <class Model> void set_spectrum(const NUHMSSMNoFVHimalaya_slha<Model>&);
   template <class T> void set_spectrum(const NUHMSSMNoFVHimalaya<T>&);
   ...
   static void fill_minpar_tuple(NUHMSSMNoFVHimalaya_input_parameters&, int, double);
   static void fill_extpar_tuple(NUHMSSMNoFVHimalaya_input_parameters&, int, double);
   static void fill_imminpar_tuple(NUHMSSMNoFVHimalaya_input_parameters&, int, double);
   static void fill_imextpar_tuple(NUHMSSMNoFVHimalaya_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const NUHMSSMNoFVHimalaya_slha<Model>&, const softsusy::QedQcd&, const NUHMSSMNoFVHimalaya_scales&, const NUHMSSMNoFVHimalaya_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const NUHMSSMNoFVHimalaya_slha<Model>&, const softsusy::QedQcd&, const NUHMSSMNoFVHimalaya_scales&, const NUHMSSMNoFVHimalaya_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const NUHMSSMNoFVHimalaya_input_parameters&);
   void set_imminpar(const NUHMSSMNoFVHimalaya_input_parameters&);
   void set_imextpar(const NUHMSSMNoFVHimalaya_input_parameters&);
   void set_minpar(const NUHMSSMNoFVHimalaya_input_parameters&);
   void set_mass(const NUHMSSMNoFVHimalaya_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const NUHMSSMNoFVHimalaya_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const NUHMSSMNoFVHimalaya_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(NUHMSSMNoFVHimalaya_mass_eigenstates&) const;
   void fill_physical(NUHMSSMNoFVHimalaya_physical&) const;
};
 ...
 */
template <class Model>
void NUHMSSMNoFVHimalaya_slha_io::fill(NUHMSSMNoFVHimalaya_slha<Model>& model) const
{
...
template <class Model>
void NUHMSSMNoFVHimalaya_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const NUHMSSMNoFVHimalaya_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const NUHMSSMNoFVHimalaya_scales& scales,
   const NUHMSSMNoFVHimalaya_observables& observables)
{
   NUHMSSMNoFVHimalaya_slha_io slha_io;
   const NUHMSSMNoFVHimalaya_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll NUHMSSMNoFVHimalaya_slha_io::fill_slhaea(
   const NUHMSSMNoFVHimalaya_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const NUHMSSMNoFVHimalaya_scales& scales, const NUHMSSMNoFVHimalaya_observables& observables)
{
   SLHAea::Coll slhaea;
   NUHMSSMNoFVHimalaya_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void NUHMSSMNoFVHimalaya_slha_io::set_model_parameters(const NUHMSSMNoFVHimalaya_slha<Model>& model)
{
   {
...
void NUHMSSMNoFVHimalaya_slha_io::set_extra(
   const NUHMSSMNoFVHimalaya_slha<Model>& model, const NUHMSSMNoFVHimalaya_scales& scales,
   const NUHMSSMNoFVHimalaya_observables& observables)
{
 ...
 */
template <class... Ts>
void NUHMSSMNoFVHimalaya_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<NUHMSSMNoFVHimalaya_slha_io> ss(this);
 ...
 */
template <class T>
void NUHMSSMNoFVHimalaya_slha_io::set_spectrum(const NUHMSSMNoFVHimalaya<T>& model)
{
   set_spectrum(NUHMSSMNoFVHimalaya_slha<NUHMSSMNoFVHimalaya<T> >(model));
}
 ...
 */
template <class Model>
void NUHMSSMNoFVHimalaya_slha_io::set_spectrum(const NUHMSSMNoFVHimalaya_slha<Model>& model)
{
   const NUHMSSMNoFVHimalaya_physical physical(model.get_physical_slha());
