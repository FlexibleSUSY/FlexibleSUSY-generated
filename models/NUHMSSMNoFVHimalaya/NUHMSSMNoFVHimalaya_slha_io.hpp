...
struct NUHMSSMNoFVHimalaya_physical;
class NUHMSSMNoFVHimalaya_slha;
...
class NUHMSSMNoFVHimalaya_decays;
...
public:
   ...
   void fill(NUHMSSMNoFVHimalaya_slha&) const;
   ...
   void set_extra(const NUHMSSMNoFVHimalaya_slha&, const NUHMSSMNoFVHimalaya_scales&, const NUHMSSMNoFVHimalaya_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const NUHMSSMNoFVHimalaya_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const NUHMSSMNoFVHimalaya_scales&, const NUHMSSMNoFVHimalaya_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, NUHMSSMNoFVHimalaya_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const NUHMSSMNoFVHimalaya_slha&);
 ...
 */
template <class... Ts>
void NUHMSSMNoFVHimalaya_slha_io::fill(
   ...
   NUHMSSMNoFVHimalaya_decays const * const decays)
{
