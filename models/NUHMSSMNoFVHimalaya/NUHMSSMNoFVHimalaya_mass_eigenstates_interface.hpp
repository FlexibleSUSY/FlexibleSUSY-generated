...
/**
 * @file NUHMSSMNoFVHimalaya_mass_eigenstates_interface.hpp
 *
...
#ifndef NUHMSSMNoFVHimalaya_MASS_EIGENSTATES_INTERFACE_H
#define NUHMSSMNoFVHimalaya_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class NUHMSSMNoFVHimalaya_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class NUHMSSMNoFVHimalaya_mass_eigenstates_interface {
public:
   virtual ~NUHMSSMNoFVHimalaya_mass_eigenstates_interface() {}

   virtual std::unique_ptr<NUHMSSMNoFVHimalaya_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const NUHMSSMNoFVHimalaya_input_parameters& get_input_parameters() const = 0;
   virtual NUHMSSMNoFVHimalaya_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const NUHMSSMNoFVHimalaya_physical& get_physical() const = 0;
   virtual NUHMSSMNoFVHimalaya_physical& get_physical() = 0;
   ...
   virtual void set_physical(const NUHMSSMNoFVHimalaya_physical&) = 0;
