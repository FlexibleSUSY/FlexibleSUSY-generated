...
/**
 * @file NUHMSSMNoFVHimalaya_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Fri 10 Apr 2020 17:35:08 with FlexibleSUSY
 * 2.4.2 (git commit: a94199e5620b8684f5d30d0eece5757a5a72c4a4) and SARAH 4.14.3 .
 */

#ifndef NUHMSSMNoFVHimalaya_EWSB_SOLVER_INTERFACE_H
#define NUHMSSMNoFVHimalaya_EWSB_SOLVER_INTERFACE_H
...
class NUHMSSMNoFVHimalaya_ewsb_solver_interface {
public:
   virtual ~NUHMSSMNoFVHimalaya_ewsb_solver_interface() {}
   ...
   virtual int solve(NUHMSSMNoFVHimalaya_mass_eigenstates&) = 0;
};
