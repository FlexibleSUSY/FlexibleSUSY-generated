...
#ifndef NUHMSSMNoFVHimalaya_WEINBERG_ANGLE_H
#define NUHMSSMNoFVHimalaya_WEINBERG_ANGLE_H
...
/**
 * @class NUHMSSMNoFVHimalaya_weinberg_angle
...
public:
   ...
   NUHMSSMNoFVHimalaya_weinberg_angle(const NUHMSSMNoFVHimalaya_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NUHMSSMNoFVHimalaya_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NUHMSSMNoFVHimalaya_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
