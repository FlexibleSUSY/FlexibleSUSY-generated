...
// File generated at Sun 26 Aug 2018 13:49:39
 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 13:49:39 with FlexibleSUSY
...
CLASSNAME::NUHMSSMNoFVHimalaya_mass_eigenstates(const NUHMSSMNoFVHimalaya_input_parameters& input_)
...
{
   if (!ewsb_solver) {
      throw SetupError("NUHMSSMNoFVHimalaya_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("NUHMSSMNoFVHimalaya_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("NUHMSSMNoFVHimalaya_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }
...
std::ostream& operator<<(std::ostream& ostr, const NUHMSSMNoFVHimalaya_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
