...
class NUHMSSMNoFVHimalaya_susy_parameters : public Beta_function {
public:
   explicit NUHMSSMNoFVHimalaya_susy_parameters(const NUHMSSMNoFVHimalaya_input_parameters& input_ = NUHMSSMNoFVHimalaya_input_parameters());
   NUHMSSMNoFVHimalaya_susy_parameters(double scale_, int loops_, int thresholds_, const NUHMSSMNoFVHimalaya_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_,
   const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_);
   NUHMSSMNoFVHimalaya_susy_parameters(const NUHMSSMNoFVHimalaya_susy_parameters&) = default;
   NUHMSSMNoFVHimalaya_susy_parameters(NUHMSSMNoFVHimalaya_susy_parameters&&) = default;
   virtual ~NUHMSSMNoFVHimalaya_susy_parameters() = default;
   NUHMSSMNoFVHimalaya_susy_parameters& operator=(const NUHMSSMNoFVHimalaya_susy_parameters&) = default;
   NUHMSSMNoFVHimalaya_susy_parameters& operator=(NUHMSSMNoFVHimalaya_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const NUHMSSMNoFVHimalaya_input_parameters& get_input() const;
   NUHMSSMNoFVHimalaya_input_parameters& get_input();
   void set_input_parameters(const NUHMSSMNoFVHimalaya_input_parameters&);

   NUHMSSMNoFVHimalaya_susy_parameters calc_beta() const;
   NUHMSSMNoFVHimalaya_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const NUHMSSMNoFVHimalaya_susy_parameters&);
