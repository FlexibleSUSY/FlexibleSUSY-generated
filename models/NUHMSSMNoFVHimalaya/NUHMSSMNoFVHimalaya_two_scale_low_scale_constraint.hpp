...
#ifndef NUHMSSMNoFVHimalaya_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define NUHMSSMNoFVHimalaya_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "NUHMSSMNoFVHimalaya_low_scale_constraint.hpp"
...
template<>
class NUHMSSMNoFVHimalaya_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   NUHMSSMNoFVHimalaya_low_scale_constraint() = default;
   NUHMSSMNoFVHimalaya_low_scale_constraint(NUHMSSMNoFVHimalaya<Two_scale>*, const softsusy::QedQcd&);
   virtual ~NUHMSSMNoFVHimalaya_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "NUHMSSMNoFVHimalaya low-scale constraint"; }
