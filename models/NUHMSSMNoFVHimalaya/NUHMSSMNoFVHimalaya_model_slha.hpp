...
class NUHMSSMNoFVHimalaya_slha : public NUHMSSMNoFVHimalaya_mass_eigenstates {
public:
   explicit NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_input_parameters& input_ = NUHMSSMNoFVHimalaya_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_mass_eigenstates&, bool do_convert_masses_to_slha = true);
