...
/**
 * @file NUHMSSMNoFVHimalaya_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Fri 10 Apr 2020 17:35:03

#ifndef NUHMSSMNoFVHimalaya_SLHA_H
#define NUHMSSMNoFVHimalaya_SLHA_H
...
/**
 * @class NUHMSSMNoFVHimalaya_slha<T>
...
class NUHMSSMNoFVHimalaya_slha : public Model {
public:
   explicit NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_input_parameters& input_ = NUHMSSMNoFVHimalaya_input_parameters());
   explicit NUHMSSMNoFVHimalaya_slha(const Model&, bool do_convert_masses_to_slha = true);
   NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_slha&) = default;
   NUHMSSMNoFVHimalaya_slha(NUHMSSMNoFVHimalaya_slha&&) = default;
   virtual ~NUHMSSMNoFVHimalaya_slha() = default;
   NUHMSSMNoFVHimalaya_slha& operator=(const NUHMSSMNoFVHimalaya_slha&) = default;
   NUHMSSMNoFVHimalaya_slha& operator=(NUHMSSMNoFVHimalaya_slha&&) = default;
   ...
   const NUHMSSMNoFVHimalaya_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   NUHMSSMNoFVHimalaya_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   NUHMSSMNoFVHimalaya_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
NUHMSSMNoFVHimalaya_slha<Model>::NUHMSSMNoFVHimalaya_slha(const NUHMSSMNoFVHimalaya_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
NUHMSSMNoFVHimalaya_slha<Model>::NUHMSSMNoFVHimalaya_slha(const Model& model_,
...
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::convert_to_slha()
{
...
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::calculate_ckm_matrix()
{

}

template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const NUHMSSMNoFVHimalaya_physical& NUHMSSMNoFVHimalaya_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
NUHMSSMNoFVHimalaya_physical& NUHMSSMNoFVHimalaya_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void NUHMSSMNoFVHimalaya_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const NUHMSSMNoFVHimalaya_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
