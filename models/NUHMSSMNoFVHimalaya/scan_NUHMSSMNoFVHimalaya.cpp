...
{
   std::cout <<
      "Usage: scan_NUHMSSMNoFVHimalaya.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --Qin=<value>\n"
      "  --M1=<value>\n"
...
struct NUHMSSMNoFVHimalaya_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
NUHMSSMNoFVHimalaya_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   NUHMSSMNoFVHimalaya_input_parameters& input)
{
   ...
   NUHMSSMNoFVHimalaya_scan_result result;
...
void scan(int solver_type, NUHMSSMNoFVHimalaya_input_parameters& input,
