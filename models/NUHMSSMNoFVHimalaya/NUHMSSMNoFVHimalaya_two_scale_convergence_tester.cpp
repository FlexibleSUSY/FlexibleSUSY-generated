...
NUHMSSMNoFVHimalaya_convergence_tester<Two_scale>::NUHMSSMNoFVHimalaya_convergence_tester(
   NUHMSSMNoFVHimalaya<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<NUHMSSMNoFVHimalaya<Two_scale> >(model, accuracy_goal, sg)
{
}

double NUHMSSMNoFVHimalaya_convergence_tester<Two_scale>::max_rel_diff() const
{
   const NUHMSSMNoFVHimalaya<Two_scale>& ol = get_last_iteration_model();
   const NUHMSSMNoFVHimalaya<Two_scale>& ne = get_current_iteration_model();
