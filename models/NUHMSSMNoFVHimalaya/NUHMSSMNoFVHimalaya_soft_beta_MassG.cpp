 ...
 */
double NUHMSSMNoFVHimalaya_soft_parameters::calc_beta_MassG_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUHMSSMNoFVHimalaya_soft_parameters::calc_beta_MassG_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUHMSSMNoFVHimalaya_soft_parameters::calc_beta_MassG_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NUHMSSMNoFVHimalaya_soft_parameters::calc_beta_MassG_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double NUHMSSMNoFVHimalaya_soft_parameters::calc_beta_MassG_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
