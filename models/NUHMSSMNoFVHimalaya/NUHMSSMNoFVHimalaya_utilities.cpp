...
#include "NUHMSSMNoFVHimalaya_utilities.hpp"
...
// NUHMSSMNoFVHimalaya_parameter_getter ////////////////////////////////////////

std::vector<std::string> NUHMSSMNoFVHimalaya_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace NUHMSSMNoFVHimalaya_info;
...
std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS> NUHMSSMNoFVHimalaya_parameter_getter::get_mixing_names()
{
   return NUHMSSMNoFVHimalaya_info::particle_mixing_names;
}

Eigen::ArrayXd NUHMSSMNoFVHimalaya_parameter_getter::get_parameters(const NUHMSSMNoFVHimalaya_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_PARAMETERS> NUHMSSMNoFVHimalaya_parameter_getter::get_parameter_names()
{
   return NUHMSSMNoFVHimalaya_info::parameter_names;
}

std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_PARTICLES> NUHMSSMNoFVHimalaya_parameter_getter::get_particle_names()
{
   return NUHMSSMNoFVHimalaya_info::particle_names;
}

std::vector<std::string> NUHMSSMNoFVHimalaya_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> NUHMSSMNoFVHimalaya_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS> NUHMSSMNoFVHimalaya_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS> NUHMSSMNoFVHimalaya_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_INPUT_PARAMETERS> NUHMSSMNoFVHimalaya_parameter_getter::get_input_parameter_names()
{
   return NUHMSSMNoFVHimalaya_info::input_parameter_names;
}

std::array<std::string, NUHMSSMNoFVHimalaya_info::NUMBER_OF_EXTRA_PARAMETERS> NUHMSSMNoFVHimalaya_parameter_getter::get_extra_parameter_names()
{
   return NUHMSSMNoFVHimalaya_info::extra_parameter_names;
}

decltype(NUHMSSMNoFVHimalaya_info::NUMBER_OF_MASSES) NUHMSSMNoFVHimalaya_parameter_getter::get_number_of_masses()
{
   return NUHMSSMNoFVHimalaya_info::NUMBER_OF_MASSES;
}

// NUHMSSMNoFVHimalaya_spectrum_plotter ////////////////////////////////////////

NUHMSSMNoFVHimalaya_spectrum_plotter::NUHMSSMNoFVHimalaya_spectrum_plotter(const NUHMSSMNoFVHimalaya_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void NUHMSSMNoFVHimalaya_spectrum_plotter::extract_spectrum(const NUHMSSMNoFVHimalaya_mass_eigenstates& model)
{
   spectrum.clear();
...
void NUHMSSMNoFVHimalaya_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("NUHMSSMNoFVHimalaya_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("NUHMSSMNoFVHimalaya_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("NUHMSSMNoFVHimalaya_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void NUHMSSMNoFVHimalaya_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("NUHMSSMNoFVHimalaya_spectrum_plotter::write_spectrum: "
...
namespace NUHMSSMNoFVHimalaya_database {
 ...
 */
void to_database(
   const std::string& file_name, const NUHMSSMNoFVHimalaya_mass_eigenstates& model,
   ...
   const NUHMSSMNoFVHimalaya_observables* observables)
{
   ...
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_DRbar_mass_names());
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_pole_mass_names());
   append(names, NUHMSSMNoFVHimalaya_parameter_getter::get_pole_mixing_names());
   ...
   if (NUHMSSMNoFVHimalaya_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, NUHMSSMNoFVHimalaya_observables::get_names());
 ...
 */
NUHMSSMNoFVHimalaya_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, NUHMSSMNoFVHimalaya_observables* observables)
{
   NUHMSSMNoFVHimalaya_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = NUHMSSMNoFVHimalaya_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = NUHMSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = NUHMSSMNoFVHimalaya_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = NUHMSSMNoFVHimalaya_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? NUHMSSMNoFVHimalaya_observables::NUMBER_OF_OBSERVABLES : 0);
