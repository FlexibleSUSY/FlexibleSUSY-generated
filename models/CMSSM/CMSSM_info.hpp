...
namespace CMSSM_info {
   ...
   class CMSSM_particle_names : public Names {
   public:
      virtual ~CMSSM_particle_names() = default;
   ...
   class CMSSM_parameter_names : public Names {
   public:
      virtual ~CMSSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const CMSSM_particle_names  particle_names_getter{};
   const CMSSM_parameter_names parameter_names_getter{};
