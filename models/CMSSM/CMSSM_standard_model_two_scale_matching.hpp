...
#ifndef CMSSM_TWO_SCALE_MATCHING_H
#define CMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class CMSSM;
template <class T> class CMSSM_standard_model_Matching;
...
template<>
class CMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   CMSSM_standard_model_Matching();

   CMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       CMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~CMSSM_standard_model_Matching();
