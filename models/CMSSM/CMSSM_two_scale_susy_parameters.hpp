...
#ifndef CMSSM_TWO_SCALE_susy_parameters_H
#define CMSSM_TWO_SCALE_susy_parameters_H
...
public:
   ...
   CMSSM_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const CMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   virtual ~CMSSM_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const CMSSM_input_parameters& get_input() const;
   CMSSM_input_parameters& get_input();
   void set_input_parameters(const CMSSM_input_parameters&);

   CMSSM_susy_parameters calc_beta() const;
   CMSSM_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const CMSSM_susy_parameters&);
