...
// File generated at Tue 12 Jul 2016 12:49:26
...
CMSSM_spectrum_plotter::CMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> CMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const CMSSM_observables* observables)
{
   ...
   append(names, CMSSM_parameter_getter().get_mass_names());
   append(names, CMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, CMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = CMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = CMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = CMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? CMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
