...
int run_solver(flexiblesusy::CMSSM_slha_io& slha_io,
               ...
               const std::string& rgflow_file)
{
   ...
   CMSSM_decays decays(std::get<0>(models), qedqcd, physical_input, flexibledecay_settings);
