...
public:
   ...
   void set_extra(const CMSSM_slha&, const CMSSM_scales&, const CMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSM_scales&, const CMSSM_observables&);
