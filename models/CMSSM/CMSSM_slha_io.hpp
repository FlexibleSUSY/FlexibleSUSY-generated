...
#include "decays/CMSSM_decays.hpp"
...
public:
   ...
   void set_decays(const CMSSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const CMSSM_slha&, const CMSSM_scales&, const CMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const CMSSM_slha&);
   ...
   void fill_decays_data(const CMSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const CMSSM_scales&, const CMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, CMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const CMSSM_slha&);
...
void CMSSM_slha_io::fill(
   ...
   CMSSM_decays const * const decays)
{
