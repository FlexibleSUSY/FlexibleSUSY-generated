...
// File generated at Sat 27 Aug 2016 13:51:10
 ...
 */
double CMSSM_soft_parameters::calc_beta_BMu_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CMSSM_soft_parameters::calc_beta_BMu_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double CMSSM_soft_parameters::calc_beta_BMu_three_loop(const Soft_traces& soft_traces) const
{
