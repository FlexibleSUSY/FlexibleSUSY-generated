...
// File generated at Sat 27 Aug 2016 13:52:20
...
public:
   ...
   explicit CMSSM_slha(const CMSSM<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~CMSSM_slha();
...
std::ostream& operator<<(std::ostream& ostr, const CMSSM_slha<Two_scale>& model);
