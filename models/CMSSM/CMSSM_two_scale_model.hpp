 ...
 */
template<>
class CMSSM<Two_scale> : public Model, public CMSSM_slha {
public:
   explicit CMSSM(const CMSSM_input_parameters& input_ = CMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit CMSSM(const CMSSM_slha&, bool do_convert_masses_to_slha = true);
