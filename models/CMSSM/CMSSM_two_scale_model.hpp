 ...
 */
template<>
class CMSSM<Two_scale> : public Two_scale_model, public CMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(CMSSM<Two_scale>::*Memfun_t)();
      CMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(CMSSM<Two_scale>* model_, Memfun_t fun_)
