...
// File generated at Tue 22 Jan 2019 17:59:23
...
const int CMSSM_soft_parameters::numberOfParameters;
...
CMSSM_soft_parameters CMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   const CMSSM_susy_parameters susy_betas(CMSSM_susy_parameters::calc_beta(loops));
...
CMSSM_soft_parameters::Soft_traces CMSSM_soft_parameters::calc_soft_traces(int loops) const
{
