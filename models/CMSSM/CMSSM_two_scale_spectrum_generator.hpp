...
class CMSSM_spectrum_generator<Two_scale>
   : public CMSSM_spectrum_generator_interface<Two_scale> {
public:
   CMSSM_spectrum_generator() = default;
   virtual ~CMSSM_spectrum_generator() = default;
...
protected:
   virtual void run_except(const softsusy::QedQcd&, const CMSSM_input_parameters&) override;
