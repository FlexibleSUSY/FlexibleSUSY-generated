...
int main(int argc, char* argv[])
{
   ...
   const CMSSM_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(CMSSM_slha_io::fill_slhaea(model, qedqcd, scales, observables));
