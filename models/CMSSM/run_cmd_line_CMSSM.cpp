...
// File generated at Sun 26 Aug 2018 15:30:05
...
int run_solver(const CMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(CMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const CMSSM_input_parameters& input)
{
   int exit_code = 0;
