...
CMSSM_slha::CMSSM_slha(const CMSSM_input_parameters& input_,
 ...
 */
CMSSM_slha::CMSSM_slha(const CMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : CMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void CMSSM_slha::clear()
{
   CMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void CMSSM_slha::calculate_spectrum()
{
   CMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void CMSSM_slha::convert_to_slha()
{
...
void CMSSM_slha::calculate_ckm_matrix()
{
...
void CMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void CMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void CMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void CMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const CMSSM_physical& CMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

CMSSM_physical& CMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void CMSSM_slha::print(std::ostream& ostr) const
{
   CMSSM_mass_eigenstates::print(ostr);
...
void CMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const CMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
