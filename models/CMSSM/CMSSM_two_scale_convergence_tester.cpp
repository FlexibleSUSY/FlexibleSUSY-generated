...
// File generated at Sun 31 May 2015 12:56:38
...
CMSSM_convergence_tester<Two_scale>::CMSSM_convergence_tester(CMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<CMSSM<Two_scale> >(model, accuracy_goal)
{
}

CMSSM_convergence_tester<Two_scale>::~CMSSM_convergence_tester()
{
}

double CMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const CMSSM<Two_scale>& ol = get_last_iteration_model();
   const CMSSM<Two_scale>& ne = get_model();
