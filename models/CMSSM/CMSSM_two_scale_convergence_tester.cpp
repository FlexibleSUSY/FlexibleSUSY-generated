...
// File generated at Tue 10 Oct 2017 23:21:51
...
CMSSM_convergence_tester<Two_scale>::CMSSM_convergence_tester(
   CMSSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<CMSSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double CMSSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const CMSSM<Two_scale>& ne = get_current_iteration_model();
