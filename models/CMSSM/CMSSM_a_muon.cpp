...
// File generated at Tue 22 Jan 2019 18:00:41

/**
 * @file CMSSM_a_muon.cpp
 *
 * This file was generated at Tue 22 Jan 2019 18:00:41 with FlexibleSUSY
...
double calculate_a_muon_impl(CMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const CMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("CMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double CMSSM_a_muon::calculate_a_muon(const CMSSM_mass_eigenstates& model_)
{
...
double CMSSM_a_muon::calculate_a_muon_uncertainty(const CMSSM_mass_eigenstates& model_)
{
   CMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("CMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
