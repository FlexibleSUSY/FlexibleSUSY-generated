...
// File generated at Wed 29 Jun 2016 13:32:49
...
class CMSSM_effective_couplings {
public:
   CMSSM_effective_couplings(const CMSSM_mass_eigenstates&,
                                   const softsusy::QedQcd&,
                                   const Physical_input&);
   ~CMSSM_effective_couplings();
   ...
   void set_model(const CMSSM_mass_eigenstates& model_);
