...
/**
 * @file CMSSM_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the CMSSM model class in the decoupling scheme
 *
...
#define CLASSNAME CMSSM_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const CMSSM_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<CMSSM_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const CMSSM_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const CMSSM_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
