...
/**
 * @file CMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef CMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define CMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class CMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class CMSSM_mass_eigenstates_decoupling_scheme
   : private CMSSM_soft_parameters
   , public CMSSM_mass_eigenstates_interface
{
public:
   explicit CMSSM_mass_eigenstates_decoupling_scheme(const CMSSM_input_parameters& input_ = CMSSM_input_parameters());
   explicit CMSSM_mass_eigenstates_decoupling_scheme(const CMSSM_mass_eigenstates&);
   CMSSM_mass_eigenstates_decoupling_scheme(const CMSSM_mass_eigenstates_decoupling_scheme&) = default;
   CMSSM_mass_eigenstates_decoupling_scheme(CMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~CMSSM_mass_eigenstates_decoupling_scheme() = default;
   CMSSM_mass_eigenstates_decoupling_scheme& operator=(const CMSSM_mass_eigenstates_decoupling_scheme&) = default;
   CMSSM_mass_eigenstates_decoupling_scheme& operator=(CMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const CMSSM_mass_eigenstates&);
...
private:
   ...
   Problems problems{CMSSM_info::model_name,
...
std::ostream& operator<<(std::ostream&, const CMSSM_mass_eigenstates_decoupling_scheme&);
