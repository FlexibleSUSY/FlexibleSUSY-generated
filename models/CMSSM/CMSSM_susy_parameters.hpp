...
public:
   ...
   CMSSM_susy_parameters& operator=(const CMSSM_susy_parameters&) = default;
   CMSSM_susy_parameters& operator=(CMSSM_susy_parameters&&) = default;
   ...
   CMSSM_susy_parameters calc_beta(int) const;
   virtual void clear();
