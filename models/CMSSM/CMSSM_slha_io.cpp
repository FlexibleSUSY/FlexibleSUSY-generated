 ...
 */
void CMSSM_slha_io::set_spinfo(const Problems<CMSSM_info::NUMBER_OF_PARTICLES>& problems)
{
...
void CMSSM_slha_io::fill(CMSSM_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&CMSSM_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&CMSSM_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void CMSSM_slha_io::convert_to_slha_convention(CMSSM_physical& physical)
{
