...
// File generated at Sat 27 Aug 2016 13:51:23
 ...
 */
Eigen::Matrix<double,3,3> CMSSM_soft_parameters::calc_beta_mq2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CMSSM_soft_parameters::calc_beta_mq2_two_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CMSSM_soft_parameters::calc_beta_mq2_three_loop(const Soft_traces& soft_traces) const
{
