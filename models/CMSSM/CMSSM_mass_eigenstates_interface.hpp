...
/**
 * @file CMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef CMSSM_MASS_EIGENSTATES_INTERFACE_H
#define CMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class CMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class CMSSM_mass_eigenstates_interface {
public:
   virtual ~CMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<CMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const CMSSM_input_parameters& get_input_parameters() const = 0;
   virtual CMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const CMSSM_physical& get_physical() const = 0;
   virtual CMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const CMSSM_physical&) = 0;
