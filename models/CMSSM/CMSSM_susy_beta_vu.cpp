...
// File generated at Fri 10 Apr 2020 20:47:12
 ...
 */
double CMSSM_susy_parameters::calc_beta_vu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CMSSM_susy_parameters::calc_beta_vu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double CMSSM_susy_parameters::calc_beta_vu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CMSSM_susy_parameters::calc_beta_vu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double CMSSM_susy_parameters::calc_beta_vu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
