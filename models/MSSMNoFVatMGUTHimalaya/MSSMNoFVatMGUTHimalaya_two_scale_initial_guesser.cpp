...
// File generated at Fri 10 Apr 2020 17:38:45
...
MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::MSSMNoFVatMGUTHimalaya_initial_guesser(
   MSSMNoFVatMGUTHimalaya<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MSSMNoFVatMGUTHimalaya_low_scale_constraint<Two_scale>& low_constraint_,
   const MSSMNoFVatMGUTHimalaya_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSMNoFVatMGUTHimalaya_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("MSSMNoFVatMGUTHimalaya_initial_guesser: Error: pointer to model"
                       " MSSMNoFVatMGUTHimalaya<Two_scale> must not be zero");
}
 ...
 */
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>::guess_soft_parameters()
{
