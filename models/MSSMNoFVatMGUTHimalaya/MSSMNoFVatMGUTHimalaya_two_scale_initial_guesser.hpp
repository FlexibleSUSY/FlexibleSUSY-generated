...
#include "MSSMNoFVatMGUTHimalaya_initial_guesser.hpp"
...
/**
 * @class MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale>
 * @brief initial guesser for the MSSMNoFVatMGUTHimalaya
 */

template<>
class MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale> : public Initial_guesser {
public:
   MSSMNoFVatMGUTHimalaya_initial_guesser(MSSMNoFVatMGUTHimalaya<Two_scale>*,
                               const softsusy::QedQcd&,
                               const MSSMNoFVatMGUTHimalaya_low_scale_constraint<Two_scale>&,
                               const MSSMNoFVatMGUTHimalaya_susy_scale_constraint<Two_scale>&,
                               const MSSMNoFVatMGUTHimalaya_high_scale_constraint<Two_scale>&);
   virtual ~MSSMNoFVatMGUTHimalaya_initial_guesser() = default;
...
private:
   MSSMNoFVatMGUTHimalaya<Two_scale>* model{nullptr}; ///< pointer to model class
