...
// File generated at Sun 26 Aug 2018 13:50:13

#include "MSSMNoFVatMGUTHimalaya_effective_couplings.hpp"
...
MSSMNoFVatMGUTHimalaya_effective_couplings::MSSMNoFVatMGUTHimalaya_effective_couplings(
   const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_,
...
void MSSMNoFVatMGUTHimalaya_effective_couplings::calculate_effective_couplings()
{
...
void MSSMNoFVatMGUTHimalaya_effective_couplings::set_model(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void MSSMNoFVatMGUTHimalaya_effective_couplings::copy_mixing_matrices_from_model()
{
...
standard_model::Standard_model MSSMNoFVatMGUTHimalaya_effective_couplings::initialise_SM() const
{
...
void MSSMNoFVatMGUTHimalaya_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double MSSMNoFVatMGUTHimalaya_effective_couplings::number_of_active_flavours(double m) const
{
...
double MSSMNoFVatMGUTHimalaya_effective_couplings::scalar_scaling_factor(double m) const
{
...
double MSSMNoFVatMGUTHimalaya_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double MSSMNoFVatMGUTHimalaya_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double MSSMNoFVatMGUTHimalaya_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double MSSMNoFVatMGUTHimalaya_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double MSSMNoFVatMGUTHimalaya_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFdFdhhPL(int gI1) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFdFdAhPL(int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFsFshhPL(int gI1) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFsFsAhPL(int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFbFbhhPL(int gI1) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFbFbAhPL(int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFuFuhhPL(int gI1) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFuFuAhPL(int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFcFchhPL(int gI1) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFcFcAhPL(int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFtFthhPL(int gI1) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFtFtAhPL(int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFeFehhPL(int gI1) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFeFeAhPL(int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFmFmhhPL(int gI1) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFmFmAhPL(int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFtauFtauhhPL(int gI1) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarFtauFtauAhPL(int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhSeconjSe(int gt1, int gt2, int gt3) const
{
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhSmconjSm(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhStauconjStau(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhSsconjSs(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhScconjSc(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
   ...
   const std::complex<double> result = 0.05*(2*Conj(ZC(gt2,1))*(-
      ...
      (-(vd*ZH(gt1,0)) + vu*ZH(gt1,1)) + 5*Conj(Yu(1,1))*(1.4142135623730951*Mu*ZC
      (gt3,0)*ZH(gt1,0) - 2*vu*Yu(1,1)*ZC(gt3,1)*ZH(gt1,1))) + Conj(ZC(gt2,0))*(ZC
      (gt3,0)*(vd*(Sqr(g1) - 5*Sqr(g2))*ZH(gt1,0) - vu*(20*AbsSqr(Yu(1,1)) + Sqr(
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhSbconjSb(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhStconjSt(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZP(gt2,0)*(vd*(0.6*Sqr(
      g1) + Sqr(g2))*ZP(gt3,0) + vu*Sqr(g2)*ZP(gt3,1)) + ZP(gt2,1)*(vu*Sqr(g2)*ZP(
      gt3,0) + vd*(-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)))) + ZH(gt1,1)*(ZP(gt2,0)*(vu
      *(0.6*Sqr(g1) - Sqr(g2))*ZP(gt3,0) - vd*Sqr(g2)*ZP(gt3,1)) - ZP(gt2,1)*(vd*
      Sqr(g2)*ZP(gt3,0) + vu*(0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1))));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarChaChahhPL(int gt3, int gt1, int gt2) const
{
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhSdconjSd(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto Yd = MODELPARAMETER(Yd);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(ZD(gt2,1))*(Conj(TYd(0,0))*ZA(gt1,0) + Conj(Yd(0,0))*Mu*ZA(gt1,1))*ZD
      (gt3,0) - Conj(ZD(gt2,0))*ZD(gt3,1)*(Conj(Mu)*Yd(0,0)*ZA(gt1,1) + ZA(gt1,0)*
      TYd(0,0)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhSuconjSu(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto Yu = MODELPARAMETER(Yu);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(Yu(0,0))*Conj(ZU(gt2,1))*Mu*ZA(gt1,0)*ZU(gt3,0) + Conj(ZU(gt2,1))*
      Conj(TYu(0,0))*ZA(gt1,1)*ZU(gt3,0) - Conj(ZU(gt2,0))*ZU(gt3,1)*(Conj(Mu)*Yu(
      0,0)*ZA(gt1,0) + ZA(gt1,1)*TYu(0,0)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhSeconjSe(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto Ye = MODELPARAMETER(Ye);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(ZE(gt2,1))*(Conj(TYe(0,0))*ZA(gt1,0) + Conj(Ye(0,0))*Mu*ZA(gt1,1))*ZE
      (gt3,0) - Conj(ZE(gt2,0))*ZE(gt3,1)*(Conj(Mu)*Ye(0,0)*ZA(gt1,1) + ZA(gt1,0)*
      TYe(0,0)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhSmconjSm(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto Ye = MODELPARAMETER(Ye);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(ZM(gt2,1))*(Conj(TYe(1,1))*ZA(gt1,0) + Conj(Ye(1,1))*Mu*ZA(gt1,1))*ZM
      (gt3,0) - Conj(ZM(gt2,0))*ZM(gt3,1)*(Conj(Mu)*Ye(1,1)*ZA(gt1,1) + ZA(gt1,0)*
      TYe(1,1)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhStauconjStau(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto Ye = MODELPARAMETER(Ye);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(ZTau(gt2,1))*(Conj(TYe(2,2))*ZA(gt1,0) + Conj(Ye(2,2))*Mu*ZA(gt1,1))*
      ZTau(gt3,0) - Conj(ZTau(gt2,0))*ZTau(gt3,1)*(Conj(Mu)*Ye(2,2)*ZA(gt1,1) + ZA
      (gt1,0)*TYe(2,2)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhSsconjSs(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto Yd = MODELPARAMETER(Yd);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(ZS(gt2,1))*(Conj(TYd(1,1))*ZA(gt1,0) + Conj(Yd(1,1))*Mu*ZA(gt1,1))*ZS
      (gt3,0) - Conj(ZS(gt2,0))*ZS(gt3,1)*(Conj(Mu)*Yd(1,1)*ZA(gt1,1) + ZA(gt1,0)*
      TYd(1,1)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhScconjSc(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto Yu = MODELPARAMETER(Yu);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(Yu(1,1))*Conj(ZC(gt2,1))*Mu*ZA(gt1,0)*ZC(gt3,0) + Conj(ZC(gt2,1))*
      Conj(TYu(1,1))*ZA(gt1,1)*ZC(gt3,0) - Conj(ZC(gt2,0))*ZC(gt3,1)*(Conj(Mu)*Yu(
      1,1)*ZA(gt1,0) + ZA(gt1,1)*TYu(1,1)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhSbconjSb(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto Yd = MODELPARAMETER(Yd);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(ZB(gt2,1))*(Conj(TYd(2,2))*ZA(gt1,0) + Conj(Yd(2,2))*Mu*ZA(gt1,1))*ZB
      (gt3,0) - Conj(ZB(gt2,0))*ZB(gt3,1)*(Conj(Mu)*Yd(2,2)*ZA(gt1,1) + ZA(gt1,0)*
      TYd(2,2)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhStconjSt(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto Yu = MODELPARAMETER(Yu);
   const auto Mu = MODELPARAMETER(Mu);
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *(Conj(Yu(2,2))*Conj(ZT(gt2,1))*Mu*ZA(gt1,0)*ZT(gt3,0) + Conj(ZT(gt2,1))*
      Conj(TYu(2,2))*ZA(gt1,1)*ZT(gt3,0) - Conj(ZT(gt2,0))*ZT(gt3,1)*(Conj(Mu)*Yu(
      2,2)*ZA(gt1,0) + ZA(gt1,1)*TYu(2,2)));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpAhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*Sqr(g2)*(vu*
      ZA(gt1,0) + vd*ZA(gt1,1))*(ZP(gt2,1)*ZP(gt3,0) - ZP(gt2,0)*ZP(gt3,1));

   return result;
}

std::complex<double> MSSMNoFVatMGUTHimalaya_effective_couplings::CpbarChaChaAhPL(int gt3, int gt2, int gt1) const
{
   const auto g2 = MODELPARAMETER(g2);

   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *g2*(Conj(UM(gt2,1))*Conj(UP(gt3,0))*ZA(gt1,0) + Conj(UM(gt2,0))*Conj(UP(gt3
      ,1))*ZA(gt1,1));

   return result;
}

void MSSMNoFVatMGUTHimalaya_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   ...
   result += CpbarFtauFtauhhPL(gO1) * vev * AS12(decay_scale / Sqr(MFtau)) / MFtau
      ;
   ...
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.5 * CphhSmconjSm(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(
         MSm(gI1))) / Sqr(MSm(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.5 * CphhStauconjStau(gO1, gI1, gI1) * vev * AS0(decay_scale /
         Sqr(MStau(gI1))) / Sqr(MStau(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.16666666666666666 * scalar_scalar_qcd_factor(decay_mass, MSs(gI1
         )) * CphhSsconjSs(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(MSs(gI1)))
         / Sqr(MSs(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.6666666666666666 * scalar_scalar_qcd_factor(decay_mass, MSc(gI1)
         ) * CphhScconjSc(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(MSc(gI1)))
         / Sqr(MSc(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.16666666666666666 * scalar_scalar_qcd_factor(decay_mass, MSb(gI1
         )) * CphhSbconjSb(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(MSb(gI1)))
         / Sqr(MSb(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.6666666666666666 * scalar_scalar_qcd_factor(decay_mass, MSt(gI1)
         ) * CphhStconjSt(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(MSt(gI1)))
         / Sqr(MSt(gI1));
   }
...
void MSSMNoFVatMGUTHimalaya_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
   ...
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.5 * CphhSsconjSs(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(
         MSs(gI1))) / Sqr(MSs(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.5 * CphhScconjSc(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(
         MSc(gI1))) / Sqr(MSc(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.5 * CphhSbconjSb(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(
         MSb(gI1))) / Sqr(MSb(gI1));
   }
   for (int gI1 = 0; gI1 < 2; ++gI1) {
      result += 0.5 * CphhStconjSt(gO1, gI1, gI1) * vev * AS0(decay_scale / Sqr(
         MSt(gI1))) / Sqr(MSt(gI1));
   }
   result *= 0.75;
...
void MSSMNoFVatMGUTHimalaya_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto MFd = MODELPARAMETER(MFd);
   ...
   std::complex<double> result = 0;
   result += 0.3333333333333333 * pseudoscalar_fermion_qcd_factor(decay_mass, MFd)
      * CpbarFdFdAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFd)) / MFd;
   result += 0.3333333333333333 * pseudoscalar_fermion_qcd_factor(decay_mass, MFs)
      * CpbarFsFsAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFs)) / MFs;
   result += 0.3333333333333333 * pseudoscalar_fermion_qcd_factor(decay_mass, MFb)
      * CpbarFbFbAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFb)) / MFb;
   result += 1.3333333333333333 * pseudoscalar_fermion_qcd_factor(decay_mass, MFu)
      * CpbarFuFuAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFu)) / MFu;
   result += 1.3333333333333333 * pseudoscalar_fermion_qcd_factor(decay_mass, MFc)
      * CpbarFcFcAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFc)) / MFc;
   result += 1.3333333333333333 * pseudoscalar_fermion_qcd_factor(decay_mass, MFt)
      * CpbarFtFtAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFt)) / MFt;
   result += CpbarFeFeAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFe)) / MFe;
   result += CpbarFmFmAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFm)) / MFm;
   result += CpbarFtauFtauAhPL(gO1) * vev * AP12(decay_scale / Sqr(MFtau)) / MFtau
      ;
   for (int gI1 = 0; gI1 < 2; ++gI1) {
...
void MSSMNoFVatMGUTHimalaya_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
