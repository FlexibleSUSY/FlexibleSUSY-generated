...
// File generated at Wed 16 Oct 2019 19:02:42

#ifndef MSSMNoFVatMGUTHimalaya_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMNoFVatMGUTHimalaya_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMNoFVatMGUTHimalaya_low_scale_constraint.hpp"
...
template<>
class MSSMNoFVatMGUTHimalaya_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMNoFVatMGUTHimalaya_low_scale_constraint() = default;
   MSSMNoFVatMGUTHimalaya_low_scale_constraint(MSSMNoFVatMGUTHimalaya<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMNoFVatMGUTHimalaya_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMNoFVatMGUTHimalaya low-scale constraint"; }
