...
// File generated at Tue 22 Jan 2019 13:27:12
...
#include "MSSMNoFVatMGUTHimalaya_two_scale_initial_guesser.hpp"
#include "MSSMNoFVatMGUTHimalaya_two_scale_low_scale_constraint.hpp"
#include "MSSMNoFVatMGUTHimalaya_two_scale_susy_scale_constraint.hpp"
...
double MSSMNoFVatMGUTHimalaya_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
   ...
   MSSMNoFVatMGUTHimalaya_ewsb_solver<Two_scale> ewsb_solver;
   model.set_ewsb_solver(
      std::make_shared<MSSMNoFVatMGUTHimalaya_ewsb_solver<Two_scale> >(ewsb_solver));

   MSSMNoFVatMGUTHimalaya_high_scale_constraint<Two_scale> high_scale_constraint(&model);
   MSSMNoFVatMGUTHimalaya_susy_scale_constraint<Two_scale> susy_scale_constraint(&model, qedqcd);
   MSSMNoFVatMGUTHimalaya_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);

   high_scale_constraint.initialize();
   susy_scale_constraint.initialize();
   low_scale_constraint .initialize();

   MSSMNoFVatMGUTHimalaya_convergence_tester<Two_scale> convergence_tester(
   ...
   MSSMNoFVatMGUTHimalaya_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void MSSMNoFVatMGUTHimalaya_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   MSSMNoFVatMGUTHimalaya_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_high_scale());
}

void MSSMNoFVatMGUTHimalaya_spectrum_generator<Two_scale>::calculate_spectrum()
{
