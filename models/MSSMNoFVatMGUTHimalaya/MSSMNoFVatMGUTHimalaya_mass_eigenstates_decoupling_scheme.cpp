...
/**
 * @file MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the MSSMNoFVatMGUTHimalaya model class in the decoupling scheme
 *
...
#include "MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme.hpp"
...
#define CLASSNAME MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
