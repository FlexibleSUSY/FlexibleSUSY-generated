...
// File generated at Fri 10 Apr 2020 17:38:54

/**
 * @file MSSMNoFVatMGUTHimalaya_a_muon.cpp
 *
 * This file was generated at Fri 10 Apr 2020 17:38:54 with FlexibleSUSY
...
double calculate_a_muon_impl(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   const auto form_factors = MSSMNoFVatMGUTHimalaya_FFV_form_factors::calculate_Fm_Fm_VP_form_factors(model, true);
...
std::pair<double,double> vary_scale(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model,&qedqcd] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMNoFVatMGUTHimalaya_a_muon: scale variation: " << e.what_detailed());
                     }
                     return amu;
                  });
...
double MSSMNoFVatMGUTHimalaya_a_muon::calculate_a_muon(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   ...
   try {
      ...
      ERROR("MSSMNoFVatMGUTHimalaya_a_muon:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
double MSSMNoFVatMGUTHimalaya_a_muon::calculate_a_muon_uncertainty(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMNoFVatMGUTHimalaya_a_muon uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
