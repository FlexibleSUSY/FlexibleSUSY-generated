...
Eigen::ArrayXd MSSMNoFVatMGUTHimalaya_input_parameters::get() const
{
...
void MSSMNoFVatMGUTHimalaya_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   SignMu = pars(1);
   M1 = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
