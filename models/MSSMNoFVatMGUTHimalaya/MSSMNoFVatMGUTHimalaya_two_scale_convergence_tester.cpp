...
MSSMNoFVatMGUTHimalaya_convergence_tester<Two_scale>::MSSMNoFVatMGUTHimalaya_convergence_tester(
   MSSMNoFVatMGUTHimalaya<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMNoFVatMGUTHimalaya<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMNoFVatMGUTHimalaya_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMNoFVatMGUTHimalaya<Two_scale>& ol = get_last_iteration_model();
   const MSSMNoFVatMGUTHimalaya<Two_scale>& ne = get_current_iteration_model();
