...
void MSSMNoFVatMGUTHimalaya_physical::clear()
{
   MVG = 0.;
   MGlu = 0.;
   MFd = 0.;
 ...
 * to be complex.
 */
void MSSMNoFVatMGUTHimalaya_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void MSSMNoFVatMGUTHimalaya_physical::convert_to_slha()
{
   SLHA_io::convert_symmetric_fermion_mixings_to_slha(LOCALPHYSICAL(MChi), LOCALPHYSICAL(ZN));

}

Eigen::ArrayXd MSSMNoFVatMGUTHimalaya_physical::get() const
{
...
void MSSMNoFVatMGUTHimalaya_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSMNoFVatMGUTHimalaya_physical::get_masses() const
{
...
void MSSMNoFVatMGUTHimalaya_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFd = pars(2);
...
void MSSMNoFVatMGUTHimalaya_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUTHimalaya_physical& phys_pars)
{
