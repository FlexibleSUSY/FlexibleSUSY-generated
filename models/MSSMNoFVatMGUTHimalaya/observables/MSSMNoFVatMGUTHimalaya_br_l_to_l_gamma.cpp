...
/**
 * @file MSSMNoFVatMGUTHimalaya_br_l_to_l_gamma.cpp
 *
...
#include "MSSMNoFVatMGUTHimalaya_br_l_to_l_gamma.hpp"
...
void run_to_MSUSY(MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_l_to_lgamma: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_l_to_lgamma:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_l_to_lgamma: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("MSSMNoFVatMGUTHimalaya_l_to_lgamma: run_to_MSUSY(): "
...
namespace MSSMNoFVatMGUTHimalaya_br_l_to_l_gamma {
