...
// File generated at Mon 5 Mar 2018 14:29:34
...
#define CLASSNAME MSSMNoFVatMGUTHimalaya_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int MSSMNoFVatMGUTHimalaya_susy_parameters::numberOfParameters;

MSSMNoFVatMGUTHimalaya_susy_parameters::MSSMNoFVatMGUTHimalaya_susy_parameters(const MSSMNoFVatMGUTHimalaya_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMNoFVatMGUTHimalaya_susy_parameters::MSSMNoFVatMGUTHimalaya_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const MSSMNoFVatMGUTHimalaya_input_parameters& input_
...
Eigen::ArrayXd MSSMNoFVatMGUTHimalaya_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMNoFVatMGUTHimalaya_susy_parameters MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta(int loops) const
{
   ...
   if (loops > 0) {
      ...
      if (loops > 1) {
         ...
         if (loops > 2) {
            ...
            {
               auto fut_Yd = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_Yd_3_loop(
                  TRACE_STRUCT); });
               auto fut_Ye = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_Ye_3_loop(
                  TRACE_STRUCT); });
               auto fut_Yu = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_Yu_3_loop(
                  TRACE_STRUCT); });
               auto fut_Mu = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_Mu_3_loop(
                  TRACE_STRUCT); });
               auto fut_g1 = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_g1_3_loop(
                  TRACE_STRUCT); });
               auto fut_g2 = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_g2_3_loop(
                  TRACE_STRUCT); });
               auto fut_g3 = global_thread_pool().run_packaged_task
                  ([this, &TRACE_STRUCT](){ return calc_beta_g3_3_loop(
                  TRACE_STRUCT); });
   ...
   return MSSMNoFVatMGUTHimalaya_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Yu, beta_Mu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu);
}

MSSMNoFVatMGUTHimalaya_susy_parameters MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMNoFVatMGUTHimalaya_susy_parameters::clear()
{
   reset();
...
Eigen::Matrix<double,3,3> CLASSNAME::get_SqSq() const
{
   ...
   if (get_loops() > 1) {
      anomDim += (twoLoop*(0.8*Sqr(g1)*(Yu.adjoint()*Yu) - 2*(
         ...
         + (0.22111111111111112*Quad(g1) + 3.75*Quad(g2) - 0.8888888888888888*
         Quad(g3) + 8*Sqr(g2)*Sqr(g3) + 0.011111111111111112*Sqr(g1)*(9*Sqr(g2)
...
Eigen::ArrayXd MSSMNoFVatMGUTHimalaya_susy_parameters::get() const
{
...
void MSSMNoFVatMGUTHimalaya_susy_parameters::print(std::ostream& ostr) const
{
...
void MSSMNoFVatMGUTHimalaya_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const MSSMNoFVatMGUTHimalaya_input_parameters& MSSMNoFVatMGUTHimalaya_susy_parameters::get_input() const
{
   return input;
}

MSSMNoFVatMGUTHimalaya_input_parameters& MSSMNoFVatMGUTHimalaya_susy_parameters::get_input()
{
   return input;
}

void MSSMNoFVatMGUTHimalaya_susy_parameters::set_input_parameters(const MSSMNoFVatMGUTHimalaya_input_parameters& input_)
{
   input = input_;
}

MSSMNoFVatMGUTHimalaya_susy_parameters::Susy_traces MSSMNoFVatMGUTHimalaya_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUTHimalaya_susy_parameters& susy_pars)
{
