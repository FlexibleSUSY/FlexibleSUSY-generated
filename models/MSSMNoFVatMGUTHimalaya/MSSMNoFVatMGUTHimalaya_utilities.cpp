...
#include "MSSMNoFVatMGUTHimalaya_utilities.hpp"
...
// MSSMNoFVatMGUTHimalaya_parameter_getter ////////////////////////////////////////

std::vector<std::string> MSSMNoFVatMGUTHimalaya_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace MSSMNoFVatMGUTHimalaya_info;
...
std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_MIXINGS> MSSMNoFVatMGUTHimalaya_parameter_getter::get_mixing_names()
{
   return MSSMNoFVatMGUTHimalaya_info::particle_mixing_names;
}

Eigen::ArrayXd MSSMNoFVatMGUTHimalaya_parameter_getter::get_parameters(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_PARAMETERS> MSSMNoFVatMGUTHimalaya_parameter_getter::get_parameter_names()
{
   return MSSMNoFVatMGUTHimalaya_info::parameter_names;
}

std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_PARTICLES> MSSMNoFVatMGUTHimalaya_parameter_getter::get_particle_names()
{
   return MSSMNoFVatMGUTHimalaya_info::particle_names;
}

std::vector<std::string> MSSMNoFVatMGUTHimalaya_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> MSSMNoFVatMGUTHimalaya_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_MIXINGS> MSSMNoFVatMGUTHimalaya_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_MIXINGS> MSSMNoFVatMGUTHimalaya_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_INPUT_PARAMETERS> MSSMNoFVatMGUTHimalaya_parameter_getter::get_input_parameter_names()
{
   return MSSMNoFVatMGUTHimalaya_info::input_parameter_names;
}

std::array<std::string, MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_EXTRA_PARAMETERS> MSSMNoFVatMGUTHimalaya_parameter_getter::get_extra_parameter_names()
{
   return MSSMNoFVatMGUTHimalaya_info::extra_parameter_names;
}

decltype(MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_MASSES) MSSMNoFVatMGUTHimalaya_parameter_getter::get_number_of_masses()
{
   return MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_MASSES;
}

// MSSMNoFVatMGUTHimalaya_spectrum_plotter ////////////////////////////////////////

MSSMNoFVatMGUTHimalaya_spectrum_plotter::MSSMNoFVatMGUTHimalaya_spectrum_plotter(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void MSSMNoFVatMGUTHimalaya_spectrum_plotter::extract_spectrum(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   spectrum.clear();
...
void MSSMNoFVatMGUTHimalaya_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("MSSMNoFVatMGUTHimalaya_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void MSSMNoFVatMGUTHimalaya_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("MSSMNoFVatMGUTHimalaya_spectrum_plotter::write_spectrum: "
...
namespace MSSMNoFVatMGUTHimalaya_database {
 ...
 */
void to_database(
   const std::string& file_name, const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model,
   ...
   const MSSMNoFVatMGUTHimalaya_observables* observables)
{
   ...
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_DRbar_mass_names());
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_pole_mass_names());
   append(names, MSSMNoFVatMGUTHimalaya_parameter_getter::get_pole_mixing_names());
   ...
   if (MSSMNoFVatMGUTHimalaya_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, MSSMNoFVatMGUTHimalaya_observables::get_names());
 ...
 */
MSSMNoFVatMGUTHimalaya_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, MSSMNoFVatMGUTHimalaya_observables* observables)
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = MSSMNoFVatMGUTHimalaya_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = MSSMNoFVatMGUTHimalaya_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? MSSMNoFVatMGUTHimalaya_observables::NUMBER_OF_OBSERVABLES : 0);
