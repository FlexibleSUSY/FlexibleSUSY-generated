...
double MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_g3_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_g3 = Re(0.2*Cube(g3)*(-20*traceYdAdjYd - 20*traceYuAdjYu + 11*Sqr(g1) +
      45*Sqr(g2) + 70*Sqr(g3)));
 ...
 */
double MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_g3_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
