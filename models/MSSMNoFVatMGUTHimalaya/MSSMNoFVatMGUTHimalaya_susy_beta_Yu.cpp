 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (-0.06666666666666667*Yu*(-45*traceYuAdjYu + 13*Sqr(g1) + 45*Sqr(
      g2) + 80*Sqr(g3)) + Yu*Yd.adjoint()*Yd + 3*(Yu*Yu.adjoint()*Yu)).real();
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yu = (0.0022222222222222222*Yu*(-1350*traceYdAdjYuYuAdjYd - 4050*
      traceYuAdjYuYuAdjYu + 2743*Quad(g1) + 3375*Quad(g2) - 800*Quad(g3) + 360*
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_Yu_1 = ((0.00007407407407407407*Yu*(
      ...
      *Quad(g1)*Sqr(g3) + 1890000*Quad(g2)*Sqr(g3) - 558000*traceAdjYuYu*Sqr(g1
      ...
      Sqr(g3)) + 0.004*(4500*traceAdjYuYuAdjYuYuAdjYuYu - 5174*Power6(g1) +
      ...
      Sqr(g3))*(Yu*1.2020569031595942) + 0.0033333333333333335*(5400*
      ...
      300*Sqr(traceAdjYeYe))*(Yu*Yd.adjoint()*Yd) + 0.0033333333333333335*(5400
      *traceAdjYuYuAdjYdYd + 16200*traceAdjYuYuAdjYuYu - 8561*Quad(g1) - 16425*
      Quad(g2) + 2400*Quad(g3) + 2700*traceAdjYuYu*Sqr(g1) + 13500*traceAdjYuYu
      *Sqr(g2) - 5790*Sqr(g1)*Sqr(g2) - 7200*traceAdjYuYu*Sqr(g3) - 4240*Sqr(g1
      )*Sqr(g3) - 27600*Sqr(g2)*Sqr(g3) - 8100*Sqr(traceAdjYuYu))*(Yu*Yu.
      adjoint()*Yu) + 0.03333333333333333*(7*Quad(g1) - 945*Quad(g2) - 2720*
      Quad(g3) - 144*traceAdjYdYd*Sqr(g1) + 72*traceAdjYeYe*Sqr(g1) + 54*Sqr(g1
      )*Sqr(g2) + 1440*traceAdjYdYd*Sqr(g3) + 256*Sqr(g1)*Sqr(g3))*(Yu*Yd.
      adjoint()*Yd*1.2020569031595942) + 0.02*(-117*Quad(g1) - 2025*Quad(g2) -
      13600*Quad(g3) + 180*traceAdjYuYu*Sqr(g1) - 2700*traceAdjYuYu*Sqr(g2) +
      1230*Sqr(g1)*Sqr(g2) + 7200*traceAdjYuYu*Sqr(g3) - 320*Sqr(g1)*Sqr(g3) +
      4800*Sqr(g2)*Sqr(g3))*(Yu*Yu.adjoint()*Yu*1.2020569031595942))*UNITMATRIX
      (3)).real();
   const Eigen::Matrix<double,3,3> beta_Yu_2 = ((0.06666666666666667*(90*
      traceAdjYdYd + 30*traceAdjYeYe + 7*Sqr(g1) - 45*Sqr(g2) + 320*Sqr(g3))*(
      Yu*Yd.adjoint()*Yd*Yd.adjoint()*Yd) + 0.06666666666666667*(180*
      traceAdjYdYd + 60*traceAdjYeYe - 90*traceAdjYuYu + 19*Sqr(g1) + 135*Sqr(
      g2) + 320*Sqr(g3))*(Yu*Yd.adjoint()*Yd*Yu.adjoint()*Yu) +
      0.6666666666666666*(18*traceAdjYuYu + 5*Sqr(g1) + 9*Sqr(g2) + 64*Sqr(g3))
      *(Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu) - 1.2*(Sqr(g1) - 15*Sqr(g2))*(Yu*Yd
      .adjoint()*Yd*Yd.adjoint()*Yd*1.2020569031595942) + 3.6*(Sqr(g1) - 5*Sqr(
      g2))*(Yu*Yd.adjoint()*Yd*Yu.adjoint()*Yu*1.2020569031595942) + 6*(Yu*Yd.
      adjoint()*Yd*Yd.adjoint()*Yd*Yu.adjoint()*Yu) + 4*(Yu*Yd.adjoint()*Yd*Yu.
      adjoint()*Yu*Yd.adjoint()*Yd) - 2*(Yu*Yd.adjoint()*Yd*Yu.adjoint()*Yu*Yu.
      adjoint()*Yu) + 2*(Yu*Yu.adjoint()*Yu*Yd.adjoint()*Yd*Yu.adjoint()*Yu) +
      6*(Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu) + 6*(Yu*Yd.adjoint
      ()*Yd*Yd.adjoint()*Yd*Yd.adjoint()*Yd*1.2020569031595942) + 18*(Yu*Yu.
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_Yu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
