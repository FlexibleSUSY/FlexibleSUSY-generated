...
// File generated at Mon 5 Mar 2018 14:29:41
...
double MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_g1_3_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_g1 = Re(-0.0026666666666666666*threeLoop*Cube(g1)*(32117*Quad(g1)
      ...
      *Sqr(g2) + 1096*Sqr(g3)) + 25*(243*Quad(g2) + 9*Sqr(g2)*(11*traceAdjYdYd
      + 21*traceAdjYeYe + 29*traceAdjYuYu + 8*Sqr(g3)) - 2*(242*Quad(g3) - 16*(
      8*traceAdjYdYd + 11*traceAdjYuYu)*Sqr(g3) + 3*(27*traceAdjYdYdAdjYdYd +
