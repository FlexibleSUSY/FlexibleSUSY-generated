...
// File generated at Tue 22 Jan 2019 13:26:58

#ifndef MSSMNoFVatMGUTHimalaya_SLHA_IO_H
#define MSSMNoFVatMGUTHimalaya_SLHA_IO_H
...
struct MSSMNoFVatMGUTHimalaya_input_parameters;
class Spectrum_generator_settings;

template <class T>
class MSSMNoFVatMGUTHimalaya;

struct MSSMNoFVatMGUTHimalaya_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MSSMNoFVatMGUTHimalaya_slha_io {
public:
   MSSMNoFVatMGUTHimalaya_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MSSMNoFVatMGUTHimalaya_input_parameters&) const;
   void fill(MSSMNoFVatMGUTHimalaya_mass_eigenstates&) const;
   template <class Model> void fill(MSSMNoFVatMGUTHimalaya_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSMNoFVatMGUTHimalaya_slha<Model>&, const MSSMNoFVatMGUTHimalaya_scales&, const MSSMNoFVatMGUTHimalaya_observables&);
   void set_input(const MSSMNoFVatMGUTHimalaya_input_parameters&);
   ...
   template <class Model> void set_spectrum(const MSSMNoFVatMGUTHimalaya_slha<Model>&);
   template <class T> void set_spectrum(const MSSMNoFVatMGUTHimalaya<T>&);
   ...
   static void fill_minpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters&, int, double);
   static void fill_imminpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters&, int, double);
   static void fill_imextpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MSSMNoFVatMGUTHimalaya_slha<Model>&, const softsusy::QedQcd&, const MSSMNoFVatMGUTHimalaya_scales&, const MSSMNoFVatMGUTHimalaya_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSMNoFVatMGUTHimalaya_slha<Model>&, const softsusy::QedQcd&, const MSSMNoFVatMGUTHimalaya_scales&, const MSSMNoFVatMGUTHimalaya_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MSSMNoFVatMGUTHimalaya_input_parameters&);
   void set_imminpar(const MSSMNoFVatMGUTHimalaya_input_parameters&);
   void set_imextpar(const MSSMNoFVatMGUTHimalaya_input_parameters&);
   void set_minpar(const MSSMNoFVatMGUTHimalaya_input_parameters&);
   void set_mass(const MSSMNoFVatMGUTHimalaya_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const MSSMNoFVatMGUTHimalaya_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const MSSMNoFVatMGUTHimalaya_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMNoFVatMGUTHimalaya_mass_eigenstates&) const;
   void fill_physical(MSSMNoFVatMGUTHimalaya_physical&) const;
};
 ...
 */
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha_io::fill(MSSMNoFVatMGUTHimalaya_slha<Model>& model) const
{
...
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMNoFVatMGUTHimalaya_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MSSMNoFVatMGUTHimalaya_scales& scales,
   const MSSMNoFVatMGUTHimalaya_observables& observables)
{
   MSSMNoFVatMGUTHimalaya_slha_io slha_io;
   const MSSMNoFVatMGUTHimalaya_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MSSMNoFVatMGUTHimalaya_slha_io::fill_slhaea(
   const MSSMNoFVatMGUTHimalaya_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MSSMNoFVatMGUTHimalaya_scales& scales, const MSSMNoFVatMGUTHimalaya_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMNoFVatMGUTHimalaya_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha_io::set_model_parameters(const MSSMNoFVatMGUTHimalaya_slha<Model>& model)
{
   {
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_extra(
   const MSSMNoFVatMGUTHimalaya_slha<Model>& model, const MSSMNoFVatMGUTHimalaya_scales& scales,
   const MSSMNoFVatMGUTHimalaya_observables& observables)
{
 ...
 */
template <class... Ts>
void MSSMNoFVatMGUTHimalaya_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MSSMNoFVatMGUTHimalaya_slha_io> ss(this);
 ...
 */
template <class T>
void MSSMNoFVatMGUTHimalaya_slha_io::set_spectrum(const MSSMNoFVatMGUTHimalaya<T>& model)
{
   set_spectrum(MSSMNoFVatMGUTHimalaya_slha<MSSMNoFVatMGUTHimalaya<T> >(model));
}
 ...
 */
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha_io::set_spectrum(const MSSMNoFVatMGUTHimalaya_slha<Model>& model)
{
   const MSSMNoFVatMGUTHimalaya_physical physical(model.get_physical_slha());
