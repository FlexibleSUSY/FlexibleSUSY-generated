...
class MSSMNoFVatMGUTHimalaya_slha : public MSSMNoFVatMGUTHimalaya_mass_eigenstates {
public:
   explicit MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_input_parameters& input_ = MSSMNoFVatMGUTHimalaya_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_mass_eigenstates&, bool do_convert_masses_to_slha = true);
