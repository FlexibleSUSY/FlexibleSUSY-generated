...
/**
 * @file MSSMNoFVatMGUTHimalaya_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Sun 26 Aug 2018 13:49:36

#ifndef MSSMNoFVatMGUTHimalaya_SLHA_H
#define MSSMNoFVatMGUTHimalaya_SLHA_H
...
/**
 * @class MSSMNoFVatMGUTHimalaya_slha<T>
...
class MSSMNoFVatMGUTHimalaya_slha : public Model {
public:
   explicit MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_input_parameters& input_ = MSSMNoFVatMGUTHimalaya_input_parameters());
   explicit MSSMNoFVatMGUTHimalaya_slha(const Model&, bool do_convert_masses_to_slha = true);
   MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_slha&) = default;
   MSSMNoFVatMGUTHimalaya_slha(MSSMNoFVatMGUTHimalaya_slha&&) = default;
   virtual ~MSSMNoFVatMGUTHimalaya_slha() = default;
   MSSMNoFVatMGUTHimalaya_slha& operator=(const MSSMNoFVatMGUTHimalaya_slha&) = default;
   MSSMNoFVatMGUTHimalaya_slha& operator=(MSSMNoFVatMGUTHimalaya_slha&&) = default;
   ...
   const MSSMNoFVatMGUTHimalaya_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MSSMNoFVatMGUTHimalaya_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MSSMNoFVatMGUTHimalaya_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
MSSMNoFVatMGUTHimalaya_slha<Model>::MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MSSMNoFVatMGUTHimalaya_slha<Model>::MSSMNoFVatMGUTHimalaya_slha(const Model& model_,
...
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::calculate_ckm_matrix()
{

}

template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MSSMNoFVatMGUTHimalaya_physical& MSSMNoFVatMGUTHimalaya_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MSSMNoFVatMGUTHimalaya_physical& MSSMNoFVatMGUTHimalaya_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MSSMNoFVatMGUTHimalaya_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUTHimalaya_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
