...
#include "MSSMNoFVatMGUTHimalaya_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME MSSMNoFVatMGUTHimalaya_mass_eigenstates
...
CLASSNAME::CLASSNAME(const MSSMNoFVatMGUTHimalaya_input_parameters& input_)
   : MSSMNoFVatMGUTHimalaya_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new MSSMNoFVatMGUTHimalaya_ewsb_solver<Two_scale>())
#endif
{
}

std::unique_ptr<MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<MSSMNoFVatMGUTHimalaya_mass_eigenstates>(*this);
}
...
const MSSMNoFVatMGUTHimalaya_physical& CLASSNAME::get_physical() const
{
   return physical;
}

MSSMNoFVatMGUTHimalaya_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const MSSMNoFVatMGUTHimalaya_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MSSMNoFVatMGUTHimalaya_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving MSSMNoFVatMGUTHimalaya EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           ...
           "========================================\n";
   MSSMNoFVatMGUTHimalaya_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSveL) < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::SveL); }
   if (PHYSICAL(MSvmL) < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::SvmL); }
   if (PHYSICAL(MSvtL) < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::SvtL); }
   if (PHYSICAL(MSd).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Sd); }
   if (PHYSICAL(MSu).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Su); }
   if (PHYSICAL(MSe).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Se); }
   if (PHYSICAL(MSm).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Sm); }
   if (PHYSICAL(MStau).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Stau); }
   if (PHYSICAL(MSs).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Ss); }
   if (PHYSICAL(MSc).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Sc); }
   if (PHYSICAL(MSb).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Sb); }
   if (PHYSICAL(MSt).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::St); }
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::hh); }
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Ah); }
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::Hpm); }
}
...
{
   MSSMNoFVatMGUTHimalaya_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   MSSMNoFVatMGUTHimalaya_soft_parameters::run_to(scale, eps);
}
...
const MSSMNoFVatMGUTHimalaya_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

MSSMNoFVatMGUTHimalaya_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
...
void CLASSNAME::calculate_MSveL()
{
   ...
   if (MSveL < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::SveL);
   }
...
void CLASSNAME::calculate_MSvmL()
{
   ...
   if (MSvmL < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::SvmL);
   }
...
void CLASSNAME::calculate_MSvtL()
{
   ...
   if (MSvtL < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::SvtL);
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sd, eigenvalue_error >
      precision * Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Sd);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Su, eigenvalue_error >
      precision * Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Se, eigenvalue_error >
      precision * Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Se);
   }
...
void CLASSNAME::calculate_MSm()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sm, eigenvalue_error >
      precision * Abs(MSm(0)));
#else
   ...
   if (MSm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Sm);
   }
...
void CLASSNAME::calculate_MStau()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Stau, eigenvalue_error >
   ...
   if (MStau.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Stau);
   }
...
void CLASSNAME::calculate_MSs()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Ss, eigenvalue_error >
      precision * Abs(MSs(0)));
#else
   ...
   if (MSs.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Ss);
   }
...
void CLASSNAME::calculate_MSc()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sc, eigenvalue_error >
      precision * Abs(MSc(0)));
#else
   ...
   if (MSc.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Sc);
   }
...
void CLASSNAME::calculate_MSb()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sb, eigenvalue_error >
      precision * Abs(MSb(0)));
#else
   ...
   if (MSb.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Sb);
   }
...
void CLASSNAME::calculate_MSt()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::St, eigenvalue_error >
      precision * Abs(MSt(0)));
#else
   ...
   if (MSt.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::St);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Hpm, eigenvalue_error >
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(MSSMNoFVatMGUTHimalaya_info::VWm);
   }
...
Eigen::Matrix<double,2,2> CLASSNAME::self_energy_hh_3loop() const
{
   ...
   pars.Mt = MFt;
   pars.Mb = MFb;
   pars.MA = get_MPseudoscalarHiggs()(0);
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVatMGUTHimalaya_info
      ::VZ))
      return;
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::VZ);
   }
...
void CLASSNAME::calculate_MFt_pole()
{
...

   {
      ...
      pars.mst1 = mst_1;
      pars.mst2 = mst_2;
      pars.msusy = Sqrt(Sqrt(Abs(md2(2,2))))*Sqrt(Sqrt(Abs(mq2(2,2))));
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZD;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZD,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sd,
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZU;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Su,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZE;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Se,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZM;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZM,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sm,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZTau;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZTau,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Stau,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZS;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZS,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Ss,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZC;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZC,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sc,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZB;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZB,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sb,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   for (int es = 0; es < 2; ++es) {
      ...
      Eigen::Matrix<double,2,2> mix_ZT;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZT,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::St,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
...
void CLASSNAME::calculate_Mhh_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMNoFVatMGUTHimalaya_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(MSSMNoFVatMGUTHimalaya_info::hh)
         ;
}
...
void CLASSNAME::calculate_MAh_pole()
{
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Ah);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMNoFVatMGUTHimalaya_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(MSSMNoFVatMGUTHimalaya_info::Ah)
         ;
}
...
void CLASSNAME::calculate_MHpm_pole()
{
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMNoFVatMGUTHimalaya_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(MSSMNoFVatMGUTHimalaya_info::Hpm
         );
}
   ...
   for (int es = 0; es < 4; ++es) {
      ...
      decltype(ZN) mix_ZN;
         ...
         fs_diagonalize_symmetric(M_loop, eigen_values, mix_ZN,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Chi,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
...
void CLASSNAME::calculate_MVWm_pole()
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::VWm);
   }
...
double CLASSNAME::calculate_MFb_DRbar(double m_sm_msbar) const
{
   ...
   if (get_thresholds() > 1 && threshold_corrections.mb > 1) {
      ...
      pars.msb1 = msb_1;
      pars.msb2 = msb_2;
      pars.msusy = Power(AbsSqrt(md2(0,0))*AbsSqrt(md2(1,1))*AbsSqrt(mq2(0,0))*
         AbsSqrt(mq2(1,1))*AbsSqrt(mu2(0,0))*AbsSqrt(mu2(1,1)),
         0.16666666666666666);
      pars.xt = Sin(2*theta_t) * (Sqr(mst_1) - Sqr(mst_2)) / (2. * pars.mt);
...
double CLASSNAME::calculate_MVZ_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::VZ);return m_pole
         ;
   }
...
double CLASSNAME::calculate_MVWm_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MSSMNoFVatMGUTHimalaya_info::VWm);return
         m_pole;
   }
