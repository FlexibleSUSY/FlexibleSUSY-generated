 ...
 * parameters.
 *
 * This file was generated at Mon 5 Mar 2018 14:59:10 with FlexibleSUSY
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sd,
      eigenvalue_error > precision * Abs(MSd(0)));
#else
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Su,
      eigenvalue_error > precision * Abs(MSu(0)));
#else
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Se,
      eigenvalue_error > precision * Abs(MSe(0)));
#else
...
void CLASSNAME::calculate_MSm()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sm,
      eigenvalue_error > precision * Abs(MSm(0)));
#else
...
void CLASSNAME::calculate_MSs()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Ss,
      eigenvalue_error > precision * Abs(MSs(0)));
#else
...
void CLASSNAME::calculate_MSc()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sc,
      eigenvalue_error > precision * Abs(MSc(0)));
#else
...
void CLASSNAME::calculate_MSb()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Sb,
      eigenvalue_error > precision * Abs(MSb(0)));
#else
...
void CLASSNAME::calculate_MSt()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::St,
      eigenvalue_error > precision * Abs(MSt(0)));
#else
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::hh,
      eigenvalue_error > precision * Abs(Mhh(0)));
#else
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Ah,
      eigenvalue_error > precision * Abs(MAh(0)));
#else
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Hpm,
      eigenvalue_error > precision * Abs(MHpm(0)));
#else
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Chi,
      eigenvalue_error > precision * Abs(MChi(0)));
#else
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSMNoFVatMGUTHimalaya_info::Cha,
      eigenvalue_error > precision * Abs(MCha(0)));
#else
...
void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::VZ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::SveL))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::SvmL))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::SvtL))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Sm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Stau))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Ss))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Sc))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Sb))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::St))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::hh))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            problems.flag_bad_mass(
               MSSMNoFVatMGUTHimalaya_info::hh, eigenvalue_error > precision *
               Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZH);
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Ah))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            problems.flag_bad_mass(
               MSSMNoFVatMGUTHimalaya_info::Ah, eigenvalue_error > precision *
               Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZA);
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::Hpm))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(
               MSSMNoFVatMGUTHimalaya_info::Hpm, eigenvalue_error > precision *
               Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
...
{
   if (!force_output && problems.is_running_tachyon(
      MSSMNoFVatMGUTHimalaya_info::VWm))
      return;
