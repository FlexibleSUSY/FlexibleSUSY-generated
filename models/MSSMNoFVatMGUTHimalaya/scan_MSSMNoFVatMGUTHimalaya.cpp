...
MSSMNoFVatMGUTHimalaya_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
...
void scan(int solver_type, MSSMNoFVatMGUTHimalaya_input_parameters& input,
