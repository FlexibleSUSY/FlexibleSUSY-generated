...
MSSMNoFVatMGUTHimalaya_slha_io::MSSMNoFVatMGUTHimalaya_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MSSMNoFVatMGUTHimalaya_slha_io::clear()
{
   slha_io.clear();
}

void MSSMNoFVatMGUTHimalaya_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill(MSSMNoFVatMGUTHimalaya_slha& model) const
{
   fill(static_cast<MSSMNoFVatMGUTHimalaya_mass_eigenstates&>(model));
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_extpar(const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_imminpar(const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_imextpar(const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_minpar(const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_input(const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 * @param settings class of settings
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_unitarity_infinite_s(
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMNoFVatMGUTHimalaya_info::model_name)
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_mass(const MSSMNoFVatMGUTHimalaya_physical& physical,
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_mixing_matrices(const MSSMNoFVatMGUTHimalaya_physical& physical,
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_ckm(
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_pmns(
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_model_parameters(const MSSMNoFVatMGUTHimalaya_slha& model)
{
   {
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
...
void MSSMNoFVatMGUTHimalaya_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::set_spectrum(const MSSMNoFVatMGUTHimalaya_slha& model)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void MSSMNoFVatMGUTHimalaya_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void MSSMNoFVatMGUTHimalaya_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void MSSMNoFVatMGUTHimalaya_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double MSSMNoFVatMGUTHimalaya_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill(MSSMNoFVatMGUTHimalaya_input_parameters& input) const
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill_drbar_parameters(MSSMNoFVatMGUTHimalaya_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill(MSSMNoFVatMGUTHimalaya_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMNoFVatMGUTHimalaya_physical physical_hk;
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
...
void MSSMNoFVatMGUTHimalaya_slha_io::fill_minpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters& input,
...
void MSSMNoFVatMGUTHimalaya_slha_io::fill_extpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMNoFVatMGUTHimalaya_slha_io::fill_imminpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMNoFVatMGUTHimalaya_slha_io::fill_imextpar_tuple(MSSMNoFVatMGUTHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha_io::fill_physical(MSSMNoFVatMGUTHimalaya_physical& physical) const
{
   {
 ...
 */
double MSSMNoFVatMGUTHimalaya_slha_io::read_scale() const
{
