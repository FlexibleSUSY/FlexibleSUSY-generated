...
/**
 * @file MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme.hpp
 *
...
#define MSSMNoFVatMGUTHimalaya_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme
   : private MSSMNoFVatMGUTHimalaya_soft_parameters
   , public MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface
{
public:
   explicit MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme(const MSSMNoFVatMGUTHimalaya_input_parameters& input_ = MSSMNoFVatMGUTHimalaya_input_parameters());
   explicit MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme(const MSSMNoFVatMGUTHimalaya_mass_eigenstates&);
   MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme(const MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme(MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const MSSMNoFVatMGUTHimalaya_mass_eigenstates&);
...
private:
   ...
   Problems problems{MSSMNoFVatMGUTHimalaya_info::model_name,
...
std::ostream& operator<<(std::ostream&, const MSSMNoFVatMGUTHimalaya_mass_eigenstates_decoupling_scheme&);
