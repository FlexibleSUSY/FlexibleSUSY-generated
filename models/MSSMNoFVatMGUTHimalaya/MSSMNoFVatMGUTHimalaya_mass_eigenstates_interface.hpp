...
/**
 * @file MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSMNoFVatMGUTHimalaya_MASS_EIGENSTATES_INTERFACE_H
#define MSSMNoFVatMGUTHimalaya_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface {
public:
   virtual ~MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMNoFVatMGUTHimalaya_input_parameters& get_input_parameters() const = 0;
   virtual MSSMNoFVatMGUTHimalaya_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMNoFVatMGUTHimalaya_physical& get_physical() const = 0;
   virtual MSSMNoFVatMGUTHimalaya_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMNoFVatMGUTHimalaya_physical&) = 0;
