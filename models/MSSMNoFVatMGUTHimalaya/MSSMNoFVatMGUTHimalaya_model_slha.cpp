...
MSSMNoFVatMGUTHimalaya_slha::MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_input_parameters& input_,
 ...
 */
MSSMNoFVatMGUTHimalaya_slha::MSSMNoFVatMGUTHimalaya_slha(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MSSMNoFVatMGUTHimalaya_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MSSMNoFVatMGUTHimalaya_slha::clear()
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates::clear();
   physical_slha.clear();
}

void MSSMNoFVatMGUTHimalaya_slha::calculate_spectrum()
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MSSMNoFVatMGUTHimalaya_slha::convert_to_slha()
{
...
void MSSMNoFVatMGUTHimalaya_slha::calculate_ckm_matrix()
{

}

void MSSMNoFVatMGUTHimalaya_slha::calculate_pmns_matrix()
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MSSMNoFVatMGUTHimalaya_slha::convert_soft_squared_masses_to_slha()
{
...
const MSSMNoFVatMGUTHimalaya_physical& MSSMNoFVatMGUTHimalaya_slha::get_physical_slha() const
{
   return physical_slha;
}

MSSMNoFVatMGUTHimalaya_physical& MSSMNoFVatMGUTHimalaya_slha::get_physical_slha()
{
   return physical_slha;
}

void MSSMNoFVatMGUTHimalaya_slha::print(std::ostream& ostr) const
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates::print(ostr);
...
void MSSMNoFVatMGUTHimalaya_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVatMGUTHimalaya_slha& model)
{
   model.print(ostr);
   return ostr;
}
