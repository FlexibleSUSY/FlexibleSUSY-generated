...
// File generated at Fri 10 Apr 2020 17:36:46
 ...
 */
double MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_vu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_vu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMNoFVatMGUTHimalaya_susy_parameters::calc_beta_vu_3_loop(const Susy_traces& susy_traces) const
{
