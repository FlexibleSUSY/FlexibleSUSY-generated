...
#ifndef MSSMNoFVatMGUTHimalaya_WEINBERG_ANGLE_H
#define MSSMNoFVatMGUTHimalaya_WEINBERG_ANGLE_H
...
/**
 * @class MSSMNoFVatMGUTHimalaya_weinberg_angle
...
public:
   ...
   MSSMNoFVatMGUTHimalaya_weinberg_angle(const MSSMNoFVatMGUTHimalaya_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMNoFVatMGUTHimalaya_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMNoFVatMGUTHimalaya_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
