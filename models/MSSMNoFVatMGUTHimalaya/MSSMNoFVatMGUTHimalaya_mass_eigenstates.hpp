 ...
 */
class MSSMNoFVatMGUTHimalaya_mass_eigenstates : public MSSMNoFVatMGUTHimalaya_soft_parameters {
public:
   ...
   void set_physical(const MSSMNoFVatMGUTHimalaya_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMNoFVatMGUTHimalaya_physical& get_physical() const;
   MSSMNoFVatMGUTHimalaya_physical& get_physical();
