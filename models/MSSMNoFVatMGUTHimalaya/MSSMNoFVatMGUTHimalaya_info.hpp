...
#ifndef MSSMNoFVatMGUTHimalaya_INFO_H
#define MSSMNoFVatMGUTHimalaya_INFO_H
...
namespace MSSMNoFVatMGUTHimalaya_info {
   ...
   enum Input_parameters : int { TanBeta, SignMu, M1, M2, M3, AtIN, AbIN, AtauIN,
      AcIN, AsIN, AmuonIN, AuIN, AdIN, AeIN, mHd2IN, mHu2IN, ml11IN, ml22IN,
      ml33IN, me11IN, me22IN, me33IN, mq11IN, mq22IN, mq33IN, mu11IN, mu22IN,
      mu33IN, md11IN, md22IN, md33IN, Mlow, NUMBER_OF_INPUT_PARAMETERS };
   ...
   class MSSMNoFVatMGUTHimalaya_particle_names : public Names {
   public:
      virtual ~MSSMNoFVatMGUTHimalaya_particle_names() = default;
   ...
   class MSSMNoFVatMGUTHimalaya_parameter_names : public Names {
   public:
      virtual ~MSSMNoFVatMGUTHimalaya_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMNoFVatMGUTHimalaya_particle_names  particle_names_getter{};
   const MSSMNoFVatMGUTHimalaya_parameter_names parameter_names_getter{};
