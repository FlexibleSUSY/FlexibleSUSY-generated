...
// File generated at Fri 10 Apr 2020 17:38:36
...
template <class T>
class MSSMNoFVatMGUTHimalaya_spectrum_generator_interface {
public:
   virtual ~MSSMNoFVatMGUTHimalaya_spectrum_generator_interface() = default;

   std::tuple<MSSMNoFVatMGUTHimalaya<T>> get_models() const
   { return std::make_tuple(model); }
   std::tuple<MSSMNoFVatMGUTHimalaya_slha<MSSMNoFVatMGUTHimalaya<T>>> get_models_slha() const
   { return std::make_tuple(MSSMNoFVatMGUTHimalaya_slha<MSSMNoFVatMGUTHimalaya<T> >(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.)); }

   const MSSMNoFVatMGUTHimalaya<T>& get_model() const
   { return model; }
   MSSMNoFVatMGUTHimalaya<T>& get_model()
   { return model; }
   MSSMNoFVatMGUTHimalaya_slha<MSSMNoFVatMGUTHimalaya<T>> get_model_slha() const
   { return MSSMNoFVatMGUTHimalaya_slha<MSSMNoFVatMGUTHimalaya<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const MSSMNoFVatMGUTHimalaya_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "MSSMNoFVatMGUTHimalaya_spectrum.dat") const;

protected:
   MSSMNoFVatMGUTHimalaya<T> model;
   ...
   void translate_exception_to_problem(MSSMNoFVatMGUTHimalaya<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const MSSMNoFVatMGUTHimalaya_input_parameters&) = 0;
};
 ...
 */
template <class T>
void MSSMNoFVatMGUTHimalaya_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void MSSMNoFVatMGUTHimalaya_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
 ...
 */
template <class T>
void MSSMNoFVatMGUTHimalaya_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates tmp_model(model);
   try {
   ...
   MSSMNoFVatMGUTHimalaya_parameter_getter parameter_getter;
   Coupling_monitor<MSSMNoFVatMGUTHimalaya_mass_eigenstates, MSSMNoFVatMGUTHimalaya_parameter_getter>
 ...
 */
template <class T>
void MSSMNoFVatMGUTHimalaya_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   MSSMNoFVatMGUTHimalaya_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void MSSMNoFVatMGUTHimalaya_spectrum_generator_interface<T>::translate_exception_to_problem(MSSMNoFVatMGUTHimalaya<T>& model)
{
   try {
      throw;
