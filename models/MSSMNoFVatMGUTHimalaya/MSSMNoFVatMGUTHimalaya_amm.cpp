...
/**
 * @file MSSMNoFVatMGUTHimalaya_amm.cpp
 *
 * This file was generated with FlexibleSUSY 2.8.0 and SARAH 4.15.1 .
 */

#include "MSSMNoFVatMGUTHimalaya_amm.hpp"
#include "MSSMNoFVatMGUTHimalaya_mass_eigenstates.hpp"

#include "cxx_qft/MSSMNoFVatMGUTHimalaya_qft.hpp"
#include "cxx_qft/MSSMNoFVatMGUTHimalaya_particle_aliases.hpp"
#include "MSSMNoFVatMGUTHimalaya_FFV_form_factors.hpp"
...
using namespace MSSMNoFVatMGUTHimalaya_cxx_diagrams;
...
double get_MLCP(const MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface& model)
{
...
void run_to_MSUSY(MSSMNoFVatMGUTHimalaya_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_amm: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_amm:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_amm: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("MSSMNoFVatMGUTHimalaya_amm: run_to_MSUSY(): "
...
template <typename Lepton>
std::enable_if_t<std::is_same_v<Lepton, MSSMNoFVatMGUTHimalaya_cxx_diagrams::fields::Fm>, double>
...
template <typename Lepton>
double calculate_amm_impl_1l(const context_base& context, const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model, double ml_pole)
{
   using namespace MSSMNoFVatMGUTHimalaya_cxx_diagrams::fields;

   const auto form_factors = MSSMNoFVatMGUTHimalaya_FFV_form_factors::calculate_form_factors<Lepton,Lepton,VP>(model, true);
...
template <typename Lepton>
double calculate_amm_impl_2l_barrzee(const context_base& context, double ml_pole)
{
   using namespace MSSMNoFVatMGUTHimalaya_cxx_diagrams::fields;

   double val = 0.;

   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Cha>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fb>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fc>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fd>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fe>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fm>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fs>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Ft>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Ftau>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fu>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Hpm>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sb>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sc>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sd>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Se>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sm>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Ss>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<St>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Stau>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Su>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Cha>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fb>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fc>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fd>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fe>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fm>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fs>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Ft>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Ftau>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoop<Lepton,typename bar<Fu>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Hpm>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sb>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sc>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sd>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Se>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Sm>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Ss>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<St>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Stau>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeScalarLoop<Lepton,typename conj<Su>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeVectorLoop<Lepton,typename conj<VWm>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Cha>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fb>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fc>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fd>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fe>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fm>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fs>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Ft>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Ftau>::type, Ah>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fu>::type, Ah>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Cha>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fb>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fc>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fd>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fe>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fm>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fs>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Ft>::type, hh>::value({}, context, ml_pole);
   val += 1.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Ftau>::type, hh>::value({}, context, ml_pole);
   val += 3.000000000000000 * AMMBarrZeeFermionLoopZ<Lepton,typename bar<Fu>::type, hh>::value({}, context, ml_pole);
...
template <typename Lepton>
double calculate_amm_impl(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings)
{
   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_amm: calculating a_mu at Q = " << model.get_scale());

   using namespace MSSMNoFVatMGUTHimalaya_cxx_diagrams::fields;

   const context_base context{model};
   const double ml_pole = lepton_pole_mass<Lepton>(qedqcd);
   const double loops = settings.get(Spectrum_generator_settings::calculate_amm);

   double val = 0.;

   if (loops > amm_threshold_1l) {
      const double amu_1l = calculate_amm_impl_1l<Lepton>(context, model, ml_pole);
   ...
   if (loops > amm_threshold_2l_barrzee) {
      val += calculate_amm_impl_2l_barrzee<Lepton>(context, ml_pole);
   }
...
template <typename Lepton>
double MSSMNoFVatMGUTHimalaya_amm::calculate_amm(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings)
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates model(model_);

   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_amm: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MSSMNoFVatMGUTHimalaya_amm:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }

   return calculate_amm_impl<Lepton>(model, qedqcd, settings);
}

// spliting templated function into header and cpp
// https://isocpp.org/wiki/faq/templates#separate-template-fn-defn-from-decl
template double MSSMNoFVatMGUTHimalaya_amm::calculate_amm<MSSMNoFVatMGUTHimalaya_cxx_diagrams::fields::Fm>(const MSSMNoFVatMGUTHimalaya_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&);

template <typename Lepton>
double MSSMNoFVatMGUTHimalaya_amm::calculate_amm_uncertainty(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd, const Spectrum_generator_settings& settings)
{
   MSSMNoFVatMGUTHimalaya_mass_eigenstates model(model_);

   VERBOSE_MSG("MSSMNoFVatMGUTHimalaya_amm: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("MSSMNoFVatMGUTHimalaya_amm uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
   ...
   const double amu_2l_barrzee = calculate_amm_impl_2l_barrzee<Lepton>(context, ml_pole);
...
// spliting templated function into header and cpp
// https://isocpp.org/wiki/faq/templates#separate-template-fn-defn-from-decl
template double MSSMNoFVatMGUTHimalaya_amm::calculate_amm_uncertainty<MSSMNoFVatMGUTHimalaya_cxx_diagrams::fields::Fm>(const MSSMNoFVatMGUTHimalaya_mass_eigenstates&, const softsusy::QedQcd&, const Spectrum_generator_settings&);
