...
int run_solver(const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMNoFVatMGUTHimalaya_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMNoFVatMGUTHimalaya_input_parameters& input)
{
   int exit_code = 0;
