...
/**
 * @file MSSMNoFVatMGUTHimalaya_unitarity.cpp
 *
...
namespace MSSMNoFVatMGUTHimalaya_unitarity {
...
// s -> infinity limit
UnitarityInfiniteS
max_scattering_eigenvalue_infinite_s(MSSMNoFVatMGUTHimalaya_mass_eigenstates const& model) {
