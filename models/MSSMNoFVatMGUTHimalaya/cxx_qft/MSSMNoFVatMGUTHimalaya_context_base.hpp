...
namespace MSSMNoFVatMGUTHimalaya_cxx_diagrams {
   ...
   struct context_base {
      MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MSSMNoFVatMGUTHimalaya_mass_eigenstates_interface const* const m) : model(*m) {}
