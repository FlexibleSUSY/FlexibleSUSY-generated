...
/**
 * @file MSSMNoFVatMGUTHimalaya_f_to_f_conversion.cpp
 *
...
namespace MSSMNoFVatMGUTHimalaya_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const MSSMNoFVatMGUTHimalaya_mass_eigenstates& model) {
