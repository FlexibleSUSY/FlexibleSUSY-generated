...
int run_solver(flexiblesusy::MSSMNoFVatMGUTHimalaya_slha_io& slha_io,
               ...
               const std::string& rgflow_file)
{
   ...
   if (!database_output_file.empty() && show_result) {
      MSSMNoFVatMGUTHimalaya_database::to_database(
 ...
 */
int run(
   flexiblesusy::MSSMNoFVatMGUTHimalaya_slha_io& slha_io,
   const flexiblesusy::Spectrum_generator_settings& spectrum_generator_settings,
...
int main(int argc, char* argv[])
{
   ...
   if (options.must_print_model_info())
      MSSMNoFVatMGUTHimalaya_info::print(std::cout);
