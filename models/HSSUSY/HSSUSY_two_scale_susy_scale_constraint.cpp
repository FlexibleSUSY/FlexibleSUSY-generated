...
// File generated at Sun 26 Aug 2018 14:11:44
...
void HSSUSY_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<HSSUSY<Two_scale>*>(model_);
}

void HSSUSY_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& HSSUSY_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
...
void HSSUSY_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("HSSUSY_susy_scale_constraint<Two_scale>: "
