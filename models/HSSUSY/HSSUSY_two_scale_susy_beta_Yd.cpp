...
// File generated at Sun 18 Oct 2015 11:23:48
 ...
 */
Eigen::Matrix<double,3,3> HSSUSY_susy_parameters::calc_beta_Yd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> HSSUSY_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
Eigen::Matrix<double,3,3> HSSUSY_susy_parameters::calc_beta_Yd_three_loop(const Susy_traces& susy_traces) const
{
