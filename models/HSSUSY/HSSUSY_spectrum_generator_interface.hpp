...
public:
   HSSUSY_spectrum_generator_interface()
      : model()
      , settings()
   ...
   virtual void run(const softsusy::QedQcd&, const HSSUSY_input_parameters&) = 0;
 ...
 */
template <class T>
void HSSUSY_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
