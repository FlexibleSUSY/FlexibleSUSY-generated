 ...
 * @brief HSSUSY model class wrapper for SLHA conversion
 */
...
#define CLASSNAME HSSUSY_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::HSSUSY_slha(const HSSUSY_input_parameters& input_)
   : HSSUSY<Two_scale>(input_)
   , physical_slha()
...
CLASSNAME::~HSSUSY_slha()
{
}

void CLASSNAME::clear()
{
   HSSUSY<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   HSSUSY<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const HSSUSY_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

HSSUSY_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
