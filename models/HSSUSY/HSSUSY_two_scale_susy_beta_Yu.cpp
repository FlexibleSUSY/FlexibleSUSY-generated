...
// File generated at Mon 19 Sep 2016 09:49:07
 ...
 */
Eigen::Matrix<double,3,3> HSSUSY_susy_parameters::calc_beta_Yu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> HSSUSY_susy_parameters::calc_beta_Yu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
Eigen::Matrix<double,3,3> HSSUSY_susy_parameters::calc_beta_Yu_three_loop(const Susy_traces& susy_traces) const
{
