...
#ifndef HSSUSY_TWO_SCALE_MATCHING_H
#define HSSUSY_TWO_SCALE_MATCHING_H
...
template <class T> class HSSUSY;
template <class T> class HSSUSY_standard_model_Matching;
...
template<>
class HSSUSY_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   HSSUSY_standard_model_Matching();

   HSSUSY_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       HSSUSY<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~HSSUSY_standard_model_Matching();
