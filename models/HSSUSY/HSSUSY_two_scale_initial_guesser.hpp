...
#ifndef HSSUSY_TWO_SCALE_INITIAL_GUESSER_H
#define HSSUSY_TWO_SCALE_INITIAL_GUESSER_H

#include "HSSUSY_initial_guesser.hpp"
...
/**
 * @class HSSUSY_initial_guesser<Two_scale>
 * @brief initial guesser for the HSSUSY
 */

template<>
class HSSUSY_initial_guesser<Two_scale> : public Initial_guesser {
public:
   HSSUSY_initial_guesser(HSSUSY<Two_scale>*,
                               const softsusy::QedQcd&,
                               const HSSUSY_low_scale_constraint<Two_scale>&,
                               const HSSUSY_susy_scale_constraint<Two_scale>&,
                               const HSSUSY_high_scale_constraint<Two_scale>&);
   virtual ~HSSUSY_initial_guesser() = default;
...
private:
   HSSUSY<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   HSSUSY_low_scale_constraint<Two_scale> low_constraint{};
   HSSUSY_susy_scale_constraint<Two_scale> susy_constraint{};
   HSSUSY_high_scale_constraint<Two_scale> high_constraint{};
