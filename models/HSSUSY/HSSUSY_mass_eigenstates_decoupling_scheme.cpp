...
/**
 * @file HSSUSY_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the HSSUSY model class in the decoupling scheme
 *
...
#define CLASSNAME HSSUSY_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const HSSUSY_input_parameters& input_)
   : HSSUSY_soft_parameters(input_)
{
}

CLASSNAME::CLASSNAME(const HSSUSY_mass_eigenstates& model)
{
   fill_from(model);
}

std::unique_ptr<HSSUSY_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<HSSUSY_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const HSSUSY_mass_eigenstates& model)
{
   set(model.get());
...
const HSSUSY_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

HSSUSY_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(HSSUSY_info::Fd, eigenvalue_error > precision * Abs(
      MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(HSSUSY_info::Fu, eigenvalue_error > precision * Abs(
      MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(HSSUSY_info::Fe, eigenvalue_error > precision * Abs(
      MFe(0)));
#else
...
std::ostream& operator<<(std::ostream& ostr, const HSSUSY_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
