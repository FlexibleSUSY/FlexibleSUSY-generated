...
public:
   ...
   HSSUSY_susy_parameters& operator=(const HSSUSY_susy_parameters&) = default;
   HSSUSY_susy_parameters& operator=(HSSUSY_susy_parameters&&) = default;
   ...
   HSSUSY_susy_parameters calc_beta(int) const;
   virtual void clear();
