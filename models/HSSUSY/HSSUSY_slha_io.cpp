 ...
 * SLHA output file.
 */
void HSSUSY_slha_io::fill(HSSUSY_slha& model) const
{
 ...
 */
void HSSUSY_slha_io::set_extpar(const HSSUSY_input_parameters& input)
{
 ...
 * @param settings class of settings
 */
void HSSUSY_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void HSSUSY_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void HSSUSY_slha_io::set_unitarity_infinite_s(
 ...
 */
void HSSUSY_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void HSSUSY_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, HSSUSY_info::model_name)
 ...
 */
void HSSUSY_slha_io::set_mass(const HSSUSY_physical& physical,
 ...
 */
void HSSUSY_slha_io::set_mixing_matrices(const HSSUSY_physical& physical,
 ...
 */
void HSSUSY_slha_io::set_model_parameters(const HSSUSY_slha& model)
{
   {
 ...
 */
void HSSUSY_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void HSSUSY_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, HSSUSY_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void HSSUSY_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = HSSUSY_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + HSSUSY_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void HSSUSY_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void HSSUSY_slha_io::set_spectrum(const HSSUSY_slha& model)
{
...
void HSSUSY_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void HSSUSY_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void HSSUSY_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double HSSUSY_slha_io::get_parameter_output_scale() const
{
 ...
 */
void HSSUSY_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void HSSUSY_slha_io::fill_drbar_parameters(HSSUSY_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void HSSUSY_slha_io::fill(HSSUSY_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   HSSUSY_physical physical_hk;
 ...
 */
void HSSUSY_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void HSSUSY_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void HSSUSY_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void HSSUSY_slha_io::fill_minpar_tuple(HSSUSY_input_parameters& input,
...
void HSSUSY_slha_io::fill_extpar_tuple(HSSUSY_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void HSSUSY_slha_io::fill_physical(HSSUSY_physical& physical) const
{
   {
