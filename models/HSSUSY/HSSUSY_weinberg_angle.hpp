...
public:
   ...
   HSSUSY_weinberg_angle(const HSSUSY_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const HSSUSY_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const HSSUSY_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
