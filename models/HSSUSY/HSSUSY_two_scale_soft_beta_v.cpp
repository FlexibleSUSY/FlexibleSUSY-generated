...
// File generated at Wed 29 Jun 2016 11:26:06
 ...
 */
double HSSUSY_soft_parameters::calc_beta_v_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double HSSUSY_soft_parameters::calc_beta_v_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double HSSUSY_soft_parameters::calc_beta_v_three_loop(const Soft_traces& soft_traces) const
{
