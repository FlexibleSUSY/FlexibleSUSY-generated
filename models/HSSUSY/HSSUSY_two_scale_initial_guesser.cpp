...
{
   if (!model)
      throw SetupError("HSSUSY_initial_guesser: Error: pointer to model"
                       " HSSUSY<Two_scale> must not be zero");
}
 ...
 */
void HSSUSY_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void HSSUSY_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void HSSUSY_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void HSSUSY_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 */
void HSSUSY_initial_guesser<Two_scale>::guess_soft_parameters()
{
