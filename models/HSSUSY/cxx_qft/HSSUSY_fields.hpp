...
template<>
struct is_vector<HSSUSY_cxx_diagrams::fields::VG > : public std::true_type {};
template<>
struct is_ghost<HSSUSY_cxx_diagrams::fields::gG > : public std::true_type {};
template<>
struct is_scalar<HSSUSY_cxx_diagrams::fields::Hp > : public std::true_type {};
template<>
struct is_fermion<HSSUSY_cxx_diagrams::fields::Fv > : public std::true_type {};
template<>
struct is_scalar<HSSUSY_cxx_diagrams::fields::Ah > : public std::true_type {};
template<>
struct is_scalar<HSSUSY_cxx_diagrams::fields::hh > : public std::true_type {};
template<>
struct is_vector<HSSUSY_cxx_diagrams::fields::VP > : public std::true_type {};
template<>
struct is_vector<HSSUSY_cxx_diagrams::fields::VZ > : public std::true_type {};
template<>
struct is_ghost<HSSUSY_cxx_diagrams::fields::gP > : public std::true_type {};
template<>
struct is_ghost<HSSUSY_cxx_diagrams::fields::gZ > : public std::true_type {};
template<>
struct is_ghost<HSSUSY_cxx_diagrams::fields::gWp > : public std::true_type {};
template<>
struct is_ghost<HSSUSY_cxx_diagrams::fields::gWpC > : public std::true_type {};
template<>
struct is_fermion<HSSUSY_cxx_diagrams::fields::Fd > : public std::true_type {};
template<>
struct is_fermion<HSSUSY_cxx_diagrams::fields::Fu > : public std::true_type {};
template<>
struct is_fermion<HSSUSY_cxx_diagrams::fields::Fe > : public std::true_type {};
template<>
struct is_vector<HSSUSY_cxx_diagrams::fields::VWp > : public std::true_type {};
