...
namespace HSSUSY_cxx_diagrams {
   ...
   struct context_base {
      HSSUSY_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(HSSUSY_mass_eigenstates_interface const& m) : model(m) {}
      context_base(HSSUSY_mass_eigenstates_interface const* const m) : model(*m) {}
