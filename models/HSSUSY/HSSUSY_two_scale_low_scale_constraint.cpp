...
// File generated at Mon 27 Feb 2017 13:25:27
...
HSSUSY_low_scale_constraint<Two_scale>::HSSUSY_low_scale_constraint()
...
HSSUSY_low_scale_constraint<Two_scale>::HSSUSY_low_scale_constraint(
   HSSUSY<Two_scale>* model_, const softsusy::QedQcd& qedqcd_)
   : Constraint<Two_scale>()
   , model(model_)
   , qedqcd(qedqcd_)
   , new_g1(0.)
...
void HSSUSY_low_scale_constraint<Two_scale>::apply()
{
   assert(model && "Error: HSSUSY_low_scale_constraint::apply():"
...
const Eigen::Matrix<std::complex<double>,3,3>& HSSUSY_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& HSSUSY_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double HSSUSY_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double HSSUSY_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void HSSUSY_low_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
   model = cast_model<HSSUSY<Two_scale>*>(model_);
}

void HSSUSY_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& HSSUSY_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void HSSUSY_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
...
void HSSUSY_low_scale_constraint<Two_scale>::initialize()
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
...
void HSSUSY_low_scale_constraint<Two_scale>::update_scale()
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
...
void HSSUSY_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
...
double HSSUSY_low_scale_constraint<Two_scale>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
...
void HSSUSY_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
...
double HSSUSY_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
...
void HSSUSY_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
...
void HSSUSY_low_scale_constraint<Two_scale>::calculate_Ye_DRbar()
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
 ...
 */
double HSSUSY_low_scale_constraint<Two_scale>::recalculate_mw_pole(double mw_pole)
{
   assert(model && "HSSUSY_low_scale_constraint<Two_scale>::"
