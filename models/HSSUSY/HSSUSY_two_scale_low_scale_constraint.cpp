...
void HSSUSY_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
double HSSUSY_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();
   ...
   HSSUSY_weinberg_angle::Sm_parameters sm_pars;
...
double HSSUSY_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
{
   if (!model)
      throw SetupError("HSSUSY_low_scale_constraint<Two_scale>: "
