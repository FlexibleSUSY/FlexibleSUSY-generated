...
/**
 * @file HSSUSY_mass_eigenstates_interface.hpp
 *
...
#ifndef HSSUSY_MASS_EIGENSTATES_INTERFACE_H
#define HSSUSY_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class HSSUSY_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class HSSUSY_mass_eigenstates_interface {
public:
   virtual ~HSSUSY_mass_eigenstates_interface() {}

   virtual std::unique_ptr<HSSUSY_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const HSSUSY_input_parameters& get_input_parameters() const = 0;
   virtual HSSUSY_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const HSSUSY_physical& get_physical() const = 0;
   virtual HSSUSY_physical& get_physical() = 0;
   ...
   virtual void set_physical(const HSSUSY_physical&) = 0;
