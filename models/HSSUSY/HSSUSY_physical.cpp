...
// File generated at Mon 27 Feb 2017 13:25:40
 ...
 * to be complex.
 */
void HSSUSY_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void HSSUSY_physical::convert_to_slha()
{

}

Eigen::ArrayXd HSSUSY_physical::get() const
{
...
void HSSUSY_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd HSSUSY_physical::get_masses() const
{
...
void HSSUSY_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHp = pars(1);
   MFv(0) = pars(2);
...
void HSSUSY_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const HSSUSY_physical& phys_pars)
{
