...
HSSUSY_slha::HSSUSY_slha(const HSSUSY_input_parameters& input_,
 ...
 */
HSSUSY_slha::HSSUSY_slha(const HSSUSY_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : HSSUSY_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void HSSUSY_slha::clear()
{
   HSSUSY_mass_eigenstates::clear();
   physical_slha.clear();
}

void HSSUSY_slha::calculate_spectrum()
{
   HSSUSY_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void HSSUSY_slha::convert_to_slha()
{
...
void HSSUSY_slha::calculate_ckm_matrix()
{
...
void HSSUSY_slha::calculate_pmns_matrix()
{
 ...
 */
void HSSUSY_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void HSSUSY_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void HSSUSY_slha::convert_soft_squared_masses_to_slha()
{

}

const HSSUSY_physical& HSSUSY_slha::get_physical_slha() const
{
   return physical_slha;
}

HSSUSY_physical& HSSUSY_slha::get_physical_slha()
{
   return physical_slha;
}

void HSSUSY_slha::print(std::ostream& ostr) const
{
   HSSUSY_mass_eigenstates::print(ostr);
...
void HSSUSY_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const HSSUSY_slha& model)
{
   model.print(ostr);
   return ostr;
}
