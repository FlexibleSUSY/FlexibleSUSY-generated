...
// File generated at Sun 18 Oct 2015 11:24:56
 ...
 */
template <class T>
void HSSUSY_spectrum_generator<T>::run(const softsusy::QedQcd& oneset,
                                const HSSUSY_input_parameters& input)
{
   ...
   HSSUSY_initial_guesser<T> initial_guesser(&model, oneset,
                                                  low_scale_constraint,
                                                  susy_scale_constraint,
                                                  high_scale_constraint);
