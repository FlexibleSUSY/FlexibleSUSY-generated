...
// File generated at Mon 27 Feb 2017 13:25:42
                                ...
                                const HSSUSY_input_parameters& input)
{
   ...
   HSSUSY_high_scale_constraint<T> high_scale_constraint(&model);
   HSSUSY_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   HSSUSY_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
