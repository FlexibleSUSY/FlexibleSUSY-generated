...
public:
   ...
   void set_extra(const HSSUSY_slha&, const HSSUSY_scales&, const HSSUSY_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const HSSUSY_scales&, const HSSUSY_observables&);
