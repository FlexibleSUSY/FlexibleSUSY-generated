...
public:
   ...
   void set_extra(const HSSUSY_slha&, const HSSUSY_scales&, const HSSUSY_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const HSSUSY_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const HSSUSY_scales&, const HSSUSY_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, HSSUSY_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const HSSUSY_slha&);
...
void HSSUSY_slha_io::fill(
   ...
   HSSUSY_decays const * const decays)
{
