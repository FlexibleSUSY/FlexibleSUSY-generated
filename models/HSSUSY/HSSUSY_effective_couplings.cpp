...
// File generated at Tue 10 Oct 2017 21:31:39
...
std::complex<double> HSSUSY_effective_couplings::CpbarFdFdAhPL(int gI1, int gI2) const
{
...
std::complex<double> HSSUSY_effective_couplings::CpbarFeFeAhPL(int gI1, int gI2) const
{
...
std::complex<double> HSSUSY_effective_couplings::CpbarFuFuAhPL(int gI1, int gI2) const
{
...
double HSSUSY_effective_couplings::CphhconjVWpVWp() const
{
...
std::complex<double> HSSUSY_effective_couplings::CpbarFdFdhhPL(int gI1, int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> HSSUSY_effective_couplings::CpbarFeFehhPL(int gI1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> HSSUSY_effective_couplings::CpbarFuFuhhPL(int gI1, int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
