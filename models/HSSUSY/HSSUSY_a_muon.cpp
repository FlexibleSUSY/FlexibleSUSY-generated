 ...
 *
 * This file was generated at Tue 22 Jan 2019 16:37:58 with FlexibleSUSY
...
double calculate_a_muon_impl(HSSUSY_mass_eigenstates& model)
{
   ...
   val += AMuonVertexCorrectionSF<typename conj<Hp>::type, Fv>::value(indices, context);
...
std::pair<double,double> vary_scale(const HSSUSY_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("HSSUSY_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double HSSUSY_a_muon::calculate_a_muon(const HSSUSY_mass_eigenstates& model_)
{
...
double HSSUSY_a_muon::calculate_a_muon_uncertainty(const HSSUSY_mass_eigenstates& model_)
{
   HSSUSY_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("HSSUSY_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
