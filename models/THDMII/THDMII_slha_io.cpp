...
THDMII_slha_io::THDMII_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void THDMII_slha_io::clear()
{
   slha_io.clear();
}
 ...
 */
void THDMII_slha_io::set_extpar(const THDMII_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void THDMII_slha_io::set_imminpar(const THDMII_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void THDMII_slha_io::set_imextpar(const THDMII_input_parameters& input)
{
 ...
 */
void THDMII_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void THDMII_slha_io::set_minpar(const THDMII_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void THDMII_slha_io::set_input(const THDMII_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void THDMII_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void THDMII_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void THDMII_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void THDMII_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void THDMII_slha_io::set_unitarity_infinite_s(
 ...
 */
void THDMII_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void THDMII_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void THDMII_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void THDMII_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, THDMII_info::model_name)
 ...
 */
void THDMII_slha_io::set_mass(const THDMII_physical& physical,
 ...
 */
void THDMII_slha_io::set_mixing_matrices(const THDMII_physical& physical,
...
void THDMII_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void THDMII_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void THDMII_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void THDMII_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void THDMII_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, THDMII_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void THDMII_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = THDMII_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + THDMII_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void THDMII_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
   ...
   if (spectrum_generator_settings.get(Spectrum_generator_settings::calculate_observables)) {
      {
         ...
         block << "Block FlexibleSUSYLowEnergy Q= " << FORMAT_SCALE(model.get_scale()) << '\n'
               ...
               << FORMAT_ELEMENT(22, (OBSERVABLES.amm_uncertainty_Fe_1), "uncertainty of Delta(g-2)/2 of Fe(2) (calculated with FlexibleSUSY)")
               << FORMAT_ELEMENT(26, (OBSERVABLES.a_muon_gm2calc), "Delta(g-2)_muon/2 GM2Calc")
               << FORMAT_ELEMENT(27, (OBSERVABLES.a_muon_gm2calc_uncertainty), "Delta(g-2)_muon/2 GM2Calc uncertainty")
         ;
         slha_io.set_block(block);
      }
   }
 ...
 */
void THDMII_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double THDMII_slha_io::get_parameter_output_scale() const
{
 ...
 */
void THDMII_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void THDMII_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void THDMII_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void THDMII_slha_io::fill_drbar_parameters(THDMII_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void THDMII_slha_io::fill(THDMII_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   THDMII_physical physical_hk;
 ...
 */
void THDMII_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void THDMII_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void THDMII_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void THDMII_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void THDMII_slha_io::fill_minpar_tuple(THDMII_input_parameters& input,
...
void THDMII_slha_io::fill_extpar_tuple(THDMII_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void THDMII_slha_io::fill_imminpar_tuple(THDMII_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void THDMII_slha_io::fill_imextpar_tuple(THDMII_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void THDMII_slha_io::fill_physical(THDMII_physical& physical) const
{
   {
 ...
 */
double THDMII_slha_io::read_scale() const
{
