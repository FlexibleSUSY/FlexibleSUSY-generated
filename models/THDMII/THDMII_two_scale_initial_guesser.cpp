...
#include "THDMII_two_scale_initial_guesser.hpp"
...
THDMII_initial_guesser<Two_scale>::THDMII_initial_guesser(
   THDMII<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const THDMII_low_scale_constraint<Two_scale>& low_constraint_,
   const THDMII_susy_scale_constraint<Two_scale>& susy_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("THDMII_initial_guesser: Error: pointer to model"
                       " THDMII<Two_scale> must not be zero");
}
 ...
 */
void THDMII_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void THDMII_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void THDMII_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void THDMII_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void THDMII_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void THDMII_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void THDMII_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto v1 = MODELPARAMETER(v1);
 ...
 */
void THDMII_initial_guesser<Two_scale>::guess_soft_parameters()
{
