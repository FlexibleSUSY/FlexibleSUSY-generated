...
// File generated at Sun 26 Aug 2018 14:09:10
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda4_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda4 = Re(twoLoop*(-80*Lambda1*Lambda3*Lambda4 - 80*Lambda2*Lambda3*
      ...
      + 7.065*Lambda4*Quad(g1) - 28.875*Lambda4*Quad(g2) + 4.8*Lambda1*Lambda4*
      ...
      8.4*AbsSqr(Lambda7)*Sqr(g1) + 2.4*Lambda6*Conj(Lambda7)*Sqr(g1) - 8.4*
      Quad(g2)*Sqr(g1) + 36*Lambda3*Lambda4*Sqr(g2) + 11.25*Lambda4*
      traceYdAdjYd*Sqr(g2) + 3.75*Lambda4*traceYeAdjYe*Sqr(g2) + 11.25*Lambda4*
      traceYuAdjYu*Sqr(g2) + 54*AbsSqr(Lambda7)*Sqr(g2) - 13.14*Quad(g1)*Sqr(g2
      ) + 6*Lambda1*Sqr(g1)*Sqr(g2) + 6*Lambda2*Sqr(g1)*Sqr(g2) + 1.2*Lambda3*
      Sqr(g1)*Sqr(g2) + 7.65*Lambda4*Sqr(g1)*Sqr(g2) + 5.4*traceYdAdjYd*Sqr(g1)
      *Sqr(g2) + 6.6*traceYeAdjYe*Sqr(g1)*Sqr(g2) + 12.6*traceYuAdjYu*Sqr(g1)*
      Sqr(g2) + Conj(Lambda6)*(-2*(36*Lambda3*Lambda6 + 34*Lambda4*Lambda6 + 20
      *Lambda3*Lambda7 + 40*Lambda4*Lambda7 + 10*Lambda2*(Lambda6 + Lambda7) +
      2*Lambda1*(37*Lambda6 + 5*Lambda7) + 30*Lambda6*traceYdAdjYd + 3*Lambda7*
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda4_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda4_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
