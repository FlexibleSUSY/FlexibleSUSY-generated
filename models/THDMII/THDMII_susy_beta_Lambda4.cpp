...
// File generated at Mon 5 Mar 2018 17:34:15
...
double THDMII_susy_parameters::calc_beta_Lambda4_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda4 = Re(twoLoop*(-80*Lambda1*Lambda3*Lambda4 - 80*Lambda2*
      ...
      *traceYeAdjYe - 4.5*Lambda4*traceYeAdjYeYeAdjYe - 24*Lambda2*Lambda4*
      ...
      - 0.045*Quad(g1)*(-157*Lambda4 + 292*Sqr(g2)) + 40*Lambda4*traceYdAdjYd*
      ...
      *Sqr(Lambda5) - 148*Lambda1*Sqr(Lambda6) - 20*Lambda2*Sqr(Lambda6) - 72*
      ...
      Lambda4*traceYeAdjYe - 85*Lambda4*traceYuAdjYu + 168*Quad(g2) - 3*(40*
