 ...
 */
double THDMII_soft_parameters::calc_beta_M112_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_M112 = Re(0.1*(120*Lambda1*M112 + 40*Lambda3*M222 + 20*Lambda4*M222 +
      ...
      Lambda6*Conj(M122) - 9*M112*Sqr(g1) - 45*M112*Sqr(g2)));
 ...
 */
double THDMII_soft_parameters::calc_beta_M112_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_M112 = Re(0.0025*(-800*Lambda3*Lambda4*M112 + 4200*Lambda5*Lambda6*M122
       + 1800*Lambda5*Lambda7*M122 - 3200*Lambda3*Lambda4*M222 - 28800*Lambda1*
      M112*traceYdAdjYd - 5400*M112*traceYdAdjYdYdAdjYd - 1800*M112*
      traceYdAdjYuYuAdjYd - 9600*Lambda1*M112*traceYeAdjYe - 1800*M112*
      ...
      Lambda6)*Conj(M122) + 1800*Conj(Lambda5)*Conj(Lambda7)*Conj(M122) + 1737*
      M112*Quad(g1) + 360*M222*Quad(g1) - 3075*M112*Quad(g2) + 3000*M222*Quad(
      ...
      *M222*Sqr(g1) + 500*M112*traceYdAdjYd*Sqr(g1) + 1500*M112*traceYeAdjYe*
      ...
      (Lambda3) - 800*M112*Sqr(Lambda4) - 3200*M222*Sqr(Lambda4)));
 ...
 */
double THDMII_soft_parameters::calc_beta_M112_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double THDMII_soft_parameters::calc_beta_M112_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double THDMII_soft_parameters::calc_beta_M112_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
