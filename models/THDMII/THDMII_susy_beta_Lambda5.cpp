 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda5_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda5 = Re(0.2*(20*Lambda1*Lambda5 + 20*Lambda2*Lambda5 + 40*Lambda3*
      ...
      9*Lambda5*Sqr(g1) - 45*Lambda5*Sqr(g2) + 50*Sqr(Conj(Lambda6)) + 50*Sqr(
      Conj(Lambda7))));
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda5_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda5 = Re(0.005*(-16000*Lambda1*Lambda3*Lambda5 - 16000*Lambda2*
      Lambda3*Lambda5 - 17600*Lambda1*Lambda4*Lambda5 - 17600*Lambda2*Lambda4*
      Lambda5 - 15200*Lambda3*Lambda4*Lambda5 - 4800*Lambda1*Lambda5*
      ...
      ) - 2400*traceYuAdjYu*Conj(Lambda6)*Conj(Lambda7) + 1413*Lambda5*Quad(g1)
      + 90*traceYdAdjYd*Quad(g1) - 450*traceYeAdjYe*Quad(g1) - 5775*Lambda5*
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda5_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda5_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double THDMII_susy_parameters::calc_beta_Lambda5_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
