...
// File generated at Wed 16 Oct 2019 21:27:49
 ...
 */
Eigen::Matrix<double,3,3> THDMII_susy_parameters::calc_beta_Yd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> THDMII_susy_parameters::calc_beta_Yd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_Yd = (twoLoop*(-0.0016666666666666668*Yd*(-600*Lambda3*Lambda4 + 4050*
      ...
      *Quad(g1) + 3150*Quad(g2) + 64800*Quad(g3) - 375*traceYdAdjYd*Sqr(g1) -
      1125*traceYeAdjYe*Sqr(g1) - 3375*traceYdAdjYd*Sqr(g2) - 1125*traceYeAdjYe
      *Sqr(g2) + 810*Sqr(g1)*Sqr(g2) - 12000*traceYdAdjYd*Sqr(g3) - 1240*Sqr(g1
      )*Sqr(g3) - 5400*Sqr(g2)*Sqr(g3) - 3600*Sqr(Lambda1) - 600*Sqr(Lambda3) -
      600*Sqr(Lambda4)) + 0.0125*(-960*Lambda1 - 540*traceYdAdjYd - 180*
      traceYeAdjYe + 187*Sqr(g1) + 675*Sqr(g2) + 1280*Sqr(g3))*(Yd*Yd.adjoint()
 ...
 */
Eigen::Matrix<double,3,3> THDMII_susy_parameters::calc_beta_Yd_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> THDMII_susy_parameters::calc_beta_Yd_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> THDMII_susy_parameters::calc_beta_Yd_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
