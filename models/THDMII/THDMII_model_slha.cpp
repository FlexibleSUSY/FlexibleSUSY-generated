...
THDMII_slha::THDMII_slha(const THDMII_input_parameters& input_,
                                   bool do_convert_masses_to_slha)
   : THDMII_mass_eigenstates(input_)
 ...
 */
THDMII_slha::THDMII_slha(const THDMII_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : THDMII_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void THDMII_slha::clear()
{
   THDMII_mass_eigenstates::clear();
   physical_slha.clear();
}

void THDMII_slha::calculate_spectrum()
{
   THDMII_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void THDMII_slha::convert_to_slha()
{
...
void THDMII_slha::calculate_ckm_matrix()
{
...
void THDMII_slha::calculate_pmns_matrix()
{
 ...
 */
void THDMII_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void THDMII_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void THDMII_slha::convert_soft_squared_masses_to_slha()
{

}

const THDMII_physical& THDMII_slha::get_physical_slha() const
{
   return physical_slha;
}

THDMII_physical& THDMII_slha::get_physical_slha()
{
   return physical_slha;
}

void THDMII_slha::print(std::ostream& ostr) const
{
   THDMII_mass_eigenstates::print(ostr);
...
void THDMII_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const THDMII_slha& model)
{
   model.print(ostr);
   return ostr;
}
