...
public:
   ...
   THDMII_weinberg_angle(const THDMII_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDMII_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDMII_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
