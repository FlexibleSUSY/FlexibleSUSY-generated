...
// File generated at Fri 10 Apr 2020 19:45:47
...
Eigen::ArrayXd THDMII_input_parameters::get() const
{
...
void THDMII_input_parameters::set(const Eigen::ArrayXd& pars)
{
   Lambda1IN = pars(0);
   Lambda2IN = pars(1);
   Lambda3IN = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const THDMII_input_parameters& input)
{
