...
// File generated at Wed 16 Oct 2019 21:27:37
...
#define CLASSNAME THDMII_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int THDMII_susy_parameters::numberOfParameters;

THDMII_susy_parameters::THDMII_susy_parameters(const THDMII_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

THDMII_susy_parameters::THDMII_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const THDMII_input_parameters& input_
...
Eigen::ArrayXd THDMII_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

THDMII_susy_parameters THDMII_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return THDMII_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
THDMII_susy_parameters THDMII_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void THDMII_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd THDMII_susy_parameters::get() const
{
...
void THDMII_susy_parameters::print(std::ostream& ostr) const
{
...
void THDMII_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const THDMII_input_parameters& THDMII_susy_parameters::get_input() const
{
   return input;
}

THDMII_input_parameters& THDMII_susy_parameters::get_input()
{
   return input;
}

void THDMII_susy_parameters::set_input_parameters(const THDMII_input_parameters& input_)
{
   input = input_;
}

THDMII_susy_parameters::Susy_traces THDMII_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const THDMII_susy_parameters& susy_pars)
{
