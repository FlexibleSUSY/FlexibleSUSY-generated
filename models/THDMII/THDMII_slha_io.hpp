...
public:
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const THDMII_scales&, const THDMII_observables&, const Spectrum_generator_settings&);
...
private:
   ...
   void set_model_parameters(const THDMII_slha&);
