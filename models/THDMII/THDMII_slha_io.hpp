...
public:
   ...
   void fill(THDMII_input_parameters&) const;
   void fill(THDMII_mass_eigenstates&) const;
   template <class Model> void fill(THDMII_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const THDMII_slha<Model>&, const THDMII_scales&, const THDMII_observables&);
   ...
   template <class Model> void set_spectrum(const THDMII_slha<Model>&);
   template <class T> void set_spectrum(const THDMII<T>&);
   ...
   static void fill_minpar_tuple(THDMII_input_parameters&, int, double);
   static void fill_extpar_tuple(THDMII_input_parameters&, int, double);
   ...
   static void fill_slhaea(SLHAea::Coll&, const THDMII_slha<Model>&, const softsusy::QedQcd&, const THDMII_scales&, const THDMII_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const THDMII_slha<Model>&, const softsusy::QedQcd&, const THDMII_scales&, const THDMII_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const THDMII_input_parameters&);
   void set_imminpar(const THDMII_input_parameters&);
   void set_imextpar(const THDMII_input_parameters&);
   void set_minpar(const THDMII_input_parameters&);
   void set_mass(const THDMII_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const THDMII_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const THDMII_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(THDMII_mass_eigenstates&) const;
   void fill_physical(THDMII_physical&) const;
};
 ...
 */
template <class Model>
void THDMII_slha_io::fill(THDMII_slha<Model>& model) const
{
...
template <class Model>
void THDMII_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const THDMII_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const THDMII_scales& scales,
   const THDMII_observables& observables)
{
   THDMII_slha_io slha_io;
   const THDMII_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll THDMII_slha_io::fill_slhaea(
   const THDMII_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const THDMII_scales& scales, const THDMII_observables& observables)
{
   SLHAea::Coll slhaea;
   THDMII_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void THDMII_slha_io::set_model_parameters(const THDMII_slha<Model>& model)
{
   {
...
void THDMII_slha_io::set_extra(
   const THDMII_slha<Model>& model, const THDMII_scales& scales,
   const THDMII_observables& observables)
{
 ...
 */
template <class... Ts>
void THDMII_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<THDMII_slha_io> ss(this);
 ...
 */
template <class T>
void THDMII_slha_io::set_spectrum(const THDMII<T>& model)
{
   set_spectrum(THDMII_slha<THDMII<T> >(model));
}
 ...
 */
template <class Model>
void THDMII_slha_io::set_spectrum(const THDMII_slha<Model>& model)
{
   const THDMII_physical physical(model.get_physical_slha());
