...
int run_solver(const THDMII_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(THDMII_slha_io::fill_slhaea(
...
int run(int solver_type, const THDMII_input_parameters& input)
{
   int exit_code = 0;
