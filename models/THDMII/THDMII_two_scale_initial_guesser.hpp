...
#ifndef THDMII_TWO_SCALE_INITIAL_GUESSER_H
#define THDMII_TWO_SCALE_INITIAL_GUESSER_H

#include "THDMII_initial_guesser.hpp"
...
/**
 * @class THDMII_initial_guesser<Two_scale>
 * @brief initial guesser for the THDMII
 */

template<>
class THDMII_initial_guesser<Two_scale> : public Initial_guesser {
public:
   THDMII_initial_guesser(THDMII<Two_scale>*,
                               const softsusy::QedQcd&,
                               const THDMII_low_scale_constraint<Two_scale>&,
                               const THDMII_susy_scale_constraint<Two_scale>&);
   virtual ~THDMII_initial_guesser() = default;
   virtual void guess() override; ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   THDMII<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   THDMII_low_scale_constraint<Two_scale> low_constraint{};
   THDMII_susy_scale_constraint<Two_scale> susy_constraint{};
