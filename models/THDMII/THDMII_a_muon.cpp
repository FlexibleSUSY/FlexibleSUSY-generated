...
// File generated at Mon 5 Mar 2018 17:35:16

/**
 * @file THDMII_a_muon.cpp
 *
 * This file was generated at Mon 5 Mar 2018 17:35:16 with FlexibleSUSY
...
#include "THDMII_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(THDMII_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const THDMII_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("THDMII_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double THDMII_a_muon::calculate_a_muon(const THDMII_mass_eigenstates& model_)
{
...
double THDMII_a_muon::calculate_a_muon_uncertainty(const THDMII_mass_eigenstates& model_)
{
   THDMII_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("THDMII_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
