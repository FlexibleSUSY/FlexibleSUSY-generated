 ...
 * to be complex.
 */
void THDMII_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void THDMII_physical::convert_to_slha()
{

}

Eigen::ArrayXd THDMII_physical::get() const
{
...
void THDMII_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd THDMII_physical::get_masses() const
{
...
void THDMII_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MFv(0) = pars(1);
   MFv(1) = pars(2);
...
void THDMII_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const THDMII_physical& phys_pars)
{
