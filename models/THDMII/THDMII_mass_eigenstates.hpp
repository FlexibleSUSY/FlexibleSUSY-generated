 ...
 */
class THDMII_mass_eigenstates : public THDMII_soft_parameters {
public:
   ...
   void set_physical(const THDMII_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const THDMII_physical& get_physical() const;
   THDMII_physical& get_physical();
