...
// File generated at Mon 5 Mar 2018 17:35:09
...
#define CLASSNAME THDMII_weinberg_angle
 ...
 */
CLASSNAME::THDMII_weinberg_angle(
...
void CLASSNAME::set_model(const THDMII_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * THDMII_info::normalization_g1;
   const double g2 = MODEL->get_g2() * THDMII_info::normalization_g2;
