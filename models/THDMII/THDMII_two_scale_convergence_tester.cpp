...
THDMII_convergence_tester<Two_scale>::THDMII_convergence_tester(
   THDMII<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<THDMII<Two_scale> >(model, accuracy_goal, sg)
{
}

double THDMII_convergence_tester<Two_scale>::max_rel_diff() const
{
   const THDMII<Two_scale>& ol = get_last_iteration_model();
   const THDMII<Two_scale>& ne = get_current_iteration_model();
