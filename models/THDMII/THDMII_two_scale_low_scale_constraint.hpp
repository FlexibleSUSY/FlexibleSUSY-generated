...
#ifndef THDMII_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define THDMII_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "THDMII_low_scale_constraint.hpp"
...
template<>
class THDMII_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   THDMII_low_scale_constraint() = default;
   THDMII_low_scale_constraint(THDMII<Two_scale>*, const softsusy::QedQcd&);
   virtual ~THDMII_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "THDMII low-scale constraint"; }
