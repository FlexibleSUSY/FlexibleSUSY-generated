...
// File generated at Sun 26 Aug 2018 14:09:54
...
class THDMII_slha : public Model {
public:
   explicit THDMII_slha(const THDMII_input_parameters& input_ = THDMII_input_parameters());
   explicit THDMII_slha(const Model&, bool do_convert_masses_to_slha = true);
...
template <class Model>
THDMII_slha<Model>::THDMII_slha(const THDMII_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
THDMII_slha<Model>::THDMII_slha(const Model& model_,
...
template <class Model>
void THDMII_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void THDMII_slha<Model>::convert_to_slha()
{
...
template <class Model>
void THDMII_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void THDMII_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void THDMII_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDMII_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void THDMII_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const THDMII_physical& THDMII_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
THDMII_physical& THDMII_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void THDMII_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void THDMII_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const THDMII_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
