...
#define CLASSNAME THDMII_mass_eigenstates
...
CLASSNAME::THDMII_mass_eigenstates(const THDMII_input_parameters& input_)
   : THDMII_soft_parameters(input_)
...
const THDMII_physical& CLASSNAME::get_physical() const
{
   return physical;
}

THDMII_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const THDMII_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<THDMII_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("THDMII_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("THDMII_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("THDMII_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving THDMII EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "THDMII\n"
           "========================================\n";
   THDMII_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(THDMII_info::hh, eigenvalue_error > precision *
      Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDMII_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(THDMII_info::Ah, eigenvalue_error > precision *
      Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDMII_info::Ah);
   }
...
void CLASSNAME::calculate_MHm()
{
   ...
   if (MHm.minCoeff() < 0.) {
      problems.flag_running_tachyon(THDMII_info::Hm);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(THDMII_info::Fd, eigenvalue_error > precision *
      Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(THDMII_info::Fu, eigenvalue_error > precision *
      Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(THDMII_info::Fe, eigenvalue_error > precision *
      Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(THDMII_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(THDMII_info::VZ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(THDMII_info::hh))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            problems.flag_bad_mass(THDMII_info::hh,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(THDMII_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(THDMII_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(THDMII_info::Ah))
      return;
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            problems.flag_bad_mass(THDMII_info::Ah,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZA);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(THDMII_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(THDMII_info::Ah);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(THDMII_info::Fd, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(THDMII_info::Fu, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(THDMII_info::Fe, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
{
   if (!force_output && problems.is_running_tachyon(THDMII_info::VWm))
      return;
...
std::ostream& operator<<(std::ostream& ostr, const THDMII_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
