 ...
 */
template<>
class THDMII<Two_scale> : public Model, public THDMII_slha {
public:
   explicit THDMII(const THDMII_input_parameters& input_ = THDMII_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit THDMII(const THDMII_slha&, bool do_convert_masses_to_slha = true);
