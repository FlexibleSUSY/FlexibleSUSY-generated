...
public:
   ...
   THDMII_susy_parameters& operator=(const THDMII_susy_parameters&) = default;
   THDMII_susy_parameters& operator=(THDMII_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const THDMII_input_parameters& get_input() const;
   THDMII_input_parameters& get_input();
   void set_input_parameters(const THDMII_input_parameters&);

   THDMII_susy_parameters calc_beta() const;
   THDMII_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const THDMII_susy_parameters&);
