...
#ifndef THDMII_DECAY_TABLE_H
#define THDMII_DECAY_TABLE_H
...
public:
   ...
   THDMII_decay_table();
   ~THDMII_decay_table() = default;
   THDMII_decay_table(const THDMII_decay_table&) = default;
   THDMII_decay_table(THDMII_decay_table&&) = default;
   THDMII_decay_table& operator=(const THDMII_decay_table&) = default;
   THDMII_decay_table& operator=(THDMII_decay_table&&) = default;
   ...
   Decays_list& get_Hm_decays(int);
   const Decays_list& get_Hm_decays(int) const;
...
std::ostream& operator<<(std::ostream&, const THDMII_decay_table&);
