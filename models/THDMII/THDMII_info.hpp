...
#ifndef THDMII_INFO_H
#define THDMII_INFO_H
...
namespace THDMII_info {
   ...
   class THDMII_particle_names : public Names {
   public:
      virtual ~THDMII_particle_names() = default;
   ...
   class THDMII_parameter_names : public Names {
   public:
      virtual ~THDMII_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const THDMII_particle_names  particle_names_getter{};
   const THDMII_parameter_names parameter_names_getter{};
