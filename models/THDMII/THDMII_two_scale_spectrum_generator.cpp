...
// File generated at Sun 26 Aug 2018 14:10:08

#include "THDMII_two_scale_spectrum_generator.hpp"
#include "THDMII_input_parameters.hpp"
#include "THDMII_two_scale_convergence_tester.hpp"
...
double THDMII_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void THDMII_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const THDMII_input_parameters& input)
{
   ...
   THDMII_susy_scale_constraint<Two_scale> susy_scale_constraint(&model, qedqcd);
   THDMII_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);
   ...
   THDMII_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void THDMII_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   THDMII_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_susy_scale());
}

void THDMII_spectrum_generator<Two_scale>::calculate_spectrum()
{
