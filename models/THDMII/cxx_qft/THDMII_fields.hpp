...
/**
 * @file cxx_qft/THDMII_fields.hpp
 *
 * This file was generated with FlexibleSUSY 2.8.0 and SARAH 4.15.1 .
 */

#ifndef THDMII_CXXQFT_FIELDS_H
#define THDMII_CXXQFT_FIELDS_H
...
template<> struct conj<flexiblesusy::THDMII_cxx_diagrams::fields::VG> { using type = flexiblesusy::THDMII_cxx_diagrams::fields::VG; };
template<> struct conj<flexiblesusy::THDMII_cxx_diagrams::fields::VP> { using type = flexiblesusy::THDMII_cxx_diagrams::fields::VP; };
template<> struct conj<flexiblesusy::THDMII_cxx_diagrams::fields::VZ> { using type = flexiblesusy::THDMII_cxx_diagrams::fields::VZ; };
template<> struct conj<flexiblesusy::THDMII_cxx_diagrams::fields::hh> { using type = flexiblesusy::THDMII_cxx_diagrams::fields::hh; };
template<> struct conj<flexiblesusy::THDMII_cxx_diagrams::fields::Ah> { using type = flexiblesusy::THDMII_cxx_diagrams::fields::Ah; };



template<>
struct is_vector<flexiblesusy::THDMII_cxx_diagrams::fields::VG > : public std::true_type {};
template<>
struct is_ghost<flexiblesusy::THDMII_cxx_diagrams::fields::gG > : public std::true_type {};
template<>
struct is_fermion<flexiblesusy::THDMII_cxx_diagrams::fields::Fv > : public std::true_type {};
template<>
struct is_vector<flexiblesusy::THDMII_cxx_diagrams::fields::VP > : public std::true_type {};
template<>
struct is_vector<flexiblesusy::THDMII_cxx_diagrams::fields::VZ > : public std::true_type {};
template<>
struct is_ghost<flexiblesusy::THDMII_cxx_diagrams::fields::gP > : public std::true_type {};
template<>
struct is_ghost<flexiblesusy::THDMII_cxx_diagrams::fields::gZ > : public std::true_type {};
template<>
struct is_ghost<flexiblesusy::THDMII_cxx_diagrams::fields::gWm > : public std::true_type {};
template<>
struct is_ghost<flexiblesusy::THDMII_cxx_diagrams::fields::gWmC > : public std::true_type {};
template<>
struct is_scalar<flexiblesusy::THDMII_cxx_diagrams::fields::hh > : public std::true_type {};
template<>
struct is_scalar<flexiblesusy::THDMII_cxx_diagrams::fields::Ah > : public std::true_type {};
template<>
struct is_scalar<flexiblesusy::THDMII_cxx_diagrams::fields::Hm > : public std::true_type {};
template<>
struct is_fermion<flexiblesusy::THDMII_cxx_diagrams::fields::Fd > : public std::true_type {};
template<>
struct is_fermion<flexiblesusy::THDMII_cxx_diagrams::fields::Fu > : public std::true_type {};
template<>
struct is_fermion<flexiblesusy::THDMII_cxx_diagrams::fields::Fe > : public std::true_type {};
template<>
struct is_vector<flexiblesusy::THDMII_cxx_diagrams::fields::VWm > : public std::true_type {};
