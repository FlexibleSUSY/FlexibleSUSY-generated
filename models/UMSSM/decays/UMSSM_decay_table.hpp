...
#ifndef UMSSM_DECAY_TABLE_H
#define UMSSM_DECAY_TABLE_H
...
public:
   ...
   UMSSM_decay_table();
   ~UMSSM_decay_table() = default;
   UMSSM_decay_table(const UMSSM_decay_table&) = default;
   UMSSM_decay_table(UMSSM_decay_table&&) = default;
   UMSSM_decay_table& operator=(const UMSSM_decay_table&) = default;
   UMSSM_decay_table& operator=(UMSSM_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const UMSSM_decay_table&);
