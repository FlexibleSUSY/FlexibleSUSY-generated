...
// File generated at Wed 29 Jun 2016 12:02:42
...
private:
   ...
   double calc_beta_MassU_one_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MassU_two_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MassU_three_loop(const TRACE_STRUCT_TYPE&) const;
