...
#ifndef UMSSM_TWO_SCALE_MATCHING_H
#define UMSSM_TWO_SCALE_MATCHING_H
...
template <class T> class UMSSM;
template <class T> class UMSSM_standard_model_Matching;
...
template<>
class UMSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   UMSSM_standard_model_Matching();

   UMSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       UMSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~UMSSM_standard_model_Matching();
