...
// File generated at Tue 10 Oct 2017 22:47:55
...
#define CLASSNAME UMSSM_weinberg_angle
 ...
 */
CLASSNAME::UMSSM_weinberg_angle(
...
void CLASSNAME::set_model(const UMSSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * UMSSM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * UMSSM_info::normalization_g2;
...
double CLASSNAME::calculate_rho_hat_tree() const
{
   ...
   rhohat_tree = (5*(0.6*Sqr(g1) + Sqr(g2))*Sqrt(3*Sqr(g1) + 5*Sqr(g2))*(Sqr(vd
      ) + Sqr(vu)))/(4*gp*Sin(ThetaWp)*(2.23606797749979*Cos(ThetaWp)*(3*Sqr(g1) +
      5*Sqr(g2))*(QHd*Sqr(vd) - QHu*Sqr(vu)) + 5*gp*Sin(ThetaWp)*Sqrt(3*Sqr(g1) +
      5*Sqr(g2))*(Sqr(QHd)*Sqr(vd) + Sqr(Qs)*Sqr(vS) + Sqr(QHu)*Sqr(vu))) +
      Power3(Sqrt(3*Sqr(g1) + 5*Sqr(g2)))*(Sqr(vd) + Sqr(vu))*Sqr(Cos(ThetaWp)));
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         + Sqr(vu))*(RHO2(MAh(2)/MT)*(Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2
         ))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1
         ,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,0,2,Conj(ZUL(
         2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(
         Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(0)/MT)*(Sqr(Abs(Conj(ZH(0,1)
         )*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(
         j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH
         (0,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) +
         SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(1
         )/MT)*(Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR
         (2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2
         ,j2))))) - Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj
         (ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*
         ZUL(2,j2)))))) - RHO2(Mhh(2)/MT)*(Sqr(Abs(Conj(ZH(2,1))*(SUM(j2,0,2,Conj(ZUL
         (2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(
         Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(2,1))*(SUM(j2,0,2,Conj
         (ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,
         Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))))))/(1 + PIZZTMZ/Sqr(MZ));
   }
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         MAh(2)/MT)*(Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,
         Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1
         ))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,
         0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(
         2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(0)/MT)*(Sqr(Abs(Conj(ZH(0,1))*(SUM(j2,0,2,
         Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0
         ,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(0,1))*(SUM(j2,
         0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(
         j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(1)/MT)*(Sqr(Abs(
         Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,
         j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr
         (Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu
         (j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))))
         - RHO2(Mhh(2)/MT)*(Sqr(Abs(Conj(ZH(2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,
         0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(
         2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(2,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM
         (j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*
         ZUR(2,j1))*ZUL(2,j2))))))));
   }
...
std::complex<double> CLASSNAME::CpChaFvconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -(g2*Conj(UM(gI1,0))*SUM(j1,0,2,Conj(ZVL
      (gO1,j1))*ZE(gI2,j1))) + Conj(UM(gI1,1))*SUM(j2,0,2,Conj(ZVL(gO1,j2))*SUM(j1
      ,0,2,Ye(j1,j2)*ZE(gI2,3 + j1)));

   return result;
}

std::complex<double> CLASSNAME::CpbarFvFvhhPL(int gI2, int gO1, int gI1) const
{
   const auto Yv = MODELPARAMETER(Yv);
   const auto ZH = MODELPARAMETER(ZH);
   const auto ZVR = MODELPARAMETER(ZVR);
   ...
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,1))*SUM(
      j2,0,2,Conj(ZVR(gI2,j2))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpChiFvconjSvPL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*Conj(ZN(gI1,0)
      )*SUM(j1,0,2,Conj(ZVL(gO1,j1))*ZV(gI2,j1)) + 0.5477225575051661*g1*Conj(ZN(
      gI1,1))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*ZV(gI2,j1)) - 0.7071067811865475*g2*
      Conj(ZN(gI1,2))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*ZV(gI2,j1)) - Conj(ZN(gI1,4))*
      SUM(j2,0,2,SUM(j1,0,2,Conj(ZVL(gO1,j1))*Yv(j1,j2))*ZV(gI2,3 + j2));

   return result;
}

std::complex<double> CLASSNAME::CpbarFvFvAhPL(int gI2, int gO1, int gI1) const
{
   const auto Yv = MODELPARAMETER(Yv);
   const auto ZA = MODELPARAMETER(ZA);
   const auto ZVR = MODELPARAMETER(ZVR);
   ...
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*Conj(ZA(gI1,1))*SUM(j2,0,2,Conj(ZVR(gI2,j2))*SUM(j1,0,2
      ,Conj(ZVL(gO1,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpbarChaFeconjSvPL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*SUM(j1,0,2,Conj(ZEL
      (gO1,j1))*ZV(gI2,j1))) + Conj(UP(gI1,1))*SUM(j2,0,2,SUM(j1,0,2,Conj(ZEL(gO1,
      j1))*Yv(j1,j2))*ZV(gI2,3 + j2));

   return result;
}

std::complex<double> CLASSNAME::CpbarFvFeconjHpmPL(int gI1, int gO1, int gI2) const
{
   const auto Yv = MODELPARAMETER(Yv);
   const auto ZVR = MODELPARAMETER(ZVR);
   const auto ZEL = MODELPARAMETER(ZEL);
   ...
   const std::complex<double> result = SUM(j2,0,2,Conj(ZVR(gI1,j2))*SUM(j1,0,2,
      Conj(ZEL(gO1,j1))*Yv(j1,j2)))*ZP(gI2,1);
...
std::complex<double> CLASSNAME::CpChiFeconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*Conj(ZN(gI1,0)
      )*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) + 0.5477225575051661*g1*Conj(ZN(
      gI1,1))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) + 0.7071067811865475*g2*
      Conj(ZN(gI1,2))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - Conj(ZN(gI1,3))*
      SUM(j2,0,2,Conj(ZEL(gO1,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI2,3 + j1)));

   return result;
}

std::complex<double> CLASSNAME::CpbarChabarFvSePR(int gI1, int gO2, int gI3) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Ye = MODELPARAMETER(Ye);
   const auto ZE = MODELPARAMETER(ZE);
   ...
   const std::complex<double> result = -(g2*SUM(j1,0,2,Conj(ZE(gI3,j1))*ZVL(gO2
      ,j1))*UM(gI1,0)) + SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI3,3 + j1)
      ))*ZVL(gO2,j2))*UM(gI1,1);

   return result;
}

std::complex<double> CLASSNAME::CpbarFvFvhhPR(int gO2, int gI1, int gI3) const
{
   const auto Yv = MODELPARAMETER(Yv);
   const auto ZH = MODELPARAMETER(ZH);
   const auto ZVL = MODELPARAMETER(ZVL);
   ...
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI3,1))*SUM(
      j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*ZVL(gO2,j1))*ZVR(gI1,j2));

   return result;
}

std::complex<double> CLASSNAME::CpbarFvFvAhPR(int gO2, int gI1, int gI3) const
{
   const auto Yv = MODELPARAMETER(Yv);
   const auto ZA = MODELPARAMETER(ZA);
   const auto ZVL = MODELPARAMETER(ZVL);
   ...
   const std::complex<double> result = std::complex<double>(0.,
      0.7071067811865475)*Conj(ZA(gI3,1))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*
      ZVL(gO2,j1))*ZVR(gI1,j2));

   return result;
}

std::complex<double> CLASSNAME::CpbarFvChiSvPR(int gO2, int gI1, int gI3) const
{
   const auto Ql = INPUTPARAMETER(Ql);
   const auto gp = MODELPARAMETER(gp);
   const auto g1 = MODELPARAMETER(g1);
   ...
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(ZV(
      gI3,j1))*ZVL(gO2,j1))*(2*gp*Ql*ZN(gI1,0) - 0.7745966692414834*g1*ZN(gI1,1) +
      g2*ZN(gI1,2)) - SUM(j2,0,2,Conj(ZV(gI3,3 + j2))*SUM(j1,0,2,Conj(Yv(j1,j2))*
      ZVL(gO2,j1)))*ZN(gI1,4);

   return result;
}

std::complex<double> CLASSNAME::CpbarFvFeconjHpmPR(int gO2, int gI3, int gI1) const
{
   const auto Ye = MODELPARAMETER(Ye);
   const auto ZER = MODELPARAMETER(ZER);
   const auto ZVL = MODELPARAMETER(ZVL);
   ...
   const std::complex<double> result = SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*
      ZER(gI3,j1))*ZVL(gO2,j2))*ZP(gI1,0);
...
std::complex<double> CLASSNAME::delta_vb_wave_Fv(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,-(AbsSqr(
      ...
      gI1,0,2,SUM(gI2,0,2,-(AbsSqr(CpbarFvFvhhPL(gI2,gO1,gI1))*B1(0,Sqr(MFv(gI2)),
      Sqr(Mhh(gI1)))))) + SUM(gI1,0,5,SUM(gI2,0,5,-(AbsSqr(CpChiFvconjSvPL(gI1,gO1
      ,gI2))*B1(0,Sqr(MChi(gI1)),Sqr(MSv(gI2)))))) + SUM(gI1,1,1,SUM(gI2,0,2,-(
      AbsSqr(CpbarFeFvHpmPL(gI2,gO1,gI1))*B1(0,Sqr(MFe(gI2)),Sqr(MHpm(gI1)))))) +
      SUM(gI1,2,2,SUM(gI2,0,2,-(AbsSqr(CpbarFvFvAhPL(gI2,gO1,gI1))*B1(0,Sqr(MFv(
      gI2)),Sqr(MAh(gI1))))));
...
std::complex<double> CLASSNAME::delta_vb_wave_Fe(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,-(AbsSqr(
      ...
      (gI1,0,2,SUM(gI2,0,2,-(AbsSqr(CpbarFeFehhPL(gI2,gO1,gI1))*B1(0,Sqr(MFe(gI2))
      ,Sqr(Mhh(gI1)))))) + SUM(gI1,0,2,SUM(gI2,1,1,-(AbsSqr(CpbarFvFeconjHpmPL(gI1
      ,gO1,gI2))*B1(0,Sqr(MFv(gI1)),Sqr(MHpm(gI2)))))) + SUM(gI1,0,5,SUM(gI2,0,5,-
      (AbsSqr(CpChiFeconjSePL(gI1,gO1,gI2))*B1(0,Sqr(MChi(gI1)),Sqr(MSe(gI2))))))
      + SUM(gI1,2,2,SUM(gI2,0,2,-(AbsSqr(CpbarFeFeAhPL(gI2,gO1,gI1))*B1(0,Sqr(MFe(
      gI2)),Sqr(MAh(gI1))))));
...
std::complex<double> CLASSNAME::delta_vb_vertex(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = (SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,5,
      ...
      + SUM(gI1,0,2,SUM(gI2,0,2,SUM(gI3,0,2,CpbarFeFehhPL(gI2,gO1,gI3)*
      CpbarFvFvhhPR(gO2,gI1,gI3)*(-(C0(Sqr(Mhh(gI3)),Sqr(MFv(gI1)),Sqr(MFe(gI2)))*
      CpbarFvFeconjVWmPL(gI1,gI2)*MFe(gI2)*MFv(gI1)) + 0.5*CpbarFvFeconjVWmPR(gI1,
      gI2)*(-0.5 + B0(0,Sqr(MFv(gI1)),Sqr(MFe(gI2))) + C0(Sqr(Mhh(gI3)),Sqr(MFv(
      gI1)),Sqr(MFe(gI2)))*Sqr(Mhh(gI3))))))) + SUM(gI1,0,2,SUM(gI2,0,2,SUM(gI3,2,
      2,CpbarFeFeAhPL(gI2,gO1,gI3)*CpbarFvFvAhPR(gO2,gI1,gI3)*(-(C0(Sqr(MAh(gI3)),
      Sqr(MFv(gI1)),Sqr(MFe(gI2)))*CpbarFvFeconjVWmPL(gI1,gI2)*MFe(gI2)*MFv(gI1))
      + 0.5*CpbarFvFeconjVWmPR(gI1,gI2)*(-0.5 + B0(0,Sqr(MFv(gI1)),Sqr(MFe(gI2)))
      + C0(Sqr(MAh(gI3)),Sqr(MFv(gI1)),Sqr(MFe(gI2)))*Sqr(MAh(gI3))))))) + SUM(gI1
      ,0,2,SUM(gI2,1,1,SUM(gI3,0,2,0.5*CpbarFvFeconjHpmPL(gI3,gO1,gI2)*
      CpbarFvFvhhPR(gO2,gI3,gI1)*CphhHpmconjVWm(gI1,gI2)*(0.5 + B0(0,Sqr(Mhh(gI1))
      ,Sqr(MHpm(gI2))) + C0(Sqr(MFv(gI3)),Sqr(Mhh(gI1)),Sqr(MHpm(gI2)))*Sqr(MFv(
      gI3)))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,5,CpbarChaFeconjSvPL(gI2,gO1,
      gI3)*CpbarFvChiSvPR(gO2,gI1,gI3)*(-(C0(Sqr(MSv(gI3)),Sqr(MChi(gI1)),Sqr(MCha
      (gI2)))*CpChiChaconjVWmPL(gI1,gI2)*MCha(gI2)*MChi(gI1)) + 0.5*
      CpChiChaconjVWmPR(gI1,gI2)*(-0.5 + B0(0,Sqr(MChi(gI1)),Sqr(MCha(gI2))) + C0(
      Sqr(MSv(gI3)),Sqr(MChi(gI1)),Sqr(MCha(gI2)))*Sqr(MSv(gI3))))))) + SUM(gI1,0,
      5,SUM(gI2,0,5,SUM(gI3,0,5,-0.5*CpbarFvChiSvPR(gO2,gI3,gI1)*CpChiFeconjSePL(
      gI3,gO1,gI2)*CpSeconjSvconjVWm(gI2,gI1)*(0.5 + B0(0,Sqr(MSv(gI1)),Sqr(MSe(
      gI2))) + C0(Sqr(MChi(gI3)),Sqr(MSv(gI1)),Sqr(MSe(gI2)))*Sqr(MChi(gI3)))))) +
      SUM(gI1,1,1,SUM(gI2,0,2,SUM(gI3,0,2,-0.5*CpbarFeFehhPL(gI3,gO1,gI2)*
      CpbarFvFeconjHpmPR(gO2,gI3,gI1)*CphhHpmconjVWm(gI2,gI1)*(0.5 + B0(0,Sqr(MHpm
      (gI1)),Sqr(Mhh(gI2))) + C0(Sqr(MFe(gI3)),Sqr(MHpm(gI1)),Sqr(Mhh(gI2)))*Sqr(
      MFe(gI3)))))) + SUM(gI1,1,1,SUM(gI2,2,2,SUM(gI3,0,2,-0.5*CpAhHpmconjVWm(gI2,
      gI1)*CpbarFeFeAhPL(gI3,gO1,gI2)*CpbarFvFeconjHpmPR(gO2,gI3,gI1)*(0.5 + B0(0,
      Sqr(MHpm(gI1)),Sqr(MAh(gI2))) + C0(Sqr(MFe(gI3)),Sqr(MHpm(gI1)),Sqr(MAh(gI2)
      ))*Sqr(MFe(gI3)))))) + SUM(gI1,2,2,SUM(gI2,1,1,SUM(gI3,0,2,0.5*
      CpAhHpmconjVWm(gI1,gI2)*CpbarFvFeconjHpmPL(gI3,gO1,gI2)*CpbarFvFvAhPR(gO2,
      gI3,gI1)*(0.5 + B0(0,Sqr(MAh(gI1)),Sqr(MHpm(gI2))) + C0(Sqr(MFv(gI3)),Sqr(
      MAh(gI1)),Sqr(MHpm(gI2)))*Sqr(MFv(gI3)))))))/CpbarFvFeconjVWmPL(gO2,gO1);
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,1,SUM(
      gI4,0,5,0.5*CpbarChabarFvSePR(gI3,gO2,gI2)*CpbarChaFeconjSvPL(gI1,gO1,gI4)*
      ...
      gI1,0,2,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,0,2,CpbarFeFehhPL(gI4,gO1,gI1)*
      CpbarFeFehhPR(gO4,gI4,gI3)*CpbarFvFvhhPL(gI2,gO3,gI3)*CpbarFvFvhhPR(gO2,gI2,
      gI1)*D27(Sqr(Mhh(gI1)),Sqr(MFv(gI2)),Sqr(Mhh(gI3)),Sqr(MFe(gI4))))))) + SUM(
      gI1,0,2,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,0,2,-(CpbarFeFehhPL(gI4,gO1,gI1)*
      CpbarFeFehhPR(gO4,gI4,gI3)*CpbarFvFvhhPL(gI2,gO3,gI1)*CpbarFvFvhhPR(gO2,gI2,
      gI3)*D27(Sqr(Mhh(gI1)),Sqr(MFv(gI2)),Sqr(Mhh(gI3)),Sqr(MFe(gI4)))))))) + SUM
      (gI1,0,2,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,1,1,-(CpbarFeFehhPR(gO4,gI3,gI2)*
      CpbarFeFvHpmPL(gI3,gO3,gI4)*CpbarFvFeconjHpmPL(gI1,gO1,gI4)*CpbarFvFvhhPR(
      gO2,gI1,gI2)*D27(Sqr(MFv(gI1)),Sqr(Mhh(gI2)),Sqr(MFe(gI3)),Sqr(MHpm(gI4)))))
      ))) + SUM(gI1,0,2,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,1,1,CpbarFeFvHpmPR(gO4,gI3
      ,gI4)*CpbarFvFeconjHpmPL(gI1,gO1,gI4)*CpbarFvFvhhPL(gI3,gO3,gI2)*
      CpbarFvFvhhPR(gO2,gI1,gI2)*D27(Sqr(MFv(gI1)),Sqr(Mhh(gI2)),Sqr(MFv(gI3)),Sqr
      (MHpm(gI4))))))) + SUM(gI1,0,2,SUM(gI2,0,2,SUM(gI3,2,2,SUM(gI4,0,2,-(
      CpbarFeFeAhPR(gO4,gI4,gI3)*CpbarFeFehhPL(gI4,gO1,gI1)*CpbarFvFvAhPR(gO2,gI2,
      gI3)*CpbarFvFvhhPL(gI2,gO3,gI1)*D27(Sqr(Mhh(gI1)),Sqr(MFv(gI2)),Sqr(MAh(gI3)
      ),Sqr(MFe(gI4)))))))) + SUM(gI1,0,2,SUM(gI2,0,2,SUM(gI3,2,2,SUM(gI4,0,2,
      CpbarFeFeAhPR(gO4,gI4,gI3)*CpbarFeFehhPL(gI4,gO1,gI1)*CpbarFvFvAhPL(gI2,gO3,
      gI3)*CpbarFvFvhhPR(gO2,gI2,gI1)*D27(Sqr(Mhh(gI1)),Sqr(MFv(gI2)),Sqr(MAh(gI3)
      ),Sqr(MFe(gI4))))))) + SUM(gI1,0,2,SUM(gI2,1,1,SUM(gI3,0,2,SUM(gI4,0,2,
      CpbarFeFehhPL(gI1,gO1,gI4)*CpbarFeFehhPR(gO4,gI3,gI4)*CpbarFeFvHpmPL(gI3,gO3
      ,gI2)*CpbarFvFeconjHpmPR(gO2,gI1,gI2)*D27(Sqr(MFe(gI1)),Sqr(MHpm(gI2)),Sqr(
      MFe(gI3)),Sqr(Mhh(gI4))))))) + SUM(gI1,0,2,SUM(gI2,1,1,SUM(gI3,0,2,SUM(gI4,0
      ,2,-(CpbarFeFehhPL(gI1,gO1,gI4)*CpbarFeFvHpmPR(gO4,gI3,gI2)*
      CpbarFvFeconjHpmPR(gO2,gI1,gI2)*CpbarFvFvhhPL(gI3,gO3,gI4)*D27(Sqr(MFe(gI1))
      ,Sqr(MHpm(gI2)),Sqr(MFv(gI3)),Sqr(Mhh(gI4)))))))) + SUM(gI1,0,2,SUM(gI2,1,1,
      SUM(gI3,0,2,SUM(gI4,2,2,CpbarFeFeAhPL(gI1,gO1,gI4)*CpbarFeFeAhPR(gO4,gI3,gI4
      )*CpbarFeFvHpmPL(gI3,gO3,gI2)*CpbarFvFeconjHpmPR(gO2,gI1,gI2)*D27(Sqr(MFe(
      gI1)),Sqr(MHpm(gI2)),Sqr(MFe(gI3)),Sqr(MAh(gI4))))))) + SUM(gI1,0,2,SUM(gI2,
      1,1,SUM(gI3,0,2,SUM(gI4,2,2,-(CpbarFeFeAhPL(gI1,gO1,gI4)*CpbarFeFvHpmPR(gO4,
      gI3,gI2)*CpbarFvFeconjHpmPR(gO2,gI1,gI2)*CpbarFvFvAhPL(gI3,gO3,gI4)*D27(Sqr(
      MFe(gI1)),Sqr(MHpm(gI2)),Sqr(MFv(gI3)),Sqr(MAh(gI4)))))))) + SUM(gI1,0,2,SUM
      (gI2,2,2,SUM(gI3,0,2,SUM(gI4,1,1,-(CpbarFeFeAhPR(gO4,gI3,gI2)*CpbarFeFvHpmPL
      (gI3,gO3,gI4)*CpbarFvFeconjHpmPL(gI1,gO1,gI4)*CpbarFvFvAhPR(gO2,gI1,gI2)*D27
      (Sqr(MFv(gI1)),Sqr(MAh(gI2)),Sqr(MFe(gI3)),Sqr(MHpm(gI4)))))))) + SUM(gI1,0,
      2,SUM(gI2,2,2,SUM(gI3,0,2,SUM(gI4,1,1,CpbarFeFvHpmPR(gO4,gI3,gI4)*
      CpbarFvFeconjHpmPL(gI1,gO1,gI4)*CpbarFvFvAhPL(gI3,gO3,gI2)*CpbarFvFvAhPR(gO2
      ,gI1,gI2)*D27(Sqr(MFv(gI1)),Sqr(MAh(gI2)),Sqr(MFv(gI3)),Sqr(MHpm(gI4)))))))
      + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,5,SUM(gI4,0,5,CpbarChabarFvSePR(gI2,gO2,
      gI1)*CpbarFeChiSePR(gO4,gI4,gI3)*CpChaFvconjSePL(gI2,gO3,gI3)*
      CpChiFeconjSePL(gI4,gO1,gI1)*D27(Sqr(MSe(gI1)),Sqr(MCha(gI2)),Sqr(MSe(gI3)),
      Sqr(MChi(gI4))))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,5,SUM(gI4,0,5,0.5*
      ...
      0,5,SUM(gI3,0,5,SUM(gI4,0,1,CpbarChaFeconjSvPL(gI4,gO1,gI1)*CpbarFeChaSvPR(
      gO4,gI4,gI3)*CpbarFvChiSvPR(gO2,gI2,gI1)*CpChiFvconjSvPL(gI2,gO3,gI3)*D27(
      Sqr(MSv(gI1)),Sqr(MChi(gI2)),Sqr(MSv(gI3)),Sqr(MCha(gI4))))))) + SUM(gI1,0,5
      ,SUM(gI2,0,5,SUM(gI3,0,5,SUM(gI4,0,1,0.5*CpbarChaFeconjSvPL(gI4,gO1,gI1)*
      CpbarFeChiSePR(gO4,gI2,gI3)*CpbarFvChiSvPR(gO2,gI2,gI1)*CpChaFvconjSePL(gI4,
      gO3,gI3)*D0(Sqr(MSv(gI1)),Sqr(MChi(gI2)),Sqr(MSe(gI3)),Sqr(MCha(gI4)))*MCha(
      gI4)*MChi(gI2))))) + SUM(gI1,0,5,SUM(gI2,0,5,SUM(gI3,0,5,SUM(gI4,0,5,
      CpbarFeChiSePR(gO4,gI3,gI4)*CpbarFvChiSvPR(gO2,gI1,gI2)*CpChiFeconjSePL(gI1,
      gO1,gI4)*CpChiFvconjSvPL(gI3,gO3,gI2)*D27(Sqr(MChi(gI1)),Sqr(MSv(gI2)),Sqr(
      MChi(gI3)),Sqr(MSe(gI4))))))) + SUM(gI1,0,5,SUM(gI2,0,5,SUM(gI3,0,5,SUM(gI4,
      0,5,0.5*CpbarFeChiSePR(gO4,gI3,gI4)*CpbarFvChiSvPR(gO2,gI3,gI2)*
      CpChiFeconjSePL(gI1,gO1,gI4)*CpChiFvconjSvPL(gI1,gO3,gI2)*D0(Sqr(MChi(gI1)),
      Sqr(MSv(gI2)),Sqr(MChi(gI3)),Sqr(MSe(gI4)))*MChi(gI1)*MChi(gI3))))) + SUM(
      gI1,1,1,SUM(gI2,0,2,SUM(gI3,1,1,SUM(gI4,0,2,-(CpbarFeFvHpmPL(gI2,gO3,gI1)*
      ...
      gI3)),Sqr(MFv(gI4)))))))) + SUM(gI1,2,2,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,0,2,
      CpbarFeFeAhPL(gI4,gO1,gI1)*CpbarFeFehhPR(gO4,gI4,gI3)*CpbarFvFvAhPR(gO2,gI2,
      gI1)*CpbarFvFvhhPL(gI2,gO3,gI3)*D27(Sqr(MAh(gI1)),Sqr(MFv(gI2)),Sqr(Mhh(gI3)
      ),Sqr(MFe(gI4))))))) + SUM(gI1,2,2,SUM(gI2,0,2,SUM(gI3,0,2,SUM(gI4,0,2,-(
      CpbarFeFeAhPL(gI4,gO1,gI1)*CpbarFeFehhPR(gO4,gI4,gI3)*CpbarFvFvAhPL(gI2,gO3,
      gI1)*CpbarFvFvhhPR(gO2,gI2,gI3)*D27(Sqr(MAh(gI1)),Sqr(MFv(gI2)),Sqr(Mhh(gI3)
      ),Sqr(MFe(gI4)))))))) + SUM(gI1,2,2,SUM(gI2,0,2,SUM(gI3,2,2,SUM(gI4,0,2,
      CpbarFeFeAhPL(gI4,gO1,gI1)*CpbarFeFeAhPR(gO4,gI4,gI3)*CpbarFvFvAhPL(gI2,gO3,
      gI3)*CpbarFvFvAhPR(gO2,gI2,gI1)*D27(Sqr(MAh(gI1)),Sqr(MFv(gI2)),Sqr(MAh(gI3)
      ),Sqr(MFe(gI4))))))) + SUM(gI1,2,2,SUM(gI2,0,2,SUM(gI3,2,2,SUM(gI4,0,2,-(
      CpbarFeFeAhPL(gI4,gO1,gI1)*CpbarFeFeAhPR(gO4,gI4,gI3)*CpbarFvFvAhPL(gI2,gO3,
      gI1)*CpbarFvFvAhPR(gO2,gI2,gI3)*D27(Sqr(MAh(gI1)),Sqr(MFv(gI2)),Sqr(MAh(gI3)
      ),Sqr(MFe(gI4))))))));
