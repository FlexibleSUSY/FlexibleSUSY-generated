...
{
   const auto gY = MODEL->get_g1() * UMSSM_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * UMSSM_info::normalization_g2;
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-
         ...
         *SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,
         j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZA(2,1))*(SUM(j2,0,2,Conj(ZUL(2
         ,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu
         (j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(0)/MT)*(Sqr(Abs(Conj(ZH(0,1))*
         (SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,
         0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))))) - Sqr(Abs(Conj(ZH(0,
         1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM
         (j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))))) - RHO2(Mhh(1)/
         MT)*(Sqr(Abs(Conj(ZH(1,1))*(SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2
         ,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,
...
std::complex<double> CLASSNAME::CpbarFvFvhhPL(int gI2, int gO1, int gI1) const
{
   ...
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI1,1))*SUM(j2,
      0,2,Conj(ZVR(gI2,j2))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpChiFvconjSvPL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*Conj(ZN(gI1,0))*
      SUM(j1,0,2,Conj(ZVL(gO1,j1))*ZV(gI2,j1)) + 0.5477225575051661*g1*Conj(ZN(gI1
      ,1))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*ZV(gI2,j1)) - 0.7071067811865475*g2*Conj(
      ZN(gI1,2))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*ZV(gI2,j1)) - Conj(ZN(gI1,4))*SUM(j2
      ,0,2,SUM(j1,0,2,Conj(ZVL(gO1,j1))*Yv(j1,j2))*ZV(gI2,3 + j2));
...
std::complex<double> CLASSNAME::CpbarFvFvAhPL(int gI2, int gO1, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.7071067811865475
      )*Conj(ZA(gI1,1))*SUM(j2,0,2,Conj(ZVR(gI2,j2))*SUM(j1,0,2,Conj(ZVL(gO1,j1))*
      Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpChiFeconjSePL(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*Conj(ZN(gI1,0))*
      SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) + 0.5477225575051661*g1*Conj(ZN(gI1
      ,1))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) + 0.7071067811865475*g2*Conj(
      ZN(gI1,2))*SUM(j1,0,2,Conj(ZEL(gO1,j1))*ZE(gI2,j1)) - Conj(ZN(gI1,3))*SUM(j2
      ,0,2,Conj(ZEL(gO1,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::CpbarChabarFvSePR(int gI1, int gO2, int gI3) const
{
   ...
   const std::complex<double> result = -(g2*SUM(j1,0,2,Conj(ZE(gI3,j1))*ZVL(gO2,j1
      ))*UM(gI1,0)) + SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI3,3 + j1)))*
      ZVL(gO2,j2))*UM(gI1,1);
...
std::complex<double> CLASSNAME::CpbarFvFvhhPR(int gO2, int gI1, int gI3) const
{
   ...
   const std::complex<double> result = -0.7071067811865475*Conj(ZH(gI3,1))*SUM(j2,
      0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*ZVL(gO2,j1))*ZVR(gI1,j2));
...
std::complex<double> CLASSNAME::CpbarFvFvAhPR(int gO2, int gI1, int gI3) const
{
   ...
   const std::complex<double> result = std::complex<double>(0.,0.7071067811865475)
      *Conj(ZA(gI3,1))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*ZVL(gO2,j1))*ZVR(gI1,
      j2));
...
std::complex<double> CLASSNAME::CpbarFvChiSvPR(int gO2, int gI1, int gI3) const
{
   ...
   const std::complex<double> result = -0.7071067811865475*SUM(j1,0,2,Conj(ZV(gI3,
      j1))*ZVL(gO2,j1))*(2*gp*Ql*ZN(gI1,0) - 0.7745966692414834*g1*ZN(gI1,1) + g2*
      ZN(gI1,2)) - SUM(j2,0,2,Conj(ZV(gI3,3 + j2))*SUM(j1,0,2,Conj(Yv(j1,j2))*ZVL(
      gO2,j1)))*ZN(gI1,4);
...
std::complex<double> CLASSNAME::CpbarFvFeconjHpmPR(int gO2, int gI3, int gI1) const
{
   ...
   const std::complex<double> result = SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(
      gI3,j1))*ZVL(gO2,j2))*ZP(gI1,0);
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,1,SUM(gI4
      ,0,5,0.5*CpbarChabarFvSePR(gI3,gO2,gI2)*CpbarChaFeconjSvPL(gI1,gO1,gI4)*
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * UMSSM_info::normalization_g3 /
   ...
   sm.set_Yu(Re(model->get_Yu()*vu/SMvev));
   sm.set_Yd(Re(model->get_Yd()*vd/SMvev));
   sm.set_Ye(Re(model->get_Ye()*vd/SMvev));
...
double CLASSNAME::calculate_delta_alpha_hat_bsm(double alpha_em) const
{
   ...
   delta_alpha_hat_bsm += alpha_em/(2.*Pi)*(0.3333333333333333 -
