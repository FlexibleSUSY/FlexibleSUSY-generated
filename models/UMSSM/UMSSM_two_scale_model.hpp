 ...
 */
template<>
class UMSSM<Two_scale> : public Two_scale_model, public UMSSM_soft_parameters {
public:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(UMSSM<Two_scale>::*Memfun_t)();
      UMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(UMSSM<Two_scale>* model_, Memfun_t fun_)
