...
/**
 * @file UMSSM_mass_eigenstates_interface.hpp
 *
...
#ifndef UMSSM_MASS_EIGENSTATES_INTERFACE_H
#define UMSSM_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class UMSSM_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class UMSSM_mass_eigenstates_interface {
public:
   virtual ~UMSSM_mass_eigenstates_interface() {}

   virtual std::unique_ptr<UMSSM_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const UMSSM_input_parameters& get_input_parameters() const = 0;
   virtual UMSSM_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const UMSSM_physical& get_physical() const = 0;
   virtual UMSSM_physical& get_physical() = 0;
   ...
   virtual void set_physical(const UMSSM_physical&) = 0;
   ...
   virtual const Eigen::Matrix<double,3,3>& get_mvR2() const = 0;
   virtual double get_mvR2(int i, int k) const = 0;
   ...
   virtual double get_MassU() const = 0;
   ...
   virtual void set_gp(double gp_) = 0;
   ...
   virtual void set_mvR2(const Eigen::Matrix<double,3,3>& mvR2_) = 0;
   virtual void set_mvR2(int i, int k, const double& value) = 0;
   ...
   virtual void set_MassU(double MassU_) = 0;
   ...
   virtual const Eigen::Matrix<std::complex<double>,3,3>& get_ZVL() const = 0;
   virtual std::complex<double> get_ZVL(int i, int k) const = 0;
   virtual const Eigen::Matrix<std::complex<double>,3,3>& get_ZVR() const = 0;
   virtual std::complex<double> get_ZVR(int i, int k) const = 0;
