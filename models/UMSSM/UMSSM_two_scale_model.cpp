 ...
 * parameters.
 *
 * This file was generated at Mon 23 Feb 2015 13:15:58 with FlexibleSUSY
...
int CLASSNAME::solve_ewsb_tree_level()
{
   ...
   mHd2 = (0.025*(14.142135623730951*vS*vu*Conj(TLambdax) - 3*Power(vd,3)*Sqr(
      g1) - 5*Power(vd,3)*Sqr(g2) - 20*Power(vd,3)*Sqr(gp)*Sqr(QHd) - 20*vd*AbsSqr
   ...
   mHu2 = (0.025*(14.142135623730951*vd*vS*Conj(TLambdax) - 3*Power(vu,3)*Sqr(
      g1) - 5*Power(vu,3)*Sqr(g2) - 20*Power(vu,3)*Sqr(gp)*Sqr(QHu) - 20*vu*AbsSqr
   ...
   ms2 = (0.25*(1.4142135623730951*vd*vu*Conj(TLambdax) - 2*Power(vS,3)*Sqr(gp)
...
int CLASSNAME::solve_ewsb_tree_level_via_soft_higgs_masses()
{
   ...
   const double new_mHd2 = (0.025*(14.142135623730951*vS*vu*Conj(TLambdax) - 3*
      Power(vd,3)*Sqr(g1) - 5*Power(vd,3)*Sqr(g2) - 20*Power(vd,3)*Sqr(gp)*Sqr(QHd
      ) - 20*vd*AbsSqr(Lambdax)*Sqr(vS) - 20*QHd*Qs*vd*Sqr(gp)*Sqr(vS) - 20*vd*
   ...
   const double new_mHu2 = (0.025*(14.142135623730951*vd*vS*Conj(TLambdax) - 3*
      Power(vu,3)*Sqr(g1) - 5*Power(vu,3)*Sqr(g2) - 20*Power(vu,3)*Sqr(gp)*Sqr(QHu
      ) - 20*vu*AbsSqr(Lambdax)*Sqr(vd) + 3*vu*Sqr(g1)*Sqr(vd) + 5*vu*Sqr(g2)*Sqr(
      vd) - 20*QHd*QHu*vu*Sqr(gp)*Sqr(vd) - 20*vu*AbsSqr(Lambdax)*Sqr(vS) - 20*QHu
      *Qs*vu*Sqr(gp)*Sqr(vS) + 14.142135623730951*vd*vS*TLambdax))/vu;
   const double new_ms2 = (0.25*(1.4142135623730951*vd*vu*Conj(TLambdax) - 2*
...
int CLASSNAME::ewsb_step(double ewsb_parameters[number_of_ewsb_equations]) const
{
   ...
   mHu2 = (0.025*(14.142135623730951*vd*vS*Conj(TLambdax) + 40*tadpole[1] - 3*
      ...
      vd) - 20*QHd*QHu*vu*Sqr(gp)*Sqr(vd) - 20*vu*AbsSqr(Lambdax)*Sqr(vS) - 20*QHu
      *Qs*vu*Sqr(gp)*Sqr(vS) + 14.142135623730951*vd*vS*TLambdax))/vu;
   ms2 = (0.25*(1.4142135623730951*vd*vu*Conj(TLambdax) + 4*tadpole[2] - 2*
      Power(vS,3)*Sqr(gp)*Sqr(Qs) - 2*vS*AbsSqr(Lambdax)*Sqr(vd) - 2*QHd*Qs*vS*Sqr
      (gp)*Sqr(vd) - 2*vS*AbsSqr(Lambdax)*Sqr(vu) - 2*QHu*Qs*vS*Sqr(gp)*Sqr(vu) +
      1.4142135623730951*vd*vu*TLambdax))/vS;
...
double CLASSNAME::get_mass_matrix_VZ() const
{
   ...
   const double mass_matrix_VZ = 0.25*(2*g2*gp*Cos(ThetaW())*Sin(2*
...
double CLASSNAME::get_mass_matrix_VZp() const
{
   ...
   const double mass_matrix_VZp = 0.25*(-2*gp*(g2*Cos(ThetaW()) +
...
double CLASSNAME::get_ewsb_eq_hh_1() const
{
   ...
   double result = mHd2*vd - 0.35355339059327373*vS*vu*Conj(TLambdax) + 0.075*
      Power(vd,3)*Sqr(g1) + 0.125*Power(vd,3)*Sqr(g2) + 0.5*Power(vd,3)*Sqr(gp)*
      Sqr(QHd) + 0.5*vd*AbsSqr(Lambdax)*Sqr(vS) + 0.5*QHd*Qs*vd*Sqr(gp)*Sqr(vS) +
      0.5*vd*AbsSqr(Lambdax)*Sqr(vu) - 0.075*vd*Sqr(g1)*Sqr(vu) - 0.125*vd*Sqr(g2)
      *Sqr(vu) + 0.5*QHd*QHu*vd*Sqr(gp)*Sqr(vu) - 0.35355339059327373*vS*vu*
      TLambdax;
...
double CLASSNAME::get_ewsb_eq_hh_2() const
{
   ...
   double result = mHu2*vu - 0.35355339059327373*vd*vS*Conj(TLambdax) + 0.075*
      Power(vu,3)*Sqr(g1) + 0.125*Power(vu,3)*Sqr(g2) + 0.5*Power(vu,3)*Sqr(gp)*
      Sqr(QHu) + 0.5*vu*AbsSqr(Lambdax)*Sqr(vd) - 0.075*vu*Sqr(g1)*Sqr(vd) - 0.125
      *vu*Sqr(g2)*Sqr(vd) + 0.5*QHd*QHu*vu*Sqr(gp)*Sqr(vd) + 0.5*vu*AbsSqr(Lambdax
      )*Sqr(vS) + 0.5*QHu*Qs*vu*Sqr(gp)*Sqr(vS) - 0.35355339059327373*vd*vS*
      TLambdax;
...
double CLASSNAME::get_ewsb_eq_hh_3() const
{
   ...
   double result = ms2*vS - 0.35355339059327373*vd*vu*Conj(TLambdax) + 0.5*
...
std::complex<double> CLASSNAME::tadpole_hh(unsigned gO1) const
{
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3716 += A0(MHpm(gI1))*CpUhhconjHpmHpm(gO1,gI1,gI1);
   }
   tmp_3715 += tmp_3716;
   result += (-1) * tmp_3715;
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_3718 += A0(MCha(gI1))*(CpUhhbarChaChaPL(gO1,gI1,gI1) +
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3720 += A0(MAh(gI1))*CpUhhAhAh(gO1,gI1,gI1);
   }
   tmp_3719 += tmp_3720;
   result += (-0.5) * tmp_3719;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3722 += A0(MSv(gI1))*CpUhhconjSvSv(gO1,gI1,gI1);
   }
   tmp_3721 += tmp_3722;
   result += (-1) * tmp_3721;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3724 += A0(Mhh(gI1))*CpUhhhhhh(gO1,gI1,gI1);
   }
   tmp_3723 += tmp_3724;
   result += (-0.5) * tmp_3723;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3726 += A0(MFd(gI1))*(CpUhhbarFdFdPL(gO1,gI1,gI1) + CpUhhbarFdFdPR
         (gO1,gI1,gI1))*MFd(gI1);
   }
   tmp_3725 += tmp_3726;
   result += (6) * tmp_3725;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3728 += A0(MFe(gI1))*(CpUhhbarFeFePL(gO1,gI1,gI1) + CpUhhbarFeFePR
         (gO1,gI1,gI1))*MFe(gI1);
   }
   tmp_3727 += tmp_3728;
   result += (2) * tmp_3727;
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      tmp_3730 += A0(MFu(gI1))*(CpUhhbarFuFuPL(gO1,gI1,gI1) + CpUhhbarFuFuPR
         (gO1,gI1,gI1))*MFu(gI1);
   }
   tmp_3729 += tmp_3730;
   result += (6) * tmp_3729;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3732 += A0(MSd(gI1))*CpUhhconjSdSd(gO1,gI1,gI1);
   }
   tmp_3731 += tmp_3732;
   result += (-3) * tmp_3731;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3734 += A0(MSe(gI1))*CpUhhconjSeSe(gO1,gI1,gI1);
   }
   tmp_3733 += tmp_3734;
   result += (-1) * tmp_3733;
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3736 += A0(MSu(gI1))*CpUhhconjSuSu(gO1,gI1,gI1);
   }
   tmp_3735 += tmp_3736;
   result += (-3) * tmp_3735;
   std::complex<double> tmp_3737;
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      tmp_3737 += A0(MChi(gI1))*(CpUhhChiChiPL(gO1,gI1,gI1) + CpUhhChiChiPR(
