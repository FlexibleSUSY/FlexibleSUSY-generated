...
double UMSSM_soft_parameters::calc_beta_mHu2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHu2 = Re(0.2*(3.872983346207417*g1*Tr11 + 10*gp*QHu*Tr14 + 30*
      traceconjTYuTpTYu + 10*traceconjTYvTpTYv + 30*tracemq2AdjYuYu + 30*
      tracemu2YuAdjYu + 30*mHu2*traceYuAdjYu + 10*mHu2*traceYvAdjYv + 10*
...
double UMSSM_soft_parameters::calc_beta_mHu2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   const double beta_mHu2_1 = Re(0.04*(77.45966692414834*g1*gp*QHu*Tr2U114 +
      77.45966692414834*g1*gp*QHu*Tr2U141 + 77.45966692414834*g1*Tr31 + 200*gp*
      QHu*Tr34 - 50*traceAdjYeTYeconjTYvTpYv - 50*traceAdjYvTpYeconjTYeTYv -
      150*tracemd2YdAdjYuYuAdjYd - 150*tracemq2AdjYdYdAdjYuYu - 150*
      ...
      traceYeconjTYvTpTYvAdjYe - 150*traceYuAdjTYdTYdAdjYu - 900*
      traceYuAdjTYuTYuAdjYu - 150*traceYuAdjYdTYdAdjTYu - 900*
      traceYuAdjYuTYuAdjTYu - 900*mHu2*traceYuAdjYuYuAdjYu - 300*
      traceYvAdjTYvTYvAdjYv - 50*traceYvAdjYvconjml2TpYeconjYe - 150*
      traceYvAdjYvconjml2YvAdjYv - 50*traceYvAdjYvTpTYeconjTYe - 50*
      traceYvAdjYvTpYeconjme2conjYe - 50*mHd2*traceYvAdjYvTpYeconjYe - 50*mHu2*
      traceYvAdjYvTpYeconjYe - 50*traceYvAdjYvTpYeconjYeconjml2 - 300*
      traceYvAdjYvTYvAdjTYv - 300*mHu2*traceYvAdjYvYvAdjYv - 150*
      traceYvAdjYvYvAdjYvconjml2 - 150*traceYvAdjYvYvconjmvR2AdjYv - 50*
      traceYvconjmvR2AdjYvTpYeconjYe - 150*traceYvconjmvR2AdjYvYvAdjYv + 621*
      AbsSqr(MassB)*Quad(g1) + 150*Tr22*Quad(g2) + 30*Tr2U111*Sqr(g1) + 40*
      ...
      traceAdjYuTYu*Conj(MassB)*Sqr(g1) + 90*AbsSqr(MassB)*Sqr(g1)*Sqr(g2) + 45
      *MassWB*Conj(MassB)*Sqr(g1)*Sqr(g2) + 800*traceconjTYuTpTYu*Sqr(g3) - 800
      *MassG*traceconjTYuTpYu*Sqr(g3) + 800*tracemq2AdjYuYu*Sqr(g3) + 800*
      ...
      ) + 360*Qd*QHu*AbsSqr(MassB)*Sqr(g1)*Sqr(gp) + 360*Qe*QHu*AbsSqr(MassB)*
      Sqr(g1)*Sqr(gp) - 120*QHd*QHu*AbsSqr(MassB)*Sqr(g1)*Sqr(gp) - 360*QHu*Ql*
      AbsSqr(MassB)*Sqr(g1)*Sqr(gp) + 360*QHu*Qq*AbsSqr(MassB)*Sqr(g1)*Sqr(gp)
      - 720*QHu*Qu*AbsSqr(MassB)*Sqr(g1)*Sqr(gp) + 180*MassU*Qd*QHu*Conj(MassB)
      *Sqr(g1)*Sqr(gp) + 180*MassU*Qe*QHu*Conj(MassB)*Sqr(g1)*Sqr(gp) - 60*
      MassU*QHd*QHu*Conj(MassB)*Sqr(g1)*Sqr(gp) - 180*MassU*QHu*Ql*Conj(MassB)*
      Sqr(g1)*Sqr(gp) + 180*MassU*QHu*Qq*Conj(MassB)*Sqr(g1)*Sqr(gp) - 360*
      MassU*QHu*Qu*Conj(MassB)*Sqr(g1)*Sqr(gp) + 200*Tr2U144*Sqr(gp)*Sqr(QHu) -
      300*traceconjTYuTpTYu*Sqr(gp)*Sqr(QHu) + 300*MassU*traceconjTYuTpYu*Sqr(
      gp)*Sqr(QHu) - 100*traceconjTYvTpTYv*Sqr(gp)*Sqr(QHu) + 100*MassU*
      traceconjTYvTpYv*Sqr(gp)*Sqr(QHu) - 300*tracemq2AdjYuYu*Sqr(gp)*Sqr(QHu)
      - 300*tracemu2YuAdjYu*Sqr(gp)*Sqr(QHu) - 300*mHu2*traceYuAdjYu*Sqr(gp)*
      Sqr(QHu) - 100*mHu2*traceYvAdjYv*Sqr(gp)*Sqr(QHu) - 100*
      traceYvAdjYvconjml2*Sqr(gp)*Sqr(QHu) - 100*traceYvconjmvR2AdjYv*Sqr(gp)*
      Sqr(QHu) + 240*AbsSqr(MassB)*Sqr(g1)*Sqr(gp)*Sqr(QHu) + 120*MassU*Conj(
      MassB)*Sqr(g1)*Sqr(gp)*Sqr(QHu) + 100*traceconjTYvTpTYv*Sqr(gp)*Sqr(Ql) -
      100*MassU*traceconjTYvTpYv*Sqr(gp)*Sqr(Ql) + 100*mHu2*traceYvAdjYv*Sqr(gp
      )*Sqr(Ql) + 100*traceYvAdjYvconjml2*Sqr(gp)*Sqr(Ql) + 100*
      traceYvconjmvR2AdjYv*Sqr(gp)*Sqr(Ql) + 300*traceconjTYuTpTYu*Sqr(gp)*Sqr(
      Qq) - 300*MassU*traceconjTYuTpYu*Sqr(gp)*Sqr(Qq) + 300*tracemq2AdjYuYu*
      Sqr(gp)*Sqr(Qq) + 300*tracemu2YuAdjYu*Sqr(gp)*Sqr(Qq) + 300*mHu2*
      traceYuAdjYu*Sqr(gp)*Sqr(Qq) + 300*traceconjTYuTpTYu*Sqr(gp)*Sqr(Qu) -
      300*MassU*traceconjTYuTpYu*Sqr(gp)*Sqr(Qu) + 300*tracemq2AdjYuYu*Sqr(gp)*
      Sqr(Qu) + 300*tracemu2YuAdjYu*Sqr(gp)*Sqr(Qu) + 300*mHu2*traceYuAdjYu*Sqr
      (gp)*Sqr(Qu) + 100*traceconjTYvTpTYv*Sqr(gp)*Sqr(Qv) - 100*MassU*
      traceconjTYvTpYv*Sqr(gp)*Sqr(Qv) + 100*mHu2*traceYvAdjYv*Sqr(gp)*Sqr(Qv)
      + 100*traceYvAdjYvconjml2*Sqr(gp)*Sqr(Qv) + 100*traceYvconjmvR2AdjYv*Sqr(
      gp)*Sqr(Qv)));
   const double beta_mHu2_2 = Re(0.2*(-30*traceconjTYdTpTYd*AbsSqr(Lambdax) -
      10*traceconjTYeTpTYe*AbsSqr(Lambdax) - 30*tracemd2YdAdjYd*AbsSqr(Lambdax)
      - 10*traceme2YeAdjYe*AbsSqr(Lambdax) - 10*traceml2AdjYeYe*AbsSqr(Lambdax)
      - 30*tracemq2AdjYdYd*AbsSqr(Lambdax) - 60*mHd2*traceYdAdjYd*AbsSqr(
      Lambdax) - 30*mHu2*traceYdAdjYd*AbsSqr(Lambdax) - 30*ms2*traceYdAdjYd*
      AbsSqr(Lambdax) - 20*mHd2*traceYeAdjYe*AbsSqr(Lambdax) - 10*mHu2*
      traceYeAdjYe*AbsSqr(Lambdax) - 10*ms2*traceYeAdjYe*AbsSqr(Lambdax) - 30*
      traceYdAdjYd*AbsSqr(TLambdax) - 10*traceYeAdjYe*AbsSqr(TLambdax) - 120*
      AbsSqr(Lambdax)*AbsSqr(TLambdax) - 30*traceAdjYdTYd*Conj(TLambdax)*
