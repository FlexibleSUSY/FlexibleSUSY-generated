...
// File generated at Sun 26 Aug 2018 14:23:05
...
double UMSSM_soft_parameters::calc_beta_mHu2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHu2 = Re(oneOver16PiSqr*(0.7745966692414834*g1*Tr11 + 2*gp*QHu*Tr14 +
      6*traceconjTYuTpTYu + 2*traceconjTYvTpTYv + 6*tracemq2AdjYuYu + 6*
...
double UMSSM_soft_parameters::calc_beta_mHu2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   const double beta_mHu2_1 = Re(0.04*twoLoop*(Conj(MassB)*Sqr(g1)*(621*MassB*
      Sqr(g1) + 5*(9*(2*MassB + MassWB)*Sqr(g2) + 4*(-2*traceAdjYuTYu + 4*MassB
      *traceYuAdjYu + 3*(2*MassB + MassU)*QHu*(3*Qd + 3*Qe - QHd + 2*QHu - 3*Ql
       + 3*Qq - 6*Qu)*Sqr(gp)))) + 10*(7.745966692414834*g1*gp*QHu*Tr2U114 +
      7.745966692414834*g1*gp*QHu*Tr2U141 + 7.745966692414834*g1*Tr31 + 20*gp*
      QHu*Tr34 - 5*traceAdjYeTYeconjTYvTpYv - 5*traceAdjYvTpYeconjTYeTYv - 15*
      ...
      traceYvconjmvR2AdjYvTpYeconjYe - 15*traceYvconjmvR2AdjYvYvAdjYv + 15*Tr22
      *Quad(g2) + 3*Tr2U111*Sqr(g1) + 4*traceconjTYuTpTYu*Sqr(g1) - 4*MassB*
      traceconjTYuTpYu*Sqr(g1) + 4*tracemq2AdjYuYu*Sqr(g1) + 4*tracemu2YuAdjYu*
      Sqr(g1) + 4*mHu2*traceYuAdjYu*Sqr(g1) + 80*traceconjTYuTpTYu*Sqr(g3) - 80
      *MassG*traceconjTYuTpYu*Sqr(g3) + 80*tracemq2AdjYuYu*Sqr(g3) + 80*
      ...
      *Sqr(QHu) - 30*tracemu2YuAdjYu*Sqr(gp)*Sqr(QHu) - 30*mHu2*traceYuAdjYu*
      ...
      + 30*traceconjTYuTpTYu*Sqr(gp)*Sqr(Qu) - 30*MassU*traceconjTYuTpYu*Sqr(gp
      )*Sqr(Qu) + 30*tracemq2AdjYuYu*Sqr(gp)*Sqr(Qu) + 30*tracemu2YuAdjYu*Sqr(
      gp)*Sqr(Qu) + 30*mHu2*traceYuAdjYu*Sqr(gp)*Sqr(Qu) + 10*traceconjTYvTpTYv
      *Sqr(gp)*Sqr(Qv) - 10*MassU*traceconjTYvTpYv*Sqr(gp)*Sqr(Qv) + 10*mHu2*
      traceYvAdjYv*Sqr(gp)*Sqr(Qv) + 10*traceYvAdjYvconjml2*Sqr(gp)*Sqr(Qv) +
      10*traceYvconjmvR2AdjYv*Sqr(gp)*Sqr(Qv))));
   const double beta_mHu2_2 = Re(0.2*twoLoop*(3*Conj(MassWB)*Sqr(g2)*(3*(MassB
      + 2*MassWB)*Sqr(g1) + 5*(11*MassWB*Sqr(g2) + 4*(MassU + 2*MassWB)*Sqr(gp)
      *Sqr(QHu))) + 4*Conj(MassU)*Sqr(gp)*(3*(MassB + 2*MassU)*QHu*(3*Qd + 3*Qe
       - QHd + 2*QHu - 3*Ql + 3*Qq - 6*Qu)*Sqr(g1) + 5*(3*traceAdjYuTYu*Sqr(QHu
      ) + traceAdjYvTYv*Sqr(QHu) - 6*MassU*traceYuAdjYu*Sqr(QHu) - 2*MassU*
      traceYvAdjYv*Sqr(QHu) + 3*(2*MassU + MassWB)*Sqr(g2)*Sqr(QHu) -
