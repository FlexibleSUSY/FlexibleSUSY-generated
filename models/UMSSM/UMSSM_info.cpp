...
namespace UMSSM_info {
   ...
   const std::array<int, NUMBER_OF_PARTICLES> particle_multiplicities = {1, 1,
      6, 6, 6, 6, 3, 3, 2, 6, 3, 2, 3, 3, 3, 1, 1, 1, 1};

   const std::array<std::string, NUMBER_OF_PARTICLES> particle_names = {"VG",
      "Glu", "Sd", "Sv", "Su", "Se", "hh", "Ah", "Hpm", "Chi", "Fv", "Cha", "Fe",
      "Fd", "Fu", "VWm", "VP", "VZ", "VZp"};

   const std::array<std::string, NUMBER_OF_PARTICLES> particle_latex_names = {
      "g", "\\tilde{g}", "\\tilde{d}", "\\tilde{\\nu}", "\\tilde{u}",
      "\\tilde{e}", "h", "A^0", "H^-", "\\tilde{\\chi}^0", "\\nu",
      "\\tilde{\\chi}^-", "e", "d", "u", "W^-", "\\gamma", "Z", "{Z'}"};
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {
      ...
      , "Ye(1,2)", "Ye(2,0)", "Ye(2,1)", "Ye(2,2)", "Lambdax", "Yv(0,0)",
      "Yv(0,1)", "Yv(0,2)", "Yv(1,0)", "Yv(1,1)", "Yv(1,2)", "Yv(2,0)", "Yv(2,1)",
      "Yv(2,2)", "Yu(0,0)", "Yu(0,1)", "Yu(0,2)", "Yu(1,0)", "Yu(1,1)", "Yu(1,2)"
      , "Yu(2,0)", "Yu(2,1)", "Yu(2,2)", "g1", "g2", "g3", "gp", "vd", "vu", "vS",
      ...
      "TLambdax", "TYv(0,0)", "TYv(0,1)", "TYv(0,2)", "TYv(1,0)", "TYv(1,1)",
      "TYv(1,2)", "TYv(2,0)", "TYv(2,1)", "TYv(2,2)", "TYu(0,0)", "TYu(0,1)",
      "TYu(0,2)", "TYu(1,0)", "TYu(1,1)", "TYu(1,2)", "TYu(2,0)", "TYu(2,1)",
      "TYu(2,2)", "mq2(0,0)", "mq2(0,1)", "mq2(0,2)", "mq2(1,0)", "mq2(1,1)",
      ...
      "me2(1,1)", "me2(1,2)", "me2(2,0)", "me2(2,1)", "me2(2,2)", "mvR2(0,0)",
      "mvR2(0,1)", "mvR2(0,2)", "mvR2(1,0)", "mvR2(1,1)", "mvR2(1,2)", "mvR2(2,0)"
      , "mvR2(2,1)", "mvR2(2,2)", "ms2", "MassB", "MassWB", "MassG", "MassU"};
   ...
   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      ...
      "ZD(5,3)", "ZD(5,4)", "ZD(5,5)", "ZV(0,0)", "ZV(0,1)", "ZV(0,2)", "ZV(0,3)",
      "ZV(0,4)", "ZV(0,5)", "ZV(1,0)", "ZV(1,1)", "ZV(1,2)", "ZV(1,3)", "ZV(1,4)"
      , "ZV(1,5)", "ZV(2,0)", "ZV(2,1)", "ZV(2,2)", "ZV(2,3)", "ZV(2,4)",
      "ZV(2,5)", "ZV(3,0)", "ZV(3,1)", "ZV(3,2)", "ZV(3,3)", "ZV(3,4)", "ZV(3,5)",
      "ZV(4,0)", "ZV(4,1)", "ZV(4,2)", "ZV(4,3)", "ZV(4,4)", "ZV(4,5)", "ZV(5,0)"
      , "ZV(5,1)", "ZV(5,2)", "ZV(5,3)", "ZV(5,4)", "ZV(5,5)", "ZU(0,0)",
      "ZU(0,1)", "ZU(0,2)", "ZU(0,3)", "ZU(0,4)", "ZU(0,5)", "ZU(1,0)", "ZU(1,1)",
      "ZU(1,2)", "ZU(1,3)", "ZU(1,4)", "ZU(1,5)", "ZU(2,0)", "ZU(2,1)", "ZU(2,2)"
      , "ZU(2,3)", "ZU(2,4)", "ZU(2,5)", "ZU(3,0)", "ZU(3,1)", "ZU(3,2)",
      "ZU(3,3)", "ZU(3,4)", "ZU(3,5)", "ZU(4,0)", "ZU(4,1)", "ZU(4,2)", "ZU(4,3)",
      "ZU(4,4)", "ZU(4,5)", "ZU(5,0)", "ZU(5,1)", "ZU(5,2)", "ZU(5,3)", "ZU(5,4)"
      , "ZU(5,5)", "ZE(0,0)", "ZE(0,1)", "ZE(0,2)", "ZE(0,3)", "ZE(0,4)",
      "ZE(0,5)", "ZE(1,0)", "ZE(1,1)", "ZE(1,2)", "ZE(1,3)", "ZE(1,4)", "ZE(1,5)",
      "ZE(2,0)", "ZE(2,1)", "ZE(2,2)", "ZE(2,3)", "ZE(2,4)", "ZE(2,5)", "ZE(3,0)"
      , "ZE(3,1)", "ZE(3,2)", "ZE(3,3)", "ZE(3,4)", "ZE(3,5)", "ZE(4,0)",
      "ZE(4,1)", "ZE(4,2)", "ZE(4,3)", "ZE(4,4)", "ZE(4,5)", "ZE(5,0)", "ZE(5,1)",
      "ZE(5,2)", "ZE(5,3)", "ZE(5,4)", "ZE(5,5)", "ZH(0,0)", "ZH(0,1)", "ZH(0,2)"
      , "ZH(1,0)", "ZH(1,1)", "ZH(1,2)", "ZH(2,0)", "ZH(2,1)", "ZH(2,2)",
      ...
      "Re(ZN(5,5))", "Im(ZN(5,5))", "Re(ZVL(0,0))", "Im(ZVL(0,0))", "Re(ZVL(0,1))"
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS>
      input_parameter_names = {"m0", "m12", "TanBeta", "Azero", "LambdaInput",
      "ALambdaInput", "vSInput", "Qq", "Ql", "QHd", "QHu", "Qd", "Qu", "Qe", "Qs",
      "Qv"};

   const std::array<std::string, NUMBER_OF_EXTRA_PARAMETERS>
      extra_parameter_names = {};

   const std::string model_name = "UMSSM";
