...
// File generated at Mon 23 Feb 2015 13:04:31
...
namespace UMSSM_info {
   ...
   const unsigned particle_multiplicities[NUMBER_OF_PARTICLES] = {1, 3, 1, 1, 6
      , 3, 6, 6, 3, 3, 2, 6, 2, 3, 3, 3, 1, 1, 1};

   const char* particle_names[NUMBER_OF_PARTICLES] = {"Glu", "Fv", "VZ", "VZp",
      "Sd", "Sv", "Su", "Se", "hh", "Ah", "Hpm", "Chi", "Cha", "Fe", "Fd", "Fu",
      "VG", "VP", "VWm"};
   ...
   const char* parameter_names[NUMBER_OF_PARAMETERS] = {"Yd(0,0)", "Yd(0,1)",
      ...
      "Yu(1,0)", "Yu(1,1)", "Yu(1,2)", "Yu(2,0)", "Yu(2,1)", "Yu(2,2)", "g1", "g2"
      , "g3", "gp", "vd", "vu", "vS", "TYd(0,0)", "TYd(0,1)", "TYd(0,2)",
