...
namespace UMSSM_info {
   ...
   const std::array<int, NUMBER_OF_PARTICLES> particle_multiplicities = {1, 1, 6,
      6, 6, 6, 3, 3, 2, 6, 3, 2, 3, 3, 3, 1, 1, 1, 1};
   ...
   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      ...
      "ZD(5,5)", "ZV(0,0)", "ZV(0,1)", "ZV(0,2)", "ZV(0,3)", "ZV(0,4)", "ZV(0,5)",
      "ZV(1,0)", "ZV(1,1)", "ZV(1,2)", "ZV(1,3)", "ZV(1,4)", "ZV(1,5)", "ZV(2,0)",
      "ZV(2,1)", "ZV(2,2)", "ZV(2,3)", "ZV(2,4)", "ZV(2,5)", "ZV(3,0)", "ZV(3,1)",
      "ZV(3,2)", "ZV(3,3)", "ZV(3,4)", "ZV(3,5)", "ZV(4,0)", "ZV(4,1)", "ZV(4,2)",
      "ZV(4,3)", "ZV(4,4)", "ZV(4,5)", "ZV(5,0)", "ZV(5,1)", "ZV(5,2)", "ZV(5,3)",
      "ZV(5,4)", "ZV(5,5)", "ZU(0,0)", "ZU(0,1)", "ZU(0,2)", "ZU(0,3)", "ZU(0,4)",
      "ZU(0,5)", "ZU(1,0)", "ZU(1,1)", "ZU(1,2)", "ZU(1,3)", "ZU(1,4)", "ZU(1,5)",
      "ZU(2,0)", "ZU(2,1)", "ZU(2,2)", "ZU(2,3)", "ZU(2,4)", "ZU(2,5)", "ZU(3,0)",
      "ZU(3,1)", "ZU(3,2)", "ZU(3,3)", "ZU(3,4)", "ZU(3,5)", "ZU(4,0)", "ZU(4,1)",
      "ZU(4,2)", "ZU(4,3)", "ZU(4,4)", "ZU(4,5)", "ZU(5,0)", "ZU(5,1)", "ZU(5,2)",
      "ZU(5,3)", "ZU(5,4)", "ZU(5,5)", "ZE(0,0)", "ZE(0,1)", "ZE(0,2)", "ZE(0,3)",
      "ZE(0,4)", "ZE(0,5)", "ZE(1,0)", "ZE(1,1)", "ZE(1,2)", "ZE(1,3)", "ZE(1,4)",
      "ZE(1,5)", "ZE(2,0)", "ZE(2,1)", "ZE(2,2)", "ZE(2,3)", "ZE(2,4)", "ZE(2,5)",
      "ZE(3,0)", "ZE(3,1)", "ZE(3,2)", "ZE(3,3)", "ZE(3,4)", "ZE(3,5)", "ZE(4,0)",
      ...
      "ZA(0,1)", "ZA(0,2)", "ZA(1,0)", "ZA(1,1)", "ZA(1,2)", "ZA(2,0)", "ZA(2,1)",
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS> input_parameter_names
       = {"m0", "m12", "TanBeta", "Azero", "LambdaInput", "ALambdaInput",
      "vSInput", "Qq", "Ql", "QHd", "QHu", "Qd", "Qu", "Qe", "Qs", "Qv"};
