...
#ifndef UMSSM_WEINBERG_ANGLE_H
#define UMSSM_WEINBERG_ANGLE_H
...
public:
   ...
   UMSSM_weinberg_angle(const UMSSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const UMSSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const UMSSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
   ...
   std::complex<double> CpbarFvFvhhPL(int gI2, int gO1, int gI1) const;
   std::complex<double> CpChiFvconjSvPL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpbarFvFvAhPL(int gI2, int gO1, int gI1) const;
   std::complex<double> CpbarChaFeconjSvPL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpbarFvFeconjHpmPL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpChiFeconjSePL(int gI1, int gO1, int gI2) const;
   std::complex<double> CpbarChabarFvSePR(int gI1, int gO2, int gI3) const;
   std::complex<double> CpbarFvFvhhPR(int gO2, int gI1, int gI3) const;
   std::complex<double> CpbarFvFvAhPR(int gO2, int gI1, int gI3) const;
   std::complex<double> CpbarFvChiSvPR(int gO2, int gI1, int gI3) const;
   std::complex<double> CpbarFvFeconjHpmPR(int gO2, int gI3, int gI1) const;
