...
/**
 * @file UMSSM_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 12 Jul 2016 11:30:59
...
/**
 * @class UMSSM_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class UMSSM_slha<Two_scale> : public UMSSM<Two_scale> {
public:
   explicit UMSSM_slha(const UMSSM_input_parameters& input_ = UMSSM_input_parameters());
   explicit UMSSM_slha(const UMSSM<Two_scale>&, bool do_convert_masses_to_slha = true);
   virtual ~UMSSM_slha();
