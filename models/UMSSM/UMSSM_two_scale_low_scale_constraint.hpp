...
#include "UMSSM_low_scale_constraint.hpp"
...
template<>
class UMSSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "UMSSM low-scale constraint"; }
