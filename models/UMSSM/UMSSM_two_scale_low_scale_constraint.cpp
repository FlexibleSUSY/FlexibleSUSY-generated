...
// File generated at Fri 26 Jun 2015 19:03:55
...
UMSSM_low_scale_constraint<Two_scale>::UMSSM_low_scale_constraint(
   UMSSM<Two_scale>* model_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void UMSSM_low_scale_constraint<Two_scale>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& UMSSM_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return oneset;
}
