...
// File generated at Tue 24 Feb 2015 17:36:07
...
UMSSM_low_scale_constraint<Two_scale>::UMSSM_low_scale_constraint(
   ...
   const UMSSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(model_)
...
void UMSSM_low_scale_constraint<Two_scale>::set_input_parameters(const UMSSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
