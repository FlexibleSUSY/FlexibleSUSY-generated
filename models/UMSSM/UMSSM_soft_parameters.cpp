...
// File generated at Tue 10 Oct 2017 22:13:42
   ...
   if (loops > 0) {
      ...
      TRACE_STRUCT.Tr34 = Re(0.1*gp*(-10*(mHd2*QHd + mHu2*QHu + ms2*Qs)*AbsSqr(
         ...
         *(md2).trace() + 6*Qe*Sqr(g1)*(me2).trace() + 10*Cube(Qe)*Sqr(gp)*(me2)
         .trace() + 3*Ql*Sqr(g1)*(ml2).trace() + 15*Ql*Sqr(g2)*(ml2).trace() + 20*
         Cube(Ql)*Sqr(gp)*(ml2).trace() + Qq*Sqr(g1)*(mq2).trace() + 45*Qq*Sqr(g2)*(
         mq2).trace() + 80*Qq*Sqr(g3)*(mq2).trace() + 60*Cube(Qq)*Sqr(gp)*(mq2).trace
         () + 8*Qu*Sqr(g1)*(mu2).trace() + 40*Qu*Sqr(g3)*(mu2).trace() + 30*Cube(Qu)*
         Sqr(gp)*(mu2).trace() + 10*Cube(Qv)*Sqr(gp)*(mvR2).trace() - 30*mHd2*QHd*(Yd
         *Yd.adjoint()).trace() - 10*mHd2*QHd*(Ye*Ye.adjoint()).trace() - 30*mHu2*QHu
         *(Yu*Yu.adjoint()).trace() - 10*mHu2*QHu*(Yv*Yv.adjoint()).trace() - 10*Ql*(
         ml2*Yv*Yv.adjoint()).trace() - 10*Qv*(mvR2*Yv.adjoint()*Yv).trace() - 30*Qd*
         (Yd*Yd.adjoint()*md2.conjugate()).trace() - 30*Qq*(Yd*mq2.conjugate()*
         Yd.adjoint()).trace() - 10*Qe*(Ye*Ye.adjoint()*me2.conjugate()).trace() - 10
         *Ql*(Ye*ml2.conjugate()*Ye.adjoint()).trace() - 30*Qu*(Yu*Yu.adjoint()*
         mu2.conjugate()).trace() - 30*Qq*(Yu*mq2.conjugate()*Yu.adjoint()).trace()))
         ;
