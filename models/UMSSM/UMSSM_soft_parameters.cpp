...
// File generated at Tue 22 Jan 2019 17:28:53
...
UMSSM_soft_parameters UMSSM_soft_parameters::calc_beta(int loops) const
{
   ...
   if (loops > 0) {
      ...
      beta_TYv += calc_beta_TYv_1_loop(TRACE_STRUCT);
      ...
      beta_mvR2 += calc_beta_mvR2_1_loop(TRACE_STRUCT);
      ...
      beta_MassU += calc_beta_MassU_1_loop(TRACE_STRUCT);
      ...
      if (loops > 1) {
         ...
         beta_TYv += calc_beta_TYv_2_loop(TRACE_STRUCT);
         ...
         beta_mvR2 += calc_beta_mvR2_2_loop(TRACE_STRUCT);
   ...
   const UMSSM_susy_parameters susy_betas(UMSSM_susy_parameters::calc_beta(loops));
...
UMSSM_soft_parameters::Soft_traces UMSSM_soft_parameters::calc_soft_traces(int loops) const
{
   ...
   if (loops > 0) {
      ...
      TRACE_STRUCT.Tr14 = Re(gp*(2*mHd2*QHd + 2*mHu2*QHu + ms2*Qs + 3*Qd*(md2).trace(
         ) + Qe*(me2).trace() + 2*Ql*(ml2).trace() + 6*Qq*(mq2).trace() + 3*Qu*(mu2).
         trace() + Qv*(mvR2).trace()));
      TRACE_STRUCT.Tr2U111 = Re(0.1*Sqr(g1)*(3*mHd2 + 3*mHu2 + 2*(md2).trace() + 6*(
         me2).trace() + 3*(ml2).trace() + (mq2).trace() + 8*(mu2).trace()));
      TRACE_STRUCT.Tr2U114 = Re(0.7745966692414834*g1*gp*(-(mHd2*QHd) + mHu2*QHu + Qd
         *(md2).trace() + Qe*(me2).trace() - Ql*(ml2).trace() + Qq*(mq2).trace() - 2*
         Qu*(mu2).trace()));
      TRACE_STRUCT.Tr31 = Re(0.012909944487358056*g1*(30*(mHd2 - mHu2)*AbsSqr(Lambdax
         ) - 9*mHd2*Sqr(g1) + 9*mHu2*Sqr(g1) - 45*mHd2*Sqr(g2) + 45*mHu2*Sqr(g2) - 60
         *mHd2*Sqr(gp)*Sqr(QHd) + 60*mHu2*Sqr(gp)*Sqr(QHu) + 4*(Sqr(g1) + 20*Sqr(g3)
         + 15*Sqr(gp)*Sqr(Qd))*(md2).trace() + 36*Sqr(g1)*(me2).trace() + 60*Sqr(gp)*
         Sqr(Qe)*(me2).trace() - 9*Sqr(g1)*(ml2).trace() - 45*Sqr(g2)*(ml2).trace() -
         60*Sqr(gp)*Sqr(Ql)*(ml2).trace() + Sqr(g1)*(mq2).trace() + 45*Sqr(g2)*(mq2).
         trace() + 80*Sqr(g3)*(mq2).trace() + 60*Sqr(gp)*Sqr(Qq)*(mq2).trace() - 32*
         Sqr(g1)*(mu2).trace() - 160*Sqr(g3)*(mu2).trace() - 120*Sqr(gp)*Sqr(Qu)*(mu2
         ).trace() + 90*mHd2*(Yd*Yd.adjoint()).trace() + 30*mHd2*(Ye*Ye.adjoint()).
         trace() - 90*mHu2*(Yu*Yu.adjoint()).trace() - 30*mHu2*(Yv*Yv.adjoint()).
         trace() + 30*(ml2*Yv*Yv.adjoint()).trace() - 60*(Yd*Yd.adjoint()*md2.
      ...
      TRACE_STRUCT.Tr2U141 = Re(0.7745966692414834*g1*gp*(-(mHd2*QHd) + mHu2*QHu + Qd
         *(md2).trace() + Qe*(me2).trace() - Ql*(ml2).trace() + Qq*(mq2).trace() - 2*
         Qu*(mu2).trace()));
      TRACE_STRUCT.Tr2U144 = Re(Sqr(gp)*(2*mHd2*Sqr(QHd) + 2*mHu2*Sqr(QHu) + ms2*Sqr(
         Qs) + 3*Sqr(Qd)*(md2).trace() + Sqr(Qe)*(me2).trace() + 2*Sqr(Ql)*(ml2).
      ...
      TRACE_STRUCT.Tr34 = Re(0.1*gp*(-10*(mHd2*QHd + mHu2*QHu + ms2*Qs)*AbsSqr(
         ...
         15*mHu2*QHu*Sqr(g2) + 20*mHd2*Cube(QHd)*Sqr(gp) + 20*mHu2*Cube(QHu)*Sqr(gp)
         + 10*ms2*Cube(Qs)*Sqr(gp) + 2*Qd*(Sqr(g1) + 20*Sqr(g3) + 15*Sqr(gp)*Sqr(Qd))
         *(md2).trace() + 6*Qe*Sqr(g1)*(me2).trace() + 10*Cube(Qe)*Sqr(gp)*(me2).
         trace() + 3*Ql*Sqr(g1)*(ml2).trace() + 15*Ql*Sqr(g2)*(ml2).trace() + 20*Cube
         (Ql)*Sqr(gp)*(ml2).trace() + Qq*Sqr(g1)*(mq2).trace() + 45*Qq*Sqr(g2)*(mq2).
         trace() + 80*Qq*Sqr(g3)*(mq2).trace() + 60*Cube(Qq)*Sqr(gp)*(mq2).trace() +
         8*Qu*Sqr(g1)*(mu2).trace() + 40*Qu*Sqr(g3)*(mu2).trace() + 30*Cube(Qu)*Sqr(
         gp)*(mu2).trace() + 10*Cube(Qv)*Sqr(gp)*(mvR2).trace() - 30*mHd2*QHd*(Yd*Yd.
         adjoint()).trace() - 10*mHd2*QHd*(Ye*Ye.adjoint()).trace() - 30*mHu2*QHu*(Yu
         *Yu.adjoint()).trace() - 10*mHu2*QHu*(Yv*Yv.adjoint()).trace() - 10*Ql*(ml2*
         Yv*Yv.adjoint()).trace() - 10*Qv*(mvR2*Yv.adjoint()*Yv).trace() - 30*Qd*(Yd*
         Yd.adjoint()*md2.conjugate()).trace() - 30*Qq*(Yd*mq2.conjugate()*Yd.adjoint
         ()).trace() - 10*Qe*(Ye*Ye.adjoint()*me2.conjugate()).trace() - 10*Ql*(Ye*
         ml2.conjugate()*Ye.adjoint()).trace() - 30*Qu*(Yu*Yu.adjoint()*mu2.conjugate
         ()).trace() - 30*Qq*(Yu*mq2.conjugate()*Yu.adjoint()).trace()));
      ...
      TRACE_STRUCT.traceconjTYvTpTYv = Re((TYv.conjugate()*(TYv).transpose()).trace()
         );
      ...
      TRACE_STRUCT.traceYvAdjYvconjml2 = Re((Yv*Yv.adjoint()*ml2.conjugate()).trace()
         );
      TRACE_STRUCT.traceYvconjmvR2AdjYv = Re((Yv*mvR2.conjugate()*Yv.adjoint()).trace
         ());
   ...
   if (loops > 1) {
      ...
      TRACE_STRUCT.traceYeAdjTYeTYeAdjYe = Re((Ye*(TYe).adjoint()*TYe*Ye.adjoint()).
         trace());
      TRACE_STRUCT.traceYeconjTYvTpTYvAdjYe = Re((Ye*TYv.conjugate()*(TYv).transpose(
         )*Ye.adjoint()).trace());
      ...
      TRACE_STRUCT.traceYvAdjYvTYvAdjYv = Re((Yv*Yv.adjoint()*TYv*Yv.adjoint()).trace
         ());
      ...
      TRACE_STRUCT.traceYvAdjTYvTYvAdjYv = Re((Yv*(TYv).adjoint()*TYv*Yv.adjoint()).
         trace());
      TRACE_STRUCT.traceAdjYeTYeconjYvTpYv = Re((Ye.adjoint()*TYe*Yv.conjugate()*Yv.
         transpose()).trace());
      TRACE_STRUCT.traceAdjYeTYeconjTYvTpYv = Re((Ye.adjoint()*TYe*TYv.conjugate()*Yv
         .transpose()).trace());
      TRACE_STRUCT.traceAdjYvTpYeconjYeTYv = Re((Yv.adjoint()*Ye.transpose()*Ye.
         conjugate()*TYv).trace());
      TRACE_STRUCT.traceAdjYvTpYeconjTYeTYv = Re((Yv.adjoint()*Ye.transpose()*TYe.
         conjugate()*TYv).trace());
      ...
      TRACE_STRUCT.traceYvAdjYvYvAdjYvconjml2 = Re((Yv*Yv.adjoint()*Yv*Yv.adjoint()*
         ml2.conjugate()).trace());
      TRACE_STRUCT.traceYvAdjYvYvconjmvR2AdjYv = Re((Yv*Yv.adjoint()*Yv*mvR2.
         conjugate()*Yv.adjoint()).trace());
      TRACE_STRUCT.traceYvAdjYvconjml2YvAdjYv = Re((Yv*Yv.adjoint()*ml2.conjugate()*
         Yv*Yv.adjoint()).trace());
      TRACE_STRUCT.traceYvAdjYvconjml2TpYeconjYe = Re((Yv*Yv.adjoint()*ml2.conjugate(
         )*Ye.transpose()*Ye.conjugate()).trace());
      TRACE_STRUCT.traceYvAdjYvTpYeconjme2conjYe = Re((Yv*Yv.adjoint()*Ye.transpose()
         *me2.conjugate()*Ye.conjugate()).trace());
      TRACE_STRUCT.traceYvAdjYvTpYeconjYeconjml2 = Re((Yv*Yv.adjoint()*Ye.transpose()
         *Ye.conjugate()*ml2.conjugate()).trace());
      TRACE_STRUCT.traceYvconjmvR2AdjYvYvAdjYv = Re((Yv*mvR2.conjugate()*Yv.adjoint()
         *Yv*Yv.adjoint()).trace());
      TRACE_STRUCT.traceYvconjmvR2AdjYvTpYeconjYe = Re((Yv*mvR2.conjugate()*Yv.
         adjoint()*Ye.transpose()*Ye.conjugate()).trace());
