...
int run_solver(const UMSSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(UMSSM_slha_io::fill_slhaea(
...
int run(int solver_type, const UMSSM_input_parameters& input)
{
   int exit_code = 0;
