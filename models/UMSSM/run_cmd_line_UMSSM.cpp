...
int run_solver(int loop_library, const UMSSM_input_parameters& input)
{
   ...
   UMSSM_decays decays;if (settings.get(Spectrum_generator_settings::calculate_sm_masses)) {
...
int run(int solver_type, int loop_library, const UMSSM_input_parameters& input)
{
   int exit_code = 0;
