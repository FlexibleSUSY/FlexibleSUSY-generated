...
template<> struct VertexImpl<fields::Ah, fields::hh, fields::Sv, typename fields::conj<fields::Sv>::type>
{
   static ScalarVertex evaluate(const std::array<int, 4>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename fields::bar<fields::Fv>::type, fields::Fv, fields::Ah>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename fields::bar<fields::Fv>::type, fields::Fv, fields::hh>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
