...
int main(int argc, char* argv[])
{
   ...
   UMSSM_spectrum_generator<Two_scale> spectrum_generator;
   ...
   UMSSM_slha m = std::get<0>(spectrum_generator.get_models_slha());

   Loop_library::set(1);
   Physical_input physical_input;
   UMSSM_decays decays(m, qedqcd, physical_input, flexibledecay_settings);
