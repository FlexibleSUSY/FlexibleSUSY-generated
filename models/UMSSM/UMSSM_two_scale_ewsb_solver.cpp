...
// File generated at Tue 22 Jan 2019 17:54:22
 ...
 *
 * This file was generated at Tue 22 Jan 2019 17:54:22 with FlexibleSUSY
...
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const UMSSM_mass_eigenstates& model) const
{
   ...
   mHd2 = Re((0.025*(14.142135623730951*vS*vu*Conj(TLambdax) + 40*tadpole[0] - 3*
      Cube(vd)*Sqr(g1) - 5*Cube(vd)*Sqr(g2) - 20*Cube(vd)*Sqr(gp)*Sqr(QHd) - 20*vd
   ...
   mHu2 = Re((0.025*(14.142135623730951*vd*vS*Conj(TLambdax) + 40*tadpole[1] - 3*
      Cube(vu)*Sqr(g1) - 5*Cube(vu)*Sqr(g2) - 20*Cube(vu)*Sqr(gp)*Sqr(QHu) - 20*vu
   ...
   ms2 = Re((0.25*(1.4142135623730951*vd*vu*Conj(TLambdax) + 4*tadpole[2] - 2*Cube
      (vS)*Sqr(gp)*Sqr(Qs) - 2*vS*AbsSqr(Lambdax)*Sqr(vd) - 2*QHd*Qs*vS*Sqr(gp)*
