...
UMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBUMSSM_SRC += \
		$(DIR)/UMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/UMSSM_two_scale_ewsb_solver.cpp \
...
LIBUMSSM_HDR += \
		...
		$(DIR)/UMSSM_two_scale_spectrum_generator.hpp \
