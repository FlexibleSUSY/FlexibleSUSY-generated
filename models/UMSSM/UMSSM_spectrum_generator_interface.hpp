...
public:
   ...
   virtual void run(const softsusy::QedQcd&, const UMSSM_input_parameters&) = 0;
 ...
 */
template <class T>
void UMSSM_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
