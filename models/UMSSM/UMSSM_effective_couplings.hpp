...
#ifndef UMSSM_EFFECTIVE_COUPLINGS_H
#define UMSSM_EFFECTIVE_COUPLINGS_H
...
class UMSSM_effective_couplings {
public:
   UMSSM_effective_couplings(const UMSSM_mass_eigenstates&,
                                   const softsusy::QedQcd&,
                                   const Physical_input&);
   ~UMSSM_effective_couplings();
   ...
   void set_model(const UMSSM_mass_eigenstates& model_);
