...
// File generated at Fri 20 Oct 2017 09:01:50

/**
 * @file UMSSM_a_muon.cpp
 *
 * This file was generated at Fri 20 Oct 2017 09:01:50 with FlexibleSUSY
...
#include "UMSSM_cxx_diagrams.hpp"
...
double calculate_a_muon_impl(UMSSM_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const UMSSM_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("UMSSM_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double UMSSM_a_muon::calculate_a_muon(const UMSSM_mass_eigenstates& model_)
{
...
double UMSSM_a_muon::calculate_a_muon_uncertainty(const UMSSM_mass_eigenstates& model_)
{
   UMSSM_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("UMSSM_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
