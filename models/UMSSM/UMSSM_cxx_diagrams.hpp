...
// File generated at Tue 10 Oct 2017 22:48:52

/**
 * @file UMSSM_cxx_diagrams.hpp
 *
 * This file was generated at Tue 10 Oct 2017 22:48:52 with FlexibleSUSY
 * 2.0.0 and SARAH 4.12.0 .
 */

#ifndef UMSSM_CXXDIAGRAMS_H
#define UMSSM_CXXDIAGRAMS_H
...
*/
struct EvaluationContext {
   UMSSM_mass_eigenstates& model; ///< The model object.
...
{
   static constexpr impl::IndexBounds<3> index_bounds = { { 0, 0, 0 }, { 3, 6, 2 } };
   static constexpr int fieldIndexStart[4] = { 0, 1, 2, 3 };
   using vertex_type = LeftAndRightComponentedVertex;
};
...
Vertex<bar<Fe>::type, Ah, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gt2,0))*SUM(j2,0,2,Conj(ZEL(gt3,j2))*SUM(j1,0,2,Conj(ZER(gt1,j1))*Ye(j1,j2)));

   const std::complex<double> right = std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gt2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt3,j1))*ZEL(gt1,j2));
...
Vertex<Fe, Ah, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0.,-0.7071067811865475)*Conj(ZA(gt2,0))*SUM(j2,0,2,Conj(ZEL(gt1,j2))*SUM(j1,0,2,Conj(ZER(gt3,j1))*Ye(j1,j2)));

   const std::complex<double> right = std::complex<double>(0.,0.7071067811865475)*Conj(ZA(gt2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt1,j1))*ZEL(gt3,j2));
...
Vertex<Fe, Chi, conj<Se>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -1.4142135623730951*gp*Ql*Conj(ZN(gt2,0))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1)) + 0.5477225575051661*g1*Conj(ZN(gt2,1))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1)) + 0.7071067811865475*g2*Conj(ZN(gt2,2))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZE(gt3,j1)) - Conj(ZN(gt2,3))*SUM(j2,0,2,Conj(ZEL(gt1,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)));

   const std::complex<double> right = -1.4142135623730951*SUM(j1,0,2,ZE(gt3,3 + j1)*ZER(gt1,j1))*(gp*Qe*ZN(gt2,0) + 0.7745966692414834*g1*ZN(gt2,1)) - SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt1,j1))*ZE(gt3,j2))*ZN(gt2,3);
...
Vertex<Fe, bar<Fv>::type, conj<Hpm>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = SUM(j2,0,2,Conj(ZVR(gt2,j2))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*Yv(j1,j2)))*ZP(gt3,1);

   const std::complex<double> right = SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt1,j1))*ZVL(gt2,j2))*ZP(gt3,0);
...
Vertex<bar<Fe>::type, hh, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,Conj(ZEL(gt3,j2))*SUM(j1,0,2,Conj(ZER(gt1,j1))*Ye(j1,j2)));

   const std::complex<double> right = -0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt3,j1))*ZEL(gt1,j2));
...
Vertex<Fe, hh, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,Conj(ZEL(gt1,j2))*SUM(j1,0,2,Conj(ZER(gt3,j1))*Ye(j1,j2)));

   const std::complex<double> right = -0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*ZER(gt1,j1))*ZEL(gt3,j2));
...
Vertex<bar<Fe>::type, Sv, Cha>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> right = -(g2*SUM(j1,0,2,Conj(ZV(gt2,j1))*ZEL(gt1,j1))*UP(gt3,0)) + SUM(j2,0,2,Conj(ZV(gt2,3 + j2))*SUM(j1,0,2,Conj(Yv(j1,j2))*ZEL(gt1,j1)))*UP(gt3,1);
...
Vertex<Fe, conj<Sv>::type, bar<Cha>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = -(g2*Conj(UP(gt3,0))*SUM(j1,0,2,Conj(ZEL(gt1,j1))*ZV(gt2,j1))) + Conj(UP(gt3,1))*SUM(j2,0,2,SUM(j1,0,2,Conj(ZEL(gt1,j1))*Yv(j1,j2))*ZV(gt2,3 + j2));
