...
// File generated at Tue 10 Oct 2017 22:15:49
...
Eigen::Matrix<double,3,3> UMSSM_soft_parameters::calc_beta_md2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_md2_1 = (UNITMATRIX(3)*(0.8*
      ...
      *(Conj(MassB)*Sqr(g1) + 5*(3*traceconjTYdTpYd + traceconjTYeTpYe + Conj(
      ...
      Yu.adjoint()*Yu*Yd.adjoint()*md2) + 0.035555555555555556*twoLoop*(15*(
      3.872983346207417*g1*(gp*Qd*(Tr2U114 + Tr2U141) + Tr31) + 15*gp*Qd*(gp*Qd
      *Tr2U144 + Tr34) + 20*Tr23*Quad(g3) + Tr2U111*Sqr(g1)) + AbsSqr(MassB)*
