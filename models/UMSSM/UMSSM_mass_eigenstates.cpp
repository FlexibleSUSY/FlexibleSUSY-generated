...
// File generated at Tue 10 Oct 2017 22:47:19
 ...
 * parameters.
 *
 * This file was generated at Tue 10 Oct 2017 22:47:19 with FlexibleSUSY
...
int CLASSNAME::solve_ewsb_tree_level_custom()
{
   ...
   mHd2 = Re((0.025*(14.142135623730951*vS*vu*Conj(TLambdax) - 3*Cube(vd)*Sqr(
      g1) - 5*Cube(vd)*Sqr(g2) - 20*Cube(vd)*Sqr(gp)*Sqr(QHd) - 20*vd*AbsSqr(
      Lambdax)*Sqr(vS) - 20*QHd*Qs*vd*Sqr(gp)*Sqr(vS) - 20*vd*AbsSqr(Lambdax)*Sqr(
      vu) + 3*vd*Sqr(g1)*Sqr(vu) + 5*vd*Sqr(g2)*Sqr(vu) - 20*QHd*QHu*vd*Sqr(gp)*
      Sqr(vu) + 14.142135623730951*vS*vu*TLambdax))/vd);
   mHu2 = Re((0.025*(14.142135623730951*vd*vS*Conj(TLambdax) - 3*Cube(vu)*Sqr(
      g1) - 5*Cube(vu)*Sqr(g2) - 20*Cube(vu)*Sqr(gp)*Sqr(QHu) - 20*vu*AbsSqr(
      Lambdax)*Sqr(vd) + 3*vu*Sqr(g1)*Sqr(vd) + 5*vu*Sqr(g2)*Sqr(vd) - 20*QHd*QHu*
      vu*Sqr(gp)*Sqr(vd) - 20*vu*AbsSqr(Lambdax)*Sqr(vS) - 20*QHu*Qs*vu*Sqr(gp)*
      Sqr(vS) + 14.142135623730951*vd*vS*TLambdax))/vu);
...
double CLASSNAME::get_ewsb_eq_hh_1() const
{
   ...
   double result = Re(mHd2*vd - 0.35355339059327373*vS*vu*Conj(TLambdax) +
      0.075*Cube(vd)*Sqr(g1) + 0.125*Cube(vd)*Sqr(g2) + 0.5*Cube(vd)*Sqr(gp)*Sqr(
      QHd) + 0.5*vd*AbsSqr(Lambdax)*Sqr(vS) + 0.5*QHd*Qs*vd*Sqr(gp)*Sqr(vS) + 0.5*
      vd*AbsSqr(Lambdax)*Sqr(vu) - 0.075*vd*Sqr(g1)*Sqr(vu) - 0.125*vd*Sqr(g2)*Sqr
      (vu) + 0.5*QHd*QHu*vd*Sqr(gp)*Sqr(vu) - 0.35355339059327373*vS*vu*TLambdax);
...
double CLASSNAME::get_ewsb_eq_hh_2() const
{
   ...
   double result = Re(mHu2*vu - 0.35355339059327373*vd*vS*Conj(TLambdax) +
      0.075*Cube(vu)*Sqr(g1) + 0.125*Cube(vu)*Sqr(g2) + 0.5*Cube(vu)*Sqr(gp)*Sqr(
      QHu) + 0.5*vu*AbsSqr(Lambdax)*Sqr(vd) - 0.075*vu*Sqr(g1)*Sqr(vd) - 0.125*vu*
      Sqr(g2)*Sqr(vd) + 0.5*QHd*QHu*vu*Sqr(gp)*Sqr(vd) + 0.5*vu*AbsSqr(Lambdax)*
      Sqr(vS) + 0.5*QHu*Qs*vu*Sqr(gp)*Sqr(vS) - 0.35355339059327373*vd*vS*TLambdax
      );
...
double CLASSNAME::get_ewsb_eq_hh_3() const
{
   ...
   double result = Re(ms2*vS - 0.35355339059327373*vd*vu*Conj(TLambdax) + 0.5*
      Cube(vS)*Sqr(gp)*Sqr(Qs) + 0.5*vS*AbsSqr(Lambdax)*Sqr(vd) + 0.5*QHd*Qs*vS*
      Sqr(gp)*Sqr(vd) + 0.5*vS*AbsSqr(Lambdax)*Sqr(vu) + 0.5*QHu*Qs*vS*Sqr(gp)*Sqr
      (vu) - 0.35355339059327373*vd*vu*TLambdax);
...
std::complex<double> CLASSNAME::CpChiFdconjUSdPL(int gI2, int gI1, int gO1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Qq*
      Conj(ZDL(gI1,gO1))*Conj(ZN(gI2,0)),0) + IF(gO1 < 3,-0.18257418583505536*g1*
      Conj(ZDL(gI1,gO1))*Conj(ZN(gI2,1)),0) + IF(gO1 < 3,0.7071067811865475*g2*
      Conj(ZDL(gI1,gO1))*Conj(ZN(gI2,2)),0) - Conj(ZN(gI2,3))*SUM(j2,0,2,Conj(ZDL(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*Yd(j1,j2)));
...
std::complex<double> CLASSNAME::CpUSdconjUSdconjSdSd(int gO1, int gO2, int gI1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Yd(j1
      ...
      (gO2,3 + j1))*ZD(gI1,gO1),0) + IF(gO1 < 3,0.6666666666666666*Sqr(g3)*SUM(j1,
      0,2,Conj(ZD(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZD(gI1,gO1),0) + IF(gO1
      ...
      ,Conj(ZD(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2))*ZD(gI1,gO1),0) + IF(gO1 <
      3,0.6666666666666666*Sqr(g3)*SUM(j2,0,2,Conj(ZD(gI2,3 + j2))*KroneckerDelta(
      ...
      gO2 < 3,-0.5*Qd*Qq*Conj(ZD(gI2,gO2))*Sqr(gp)*SUM(j1,0,2,KroneckerDelta(gO1,3
      ...
      < 3,0.6666666666666666*Conj(ZD(gI2,gO2))*Sqr(g3)*SUM(j2,0,2,KroneckerDelta(
      gO1,3 + j2)*ZD(gI1,3 + j2)),0) + IF(gO2 < 3,-0.5*Qd*Qq*Conj(ZD(gI2,gO2))*Sqr
      (gp)*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZD(gI1,3 + j2)),0) + IF(gO2 < 3,
      -3*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1)))*SUM(j3,
      0,2,Conj(Yd(j3,gO2))*KroneckerDelta(gO1,3 + j3)),0) - 0.03333333333333333*
      Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZD(gI1,3 + j1))*SUM(j2,0,2,
      Conj(ZD(gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) - 0.6666666666666666*Sqr(g3
      )*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZD(gI1,3 + j1))*SUM(j2,0,2,Conj(ZD(
      gI2,3 + j2))*KroneckerDelta(gO2,3 + j2)) - 0.5*Sqr(gp)*Sqr(Qd)*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpUSdconjUSdconjSuSu(int gO1, int gO2, int gI1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Yu(j1
      ...
      j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)),0) + IF(gO1 < 3,-1.5*KroneckerDelta(gO1,
      gO2)*Sqr(gp)*Sqr(Qq)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)),0) + IF(gO1 < 3
      ,0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,
      3 + j1)),0) + IF(gO1 < 3,-1.5*Qq*Qu*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0
      ,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)),0) + IF(gO1 < 3,-0.025*
      ...
      )*ZU(gI1,j2)),0) + IF(gO1 < 3,-1.5*KroneckerDelta(gO1,gO2)*Sqr(gp)*Sqr(Qq)*
      SUM(j2,0,2,Conj(ZU(gI2,j2))*ZU(gI1,j2)),0) + IF(gO1 < 3,0.1*KroneckerDelta(
      gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*ZU(gI1,3 + j2)),0) + IF(gO1
      < 3,-1.5*Qq*Qu*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j2,0,2,Conj(ZU(gI2,3 +
      j2))*ZU(gI1,3 + j2)),0) - 0.05*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1
      ))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 1.5*
      Qd*Qq*Sqr(gp)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1))*SUM(j2,0,2,
      ...
      j2)*KroneckerDelta(gO2,3 + j2)) - 1.5*Qd*Qu*Sqr(gp)*SUM(j1,0,2,Conj(ZU(gI2,3
      + j1))*ZU(gI1,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta
      (gO2,3 + j2)) - 0.05*Sqr(g1)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*
      KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZU(gI2,j2))*ZU(gI1,j2)) - 1.5*Qd
      *Qq*Sqr(gp)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)
      )*SUM(j2,0,2,Conj(ZU(gI2,j2))*ZU(gI1,j2)) + 0.2*Sqr(g1)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZU(
      gI2,3 + j2))*ZU(gI1,3 + j2)) - 1.5*Qd*Qu*Sqr(gp)*SUM(j1,0,2,KroneckerDelta(
      gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZU(gI2,3 + j2))*ZU(
      gI1,3 + j2)) - SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 +
      j1)*Yd(j1,j2)))*SUM(j4,0,2,SUM(j3,0,2,Conj(Yd(j3,j4))*KroneckerDelta(gO1,3
      + j3))*ZU(gI1,j4));
...
std::complex<double> CLASSNAME::CpUSdSeconjUSdconjSe(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.125*
      ...
      IF(gO1 < 3,-0.5*Ql*Qq*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0,2,Conj(ZE(
      gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1)),0) + IF(gO1 < 3,-0.5*Qe*Qq*
      ...
      (gp)*SUM(j2,0,2,Conj(ZE(gI1,3 + j2))*ZE(gI2,3 + j2)),0) + IF(gO1 < 3,-(SUM(
      j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,gO1))*SUM(j4,0,2,SUM(j3,0,2,Conj(Ye(
      j3,j4))*Conj(ZE(gI1,3 + j3)))*ZE(gI2,j4))),0) + IF(gO2 < 3,-(SUM(j2,0,2,Conj
      ...
      )*ZE(gI2,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 +
      j2)) - 0.5*Qd*Ql*Sqr(gp)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1))*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 0.1*Sqr(g1)*SUM(j1,
...
std::complex<double> CLASSNAME::CpUSdSvconjUSdconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,0.125*
      ...
      IF(gO1 < 3,-0.5*Ql*Qq*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0,2,Conj(ZV(
      gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,-0.5*Qq*Qv*KroneckerDelta(gO1,gO2)*Sqr(
      gp)*SUM(j1,0,2,Conj(ZV(gI1,3 + j1))*ZV(gI2,3 + j1)),0) + IF(gO1 < 3,0.025*
...
std::complex<double> CLASSNAME::CpHpmSuconjUSd(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      *SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1)))*ZP(gI2,0),0) + IF(gO2 < 3
      ...
      ,gO2))*Sqr(g2)*ZP(gI2,1),0) + IF(gO2 < 3,SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*
      ...
      (j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2)))*ZP(gI2,1) +
...
std::complex<double> CLASSNAME::CphhSdconjUSd(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZD(gI1,gO2))*
      ...
      ) + IF(gO2 < 3,-(QHd*Qq*vd*Conj(ZD(gI1,gO2))*Conj(ZH(gI2,0))*Sqr(gp)),0) +
      IF(gO2 < 3,-(QHu*Qq*vu*Conj(ZD(gI1,gO2))*Conj(ZH(gI2,1))*Sqr(gp)),0) + IF(
      gO2 < 3,-(Qq*Qs*vS*Conj(ZD(gI1,gO2))*Conj(ZH(gI2,2))*Sqr(gp)),0) + IF(gO2 <
      3,0.5*vS*Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,gO2))*Conj(ZD(gI1,3 +
      j1))),0) + IF(gO2 < 3,0.5*vu*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,Conj(Yd(j1,
      gO2))*Conj(ZD(gI1,3 + j1))),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,
      0))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*Conj(TYd(j1,gO2))),0) + IF(gO2 < 3,-(vd*
      Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,Conj(Yd(j1,gO2))*Yd(
      j1,j2)))),0) + 0.1*vd*Conj(ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1)
      )*KroneckerDelta(gO2,3 + j1)) - 0.1*vu*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      Conj(ZD(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) - Qd*QHd*vd*Conj(ZH(gI2,0))
      *Sqr(gp)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) - Qd*
      QHu*vu*Conj(ZH(gI2,1))*Sqr(gp)*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*
      KroneckerDelta(gO2,3 + j1)) - Qd*Qs*vS*Conj(ZH(gI2,2))*Sqr(gp)*SUM(j1,0,2,
      Conj(ZD(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj
      (ZH(gI2,1))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1
      )*Yd(j1,j2))) + 0.5*vu*Conj(Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,Conj(ZD(gI1,
      j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Yd(j1,j2))) - 0.7071067811865475*
      Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3
      + j1)*TYd(j1,j2))) - vd*Conj(ZH(gI2,0))*SUM(j3,0,2,Conj(ZD(gI1,3 + j3))*SUM(
      j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))));
...
std::complex<double> CLASSNAME::CpSdconjUSdVZ(int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.5*g2*Conj(ZD(gI2,gO2))*Cos
      ...
      gI2,gO2))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gO2 < 3,gp*Qq*Conj(ZD(gI2,gO2
      ))*Sin(ThetaWp()),0) + 0.2581988897471611*g1*Cos(ThetaWp())*Sin(ThetaW())*
      SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*KroneckerDelta(gO2,3 + j1)) - gp*Qd*Sin(
...
std::complex<double> CLASSNAME::CpbarChaFeconjUSvPL(int gI1, int gI2, int gO1) const
{
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(UP(gI1,0))*Conj(ZEL
      (gI2,gO1))),0) + Conj(UP(gI1,1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*SUM(
      j1,0,2,Conj(ZEL(gI2,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpSeconjHpmconjUSv(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ...
      ZE(gI2,3 + j1)))*ZP(gI1,1),0) + IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,2,
...
std::complex<double> CLASSNAME::CpAhAhUSvconjUSv(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZA(gI1,1))*
      ...
      (gp)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) -
      Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2
      ,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Yv(j1,j2))));
...
std::complex<double> CLASSNAME::CpChiFvconjUSvPL(int gI2, int gI1, int gO1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Ql*
      Conj(ZN(gI2,0))*Conj(ZVL(gI1,gO1)),0) + IF(gO1 < 3,0.5477225575051661*g1*
      Conj(ZN(gI2,1))*Conj(ZVL(gI1,gO1)),0) + IF(gO1 < 3,-0.7071067811865475*g2*
      Conj(ZN(gI2,2))*Conj(ZVL(gI1,gO1)),0) - Conj(ZN(gI2,4))*SUM(j2,0,2,
      KroneckerDelta(gO1,3 + j2)*SUM(j1,0,2,Conj(ZVL(gI1,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpSdUSvconjSdconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)),0) + IF(gO1 < 3,0.125*
      ...
      IF(gO1 < 3,-0.5*Ql*Qq*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0,2,Conj(ZD(
      gI1,j1))*ZD(gI2,j1)),0) + IF(gO1 < 3,0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)),0) + IF(gO1 < 3,-0.5*Qd*Ql*
...
std::complex<double> CLASSNAME::CpSeUSvconjSeconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Ye(j1
      ...
      0.5*Qe*Qv*Sqr(gp)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1))*SUM(j2,0,
      2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 0.5*Ql*Qv*Sqr(gp)
      *SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,
      2,Conj(ZE(gI1,j2))*ZE(gI2,j2)) - 0.5*Qe*Qv*Sqr(gp)*SUM(j1,0,2,KroneckerDelta
      (gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZE(gI1,3 + j2))*ZE(
...
std::complex<double> CLASSNAME::CpSuUSvconjSuconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)),0) + IF(gO1 < 3,-0.125*
      ...
      IF(gO1 < 3,-0.5*Ql*Qq*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0,2,Conj(ZU(
      gI1,j1))*ZU(gI2,j1)),0) + IF(gO1 < 3,-0.1*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)),0) + IF(gO1 < 3,-0.5*Ql*Qu*
...
std::complex<double> CLASSNAME::CpSvUSvconjSvconjUSv(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j2,0,2,Yv(
      gO1,j2)*ZV(gI2,3 + j2))*SUM(j4,0,2,Conj(Yv(gO2,j4))*Conj(ZV(gI1,3 + j4)))),0
      ),0) + IF(gO1 < 3,IF(gO2 < 3,-0.15*Conj(ZV(gI1,gO2))*Sqr(g1)*ZV(gI2,gO1),0),
      0) + IF(gO1 < 3,IF(gO2 < 3,-0.25*Conj(ZV(gI1,gO2))*Sqr(g2)*ZV(gI2,gO1),0),0)
      + IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZV(gI1,gO2))*Sqr(gp)*Sqr(Ql)*ZV(gI2,gO1)),0)
      ,0) + IF(gO1 < 3,-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZV(
      gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*
      SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,-0.5*KroneckerDelta(
      gO1,gO2)*Sqr(gp)*Sqr(Ql)*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1
      < 3,-0.5*Ql*Qv*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI1,3 +
      j1))*ZV(gI2,3 + j1)),0) + IF(gO1 < 3,-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)*
      SUM(j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)),0) + IF(gO1 < 3,-0.125*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)),0) +
      IF(gO1 < 3,-0.5*KroneckerDelta(gO1,gO2)*Sqr(gp)*Sqr(Ql)*SUM(j2,0,2,Conj(ZV(
      gI1,j2))*ZV(gI2,j2)),0) + IF(gO1 < 3,-0.5*Ql*Qv*KroneckerDelta(gO1,gO2)*Sqr(
      gp)*SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*ZV(gI2,3 + j2)),0) + IF(gO1 < 3,-(SUM(j2
      ,0,2,KroneckerDelta(gO2,3 + j2)*Yv(gO1,j2))*SUM(j4,0,2,Conj(ZV(gI1,3 + j4))*
      SUM(j3,0,2,Conj(Yv(j3,j4))*ZV(gI2,j3)))),0) + IF(gO1 < 3,-0.5*Ql*Qv*Sqr(gp)*
      SUM(j1,0,2,Conj(ZV(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1))*ZV(gI2,gO1),0) +
      IF(gO1 < 3,-0.5*Ql*Qv*Sqr(gp)*SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*
      KroneckerDelta(gO2,3 + j2))*ZV(gI2,gO1),0) + IF(gO2 < 3,-0.5*Ql*Qv*Conj(ZV(
      gI1,gO2))*Sqr(gp)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*ZV(gI2,3 + j1)),0) +
      IF(gO2 < 3,-0.5*Ql*Qv*Conj(ZV(gI1,gO2))*Sqr(gp)*SUM(j2,0,2,KroneckerDelta(
      gO1,3 + j2)*ZV(gI2,3 + j2)),0) + IF(gO2 < 3,-(SUM(j2,0,2,SUM(j1,0,2,Conj(ZV(
      gI1,j1))*Yv(j1,j2))*ZV(gI2,3 + j2))*SUM(j4,0,2,Conj(Yv(gO2,j4))*
      KroneckerDelta(gO1,3 + j4))),0) - 0.5*Sqr(gp)*Sqr(Qv)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*ZV(gI2,3 + j1))*SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*
      KroneckerDelta(gO2,3 + j2)) - 0.5*Ql*Qv*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI1,j1))*
      ZV(gI2,j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)
      ) - 0.5*Sqr(gp)*Sqr(Qv)*SUM(j1,0,2,Conj(ZV(gI1,3 + j1))*ZV(gI2,3 + j1))*SUM(
      j2,0,2,KroneckerDelta(gO1,3 + j2)*KroneckerDelta(gO2,3 + j2)) - 0.5*Ql*Qv*
      Sqr(gp)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*
      SUM(j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)) - 0.5*Sqr(gp)*Sqr(Qv)*SUM(j1,0,2,
      KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,Conj(ZV(
      gI1,3 + j2))*ZV(gI2,3 + j2)) - 0.5*Sqr(gp)*Sqr(Qv)*SUM(j1,0,2,Conj(ZV(gI1,3
      + j1))*KroneckerDelta(gO2,3 + j1))*SUM(j2,0,2,KroneckerDelta(gO1,3 + j2)*ZV(
      gI2,3 + j2)) - SUM(j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(ZV(gI1,
      j1))*Yv(j1,j2)))*SUM(j4,0,2,KroneckerDelta(gO1,3 + j4)*SUM(j3,0,2,Conj(Yv(j3
      ,j4))*ZV(gI2,j3)));
...
{
   const std::complex<double> result = IF(gO2 < 3,std::complex<double>(0,0.5)*
      vS*Conj(ZA(gI2,0))*Lambdax*SUM(j2,0,2,Conj(Yv(gO2,j2))*Conj(ZV(gI1,3 + j2)))
      ,0) + IF(gO2 < 3,std::complex<double>(0,0.5)*vd*Conj(ZA(gI2,2))*Lambdax*SUM(
      j2,0,2,Conj(Yv(gO2,j2))*Conj(ZV(gI1,3 + j2))),0) + IF(gO2 < 3,std::complex<
...
std::complex<double> CLASSNAME::CphhSvconjUSv(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZH(gI2,0))*Conj
      (ZV(gI1,gO2))*Sqr(g1),0) + IF(gO2 < 3,0.15*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,
      gO2))*Sqr(g1),0) + IF(gO2 < 3,-0.25*vd*Conj(ZH(gI2,0))*Conj(ZV(gI1,gO2))*Sqr
      (g2),0) + IF(gO2 < 3,0.25*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,gO2))*Sqr(g2),0) +
      IF(gO2 < 3,-(QHd*Ql*vd*Conj(ZH(gI2,0))*Conj(ZV(gI1,gO2))*Sqr(gp)),0) + IF(
      gO2 < 3,-(QHu*Ql*vu*Conj(ZH(gI2,1))*Conj(ZV(gI1,gO2))*Sqr(gp)),0) + IF(gO2 <
      3,-(Ql*Qs*vS*Conj(ZH(gI2,2))*Conj(ZV(gI1,gO2))*Sqr(gp)),0) + IF(gO2 < 3,0.5
      *vS*Conj(ZH(gI2,0))*Lambdax*SUM(j2,0,2,Conj(Yv(gO2,j2))*Conj(ZV(gI1,3 + j2))
      ),0) + IF(gO2 < 3,0.5*vd*Conj(ZH(gI2,2))*Lambdax*SUM(j2,0,2,Conj(Yv(gO2,j2))
      *Conj(ZV(gI1,3 + j2))),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,1))*
      SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*Conj(TYv(gO2,j2))),0) + IF(gO2 < 3,-(vu*Conj
      (ZH(gI2,1))*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj(Yv(gO2,j1))*Yv(j2,j1
...
std::complex<double> CLASSNAME::CpUSuconjUSuVZVZ(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-0.5163977794943222*g1*gp*Qq*
      Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*Sin(ThetaW())*Sin(ThetaWp()),0) + IF(
      gO1 < 3,g2*gp*Qq*Cos(ThetaW())*KroneckerDelta(gO1,gO2)*Sin(2*ThetaWp()),0) +
      IF(gO1 < 3,-0.2581988897471611*g1*g2*Cos(ThetaW())*KroneckerDelta(gO1,gO2)*
      Sin(ThetaW())*Sqr(Cos(ThetaWp())),0) + IF(gO1 < 3,0.5*KroneckerDelta(gO1,gO2
...
std::complex<double> CLASSNAME::CpAhAhUSuconjUSu(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(Conj(ZA(gI1,1))*
      ...
      *SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) + 0.2*
      ...
      (gp)*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*KroneckerDelta(gO2,3 + j1)) -
      Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*SUM(j3,0,2,KroneckerDelta(gO1,3 + j3)*SUM(j2
      ,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))));
...
std::complex<double> CLASSNAME::CpChiFuconjUSuPL(int gI2, int gI1, int gO1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Qq*
      Conj(ZN(gI2,0))*Conj(ZUL(gI1,gO1)),0) + IF(gO1 < 3,-0.18257418583505536*g1*
      Conj(ZN(gI2,1))*Conj(ZUL(gI1,gO1)),0) + IF(gO1 < 3,-0.7071067811865475*g2*
      Conj(ZN(gI2,2))*Conj(ZUL(gI1,gO1)),0) - Conj(ZN(gI2,4))*SUM(j2,0,2,Conj(ZUL(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*Yu(j1,j2)));
...
std::complex<double> CLASSNAME::CpUSuconjUSuconjSdSd(int gO1, int gO2, int gI1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Yd(j1
      ...
      j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0) + IF(gO1 < 3,-1.5*KroneckerDelta(gO1,
      gO2)*Sqr(gp)*Sqr(Qq)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)),0) + IF(gO1 < 3
      ,-0.05*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(
      gI1,3 + j1)),0) + IF(gO1 < 3,-1.5*Qd*Qq*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(
      j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)),0) + IF(gO1 < 3,-0.025*
...
std::complex<double> CLASSNAME::CpUSuSvconjUSuconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,0.025*KroneckerDelta(gO1,gO2)
      *Sqr(g1)*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,-0.125*
      ...
      KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)),0) +
      IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j2,0,2,Conj(ZV(gI1,j2
      ))*ZV(gI2,j2)),0) + IF(gO1 < 3,-0.5*Ql*Qq*KroneckerDelta(gO1,gO2)*Sqr(gp)*
      SUM(j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)),0) + IF(gO1 < 3,-0.5*Qq*Qv*
      KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*ZV(gI2,3 +
...
std::complex<double> CLASSNAME::CphhSuconjUSu(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,0.05*vd*Conj(ZH(gI2,0))*Conj(
      ...
      IF(gO2 < 3,-(QHd*Qq*vd*Conj(ZH(gI2,0))*Conj(ZU(gI1,gO2))*Sqr(gp)),0) + IF(
      gO2 < 3,-(QHu*Qq*vu*Conj(ZH(gI2,1))*Conj(ZU(gI1,gO2))*Sqr(gp)),0) + IF(gO2 <
      3,-(Qq*Qs*vS*Conj(ZH(gI2,2))*Conj(ZU(gI1,gO2))*Sqr(gp)),0) + IF(gO2 < 3,0.5
      *vS*Conj(ZH(gI2,0))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))*Conj(ZU(gI1,3 + j1))
      ),0) + IF(gO2 < 3,0.5*vd*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,Conj(Yu(j1,gO2))
      *Conj(ZU(gI1,3 + j1))),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,1))*
      SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(TYu(j1,gO2))),0) + IF(gO2 < 3,-(vu*Conj
      (ZH(gI2,1))*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,Conj(Yu(j1,gO2))*Yu(j1,j2
...
std::complex<double> CLASSNAME::CpUSeconjUSeVZpVZp(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.5491933384829668*g1*gp*Ql*
      Cos(ThetaWp())*KroneckerDelta(gO1,gO2)*Sin(ThetaW())*Sin(ThetaWp()),0) + IF(
      gO1 < 3,g2*gp*Ql*Cos(ThetaW())*KroneckerDelta(gO1,gO2)*Sin(2*ThetaWp()),0) +
      IF(gO1 < 3,2*KroneckerDelta(gO1,gO2)*Sqr(gp)*Sqr(Ql)*Sqr(Cos(ThetaWp())),0)
      + IF(gO1 < 3,-0.7745966692414834*g1*g2*Cos(ThetaW())*KroneckerDelta(gO1,gO2
      )*Sin(ThetaW())*Sqr(Sin(ThetaWp())),0) + IF(gO1 < 3,0.5*KroneckerDelta(gO1,
      gO2)*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())),0) + IF(gO1 < 3,0.3*
...
std::complex<double> CLASSNAME::CpHpmUSeconjHpmconjUSe(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Conj(
      Yv(gO2,j1))*Yv(gO1,j1))*ZP(gI1,1)*ZP(gI2,1)),0),0) + IF(gO1 < 3,-0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,-0.25*
      KroneckerDelta(gO1,gO2)*Sqr(g2)*ZP(gI1,0)*ZP(gI2,0),0) + IF(gO1 < 3,-(QHd*Ql
      *KroneckerDelta(gO1,gO2)*Sqr(gp)*ZP(gI1,0)*ZP(gI2,0)),0) + IF(gO1 < 3,0.15*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*ZP(gI1,1)*ZP(gI2,1),0) + IF(gO1 < 3,0.25*
...
std::complex<double> CLASSNAME::CpChiFeconjUSePL(int gI2, int gI1, int gO1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Ql*
      Conj(ZEL(gI1,gO1))*Conj(ZN(gI2,0)),0) + IF(gO1 < 3,0.5477225575051661*g1*
      Conj(ZEL(gI1,gO1))*Conj(ZN(gI2,1)),0) + IF(gO1 < 3,0.7071067811865475*g2*
      Conj(ZEL(gI1,gO1))*Conj(ZN(gI2,2)),0) - Conj(ZN(gI2,3))*SUM(j2,0,2,Conj(ZEL(
      gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO1,3 + j1)*Ye(j1,j2)));
...
std::complex<double> CLASSNAME::CpSeUSeconjSeconjUSe(int gI1, int gO1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j1,0,2,Ye(j1
      ...
      ,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM
      (j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 < 3,-0.5*KroneckerDelta(gO1
      ,gO2)*Sqr(gp)*Sqr(Ql)*SUM(j1,0,2,Conj(ZE(gI1,j1))*ZE(gI2,j1)),0) + IF(gO1 <
      3,0.15*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(
      gI2,3 + j1)),0) + IF(gO1 < 3,-0.5*Qe*Ql*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(
      j1,0,2,Conj(ZE(gI1,3 + j1))*ZE(gI2,3 + j1)),0) + IF(gO1 < 3,-0.075*
      KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(j2,0,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)),0) +
      IF(gO1 < 3,-0.125*KroneckerDelta(gO1,gO2)*Sqr(g2)*SUM(j2,0,2,Conj(ZE(gI1,j2
      ))*ZE(gI2,j2)),0) + IF(gO1 < 3,-0.5*KroneckerDelta(gO1,gO2)*Sqr(gp)*Sqr(Ql)*
      SUM(j2,0,2,Conj(ZE(gI1,j2))*ZE(gI2,j2)),0) + IF(gO1 < 3,0.15*KroneckerDelta(
      ...
      *Ye(j1,gO1))*SUM(j4,0,2,SUM(j3,0,2,Conj(Ye(j3,j4))*Conj(ZE(gI1,3 + j3)))*ZE(
      ...
      IF(gO1 < 3,0.15*Sqr(g1)*SUM(j2,0,2,Conj(ZE(gI1,3 + j2))*KroneckerDelta(gO2,
      3 + j2))*ZE(gI2,gO1),0) + IF(gO1 < 3,-0.5*Qe*Ql*Sqr(gp)*SUM(j2,0,2,Conj(ZE(
...
std::complex<double> CLASSNAME::CpUSeSvconjUSeconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,IF(gO2 < 3,-(SUM(j2,0,2,Yv(
      ...
      j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3,-0.5*KroneckerDelta(gO1,
      gO2)*Sqr(gp)*Sqr(Ql)*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)),0) + IF(gO1 < 3
      ,-0.5*Ql*Qv*KroneckerDelta(gO1,gO2)*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI1,3 + j1))*
      ZV(gI2,3 + j1)),0) + IF(gO1 < 3,-0.075*KroneckerDelta(gO1,gO2)*Sqr(g1)*SUM(
      j2,0,2,Conj(ZV(gI1,j2))*ZV(gI2,j2)),0) + IF(gO1 < 3,0.125*KroneckerDelta(gO1
...
{
   const std::complex<double> result = IF(gO2 < 3,-0.35355339059327373*vd*Conj(
      ZV(gI1,gO2))*Sqr(g2)*ZP(gI2,0),0) + IF(gO2 < 3,0.7071067811865475*vS*Lambdax
      *SUM(j2,0,2,Conj(Yv(gO2,j2))*Conj(ZV(gI1,3 + j2)))*ZP(gI2,0),0) + IF(gO2 < 3
      ...
      ,gO2))*Sqr(g2)*ZP(gI2,1),0) + IF(gO2 < 3,SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*
      Conj(TYv(gO2,j2)))*ZP(gI2,1),0) + IF(gO2 < 3,0.7071067811865475*vu*SUM(j2,0,
      2,Conj(ZV(gI1,j2))*SUM(j1,0,2,Conj(Yv(gO2,j1))*Yv(j2,j1)))*ZP(gI2,1),0) +
      SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*TYe(j1,j2)
      ))*ZP(gI2,0) + 0.7071067811865475*vu*SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,
      0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Ye(j2,j1))))*ZP(
      gI2,0) + 0.7071067811865475*vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM
      (j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2)))*ZP(gI2,1) +
      0.7071067811865475*vd*SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,
      KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Yv(j1,j3))*Ye(j2,j1))))*ZP(gI2,1)
      ;
...
std::complex<double> CLASSNAME::CphhSeconjUSe(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-0.15*vd*Conj(ZE(gI1,gO2))*
      ...
      ) + IF(gO2 < 3,-(QHd*Ql*vd*Conj(ZE(gI1,gO2))*Conj(ZH(gI2,0))*Sqr(gp)),0) +
      IF(gO2 < 3,-(QHu*Ql*vu*Conj(ZE(gI1,gO2))*Conj(ZH(gI2,1))*Sqr(gp)),0) + IF(
      gO2 < 3,-(Ql*Qs*vS*Conj(ZE(gI1,gO2))*Conj(ZH(gI2,2))*Sqr(gp)),0) + IF(gO2 <
      3,0.5*vS*Conj(ZH(gI2,1))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,gO2))*Conj(ZE(gI1,3 +
      j1))),0) + IF(gO2 < 3,0.5*vu*Conj(ZH(gI2,2))*Lambdax*SUM(j1,0,2,Conj(Ye(j1,
      gO2))*Conj(ZE(gI1,3 + j1))),0) + IF(gO2 < 3,-0.7071067811865475*Conj(ZH(gI2,
      0))*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*Conj(TYe(j1,gO2))),0) + IF(gO2 < 3,-(vd*
      Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,Conj(Ye(j1,gO2))*Ye(
      j1,j2)))),0) + 0.3*vd*Conj(ZH(gI2,0))*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1)
      )*KroneckerDelta(gO2,3 + j1)) - 0.3*vu*Conj(ZH(gI2,1))*Sqr(g1)*SUM(j1,0,2,
      Conj(ZE(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) - Qe*QHd*vd*Conj(ZH(gI2,0))
      *Sqr(gp)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) - Qe*
      QHu*vu*Conj(ZH(gI2,1))*Sqr(gp)*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*
      KroneckerDelta(gO2,3 + j1)) - Qe*Qs*vS*Conj(ZH(gI2,2))*Sqr(gp)*SUM(j1,0,2,
      Conj(ZE(gI1,3 + j1))*KroneckerDelta(gO2,3 + j1)) + 0.5*vS*Conj(Lambdax)*Conj
      (ZH(gI2,1))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1
      )*Ye(j1,j2))) + 0.5*vu*Conj(Lambdax)*Conj(ZH(gI2,2))*SUM(j2,0,2,Conj(ZE(gI1,
      j2))*SUM(j1,0,2,KroneckerDelta(gO2,3 + j1)*Ye(j1,j2))) - 0.7071067811865475*
      Conj(ZH(gI2,0))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,KroneckerDelta(gO2,3
      + j1)*TYe(j1,j2))) - vd*Conj(ZH(gI2,0))*SUM(j3,0,2,Conj(ZE(gI1,3 + j3))*SUM(
      j2,0,2,KroneckerDelta(gO2,3 + j2)*SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))));
...
std::complex<double> CLASSNAME::CpbargZgZUhh(int gO1) const
{
   ...
   const std::complex<double> result = 0.05*(-20*vS*KroneckerDelta(2,gO1)*Sqr(
      gp)*Sqr(Qs)*Sqr(Sin(ThetaWp())) - vd*KroneckerDelta(0,gO1)*(20*g2*gp*QHd*Cos
      ...
      Sqr(Sin(ThetaWp()))) - vu*KroneckerDelta(1,gO1)*(-20*g2*gp*QHu*Cos(ThetaW())
...
std::complex<double> CLASSNAME::CpbargZpgZUhh(int gO1) const
{
   ...
   const std::complex<double> result = 0.05*(-20*vS*Cos(ThetaWp())*
      KroneckerDelta(2,gO1)*Sin(ThetaWp())*Sqr(gp)*Sqr(Qs) + vd*KroneckerDelta(0,
      gO1)*(5*Cos(ThetaWp())*Sin(ThetaWp())*Sqr(g2)*Sqr(Cos(ThetaW())) -
      7.745966692414834*g1*gp*QHd*Sin(ThetaW())*Sqr(Cos(ThetaWp())) + Cos(ThetaWp(
      ))*Sin(ThetaWp())*(-20*Sqr(gp)*Sqr(QHd) + 3*Sqr(g1)*Sqr(Sin(ThetaW()))) +
      7.745966692414834*g1*gp*QHd*Sin(ThetaW())*Sqr(Sin(ThetaWp())) + 2*g2*Cos(
      ThetaW())*(3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp())
      - 5*gp*QHd*Sqr(Cos(ThetaWp())) + 5*gp*QHd*Sqr(Sin(ThetaWp())))) + vu*
      KroneckerDelta(1,gO1)*(5*Cos(ThetaWp())*Sin(ThetaWp())*Sqr(g2)*Sqr(Cos(
      ThetaW())) + 7.745966692414834*g1*gp*QHu*Sin(ThetaW())*Sqr(Cos(ThetaWp())) +
      Cos(ThetaWp())*Sin(ThetaWp())*(-20*Sqr(gp)*Sqr(QHu) + 3*Sqr(g1)*Sqr(Sin(
      ThetaW()))) - 7.745966692414834*g1*gp*QHu*Sin(ThetaW())*Sqr(Sin(ThetaWp()))
      + 2*g2*Cos(ThetaW())*(3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())*Sin(
      ThetaWp()) + 5*gp*QHu*Sqr(Cos(ThetaWp())) - 5*gp*QHu*Sqr(Sin(ThetaWp())))));
...
std::complex<double> CLASSNAME::CpbargZpgZpUhh(int gO1) const
{
   ...
   const std::complex<double> result = 0.05*(-20*vS*KroneckerDelta(2,gO1)*Sqr(
      gp)*Sqr(Qs)*Sqr(Cos(ThetaWp())) - vd*KroneckerDelta(0,gO1)*(-2*gp*QHd*(5*g2*
      Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(2*ThetaWp()) + 20*
      Sqr(gp)*Sqr(QHd)*Sqr(Cos(ThetaWp())) + (g1*Sin(ThetaW())*(7.745966692414834*
      g2*Cos(ThetaW()) + 3*g1*Sin(ThetaW())) + 5*Sqr(g2)*Sqr(Cos(ThetaW())))*Sqr(
      Sin(ThetaWp()))) - vu*KroneckerDelta(1,gO1)*(2*gp*QHu*(5*g2*Cos(ThetaW()) +
...
std::complex<double> CLASSNAME::CpUhhVZVZ(int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(20*vS*KroneckerDelta(2,gO2)*Sqr(gp)
      *Sqr(Qs)*Sqr(Sin(ThetaWp())) + vd*KroneckerDelta(0,gO2)*(20*g2*gp*QHd*Cos(
      ...
      7.745966692414834*g2*Cos(ThetaW()) + 3*g1*Sin(ThetaW()))*Sqr(Cos(ThetaWp()))
      + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + 20*Sqr(gp)*Sqr(QHd)*
      Sqr(Sin(ThetaWp()))) + vu*KroneckerDelta(1,gO2)*(-20*g2*gp*QHu*Cos(ThetaW())
      *Cos(ThetaWp())*Sin(ThetaWp()) - 15.491933384829668*g1*gp*QHu*Cos(ThetaWp())
      *Sin(ThetaW())*Sin(ThetaWp()) + g1*Sin(ThetaW())*(7.745966692414834*g2*Cos(
      ThetaW()) + 3*g1*Sin(ThetaW()))*Sqr(Cos(ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(
      ThetaW()))*Sqr(Cos(ThetaWp())) + 20*Sqr(gp)*Sqr(QHu)*Sqr(Sin(ThetaWp()))));
...
std::complex<double> CLASSNAME::CpUhhVZVZp(int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(20*vS*Cos(ThetaWp())*KroneckerDelta
      (2,gO2)*Sin(ThetaWp())*Sqr(gp)*Sqr(Qs) - vd*KroneckerDelta(0,gO2)*(5*Cos(
...
std::complex<double> CLASSNAME::CpUhhVZpVZp(int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(20*vS*KroneckerDelta(2,gO2)*Sqr(gp)
      *Sqr(Qs)*Sqr(Cos(ThetaWp())) + vd*KroneckerDelta(0,gO2)*(-2*gp*QHd*(5*g2*Cos
      (ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(2*ThetaWp()) + 20*Sqr(
      gp)*Sqr(QHd)*Sqr(Cos(ThetaWp())) + (g1*Sin(ThetaW())*(7.745966692414834*g2*
      Cos(ThetaW()) + 3*g1*Sin(ThetaW())) + 5*Sqr(g2)*Sqr(Cos(ThetaW())))*Sqr(Sin(
...
std::complex<double> CLASSNAME::CpUhhHpmconjHpm(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(-(KroneckerDelta(0,gO2)*(ZP(gI1,0)
      *(vd*(3*Sqr(g1) + 5*Sqr(g2) + 20*Sqr(gp)*Sqr(QHd))*ZP(gI2,0) + 5*vu*(-2*
      AbsSqr(Lambdax) + Sqr(g2))*ZP(gI2,1)) + ZP(gI1,1)*(5*vu*(-2*AbsSqr(Lambdax)
      + Sqr(g2))*ZP(gI2,0) + vd*(-3*Sqr(g1) + 5*Sqr(g2) + 20*QHd*QHu*Sqr(gp))*ZP(
      gI2,1)))) - 10*KroneckerDelta(2,gO2)*(ZP(gI1,0)*(2*vS*(AbsSqr(Lambdax) + QHd
      *Qs*Sqr(gp))*ZP(gI2,0) + 1.4142135623730951*Conj(TLambdax)*ZP(gI2,1)) + ZP(
      gI1,1)*(1.4142135623730951*TLambdax*ZP(gI2,0) + 2*vS*(AbsSqr(Lambdax) + QHu*
      Qs*Sqr(gp))*ZP(gI2,1))) + KroneckerDelta(1,gO2)*(ZP(gI1,0)*(vu*(3*Sqr(g1) -
      5*(Sqr(g2) + 4*QHd*QHu*Sqr(gp)))*ZP(gI2,0) - 5*vd*(-2*AbsSqr(Lambdax) + Sqr(
      g2))*ZP(gI2,1)) - ZP(gI1,1)*(5*vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI2,0) +
      vu*(3*Sqr(g1) + 5*Sqr(g2) + 20*Sqr(gp)*Sqr(QHu))*ZP(gI2,1))));
...
std::complex<double> CLASSNAME::CphhhhUhhUhh(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-(Conj(ZH(gI1,0))*(20*Conj(ZH(gI2,
      2))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(0,gO1)*
...
std::complex<double> CLASSNAME::CpAhhhUhh(int gI2, int gI1, int gO2) const
{
   const std::complex<double> result = std::complex<double>(0.,
      ...
      )*KroneckerDelta(0,gO2) + Conj(ZH(gI1,0))*KroneckerDelta(2,gO2)) + Conj(ZA(
      gI2,0))*(Conj(ZH(gI1,2))*KroneckerDelta(1,gO2) + Conj(ZH(gI1,1))*
...
std::complex<double> CLASSNAME::CpUhhUhhSuconjSu(int gO1, int gO2, int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(10*KroneckerDelta(2,gO1)*(-2*Qs*
      ...
      + 10*KroneckerDelta(2,gO2)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(
      j1,0,2,Yu(j1,j2)*ZU(gI2,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1
      ...
      Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1))) + 5*(SUM(j3,0,2,Conj(ZU(gI1,3 + j3))*
...
std::complex<double> CLASSNAME::CpUhhSdconjSd(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(10*KroneckerDelta(2,gO2)*(-2*Qq*Qs
      *vS*Sqr(gp)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) - 2*Qd*Qs*vS*Sqr(gp)*SUM
      (j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)) + vu*Conj(Lambdax)*SUM(j2,0,2,
      Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) + vu*Lambdax*SUM(j2,0
      ,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gI2,3 + j1)))*ZD(gI1,j2))) -
...
std::complex<double> CLASSNAME::CpUhhSeconjSe(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(10*KroneckerDelta(2,gO2)*(-2*Ql*Qs
      *vS*Sqr(gp)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 2*Qe*Qs*vS*Sqr(gp)*SUM
      (j1,0,2,Conj(ZE(gI2,3 + j1))*ZE(gI1,3 + j1)) + vu*Conj(Lambdax)*SUM(j2,0,2,
      Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) + vu*Lambdax*SUM(j2,0
      ,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1)))*ZE(gI1,j2))) +
...
std::complex<double> CLASSNAME::CpUhhSuconjSu(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(10*KroneckerDelta(2,gO2)*(-2*Qq*Qs
      *vS*Sqr(gp)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) - 2*Qs*Qu*vS*Sqr(gp)*SUM
      (j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)) + vd*Conj(Lambdax)*SUM(j2,0,2,
      Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) + vd*Lambdax*SUM(j2,0
...
std::complex<double> CLASSNAME::CpUhhSvconjSv(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(10*KroneckerDelta(2,gO2)*(-2*Ql*Qs
      *vS*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI2,j1))*ZV(gI1,j1)) - 2*Qs*Qv*vS*Sqr(gp)*SUM
      (j1,0,2,Conj(ZV(gI2,3 + j1))*ZV(gI1,3 + j1)) + vd*Lambdax*SUM(j2,0,2,Conj(ZV
      ...
      j1,0,2,Conj(ZV(gI2,j1))*ZV(gI1,j1)) + 10*(2*QHd*Qv*vd*Sqr(gp)*SUM(j1,0,2,
      Conj(ZV(gI2,3 + j1))*ZV(gI1,3 + j1)) - vS*(Lambdax*SUM(j2,0,2,Conj(ZV(gI2,3
      + j2))*SUM(j1,0,2,Conj(Yv(j1,j2))*ZV(gI1,j1))) + Conj(Lambdax)*SUM(j2,0,2,
      SUM(j1,0,2,Conj(ZV(gI2,j1))*Yv(j1,j2))*ZV(gI1,3 + j2))))) + KroneckerDelta(1
      ,gO2)*(vu*(3*Sqr(g1) + 5*Sqr(g2) - 20*QHu*Ql*Sqr(gp))*SUM(j1,0,2,Conj(ZV(gI2
      ,j1))*ZV(gI1,j1)) - 10*(2*QHu*Qv*vu*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI2,3 + j1))*
      ZV(gI1,3 + j1)) + 1.4142135623730951*SUM(j2,0,2,Conj(ZV(gI2,3 + j2))*SUM(j1,
      0,2,Conj(TYv(j1,j2))*ZV(gI1,j1))) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2
      ,Conj(ZV(gI2,j1))*TYv(j1,j2))*ZV(gI1,3 + j2)) + 2*vu*SUM(j3,0,2,Conj(ZV(gI2,
      3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j3))*Yv(j1,j2))*ZV(gI1,3 + j2))) +
      2*vu*SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gI2,j2))*SUM(j1,0,2,Conj(Yv(j3,j1))*Yv(
      j2,j1)))*ZV(gI1,j3)))));
...
std::complex<double> CLASSNAME::CpChiChiUhhPR(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(5*KroneckerDelta(2,gO2)*(-2*gp*Qs*
      ZN(gI1,5)*ZN(gI2,0) + 1.4142135623730951*Conj(Lambdax)*(ZN(gI1,4)*ZN(gI2,3)
      + ZN(gI1,3)*ZN(gI2,4)) - 2*gp*Qs*ZN(gI1,0)*ZN(gI2,5)) + KroneckerDelta(0,gO2
      )*(ZN(gI1,3)*(-10*gp*QHd*ZN(gI2,0) + 3.872983346207417*g1*ZN(gI2,1) - 5*g2*
      ZN(gI2,2)) - 10*gp*QHd*ZN(gI1,0)*ZN(gI2,3) + 3.872983346207417*g1*ZN(gI1,1)*
      ZN(gI2,3) - 5*g2*ZN(gI1,2)*ZN(gI2,3) + 7.0710678118654755*Conj(Lambdax)*ZN(
      gI1,5)*ZN(gI2,4) + 7.0710678118654755*Conj(Lambdax)*ZN(gI1,4)*ZN(gI2,5)) -
...
std::complex<double> CLASSNAME::CpAhUhhVZ(int gI2, int gO2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(10*gp*Qs*
      Conj(ZA(gI2,2))*KroneckerDelta(2,gO2)*Sin(ThetaWp()) + Conj(ZA(gI2,0))*
...
std::complex<double> CLASSNAME::CpAhUhhVZp(int gI2, int gO2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(10*gp*Qs*
      Conj(ZA(gI2,2))*Cos(ThetaWp())*KroneckerDelta(2,gO2) + Conj(ZA(gI2,1))*
...
std::complex<double> CLASSNAME::CpAhAhUAhUAh(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-(Conj(ZA(gI1,0))*(20*Conj(ZA(gI2,
      2))*(KroneckerDelta(0,gO2)*KroneckerDelta(2,gO1) + KroneckerDelta(0,gO1)*
...
{
   const std::complex<double> result = std::complex<double>(0.,
      0.35355339059327373)*(Conj(ZA(gI1,2))*(Conj(ZA(gI2,1))*KroneckerDelta(0,gO2)
      + Conj(ZA(gI2,0))*KroneckerDelta(1,gO2)) + Conj(ZA(gI1,1))*(Conj(ZA(gI2,2))
      *KroneckerDelta(0,gO2) + Conj(ZA(gI2,0))*KroneckerDelta(2,gO2)) + Conj(ZA(
      gI1,0))*(Conj(ZA(gI2,2))*KroneckerDelta(1,gO2) + Conj(ZA(gI2,1))*
      KroneckerDelta(2,gO2)))*(Conj(TLambdax) - TLambdax);
...
std::complex<double> CLASSNAME::CpAhUAhhh(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = 0.05*(-20*vd*AbsSqr(Lambdax)*Conj(ZA(gI2
      ,1))*Conj(ZH(gI1,0))*KroneckerDelta(1,gO2) - 20*vS*AbsSqr(Lambdax)*Conj(ZA(
      gI2,1))*Conj(ZH(gI1,2))*KroneckerDelta(1,gO2) - 20*vd*AbsSqr(Lambdax)*Conj(
      ZA(gI2,2))*Conj(ZH(gI1,0))*KroneckerDelta(2,gO2) - 20*vu*AbsSqr(Lambdax)*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,1))*KroneckerDelta(2,gO2) - 7.0710678118654755*
...
{
   const std::complex<double> result = std::complex<double>(0.,
      -0.7071067811865475)*KroneckerDelta(1,gO1)*SUM(j2,0,2,Conj(ZVR(gI1,j2))*SUM(
      j1,0,2,Conj(ZVL(gI2,j1))*Yv(j1,j2)));
...
{
   const std::complex<double> result = std::complex<double>(0,-0.5)*(Conj(
      Lambdax)*(vS*KroneckerDelta(1,gO2) + vu*KroneckerDelta(2,gO2))*SUM(j2,0,2,
      Conj(ZD(gI2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gI1,3 + j1))) - (vS*KroneckerDelta(
      1,gO2) + vu*KroneckerDelta(2,gO2))*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,
      j2))*Conj(ZD(gI2,3 + j1)))*ZD(gI1,j2)) + 1.4142135623730951*KroneckerDelta(0
      ,gO2)*(SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,ZD(gI1,3 + j1)*TYd(j1,j2))) -
      SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gI1,j2))));
...
std::complex<double> CLASSNAME::CpUAhSeconjSe(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = std::complex<double>(0,-0.5)*(Conj(
      Lambdax)*(vS*KroneckerDelta(1,gO2) + vu*KroneckerDelta(2,gO2))*SUM(j2,0,2,
      Conj(ZE(gI2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gI1,3 + j1))) - (vS*KroneckerDelta(
      1,gO2) + vu*KroneckerDelta(2,gO2))*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,
      j2))*Conj(ZE(gI2,3 + j1)))*ZE(gI1,j2)) + 1.4142135623730951*KroneckerDelta(0
      ,gO2)*(SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(j1,0,2,ZE(gI1,3 + j1)*TYe(j1,j2))) -
...
{
   const std::complex<double> result = std::complex<double>(0,-0.5)*(Conj(
      Lambdax)*(vS*KroneckerDelta(0,gO2) + vd*KroneckerDelta(2,gO2))*SUM(j2,0,2,
      Conj(ZU(gI2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gI1,3 + j1))) - (vS*KroneckerDelta(
      0,gO2) + vd*KroneckerDelta(2,gO2))*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,
      j2))*Conj(ZU(gI2,3 + j1)))*ZU(gI1,j2)) + 1.4142135623730951*KroneckerDelta(1
      ,gO2)*(SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(j1,0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) -
      SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gI1,j2))));
...
std::complex<double> CLASSNAME::CpChiChiUAhPR(int gI1, int gI2, int gO2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.1)*(5*
      ...
      *Conj(Lambdax)*ZN(gI1,4)*ZN(gI2,5)) + KroneckerDelta(1,gO2)*(ZN(gI1,4)*(10*
      gp*QHu*ZN(gI2,0) + 3.872983346207417*g1*ZN(gI2,1) - 5*g2*ZN(gI2,2)) + (10*gp
...
std::complex<double> CLASSNAME::CpChiChiUAhPL(int gI1, int gI2, int gO1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(
      ...
      + 5*g2*Conj(ZN(gI1,2))*Conj(ZN(gI2,3))*KroneckerDelta(0,gO1) + 10*gp*QHu*
      Conj(ZN(gI1,4))*Conj(ZN(gI2,0))*KroneckerDelta(1,gO1) + 3.872983346207417*g1
      *Conj(ZN(gI1,4))*Conj(ZN(gI2,1))*KroneckerDelta(1,gO1) - 5*g2*Conj(ZN(gI1,4)
      )*Conj(ZN(gI2,2))*KroneckerDelta(1,gO1) + 3.872983346207417*g1*Conj(ZN(gI1,1
      ))*Conj(ZN(gI2,4))*KroneckerDelta(1,gO1) - 5*g2*Conj(ZN(gI1,2))*Conj(ZN(gI2,
      4))*KroneckerDelta(1,gO1) + 10*gp*Qs*Conj(ZN(gI1,5))*Conj(ZN(gI2,0))*
...
std::complex<double> CLASSNAME::CpUAhhhVZ(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(10*gp*Qs*
      Conj(ZH(gI2,2))*KroneckerDelta(2,gO2)*Sin(ThetaWp()) + Conj(ZH(gI2,0))*
      KroneckerDelta(0,gO2)*(5*g2*Cos(ThetaW())*Cos(ThetaWp()) + 3.872983346207417
...
std::complex<double> CLASSNAME::CpUAhhhVZp(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(10*gp*Qs*
      Conj(ZH(gI2,2))*Cos(ThetaWp())*KroneckerDelta(2,gO2) + Conj(ZH(gI2,1))*
      KroneckerDelta(1,gO2)*(10*gp*QHu*Cos(ThetaWp()) + 5*g2*Cos(ThetaW())*Sin(
...
std::complex<double> CLASSNAME::CpbargWmgZUHpm(int gO2) const
{
   ...
   const std::complex<double> result = 0.05*g2*(vd*KroneckerDelta(0,gO2)*(5*g2*
      ...
      ThetaW()) - 10*gp*QHd*Sin(ThetaWp())) + vu*KroneckerDelta(1,gO2)*(-5*g2*Cos(
      ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())
      - 10*gp*QHu*Sin(ThetaWp())));
...
std::complex<double> CLASSNAME::CpbargZgWmconjUHpm(int gO1) const
{
   ...
   const std::complex<double> result = -0.05*g2*(vd*KroneckerDelta(0,gO1)*(5*g2
      *Cos(ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(
      ThetaW()) + 10*gp*QHd*Sin(ThetaWp())) - vu*KroneckerDelta(1,gO1)*(5*g2*Cos(
      ThetaW())*Cos(ThetaWp()) + 3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW())
      - 10*gp*QHu*Sin(ThetaWp())));
...
std::complex<double> CLASSNAME::CpbargWmgZpUHpm(int gO2) const
{
   ...
   const std::complex<double> result = -0.05*g2*(vd*KroneckerDelta(0,gO2)*(10*
      gp*QHd*Cos(ThetaWp()) + (5*g2*Cos(ThetaW()) - 3.872983346207417*g1*Sin(
      ThetaW()))*Sin(ThetaWp())) + vu*KroneckerDelta(1,gO2)*(10*gp*QHu*Cos(ThetaWp
...
std::complex<double> CLASSNAME::CpbargZpgWmconjUHpm(int gO1) const
{
   ...
   const std::complex<double> result = 0.05*g2*(vd*KroneckerDelta(0,gO1)*(-10*
      gp*QHd*Cos(ThetaWp()) + (5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(
      ThetaW()))*Sin(ThetaWp())) - vu*KroneckerDelta(1,gO1)*(10*gp*QHu*Cos(ThetaWp
      ()) + (5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp(
      ))));
...
std::complex<double> CLASSNAME::CpconjUHpmVWmVZp(int gO2) const
{
   ...
   const std::complex<double> result = 0.1*g2*(vd*KroneckerDelta(0,gO2)*(10*gp*
      QHd*Cos(ThetaWp()) - 3.872983346207417*g1*Sin(ThetaW())*Sin(ThetaWp())) + vu
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmVZVZ(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(15.491933384829668*g1*gp*QHd*Cos(ThetaWp())*Sin(
      ThetaW())*Sin(ThetaWp()) - 2*g2*Cos(ThetaW())*Cos(ThetaWp())*(
      3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW()) + 10*gp*QHd*Sin(ThetaWp())
      ) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + 3*Sqr(g1)*Sqr(Cos(
      ThetaWp()))*Sqr(Sin(ThetaW())) + 20*Sqr(gp)*Sqr(QHd)*Sqr(Sin(ThetaWp()))) +
      KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(-15.491933384829668*g1*gp*QHu*
      Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) - 2*g2*Cos(ThetaW())*Cos(ThetaWp
      ())*(3.872983346207417*g1*Cos(ThetaWp())*Sin(ThetaW()) - 10*gp*QHu*Sin(
      ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + 3*Sqr(g1)*
      Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 20*Sqr(gp)*Sqr(QHu)*Sqr(Sin(ThetaWp
      ()))));
...
std::complex<double> CLASSNAME::CpUHpmconjUHpmVZpVZp(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*(2*gp*QHd*(5*g2*Cos(ThetaW()) - 3.872983346207417*g1*
      Sin(ThetaW()))*Sin(2*ThetaWp()) + 20*Sqr(gp)*Sqr(QHd)*Sqr(Cos(ThetaWp())) +
...
std::complex<double> CLASSNAME::CphhHpmconjUHpm(int gI2, int gI1, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-(Conj(ZH(gI2,0))*(KroneckerDelta(
      0,gO2)*(vd*(3*Sqr(g1) + 5*Sqr(g2) + 20*Sqr(gp)*Sqr(QHd))*ZP(gI1,0) + 5*vu*(
      -2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gI1,1)) + KroneckerDelta(1,gO2)*(5*vu*(-2*
...
std::complex<double> CLASSNAME::CpAhAhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-20*Conj(ZA(gI1,2))*Conj(ZA(gI2,2)
      )*(KroneckerDelta(0,gO1)*KroneckerDelta(0,gO2)*(AbsSqr(Lambdax) + QHd*Qs*Sqr
      (gp)) + KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(AbsSqr(Lambdax) + QHu*
      Qs*Sqr(gp))) - Conj(ZA(gI1,0))*(-5*Conj(ZA(gI2,1))*(KroneckerDelta(0,gO2)*
...
std::complex<double> CLASSNAME::CphhhhUHpmconjUHpm(int gI1, int gI2, int gO1, int gO2) const
{
   ...
   const std::complex<double> result = 0.05*(-20*Conj(ZH(gI1,2))*Conj(ZH(gI2,2)
      ...
      (gp)) + KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*(AbsSqr(Lambdax) + QHu*
      Qs*Sqr(gp))) - Conj(ZH(gI1,0))*(5*Conj(ZH(gI2,1))*(KroneckerDelta(0,gO2)*
      KroneckerDelta(1,gO1) + KroneckerDelta(0,gO1)*KroneckerDelta(1,gO2))*(-2*
...
{
   const std::complex<double> result = KroneckerDelta(0,gO2)*SUM(j2,0,2,SUM(j1,
      0,2,Conj(Ye(j1,j2))*ZER(gI2,j1))*ZVL(gI1,j2));
...
{
   const std::complex<double> result = KroneckerDelta(1,gO1)*SUM(j2,0,2,Conj(
      ZVR(gI1,j2))*SUM(j1,0,2,Conj(ZEL(gI2,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpUHpmSdconjUHpmconjSd(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(KroneckerDelta(0,gO1)*
      ...
      ,Conj(ZD(gI1,j1))*ZD(gI2,j1)) + 2*(Sqr(g1) - 10*Qd*QHd*Sqr(gp))*SUM(j1,0,2,
      Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)) - 20*SUM(j3,0,2,Conj(ZD(gI1,3 + j3))*
      SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gI2,3 + j2)))) -
      KroneckerDelta(1,gO1)*KroneckerDelta(1,gO2)*((Sqr(g1) - 5*Sqr(g2) + 20*QHu*
      Qq*Sqr(gp))*SUM(j1,0,2,Conj(ZD(gI1,j1))*ZD(gI2,j1)) + 2*(Sqr(g1) + 10*Qd*QHu
      *Sqr(gp))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*ZD(gI2,3 + j1)) + 20*SUM(j3,0,2,
      SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gI2,j3
      ))));
...
std::complex<double> CLASSNAME::CpUHpmSvconjUHpmconjSv(int gO1, int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = 0.05*(KroneckerDelta(1,gO1)*
      KroneckerDelta(1,gO2)*((3*Sqr(g1) - 5*(Sqr(g2) + 4*QHu*Ql*Sqr(gp)))*SUM(j1,0
      ,2,Conj(ZV(gI1,j1))*ZV(gI2,j1)) - 20*(QHu*Qv*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI1,
      3 + j1))*ZV(gI2,3 + j1)) + SUM(j3,0,2,Conj(ZV(gI1,3 + j3))*SUM(j2,0,2,SUM(j1
      ,0,2,Conj(Yv(j1,j3))*Yv(j1,j2))*ZV(gI2,3 + j2))))) - KroneckerDelta(0,gO1)*
      KroneckerDelta(0,gO2)*((3*Sqr(g1) - 5*Sqr(g2) + 20*QHd*Ql*Sqr(gp))*SUM(j1,0,
      2,Conj(ZV(gI1,j1))*ZV(gI2,j1)) + 20*(QHd*Qv*Sqr(gp)*SUM(j1,0,2,Conj(ZV(gI1,3
      + j1))*ZV(gI2,3 + j1)) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gI1,j2))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpSdconjUHpmconjSu(int gI2, int gO2, int gI1) const
{
   const std::complex<double> result = 0.25*(KroneckerDelta(0,gO2)*(
      ...
      2*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(j1,0,2,ZU(gI1,3 + j1)*TYu(j1,j2))) +
      1.4142135623730951*(vS*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD
...
{
   const std::complex<double> result = 0.25*(KroneckerDelta(0,gO2)*(
      -1.4142135623730951*vd*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZV(gI1,j1)) + 2*(
      2*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*Conj(TYe(j1,j2)))*ZV(gI1,j2)) +
      1.4142135623730951*(vS*Conj(Lambdax)*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gI2,j1))
...
std::complex<double> CLASSNAME::CpHpmconjUHpmVZp(int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(KroneckerDelta(0,gO2)*(10*gp*QHd*
      Cos(ThetaWp()) + (5*g2*Cos(ThetaW()) - 3.872983346207417*g1*Sin(ThetaW()))*
      Sin(ThetaWp()))*ZP(gI2,0) - KroneckerDelta(1,gO2)*(10*gp*QHu*Cos(ThetaWp())
      + (-5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp()))
      *ZP(gI2,1));
...
std::complex<double> CLASSNAME::CpbarChaChaVZPL(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(2*g2*Conj(UM(gI2,0))*Cos(ThetaW())*
      Cos(ThetaWp())*UM(gI1,0) + Conj(UM(gI2,1))*(g2*Cos(ThetaW())*Cos(ThetaWp())
...
std::complex<double> CLASSNAME::CpbarChaChaVZPR(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(2*g2*Conj(UP(gI1,0))*Cos(ThetaW())*
      Cos(ThetaWp())*UP(gI2,0) + Conj(UP(gI1,1))*(g2*Cos(ThetaW())*Cos(ThetaWp())
...
std::complex<double> CLASSNAME::CpAhAhVZVZ(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.1*(20*Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*
      Sqr(gp)*Sqr(Qs)*Sqr(Sin(ThetaWp())) + Conj(ZA(gI1,0))*Conj(ZA(gI2,0))*(20*g2
      *gp*QHd*Cos(ThetaW())*Cos(ThetaWp())*Sin(ThetaWp()) + 15.491933384829668*g1*
      gp*QHd*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + g1*Sin(ThetaW())*(
      7.745966692414834*g2*Cos(ThetaW()) + 3*g1*Sin(ThetaW()))*Sqr(Cos(ThetaWp()))
      + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + 20*Sqr(gp)*Sqr(QHd)*
      Sqr(Sin(ThetaWp()))) + Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*(-20*g2*gp*QHu*Cos(
...
std::complex<double> CLASSNAME::CphhhhVZVZ(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.1*(20*Conj(ZH(gI1,2))*Conj(ZH(gI2,2))*
      Sqr(gp)*Sqr(Qs)*Sqr(Sin(ThetaWp())) + Conj(ZH(gI1,0))*Conj(ZH(gI2,0))*(20*g2
      *gp*QHd*Cos(ThetaW())*Cos(ThetaWp())*Sin(ThetaWp()) + 15.491933384829668*g1*
      gp*QHd*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + g1*Sin(ThetaW())*(
      7.745966692414834*g2*Cos(ThetaW()) + 3*g1*Sin(ThetaW()))*Sqr(Cos(ThetaWp()))
      + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + 20*Sqr(gp)*Sqr(QHd)*
      Sqr(Sin(ThetaWp()))) + Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*(-20*g2*gp*QHu*Cos(
      ThetaW())*Cos(ThetaWp())*Sin(ThetaWp()) - 15.491933384829668*g1*gp*QHu*Cos(
      ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) + g1*Sin(ThetaW())*(
      7.745966692414834*g2*Cos(ThetaW()) + 3*g1*Sin(ThetaW()))*Sqr(Cos(ThetaWp()))
      + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos(ThetaWp())) + 20*Sqr(gp)*Sqr(QHu)*
...
std::complex<double> CLASSNAME::CpAhhhVZ(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(2*gp*Qs*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*Sin(ThetaWp()) + Conj(ZA(gI2,0))*Conj(ZH(gI1
      ,0))*(g2*Cos(ThetaW())*Cos(ThetaWp()) + 0.7745966692414834*g1*Cos(ThetaWp())
      *Sin(ThetaW()) + 2*gp*QHd*Sin(ThetaWp())) - Conj(ZA(gI2,1))*Conj(ZH(gI1,1))*
...
std::complex<double> CLASSNAME::CpSdconjSdVZVZ(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.03333333333333333*((-60*g2*gp*Qq*Cos(
      ...
      -7.745966692414834*g1*gp*Qd*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) +
      Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 15*Sqr(gp)*Sqr(Qd)*Sqr(Sin(
...
std::complex<double> CLASSNAME::CpSuconjSuVZVZ(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.03333333333333333*((
      -15.491933384829668*g1*gp*Qq*Cos(ThetaWp())*Sin(ThetaW())*Sin(ThetaWp()) - 2
      *g2*Cos(ThetaW())*Cos(ThetaWp())*(3.872983346207417*g1*Cos(ThetaWp())*Sin(
      ThetaW()) - 30*gp*Qq*Sin(ThetaWp())) + 15*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Cos
      (ThetaWp())) + Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + 60*Sqr(gp)*
      Sqr(Qq)*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)) + 4*(4*
      Sqr(g1)*Sqr(Cos(ThetaWp()))*Sqr(Sin(ThetaW())) + gp*Qu*(7.745966692414834*g1
      *Sin(ThetaW())*Sin(2*ThetaWp()) + 15*gp*Qu*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,
...
std::complex<double> CLASSNAME::CpSdconjSdVZ(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*(-((3*g2*Cos(ThetaW(
      ))*Cos(ThetaWp()) + 0.7745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) - 6*
      gp*Qq*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1))) + 2*(
...
std::complex<double> CLASSNAME::CpSvconjSvVZ(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.5*((g2*Cos(ThetaW())*Cos(ThetaWp()) +
      ...
      *SUM(j1,0,2,Conj(ZV(gI2,j1))*ZV(gI1,j1)) - 2*gp*Qv*Sin(ThetaWp())*SUM(j1,0,2
...
std::complex<double> CLASSNAME::CpChiChiVZPR(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(Conj(ZN(gI1,3))*(g2*Cos(ThetaW())*
      Cos(ThetaWp()) + 0.7745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) + 2*gp*
      QHd*Sin(ThetaWp()))*ZN(gI2,3) - Conj(ZN(gI1,4))*(g2*Cos(ThetaW())*Cos(
      ThetaWp()) + 0.7745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) - 2*gp*QHu*
      Sin(ThetaWp()))*ZN(gI2,4) + 2*gp*Qs*Conj(ZN(gI1,5))*Sin(ThetaWp())*ZN(gI2,5)
      );
...
std::complex<double> CLASSNAME::CphhVZVZ(int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(4*vS*Conj(ZH(gI2,2))*Sqr(gp)*Sqr(Qs
      ...
      )) + 0.7745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) + 2*gp*QHd*Sin(
      ThetaWp())) + vu*Conj(ZH(gI2,1))*Sqr(g2*Cos(ThetaW())*Cos(ThetaWp()) +
      0.7745966692414834*g1*Cos(ThetaWp())*Sin(ThetaW()) - 2*gp*QHu*Sin(ThetaWp())
      ));
...
std::complex<double> CLASSNAME::CpbarChaChaVZpPL(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(-2*g2*Conj(UM(gI2,0))*Cos(ThetaW())
      *Sin(ThetaWp())*UM(gI1,0) - Conj(UM(gI2,1))*(2*gp*QHd*Cos(ThetaWp()) + g2*
...
std::complex<double> CLASSNAME::CpbarChaChaVZpPR(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.1*(-10*g2*Conj(UP(gI1,0))*Cos(ThetaW()
      )*Sin(ThetaWp())*UP(gI2,0) + Conj(UP(gI1,1))*(10*gp*QHu*Cos(ThetaWp()) + (-5
...
std::complex<double> CLASSNAME::CpAhAhVZpVZp(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.1*(20*Conj(ZA(gI1,2))*Conj(ZA(gI2,2))*
      Sqr(gp)*Sqr(Qs)*Sqr(Cos(ThetaWp())) + Conj(ZA(gI1,0))*Conj(ZA(gI2,0))*(-2*gp
      *QHd*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(2*ThetaWp
      ...
      (ThetaW())))*Sqr(Sin(ThetaWp()))) + Conj(ZA(gI1,1))*Conj(ZA(gI2,1))*(20*g2*
      gp*QHu*Cos(ThetaW())*Cos(ThetaWp())*Sin(ThetaWp()) + 20*Sqr(gp)*Sqr(QHu)*Sqr
      (Cos(ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())) + g1*(
      7.745966692414834*gp*QHu*Sin(ThetaW())*Sin(2*ThetaWp()) + 3.872983346207417*
      g2*Sin(2*ThetaW())*Sqr(Sin(ThetaWp())) + 3*g1*Sqr(Sin(ThetaW()))*Sqr(Sin(
      ThetaWp())))));
...
std::complex<double> CLASSNAME::CphhhhVZpVZp(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.1*(20*Conj(ZH(gI1,2))*Conj(ZH(gI2,2))*
      Sqr(gp)*Sqr(Qs)*Sqr(Cos(ThetaWp())) + Conj(ZH(gI1,0))*Conj(ZH(gI2,0))*(-2*gp
      *QHd*(5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(2*ThetaWp
      ()) + 20*Sqr(gp)*Sqr(QHd)*Sqr(Cos(ThetaWp())) + (g1*Sin(ThetaW())*(
      7.745966692414834*g2*Cos(ThetaW()) + 3*g1*Sin(ThetaW())) + 5*Sqr(g2)*Sqr(Cos
      (ThetaW())))*Sqr(Sin(ThetaWp()))) + Conj(ZH(gI1,1))*Conj(ZH(gI2,1))*(20*g2*
      gp*QHu*Cos(ThetaW())*Cos(ThetaWp())*Sin(ThetaWp()) + 20*Sqr(gp)*Sqr(QHu)*Sqr
      (Cos(ThetaWp())) + 5*Sqr(g2)*Sqr(Cos(ThetaW()))*Sqr(Sin(ThetaWp())) + g1*(
      7.745966692414834*gp*QHu*Sin(ThetaW())*Sin(2*ThetaWp()) + 3.872983346207417*
      g2*Sin(2*ThetaW())*Sqr(Sin(ThetaWp())) + 3*g1*Sqr(Sin(ThetaW()))*Sqr(Sin(
...
std::complex<double> CLASSNAME::CpAhhhVZp(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(2*gp*Qs*
      Conj(ZA(gI2,2))*Conj(ZH(gI1,2))*Cos(ThetaWp()) + Conj(ZA(gI2,1))*Conj(ZH(gI1
      ,1))*(2*gp*QHu*Cos(ThetaWp()) + g2*Cos(ThetaW())*Sin(ThetaWp()) +
...
double CLASSNAME::CpbarFdFdVZpPL(int gI1, int gI2) const
{
   ...
   const double result = -0.16666666666666666*KroneckerDelta(gI1,gI2)*(6*gp*Qq*
      Cos(ThetaWp()) + 3*g2*Cos(ThetaW())*Sin(ThetaWp()) + 0.7745966692414834*g1*
...
std::complex<double> CLASSNAME::CpSdconjSdVZpVZp(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.03333333333333333*((2*gp*Qq*(15*g2*Cos
      (ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*Sin(2*ThetaWp()) + 60*Sqr(
      gp)*Sqr(Qq)*Sqr(Cos(ThetaWp())) + (g1*Sin(ThetaW())*(7.745966692414834*g2*
      Cos(ThetaW()) + g1*Sin(ThetaW())) + 15*Sqr(g2)*Sqr(Cos(ThetaW())))*Sqr(Sin(
...
std::complex<double> CLASSNAME::CpSuconjSuVZpVZp(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.03333333333333333*((-2*gp*Qq*(15*g2*
      Cos(ThetaW()) - 3.872983346207417*g1*Sin(ThetaW()))*Sin(2*ThetaWp()) + 60*
      Sqr(gp)*Sqr(Qq)*Sqr(Cos(ThetaWp())) + (-7.745966692414834*g1*g2*Cos(ThetaW()
      )*Sin(ThetaW()) + 15*Sqr(g2)*Sqr(Cos(ThetaW())) + Sqr(g1)*Sqr(Sin(ThetaW()))
      )*Sqr(Sin(ThetaWp())))*SUM(j1,0,2,Conj(ZU(gI1,j1))*ZU(gI2,j1)) + 4*(15*Sqr(
      gp)*Sqr(Qu)*Sqr(Cos(ThetaWp())) + 2*g1*Sin(ThetaW())*(-3.872983346207417*gp*
      Qu*Sin(2*ThetaWp()) + 2*g1*Sin(ThetaW())*Sqr(Sin(ThetaWp()))))*SUM(j1,0,2,
      Conj(ZU(gI1,3 + j1))*ZU(gI2,3 + j1)));
...
std::complex<double> CLASSNAME::CpSdconjSdVZp(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*((6*gp*Qq*Cos(
      ThetaWp()) + 3*g2*Cos(ThetaW())*Sin(ThetaWp()) + 0.7745966692414834*g1*Sin(
      ThetaW())*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZD(gI1,j1)) - 2*(3*gp*
      Qd*Cos(ThetaWp()) + 0.7745966692414834*g1*Sin(ThetaW())*Sin(ThetaWp()))*SUM(
      j1,0,2,Conj(ZD(gI2,3 + j1))*ZD(gI1,3 + j1)));
...
std::complex<double> CLASSNAME::CpSeconjSeVZp(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.5*((2*gp*Ql*Cos(ThetaWp()) + g2*Cos(
      ThetaW())*Sin(ThetaWp()) - 0.7745966692414834*g1*Sin(ThetaW())*Sin(ThetaWp()
      ))*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZE(gI1,j1)) - 2*(gp*Qe*Cos(ThetaWp()) +
...
std::complex<double> CLASSNAME::CpSuconjSuVZp(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*((6*gp*Qq*Cos(
      ThetaWp()) - 3*g2*Cos(ThetaW())*Sin(ThetaWp()) + 0.7745966692414834*g1*Sin(
      ThetaW())*Sin(ThetaWp()))*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZU(gI1,j1)) + 2*(-3*gp
      *Qu*Cos(ThetaWp()) + 1.5491933384829668*g1*Sin(ThetaW())*Sin(ThetaWp()))*SUM
      (j1,0,2,Conj(ZU(gI2,3 + j1))*ZU(gI1,3 + j1)));
...
std::complex<double> CLASSNAME::CpSvconjSvVZp(int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.5*((2*gp*Ql*Cos(ThetaWp()) - (g2*Cos(
      ThetaW()) + 0.7745966692414834*g1*Sin(ThetaW()))*Sin(ThetaWp()))*SUM(j1,0,2,
      Conj(ZV(gI2,j1))*ZV(gI1,j1)) - 2*gp*Qv*Cos(ThetaWp())*SUM(j1,0,2,Conj(ZV(gI2
      ,3 + j1))*ZV(gI1,3 + j1)));
...
std::complex<double> CLASSNAME::CpChiChiVZpPR(int gI1, int gI2) const
{
   ...
   const std::complex<double> result = 0.5*(Conj(ZN(gI1,3))*(2*gp*QHd*Cos(
      ThetaWp()) - (g2*Cos(ThetaW()) + 0.7745966692414834*g1*Sin(ThetaW()))*Sin(
      ThetaWp()))*ZN(gI2,3) + Conj(ZN(gI1,4))*(2*gp*QHu*Cos(ThetaWp()) + g2*Cos(
      ThetaW())*Sin(ThetaWp()) + 0.7745966692414834*g1*Sin(ThetaW())*Sin(ThetaWp()
      ))*ZN(gI2,4) + 2*gp*Qs*Conj(ZN(gI1,5))*Cos(ThetaWp())*ZN(gI2,5));
...
std::complex<double> CLASSNAME::CpbarChaUChiHpmPL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*KroneckerDelta(4,
      gO2)*ZP(gI2,1)) - 0.1*Conj(UP(gI1,1))*(10*KroneckerDelta(5,gO2)*Lambdax*ZP(
      gI2,0) + 1.4142135623730951*(10*gp*QHu*KroneckerDelta(0,gO2) +
      3.872983346207417*g1*KroneckerDelta(1,gO2) + 5*g2*KroneckerDelta(2,gO2))*ZP(
      gI2,1));
...
std::complex<double> CLASSNAME::CpbarChaUChiHpmPR(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -(g2*KroneckerDelta(3,gO1)*UM(gI1,0)*ZP(
      gI2,0)) + 0.1*UM(gI1,1)*(-14.142135623730951*gp*QHd*KroneckerDelta(0,gO1)*ZP
...
std::complex<double> CLASSNAME::CpUChiChaconjHpmPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(g2*Conj(UM(gI2,0))*KroneckerDelta(3,
      gO2)*ZP(gI1,0)) + Conj(UM(gI2,1))*(-1.4142135623730951*gp*QHd*KroneckerDelta
      (0,gO2)*ZP(gI1,0) + 0.5477225575051661*g1*KroneckerDelta(1,gO2)*ZP(gI1,0) +
...
{
   const std::complex<double> result = -0.5*g2*(2*KroneckerDelta(2,gO2)*UM(gI1,
      0) + 1.4142135623730951*KroneckerDelta(3,gO2)*UM(gI1,1));
...
{
   const std::complex<double> result = -(g2*Conj(UP(gI1,0))*KroneckerDelta(2,
      gO1)) + 0.7071067811865475*g2*Conj(UP(gI1,1))*KroneckerDelta(4,gO1);
...
std::complex<double> CLASSNAME::CpbarFdUChiSdPL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qd*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*Conj(ZDR(gI1,j1))) -
      0.3651483716701107*g1*KroneckerDelta(1,gO2)*SUM(j1,0,2,Conj(ZD(gI2,3 + j1))*
      Conj(ZDR(gI1,j1))) - KroneckerDelta(3,gO2)*SUM(j2,0,2,Conj(ZD(gI2,j2))*SUM(
      j1,0,2,Conj(ZDR(gI1,j1))*Yd(j1,j2)));
...
std::complex<double> CLASSNAME::CpbarFdUChiSdPR(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qq*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,Conj(ZD(gI2,j1))*ZDL(gI1,j1)) - 0.18257418583505536*g1*
...
std::complex<double> CLASSNAME::CpbarFeUChiSePL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qe*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*Conj(ZER(gI1,j1))) -
      1.0954451150103321*g1*KroneckerDelta(1,gO2)*SUM(j1,0,2,Conj(ZE(gI2,3 + j1))*
      Conj(ZER(gI1,j1))) - KroneckerDelta(3,gO2)*SUM(j2,0,2,Conj(ZE(gI2,j2))*SUM(
      j1,0,2,Conj(ZER(gI1,j1))*Ye(j1,j2)));
...
std::complex<double> CLASSNAME::CpbarFeUChiSePR(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,Conj(ZE(gI2,j1))*ZEL(gI1,j1)) + 0.5477225575051661*g1*
...
std::complex<double> CLASSNAME::CpbarFuUChiSuPL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qu*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*Conj(ZUR(gI1,j1))) +
      0.7302967433402214*g1*KroneckerDelta(1,gO2)*SUM(j1,0,2,Conj(ZU(gI2,3 + j1))*
      Conj(ZUR(gI1,j1))) - KroneckerDelta(4,gO2)*SUM(j2,0,2,Conj(ZU(gI2,j2))*SUM(
      j1,0,2,Conj(ZUR(gI1,j1))*Yu(j1,j2)));
...
std::complex<double> CLASSNAME::CpbarFuUChiSuPR(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qq*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,Conj(ZU(gI2,j1))*ZUL(gI1,j1)) - 0.18257418583505536*g1*
...
std::complex<double> CLASSNAME::CpbarFvUChiSvPL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qv*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZV(gI2,3 + j1))*Conj(ZVR(gI1,j1))) - KroneckerDelta(
      4,gO2)*SUM(j2,0,2,Conj(ZVR(gI1,j2))*SUM(j1,0,2,Conj(ZV(gI2,j1))*Yv(j1,j2)));
...
std::complex<double> CLASSNAME::CpbarFvUChiSvPR(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,Conj(ZV(gI2,j1))*ZVL(gI1,j1)) + 0.5477225575051661*g1*
...
std::complex<double> CLASSNAME::CpChiUChihhPL(int gI2, int gO2, int gI1) const
{
   ...
   const std::complex<double> result = 0.1*(5*Conj(ZH(gI1,2))*(-2*gp*Qs*Conj(ZN
      (gI2,5))*KroneckerDelta(0,gO2) - 2*gp*Qs*Conj(ZN(gI2,0))*KroneckerDelta(5,
      gO2) + 1.4142135623730951*Conj(ZN(gI2,4))*KroneckerDelta(3,gO2)*Lambdax +
...
std::complex<double> CLASSNAME::CpChiUChiAhPL(int gI1, int gO2, int gI2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.1)*(5*Conj(ZA(
      gI2,2))*(2*gp*Qs*Conj(ZN(gI1,5))*KroneckerDelta(0,gO2) + 2*gp*Qs*Conj(ZN(gI1
      ,0))*KroneckerDelta(5,gO2) + 1.4142135623730951*Conj(ZN(gI1,4))*
      KroneckerDelta(3,gO2)*Lambdax + 1.4142135623730951*Conj(ZN(gI1,3))*
      KroneckerDelta(4,gO2)*Lambdax) + Conj(ZA(gI2,1))*(Conj(ZN(gI1,4))*(10*gp*QHu
      *KroneckerDelta(0,gO2) + 3.872983346207417*g1*KroneckerDelta(1,gO2) - 5*g2*
      KroneckerDelta(2,gO2)) + 10*gp*QHu*Conj(ZN(gI1,0))*KroneckerDelta(4,gO2) +
      3.872983346207417*g1*Conj(ZN(gI1,1))*KroneckerDelta(4,gO2) - 5*g2*Conj(ZN(
      gI1,2))*KroneckerDelta(4,gO2) + 7.0710678118654755*Conj(ZN(gI1,5))*
      KroneckerDelta(3,gO2)*Lambdax + 7.0710678118654755*Conj(ZN(gI1,3))*
      KroneckerDelta(5,gO2)*Lambdax) + Conj(ZA(gI2,0))*(Conj(ZN(gI1,3))*(10*gp*QHd
      *KroneckerDelta(0,gO2) - 3.872983346207417*g1*KroneckerDelta(1,gO2) + 5*g2*
      KroneckerDelta(2,gO2)) + 10*gp*QHd*Conj(ZN(gI1,0))*KroneckerDelta(3,gO2) -
      3.872983346207417*g1*Conj(ZN(gI1,1))*KroneckerDelta(3,gO2) + 5*g2*Conj(ZN(
      gI1,2))*KroneckerDelta(3,gO2) + 7.0710678118654755*Conj(ZN(gI1,5))*
      KroneckerDelta(4,gO2)*Lambdax + 7.0710678118654755*Conj(ZN(gI1,4))*
...
std::complex<double> CLASSNAME::CpChiUChiAhPR(int gI1, int gO1, int gI2) const
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.1)*(5*Conj(ZA(
      gI2,2))*(2*gp*Qs*KroneckerDelta(5,gO1)*ZN(gI1,0) + 1.4142135623730951*Conj(
      Lambdax)*(KroneckerDelta(4,gO1)*ZN(gI1,3) + KroneckerDelta(3,gO1)*ZN(gI1,4))
      + 2*gp*Qs*KroneckerDelta(0,gO1)*ZN(gI1,5)) + Conj(ZA(gI2,0))*(
      KroneckerDelta(3,gO1)*(10*gp*QHd*ZN(gI1,0) - 3.872983346207417*g1*ZN(gI1,1)
      + 5*g2*ZN(gI1,2)) + 10*gp*QHd*KroneckerDelta(0,gO1)*ZN(gI1,3) -
      3.872983346207417*g1*KroneckerDelta(1,gO1)*ZN(gI1,3) + 5*g2*KroneckerDelta(2
      ,gO1)*ZN(gI1,3) + 7.0710678118654755*Conj(Lambdax)*KroneckerDelta(5,gO1)*ZN(
      gI1,4) + 7.0710678118654755*Conj(Lambdax)*KroneckerDelta(4,gO1)*ZN(gI1,5)) +
      Conj(ZA(gI2,1))*(KroneckerDelta(4,gO1)*(10*gp*QHu*ZN(gI1,0) +
      3.872983346207417*g1*ZN(gI1,1) - 5*g2*ZN(gI1,2)) + (10*gp*QHu*KroneckerDelta
      (0,gO1) + 3.872983346207417*g1*KroneckerDelta(1,gO1) - 5*g2*KroneckerDelta(2
      ,gO1))*ZN(gI1,4) + 7.0710678118654755*Conj(Lambdax)*(KroneckerDelta(5,gO1)*
      ZN(gI1,3) + KroneckerDelta(3,gO1)*ZN(gI1,5))));
...
std::complex<double> CLASSNAME::CpUChiFdconjSdPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qq*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZDL(gI2,j1))*ZD(gI1,j1)) - 0.18257418583505536*g1*
...
std::complex<double> CLASSNAME::CpUChiFdconjSdPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qd*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,ZD(gI1,3 + j1)*ZDR(gI2,j1)) - 0.3651483716701107*g1*
...
std::complex<double> CLASSNAME::CpUChiFeconjSePL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZEL(gI2,j1))*ZE(gI1,j1)) + 0.5477225575051661*g1*
...
std::complex<double> CLASSNAME::CpUChiFeconjSePR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qe*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,ZE(gI1,3 + j1)*ZER(gI2,j1)) - 1.0954451150103321*g1*
...
std::complex<double> CLASSNAME::CpUChiFuconjSuPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qq*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZUL(gI2,j1))*ZU(gI1,j1)) - 0.18257418583505536*g1*
...
std::complex<double> CLASSNAME::CpUChiFuconjSuPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qu*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,ZU(gI1,3 + j1)*ZUR(gI2,j1)) + 0.7302967433402214*g1*
...
std::complex<double> CLASSNAME::CpUChiFvconjSvPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Ql*KroneckerDelta
      (0,gO2)*SUM(j1,0,2,Conj(ZVL(gI2,j1))*ZV(gI1,j1)) + 0.5477225575051661*g1*
...
std::complex<double> CLASSNAME::CpUChiFvconjSvPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qv*KroneckerDelta
      (0,gO1)*SUM(j1,0,2,ZV(gI1,3 + j1)*ZVR(gI2,j1)) - KroneckerDelta(4,gO1)*SUM(
      j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*ZV(gI1,j1))*ZVR(gI2,j2));
...
std::complex<double> CLASSNAME::CpUChiChaconjVWmPL(int gO1, int gI2) const
{
   const std::complex<double> result = -0.5*g2*(2*Conj(UM(gI2,0))*
      KroneckerDelta(2,gO1) + 1.4142135623730951*Conj(UM(gI2,1))*KroneckerDelta(3,
      gO1));
...
std::complex<double> CLASSNAME::CpChiUChiVZpPL(int gI2, int gO2) const
{
   ...
   const std::complex<double> result = 0.1*(KroneckerDelta(3,gO2)*(-10*gp*QHd*
      Cos(ThetaWp()) + (5*g2*Cos(ThetaW()) + 3.872983346207417*g1*Sin(ThetaW()))*
      Sin(ThetaWp()))*ZN(gI2,3) - KroneckerDelta(4,gO2)*(10*gp*QHu*Cos(ThetaWp())
      + 5*g2*Cos(ThetaW())*Sin(ThetaWp()) + 3.872983346207417*g1*Sin(ThetaW())*Sin
      (ThetaWp()))*ZN(gI2,4) - 10*gp*Qs*Cos(ThetaWp())*KroneckerDelta(5,gO2)*ZN(
      gI2,5));
...
std::complex<double> CLASSNAME::CpChiUChiVZpPR(int gI2, int gO1) const
{
   ...
   const std::complex<double> result = 0.1*(10*gp*Qs*Conj(ZN(gI2,5))*Cos(
      ThetaWp())*KroneckerDelta(5,gO1) + Conj(ZN(gI2,4))*KroneckerDelta(4,gO1)*(10
      *gp*QHu*Cos(ThetaWp()) + 5*g2*Cos(ThetaW())*Sin(ThetaWp()) +
      3.872983346207417*g1*Sin(ThetaW())*Sin(ThetaWp())) + Conj(ZN(gI2,3))*
      KroneckerDelta(3,gO1)*(10*gp*QHd*Cos(ThetaWp()) - (5*g2*Cos(ThetaW()) +
      3.872983346207417*g1*Sin(ThetaW()))*Sin(ThetaWp())));
...
{
   const std::complex<double> result = IF(gO2 < 3,SUM(j1,0,2,Conj(ZEL(gI2,j1))*
      Yv(j1,gO2))*ZP(gI1,1),0);
...
{
   const std::complex<double> result = IF(gO2 < 3,Conj(UP(gI1,1))*SUM(j1,0,2,
      Conj(ZE(gI2,j1))*Yv(j1,gO2)),0);
...
std::complex<double> CLASSNAME::CpbarUFvFvhhPL(int gO2, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO2 < 3,-0.7071067811865475*Conj(ZH(
      gI1,1))*SUM(j1,0,2,Conj(ZVL(gI2,j1))*Yv(j1,gO2)),0);
...
std::complex<double> CLASSNAME::CpbarUFvFvhhPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,-0.7071067811865475*Conj(ZH(
      gI1,1))*SUM(j2,0,2,Conj(Yv(gO1,j2))*ZVR(gI2,j2)),0);
...
std::complex<double> CLASSNAME::CpbarUFvChiSvPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-1.4142135623730951*gp*Qv*
      Conj(ZN(gI2,0))*Conj(ZV(gI1,3 + gO2)),0) + IF(gO2 < 3,-(Conj(ZN(gI2,4))*SUM(
      j1,0,2,Conj(ZV(gI1,j1))*Yv(j1,gO2))),0);
...
std::complex<double> CLASSNAME::CpbarUFvChiSvPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Ql*
      Conj(ZV(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 3,0.5477225575051661*g1*Conj(ZV(
      gI1,gO1))*ZN(gI2,1),0) + IF(gO1 < 3,-0.7071067811865475*g2*Conj(ZV(gI1,gO1))
      *ZN(gI2,2),0) + IF(gO1 < 3,-(SUM(j2,0,2,Conj(Yv(gO1,j2))*Conj(ZV(gI1,3 + j2)
      ))*ZN(gI2,4)),0);
...
std::complex<double> CLASSNAME::CpbarUFvFvVZPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,gp*Qv*Sin(ThetaWp())*ZVR(gI2,
      gO2),0);
...
std::complex<double> CLASSNAME::CpbarUFvFvVZPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,-0.5*g2*Conj(ZVL(gI2,gO1))*
      Cos(ThetaW())*Cos(ThetaWp()),0) + IF(gI2 < 3,-0.3872983346207417*g1*Conj(ZVL
      (gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-(gp*Ql*Conj(ZVL(gI2
      ,gO1))*Sin(ThetaWp())),0);
...
std::complex<double> CLASSNAME::CpbarUFvFvVZpPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,gp*Qv*Cos(ThetaWp())*ZVR(gI2,
      gO2),0);
...
std::complex<double> CLASSNAME::CpbarUFvFvVZpPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,-(gp*Ql*Conj(ZVL(gI2,gO1))*
      Cos(ThetaWp())),0) + IF(gI2 < 3,0.5*g2*Conj(ZVL(gI2,gO1))*Cos(ThetaW())*Sin(
...
std::complex<double> CLASSNAME::CpbarUChaChiHpmPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*ZN(gI2,3)*ZP(
      gI1,0)) + KroneckerDelta(1,gO1)*(-1.4142135623730951*gp*QHd*ZN(gI2,0)*ZP(gI1
      ,0) + 0.5477225575051661*g1*ZN(gI2,1)*ZP(gI1,0) + 0.7071067811865475*g2*ZN(
      gI2,2)*ZP(gI1,0) - Conj(Lambdax)*ZN(gI2,5)*ZP(gI1,1));
...
std::complex<double> CLASSNAME::CpbarUChabarFvSePL(int gO2, int gI1, int gI2) const
{
   const std::complex<double> result = KroneckerDelta(1,gO2)*SUM(j2,0,2,Conj(
      ZVR(gI1,j2))*SUM(j1,0,2,Conj(ZE(gI2,j1))*Yv(j1,j2)));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO1)*SUM(j1,0,2,
      Conj(ZE(gI2,j1))*ZVL(gI1,j1))) + KroneckerDelta(1,gO1)*SUM(j2,0,2,SUM(j1,0,2
      ,Conj(Ye(j1,j2))*Conj(ZE(gI2,3 + j1)))*ZVL(gI1,j2));
...
{
   const std::complex<double> result = -(g2*KroneckerDelta(0,gO2)*SUM(j1,0,2,
      Conj(ZEL(gI2,j1))*ZV(gI1,j1))) + KroneckerDelta(1,gO2)*SUM(j2,0,2,SUM(j1,0,2
      ,Conj(ZEL(gI2,j1))*Yv(j1,j2))*ZV(gI1,3 + j2));
...
std::complex<double> CLASSNAME::CpbarUChaChaVZpPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = -(g2*Cos(ThetaW())*KroneckerDelta(0,gO2)
      *Sin(ThetaWp())*UP(gI2,0)) + 0.1*KroneckerDelta(1,gO2)*(10*gp*QHu*Cos(
...
{
   const std::complex<double> result = -0.5*g2*(2*Conj(ZN(gI2,2))*
      KroneckerDelta(0,gO1) + 1.4142135623730951*Conj(ZN(gI2,3))*KroneckerDelta(1,
      gO1));
...
{
   const std::complex<double> result = IF(gO2 < 3,SUM(j2,0,2,Conj(ZVL(gI2,j2))*
...
{
   const std::complex<double> result = IF(gO1 < 3,SUM(j2,0,2,Conj(Yv(gO1,j2))*
      ZVR(gI2,j2))*ZP(gI1,1),0);
...
std::complex<double> CLASSNAME::CpbarUFeChaSvPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = IF(gO1 < 3,-(g2*Conj(ZV(gI1,gO1))*UP(gI2
      ,0)),0) + IF(gO1 < 3,SUM(j2,0,2,Conj(Yv(gO1,j2))*Conj(ZV(gI1,3 + j2)))*UP(
      gI2,1),0);
...
std::complex<double> CLASSNAME::CpbarUFeChiSePL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-1.4142135623730951*gp*Qe*
      Conj(ZE(gI1,3 + gO2))*Conj(ZN(gI2,0)),0) + IF(gO2 < 3,-1.0954451150103321*g1
      *Conj(ZE(gI1,3 + gO2))*Conj(ZN(gI2,1)),0) + IF(gO2 < 3,-(Conj(ZN(gI2,3))*SUM
      (j2,0,2,Conj(ZE(gI1,j2))*Ye(gO2,j2))),0);
...
std::complex<double> CLASSNAME::CpbarUFeChiSePR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Ql*
      Conj(ZE(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 3,0.5477225575051661*g1*Conj(ZE(
      gI1,gO1))*ZN(gI2,1),0) + IF(gO1 < 3,0.7071067811865475*g2*Conj(ZE(gI1,gO1))*
      ZN(gI2,2),0) + IF(gO1 < 3,-(SUM(j1,0,2,Conj(Ye(j1,gO1))*Conj(ZE(gI1,3 + j1))
      )*ZN(gI2,3)),0);
...
std::complex<double> CLASSNAME::CpbarUFeFeVZPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,0.5*g2*Conj(ZEL(gI2,gO1))*Cos
      ...
      gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-(gp*Ql*Conj(ZEL(gI2,
      gO1))*Sin(ThetaWp())),0);
...
std::complex<double> CLASSNAME::CpbarUFeFeVZpPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,gp*Qe*Cos(ThetaWp())*ZER(gI2,
      gO2),0) + IF(gI2 < 3,0.7745966692414834*g1*Sin(ThetaW())*Sin(ThetaWp())*ZER(
      gI2,gO2),0);
...
std::complex<double> CLASSNAME::CpbarUFeFeVZpPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,-(gp*Ql*Conj(ZEL(gI2,gO1))*
      Cos(ThetaWp())),0) + IF(gI2 < 3,-0.5*g2*Conj(ZEL(gI2,gO1))*Cos(ThetaW())*Sin
...
std::complex<double> CLASSNAME::CpbarUFdChiSdPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-1.4142135623730951*gp*Qd*
      Conj(ZD(gI1,3 + gO2))*Conj(ZN(gI2,0)),0) + IF(gO2 < 3,-0.3651483716701107*g1
      *Conj(ZD(gI1,3 + gO2))*Conj(ZN(gI2,1)),0) + IF(gO2 < 3,-(Conj(ZN(gI2,3))*SUM
      (j2,0,2,Conj(ZD(gI1,j2))*Yd(gO2,j2))),0);
...
std::complex<double> CLASSNAME::CpbarUFdChiSdPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Qq*
      Conj(ZD(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 3,-0.18257418583505536*g1*Conj(ZD(
      gI1,gO1))*ZN(gI2,1),0) + IF(gO1 < 3,0.7071067811865475*g2*Conj(ZD(gI1,gO1))*
      ZN(gI2,2),0) + IF(gO1 < 3,-(SUM(j1,0,2,Conj(Yd(j1,gO1))*Conj(ZD(gI1,3 + j1))
      )*ZN(gI2,3)),0);
...
std::complex<double> CLASSNAME::CpbarUFdFdVZPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,0.5*g2*Conj(ZDL(gI2,gO1))*Cos
      ...
      gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-(gp*Qq*Conj(ZDL(gI2,
      gO1))*Sin(ThetaWp())),0);
...
std::complex<double> CLASSNAME::CpbarUFdFdVZpPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,gp*Qd*Cos(ThetaWp())*ZDR(gI2,
      gO2),0) + IF(gI2 < 3,0.2581988897471611*g1*Sin(ThetaW())*Sin(ThetaWp())*ZDR(
      gI2,gO2),0);
...
std::complex<double> CLASSNAME::CpbarUFdFdVZpPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,-(gp*Qq*Conj(ZDL(gI2,gO1))*
      Cos(ThetaWp())),0) + IF(gI2 < 3,-0.5*g2*Conj(ZDL(gI2,gO1))*Cos(ThetaW())*Sin
...
std::complex<double> CLASSNAME::CpbarUFuChiSuPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO2 < 3,-1.4142135623730951*gp*Qu*
      Conj(ZN(gI2,0))*Conj(ZU(gI1,3 + gO2)),0) + IF(gO2 < 3,0.7302967433402214*g1*
      Conj(ZN(gI2,1))*Conj(ZU(gI1,3 + gO2)),0) + IF(gO2 < 3,-(Conj(ZN(gI2,4))*SUM(
      j2,0,2,Conj(ZU(gI1,j2))*Yu(gO2,j2))),0);
...
std::complex<double> CLASSNAME::CpbarUFuChiSuPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = IF(gO1 < 3,-1.4142135623730951*gp*Qq*
      Conj(ZU(gI1,gO1))*ZN(gI2,0),0) + IF(gO1 < 3,-0.18257418583505536*g1*Conj(ZU(
      gI1,gO1))*ZN(gI2,1),0) + IF(gO1 < 3,-0.7071067811865475*g2*Conj(ZU(gI1,gO1))
      *ZN(gI2,2),0) + IF(gO1 < 3,-(SUM(j1,0,2,Conj(Yu(j1,gO1))*Conj(ZU(gI1,3 + j1)
      ))*ZN(gI2,4)),0);
...
std::complex<double> CLASSNAME::CpbarUFuFuVZPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,-0.5*g2*Conj(ZUL(gI2,gO1))*
      ...
      (gI2,gO1))*Cos(ThetaWp())*Sin(ThetaW()),0) + IF(gI2 < 3,-(gp*Qq*Conj(ZUL(gI2
      ,gO1))*Sin(ThetaWp())),0);
...
std::complex<double> CLASSNAME::CpbarUFuFuVZpPR(int gO2, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,gp*Qu*Cos(ThetaWp())*ZUR(gI2,
      gO2),0) + IF(gI2 < 3,-0.5163977794943222*g1*Sin(ThetaW())*Sin(ThetaWp())*ZUR
      (gI2,gO2),0);
...
std::complex<double> CLASSNAME::CpbarUFuFuVZpPL(int gO1, int gI2) const
{
   ...
   const std::complex<double> result = IF(gI2 < 3,-(gp*Qq*Conj(ZUL(gI2,gO1))*
      Cos(ThetaWp())),0) + IF(gI2 < 3,0.5*g2*Conj(ZUL(gI2,gO1))*Cos(ThetaW())*Sin(
...
std::complex<double> CLASSNAME::CpbarFeFvHpmPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = SUM(j2,0,2,SUM(j1,0,2,Conj(Yv(j1,j2))*
      ZEL(gO1,j1))*ZVR(gI2,j2))*ZP(gI1,1);
...
std::complex<double> CLASSNAME::CpbarFeChaSvPR(int gO1, int gI2, int gI1) const
{
   const std::complex<double> result = -(g2*SUM(j1,0,2,Conj(ZV(gI1,j1))*ZEL(gO1
      ,j1))*UP(gI2,0)) + SUM(j2,0,2,Conj(ZV(gI1,3 + j2))*SUM(j1,0,2,Conj(Yv(j1,j2)
      )*ZEL(gO1,j1)))*UP(gI2,1);
...
std::complex<double> CLASSNAME::CpbarFeChiSePL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qe*Conj(ZN(gI2,0)
      ...
      *Conj(ZN(gI2,1))*SUM(j1,0,2,Conj(ZE(gI1,3 + j1))*Conj(ZER(gO2,j1))) - Conj(
      ZN(gI2,3))*SUM(j2,0,2,Conj(ZE(gI1,j2))*SUM(j1,0,2,Conj(ZER(gO2,j1))*Ye(j1,j2
      )));
...
std::complex<double> CLASSNAME::CpbarFeChiSePR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.1414213562373095*SUM(j1,0,2,Conj(ZE(
      gI1,j1))*ZEL(gO1,j1))*(-10*gp*Ql*ZN(gI2,0) + 3.872983346207417*g1*ZN(gI2,1)
      + 5*g2*ZN(gI2,2)) - SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gI1,3 + j1
      )))*ZEL(gO1,j2))*ZN(gI2,3);
...
std::complex<double> CLASSNAME::CpbarFdChiSdPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qd*Conj(ZN(gI2,0)
      ...
      *Conj(ZN(gI2,1))*SUM(j1,0,2,Conj(ZD(gI1,3 + j1))*Conj(ZDR(gO2,j1))) - Conj(
      ZN(gI2,3))*SUM(j2,0,2,Conj(ZD(gI1,j2))*SUM(j1,0,2,Conj(ZDR(gO2,j1))*Yd(j1,j2
      )));
...
std::complex<double> CLASSNAME::CpbarFdChiSdPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*(-1.4142135623730951
      *SUM(j1,0,2,Conj(ZD(gI1,j1))*ZDL(gO1,j1))*(6*gp*Qq*ZN(gI2,0) +
      0.7745966692414834*g1*ZN(gI2,1) - 3*g2*ZN(gI2,2)) - 6*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Yd(j1,j2))*Conj(ZD(gI1,3 + j1)))*ZDL(gO1,j2))*ZN(gI2,3));
...
std::complex<double> CLASSNAME::CpbarFuChiSuPL(int gO2, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = -1.4142135623730951*gp*Qu*Conj(ZN(gI2,0)
      ...
      *Conj(ZN(gI2,1))*SUM(j1,0,2,Conj(ZU(gI1,3 + j1))*Conj(ZUR(gO2,j1))) - Conj(
      ZN(gI2,4))*SUM(j2,0,2,Conj(ZU(gI1,j2))*SUM(j1,0,2,Conj(ZUR(gO2,j1))*Yu(j1,j2
      )));
...
std::complex<double> CLASSNAME::CpbarFuChiSuPR(int gO1, int gI2, int gI1) const
{
   ...
   const std::complex<double> result = 0.16666666666666666*(-1.4142135623730951
      *SUM(j1,0,2,Conj(ZU(gI1,j1))*ZUL(gO1,j1))*(6*gp*Qq*ZN(gI2,0) +
      0.7745966692414834*g1*ZN(gI2,1) + 3*g2*ZN(gI2,2)) - 6*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Yu(j1,j2))*Conj(ZU(gI1,3 + j1)))*ZUL(gO1,j2))*ZN(gI2,4));
...
std::complex<double> CLASSNAME::self_energy_Sv_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI1,0,5,A0(Sqr(MSv(gI1)))*CpSvUSvconjSvconjUSv(gI1,gO1,gI1,
      gO2));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(MAh(gI2)))*
      Conj(CpAhSvconjUSv(gI2,gI1,gO2))*CpAhSvconjUSv(gI2,gI1,gO1)));
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MSv(gI1)),Sqr(Mhh(gI2)))*
   ...
   result += SUM(gI2,0,5,Conj(CpSvconjUSvVZp(gI2,gO2))*CpSvconjUSvVZp(gI2,gO1)*
...
std::complex<double> CLASSNAME::self_energy_hh_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFv(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(
      MFv(gI2)))*(Conj(CpbarFvFvUhhPR(gI1,gI2,gO2))*CpbarFvFvUhhPL(gI1,gI2,gO1) +
      Conj(CpbarFvFvUhhPL(gI1,gI2,gO2))*CpbarFvFvUhhPR(gI1,gI2,gO1))*MFv(gI2)));
...
std::complex<double> CLASSNAME::self_energy_Ah_1loop(double p , int gO1, int gO2) const
{
   ...
   result += -2*SUM(gI1,0,2,MFv(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(
      MFv(gI2)))*(Conj(CpbarFvFvUAhPR(gI1,gI2,gO2))*CpbarFvFvUAhPL(gI1,gI2,gO1) +
      Conj(CpbarFvFvUAhPL(gI1,gI2,gO2))*CpbarFvFvUAhPR(gI1,gI2,gO1))*MFv(gI2)));
...
std::complex<double> CLASSNAME::self_energy_VZp_1loop(double p ) const
{
   ...
   result += -12*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSuconjSuVZp(gI2,gI1))*B00(Sqr
      (p),Sqr(MSu(gI1)),Sqr(MSu(gI2)))));
   result += -4*SUM(gI1,0,5,SUM(gI2,0,5,AbsSqr(CpSvconjSvVZp(gI2,gI1))*B00(Sqr(
...
std::complex<double> CLASSNAME::self_energy_Chi_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,2,MFv(gI1)*SUM(gI2,0,5,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MSv(
   ...
   result += 3*SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFu(gI2)),Sqr(MSu(gI1)))*
      ...
      ;
   result += SUM(gI1,0,5,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MSv(gI1)))*
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI1,0,1,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(MHpm(gI1)))*
      Conj(CpbarUFvFeconjHpmPL(gO2,gI2,gI1))*CpbarUFvFeconjHpmPR(gO1,gI2,gI1)*MFe(
      gI2)));
   ...
   result += SUM(gI1,0,2,MFv(gI1)*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI1)),Sqr(MAh(
      gI2)))*Conj(CpbarUFvFvAhPL(gO2,gI1,gI2))*CpbarUFvFvAhPR(gO1,gI1,gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(Mhh(gI1)))*
      Conj(CpbarUFvFvhhPL(gO2,gI2,gI1))*CpbarUFvFvhhPR(gO1,gI2,gI1)*MFv(gI2)));
   result += SUM(gI1,0,5,SUM(gI2,0,5,B0(Sqr(p),Sqr(MChi(gI2)),Sqr(MSv(gI1)))*
      Conj(CpbarUFvChiSvPL(gO2,gI2,gI1))*CpbarUFvChiSvPR(gO1,gI2,gI1)*MChi(gI2)));
   ...
   result += -4*SUM(gI2,0,2,B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ))*Conj(
      CpbarUFvFvVZPR(gO2,gI2))*CpbarUFvFvVZPL(gO1,gI2)*MFv(gI2));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZp))*Conj(
      CpbarUFvFvVZpPL(gO2,gI2))*CpbarUFvFvVZpPL(gO1,gI2));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -SUM(gI2,0,2,B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZp))*Conj(
      CpbarUFvFvVZpPR(gO2,gI2))*CpbarUFvFvVZpPR(gO1,gI2));
