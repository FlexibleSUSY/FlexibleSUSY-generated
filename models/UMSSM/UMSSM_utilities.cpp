...
UMSSM_spectrum_plotter::UMSSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
...
std::valarray<double> UMSSM_spectrum_plotter::to_valarray(double v)
{
   ...
   const UMSSM_observables* observables)
{
   ...
   append(names, UMSSM_parameter_getter().get_mass_names());
   append(names, UMSSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, UMSSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = UMSSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = UMSSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = UMSSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? UMSSM_observables::NUMBER_OF_OBSERVABLES : 0u);
