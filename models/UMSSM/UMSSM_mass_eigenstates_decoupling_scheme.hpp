...
/**
 * @file UMSSM_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef UMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define UMSSM_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class UMSSM_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class UMSSM_mass_eigenstates_decoupling_scheme
   : private UMSSM_soft_parameters
   , public UMSSM_mass_eigenstates_interface
{
public:
   explicit UMSSM_mass_eigenstates_decoupling_scheme(const UMSSM_input_parameters& input_ = UMSSM_input_parameters());
   explicit UMSSM_mass_eigenstates_decoupling_scheme(const UMSSM_mass_eigenstates&);
   UMSSM_mass_eigenstates_decoupling_scheme(const UMSSM_mass_eigenstates_decoupling_scheme&) = default;
   UMSSM_mass_eigenstates_decoupling_scheme(UMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~UMSSM_mass_eigenstates_decoupling_scheme() = default;
   UMSSM_mass_eigenstates_decoupling_scheme& operator=(const UMSSM_mass_eigenstates_decoupling_scheme&) = default;
   UMSSM_mass_eigenstates_decoupling_scheme& operator=(UMSSM_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const UMSSM_mass_eigenstates&);
...
std::ostream& operator<<(std::ostream&, const UMSSM_mass_eigenstates_decoupling_scheme&);
