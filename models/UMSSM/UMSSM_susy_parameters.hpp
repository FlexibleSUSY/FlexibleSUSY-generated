...
// File generated at Tue 22 Jan 2019 17:28:20

#ifndef UMSSM_susy_parameters_H
#define UMSSM_susy_parameters_H
...
public:
   ...
   UMSSM_susy_parameters(double scale_, int loops_, int thresholds_, const UMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_,
   ...
   UMSSM_susy_parameters(const UMSSM_susy_parameters&) = default;
   UMSSM_susy_parameters(UMSSM_susy_parameters&&) = default;
   virtual ~UMSSM_susy_parameters() = default;
   UMSSM_susy_parameters& operator=(const UMSSM_susy_parameters&) = default;
   UMSSM_susy_parameters& operator=(UMSSM_susy_parameters&&) = default;
...
private:
   ...
   double calc_beta_gp_1_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gp_2_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gp_3_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gp_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_gp_5_loop(const TRACE_STRUCT_TYPE&) const;
