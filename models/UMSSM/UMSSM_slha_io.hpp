...
public:
   ...
   template <class T> void set_extra(const UMSSM_slha<T>&, const UMSSM_scales&, const UMSSM_observables&);
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const UMSSM_slha<T>&, const softsusy::QedQcd&, const UMSSM_scales&, const UMSSM_observables&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const UMSSM_slha<T>&, const softsusy::QedQcd&, const UMSSM_scales&, const UMSSM_observables&);
