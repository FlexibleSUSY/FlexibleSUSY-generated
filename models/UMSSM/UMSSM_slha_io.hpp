...
#include "decays/UMSSM_decays.hpp"
...
public:
   ...
   void set_decays(const UMSSM_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const UMSSM_slha&, const UMSSM_scales&, const UMSSM_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const UMSSM_slha&);
   ...
   void fill_decays_data(const UMSSM_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const UMSSM_scales&, const UMSSM_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, UMSSM_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const UMSSM_slha&);
...
void UMSSM_slha_io::fill(
   ...
   UMSSM_decays const * const decays)
{
