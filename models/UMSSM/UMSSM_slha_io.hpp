...
public:
   ...
   void set_extra(const UMSSM_slha&, const UMSSM_scales&, const UMSSM_observables&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const UMSSM_scales&, const UMSSM_observables&);
