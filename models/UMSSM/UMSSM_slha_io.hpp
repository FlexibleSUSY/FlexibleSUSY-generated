...
public:
   ...
   template <class Model> void fill(UMSSM_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const UMSSM_slha<Model>&, const UMSSM_scales&, const UMSSM_observables&);
   void set_input(const UMSSM_input_parameters&);
   ...
   template <class Model> void set_spectrum(const UMSSM_slha<Model>&);
   ...
   static void fill_imminpar_tuple(UMSSM_input_parameters&, int, double);
   static void fill_imextpar_tuple(UMSSM_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const UMSSM_slha<Model>&, const softsusy::QedQcd&, const UMSSM_scales&, const UMSSM_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const UMSSM_slha<Model>&, const softsusy::QedQcd&, const UMSSM_scales&, const UMSSM_observables&);
...
private:
   ...
   void set_imminpar(const UMSSM_input_parameters&);
   void set_imextpar(const UMSSM_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const UMSSM_slha<Model>&);
 ...
 */
template <class Model>
void UMSSM_slha_io::fill(UMSSM_slha<Model>& model) const
{
...
void UMSSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const UMSSM_slha<Model>& model,
...
SLHAea::Coll UMSSM_slha_io::fill_slhaea(
   const UMSSM_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const UMSSM_scales& scales, const UMSSM_observables& observables)
{
   SLHAea::Coll slhaea;
 ...
 */
template <class Model>
void UMSSM_slha_io::set_model_parameters(const UMSSM_slha<Model>& model)
{
   {
...
void UMSSM_slha_io::set_extra(
   const UMSSM_slha<Model>& model, const UMSSM_scales& scales,
   const UMSSM_observables& observables)
{
 ...
 */
template <class... Ts>
void UMSSM_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<UMSSM_slha_io> ss(this);
...
{
   set_spectrum(UMSSM_slha<UMSSM<T> >(model));
}
 ...
 */
template <class Model>
void UMSSM_slha_io::set_spectrum(const UMSSM_slha<Model>& model)
{
   const UMSSM_physical physical(model.get_physical_slha());
