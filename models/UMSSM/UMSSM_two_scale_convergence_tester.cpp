...
UMSSM_convergence_tester<Two_scale>::UMSSM_convergence_tester(UMSSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<UMSSM<Two_scale> >(model, accuracy_goal)
{
}
