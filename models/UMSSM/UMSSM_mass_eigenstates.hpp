...
public:
   ...
   UMSSM_mass_eigenstates(UMSSM_mass_eigenstates&&) = default;
   ...
   std::complex<double> CpChaFvconjUSePR(int gI2, int gI1, int gO2) const;
   ...
   std::complex<double> CpbarFvFvUhhPR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpbarFvFvUhhPL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpbarFvFvUAhPR(int gI1, int gI2, int gO2) const;
   std::complex<double> CpbarFvFvUAhPL(int gI1, int gI2, int gO1) const;
   ...
   std::complex<double> CpbarFvFeconjUHpmPL(int gI1, int gI2, int gO1) const;
   ...
   double CpbarFvFvVZPR(int gI1, int gI2) const;
   ...
   double CpbarFvFvVZpPR(int gI1, int gI2) const;
   ...
   std::complex<double> CpSvconjSvVZp(int gI2, int gI1) const;
   ...
   std::complex<double> CpbarFvUChiSvPL(int gI1, int gO2, int gI2) const;
   ...
   std::complex<double> CpbarUFvFeconjHpmPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpbarUFvFeconjHpmPR(int gO1, int gI2, int gI1) const;
   std::complex<double> CpbarChabarUFvSePL(int gI1, int gO2, int gI2) const;
   std::complex<double> CpbarChabarUFvSePR(int gI1, int gO1, int gI2) const;
   std::complex<double> CpbarUFvFvAhPL(int gO2, int gI1, int gI2) const;
   std::complex<double> CpbarUFvFvAhPR(int gO1, int gI1, int gI2) const;
   std::complex<double> CpbarUFvFvhhPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpbarUFvFvhhPR(int gO1, int gI2, int gI1) const;
   std::complex<double> CpbarUFvChiSvPL(int gO2, int gI2, int gI1) const;
   std::complex<double> CpbarUFvChiSvPR(int gO1, int gI2, int gI1) const;
   double CpbarUFvFeconjVWmPR(int , int ) const;
   std::complex<double> CpbarUFvFeconjVWmPL(int gO1, int gI2) const;
   std::complex<double> CpbarUFvFvVZPR(int gO2, int gI2) const;
   std::complex<double> CpbarUFvFvVZPL(int gO1, int gI2) const;
   std::complex<double> CpbarUFvFvVZpPR(int gO2, int gI2) const;
   std::complex<double> CpbarUFvFvVZpPL(int gO1, int gI2) const;
   ...
   std::complex<double> CpbarUChabarFvSePL(int gO2, int gI1, int gI2) const;
