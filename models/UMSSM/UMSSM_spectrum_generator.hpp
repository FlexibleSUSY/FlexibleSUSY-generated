...
// File generated at Tue 5 Sep 2017 12:24:45
                                ...
                                const UMSSM_input_parameters& input)
{
   ...
   UMSSM_high_scale_constraint<T> high_scale_constraint(&model);
   UMSSM_susy_scale_constraint<T> susy_scale_constraint(&model, qedqcd);
   UMSSM_low_scale_constraint<T>  low_scale_constraint(&model, qedqcd);
