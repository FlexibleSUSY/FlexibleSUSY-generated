...
UMSSM_slha::UMSSM_slha(const UMSSM_input_parameters& input_,
 ...
 */
UMSSM_slha::UMSSM_slha(const UMSSM_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : UMSSM_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void UMSSM_slha::clear()
{
   UMSSM_mass_eigenstates::clear();
   physical_slha.clear();
}

void UMSSM_slha::calculate_spectrum()
{
   UMSSM_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void UMSSM_slha::convert_to_slha()
{
...
void UMSSM_slha::calculate_ckm_matrix()
{
...
void UMSSM_slha::calculate_pmns_matrix()
{
 ...
 */
void UMSSM_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void UMSSM_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void UMSSM_slha::convert_soft_squared_masses_to_slha()
{
...
const UMSSM_physical& UMSSM_slha::get_physical_slha() const
{
   return physical_slha;
}

UMSSM_physical& UMSSM_slha::get_physical_slha()
{
   return physical_slha;
}

void UMSSM_slha::print(std::ostream& ostr) const
{
   UMSSM_mass_eigenstates::print(ostr);
...
void UMSSM_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const UMSSM_slha& model)
{
   model.print(ostr);
   return ostr;
}
