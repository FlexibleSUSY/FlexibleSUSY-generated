...
class UMSSM_slha : public UMSSM_mass_eigenstates {
public:
   explicit UMSSM_slha(const UMSSM_input_parameters& input_ = UMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit UMSSM_slha(const UMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
