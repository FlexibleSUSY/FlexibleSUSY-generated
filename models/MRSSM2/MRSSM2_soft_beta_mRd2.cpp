 ...
 */
double MRSSM2_soft_parameters::calc_beta_mRd2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM2_soft_parameters::calc_beta_mRd2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM2_soft_parameters::calc_beta_mRd2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MRSSM2_soft_parameters::calc_beta_mRd2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double MRSSM2_soft_parameters::calc_beta_mRd2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
