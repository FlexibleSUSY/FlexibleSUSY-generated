 ...
 */
double MRSSM2_susy_parameters::calc_beta_Mu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Mu = Re(-0.1*Mu*(-30*traceYdAdjYd - 10*traceYeAdjYe - 30*traceYuAdjYu -
      10*AbsSqr(LamSD) - 10*AbsSqr(LamSU) - 15*AbsSqr(LamTD) - 15*AbsSqr(LamTU)
      + 6*Sqr(g1) + 30*Sqr(g2)));
 ...
 */
double MRSSM2_susy_parameters::calc_beta_Mu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Mu = Re(0.05*Mu*(-180*traceYdAdjYdYdAdjYd - 120*traceYdAdjYuYuAdjYd -
 ...
 */
double MRSSM2_susy_parameters::calc_beta_Mu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSM2_susy_parameters::calc_beta_Mu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double MRSSM2_susy_parameters::calc_beta_Mu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
