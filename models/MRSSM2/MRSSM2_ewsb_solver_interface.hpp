...
/**
 * @file MRSSM2_ewsb_solver_interface.hpp
 *
...
#ifndef MRSSM2_EWSB_SOLVER_INTERFACE_H
#define MRSSM2_EWSB_SOLVER_INTERFACE_H
...
class MRSSM2_ewsb_solver_interface {
public:
   virtual ~MRSSM2_ewsb_solver_interface() {}
   ...
   virtual int solve(MRSSM2_mass_eigenstates&) = 0;
};
