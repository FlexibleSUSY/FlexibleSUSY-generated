...
#ifndef MRSSM2_DECAY_TABLE_H
#define MRSSM2_DECAY_TABLE_H
...
public:
   ...
   MRSSM2_decay_table();
   ~MRSSM2_decay_table() = default;
   MRSSM2_decay_table(const MRSSM2_decay_table&) = default;
   MRSSM2_decay_table(MRSSM2_decay_table&&) = default;
   MRSSM2_decay_table& operator=(const MRSSM2_decay_table&) = default;
   MRSSM2_decay_table& operator=(MRSSM2_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const MRSSM2_decay_table&);
