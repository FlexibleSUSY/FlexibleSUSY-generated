...
Eigen::ArrayXd MRSSM2_input_parameters::get() const
{
...
void MRSSM2_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   Ms = pars(1);
   LamTDInput = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MRSSM2_input_parameters& input)
{
