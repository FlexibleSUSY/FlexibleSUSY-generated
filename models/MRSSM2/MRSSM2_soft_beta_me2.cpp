 ...
 */
Eigen::Matrix<double,3,3> MRSSM2_soft_parameters::calc_beta_me2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_me2 = (4*mHd2*(Ye*Ye.adjoint()) + 2*(me2*Ye*Ye.adjoint()) + 4*(Ye*ml2*
      Ye.adjoint()) + 2*(Ye*Ye.adjoint()*me2) + 1.5491933384829668*g1*Tr11*
      UNITMATRIX(3)).real();
 ...
 */
Eigen::Matrix<double,3,3> MRSSM2_soft_parameters::calc_beta_me2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_me2 = (-0.4*(30*tracemd2YdAdjYd + 10*traceme2YeAdjYe + 10*
 ...
 */
Eigen::Matrix<double,3,3> MRSSM2_soft_parameters::calc_beta_me2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MRSSM2_soft_parameters::calc_beta_me2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> MRSSM2_soft_parameters::calc_beta_me2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
