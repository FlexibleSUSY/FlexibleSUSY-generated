...
template<> struct VertexImpl<fields::Fe, fields::Chi, typename fields::conj<fields::Se>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename fields::bar<fields::Fe>::type, typename fields::bar<fields::Chi>::type, fields::Se>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<fields::Fe, typename fields::bar<fields::Chi>::type, typename fields::conj<fields::Se>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<fields::Fe, typename fields::bar<fields::Fv>::type, typename fields::conj<fields::Hpm>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};
...
template<> struct VertexImpl<fields::Fe, typename fields::conj<fields::Sv>::type, fields::Cha1>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<typename fields::bar<fields::Fe>::type, fields::Sv, typename fields::bar<fields::Cha1>::type>
{
   static ChiralVertex evaluate(const std::array<int, 3>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::VP, typename fields::bar<fields::Cha1>::type, fields::Cha1>
{
   static ChiralVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};
...
template<> struct VertexImpl<typename fields::bar<fields::Glu>::type, fields::Glu, fields::sigmaO>
{
   static ChiralVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::sigmaO, fields::sigmaO, fields::VG>
{
   static MomentumDifferenceVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::phiO, fields::Sd, fields::sigmaO, typename fields::conj<fields::Sd>::type>
{
   static ScalarVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::phiO, fields::sigmaO, fields::Su, typename fields::conj<fields::Su>::type>
{
   static ScalarVertex evaluate(const std::array<int, 2>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::phiO, fields::phiO, fields::sigmaO, fields::sigmaO>
{
   static ScalarVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::sigmaO, fields::sigmaO, fields::VG, fields::VG>
{
   static InverseMetricVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};

template<> struct VertexImpl<typename fields::bar<fields::Glu>::type, fields::Glu, fields::phiO>
{
   static ChiralVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};

template<> struct VertexImpl<typename fields::bar<fields::Glu>::type, fields::Glu, fields::VG>
{
   static ChiralVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};
...
template<> struct VertexImpl<fields::phiO, fields::phiO, fields::VG>
{
   static MomentumDifferenceVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};

template<> struct VertexImpl<fields::phiO, fields::phiO, fields::VG, fields::VG>
{
   static InverseMetricVertex evaluate(const std::array<int, 0>& indices, const context_base& context);
};
