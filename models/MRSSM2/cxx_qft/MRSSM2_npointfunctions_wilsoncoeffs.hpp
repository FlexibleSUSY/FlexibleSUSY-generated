...
/**
 * @file cxx_qft/MRSSM2_npointfunctions_wilsoncoeffs.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.0 and SARAH 4.14.4 .
 */

#ifndef MRSSM2_CXXQFT_NPOINTFUNCTIONS_H
#define MRSSM2_CXXQFT_NPOINTFUNCTIONS_H

#include "MRSSM2_qft.hpp"
...
struct context_with_vertices : context_base {
   ...
   double scale( void ) const {
      return dynamic_cast<MRSSM2_mass_eigenstates const&>(model).get_scale();
   }
...
public:
   correlation_function_context(
      const MRSSM2_mass_eigenstates &m,
