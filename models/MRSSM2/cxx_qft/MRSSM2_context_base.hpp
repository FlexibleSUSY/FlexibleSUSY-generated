...
/**
 * @file cxx_qft/MRSSM2_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.2 and SARAH 4.14.5 .
 */

#ifndef MRSSM2_CXXQFT_CONTEXT_BASE_H
#define MRSSM2_CXXQFT_CONTEXT_BASE_H
...
namespace MRSSM2_cxx_diagrams {
   ...
   struct context_base {
      MRSSM2_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(MRSSM2_mass_eigenstates_interface const& m) : model(m) {}
      context_base(MRSSM2_mass_eigenstates_interface const* const m) : model(*m) {}
