...
#ifndef MRSSM2_susy_parameters_H
#define MRSSM2_susy_parameters_H
...
class MRSSM2_susy_parameters : public Beta_function {
public:
   explicit MRSSM2_susy_parameters(const MRSSM2_input_parameters& input_ = MRSSM2_input_parameters());
   MRSSM2_susy_parameters(double scale_, int loops_, int thresholds_, const MRSSM2_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_,
   ...
   MRSSM2_susy_parameters(const MRSSM2_susy_parameters&) = default;
   MRSSM2_susy_parameters(MRSSM2_susy_parameters&&) = default;
   virtual ~MRSSM2_susy_parameters() = default;
   MRSSM2_susy_parameters& operator=(const MRSSM2_susy_parameters&) = default;
   MRSSM2_susy_parameters& operator=(MRSSM2_susy_parameters&&) = default;
   ...
   const MRSSM2_input_parameters& get_input() const;
   MRSSM2_input_parameters& get_input();
   void set_input_parameters(const MRSSM2_input_parameters&);

   MRSSM2_susy_parameters calc_beta() const;
   MRSSM2_susy_parameters calc_beta(int) const;
   virtual void clear();
...
private:
   ...
   double calc_beta_LamTD_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LamTD_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_LamTU_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LamTU_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_LamSD_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LamSD_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_LamSU_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_LamSU_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_MuD_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MuD_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_MuU_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_MuU_5_loop(const TRACE_STRUCT_TYPE&) const;
   ...
   double calc_beta_vT_4_loop(const TRACE_STRUCT_TYPE&) const;
   double calc_beta_vT_5_loop(const TRACE_STRUCT_TYPE&) const;
...
std::ostream& operator<<(std::ostream&, const MRSSM2_susy_parameters&);
