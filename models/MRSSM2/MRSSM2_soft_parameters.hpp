...
#ifndef MRSSM2_soft_parameters_H
#define MRSSM2_soft_parameters_H
...
class MRSSM2_soft_parameters : public MRSSM2_susy_parameters {
public:
   explicit MRSSM2_soft_parameters(const MRSSM2_input_parameters& input_ = MRSSM2_input_parameters());
   MRSSM2_soft_parameters(const MRSSM2_susy_parameters& , double BMu_, double BMuD_, double BMuU_, const Eigen::Matrix<double,3,3>&
   ...
   MDGoc_);
   MRSSM2_soft_parameters(const MRSSM2_soft_parameters&) = default;
   MRSSM2_soft_parameters(MRSSM2_soft_parameters&&) = default;
   virtual ~MRSSM2_soft_parameters() = default;
   MRSSM2_soft_parameters& operator=(const MRSSM2_soft_parameters&) = default;
   MRSSM2_soft_parameters& operator=(MRSSM2_soft_parameters&&) = default;
   ...
   MRSSM2_soft_parameters calc_beta() const;
   MRSSM2_soft_parameters calc_beta(int) const;
...
private:
   static constexpr int numberOfParameters = 99;
...
std::ostream& operator<<(std::ostream&, const MRSSM2_soft_parameters&);
