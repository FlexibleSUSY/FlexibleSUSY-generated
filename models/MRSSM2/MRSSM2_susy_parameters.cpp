...
#define CLASSNAME MRSSM2_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int MRSSM2_susy_parameters::numberOfParameters;

MRSSM2_susy_parameters::MRSSM2_susy_parameters(const MRSSM2_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MRSSM2_susy_parameters::MRSSM2_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const MRSSM2_input_parameters& input_
...
Eigen::ArrayXd MRSSM2_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MRSSM2_susy_parameters MRSSM2_susy_parameters::calc_beta(int loops) const
{
   ...
   return MRSSM2_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
MRSSM2_susy_parameters MRSSM2_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MRSSM2_susy_parameters::clear()
{
   reset();
...
Eigen::ArrayXd MRSSM2_susy_parameters::get() const
{
...
void MRSSM2_susy_parameters::print() const
{
   this->print(std::cerr);
}

void MRSSM2_susy_parameters::print(std::ostream& ostr) const
{
...
void MRSSM2_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const MRSSM2_input_parameters& MRSSM2_susy_parameters::get_input() const
{
   return input;
}

MRSSM2_input_parameters& MRSSM2_susy_parameters::get_input()
{
   return input;
}

void MRSSM2_susy_parameters::set_input_parameters(const MRSSM2_input_parameters& input_)
{
   input = input_;
}

MRSSM2_susy_parameters::Susy_traces MRSSM2_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MRSSM2_susy_parameters& susy_pars)
{
