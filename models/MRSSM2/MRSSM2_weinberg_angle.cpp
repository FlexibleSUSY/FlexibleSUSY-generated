...
#include "MRSSM2_weinberg_angle.hpp"
...
#define CLASSNAME MRSSM2_weinberg_angle
 ...
 */
CLASSNAME::MRSSM2_weinberg_angle(
   const MRSSM2_mass_eigenstates* model_,
...
void CLASSNAME::set_model(const MRSSM2_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * MRSSM2_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * MRSSM2_info::normalization_g2;
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-
         ...
         Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1
         ))*ZUL(2,j2)))*ZA(1,1)))) + RHO2(MAh(2)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,
         j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
         j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZA(2,1))) - Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2
         ))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1
         ,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZA(2,1)))) + RHO2(MAh(3)/MT)*(Sqr(Abs((SUM(j2,0
         ,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(
         j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZA(3,1))) - Sqr(Abs((SUM(j2,0,
         ...
         )))*ZH(1,1))) - Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1
         ))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))
         )*ZH(1,1)))) - RHO2(Mhh(2)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0
         ,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2
         ,j1))*ZUL(2,j2)))*ZH(2,1))) - Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2
         ,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,
         j1))*ZUL(2,j2)))*ZH(2,1)))) - RHO2(Mhh(3)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(-0.224
         ...
         Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*
         ZA(1,1)))) + RHO2(MAh(2)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2
         ,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,
         j1))*ZUL(2,j2)))*ZA(2,1))) - Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,
         Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1
         ))*ZUL(2,j2)))*ZA(2,1)))) + RHO2(MAh(3)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,
         j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
         j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZA(3,1))) - Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2
         ))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1
         ,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZA(3,1)))) - RHO2(Mhh(0)/MT)*(Sqr(Abs((SUM(j2,0
         ,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(
         j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2)))*ZH(0,1))) - Sqr(Abs((SUM(j2,0,
         2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1
         ...
         j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2
         )))*ZH(2,1))) - Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0,2,Conj(ZUR(2,j1
         ))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2,j1))*ZUL(2,j2))
         )*ZH(2,1)))) - RHO2(Mhh(3)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(ZUL(2,j2))*SUM(j1,0
         ,2,Conj(ZUR(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*ZUR(2
...
std::complex<double> CLASSNAME::CpbarCha1FvconjSePL(int gI1, int gO1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
   const auto UM1 = MODELPARAMETER(UM1);
   const auto ZE = MODELPARAMETER(ZE);
...
std::complex<double> CLASSNAME::CpCha2FvconjSePL(int gI1, int gO1, int gI2) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto UM2 = MODELPARAMETER(UM2);
   const auto ZE = MODELPARAMETER(ZE);
...
std::complex<double> CLASSNAME::CpCha1FeconjSvPL(int gI1, int gO1, int gI2) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto UP1 = MODELPARAMETER(UP1);
   const auto ZEL = MODELPARAMETER(ZEL);
...
std::complex<double> CLASSNAME::CpbarChiFeconjSePL(int gI1, int gO1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
   const auto ZN2 = MODELPARAMETER(ZN2);
   const auto ZEL = MODELPARAMETER(ZEL);
...
std::complex<double> CLASSNAME::delta_vb_wave_Fv(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,-(AbsSqr(
      CpbarCha1FvconjSePL(gI1,gO1,gI2))*B1(0,Sqr(MCha1(gI1)),Sqr(MSe(gI2)))))) +
      SUM(gI1,0,1,SUM(gI2,0,5,-(AbsSqr(CpCha2FvconjSePL(gI1,gO1,gI2))*B1(0,Sqr(
      MCha2(gI1)),Sqr(MSe(gI2)))))) + SUM(gI1,0,3,SUM(gI2,0,2,-(AbsSqr(
      CpChiFvconjSvPL(gI1,gO1,gI2))*B1(0,Sqr(MChi(gI1)),Sqr(MSv(gI2)))))) + SUM(
...
std::complex<double> CLASSNAME::delta_vb_wave_Fe(int gO1) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,2,-(AbsSqr(
      CpCha1FeconjSvPL(gI1,gO1,gI2))*B1(0,Sqr(MCha1(gI1)),Sqr(MSv(gI2)))))) + SUM(
      gI1,0,2,SUM(gI2,1,3,-(AbsSqr(CpbarFvFeconjHpmPL(gI1,gO1,gI2))*B1(0,Sqr(MFv(
      gI1)),Sqr(MHpm(gI2)))))) + SUM(gI1,0,3,SUM(gI2,0,2,-(AbsSqr(CpbarFeFehhPL(
      gI2,gO1,gI1))*B1(0,Sqr(MFe(gI2)),Sqr(Mhh(gI1)))))) + SUM(gI1,0,3,SUM(gI2,0,5
      ,-(AbsSqr(CpbarChiFeconjSePL(gI1,gO1,gI2))*B1(0,Sqr(MChi(gI1)),Sqr(MSe(gI2))
      )))) + SUM(gI1,0,3,SUM(gI2,0,5,-(AbsSqr(CpChiFeconjSePL(gI1,gO1,gI2))*B1(0,
...
std::complex<double> CLASSNAME::delta_vb_vertex(int gO1, int gO2) const
{
   ...
   const std::complex<double> result = (SUM(gI1,0,1,SUM(gI2,0,3,SUM(gI3,0,5,
      CpbarChiFeconjSePL(gI2,gO1,gI3)*CpbarFvCha1SePR(gO2,gI1,gI3)*(-(C0(Sqr(MSe(
      gI3)),Sqr(MCha1(gI1)),Sqr(MChi(gI2)))*CpbarCha1ChiconjVWmPL(gI1,gI2)*MCha1(
      gI1)*MChi(gI2)) + 0.5*CpbarCha1ChiconjVWmPR(gI1,gI2)*(-0.5 + B0(0,Sqr(MCha1(
      gI1)),Sqr(MChi(gI2))) + C0(Sqr(MSe(gI3)),Sqr(MCha1(gI1)),Sqr(MChi(gI2)))*Sqr
      (MSe(gI3))))))) + SUM(gI1,0,1,SUM(gI2,0,3,SUM(gI3,0,5,CpbarCha2barFvSePR(gI1
      ,gO2,gI3)*CpChiFeconjSePL(gI2,gO1,gI3)*(C0(Sqr(MSe(gI3)),Sqr(MCha2(gI1)),Sqr
      (MChi(gI2)))*CpbarChiCha2conjVWmPR(gI2,gI1)*MCha2(gI1)*MChi(gI2) - 0.5*
      CpbarChiCha2conjVWmPL(gI2,gI1)*(-0.5 + B0(0,Sqr(MCha2(gI1)),Sqr(MChi(gI2)))
      + C0(Sqr(MSe(gI3)),Sqr(MCha2(gI1)),Sqr(MChi(gI2)))*Sqr(MSe(gI3))))))) + SUM(
      gI1,0,2,SUM(gI2,0,5,SUM(gI3,0,3,-0.5*CpbarChibarFvSvPR(gI3,gO2,gI1)*
      ...
      MChi(gI3)))))) + SUM(gI1,0,3,SUM(gI2,0,1,SUM(gI3,0,2,CpbarChibarFvSvPR(gI1,
      gO2,gI3)*CpCha1FeconjSvPL(gI2,gO1,gI3)*(C0(Sqr(MSv(gI3)),Sqr(MChi(gI1)),Sqr(
      MCha1(gI2)))*CpbarCha1ChiconjVWmPR(gI2,gI1)*MCha1(gI2)*MChi(gI1) - 0.5*
      CpbarCha1ChiconjVWmPL(gI2,gI1)*(-0.5 + B0(0,Sqr(MChi(gI1)),Sqr(MCha1(gI2)))
      + C0(Sqr(MSv(gI3)),Sqr(MChi(gI1)),Sqr(MCha1(gI2)))*Sqr(MSv(gI3))))))) + SUM(
      gI1,1,3,SUM(gI2,0,3,SUM(gI3,0,2,-0.5*CpbarFeFehhPL(gI3,gO1,gI2)*
      ...
      MFe(gI3)))))) + SUM(gI1,1,3,SUM(gI2,1,3,SUM(gI3,0,2,-0.5*CpAhHpmconjVWm(gI2,
...
std::complex<double> CLASSNAME::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
   ...
   const std::complex<double> result = SUM(gI1,0,1,SUM(gI2,0,5,SUM(gI3,0,1,SUM(gI4
      ...
      Sqr(MCha1(gI4))))))) + SUM(gI1,0,2,SUM(gI2,0,3,SUM(gI3,0,5,SUM(gI4,0,1,0.5*
      CpbarCha1FvconjSePL(gI4,gO3,gI3)*CpbarChibarFvSvPR(gI2,gO2,gI1)*
      CpbarFeChiSePR(gO4,gI2,gI3)*CpCha1FeconjSvPL(gI4,gO1,gI1)*D0(Sqr(MSv(gI1)),
      Sqr(MChi(gI2)),Sqr(MSe(gI3)),Sqr(MCha1(gI4)))*MCha1(gI4)*MChi(gI2))))) + SUM
      (gI1,0,2,SUM(gI2,1,3,SUM(gI3,0,2,SUM(gI4,0,3,CpbarFeFehhPL(gI1,gO1,gI4)*
      CpbarFeFehhPR(gO4,gI3,gI4)*CpbarFeFvHpmPL(gI3,gO3,gI2)*CpbarFvFeconjHpmPR(
      gO2,gI1,gI2)*D27(Sqr(MFe(gI1)),Sqr(MHpm(gI2)),Sqr(MFe(gI3)),Sqr(Mhh(gI4)))))
      )) + SUM(gI1,0,2,SUM(gI2,1,3,SUM(gI3,0,2,SUM(gI4,1,3,CpbarFeFeAhPL(gI1,gO1,
      gI4)*CpbarFeFeAhPR(gO4,gI3,gI4)*CpbarFeFvHpmPL(gI3,gO3,gI2)*
      CpbarFvFeconjHpmPR(gO2,gI1,gI2)*D27(Sqr(MFe(gI1)),Sqr(MHpm(gI2)),Sqr(MFe(gI3
      )),Sqr(MAh(gI4))))))) + SUM(gI1,0,3,SUM(gI2,0,2,SUM(gI3,0,3,SUM(gI4,0,5,
      CpbarChibarFeSePR(gI3,gO4,gI4)*CpbarChibarFvSvPR(gI1,gO2,gI2)*
      CpChiFeconjSePL(gI1,gO1,gI4)*CpChiFvconjSvPL(gI3,gO3,gI2)*D27(Sqr(MChi(gI1))
      ,Sqr(MSv(gI2)),Sqr(MChi(gI3)),Sqr(MSe(gI4))))))) + SUM(gI1,0,3,SUM(gI2,0,2,
      SUM(gI3,0,3,SUM(gI4,0,5,0.5*CpbarChibarFvSvPR(gI3,gO2,gI2)*
      CpbarChiFeconjSePL(gI1,gO1,gI4)*CpbarFeChiSePR(gO4,gI3,gI4)*CpChiFvconjSvPL(
      gI1,gO3,gI2)*D0(Sqr(MChi(gI1)),Sqr(MSv(gI2)),Sqr(MChi(gI3)),Sqr(MSe(gI4)))*
      MChi(gI1)*MChi(gI3))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,2,SUM(gI4,0,3,
      0.5*CpbarCha1barFeSvPR(gI2,gO4,gI3)*CpbarChiFeconjSePL(gI4,gO1,gI1)*
      CpbarFvCha1SePR(gO2,gI2,gI1)*CpChiFvconjSvPL(gI4,gO3,gI3)*D0(Sqr(MSe(gI1)),
      Sqr(MCha1(gI2)),Sqr(MSv(gI3)),Sqr(MChi(gI4)))*MCha1(gI2)*MChi(gI4))))) + SUM
      (gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,5,SUM(gI4,0,3,CpbarCha1FvconjSePL(gI2,gO3,gI3
      )*CpbarChiFeconjSePL(gI4,gO1,gI1)*CpbarFeChiSePR(gO4,gI4,gI3)*
      CpbarFvCha1SePR(gO2,gI2,gI1)*D27(Sqr(MSe(gI1)),Sqr(MCha1(gI2)),Sqr(MSe(gI3))
      ,Sqr(MChi(gI4))))))) + SUM(gI1,0,5,SUM(gI2,0,1,SUM(gI3,0,5,SUM(gI4,0,3,
      CpbarCha1FvconjSePL(gI2,gO3,gI3)*CpbarChibarFeSePR(gI4,gO4,gI3)*
      CpbarFvCha1SePR(gO2,gI2,gI1)*CpChiFeconjSePL(gI4,gO1,gI1)*D27(Sqr(MSe(gI1)),
      Sqr(MCha1(gI2)),Sqr(MSe(gI3)),Sqr(MChi(gI4))))))) + SUM(gI1,0,5,SUM(gI2,0,1,
      SUM(gI3,0,5,SUM(gI4,0,3,CpbarCha2barFvSePR(gI2,gO2,gI1)*CpbarChiFeconjSePL(
      gI4,gO1,gI1)*CpbarFeChiSePR(gO4,gI4,gI3)*CpCha2FvconjSePL(gI2,gO3,gI3)*D27(
      Sqr(MSe(gI1)),Sqr(MCha2(gI2)),Sqr(MSe(gI3)),Sqr(MChi(gI4))))))) + SUM(gI1,0,
      5,SUM(gI2,0,1,SUM(gI3,0,5,SUM(gI4,0,3,CpbarCha2barFvSePR(gI2,gO2,gI1)*
      CpbarChibarFeSePR(gI4,gO4,gI3)*CpCha2FvconjSePL(gI2,gO3,gI3)*CpChiFeconjSePL
      (gI4,gO1,gI1)*D27(Sqr(MSe(gI1)),Sqr(MCha2(gI2)),Sqr(MSe(gI3)),Sqr(MChi(gI4))
      ))))) + SUM(gI1,1,3,SUM(gI2,0,2,SUM(gI3,1,3,SUM(gI4,0,2,-(CpbarFeFvHpmPL(gI2
      ,gO3,gI1)*CpbarFeFvHpmPR(gO4,gI4,gI3)*CpbarFvFeconjHpmPL(gI4,gO1,gI1)*
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * MRSSM2_info::normalization_g3 /
...
double CLASSNAME::calculate_delta_alpha_hat_bsm(double alpha_em) const
{
   ...
   delta_alpha_hat_bsm += alpha_em/(2.*Pi)*(0.3333333333333333 -
      0.3333333333333333*FiniteLog(Abs(MSRdp/currentScale)) - 0.3333333333333333*
      FiniteLog(Abs(MSRum/currentScale)) - 1.3333333333333333*FiniteLog(Abs(MCha1(
      0)/currentScale)) - 1.3333333333333333*FiniteLog(Abs(MCha1(1)/currentScale))
