...
#ifndef MRSSM2_SLHA_IO_H
#define MRSSM2_SLHA_IO_H
...
public:
   ...
   void fill(MRSSM2_input_parameters&) const;
   void fill(MRSSM2_mass_eigenstates&) const;
   void fill(MRSSM2_slha&) const;
   ...
   void set_decays(const MRSSM2_decay_table&, FlexibleDecay_settings const&);
   void set_extra(const MRSSM2_slha&, const MRSSM2_scales&, const MRSSM2_observables&, const flexiblesusy::Spectrum_generator_settings&);
   void set_input(const MRSSM2_input_parameters&);
   ...
   void set_spectrum(const MRSSM2_slha&);
   ...
   static void fill_minpar_tuple(MRSSM2_input_parameters&, int, double);
   static void fill_extpar_tuple(MRSSM2_input_parameters&, int, double);
   static void fill_imminpar_tuple(MRSSM2_input_parameters&, int, double);
   static void fill_imextpar_tuple(MRSSM2_input_parameters&, int, double);

   void fill_decays_data(const MRSSM2_decays&, FlexibleDecay_settings const&);
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MRSSM2_scales&, const MRSSM2_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MRSSM2_decays const * const = nullptr);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MRSSM2_input_parameters&);
   void set_imminpar(const MRSSM2_input_parameters&);
   void set_imextpar(const MRSSM2_input_parameters&);
   void set_minpar(const MRSSM2_input_parameters&);
   void set_mass(const MRSSM2_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const MRSSM2_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   void set_model_parameters(const MRSSM2_slha&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MRSSM2_mass_eigenstates&) const;
   void fill_physical(MRSSM2_physical&) const;
};
...
void MRSSM2_slha_io::fill(
   ...
   MRSSM2_decays const * const decays)
{
 ...
 */
template <class... Ts>
void MRSSM2_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
