...
#ifndef MRSSM2_WEINBERG_ANGLE_H
#define MRSSM2_WEINBERG_ANGLE_H
...
public:
   ...
   MRSSM2_weinberg_angle(const MRSSM2_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MRSSM2_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MRSSM2_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
