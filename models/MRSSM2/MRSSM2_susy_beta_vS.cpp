 ...
 */
double MRSSM2_susy_parameters::calc_beta_vS_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSM2_susy_parameters::calc_beta_vS_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSM2_susy_parameters::calc_beta_vS_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MRSSM2_susy_parameters::calc_beta_vS_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double MRSSM2_susy_parameters::calc_beta_vS_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
