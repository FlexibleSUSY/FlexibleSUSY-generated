...
/**
 * @file MRSSM2_mass_eigenstates.cpp
...
#include "MRSSM2_ewsb_solver_interface.hpp"
#include "config.h"
...
#include "MRSSM2_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME MRSSM2_mass_eigenstates
...
CLASSNAME::CLASSNAME(const MRSSM2_input_parameters& input_)
   ...
   , ewsb_solver(new MRSSM2_ewsb_solver<Two_scale>())
#endif
{
}
...
{
   return std::make_unique<MRSSM2_mass_eigenstates>(*this);
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MRSSM2_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving MRSSM2 EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   MRSSM2_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::VG);
}
...
void CLASSNAME::calculate_MGlu_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Glu);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Glu);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Fv);
}

void CLASSNAME::calculate_MSRdp_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::SRdp))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::SRdp);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::SRdp);
}

void CLASSNAME::calculate_MSRum_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::SRum))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::SRum);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::SRum);
}

void CLASSNAME::calculate_MsigmaO_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::sigmaO))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::sigmaO);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::sigmaO);
}

void CLASSNAME::calculate_MphiO_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::phiO))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::phiO);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::phiO);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::VP);
}

void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::VZ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.) {
         problems.flag_pole_tachyon(MRSSM2_info::VZ);
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::VZ);
}

void CLASSNAME::calculate_MSd_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Sd))
      return;
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZD;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZD,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Sd, eigenvalue_error >
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Sd);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Sd);
}

void CLASSNAME::calculate_MSv_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Sv))
      return;
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZV;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Sv, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Sv);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Sv);
}

void CLASSNAME::calculate_MSu_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Su))
      return;
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZU;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Su, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Su);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Su);
}

void CLASSNAME::calculate_MSe_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Se))
      return;
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZE;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Se, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Se);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Se);
}

void CLASSNAME::calculate_Mhh_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::hh))
      return;
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         Eigen::Matrix<double,4,4> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::hh, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Ah))
      return;
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         Eigen::Matrix<double,4,4> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Ah);
}

void CLASSNAME::calculate_MRh_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Rh))
      return;
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZHR;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZHR,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Rh, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Rh);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Rh);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::Hpm))
      return;
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         Eigen::Matrix<double,4,4> mix_ZP;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZP,
               eigenvalue_error);
            problems.flag_bad_mass(MRSSM2_info::Hpm, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Hpm);
}
...
void CLASSNAME::calculate_MChi_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         problems.flag_bad_mass(MRSSM2_info::Chi, eigenvalue_error > precision
            * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Chi);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Chi);
}
...
void CLASSNAME::calculate_MCha1_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         problems.flag_bad_mass(MRSSM2_info::Cha1, eigenvalue_error > precision
             * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Cha1);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Cha1);
}
...
void CLASSNAME::calculate_MCha2_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         problems.flag_bad_mass(MRSSM2_info::Cha2, eigenvalue_error > precision
             * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Cha2);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Cha2);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(MRSSM2_info::Fe, eigenvalue_error > precision *
            Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Fe);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(MRSSM2_info::Fd, eigenvalue_error > precision *
            Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(MRSSM2_info::Fu, eigenvalue_error > precision *
            Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::Fu);
}

void CLASSNAME::calculate_MVWm_pole()
{
   if (!force_output && problems.is_running_tachyon(MRSSM2_info::VWm))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.) {
         problems.flag_pole_tachyon(MRSSM2_info::VWm);
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MRSSM2_info::VWm);
   else
      problems.unflag_no_pole_mass_convergence(MRSSM2_info::VWm);
}
...
double CLASSNAME::calculate_MVZ_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MRSSM2_info::VZ);return m_pole;
   }
...
double CLASSNAME::calculate_MVWm_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(MRSSM2_info::VWm);return m_pole;
   }
