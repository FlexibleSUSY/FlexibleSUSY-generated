 ...
 * to be complex.
 */
void MRSSM2_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void MRSSM2_physical::convert_to_slha()
{

}

Eigen::ArrayXd MRSSM2_physical::get() const
{
...
void MRSSM2_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MRSSM2_physical::get_masses() const
{
...
void MRSSM2_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void MRSSM2_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MRSSM2_physical& phys_pars)
{
