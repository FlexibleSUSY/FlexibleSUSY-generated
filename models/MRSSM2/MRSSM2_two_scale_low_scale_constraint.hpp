...
#ifndef MRSSM2_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MRSSM2_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MRSSM2_low_scale_constraint.hpp"
...
template<>
class MRSSM2_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MRSSM2_low_scale_constraint() = default;
   MRSSM2_low_scale_constraint(MRSSM2<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MRSSM2_low_scale_constraint() = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MRSSM2 low-scale constraint"; }
