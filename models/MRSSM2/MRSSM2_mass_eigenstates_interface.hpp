...
/**
 * @file MRSSM2_mass_eigenstates_interface.hpp
 *
...
#ifndef MRSSM2_MASS_EIGENSTATES_INTERFACE_H
#define MRSSM2_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MRSSM2_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MRSSM2_mass_eigenstates_interface {
public:
   virtual ~MRSSM2_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MRSSM2_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MRSSM2_input_parameters& get_input_parameters() const = 0;
   virtual MRSSM2_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MRSSM2_physical& get_physical() const = 0;
   virtual MRSSM2_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MRSSM2_physical&) = 0;
