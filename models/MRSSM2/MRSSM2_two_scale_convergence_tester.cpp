...
MRSSM2_convergence_tester<Two_scale>::MRSSM2_convergence_tester(
   MRSSM2<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MRSSM2<Two_scale> >(model, accuracy_goal, sg)
{
}

double MRSSM2_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MRSSM2<Two_scale>& ol = get_last_iteration_model();
   const MRSSM2<Two_scale>& ne = get_current_iteration_model();
