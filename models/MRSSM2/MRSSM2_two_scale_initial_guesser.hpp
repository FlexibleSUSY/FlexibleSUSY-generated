...
#ifndef MRSSM2_TWO_SCALE_INITIAL_GUESSER_H
#define MRSSM2_TWO_SCALE_INITIAL_GUESSER_H

#include "MRSSM2_initial_guesser.hpp"
...
/**
 * @class MRSSM2_initial_guesser<Two_scale>
 * @brief initial guesser for the MRSSM2
 */

template<>
class MRSSM2_initial_guesser<Two_scale> : public Initial_guesser {
public:
   MRSSM2_initial_guesser(MRSSM2<Two_scale>*,
                               const softsusy::QedQcd&,
                               const MRSSM2_low_scale_constraint<Two_scale>&,
                               const MRSSM2_susy_scale_constraint<Two_scale>&);
   virtual ~MRSSM2_initial_guesser() = default;
   virtual void guess() override; ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   MRSSM2<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   MRSSM2_low_scale_constraint<Two_scale> low_constraint{};
   MRSSM2_susy_scale_constraint<Two_scale> susy_constraint{};
