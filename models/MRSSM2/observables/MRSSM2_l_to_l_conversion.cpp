...
/**
 * @file MRSSM2_l_to_l_conversion.cpp
 *
 * This file was generated at Sun 25 Feb 2024 20:36:18 with FlexibleSUSY
...
#include "MRSSM2_l_to_l_conversion.hpp"
...
class nPointFeFuFeFu_3917882177239549 : public correlation_function_context<4,0>
{
   ...
   std::array<std::complex<double>,10> genericSum5( void ) {
      ...
      using GenericInsertions = boost::mpl::vector<
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Chi>::type, typename cxx_diagrams::bar<fields::Chi>::type, fields::Se, fields::Su>,
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Chi>::type, fields::Chi, fields::Se, fields::Su>,
         boost::mpl::vector<fields::Chi, typename cxx_diagrams::bar<fields::Chi>::type, fields::Se, fields::Su>,
         boost::mpl::vector<fields::Chi, fields::Chi, fields::Se, fields::Su>,
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Cha1>::type, fields::Cha1, fields::Sv, fields::Sd>
         >;
      using combinatorial_factors = boost::mpl::vector<
         boost::mpl::int_<1>,
         boost::mpl::int_<1>,
   ...
   public:
   nPointFeFuFeFu_3917882177239549( const MRSSM2_mass_eigenstates &model,
...
}; // End of nPointFeFuFeFu_3917882177239549

std::array<std::complex<double>, 10> conversion_FeFu_to_FeFu_All1loop(const MRSSM2_mass_eigenstates &model,
const std::array<int, 4> &indices,
const std::array<Eigen::Vector4d, 0> &momenta
) {
   nPointFeFuFeFu_3917882177239549 helper{model, indices, momenta};
   return helper.calculate();
}

class nPointFeFdFeFd_3917882177854720 : public correlation_function_context<4,0>
{
   using generic_sum_base = correlation_function_context<4,0>;
   ...
   std::array<std::complex<double>,10> genericSum5( void ) {
      using GenericKeys = boost::mpl::vector< GenericF5Key, GenericF8Key, GenericS6Key, GenericS7Key >;
      using GenericInsertions = boost::mpl::vector<
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Chi>::type, typename cxx_diagrams::bar<fields::Chi>::type, fields::Se, fields::Sd>,
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Chi>::type, fields::Chi, fields::Se, fields::Sd>,
         boost::mpl::vector<fields::Chi, typename cxx_diagrams::bar<fields::Chi>::type, fields::Se, fields::Sd>,
   ...
   std::array<std::complex<double>,10> genericSum7( void ) {
      using GenericKeys = boost::mpl::vector< GenericF6Key, GenericF7Key, GenericS5Key, GenericS8Key >;
      using GenericInsertions = boost::mpl::vector<
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Cha1>::type, typename cxx_diagrams::bar<fields::Cha1>::type, fields::Sv, fields::Su>,
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Chi>::type, typename cxx_diagrams::bar<fields::Chi>::type, fields::Se, fields::Sd>,
         boost::mpl::vector<typename cxx_diagrams::bar<fields::Chi>::type, fields::Chi, fields::Se, fields::Sd>,
         boost::mpl::vector<fields::Chi, typename cxx_diagrams::bar<fields::Chi>::type, fields::Se, fields::Sd>,
         boost::mpl::vector<fields::Chi, fields::Chi, fields::Se, fields::Sd>
   ...
   public:
   nPointFeFdFeFd_3917882177854720( const MRSSM2_mass_eigenstates &model,
   const std::array<int, 4> &indices,
   const std::array<Eigen::Vector4d, 0> &momenta
    ) :
   correlation_function_context<4,0> { model, indices, momenta }
...
}; // End of nPointFeFdFeFd_3917882177854720

std::array<std::complex<double>, 10> conversion_FeFd_to_FeFd_All1loop(const MRSSM2_mass_eigenstates &model,
const std::array<int, 4> &indices,
const std::array<Eigen::Vector4d, 0> &momenta
) {
   nPointFeFdFeFd_3917882177854720 helper{model, indices, momenta};
   return helper.calculate();
}
...
void run_to_MSUSY(MRSSM2_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("MRSSM2_l_to_l_conversion: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("MRSSM2_l_to_l_conversion:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("MRSSM2_l_to_l_conversion: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("MRSSM2_l_to_l_conversion: run_to_MSUSY(): "
...
typedef std::array<std::complex<double>, 10> (*npf_function)
   (const MRSSM2_mass_eigenstates&, const std::array<int,4>&, const std::array<Eigen::Vector4d,0>&);
...
std::complex<double> left(const MRSSM2_mass_eigenstates& model, int g) {
 ...
 */
template <class Q, class A>
std::complex<double> right(const MRSSM2_mass_eigenstates& model, int g) {
    context_base context {model};
    using vertex = Vertex<typename Q::lorentz_conjugate, Q, A>;
    std::array<int, 2> indices {g, g};
    const auto value =  vertex::evaluate(indices, context);
...
Eigen::Array<std::complex<double>,10,1> fix_tensors_sign(
   const MRSSM2_mass_eigenstates& model, int in, int out, int g) {
 ...
 *       for photon, as in MRSSM2, using eq. (t.3).
 ...
 *          <out:q4,l3| T exp(i L_MRSSM2 dx) |in:q2,l1> =: G4
...
Eigen::Array<std::complex<double>, 13, 1> forge_conversion(int in, int out,
   const MRSSM2_l_to_l_conversion::Nucleus nucleus,
   ...
   try {
      ...
      ERROR("MRSSM2_l_to_l_conversion:" << e.what_detailed());
...
Eigen::Array<std::complex<double>,13,1> calculate_FeFe_forAll_1loop(int in, int out, const MRSSM2_l_to_l_conversion::Nucleus n, const MRSSM2_mass_eigenstates& model, const LToLConversion_settings& parameters, const softsusy::QedQcd& qedqcd) {
