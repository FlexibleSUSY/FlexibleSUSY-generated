...
#ifndef MRSSM2_EFFECTIVE_COUPLINGS_H
#define MRSSM2_EFFECTIVE_COUPLINGS_H
...
class MRSSM2_effective_couplings {
public:
   MRSSM2_effective_couplings(const MRSSM2_mass_eigenstates&,
   ...
   void set_model(const MRSSM2_mass_eigenstates& model_);
