 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHu2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHu2 = Re(0.2*(3.872983346207417*g1*Tr11 + 30*traceconjTYuTpTYu + 30*
      tracemq2AdjYuYu + 30*tracemu2YuAdjYu + 30*mHu2*traceYuAdjYu + 10*mHd2*
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHu2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHu2 = Re(0.04*(77.45966692414834*g1*Tr31 - 150*tracemd2YdAdjYuYuAdjYd
      ...
      traceconjTYdTpTYd*AbsSqr(Lambdax) - 50*traceconjTYeTpTYe*AbsSqr(Lambdax)
      - 150*tracemd2YdAdjYd*AbsSqr(Lambdax) - 50*traceme2YeAdjYe*AbsSqr(Lambdax
      ) - 50*traceml2AdjYeYe*AbsSqr(Lambdax) - 150*tracemq2AdjYdYd*AbsSqr(
      Lambdax) - 300*mHd2*traceYdAdjYd*AbsSqr(Lambdax) - 150*mHu2*traceYdAdjYd*
      AbsSqr(Lambdax) - 150*ms2*traceYdAdjYd*AbsSqr(Lambdax) - 100*mHd2*
      traceYeAdjYe*AbsSqr(Lambdax) - 50*mHu2*traceYeAdjYe*AbsSqr(Lambdax) - 50*
      ms2*traceYeAdjYe*AbsSqr(Lambdax) - 100*mHd2*AbsSqr(Kappa)*AbsSqr(Lambdax)
      - 100*mHu2*AbsSqr(Kappa)*AbsSqr(Lambdax) - 400*ms2*AbsSqr(Kappa)*AbsSqr(
      Lambdax) - 100*AbsSqr(Lambdax)*AbsSqr(TKappa) - 150*traceYdAdjYd*AbsSqr(
      TLambdax) - 50*traceYeAdjYe*AbsSqr(TLambdax) - 100*AbsSqr(Kappa)*AbsSqr(
      TLambdax) - 600*AbsSqr(Lambdax)*AbsSqr(TLambdax) - 150*traceAdjYdTYd*Conj
      (TLambdax)*Lambdax - 50*traceAdjYeTYe*Conj(TLambdax)*Lambdax + 621*AbsSqr
      (MassB)*Quad(g1) + 150*Tr22*Quad(g2) + 825*AbsSqr(MassWB)*Quad(g2) + 30*
      Tr2U111*Sqr(g1) + 40*traceconjTYuTpTYu*Sqr(g1) - 40*MassB*
      ...
      *traceconjTYuTpTYu*Sqr(g3) - 800*MassG*traceconjTYuTpYu*Sqr(g3) + 800*
      ...
      traceAdjYuTYu*Conj(MassG)*Sqr(g3) - 300*mHd2*Sqr(Conj(Lambdax))*Sqr(
      Lambdax) - 300*mHu2*Sqr(Conj(Lambdax))*Sqr(Lambdax) - 300*ms2*Sqr(Conj(
      Lambdax))*Sqr(Lambdax) - 100*Conj(Kappa)*Conj(TLambdax)*Lambdax*TKappa -
      150*traceconjTYdTpYd*Conj(Lambdax)*TLambdax - 50*traceconjTYeTpYe*Conj(
      Lambdax)*TLambdax - 100*Conj(Lambdax)*Conj(TKappa)*Kappa*TLambdax));
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHu2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHu2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHu2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
