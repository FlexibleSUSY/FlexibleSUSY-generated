...
// File generated at Mon 5 Mar 2018 18:17:28
...
#define CLASSNAME lowNMSSMTanBetaAtMZ_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int lowNMSSMTanBetaAtMZ_susy_parameters::numberOfParameters;

lowNMSSMTanBetaAtMZ_susy_parameters::lowNMSSMTanBetaAtMZ_susy_parameters(const lowNMSSMTanBetaAtMZ_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

lowNMSSMTanBetaAtMZ_susy_parameters::lowNMSSMTanBetaAtMZ_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const lowNMSSMTanBetaAtMZ_input_parameters& input_
...
Eigen::ArrayXd lowNMSSMTanBetaAtMZ_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

lowNMSSMTanBetaAtMZ_susy_parameters lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta(int loops) const
{
   ...
   return lowNMSSMTanBetaAtMZ_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_Yd, beta_Ye, beta_Lambdax, beta_Kappa, beta_Yu, beta_g1, beta_g2, beta_g3, beta_vd, beta_vu, beta_vS);
}

lowNMSSMTanBetaAtMZ_susy_parameters lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void lowNMSSMTanBetaAtMZ_susy_parameters::clear()
{
   reset();
...
Eigen::Matrix<double,3,3> CLASSNAME::get_SlSl() const
{
   ...
   if (get_loops() > 1) {
      anomDim += (twoLoop*(-2*(Ye.adjoint()*Ye*Ye.adjoint()*Ye) +
         ...
         .trace() - (Ye*Ye.adjoint()).trace()) + 0.03*(69*Quad(g1) + 125*Quad(
         g2) + 30*Sqr(g1)*Sqr(g2))*UNITMATRIX(3))).real();
   }
...
double CLASSNAME::get_SHdSHd() const
{
   ...
   if (get_loops() > 1) {
      anomDim += Re(twoLoop*(-2*AbsSqr(Kappa)*AbsSqr(Lambdax) + 2.07*
         Quad(g1) + 3.75*Quad(g2) + 0.9*Sqr(g1)*Sqr(g2) - 3*Sqr(Conj(Lambdax))*
         Sqr(Lambdax) - 0.4*Sqr(g1)*(Yd*Yd.adjoint()).trace() + 16*Sqr(g3)*(Yd*
         Yd.adjoint()).trace() + 1.2*Sqr(g1)*(Ye*Ye.adjoint()).trace() - 3*
         AbsSqr(Lambdax)*(Yu*Yu.adjoint()).trace() - 9*(Yd*Yd.adjoint()*Yd*
...
double CLASSNAME::get_SHuSHu() const
{
   ...
   anomDim = Re(oneOver16PiSqr*(AbsSqr(Lambdax) - 0.3*(Sqr(g1) + 5*Sqr(g2
      ) - 10*(Yu*Yu.adjoint()).trace())));

   if (get_loops() > 1) {
      anomDim += Re(twoLoop*(-2*AbsSqr(Kappa)*AbsSqr(Lambdax) + 2.07*
         Quad(g1) + 3.75*Quad(g2) + 0.9*Sqr(g1)*Sqr(g2) - 3*Sqr(Conj(Lambdax))*
         Sqr(Lambdax) - AbsSqr(Lambdax)*(3*(Yd*Yd.adjoint()).trace() + (Ye*
         Ye.adjoint()).trace()) + 0.8*Sqr(g1)*(Yu*Yu.adjoint()).trace() + 16*
         Sqr(g3)*(Yu*Yu.adjoint()).trace() - 3*(Yd*Yu.adjoint()*Yu*Yd.adjoint()
         ).trace() - 9*(Yu*Yu.adjoint()*Yu*Yu.adjoint()).trace()));
   }
...
double CLASSNAME::get_SsRSsR() const
{
   ...
   if (get_loops() > 1) {
      anomDim += Re(twoLoop*(-8*AbsSqr(Kappa)*AbsSqr(Lambdax) - 8*Sqr(
...
Eigen::ArrayXd lowNMSSMTanBetaAtMZ_susy_parameters::get() const
{
...
void lowNMSSMTanBetaAtMZ_susy_parameters::print(std::ostream& ostr) const
{
...
void lowNMSSMTanBetaAtMZ_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
const lowNMSSMTanBetaAtMZ_input_parameters& lowNMSSMTanBetaAtMZ_susy_parameters::get_input() const
{
   return input;
}

lowNMSSMTanBetaAtMZ_input_parameters& lowNMSSMTanBetaAtMZ_susy_parameters::get_input()
{
   return input;
}

void lowNMSSMTanBetaAtMZ_susy_parameters::set_input_parameters(const lowNMSSMTanBetaAtMZ_input_parameters& input_)
{
   input = input_;
}

lowNMSSMTanBetaAtMZ_susy_parameters::Susy_traces lowNMSSMTanBetaAtMZ_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowNMSSMTanBetaAtMZ_susy_parameters& susy_pars)
{
