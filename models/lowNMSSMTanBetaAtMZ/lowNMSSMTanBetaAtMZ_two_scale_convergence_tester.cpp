...
lowNMSSMTanBetaAtMZ_convergence_tester<Two_scale>::lowNMSSMTanBetaAtMZ_convergence_tester(
   lowNMSSMTanBetaAtMZ<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<lowNMSSMTanBetaAtMZ<Two_scale> >(model, accuracy_goal, sg)
{
}

double lowNMSSMTanBetaAtMZ_convergence_tester<Two_scale>::max_rel_diff() const
{
   const lowNMSSMTanBetaAtMZ<Two_scale>& ol = get_last_iteration_model();
   const lowNMSSMTanBetaAtMZ<Two_scale>& ne = get_current_iteration_model();
