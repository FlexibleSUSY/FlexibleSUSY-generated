...
#ifndef lowNMSSMTanBetaAtMZ_EFFECTIVE_COUPLINGS_H
#define lowNMSSMTanBetaAtMZ_EFFECTIVE_COUPLINGS_H
...
class lowNMSSMTanBetaAtMZ_effective_couplings {
public:
   lowNMSSMTanBetaAtMZ_effective_couplings(const lowNMSSMTanBetaAtMZ_mass_eigenstates&,
   ...
   void set_model(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model_);
