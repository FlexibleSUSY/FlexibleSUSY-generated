...
// File generated at Mon 5 Mar 2018 18:17:47
...
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mq2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_mq2_1 = (UNITMATRIX(3)*(0.4*
      ...
      *(9*(2*MassB + MassWB)*Sqr(g2) + 16*(2*MassB + MassG)*Sqr(g3))) + 10*(3*(
      7.745966692414834*g1*Tr31 + 45*Tr22*Quad(g2) + 80*Tr23*Quad(g3) + Tr2U111
      *Sqr(g1)) + 8*Conj(MassG)*Sqr(g3)*((MassB + 2*MassG)*Sqr(g1) + 15*(3*(2*
      MassG + MassWB)*Sqr(g2) - 8*MassG*Sqr(g3)))))*UNITMATRIX(3))).real();
