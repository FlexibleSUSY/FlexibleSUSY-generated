...
#ifndef lowNMSSMTanBetaAtMZ_DECAY_TABLE_H
#define lowNMSSMTanBetaAtMZ_DECAY_TABLE_H
...
class lowNMSSMTanBetaAtMZ_decay_table {
private:
...
public:
   ...
   lowNMSSMTanBetaAtMZ_decay_table();
   ~lowNMSSMTanBetaAtMZ_decay_table() = default;
   lowNMSSMTanBetaAtMZ_decay_table(const lowNMSSMTanBetaAtMZ_decay_table&) = default;
   lowNMSSMTanBetaAtMZ_decay_table(lowNMSSMTanBetaAtMZ_decay_table&&) = default;
   lowNMSSMTanBetaAtMZ_decay_table& operator=(const lowNMSSMTanBetaAtMZ_decay_table&) = default;
   lowNMSSMTanBetaAtMZ_decay_table& operator=(lowNMSSMTanBetaAtMZ_decay_table&&) = default;
...
std::ostream& operator<<(std::ostream&, const lowNMSSMTanBetaAtMZ_decay_table&);
