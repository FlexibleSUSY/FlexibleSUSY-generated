 ...
 */
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (-0.06666666666666667*Yu*(-45*traceYuAdjYu - 15*AbsSqr(Lambdax) +
      13*Sqr(g1) + 45*Sqr(g2) + 80*Sqr(g3)) + Yu*Yd.adjoint()*Yd + 3*(Yu*Yu.
      adjoint()*Yu)).real();
 ...
 */
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yu = (0.0022222222222222222*Yu*(-1350*traceYdAdjYuYuAdjYd - 4050*
      traceYuAdjYuYuAdjYu - 1350*traceYdAdjYd*AbsSqr(Lambdax) - 450*
 ...
 */
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta_Yu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
