...
/**
 * @file lowNMSSMTanBetaAtMZ_edm.cpp
 *
...
double calculate_edm(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model, const softsusy::QedQcd& qedqcd, int idx)
{
