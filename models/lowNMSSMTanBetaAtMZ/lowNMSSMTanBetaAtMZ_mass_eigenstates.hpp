...
/**
 * @file lowNMSSMTanBetaAtMZ_mass_eigenstates.hpp
 *
...
#ifndef lowNMSSMTanBetaAtMZ_MASS_EIGENSTATES_H
#define lowNMSSMTanBetaAtMZ_MASS_EIGENSTATES_H
...
#include "lowNMSSMTanBetaAtMZ_mass_eigenstates_interface.hpp"
...
#define SUPER(p) lowNMSSMTanBetaAtMZ_soft_parameters::p

namespace flexiblesusy {

class lowNMSSMTanBetaAtMZ_ewsb_solver_interface;
/**
 * @class lowNMSSMTanBetaAtMZ_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class lowNMSSMTanBetaAtMZ_mass_eigenstates
   : public lowNMSSMTanBetaAtMZ_soft_parameters
   , public lowNMSSMTanBetaAtMZ_mass_eigenstates_interface
{
public:
   explicit lowNMSSMTanBetaAtMZ_mass_eigenstates(const lowNMSSMTanBetaAtMZ_input_parameters& input_ = lowNMSSMTanBetaAtMZ_input_parameters());
   lowNMSSMTanBetaAtMZ_mass_eigenstates(const lowNMSSMTanBetaAtMZ_mass_eigenstates&) = default;
   lowNMSSMTanBetaAtMZ_mass_eigenstates(lowNMSSMTanBetaAtMZ_mass_eigenstates&&) = default;
   virtual ~lowNMSSMTanBetaAtMZ_mass_eigenstates() = default;
   lowNMSSMTanBetaAtMZ_mass_eigenstates& operator=(const lowNMSSMTanBetaAtMZ_mass_eigenstates&) = default;
   lowNMSSMTanBetaAtMZ_mass_eigenstates& operator=(lowNMSSMTanBetaAtMZ_mass_eigenstates&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<lowNMSSMTanBetaAtMZ_mass_eigenstates_interface> clone() const override;
   ...
   void set_ewsb_solver(const std::shared_ptr<lowNMSSMTanBetaAtMZ_ewsb_solver_interface>&);
   ...
   const lowNMSSMTanBetaAtMZ_input_parameters& get_input_parameters() const override;
   lowNMSSMTanBetaAtMZ_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const lowNMSSMTanBetaAtMZ_physical& get_physical() const override;
   lowNMSSMTanBetaAtMZ_physical& get_physical() override;
   ...
   void set_physical(const lowNMSSMTanBetaAtMZ_physical&) override;
   void clear_problems() override;

   double get_lsp(lowNMSSMTanBetaAtMZ_info::Particles&) const;
...
private:
   ...
   lowNMSSMTanBetaAtMZ_physical physical{}; ///< contains the pole masses and mixings
   mutable Problems problems{lowNMSSMTanBetaAtMZ_info::model_name,
                             &lowNMSSMTanBetaAtMZ_info::particle_names_getter,
                             &lowNMSSMTanBetaAtMZ_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<lowNMSSMTanBetaAtMZ_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const lowNMSSMTanBetaAtMZ_mass_eigenstates&);
