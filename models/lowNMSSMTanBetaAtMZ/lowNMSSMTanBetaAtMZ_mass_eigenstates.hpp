 ...
 */
class lowNMSSMTanBetaAtMZ_mass_eigenstates : public lowNMSSMTanBetaAtMZ_soft_parameters {
public:
   ...
   void set_physical(const lowNMSSMTanBetaAtMZ_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const lowNMSSMTanBetaAtMZ_physical& get_physical() const;
   lowNMSSMTanBetaAtMZ_physical& get_physical();
