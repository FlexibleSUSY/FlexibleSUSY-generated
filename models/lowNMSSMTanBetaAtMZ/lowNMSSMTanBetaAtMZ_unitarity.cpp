...
/**
 * @file lowNMSSMTanBetaAtMZ_unitarity.cpp
 *
...
#include "cxx_qft/lowNMSSMTanBetaAtMZ_fields.hpp"
...
// s -> infinity limit
UnitarityInfiniteS
max_scattering_eigenvalue_infinite_s(lowNMSSMTanBetaAtMZ_mass_eigenstates const& model) {
