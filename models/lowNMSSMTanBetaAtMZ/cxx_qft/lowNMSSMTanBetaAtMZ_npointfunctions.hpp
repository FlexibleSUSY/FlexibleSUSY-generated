...
// File generated at Tue 22 Jan 2019 17:12:57

/**
 * @file cxx_qft/lowNMSSMTanBetaAtMZ_npointfunctions.hpp
 *
 * This file was generated at Tue 22 Jan 2019 17:12:57 with FlexibleSUSY
 * 2.3.0 and SARAH 4.14.1 .
 */

#ifndef lowNMSSMTanBetaAtMZ_CXXQFT_NPOINTFUNCTIONS_H
#define lowNMSSMTanBetaAtMZ_CXXQFT_NPOINTFUNCTIONS_H

#include "lowNMSSMTanBetaAtMZ_qft.hpp"
...
namespace detail
{
  ...
  public:
    template<class ...Args>
    accumulate_generic_impl( std::complex<double> &v,
        Args && ...args )
    ...
    void operator()( InsertionData )
    {
      ...
      value += combinatorial_factor * boost::fusion::fused<
        boost::value_factory<F<GenericFieldMap>>
      >{}( state )();
    }
  };
  ...
  > make_accumulate_generic_impl( std::complex<double> &v,
      Args &&... args )
  {
...
{
  const std::array<int,
    NumberOfExternalIndices> &ext_indices;
  const std::array<Eigen::Vector4d,
    NumberOfExternalMomenta> &ext_momenta;

public:
  correlation_function_context(
    lowNMSSMTanBetaAtMZ_mass_eigenstates &m,
  ...
  int external_indices( int index ) const
  { return ext_indices.at( index ); }
