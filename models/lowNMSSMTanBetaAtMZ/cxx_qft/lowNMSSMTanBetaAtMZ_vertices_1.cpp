...
/**
 * @file cxx_qft/lowNMSSMTanBetaAtMZ_vertices.cpp
 *
 * This file was generated with FlexibleSUSY 2.7.1 and SARAH 4.14.5 .
 */

#include "lowNMSSMTanBetaAtMZ_context_base.hpp"
#include "lowNMSSMTanBetaAtMZ_input_parameters.hpp"
#include "lowNMSSMTanBetaAtMZ_vertices.hpp"
...
namespace lowNMSSMTanBetaAtMZ_cxx_diagrams {
namespace detail {
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZA(gt1,0)*(ZA(gt2,0)*(3*(0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,0)*ZA(gt4,0) - (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,1)*ZA(gt4,1) + 4*AbsSqr(Lambdax)*ZA(gt3,2)*ZA(gt4,2)) - ZA(gt2,1)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,1)*ZA(gt4,0) + (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,0)*ZA(gt4,1) + 2*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*ZA(gt3,2)*ZA(gt4,2)) + 2*ZA(gt2,2)*(-(Conj(Kappa)*Lambdax*(ZA(gt3,2)*ZA(gt4,1) + ZA(gt3,1)*ZA(gt4,2))) + Conj(Lambdax)*(ZA(gt3,2)*(2*Lambdax*ZA(gt4,0) - Kappa*ZA(gt4,1)) + (2*Lambdax*ZA(gt3,0) - Kappa*ZA(gt3,1))*ZA(gt4,2))))) + ZA(gt1,1)*(ZA(gt2,1)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,0)*ZA(gt4,0) - 3*(0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,1)*ZA(gt4,1) - 4*AbsSqr(Lambdax)*ZA(gt3,2)*ZA(gt4,2)) + ZA(gt2,0)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,1)*ZA(gt4,0) + (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZA(gt3,0)*ZA(gt4,1) + 2*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*ZA(gt3,2)*ZA(gt4,2)) + 2*ZA(gt2,2)*(Conj(Kappa)*Lambdax*(ZA(gt3,2)*ZA(gt4,0) + ZA(gt3,0)*ZA(gt4,2)) + Conj(Lambdax)*(ZA(gt3,2)*(Kappa*ZA(gt4,0) - 2*Lambdax*ZA(gt4,1)) + (Kappa*ZA(gt3,0) - 2*Lambdax*ZA(gt3,1))*ZA(gt4,2)))) - 2*ZA(gt1,2)*(Conj(Lambdax)*(ZA(gt2,2)*(ZA(gt3,0)*(2*Lambdax*ZA(gt4,0) - Kappa*ZA(gt4,1)) + ZA(gt3,1)*(-(Kappa*ZA(gt4,0)) + 2*Lambdax*ZA(gt4,1))) + ZA(gt2,0)*(ZA(gt3,2)*(2*Lambdax*ZA(gt4,0) - Kappa*ZA(gt4,1)) + (2*Lambdax*ZA(gt3,0) - Kappa*ZA(gt3,1))*ZA(gt4,2)) - ZA(gt2,1)*(ZA(gt3,2)*(Kappa*ZA(gt4,0) - 2*Lambdax*ZA(gt4,1)) + (Kappa*ZA(gt3,0) - 2*Lambdax*ZA(gt3,1))*ZA(gt4,2))) - Conj(Kappa)*(Lambdax*ZA(gt2,1)*(ZA(gt3,2)*ZA(gt4,0) + ZA(gt3,0)*ZA(gt4,2)) + Lambdax*ZA(gt2,0)*(ZA(gt3,2)*ZA(gt4,1) + ZA(gt3,1)*ZA(gt4,2)) + ZA(gt2,2)*(Lambdax*ZA(gt3,1)*ZA(gt4,0) + Lambdax*ZA(gt3,0)*ZA(gt4,1) - 12*Kappa*ZA(gt3,2)*ZA(gt4,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(-(Conj(Lambdax)*Kappa) + Conj(Kappa)*Lambdax)*(ZA(gt1,1)*(ZA(gt2,0)*ZA(gt3,2)*ZH(gt4,2) + ZA(gt2,2)*(-(ZA(gt3,2)*ZH(gt4,0)) + ZA(gt3,0)*ZH(gt4,2))) - ZA(gt1,2)*(ZA(gt2,2)*(ZA(gt3,1)*ZH(gt4,0) + ZA(gt3,0)*ZH(gt4,1)) + ZA(gt2,1)*(ZA(gt3,2)*ZH(gt4,0) - ZA(gt3,0)*ZH(gt4,2)) + ZA(gt2,0)*(ZA(gt3,2)*ZH(gt4,1) - ZA(gt3,1)*ZH(gt4,2))) + ZA(gt1,0)*(ZA(gt2,1)*ZA(gt3,2)*ZH(gt4,2) + ZA(gt2,2)*(-(ZA(gt3,2)*ZH(gt4,1)) + ZA(gt3,1)*ZH(gt4,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*(-2*Conj(Lambdax)*Kappa*(ZA(gt1,1)*(vS*ZA(gt2,0)*ZA(gt3,2) + ZA(gt2,2)*(vS*ZA(gt3,0) - vd*ZA(gt3,2))) + ZA(gt1,0)*(vS*ZA(gt2,1)*ZA(gt3,2) + ZA(gt2,2)*(vS*ZA(gt3,1) - vu*ZA(gt3,2))) - ZA(gt1,2)*(ZA(gt2,2)*(vu*ZA(gt3,0) + vd*ZA(gt3,1)) + ZA(gt2,1)*(-(vS*ZA(gt3,0)) + vd*ZA(gt3,2)) + ZA(gt2,0)*(-(vS*ZA(gt3,1)) + vu*ZA(gt3,2)))) + 2*Conj(Kappa)*Lambdax*(ZA(gt1,1)*(vS*ZA(gt2,0)*ZA(gt3,2) + ZA(gt2,2)*(vS*ZA(gt3,0) - vd*ZA(gt3,2))) + ZA(gt1,0)*(vS*ZA(gt2,1)*ZA(gt3,2) + ZA(gt2,2)*(vS*ZA(gt3,1) - vu*ZA(gt3,2))) - ZA(gt1,2)*(ZA(gt2,2)*(vu*ZA(gt3,0) + vd*ZA(gt3,1)) + ZA(gt2,1)*(-(vS*ZA(gt3,0)) + vd*ZA(gt3,2)) + ZA(gt2,0)*(-(vS*ZA(gt3,1)) + vu*ZA(gt3,2)))) + 1.4142135623730951*(2*(-Conj(TKappa) + TKappa)*ZA(gt1,2)*ZA(gt2,2)*ZA(gt3,2) + Conj(TLambdax)*(ZA(gt1,2)*(ZA(gt2,1)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,1)) + ZA(gt1,1)*(ZA(gt2,2)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,2)) + ZA(gt1,0)*(ZA(gt2,2)*ZA(gt3,1) + ZA(gt2,1)*ZA(gt3,2))) - TLambdax*(ZA(gt1,2)*(ZA(gt2,1)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,1)) + ZA(gt1,1)*(ZA(gt2,2)*ZA(gt3,0) + ZA(gt2,0)*ZA(gt3,2)) + ZA(gt1,0)*(ZA(gt2,2)*ZA(gt3,1) + ZA(gt2,1)*ZA(gt3,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(ZA(gt1,1)*(ZA(gt2,1)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - (0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) - 4*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2)) + 2*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*(-(ZA(gt2,0)*ZH(gt3,2)*ZH(gt4,2)) + ZA(gt2,2)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)))) + ZA(gt1,0)*(-(ZA(gt2,0)*((0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) + 4*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2))) + 2*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*(-(ZA(gt2,1)*ZH(gt3,2)*ZH(gt4,2)) + ZA(gt2,2)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2)))) + 2*ZA(gt1,2)*(Conj(Kappa)*(Lambdax*ZA(gt2,1)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + Lambdax*ZA(gt2,0)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2)) - ZA(gt2,2)*(Lambdax*ZH(gt3,1)*ZH(gt4,0) + Lambdax*ZH(gt3,0)*ZH(gt4,1) + 4*Kappa*ZH(gt3,2)*ZH(gt4,2))) + Conj(Lambdax)*(-(ZA(gt2,2)*(ZH(gt3,0)*(2*Lambdax*ZH(gt4,0) + Kappa*ZH(gt4,1)) + ZH(gt3,1)*(Kappa*ZH(gt4,0) + 2*Lambdax*ZH(gt4,1)))) + Kappa*(ZA(gt2,1)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + ZA(gt2,0)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2))))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(5*ZA(gt1,2)*(-1.4142135623730951*(Conj(TLambdax)*(ZA(gt2,1)*ZH(gt3,0) + ZA(gt2,0)*ZH(gt3,1)) + TLambdax*(ZA(gt2,1)*ZH(gt3,0) + ZA(gt2,0)*ZH(gt3,1)) - 2*(Conj(TKappa) + TKappa)*ZA(gt2,2)*ZH(gt3,2)) + 2*Conj(Lambdax)*(-(ZA(gt2,2)*((vu*Kappa + 2*vd*Lambdax)*ZH(gt3,0) + (vd*Kappa + 2*vu*Lambdax)*ZH(gt3,1))) + Kappa*ZA(gt2,1)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)) + Kappa*ZA(gt2,0)*(vS*ZH(gt3,1) + vu*ZH(gt3,2))) + 2*Conj(Kappa)*(Lambdax*ZA(gt2,1)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)) + Lambdax*ZA(gt2,0)*(vS*ZH(gt3,1) + vu*ZH(gt3,2)) - ZA(gt2,2)*(vu*Lambdax*ZH(gt3,0) + vd*Lambdax*ZH(gt3,1) + 4*vS*Kappa*ZH(gt3,2)))) + ZA(gt1,1)*(ZA(gt2,1)*(vd*(-20*AbsSqr(Lambdax) + 3*Sqr(g1) + 5*Sqr(g2))*ZH(gt3,0) - vu*(3*Sqr(g1) + 5*Sqr(g2))*ZH(gt3,1) - 20*vS*AbsSqr(Lambdax)*ZH(gt3,2)) + 5*(-1.4142135623730951*(Conj(TLambdax) + TLambdax)*(ZA(gt2,2)*ZH(gt3,0) + ZA(gt2,0)*ZH(gt3,2)) + 2*Conj(Lambdax)*Kappa*(-(vS*ZA(gt2,0)*ZH(gt3,2)) + ZA(gt2,2)*(vS*ZH(gt3,0) + vd*ZH(gt3,2))) + 2*Conj(Kappa)*Lambdax*(-(vS*ZA(gt2,0)*ZH(gt3,2)) + ZA(gt2,2)*(vS*ZH(gt3,0) + vd*ZH(gt3,2))))) - ZA(gt1,0)*(ZA(gt2,0)*(vd*(3*Sqr(g1) + 5*Sqr(g2))*ZH(gt3,0) + vu*(20*AbsSqr(Lambdax) - 3*Sqr(g1) - 5*Sqr(g2))*ZH(gt3,1) + 20*vS*AbsSqr(Lambdax)*ZH(gt3,2)) + 5*(1.4142135623730951*(Conj(TLambdax) + TLambdax)*(ZA(gt2,2)*ZH(gt3,1) + ZA(gt2,1)*ZH(gt3,2)) - 2*Conj(Lambdax)*Kappa*(-(vS*ZA(gt2,1)*ZH(gt3,2)) + ZA(gt2,2)*(vS*ZH(gt3,1) + vu*ZH(gt3,2))) - 2*Conj(Kappa)*Lambdax*(-(vS*ZA(gt2,1)*ZH(gt3,2)) + ZA(gt2,2)*(vS*ZH(gt3,1) + vu*ZH(gt3,2))))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZA(gt1,0)*(-((-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1))) + ZA(gt2,0)*((0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1)))) - ZA(gt1,1)*(-((-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1))) + ZA(gt2,1)*((-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1))) - 4*ZA(gt1,2)*ZA(gt2,2)*(-(Conj(Kappa)*Lambdax*ZP(gt3,0)*ZP(gt4,1)) + Conj(Lambdax)*(Lambdax*ZP(gt3,0)*ZP(gt4,0) + ZP(gt3,1)*(-(Kappa*ZP(gt4,0)) + Lambdax*ZP(gt4,1)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gt3,j1))*ZD(gt4,j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) + 2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gt3,3 + j1))*ZD(gt4,3 + j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) - 10*(2*SUM(j3,0,2,Conj(ZD(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*ZA(gt1,0)*ZA(gt2,0) + 2*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZA(gt1,0)*ZA(gt2,0) + (Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt3,3 + j1)))*ZD(gt4,j2)))*(ZA(gt1,2)*ZA(gt2,1) + ZA(gt1,1)*ZA(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(-((3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gt3,j1))*ZE(gt4,j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1))) + 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt3,3 + j1))*ZE(gt4,3 + j1))*(ZA(gt1,0)*ZA(gt2,0) - ZA(gt1,1)*ZA(gt2,1)) - 10*(2*SUM(j3,0,2,Conj(ZE(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt4,3 + j2)))*ZA(gt1,0)*ZA(gt2,0) + 2*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZA(gt1,0)*ZA(gt2,0) + (Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt3,3 + j1)))*ZE(gt4,j2)))*(ZA(gt1,2)*ZA(gt2,1) + ZA(gt1,1)*ZA(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.5)*(-(Conj(Lambdax)*Kappa) + Conj(Kappa)*Lambdax)*(ZA(gt1,1)*(ZH(gt2,0)*ZH(gt3,2)*ZH(gt4,2) + ZH(gt2,2)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2))) - ZA(gt1,2)*(ZH(gt2,2)*(ZH(gt3,1)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,1)) + ZH(gt2,1)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + ZH(gt2,0)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2))) + ZA(gt1,0)*(ZH(gt2,1)*ZH(gt3,2)*ZH(gt4,2) + ZH(gt2,2)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,0.25)*(2*Conj(Lambdax)*Kappa*(-(ZA(gt1,1)*(vS*ZH(gt2,0)*ZH(gt3,2) + ZH(gt2,2)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)))) + ZA(gt1,2)*(ZH(gt2,2)*(vu*ZH(gt3,0) + vd*ZH(gt3,1)) + ZH(gt2,1)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)) + ZH(gt2,0)*(vS*ZH(gt3,1) + vu*ZH(gt3,2))) - ZA(gt1,0)*(vS*ZH(gt2,1)*ZH(gt3,2) + ZH(gt2,2)*(vS*ZH(gt3,1) + vu*ZH(gt3,2)))) - 2*Conj(Kappa)*Lambdax*(-(ZA(gt1,1)*(vS*ZH(gt2,0)*ZH(gt3,2) + ZH(gt2,2)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)))) + ZA(gt1,2)*(ZH(gt2,2)*(vu*ZH(gt3,0) + vd*ZH(gt3,1)) + ZH(gt2,1)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)) + ZH(gt2,0)*(vS*ZH(gt3,1) + vu*ZH(gt3,2))) - ZA(gt1,0)*(vS*ZH(gt2,1)*ZH(gt3,2) + ZH(gt2,2)*(vS*ZH(gt3,1) + vu*ZH(gt3,2)))) + 1.4142135623730951*(2*(Conj(TKappa) - TKappa)*ZA(gt1,2)*ZH(gt2,2)*ZH(gt3,2) - Conj(TLambdax)*(ZA(gt1,2)*(ZH(gt2,1)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,1)) + ZA(gt1,1)*(ZH(gt2,2)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,2)) + ZA(gt1,0)*(ZH(gt2,2)*ZH(gt3,1) + ZH(gt2,1)*ZH(gt3,2))) + TLambdax*(ZA(gt1,2)*(ZH(gt2,1)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,1)) + ZA(gt1,1)*(ZH(gt2,2)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,2)) + ZA(gt1,0)*(ZH(gt2,2)*ZH(gt3,1) + ZH(gt2,1)*ZH(gt3,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gt1,1)*ZH(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) - ZP(gt3,0)*ZP(gt4,1)) + (-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gt1,0)*ZH(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) - ZP(gt3,0)*ZP(gt4,1)) + 4*ZA(gt1,2)*ZH(gt2,2)*(Conj(Lambdax)*Kappa*ZP(gt3,1)*ZP(gt4,0) - Conj(Kappa)*Lambdax*ZP(gt3,0)*ZP(gt4,1)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt3,3 + j1)))*ZD(gt4,j2)))*(ZA(gt1,2)*ZH(gt2,1) + ZA(gt1,1)*ZH(gt2,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt3,3 + j1)))*ZE(gt4,j2)))*(ZA(gt1,2)*ZH(gt2,1) + ZA(gt1,1)*ZH(gt2,2));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZU(gt4,j2)))*(ZA(gt1,2)*ZH(gt2,0) + ZA(gt1,0)*ZH(gt2,2));
   ...
   const std::array<int, 2>& indices, const context_base& context)
{
   ...
   const int gt945 = indices[0];
   const int gt946 = indices[1];
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,0.35355339059327373)*(Sqr(g2)*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZD(gt4,j1))*(ZA(gt1,0)*ZP(gt2,0) - ZA(gt1,1)*ZP(gt2,1)) + 2*(-(SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZA(gt1,0)*ZP(gt2,0)) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZD(gt4,j2))*ZA(gt1,2)*ZP(gt2,0) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gt4,j3))*ZA(gt1,1)*ZP(gt2,1) - Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZA(gt1,2)*ZP(gt2,1) + SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*(-(ZA(gt1,1)*ZP(gt2,0)) + ZA(gt1,0)*ZP(gt2,1))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(Sqr(g2)*SUM(j1,0,2,Conj(ZV(gt3,j1))*ZE(gt4,j1))*(-(ZA(gt1,0)*ZP(gt2,0)) + ZA(gt1,1)*ZP(gt2,1)) + 2*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZA(gt1,0)*ZP(gt2,0) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1)))*ZA(gt1,2)*ZP(gt2,1)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*(vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gt1,0)*(ZP(gt2,1)*ZP(gt3,0) - ZP(gt2,0)*ZP(gt3,1)) + vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZA(gt1,1)*(ZP(gt2,1)*ZP(gt3,0) - ZP(gt2,0)*ZP(gt3,1)) + 2*ZA(gt1,2)*(-1.4142135623730951*Conj(TLambdax)*ZP(gt2,1)*ZP(gt3,0) + 2*vS*Conj(Lambdax)*Kappa*ZP(gt2,1)*ZP(gt3,0) + (-2*vS*Conj(Kappa)*Lambdax + 1.4142135623730951*TLambdax)*ZP(gt2,0)*ZP(gt3,1)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(Sqr(g2)*SUM(j1,0,2,Conj(ZD(gt2,j1))*ZU(gt4,j1))*(ZA(gt1,0)*ZP(gt3,0) - ZA(gt1,1)*ZP(gt3,1)) + 2*(-(SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gt4,j3))*ZA(gt1,0)*ZP(gt3,0)) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZA(gt1,2)*ZP(gt3,0) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3))*ZA(gt1,1)*ZP(gt3,1) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZU(gt4,j2))*ZA(gt1,2)*ZP(gt3,1) + SUM(j3,0,2,Conj(ZD(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2)))*(-(ZA(gt1,1)*ZP(gt3,0)) + ZA(gt1,0)*ZP(gt3,1))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(1.4142135623730951*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,ZD(gt3,3 + j1)*TYd(j1,j2)))*ZA(gt1,0) - 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gt2,3 + j1))*Conj(TYd(j1,j2)))*ZD(gt3,j2))*ZA(gt1,0) + (Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2)))*(vS*ZA(gt1,1) + vu*ZA(gt1,2)));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0.,-0.35355339059327373)*(Sqr(g2)*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZV(gt4,j1))*(ZA(gt1,0)*ZP(gt3,0) - ZA(gt1,1)*ZP(gt3,1)) - 2*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gt4,j3))*ZA(gt1,0)*ZP(gt3,0) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZV(gt4,j2))*ZA(gt1,2)*ZP(gt3,1)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(1.4142135623730951*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 + j1)*TYe(j1,j2)))*ZA(gt1,0) - 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gt3,j2))*ZA(gt1,0) + (Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1))) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2)))*(vS*ZA(gt1,1) + vu*ZA(gt1,2)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(1.4142135623730951*(SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZU(gt3,3 + j1)*TYu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gt3,j2)))*ZA(gt1,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*(vS*ZA(gt1,0) + vd*ZA(gt1,2)) - Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*(vS*ZA(gt1,0) + vd*ZA(gt1,2)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = std::complex<double>(0,0.1)*(5*g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,2))*ZA(gt3,0) + 7.0710678118654755*Conj(ZN(gt1,4))*Conj(ZN(gt2,3))*Lambdax*ZA(gt3,0) + 7.0710678118654755*Conj(ZN(gt1,3))*Conj(ZN(gt2,4))*Lambdax*ZA(gt3,0) + 3.872983346207417*g1*Conj(ZN(gt1,3))*Conj(ZN(gt2,0))*ZA(gt3,1) - 5*g2*Conj(ZN(gt1,3))*Conj(ZN(gt2,1))*ZA(gt3,1) - 5*g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,3))*ZA(gt3,1) + 7.0710678118654755*Conj(ZN(gt1,4))*Conj(ZN(gt2,2))*Lambdax*ZA(gt3,1) + 3.872983346207417*g1*Conj(ZN(gt1,0))*(-(Conj(ZN(gt2,2))*ZA(gt3,0)) + Conj(ZN(gt2,3))*ZA(gt3,1)) - 14.142135623730951*Conj(ZN(gt1,4))*Conj(ZN(gt2,4))*Kappa*ZA(gt3,2) + 7.0710678118654755*Conj(ZN(gt1,3))*Conj(ZN(gt2,2))*Lambdax*ZA(gt3,2) + Conj(ZN(gt1,2))*(-3.872983346207417*g1*Conj(ZN(gt2,0))*ZA(gt3,0) + 5*g2*Conj(ZN(gt2,1))*ZA(gt3,0) + 7.0710678118654755*Lambdax*(Conj(ZN(gt2,4))*ZA(gt3,1) + Conj(ZN(gt2,3))*ZA(gt3,2))));

   const std::complex<double> right = std::complex<double>(0,-0.1)*(7.0710678118654755*ZA(gt3,2)*(Conj(Lambdax)*(ZN(gt1,3)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,3)) - 2*Conj(Kappa)*ZN(gt1,4)*ZN(gt2,4)) + ZA(gt3,1)*(ZN(gt1,3)*(3.872983346207417*g1*ZN(gt2,0) - 5*g2*ZN(gt2,1)) + (3.872983346207417*g1*ZN(gt1,0) - 5*g2*ZN(gt1,1))*ZN(gt2,3) + 7.0710678118654755*Conj(Lambdax)*(ZN(gt1,4)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,4))) + ZA(gt3,0)*(ZN(gt1,2)*(-3.872983346207417*g1*ZN(gt2,0) + 5*g2*ZN(gt2,1)) - 3.872983346207417*g1*ZN(gt1,0)*ZN(gt2,2) + 5*g2*ZN(gt1,1)*ZN(gt2,2) + 7.0710678118654755*Conj(Lambdax)*(ZN(gt1,4)*ZN(gt2,3) + ZN(gt1,3)*ZN(gt2,4))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> left = 0.5*(-(g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,2))*ZH(gt3,0)) + 1.4142135623730951*Conj(ZN(gt1,4))*Conj(ZN(gt2,3))*Lambdax*ZH(gt3,0) + 1.4142135623730951*Conj(ZN(gt1,3))*Conj(ZN(gt2,4))*Lambdax*ZH(gt3,0) - 0.7745966692414834*g1*Conj(ZN(gt1,3))*Conj(ZN(gt2,0))*ZH(gt3,1) + g2*Conj(ZN(gt1,3))*Conj(ZN(gt2,1))*ZH(gt3,1) + g2*Conj(ZN(gt1,1))*Conj(ZN(gt2,3))*ZH(gt3,1) + 1.4142135623730951*Conj(ZN(gt1,4))*Conj(ZN(gt2,2))*Lambdax*ZH(gt3,1) + 0.7745966692414834*g1*Conj(ZN(gt1,0))*(Conj(ZN(gt2,2))*ZH(gt3,0) - Conj(ZN(gt2,3))*ZH(gt3,1)) - 2.8284271247461903*Conj(ZN(gt1,4))*Conj(ZN(gt2,4))*Kappa*ZH(gt3,2) + 1.4142135623730951*Conj(ZN(gt1,3))*Conj(ZN(gt2,2))*Lambdax*ZH(gt3,2) + Conj(ZN(gt1,2))*(0.7745966692414834*g1*Conj(ZN(gt2,0))*ZH(gt3,0) - g2*Conj(ZN(gt2,1))*ZH(gt3,0) + 1.4142135623730951*Lambdax*(Conj(ZN(gt2,4))*ZH(gt3,1) + Conj(ZN(gt2,3))*ZH(gt3,2))));

   const std::complex<double> right = 0.5*(ZH(gt3,0)*(ZN(gt1,2)*(0.7745966692414834*g1*ZN(gt2,0) - g2*ZN(gt2,1)) + 0.7745966692414834*g1*ZN(gt1,0)*ZN(gt2,2) - g2*ZN(gt1,1)*ZN(gt2,2) + 1.4142135623730951*Conj(Lambdax)*ZN(gt1,4)*ZN(gt2,3) + 1.4142135623730951*Conj(Lambdax)*ZN(gt1,3)*ZN(gt2,4)) + 1.4142135623730951*ZH(gt3,2)*(Conj(Lambdax)*(ZN(gt1,3)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,3)) - 2*Conj(Kappa)*ZN(gt1,4)*ZN(gt2,4)) + ZH(gt3,1)*(ZN(gt1,3)*(-0.7745966692414834*g1*ZN(gt2,0) + g2*ZN(gt2,1)) + (-0.7745966692414834*g1*ZN(gt1,0) + g2*ZN(gt1,1))*ZN(gt2,3) + 1.4142135623730951*Conj(Lambdax)*(ZN(gt1,4)*ZN(gt2,2) + ZN(gt1,2)*ZN(gt2,4))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZH(gt2,0)*(3*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) + 4*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2)) - ZH(gt2,1)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,0) + (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,1) + 2*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*ZH(gt3,2)*ZH(gt4,2)) + 2*ZH(gt2,2)*(-(Conj(Kappa)*Lambdax*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2))) + Conj(Lambdax)*(ZH(gt3,2)*(2*Lambdax*ZH(gt4,0) - Kappa*ZH(gt4,1)) + (2*Lambdax*ZH(gt3,0) - Kappa*ZH(gt3,1))*ZH(gt4,2))))) + ZH(gt1,1)*(ZH(gt2,1)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,0) - 3*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,1) - 4*AbsSqr(Lambdax)*ZH(gt3,2)*ZH(gt4,2)) + ZH(gt2,0)*((-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1)*ZH(gt4,0) + (-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0)*ZH(gt4,1) + 2*(Conj(Lambdax)*Kappa + Conj(Kappa)*Lambdax)*ZH(gt3,2)*ZH(gt4,2)) + 2*ZH(gt2,2)*(Conj(Kappa)*Lambdax*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + Conj(Lambdax)*(ZH(gt3,2)*(Kappa*ZH(gt4,0) - 2*Lambdax*ZH(gt4,1)) + (Kappa*ZH(gt3,0) - 2*Lambdax*ZH(gt3,1))*ZH(gt4,2)))) - 2*ZH(gt1,2)*(Conj(Lambdax)*(ZH(gt2,2)*(ZH(gt3,0)*(2*Lambdax*ZH(gt4,0) - Kappa*ZH(gt4,1)) + ZH(gt3,1)*(-(Kappa*ZH(gt4,0)) + 2*Lambdax*ZH(gt4,1))) + ZH(gt2,0)*(ZH(gt3,2)*(2*Lambdax*ZH(gt4,0) - Kappa*ZH(gt4,1)) + (2*Lambdax*ZH(gt3,0) - Kappa*ZH(gt3,1))*ZH(gt4,2)) - ZH(gt2,1)*(ZH(gt3,2)*(Kappa*ZH(gt4,0) - 2*Lambdax*ZH(gt4,1)) + (Kappa*ZH(gt3,0) - 2*Lambdax*ZH(gt3,1))*ZH(gt4,2))) - Conj(Kappa)*(Lambdax*ZH(gt2,1)*(ZH(gt3,2)*ZH(gt4,0) + ZH(gt3,0)*ZH(gt4,2)) + Lambdax*ZH(gt2,0)*(ZH(gt3,2)*ZH(gt4,1) + ZH(gt3,1)*ZH(gt4,2)) + ZH(gt2,2)*(Lambdax*ZH(gt3,1)*ZH(gt4,0) + Lambdax*ZH(gt3,0)*ZH(gt4,1) - 12*Kappa*ZH(gt3,2)*ZH(gt4,2)))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZH(gt2,0)*(3*vd*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) - vu*(-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) + 4*vS*AbsSqr(Lambdax)*ZH(gt3,2)) - ZH(gt2,1)*(vu*(-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) + vd*(-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) + (2*vS*Conj(Lambdax)*Kappa + 2*vS*Conj(Kappa)*Lambdax + 1.4142135623730951*(Conj(TLambdax) + TLambdax))*ZH(gt3,2)) - ZH(gt2,2)*(1.4142135623730951*(Conj(TLambdax) + TLambdax)*ZH(gt3,1) + 2*Conj(Kappa)*Lambdax*(vS*ZH(gt3,1) + vu*ZH(gt3,2)) + 2*Conj(Lambdax)*(-2*vS*Lambdax*ZH(gt3,0) + vS*Kappa*ZH(gt3,1) + (vu*Kappa - 2*vd*Lambdax)*ZH(gt3,2))))) + ZH(gt1,1)*(ZH(gt2,1)*(vd*(-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) - 3*vu*(0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) - 4*vS*AbsSqr(Lambdax)*ZH(gt3,2)) + ZH(gt2,0)*(vu*(-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,0) + vd*(-4*AbsSqr(Lambdax) + 0.6*Sqr(g1) + Sqr(g2))*ZH(gt3,1) + (2*vS*Conj(Lambdax)*Kappa + 2*vS*Conj(Kappa)*Lambdax + 1.4142135623730951*(Conj(TLambdax) + TLambdax))*ZH(gt3,2)) + ZH(gt2,2)*(1.4142135623730951*(Conj(TLambdax) + TLambdax)*ZH(gt3,0) + 2*Conj(Kappa)*Lambdax*(vS*ZH(gt3,0) + vd*ZH(gt3,2)) + 2*Conj(Lambdax)*(vS*Kappa*ZH(gt3,0) - 2*vS*Lambdax*ZH(gt3,1) + (vd*Kappa - 2*vu*Lambdax)*ZH(gt3,2)))) + ZH(gt1,2)*(1.4142135623730951*(Conj(TLambdax)*(ZH(gt2,1)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,1)) + TLambdax*(ZH(gt2,1)*ZH(gt3,0) + ZH(gt2,0)*ZH(gt3,1)) - 2*(Conj(TKappa) + TKappa)*ZH(gt2,2)*ZH(gt3,2)) + 2*Conj(Kappa)*(Lambdax*ZH(gt2,1)*(vS*ZH(gt3,0) + vd*ZH(gt3,2)) + Lambdax*ZH(gt2,0)*(vS*ZH(gt3,1) + vu*ZH(gt3,2)) + ZH(gt2,2)*(vu*Lambdax*ZH(gt3,0) + vd*Lambdax*ZH(gt3,1) - 12*vS*Kappa*ZH(gt3,2))) + 2*Conj(Lambdax)*(ZH(gt2,2)*((vu*Kappa - 2*vd*Lambdax)*ZH(gt3,0) + (vd*Kappa - 2*vu*Lambdax)*ZH(gt3,1)) + ZH(gt2,0)*(-2*vS*Lambdax*ZH(gt3,0) + vS*Kappa*ZH(gt3,1) + (vu*Kappa - 2*vd*Lambdax)*ZH(gt3,2)) + ZH(gt2,1)*(vS*Kappa*ZH(gt3,0) - 2*vS*Lambdax*ZH(gt3,1) + (vd*Kappa - 2*vu*Lambdax)*ZH(gt3,2)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,1)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) + ZH(gt2,0)*((0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1)))) - ZH(gt1,1)*((-2*AbsSqr(Lambdax) + Sqr(g2))*ZH(gt2,0)*(ZP(gt3,1)*ZP(gt4,0) + ZP(gt3,0)*ZP(gt4,1)) + ZH(gt2,1)*((-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0)*ZP(gt4,0) + (0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)*ZP(gt4,1))) - 4*ZH(gt1,2)*ZH(gt2,2)*(Conj(Kappa)*Lambdax*ZP(gt3,0)*ZP(gt4,1) + Conj(Lambdax)*(Lambdax*ZP(gt3,0)*ZP(gt4,0) + ZP(gt3,1)*(Kappa*ZP(gt4,0) + Lambdax*ZP(gt4,1)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj(ZD(gt3,j1))*ZD(gt4,j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 2*Sqr(g1)*SUM(j1,0,2,Conj(ZD(gt3,3 + j1))*ZD(gt4,3 + j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 10*(-2*SUM(j3,0,2,Conj(ZD(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*ZH(gt1,0)*ZH(gt2,0) - 2*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZH(gt1,0)*ZH(gt2,0) + (Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt3,3 + j1)))*ZD(gt4,j2)))*(ZH(gt1,2)*ZH(gt2,1) + ZH(gt1,1)*ZH(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*(-((3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gt3,j1))*ZE(gt4,j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1))) + 6*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt3,3 + j1))*ZE(gt4,3 + j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 10*(-2*SUM(j3,0,2,Conj(ZE(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt4,3 + j2)))*ZH(gt1,0)*ZH(gt2,0) - 2*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZH(gt1,0)*ZH(gt2,0) + (Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1))) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt3,3 + j1)))*ZE(gt4,j2)))*(ZH(gt1,2)*ZH(gt2,1) + ZH(gt1,1)*ZH(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZU(gt4,j1))*(ZH(gt1,0)*ZH(gt2,0) - ZH(gt1,1)*ZH(gt2,1)) + 4*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gt3,3 + j1))*ZU(gt4,3 + j1))*(-(ZH(gt1,0)*ZH(gt2,0)) + ZH(gt1,1)*ZH(gt2,1)) + 10*(-2*(SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3)))*ZH(gt1,1)*ZH(gt2,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*(ZH(gt1,2)*ZH(gt2,0) + ZH(gt1,0)*ZH(gt2,2)) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZU(gt4,j2))*(ZH(gt1,2)*ZH(gt2,0) + ZH(gt1,0)*ZH(gt2,2))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.35355339059327373*(Sqr(g2)*SUM(j1,0,2,Conj(ZU(gt3,j1))*ZD(gt4,j1))*(ZH(gt1,0)*ZP(gt2,0) + ZH(gt1,1)*ZP(gt2,1)) - 2*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt4,j3))*ZH(gt1,0)*ZP(gt2,0) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt3,3 + j1)))*ZD(gt4,j2))*ZH(gt1,2)*ZP(gt2,0) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZD(gt4,j3))*ZH(gt1,1)*ZP(gt2,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt3,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt4,3 + j1)))*ZH(gt1,2)*ZP(gt2,1) + SUM(j3,0,2,Conj(ZU(gt3,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yd(j2,j1))*ZD(gt4,3 + j2)))*(ZH(gt1,1)*ZP(gt2,0) + ZH(gt1,0)*ZP(gt2,1))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.35355339059327373*(Sqr(g2)*SUM(j1,0,2,Conj(ZV(gt3,j1))*ZE(gt4,j1))*(ZH(gt1,0)*ZP(gt2,0) + ZH(gt1,1)*ZP(gt2,1)) - 2*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt4,j3))*ZH(gt1,0)*ZP(gt2,0) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt3,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt4,3 + j1)))*ZH(gt1,2)*ZP(gt2,1)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZP(gt2,0)*(vd*(0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0) + vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1)) + ZP(gt2,1)*(vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vd*(-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1)))) - ZH(gt1,1)*(ZP(gt2,0)*(vu*(-0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,0) + vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1)) + ZP(gt2,1)*(vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vu*(0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1))) - 2*ZH(gt1,2)*(1.4142135623730951*Conj(TLambdax)*ZP(gt2,1)*ZP(gt3,0) + (2*vS*Conj(Kappa)*Lambdax + 1.4142135623730951*TLambdax)*ZP(gt2,0)*ZP(gt3,1) + 2*vS*Conj(Lambdax)*(Lambdax*ZP(gt2,0)*ZP(gt3,0) + ZP(gt2,1)*(Kappa*ZP(gt3,0) + Lambdax*ZP(gt3,1)))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.35355339059327373*(Sqr(g2)*SUM(j1,0,2,Conj(ZD(gt2,j1))*ZU(gt4,j1))*(ZH(gt1,0)*ZP(gt3,0) + ZH(gt1,1)*ZP(gt3,1)) - 2*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yd(j1,j3))*Yd(j1,j2)))*ZU(gt4,j3))*ZH(gt1,0)*ZP(gt3,0) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt4,3 + j1)))*ZH(gt1,2)*ZP(gt3,0) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt4,j3))*ZH(gt1,1)*ZP(gt3,1) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZU(gt4,j2))*ZH(gt1,2)*ZP(gt3,1) + SUM(j3,0,2,Conj(ZD(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yu(j2,j1))*ZU(gt4,3 + j2)))*(ZH(gt1,1)*ZP(gt3,0) + ZH(gt1,0)*ZP(gt3,1))));
   ...
   const std::array<int, 4>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = -0.35355339059327373*(Sqr(g2)*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZV(gt4,j1))*(ZH(gt1,0)*ZP(gt3,0) + ZH(gt1,1)*ZP(gt3,1)) - 2*(SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gt4,j3))*ZH(gt1,0)*ZP(gt3,0) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZV(gt4,j2))*ZH(gt1,2)*ZP(gt3,1)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.25*(-0.2*(3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZE(gt2,j1))*ZE(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 1.2*Sqr(g1)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 2*(-1.4142135623730951*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 + j1)*TYe(j1,j2)))*ZH(gt1,0) - 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gt3,j2))*ZH(gt1,0) - 2*vd*SUM(j3,0,2,Conj(ZE(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*ZE(gt3,3 + j2)))*ZH(gt1,0) - 2*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt3,j3))*ZH(gt1,0) + vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,1) + vS*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,1) + vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,2) + vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,2)));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj(ZU(gt2,j1))*ZU(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) - 4*Sqr(g1)*SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 10*(-((1.4142135623730951*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZU(gt3,3 + j1)*TYu(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2)))*ZU(gt3,j2)) + 2*vu*(SUM(j3,0,2,Conj(ZU(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt3,3 + j2))) + SUM(j3,0,2,SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(gt3,j3))))*ZH(gt1,1)) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1,j2)*ZU(gt3,3 + j1)))*(vS*ZH(gt1,0) + vd*ZH(gt1,2)) + Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*(vS*ZH(gt1,0) + vd*ZH(gt1,2))));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 + j1)*TYe(j1,j2)))*ZP(gt1,0) - 0.35355339059327373*Sqr(g2)*SUM(j1,0,2,Conj(ZV(gt2,j1))*ZE(gt3,j1))*(vd*ZP(gt1,0) + vu*ZP(gt1,1)) + 0.7071067811865475*(vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt3,j3))*ZP(gt1,0) + vS*Conj(Lambdax)*SUM(j2,0,2,Conj(ZV(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZP(gt1,1));
   ...
   const std::array<int, 3>& indices, const context_base& context)
{
   ...
   const std::complex<double> result = SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt1,3 + j1))*Conj(TYe(j1,j2)))*ZV(gt3,j2))*ZP(gt2,0) - 0.35355339059327373*Sqr(g2)*SUM(j1,0,2,Conj(ZE(gt1,j1))*ZV(gt3,j1))*(vd*ZP(gt2,0) + vu*ZP(gt2,1)) + 0.7071067811865475*(vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt1,j2))*SUM(j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZV(gt3,j3))*ZP(gt2,0) + vS*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt1,3 + j1)))*ZV(gt3,j2))*ZP(gt2,1));
