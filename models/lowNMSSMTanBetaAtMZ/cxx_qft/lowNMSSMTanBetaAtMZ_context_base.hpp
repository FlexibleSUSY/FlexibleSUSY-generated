...
/**
 * @file cxx_qft/lowNMSSMTanBetaAtMZ_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.6.1 and SARAH 4.14.5 .
 */

#ifndef lowNMSSMTanBetaAtMZ_CXXQFT_CONTEXT_BASE_H
#define lowNMSSMTanBetaAtMZ_CXXQFT_CONTEXT_BASE_H

#include "lowNMSSMTanBetaAtMZ_fields.hpp"
...
namespace lowNMSSMTanBetaAtMZ_cxx_diagrams {
   ...
   struct context_base {
      lowNMSSMTanBetaAtMZ_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(lowNMSSMTanBetaAtMZ_mass_eigenstates_interface const& m) : model(m) {}
      context_base(lowNMSSMTanBetaAtMZ_mass_eigenstates_interface const* const m) : model(*m) {}
