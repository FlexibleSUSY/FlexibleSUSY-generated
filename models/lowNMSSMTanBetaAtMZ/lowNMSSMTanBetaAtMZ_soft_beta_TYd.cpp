...
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_TYd_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYd = (0.06666666666666667*(90*traceAdjYdTYd*Yd + 30*traceAdjYeTYe*Yd +
      ...
      traceYdAdjYd*TYd + 15*traceYeAdjYe*TYd + 15*AbsSqr(Lambdax)*TYd - 7*Sqr(
      g1)*TYd - 45*Sqr(g2)*TYd - 80*Sqr(g3)*TYd + 30*Yd*Conj(Lambdax)*TLambdax)
 ...
 */
Eigen::Matrix<double,3,3> lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_TYd_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
