...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,
      ...
      Conj(Yd(j1,j3))*Yd(j1,j2)))*ZD(gt3,j3))*ZH(gt1,0) - vS*Conj(Lambdax)*SUM(j2,
      0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZH(gt1,1) - vS*
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,
      Conj(ZU(gt2,j1))*ZU(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) - 2*(2*Sqr(g1)*
      SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)
      ) - 5*(-((1.4142135623730951*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZU(gt3,3
      ...
      )*SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j3,j1))*Yu(j2,j1))*ZU(gt3,3 + j2))) + SUM(j3
      ,0,2,SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Conj(Yu(j1,j3))*Yu(j1,j2)))*ZU(
      gt3,j3))))*ZH(gt1,1)) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2
      ,Yu(j1,j2)*ZU(gt3,3 + j1)))*(vS*ZH(gt1,0) + vd*ZH(gt1,2)) + Lambdax*SUM(j2,0
      ,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*(vS*ZH(gt1,0
      ) + vd*ZH(gt1,2)))));
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhSeconjSe(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.25*(-0.2*(3*Sqr(g1) - 5*Sqr(g2))*SUM(
      j1,0,2,Conj(ZE(gt2,j1))*ZE(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 1.2*Sqr(
      g1)*SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(
      gt1,1)) + 2*(-1.4142135623730951*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,ZE(
      gt3,3 + j1)*TYe(j1,j2)))*ZH(gt1,0) - 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,
      2,Conj(ZE(gt2,3 + j1))*Conj(TYe(j1,j2)))*ZE(gt3,j2))*ZH(gt1,0) - 2*vd*SUM(j3
      ,0,2,Conj(ZE(gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j3,j1))*Ye(j2,j1))*
      ZE(gt3,3 + j2)))*ZH(gt1,0) - 2*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM
      (j1,0,2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt3,j3))*ZH(gt1,0) + vS*Conj(Lambdax)
      *SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,1)
      + vS*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE
      (gt3,j2))*ZH(gt1,1) + vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,
      2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,2) + vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,
      Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,2)));
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZP(gt2,0)*(vd*(0.6*
      Sqr(g1) + Sqr(g2))*ZP(gt3,0) + vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1))
