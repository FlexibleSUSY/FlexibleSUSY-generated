...
// File generated at Wed 16 Oct 2019 22:10:53

#include "lowNMSSMTanBetaAtMZ_effective_couplings.hpp"
...
lowNMSSMTanBetaAtMZ_effective_couplings::lowNMSSMTanBetaAtMZ_effective_couplings(
   const lowNMSSMTanBetaAtMZ_mass_eigenstates& model_,
...
void lowNMSSMTanBetaAtMZ_effective_couplings::calculate_effective_couplings()
{
...
void lowNMSSMTanBetaAtMZ_effective_couplings::set_model(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void lowNMSSMTanBetaAtMZ_effective_couplings::copy_mixing_matrices_from_model()
{
...
standard_model::Standard_model lowNMSSMTanBetaAtMZ_effective_couplings::initialise_SM() const
{
...
void lowNMSSMTanBetaAtMZ_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double lowNMSSMTanBetaAtMZ_effective_couplings::number_of_active_flavours(double m) const
{
...
double lowNMSSMTanBetaAtMZ_effective_couplings::scalar_scaling_factor(double m) const
{
...
double lowNMSSMTanBetaAtMZ_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double lowNMSSMTanBetaAtMZ_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double lowNMSSMTanBetaAtMZ_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double lowNMSSMTanBetaAtMZ_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double lowNMSSMTanBetaAtMZ_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarFeFeAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarFeFehhPL(int gO2, int gI2, int gI1) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarFdFdAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarFdFdhhPL(int gO2, int gI2, int gI1) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarFuFuAhPL(int gO2, int gI1, int gI2) const
{
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarFuFuhhPL(int gO2, int gI2, int gI1) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) + 5*Sqr(g2))*SUM(j1,0,2,Conj
      ...
      (j1,j2)))*ZH(gt1,0) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gt2,3
       + j1))*Conj(TYd(j1,j2)))*ZD(gt3,j2))*ZH(gt1,0) + 2*vd*SUM(j3,0,2,Conj(ZD(
      gt2,3 + j3))*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j3,j1))*Yd(j2,j1))*ZD(gt3,3 + j2)
      ))*ZH(gt1,0) + 2*vd*SUM(j3,0,2,SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Conj(
      Yd(j1,j3))*Yd(j1,j2)))*ZD(gt3,j3))*ZH(gt1,0) - vS*Conj(Lambdax)*SUM(j2,0,2,
      Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1)))*ZH(gt1,1) - vS*
      Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,
      j2))*ZH(gt1,1) - vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(
      j1,j2)*ZD(gt3,3 + j1)))*ZH(gt1,2) - vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Yd
      (j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2))*ZH(gt1,2))));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.05*((Sqr(g1) - 5*Sqr(g2))*SUM(j1,0,2,Conj
      (ZU(gt2,j1))*ZU(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) - 2*(2*Sqr(g1)*SUM(j1
      ,0,2,Conj(ZU(gt2,3 + j1))*ZU(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) - 5*
      ...
      *TYu(j1,j2))) + 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1)
      ...
      ))))*ZH(gt1,1)) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,Yu(j1
      ,j2)*ZU(gt3,3 + j1)))*(vS*ZH(gt1,0) + vd*ZH(gt1,2)) + Lambdax*SUM(j2,0,2,SUM
      (j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*(vS*ZH(gt1,0) + vd
      *ZH(gt1,2)))));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhSeconjSe(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.25*(-0.2*(3*Sqr(g1) - 5*Sqr(g2))*SUM(j1,0
      ,2,Conj(ZE(gt2,j1))*ZE(gt3,j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)) + 1.2*Sqr(g1)*
      SUM(j1,0,2,Conj(ZE(gt2,3 + j1))*ZE(gt3,3 + j1))*(vd*ZH(gt1,0) - vu*ZH(gt1,1)
      ) + 2*(-1.4142135623730951*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,ZE(gt3,3 +
      ...
      2,Conj(Ye(j1,j3))*Ye(j1,j2)))*ZE(gt3,j3))*ZH(gt1,0) + vS*Conj(Lambdax)*SUM(
      j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,1) + vS
      *Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,
      j2))*ZH(gt1,1) + vu*Conj(Lambdax)*SUM(j2,0,2,Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(
      j1,j2)*ZE(gt3,3 + j1)))*ZH(gt1,2) + vu*Lambdax*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye
      (j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2))*ZH(gt1,2)));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   ...
   const std::complex<double> result = 0.25*(-(ZH(gt1,0)*(ZP(gt2,0)*(vd*(0.6*Sqr(
      g1) + Sqr(g2))*ZP(gt3,0) + vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1)) + ZP
      (gt2,1)*(vu*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vd*(-0.6*Sqr(g1) +
      Sqr(g2))*ZP(gt3,1)))) + ZH(gt1,1)*(ZP(gt2,0)*(vu*(0.6*Sqr(g1) - Sqr(g2))*ZP(
      gt3,0) - vd*(-2*AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,1)) - ZP(gt2,1)*(vd*(-2*
      AbsSqr(Lambdax) + Sqr(g2))*ZP(gt3,0) + vu*(0.6*Sqr(g1) + Sqr(g2))*ZP(gt3,1))
      ) - 2*ZH(gt1,2)*(1.4142135623730951*Conj(TLambdax)*ZP(gt2,1)*ZP(gt3,0) + (2*
      vS*Conj(Kappa)*Lambdax + 1.4142135623730951*TLambdax)*ZP(gt2,0)*ZP(gt3,1) +
      2*vS*Conj(Lambdax)*(Lambdax*ZP(gt2,0)*ZP(gt3,0) + ZP(gt2,1)*(Kappa*ZP(gt3,0)
      + Lambdax*ZP(gt3,1)))));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarChaChahhPL(int gt3, int gt1, int gt2) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Lambdax = MODELPARAMETER(Lambdax);
...
std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpAhSdconjSd(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto vS = MODELPARAMETER(vS);
   const auto vu = MODELPARAMETER(vu);
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(
      1.4142135623730951*SUM(j2,0,2,Conj(ZD(gt2,j2))*SUM(j1,0,2,ZD(gt3,3 + j1)*TYd
      (j1,j2)))*ZA(gt1,0) - 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZD(gt2,3
       + j1))*Conj(TYd(j1,j2)))*ZD(gt3,j2))*ZA(gt1,0) + (Conj(Lambdax)*SUM(j2,0,2,
      Conj(ZD(gt2,j2))*SUM(j1,0,2,Yd(j1,j2)*ZD(gt3,3 + j1))) - Lambdax*SUM(j2,0,2,
      SUM(j1,0,2,Conj(Yd(j1,j2))*Conj(ZD(gt2,3 + j1)))*ZD(gt3,j2)))*(vS*ZA(gt1,1)
      + vu*ZA(gt1,2)));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpAhSuconjSu(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto vd = MODELPARAMETER(vd);
   const auto vS = MODELPARAMETER(vS);
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(
      1.4142135623730951*(SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,2,ZU(gt3,3 + j1)*
      TYu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(ZU(gt2,3 + j1))*Conj(TYu(j1,j2)))*
      ZU(gt3,j2)))*ZA(gt1,1) + Conj(Lambdax)*SUM(j2,0,2,Conj(ZU(gt2,j2))*SUM(j1,0,
      2,Yu(j1,j2)*ZU(gt3,3 + j1)))*(vS*ZA(gt1,0) + vd*ZA(gt1,2)) - Lambdax*SUM(j2,
      0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Conj(ZU(gt2,3 + j1)))*ZU(gt3,j2))*(vS*ZA(gt1,
      0) + vd*ZA(gt1,2)));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpAhSeconjSe(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto vS = MODELPARAMETER(vS);
   const auto vu = MODELPARAMETER(vu);
   ...
   const std::complex<double> result = std::complex<double>(0,-0.5)*(
      ...
      (j1,j2)))*ZA(gt1,0) - 1.4142135623730951*SUM(j2,0,2,SUM(j1,0,2,Conj(ZE(gt2,3
       + j1))*Conj(TYe(j1,j2)))*ZE(gt3,j2))*ZA(gt1,0) + (Conj(Lambdax)*SUM(j2,0,2,
      Conj(ZE(gt2,j2))*SUM(j1,0,2,Ye(j1,j2)*ZE(gt3,3 + j1))) - Lambdax*SUM(j2,0,2,
      SUM(j1,0,2,Conj(Ye(j1,j2))*Conj(ZE(gt2,3 + j1)))*ZE(gt3,j2)))*(vS*ZA(gt1,1)
      + vu*ZA(gt1,2)));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpAhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto TLambdax = MODELPARAMETER(TLambdax);
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
   ...
   const std::complex<double> result = std::complex<double>(0,-0.25)*(vu*(-2*
      ...
      (gt2,0)*ZP(gt3,1)) + 2*ZA(gt1,2)*(-1.4142135623730951*Conj(TLambdax)*ZP(gt2,
      1)*ZP(gt3,0) + 2*vS*Conj(Lambdax)*Kappa*ZP(gt2,1)*ZP(gt3,0) + (-2*vS*Conj(
      Kappa)*Lambdax + 1.4142135623730951*TLambdax)*ZP(gt2,0)*ZP(gt3,1)));

   return result;
}

std::complex<double> lowNMSSMTanBetaAtMZ_effective_couplings::CpbarChaChaAhPL(int gt3, int gt2, int gt1) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto Lambdax = MODELPARAMETER(Lambdax);
...
void lowNMSSMTanBetaAtMZ_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
void lowNMSSMTanBetaAtMZ_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
...
void lowNMSSMTanBetaAtMZ_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto MCha = MODELPARAMETER(MCha);
...
void lowNMSSMTanBetaAtMZ_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
