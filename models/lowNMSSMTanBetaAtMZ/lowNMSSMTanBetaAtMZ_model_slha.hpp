...
class lowNMSSMTanBetaAtMZ_slha : public lowNMSSMTanBetaAtMZ_mass_eigenstates {
public:
   explicit lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_input_parameters& input_ = lowNMSSMTanBetaAtMZ_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_mass_eigenstates&, bool do_convert_masses_to_slha = true);
