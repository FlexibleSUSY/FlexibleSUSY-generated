...
/**
 * @file lowNMSSMTanBetaAtMZ_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Wed 16 Oct 2019 22:10:19

#ifndef lowNMSSMTanBetaAtMZ_SLHA_H
#define lowNMSSMTanBetaAtMZ_SLHA_H
...
/**
 * @class lowNMSSMTanBetaAtMZ_slha<T>
...
class lowNMSSMTanBetaAtMZ_slha : public Model {
public:
   explicit lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_input_parameters& input_ = lowNMSSMTanBetaAtMZ_input_parameters());
   explicit lowNMSSMTanBetaAtMZ_slha(const Model&, bool do_convert_masses_to_slha = true);
   lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_slha&) = default;
   lowNMSSMTanBetaAtMZ_slha(lowNMSSMTanBetaAtMZ_slha&&) = default;
   virtual ~lowNMSSMTanBetaAtMZ_slha() = default;
   lowNMSSMTanBetaAtMZ_slha& operator=(const lowNMSSMTanBetaAtMZ_slha&) = default;
   lowNMSSMTanBetaAtMZ_slha& operator=(lowNMSSMTanBetaAtMZ_slha&&) = default;
   ...
   const lowNMSSMTanBetaAtMZ_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   lowNMSSMTanBetaAtMZ_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   lowNMSSMTanBetaAtMZ_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
lowNMSSMTanBetaAtMZ_slha<Model>::lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
lowNMSSMTanBetaAtMZ_slha<Model>::lowNMSSMTanBetaAtMZ_slha(const Model& model_,
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::convert_to_slha()
{
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const lowNMSSMTanBetaAtMZ_physical& lowNMSSMTanBetaAtMZ_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
lowNMSSMTanBetaAtMZ_physical& lowNMSSMTanBetaAtMZ_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const lowNMSSMTanBetaAtMZ_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
