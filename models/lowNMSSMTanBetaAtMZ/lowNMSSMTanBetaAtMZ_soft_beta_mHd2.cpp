 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHd2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHd2 = Re(0.2*(-3.872983346207417*g1*Tr11 + 30*traceconjTYdTpTYd + 10*
      ...
      traceYeAdjYe + 10*mHd2*AbsSqr(Lambdax) + 10*mHu2*AbsSqr(Lambdax) + 10*ms2
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHd2_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   ...
   beta_mHd2 = Re(0.04*(-77.45966692414834*g1*Tr31 - 900*tracemd2YdAdjYdYdAdjYd
      ...
      traceYuAdjYdTYdAdjTYu - 150*traceconjTYuTpTYu*AbsSqr(Lambdax) - 150*
      tracemq2AdjYuYu*AbsSqr(Lambdax) - 150*tracemu2YuAdjYu*AbsSqr(Lambdax) -
      150*mHd2*traceYuAdjYu*AbsSqr(Lambdax) - 300*mHu2*traceYuAdjYu*AbsSqr(
      Lambdax) - 150*ms2*traceYuAdjYu*AbsSqr(Lambdax) - 100*mHd2*AbsSqr(Kappa)*
      AbsSqr(Lambdax) - 100*mHu2*AbsSqr(Kappa)*AbsSqr(Lambdax) - 400*ms2*AbsSqr
      (Kappa)*AbsSqr(Lambdax) - 100*AbsSqr(Lambdax)*AbsSqr(TKappa) - 150*
      traceYuAdjYu*AbsSqr(TLambdax) - 100*AbsSqr(Kappa)*AbsSqr(TLambdax) - 600*
      AbsSqr(Lambdax)*AbsSqr(TLambdax) - 150*traceAdjYuTYu*Conj(TLambdax)*
      Lambdax + 621*AbsSqr(MassB)*Quad(g1) + 150*Tr22*Quad(g2) + 825*AbsSqr(
      MassWB)*Quad(g2) + 30*Tr2U111*Sqr(g1) - 20*traceconjTYdTpTYd*Sqr(g1) + 20
      *MassB*traceconjTYdTpYd*Sqr(g1) + 60*traceconjTYeTpTYe*Sqr(g1) - 60*MassB
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHd2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHd2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_mHd2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
