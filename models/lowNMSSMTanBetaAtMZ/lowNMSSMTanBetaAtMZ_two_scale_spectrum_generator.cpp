...
#include "lowNMSSMTanBetaAtMZ_two_scale_convergence_tester.hpp"
...
double lowNMSSMTanBetaAtMZ_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void lowNMSSMTanBetaAtMZ_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
   ...
   lowNMSSMTanBetaAtMZ_ewsb_solver<Two_scale> ewsb_solver;
   model.set_ewsb_solver(
      std::make_shared<lowNMSSMTanBetaAtMZ_ewsb_solver<Two_scale> >(ewsb_solver));

   lowNMSSMTanBetaAtMZ_susy_scale_constraint<Two_scale> susy_scale_constraint(&model, qedqcd);
   lowNMSSMTanBetaAtMZ_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);
   ...
   lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void lowNMSSMTanBetaAtMZ_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   lowNMSSMTanBetaAtMZ_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_susy_scale());
}

void lowNMSSMTanBetaAtMZ_spectrum_generator<Two_scale>::calculate_spectrum()
{
