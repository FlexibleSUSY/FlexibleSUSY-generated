...
// File generated at Wed 16 Oct 2019 22:08:50
...
Eigen::ArrayXd lowNMSSMTanBetaAtMZ_input_parameters::get() const
{
...
void lowNMSSMTanBetaAtMZ_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   Qin = pars(1);
   M1Input = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
