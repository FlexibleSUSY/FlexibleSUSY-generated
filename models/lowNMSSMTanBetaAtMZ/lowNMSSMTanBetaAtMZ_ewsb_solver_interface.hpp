...
/**
 * @file lowNMSSMTanBetaAtMZ_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Wed 16 Oct 2019 22:10:27 with FlexibleSUSY
 * 2.4.1 (git commit: 3e3a10f4fde301d99a4732f29d14f4ac1c646945) and SARAH 4.14.3 .
 */

#ifndef lowNMSSMTanBetaAtMZ_EWSB_SOLVER_INTERFACE_H
#define lowNMSSMTanBetaAtMZ_EWSB_SOLVER_INTERFACE_H
...
class lowNMSSMTanBetaAtMZ_ewsb_solver_interface {
public:
   virtual ~lowNMSSMTanBetaAtMZ_ewsb_solver_interface() {}
   ...
   virtual int solve(lowNMSSMTanBetaAtMZ_mass_eigenstates&) = 0;
};
