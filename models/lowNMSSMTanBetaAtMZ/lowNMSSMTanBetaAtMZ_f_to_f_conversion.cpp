...
/**
 * @file lowNMSSMTanBetaAtMZ_f_to_f_conversion.cpp
 *
...
namespace lowNMSSMTanBetaAtMZ_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model) {
