 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_MassWB_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_MassWB_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta_MassWB_3_loop(const Soft_traces& soft_traces) const
{
