...
template <class T>
class lowNMSSMTanBetaAtMZ;

struct lowNMSSMTanBetaAtMZ_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class lowNMSSMTanBetaAtMZ_slha_io {
public:
   lowNMSSMTanBetaAtMZ_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(lowNMSSMTanBetaAtMZ_input_parameters&) const;
   void fill(lowNMSSMTanBetaAtMZ_mass_eigenstates&) const;
   template <class Model> void fill(lowNMSSMTanBetaAtMZ_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const lowNMSSMTanBetaAtMZ_slha<Model>&, const lowNMSSMTanBetaAtMZ_scales&, const lowNMSSMTanBetaAtMZ_observables&);
   ...
   template <class Model> void set_spectrum(const lowNMSSMTanBetaAtMZ_slha<Model>&);
   template <class T> void set_spectrum(const lowNMSSMTanBetaAtMZ<T>&);
   ...
   static void fill_minpar_tuple(lowNMSSMTanBetaAtMZ_input_parameters&, int, double);
   static void fill_extpar_tuple(lowNMSSMTanBetaAtMZ_input_parameters&, int, double);
   ...
   static void fill_slhaea(SLHAea::Coll&, const lowNMSSMTanBetaAtMZ_slha<Model>&, const softsusy::QedQcd&, const lowNMSSMTanBetaAtMZ_scales&, const lowNMSSMTanBetaAtMZ_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const lowNMSSMTanBetaAtMZ_slha<Model>&, const softsusy::QedQcd&, const lowNMSSMTanBetaAtMZ_scales&, const lowNMSSMTanBetaAtMZ_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const lowNMSSMTanBetaAtMZ_input_parameters&);
   void set_imminpar(const lowNMSSMTanBetaAtMZ_input_parameters&);
   void set_imextpar(const lowNMSSMTanBetaAtMZ_input_parameters&);
   void set_minpar(const lowNMSSMTanBetaAtMZ_input_parameters&);
   void set_mass(const lowNMSSMTanBetaAtMZ_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const lowNMSSMTanBetaAtMZ_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const lowNMSSMTanBetaAtMZ_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(lowNMSSMTanBetaAtMZ_mass_eigenstates&) const;
   void fill_physical(lowNMSSMTanBetaAtMZ_physical&) const;
};
 ...
 */
template <class Model>
void lowNMSSMTanBetaAtMZ_slha_io::fill(lowNMSSMTanBetaAtMZ_slha<Model>& model) const
{
...
template <class Model>
void lowNMSSMTanBetaAtMZ_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const lowNMSSMTanBetaAtMZ_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const lowNMSSMTanBetaAtMZ_scales& scales,
   const lowNMSSMTanBetaAtMZ_observables& observables)
{
   lowNMSSMTanBetaAtMZ_slha_io slha_io;
   const lowNMSSMTanBetaAtMZ_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll lowNMSSMTanBetaAtMZ_slha_io::fill_slhaea(
   const lowNMSSMTanBetaAtMZ_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const lowNMSSMTanBetaAtMZ_scales& scales, const lowNMSSMTanBetaAtMZ_observables& observables)
{
   SLHAea::Coll slhaea;
   lowNMSSMTanBetaAtMZ_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void lowNMSSMTanBetaAtMZ_slha_io::set_model_parameters(const lowNMSSMTanBetaAtMZ_slha<Model>& model)
{
   {
...
void lowNMSSMTanBetaAtMZ_slha_io::set_extra(
   const lowNMSSMTanBetaAtMZ_slha<Model>& model, const lowNMSSMTanBetaAtMZ_scales& scales,
   const lowNMSSMTanBetaAtMZ_observables& observables)
{
 ...
 */
template <class... Ts>
void lowNMSSMTanBetaAtMZ_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<lowNMSSMTanBetaAtMZ_slha_io> ss(this);
 ...
 */
template <class T>
void lowNMSSMTanBetaAtMZ_slha_io::set_spectrum(const lowNMSSMTanBetaAtMZ<T>& model)
{
   set_spectrum(lowNMSSMTanBetaAtMZ_slha<lowNMSSMTanBetaAtMZ<T> >(model));
}
 ...
 */
template <class Model>
void lowNMSSMTanBetaAtMZ_slha_io::set_spectrum(const lowNMSSMTanBetaAtMZ_slha<Model>& model)
{
   const lowNMSSMTanBetaAtMZ_physical physical(model.get_physical_slha());
