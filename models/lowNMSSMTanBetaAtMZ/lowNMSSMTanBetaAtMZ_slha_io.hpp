...
public:
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const lowNMSSMTanBetaAtMZ_scales&, const lowNMSSMTanBetaAtMZ_observables&, const Spectrum_generator_settings&);
