...
struct lowNMSSMTanBetaAtMZ_physical;
class lowNMSSMTanBetaAtMZ_slha;
...
public:
   ...
   void fill(lowNMSSMTanBetaAtMZ_slha&) const;
   ...
   void set_extra(const lowNMSSMTanBetaAtMZ_slha&, const lowNMSSMTanBetaAtMZ_scales&, const lowNMSSMTanBetaAtMZ_observables&);
   ...
   void set_spectrum(const lowNMSSMTanBetaAtMZ_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const lowNMSSMTanBetaAtMZ_scales&, const lowNMSSMTanBetaAtMZ_observables&);
...
private:
   ...
   void set_model_parameters(const lowNMSSMTanBetaAtMZ_slha&);
 ...
 */
template <class... Ts>
void lowNMSSMTanBetaAtMZ_slha_io::fill(
