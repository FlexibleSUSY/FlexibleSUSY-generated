 ...
 *
 * This file was generated at Tue 22 Jan 2019 17:12:55 with FlexibleSUSY
...
double calculate_a_muon_impl(lowNMSSMTanBetaAtMZ_mass_eigenstates& model)
{
...
std::pair<double,double> vary_scale(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("lowNMSSMTanBetaAtMZ_a_muon: scale variation: " << e.what());
                     }
                     return amu;
                  });
...
double lowNMSSMTanBetaAtMZ_a_muon::calculate_a_muon(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model_)
{
   ...
   try {
      ...
      ERROR("lowNMSSMTanBetaAtMZ_a_muon:" << e.what());
...
double lowNMSSMTanBetaAtMZ_a_muon::calculate_a_muon_uncertainty(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model_)
{
   lowNMSSMTanBetaAtMZ_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("lowNMSSMTanBetaAtMZ_a_muon uncertainty: " << e.what());
      return std::numeric_limits<double>::quiet_NaN();
   }
