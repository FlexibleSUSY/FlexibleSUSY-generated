...
class lowNMSSMTanBetaAtMZ_soft_parameters : public lowNMSSMTanBetaAtMZ_susy_parameters {
public:
   explicit lowNMSSMTanBetaAtMZ_soft_parameters(const lowNMSSMTanBetaAtMZ_input_parameters& input_ = lowNMSSMTanBetaAtMZ_input_parameters());
   lowNMSSMTanBetaAtMZ_soft_parameters(const lowNMSSMTanBetaAtMZ_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>& TYe_,
   ...
   lowNMSSMTanBetaAtMZ_soft_parameters(const lowNMSSMTanBetaAtMZ_soft_parameters&) = default;
   lowNMSSMTanBetaAtMZ_soft_parameters(lowNMSSMTanBetaAtMZ_soft_parameters&&) = default;
   virtual ~lowNMSSMTanBetaAtMZ_soft_parameters() = default;
   lowNMSSMTanBetaAtMZ_soft_parameters& operator=(const lowNMSSMTanBetaAtMZ_soft_parameters&) = default;
   lowNMSSMTanBetaAtMZ_soft_parameters& operator=(lowNMSSMTanBetaAtMZ_soft_parameters&&) = default;
   ...
   lowNMSSMTanBetaAtMZ_soft_parameters calc_beta() const;
   lowNMSSMTanBetaAtMZ_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const lowNMSSMTanBetaAtMZ_soft_parameters&);
