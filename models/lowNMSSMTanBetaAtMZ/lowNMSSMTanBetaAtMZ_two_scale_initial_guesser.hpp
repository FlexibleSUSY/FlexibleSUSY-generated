...
#include "lowNMSSMTanBetaAtMZ_initial_guesser.hpp"
...
/**
 * @class lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>
 * @brief initial guesser for the lowNMSSMTanBetaAtMZ
 */

template<>
class lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale> : public Initial_guesser {
public:
   lowNMSSMTanBetaAtMZ_initial_guesser(lowNMSSMTanBetaAtMZ<Two_scale>*,
                               const softsusy::QedQcd&,
                               const lowNMSSMTanBetaAtMZ_low_scale_constraint<Two_scale>&,
                               const lowNMSSMTanBetaAtMZ_susy_scale_constraint<Two_scale>&);
   virtual ~lowNMSSMTanBetaAtMZ_initial_guesser() = default;
   virtual void guess() override; ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   lowNMSSMTanBetaAtMZ<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   lowNMSSMTanBetaAtMZ_low_scale_constraint<Two_scale> low_constraint{};
   lowNMSSMTanBetaAtMZ_susy_scale_constraint<Two_scale> susy_constraint{};
