 ...
 * parameters.
 *
 * This file was generated at Sun 26 Aug 2018 14:35:37 with FlexibleSUSY
...
{
   if (!force_output && problems.is_running_tachyon(lowNMSSMTanBetaAtMZ_info::
      VZ))
      return;
...
void CLASSNAME::calculate_Mhh_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(lowNMSSMTanBetaAtMZ_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(lowNMSSMTanBetaAtMZ_info::hh);
}
...
void CLASSNAME::calculate_MAh_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(lowNMSSMTanBetaAtMZ_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(lowNMSSMTanBetaAtMZ_info::Ah);
}
...
void CLASSNAME::calculate_MHpm_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(lowNMSSMTanBetaAtMZ_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(lowNMSSMTanBetaAtMZ_info::Hpm);
}
