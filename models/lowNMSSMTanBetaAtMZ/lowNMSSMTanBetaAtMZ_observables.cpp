...
const int lowNMSSMTanBetaAtMZ_observables::NUMBER_OF_OBSERVABLES;

lowNMSSMTanBetaAtMZ_observables::lowNMSSMTanBetaAtMZ_observables()

{
}

Eigen::ArrayXd lowNMSSMTanBetaAtMZ_observables::get() const
{
   Eigen::ArrayXd vec(1);
...
std::vector<std::string> lowNMSSMTanBetaAtMZ_observables::get_names()
{
...
void lowNMSSMTanBetaAtMZ_observables::clear()
{

}

void lowNMSSMTanBetaAtMZ_observables::set(const Eigen::ArrayXd& vec)
{

}

lowNMSSMTanBetaAtMZ_observables calculate_observables(lowNMSSMTanBetaAtMZ_mass_eigenstates& model,
                                              ...
                                              double scale)
{
   ...
   if (scale > 0.) {
      try {
         ...
         return lowNMSSMTanBetaAtMZ_observables();
      }
   }
