...
// File generated at Mon 5 Mar 2018 18:17:37
...
const int lowNMSSMTanBetaAtMZ_soft_parameters::numberOfParameters;

lowNMSSMTanBetaAtMZ_soft_parameters::lowNMSSMTanBetaAtMZ_soft_parameters(const lowNMSSMTanBetaAtMZ_input_parameters& input_)
   : lowNMSSMTanBetaAtMZ_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

lowNMSSMTanBetaAtMZ_soft_parameters::lowNMSSMTanBetaAtMZ_soft_parameters(
   const lowNMSSMTanBetaAtMZ_susy_parameters& susy_model
   ...
   : lowNMSSMTanBetaAtMZ_susy_parameters(susy_model)
...
Eigen::ArrayXd lowNMSSMTanBetaAtMZ_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

lowNMSSMTanBetaAtMZ_soft_parameters lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta(int loops) const
{
   ...
   const lowNMSSMTanBetaAtMZ_susy_parameters susy_betas(lowNMSSMTanBetaAtMZ_susy_parameters::calc_beta(loops));

   return lowNMSSMTanBetaAtMZ_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TLambdax, beta_TKappa, beta_TYu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_MassB, beta_MassWB, beta_MassG);
}

lowNMSSMTanBetaAtMZ_soft_parameters lowNMSSMTanBetaAtMZ_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void lowNMSSMTanBetaAtMZ_soft_parameters::clear()
{
   lowNMSSMTanBetaAtMZ_susy_parameters::clear();
...
Eigen::ArrayXd lowNMSSMTanBetaAtMZ_soft_parameters::get() const
{
   Eigen::ArrayXd pars(lowNMSSMTanBetaAtMZ_susy_parameters::get());
...
void lowNMSSMTanBetaAtMZ_soft_parameters::print(std::ostream& ostr) const
{
   lowNMSSMTanBetaAtMZ_susy_parameters::print(ostr);
...
void lowNMSSMTanBetaAtMZ_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   lowNMSSMTanBetaAtMZ_susy_parameters::set(pars);
...
lowNMSSMTanBetaAtMZ_soft_parameters::Soft_traces lowNMSSMTanBetaAtMZ_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowNMSSMTanBetaAtMZ_soft_parameters& soft_pars)
{
