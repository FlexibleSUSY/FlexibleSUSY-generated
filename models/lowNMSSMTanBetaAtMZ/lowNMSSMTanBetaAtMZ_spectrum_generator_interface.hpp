...
#ifndef lowNMSSMTanBetaAtMZ_SPECTRUM_GENERATOR_INTERFACE_H
#define lowNMSSMTanBetaAtMZ_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class lowNMSSMTanBetaAtMZ_spectrum_generator_interface {
public:
   virtual ~lowNMSSMTanBetaAtMZ_spectrum_generator_interface() = default;

   std::tuple<lowNMSSMTanBetaAtMZ<T>> get_models() const
   { return std::make_tuple(model); }
   std::tuple<lowNMSSMTanBetaAtMZ_slha<lowNMSSMTanBetaAtMZ<T>>> get_models_slha() const
   { return std::make_tuple(lowNMSSMTanBetaAtMZ_slha<lowNMSSMTanBetaAtMZ<T> >(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.)); }

   const lowNMSSMTanBetaAtMZ<T>& get_model() const
   { return model; }
   lowNMSSMTanBetaAtMZ<T>& get_model()
   { return model; }
   lowNMSSMTanBetaAtMZ_slha<lowNMSSMTanBetaAtMZ<T>> get_model_slha() const
   { return lowNMSSMTanBetaAtMZ_slha<lowNMSSMTanBetaAtMZ<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const lowNMSSMTanBetaAtMZ_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "lowNMSSMTanBetaAtMZ_spectrum.dat") const;

protected:
   lowNMSSMTanBetaAtMZ<T> model;
   ...
   void translate_exception_to_problem(lowNMSSMTanBetaAtMZ<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const lowNMSSMTanBetaAtMZ_input_parameters&) = 0;
};
 ...
 */
template <class T>
void lowNMSSMTanBetaAtMZ_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void lowNMSSMTanBetaAtMZ_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
 ...
 */
template <class T>
void lowNMSSMTanBetaAtMZ_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   lowNMSSMTanBetaAtMZ_mass_eigenstates tmp_model(model);
   try {
   ...
   lowNMSSMTanBetaAtMZ_parameter_getter parameter_getter;
   Coupling_monitor<lowNMSSMTanBetaAtMZ_mass_eigenstates, lowNMSSMTanBetaAtMZ_parameter_getter>
 ...
 */
template <class T>
void lowNMSSMTanBetaAtMZ_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   lowNMSSMTanBetaAtMZ_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void lowNMSSMTanBetaAtMZ_spectrum_generator_interface<T>::translate_exception_to_problem(lowNMSSMTanBetaAtMZ<T>& model)
{
   try {
      throw;
