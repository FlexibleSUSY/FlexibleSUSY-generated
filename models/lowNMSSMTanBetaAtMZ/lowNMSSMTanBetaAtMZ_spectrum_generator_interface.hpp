...
public:
   ...
   std::tuple<lowNMSSMTanBetaAtMZ<T>> get_models_slha() const
   { return std::make_tuple(lowNMSSMTanBetaAtMZ<T>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.)); }

   const lowNMSSMTanBetaAtMZ<T>& get_model() const
   { return model; }
   lowNMSSMTanBetaAtMZ<T>& get_model()
   { return model; }
   lowNMSSMTanBetaAtMZ<T> get_model_slha() const
   { return lowNMSSMTanBetaAtMZ<T>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   double start, double stop) const
{
   ...
   auto data_getter = [&tmp_model](double scale) {
      ...
      return lowNMSSMTanBetaAtMZ_parameter_getter::get_parameters(tmp_model);
   };

   std::vector<std::string> parameter_names(
      std::cbegin(lowNMSSMTanBetaAtMZ_info::parameter_names),
      std::cend(lowNMSSMTanBetaAtMZ_info::parameter_names));
