...
#include "lowNMSSMTanBetaAtMZ_utilities.hpp"
...
// lowNMSSMTanBetaAtMZ_parameter_getter ////////////////////////////////////////

std::vector<std::string> lowNMSSMTanBetaAtMZ_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace lowNMSSMTanBetaAtMZ_info;
...
std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_MIXINGS> lowNMSSMTanBetaAtMZ_parameter_getter::get_mixing_names()
{
   return lowNMSSMTanBetaAtMZ_info::particle_mixing_names;
}

Eigen::ArrayXd lowNMSSMTanBetaAtMZ_parameter_getter::get_parameters(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_PARAMETERS> lowNMSSMTanBetaAtMZ_parameter_getter::get_parameter_names()
{
   return lowNMSSMTanBetaAtMZ_info::parameter_names;
}

std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_PARTICLES> lowNMSSMTanBetaAtMZ_parameter_getter::get_particle_names()
{
   return lowNMSSMTanBetaAtMZ_info::particle_names;
}

std::vector<std::string> lowNMSSMTanBetaAtMZ_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> lowNMSSMTanBetaAtMZ_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_MIXINGS> lowNMSSMTanBetaAtMZ_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_MIXINGS> lowNMSSMTanBetaAtMZ_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_INPUT_PARAMETERS> lowNMSSMTanBetaAtMZ_parameter_getter::get_input_parameter_names()
{
   return lowNMSSMTanBetaAtMZ_info::input_parameter_names;
}

std::array<std::string, lowNMSSMTanBetaAtMZ_info::NUMBER_OF_EXTRA_PARAMETERS> lowNMSSMTanBetaAtMZ_parameter_getter::get_extra_parameter_names()
{
   return lowNMSSMTanBetaAtMZ_info::extra_parameter_names;
}

decltype(lowNMSSMTanBetaAtMZ_info::NUMBER_OF_MASSES) lowNMSSMTanBetaAtMZ_parameter_getter::get_number_of_masses()
{
   return lowNMSSMTanBetaAtMZ_info::NUMBER_OF_MASSES;
}

// lowNMSSMTanBetaAtMZ_spectrum_plotter ////////////////////////////////////////

lowNMSSMTanBetaAtMZ_spectrum_plotter::lowNMSSMTanBetaAtMZ_spectrum_plotter(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void lowNMSSMTanBetaAtMZ_spectrum_plotter::extract_spectrum(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model)
{
   spectrum.clear();
...
void lowNMSSMTanBetaAtMZ_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("lowNMSSMTanBetaAtMZ_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("lowNMSSMTanBetaAtMZ_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("lowNMSSMTanBetaAtMZ_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void lowNMSSMTanBetaAtMZ_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("lowNMSSMTanBetaAtMZ_spectrum_plotter::write_spectrum: "
...
namespace lowNMSSMTanBetaAtMZ_database {
 ...
 */
void to_database(
   const std::string& file_name, const lowNMSSMTanBetaAtMZ_mass_eigenstates& model,
   ...
   const lowNMSSMTanBetaAtMZ_observables* observables)
{
   ...
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_DRbar_mass_names());
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_pole_mass_names());
   append(names, lowNMSSMTanBetaAtMZ_parameter_getter::get_pole_mixing_names());
   ...
   if (lowNMSSMTanBetaAtMZ_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, lowNMSSMTanBetaAtMZ_observables::get_names());
 ...
 */
lowNMSSMTanBetaAtMZ_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, lowNMSSMTanBetaAtMZ_observables* observables)
{
   lowNMSSMTanBetaAtMZ_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = lowNMSSMTanBetaAtMZ_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = lowNMSSMTanBetaAtMZ_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = lowNMSSMTanBetaAtMZ_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = lowNMSSMTanBetaAtMZ_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? lowNMSSMTanBetaAtMZ_observables::NUMBER_OF_OBSERVABLES : 0);
