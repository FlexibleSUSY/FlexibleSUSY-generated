...
lowNMSSMTanBetaAtMZ_slha::lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_input_parameters& input_,
 ...
 */
lowNMSSMTanBetaAtMZ_slha::lowNMSSMTanBetaAtMZ_slha(const lowNMSSMTanBetaAtMZ_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : lowNMSSMTanBetaAtMZ_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void lowNMSSMTanBetaAtMZ_slha::clear()
{
   lowNMSSMTanBetaAtMZ_mass_eigenstates::clear();
   physical_slha.clear();
}

void lowNMSSMTanBetaAtMZ_slha::calculate_spectrum()
{
   lowNMSSMTanBetaAtMZ_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void lowNMSSMTanBetaAtMZ_slha::convert_to_slha()
{
...
void lowNMSSMTanBetaAtMZ_slha::calculate_ckm_matrix()
{
...
void lowNMSSMTanBetaAtMZ_slha::calculate_pmns_matrix()
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha::convert_soft_squared_masses_to_slha()
{
...
const lowNMSSMTanBetaAtMZ_physical& lowNMSSMTanBetaAtMZ_slha::get_physical_slha() const
{
   return physical_slha;
}

lowNMSSMTanBetaAtMZ_physical& lowNMSSMTanBetaAtMZ_slha::get_physical_slha()
{
   return physical_slha;
}

void lowNMSSMTanBetaAtMZ_slha::print(std::ostream& ostr) const
{
   lowNMSSMTanBetaAtMZ_mass_eigenstates::print(ostr);
...
void lowNMSSMTanBetaAtMZ_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const lowNMSSMTanBetaAtMZ_slha& model)
{
   model.print(ostr);
   return ostr;
}
