...
#ifndef lowNMSSMTanBetaAtMZ_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define lowNMSSMTanBetaAtMZ_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "lowNMSSMTanBetaAtMZ_low_scale_constraint.hpp"
...
template<>
class lowNMSSMTanBetaAtMZ_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ...
   virtual std::string name() const override { return "lowNMSSMTanBetaAtMZ low-scale constraint"; }
