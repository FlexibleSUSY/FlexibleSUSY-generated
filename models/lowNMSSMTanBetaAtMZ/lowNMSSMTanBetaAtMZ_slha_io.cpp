...
lowNMSSMTanBetaAtMZ_slha_io::lowNMSSMTanBetaAtMZ_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void lowNMSSMTanBetaAtMZ_slha_io::clear()
{
   slha_io.clear();
}

void lowNMSSMTanBetaAtMZ_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(lowNMSSMTanBetaAtMZ_slha& model) const
{
   fill(static_cast<lowNMSSMTanBetaAtMZ_mass_eigenstates&>(model));
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_extpar(const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
   ...
   extpar << FORMAT_ELEMENT(11, input.AtInput, "AtInput");
   extpar << FORMAT_ELEMENT(12, input.AbInput, "AbInput");
   extpar << FORMAT_ELEMENT(13, input.ATauInput, "ATauInput");
   extpar << FORMAT_ELEMENT(31, input.ml1Input, "ml1Input");
   extpar << FORMAT_ELEMENT(32, input.ml2Input, "ml2Input");
   extpar << FORMAT_ELEMENT(33, input.ml3Input, "ml3Input");
   extpar << FORMAT_ELEMENT(34, input.me1Input, "me1Input");
   extpar << FORMAT_ELEMENT(35, input.me2Input, "me2Input");
   extpar << FORMAT_ELEMENT(36, input.me3Input, "me3Input");
   extpar << FORMAT_ELEMENT(41, input.mq1Input, "mq1Input");
   extpar << FORMAT_ELEMENT(42, input.mq2Input, "mq2Input");
   extpar << FORMAT_ELEMENT(43, input.mq3Input, "mq3Input");
   extpar << FORMAT_ELEMENT(47, input.md1Input, "md1Input");
   extpar << FORMAT_ELEMENT(48, input.md2Input, "md2Input");
   extpar << FORMAT_ELEMENT(49, input.md3Input, "md3Input");
   extpar << FORMAT_ELEMENT(44, input.mu1Input, "mu1Input");
   extpar << FORMAT_ELEMENT(45, input.mu2Input, "mu2Input");
   extpar << FORMAT_ELEMENT(46, input.mu3Input, "mu3Input");
   ...
   extpar << FORMAT_ELEMENT(64, input.AKappaInput, "AKappaInput");
   extpar << FORMAT_ELEMENT(65, input.MuEffInput, "MuEffInput");
 ...
 * @param input struct of input parameters
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_imminpar(const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_imextpar(const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_minpar(const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_input(const lowNMSSMTanBetaAtMZ_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_unitarity_infinite_s(
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, lowNMSSMTanBetaAtMZ_info::model_name)
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_mass(const lowNMSSMTanBetaAtMZ_physical& physical,
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_mixing_matrices(const lowNMSSMTanBetaAtMZ_physical& physical,
...
void lowNMSSMTanBetaAtMZ_slha_io::set_ckm(
...
void lowNMSSMTanBetaAtMZ_slha_io::set_pmns(
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_model_parameters(const lowNMSSMTanBetaAtMZ_slha& model)
{
   {
...
void lowNMSSMTanBetaAtMZ_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void lowNMSSMTanBetaAtMZ_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void lowNMSSMTanBetaAtMZ_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void lowNMSSMTanBetaAtMZ_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, lowNMSSMTanBetaAtMZ_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = lowNMSSMTanBetaAtMZ_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + lowNMSSMTanBetaAtMZ_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void lowNMSSMTanBetaAtMZ_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_spectrum(const lowNMSSMTanBetaAtMZ_slha& model)
{
   const lowNMSSMTanBetaAtMZ_physical physical(model.get_physical_slha());
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::set_extra(
   const lowNMSSMTanBetaAtMZ_slha& model,
   const lowNMSSMTanBetaAtMZ_scales& scales,
   const lowNMSSMTanBetaAtMZ_observables& observables,
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void lowNMSSMTanBetaAtMZ_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void lowNMSSMTanBetaAtMZ_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void lowNMSSMTanBetaAtMZ_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double lowNMSSMTanBetaAtMZ_slha_io::get_parameter_output_scale() const
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(lowNMSSMTanBetaAtMZ_input_parameters& input) const
{
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill_drbar_parameters(lowNMSSMTanBetaAtMZ_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(lowNMSSMTanBetaAtMZ_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   lowNMSSMTanBetaAtMZ_physical physical_hk;
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void lowNMSSMTanBetaAtMZ_slha_io::fill_minpar_tuple(lowNMSSMTanBetaAtMZ_input_parameters& input,
...
void lowNMSSMTanBetaAtMZ_slha_io::fill_extpar_tuple(lowNMSSMTanBetaAtMZ_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
   ...
   case 11: input.AtInput = value; break;
   case 12: input.AbInput = value; break;
   case 13: input.ATauInput = value; break;
   case 31: input.ml1Input = value; break;
   case 32: input.ml2Input = value; break;
   case 33: input.ml3Input = value; break;
   case 34: input.me1Input = value; break;
   case 35: input.me2Input = value; break;
   case 36: input.me3Input = value; break;
   case 41: input.mq1Input = value; break;
   case 42: input.mq2Input = value; break;
   case 43: input.mq3Input = value; break;
   case 47: input.md1Input = value; break;
   case 48: input.md2Input = value; break;
   case 49: input.md3Input = value; break;
   case 44: input.mu1Input = value; break;
   case 45: input.mu2Input = value; break;
   case 46: input.mu3Input = value; break;
   ...
   case 65: input.MuEffInput = value; break;
   default: WARNING("Unrecognized entry in block EXTPAR: " << key); break;
   }

}

void lowNMSSMTanBetaAtMZ_slha_io::fill_imminpar_tuple(lowNMSSMTanBetaAtMZ_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void lowNMSSMTanBetaAtMZ_slha_io::fill_imextpar_tuple(lowNMSSMTanBetaAtMZ_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void lowNMSSMTanBetaAtMZ_slha_io::fill_physical(lowNMSSMTanBetaAtMZ_physical& physical) const
{
   {
