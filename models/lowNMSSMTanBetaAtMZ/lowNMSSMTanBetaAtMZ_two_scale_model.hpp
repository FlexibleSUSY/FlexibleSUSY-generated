 ...
 */
template<>
class lowNMSSMTanBetaAtMZ<Two_scale> : public Model, public lowNMSSMTanBetaAtMZ_mass_eigenstates {
public:
   explicit lowNMSSMTanBetaAtMZ(const lowNMSSMTanBetaAtMZ_input_parameters& input_ = lowNMSSMTanBetaAtMZ_input_parameters());
