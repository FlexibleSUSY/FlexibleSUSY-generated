...
// File generated at Wed 16 Oct 2019 22:10:45

#include "lowNMSSMTanBetaAtMZ_two_scale_initial_guesser.hpp"
...
lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::lowNMSSMTanBetaAtMZ_initial_guesser(
   lowNMSSMTanBetaAtMZ<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const lowNMSSMTanBetaAtMZ_low_scale_constraint<Two_scale>& low_constraint_,
   const lowNMSSMTanBetaAtMZ_susy_scale_constraint<Two_scale>& susy_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("lowNMSSMTanBetaAtMZ_initial_guesser: Error: pointer to model"
                       " lowNMSSMTanBetaAtMZ<Two_scale> must not be zero");
}
 ...
 */
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::guess()
{
 ...
 * \code{.cpp}
   ...
   MODEL->set_ms2(Re(Sqr(LowEnergyConstant(MZ))));
   MODEL->set_mHd2(Re(Sqr(LowEnergyConstant(MZ))));
   MODEL->set_mHu2(Re(-Sqr(LowEnergyConstant(MZ))));
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * \endcode
 */
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void lowNMSSMTanBetaAtMZ_initial_guesser<Two_scale>::guess_soft_parameters()
{
