...
/**
 * @file lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef lowNMSSMTanBetaAtMZ_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define lowNMSSMTanBetaAtMZ_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
/**
 * @class lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme
   : private lowNMSSMTanBetaAtMZ_soft_parameters
   , public lowNMSSMTanBetaAtMZ_mass_eigenstates_interface
{
public:
   explicit lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme(const lowNMSSMTanBetaAtMZ_input_parameters& input_ = lowNMSSMTanBetaAtMZ_input_parameters());
   explicit lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme(const lowNMSSMTanBetaAtMZ_mass_eigenstates&);
   lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme(const lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme&) = default;
   lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme(lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme() = default;
   lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme& operator=(const lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme&) = default;
   lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme& operator=(lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme&&) = default;
   ...
   void fill_from(const lowNMSSMTanBetaAtMZ_mass_eigenstates&);
...
private:
   ...
   Problems problems{lowNMSSMTanBetaAtMZ_info::model_name,
...
std::ostream& operator<<(std::ostream&, const lowNMSSMTanBetaAtMZ_mass_eigenstates_decoupling_scheme&);
