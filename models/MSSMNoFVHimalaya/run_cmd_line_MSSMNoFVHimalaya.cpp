...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMNoFVHimalaya.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --Qin=<value>\n"
...
int run_solver(const MSSMNoFVHimalaya_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMNoFVHimalaya_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMNoFVHimalaya_input_parameters& input)
{
   int exit_code = 0;
