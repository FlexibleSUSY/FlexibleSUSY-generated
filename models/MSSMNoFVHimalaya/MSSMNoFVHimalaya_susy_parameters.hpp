...
public:
   ...
   MSSMNoFVHimalaya_susy_parameters& operator=(const MSSMNoFVHimalaya_susy_parameters&) = default;
   MSSMNoFVHimalaya_susy_parameters& operator=(MSSMNoFVHimalaya_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSMNoFVHimalaya_input_parameters& get_input() const;
   MSSMNoFVHimalaya_input_parameters& get_input();
   void set_input_parameters(const MSSMNoFVHimalaya_input_parameters&);

   MSSMNoFVHimalaya_susy_parameters calc_beta() const;
   MSSMNoFVHimalaya_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMNoFVHimalaya_susy_parameters&);
