...
struct MSSMNoFVHimalaya_physical;
class MSSMNoFVHimalaya_slha;
...
public:
   ...
   void fill(MSSMNoFVHimalaya_slha&) const;
   ...
   void set_extra(const MSSMNoFVHimalaya_slha&, const MSSMNoFVHimalaya_scales&, const MSSMNoFVHimalaya_observables&, const flexiblesusy::Spectrum_generator_settings&);
   ...
   void set_spectrum(const MSSMNoFVHimalaya_slha&);
   ...
   template <class... Ts>
   void fill(const std::tuple<Ts...>&, const softsusy::QedQcd&, const MSSMNoFVHimalaya_scales&, const MSSMNoFVHimalaya_observables&, const Spectrum_generator_settings&, const FlexibleDecay_settings&, MSSMNoFVHimalaya_decays const * const = nullptr);
...
private:
   ...
   void set_model_parameters(const MSSMNoFVHimalaya_slha&);
 ...
 */
template <class... Ts>
void MSSMNoFVHimalaya_slha_io::fill(
   ...
   MSSMNoFVHimalaya_decays const * const decays)
{
