...
// File generated at Mon 5 Mar 2018 14:59:44

#ifndef MSSMNoFVHimalaya_SLHA_IO_H
#define MSSMNoFVHimalaya_SLHA_IO_H
...
struct MSSMNoFVHimalaya_input_parameters;
class Spectrum_generator_settings;

template <class T>
class MSSMNoFVHimalaya;

struct MSSMNoFVHimalaya_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MSSMNoFVHimalaya_slha_io {
public:
   MSSMNoFVHimalaya_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MSSMNoFVHimalaya_input_parameters&) const;
   void fill(MSSMNoFVHimalaya_mass_eigenstates&) const;
   template <class Model> void fill(MSSMNoFVHimalaya_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSMNoFVHimalaya_slha<Model>&, const MSSMNoFVHimalaya_scales&, const MSSMNoFVHimalaya_observables&);
   void set_input(const MSSMNoFVHimalaya_input_parameters&);
   ...
   template <class Model> void set_spectrum(const MSSMNoFVHimalaya_slha<Model>&);
   template <class T> void set_spectrum(const MSSMNoFVHimalaya<T>&);
   ...
   static void fill_minpar_tuple(MSSMNoFVHimalaya_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMNoFVHimalaya_input_parameters&, int, double);
   static void fill_imminpar_tuple(MSSMNoFVHimalaya_input_parameters&, int, double);
   static void fill_imextpar_tuple(MSSMNoFVHimalaya_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MSSMNoFVHimalaya_slha<Model>&, const softsusy::QedQcd&, const MSSMNoFVHimalaya_scales&, const MSSMNoFVHimalaya_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSMNoFVHimalaya_slha<Model>&, const softsusy::QedQcd&, const MSSMNoFVHimalaya_scales&, const MSSMNoFVHimalaya_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MSSMNoFVHimalaya_input_parameters&);
   void set_imminpar(const MSSMNoFVHimalaya_input_parameters&);
   void set_imextpar(const MSSMNoFVHimalaya_input_parameters&);
   void set_minpar(const MSSMNoFVHimalaya_input_parameters&);
   void set_mass(const MSSMNoFVHimalaya_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const MSSMNoFVHimalaya_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const MSSMNoFVHimalaya_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMNoFVHimalaya_mass_eigenstates&) const;
   void fill_physical(MSSMNoFVHimalaya_physical&) const;
};
 ...
 */
template <class Model>
void MSSMNoFVHimalaya_slha_io::fill(MSSMNoFVHimalaya_slha<Model>& model) const
{
...
template <class Model>
void MSSMNoFVHimalaya_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMNoFVHimalaya_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MSSMNoFVHimalaya_scales& scales,
   const MSSMNoFVHimalaya_observables& observables)
{
   MSSMNoFVHimalaya_slha_io slha_io;
   const MSSMNoFVHimalaya_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MSSMNoFVHimalaya_slha_io::fill_slhaea(
   const MSSMNoFVHimalaya_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MSSMNoFVHimalaya_scales& scales, const MSSMNoFVHimalaya_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMNoFVHimalaya_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MSSMNoFVHimalaya_slha_io::set_model_parameters(const MSSMNoFVHimalaya_slha<Model>& model)
{
   {
...
void MSSMNoFVHimalaya_slha_io::set_extra(
   const MSSMNoFVHimalaya_slha<Model>& model, const MSSMNoFVHimalaya_scales& scales,
   const MSSMNoFVHimalaya_observables& observables)
{
 ...
 */
template <class... Ts>
void MSSMNoFVHimalaya_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MSSMNoFVHimalaya_slha_io> ss(this);
 ...
 */
template <class T>
void MSSMNoFVHimalaya_slha_io::set_spectrum(const MSSMNoFVHimalaya<T>& model)
{
   set_spectrum(MSSMNoFVHimalaya_slha<MSSMNoFVHimalaya<T> >(model));
}
 ...
 */
template <class Model>
void MSSMNoFVHimalaya_slha_io::set_spectrum(const MSSMNoFVHimalaya_slha<Model>& model)
{
   const MSSMNoFVHimalaya_physical physical(model.get_physical_slha());
