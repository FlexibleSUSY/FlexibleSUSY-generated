...
// File generated at Wed 16 Oct 2019 19:03:04

/**
 * @file MSSMNoFVHimalaya_a_muon.cpp
 *
 * This file was generated at Wed 16 Oct 2019 19:03:04 with FlexibleSUSY
...
double calculate_a_muon_impl(const MSSMNoFVHimalaya_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   const auto form_factors = MSSMNoFVHimalaya_FFV_form_factors::calculate_Fm_Fm_VP_form_factors(model, true);
...
std::pair<double,double> vary_scale(const MSSMNoFVHimalaya_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model,&qedqcd] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("MSSMNoFVHimalaya_a_muon: scale variation: " << e.what_detailed());
                     }
                     return amu;
                  });
...
double MSSMNoFVHimalaya_a_muon::calculate_a_muon(const MSSMNoFVHimalaya_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   ...
   try {
      ...
      ERROR("MSSMNoFVHimalaya_a_muon:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
double MSSMNoFVHimalaya_a_muon::calculate_a_muon_uncertainty(const MSSMNoFVHimalaya_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   MSSMNoFVHimalaya_mass_eigenstates model(model_);
   ...
   try {
      ...
      ERROR("MSSMNoFVHimalaya_a_muon uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
