...
MSSMNoFVHimalaya_initial_guesser<Two_scale>::MSSMNoFVHimalaya_initial_guesser(
   MSSMNoFVHimalaya<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MSSMNoFVHimalaya_low_scale_constraint<Two_scale>& low_constraint_,
   const MSSMNoFVHimalaya_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSMNoFVHimalaya_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("MSSMNoFVHimalaya_initial_guesser: Error: pointer to model"
                       " MSSMNoFVHimalaya<Two_scale> must not be zero");
}
 ...
 */
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto vd = MODELPARAMETER(vd);
 ...
 */
void MSSMNoFVHimalaya_initial_guesser<Two_scale>::guess_soft_parameters()
{
