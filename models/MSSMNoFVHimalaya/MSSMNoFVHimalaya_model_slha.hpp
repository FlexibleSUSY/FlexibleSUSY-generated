...
class MSSMNoFVHimalaya_slha : public MSSMNoFVHimalaya_mass_eigenstates {
public:
   explicit MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_input_parameters& input_ = MSSMNoFVHimalaya_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_mass_eigenstates&, bool do_convert_masses_to_slha = true);
