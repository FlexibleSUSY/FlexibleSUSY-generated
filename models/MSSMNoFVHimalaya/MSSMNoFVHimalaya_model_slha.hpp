...
class MSSMNoFVHimalaya_slha : public Model {
public:
   explicit MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_input_parameters& input_ = MSSMNoFVHimalaya_input_parameters());
   explicit MSSMNoFVHimalaya_slha(const Model&, bool do_convert_masses_to_slha = true);
   MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_slha&) = default;
   MSSMNoFVHimalaya_slha(MSSMNoFVHimalaya_slha&&) = default;
   virtual ~MSSMNoFVHimalaya_slha() = default;
   MSSMNoFVHimalaya_slha& operator=(const MSSMNoFVHimalaya_slha&) = default;
   MSSMNoFVHimalaya_slha& operator=(MSSMNoFVHimalaya_slha&&) = default;
   ...
   const MSSMNoFVHimalaya_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MSSMNoFVHimalaya_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MSSMNoFVHimalaya_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
MSSMNoFVHimalaya_slha<Model>::MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MSSMNoFVHimalaya_slha<Model>::MSSMNoFVHimalaya_slha(const Model& model_,
...
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::calculate_ckm_matrix()
{

}

template <class Model>
void MSSMNoFVHimalaya_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MSSMNoFVHimalaya_physical& MSSMNoFVHimalaya_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MSSMNoFVHimalaya_physical& MSSMNoFVHimalaya_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MSSMNoFVHimalaya_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MSSMNoFVHimalaya_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVHimalaya_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
