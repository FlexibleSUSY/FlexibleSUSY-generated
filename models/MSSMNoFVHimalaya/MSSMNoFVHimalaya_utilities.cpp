...
#include "MSSMNoFVHimalaya_utilities.hpp"
...
// MSSMNoFVHimalaya_parameter_getter ////////////////////////////////////////

std::vector<std::string> MSSMNoFVHimalaya_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace MSSMNoFVHimalaya_info;
...
std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS> MSSMNoFVHimalaya_parameter_getter::get_mixing_names()
{
   return MSSMNoFVHimalaya_info::particle_mixing_names;
}

Eigen::ArrayXd MSSMNoFVHimalaya_parameter_getter::get_parameters(const MSSMNoFVHimalaya_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_PARAMETERS> MSSMNoFVHimalaya_parameter_getter::get_parameter_names()
{
   return MSSMNoFVHimalaya_info::parameter_names;
}

std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_PARTICLES> MSSMNoFVHimalaya_parameter_getter::get_particle_names()
{
   return MSSMNoFVHimalaya_info::particle_names;
}

std::vector<std::string> MSSMNoFVHimalaya_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> MSSMNoFVHimalaya_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS> MSSMNoFVHimalaya_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS> MSSMNoFVHimalaya_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_INPUT_PARAMETERS> MSSMNoFVHimalaya_parameter_getter::get_input_parameter_names()
{
   return MSSMNoFVHimalaya_info::input_parameter_names;
}

std::array<std::string, MSSMNoFVHimalaya_info::NUMBER_OF_EXTRA_PARAMETERS> MSSMNoFVHimalaya_parameter_getter::get_extra_parameter_names()
{
   return MSSMNoFVHimalaya_info::extra_parameter_names;
}

decltype(MSSMNoFVHimalaya_info::NUMBER_OF_MASSES) MSSMNoFVHimalaya_parameter_getter::get_number_of_masses()
{
   return MSSMNoFVHimalaya_info::NUMBER_OF_MASSES;
}

// MSSMNoFVHimalaya_spectrum_plotter ////////////////////////////////////////

MSSMNoFVHimalaya_spectrum_plotter::MSSMNoFVHimalaya_spectrum_plotter(const MSSMNoFVHimalaya_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void MSSMNoFVHimalaya_spectrum_plotter::extract_spectrum(const MSSMNoFVHimalaya_mass_eigenstates& model)
{
   spectrum.clear();
...
void MSSMNoFVHimalaya_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("MSSMNoFVHimalaya_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("MSSMNoFVHimalaya_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("MSSMNoFVHimalaya_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void MSSMNoFVHimalaya_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("MSSMNoFVHimalaya_spectrum_plotter::write_spectrum: "
...
namespace MSSMNoFVHimalaya_database {
 ...
 */
void to_database(
   const std::string& file_name, const MSSMNoFVHimalaya_mass_eigenstates& model,
   ...
   const MSSMNoFVHimalaya_observables* observables)
{
   ...
   append(names, MSSMNoFVHimalaya_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, MSSMNoFVHimalaya_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, MSSMNoFVHimalaya_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, MSSMNoFVHimalaya_parameter_getter::get_DRbar_mass_names());
   append(names, MSSMNoFVHimalaya_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, MSSMNoFVHimalaya_parameter_getter::get_pole_mass_names());
   append(names, MSSMNoFVHimalaya_parameter_getter::get_pole_mixing_names());
   ...
   if (MSSMNoFVHimalaya_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, MSSMNoFVHimalaya_observables::get_names());
 ...
 */
MSSMNoFVHimalaya_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, MSSMNoFVHimalaya_observables* observables)
{
   MSSMNoFVHimalaya_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = MSSMNoFVHimalaya_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = MSSMNoFVHimalaya_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = MSSMNoFVHimalaya_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = MSSMNoFVHimalaya_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? MSSMNoFVHimalaya_observables::NUMBER_OF_OBSERVABLES : 0);
