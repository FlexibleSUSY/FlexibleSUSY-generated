...
// File generated at Wed 16 Oct 2019 19:02:34

#ifndef MSSMNoFVHimalaya_SPECTRUM_GENERATOR_INTERFACE_H
#define MSSMNoFVHimalaya_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class MSSMNoFVHimalaya_spectrum_generator_interface {
public:
   virtual ~MSSMNoFVHimalaya_spectrum_generator_interface() = default;

   std::tuple<MSSMNoFVHimalaya<T>> get_models() const
   { return std::make_tuple(model); }
   std::tuple<MSSMNoFVHimalaya_slha<MSSMNoFVHimalaya<T>>> get_models_slha() const
   { return std::make_tuple(MSSMNoFVHimalaya_slha<MSSMNoFVHimalaya<T> >(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.)); }

   const MSSMNoFVHimalaya<T>& get_model() const
   { return model; }
   MSSMNoFVHimalaya<T>& get_model()
   { return model; }
   MSSMNoFVHimalaya_slha<MSSMNoFVHimalaya<T>> get_model_slha() const
   { return MSSMNoFVHimalaya_slha<MSSMNoFVHimalaya<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const MSSMNoFVHimalaya_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "MSSMNoFVHimalaya_spectrum.dat") const;

protected:
   MSSMNoFVHimalaya<T> model;
   ...
   void translate_exception_to_problem(MSSMNoFVHimalaya<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const MSSMNoFVHimalaya_input_parameters&) = 0;
};
 ...
 */
template <class T>
void MSSMNoFVHimalaya_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void MSSMNoFVHimalaya_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const MSSMNoFVHimalaya_input_parameters& input)
{
 ...
 */
template <class T>
void MSSMNoFVHimalaya_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   MSSMNoFVHimalaya_mass_eigenstates tmp_model(model);
   try {
   ...
   MSSMNoFVHimalaya_parameter_getter parameter_getter;
   Coupling_monitor<MSSMNoFVHimalaya_mass_eigenstates, MSSMNoFVHimalaya_parameter_getter>
 ...
 */
template <class T>
void MSSMNoFVHimalaya_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   MSSMNoFVHimalaya_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void MSSMNoFVHimalaya_spectrum_generator_interface<T>::translate_exception_to_problem(MSSMNoFVHimalaya<T>& model)
{
   try {
      throw;
