 ...
 */
double MSSMNoFVHimalaya_soft_parameters::calc_beta_mHu2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_mHu2 = Re(0.2*(3.872983346207417*g1*Tr11 + 30*traceconjTYuTpTYu + 30*
      tracemq2AdjYuYu + 30*tracemu2YuAdjYu + 30*mHu2*traceYuAdjYu - 6*AbsSqr(
 ...
 */
double MSSMNoFVHimalaya_soft_parameters::calc_beta_mHu2_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_mHu2 = Re(0.04*(77.45966692414834*g1*Tr31 - 150*tracemd2YdAdjYuYuAdjYd
      ...
      traceYuAdjYuTYuAdjTYu - 900*mHu2*traceYuAdjYuYuAdjYu + 621*AbsSqr(MassB)*
 ...
 */
double MSSMNoFVHimalaya_soft_parameters::calc_beta_mHu2_3_loop(const Soft_traces& soft_traces) const
{
   ...
   const double beta_mHu2_1 = Re(239.45914429835202*(0.07516939915885217*
      traceAdjTYdTYdAdjYuYuAdjYdYd + 0.07516939915885217*
   ...
   const double beta_mHu2_2 = Re(-3.312*(-65.21739130434783*
      ...
      *Sqr(g1)*Sqr(g2)*Sqr(MassWB) - 49.63308460746566*traceAdjYuYu*Sqr(g2)*Sqr
      (g3)*Sqr(MassWB)));
   const double beta_mHu2_3 = Re(90.*(0.4*traceAdjTYuYuAdjYdYd*traceTYdAdjYd +
      0.4*traceAdjYuYuAdjTYdYd*traceTYdAdjYd + 0.4*traceAdjTYdYd*
      traceTYdAdjYuYuAdjYd + 0.13333333333333333*traceAdjTYeYe*
 ...
 */
double MSSMNoFVHimalaya_soft_parameters::calc_beta_mHu2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double MSSMNoFVHimalaya_soft_parameters::calc_beta_mHu2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
