...
/**
 * @file MSSMNoFVHimalaya_mass_eigenstates.cpp
...
#include "MSSMNoFVHimalaya_ewsb_solver_interface.hpp"
#include "config.h"
...
#define CLASSNAME MSSMNoFVHimalaya_mass_eigenstates
...
CLASSNAME::CLASSNAME(const MSSMNoFVHimalaya_input_parameters& input_)
   : MSSMNoFVHimalaya_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new MSSMNoFVHimalaya_ewsb_solver<Two_scale>())
#endif
{
}

std::unique_ptr<MSSMNoFVHimalaya_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<MSSMNoFVHimalaya_mass_eigenstates>(*this);
}
...
const MSSMNoFVHimalaya_physical& CLASSNAME::get_physical() const
{
   return physical;
}

MSSMNoFVHimalaya_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const MSSMNoFVHimalaya_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MSSMNoFVHimalaya_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving MSSMNoFVHimalaya EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "MSSMNoFVHimalaya\n"
           "========================================\n";
   MSSMNoFVHimalaya_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSveL) < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::SveL); }
   if (PHYSICAL(MSvmL) < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::SvmL); }
   if (PHYSICAL(MSvtL) < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::SvtL); }
   if (PHYSICAL(MSd).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Sd); }
   if (PHYSICAL(MSu).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Su); }
   if (PHYSICAL(MSe).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Se); }
   if (PHYSICAL(MSm).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Sm); }
   if (PHYSICAL(MStau).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Stau); }
   if (PHYSICAL(MSs).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Ss); }
   if (PHYSICAL(MSc).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Sc); }
   if (PHYSICAL(MSb).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Sb); }
   if (PHYSICAL(MSt).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::St); }
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::hh); }
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Ah); }
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) { problems.flag_pole_tachyon(MSSMNoFVHimalaya_info::Hpm); }
}
...
{
   MSSMNoFVHimalaya_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   MSSMNoFVHimalaya_soft_parameters::run_to(scale, eps);
}
...
const MSSMNoFVHimalaya_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

MSSMNoFVHimalaya_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
...
void CLASSNAME::calculate_MSveL()
{
   ...
   if (MSveL < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::SveL);
   }
...
void CLASSNAME::calculate_MSvmL()
{
   ...
   if (MSvmL < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::SvmL);
   }
...
void CLASSNAME::calculate_MSvtL()
{
   ...
   if (MSvtL < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::SvtL);
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Sd, eigenvalue_error >
      precision * Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Sd);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Su, eigenvalue_error >
      precision * Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Se, eigenvalue_error >
      precision * Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Se);
   }
...
void CLASSNAME::calculate_MSm()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Sm, eigenvalue_error >
      precision * Abs(MSm(0)));
#else
   ...
   if (MSm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Sm);
   }
...
void CLASSNAME::calculate_MStau()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Stau, eigenvalue_error >
   ...
   if (MStau.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Stau);
   }
...
void CLASSNAME::calculate_MSs()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Ss, eigenvalue_error >
      precision * Abs(MSs(0)));
#else
   ...
   if (MSs.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Ss);
   }
...
void CLASSNAME::calculate_MSc()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Sc, eigenvalue_error >
      precision * Abs(MSc(0)));
#else
   ...
   if (MSc.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Sc);
   }
...
void CLASSNAME::calculate_MSb()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Sb, eigenvalue_error >
      precision * Abs(MSb(0)));
#else
   ...
   if (MSb.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Sb);
   }
...
void CLASSNAME::calculate_MSt()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::St, eigenvalue_error >
      precision * Abs(MSt(0)));
#else
   ...
   if (MSt.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::St);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Hpm, eigenvalue_error >
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSMNoFVHimalaya_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(MSSMNoFVHimalaya_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::VZ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::SveL
      ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::SvmL
      ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::SvtL
      ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Sd))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Su))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Se))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Sm))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Stau
      ))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Ss))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Sc))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Sb))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::St))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::hh))
      return;
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(MSSMNoFVHimalaya_info::hh);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMNoFVHimalaya_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(MSSMNoFVHimalaya_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Ah))
      return;
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 2; i++) {
         for (int k = 0; k < 2; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(MSSMNoFVHimalaya_info::Ah);
            }
         }
      }
   }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMNoFVHimalaya_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(MSSMNoFVHimalaya_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::Hpm)
      )
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(MSSMNoFVHimalaya_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(MSSMNoFVHimalaya_info::Hpm);
}
...
{
   if (!force_output && problems.is_running_tachyon(MSSMNoFVHimalaya_info::VWm)
      )
      return;
