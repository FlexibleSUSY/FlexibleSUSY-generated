...
Eigen::ArrayXd MSSMNoFVHimalaya_input_parameters::get() const
{
   Eigen::ArrayXd pars(33);
...
void MSSMNoFVHimalaya_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   SignMu = pars(1);
   Qin = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVHimalaya_input_parameters& input)
{
