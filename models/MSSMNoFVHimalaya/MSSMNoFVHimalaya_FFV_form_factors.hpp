...
std::enable_if_t<
   std::is_same_v<Fj, MSSMNoFVHimalaya_cxx_diagrams::fields::Fm> && std::is_same_v<Fi, MSSMNoFVHimalaya_cxx_diagrams::fields::Fm> && std::is_same_v<V, MSSMNoFVHimalaya_cxx_diagrams::fields::VP>,
   std::valarray<std::complex<double>>
>
calculate_form_factors(     const MSSMNoFVHimalaya_mass_eigenstates&, bool);
