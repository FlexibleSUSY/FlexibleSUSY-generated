...
/**
 * @file MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef MSSMNoFVHimalaya_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define MSSMNoFVHimalaya_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "MSSMNoFVHimalaya_info.hpp"
#include "MSSMNoFVHimalaya_physical.hpp"
#include "MSSMNoFVHimalaya_soft_parameters.hpp"
#include "MSSMNoFVHimalaya_mass_eigenstates_interface.hpp"
...
#define SUPER(p) MSSMNoFVHimalaya_soft_parameters::p
...
/**
 * @class MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme
   : private MSSMNoFVHimalaya_soft_parameters
   , public MSSMNoFVHimalaya_mass_eigenstates_interface
{
public:
   explicit MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(const MSSMNoFVHimalaya_input_parameters& input_ = MSSMNoFVHimalaya_input_parameters());
   explicit MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(const MSSMNoFVHimalaya_mass_eigenstates&);
   MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(const MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme(MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme() = default;
   MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme& operator=(const MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&) = default;
   MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme& operator=(MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<MSSMNoFVHimalaya_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const MSSMNoFVHimalaya_mass_eigenstates&);
   ...
   const MSSMNoFVHimalaya_input_parameters& get_input_parameters() const override;
   MSSMNoFVHimalaya_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const MSSMNoFVHimalaya_physical& get_physical() const override;
   MSSMNoFVHimalaya_physical& get_physical() override;
   ...
   void set_physical(const MSSMNoFVHimalaya_physical&) override;
...
private:
   ...
   MSSMNoFVHimalaya_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMNoFVHimalaya_info::model_name,
                     &MSSMNoFVHimalaya_info::particle_names_getter,
                     &MSSMNoFVHimalaya_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const MSSMNoFVHimalaya_mass_eigenstates_decoupling_scheme&);
