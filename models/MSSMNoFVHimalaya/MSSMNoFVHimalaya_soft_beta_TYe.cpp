 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYe_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYe = (0.2*(30*traceAdjYdTYd*Ye + 10*traceAdjYeTYe*Ye + 18*MassB*Ye*Sqr
      (g1) + 30*MassWB*Ye*Sqr(g2) + 15*traceYdAdjYd*TYe + 5*traceYeAdjYe*TYe -
      9*Sqr(g1)*TYe - 15*Sqr(g2)*TYe) + 4*(Ye*Ye.adjoint()*TYe) + 5*(TYe*Ye.
      adjoint()*Ye)).real();


   return oneLoop * beta_TYe;
}
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYe_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceAdjYdTYd = TRACE_STRUCT.traceAdjYdTYd;
   ...
   beta_TYe = (0.1*(-360*traceYdAdjYdTYdAdjYd*Ye - 60*traceYdAdjYuTYuAdjYd*Ye -
      120*traceYeAdjYeTYeAdjYe*Ye - 60*traceYuAdjYdTYdAdjYu*Ye - 540*MassB*Ye*
      Quad(g1) - 300*MassWB*Ye*Quad(g2) - 8*traceAdjYdTYd*Ye*Sqr(g1) + 24*
      ...
      traceYeAdjYeYeAdjYe*TYe + 135*Quad(g1)*TYe + 75*Quad(g2)*TYe - 4*
      traceYdAdjYd*Sqr(g1)*TYe + 12*traceYeAdjYe*Sqr(g1)*TYe + 18*Sqr(g1)*Sqr(
      g2)*TYe + 160*traceYdAdjYd*Sqr(g3)*TYe) - 6*(3*traceAdjYdTYd +
      traceAdjYeTYe + 2*MassWB*Sqr(g2))*(Ye*Ye.adjoint()*Ye) + 0.4*(-30*
      traceYdAdjYd - 10*traceYeAdjYe + 3*Sqr(g1) + 15*Sqr(g2))*(Ye*Ye.adjoint()
      *TYe) + 0.2*(-75*traceYdAdjYd - 25*traceYeAdjYe - 6*Sqr(g1) + 60*Sqr(g2))
      *(TYe*Ye.adjoint()*Ye) - 6*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*TYe) - 8*(Ye*
      Ye.adjoint()*TYe*Ye.adjoint()*Ye) - 6*(TYe*Ye.adjoint()*Ye*Ye.adjoint()*
      Ye)).real();


   return twoLoop * beta_TYe;
}
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYe_3_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_TYe_1 = ((-0.0013333333333333333*Ye*(-
      162000*traceAdjYdTYdAdjYdYd*traceAdjYdYd - 13500*
      ...
      traceTYdAdjYd*Sqr(g2)*Sqr(g3)) + 0.016*(6750*traceAdjYdYdAdjYdTYdAdjYdYd
      + 16119*MassB*Power6(g1) - 118125*MassWB*Power6(g2) + 385*MassB*
      traceAdjYdYd*Quad(g1) - 405*MassB*traceAdjYeYe*Quad(g1) + 23625*MassWB*
      traceAdjYdYd*Quad(g2) + 4000*MassG*traceAdjYdYd*Quad(g3) + 2700*
      traceAdjYdTYdAdjYdYd*Sqr(g1) - 1350*MassB*traceAdjYdYdAdjYdYd*Sqr(g1) -
      2700*traceAdjYeTYeAdjYeYe*Sqr(g1) + 2025*MassB*Quad(g2)*Sqr(g1) + 4050*
      MassWB*Quad(g2)*Sqr(g1) + 13500*traceAdjYdTYdAdjYdYd*Sqr(g2) - 6750*
      MassWB*traceAdjYdYdAdjYdYd*Sqr(g2) + 4500*traceAdjYeTYeAdjYeYe*Sqr(g2) +
      7290*MassB*Quad(g1)*Sqr(g2) + 3645*MassWB*Quad(g1)*Sqr(g2) + 1125*MassB*
      traceAdjYdYd*Sqr(g1)*Sqr(g2) + 1125*MassWB*traceAdjYdYd*Sqr(g1)*Sqr(g2) -
      36000*traceAdjYdTYdAdjYdYd*Sqr(g3) + 18000*MassG*traceAdjYdYdAdjYdYd*Sqr(
      g3) + 23760*MassB*Quad(g1)*Sqr(g3) + 11880*MassG*Quad(g1)*Sqr(g3) + 27000
      *MassG*Quad(g2)*Sqr(g3) + 54000*MassWB*Quad(g2)*Sqr(g3) - 2800*MassB*
      traceAdjYdYd*Sqr(g1)*Sqr(g3) - 2800*MassG*traceAdjYdYd*Sqr(g1)*Sqr(g3) -
      18000*MassG*traceAdjYdYd*Sqr(g2)*Sqr(g3) - 18000*MassWB*traceAdjYdYd*Sqr(
      g2)*Sqr(g3))*(Ye*1.2020569031595942))*UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_TYe_2 = ((0.04*(900*
      ...
      *Sqr(g2) - 2400*traceAdjYuTYuAdjYdYd*Sqr(g3) + 2400*MassG*
      ...
      1.2020569031595942) + 0.004*(4500*traceAdjYdYdAdjYdYdAdjYdYd + 1500*
      traceAdjYeYeAdjYeYeAdjYeYe - 10746*Power6(g1) + 78750*Power6(g2) - 385*
      ...
      *traceAdjYdYdAdjYdYd*Sqr(g1) - 2700*traceAdjYeYeAdjYeYe*Sqr(g1) + 2100*
      traceAdjYuYuAdjYdYd*Sqr(g1) - 4050*Quad(g2)*Sqr(g1) + 13500*
      traceAdjYdYdAdjYdYd*Sqr(g2) + 4500*traceAdjYeYeAdjYeYe*Sqr(g2) - 7290*
      Quad(g1)*Sqr(g2) - 2250*traceAdjYdYd*Sqr(g1)*Sqr(g2) + 4050*traceAdjYeYe*
      ...
      (g3))*(TYe*1.2020569031595942) + 0.12*(1800*traceAdjYdTYdAdjYdYd + 600*
      traceAdjYeTYeAdjYeYe + 300*traceAdjYuTYuAdjYdYd - 900*traceAdjYdYd*
      traceTYdAdjYd - 300*traceAdjYeYe*traceTYdAdjYd + 300*traceTYdAdjYuYuAdjYd
       - 300*traceAdjYdYd*traceTYeAdjYe - 100*traceAdjYeYe*traceTYeAdjYe + 1917
      *MassB*Quad(g1) + 1825*MassWB*Quad(g2) - 490*MassB*traceAdjYdYd*Sqr(g1) -
      30*MassB*traceAdjYeYe*Sqr(g1) + 490*traceTYdAdjYd*Sqr(g1) + 30*
      traceTYeAdjYe*Sqr(g1) - 750*MassWB*traceAdjYdYd*Sqr(g2) - 250*MassWB*
      traceAdjYeYe*Sqr(g2) + 750*traceTYdAdjYd*Sqr(g2) + 250*traceTYeAdjYe*Sqr(
      g2) + 585*MassB*Sqr(g1)*Sqr(g2) + 585*MassWB*Sqr(g1)*Sqr(g2) + 1600*MassG
      *traceAdjYdYd*Sqr(g3) - 1600*traceTYdAdjYd*Sqr(g3))*(Ye*Ye.adjoint()*Ye)
      + 0.04*(1800*traceAdjYdYdAdjYdYd - 600*traceAdjYdYd*traceAdjYeYe + 600*
      ...
      )*(Ye*Ye.adjoint()*TYe) + 0.01*(9000*traceAdjYdYdAdjYdYd - 3000*
      traceAdjYdYd*traceAdjYeYe + 3000*traceAdjYeYeAdjYeYe + 3000*
      ...
      0.72*(81*MassB*Quad(g1) + 225*MassWB*Quad(g2) + 10*MassB*traceAdjYdYd*Sqr
      (g1) - 135*MassB*Sqr(g1)*Sqr(g2) - 135*MassWB*Sqr(g1)*Sqr(g2))*(Ye*Ye.
      adjoint()*Ye*1.2020569031595942))*UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_TYe_3 = ((0.0006666666666666666*(81000*
      traceAdjYdYd*traceAdjYdYdAdjYdYd + 4500*traceAdjYdYdAdjYdYdAdjYdYd +
      27000*traceAdjYdYdAdjYdYd*traceAdjYeYe + 27000*traceAdjYdYd*
      traceAdjYeYeAdjYeYe + 9000*traceAdjYeYe*traceAdjYeYeAdjYeYe + 1500*
      ...
      *Quad(g2) - 67500*traceAdjYuYu*Quad(g2) - 80000*traceAdjYdYd*Quad(g3) +
      ...
      Sqr(g3) - 198000*traceAdjYdYd*Sqr(g2)*Sqr(g3))*TYe - 7.2*(3*MassB*
      traceAdjYeYe*Sqr(g1) + traceTYdAdjYd*Sqr(g1) - 3*traceTYeAdjYe*Sqr(g1) -
      15*MassWB*traceAdjYdYd*Sqr(g2) - 5*MassWB*traceAdjYeYe*Sqr(g2) + 15*
      traceTYdAdjYd*Sqr(g2) + 5*traceTYeAdjYe*Sqr(g2) + 40*MassG*traceAdjYdYd*
      Sqr(g3) - 40*traceTYdAdjYd*Sqr(g3))*(Ye*Ye.adjoint()*Ye*
      1.2020569031595942) - 0.24*(54*Quad(g1) + 300*Quad(g2) + 65*traceAdjYdYd*
      Sqr(g1) - 45*traceAdjYeYe*Sqr(g1) + 225*traceAdjYdYd*Sqr(g2) + 75*
      traceAdjYeYe*Sqr(g2) - 270*Sqr(g1)*Sqr(g2) - 800*traceAdjYdYd*Sqr(g3))*(
      Ye*Ye.adjoint()*TYe*1.2020569031595942) - 0.06*(513*Quad(g1) + 825*Quad(
      g2) - 80*traceAdjYdYd*Sqr(g1) - 360*traceAdjYeYe*Sqr(g1) + 1800*
      traceAdjYdYd*Sqr(g2) + 600*traceAdjYeYe*Sqr(g2) - 1350*Sqr(g1)*Sqr(g2) -
      4000*traceAdjYdYd*Sqr(g3))*(TYe*Ye.adjoint()*Ye*1.2020569031595942) - 0.8
      *(-30*traceTYdAdjYd - 10*traceTYeAdjYe + 27*MassB*Sqr(g1) + 15*MassWB*Sqr
      (g2))*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*Ye) + 0.6*(30*traceAdjYdYd + 10*
      traceAdjYeYe + 33*Sqr(g1) + 5*Sqr(g2))*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*
      TYe) + 0.8*(30*traceAdjYdYd + 10*traceAdjYeYe + 27*Sqr(g1) + 15*Sqr(g2))*
      (Ye*Ye.adjoint()*TYe*Ye.adjoint()*Ye) + 0.6*(30*traceAdjYdYd + 10*
      traceAdjYeYe + 21*Sqr(g1) + 25*Sqr(g2))*(TYe*Ye.adjoint()*Ye*Ye.adjoint()
      *Ye) - 3.6*(3*Sqr(g1) - 5*Sqr(g2))*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*TYe*
      1.2020569031595942) + 3.6*(3*Sqr(g1) - 5*Sqr(g2))*(TYe*Ye.adjoint()*Ye*Ye
      .adjoint()*Ye*1.2020569031595942) + 6*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*Ye
      *Ye.adjoint()*TYe) + 12*(Ye*Ye.adjoint()*Ye*Ye.adjoint()*TYe*Ye.adjoint()
      *Ye) + 12*(Ye*Ye.adjoint()*TYe*Ye.adjoint()*Ye*Ye.adjoint()*Ye) + 12*(TYe
      *Ye.adjoint()*Ye*Ye.adjoint()*Ye*Ye.adjoint()*Ye) + 24*(Ye*Ye.adjoint()*
      Ye*Ye.adjoint()*Ye*Ye.adjoint()*TYe*1.2020569031595942) + 36*(Ye*Ye.
      adjoint()*Ye*Ye.adjoint()*TYe*Ye.adjoint()*Ye*1.2020569031595942) + 36*(
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYe_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYe_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
