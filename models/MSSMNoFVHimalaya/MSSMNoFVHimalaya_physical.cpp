...
void MSSMNoFVHimalaya_physical::clear()
{
   MVG = 0.;
   MGlu = 0.;
   MFd = 0.;
 ...
 * to be complex.
 */
void MSSMNoFVHimalaya_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void MSSMNoFVHimalaya_physical::convert_to_slha()
{
   SLHA_io::convert_symmetric_fermion_mixings_to_slha(LOCALPHYSICAL(MChi), LOCALPHYSICAL(ZN));

}

Eigen::ArrayXd MSSMNoFVHimalaya_physical::get() const
{
...
void MSSMNoFVHimalaya_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSMNoFVHimalaya_physical::get_masses() const
{
...
void MSSMNoFVHimalaya_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFd = pars(2);
...
void MSSMNoFVHimalaya_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVHimalaya_physical& phys_pars)
{
