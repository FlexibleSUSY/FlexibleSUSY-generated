...
/**
 * @file MSSMNoFVHimalaya_mass_eigenstates.hpp
 *
...
#ifndef MSSMNoFVHimalaya_MASS_EIGENSTATES_H
#define MSSMNoFVHimalaya_MASS_EIGENSTATES_H
 ...
 */
class MSSMNoFVHimalaya_mass_eigenstates
   : public MSSMNoFVHimalaya_soft_parameters
   , public MSSMNoFVHimalaya_mass_eigenstates_interface
{
public:
   explicit MSSMNoFVHimalaya_mass_eigenstates(const MSSMNoFVHimalaya_input_parameters& input_ = MSSMNoFVHimalaya_input_parameters());
   MSSMNoFVHimalaya_mass_eigenstates(const MSSMNoFVHimalaya_mass_eigenstates&) = default;
   MSSMNoFVHimalaya_mass_eigenstates(MSSMNoFVHimalaya_mass_eigenstates&&) = default;
   virtual ~MSSMNoFVHimalaya_mass_eigenstates() = default;
   MSSMNoFVHimalaya_mass_eigenstates& operator=(const MSSMNoFVHimalaya_mass_eigenstates&) = default;
   MSSMNoFVHimalaya_mass_eigenstates& operator=(MSSMNoFVHimalaya_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<MSSMNoFVHimalaya_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{MSSMNoFVHimalaya_info::model_name,
   ...
   std::shared_ptr<MSSMNoFVHimalaya_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMNoFVHimalaya_mass_eigenstates&);
