 ...
 */
class MSSMNoFVHimalaya_mass_eigenstates : public MSSMNoFVHimalaya_soft_parameters {
public:
   ...
   void set_physical(const MSSMNoFVHimalaya_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMNoFVHimalaya_physical& get_physical() const;
   MSSMNoFVHimalaya_physical& get_physical();
