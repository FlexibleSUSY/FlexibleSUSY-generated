...
/**
 * @file MSSMNoFVHimalaya_mass_eigenstates_interface.hpp
 *
...
#ifndef MSSMNoFVHimalaya_MASS_EIGENSTATES_INTERFACE_H
#define MSSMNoFVHimalaya_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class MSSMNoFVHimalaya_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class MSSMNoFVHimalaya_mass_eigenstates_interface {
public:
   virtual ~MSSMNoFVHimalaya_mass_eigenstates_interface() {}

   virtual std::unique_ptr<MSSMNoFVHimalaya_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const MSSMNoFVHimalaya_input_parameters& get_input_parameters() const = 0;
   virtual MSSMNoFVHimalaya_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const MSSMNoFVHimalaya_physical& get_physical() const = 0;
   virtual MSSMNoFVHimalaya_physical& get_physical() = 0;
   ...
   virtual void set_physical(const MSSMNoFVHimalaya_physical&) = 0;
