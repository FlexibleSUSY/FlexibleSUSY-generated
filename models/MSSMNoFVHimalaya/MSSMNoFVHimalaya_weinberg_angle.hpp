...
#ifndef MSSMNoFVHimalaya_WEINBERG_ANGLE_H
#define MSSMNoFVHimalaya_WEINBERG_ANGLE_H
...
/**
 * @class MSSMNoFVHimalaya_weinberg_angle
...
public:
   ...
   MSSMNoFVHimalaya_weinberg_angle(const MSSMNoFVHimalaya_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMNoFVHimalaya_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMNoFVHimalaya_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
