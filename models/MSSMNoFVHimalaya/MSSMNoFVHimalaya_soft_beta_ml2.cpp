...
// File generated at Sun 26 Aug 2018 13:46:08
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_ml2 = (twoLoop*(0.4*(-5*(3*traceconjTYdTpTYd + traceconjTYeTpTYe + 3*
      tracemd2YdAdjYd + traceme2YeAdjYe + traceml2AdjYeYe + 3*tracemq2AdjYdYd +
      6*mHd2*traceYdAdjYd + 2*mHd2*traceYeAdjYe) + 6*mHd2*Sqr(g1) + 12*AbsSqr(
      MassB)*Sqr(g1))*(Ye.adjoint()*Ye) - 0.4*(5*(3*traceconjTYdTpYd +
      traceconjTYeTpYe) + 6*Conj(MassB)*Sqr(g1))*(Ye.adjoint()*TYe) - 0.4*(5*(3
      *traceAdjYdTYd + traceAdjYeTYe) + 6*MassB*Sqr(g1))*((TYe).adjoint()*Ye) +
      (-2*(3*traceYdAdjYd + traceYeAdjYe) + 2.4*Sqr(g1))*((TYe).adjoint()*TYe)
      + (-3*traceYdAdjYd - traceYeAdjYe + 1.2*Sqr(g1))*(ml2*Ye.adjoint()*Ye) +
      (-2*(3*traceYdAdjYd + traceYeAdjYe) + 2.4*Sqr(g1))*(Ye.adjoint()*me2*Ye)
      + (-3*traceYdAdjYd - traceYeAdjYe + 1.2*Sqr(g1))*(Ye.adjoint()*Ye*ml2) -
      ...
      *(9*Conj(MassB)*Sqr(g1)*(69*MassB*Sqr(g1) + 5*(2*MassB + MassWB)*Sqr(g2))
      + 5*(-15.491933384829668*g1*Tr31 + 30*Tr22*Quad(g2) + 6*Tr2U111*Sqr(g1) +
      3*Conj(MassWB)*Sqr(g2)*(3*(MassB + 2*MassWB)*Sqr(g1) + 55*MassWB*Sqr(g2))
      ))*UNITMATRIX(3))).real();
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_3_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_ml2_1 = ((threeLoop*(Power6(g1)*(-4.968
      *mHd2 - 4.968*mHu2 - 3.312*tracemd2 - 9.936*traceme2 - 4.968*traceml2 -
      1.656*tracemq2 - 13.248*tracemu2 + 239.45914429835202*Sqr(MassB)) + Quad(
      g1)*(8.4*MassB*traceAdjTYdYd + 10.8*MassB*traceAdjTYeYe + 15.6*MassB*
      traceAdjTYuYu - 5.04*mHd2*traceAdjYdYd - 5.04*traceAdjYdYdmq2 - 6.48*mHd2
      *traceAdjYeYe - 6.48*traceAdjYeYeml2 - 9.36*mHu2*traceAdjYuYu - 9.36*
      traceAdjYuYumq2 - 5.04*traceTYdAdjTYd + 8.4*MassB*traceTYdAdjYd - 6.48*
      traceTYeAdjTYe + 10.8*MassB*traceTYeAdjYe - 9.36*traceTYuAdjTYu + 15.6*
      MassB*traceTYuAdjYu - 5.04*traceYdAdjYdmd2 - 6.48*traceYeAdjYeme2 - 9.36*
      traceYuAdjYumu2 - 25.2*traceAdjYdYd*Sqr(MassB) - 32.4*traceAdjYeYe*Sqr(
      MassB) - 46.8*traceAdjYuYu*Sqr(MassB) + Sqr(g3)*(-46.72465076838378*MassB
      *MassG - 70.08697615257569*Sqr(MassB) - 12.802325384191889*Sqr(MassG)) +
      Sqr(g2)*(-44.575972394845024*MassB*MassWB - 1.08*mHd2 - 1.08*mHu2 - 0.72*
      tracemd2 - 2.16*traceme2 - 1.08*traceml2 - 0.36*tracemq2 - 2.88*tracemu2
      - 66.86395859226754*Sqr(MassB) - 19.047986197422514*Sqr(MassWB))) + Quad(
      g2)*Sqr(g1)*(-59.893287324741706*MassB*MassWB - 1.8*mHd2 - 1.8*mHu2 - 1.8
      *traceml2 - 5.4*tracemq2 - 24.546643662370855*Sqr(MassB) -
      ...
      *traceYeAdjYeme2 - 54.*traceYuAdjYumu2 + Sqr(g3)*(-318.57716432988946*
      ...
      270.*traceAdjYuYu*Sqr(MassWB) + Sqr(g2)*(-3.*mHd2 - 3.*mHu2 - 3.*traceml2
       - 9.*tracemq2 + 6700.775093943266*Sqr(MassWB)))) + threeLoop*(72.*
   ...
   const Eigen::Matrix<double,3,3> beta_ml2_2 = ((threeLoop*(108.*mHd2*
      ...
      *traceAdjYdYd - 12.*MassWB*traceAdjYeYe)*Sqr(g2) + Sqr(g1)*(
      ...
      45.*MassWB*Quad(g2) + (-36.*MassWB*traceAdjYdYd - 12.*MassWB*traceAdjYeYe
       + 36.*traceTYdAdjYd + 12.*traceTYeAdjYe)*Sqr(g2) + Sqr(g1)*(-
   ...
   const Eigen::Matrix<double,3,3> beta_ml2_3 = ((threeLoop*(36.*
      ...
      *traceAdjYdYdmq2 - 24.*traceTYdAdjTYd + 24.*MassB*traceTYdAdjYd - 24.*
      ...
      UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_ml2_4 = ((threeLoop*(-62.99999999999999
      *Quad(g2) + Sqr(g1)*(-24.*traceAdjYdYd + 32.4*Sqr(g2)) + 96.*traceAdjYdYd
      *Sqr(g3))*(Ye.adjoint()*me2*Ye*1.2020569031595942) + threeLoop*(1.62*Quad
      (g1) - 31.499999999999996*Quad(g2) + Sqr(g1)*(-12.*traceAdjYdYd + 16.2*
      Sqr(g2)) + 48.*traceAdjYdYd*Sqr(g3))*(Ye.adjoint()*Ye*ml2*
      1.2020569031595942) + threeLoop*(36.*mHd2*traceAdjYdYd + 12.*
      ...
      *mHd2 + 36.*Sqr(MassB)) + Sqr(g2)*(-12.*mHd2 - 12.*Sqr(MassWB)))*(Ye.
      adjoint()*Ye*Ye.adjoint()*Ye) + threeLoop*(12.*traceAdjTYdYd +
      ...
      *((TYe).adjoint()*Ye*Ye.adjoint()*Ye) + threeLoop*(12.*traceAdjYdYd +
      ...
      1.9999999999999998*traceAdjYeYe + 9.*Sqr(g1) - 3.*Sqr(g2))*(ml2*Ye.
      adjoint()*Ye*Ye.adjoint()*Ye) + threeLoop*(12.*traceAdjYdYd +
      3.9999999999999996*traceAdjYeYe + 18.*Sqr(g1) - 6.*Sqr(g2))*(Ye.adjoint()
      ...
      *Ye*Ye.adjoint()*me2*Ye) + threeLoop*(Sqr(g1)*(-43.2*mHd2 - 43.2*Sqr(
      MassB)) + Sqr(g2)*(72.*mHd2 + 72.*Sqr(MassWB)))*(Ye.adjoint()*Ye*Ye.
      adjoint()*Ye*1.2020569031595942) + threeLoop*(6.*traceAdjYdYd +
      ...
      *Ye*1.2020569031595942) + threeLoop*(-21.6*Sqr(g1) + 36.*Sqr(g2))*(Ye.
      adjoint()*Ye*(TYe).adjoint()*TYe*1.2020569031595942) + threeLoop*(21.6*
      ...
      1.2020569031595942) + threeLoop*(-10.8*Sqr(g1) + 18.*Sqr(g2))*(ml2*Ye.
      adjoint()*Ye*Ye.adjoint()*Ye*1.2020569031595942) + threeLoop*(-21.6*Sqr(
      g1) + 36.*Sqr(g2))*(Ye.adjoint()*me2*Ye*Ye.adjoint()*Ye*
      1.2020569031595942) + threeLoop*(-21.6*Sqr(g1) + 36.*Sqr(g2))*(Ye.adjoint
   ...
   const Eigen::Matrix<double,3,3> beta_ml2_5 = ((36.*threeLoop*Sqr(g2)*(Ye.
      adjoint()*Ye*Ye.adjoint()*me2*Ye*1.2020569031595942) + threeLoop*(-10.8*
      Sqr(g1) + 18.*Sqr(g2))*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*ml2*
      1.2020569031595942) + 36.*mHd2*threeLoop*(Ye.adjoint()*Ye*Ye.adjoint()*Ye
      *Ye.adjoint()*Ye*1.2020569031595942) + 12.*threeLoop*(Ye.adjoint()*Ye*Ye.
      adjoint()*Ye*(TYe).adjoint()*TYe*1.2020569031595942) + 12.*threeLoop*(Ye.
      adjoint()*Ye*Ye.adjoint()*TYe*(TYe).adjoint()*Ye*1.2020569031595942) +
      12.*threeLoop*(Ye.adjoint()*Ye*(TYe).adjoint()*Ye*Ye.adjoint()*TYe*
      1.2020569031595942) + 12.*threeLoop*(Ye.adjoint()*Ye*(TYe).adjoint()*TYe*
      Ye.adjoint()*Ye*1.2020569031595942) + 12.*threeLoop*(Ye.adjoint()*TYe*Ye.
      adjoint()*Ye*(TYe).adjoint()*Ye*1.2020569031595942) + 12.*threeLoop*(Ye.
      adjoint()*TYe*(TYe).adjoint()*Ye*Ye.adjoint()*Ye*1.2020569031595942) +
      ...
      *threeLoop*(Ye.adjoint()*me2*Ye*Ye.adjoint()*Ye*Ye.adjoint()*Ye*
      ...
      Ye.adjoint()*Ye*1.2020569031595942) + 12.*threeLoop*(Ye.adjoint()*Ye*Ye.
      adjoint()*me2*Ye*Ye.adjoint()*Ye*1.2020569031595942) + 12.*threeLoop*(Ye.
      adjoint()*Ye*Ye.adjoint()*Ye*ml2*Ye.adjoint()*Ye*1.2020569031595942) +
      12.*threeLoop*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*Ye.adjoint()*me2*Ye*
      1.2020569031595942) + 6.*threeLoop*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*Ye.
