 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_3_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_ml2_1 = ((239.45914429835202*(-
      ...
      *traceAdjYuYu*Quad(g1)*Sqr(MassB) - 0.1025086919703813*Quad(g2)*Sqr(g1)*
      ...
      ) - 329.4*(-0.21857923497267762*traceAdjTYdTYdAdjYdYd -
   ...
   const Eigen::Matrix<double,3,3> beta_ml2_2 = ((72.*(1.5*mHd2*
      ...
      0.16666666666666666*traceYuAdjYdYdAdjYumu2 - 0.013333333333333329*
      tracemd2*Quad(g1) - 0.04*traceme2*Quad(g1) - 0.02*traceml2*Quad(g1) -
      0.0066666666666666645*tracemq2*Quad(g1) - 0.053333333333333316*tracemu2*
      ...
      traceAdjYeYe))*(Ye.adjoint()*Ye) + 109.8*(0.1092896174863388*
      ...
      *Quad(g1) + 0.4098360655737705*MassWB*Quad(g2) + 0.14571948998178505*
      ...
      traceAdjYdYd*Sqr(g3))*(Ye.adjoint()*TYe) + 109.8*(0.6557377049180328*
      traceAdjYdTYdAdjYdYd + 0.2185792349726776*traceAdjYeTYeAdjYeYe +
      0.1092896174863388*traceAdjYuTYuAdjYdYd - 0.3278688524590164*traceAdjYdYd
      *traceTYdAdjYd - 0.1092896174863388*traceAdjYeYe*traceTYdAdjYd +
      0.1092896174863388*traceTYdAdjYuYuAdjYd - 0.1092896174863388*traceAdjYdYd
      *traceTYeAdjYe - 0.03642987249544626*traceAdjYeYe*traceTYeAdjYe + 1.*
      MassB*Quad(g1) + 0.4098360655737705*MassWB*Quad(g2) - 0.14571948998178505
      *MassB*traceAdjYdYd*Sqr(g1) + 0.14571948998178505*traceTYdAdjYd*Sqr(g1) -
      0.3278688524590164*MassWB*traceAdjYdYd*Sqr(g2) - 0.1092896174863388*
      MassWB*traceAdjYeYe*Sqr(g2) + 0.3278688524590164*traceTYdAdjYd*Sqr(g2) +
      0.1092896174863388*traceTYeAdjYe*Sqr(g2) + 0.14754098360655737*MassB*Sqr(
      g1)*Sqr(g2) + 0.14754098360655737*MassWB*Sqr(g1)*Sqr(g2) +
      0.5828779599271402*MassG*traceAdjYdYd*Sqr(g3) - 0.5828779599271402*
      traceTYdAdjYd*Sqr(g3))*((TYe).adjoint()*Ye) - 54.9*Quad(g1)*((TYe).
      adjoint()*TYe))*UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_ml2_3 = ((-16.2*(-2.2222222222222223*
      traceAdjYdYdAdjYdYd + 0.7407407407407408*traceAdjYdYd*traceAdjYeYe -
      0.7407407407407408*traceAdjYeYeAdjYeYe - 0.7407407407407408*
      traceAdjYuYuAdjYdYd + 1.3888888888888888*Quad(g2) - 0.9876543209876543*
      traceAdjYdYd*Sqr(g1) - 2.2222222222222223*traceAdjYdYd*Sqr(g2) -
      0.7407407407407408*traceAdjYeYe*Sqr(g2) + 1.*Sqr(g1)*Sqr(g2) +
      ...
      TYe) - 27.45*(-0.6557377049180328*traceAdjYdYdAdjYdYd +
      ...
      Ye) - 54.9*(-0.6557377049180328*traceAdjYdYdAdjYdYd + 0.2185792349726776*
      traceAdjYdYd*traceAdjYeYe - 0.2185792349726776*traceAdjYeYeAdjYeYe -
      0.2185792349726776*traceAdjYuYuAdjYdYd + 1.*Quad(g1) + 0.4098360655737705
      *Quad(g2) - 0.2914389799635701*traceAdjYdYd*Sqr(g1) - 0.6557377049180328*
      traceAdjYdYd*Sqr(g2) - 0.2185792349726776*traceAdjYeYe*Sqr(g2) +
      0.29508196721311475*Sqr(g1)*Sqr(g2) + 1.1657559198542804*traceAdjYdYd*Sqr
      (g3) + 0.3278688524590164*Sqr(traceAdjYdYd) + 0.03642987249544626*Sqr(
      traceAdjYeYe))*(Ye.adjoint()*me2*Ye) + 19.44*(0.16666666666666666*mHd2*
      Quad(g1) - 3.24074074074074*mHd2*Quad(g2) + 1.2345679012345678*MassB*
      traceAdjTYdYd*Sqr(g1) - 2.4691358024691357*mHd2*traceAdjYdYd*Sqr(g1) -
      ...
      1.2020569031595942) - 27.45*(-0.6557377049180328*traceAdjYdYdAdjYdYd +
      0.2185792349726776*traceAdjYdYd*traceAdjYeYe - 0.2185792349726776*
      traceAdjYeYeAdjYeYe - 0.2185792349726776*traceAdjYuYuAdjYdYd + 1.*Quad(g1
      ) + 0.4098360655737705*Quad(g2) - 0.2914389799635701*traceAdjYdYd*Sqr(g1)
      - 0.6557377049180328*traceAdjYdYd*Sqr(g2) - 0.2185792349726776*
      traceAdjYeYe*Sqr(g2) + 0.29508196721311475*Sqr(g1)*Sqr(g2) +
      1.1657559198542804*traceAdjYdYd*Sqr(g3) + 0.3278688524590164*Sqr(
      traceAdjYdYd) + 0.03642987249544626*Sqr(traceAdjYeYe))*(Ye.adjoint()*Ye*
      ml2) - 6.48*(1.*MassB*Quad(g1) - 19.44444444444444*MassWB*Quad(g2) +
      3.7037037037037033*traceAdjTYdYd*Sqr(g1) - 3.7037037037037033*MassB*
      traceAdjYdYd*Sqr(g1) + 4.999999999999999*MassB*Sqr(g1)*Sqr(g2) +
      4.999999999999999*MassWB*Sqr(g1)*Sqr(g2) - 14.814814814814813*
      traceAdjTYdYd*Sqr(g3) + 14.814814814814813*MassG*traceAdjYdYd*Sqr(g3))*(
      Ye.adjoint()*TYe*1.2020569031595942) - 6.48*(1.*MassB*Quad(g1) -
      19.44444444444444*MassWB*Quad(g2) - 3.7037037037037033*MassB*traceAdjYdYd
      *Sqr(g1) + 3.7037037037037033*traceTYdAdjYd*Sqr(g1) + 4.999999999999999*
      MassB*Sqr(g1)*Sqr(g2) + 4.999999999999999*MassWB*Sqr(g1)*Sqr(g2) +
      14.814814814814813*MassG*traceAdjYdYd*Sqr(g3) - 14.814814814814813*
      traceTYdAdjYd*Sqr(g3))*((TYe).adjoint()*Ye*1.2020569031595942) + 3.24*(1.
      *Quad(g1) - 19.44444444444444*Quad(g2) - 7.4074074074074066*traceAdjYdYd*
      Sqr(g1) + 9.999999999999998*Sqr(g1)*Sqr(g2) + 29.629629629629626*
      traceAdjYdYd*Sqr(g3))*((TYe).adjoint()*TYe*1.2020569031595942) + 1.62*(1.
      *Quad(g1) - 19.44444444444444*Quad(g2) - 7.4074074074074066*traceAdjYdYd*
      Sqr(g1) + 9.999999999999998*Sqr(g1)*Sqr(g2) + 29.629629629629626*
      traceAdjYdYd*Sqr(g3))*(ml2*Ye.adjoint()*Ye*1.2020569031595942) + 3.24*
      Quad(g1)*(Ye.adjoint()*me2*Ye*1.2020569031595942))*UNITMATRIX(3)).real();
   const Eigen::Matrix<double,3,3> beta_ml2_4 = ((32.4*(-1.9444444444444442*
      Quad(g2) - 0.7407407407407408*traceAdjYdYd*Sqr(g1) + 1.*Sqr(g1)*Sqr(g2) +
      2.9629629629629632*traceAdjYdYd*Sqr(g3))*(Ye.adjoint()*me2*Ye*
      1.2020569031595942) + 1.62*(1.*Quad(g1) - 19.44444444444444*Quad(g2) -
      7.4074074074074066*traceAdjYdYd*Sqr(g1) + 9.999999999999998*Sqr(g1)*Sqr(
      g2) + 29.629629629629626*traceAdjYdYd*Sqr(g3))*(Ye.adjoint()*Ye*ml2*
      1.2020569031595942) + 36.*(1.*mHd2*traceAdjYdYd + 0.3333333333333333*
      traceAdjYdYdmq2 + 0.3333333333333333*mHd2*traceAdjYeYe +
      0.1111111111111111*traceAdjYeYeml2 + 0.3333333333333333*traceTYdAdjTYd +
      0.1111111111111111*traceTYeAdjTYe + 0.3333333333333333*traceYdAdjYdmd2 +
      0.1111111111111111*traceYeAdjYeme2 + 1.*mHd2*Sqr(g1) - 0.3333333333333333
      *mHd2*Sqr(g2) + 1.*Sqr(g1)*Sqr(MassB) - 0.3333333333333333*Sqr(g2)*Sqr(
      MassWB))*(Ye.adjoint()*Ye*Ye.adjoint()*Ye) - 18.*(-0.6666666666666666*
      traceAdjTYdYd - 0.2222222222222222*traceAdjTYeYe + 1.*MassB*Sqr(g1) -
      0.3333333333333333*MassWB*Sqr(g2))*(Ye.adjoint()*Ye*Ye.adjoint()*TYe) -
      18.*(-0.6666666666666666*traceTYdAdjYd - 0.2222222222222222*traceTYeAdjYe
       + 1.*MassB*Sqr(g1) - 0.3333333333333333*MassWB*Sqr(g2))*(Ye.adjoint()*Ye
      *(TYe).adjoint()*Ye) + 18.*(0.6666666666666666*traceAdjYdYd +
      0.2222222222222222*traceAdjYeYe + 1.*Sqr(g1) - 0.3333333333333333*Sqr(g2)
      )*(Ye.adjoint()*Ye*(TYe).adjoint()*TYe) - 18.*(-0.6666666666666666*
      traceAdjTYdYd - 0.2222222222222222*traceAdjTYeYe + 1.*MassB*Sqr(g1) -
      0.3333333333333333*MassWB*Sqr(g2))*(Ye.adjoint()*TYe*Ye.adjoint()*Ye) +
      18.*(0.6666666666666666*traceAdjYdYd + 0.2222222222222222*traceAdjYeYe +
      1.*Sqr(g1) - 0.3333333333333333*Sqr(g2))*(Ye.adjoint()*TYe*(TYe).adjoint(
      )*Ye) - 18.*(-0.6666666666666666*traceTYdAdjYd - 0.2222222222222222*
      traceTYeAdjYe + 1.*MassB*Sqr(g1) - 0.3333333333333333*MassWB*Sqr(g2))*((
      TYe).adjoint()*Ye*Ye.adjoint()*Ye) + 18.*(0.6666666666666666*traceAdjYdYd
       + 0.2222222222222222*traceAdjYeYe + 1.*Sqr(g1) - 0.3333333333333333*Sqr(
      g2))*((TYe).adjoint()*Ye*Ye.adjoint()*TYe) + 18.*(0.6666666666666666*
      traceAdjYdYd + 0.2222222222222222*traceAdjYeYe + 1.*Sqr(g1) -
      0.3333333333333333*Sqr(g2))*((TYe).adjoint()*TYe*Ye.adjoint()*Ye) + 9.*(
      0.6666666666666666*traceAdjYdYd + 0.2222222222222222*traceAdjYeYe + 1.*
      Sqr(g1) - 0.3333333333333333*Sqr(g2))*(ml2*Ye.adjoint()*Ye*Ye.adjoint()*
      Ye) + 18.*(0.6666666666666666*traceAdjYdYd + 0.2222222222222222*
      traceAdjYeYe + 1.*Sqr(g1) - 0.3333333333333333*Sqr(g2))*(Ye.adjoint()*me2
      *Ye*Ye.adjoint()*Ye) + 18.*(0.6666666666666666*traceAdjYdYd +
      0.2222222222222222*traceAdjYeYe + 1.*Sqr(g1) - 0.3333333333333333*Sqr(g2)
      )*(Ye.adjoint()*Ye*ml2*Ye.adjoint()*Ye) + 18.*(0.6666666666666666*
      traceAdjYdYd + 0.2222222222222222*traceAdjYeYe + 1.*Sqr(g1) -
      0.3333333333333333*Sqr(g2))*(Ye.adjoint()*Ye*Ye.adjoint()*me2*Ye) - 43.2*
      (1.*mHd2*Sqr(g1) - 1.6666666666666665*mHd2*Sqr(g2) + 1.*Sqr(g1)*Sqr(MassB
      ) - 1.6666666666666665*Sqr(g2)*Sqr(MassWB))*(Ye.adjoint()*Ye*Ye.adjoint()
      *Ye*1.2020569031595942) + 9.*(0.6666666666666666*traceAdjYdYd +
      0.2222222222222222*traceAdjYeYe + 1.*Sqr(g1) - 0.3333333333333333*Sqr(g2)
      )*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*ml2) + 21.6*(1.*MassB*Sqr(g1) -
      1.6666666666666665*MassWB*Sqr(g2))*(Ye.adjoint()*Ye*Ye.adjoint()*TYe*
      1.2020569031595942) + 21.6*(1.*MassB*Sqr(g1) - 1.6666666666666665*MassWB*
      Sqr(g2))*(Ye.adjoint()*Ye*(TYe).adjoint()*Ye*1.2020569031595942) - 21.6*(
      1.*Sqr(g1) - 1.6666666666666665*Sqr(g2))*(Ye.adjoint()*Ye*(TYe).adjoint()
      *TYe*1.2020569031595942) + 21.6*(1.*MassB*Sqr(g1) - 1.6666666666666665*
      MassWB*Sqr(g2))*(Ye.adjoint()*TYe*Ye.adjoint()*Ye*1.2020569031595942) -
      21.6*(1.*Sqr(g1) - 1.6666666666666665*Sqr(g2))*(Ye.adjoint()*TYe*(TYe).
      adjoint()*Ye*1.2020569031595942) + 21.6*(1.*MassB*Sqr(g1) -
      1.6666666666666665*MassWB*Sqr(g2))*((TYe).adjoint()*Ye*Ye.adjoint()*Ye*
      1.2020569031595942) - 21.6*(1.*Sqr(g1) - 1.6666666666666665*Sqr(g2))*((
      TYe).adjoint()*Ye*Ye.adjoint()*TYe*1.2020569031595942) - 21.6*(1.*Sqr(g1)
      - 1.6666666666666665*Sqr(g2))*((TYe).adjoint()*TYe*Ye.adjoint()*Ye*
      1.2020569031595942) - 10.8*(1.*Sqr(g1) - 1.6666666666666665*Sqr(g2))*(ml2
      *Ye.adjoint()*Ye*Ye.adjoint()*Ye*1.2020569031595942) - 21.6*(1.*Sqr(g1) -
      1.6666666666666665*Sqr(g2))*(Ye.adjoint()*me2*Ye*Ye.adjoint()*Ye*
      1.2020569031595942) - 21.6*(1.*Sqr(g1) - 1.6666666666666665*Sqr(g2))*(Ye.
      adjoint()*Ye*ml2*Ye.adjoint()*Ye*1.2020569031595942) - 21.6*Sqr(g1)*(Ye.
      adjoint()*Ye*Ye.adjoint()*me2*Ye*1.2020569031595942))*UNITMATRIX(3)).real
      ();
   const Eigen::Matrix<double,3,3> beta_ml2_5 = ((36.*Sqr(g2)*(Ye.adjoint()*Ye*
      Ye.adjoint()*me2*Ye*1.2020569031595942) - 10.8*(1.*Sqr(g1) -
      1.6666666666666665*Sqr(g2))*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*ml2*
      1.2020569031595942) + 36.*mHd2*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*Ye.
      adjoint()*Ye*1.2020569031595942) + 12.*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*(
      TYe).adjoint()*TYe*1.2020569031595942) + 12.*(Ye.adjoint()*Ye*Ye.adjoint(
      )*TYe*(TYe).adjoint()*Ye*1.2020569031595942) + 12.*(Ye.adjoint()*Ye*(TYe)
      .adjoint()*Ye*Ye.adjoint()*TYe*1.2020569031595942) + 12.*(Ye.adjoint()*Ye
      *(TYe).adjoint()*TYe*Ye.adjoint()*Ye*1.2020569031595942) + 12.*(Ye.
      adjoint()*TYe*Ye.adjoint()*Ye*(TYe).adjoint()*Ye*1.2020569031595942) +
      12.*(Ye.adjoint()*TYe*(TYe).adjoint()*Ye*Ye.adjoint()*Ye*
      1.2020569031595942) + 12.*((TYe).adjoint()*Ye*Ye.adjoint()*Ye*Ye.adjoint(
      )*TYe*1.2020569031595942) + 12.*((TYe).adjoint()*Ye*Ye.adjoint()*TYe*Ye.
      adjoint()*Ye*1.2020569031595942) + 12.*((TYe).adjoint()*TYe*Ye.adjoint()*
      Ye*Ye.adjoint()*Ye*1.2020569031595942) + 6.*(ml2*Ye.adjoint()*Ye*Ye.
      adjoint()*Ye*Ye.adjoint()*Ye*1.2020569031595942) + 12.*(Ye.adjoint()*me2*
      Ye*Ye.adjoint()*Ye*Ye.adjoint()*Ye*1.2020569031595942) + 12.*(Ye.adjoint(
      )*Ye*ml2*Ye.adjoint()*Ye*Ye.adjoint()*Ye*1.2020569031595942) + 12.*(Ye.
      ...
      me2*Ye*1.2020569031595942) + 6.*(Ye.adjoint()*Ye*Ye.adjoint()*Ye*Ye.
      adjoint()*Ye*ml2*1.2020569031595942))*UNITMATRIX(3)).real();
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_ml2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
