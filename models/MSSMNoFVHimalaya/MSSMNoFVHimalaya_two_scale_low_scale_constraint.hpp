...
#ifndef MSSMNoFVHimalaya_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMNoFVHimalaya_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMNoFVHimalaya_low_scale_constraint.hpp"
...
template<>
class MSSMNoFVHimalaya_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMNoFVHimalaya_low_scale_constraint() = default;
   MSSMNoFVHimalaya_low_scale_constraint(MSSMNoFVHimalaya<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMNoFVHimalaya_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMNoFVHimalaya low-scale constraint"; }
