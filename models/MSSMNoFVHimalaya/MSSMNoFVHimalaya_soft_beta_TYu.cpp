...
// File generated at Sun 26 Aug 2018 13:45:44
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYu_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYu = (oneOver16PiSqr*(0.06666666666666667*(2*Yu*(45*traceAdjYuTYu + 13
      *MassB*Sqr(g1) + 45*MassWB*Sqr(g2) + 80*MassG*Sqr(g3)) - (-45*
      traceYuAdjYu + 13*Sqr(g1) + 45*Sqr(g2) + 80*Sqr(g3))*TYu) + 2*(Yu*Yd.
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYu_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYu = (twoLoop*(-0.008888888888888889*Yu*(2743*MassB*Quad(g1) + 25*(27*
      ...
      traceYuAdjYuYuAdjYu + 6.095555555555555*Quad(g1) + 7.5*Quad(g2) -
      ...
      TYu + (-2*(3*traceAdjYdTYd + traceAdjYeTYe) - 0.8*MassB*Sqr(g1))*(Yu*Yd.
      adjoint()*Yd) + (-2*(3*traceYdAdjYd + traceYeAdjYe) + 0.8*Sqr(g1))*(Yu*Yd
      .adjoint()*TYd) - 0.4*(45*traceAdjYuTYu + 2*MassB*Sqr(g1) + 30*MassWB*Sqr
      (g2))*(Yu*Yu.adjoint()*Yu) + 1.2*(Sqr(g1) + 5*(-2*traceYuAdjYu + Sqr(g2))
      )*(Yu*Yu.adjoint()*TYu) + (-3*traceYdAdjYd - traceYeAdjYe + 0.4*Sqr(g1))*
      (TYu*Yd.adjoint()*Yd) + 3*(-5*traceYuAdjYu + 4*Sqr(g2))*(TYu*Yu.adjoint()
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYu_3_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_TYu_2 = ((0.2*threeLoop*(540*
      ...
      MassB*traceAdjYeYe - 2*traceTYdAdjYd + traceTYeAdjYe) + 19*(MassB + MassG
      )*Sqr(g3))) + 25*(135*MassWB*Quad(g2) + 12*Sqr(g2)*(-9*MassWB*
   ...
   const Eigen::Matrix<double,3,3> beta_TYu_4 = ((-1.3333333333333333*threeLoop
      *(340*Quad(g3) - 9*traceAdjYuYu*(Sqr(g1) - 9*Sqr(g2)) - 180*traceAdjYuYu*
      Sqr(g3))*(TYu*Yu.adjoint()*Yu*1.2020569031595942) + threeLoop*(12*
      traceTYdAdjYd + 4*traceTYeAdjYe - 0.9333333333333333*MassB*Sqr(g1) + 6*
      MassWB*Sqr(g2) - 42.666666666666664*MassG*Sqr(g3))*(Yu*Yd.adjoint()*Yd*Yd
      .adjoint()*Yd) + 0.13333333333333333*threeLoop*(7*Sqr(g1) + 5*(18*
      traceAdjYdYd + 6*traceAdjYeYe - 9*Sqr(g2) + 64*Sqr(g3)))*(Yu*Yd.adjoint()
      *Yd*Yd.adjoint()*TYd) + threeLoop*(24*traceTYdAdjYd + 8*traceTYeAdjYe -
      12*traceTYuAdjYu - 2.533333333333333*MassB*Sqr(g1) - 18*MassWB*Sqr(g2) -
      42.666666666666664*MassG*Sqr(g3))*(Yu*Yd.adjoint()*Yd*Yu.adjoint()*Yu) +
      threeLoop*(12*traceAdjYdYd + 4*traceAdjYeYe - 6*traceAdjYuYu +
      1.2666666666666666*Sqr(g1) + 9*Sqr(g2) + 21.333333333333332*Sqr(g3))*(Yu*
      Yd.adjoint()*Yd*Yu.adjoint()*TYu) + 0.13333333333333333*threeLoop*(7*Sqr(
      ...
      1.3333333333333333*threeLoop*(-18*traceTYuAdjYu + 5*MassB*Sqr(g1) + 9*
      MassWB*Sqr(g2) + 64*MassG*Sqr(g3))*(Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu) +
      threeLoop*(18*traceAdjYuYu + 7*Sqr(g1) + 3*Sqr(g2) + 64*Sqr(g3))*(Yu*Yu.
      adjoint()*Yu*Yu.adjoint()*TYu) + 1.3333333333333333*threeLoop*(18*
      traceAdjYuYu + 5*Sqr(g1) + 9*Sqr(g2) + 64*Sqr(g3))*(Yu*Yu.adjoint()*TYu*
      Yu.adjoint()*Yu) + threeLoop*(6*traceAdjYdYd + 2*traceAdjYeYe +
      0.4666666666666667*Sqr(g1) - 3*Sqr(g2) + 21.333333333333332*Sqr(g3))*(TYu
      *Yd.adjoint()*Yd*Yd.adjoint()*Yd) + threeLoop*(24*traceAdjYdYd + 8*
      traceAdjYeYe - 12*traceAdjYuYu + 2.533333333333333*Sqr(g1) + 18*Sqr(g2) +
      42.666666666666664*Sqr(g3))*(TYu*Yd.adjoint()*Yd*Yu.adjoint()*Yu) +
   ...
   const Eigen::Matrix<double,3,3> beta_TYu_5 = ((0.00007407407407407407*
      ...
      *Yd.adjoint()*Yd*Yu.adjoint()*Yu*Yu.adjoint()*Yu) + 12*threeLoop*(TYu*Yu.
      adjoint()*Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu) + 12*threeLoop*(Yu*Yd.
      adjoint()*Yd*Yd.adjoint()*Yd*Yd.adjoint()*TYd*1.2020569031595942) + 12*
      threeLoop*(Yu*Yd.adjoint()*Yd*Yd.adjoint()*TYd*Yd.adjoint()*Yd*
      1.2020569031595942) + 12*threeLoop*(Yu*Yd.adjoint()*TYd*Yd.adjoint()*Yd*
      Yd.adjoint()*Yd*1.2020569031595942) + 24*threeLoop*(Yu*Yu.adjoint()*Yu*Yu
      .adjoint()*Yu*Yu.adjoint()*TYu*1.2020569031595942) + 36*threeLoop*(Yu*Yu.
      adjoint()*Yu*Yu.adjoint()*TYu*Yu.adjoint()*Yu*1.2020569031595942) + 36*
      threeLoop*(Yu*Yu.adjoint()*TYu*Yu.adjoint()*Yu*Yu.adjoint()*Yu*
      1.2020569031595942) + 6*threeLoop*(TYu*Yd.adjoint()*Yd*Yd.adjoint()*Yd*Yd
      .adjoint()*Yd*1.2020569031595942) + 30*threeLoop*(TYu*Yu.adjoint()*Yu*Yu.
