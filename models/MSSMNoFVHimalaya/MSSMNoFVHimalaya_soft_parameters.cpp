...
// File generated at Tue 22 Jan 2019 13:04:27
...
const int MSSMNoFVHimalaya_soft_parameters::numberOfParameters;

MSSMNoFVHimalaya_soft_parameters::MSSMNoFVHimalaya_soft_parameters(const MSSMNoFVHimalaya_input_parameters& input_)
   : MSSMNoFVHimalaya_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMNoFVHimalaya_soft_parameters::MSSMNoFVHimalaya_soft_parameters(
   const MSSMNoFVHimalaya_susy_parameters& susy_model
   ...
   : MSSMNoFVHimalaya_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMNoFVHimalaya_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMNoFVHimalaya_soft_parameters MSSMNoFVHimalaya_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMNoFVHimalaya_susy_parameters susy_betas(MSSMNoFVHimalaya_susy_parameters::calc_beta(loops));

   return MSSMNoFVHimalaya_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMNoFVHimalaya_soft_parameters MSSMNoFVHimalaya_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMNoFVHimalaya_soft_parameters::clear()
{
   MSSMNoFVHimalaya_susy_parameters::clear();
...
Eigen::ArrayXd MSSMNoFVHimalaya_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMNoFVHimalaya_susy_parameters::get());
...
void MSSMNoFVHimalaya_soft_parameters::print(std::ostream& ostr) const
{
   MSSMNoFVHimalaya_susy_parameters::print(ostr);
...
void MSSMNoFVHimalaya_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMNoFVHimalaya_susy_parameters::set(pars);
...
MSSMNoFVHimalaya_soft_parameters::Soft_traces MSSMNoFVHimalaya_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVHimalaya_soft_parameters& soft_pars)
{
