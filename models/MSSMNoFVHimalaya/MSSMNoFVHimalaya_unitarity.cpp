...
/**
 * @file MSSMNoFVHimalaya_unitarity.cpp
 *
...
namespace MSSMNoFVHimalaya_unitarity {
...
// s -> infinity limit
UnitarityInfiniteS
max_scattering_eigenvalue_infinite_s(MSSMNoFVHimalaya_mass_eigenstates const& model) {
