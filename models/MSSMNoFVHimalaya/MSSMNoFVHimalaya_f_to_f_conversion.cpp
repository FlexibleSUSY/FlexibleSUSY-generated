...
/**
 * @file MSSMNoFVHimalaya_f_to_f_conversion.cpp
 *
...
#include "MSSMNoFVHimalaya_f_to_f_conversion.hpp"
...
namespace MSSMNoFVHimalaya_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const MSSMNoFVHimalaya_mass_eigenstates& model) {
