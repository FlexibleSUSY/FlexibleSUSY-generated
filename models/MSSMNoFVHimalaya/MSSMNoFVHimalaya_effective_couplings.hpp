...
class MSSMNoFVHimalaya_effective_couplings {
public:
   MSSMNoFVHimalaya_effective_couplings(const MSSMNoFVHimalaya_mass_eigenstates&,
   ...
   void set_model(const MSSMNoFVHimalaya_mass_eigenstates& model_);
