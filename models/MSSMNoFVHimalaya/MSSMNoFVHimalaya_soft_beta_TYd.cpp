...
// File generated at Sun 26 Aug 2018 13:45:11
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYd_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYd = (oneOver16PiSqr*(0.13333333333333333*Yd*(7*MassB*Sqr(g1) + 5*(9*
      traceAdjYdTYd + 3*traceAdjYeTYe + 9*MassWB*Sqr(g2) + 16*MassG*Sqr(g3))) +
      (3*traceYdAdjYd + traceYeAdjYe - 0.4666666666666667*Sqr(g1) - 3*Sqr(g2) -
      5.333333333333333*Sqr(g3))*TYd + 4*(Yd*Yd.adjoint()*TYd) + 2*(Yd*Yu.
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYd_2_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_TYd = (twoLoop*(-0.044444444444444446*Yd*(287*MassB*Quad(g1) + 5*(27*(6
      *traceYdAdjYdTYdAdjYd + traceYdAdjYuTYuAdjYd + 2*traceYeAdjYeTYeAdjYe +
      traceYuAdjYdTYdAdjYu) + 135*MassWB*Quad(g2) - 32*MassG*Quad(g3) - 144*(
      traceAdjYdTYd - MassG*traceYdAdjYd)*Sqr(g3) + 72*(MassG + MassWB)*Sqr(g2)
      *Sqr(g3)) + Sqr(g1)*(45*(MassB + MassWB)*Sqr(g2) + 2*(9*(traceAdjYdTYd -
      3*traceAdjYeTYe - MassB*traceYdAdjYd + 3*MassB*traceYeAdjYe) + 20*(MassB
      + MassG)*Sqr(g3)))) + (-9*traceYdAdjYdYdAdjYd - 3*traceYdAdjYuYuAdjYd - 3
      *traceYeAdjYeYeAdjYe + 3.188888888888889*Quad(g1) + 7.5*Quad(g2) -
      1.7777777777777777*Quad(g3) + Sqr(g1)*(-0.4*traceYdAdjYd + 1.2*
      traceYeAdjYe + Sqr(g2) + 0.8888888888888888*Sqr(g3)) + 16*traceYdAdjYd*
      Sqr(g3) + 8*Sqr(g2)*Sqr(g3))*TYd - 0.4*(4*MassB*Sqr(g1) + 15*(3*
      traceAdjYdTYd + traceAdjYeTYe + 2*MassWB*Sqr(g2)))*(Yd*Yd.adjoint()*Yd) +
      (-4*(3*traceYdAdjYd + traceYeAdjYe) + 1.2*Sqr(g1) + 6*Sqr(g2))*(Yd*Yd.
      adjoint()*TYd) + (-6*traceAdjYuTYu - 1.6*MassB*Sqr(g1))*(Yd*Yu.adjoint()*
      Yu) + (-6*traceYuAdjYu + 1.6*Sqr(g1))*(Yd*Yu.adjoint()*TYu) + (-5*(3*
      traceYdAdjYd + traceYeAdjYe) + 1.2*Sqr(g1) + 12*Sqr(g2))*(TYd*Yd.adjoint(
      )*Yd) + (-3*traceYuAdjYu + 0.8*Sqr(g1))*(TYd*Yu.adjoint()*Yu) - 6*(Yd*Yd.
...
Eigen::Matrix<double,3,3> MSSMNoFVHimalaya_soft_parameters::calc_beta_TYd_3_loop(const Soft_traces& soft_traces) const
{
   ...
   const Eigen::Matrix<double,3,3> beta_TYd_2 = ((-0.04*threeLoop*((162*MassB*
      traceAdjYeYe + 77*traceTYdAdjYd - 81*traceTYeAdjYe)*Quad(g1) - 10*Sqr(g1)
      *(9*(5*MassB*traceAdjYdYd + 5*MassWB*traceAdjYdYd - 9*MassB*traceAdjYeYe
      - 9*MassWB*traceAdjYeYe - 5*traceTYdAdjYd + 9*traceTYeAdjYe)*Sqr(g2) - 2*
      (3*(18*traceAdjYeTYeAdjYeYe + MassB*(9*traceAdjYdYdAdjYdYd - 9*
      traceAdjYeYeAdjYeYe + 7*traceAdjYuYuAdjYdYd) - 7*(traceAdjYuTYuAdjYdYd +
      ...
      *(81*Quad(g2) + 9*(5*traceAdjYdYd - 9*traceAdjYeYe)*Sqr(g2) + 2*(-27*
      ...
      69*MassB*traceAdjYeYe + 153*traceTYdAdjYd - 69*traceTYeAdjYe + 148*(MassB
       + MassG)*Sqr(g3))) + 75*(219*MassWB*Quad(g2) + 2*Sqr(g2)*(-15*(3*MassWB*
      traceAdjYdYd + MassWB*traceAdjYeYe - 3*traceTYdAdjYd - traceTYeAdjYe) +
   ...
   const Eigen::Matrix<double,3,3> beta_TYd_4 = ((-18*threeLoop*traceAdjYeYe*
      ...
      threeLoop*(143*MassB*Quad(g1) - 25*(189*MassWB*Quad(g2) + 544*MassG*Quad(
      g3) - 144*(MassG*traceAdjYuYu - traceTYuAdjYu)*Sqr(g3)) + 5*Sqr(g1)*(135*
      (MassB + MassWB)*Sqr(g2) + 8*(-9*MassB*traceAdjYuYu + 9*traceTYuAdjYu +
      16*(MassB + MassG)*Sqr(g3))))*(Yd*Yu.adjoint()*Yu*1.2020569031595942) +
      0.013333333333333334*threeLoop*(143*Quad(g1) + 10*Sqr(g1)*(-72*
      traceAdjYuYu + 135*Sqr(g2) + 128*Sqr(g3)) - 25*(189*Quad(g2) + 544*Quad(
      g3) - 288*traceAdjYuYu*Sqr(g3)))*(Yd*Yu.adjoint()*TYu*1.2020569031595942)
      + 0.006666666666666667*threeLoop*(7*Quad(g1) + 10*Sqr(g1)*(-252*
      traceAdjYdYd + 216*traceAdjYeYe + 279*Sqr(g2) + 448*Sqr(g3)) - 25*(297*
      Quad(g2) - 72*Sqr(g2)*(-9*traceAdjYdYd - 3*traceAdjYeYe + 16*Sqr(g3)) +
      160*(17*Quad(g3) - 9*traceAdjYdYd*Sqr(g3))))*(TYd*Yd.adjoint()*Yd*
      ...
      *Sqr(g1) - 9*Sqr(g2) + 64*Sqr(g3))*(Yd*Yu.adjoint()*Yu*Yu.adjoint()*TYu)
      ...
      11*Sqr(g1) - 9*Sqr(g2) + 64*Sqr(g3))*(Yd*Yu.adjoint()*TYu*Yu.adjoint()*Yu
      ) + (-0.2*threeLoop*Sqr(g1) + threeLoop*(18*traceAdjYdYd + 6*traceAdjYeYe
       + 15*Sqr(g2) + 64*Sqr(g3)))*(TYd*Yd.adjoint()*Yd*Yd.adjoint()*Yd) -
      0.13333333333333333*threeLoop*(29*Sqr(g1) - 5*(-6*(3*traceAdjYdYd +
      traceAdjYeYe - 6*traceAdjYuYu) + 27*Sqr(g2) + 64*Sqr(g3)))*(TYd*Yu.
      adjoint()*Yu*Yd.adjoint()*Yd) + 0.3333333333333333*threeLoop*(18*
   ...
   const Eigen::Matrix<double,3,3> beta_TYd_5 = ((0.00007407407407407407*
      ...
      *(Yd*Yu.adjoint()*Yu*Yu.adjoint()*Yu*1.2020569031595942) - 12*threeLoop*(
      ...
      Yd.adjoint()*Yd*Yd.adjoint()*Yd*1.2020569031595942) + 12*threeLoop*(Yd*Yu
      .adjoint()*Yu*Yu.adjoint()*Yu*Yu.adjoint()*TYu*1.2020569031595942) + 12*
      ...
      Yd.adjoint()*Yd*Yd.adjoint()*Yd*1.2020569031595942) + 6*threeLoop*(TYd*Yu
      .adjoint()*Yu*Yu.adjoint()*Yu*Yu.adjoint()*Yu*1.2020569031595942))*
      UNITMATRIX(3)).real();
