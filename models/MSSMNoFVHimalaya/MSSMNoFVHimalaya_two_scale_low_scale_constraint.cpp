...
// File generated at Wed 16 Oct 2019 19:02:50
...
MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::MSSMNoFVHimalaya_low_scale_constraint(
   MSSMNoFVHimalaya<Two_scale>* model_, const softsusy::QedQcd& qedqcd_)
   : model(model_)
   , qedqcd(qedqcd_)
{
   initialize();
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
const Eigen::Matrix<std::complex<double>,3,3>& MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::get_ckm()
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::get_pmns()
{
   return pmns;
}

double MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<MSSMNoFVHimalaya<Two_scale>*>(model_);
}

void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_threshold_corrections()
{
   check_model_ptr();
...
double MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_theta_w()
{
   check_model_ptr();

   double theta_w = std::asin(Electroweak_constants::sinThetaW);

   MSSMNoFVHimalaya_weinberg_angle::Sm_parameters sm_pars;
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_DRbar_gauge_couplings()
{
   check_model_ptr();
...
double MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_delta_alpha_s(double alphaS) const
{
   check_model_ptr();
...
double MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_alpha_s_SM5_at(
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_Yd_DRbar()
{
   check_model_ptr();
...
void MSSMNoFVHimalaya_low_scale_constraint<Two_scale>::calculate_Ye_DRbar()
{
   check_model_ptr();
...
{
   if (!model)
      throw SetupError("MSSMNoFVHimalaya_low_scale_constraint<Two_scale>: "
