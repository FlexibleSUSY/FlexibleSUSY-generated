...
namespace MSSMNoFVHimalaya_info {
   ...
   enum Input_parameters : int { TanBeta, SignMu, Qin, M1, M2, M3, AtIN, AbIN,
   ...
   class MSSMNoFVHimalaya_particle_names : public Names {
   public:
      virtual ~MSSMNoFVHimalaya_particle_names() = default;
   ...
   class MSSMNoFVHimalaya_parameter_names : public Names {
   public:
      virtual ~MSSMNoFVHimalaya_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMNoFVHimalaya_particle_names  particle_names_getter{};
   const MSSMNoFVHimalaya_parameter_names parameter_names_getter{};
