...
#include "MSSMNoFVHimalaya_slha_io.hpp"
...
#include "MSSMNoFVHimalaya_physical.hpp"
...
MSSMNoFVHimalaya_slha_io::MSSMNoFVHimalaya_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MSSMNoFVHimalaya_slha_io::clear()
{
   slha_io.clear();
}

void MSSMNoFVHimalaya_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void MSSMNoFVHimalaya_slha_io::fill(MSSMNoFVHimalaya_slha& model) const
{
   fill(static_cast<MSSMNoFVHimalaya_mass_eigenstates&>(model));
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_extpar(const MSSMNoFVHimalaya_input_parameters& input)
{
   ...
   extpar << FORMAT_ELEMENT(100, input.Mlow, "Mlow");
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVHimalaya_slha_io::set_imminpar(const MSSMNoFVHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVHimalaya_slha_io::set_imextpar(const MSSMNoFVHimalaya_input_parameters& input)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVHimalaya_slha_io::set_minpar(const MSSMNoFVHimalaya_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMNoFVHimalaya_slha_io::set_input(const MSSMNoFVHimalaya_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMNoFVHimalaya_slha_io::set_LToLConversion_settings(const LToLConversion_settings& settings)
{
 ...
 * @param settings class of settings
 */
void MSSMNoFVHimalaya_slha_io::set_FlexibleDecay_settings(const FlexibleDecay_settings& settings)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_unitarity_infinite_s(
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMNoFVHimalaya_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMNoFVHimalaya_info::model_name)
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_mass(const MSSMNoFVHimalaya_physical& physical,
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_mixing_matrices(const MSSMNoFVHimalaya_physical& physical,
...
void MSSMNoFVHimalaya_slha_io::set_ckm(
...
void MSSMNoFVHimalaya_slha_io::set_pmns(
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_model_parameters(const MSSMNoFVHimalaya_slha& model)
{
   {
...
void MSSMNoFVHimalaya_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void MSSMNoFVHimalaya_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void MSSMNoFVHimalaya_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void MSSMNoFVHimalaya_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_dcinfo(const FlexibleDecay_problems& problems)
{
 ...
 * @param warnings vector of warning strings
 */
void MSSMNoFVHimalaya_slha_io::set_dcinfo(
   const std::vector<std::string>& problems,
   const std::vector<std::string>& warnings)
{
   ...
   dcinfo << FORMAT_SPINFO(5, MSSMNoFVHimalaya_info::model_name)
          << FORMAT_SPINFO(9, SARAH_VERSION);
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_decay_block(const Decays_list& decays_list, FlexibleDecay_settings const& flexibledecay_settings)
{
   const auto pdg = decays_list.get_particle_id();
   const auto width = decays_list.get_total_width();
   const std::string name = MSSMNoFVHimalaya_info::get_particle_name_from_pdg(pdg);
   ...
   if (!is_zero(width, 1e-100)) {
      ...
      for (const auto& channel : sorted_decays_list) {
         ...
         for (auto id : final_state) {
            comment += " " + MSSMNoFVHimalaya_info::get_particle_name_from_pdg(id);
         }
         comment += ")";
...
void MSSMNoFVHimalaya_slha_io::set_effectivecouplings_block(const std::vector<std::tuple<int, int, int, double, std::string>>& effCouplings)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_spectrum(const MSSMNoFVHimalaya_slha& model)
{
   const MSSMNoFVHimalaya_physical physical(model.get_physical_slha());
 ...
 */
void MSSMNoFVHimalaya_slha_io::set_extra(
   const MSSMNoFVHimalaya_slha& model,
   const MSSMNoFVHimalaya_scales& scales,
   const MSSMNoFVHimalaya_observables& observables,
 ...
 */
void MSSMNoFVHimalaya_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void MSSMNoFVHimalaya_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void MSSMNoFVHimalaya_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void MSSMNoFVHimalaya_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double MSSMNoFVHimalaya_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::fill(MSSMNoFVHimalaya_input_parameters& input) const
{
 ...
 */
void MSSMNoFVHimalaya_slha_io::fill_drbar_parameters(MSSMNoFVHimalaya_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMNoFVHimalaya_slha_io::fill(MSSMNoFVHimalaya_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMNoFVHimalaya_physical physical_hk;
 ...
 */
void MSSMNoFVHimalaya_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MSSMNoFVHimalaya_slha_io::fill(Spectrum_generator_settings& settings) const
{
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMNoFVHimalaya_slha_io::fill(LToLConversion_settings& settings) const
{
   slha_io.fill(settings);
}
 ...
 * @param settings struct of spectrum generator settings to be filled
 */
void MSSMNoFVHimalaya_slha_io::fill(FlexibleDecay_settings& settings) const
{
   slha_io.fill(settings);
}

void MSSMNoFVHimalaya_slha_io::fill_minpar_tuple(MSSMNoFVHimalaya_input_parameters& input,
...
void MSSMNoFVHimalaya_slha_io::fill_extpar_tuple(MSSMNoFVHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
   ...
   case 100: input.Mlow = value; break;
   default: WARNING("Unrecognized entry in block EXTPAR: " << key); break;
   }

}

void MSSMNoFVHimalaya_slha_io::fill_imminpar_tuple(MSSMNoFVHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMNoFVHimalaya_slha_io::fill_imextpar_tuple(MSSMNoFVHimalaya_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMNoFVHimalaya_slha_io::fill_physical(MSSMNoFVHimalaya_physical& physical) const
{
   {
 ...
 */
double MSSMNoFVHimalaya_slha_io::read_scale() const
{
