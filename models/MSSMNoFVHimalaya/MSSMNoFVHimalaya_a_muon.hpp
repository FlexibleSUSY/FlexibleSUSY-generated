...
*/
double calculate_a_muon(const MSSMNoFVHimalaya_mass_eigenstates& model);

/**
* @fn calculate_a_muon_uncertainty
* @brief Calculates \f$\Delta a_\mu\f$ of the muon.
*/
double calculate_a_muon_uncertainty(const MSSMNoFVHimalaya_mass_eigenstates& model);
} // namespace MSSMNoFVHimalaya_a_muon
} // namespace flexiblesusy
