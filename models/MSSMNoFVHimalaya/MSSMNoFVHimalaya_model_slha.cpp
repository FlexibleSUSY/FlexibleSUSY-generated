...
MSSMNoFVHimalaya_slha::MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_input_parameters& input_,
 ...
 */
MSSMNoFVHimalaya_slha::MSSMNoFVHimalaya_slha(const MSSMNoFVHimalaya_mass_eigenstates& model_, bool do_convert_masses_to_slha)
   : MSSMNoFVHimalaya_mass_eigenstates(model_)
   , convert_masses_to_slha(do_convert_masses_to_slha)
{
   convert_to_slha();
}

void MSSMNoFVHimalaya_slha::clear()
{
   MSSMNoFVHimalaya_mass_eigenstates::clear();
   physical_slha.clear();
}

void MSSMNoFVHimalaya_slha::calculate_spectrum()
{
   MSSMNoFVHimalaya_mass_eigenstates::calculate_spectrum();
   convert_to_slha();
}

void MSSMNoFVHimalaya_slha::convert_to_slha()
{
...
void MSSMNoFVHimalaya_slha::calculate_ckm_matrix()
{

}

void MSSMNoFVHimalaya_slha::calculate_pmns_matrix()
{
 ...
 */
void MSSMNoFVHimalaya_slha::convert_yukawa_couplings_to_slha()
{
 ...
 */
void MSSMNoFVHimalaya_slha::convert_trilinear_couplings_to_slha()
{
 ...
 */
void MSSMNoFVHimalaya_slha::convert_soft_squared_masses_to_slha()
{
...
const MSSMNoFVHimalaya_physical& MSSMNoFVHimalaya_slha::get_physical_slha() const
{
   return physical_slha;
}

MSSMNoFVHimalaya_physical& MSSMNoFVHimalaya_slha::get_physical_slha()
{
   return physical_slha;
}

void MSSMNoFVHimalaya_slha::print(std::ostream& ostr) const
{
   MSSMNoFVHimalaya_mass_eigenstates::print(ostr);
...
void MSSMNoFVHimalaya_slha::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

std::ostream& operator<<(std::ostream& ostr, const MSSMNoFVHimalaya_slha& model)
{
   model.print(ostr);
   return ostr;
}
