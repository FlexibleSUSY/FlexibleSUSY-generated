...
{
   std::cout <<
      "Usage: scan_MSSMNoFVHimalaya.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --Qin=<value>\n"
...
struct MSSMNoFVHimalaya_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMNoFVHimalaya_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMNoFVHimalaya_input_parameters& input)
{
   ...
   MSSMNoFVHimalaya_scan_result result;
...
void scan(int solver_type, MSSMNoFVHimalaya_input_parameters& input,
