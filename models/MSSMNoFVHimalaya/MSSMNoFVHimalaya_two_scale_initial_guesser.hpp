...
#include "MSSMNoFVHimalaya_initial_guesser.hpp"
...
/**
 * @class MSSMNoFVHimalaya_initial_guesser<Two_scale>
 * @brief initial guesser for the MSSMNoFVHimalaya
 */

template<>
class MSSMNoFVHimalaya_initial_guesser<Two_scale> : public Initial_guesser {
public:
   MSSMNoFVHimalaya_initial_guesser(MSSMNoFVHimalaya<Two_scale>*,
                               const softsusy::QedQcd&,
                               const MSSMNoFVHimalaya_low_scale_constraint<Two_scale>&,
                               const MSSMNoFVHimalaya_susy_scale_constraint<Two_scale>&,
                               const MSSMNoFVHimalaya_high_scale_constraint<Two_scale>&);
   virtual ~MSSMNoFVHimalaya_initial_guesser() = default;
...
private:
   MSSMNoFVHimalaya<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   MSSMNoFVHimalaya_low_scale_constraint<Two_scale> low_constraint{};
   MSSMNoFVHimalaya_susy_scale_constraint<Two_scale> susy_constraint{};
   MSSMNoFVHimalaya_high_scale_constraint<Two_scale> high_constraint{};
